#region Local Var
	...
	int iLocal_388 = 0;
	int iLocal_389 = 0;
	Vector3 vLocal_390 = 0;
	Vector3 vLocal_393 = 0;
	Vector3 vLocal_396 = 0;
	Vector3 vLocal_399 = 0;
	struct<13>[] Local_402 = new struct<13>[4];
	struct<9> Local_455 = 0;
	auto uLocal_464 = 0;
	auto uLocal_465 = 0;
	auto uLocal_466 = 0;
	auto uLocal_467 = 0;
	struct<9> Local_468 = 0;
	auto uLocal_477 = 0;
	auto uLocal_478 = 0;
	auto uLocal_479 = 0;
	auto uLocal_480 = 0;
	struct<13>[] Local_481 = new struct<13>[3];
	struct<13>[] Local_521 = new struct<13>[3];
	struct<13>[] Local_561 = new struct<13>[6];
	struct<13>[] Local_640 = new struct<13>[2];
	int[] iLocal_667 = new int[3];
	int[] iLocal_671 = new int[6];
	int[] iLocal_678 = new int[2];
	int[] iLocal_681 = new int[3];
	int[] iLocal_685 = new int[4];
	int iLocal_690 = 0;
	int iLocal_691 = 0;
	auto uLocal_692 = 0;
	int iLocal_693 = 0;
	struct<6>[] Local_694 = new struct<6>[9];
	struct<6> Local_749 = 0;
	struct<6>[] Local_755 = new struct<6>[2];
	struct<6> Local_768 = 0;
	int iLocal_774 = 0;
	int iLocal_775 = 0;
	int iLocal_776 = 0;
	int iLocal_777 = 0;
	...
	int iLocal_780 = 0;
	int iLocal_781 = 0;
	struct<4> Local_782 = 0;
	auto uLocal_786 = 0;
	auto uLocal_787 = 0;
	struct<6>[] Local_788 = new struct<6>[6];
	struct<6> Local_825 = 0;
	auto uLocal_831 = 15;
	auto uLocal_832 = 0;
	auto uLocal_833 = 0;
	auto uLocal_834 = 0;
...
void main()
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_101154.f_17264.f_382), 4);
	func_484();
	iVar0 = 0;
	while (iVar0 <= Local_481 - 1)
	{
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			...
			set_entity_can_be_damaged_by_relationship_group(Local_481[iVar0 /*13*/], 0, iLocal_774);
	...
	if (func_503() || func_482(0))
	{
		...
		{
			iVar1 = 0;
			func_481(PLAYER::PLAYER_PED_ID(), -1291.596f, -12.9214f, 48.5137f, 294.7073f, 0, 1);
		}
		else
		{
			iVar1 = func_480();
	...
	switch (iLocal_169)
	{
		...
		case 1:
			...
			if ((func_9(1) && func_8(1)) && func_7(1))
			{
				if (!func_32())
				{
					if (func_483(PLAYER::PLAYER_PED_ID()))
					{
						set_entity_coords(PLAYER::PLAYER_PED_ID(), -1291.596f, -12.9214f, 48.5137f, 1, false, 0, 1);
						set_entity_heading(PLAYER::PLAYER_PED_ID(), 303.114f);
					}
				}
			}
			break;
		...
		case 2:
			...
			if (!func_32())
			{
				if (func_483(PLAYER::PLAYER_PED_ID()))
				{
					set_entity_coords(PLAYER::PLAYER_PED_ID(), -1190.22f, 36.83f, 52.03f, 1, false, 0, 1);
					set_entity_heading(PLAYER::PLAYER_PED_ID(), 299f);
				}
			}
			break;
		...
		case 3:
			...
			if (!func_32())
			{
				if (func_483(PLAYER::PLAYER_PED_ID()))
				{
					set_entity_coords(PLAYER::PLAYER_PED_ID(), -1102.455f, 73.615f, 53.2039f, 1, false, 0, 1);
					set_entity_heading(PLAYER::PLAYER_PED_ID(), 238f);
				}
				if (func_6(Local_455))
				{
					if (func_5(Local_749))
		...
		case 4:
			...
			if (func_5(Local_749))
			{
				...
				set_entity_coords(Local_749, -1246.956f, -89.9753f, 42.904f, 1, false, 0, 1);
			...
			if (!func_32())
			{
				if (func_5(Local_694[4 /*6*/]))
				{
					if (func_483(PLAYER::PLAYER_PED_ID()))
					{
						if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_694[4 /*6*/], 0))
						{
							set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), Local_694[4 /*6*/], -1);
						}
					}
					set_entity_coords(Local_694[4 /*6*/], -1273.736f, -75.3014f, 44.6289f, 1, false, 0, 1);
		...
		case 5:
			...
			if (func_5(Local_749))
			{
				set_entity_health(Local_749, 450);
			...
			if (func_483(iLocal_777))
			{
				...
				{
					detach_entity(iLocal_777, 1, true);
				}
			}
			func_4(&Local_455);
			iLocal_354 = 0;
		...
		case 6:
			...
			if (!func_32())
			{
				if (func_483(PLAYER::PLAYER_PED_ID()))
				{
					set_entity_coords(PLAYER::PLAYER_PED_ID(), get_entity_coords(iLocal_777, 1) + Vector(0f, 1.5f, 0f), 1, false, 0, 1);
				}
			}
			iLocal_362 = 1;
			iLocal_171 = 2;
		...
		case 9:
			...
			while (iVar0 <= 2)
			{
				if (func_483(Local_481[iVar0 /*13*/]))
				{
					set_entity_health(Local_481[iVar0 /*13*/], false);
				}
				iVar0++;
			}
			break;
	...
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_483(PLAYER::PLAYER_PED_ID()))
			{
				...
				func_286(&uLocal_174, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_41()
{
	...
	{
		func_43(13, floor(Global_101154.f_8884.f_3853));
	}
...
void func_183()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_234(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_232(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_237(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Global_2621441 = 0;
	return func_238(sParam3, iParam4, iParam8);
}
...
void func_246(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_247()
{
	...
	if (func_483(Local_455))
	{
		switch (iLocal_170)
		{
			case 0:
				func_284();
				if (func_265(Local_455, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						if (func_14())
						...
						if (func_5(Local_749))
						{
							if (func_6(Local_455))
							{
								if (!is_ped_in_vehicle(Local_455, Local_749, 0))
								{
									task_enter_vehicle(Local_455, Local_749, -1, -1, 2f, 1, 0);
								}
							}
						}
				...
				else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
				{
					if (!func_179(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (func_14())
						{
							func_12();
						}
						func_286(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
						func_286(&uLocal_174, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			case 1:
				if (func_265(Local_455, 1, 1116471296, 1126825984, 0, 0, 0, 0) || iLocal_350 == 1)
				{
				...
				{
					if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
					{
						attach_entity_to_entity(Local_782.f_1, Local_455, get_ped_bone_index(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						open_sequence_task(&iLocal_776);
						task_achieve_heading(false, 112f, 0);
						task_play_anim(false, "rcmnigel1d", "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "rcmnigel1d", "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
						set_sequence_to_repeat(iLocal_776, 1);
						close_sequence_task(iLocal_776);
						task_perform_sequence(Local_455, iLocal_776);
						clear_sequence_task(&iLocal_776);
						if (func_483(Local_468))
						{
					...
					{
						if (is_entity_touching_entity(Local_455, PLAYER::PLAYER_PED_ID()))
						{
							if (!func_14())
							{
								func_286(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
					...
					if ((func_5(Local_749) && func_5(Local_694[5 /*6*/])) && func_483(PLAYER::PLAYER_PED_ID()))
					{
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 0) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_694[5 /*6*/], 0))
						{
							if (func_14())
							{
								func_15();
							...
							open_sequence_task(&iLocal_776);
							task_play_anim(false, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
			...
			case 2:
				...
				if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
				{
					attach_entity_to_entity(Local_782.f_1, Local_455, get_ped_bone_index(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					open_sequence_task(&iLocal_776);
					task_turn_ped_to_face_coord(false, -1094.57f, 60.98f, 52.67f, 0);
					task_play_anim(false, "mini@golf", "iron_idle_high_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, "mini@golf", "iron_swing_intro_high", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, "mini@golf", "iron_swing_action_high", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, "mini@golf", "swing_outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, "mini@golf", "swing_react_bad_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					set_sequence_to_repeat(iLocal_776, 1);
					close_sequence_task(iLocal_776);
					task_perform_sequence(Local_455, iLocal_776);
					clear_sequence_task(&iLocal_776);
			...
			case 3:
				if (((func_5(Local_749) && func_255(Local_455, Local_749, 1) < 10f) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 0)) && !is_entity_upsidedown(Local_749))
				{
					if (is_ped_sitting_in_vehicle(Local_455, Local_749))
					{
						...
						if (func_6(Local_455))
						{
							if (!func_253())
							{
								task_vehicle_follow_waypoint_recording(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 12, -1, -1f, 0, 2f);
							}
							else
							{
								iLocal_363 = 1;
								task_vehicle_follow_waypoint_recording(Local_455, Local_749, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1f, 0, 2f);
							}
						}
						iLocal_170 = 4;
					}
			...
			case 4:
				...
				if (func_5(Local_749))
				{
					...
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 1))
					{
						iLocal_170 = 7;
					}
				}
			...
			case 6:
				...
				if (func_5(Local_749))
				{
					if (!is_ped_in_vehicle(Local_455, Local_749, 0) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 1))
					{
						iLocal_170 = 7;
					}
				}
	...
	else
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264.f_382, 4))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_382), 4);
		}
	}
}
...
bool func_248()
{
	if (get_entity_speed(Local_749) < 0.15f && is_ped_in_vehicle(Local_455, Local_749, 0))
	{
		...
		{
			vehicle_waypoint_playback_pause(Local_749);
			if (func_5(Local_749) && func_483(Local_455))
			{
				_task_bring_vehicle_to_halt(Local_749, 2f, 3, 0);
				if (is_ped_in_vehicle(Local_455, Local_749, 0))
				{
			...
			if (!is_message_being_displayed())
			{
				if (!func_14())
				{
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_386 > 15000)
					{
						if (func_6(Local_455))
						{
							if (func_251(Local_455, PLAYER::PLAYER_PED_ID()) < 40f)
							{
								func_286(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
								func_286(&uLocal_174, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								switch (iLocal_380)
...
auto func_251(int iParam0, int iParam1)
{
...
bool func_253()
{
	if (func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (func_254(&uLocal_935, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
		{
			return true;
		}
	}
...
int func_254(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_255(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_256(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iLocal_357 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_483(Local_481[iVar0 /*13*/]))
			{
				...
				open_sequence_task(&iLocal_775);
				task_pause(false, get_random_int_in_range(250, 600));
				task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
				close_sequence_task(iLocal_775);
				task_perform_sequence(Local_481[iVar0 /*13*/], iLocal_775);
				clear_sequence_task(&iLocal_775);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_481[iVar0 /*13*/], 25, true);
				set_entity_load_collision_flag(Local_481[iVar0 /*13*/], true);
				set_ped_keep_task(Local_481[iVar0 /*13*/], true);
		...
		if (func_5(Local_749))
		{
			if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 0))
			{
				if (func_6(Local_455))
				{
					if (!is_ped_in_vehicle(Local_455, Local_749, 0))
					{
						...
						task_pause(false, get_random_int_in_range(250, 500));
						task_enter_vehicle(false, Local_749, -1, -1, 2f, 1, 0);
						close_sequence_task(iLocal_775);
						task_perform_sequence(Local_455, iLocal_775);
						clear_sequence_task(&iLocal_775);
		...
		if (func_483(Local_468))
		{
			set_entity_load_collision_flag(Local_468, true);
		}
		func_289(Local_468, 1);
		func_259();
		if (iLocal_169 <= 3 && func_483(Local_455))
		{
			attach_entity_to_entity(Local_782.f_1, Local_455, get_ped_bone_index(Local_455, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			if (func_483(Local_468))
			{
		...
		{
			detach_entity(Local_782.f_1, 1, true);
		}
		func_258(790, 0);
		iLocal_357 = 1;
	}
...
void func_260(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_788[iParam0 /*6*/]))
	{
		...
		{
			detach_entity(Local_788[iParam0 /*6*/], 1, true);
		}
	}
...
int func_262(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_263()
{
	if ((func_264(PLAYER::PLAYER_PED_ID()) == joaat("weapon_sniperrifle") || func_264(PLAYER::PLAYER_PED_ID()) == joaat("weapon_heavysniper")) || func_264(PLAYER::PLAYER_PED_ID()) == joaat("weapon_remotesniper"))
	{
		return true;
	}
	return false;
...
int func_265(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	...
	if (func_483(PLAYER::PLAYER_PED_ID()) && func_483(iParam0))
	{
		...
		if (func_279(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
...
bool func_266(int iParam0, float fParam1)
{
	...
	if (func_483(PLAYER::PLAYER_PED_ID()) && func_483(iParam0))
	{
		if (func_277(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
int func_268(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_269(&(Local_49[iVar4 /*4*/]), vVar1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3 < iParam4);
}

bool func_269(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_270(iParam4, iParam7)};
...
bool func_272(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_274(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_274(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_273(vVar3, vVar0);
...
float func_273(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}

Vector3 func_274(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_278(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_279(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_483(PLAYER::PLAYER_PED_ID()) && func_483(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_283(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_280(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_280(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_281(int iParam0, float fParam1)
{
	...
	{
		if (func_282(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_282(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_274(vParam1 - get_entity_coords(iParam0, 1))};
...
bool func_283(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
void func_284()
{
	...
	{
		case 0:
			if (func_6(Local_455) && func_483(PLAYER::PLAYER_PED_ID()))
			{
				if (((func_285(PLAYER::PLAYER_PED_ID(), Local_455, 35f, 1) && iLocal_667[0] != 5) && iLocal_667[1] != 5) && iLocal_667[2] != 5)
				{
					if (!func_14())
					{
						func_286(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
...
void func_289(int iParam0, int iParam1)
{
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			set_ped_flee_attributes(iParam0, 64, false);
			open_sequence_task(&iLocal_776);
			task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
			close_sequence_task(iLocal_776);
			task_perform_sequence(iParam0, iLocal_776);
			clear_sequence_task(&iLocal_776);
			set_ped_keep_task(iParam0, true);
		}
	}
...
void func_291()
{
	if (iLocal_368)
	{
		if (!func_483(Local_455) && func_293())
		{
	...
	if (iLocal_348 == 0)
	{
		if (func_300(0))
		{
			...
			while (iVar0 <= 1)
			{
				...
				set_blocking_of_non_temporary_events(Local_640[iVar0 /*13*/], true);
				set_ped_can_be_targetted(Local_640[iVar0 /*13*/], false);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 1)
			{
				...
				set_vehicle_model_is_suppressed(Local_755[iVar0 /*6*/].f_5, true);
				iVar0++;
			}
			iLocal_348 = 1;
		}
...
void func_295(int iParam0)
{
	switch (iLocal_678[iParam0])
	{
				...
				if (func_483(Local_455))
				{
					if (is_ped_in_vehicle(Local_455, Local_749, 0))
					{
						...
						else if (is_bullet_in_area(get_entity_coords(Local_640[iParam0 /*13*/], 1), 15f, 1))
						{
							...
							if (func_255(PLAYER::PLAYER_PED_ID(), Local_640[iParam0 /*13*/], 1) < 45f)
							{
					...
					else if (func_265(Local_640[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || is_entity_at_entity(Local_455, Local_640[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0))
					{
						func_289(Local_640[iParam0 /*13*/], 0);
						iLocal_678[iParam0] = 3;
					}
		...
		case 1:
			if (is_entity_at_entity(Local_455, Local_640[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_640[iParam0 /*13*/]))
				{
					...
					task_go_straight_to_coord(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 0.5f);
					set_ped_keep_task(Local_640[iParam0 /*13*/], true);
		...
		case 2:
			if (is_entity_at_coord(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 2f, 2f, 2f, false, true, 0))
			{
				func_289(Local_640[iParam0 /*13*/], 0);
				iLocal_678[iParam0] = 3;
			}
...
{
	_play_ambient_speech1(iParam0, sParam1, func_297(iParam2), 1);
}
...
void func_299(int iParam0, int iParam1)
{
	...
	{
		*iParam0 = PED::CREATE_PED(26, *iParam0.f_8, *iParam0.f_1, 0, 1, true);
		if (func_483(*iParam0))
		{
	...
	if (iLocal_345 == 0)
	{
		if (func_8(0))
		{
			...
			while (iVar0 <= 2)
			{
				...
				set_blocking_of_non_temporary_events(Local_481[iVar0 /*13*/], true);
				give_weapon_to_ped(Local_481[iVar0 /*13*/], joaat("weapon_pistol"), -1, false, true);
				set_entity_only_damaged_by_player(Local_481[iVar0 /*13*/], true);
				set_ped_can_be_targetted(Local_481[iVar0 /*13*/], true);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_481[iVar0 /*13*/], iLocal_774);
				set_ped_dies_when_injured(Local_481[iVar0 /*13*/], true);
				set_ped_model_is_suppressed(Local_481[iVar0 /*13*/].f_8, true);
				iVar0++;
			}
			iLocal_345 = 1;
		}
		...
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			if (iLocal_357 == 0 && iLocal_351 == 0)
			{
				if (func_311())
				{
					...
					if (func_310(PLAYER::PLAYER_PED_ID(), -1098.865f, 69.9792f, 53.6198f, 1) < 45f)
					{
...
void func_303(int iParam0)
{
	...
	if (func_483(PLAYER::PLAYER_PED_ID()) && func_483(Local_481[iParam0 /*13*/]))
	{
		if (func_255(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) < 20f)
		{
			if (!is_ped_headtracking_ped(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID()))
			{
				task_look_at_entity(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1000, 0, 2);
			}
		}
	}
	...
	{
		case 0:
			if (func_265(Local_481[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || has_ped_received_event(Local_481[iParam0 /*13*/], 60))
			{
			...
			{
				if ((is_entity_on_screen(Local_481[iParam0 /*13*/]) && func_267(Local_481[iParam0 /*13*/], 1126825984)) && func_255(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
			...
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_179(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (!func_307())
						{
							if (func_267(Local_481[iParam0 /*13*/], 1126825984) && is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
							{
								if (func_14())
								{
									func_12();
						...
						else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
						{
							if (iLocal_349 == 0)
							{
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								if (!is_message_being_displayed() || get_profile_setting(203) == 0)
								{
									if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										...
										task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), -1);
										close_sequence_task(iLocal_775);
										task_perform_sequence(Local_481[iParam0 /*13*/], iLocal_775);
										clear_sequence_task(&iLocal_775);
										iLocal_387 = GAMEPLAY::GET_GAME_TIMER();
										iLocal_349 = 1;
							...
							{
								if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
								{
									if (func_14())
									{
										func_12();
					...
					else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
					{
						if (iLocal_349 == 0)
						{
							if (!func_14() && iLocal_359 == 0)
							{
								...
								{
									task_turn_ped_to_face_entity(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
								}
								if (func_6(Local_468))
								{
									task_look_at_entity(Local_468, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								}
								if (func_6(Local_455))
								{
									task_look_at_entity(Local_455, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									open_sequence_task(&iLocal_776);
									task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 1500);
									task_play_anim(false, "rcmnigel1d", "idle_c", 2f, -4f, -1, 1, 0, 0, 0, 0);
									close_sequence_task(iLocal_776);
									task_perform_sequence(Local_455, iLocal_776);
									clear_sequence_task(&iLocal_776);
								}
			...
			else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0))
			{
				if (!is_vehicle_model(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), Local_749.f_5))
				{
					if (func_267(Local_481[iParam0 /*13*/], 1126825984))
					{
						if (func_14())
				...
				else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) >= 15f)
					{
						func_306("Going too fast, going to trigger aggro: ", get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)));
						if (has_ped_received_event(Local_481[iParam0 /*13*/], 60) || is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 0))
						{
							if (func_267(Local_481[iParam0 /*13*/], 1126825984))
							{
								if (func_14())
		...
		case 1:
			if (!func_307())
			{
				if (func_267(Local_481[iParam0 /*13*/], 1126825984))
				{
					if (func_255(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) < 80f)
					{
			...
			else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) && iLocal_351 == 1)
			{
				func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
			...
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						...
						task_play_anim(false, "rcmnigel1d", "thanks_male_05", 4f, -4f, -1, 0, 0, 0, 0, 0);
						close_sequence_task(iLocal_775);
						task_perform_sequence(Local_481[iParam0 /*13*/], iLocal_775);
						clear_sequence_task(&iLocal_775);
						iLocal_387 = GAMEPLAY::GET_GAME_TIMER();
		...
		case 2:
			...
			else if (!func_179(PLAYER::PLAYER_PED_ID(), 12, 4))
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 8f, 8f, 8f, 0, 1, 0) && iLocal_351 == 1))
				{
					func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
					{
				...
				{
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0))
					{
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) >= 15f)
							{
								...
								func_306("SS_WARN_PLAYER, going too fast: ", get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)));
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					...
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_387 >= 7000)
					{
						...
						else if (func_255(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) > 20f)
						{
			...
			else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
			{
				if (iLocal_349 == 0)
				{
					if (!func_14() && iLocal_359 == 0)
					{
						...
						if (func_6(Local_455))
						{
							task_turn_ped_to_face_entity(Local_455, PLAYER::PLAYER_PED_ID(), -1);
						}
						func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_286(&uLocal_174, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_286(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
		...
		case 3:
				...
				if (func_267(Local_481[iParam0 /*13*/], 1126825984))
				{
					if (func_255(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) < 80f)
					{
						...
						else
						{
							...
							open_sequence_task(&iLocal_775);
							task_pause(false, get_random_int_in_range(5, 200));
							task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
							close_sequence_task(iLocal_775);
							task_perform_sequence(Local_481[iParam0 /*13*/], iLocal_775);
							clear_sequence_task(&iLocal_775);
							PED::SET_PED_COMBAT_ATTRIBUTES(Local_481[iParam0 /*13*/], 25, true);
							set_entity_load_collision_flag(Local_481[iParam0 /*13*/], true);
							set_ped_keep_task(Local_481[iParam0 /*13*/], true);
			...
			{
				if (is_bullet_in_area(get_entity_coords(Local_481[iParam0 /*13*/], 1), 20f, 0) && is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
				...
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_305(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f) && iLocal_351 == 1))
				{
					if (func_14())
					{
						func_12();
				...
				else
				{
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
					{
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) >= 15f)
							{
								...
								func_306("SS_AIM_AT_PLAYER, going too fast: ", get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)));
								func_286(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								func_262(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
					...
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_387 >= 10000)
					{
						if (func_483(Local_455))
						{
							if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_481[iParam0 /*13*/]))
								{
									clear_ped_tasks_immediately(Local_481[iParam0 /*13*/]);
									task_go_straight_to_coord(Local_481[iParam0 /*13*/], Local_481[iParam0 /*13*/].f_1, 3f, -1, Local_481[iParam0 /*13*/].f_7, 0.5f);
								}
								iLocal_351 = 1;
								iLocal_667[iParam0] = 0;
							}
							else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
							{
								if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || GAMEPLAY::GET_GAME_TIMER() - iLocal_387 >= 12000)
								{
									if (func_14())
									{
										func_12();
		...
		case 4:
			if (func_255(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (is_ped_in_any_vehicle(Local_455, 0) || func_483(Local_455)))
			{
				if (does_blip_exist(Local_481[iParam0 /*13*/].f_11))
				{
...
int func_305(int iParam0, Vector3 vParam1, float fParam2)
{
...
bool func_307()
{
	if (func_264(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed") && func_264(PLAYER::PLAYER_PED_ID()) != joaat("object"))
	{
		if (func_264(PLAYER::PLAYER_PED_ID()) != joaat("weapon_golfclub"))
		{
			return false;
		}
		if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
...
void func_308()
{
	...
	{
		if (iLocal_169 < 3 || func_255(PLAYER::PLAYER_PED_ID(), Local_455, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_481[iVar0 /*13*/]))
				{
					...
					if (iVar0 == 1)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_455))
						{
							task_turn_ped_to_face_entity(Local_481[iVar0 /*13*/], Local_455, false);
							task_go_to_entity(Local_481[iVar0 /*13*/], Local_455, 20000, 6f, 2f, 2f, 0);
						}
					}
					else
					{
						task_look_at_entity(Local_481[iVar0 /*13*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					}
					WEAPON::SET_CURRENT_PED_WEAPON(Local_481[iVar0 /*13*/], joaat("weapon_pistol"), true);
					set_ped_using_action_mode(Local_481[iVar0 /*13*/], true, -1, "DEFAULT_ACTION");
			...
			if (func_483(Local_455))
			{
				if (!func_304(Local_455, 474215631))
				{
					clear_ped_tasks(Local_455);
			...
			if (func_483(Local_468))
			{
				...
				{
					detach_entity(Local_825, 1, true);
				}
				task_smart_flee_ped(Local_468, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
...
auto func_310(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_311()
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_483(Local_481[iVar0 /*13*/]) || func_312(PLAYER::PLAYER_PED_ID(), Local_481[iVar0 /*13*/], 1)) || is_ped_ragdoll(Local_481[iVar0 /*13*/]))
		{
	...
	if ((!func_483(Local_455) || func_312(PLAYER::PLAYER_PED_ID(), Local_455, 1)) || is_ped_ragdoll(Local_455))
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return true;
	}
	if ((!func_483(Local_468) || func_312(PLAYER::PLAYER_PED_ID(), Local_468, 1)) || is_ped_ragdoll(Local_468))
	{
		func_495("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return true;
	}
	if (func_5(Local_749) && func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_749, 0))
		{
	...
	if (func_5(Local_694[4 /*6*/]) && func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_694[4 /*6*/], 0))
		{
	...
	if (func_5(Local_694[5 /*6*/]) && func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_694[5 /*6*/], 0))
		{
...
{
	if (func_6(iParam0) && is_ped_in_any_vehicle(iParam0, 0))
	{
		if (func_6(iParam1))
		{
...
bool func_314()
{
	...
	while (iVar0 <= 2)
	{
		if (func_483(Local_481[iVar0 /*13*/]))
		{
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_481[iVar0 /*13*/], 70f, 70f, 70f, 0, 1, 0))
			{
				return false;
			}
		}
...
void func_315()
{
	switch (iLocal_171)
	{
		...
		case 1:
			...
			if (func_483(Local_782.f_1))
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_782.f_1, 0.8f, 0.8f, 2f, 0, 1, 1))
				{
					if (is_entity_attached_to_any_object(Local_782.f_1))
					{
						func_495("Golf club attached to bag - correct?");
						play_sound_from_entity(iLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
					else
					{
						func_495("Golf club NOT attached to bag - correct?");
						play_sound_from_entity(iLocal_389, "COLLECT_OUT_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
					}
...
{
	if (func_254(&uLocal_831, get_entity_coords(iParam0, 1)))
	{
		return true;
	}
	return false;
...
void func_319()
{
	if (iLocal_364 == 0)
	{
		...
		{
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_782.f_1, 25f, 25f, 25f, 0, 1, 0))
			{
				iLocal_364 = 1;
			}
		}
	...
	if (func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_358 == 0)
		{
			if (iLocal_170 == 7 || iLocal_169 == 6)
			{
				if (func_483(Local_782.f_1))
				{
					if (iLocal_364 == 1)
					{
						if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_782.f_1, 65f, 65f, 65f, 0, 1, 0))
						{
		...
		else if (iLocal_170 == 7 || iLocal_169 == 6)
		{
			if (func_483(Local_782.f_1))
			{
				if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_782.f_1, 140f, 140f, 140f, 0, 1, 0))
				{
					func_34(3);
				}
			}
		...
		if (iLocal_169 < 6)
		{
			if (func_483(Local_455))
			{
				if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 140f, 140f, 140f, 0, 1, 0) && !func_268(PLAYER::PLAYER_PED_ID(), Local_455, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_322()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_455) && func_483(Local_782.f_1))
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_782.f_1))
	{
		iLocal_339 = add_blip_for_entity(Local_782.f_1);
		set_blip_colour(iLocal_339, 2);
	}
}
	...
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_5(Local_749))
			{
				...
				{
					set_entity_health(Local_749, 600);
				}
			}
			if (func_483(iLocal_777))
			{
			...
			if (func_483(Local_782.f_1) && func_483(Local_455))
			{
			...
			func_288(&iLocal_339);
			iLocal_339 = func_350(Local_749, 0, 5);
			iLocal_171 = 1;
			break;
		...
		case 1:
			func_247();
			func_319();
			func_349(iLocal_339, Local_749, 140f, 1061158912, 0);
			func_291();
			if (iLocal_369)
			{
...
bool func_324()
{
	if (func_5(Local_749))
	{
		if (func_483(Local_455))
		{
			func_326(&uLocal_36, Local_749, 0, 0, 1, 1, 1);
			if (is_ped_in_vehicle(Local_455, Local_749, 0))
			{
				func_325();
			}
			if ((func_248() || is_vehicle_tyre_burst(Local_749, false, 0)) || is_vehicle_tyre_burst(Local_749, true, 0))
			{
...
void func_325()
{
	if (func_483(Local_455))
	{
		if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_455, 20f, 20f, 20f, 0, 1, 0))
		{
...
void func_326(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_327(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_327(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	func_328(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}

void func_328(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	*uParam0.f_6 = 2;
	func_329(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}

void func_329(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_347(iParam1) && is_entity_visible(iParam1))
	{
		...
		if (!is_gameplay_hint_active())
		{
			if (func_342(uParam0, iParam7, iParam9, 0))
			{
...
bool func_334(char* sParam0)
{
	if (!func_335(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_321(sParam0)) || func_321("CMN_HINT"))
		{
			clear_help(1);
		}
		return false;
...
void func_338(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_341(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_342(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		case 0:
			*uParam0.f_7 = 0;
			if (*uParam0.f_6 == 0)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					if (func_346(iParam1, iParam2, iParam3))
					{
				...
				else if (func_345(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
			...
			{
				if (func_345(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
		...
		case 2:
			...
			{
				if (!func_345(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
			else if (*uParam0.f_6 == 2)
			{
				...
				else if (!func_346(iParam1, iParam2, iParam3))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				if (*uParam0.f_6 == 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
					{
						if (func_344(iParam1, iParam2, iParam3))
						{
							*uParam0.f_5 = 0;
						}
					}
					else if (func_343(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_343(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				else if (*uParam0.f_6 == 2)
				{
					...
					else if (func_344(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
void func_351()
{
	switch (iLocal_171)
	{
		case 0:
			...
			iLocal_385 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_386 = GAMEPLAY::GET_GAME_TIMER();
			set_blip_scale(iLocal_339, 1f);
			func_365(&(Local_694[3 /*6*/]));
			if (func_483(iLocal_777) && func_5(Local_749))
			{
				if (!is_entity_attached(iLocal_777))
				{
					func_495("Reattaching bag to buggy!?");
			...
			if ((func_483(Local_782.f_1) && func_483(Local_455)) && func_5(Local_749))
			{
				if (!is_entity_attached(Local_782.f_1))
				{
					func_495("Reattaching club to bag!?");
		...
		case 1:
			...
			func_317();
			_0x4669B3ED80F24B4E(player_id());
			func_349(iLocal_339, Local_455, 140f, 1061158912, 0);
			if (!func_483(Local_782.f_1))
			{
				clear_prints();
				if (func_14())
			...
			if (func_352() || !func_483(Local_455))
			{
				func_33("N1D_COLLECT", 7500, 5);
				func_35(6);
			}
...
bool func_352()
{
	if (func_5(Local_749))
	{
		if (func_483(Local_455))
		{
			...
			if (has_entity_been_damaged_by_entity(Local_749, PLAYER::PLAYER_PED_ID(), 1) && !has_entity_been_damaged_by_weapon(Local_749, false, 2))
			{
				func_353();
				func_479("VEHICLE HEALTH IS ", get_entity_health(Local_749));
				clear_entity_last_damage_entity(Local_749);
			}
			else if (has_entity_been_damaged_by_entity(Local_749, PLAYER::PLAYER_PED_ID(), 1))
			{
				func_479("VEHICLE HEALTH IS ", get_entity_health(Local_749));
				clear_entity_last_damage_entity(Local_749);
			}
			...
			if (func_5(Local_749))
			{
				if (is_ped_in_vehicle(Local_455, Local_749, 0))
				{
					if (iLocal_363 == 0)
					{
						if (!is_waypoint_playback_going_on_for_vehicle(Local_749))
						{
							task_vehicle_follow_waypoint_recording(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 8, -1, -1f, 0, 2f);
						}
					}
	...
	if (iLocal_347 == 0)
	{
		if (func_362(0))
		{
			...
			while (iVar0 <= 5)
			{
				...
				set_blocking_of_non_temporary_events(Local_561[iVar0 /*13*/], true);
				set_ped_can_be_targetted(Local_561[iVar0 /*13*/], true);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 5)
	...
	switch (iLocal_671[iParam0])
	{
		case 0:
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				else if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_265(Local_561[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						...
						else
						{
							...
							set_ped_can_be_targetted(Local_561[iParam0 /*13*/], true);
							task_combat_ped(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
							if (ENTITY::DOES_ENTITY_EXIST(Local_788[iParam0 /*6*/]))
							{
								if (is_entity_attached(Local_788[iParam0 /*6*/]))
								{
			...
			else if (get_entity_speed(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) >= 10f)
			{
				if ((is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 11f, 11f, 11f, 0, 1, 0) && has_ped_received_event(Local_561[iParam0 /*13*/], 60)) || has_entity_been_damaged_by_any_vehicle(Local_561[iParam0 /*13*/]))
				{
					if (!func_14() && !is_message_being_displayed())
					{
						func_296(Local_561[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
			...
			else if (has_entity_been_damaged_by_any_vehicle(Local_561[iParam0 /*13*/]) || has_entity_been_damaged_by_entity(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1))
			{
...
void func_357()
{
	...
	while (iVar0 <= 5)
	{
		if (func_483(Local_561[iVar0 /*13*/]))
		{
			...
			{
				if (is_entity_at_coord(Local_561[iVar0 /*13*/], vLocal_399, 20f, 20f, 20f, false, true, 0))
				{
					set_ped_can_be_targetted(Local_561[iVar0 /*13*/], true);
					task_combat_ped(Local_561[iVar0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					if (ENTITY::DOES_ENTITY_EXIST(Local_788[iVar0 /*6*/]))
					{
						if (is_entity_attached(Local_788[iVar0 /*6*/]))
						{
							detach_entity(Local_788[iVar0 /*6*/], 1, true);
						}
					}
					iLocal_671[iVar0] = 1;
				}
...
{
	return vdist2(get_entity_coords(iParam0, 0), get_entity_coords(iParam1, 1)) <= fParam2 * fParam2;
}
...
void func_361(auto uParam0, int iParam1)
{
	if (STREAMING::HAS_MODEL_LOADED(*uParam0.f_5))
	{
		*uParam0 = create_object(*uParam0.f_5, *uParam0.f_1, 1, true, false);
...
void func_363()
{
	if (iLocal_355 == 0)
	{
		if (func_483(Local_468))
		{
			if (func_265(Local_468, 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (func_483(Local_468))
				{
					set_entity_load_collision_flag(Local_468, true);
...
void func_366()
{
	switch (iLocal_171)
	{
		case 0:
			...
			_set_unk_map_flag(1);
			func_288(&iLocal_339);
			iLocal_339 = func_261(Local_455, 1, 0, 5);
			iLocal_171 = 1;
			break;
		...
		case 2:
			clear_prints();
			if (func_483(Local_455) && !iLocal_366)
			{
				func_35(4);
			}
			else
...
void func_367()
{
	switch (iLocal_690)
	{
		case 0:
			if (func_483(PLAYER::PLAYER_PED_ID()))
			{
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), -1377.18f, 55.39f, 53.7f, 2f, 2f, 2f, false, true, 1))
				{
					if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1379.154f, 57.95101f, 52.19011f, -1378.735f, 53.17284f, 54.94018f, 4f, 0, true, 0))
					{
						iLocal_690 = 1;
					}
				}
		...
		case 1:
			if (!does_cam_exist(iLocal_343))
			{
				iLocal_343 = func_369();
			}
			if (!does_cam_exist(iLocal_341))
			{
				iLocal_341 = create_camera_with_params(180543640, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, 0, 2);
				set_cam_spline_duration(iLocal_341, 4500);
				_0x0A9F2A468B328E74(iLocal_341, iLocal_343, 1500, 3);
				add_cam_spline_node(iLocal_341, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
				add_cam_spline_node(iLocal_341, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 1500, 3, 2);
			}
			set_player_control(player_id(), false, 0);
			display_radar(false);
			if (func_483(PLAYER::PLAYER_PED_ID()))
			{
				task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), -1368.33f, 56.4194f, 52.4637f, 1f, 20000, 0.25f, 0, 1193033728);
			}
			iLocal_690 = 2;
			break;
		
		case 2:
			if (!is_cam_active(iLocal_343))
			{
				if (!is_cam_active(iLocal_341))
				{
					set_cam_active(iLocal_343, true);
					render_script_cams(true, true, 3000, 1, 0, 0);
				}
			}
			else if (!is_cam_active(iLocal_341))
			{
				set_cam_active(iLocal_341, true);
				render_script_cams(true, true, 3000, 1, 0, 0);
				iLocal_690 = 3;
			}
			break;
		...
		case 3:
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), -1368.33f, 56.4194f, 52.4637f, 2f, 2f, 2f, false, true, 1))
			{
				wait(2000);
				func_67(PLAYER::PLAYER_PED_ID(), 12, 4, 0, -1, 0, 0, 0, -1, -1, -1, 0);
				func_368(2);
				iLocal_370 = 1;
				if (func_483(PLAYER::PLAYER_PED_ID()))
				{
					task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), -1373.09f, 55.61f, 52.71f, 1f, 20000, 0.25f, 0, 1193033728);
				}
				wait(500);
				iLocal_690 = 4;
			}
		...
		case 4:
			if (!does_cam_exist(iLocal_342))
			{
				iLocal_342 = create_camera_with_params(180543640, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, 0, 2);
				set_cam_spline_duration(iLocal_342, 4500);
				_0x0A9F2A468B328E74(iLocal_342, iLocal_341, 1500, 3);
				add_cam_spline_node(iLocal_342, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
				add_cam_spline_node(iLocal_342, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 1500, 3, 2);
			}
			if (!is_cam_active(iLocal_342))
			{
				render_script_cams(true, true, 3000, 1, 0, 0);
				set_cam_active(iLocal_342, true);
				wait(3500);
				iLocal_690 = 5;
			}
			if (is_cam_active(iLocal_343))
			{
				set_cam_active(iLocal_343, false);
			}
			if (is_cam_active(iLocal_341))
			{
				set_cam_active(iLocal_341, false);
			}
			break;
		...
		case 5:
			if (does_cam_exist(iLocal_342))
			{
				if (is_cam_active(iLocal_342))
				{
					...
					set_cam_active(iLocal_342, false);
					wait(2000);
					set_player_control(player_id(), true, 0);
					display_radar(true);
					destroy_cam(iLocal_343, 0);
					destroy_cam(iLocal_341, 0);
					destroy_cam(iLocal_342, 0);
				}
			}
			func_288(&iLocal_340);
			break;
	...
	if (iLocal_360 == 0)
	{
		if (func_9(0))
		{
			...
			while (iVar0 <= 3)
			{
				...
				set_blocking_of_non_temporary_events(Local_402[iVar0 /*13*/], true);
				iVar0++;
			}
...
void func_372(int iParam0)
{
	...
	{
		case 0:
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_402[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 1))
			{
				if (get_script_task_status(Local_402[iParam0 /*13*/], 150319005) != 1)
				{
					task_look_at_entity(Local_402[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 500, 12, 2);
				}
			}
...
void func_374()
{
	if (func_483(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_318(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				set_blip_flashes(iLocal_339, 1);
			}
		}
		else if (!does_blip_exist(iLocal_339))
		{
...
{
	if (func_254(&uLocal_883, get_entity_coords(iParam0, 0)))
	{
		return true;
	}
	return false;
...
void func_376()
{
	switch (iLocal_171)
	{
		...
		case 1:
			...
			func_247();
			func_367();
			if (func_483(Local_455) && func_483(PLAYER::PLAYER_PED_ID()))
			{
				if (func_285(PLAYER::PLAYER_PED_ID(), Local_455, 50f, 1) || iLocal_170 == 3)
				{
					iLocal_171 = 2;
				}
				else if (func_32())
				...
				{
					if (func_285(PLAYER::PLAYER_PED_ID(), Local_455, 150f, 1))
					{
						iLocal_171 = 2;
					}
				}
...
void func_377(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_435(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_231(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_378(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_379(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_379(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_421();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_400())
		{
			func_396(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_381(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_382(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_384(auto uParam0, int iParam1, int iParam2)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_391(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_392(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_393(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_394(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_395(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_395(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_396(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_398(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_399(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_402(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_406(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_403(Var9.f_1)) && iVar70 < 50)
			{
...
int func_405(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
void func_408(auto uParam0, int iParam1)
{
	int iVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_409(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_410(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_411(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_420())
		{
			*uParam0 = func_416(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_413(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_42() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_101(func_414(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_416(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_418(iVar0))
			{
				fVar1 = get_distance_between_coords(vParam0, func_417(iVar0, 0), 1);
...
auto func_421()
{
	...
	func_431(&uVar0, get_clock_seconds());
	func_430(&uVar0, get_clock_minutes());
	func_429(&uVar0, get_clock_hours());
	func_424(&uVar0, get_clock_day_of_month());
	func_423(&uVar0, get_clock_month());
	func_422(&uVar0, get_clock_year());
	return uVar0;
}

void func_422(auto uParam0, int iParam1)
{
	if (iParam1 <= 0)
	{
		return;
...
void func_424(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
auto func_426(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_427(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_429(auto uParam0, int iParam1)
{
...
void func_439(int iParam0)
{
	...
	{
		if (!does_blip_exist(iLocal_340))
		{
			iLocal_340 = func_440(-1377.18f, 55.39f, 53.7f, 0);
			set_blip_sprite(iLocal_340, 109);
		}
		iLocal_690 = 0;
	}
}

int func_440(Vector3 vParam0, int iParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(vParam0);
	set_blip_scale(iVar0, func_441(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	set_blip_route(iVar0, iParam3);
	return iVar0;
}

float func_441(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_442()
{
	while (iLocal_354 == 0)
	{
		if (func_443(0))
		{
			...
			set_ped_prop_index(Local_455, false, 0, 0, false);
			set_blocking_of_non_temporary_events(Local_455, true);
			set_ped_can_be_targetted(Local_455, false);
			set_entity_only_damaged_by_player(Local_455, true);
			set_entity_load_collision_flag(Local_455, true);
			func_453(Local_455, 0);
			...
			set_blocking_of_non_temporary_events(Local_468, true);
			set_ped_can_be_targetted(Local_468, false);
			if (func_483(Local_455))
			{
				Local_782.f_3 = {get_safe_pickup_coords(get_entity_coords(Local_455, 1), 1.2f, 1.5f)};
			}
			iLocal_777 = create_object(joaat("prop_golf_bag_01"), Local_782.f_3, 1, true, false);
			func_298(&Local_749, 0);
			if (is_audio_scene_active("NIGEL_1D_SCENE"))
			{
				if (func_5(Local_749))
				{
					_0x153973AB99FE8980(Local_749, "NIGEL_1D_GOLF_CART_A", 0f);
				}
			}
			set_vehicle_engine_on(Local_749, true, 1, 0);
			set_entity_health(Local_749, 1200);
			attach_entity_to_entity(iLocal_777, Local_749, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			set_vehicle_model_is_suppressed(Local_749.f_5, true);
			Local_782.f_1 = create_object(joaat("prop_golf_wood_01"), Local_782.f_3, 1, true, false);
			attach_entity_to_entity(Local_782.f_1, Local_455, get_ped_bone_index(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
...
void func_447()
{
	...
	remove_relationship_group(iLocal_774);
	func_448(2, uLocal_365);
}

void func_448(int iParam0, auto uParam1)
{
	if (!func_184(iParam0))
	{
		return;
...
struct<2> func_456(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_463(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_462(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_461(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_460(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_459(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_458(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_457(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_463(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_465(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_467(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_337(0)) || func_466(1))
			{
			}
			else
			{
...
void func_471()
{
	...
	if (func_483(PLAYER::PLAYER_PED_ID()))
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -1330.118f, -72.3159f, 48.1812f, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 326f);
	}
	func_35(1);
}
...
void func_473(int iParam0, int iParam1)
{
	...
	func_474(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}

void func_474(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_475(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_478(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_503())
	{
...
int func_481(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_484()
{
	...
	add_relationship_group("SecurityGroup", &iLocal_774);
	...
	request_additional_text("NIGEL1D", false);
	STREAMING::REQUEST_MODEL(joaat("caddy"));
	while (((((((!has_additional_text_loaded(false) || !has_anim_dict_loaded("rcmnigel1d")) || !has_anim_dict_loaded("mini@golf")) || !get_is_waypoint_recording_loaded("NIGEL1DTRANS")) || !get_is_waypoint_recording_loaded("NIGEL1DGOLF")) || !get_is_waypoint_recording_loaded("NIGEL1DGOLF2")) || !get_is_waypoint_recording_loaded("NIGEL1DCRASH")) || !STREAMING::HAS_MODEL_LOADED(joaat("caddy")))
	{
		wait(0);
	}
	set_random_vehicle_density_multiplier_this_frame(0.75f);
	set_player_control(player_id(), true, 256);
	iLocal_778 = add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
	set_ped_non_creation_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
	iLocal_779 = add_scenario_blocking_area(-1379.33f, 45.13f, 50.68f, -1368.01f, 69.83f, 55.9f, 0, 1, 1, 1);
	if (iLocal_780 == -1)
	{
...
void func_485(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_487(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
void func_496(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_497(auto uParam0, auto uParam1)
{
	int[] iVar0 = new int[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_502(&iVar0) || !has_anim_dict_loaded(*uParam0.f_48)) || !has_anim_dict_loaded(sVar8))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			*uParam0.f_41[0] = create_object(iVar0[1], -1096.855f, 67.6858f, 52.952f, 1, true, false);
			...
			task_play_anim(false, *uParam0.f_48, "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, *uParam0.f_48, "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			set_sequence_to_repeat(iVar10, 1);
			...
			*uParam0.f_28[4] = PED::CREATE_PED(26, iVar0[0], -1093.736f, 73.8568f, 53.0388f, 319f, 1, true);
			...
			while (iVar9 <= 4)
			{
				set_blocking_of_non_temporary_events(*uParam0.f_28[iVar9], true);
				give_weapon_to_ped(*uParam0.f_28[iVar9], joaat("weapon_pistol"), -1, false, true);
				set_entity_only_damaged_by_player(*uParam0.f_28[iVar9], true);
				set_ped_can_be_targetted(*uParam0.f_28[iVar9], true);
				set_ped_dies_when_injured(*uParam0.f_28[iVar9], true);
				set_ped_path_prefer_to_avoid_water(*uParam0.f_28[iVar9], 1);
				set_ped_model_is_suppressed(iVar0[0], true);
				iVar9++;
			}
			*uParam0.f_35[0] = create_vehicle(iVar0[5], -1099.91f, 61.2608f, 52.8124f, 243f, 1, true);
			set_vehicle_on_ground_properly(*uParam0.f_35[0]);
			set_vehicle_engine_on(*uParam0.f_35[0], true, 1, 0);
			set_entity_health(*uParam0.f_35[0], 1200);
			set_vehicle_model_is_suppressed(iVar0[5], true);
			*uParam0.f_41[2] = create_object(iVar0[6], -1099.91f, 63.2608f, 52.8124f, 1, true, false);
			attach_entity_to_entity(*uParam0.f_41[2], *uParam0.f_35[0], 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			*uParam0.f_35[1] = create_vehicle(iVar0[5], -1102.335f, 75.7757f, 53.2591f, 293f, 1, true);
			*uParam0.f_35[2] = create_vehicle(iVar0[5], -1103.023f, 65.6267f, 53.056f, 203f, 1, true);
			iVar9 = 1;
			while (iVar9 <= 2)
			{
				set_vehicle_on_ground_properly(*uParam0.f_35[iVar9]);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 <= iVar0 - 1)
...
void func_498(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (iParam1)
			{
				iLocal_107 = add_scenario_blocking_area(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				set_scenario_type_enabled("WORLD_HUMAN_GUARD_STAND", false);
				set_scenario_type_enabled("WORLD_HUMAN_CLIPBOARD", false);
				set_scenario_type_enabled("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (iParam1)
			{
				iLocal_107 = add_scenario_blocking_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
				set_ped_non_creation_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
				...
				clear_area_of_vehicles(-1035.73f, 365.44f, 68.91f, 27f, 0, 0, 0, 0, false);
		...
		case 41:
			if (iParam1)
			{
				iLocal_107 = add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (iParam1)
			{
				iLocal_107 = add_scenario_blocking_area(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_499(int iParam0)
{
	...
	vVar6 = {vVar0};
	vVar9 = {vVar3};
	set_roads_in_angled_area(vVar6, vVar9, 25f, 0, iParam0, 1);
	set_all_vehicle_generators_active_in_area(vVar0, vVar3, iParam0, 1);
	if (!iParam0)
	{
...
void func_504(int iParam0)
{
	...
	Global_33874 = 1;
	wait(0);
	remove_scenario_blocking_area(iLocal_778, 0);
	remove_scenario_blocking_area(iLocal_779, 0);
	if (iLocal_780 > -1)
	{
...
void func_505(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_510(uParam0, iParam1);
	func_508(uParam0, iParam2);
	func_506(uParam0, iParam3);
}
...
void func_510(auto uParam0, int iParam1)
{
	func_511(uParam0.f_28, iParam1);
}

void func_511(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_517(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_520())
	{
		...
		{
			iVar33 = func_432(get_this_script_name());
			if (iVar33 > -1)
			{
