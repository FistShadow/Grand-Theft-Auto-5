...
void main()
{
	...
	clear_bit(&(Global_101154.f_17264.f_382), 4);
	func_484();
	iVar0 = 0;
...
void func_247()
{
	...
	else
	{
		...
		if (!is_bit_set(Global_101154.f_17264.f_382, 4))
		{
...
int func_413(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_42() == 0)
		{
			return is_bit_set(func_101(func_414(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	return shift_right(iParam0, 26) & 31 * func_427(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
