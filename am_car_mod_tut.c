#region Local Var
	...
	auto uLocal_134 = 0;
	int iLocal_135 = 0;
	Vector3[] vLocal_136 = new Vector3[32];
	int iLocal_233 = 0;
	int iLocal_234 = 0;
	auto uLocal_235 = 0;
	auto uLocal_236 = 0;
...
void main()
{
	...
	while (true)
	{
		...
		switch (func_140(participant_id_to_int()))
		{
			case 0:
				if (func_139() == 2)
				{
					vLocal_136[participant_id_to_int() /*3*/] = 2;
				}
				else if (func_139() == 6)
				{
					vLocal_136[participant_id_to_int() /*3*/] = 5;
				}
				break;
			...
			case 2:
				if (func_139() == 2)
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(vLocal_136[participant_id_to_int() /*3*/].f_2, true))
					{
						func_8();
					}
				}
			...
			case 5:
				func_6(&(vLocal_57.f_2));
				if (func_5(&(vLocal_57.f_2)))
				{
					vLocal_136[participant_id_to_int() /*3*/] = 6;
				}
				break;
...
bool func_1()
{
	if (GAMEPLAY::IS_BIT_SET(vLocal_57.y, false))
	{
		return true;
	}
	return false;
...
void func_3()
{
	...
	if (network_is_host_of_this_script())
	{
		...
		if (network_is_participant_active(iVar0))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_136[iLocal_135 /*3*/].f_2, false))
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_234, true);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_1587523[iLocal_135 /*444*/].f_135, 4))
				{
				}
			}
		}
		...
		if (iLocal_135 == 32)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_57.f_1), false);
			}
...
void func_8()
{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_136[participant_id_to_int() /*3*/].f_2), false);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_136[participant_id_to_int() /*3*/].f_2), true);
	func_70(10, 0);
	func_69(0);
	func_30(1);
	func_23();
...
void func_30(int iParam0)
{
	...
	iVar1 = func_65(player_id(), iParam0);
	iVar2 = func_63(iVar1, iParam0);
	if (!func_62(-1))
	{
		iVar0 = 0;
		while (iVar0 <= 5)
...
void func_38(int iParam0, int iParam1)
{
	...
	func_9(5, iParam0, 1);
	func_9(6, iParam0, 1);
	func_9(7, iParam0, iVar0);
	func_9(8, iParam0, 1);
	func_9(9, iParam0, 1);
	func_9(10, iParam0, 1);
	func_9(11, iParam0, 1);
	func_9(12, iParam0, iVar0);
	func_9(13, iParam0, 1);
	func_9(21, iParam0, 1);
	func_9(14, iParam0, 1);
	func_9(15, iParam0, 1);
...
bool func_46()
{
	...
	iVar0 = Global_1347750[func_13(-1)];
...
void func_69(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1587523[player_id() /*444*/].f_135), 18);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1587523[player_id() /*444*/].f_135), 18);
	}
}
...
void func_74()
{
	...
	switch (vLocal_136[participant_id_to_int() /*3*/].f_1)
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(vLocal_136[participant_id_to_int() /*3*/].f_2, false))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 5))
					{
						if (get_player_wanted_level(player_id()) == 0)
						{
							...
							{
								GAMEPLAY::CLEAR_BIT(&iLocal_234, 10);
							}
							if (!is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 2))
								{
									if (iLocal_233 != -1)
									{
										func_72(iLocal_233, 0);
									...
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_234, 2);
								}
							}
							else
							{
								if (GAMEPLAY::IS_BIT_SET(iLocal_234, 2))
								{
									GAMEPLAY::CLEAR_BIT(&iLocal_234, 2);
								}
								iVar0 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
								if ((!func_130(iVar0, 0, &uVar1) || !func_129(iVar0)) || func_128(ENTITY::GET_ENTITY_MODEL(iVar0)))
								{
									if (func_127())
									{
										func_126(0);
									...
									if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 8))
									{
										if (func_121())
										{
											if (is_vehicle_driveable(iVar0, 0))
											{
												if (iLocal_242 > 0)
												{
													if (func_128(ENTITY::GET_ENTITY_MODEL(iVar0)))
													{
									...
									else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 11))
									{
								...
								else
								{
									...
									if (!func_116() || (func_116() && is_player_control_on(player_id())))
									{
										if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 3))
										{
									...
									else if (func_116() && !is_player_control_on(player_id()))
									{
										if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 3))
										{
											GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_234, 3);
						...
						else
						{
							...
							if (func_127())
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									...
									{
										iVar0 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
										if ((!func_130(iVar0, 0, &uVar2) || !func_129(iVar0)) || func_128(ENTITY::GET_ENTITY_MODEL(iVar0)))
										{
											func_126(0);
										}
									}
					...
					if (GAMEPLAY::IS_BIT_SET(iLocal_234, 3) || (func_116() && GAMEPLAY::IS_BIT_SET(iLocal_234, 10)))
					{
						if (func_116())
						{
							...
							if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 9))
							{
								if (func_106())
								{
									...
									GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1636), 25);
							...
							if (func_105())
							{
								if (!GAMEPLAY::IS_BIT_SET(Global_2460486.f_1636, 25))
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1636), 25);
								}
							...
							else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 9))
							{
								if (func_101(player_id()) || (!func_99() && func_98()))
								{
									iVar3 = func_96(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0));
									if (iVar3 > 0)
									{
						...
						else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 9))
						{
							if (!func_105())
							{
								if (is_screen_faded_in())
								{
									...
									func_23();
									iLocal_233 = -1;
									func_85(player_id(), 1, 0);
								}
							}
							else if (!GAMEPLAY::IS_BIT_SET(vLocal_136[participant_id_to_int() /*3*/].f_2, false))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_136[participant_id_to_int() /*3*/].f_2), false);
							}
						}
					...
					if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 5))
					{
						if (((func_82(player_id(), 1) || func_81()) || func_80() > 0) || (!func_78() && !func_116()))
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_234, 5);
							func_23();
						}
					}
					else if (is_player_control_on(player_id()) || func_116())
					{
						if (is_screen_faded_in())
						{
							if ((((!func_82(player_id(), 1) && !func_81()) && func_80() == 0) && func_78()) || func_116())
	...
	if (!GAMEPLAY::IS_BIT_SET(vLocal_136[participant_id_to_int() /*3*/].f_2, true))
	{
		if (func_76())
		{
			func_8();
...
void func_85(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_88(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
...
bool func_89()
{
	...
	if (func_90() >= 0)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1321273[func_90() /*138*/].f_99, 2))
		{
			return true;
		}
	}
...
int func_101(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 19);
}
...
void func_102(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1587523[player_id() /*444*/].f_135), 20);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1587523[player_id() /*444*/].f_135), 20);
	}
}
...
int func_103(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 20);
}
...
int func_104(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 21);
}
...
int func_115(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 18);
}
...
bool func_121()
{
	if (((((((((((((!func_4(player_id(), 1, 1) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || !is_player_control_on(player_id())) || func_125(8, -1)) || func_125(15, -1)) || func_124()) || func_125(3, -1)) || is_help_message_being_displayed()) || func_82(player_id(), 1)) || func_81()) || func_98()) || func_123()) || func_122()) || is_pause_menu_active())
	{
		return false;
	}
	return true;
...
void func_126(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1639), 4);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_1639), 4);
	}
}

int func_127()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_1639, 4);
}
...
bool func_130(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	if (!func_132(iVar0, iParam1, uParam2))
	{
		return false;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_131(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
void func_141()
{
	...
	if (!func_138(0))
	{
		if (func_103(player_id()) || iLocal_241)
		{
			func_31(122, 1, -1, 1);
		}
	}
...
bool func_151()
{
	...
	if (func_152() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_152()) == 0)
		{
			return true;
		}
	}
...
{
	func_167(func_168(Param0), Param0);
	func_165(0, -1, 0);
	network_register_host_broadcast_variables(&vLocal_57, 78);
	network_register_player_broadcast_variables(&vLocal_136, 97);
...
void func_167(int iParam0, struct<17> Param1, auto uParam2, auto uParam3, auto uParam4)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_142();
