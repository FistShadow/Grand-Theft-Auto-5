...
void func_17()
{
	switch (Local_215.f_1)
	{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_878 && !func_18()) || !func_443(Local_647.f_2))
			{
				func_19();
			}
			break;
...
int func_219(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_232()
{
	...
	if (Local_215.f_3 == 1)
	{
		...
		{
			func_326(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
		}
		Local_215.f_3 = 0;
	}
	if (Local_215.f_1 == 0)
	...
	if (Local_215.f_1 == 1)
	{
		if (!func_314(iLocal_1080))
		{
			...
			if (!func_314(iLocal_1080) && STREAMING::HAS_MODEL_LOADED(iLocal_1070))
			{
		...
		if (func_443(Local_647.f_2))
		{
			if (can_set_exit_state_for_registered_entity("Orleans", false))
			{
				...
				AI::TASK_PLAY_ANIM(false, sLocal_1073, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				AI::TASK_PLAY_ANIM(false, sLocal_1073, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				...
				if (func_443(PLAYER::PLAYER_PED_ID()) && can_set_exit_state_for_registered_entity("FRANKLIN", false))
				{
					task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_647.f_2, -1, 2050, 4);
					task_look_at_entity(Local_647.f_2, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
				}
			}
			if (iLocal_1147)
			{
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_240(player_id())) && !func_238(player_id(), 0)) && !func_237())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_240(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_242(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_245()
{
	...
	if (!func_335())
	{
		func_309(PLAYER::PLAYER_PED_ID(), -1518.762f, 4540.353f, 44.5008f, 95.2894f, 0, 1);
	}
...
void func_247(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_248(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_248(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_250(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_253(auto uParam0, int iParam1, int iParam2)
{
...
void func_259(int iParam0, auto uParam1)
{
	int iVar0;
...
bool func_261(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
void func_265(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_267(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_268(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
int func_274(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
int func_279(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_281(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_290())
		{
			*uParam0 = func_286(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_283(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_86(func_284(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_286(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_289(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_287(iVar0, 0), 1);
...
auto func_296(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_297(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
bool func_319(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_336(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_341(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_346()
{
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		Local_647.f_2 = PED::CREATE_PED(25, iLocal_1063, Local_293.f_1[1 /*14*/].f_1, 0, 1, true);
	}
	else
	{
		Local_647.f_2 = PED::CREATE_PED(25, iLocal_1063, Local_293.f_1[0 /*14*/].f_1, 0, 1, true);
	}
	if (func_443(Local_647.f_2))
	{
		iLocal_877 = func_347(PLAYER::PLAYER_PED_ID(), Local_647.f_2, 0f);
...
bool func_349()
{
	if ((STREAMING::HAS_MODEL_LOADED(iLocal_1063) && has_anim_dict_loaded(sLocal_1072)) && has_anim_dict_loaded(sLocal_1073))
	{
		return true;
	}
	return false;
...
void func_353()
{
	if (Local_215.f_3 == 1)
	{
		...
		func_8(1);
		func_2(1);
		if (func_443(PLAYER::PLAYER_PED_ID()) && !func_335())
		{
			set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_1123, 1, false, 0, 1);
			set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_1126);
		}
		while (!func_344())
		{
			wait(false);
	...
	if (Local_215.f_1 == 1)
	{
		...
		{
			if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 4f) || iLocal_860)
			{
		...
		else if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 4f))
		{
		...
		else
		{
			...
			{
				Local_293 = 0;
				if (Local_293.f_352 == 0 && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					Local_293.f_352 = 2;
				}
				else
			...
			if (func_361(PLAYER::PLAYER_PED_ID(), Local_293.f_1[10 /*14*/].f_5, 100f))
			{
				request_cutscene("sas_2_rcm_t7", 8);
			}
			if (iLocal_859 == 0)
			...
			else if (iLocal_867 == 0)
			{
				if (Local_293.f_352 < 5)
				{
					...
					{
						func_231(&uLocal_888, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			...
			if (iLocal_857 == 0)
			{
				if (!func_355(&uLocal_752, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
...
void func_354()
{
	clear_prints();
	func_11(&(Local_647.f_3));
	if (func_355(&uLocal_804, ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 0)))
	{
		iLocal_869 = false;
	}
	else
...
int func_355(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_362()
{
	if (has_bullet_impacted_in_area(ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 1.5f, 1, 1))
	{
		if (Local_293.f_352 < Local_293.f_353 - 1)
		{
			func_363();
	...
	else if (has_bullet_impacted_in_area(ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 5f, 1, 1))
	{
		if (Local_293.f_352 < Local_293.f_353 - 1)
		{
			if (!func_18())
...
void func_367(int iParam0)
{
	...
	switch (*iParam0.f_1)
	{
		case 1:
			...
			else if (func_368(*iParam0, PLAYER::PLAYER_PED_ID(), *iParam0.f_15, 1))
			{
...
bool func_369(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
	...
	switch (Local_647)
	{
		case 1:
			if (func_443(Local_647.f_2))
			{
				...
				else if (Local_647.f_1 == 1)
				{
					...
					else if (func_361(PLAYER::PLAYER_PED_ID(), *uParam0.f_1, fVar0))
					{
						Local_647 = 2;
						Local_647.f_1 = 0;
					}
		...
		case 2:
			if (func_443(Local_647.f_2))
			{
				...
				else if (fVar0 == -1f || func_368(Local_647.f_2, PLAYER::PLAYER_PED_ID(), fVar0, 1))
				{
				...
				else if (GAMEPLAY::GET_GAME_TIMER() > Local_647.f_4)
				{
					if ((has_sound_finished(Local_647.f_6) && has_sound_finished(Local_647.f_6)) && has_sound_finished(Local_647.f_7))
					{
						...
						_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 30f, 6);
					}
			...
			if (func_443(Local_647.f_2))
			{
				...
				else if (Local_647.f_1 == 1)
				{
					...
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_314(iVar3) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar3, Local_647.f_2))
						{
							Local_647 = 6;
							Local_647.f_1 = 0;
						}
		...
		case 5:
			if (func_443(Local_647.f_2))
			{
				...
				else if (Local_647.f_1 == 1)
				{
					if (Local_647.f_9 == 0)
					{
						if (func_368(PLAYER::PLAYER_PED_ID(), Local_647.f_2, 20f, 1))
						{
							ENTITY::SET_ENTITY_HEALTH(Local_647.f_2, 110);
					...
					else if (Local_647.f_9 == 1)
					{
						if (GAMEPLAY::GET_GAME_TIMER() > iLocal_1060)
						{
							...
							{
								iLocal_1060 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(3000, 5000);
		...
		case 6:
			if (func_443(Local_647.f_2))
			{
				if (Local_647.f_1 == 0)
				{
					...
					iLocal_860 = 1;
					task_combat_ped(Local_647.f_2, PLAYER::PLAYER_PED_ID(), 0, 16);
					func_356();
					Local_647.f_1 = 1;
				}
				else if (Local_647.f_1 == 1)
...
int func_372(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_373()
{
	...
	{
		if ((!func_18() && !is_message_being_displayed()) && !is_ped_stopped(PLAYER::PLAYER_PED_ID()))
		{
...
int func_375(auto uParam0)
{
	...
	vVar0 = {func_320(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - *uParam0.f_1)};
...
void func_376(int iParam0, struct<2> Param1, auto uParam2)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
bool func_377(int iParam0)
{
	if (Local_647 == 0)
	{
		if (iParam0 <= 1 && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			Local_647 = 3;
		}
		else
...
void func_387()
{
	...
	if (Local_215.f_1 == 1)
	{
		...
		else if ((func_408(Local_286, 0, 70f, 170f, 1, 0, 0, 0) || !func_361(Local_286, vLocal_1108, 1.5f)) || PED::IS_PED_RAGDOLL(Local_286))
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_286, -2065892691);
			task_combat_ped(Local_286, PLAYER::PLAYER_PED_ID(), 0, 16);
			func_379();
			func_244(6);
			Local_215.f_9 = 3;
			Local_215.f_1 = 3;
		...
		{
			iVar0 = func_355(&uLocal_752, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
			if (iLocal_871 && func_361(PLAYER::PLAYER_PED_ID(), vLocal_1085, 250f))
			{
				func_350();
				func_386();
				iLocal_871 = 0;
			...
			else if (iLocal_864 == 0)
			{
				...
				{
					func_231(&uLocal_888, 4, Local_286, "HUNTER", 0, 1);
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_286, 25f, 25f, 25f, 0, 1, 0))
					{
						if ((((has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_advancedrifle"), 0) || has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_assaultrifle"), 0)) || has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_carbinerifle"), 0)) || has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_specialcarbine"), 0)) || has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), 0))
						{
			...
			else if (iLocal_856 == 0)
			{
				...
				if (func_18())
				{
					if (func_389(PLAYER::PLAYER_PED_ID(), Local_286) > 25f)
					{
						func_379();
					}
				}
			...
			else
			{
				if (iLocal_858 == 0)
				{
					if (func_361(PLAYER::PLAYER_PED_ID(), vLocal_1085, 5f))
					{
						func_231(&uLocal_888, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				...
				if (iLocal_865 == 0)
				{
					if (func_361(PLAYER::PLAYER_PED_ID(), Local_293.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_346())
						{
							func_11(&iLocal_750);
							...
							_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 1), 30f, 6);
							task_look_at_coord(PLAYER::PLAYER_PED_ID(), Local_293.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_865 = 1;
							iLocal_879 = -1;
							func_388();
						}
...
auto func_389(int iParam0, int iParam1)
{
	return func_390(iParam0, iParam1, 1);
}

auto func_390(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_391()
{
	if (iLocal_862)
	{
		if (!func_314(Local_225.f_35[0]) && func_389(PLAYER::PLAYER_PED_ID(), Local_286) < 25f)
		{
			func_379();
...
int func_392(auto uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10)
{
	auto uVar0;
	auto uVar11;
...
bool func_393(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_394(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
...
void func_395()
{
	if (func_443(Local_286) && func_443(PLAYER::PLAYER_PED_ID()))
	{
		if (func_368(PLAYER::PLAYER_PED_ID(), Local_286, 50f, 1))
		{
...
{
	return func_399(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_400(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_403(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_320(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_409(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
...
bool func_413(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_320(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
		...
		if (is_entity_playing_anim(Local_286, sLocal_1072, "hunter_leadout", 3))
		{
			if (get_entity_anim_current_time(Local_286, sLocal_1072, "hunter_leadout") > 0.9f)
			{
				if (has_anim_dict_loaded(sLocal_1072))
				{
					...
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle", 8f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle_action", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle_look", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle_action", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_1072, "hunter_idle_look", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
...
int func_417(auto uParam0)
{
	...
	else
	{
		...
		fVar25 = 0f;
		fVar23 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*uParam0.f_7, vVar4, 0);
	...
	*uParam0.f_10 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(64, 256);
	*uParam0.f_5 = 0;
	return 3;
}
...
void func_421(int iParam0)
{
	if (Local_286.f_4 == 0)
	{
		if (iParam0)
		{
			if (func_443(PLAYER::PLAYER_PED_ID()) && !func_335())
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_1100, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_1103);
			...
			if (func_423(Local_286, 1862763509, iLocal_1061))
			{
				if (func_443(PLAYER::PLAYER_PED_ID()))
				{
					task_look_at_entity(Local_286, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
				}
			}
		}
		func_422();
...
bool func_424()
{
	if (((((((STREAMING::HAS_MODEL_LOADED(iLocal_1064) && STREAMING::HAS_MODEL_LOADED(iLocal_1065)) && STREAMING::HAS_MODEL_LOADED(iLocal_1066)) && STREAMING::HAS_MODEL_LOADED(iLocal_1067)) && STREAMING::HAS_MODEL_LOADED(iLocal_1068)) && has_vehicle_asset_loaded(iLocal_1065)) && has_anim_dict_loaded(sLocal_1072)) && has_anim_dict_loaded(sLocal_1073))
	{
		return true;
	}
	return false;
...
void func_426(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_427(auto uParam0, int iParam1)
{
	func_428(uParam0.f_41, iParam1);
}

void func_428(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_434()
{
	...
	{
		func_325(0);
		fVar0 = func_439(PLAYER::PLAYER_PED_ID(), -1295.844f, 4641.988f, 105.3325f, 1);
		fVar1 = func_439(PLAYER::PLAYER_PED_ID(), -1301.435f, 4641.214f, 105.6249f, 1);
		fVar2 = fVar0 - fVar1;
		if (fVar2 < 0f)
		{
			fVar2 *= -1f;
...
int func_437(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_439(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_440()
{
	...
	if ((((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_01", false) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_02", false)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SAS_BANK_03", false)) && func_344()) && func_343())
	{
		if (AUDIO::IS_AMBIENT_ZONE_ENABLED("AZ_DISTANT_SASQUATCH"))
		{
		...
		if (func_479())
		{
			...
			if (has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_pumpshotgun"), 0))
			{
				iVar1 = _get_ped_ammo_type(PLAYER::PLAYER_PED_ID(), joaat("weapon_pumpshotgun"));
				if (get_ped_ammo_by_type(PLAYER::PLAYER_PED_ID(), iVar1) < 8)
				{
					give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_pumpshotgun"), 8, true, true);
				}
			}
			else
			{
...
struct<2> func_454(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_456(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
...
void func_464(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
void func_469(int iParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	auto uVar0;
...
void func_474(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_480()
{
	...
	PLAYER::SET_PLAYER_MELEE_WEAPON_DAMAGE_MODIFIER(player_id(), 1f);
