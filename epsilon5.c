...
void func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_219(player_id())) && !func_217(player_id(), 0)) && !func_216())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_219(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
bool func_243(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_250(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_249(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_252()
{
	...
	switch (iLocal_84)
	{
		...
		case 1:
			if (func_264(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) >= 4.5f)
			{
			...
			if (iLocal_314 == 0)
			{
				if (func_264(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) <= 2.5f)
				{
					set_player_control(player_id(), false, 256);
					task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 0);
					iLocal_314 = 1;
				}
			}
				...
				if (func_242(Local_86.f_28[0]))
				{
					if (is_entity_playing_anim(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (get_entity_anim_current_time(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							...
							func_262(&uLocal_147, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
							task_look_at_entity(Local_86.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 12, 2);
...
void func_266()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_250(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_289(auto uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_290(uParam0.f_28[0], 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_214(PLAYER::PLAYER_PED_ID()))
				{
