...
{
	GAMEPLAY::CLEAR_BIT(&(vLocal_97[player_id() /*3*/].f_1), iParam0);
}
...
int func_6(int iParam0)
{
	...
	iVar0 = GAMEPLAY::IS_BIT_SET(vLocal_97[iParam0 /*3*/].f_2, player_id());
	return iVar0;
}
...
int func_7(int iParam0)
{
	...
	iVar0 = GAMEPLAY::IS_BIT_SET(vLocal_97[player_id() /*3*/].f_1, iParam0);
	return iVar0;
}
...
{
	GAMEPLAY::SET_BIT(&(vLocal_97[player_id() /*3*/].f_2), iParam0);
}
...
bool func_13()
{
	...
	if (AI::GET_SCRIPT_TASK_STATUS(iVar0, -1794415470) == 1 || AI::GET_SCRIPT_TASK_STATUS(iVar0, -1794415470) == 0)
	{
		return false;
	}
	return true;
...
{
	GAMEPLAY::CLEAR_BIT(&(vLocal_97[player_id() /*3*/].f_2), iParam0);
}
...
int func_19(int iParam0)
{
	...
	iVar0 = GAMEPLAY::IS_BIT_SET(vLocal_97[player_id() /*3*/].f_2, iParam0);
	return iVar0;
}
...
int func_20(auto uParam0)
{
	...
	iVar0 = GAMEPLAY::IS_BIT_SET(vLocal_97[uParam0 /*3*/].f_1, player_id());
	return iVar0;
}
...
void func_26(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(vLocal_97[player_id() /*3*/]), true);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(vLocal_97[player_id() /*3*/]), true);
	}
}
...
void func_30(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	...
	if ((iVar0 > -1 && iVar0 < 32) && GAMEPLAY::IS_BIT_SET(Global_1728639.f_24, iVar0))
	{
...
int func_42(int iParam0)
{
	...
	{
		iVar1 = iVar0 - 1;
		return GAMEPLAY::IS_BIT_SET(Global_1728639.f_25, iVar1);
	}
	return false;
}
...
bool func_59(int iParam0)
{
	...
	{
		if (func_70(player_id()) == 168 && !GAMEPLAY::IS_BIT_SET(Global_1727391.f_3, 4))
		{
			return false;
		}
...
void func_104()
{
	...
	else
	{
		...
		if (is_screen_faded_out() && !GAMEPLAY::IS_BIT_SET(Local_194.f_4.f_6, false))
		{
			...
			GAMEPLAY::SET_BIT(&(Local_194.f_4.f_6), false);
		}
	}
	...
	if (!_0x422F32CC7E56ABAD(PLAYER::PLAYER_PED_ID()) && iVar0)
	{
		func_145(1);
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_75(player_id())) && !func_77(player_id(), 0)) && !func_130())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_75(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
void func_146(int iParam0, auto uParam1)
{
	...
	else
	{
		...
		GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_305), false);
	}
}
...
{
	return GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 2);
}
			...
			if (player_id() != iVar2 && iVar2 != func_23())
			{
				if (func_22(iVar2, 1, 1))
				{
					if (func_14(iVar2, Local_194))
					{
						...
						{
							if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(iVar2), Local_194.f_1, 1) < IntToFloat(func_154(Local_194)))
							{
								iVar1 = true;
							}
						}
...
{
	GAMEPLAY::SET_BIT(&(vLocal_97[player_id() /*3*/].f_1), iParam0);
}
...
{
	return GAMEPLAY::IS_BIT_SET(vLocal_97[iParam0 /*3*/], true);
}

int func_157(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(vLocal_97[iParam0 /*3*/], false);
}
...
{
	if (GAMEPLAY::IS_BIT_SET(*uParam1.f_2, true))
	{
		...
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (player_id() != iVar1 && iVar1 != func_23())
			{
				if (func_22(iVar1, 1, 1))
				{
					...
					{
						if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(iVar1), Local_194.f_1, 1) < IntToFloat(func_154(Local_194)))
						{
...
{
	if (Global_2413760.f_2031.f_1[player_id()] > -1 && !GAMEPLAY::IS_BIT_SET(Global_2418472[player_id() /*313*/].f_305, false))
	{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_2418472[player_id() /*313*/].f_305, false) || func_149(&(Global_1728515.f_115), 3000, 0))
	{
		GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_305), false);
...
void func_237(int iParam0, auto uParam1)
{
	...
	if (func_38(player_id(), 1))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_1728515.f_2), false);
		}
		else
		{
			GAMEPLAY::SET_BIT(&(Global_1728515.f_2), true);
		}
		iVar0 = func_37(player_id());
		if (iVar0 != func_23() && iVar0 != player_id())
		{
			GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_305.f_3), iVar0);
		}
		iVar2 = 0;
		while (iVar2 < func_239())
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_305.f_3), iVar1);
			}
			iVar2++;
		}
	}
	...
	{
		GAMEPLAY::SET_BIT(&(Global_1728515.f_2), 2);
	}
}
...
void func_247(int iParam0, int iParam1, int iParam2)
{
	if (iParam0)
	{
		if (Global_1728515.f_9 == -1)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_305), 3);
		}
	}
	else if (Global_1728515.f_9 == iParam1)
	{
		...
		GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_305), 3);
	}
}
	...
	if (func_16(Local_194) == 0)
	{
		if (func_17(1))
		{
			if (func_71(player_id(), 0) && func_70(player_id()) == 167)
			{
				...
				GAMEPLAY::SET_BIT(&Global_1728515, false);
				if (func_246(Local_194))
				{
					Global_1728639.f_31 = 1;
					AUDIO::REQUEST_SCRIPT_AUDIO_BANK("DLC_EXEC1/BUY_SELL", false);
				}
			...
			if (func_39(player_id()) && !GAMEPLAY::IS_BIT_SET(Global_1728639, true))
			{
				if (!func_256())
				{
					GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_310), false);
				}
				else
				{
...
void func_261(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(vLocal_97[player_id() /*3*/]), false);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(vLocal_97[player_id() /*3*/]), false);
	}
}
...
bool func_262()
{
	...
	vVar0 = {1f, 1f, 2f};
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_194.f_1, vVar0, false, true, 1))
	{
		return true;
	}
	return false;
...
void func_263(int iParam0, int iParam1)
{
	if (iParam0)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2418472[player_id() /*313*/].f_305, true))
		{
			GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_305), true);
	...
	else
	{
		...
		GAMEPLAY::SET_BIT(&(Global_1728515.f_107), iParam1);
...
void func_265()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (is_entity_in_area(PLAYER::PLAYER_PED_ID(), Var1, Var1.f_3, 0, 1, 0))
		{
			iVar0 = true;
		}
	}
	if (((!func_27() && !iVar0) && !func_266(Local_194)) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(player_id()), Local_194.f_1, 1) > 200f)
	{
		func_372();
	}
}
...
void func_271()
{
	...
	{
		if (is_screen_faded_out() && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("DLC_EXEC1/BUY_SELL", false))
		{
			Local_194.f_87 = AUDIO::GET_SOUND_ID();
...
void func_272(int iParam0, Vector3 vParam1)
{
	...
	if ((Global_1728515.f_109 != 0 && !ENTITY::IS_ENTITY_DEAD(Global_1728515.f_109, 0)) && is_vehicle_driveable(Global_1728515.f_109, 0))
	{
		...
		else
		{
			...
			if (Global_1728515.f_112 == 2)
			{
				...
				Var6.f_20 = 2;
				Var6.f_23 = 1;
				if (func_273(vParam1, 0f, 0f, 0f, ENTITY::GET_ENTITY_MODEL(iVar0), 0, &vVar2, &fVar5, &Var6))
				{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && player_id() != iVar1) || iParam9 == 0)
		{
			if (func_22(iVar1, iParam5, iParam6))
			{
				...
				{
					if (!iParam8 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_283(iVar1)))
					{
	...
	if (iParam4 && !iParam7)
	{
		if (func_22(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_283(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_22(iVar1, iParam4, iParam5))
			{
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_283(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_155(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
void func_356(auto uParam0, int iParam1)
{
	...
	if (iParam1 == 20)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_79, 2))
		{
			if (vdist(func_155(player_id()), vVar0) > 70f)
			{
				GAMEPLAY::CLEAR_BIT(uParam0.f_79, 2);
			}
		}
		else if (vdist(func_155(player_id()), vVar0) <= 70f)
		{
			...
			{
				iVar3 = GAMEPLAY::GET_HASH_KEY("WHOUSE_DOOR_RANCHO_2A");
			...
			{
				iVar3 = GAMEPLAY::GET_HASH_KEY("WHOUSE_DOOR_RANCHO_2B");
				if (!_does_door_exist(iVar3))
				{
			...
			_set_door_ajar_angle(iVar3, -1f, 0, 0);
			_set_door_acceleration_limit(iVar3, 0, 0, 0);
			GAMEPLAY::SET_BIT(uParam0.f_79, 2);
		}
	}
	if (iParam1 == 18 && !GAMEPLAY::IS_BIT_SET(*uParam0.f_79, 2))
	{
		ENTITY::CREATE_MODEL_HIDE(996.4036f, -2481.757f, 28.8007f, 4f, joaat("prop_facgate_04_l"), 0);
		ENTITY::CREATE_MODEL_HIDE(985.8288f, -2480.68f, 28.8007f, 4f, joaat("prop_facgate_04_r"), 0);
		ENTITY::CREATE_MODEL_HIDE(996.5616f, -2481.773f, 28.8807f, 2f, joaat("prop_facgate_03post"), 0);
		ENTITY::CREATE_MODEL_HIDE(985.6758f, -2480.667f, 28.8807f, 2f, joaat("prop_facgate_03post"), 0);
		GAMEPLAY::SET_BIT(uParam0.f_79, 2);
	}
	if (iParam1 == 12 && !GAMEPLAY::IS_BIT_SET(*uParam0.f_79, 2))
	{
		ENTITY::CREATE_MODEL_HIDE(-550.8629f, -1772.796f, 22.3438f, 4f, -1391539216, 0);
		ENTITY::CREATE_MODEL_HIDE(-542.201f, -1777.798f, 22.1771f, 4f, 406528547, 0);
		GAMEPLAY::SET_BIT(uParam0.f_79, 2);
	}
}
...
void func_372()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_1728515, false))
	{
		set_no_loading_screen(0);
		GAMEPLAY::CLEAR_BIT(&Global_1728515, false);
	}
	func_373();
}
...
void func_377(auto uParam0, int iParam1)
{
	...
	if (iParam1 == 18)
	{
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(996.4036f, -2481.757f, 28.8007f, 4f, joaat("prop_facgate_04_l"), false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(985.8288f, -2480.68f, 28.8007f, 4f, joaat("prop_facgate_04_r"), false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(996.5616f, -2481.773f, 28.8807f, 2f, joaat("prop_facgate_03post"), false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(985.6758f, -2480.667f, 28.8807f, 2f, joaat("prop_facgate_03post"), false);
		GAMEPLAY::CLEAR_BIT(uParam0.f_79, 2);
	}
	if (iParam1 == 12)
	{
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(-550.8629f, -1772.796f, 22.3438f, 4f, -1391539216, false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(-542.201f, -1777.798f, 22.1771f, 4f, 406528547, false);
		GAMEPLAY::CLEAR_BIT(uParam0.f_79, 2);
	}
}
...
void func_380()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_1728515.f_107, Local_194))
	{
		func_374(Local_194);
	}
