			...
			switch (iLocal_21)
			{
				...
				case 1:
					if (!func_189())
					{
						...
						func_187(0, 1);
						func_71(PLAYER::PLAYER_PED_ID(), 12, 35, 0, -1, 0, 0, 0, -1, -1, -1, 0);
						wait(500);
						iLocal_21 = 2;
					}
					func_191();
				...
				case 2:
					if ((has_this_cutscene_loaded("SOL_5_MCS_2_P5") && func_70(0, 1)) && _0x7350823473013C02(PLAYER::PLAYER_PED_ID()))
					{
				...
				case 4:
					if (!is_cutscene_playing())
					{
						...
						func_6(0, &sLocal_24);
						iLocal_32 = get_interior_at_coords_with_type(Global_86649[0 /*10*/].f_3, &sLocal_24);
...
int func_6(int iParam0, char* sParam1)
{
...
void func_8(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		func_41(iParam5, &Var0, vParam1, fParam4, func_47(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_24(iParam0, 0, 0)) || func_24(iParam0, 1, 0)) || func_24(iParam0, 2, 0)) || func_47(iParam0) != 145) || func_23(iParam0)) || func_22(iParam0)) || func_21(iParam0)) || func_20(iParam0)) || !func_12(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_22(iParam0))
		{
		}
...
bool func_24(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_25(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_25(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
auto func_27()
{
	...
	func_30(&uVar0, get_clock_day_of_month());
	func_29(&uVar0, get_clock_month());
	func_28(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return shift_right(iParam0, 26) & 31 * func_33(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
int func_38(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_40(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_41(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_38(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
void func_45(auto uParam0, auto uParam1)
{
...
int func_48(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_51(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_54(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_2(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_59(*iParam1, 0, &uVar0))
		{
...
int func_57(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_59(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_60(iVar0, iParam1, uParam2))
	{
		return false;
	}
	...
	{
		if ((func_21(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_60(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
...
bool func_65(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_68(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_67(*uParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*uParam0, 24, func_67(*uParam0, *uParam1[38] - 1), false);
	}
	if (func_66(*uParam0))
	{
...
int func_70(int iParam0, int iParam1)
{
	if (func_2(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(func_39(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
...
bool func_72(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_73(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_78(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_73(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
					...
					case 3:
						switch (iParam2)
						{
							case 11:
								...
								{
									if (!func_88(iParam0, 3, 176, 191) && !func_88(iParam0, 3, 227, 242))
									{
...
bool func_85(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_101(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_101(vVar16.z)] = func_95(iParam1, vVar16.x, func_101(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_101(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
	...
	while (iVar4 <= iVar2 - 1)
	{
		...
		else
		{
			...
			while (iVar5 <= iVar6 - 1)
			{
				...
				{
					iVar3 += func_109(iParam0, iParam3);
					return iVar3;
				}
				else
				{
...
void func_114(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_119(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_118(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_115(uVar2, iVar3, iVar0, 1);
	}
}

void func_115(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_116(iParam2)];
	if (iVar0 != 0)
	{
...
int func_118(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_116(iParam1)];
...
int func_119(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_120(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_124(int iParam0)
{
	...
	func_125(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_125(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_131(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_118(func_128(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_126(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_118(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_126(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_125(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
		...
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_125(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_187(int iParam0, int iParam1)
{
	if (func_2(iParam0))
	{
		STREAMING::REQUEST_MODEL(func_39(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_188(Vector3 vParam0, Vector3 fParam1, int iParam2, float fParam3, int iParam4)
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			reset_ped_audio_flags(PLAYER::PLAYER_PED_ID());
		}
	}
	wait(0);
	set_game_paused(true);
	_new_load_scene_start_safe(vParam0, fParam5, 0);
	iVar0 = 0;
