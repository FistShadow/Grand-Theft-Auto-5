...
{
	return shift_right(iParam0, 26) & 31 * func_33(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
int func_70(int iParam0, int iParam1)
{
	if (func_2(iParam0))
	{
		return has_model_loaded(func_39(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_187(int iParam0, int iParam1)
{
	if (func_2(iParam0))
	{
		request_model(func_39(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
