...
int func_43(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_114(var uParam0, int iParam1, vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
...
bool func_126(var uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
