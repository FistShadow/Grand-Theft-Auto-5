	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 1:
				...
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -871.9259f, 162.0005f, 52.99224f, -741.5948f, 155.0873f, 113.0255f, 90f, 0, true, 0))
					{
						if (is_new_load_scene_active())
						{
							new_load_scene_stop();
						}
						_new_load_scene_start_safe(-817.6152f, 178.5613f, 71.2275f, 200f, 0);
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					vVar0 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
					if (func_213(vVar0, vVar3, 100f) || iLocal_40)
					{
						if (func_210() || iLocal_40)
						{
							...
							{
								if (func_214(&uLocal_53, vVar0) || iLocal_40)
								{
									if (func_204() || iLocal_40)
									{
										...
										{
											if ((iLocal_43 || is_new_load_scene_loaded()) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > 12000)
											{
												new_load_scene_stop();
												iLocal_50 = GAMEPLAY::GET_GAME_TIMER();
												func_203(1);
			...
			case 3:
				if ((((is_valid_interior(iLocal_51) && is_interior_ready(iLocal_51)) && is_valid_interior(iLocal_52)) && is_interior_ready(iLocal_52)) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > 500)
				{
					new_load_scene_stop();
					iLocal_50 = GAMEPLAY::GET_GAME_TIMER();
					iLocal_38 = 0;
			...
			case 5:
				func_1(25);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2621447[17]), true);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2621447[18]), true);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2621447[19]), true);
				func_218();
				break;
		}
		wait(false);
		...
		switch (iLocal_38)
		{
			case 0:
				if (func_194(0, 1093140480, 0))
				{
					...
					if (does_cam_exist(iLocal_46))
					{
						set_cam_params(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						set_cam_params(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 0, 0, 2);
					}
			...
			case 1:
				...
				vVar17 = {func_58(vVar7[0 /*3*/])};
				fVar20 = 12f;
				if (((((((is_new_load_scene_active() && is_new_load_scene_loaded()) && is_valid_interior(iLocal_51)) && is_valid_interior(iLocal_52)) && is_interior_ready(iLocal_51)) && is_interior_ready(iLocal_52)) && GAMEPLAY::GET_GAME_TIMER() - iLocal_48 > iVar21) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > iVar22)
				{
					if (does_cam_exist(iLocal_46))
					{
						set_cam_params(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
			...
			case 2:
				...
				vVar17 = {func_58(vVar7[0 /*3*/])};
				fVar20 = 10f;
				if (((is_new_load_scene_active() && is_new_load_scene_loaded()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_48 > iVar21) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > iVar22)
				{
					if (does_cam_exist(iLocal_46))
					{
						set_cam_params(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						set_cam_params(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 1, 1, 2);
						new_load_scene_stop();
			...
			case 3:
				...
				if (((is_new_load_scene_active() && is_new_load_scene_loaded()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_48 > iVar21) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > iVar22)
				{
					if (does_cam_exist(iLocal_46))
					{
						set_cam_params(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21 / 2, 1, 1, 2);
						set_cam_params(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21 / 2, 1, 1, 2);
						new_load_scene_stop();
			...
			case 4:
				...
				vVar17 = {func_58(vVar7[0 /*3*/])};
				fVar20 = 12f;
				if (((is_new_load_scene_active() && is_new_load_scene_loaded()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_48 > iVar21 / 2) || GAMEPLAY::GET_GAME_TIMER() - iLocal_50 > iVar22)
				{
					if (does_cam_exist(iLocal_46))
					{
						set_cam_params(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21 / 2, 1, 1, 2);
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (_0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4 && GAMEPLAY::GET_GAME_TIMER() - iLocal_48 >= iVar21 - 300)
					{
...
void func_10()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -840.6724f, 159.0602f, 66.2181f, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 305.1602f);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			clear_area(-857.1225f, 157.4701f, 63.7638f, 5f, 1, 0, 0, false);
			set_entity_coords(iVar0, -857.1225f, 157.4701f, 63.7638f, 1, false, 0, 1);
...
void func_11(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_27(iParam0, 0, 0)) || func_27(iParam0, 1, 0)) || func_27(iParam0, 2, 0)) || func_51(iParam0) != 145) || func_26(iParam0)) || func_25(iParam0)) || func_24(iParam0)) || func_23(iParam0)) || !func_15(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_25(iParam0))
		{
		}
...
bool func_27(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_28(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_28(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_43(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_45(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_41(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
void func_49(auto uParam0, auto uParam1)
{
...
void func_53(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_54(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_55(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_63(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_177(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_177(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_104(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_109(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_108(uVar2, iVar0, 0);
...
int func_108(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_106(iParam1)];
...
int func_109(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_110(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_115(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_121(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_108(func_118(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_116(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_108(uVar1, Global_69309, 0);
				if (!is_bit_set(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_116(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_119(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
bool func_194(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_201(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_200(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_201(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_213(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	Vector3 vVar0;
...
int func_214(auto uParam0, struct<2> Param1, auto uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_216(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
