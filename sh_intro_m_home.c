...
bool func_28(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_45(int iParam0, var uParam1, vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_41(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
bool func_55(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_109(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_110(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_119(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_214(var uParam0, struct<2> Param1, var uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_216(var uParam0, vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
