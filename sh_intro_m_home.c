...
void main()
{
	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 5:
				func_1(25);
				GAMEPLAY::SET_BIT(&(Global_2621447[17]), true);
				GAMEPLAY::SET_BIT(&(Global_2621447[18]), true);
				GAMEPLAY::SET_BIT(&(Global_2621447[19]), true);
				func_218();
				break;
		}
		wait(false);
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_54(iVar0 + 1));
			}
			iVar0++;
		}
