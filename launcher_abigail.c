		...
		switch (*iParam0)
		{
			case 0:
				*iParam0.f_166 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(1000, 2000);
				...
				task_play_anim(*uParam1, sLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				if (GAMEPLAY::GET_GAME_TIMER() > *iParam0.f_166)
				{
					...
					{
						task_play_anim(*uParam1, sLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				{
					task_play_anim(*uParam1, sLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_175(iParam0.f_1, "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						task_play_anim(*uParam1, sLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
					...
					if (is_entity_playing_anim(*uParam1, sLocal_99, "loop_talk", 3))
					{
						if (get_entity_anim_current_time(*uParam1, sLocal_99, "loop_talk") > 0.99f)
						{
							*iParam0.f_166 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(7000, 10000);
							if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
							{
								task_play_anim(*uParam1, sLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								task_play_anim(*uParam1, sLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_194(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					else if ((func_194(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
