...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_269(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_252(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_249(&iVar231, &Var0, vVar61, 1f))
	{
		func_248();
	...
	while (true)
	{
		...
		func_190(Var0);
		func_183(&iLocal_100, &(Var0.f_9), vVar61);
		switch (Var0)
		{
			case 0:
			...
			case 1:
				func_169(&Var0, vVar61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_154(&Var0, 0))
		{
...
void func_91(char* sParam0, auto uParam1, int iParam2)
{
...
bool func_169(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*uParam0.f_28[0])) && !func_130()) && GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_60 > iParam8) && func_173(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_172(&uVar0, iParam6, *uParam0.f_28[0], sParam7, 0, 1);
		func_170(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_170(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_171(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_172(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_174(int iParam0, auto uParam1, char* sParam2)
{
	if (func_111(*uParam1) && func_111(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			case 0:
				*iParam0.f_166 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(1000, 2000);
				func_172(iParam0.f_1, 3, *uParam1, "ABIGAIL", 0, 1);
				AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_182(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (is_entity_playing_anim(*uParam1, sLocal_99, "outro", 3) && get_entity_anim_current_time(*uParam1, sLocal_99, "outro") > 0.99f)
				{
					AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (is_entity_playing_anim(*uParam1, sLocal_99, "intro", 3) && get_entity_anim_current_time(*uParam1, sLocal_99, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_175(iParam0.f_1, "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_130())
				{
					if (is_entity_playing_anim(*uParam1, sLocal_99, "loop_talk", 3))
					{
						if (get_entity_anim_current_time(*uParam1, sLocal_99, "loop_talk") > 0.99f)
						{
							*iParam0.f_166 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(7000, 10000);
							if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
							{
								AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								AI::TASK_PLAY_ANIM(*uParam1, sLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (is_entity_playing_anim(*uParam1, sLocal_99, "loop_look", 3) && get_entity_anim_current_time(*uParam1, sLocal_99, "loop_look") > 0.99f)
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						if (GAMEPLAY::GET_GAME_TIMER() > *iParam0.f_166)
...
int func_175(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_192(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_193(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_194(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_193(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_199(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_206(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			*uParam0.f_25 = 1;
			...
			func_237(uParam0.f_48, sLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_236(&iVar0) || !has_anim_dict_loaded(sLocal_99))
			{
				return false;
			}
			iLocal_91 = 2;
...
void func_231(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_232(iParam0);
...
void func_237(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
bool func_238(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(iVar0) || !has_anim_dict_loaded(sLocal_99))
			{
				return false;
			}
			iLocal_91 = 2;
...
int func_243(int iParam0, char* sParam1)
{
...
bool func_249(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
...
bool func_250(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
bool func_251(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_258(auto uParam0, int iParam1, int iParam2, int iParam3)
{
