...
bool func_169(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_111(player_ped_id()) && func_111(*uParam0.f_28[0])) && !func_130()) && get_game_timer() - *uParam0.f_60 > iParam8) && func_173(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
{
	if (func_111(*uParam1) && func_111(player_ped_id()))
	{
		switch (*iParam0)
		{
			case 0:
			...
			case 1:
				...
				{
					if (is_entity_in_angled_area(player_ped_id(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						task_play_anim(*uParam1, sLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_182(player_ped_id(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
