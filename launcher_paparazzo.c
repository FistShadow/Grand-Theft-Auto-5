...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_251(&Var0, 1);
	}
	if (!func_248(&iVar64, &Var0, vVar61, 5f))
	{
		func_247();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_178(&Var0, vVar61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_178(&Var0, vVar61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_177(Var0);
		func_169(&iLocal_95, &(Var0.f_9), vVar61);
		if (func_154(&Var0, 0))
		{
			if (func_153(Var0))
			{
				func_150(Var0, &iLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_251(&Var0, 1);
...
int func_124(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_132()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_133(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_142(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_151(Vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_152(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_169(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_173(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_172(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_173(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
auto func_173(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_178(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && !func_130()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_173(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_181(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
		func_179(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_179(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_180(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_181(auto uParam0, auto uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_182(auto uParam0, int iParam1)
{
	struct<27> Var0;
...
bool func_190(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_192(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_194(int iParam0, float fParam1)
{
	...
	{
		if (func_205(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
int func_196(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_197(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_197(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_200(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = {func_202(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
bool func_207(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_209(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_222(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_231(&iVar0) || !has_anim_dict_loaded(sVar8))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[1]))
			{
				...
				if (func_110(*uParam0.f_28[1]))
				{
					...
					set_ped_component_variation(*uParam0.f_28[1], 3, 0, false, 1);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[2]))
			{
				...
				if (func_110(*uParam0.f_28[2]))
				{
					...
					set_ped_component_variation(*uParam0.f_28[2], false, 1, false, 0);
					...
					set_ped_component_variation(*uParam0.f_28[2], 9, 0, false, 0);
				}
				else
				{
					iVar11 = false;
...
void func_223(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_188(iParam0);
...
void func_224(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_225(iParam0);
...
void func_226(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	func_227(iParam0);
...
bool func_228(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_229(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_229(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_230(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_234(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_231(&iVar0) || !has_anim_dict_loaded(sVar30))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_110(*uParam0.f_28[0]))
			{
				...
				{
					func_223(uParam0.f_41[3], iVar0[1], get_offset_from_entity_in_world_coords(*uParam0.f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_111(*uParam0.f_41[0]))
			{
				iLocal_94 = create_synchronized_scene(ENTITY::GET_ENTITY_COORDS(*uParam0.f_41[0], 1), get_entity_rotation(*uParam0.f_41[0], 2), 2);
				play_synchronized_entity_anim(*uParam0.f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1000f);
				set_synchronized_scene_looped(iLocal_94, true);
				if (func_111(*uParam0.f_28[0]))
				{
					task_synchronized_scene(*uParam0.f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_111(*uParam0.f_41[1]))
				{
					play_synchronized_entity_anim(*uParam0.f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1000f);
				}
				if (func_111(*uParam0.f_41[2]))
				{
					play_synchronized_entity_anim(*uParam0.f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1000f);
				}
			}
			iVar31 = 0;
			while (iVar31 <= iVar0 - 1)
...
bool func_235(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_231(&iVar0) || !has_anim_dict_loaded("rcmpaparazzo_2"))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_110(*uParam0.f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_41[0]))
				{
					func_223(uParam0.f_41[0], iVar0[2], get_offset_from_entity_in_world_coords(*uParam0.f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_111(*uParam0.f_41[0]))
					{
		...
		case 3:
			if (func_111(*uParam0.f_28[0]) && func_111(PLAYER::PLAYER_PED_ID()))
			{
				...
				iLocal_94 = create_synchronized_scene(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				set_synchronized_scene_looped(iLocal_94, true);
				task_synchronized_scene(*uParam0.f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1000f, 0);
...
bool func_236(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_231(&iVar0) || !has_anim_dict_loaded(sVar7))
			{
				return false;
			}
			func_237(46, 1);
		...
		case 3:
			if (func_111(*uParam0.f_28[0]))
			{
				if (has_anim_dict_loaded("rcmpaparazzo1beckon"))
				{
					...
					AI::TASK_PLAY_ANIM(false, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					set_sequence_to_repeat(iVar6, 1);
					close_sequence_task(iVar6);
					task_perform_sequence(*uParam0.f_28[0], iVar6);
...
int func_242(int iParam0, char* sParam1)
{
...
bool func_248(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
...
bool func_249(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
bool func_250(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_251(int iParam0, int iParam1)
{
	if (iParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				...
				remove_scenario_blocking_area(iLocal_96, 0);
				func_253(iParam0, 0, 0, 0);
				break;
			
			case 48:
				ENTITY::ENTITY::REMOVE_MODEL_HIDE(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				ENTITY::ENTITY::REMOVE_MODEL_HIDE(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				ENTITY::ENTITY::REMOVE_MODEL_HIDE(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
	...
	if (!iParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (_get_number_of_instances_of_streamed_script(joaat("paparazzo3")) > 0)
			{
				wait(0);
			}
		}
...
void func_253(auto uParam0, int iParam1, int iParam2, int iParam3)
{
