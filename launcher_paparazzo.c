...
void func_169(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_173(player_ped_id(), vParam2, 1) <= 100f)
				{
					func_172(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_173(player_ped_id(), vParam2, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
bool func_178(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_111(player_ped_id()) && func_111(*iParam0.f_28[0])) && !func_130()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_173(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_185(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), false);
						*uParam1.f_3 = 5;
					}
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_191(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
{
	return func_196(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!does_entity_exist(*uParam0.f_41[0]))
			{
				...
				if (func_111(*uParam0.f_28[0]) && does_entity_exist(*uParam0.f_41[0]))
				{
			...
			if (!does_entity_exist(*uParam0.f_41[1]))
			{
				...
				if (func_111(*uParam0.f_28[1]) && does_entity_exist(*uParam0.f_41[1]))
				{
...
bool func_235(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_111(*uParam0.f_28[0]) && func_111(player_ped_id()))
			{
