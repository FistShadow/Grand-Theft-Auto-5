...
bool func_200(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_202(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
...
bool func_209(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_202(vParam1 - get_entity_coords(iParam0, 1))};
...
bool func_234(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_111(*uParam0.f_41[0]))
			{
				iLocal_94 = create_synchronized_scene(get_entity_coords(*uParam0.f_41[0], 1), get_entity_rotation(*uParam0.f_41[0], 2), 2);
		...
		case 3:
			if (func_111(*uParam0.f_28[0]))
			{
				if (has_anim_dict_loaded("rcmpaparazzo1beckon"))
				{
					...
					task_play_anim(false, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
