...
void main()
{
	...
	vLocal_56 = {Local_286.f_1[0 /*3*/]};
	func_306();
	if (get_clock_hours() > 7 && get_clock_hours() < 19)
	{
		terminate_this_thread();
	}
	if (func_280(vLocal_56, 23, iLocal_285, 0, 0))
	{
		func_278(-1);
	}
	else
		...
		if ((is_world_point_within_brain_activation_range() && !is_player_wanted_level_greater(player_id(), 0)) || iLocal_261)
		{
			...
			switch (iLocal_51)
			{
				...
				case 1:
					...
					if (!is_entity_dead(iLocal_252, 0))
					{
						if (is_ped_in_any_vehicle(iLocal_252, 0))
						{
							func_210();
						}
					}
					if (!is_entity_dead(iLocal_253, 0))
					{
						if (is_ped_in_any_vehicle(iLocal_253, 0))
						{
							func_210();
						}
					}
					...
					if (!iLocal_261)
					{
						if (!is_entity_dead(iLocal_254, 0))
						{
							if (func_195(PLAYER::PLAYER_PED_ID(), get_entity_coords(iLocal_254, 1), 1) < IntToFloat(iLocal_274) && !is_entity_occluded(iLocal_254))
							{
								if (!iLocal_268)
								{
									func_193();
									...
									if (does_blip_exist(iLocal_251))
									{
										_0x75A16C3DA34F1245(iLocal_251, true);
									}
									iLocal_268 = 1;
								}
							}
					...
					else
					{
						...
						if (!iLocal_263)
						{
							if (!is_entity_dead(iLocal_254, 0))
							{
								if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_254, 0))
								{
									if (!PED::IS_PED_INJURED(iLocal_252))
									{
										open_sequence_task(&iLocal_271);
										task_enter_vehicle(false, iLocal_254, -1, -1, 2f, 524296, 0);
										task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
										close_sequence_task(iLocal_271);
										task_perform_sequence(iLocal_252, iLocal_271);
										clear_sequence_task(&iLocal_271);
										set_ped_keep_task(iLocal_252, true);
									}
									iLocal_263 = 1;
								}
							}
...
void func_2()
{
	if (!is_entity_dead(iLocal_252, 0))
	{
		if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 10f, 10f, 10f, 0, 1, 0) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((timerb() > 3000 && iLocal_272 == 0) && !func_3())
			{
				func_182(&uLocal_84, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
				task_look_at_entity(iLocal_252, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
	...
	if (!iLocal_267)
	{
		if (!PED::IS_PED_INJURED(iLocal_252))
		{
			...
			else if (timera() > 4000)
			{
				if (!PED::IS_PED_INJURED(iLocal_252))
				{
					task_combat_ped(iLocal_252, PLAYER::PLAYER_PED_ID(), 0, 16);
					set_ped_keep_task(iLocal_252, true);
				}
			...
			if (!PED::IS_PED_INJURED(iLocal_252))
			{
				if ((iLocal_275 >= 1 && is_ped_being_stunned(PLAYER::PLAYER_PED_ID(), 0)) && iLocal_264)
				{
					task_play_anim(iLocal_252, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
					trigger_music_event(sLocal_277);
					shake_gameplay_cam("DEATH_FAIL_IN_EFFECT_SHAKE", 1f);
					_start_screen_effect("Dont_tazeme_bro", false, 0);
	...
	else
	{
		...
		switch (iLocal_278)
		{
			...
			case 1:
				...
				{
					func_163();
					iLocal_82 = _0x219C7B8D53E429FD(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
					func_157(1);
					do_screen_fade_out(500);
					wait(2000);
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_252))
					{
						set_ped_as_no_longer_needed(&iLocal_252);
					}
					iLocal_278++;
				}
				else
			...
			case 2:
				...
				set_entity_coords(PLAYER::PLAYER_PED_ID(), 923.5159f, 3203.386f, 40.173f, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), 280.1253f);
				...
				delete_all_trains();
				iLocal_255 = create_mission_train(0, 1063.595f, 3227.571f, 39.3899f, 1);
				iVar0 = PED::CREATE_PED_inside_vehicle(iLocal_255, 26, iLocal_258, -1, 1, true);
				iVar0 = iVar0;
				if (!iLocal_266)
				{
					if (SCRIPT::REQUEST_SCRIPT_audio_bank("Train_Horn", false))
					{
						play_sound_from_entity(-1, "Warning_Once", iLocal_255, "TRAIN_HORN", 0, 0);
					}
				}
				...
				{
					task_play_anim(PLAYER::PLAYER_PED_ID(), "random@train_tracks", "on_back_c", 1000f, -8f, -1, 0, 0, 0, 0, 0);
				}
				wait(100);
				settimera(false);
				iLocal_278++;
			...
			case 4:
				if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "random@train_tracks", "on_back_c", 3))
				{
					if (get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), "random@train_tracks", "on_back_c") > 0.95f)
					{
						func_157(0);
					...
					else if (get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), "random@train_tracks", "on_back_c") < 0.1f)
					{
						set_player_control(player_id(), true, 0);
						set_gameplay_cam_relative_heading(-5.2078f);
						set_gameplay_cam_relative_pitch(-15.2963f, 1f);
				...
				if (!is_entity_dead(iLocal_255, 0))
				{
					if (SCRIPT::REQUEST_SCRIPT_audio_bank("Train_Horn", false))
					{
						play_sound_from_entity(-1, "Warning_Once", iLocal_255, "TRAIN_HORN", 0, 0);
...
bool func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_54(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_54(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_54(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_85(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_54(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_54(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_54(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_44(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_46(iParam1);
	if (Global_101154.f_1826.f_539[uVar0 /*65*/].f_63 != -99)
	{
		if (!func_45(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_45(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_54(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_54(iParam1)))
	{
		return true;
	}
	return false;
...
bool func_50(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_45(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
bool func_57(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		if (!_is_dlc_data_empty(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						*iParam0[vVar16.z] = func_67(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_54(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_73(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_73(vVar16.z)] = func_67(iParam1, vVar16.x, func_73(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_73(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_54(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_76(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
void func_86(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_90(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_89(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_87(uVar2, iVar3, iVar0, 1);
	}
}

void func_87(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_88(iParam2)];
	if (iVar0 != 0)
	{
...
int func_89(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_88(iParam1)];
...
int func_90(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_91(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_95(int iParam0)
{
	...
	func_96(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_96(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_101(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			if (func_97(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_89(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_97(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_100(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_102(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_96(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_54(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_96(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_165()
{
	...
	if (iLocal_52 == 1)
	{
		if (!iLocal_267)
		{
			if (!PED::IS_PED_INJURED(iLocal_252))
			{
				if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 50f, 50f, 50f, 0, 1, 0))
				{
					func_15();
				}
			}
	...
	else if (iLocal_52 == 2)
	{
		...
		{
			if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 200f, 200f, 200f, 0, 1, 0) && !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 200f, 200f, 200f, 0, 1, 0))
			{
				func_15();
			}
		}
...
void func_166()
{
	if (!PED::IS_PED_INJURED(iLocal_252))
	{
		if (iLocal_52 == 1)
		{
			if (!is_ped_being_stunned(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!is_entity_at_entity(iLocal_252, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0) || !is_entity_at_coord(iLocal_252, vLocal_71, 215f, 215f, 215f, false, true, 0))
				{
					if ((is_player_free_aiming_at_entity(player_id(), iLocal_252) || is_player_targetting_entity(player_id(), iLocal_252)) || !is_entity_at_coord(iLocal_252, vLocal_71, 215f, 215f, 215f, false, true, 0))
					{
						if (is_ped_armed(PLAYER::PLAYER_PED_ID(), 6) || !is_entity_at_coord(iLocal_252, vLocal_71, 215f, 215f, 215f, false, true, 0))
						{
							task_smart_flee_ped(iLocal_252, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							set_ped_keep_task(iLocal_252, true);
							func_193();
							wait(false);
		...
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("rhino")) || is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("annihilator"))) || is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("buzzard"))) || is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("lazer")))
				{
					func_15();
				}
			}
...
void func_167()
{
	if (iLocal_52 == 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_252))
		{
			if (!is_ped_in_writhe(iLocal_252))
			{
				if (iLocal_278 < 3)
				{
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 20f, 20f, 10f, 0, 1, 0))
					{
						if (func_172())
						{
							func_171(0);
	...
	else if (iLocal_52 == 2)
	{
		if (!is_entity_dead(iLocal_252, 0))
		{
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_172())
				{
					func_171(0);
		...
		else if (!is_entity_dead(iLocal_253, 0))
		{
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_253, 31f, 31f, 11f, 0, 1, 0))
			{
				if (func_172())
				{
					func_171(0);
		...
		if (!func_3())
		{
			if (!iLocal_270)
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 30f, 30f, 10f, 0, 1, 0))
				{
					if (func_192() == 0)
					{
				...
				if (func_170())
				{
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
						if (!is_ped_in_writhe(iLocal_252))
						{
							...
							iLocal_276 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(4500, 5000);
						}
					}
				}
				else if (!PED::IS_PED_INJURED(iLocal_253))
				{
					if (!is_ped_in_writhe(iLocal_253))
					{
	...
	if (!PED::IS_PED_INJURED(iLocal_252))
	{
		if (!is_ped_in_writhe(iLocal_252))
		{
			if ((is_ped_ragdoll(iLocal_252) || is_ped_being_stunned(iLocal_252, joaat("weapon_stungun"))) || has_entity_been_damaged_by_entity(iLocal_252, PLAYER::PLAYER_PED_ID(), 1))
			{
				func_193();
				clear_entity_last_damage_entity(iLocal_252);
			}
			if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, vLocal_78, 0, 1, 0) || !is_entity_at_coord(iLocal_252, vLocal_71, 290f, 290f, 290f, false, true, 0))
			{
...
void func_174()
{
	if (!PED::IS_PED_INJURED(iLocal_252))
	{
		if (is_ped_in_any_vehicle(iLocal_252, 0))
		{
			if (is_vehicle_driveable(get_vehicle_ped_is_in(iLocal_252, 0), 0))
			{
				if (is_entity_playing_anim(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3))
				{
					if ((((((((get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && get_entity_anim_current_time(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f))
					{
						apply_force_to_entity(get_vehicle_ped_is_in(iLocal_252, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						play_sound_from_entity(-1, "SUSPENSION_SCRIPT_FORCE", get_vehicle_ped_is_in(iLocal_252, 0), 0, 0, 0);
					}
				}
		...
		if (!PED::IS_PED_INJURED(iLocal_253))
		{
			if (has_entity_been_damaged_by_entity(iLocal_253, PLAYER::PLAYER_PED_ID(), 1))
			{
				task_play_anim(iLocal_253, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
			}
		}
	}
}
...
void func_175()
{
	if (!is_entity_dead(iLocal_254, 0))
	{
		if ((!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_254, 0)) || iLocal_52 == 2)
		{
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_254, vLocal_75, 0, 1, 0) || iLocal_260)
			{
				if (iLocal_52 == 1)
				{
					vLocal_59 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - Vector(-1f, 8.8f, 0f)};
					get_safe_coord_for_ped(vLocal_59, 0, &vLocal_59, 0);
					vLocal_62 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) + Vector(-1f, 0f, 8.8f)};
					get_safe_coord_for_ped(vLocal_62, 0, &vLocal_62, 0);
					vLocal_65 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) + Vector(-1f, 8.8f, 0f)};
					get_safe_coord_for_ped(vLocal_65, 0, &vLocal_65, 0);
					vLocal_68 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - Vector(-1f, 0f, 8.8f)};
					get_safe_coord_for_ped(vLocal_68, 0, &vLocal_68, 0);
					if (!is_sphere_visible(vLocal_59, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, vLocal_59 - Vector(1f, 0f, 0f), func_180(vLocal_59, func_181(player_id())), 1, true);
					}
					else if (!is_sphere_visible(vLocal_62, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, vLocal_62 - Vector(1f, 0f, 0f), func_180(vLocal_62, func_181(player_id())), 1, true);
					}
					else if (!is_sphere_visible(vLocal_65, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, vLocal_65 - Vector(1f, 0f, 0f), func_180(vLocal_65, func_181(player_id())), 1, true);
					}
					else if (!is_sphere_visible(vLocal_68, 2f))
					{
						iLocal_252 = PED::CREATE_PED(19, iLocal_258, vLocal_68 - Vector(1f, 0f, 0f), func_180(vLocal_68, func_181(player_id())), 1, true);
					}
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
						set_ambient_voice_name(iLocal_252, "A_M_M_HillBilly_01_WHITE_MINI_02");
						give_weapon_to_ped(iLocal_252, joaat("weapon_stungun"), -1, true, true);
						set_ped_shoot_rate(iLocal_252, 100);
						...
						set_ped_min_ground_time_for_stungun(PLAYER::PLAYER_PED_ID(), 10000);
						...
						task_go_to_entity_while_aiming_at_entity(false, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 3f, 1, 3f, 4f, 1, 0, -957453492);
						task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
						close_sequence_task(iLocal_271);
						task_perform_sequence(iLocal_252, iLocal_271);
						clear_sequence_task(&iLocal_271);
						set_ped_keep_task(iLocal_252, true);
						_0x2208438012482A1A(iLocal_252, 0, 0);
						iLocal_261 = 1;
					}
				}
				else if (iLocal_52 == 2)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
						...
						open_sequence_task(&iLocal_271);
						task_play_anim(false, "random@train_tracks", "frontseat_carsex_outro_low_guy", 8f, -8f, -1, 0, 0, 0, 0, 0);
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
						close_sequence_task(iLocal_271);
						task_perform_sequence(iLocal_252, iLocal_271);
					...
					if (!PED::IS_PED_INJURED(iLocal_253))
					{
						iLocal_250 = func_176(iLocal_253, 1, 145);
						set_entity_health(iLocal_253, 200);
						open_sequence_task(&iLocal_271);
						task_play_anim(false, "random@train_tracks", "frontseat_carsex_outro_top_guy", 8f, -8f, -1, 0, 0, 0, 0, 0);
						if (!PED::IS_PED_INJURED(iLocal_252))
						{
							task_pause(false, 400);
						}
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
						close_sequence_task(iLocal_271);
						task_perform_sequence(iLocal_253, iLocal_271);
						clear_sequence_task(&iLocal_271);
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_177(iParam0, !iParam1, 0);
...
int func_177(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_178(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_178(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_178(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
float func_180(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
int func_182(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_191(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
auto func_195(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_196()
{
	if (is_vehicle_driveable(iLocal_254, 0))
	{
		if (!func_227())
		{
			if (func_195(PLAYER::PLAYER_PED_ID(), get_entity_coords(iLocal_254, 1), 1) < IntToFloat(iLocal_273))
			{
				if (does_blip_exist(iLocal_251))
				{
					remove_blip(&iLocal_251);
				}
				iLocal_251 = func_208(iLocal_254, 0, 0);
				_0x75A16C3DA34F1245(iLocal_251, false);
	...
	if (iLocal_52 == 1)
	{
		if (!is_entity_dead(iLocal_252, 0))
		{
			if ((((is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 13f, 13f, 13f, 0, 1, 0) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) || has_entity_been_damaged_by_entity(PLAYER::PLAYER_PED_ID(), iLocal_252, 1)) || has_entity_been_damaged_by_entity(iLocal_252, PLAYER::PLAYER_PED_ID(), 1)) || is_sphere_visible(get_entity_coords(iLocal_252, 1), 2f))
			{
				iLocal_260 = 1;
				settimerb(false);
				if (!is_entity_dead(iLocal_252, 0))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_252))
					{
						task_look_at_entity(iLocal_252, PLAYER::PLAYER_PED_ID(), 30000, 0, 2);
					}
				}
			}
		}
...
bool func_202()
{
	switch (func_203(&Global_25179, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return true;
			break;
...
int func_203(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
{
	return func_177(iParam0, !iParam1, iParam2);
}
...
void func_209()
{
	if (!is_entity_dead(iLocal_254, 0))
	{
		if (iLocal_52 == 1)
		{
			if (!is_entity_at_coord(iLocal_254, vLocal_71, 15f, 15f, 15f, false, true, 0))
			{
				func_14();
			}
		}
		...
		{
			if ((((((((has_entity_been_damaged_by_entity(iLocal_254, PLAYER::PLAYER_PED_ID(), 1) || is_ped_shooting_in_area(PLAYER::PLAYER_PED_ID(), vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f), 0, 1)) || is_explosion_in_area(2, vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || is_explosion_in_area(4, vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || is_explosion_in_area(0, vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || is_explosion_in_area(1, vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || is_cop_ped_in_area_3d(vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || is_cop_vehicle_in_area_3d(vLocal_71 - Vector(50f, 50f, 50f), vLocal_71 + Vector(50f, 50f, 50f))) || (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_254, 50f, 50f, 50f, 0, 1, 2) && is_player_pressing_horn(player_id())))
			{
				if (!is_entity_dead(get_players_last_vehicle(), 0))
				{
					iLocal_256 = get_players_last_vehicle();
...
void func_212()
{
	...
	clear_area_of_vehicles(vLocal_56, 50f, 0, 0, 0, 0, false);
	...
	while (((((!STREAMING::HAS_MODEL_LOADED(iLocal_258) || !STREAMING::HAS_MODEL_LOADED(iLocal_259)) || !has_anim_dict_loaded("random@train_tracks")) || !has_anim_dict_loaded("amb@world_human_guard_patrol@male@idle_b")) || !prepare_music_event(sLocal_277)) || !is_audio_scene_active("RE_ABANDONED_VEHICLE_SCENE"))
	{
		wait(false);
	}
	if (func_192() == 0)
	{
		func_179(&uLocal_84, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_192() == 1)
	{
		func_179(&uLocal_84, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_192() == 2)
	{
		func_179(&uLocal_84, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	_0xDC0F817884CDD856(3, false);
	_0xDC0F817884CDD856(5, false);
	iLocal_254 = create_vehicle(iLocal_259, vLocal_71, fLocal_74, 1, true);
	set_entity_lod_dist(iLocal_254, 10000);
	_0xACFB2463CC22BED2(iLocal_254);
	set_vehicle_lod_multiplier(iLocal_254, 5f);
	set_model_as_no_longer_needed(iLocal_259);
	_0x153973AB99FE8980(iLocal_254, "RE_ABANDONED_VEHICLE_MOTORHOME", 0f);
	set_audio_vehicle_priority(iLocal_254, 3);
	add_relationship_group("Redneck", &iLocal_81);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_81, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, iLocal_81);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_81, -1533126372);
	if (iLocal_52 == 1)
	{
		set_vehicle_door_open(iLocal_254, false, 1, 0);
		set_vehicle_door_open(iLocal_254, true, 1, 0);
		set_vehicle_damage(iLocal_254, vLocal_71, 0f, 1700f, 1);
		set_vehicle_engine_on(iLocal_254, false, 1, 0);
		set_vehicle_lights(iLocal_254, 2);
	}
	else if (iLocal_52 == 2)
	{
		set_vehicle_engine_on(iLocal_254, false, 1, 0);
		set_vehicle_lights(iLocal_254, 1);
		iLocal_252 = PED::CREATE_PED_inside_vehicle(iLocal_254, 26, iLocal_258, -1, 1, true);
		set_ped_component_variation(iLocal_252, false, false, 2, 0);
		set_ped_component_variation(iLocal_252, 2, true, 2, 0);
		set_ped_component_variation(iLocal_252, 3, true, false, 0);
		set_ped_component_variation(iLocal_252, 4, false, false, 0);
		set_ped_component_variation(iLocal_252, 8, false, false, 0);
		set_blocking_of_non_temporary_events(iLocal_252, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_252, iLocal_81);
		give_weapon_to_ped(iLocal_252, joaat("weapon_sawnoffshotgun"), -1, false, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_252, 1, false);
		set_ped_accuracy(iLocal_252, 25);
		stop_ped_speaking(iLocal_252, 1);
		set_ambient_voice_name(iLocal_252, "A_M_M_HillBilly_02_WHITE_MINI_01");
		func_179(&uLocal_84, 4, iLocal_252, "INCESTBRO1", 0, 1);
		iLocal_253 = PED::CREATE_PED_inside_vehicle(iLocal_254, 26, iLocal_258, false, 1, true);
		set_ped_component_variation(iLocal_253, false, false, false, 0);
		set_ped_component_variation(iLocal_253, 2, false, false, 0);
		set_ped_component_variation(iLocal_253, 3, false, 2, 0);
		set_ped_component_variation(iLocal_253, 4, true, false, 0);
		set_ped_component_variation(iLocal_253, 8, false, false, 0);
		set_entity_health(iLocal_253, 100000000);
		set_blocking_of_non_temporary_events(iLocal_253, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_253, iLocal_81);
		give_weapon_to_ped(iLocal_253, joaat("weapon_pistol"), -1, false, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_253, 1, false);
		set_ped_accuracy(iLocal_253, 25);
		stop_ped_speaking(iLocal_253, 1);
		set_ambient_voice_name(iLocal_253, "A_M_M_HillBilly_02_WHITE_MINI_02");
		func_179(&uLocal_84, 5, iLocal_253, "INCESTBRO2", 0, 1);
		task_play_anim(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		task_play_anim(iLocal_253, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
...
bool func_214()
{
	...
	{
		if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_48) < 75f * 75f)
		{
			return true;
		}
		if (vmag2(get_entity_velocity(PLAYER::PLAYER_PED_ID())) > 1369f && !func_225())
		{
			return false;
		}
	}
...
void func_216(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_228()
{
	if (iLocal_54)
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			set_ped_min_ground_time_for_stungun(PLAYER::PLAYER_PED_ID(), -1);
		}
		...
		{
			if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_256, 0) && !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_256, 50f, 50f, 50f, 0, 1, 0))
			{
		...
		{
			set_ped_drops_weapon(iLocal_252);
			task_smart_flee_ped(iLocal_252, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			set_ped_keep_task(iLocal_252, true);
		}
		if (!PED::IS_PED_INJURED(iLocal_253) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			set_ped_drops_weapon(iLocal_253);
			task_smart_flee_ped(iLocal_253, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			set_ped_keep_task(iLocal_253, true);
		}
	}
	func_229(-1);
...
void func_235(auto uParam0, int iParam1, int iParam2)
{
	...
	func_244(uParam0, &uVar0);
	Var1 = {func_236(&uVar0)};
}

struct<16> func_236(auto uParam0)
{
	char[64] cVar0;
	int iVar16;
	...
	StringConCat(&cVar0, "/", 64);
	StringIntConCat(&cVar0, func_237(*uParam0), 64);
	return cVar0;
}

auto func_237(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_238(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_245(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_246(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
auto func_254()
{
	...
	func_252(&uVar0, get_clock_seconds());
	func_251(&uVar0, get_clock_minutes());
	func_250(&uVar0, get_clock_hours());
	func_248(&uVar0, get_clock_day_of_month());
	func_249(&uVar0, get_clock_month());
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_275(iParam0) != 145) || func_274(iParam0)) || func_273(iParam0)) || func_272(iParam0)) || func_271(iParam0)) || !func_263(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_273(iParam0))
		{
		}
...
bool func_280(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (!iVar0)
	{
		...
		if (func_290(iParam3, iParam4) && !iParam5)
		{
			return false;
		}
...
int func_281(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
void func_285(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	func_286(func_254(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_286(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar4 < 0)
	{
		...
		iVar4 += func_253(iVar0, iVar1);
		iVar3--;
		iVar0 = round(func_287(to_float(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
float func_287(Vector3 fParam0, float fParam1, float fParam2)
{
	float fVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_299()) || Global_100201) || Global_25122) || func_298()) || func_189(8, -1)) || func_297()) || func_296()) || func_295()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_299()) || Global_25122) || func_298()) || func_189(8, -1)) || func_295()) || func_297()) || func_296()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_299()) || Global_100201) || Global_25122) || func_298()) || func_189(8, -1)) || func_295()) || func_297()) || func_296()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_299()) || Global_100201) || Global_25122) || func_298()) || func_189(8, -1)) || func_297()) || func_296()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_299() || get_player_wanted_level(player_id()) > 0) || func_189(8, -1)) || func_294()) || func_293()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_299()) || Global_25122) || func_298()) || func_189(8, -1)) || func_296()) || func_295()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_299()) || func_296()) || Global_100201) || Global_25122) || func_298()) || Global_36839) || func_189(8, -1)) || func_295()) || func_293()) || func_294()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_299()) || Global_100201) || Global_25122) || func_298()) || func_189(8, -1)) || func_295()) || func_293()) || func_297()) || func_296()) || func_294())
						{
							return false;
						}
						break;
...
Vector3 func_306()
{
	...
	if (is_player_playing(player_id()))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_279, 1);
		iLocal_285 = true;
		if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_282, 1) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_282, 1);
			iLocal_285 = 2;
		}
		if (iLocal_285 == 1)
		{
