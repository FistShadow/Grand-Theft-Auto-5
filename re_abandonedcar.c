...
bool func_50(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
bool func_57(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
...
int func_90(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_96(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	var uVar1;
...
var func_195(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
bool func_277(int iParam0, int iParam1, char* sParam2, var uParam3)
{
