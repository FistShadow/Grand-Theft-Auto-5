...
void func_2(auto uParam0, auto uParam1, auto uParam2)
{
	if (*uParam0 > 0)
	{
		if (*uParam1[*uParam0] == 0)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1[*uParam0], *uParam2);
			}
		}
	}
	*uParam2.f_1 = 0;
	*uParam2.f_1 = 0;
	while (*uParam2.f_1 < 85)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(*uParam1[*uParam2.f_1], *uParam2))
			{
				if (!func_3(int_to_playerindex(*uParam2), 0, 1))
				{
					GAMEPLAY::CLEAR_BIT(uParam1[*uParam2.f_1], *uParam2);
				}
				else
				{
...
void func_4(auto uParam0, int iParam1, int iParam2, auto uParam3)
{
	...
	switch (*uParam0.f_50)
	{
							...
							if (*iParam2.f_698 == int_to_playerindex(*iParam2.f_9))
							{
								if (GAMEPLAY::IS_BIT_SET(*iParam1, true))
								{
									*uParam0.f_1 = *iParam1.f_7;
									if (GAMEPLAY::IS_BIT_SET(*iParam1, 2) && !Global_1587507)
									{
										func_57(uParam0, 1, 0);
									}
									else
		...
		case 1:
			if ((GAMEPLAY::IS_BIT_SET(*iParam1.f_3, true) && !GAMEPLAY::IS_BIT_SET(*iParam1, false)) || Global_1587507)
			{
				func_57(uParam0, 2, 0);
			}
			else
		...
		case 2:
			if ((((GAMEPLAY::IS_BIT_SET(*iParam1.f_3, false) && !GAMEPLAY::IS_BIT_SET(*iParam1, false)) || GAMEPLAY::IS_BIT_SET(*iParam2, 8)) && !Global_1587507) || func_22())
			{
				func_57(uParam0, 1, 0);
			}
			break;
	...
	if ((((!func_55(*uParam3.f_31, -1) && !func_54(*uParam3.f_31)) && !func_56(*uParam3.f_31)) && !func_53(*uParam3.f_31)) && !func_50(player_id()))
	{
		switch (*uParam0.f_52)
		{
			...
			case 3:
				if (GAMEPLAY::IS_BIT_SET(*iParam1.f_4, 5) || Global_1587507)
				{
					func_21(uParam0, 4, 0);
				}
				else
			...
			case 4:
				if ((GAMEPLAY::IS_BIT_SET(*iParam1.f_4, 4) && !Global_1587507) || func_22())
				{
					func_21(uParam0, 3, 0);
				}
				break;
	...
	switch (*uParam0.f_51)
	{
						...
						if (network_get_host_of_this_script() == network_get_participant_index(int_to_playerindex(*iParam2.f_9)))
						{
							if (GAMEPLAY::IS_BIT_SET(*iParam1, true))
							{
								*uParam0.f_2 = *iParam1.f_8;
								if (GAMEPLAY::IS_BIT_SET(*iParam1, 4) && !Global_1587507)
								{
									func_57(uParam0, 1, 1);
								}
								else
		...
		case 2:
			if ((GAMEPLAY::IS_BIT_SET(*iParam1.f_3, false) && GAMEPLAY::IS_BIT_SET(*iParam1, false)) && !Global_1587507)
			{
				func_57(uParam0, 1, 1);
			}
			break;
...
void func_8(int iParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 15);
	func_18();
	func_16();
	func_9();
}
...
void func_23(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		iVar2 = *uParam0.f_2;
		if (!GAMEPLAY::IS_BIT_SET(*iParam2, 3) || get_time_difference(NETWORK::GET_NETWORK_TIME(), *iParam2.f_8) > 1000)
		{
			iVar0 = true;
	...
	{
		iVar2 = *uParam0.f_1;
		if (!GAMEPLAY::IS_BIT_SET(*iParam2, true) || get_time_difference(NETWORK::GET_NETWORK_TIME(), *iParam2.f_7) > 1000)
		{
			iVar0 = true;
			if (!GAMEPLAY::IS_BIT_SET(*iParam1, false))
			{
	...
	if (iVar0)
	{
		if (iVar3)
		{
			if (GAMEPLAY::IS_BIT_SET(*iParam1.f_3, 2) || GAMEPLAY::IS_BIT_SET(*iParam1.f_4, 2))
			{
				func_26(uParam0, iParam3);
				iVar1 = true;
			}
			else if (GAMEPLAY::IS_BIT_SET(*iParam1.f_3, 3) || GAMEPLAY::IS_BIT_SET(*iParam1.f_4, 3))
			{
...
bool func_34(auto uParam0, auto uParam1)
{
	...
	if (func_56(*uParam1.f_31) && !*uParam0.f_49)
	{
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_5))
		{
				...
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					if (func_48(player_id(), 0) >= 0)
					{
						...
						*uParam0.f_5 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_9, 1, 1, 0));
						...
						ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_5), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_6))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					if (func_48(player_id(), 0) >= 0)
					{
						...
						*uParam0.f_6 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_12, 1, 1, 0));
						...
						ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_6), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_7))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					if (func_48(player_id(), 0) >= 0)
					{
						...
						*uParam0.f_7 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_15, 1, 1, 0));
						...
						ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_7), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_8))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					if (func_48(player_id(), 0) >= 0)
					{
						...
						*uParam0.f_8 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_18, 1, 1, 0));
						...
						ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_8), true);
	...
	{
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_24))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_24 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_37, 1, 1, 0));
					ENTITY::SET_ENTITY_ROTATION(net_to_obj(*uParam0.f_24), Var24.f_3, 2, 1);
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_24), true);
					_0xF1CA12B18AEF5298(net_to_ent(*uParam0.f_24), 1);
				}
			}
		}
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_25))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_25 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_40, 1, 1, 0));
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_25), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_26))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_26 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_43, 1, 1, 0));
					ENTITY::SET_ENTITY_ROTATION(net_to_obj(*uParam0.f_26), Var36.f_3, 2, 1);
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_26), true);
					_0xF1CA12B18AEF5298(net_to_ent(*uParam0.f_26), 1);
				}
			}
		}
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_27))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_27 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_46, 1, 1, 0));
					ENTITY::SET_ENTITY_ROTATION(net_to_obj(*uParam0.f_27), Var42.f_3, 2, 1);
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_27), true);
	...
	{
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_22))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_22 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_34, 1, 1, 0));
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_22), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_21))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_21 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_31, 1, 1, 0));
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_21), true);
		...
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_23))
		{
			if (func_49(joaat("prop_boombox_01")))
			{
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					*uParam0.f_23 = obj_to_net(create_object_no_offset(joaat("prop_boombox_01"), *uParam0.f_28, 1, 1, 0));
					...
					ENTITY::FREEZE_ENTITY_POSITION(net_to_ent(*uParam0.f_23), true);
	...
	if (func_56(*uParam1.f_31) && !*uParam0.f_49)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_5) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_6))
		{
			return true;
		}
	}
	...
	{
		if (((network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_25) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_26)) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_27)) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_24))
		{
			return true;
		}
		else
	...
	{
		if ((network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_23) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_21)) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_22))
		{
			return true;
		}
	}
...
void func_58()
{
	...
	if (func_129(0))
	{
		func_128();
		iVar0 = true;
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1767.f_96.f_1))
		{
			iVar0 = false;
		}
	...
	else if (func_129(1))
	{
		if (!func_117())
		{
			if (GAMEPLAY::GET_FRAME_COUNT() % 10 == 0 || is_screen_faded_out())
			{
				if (func_122())
				{
	...
	else if (func_129(2))
	{
		if (func_116(Local_1767.f_3))
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_1728515.f_106, Local_1767.f_3))
			{
				return;
			}
		}
	...
	else if (func_129(3))
	{
		...
		if (!func_90(2, &(Local_1767.f_591)))
		{
			...
			{
				func_65(0);
				network_fade_out_entity(PLAYER::PLAYER_PED_ID(), 1, 1);
	...
	else if (func_129(5))
	{
		if (is_screen_faded_out())
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_1767.f_591, false))
			{
				...
				GAMEPLAY::SET_BIT(&(Local_1767.f_591), false);
			}
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_71(player_id())) && !func_73(player_id(), 0)) && !func_84())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_71(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
void func_92()
{
	...
	if (Local_2419.f_2 == 0)
	{
		...
		Local_2419.f_2 = 1;
		GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_310), true);
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_2419.f_5, Local_2419.f_2))
	{
		...
		if ((!is_string_null_or_empty(sVar0) && !is_screen_fading_in()) && (!func_126(&(Local_2419.f_8)) || func_125(&(Local_2419.f_8), 300, 0)))
		{
			...
			GAMEPLAY::SET_BIT(&(Local_2419.f_5), Local_2419.f_2);
			func_66(&(Local_2419.f_8));
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_2419.f_4, Local_2419.f_2))
	{
		...
		GAMEPLAY::SET_BIT(&(Local_2419.f_4), Local_2419.f_2);
	}
	if ((!Local_2419.f_10 && !func_91()) && !(func_116(Local_1767.f_3) && GAMEPLAY::IS_BIT_SET(Global_1728515.f_14, Local_1767.f_3)))
	{
	...
	if (func_125(&(Local_2419.f_6), func_103(Local_2419.f_2), 0))
	{
		if (Local_2419.f_2 == 4)
		{
			...
			func_70(1, 0);
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !Local_2419.f_10)
			{
			...
			{
				func_93(1);
				GAMEPLAY::CLEAR_BIT(&(Local_1190[participant_id_to_int() /*18*/]), false);
				GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_310), false);
			}
			GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_310), true);
		}
		else
		{
			Local_2419.f_2++;
...
void func_112(auto uParam0)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_2))
	{
		if (!func_113())
		{
			*uParam0.f_2 = PED::CREATE_PED(4, ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(-10f, 0f, 0f), get_entity_heading(PLAYER::PLAYER_PED_ID()), 0, false);
		}
		else
		{
...
bool func_115()
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && is_entity_in_area(PLAYER::PLAYER_PED_ID(), Local_1767.f_585, Local_1767.f_588, 0, 1, 0))
	{
		return true;
	}
	return false;
...
void func_120()
{
	...
	if (Local_1767.f_15 == player_id())
	{
		GAMEPLAY::SET_BIT(&(Local_1190[participant_id_to_int() /*18*/]), false);
		Local_2419.f_1 = 1;
	}
}
...
bool func_122()
{
	if (GAMEPLAY::IS_BIT_SET(Global_1728639, true))
	{
		GAMEPLAY::CLEAR_BIT(&Global_1728639, true);
		return false;
	}
	if (func_124())
	{
	...
	if (!Local_1767.f_15 == player_id())
	{
		if (((network_is_player_a_participant(Local_1767.f_15) && network_get_participant_index(Local_1767.f_15) > -1) && GAMEPLAY::IS_BIT_SET(Local_1190[network_get_participant_index(Local_1767.f_15) /*18*/], false)) || GAMEPLAY::IS_BIT_SET(Global_2418472[Local_1767.f_15 /*313*/].f_310, false))
		{
			return true;
		}
		return false;
...
void func_130(auto uParam0, int iParam1, int iParam2, auto uParam3, auto uParam4, auto uParam5)
{
	if (Global_3934085 != *iParam1.f_11)
	{
		*iParam1.f_11 = Global_3934085;
		GAMEPLAY::SET_BIT(iParam1, 16);
	}
	if (GAMEPLAY::IS_BIT_SET(*iParam1, 16))
	{
		*iParam1.f_13 = 0;
		GAMEPLAY::CLEAR_BIT(iParam1, 16);
	}
	...
	if (((((*uParam3.f_33 == 10 || func_54(*uParam3.f_31)) || func_55(*uParam3.f_31, -1)) || func_56(*uParam3.f_31)) || func_53(*uParam3.f_31)) || (func_50(player_id()) && !GAMEPLAY::IS_BIT_SET(*iParam1, false)))
	{
		if (((*uParam0.f_50 > 0 && *uParam0.f_52 > 0) && !GAMEPLAY::IS_BIT_SET(*iParam1, 15)) || ((*uParam0.f_50 > 0 && !GAMEPLAY::IS_BIT_SET(*iParam1, 15)) && ((((func_54(*uParam3.f_31) || func_55(*uParam3.f_31, -1)) || func_56(*uParam3.f_31)) || func_53(*uParam3.f_31)) || func_50(player_id()))))
		{
	...
	else if (*uParam0.f_50 > 0 && !GAMEPLAY::IS_BIT_SET(*iParam1, 15))
	{
		func_182(iParam1, uParam3);
		GAMEPLAY::SET_BIT(iParam1, 15);
	}
		...
		switch (*iParam1.f_13)
		{
			case 0:
				if (!Global_1587507)
				{
					*iParam1.f_11 = Global_3934085;
					func_179(iParam1);
					if ((*uParam0.f_50 > 0 && GAMEPLAY::IS_BIT_SET(*iParam1, 15)) && func_178(iParam1, uParam3))
					{
						func_186(uParam0, iParam1, iParam2, uParam3, 0);
	...
	else if (((((!GAMEPLAY::IS_BIT_SET(*iParam1, false) && !func_55(*uParam3.f_31, -1)) && !func_54(*uParam3.f_31)) && !func_56(*uParam3.f_31)) && !func_53(*uParam3.f_31)) && !func_50(player_id()))
	{
		switch (*iParam1.f_14)
		{
			case 0:
				if (*uParam0.f_50 > 0 && GAMEPLAY::IS_BIT_SET(*iParam1, 15))
				{
	...
	if (((!GAMEPLAY::IS_BIT_SET(*iParam1, 9) && !GAMEPLAY::IS_BIT_SET(*iParam1, 13)) && !GAMEPLAY::IS_BIT_SET(*iParam1, 10)) && !GAMEPLAY::IS_BIT_SET(Global_2359301, 15))
	{
		if (!iLocal_122)
		{
			iLocal_124++;
...
bool func_134(auto uParam0, int iParam1, int iParam2, int iParam3, auto uParam4, int iParam5)
{
	...
	if (func_154(iParam1))
	{
		if (!GAMEPLAY::IS_BIT_SET(*iParam3, 12))
		{
			if (func_136(uParam0, iParam1, iParam2, iParam3, iParam5))
			{
				...
				network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_120, sLocal_110, sLocal_119, 2f, -1.5f, 13, 16, 2f, 0);
				network_start_synchronised_scene(iLocal_120);
				GAMEPLAY::SET_BIT(iParam3, 12);
			}
		}
		if (GAMEPLAY::IS_BIT_SET(*iParam3, 12))
		{
			...
			if (iVar0 >= 0 && is_synchronized_scene_running(iVar0))
			{
				if (get_follow_ped_cam_view_mode() != 4)
				{
					if (get_synchronized_scene_phase(iVar0) >= 0.35f)
					{
						...
						GAMEPLAY::CLEAR_BIT(iParam3, 8);
						GAMEPLAY::CLEAR_BIT(iParam3, 12);
						*iParam1.f_10 = -1;
						GAMEPLAY::CLEAR_BIT(iParam3, 2);
						GAMEPLAY::CLEAR_BIT(iParam3, 3);
						if (iParam5 == 1)
						{
							GAMEPLAY::CLEAR_BIT(iParam3, 4);
							GAMEPLAY::CLEAR_BIT(iParam3, 5);
						}
						else
						{
							GAMEPLAY::CLEAR_BIT(iParam3, false);
							GAMEPLAY::CLEAR_BIT(iParam3, true);
						}
						return true;
					}
				}
...
bool func_136(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		iVar0 = 0;
		if (GAMEPLAY::IS_BIT_SET(*iParam3, 8))
		{
			iVar0 = _0x02C40BF885C567B6(iLocal_120);
			if (iVar0 >= 0 && is_synchronized_scene_running(iVar0))
			{
				if (get_synchronized_scene_phase(iVar0) >= 0.9f)
				{
					...
					network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_120, sLocal_110, sLocal_117, 2f, -1.5f, 13, 16, 2f, 0);
					network_start_synchronised_scene(iLocal_120);
					GAMEPLAY::SET_BIT(iParam3, 11);
				}
			}
		}
	}
	if ((!is_pause_menu_active() && !func_14(0)) && !is_warning_message_active())
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(*iParam3, 5))
			{
			...
			if (GAMEPLAY::IS_BIT_SET(*iParam3, 4))
			{
		...
		else
		{
			if ((is_control_just_pressed(2, 235) || is_control_just_pressed(2, 234)) || is_control_just_pressed(2, iLocal_121))
			{
				...
				if (func_154(iParam1))
				{
					if (!GAMEPLAY::IS_BIT_SET(*iParam3, 8))
					{
						if (is_control_just_pressed(2, 235) || is_control_just_pressed(2, 234))
						{
							...
							{
								iLocal_120 = network_create_synchronised_scene(vLocal_112, 0f, 0f, IntToFloat(iLocal_111), 2, false, false, 1f, 0f, 1f);
								network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_120, sLocal_110, sLocal_118, 2f, -1.5f, 13, 16, 2f, 0);
								network_start_synchronised_scene(iLocal_120);
								GAMEPLAY::SET_BIT(iParam3, 8);
							}
						}
						else
						{
				...
				{
					GAMEPLAY::SET_BIT(iParam3, 2);
				}
				else if (is_control_just_pressed(2, 234))
				{
					GAMEPLAY::SET_BIT(iParam3, 3);
				}
				else if (is_control_just_pressed(2, iLocal_121))
				{
					if (iParam4 == 0)
					{
						if (func_153(uParam0, iParam1) == 2)
						{
							GAMEPLAY::SET_BIT(iParam3, false);
						}
						else if (func_153(uParam0, iParam1) == 1)
						{
							GAMEPLAY::SET_BIT(iParam3, true);
						}
					}
					else if (func_152(uParam0) == 4)
					{
						GAMEPLAY::SET_BIT(iParam3, 4);
					}
					else if (func_152(uParam0) == 3)
					{
						GAMEPLAY::SET_BIT(iParam3, 5);
					}
				}
			}
			if (iParam4 == 0)
			{
				if (GAMEPLAY::IS_BIT_SET(*iParam2, false) || _0x6CD79468A1E595C6(2))
				{
					...
					GAMEPLAY::CLEAR_BIT(iParam2, false);
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(*iParam2, false))
			{
				func_149(iParam2.f_10);
				func_148(_get_control_action_name(0, 225, true), "HUD_INPUT3", iParam2.f_10, 0);
				if (func_152(uParam0) == 3)
...
bool func_161(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, auto uParam6, auto uParam7, int iParam8)
{
	...
	{
		case 0:
			if ((((!GAMEPLAY::IS_BIT_SET(*iParam0, 9) && !GAMEPLAY::IS_BIT_SET(*iParam0, 13)) && !GAMEPLAY::IS_BIT_SET(*iParam0, 10)) && !GAMEPLAY::IS_BIT_SET(Global_2359301, 15)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (iParam8 == 0)
				{
				...
				if (func_174(iParam0, uParam2, iLocal_233) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					if (func_170(11 + iLocal_233, vLocal_112, uParam7))
					{
						...
						if (!iVar0)
						{
							...
							{
								if (((((func_3(player_id(), 1, 1) && !GAMEPLAY::IS_BIT_SET(Global_2428492.f_690.f_4, false)) && !func_169()) && !func_133(iParam0, iParam1)) && !func_168()) && !network_is_player_in_mp_cutscene(player_id()))
								{
									if (iParam8 == 1)
									{
									}
								...
								else
								{
									...
									if (!GAMEPLAY::IS_BIT_SET(Global_2428492.f_690.f_4, false))
									{
									}
									if (!func_169())
									{
						...
						while (iVar4 < _network_get_num_participants_host())
						{
							if (network_is_participant_active(int_to_participantindex(iVar4)))
							{
								...
								if (iVar5 != player_id())
								{
									if (func_3(iVar5, 1, 1))
									{
										fVar6 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_167(iVar5), func_167(player_id()), 1);
					...
					if (iVar0)
					{
						...
						else if (func_165(*uParam3, 1))
						{
							...
							{
								*iParam0.f_10 = iLocal_233;
								task_turn_ped_to_face_coord(PLAYER::PLAYER_PED_ID(), func_163(iParam0, uParam2), 0);
								task_look_at_coord(PLAYER::PLAYER_PED_ID(), func_163(iParam0, uParam2), -1, 0, 2);
								GAMEPLAY::SET_BIT(iParam1, false);
								GAMEPLAY::SET_BIT(&Global_2359301, 15);
								return true;
							}
						}
					}
		...
		case 1:
			...
			{
				if ((GAMEPLAY::IS_BIT_SET(*iParam0, 13) && iVar1 == 1) || (*iParam0.f_12 && iVar1 == 1))
				{
					...
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					task_go_straight_to_coord(PLAYER::PLAYER_PED_ID(), get_anim_initial_offset_position(sLocal_110, sLocal_115, vLocal_112, 0f, 0f, IntToFloat(iLocal_111), 0f, 2), 1f, 2500, vVar7.z, 0.1f);
		...
		case 2:
			if (GAMEPLAY::IS_BIT_SET(*iParam0, 9))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7)
				{
					...
					iLocal_120 = network_create_synchronised_scene(vLocal_112, 0f, 0f, IntToFloat(iLocal_111), 2, false, false, 1f, 0f, 1f);
					network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_120, sLocal_110, sLocal_116, 2f, -1.5f, 13, 16, 2f, 0);
					network_start_synchronised_scene(iLocal_120);
...
bool func_162(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	*uParam2 = iParam0;
	...
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam3[iParam0], player_id()))
		{
			*iParam1 = 1;
			return true;
		}
...
bool func_171()
{
	if (((((((((((((((((!func_3(player_id(), 1, 1) || func_172()) || is_player_free_aiming(player_id())) || is_player_targetting_anything(player_id())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || is_player_switch_in_progress()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_jumping(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_ped_going_into_cover(PLAYER::PLAYER_PED_ID())) || is_ped_climbing(PLAYER::PLAYER_PED_ID())) || is_ped_fatally_injured(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_jumping_out_of_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || _0xDCCA191DF9980FD7(PLAYER::PLAYER_PED_ID())) || is_ped_shooting(PLAYER::PLAYER_PED_ID())) || is_ped_in_cover(PLAYER::PLAYER_PED_ID(), 0))
	{
		return false;
	}
	return true;
...
bool func_173(auto uParam0, Vector3 vParam1, auto uParam2)
{
	...
	if (*uParam4[uParam0] != 0 && !GAMEPLAY::IS_BIT_SET(*uParam4[uParam0], player_id()))
	{
		return false;
	}
	if (is_position_occupied(vParam1, 0.05f, 0, 1, 0, 0, 0, false, 0) || is_position_occupied(vParam1, 0.05f, 0, 0, 1, 0, 0, PLAYER::PLAYER_PED_ID(), 1))
	{
		iVar0 = false;
		while (iVar0 < _network_get_num_participants_host())
		{
			if (network_is_participant_active(int_to_participantindex(iVar0)))
			{
				...
				if (iVar1 != player_id())
				{
					if (ENTITY::IS_ENTITY_AT_COORD(get_player_ped(iVar1), vParam1, 0.5f, 0.5f, 0.5f, false, true, 0))
					{
						return false;
					}
				}
	...
	if (((((!func_56(*uParam1.f_31) && !func_55(*uParam1.f_31, -1)) && !func_54(*uParam1.f_31)) && !*iParam0.f_12) && !func_53(*uParam1.f_31)) && !func_50(player_id()))
	{
		switch (*uParam1.f_33)
		{
			case 2:
				if (GAMEPLAY::IS_BIT_SET(*iParam0, false))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 176.2736f, -999.4766f, -97.58723f, 176.2674f, -1000.868f, -100.0624f, 1.6875f, 0, true, 0))
					{
				...
				else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 263.615f, -994.4068f, -97.69791f, 263.6068f, -996.1709f, -100.0711f, 1.5f, 0, true, 0))
				{
			...
			case 6:
				if (GAMEPLAY::IS_BIT_SET(*iParam0, false))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 201.8828f, -993.9427f, -97.58112f, 202.0024f, -995.1277f, -100.0625f, 1.6875f, 0, true, 0))
					{
				...
				else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 340.9294f, -1002.605f, -100.1962f, 340.9887f, -1000.322f, -98.19622f, 1f, 0, true, 0))
				{
			...
			case 10:
				if (GAMEPLAY::IS_BIT_SET(*iParam0, false))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 231.8411f, -975.6349f, -100.0898f, 230.3515f, -975.6111f, -96.0415f, 2.5f, 0, true, 0))
					{
				...
				else
				{
					...
					{
						if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, fVar18, 0, true, 0))
						{
							if (iVar19 == 1)
							{
								if (!GAMEPLAY::IS_BIT_SET(*iParam0, 5))
...
int func_175(auto uParam0, auto uParam1)
{
	...
	if (*uParam1.f_33 == 10)
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0, false))
		{
			return 1;
		}
	}
...
void func_186(auto uParam0, int iParam1, int iParam2, auto uParam3, int iParam4)
{
	...
	switch (func_153(uParam0, iParam1))
	{
		case 1:
			...
			if (GAMEPLAY::IS_BIT_SET(*iParam2, 6))
			{
				GAMEPLAY::CLEAR_BIT(iParam2, 6);
			}
	...
	if (!GAMEPLAY::IS_BIT_SET(*iParam1, false))
	{
		switch (func_152(uParam0))
		{
			case 3:
				...
				if (GAMEPLAY::IS_BIT_SET(*iParam2, 12))
				{
					GAMEPLAY::CLEAR_BIT(iParam2, 12);
				}
				if (!GAMEPLAY::IS_BIT_SET(*iParam2, 11))
				{
					if (*iParam1.f_14 == 3)
					{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(*iParam2, 9))
		{
			GAMEPLAY::SET_BIT(iParam2, 9);
			func_190(iParam1, iParam2, uParam3, 1, *iParam2.f_3, 0);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(*iParam2, 9))
	{
		GAMEPLAY::CLEAR_BIT(iParam2, 9);
	}
	if (func_133(iParam1, iParam2))
	{
		if (!GAMEPLAY::IS_BIT_SET(*iParam2, 10))
		{
			start_audio_scene("MP_APT_STRIPPER_SCENE");
			GAMEPLAY::SET_BIT(iParam2, 10);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(*iParam2, 10))
	{
		stop_audio_scene("MP_APT_STRIPPER_SCENE");
		GAMEPLAY::CLEAR_BIT(iParam2, 10);
	}
}
...
void func_190(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if ((((((!func_56(*uParam2.f_31) && !func_55(*uParam2.f_31, -1)) && !func_54(*uParam2.f_31)) && !*uParam0.f_12) && !func_53(*uParam2.f_31)) && !func_50(player_id())) || GAMEPLAY::IS_BIT_SET(*uParam0, false))
	{
		iVar0 = 0;
...
void func_194()
{
	if (GAMEPLAY::IS_BIT_SET(Local_1767, false) || GAMEPLAY::IS_BIT_SET(Global_1728639, false))
	{
		return;
	}
	if (func_198(player_id(), 0))
	{
		...
		{
			GAMEPLAY::SET_BIT(&Local_1767, false);
			return;
		}
	}
	else
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_1728639, false))
	{
		if (((((!network_is_in_mp_cutscene() && !is_screen_faded_out()) && !is_screen_fading_out()) && !is_screen_fading_in()) && !is_help_message_being_displayed()) && !func_117())
		{
			if (func_125(&(Local_1767.f_650), 1200, 0))
			{
				...
				GAMEPLAY::SET_BIT(&Global_1728639, false);
			}
		}
		else
		{
...
void func_201(auto uParam0)
{
	...
	if (func_90(0, uParam0))
	{
		...
		if (*uParam0.f_31 != 0)
		{
			STREAMING::REQUEST_MODEL(*uParam0.f_31);
		}
		func_69(1, uParam0);
	}
	else if (func_90(1, uParam0))
	{
		...
		if (*uParam0.f_23 != 0 && !STREAMING::HAS_MODEL_LOADED(*uParam0.f_23))
		{
			return;
		}
		if (*uParam0.f_31 != 0 && !STREAMING::HAS_MODEL_LOADED(*uParam0.f_31))
		{
			return;
		}
		iVar0 = false;
	...
	else if (func_90(2, uParam0))
	{
		...
		if ((has_anim_dict_loaded(*uParam0.f_3) && ENTITY::DOES_ENTITY_EXIST(*uParam0.f_2)) && !ENTITY::IS_ENTITY_DEAD(*uParam0.f_2, 0))
		{
		...
		if (is_synchronized_scene_running(*uParam0.f_13))
		{
			*uParam0.f_22 = get_synchronized_scene_phase(*uParam0.f_13);
			if (!is_string_null_or_empty(*uParam0.f_52))
			{
				...
				while (iVar2 < 2)
				{
					if ((!GAMEPLAY::IS_BIT_SET(*uParam0.f_45, iVar2) && !is_string_null_or_empty(*uParam0.f_46[iVar2])) && *uParam0.f_22 >= *uParam0.f_49[iVar2])
					{
						if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_2, 0))
						{
							vVar3 = {ENTITY::GET_ENTITY_COORDS(*uParam0.f_2, 1)};
						}
						AUDIO::PLAY_SOUND_FROM_COORD(-1, *uParam0.f_46[iVar2], vVar3, *uParam0.f_52, 0, 0, 0);
						GAMEPLAY::SET_BIT(uParam0.f_45, iVar2);
					}
					iVar2++;
				}
			}
...
void func_203(auto uParam0)
{
	...
	if (!func_206(vLocal_2438[uVar1 /*3*/]))
	{
		...
		vVar2.z += 0.5f;
		vVar2.x += 0.5f;
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ped_has_use_scenario_task(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar2, fVar0, fVar0, fVar0, false, true, 0))
			{
				if (does_scenario_exist_in_area(vVar2, 2f, 1))
				{
					if (!is_scenario_occupied(vVar2, 2f, 1))
					{
						if (GAMEPLAY::IS_BIT_SET(*uParam0.f_3[uVar1], true))
						{
							GAMEPLAY::CLEAR_BIT(uParam0.f_3[uVar1], true);
							if (func_205("MPTV_STAND"))
							{
								clear_help(1);
							}
						}
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_3[uVar1], false))
						{
							GAMEPLAY::SET_BIT(uParam0.f_3[uVar1], false);
							func_102("MPTV_WALK", -1);
						}
						if (*uParam0.f_2)
						{
							PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 414, true);
							task_use_nearest_scenario_to_coord(PLAYER::PLAYER_PED_ID(), vVar2, 2f, 5000);
							*uParam0.f_2 = 0;
							*uParam0.f_1 = -1;
			...
			else
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam0.f_3[uVar1], false))
				{
					GAMEPLAY::CLEAR_BIT(uParam0.f_3[uVar1], false);
					if (func_205("MPTV_WALK"))
					{
						clear_help(1);
					}
		...
		else
		{
			...
			if (is_scenario_occupied(vVar2, 2f, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_3[uVar1], true))
				{
					GAMEPLAY::SET_BIT(uParam0.f_3[uVar1], true);
					func_102("MPTV_STAND", -1);
				}
				if (*uParam0.f_2)
				{
					_0x425AECF167663F48(PLAYER::PLAYER_PED_ID(), 1);
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
...
void func_207(auto uParam0)
{
	switch (*uParam0)
	{
		...
		case 1:
			...
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_329(*uParam0.f_1, PLAYER::PLAYER_PED_ID(), 1) < 2f) && func_326(uParam0)) && func_319()) && !Local_2419)
			{
				if (*uParam0.f_8 == -1)
				{
				...
				if (!func_169())
				{
					if (func_165(*uParam0.f_8, 1))
					{
						...
						task_go_straight_to_coord(PLAYER::PLAYER_PED_ID(), get_anim_initial_offset_position(*uParam0.f_39, "enter", *uParam0.f_27, *uParam0.f_27.f_3, 0f, 2), 1f, 5000, *uParam0.f_27.f_3.f_2, 0.05f);
		...
		case 2:
			if (AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) != 1 || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), *uParam0.f_33, *uParam0.f_33.f_3, 1f, 0, true, 0))
			{
				if (func_313(uParam0))
				{
					func_312(uParam0);
...
void func_208(auto uParam0, int iParam1)
{
	...
	*uParam0.f_20 = 0;
	*uParam0.f_21 = 0;
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_26, false))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_26, false);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_26, true))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_26, true);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_26, 2))
	{
...
bool func_210(auto uParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_26, 2))
	{
		*uParam0.f_25 = network_create_synchronised_scene(*uParam0.f_27, *uParam0.f_27.f_3, 2, true, false, 1f, 0f, 1f);
		network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), *uParam0.f_25, *uParam0.f_39, "exit", 1.5f, -1.5f, 13, 16, 1.5f, 0);
		network_start_synchronised_scene(*uParam0.f_25);
		GAMEPLAY::SET_BIT(uParam0.f_26, 2);
		return true;
	}
	else
	{
...
void func_244(auto uParam0)
{
	...
	if (((iVar0 && is_control_just_pressed(2, 201)) || (iVar0 && *uParam0.f_9.f_6)) || iLocal_2431 != 0)
	{
		if (_has_item_been_unlocked(func_276(*uParam0.f_40, *uParam0.f_23), false, false, 1, -1) == 0 || func_275(*uParam0.f_40, *uParam0.f_23))
		{
			...
			{
				func_273(GAMEPLAY::GET_HASH_KEY(func_274(*uParam0.f_40, *uParam0.f_23)), func_276(*uParam0.f_40, *uParam0.f_23), 0);
				func_266(0, 10, 3);
			}
...
bool func_247(auto uParam0)
{
	...
	if (func_265())
	{
		...
		if (func_248(-1829708865, 537254313, uVar1, 1, iVar2, &iLocal_2431, func_263(*uParam0.f_40, *uParam0.f_23), GAMEPLAY::GET_HASH_KEY(func_274(*uParam0.f_40, *uParam0.f_23))))
		{
			if (iLocal_2431 == 2)
			{
				iVar0 = true;
	...
	if (iVar0)
	{
		...
		if (*uParam0.f_40 == 2)
		{
			if (*uParam0.f_23 == 0)
			{
				GAMEPLAY::SET_BIT(&iVar3, false);
			}
			else
			{
				GAMEPLAY::SET_BIT(&iVar3, true);
			}
		}
		...
		if (!func_265())
		{
			...
			if (iVar2 > 0)
			{
				network_buy_item(iVar2, func_263(*uParam0.f_40, *uParam0.f_23), 18, true, iVar4, 0, 0, GAMEPLAY::GET_HASH_KEY(func_274(*uParam0.f_40, *uParam0.f_23)), 0, iVar5);
			}
		}
		*uParam0.f_21 = 1;
		*uParam0.f_24 = func_246();
...
void func_266(int iParam0, int iParam1, int iParam2)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_270(player_id(), 1))
	{
		return;
	}
...
bool func_275(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 2:
			...
			{
				case 0:
					if (GAMEPLAY::IS_BIT_SET(iVar0, false) || Global_262145.f_12678)
					{
						return true;
					}
					break;
				...
				case 1:
					if (GAMEPLAY::IS_BIT_SET(iVar0, true) || Global_262145.f_12681)
					{
						return true;
					}
					break;
		...
		case 1:
			...
			{
				case 0:
					if (GAMEPLAY::IS_BIT_SET(iVar0, 2) || Global_262145.f_12676)
					{
						return true;
					}
					break;
				...
				case 1:
					if (GAMEPLAY::IS_BIT_SET(iVar0, 3) || Global_262145.f_12679)
					{
						return true;
					}
					break;
		...
		case 0:
			...
			{
				case 0:
					if (GAMEPLAY::IS_BIT_SET(iVar0, 4) || Global_262145.f_12677)
					{
						return true;
					}
					break;
				...
				case 1:
					if (GAMEPLAY::IS_BIT_SET(iVar0, 5) || Global_262145.f_12680)
					{
						return true;
					}
					break;
...
bool func_311(auto uParam0)
{
	...
	{
		*uParam0.f_25 = network_create_synchronised_scene(*uParam0.f_27, *uParam0.f_27.f_3, 2, true, false, 1f, 0f, 1f);
		network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), *uParam0.f_25, *uParam0.f_39, "idle", 1.5f, -1.5f, 13, 16, 1.5f, 0);
		network_start_synchronised_scene(*uParam0.f_25);
		GAMEPLAY::SET_BIT(uParam0.f_26, true);
		return true;
	}
	else
	{
...
bool func_313(auto uParam0)
{
	...
	{
		*uParam0.f_25 = network_create_synchronised_scene(*uParam0.f_27, *uParam0.f_27.f_3, 2, true, false, 1f, 0f, 1f);
		network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), *uParam0.f_25, *uParam0.f_39, "enter", 1.5f, -1.5f, 13, 16, 1.5f, 0);
		network_start_synchronised_scene(*uParam0.f_25);
		GAMEPLAY::SET_BIT(uParam0.f_26, false);
		return true;
	}
	else
	{
...
int func_326(auto uParam0)
{
	...
	vVar0 = {*uParam0.f_2};
	vVar3 = {func_328(vVar0 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))};
	fVar6 = func_327(get_entity_forward_vector(PLAYER::PLAYER_PED_ID()), vVar3);
	return fVar6 >= 0f;
}
...
void func_330(auto uParam0)
{
	...
	*uParam0.f_39 = "anim@amb@warehouse@toolbox@";
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_1))
	{
		STREAMING::REQUEST_MODEL(73014697);
		if (STREAMING::HAS_MODEL_LOADED(73014697))
		{
			Local_1767.f_96.f_1 = create_object_no_offset(73014697, *uParam0.f_2, 0, 0, 0);
			ENTITY::SET_ENTITY_ROTATION(*uParam0.f_1, *uParam0.f_2.f_3, 2, 1);
...
void func_336(int iParam0)
{
	...
	iVar0 = func_337(iParam0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && network_has_control_of_entity(iVar0))
	{
		delete_object(&iVar0);
...
void func_338(int iParam0)
{
	...
	{
		STREAMING::REQUEST_MODEL(Local_937.f_1[iParam0]);
		if (STREAMING::HAS_MODEL_LOADED(Local_937.f_1[iParam0]))
		{
			iVar12 = create_object(Local_937.f_1[iParam0], vVar6, 0, false, false);
			ENTITY::SET_ENTITY_ROTATION(iVar12, vVar9, 2, 1);
...
{
	return ENTITY::DOES_ENTITY_EXIST(Local_1767.f_473[iParam0]);
}
...
bool func_382(auto uParam0, auto uParam1)
{
	...
	{
		if (((!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_27) && !network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_26)) && !network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_25)) && !network_ENTITY::DOES_ENTITY_EXIST_with_network_id(*uParam0.f_24))
		{
			*uParam0.f_4 = 0;
			return true;
		}
...
void func_387()
{
	...
	{
		iVar1 = func_337(iVar0);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1) && network_has_control_of_entity(iVar1))
		{
			delete_object(&iVar1);
