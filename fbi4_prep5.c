...
int func_8(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_22()
{
	switch (iLocal_85)
	{
		...
		case 2:
			...
			{
				func_21(&iLocal_200);
				if (func_44(&uLocal_86, &sLocal_375, &uLocal_210))
				{
					func_39();
				}
			}
...
void func_27(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_32(player_id())) && !func_29(player_id(), 0)) && !func_28())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_32(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_34(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_37(int iParam0, Vector3 vParam1, Vector3 fParam2)
{
	if (func_195(iParam0))
	{
...
int func_38(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_44(auto uParam0, char* sParam1, auto uParam2)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<15> Var0;
	int iVar15;
...
int func_61(auto uParam0, auto uParam1, auto uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
...
bool func_62(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_69(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_83(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_84(iParam1)];
...
bool func_90(int iParam0, Vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			request_additional_text(sLocal_193, false);
...
bool func_91(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
	...
	switch (iLocal_85)
	{
		case 0:
			if (func_89(iLocal_84, iLocal_28))
			{
				...
				{
					set_blip_colour(iLocal_200, 2);
					set_blip_route_colour(iLocal_200, 2);
				}
...
int func_99(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_102(int iParam0, Vector3 vParam1, int iParam2, int iParam3, char* sParam4)
{
	if (!does_blip_exist(*iParam0))
	{
		*iParam0 = func_103(vParam1, 5, iParam4);
		if (iParam5)
		{
			set_blip_name_from_text_file(*iParam0, sParam6);
		}
	}
}

int func_103(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_110(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
bool func_111(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_117(*iParam1, 0, &uVar0))
		{
...
int func_114(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_117(int iParam0, int iParam1, auto uParam2)
{
	...
	*uParam2 = 0;
	...
	if (!func_119(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_119(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_123(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_138(iParam0, 0, 0)) || func_138(iParam0, 1, 0)) || func_138(iParam0, 2, 0)) || func_137(iParam0) != 145) || func_136(iParam0)) || func_135(iParam0)) || func_118(iParam0)) || func_134(iParam0)) || !func_126(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_135(iParam0))
		{
		}
...
bool func_138(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_139(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_139(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_143(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_146(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_145(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_145(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_144(*iParam0))
	{
...
bool func_147(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_148(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_149(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_150(iParam0, iParam1))
				{
...
int func_160(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_161(Vector3 vParam0, Vector3 fParam1)
{
	return func_162(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_162(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_171(uParam0))
	{
		...
		if (func_170(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_164(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_164(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_165(iParam0, uVar1[iVar6], 1) && func_91(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_160(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_166(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_123(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_169(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_168())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
...
int func_179(Vector3 vParam0, int iParam1)
{
	return func_180(Global_95496.f_2311.f_12.f_66, vParam0, iParam3);
}

bool func_180(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
		...
		if (iLocal_84 > 0)
		{
			...
			if (!iLocal_196)
			{
				...
				else if (!func_99(PLAYER::PLAYER_PED_ID(), vLocal_205, 75f))
				{
					...
					{
						clear_prints();
						func_183("PRE_RETSHOP", &iLocal_208);
					}
				}
			}
		}
...
bool func_184()
{
	...
	if (!func_185(iLocal_196, iVar0) && !iLocal_196)
	{
		return false;
	}
	return true;
...
void func_192(char* sParam0, char* sParam1, char* sParam2)
{
...
void func_201(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_203() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_203() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_202(iParam0));
...
int func_205(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_203() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_210(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_211(auto uParam0, int iParam1)
{
...
void func_214(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
void func_225(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_86() == 0)
		{
			...
			func_226(func_85(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
void func_226(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_84(iParam2)];
	if (iVar0 != 0)
	{
...
{
	func_236(joaat("player_zero"), 12, 20, iParam0);
	func_236(joaat("player_zero"), 12, 21, iParam0);
	func_236(joaat("player_zero"), 12, 22, iParam0);
	func_236(joaat("player_one"), 12, 13, iParam0);
	func_236(joaat("player_one"), 12, 14, iParam0);
	func_236(joaat("player_one"), 12, 15, iParam0);
	func_236(joaat("player_two"), 12, 17, iParam0);
	func_236(joaat("player_two"), 12, 18, iParam0);
	func_236(joaat("player_two"), 12, 19, iParam0);
}
...
int func_237(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
	...
	*uParam0.f_12 = func_247(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_244(iParam1, *uParam0.f_2), Global_69309, 0);
...
int func_245(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_246(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
...
int func_246(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_248(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_249(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_307(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0.f_46 = *uParam1.f_46;
	while (iVar1 < *uParam1.f_46)
	{
		...
		if (func_308(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = {-vVar9};
		}
...
int func_308(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_310(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
void func_315(int iParam0)
{
	...
	if (does_cam_exist(iLocal_201))
	{
		render_script_cams(false, false, 3000, 1, 0, 0);
		destroy_cam(iLocal_201, 0);
	}
}
