...
bool func_44(var uParam0, char* sParam1, var uParam2)
{
	switch (*uParam0)
	{
		case 0:
...
int func_61(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
...
int func_114(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_139(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
bool func_143(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_162(var uParam0, vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
int func_237(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_246(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_308(var uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
