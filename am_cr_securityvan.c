...
void func_17()
{
	...
	if (Local_186.f_4)
	{
		if (network_is_player_active(Local_358.f_16))
		{
			...
			if (Local_186.f_1)
			{
				if (does_entity_exist(get_vehicle_ped_is_in(Local_186.f_2, 0)))
				{
	...
	if (does_entity_exist(Local_186.f_2))
	{
...
bool func_21(int iParam0, int iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!func_14(uParam2))
	{
		func_34(uParam2, 0, 0);
...
bool func_22(int iParam0, int iParam1, int iParam2, var uParam3, float fParam4, int iParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_27()
{
	if (network_does_entity_exist_with_network_id(Local_358.f_5))
	{
...
bool func_37(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_39(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_11(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_6(iVar1)))
					{
...
Vector3 func_62()
{
	...
	iVar6 = get_entity_model(iLocal_181);
	if (iVar6 != 0)
	{
		...
		if (!is_bit_set(Local_383[participant_id_to_int() /*7*/].f_5, false))
		{
			if ((Local_383[participant_id_to_int() /*7*/].f_6 || uLocal_164) || func_27())
			{
				if (vdist(vLocal_170, vLocal_146) <= 60f)
				{
					...
					{
						set_bit(&(Local_383[participant_id_to_int() /*7*/].f_5), false);
					}
				}
				else
				{
			...
			if (!iLocal_160)
			{
				if (is_ped_in_vehicle(iLocal_182, iLocal_181, 0))
				{
					if (is_ped_being_jacked(iLocal_182))
					{
						...
						{
							if (get_entity_model(get_vehicle_ped_is_using(iLocal_184)) == joaat("stockade"))
							{
...
void func_179(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
	Param0 = 0;
...
void func_182()
{
	iLocal_184 = player_ped_id();
	iLocal_185 = player_id();
	iLocal_167 = does_entity_exist(iLocal_184);
	iLocal_168 = true;
	iLocal_160 = true;
	iLocal_159 = false;
	if (iLocal_167)
	...
	iLocal_166 = network_does_entity_exist_with_network_id(Local_358.f_3);
	if (iLocal_166)
	{
		iLocal_182 = net_to_ped(Local_358.f_3);
		iLocal_160 = is_ped_injured(iLocal_182);
	}
	if (!iLocal_160)
	{
		vLocal_176 = {get_entity_coords(iLocal_182, 1)};
	}
	iLocal_161 = network_does_entity_exist_with_network_id(Local_358.f_4);
	if (iLocal_161)
	{
		iLocal_183 = net_to_ped(Local_358.f_4);
		iLocal_162 = is_ped_injured(iLocal_183);
	}
	iLocal_165 = network_does_entity_exist_with_network_id(Local_358.f_2);
	if (iLocal_165)
	{
