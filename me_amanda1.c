...
{
	return shift_right(iParam0, 26) & 31 * func_329(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
int func_383(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_385() == 0)
		{
			return is_bit_set(func_114(func_384(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_463(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_346(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_346(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_466(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_465())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_346(iVar2 + 1)))
				{
