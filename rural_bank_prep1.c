...
void main()
{
	...
	while (true)
	{
		...
		func_251(&uLocal_494);
		if (((((iLocal_1475 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_94[0 /*2*/])) && is_vehicle_driveable(Local_94[0 /*2*/], 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0)) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 1)) < 5625f)
		{
			iVar0 = false;
			if ((!Local_82.f_7 && is_ped_on_foot(PLAYER::PLAYER_PED_ID())) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				iVar1 = false;
				...
				{
					iVar2 = 0;
					get_ammo_in_clip(PLAYER::PLAYER_PED_ID(), iVar1, &iVar2);
					if (iVar2 < get_max_ammo_in_clip(PLAYER::PLAYER_PED_ID(), iVar1, 1))
					{
						iVar0 = true;
					}
				}
...
void func_8()
{
	...
	if (!iLocal_442)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_428) && is_vehicle_driveable(iLocal_428, 0)) && does_entity_belong_to_this_script(iLocal_428, 1))
		{
	...
	switch (iLocal_1476)
	{
		...
		case 2:
			...
			while (iVar0 <= 9 - 1)
			{
				...
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 400f)
					{
						if (!is_ped_in_combat(Local_111[iVar0 /*14*/], false))
						{
							task_combat_ped(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
						}
						iLocal_457 = false;
					}
					else
		...
		case 3:
			if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
			{
	...
	*iParam0.f_15 = 0;
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(*iParam0.f_17[iVar0]))
		{
			...
			if (iParam1)
			{
				if (is_ped_group_member(*iParam0.f_17[iVar0], func_34()) && *iParam0.f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
int func_42(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_43(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_43(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_103(iParam0, 0, 0)) || func_103(iParam0, 1, 0)) || func_103(iParam0, 2, 0)) || func_102(iParam0) != 145) || func_101(iParam0)) || func_100(iParam0)) || func_99(iParam0)) || func_98(iParam0)) || !func_90(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_100(iParam0))
		{
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_136(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_133(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
{
	return shift_right(iParam0, 26) & 31 * func_117(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_141()
{
	...
	while (iLocal_447 <= 9 - 1)
	{
		...
		if ((((func_31(Local_111[iLocal_447 /*14*/]) && GAMEPLAY::GET_GAME_TIMER() - iLocal_455 > 8000) && iLocal_456) && !is_ambient_speech_playing(Local_111[iLocal_447 /*14*/])) && !is_ped_in_any_vehicle(Local_111[iLocal_447 /*14*/], 0))
		{
	...
	{
		if (is_entity_in_angled_area(Local_94[0 /*2*/], -1521.829f, 2725.003f, 16.64367f, -1600.763f, 2794.875f, 21.45629f, 30f, 0, true, 0) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
	...
	if (func_31(Local_94[0 /*2*/]) && func_31(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_1475 > 0)
		{
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 650f)
			{
				func_183(5);
			}
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 600f)
			{
				if (!iLocal_454)
				{
	...
	if (func_31(Local_94[0 /*2*/]))
	{
		...
		if (iVar0)
		{
			if ((!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0) && !is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) && !is_ped_shooting(PLAYER::PLAYER_PED_ID()))
			{
				if (!is_ped_headtracking_entity(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/]))
				{
					task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], -1, 2048, 1);
				}
			}
			else if (is_ped_headtracking_entity(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/]))
			{
				task_clear_look_at(PLAYER::PLAYER_PED_ID());
			}
		}
	...
	if (!iLocal_444)
	{
		...
		if (fLocal_441 < 3f)
		{
			...
			while (iVar2 < Local_94)
			{
				...
				{
					if (ENTITY::IS_ENTITY_DEAD(uLocal_429[iVar2], 0) || !is_vehicle_driveable(uLocal_429[iVar2], 0))
					{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_88108[iVar2]))
				{
					if (ENTITY::IS_ENTITY_DEAD(Global_88108[iVar2], 0) || !is_vehicle_driveable(Global_88108[iVar2], 0))
					{
	...
	if (!iLocal_443)
	{
		if (func_144(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 0, 0))
		{
			iLocal_443 = 1;
			_0xD9F692D349249528();
	...
	else if (!func_144(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 0, 0))
	{
		if (get_player_wanted_level(player_id()) == 0)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!iLocal_1486)
			{
				func_143(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 725);
				func_142(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 718);
				iLocal_1486 = 1;
			}
		}
		else if (iLocal_1486)
		...
		if (!iLocal_1487)
		{
			func_143(PLAYER::PLAYER_PED_ID(), 722);
			iLocal_1487 = 1;
		}
	}
	if (!iLocal_442)
	{
		...
		else if ((ENTITY::DOES_ENTITY_EXIST(get_players_last_vehicle()) && is_vehicle_driveable(get_players_last_vehicle(), 0)) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(get_players_last_vehicle(), 1)) < 10000f)
		{
			iVar5 = get_players_last_vehicle();
		}
		if ((((((ENTITY::DOES_ENTITY_EXIST(iVar5) && is_vehicle_driveable(iVar5, 0)) && iVar5 != iLocal_428) && iVar5 != Local_94[1 /*2*/]) && iVar5 != Local_94[2 /*2*/]) && iVar5 != Local_94[0 /*2*/]) && is_this_model_a_car(ENTITY::GET_ENTITY_MODEL(iVar5)))
		{
	...
	if (iLocal_1475 < 1)
	{
		if (!is_audio_scene_active("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar0 < 3)
			{
				...
				{
					if (vdist2(ENTITY::GET_ENTITY_COORDS(Local_94[iVar0 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 1000f)
					{
...
bool func_149()
{
	...
	while (iVar0 < 3)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_94[iVar0 /*2*/]) && is_vehicle_driveable(Local_94[iVar0 /*2*/], 0)) && is_entity_in_angled_area(Local_94[iVar0 /*2*/], -1591.019f, 2803.731f, 15.41812f, -1569.92f, 2777.878f, 22.14856f, 8.25f, 0, true, 0))
		{
			return true;
		}
		iVar0++;
...
bool func_153(int iParam0)
{
	if (!func_154())
	{
		...
		{
			if (func_31(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
...
bool func_155(int iParam0)
{
	if (!func_154())
	{
		...
		{
			if (func_31(PLAYER::PLAYER_PED_ID()) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
			{
		...
		case 0:
			if (!iLocal_456)
			{
				...
				if (((((func_31(Local_111[4 /*14*/]) && func_31(Local_111[0 /*14*/])) && func_31(Local_111[5 /*14*/])) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[0 /*2*/]))
				{
					...
					fVar1 = vdist(ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0));
					if (vdist(ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0)) > fVar1)
					{
						fVar1 = vdist(ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0));
					}
			...
			switch (iLocal_435)
			{
					...
					switch (iLocal_436)
					{
						...
						case 1:
							...
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[1 /*2*/]))
							{
								...
								{
									open_sequence_task(&iLocal_446);
									if (vdist2(ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0)) < 1000f)
									{
						...
						case 2:
							...
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[0 /*2*/]))
							{
								...
								{
									open_sequence_task(&iLocal_446);
									if (vdist2(ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0)) < 1000f)
									{
						...
						case 3:
							if ((func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/]))
							{
								if (is_ped_in_vehicle(Local_111[0 /*14*/], Local_94[1 /*2*/], 0))
								{
									...
									if (vdist2(ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0)) < 1000f)
									{
				...
				case 2:
					...
					while (iVar0 <= 9 - 1)
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 75f)
							{
				...
				case 3:
					...
					while (iVar0 <= 9 - 1)
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 120f)
							{
								set_ped_combat_movement(Local_111[iVar0 /*14*/], 1);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 51, false);
								Local_111[iVar0 /*14*/].f_12 = 0;
				...
				case 4:
					if (func_165(PLAYER::PLAYER_PED_ID(), vLocal_49, 1) < 30f)
					{
						iVar7 = 1;
					}
					iVar0 = 0;
					while (iVar0 <= 9 - 1)
					{
						if ((func_31(PLAYER::PLAYER_PED_ID()) && func_31(Local_111[iVar0 /*14*/])) && func_31(Local_94[0 /*2*/]))
						{
							...
							else if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > 120f / 2f)
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, true);
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > 120f * 2f)
								{
								...
								{
									if (func_162(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*14*/], 1) < 35f)
									{
										...
										if (get_entity_speed(PLAYER::PLAYER_PED_ID()) < 2f && func_162(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*14*/], 1) < 20f)
										{
											PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, true);
										}
										else
							...
							else if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, false);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, true);
								remove_ped_defensive_area(Local_111[iVar0 /*14*/], 0);
...
int func_166()
{
	if (func_31(PLAYER::PLAYER_PED_ID()) && func_31(Local_94[0 /*2*/]))
	{
		...
		else if (func_165(PLAYER::PLAYER_PED_ID(), vLocal_460, 1) <= 120f)
		{
			return 2;
		}
		else if (func_165(PLAYER::PLAYER_PED_ID(), vLocal_460, 1) > 120f && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
			return 3;
		}
	}
...
void func_170()
{
	...
	while (iVar0 <= 9 - 1)
	{
		if (func_31(Local_111[iVar0 /*14*/]))
		{
			if (((((is_ped_in_combat(Local_111[iVar0 /*14*/], false) || is_ped_in_melee_combat(Local_111[iVar0 /*14*/])) || is_ped_being_stunned(Local_111[iVar0 /*14*/], 0)) || is_ped_being_stealth_killed(Local_111[iVar0 /*14*/])) || is_ped_being_jacked(Local_111[iVar0 /*14*/])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 1))
			{
				iLocal_456 = true;
			}
			...
			if (has_entity_clear_los_to_entity_in_front(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID()) && (is_player_free_aiming_at_entity(player_id(), Local_111[iVar0 /*14*/]) || is_player_targetting_entity(player_id(), Local_111[iVar0 /*14*/])))
			{
				if (iLocal_459 != 0)
				{
	...
	if (func_31(Local_94[1 /*2*/]))
	{
		if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_94[1 /*2*/], PLAYER::PLAYER_PED_ID(), 0) || has_vehicle_got_projectile_attached(PLAYER::PLAYER_PED_ID(), Local_94[1 /*2*/], 0, -1)) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[1 /*2*/], 1)) || is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[1 /*2*/]))
		{
			iLocal_456 = true;
		}
		else if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), Local_94[1 /*2*/]))
				{
					iLocal_456 = true;
				}
			}
		}
		if (func_174(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), 30f, 0))
		{
			iLocal_456 = true;
		}
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar1 = {func_173(ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0))};
			vVar4 = {ENTITY::GET_ENTITY_VELOCITY(Local_94[1 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))};
	...
	if (func_31(Local_94[2 /*2*/]))
	{
		if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_94[2 /*2*/], PLAYER::PLAYER_PED_ID(), 0) || has_vehicle_got_projectile_attached(PLAYER::PLAYER_PED_ID(), Local_94[2 /*2*/], 0, -1)) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[2 /*2*/], 1)) || is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[2 /*2*/]))
		{
			iLocal_456 = true;
		}
		else if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("towtruck")) || is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("towtruck2")))
			{
				if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), Local_94[2 /*2*/]))
				{
					iLocal_456 = true;
				}
			}
		}
		if (func_174(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0), 30f, 0))
		{
			iLocal_456 = true;
		}
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar7 = {func_173(ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0))};
			vVar10 = {ENTITY::GET_ENTITY_VELOCITY(Local_94[2 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))};
	...
	if (func_31(Local_94[0 /*2*/]))
	{
		if (func_162(PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1) < 45f && get_player_wanted_level(player_id()) > 0)
		{
			iLocal_456 = true;
		}
		if (func_174(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), 30f, 0))
		{
			iLocal_456 = true;
		}
		if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_94[0 /*2*/], PLAYER::PLAYER_PED_ID(), 0) || has_vehicle_got_projectile_attached(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0, -1)) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 1)) || is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/]))
		{
			iLocal_456 = true;
		}
		else if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("towtruck")) || is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("towtruck2")))
			{
				if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), Local_94[0 /*2*/]))
				{
					iLocal_456 = true;
				}
			}
		...
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar13 = {func_173(ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0))};
			vVar16 = {ENTITY::GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))};
			fLocal_464 = func_172(vVar16, vVar13);
		}
		if (func_171())
		{
			iVar19 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
			if (is_vehicle_driveable(iVar19, 0))
			{
				...
				vVar20 = {func_173(ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0))};
				vVar23 = {ENTITY::GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))};
...
void func_176()
{
	...
	if (((((func_31(Local_94[0 /*2*/]) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/])) && func_31(Local_111[4 /*14*/])) && func_31(Local_111[0 /*14*/])) && func_31(Local_111[5 /*14*/]))
	{
		...
		{
			case 0:
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, true, 0))
				{
					if (get_entity_speed(Local_94[1 /*2*/]) < 1f && get_entity_speed(PLAYER::PLAYER_PED_ID()) < 1f)
					{
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, true, 0))
				{
					if (get_entity_speed(Local_94[0 /*2*/]) < 1f && get_entity_speed(PLAYER::PLAYER_PED_ID()) < 1f)
					{
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, true, 0))
				{
					if (get_entity_speed(Local_94[2 /*2*/]) < 1f && get_entity_speed(PLAYER::PLAYER_PED_ID()) < 1f)
					{
				...
				if (fLocal_1481[1] > 1.5f)
				{
					...
					task_aim_gun_at_coord(false, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1000, 0, 1);
					task_go_to_entity_while_aiming_at_entity(false, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 3f, 4f, 1, 0, -957453492);
			...
			case 1:
					...
					case 3:
						if (GAMEPLAY::GET_GAME_TIMER() - iLocal_473 > 8000 && !func_9())
						{
							if (!is_ped_in_any_vehicle(iLocal_474, 0))
							{
								...
								{
									open_sequence_task(&iLocal_446);
									task_shoot_at_coord(false, get_offset_from_entity_in_world_coords(PLAYER::PLAYER_PED_ID(), 0.5f, 0f, -1f), 1000, 1566631136);
									task_go_to_entity_while_aiming_at_entity(false, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 4f, 4f, 1, 0, -957453492);
									task_aim_gun_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 0);
									close_sequence_task(iLocal_446);
				...
				if ((!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, true, 0) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, true, 0)) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, true, 0))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iLocal_474, 1630799643) != 1)
					{
						task_aim_gun_at_entity(iLocal_474, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
					if (timera() > 3000)
					{
						if (!is_ped_in_any_vehicle(iLocal_474, 0))
...
void func_200(Vector3 vParam0, Vector3 fParam1)
{
	...
	ENTITY::SET_ENTITY_HEALTH(Local_94[0 /*2*/], get_entity_health(Local_94[0 /*2*/]) * 2);
...
void func_220()
{
	...
	while (iLocal_447 <= 3 - 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_101[iLocal_447 /*2*/]) && !PED::IS_PED_INJURED(Local_101[iLocal_447 /*2*/]))
		{
			...
			{
				set_ped_coords_no_gang(Local_101[iLocal_447 /*2*/], ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(Local_101[iLocal_447 /*2*/], 0), 1) + Vector(0f, -2f, 0f));
			}
	...
	while (iLocal_447 <= 9 - 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_447 /*14*/]))
		{
			...
			if (!PED::IS_PED_INJURED(Local_111[iLocal_447 /*14*/]))
			{
				...
				{
					set_ped_coords_no_gang(Local_111[iLocal_447 /*14*/], ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(Local_111[iLocal_447 /*14*/], 0), 1) + Vector(0f, -2f, 0f));
				}
...
void func_228()
{
	switch (iLocal_1474)
	{
		...
		case 0:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_1478 > 2500)
			{
				iLocal_1478 = GAMEPLAY::GET_GAME_TIMER();
			}
			break;
	}
}
...
int func_286(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_288() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_267(func_287(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
bool func_307()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_9[9]))
		{
