...
bool func_104(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_105()
{
	...
	switch (iLocal_1476)
	{
		case 0:
			...
			set_relationship_between_groups(5, 1862763509, iLocal_493);
			_0x293220DA1B46CEBC(3f, 5f, 4);
			iLocal_1476++;
			break;
...
void func_125(int iParam0, var uParam1, vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_122(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
bool func_133(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
							...
							if (is_entity_at_coord(Local_111[0 /*14*/], -1885.875f, 3006.152f, 31.81027f, 5f, 5f, 5f, false, true, 0))
							{
								...
								while (iVar0 <= 9 - 1)
								{
									if (func_31(Local_111[iVar0 /*14*/]))
									{
										...
										set_ped_combat_attributes(Local_111[iVar0 /*14*/], 3, true);
										set_ped_combat_attributes(Local_111[iVar0 /*14*/], 1, true);
				...
				case 1:
					...
					while (iVar0 <= 9 - 1)
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(player_ped_id()))
						{
							...
							set_ped_combat_attributes(Local_111[iVar0 /*14*/], 0, true);
							set_ped_combat_attributes(Local_111[iVar0 /*14*/], 50, true);
							set_ped_config_flag(Local_111[iVar0 /*14*/], 184, false);
					...
					while (iVar0 <= 9 - 1)
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(player_ped_id()))
						{
							...
							if (get_distance_between_coords(get_entity_coords(Local_111[iVar0 /*14*/], 0), get_entity_coords(player_ped_id(), 1), 1) < 75f)
							{
								...
								{
									set_ped_combat_attributes(Local_111[iVar0 /*14*/], 51, true);
							...
							{
								set_ped_combat_movement(Local_111[iVar0 /*14*/], 1);
								set_ped_combat_attributes(Local_111[iVar0 /*14*/], 51, false);
				...
				case 4:
					...
					while (iVar0 <= 9 - 1)
					{
						if ((func_31(player_ped_id()) && func_31(Local_111[iVar0 /*14*/])) && func_31(Local_94[0 /*2*/]))
						{
							...
							{
								set_ped_combat_attributes(Local_111[iVar0 /*14*/], 1, false);
								set_ped_combat_attributes(Local_111[iVar0 /*14*/], 3, true);
									...
									if (!is_ped_in_any_vehicle(Local_111[iVar0 /*14*/], 0) && !is_entity_on_screen(Local_111[iVar0 /*14*/]))
									{
										...
										if (func_31(iVar9))
										{
											...
											if (func_163(iVar9))
											{
												...
												set_ped_combat_attributes(Local_111[iVar0 /*14*/], 3, false);
											}
											else
											{
												set_ped_as_no_longer_needed(&(Local_111[iVar0 /*14*/]));
...
var func_162(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_180(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_206(int iParam0, int iParam1)
{
	...
	Local_111[iParam0 /*14*/] = create_ped_inside_vehicle(iParam1, 26, iVar0, iVar1, 1, true);
	set_ped_relationship_group_hash(Local_111[iParam0 /*14*/], iLocal_493);
	...
	set_ped_combat_attributes(Local_111[iParam0 /*14*/], 0, true);
	set_ped_combat_attributes(Local_111[iParam0 /*14*/], 1, false);
	set_ped_combat_movement(Local_111[iParam0 /*14*/], 1);
	set_ped_config_flag(Local_111[iParam0 /*14*/], 184, true);
	set_ped_config_flag(Local_111[iParam0 /*14*/], 272, true);
...
bool func_214(var uParam0, char* sParam1)
{
	int iVar0;
	int iVar1;
...
bool func_216(var uParam0, vector3 vParam1, float fParam2, int iParam3)
{
...
void func_231(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_232(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_232(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5, int iParam6)
{
	*uParam0.f_6 = 0;
	func_233(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_233(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
...
void func_241(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_252()
{
	...
	set_relationship_between_groups(5, iLocal_493, 1862763509);
	set_relationship_between_groups(5, iLocal_493, iLocal_492);
	set_relationship_between_groups(5, iLocal_492, iLocal_493);
	set_relationship_between_groups(1, iLocal_493, -1533126372);
	set_relationship_between_groups(1, -1533126372, iLocal_493);
	set_relationship_between_groups(1, iLocal_493, iLocal_493);
	set_relationship_between_groups(1, iLocal_493, -472287501);
	set_relationship_between_groups(1, -472287501, iLocal_493);
...
bool func_260(var uParam0, var uParam1, int iParam2, int iParam3)
{
...
bool func_265(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_299(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	*uParam0.f_4 = iParam5;
	*uParam0 = sParam1;
	*uParam0.f_1 = {Param2};
...
bool func_307()
{
	...
	while (iVar0 <= 9 - 1)
	{
		if (func_31(Local_111[iVar0 /*14*/]))
		{
			set_ped_relationship_group_hash(Local_111[iVar0 /*14*/], iLocal_493);
...
void func_309(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_199())
	{
