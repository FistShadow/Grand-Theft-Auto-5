...
void main()
{
	...
	while (true)
	{
		...
		if ((Global_14413.f_1 != 9 && Global_16746 == 0) && Global_16745 == 0)
		{
			...
			else if (func_3(2, Global_14381, 0) || is_bit_set(Global_2284, 12))
			{
...
void func_28()
{
	...
	{
		if (func_31(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
	...
	if (Global_14391 == 0)
	{
		if ((func_3(2, Global_14382, 0) || Global_2563382 == 1) || Global_16772 == 1)
		{
			...
			if (iLocal_33 < iLocal_492)
			{
				...
				if (iLocal_33 == 0)
				{
					if (is_bit_set(Global_2563397, 25))
					{
						clear_bit(&Global_2563397, 25);
					}
					if (Global_2562131 > 0)
					{
...
float func_40(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, int iParam5)
{
	...
	fVar3 = func_42(to_float(get_game_timer() - iLocal_18) / fParam12, 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (iParam13)
