#region Local Var
	...
	int iLocal_126 = 0;
	int iLocal_127 = 0;
	struct<6> Local_128 = 0;
	struct<6> Local_134 = 0;
	int iLocal_140 = 0;
	int iLocal_141 = 0;
	int iLocal_142 = 0;
	int iLocal_143 = 0;
	...
	auto uLocal_187 = 0;
	auto uLocal_188 = 0;
	Vector3 fLocal_189 = 0;
	Vector3 vLocal_190 = 0;
	auto uLocal_193 = 0;
	int iLocal_194 = 0;
	auto uLocal_195 = 16;
	auto uLocal_196 = 0;
...
void main()
{
	...
	iLocal_43 = 64;
	fLocal_47 = -1f;
	iLocal_55 = _0x4A9923385BDB9DAD();
	iLocal_56 = _get_blip_info_id_iterator();
	...
	vLocal_63 = {Local_360.f_1[0 /*3*/]};
	func_264();
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			if (is_ped_in_group(iLocal_85))
			{
				remove_ped_from_group(iLocal_85);
			}
		}
		func_242();
	}
	...
	while (true)
	{
					...
					if (is_player_playing(player_id()))
					{
						switch (iLocal_58)
						{
							case 0:
								...
								switch (iLocal_59)
								{
									...
									case 9:
										if (!PED::IS_PED_INJURED(iLocal_85))
										{
											if (is_entity_at_coord(iLocal_85, vLocal_93, 200f, 200f, 200f, false, true, 0))
											{
												task_follow_nav_mesh_to_coord(iLocal_85, vLocal_93, 1f, -1, 0.25f, 0, 1193033728);
											}
											else
											{
												task_wander_standard(iLocal_85, 1193033728, 0);
											}
								...
								if ((func_52() && !func_51()) && iLocal_59 != 10)
								{
									if (!PED::IS_PED_INJURED(iLocal_85))
									{
										if (is_entity_at_coord(iLocal_85, vLocal_97, 5f, 5f, 5f, false, true, 0))
										{
											func_50(0);
											wait(false);
											func_48();
							...
							case 1:
								...
								if (iLocal_60 == 1)
								{
									func_1(&uLocal_195, sLocal_178, "REHH1_AGG", 4, 0, 0, 0);
								}
								else if (iLocal_60 == 2)
								{
									func_1(&uLocal_195, sLocal_178, "REHH2_AGG", 4, 0, 0, 0);
								}
								else if (iLocal_60 == 3)
								{
									func_1(&uLocal_195, sLocal_178, "REHH3_AGG", 4, 0, 0, 0);
									if (!PED::IS_PED_INJURED(iLocal_86))
									{
										clear_ped_tasks(iLocal_86);
										task_smart_flee_ped(iLocal_86, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
										set_ped_keep_task(iLocal_86, true);
									}
								}
								else if (iLocal_60 == 5)
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_AGG", 4, 0, 0, 0);
								}
								if (!PED::IS_PED_INJURED(iLocal_85))
								{
									clear_ped_tasks(iLocal_85);
									task_smart_flee_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
									set_ped_keep_task(iLocal_85, true);
									func_53();
								}
								break;
		...
		if (iLocal_59 > 2)
		{
			if (is_player_playing(player_id()))
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					if (!PED::IS_PED_INJURED(iLocal_85))
					{
						if (!is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
						{
							func_53();
						}
					}
		...
		if (iLocal_59 > 0 && iLocal_59 < 8)
		{
			if (is_player_playing(player_id()))
			{
				...
				else if (!is_ped_ragdoll(iLocal_85))
				{
					if (has_entity_been_damaged_by_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 0))
					{
						clear_ped_tasks(iLocal_85);
						task_smart_flee_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
						func_53();
					}
				}
			}
...
void func_17(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_24(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
void func_34(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_57()
{
	...
	{
		if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_86, 25f, 25f, 25f, 0, 1, 0) && !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 40f, 40f, 40f, 0, 1, 0))
		{
			clear_ped_tasks(iLocal_86);
			task_follow_nav_mesh_to_coord(iLocal_86, vLocal_93, 1f, -1, 0.25f, 0, 1193033728);
			func_18();
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_86))
	{
		if (has_entity_been_damaged_by_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (func_54())
			{
				Var0 = {func_60()};
		...
		if (timerb() > 5000)
		{
			if (is_ped_in_combat(iLocal_86, PLAYER::PLAYER_PED_ID()))
			{
				iLocal_159 = 4;
			}
		}
	...
	if (!iLocal_113)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			if (has_entity_been_damaged_by_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!PED::IS_PED_INJURED(iLocal_86))
				{
					func_48();
					wait(false);
					func_1(&uLocal_195, sLocal_178, "REHH3_JB2", 4, 0, 0, 0);
					iLocal_113 = 1;
				}
			}
		}
	...
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if (is_ped_ragdoll(iLocal_85))
		{
			clear_ped_secondary_task(iLocal_85);
		}
		if (PED::IS_PED_INJURED(iLocal_86) && is_entity_at_coord(iLocal_85, get_entity_coords(iLocal_86, 0), 1f, 1f, 5f, false, true, 0))
		{
			iLocal_159 = 5;
		}
	}
	...
	{
		task_combat_ped(iLocal_86, PLAYER::PLAYER_PED_ID(), 0, 16);
		func_53();
	}
	else
	{
	...
	if (!iLocal_170)
	{
		...
		if (PED::IS_PED_INJURED(iLocal_86))
		{
			...
			if (has_entity_been_damaged_by_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 1) && is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
			{
				iLocal_159 = 2;
			}
		}
		else if (!is_entity_dead(iLocal_85, 0))
		{
			if (has_entity_been_damaged_by_entity(iLocal_85, iLocal_86, 1))
			{
				iLocal_159 = 2;
			}
		}
	...
	switch (iLocal_159)
	{
		case 0:
			if (!iLocal_168)
			{
				if (!PED::IS_PED_INJURED(iLocal_85) && !PED::IS_PED_INJURED(iLocal_86))
				{
					if (!is_ped_in_any_vehicle(iLocal_85, 0) && is_ped_in_melee_combat(iLocal_86))
					{
						if (!iLocal_169)
						{
							open_sequence_task(&iLocal_89);
							task_look_at_entity(false, iLocal_86, -1, 2052, 2);
							task_play_anim(false, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
							task_turn_ped_to_face_entity(false, iLocal_86, -1);
							close_sequence_task(iLocal_89);
							task_perform_sequence(iLocal_85, iLocal_89);
							clear_sequence_task(&iLocal_89);
							iLocal_169 = 1;
						}
					}
				}
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				task_leave_any_vehicle(iLocal_85, false, 0);
				settimerb(false);
				iLocal_159 = 0;
			}
			break;
		...
		case 2:
			if (!iLocal_170)
			{
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					...
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_GUN", 4, 0, 0, 0);
					}
					else
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_AGG", 4, 0, 0, 0);
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					play_pain(iLocal_85, 7, 0f, 0);
				}
				func_1(&uLocal_195, sLocal_178, "REHH3_BAS", 4, 0, 0, 0);
				if (!PED::IS_PED_INJURED(iLocal_85) && ENTITY::DOES_ENTITY_EXIST(iLocal_86))
				{
					...
					task_play_anim(false, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
					task_look_at_entity(false, iLocal_86, -1, 2052, 4);
					task_follow_nav_mesh_to_coord(false, get_entity_coords(iLocal_86, 0), 1f, -1, 3f, 0, 1193033728);
					task_turn_ped_to_face_entity(false, iLocal_86, -1);
					task_play_anim(false, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 1, 0, 0, 0, 0);
					task_play_anim(false, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
					...
					clear_sequence_task(&iLocal_89);
					set_ped_keep_task(iLocal_85, true);
					set_blocking_of_non_temporary_events(iLocal_85, false);
					wait(10000);
					iLocal_168 = 1;
					iLocal_159 = 0;
				}
		...
		case 4:
			if (func_58())
			{
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					if (is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 15f, 15f, 15f, 0, 1, 0))
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH3_NOO", 4, 0, 0, 0))
						{
							settimerb(false);
							iLocal_159 = 0;
						}
			...
			{
				if (func_1(&uLocal_195, sLocal_178, "REHH3_FHT", 4, 0, 0, 0))
				{
					settimerb(false);
					iLocal_159 = 0;
				}
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				func_55();
				wait(false);
				if (func_1(&uLocal_195, sLocal_178, "REHH3_ATT", 4, 0, 0, 0))
				{
					iLocal_159 = 0;
				}
			}
...
void func_62()
{
	...
	if (iLocal_60 == 1)
	{
		stop_sound(iLocal_177);
		stop_audio_scene("TIMER_SCENE");
		if (!iLocal_124)
		{
			func_48();
			wait(false);
			func_1(&uLocal_195, sLocal_178, "REHH1_TKA", 4, 0, 0, 0);
			set_gameplay_coord_hint(-1055.515f, -2533.221f, 19.3049f, -1, 3000, 2000, 0);
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				func_82(func_8(), 1, 100, 0, 1);
				func_81(198, 0);
				task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 8000, 2052, 4);
				open_sequence_task(&iLocal_89);
				task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
				task_leave_any_vehicle(false, 3000, 4194369);
				task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 1000);
				task_follow_nav_mesh_to_coord(false, -1055.515f, -2533.221f, 19.3049f, 2f, -1, 0.25f, 1, 1193033728);
				task_go_straight_to_coord(false, -1046.832f, -2518.146f, 12.9447f, 2f, -1, 1193033728, 0.5f);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85) || timerb() > 15000)
		{
			if (is_entity_at_coord(iLocal_85, -1046.832f, -2518.146f, 12.9447f, 20f, 20f, 5f, false, true, 0) || timerb() > 15000)
			{
				delete_ped(&iLocal_85);
				func_18();
			}
	...
	else if (iLocal_60 == 2)
	{
		if (!iLocal_124)
		{
			func_48();
			wait(false);
			func_1(&uLocal_195, sLocal_178, "REHH2_TKB", 4, 0, 0, 0);
			iLocal_124 = 1;
		}
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			if (!is_ped_ragdoll(iLocal_85))
			{
				open_sequence_task(&iLocal_89);
				task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
				task_pause(false, 4500);
				task_leave_any_vehicle(false, false, 4194369);
				task_follow_nav_mesh_to_coord(false, 3323.43f, 5166.832f, 17.406f, 1f, -1, 0.25f, 0, 1193033728);
				task_follow_nav_mesh_to_coord(false, 3320.684f, 5186.017f, 17.4016f, 1f, -1, 0.25f, 0, 1193033728);
				task_follow_nav_mesh_to_coord(false, 3303.612f, 5185.269f, 18.7155f, 1f, -1, 0.25f, 0, 1193033728);
				task_start_scenario_in_place(false, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				close_sequence_task(iLocal_89);
				task_perform_sequence(iLocal_85, iLocal_89);
				clear_sequence_task(&iLocal_89);
				set_ped_keep_task(iLocal_85, true);
				task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 5000, 2052, 2);
				remove_ped_from_group(iLocal_85);
				wait(1000);
				set_player_control(player_id(), true, 0);
				if (func_8() == 0)
	...
	else if (iLocal_60 == 3)
	{
		if (timera() > 1000)
		{
			if (func_1(&uLocal_195, sLocal_178, "REHH3_JB", 4, 0, 0, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_86))
				{
					...
					open_sequence_task(&iLocal_89);
					task_go_to_entity(false, PLAYER::PLAYER_PED_ID(), -1, 17f, 1f, 2f, 0);
					task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
					close_sequence_task(iLocal_89);
					task_perform_sequence(iLocal_86, iLocal_89);
					clear_sequence_task(&iLocal_89);
					set_ped_keep_task(iLocal_86, true);
	...
	else if (iLocal_60 == 5)
	{
		if (!iLocal_124)
		{
			func_48();
			wait(false);
			func_1(&uLocal_195, sLocal_178, "REHH5_THX", 4, 0, 0, 0);
			iLocal_124 = 1;
		}
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			...
			task_follow_nav_mesh_to_coord(false, -346.029f, 632.2272f, 171.2525f, 1f, -1, 0.25f, 0, 1193033728);
			task_follow_nav_mesh_to_coord(false, -346.6342f, 627.3992f, 170.3573f, 1f, -1, 0.25f, 0, 1193033728);
			task_follow_nav_mesh_to_coord(false, -355.2473f, 622.1964f, 170.3572f, 1f, -1, 0.25f, 0, 1193033728);
			task_follow_nav_mesh_to_coord(false, -355.6499f, 615.3431f, 170.3572f, 1f, -1, 0.25f, 0, 1193033728);
			task_follow_nav_mesh_to_coord(false, -350.163f, 605.0463f, 170.7292f, 1f, -1, 0.25f, 0, 1193033728);
			task_follow_nav_mesh_to_coord(false, -333.177f, 594.991f, 170.7553f, 1f, -1, 0.25f, 0, 1193033728);
...
int func_64(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_65(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_65(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_65(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
	...
	if (iParam1)
	{
		if (!iVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					GAMEPLAY::SET_BIT(&(Global_2097152[func_73() /*10375*/].f_7704.f_747), iParam0);
					func_70(15, 0);
					break;
			}
			func_69(iVar1);
...
bool func_77(auto uParam0, int iParam1)
{
...
bool func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_86(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_73() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_73() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_87(iParam0));
...
int func_89(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_73() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_94(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_95(auto uParam0, int iParam1)
{
...
void func_98(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_101(auto uParam0, int iParam1)
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_114())
			{
				...
				if (get_script_task_status(iLocal_85, 1227113341) != 1 && get_script_task_status(iLocal_85, 1227113341) != 0)
				{
					task_go_to_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 2f, 0);
				}
				...
				if (!iLocal_142)
				{
					...
					if (!func_54())
					{
						if (iLocal_60 == 1)
						{
							if (!func_174())
							{
								func_1(&uLocal_195, sLocal_178, "REHH1_VEH", 4, 0, 0, 0);
							}
							else
							{
								func_1(&uLocal_195, sLocal_178, "REHH1_VEH2", 4, 0, 0, 0);
							}
						}
						else if (iLocal_60 == 2)
						{
							if (!func_174())
							{
								func_1(&uLocal_195, sLocal_178, "REHH2_VEH", 4, 0, 0, 0);
							}
							else
							{
								func_1(&uLocal_195, sLocal_178, "REHH2_VEH2", 4, 0, 0, 0);
							}
						}
						else if (iLocal_60 == 3)
						{
							if (!func_174())
							{
								func_1(&uLocal_195, sLocal_178, "REHH3_VEH", 4, 0, 0, 0);
							}
							else
							{
								func_1(&uLocal_195, sLocal_178, "REHH3_VEH2", 4, 0, 0, 0);
							}
						}
						else if (iLocal_60 == 5)
						{
							if (!func_174())
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_VEH", 4, 0, 0, 0);
							}
							else
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_VEH2", 4, 0, 0, 0);
							}
						}
						iLocal_142 = 1;
					}
		...
		else if (!is_ped_in_group(iLocal_85))
		{
			set_ped_as_group_member(iLocal_85, func_108());
			set_ped_never_leaves_group(iLocal_85, 1);
			set_ped_group_member_passenger_index(iLocal_85, false);
		}
	}
}
...
void func_109(int iParam0)
{
	if (iParam0)
	{
		if (iLocal_127)
		{
			if (func_113(&uLocal_195, sLocal_178, &Local_134, &Local_128, 8, 0, 0))
			{
				iLocal_127 = 0;
			}
		}
	}
	else if ((!iLocal_127 && is_scripted_conversation_ongoing()) && !func_111())
	{
		Local_134 = {func_110()};
		Local_128 = {func_60()};
		func_55();
...
int func_113(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_114()
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if ((((!is_ped_in_any_heli(PLAYER::PLAYER_PED_ID()) && !is_ped_in_any_plane(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_sub(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_train(PLAYER::PLAYER_PED_ID())) && !is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("rhino")))
			{
...
void func_115()
{
	...
	if (iLocal_154 - iLocal_152 > 3000 && iLocal_154 - iLocal_153 > 6000)
	{
		if (!func_54())
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_SLR", 4, 0, 0, 0);
			}
	...
	if (iLocal_154 - iLocal_152 > 50000 && !iLocal_151)
	{
		...
		if (!func_54())
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_SLW", 4, 0, 0, 0);
			}
			else if (iLocal_60 == 2)
			{
				func_1(&uLocal_195, sLocal_178, "REHH2_SLW", 4, 0, 0, 0);
			}
			else if (iLocal_60 == 3)
			{
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					if (!is_ped_running_mobile_phone_task(iLocal_85))
					{
						clear_ped_secondary_task(iLocal_85);
					}
				}
				func_1(&uLocal_195, sLocal_178, "REHH3_SLW", 4, 0, 0, 0);
			}
			else if (iLocal_60 == 5)
			{
				func_1(&uLocal_195, sLocal_178, "REHH5_SLW", 4, 0, 0, 0);
			}
			iLocal_151 = 1;
		}
	}
...
void func_116()
{
	...
	if (iLocal_149 - iLocal_148 > 90000)
	{
		...
		if (iLocal_60 == 1)
		{
			func_1(&uLocal_195, sLocal_178, "REHH1_WLK", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 2)
		{
			func_1(&uLocal_195, sLocal_178, "REHH2_WLK", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 3)
		{
			func_1(&uLocal_195, sLocal_178, "REHH3_WLK", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 5)
		{
			func_1(&uLocal_195, sLocal_178, "REHH5_WLK", 4, 0, 0, 0);
		}
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			stop_ped_speaking(iLocal_85, 1);
...
void func_117()
{
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && !is_ped_in_vehicle(iLocal_85, get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
			{
				if (!does_blip_exist(iLocal_121))
				{
		...
		if (((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_any_vehicle(iLocal_85, 0)) || is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_93, 50f, 50f, 50f, false, true, 0)) || is_ped_in_any_taxi(PLAYER::PLAYER_PED_ID()))
		{
			if (!does_blip_exist(iLocal_83))
			{
				iLocal_83 = func_118(vLocal_93, 1);
		...
		else if (!is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_93, 50f, 50f, 50f, false, true, 0))
		{
			if (does_blip_exist(iLocal_83))
			{
				remove_blip(&iLocal_83);
...
int func_118(Vector3 vParam0, int iParam1)
{
	int iVar0;
...
void func_119()
{
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if ((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) && is_ped_in_any_vehicle(iLocal_85, 1)) || is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 5f, 5f, 5f, 0, 1, 0))
		{
			if (func_121())
			{
				func_50(0);
		...
		else if (!is_ped_running_mobile_phone_task(iLocal_85))
		{
		...
		if (is_ped_running_mobile_phone_task(iLocal_85))
		{
			set_ped_can_play_gesture_anims(iLocal_85, 0);
		}
		if (func_120("REHH3_CHT3_7"))
		{
			task_use_mobile_phone(iLocal_85, 1, 1);
		}
		if (func_120("REHH3_CHT6_5"))
		{
			task_use_mobile_phone(iLocal_85, 0, 1);
		}
...
void func_122()
{
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if (iLocal_60 == 1)
		{
			...
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), get_players_last_vehicle(), 0) && is_ped_in_vehicle(iLocal_85, get_players_last_vehicle(), 0))
				{
					if (has_entity_collided_with_anything(get_players_last_vehicle()))
					{
						if (!func_112("REHH1_CRASH"))
						{
							...
							func_48();
							wait(false);
							func_1(&uLocal_195, sLocal_178, "REHH1_CRASH", 4, 0, 0, 0);
						}
					}
				}
			}
		...
		if (!iLocal_144)
		{
			if (!is_entity_dead(get_players_last_vehicle(), 0))
			{
				if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), get_players_last_vehicle(), 1) && is_ped_in_vehicle(iLocal_85, get_players_last_vehicle(), 0))
				{
					func_109(0);
					func_48();
					wait(false);
					if (!func_54())
					{
						if (iLocal_60 == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH1_OUT", 4, 0, 0, 0);
						}
						else if (iLocal_60 == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH2_GETOUT", 4, 0, 0, 0);
						}
						else if (iLocal_60 == 3)
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							...
							func_1(&uLocal_195, sLocal_178, "REHH3_GETOUT", 4, 0, 0, 0);
						}
						else if (iLocal_60 == 5)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_GETOUT", 4, 0, 0, 0);
						}
						iLocal_144 = 1;
					}
				}
		...
		if (!iLocal_145)
		{
			if (is_ped_jacking(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!func_54())
				{
					if (iLocal_60 == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_JACK", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_JACK", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 3)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_JACK", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 5)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_JACK", 4, 0, 0, 0);
					}
					iLocal_145 = 1;
				}
			}
		...
		if (!iLocal_146)
		{
			if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!func_54())
				{
					if (iLocal_60 == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_GUN", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_SHOOT", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 3)
					{
						if (!PED::IS_PED_INJURED(iLocal_85))
						...
						func_1(&uLocal_195, sLocal_178, "REHH3_SHOOT", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 5)
					{
					}
...
void func_123()
{
	if (func_125(vLocal_93))
	{
		...
		if (iLocal_60 == 1)
		{
			func_1(&uLocal_195, sLocal_178, "REHH1_WAY", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 2)
		{
			func_1(&uLocal_195, sLocal_178, "REHH2_CULT", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 3)
		{
			if (!PED::IS_PED_INJURED(iLocal_85))
			...
			func_1(&uLocal_195, sLocal_178, "REHH3_CULT", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 5)
		{
			func_1(&uLocal_195, sLocal_178, "REHH5_CULT", 4, 0, 0, 0);
		}
	}
	if (func_124())
	{
		...
		{
			func_1(&uLocal_195, sLocal_178, "REHH2_NEAR", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 3)
		{
			if (!PED::IS_PED_INJURED(iLocal_85))
			...
			func_1(&uLocal_195, sLocal_178, "REHH3_NEAR", 4, 0, 0, 0);
		}
		else if (iLocal_60 == 5)
		{
			func_1(&uLocal_195, sLocal_178, "REHH5_NEAR", 4, 0, 0, 0);
		}
	}
}
...
bool func_125(Vector3 vParam0)
{
	if (func_8() == 2)
	{
		if (func_52() && !Global_25357)
		{
			if (fLocal_47 == -1f)
			{
				fLocal_47 = vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vParam0);
			}
			if (vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vParam0) > fLocal_47 + 200f || get_distance_between_coords(-1014.154f, 4881.411f, 245.0001f, get_entity_coords(get_player_ped(get_player_index()), 0), 1) < 400f)
			{
				Global_25357 = 1;
				return true;
			}
		...
		switch (iLocal_108)
		{
			...
			case 1:
				if (iLocal_110 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_60 == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_CHT", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 3)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT", 4, 0, 0, 0);
					}
					else if (iLocal_60 == 5)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHT", 4, 0, 0, 0);
					}
					iLocal_108++;
				}
				break;
			...
			case 2:
				if (iLocal_110 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_60 == 1)
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH1_ASKM", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH1_ASKF", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH1_ASKT", 4, 0, 0, 0);
						}
					}
					else if (iLocal_60 == 2)
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH2_CHTm2", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH2_CHTf2", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH2_CHTt2", 4, 0, 0, 0);
						}
					}
					else if (iLocal_60 == 3)
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHTM", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHTF", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHTT", 4, 0, 0, 0);
						}
					}
					else if (iLocal_60 == 5)
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_RESPM", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_RESPF", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							if (!iLocal_112)
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_RESPT", 4, 0, 0, 0);
							}
						}
					}
					iLocal_108++;
			...
			case 4:
				if (iLocal_110 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_60 == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_CHT2", 4, 0, 0, 0);
						iLocal_108++;
					}
					else if (iLocal_60 == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT2", 4, 0, 0, 0);
						iLocal_108++;
					}
					else if (iLocal_60 == 3)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT2", 4, 0, 0, 0);
						iLocal_108++;
					}
					else if (iLocal_60 == 5)
					{
						if (iLocal_112 && !iLocal_114)
						{
							if (func_8() == 0)
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_OKM", 4, 0, 0, 0);
							}
							else if (func_8() == 1)
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_OKF", 4, 0, 0, 0);
							}
							else if (func_8() == 2)
							{
								func_1(&uLocal_195, sLocal_178, "REHH5_OKT", 4, 0, 0, 0);
							}
							iLocal_108++;
						}
					}
			...
			case 5:
				if (iLocal_60 == 1)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_RESPM", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_RESPF", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_RESPT", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_pchatm", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_pchatf", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_pchatt", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT2M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT2F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT2T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_CHAT1", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 6:
				if (iLocal_60 == 1)
				{
					func_1(&uLocal_195, sLocal_178, "REHH1_CHAT", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT3", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT3", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 5)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT1b", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT1c", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT1d", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 7:
				if (iLocal_60 == 1)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_CHATb", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_CHATc", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_CHATd", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT3M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT3F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT3T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT3M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT3F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT3T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 8:
				if (iLocal_60 == 1)
				{
					func_1(&uLocal_195, sLocal_178, "REHH1_CHATe", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT4", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT4", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 5)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2b", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2c", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2d", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 9:
				if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT4M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT4F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT4T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT4M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT4F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT4T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2e", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 10:
				if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT5", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT5", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 5)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2f", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2g", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT2h", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 11:
				if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT5M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT5F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT5T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT5M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT5F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT5T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_CHAT3", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 12:
				if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT6", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT6", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 5)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT3b", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT3c", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT3d", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 13:
				if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT6M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT6F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT6T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT6M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT6F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT6T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_CHAT4", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 14:
				if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT7", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT7", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 5)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT4b", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT4c", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH5_CHAT4d", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 15:
				if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT7M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT7F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT7T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT7M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT7F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT7T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 5)
				{
					func_1(&uLocal_195, sLocal_178, "REHH5_RUNOUT", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 16:
				if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT8", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT8", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 18:
				if (iLocal_60 == 2)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT8M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT8F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH2_CHT8T", 4, 0, 0, 0);
					}
				}
				else if (iLocal_60 == 3)
				{
					if (func_8() == 0)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT8M", 4, 0, 0, 0);
					}
					else if (func_8() == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT8F", 4, 0, 0, 0);
					}
					else if (func_8() == 2)
					{
						func_1(&uLocal_195, sLocal_178, "REHH3_CHT8T", 4, 0, 0, 0);
					}
				}
				iLocal_108++;
				break;
			...
			case 19:
				if (iLocal_60 == 2)
				{
					func_1(&uLocal_195, sLocal_178, "REHH2_CHT9", 4, 0, 0, 0);
				}
				else if (iLocal_60 == 3)
				{
					func_1(&uLocal_195, sLocal_178, "REHH3_CHT9", 4, 0, 0, 0);
				}
				iLocal_108++;
				break;
			...
			case 21:
				if (iLocal_110 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_60 == 3)
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHT9M", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHT9F", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH3_CHT9T", 4, 0, 0, 0);
						}
					}
					iLocal_108++;
				}
			...
			case 22:
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					task_play_anim(iLocal_85, "facials@gen_female@base", "mood_sleeping_1", 2f, -2f, -1, 33, 0, 0, 0, 0);
				}
				iLocal_108++;
				break;
			}
...
void func_127()
{
	if (iLocal_60 != 3)
	{
		if (func_130())
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_93, 3f, 3f, 2f, true, true, 0) && is_entity_at_coord(iLocal_85, vLocal_93, Global_19, false, true, 0))
				{
					if (func_129(1, 0, 1))
					{
						func_128();
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							_task_bring_vehicle_to_halt(get_players_last_vehicle(), 10.5f + 2f, 3, 0);
						}
						clear_ped_secondary_task(iLocal_85);
						iLocal_59 = 6;
					}
	...
	else if (iLocal_112)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), 805.501f, 1269.926f, 361.4025f, 25f, 30f, 2f, false, true, 0) || (is_entity_at_coord(iLocal_85, 824.8886f, 1275.671f, 359.4312f, Global_19, true, true, 0) && is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)))
			{
				func_48();
				wait(false);
				func_1(&uLocal_195, sLocal_178, "REHH3_CHT10", 4, 0, 0, 0);
				if (!PED::IS_PED_INJURED(iLocal_85) && !PED::IS_PED_INJURED(iLocal_86))
				{
					if (is_ped_in_any_vehicle(iLocal_85, 0))
					{
						...
						task_go_to_entity(false, PLAYER::PLAYER_PED_ID(), -1, 5f, 1f, 2f, 0);
						task_play_anim(false, "random@hitch_lift", "come_here_idle_c", 2f, -2f, -1, 48, 0, 0, 0, 0);
						task_turn_ped_to_face_entity(false, iLocal_86, -1);
						close_sequence_task(iLocal_89);
						task_perform_sequence(iLocal_85, iLocal_89);
						clear_sequence_task(&iLocal_89);
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (!is_entity_dead(get_players_last_vehicle(), 0))
					{
						_task_bring_vehicle_to_halt(get_players_last_vehicle(), 10.5f + 2f, 2, 0);
					}
				}
				settimera(false);
				iLocal_59 = 6;
...
bool func_130()
{
	if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_ped_sitting_in_vehicle(iLocal_85, get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
				{
					return true;
				}
			}
	...
	if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_93, 50f, 50f, 50f, false, true, 0) && !PED::IS_PED_INJURED(iLocal_85))
	{
		if (!is_ped_in_any_vehicle(iLocal_85, 0))
		{
			return true;
...
void func_131()
{
	if (iLocal_114)
	{
		...
		{
			if ((((PED::IS_PED_INJURED(iLocal_86) || !is_entity_at_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0)) || vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_93) < 250f) || vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_97) < 250f) || iLocal_116)
			{
				if (does_blip_exist(iLocal_122))
				{
					remove_blip(&iLocal_122);
				...
				func_48();
				wait(false);
				func_1(&uLocal_195, sLocal_178, "REHH5_CHT2", 4, 0, 0, 0);
				set_ped_as_no_longer_needed(&iLocal_86);
			...
			else
			{
				if (!iLocal_117)
				{
					if (!func_54())
					{
						if (func_8() == 0)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_COMM", 4, 0, 0, 0);
						}
						else if (func_8() == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_COMF", 4, 0, 0, 0);
						}
						else if (func_8() == 2)
						{
							func_1(&uLocal_195, sLocal_178, "REHH5_COMT", 4, 0, 0, 0);
						}
						iLocal_117 = 1;
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_86))
				{
					...
					func_132(iLocal_171, get_vehicle_ped_is_using(PLAYER::PLAYER_PED_ID()), &uLocal_185, &uLocal_188, &vLocal_190, &fLocal_189, &uLocal_193, 0f, 0f, 0f, 1500, 0f);
					if (is_entity_at_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 30f, 30f, 30f, 0, 1, 0))
					{
						if (iLocal_109 < GAMEPLAY::GET_GAME_TIMER())
						{
							if (!func_54())
							{
								if (func_58())
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_FHT", 4, 0, 0, 0);
								}
								else
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_FEAR", 4, 0, 0, 0);
								}
						...
						if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
						{
							if (!func_112("REHH5_SHO"))
							{
								func_48();
								wait(false);
								func_1(&uLocal_195, sLocal_178, "REHH5_SHO", 4, 0, 0, 0);
							}
						}
						if (is_ped_on_foot(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_86))
						{
							if ((is_ped_on_foot(iLocal_86) && is_ped_armed(PLAYER::PLAYER_PED_ID(), 4)) && is_player_free_aiming(player_id()))
							{
								iLocal_116 = 1;
							}
						}
					...
					{
						if (is_ped_stopped(PLAYER::PLAYER_PED_ID()) && is_entity_at_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
						{
							task_combat_ped(iLocal_86, PLAYER::PLAYER_PED_ID(), 0, 16);
							func_48();
							wait(false);
							func_1(&uLocal_195, sLocal_178, "REHH5_GRM", 4, 0, 0, 0);
							iLocal_115 = 1;
						}
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !is_this_model_a_boat(ENTITY::GET_ENTITY_MODEL(iParam1))) && !is_this_model_a_plane(ENTITY::GET_ENTITY_MODEL(iParam1))) && !is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(iParam1))) && !is_this_model_a_train(ENTITY::GET_ENTITY_MODEL(iParam1))) && is_vehicle_on_all_wheels(iParam1)) && func_137(iParam0))
		{
			if (get_distance_between_coords(get_entity_coords(iParam1, 1), *uParam4, 1) > 20f)
			{
				...
				*uParam3 = func_136(get_entity_coords(iParam0, 1), get_entity_coords(iParam1, 1));
			...
			{
				if (func_134(iParam0, iParam1, 1) > fParam11 && get_distance_between_coords(get_entity_coords(iParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_133(*uParam2))
					{
						...
						{
							vVar0 = {_get_object_offset_from_coords(vLocal_190, fLocal_189, vParam7)};
							if (!func_133(vVar0))
							{
								if (!is_sphere_visible(vVar0, 2f))
								{
									...
									set_entity_heading(iParam0, fLocal_189);
									set_vehicle_on_ground_properly(iParam0);
									set_vehicle_forward_speed(iParam0, 10f);
									set_vehicle_engine_on(iParam0, true, 1, 0);
									*uParam6 = GAMEPLAY::GET_GAME_TIMER();
...
void func_135(int iParam0, auto uParam1, auto uParam2)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!is_entity_dead(iParam0, 0))
...
float func_136(struct<2> Param0, Vector3 fParam1, struct<2> Param2, Vector3 fParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		if (is_vehicle_driveable(*iParam2, 0))
		{
			...
			if (!does_blip_exist(*iParam3))
			{
				if (iVar0 == 1)
				{
					*iParam3 = func_118(get_entity_coords(*iParam2, 1), 0);
			...
			else
			{
				...
				vVar4 = {get_entity_coords(*iParam2, 1)};
...
void func_140()
{
	if (!PED::IS_PED_INJURED(iLocal_86))
	{
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, true, 0) || is_entity_in_angled_area(iLocal_86, 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, true, 0))
		{
		...
		else
		{
			if (does_object_of_type_exist_at_coords(801.7148f, 1270.138f, 359.2855f, 6f, joaat("prop_fnclink_03gate1"), 0))
			{
				set_state_of_closest_door_of_type(joaat("prop_fnclink_03gate1"), 801.7148f, 1270.138f, 359.2855f, true, 0f, 0);
			}
			if (does_object_of_type_exist_at_coords(802.9218f, 1281.675f, 359.2962f, 6f, joaat("prop_fnclink_03gate1"), 0))
			{
				set_state_of_closest_door_of_type(joaat("prop_fnclink_03gate1"), 802.9218f, 1281.675f, 359.2962f, true, 0f, 0);
			}
		}
	}
}
...
void func_141()
{
	if (!iLocal_112)
	{
		if (iLocal_60 == 3)
		{
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_104, 200f, 200f, 200f, false, true, 0))
			{
				STREAMING::REQUEST_MODEL(iLocal_101);
				request_clip_set("move_m@brave");
				if (STREAMING::HAS_MODEL_LOADED(iLocal_101) && has_clip_set_loaded("move_m@brave"))
				{
					...
					task_look_at_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
		...
		else if (iLocal_60 == 5)
		{
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_79, 1) > 320f && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (is_ped_in_vehicle(iLocal_85, get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
					{
						if (get_nth_closest_vehicle_node(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_random_int_in_range(2, 5), &vLocal_66, 1, 3f, 0f))
						{
							if (!is_sphere_visible(vLocal_66, 7f) && vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_66) < 110f)
							{
								STREAMING::REQUEST_MODEL(iLocal_101);
								if (STREAMING::HAS_MODEL_LOADED(iLocal_101))
								{
									func_55();
									wait(false);
									if (func_144(&uLocal_195, sLocal_178, "REHH5_CHS", "REHH5_CHS_1", 4, 0, 0) && !PED::IS_PED_INJURED(iLocal_85))
									{
										...
										task_vehicle_mission_ped_target(iLocal_86, iLocal_171, iLocal_85, 6, 60f, 786468, -1f, -1f, 1);
										task_combat_ped(iLocal_86, PLAYER::PLAYER_PED_ID(), 0, 16);
										set_ped_keep_task(iLocal_86, true);
										set_model_as_no_longer_needed(iLocal_101);
										set_model_as_no_longer_needed(iLocal_102);
										set_vehicle_forward_speed(iLocal_171, get_entity_speed(PLAYER::PLAYER_PED_ID()) + 15f);
										if (does_blip_exist(iLocal_83))
										{
											remove_blip(&iLocal_83);
										}
										...
										func_113(&uLocal_195, sLocal_178, "REHH5_CHS", "REHH5_CHS_2", 4, 0, 0);
										iLocal_114 = true;
										iLocal_112 = true;
									}
								}
...
float func_142(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, int iParam4)
{
	float fVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
int func_144(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_17(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_145(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (*(uParam0[iParam1 /*10*/]).f_7 == 1)
	{
	}
...
void func_146()
{
	if (!iLocal_176 && !func_54())
	{
		if (iLocal_174 == 6 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM1", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 6 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM2", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 7 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM3", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 7 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM4", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 8 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM5", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 8 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM6", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 9 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM7", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 9 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM8", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 10 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM9", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 10 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM10", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 11 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM11", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 11 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM12", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 12 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM13", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 12 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM14", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 13 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM15", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 13 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM16", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 14 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM17", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 14 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM18", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 15 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM19", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 15 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM20", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 16 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM21", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 16 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM22", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 17 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM23", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 17 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM24", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 18 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM25", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 18 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM26", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 19 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM27", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 19 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM28", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 20 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM29", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 20 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM30", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 21 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM31", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 21 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM32", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 22 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM33", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 22 && iLocal_173 == 30)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM34", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
		if (iLocal_174 == 23 && iLocal_173 == 0)
		{
			if (iLocal_60 == 1)
			{
				func_1(&uLocal_195, sLocal_178, "REHH1_TIM35", 4, 0, 0, 0);
			}
			iLocal_176 = 1;
		}
	}
...
void func_147()
{
	...
	if ((iLocal_174 == func_151(func_153()) + 1 && iLocal_173 == func_152(func_153())) || (((iLocal_174 >= 24 && iLocal_155 < 150000) && iLocal_174 == func_151(func_153()) + 25) && iLocal_173 == func_152(func_153())))
	{
		if (!iLocal_163)
		{
			...
			if (!func_54())
			{
				if (iLocal_60 == 1)
				{
					func_1(&uLocal_195, sLocal_178, "REHH1_1HOUR", 4, 0, 0, 0);
				}
				iLocal_163 = 1;
			}
		}
	...
	if (iLocal_173 == 30)
	{
		if ((iLocal_174 == func_151(func_153()) && iLocal_173 == func_152(func_153()) + 30) || (((iLocal_174 >= 24 && iLocal_155 < 150000) && iLocal_174 == func_151(func_153()) + 24) && iLocal_173 == func_152(func_153()) + 30))
		{
			if (!iLocal_164)
			{
				...
				if (!func_54())
				{
					if (iLocal_60 == 1)
					{
						func_1(&uLocal_195, sLocal_178, "REHH1_HHOUR", 4, 0, 0, 0);
					}
					iLocal_164 = 1;
				}
				if (!iLocal_165)
				{
					...
					play_sound_frontend(iLocal_177, "VARIABLE_COUNTDOWN_CLOCK_wp", 0, 1);
					set_variable_on_sound(iLocal_177, "countdown_fadein", 35f);
		...
		if ((iLocal_174 == func_151(func_153()) && iLocal_173 == func_152(func_153()) + 5) || (((iLocal_174 >= 24 && iLocal_155 < 150000) && iLocal_174 == func_151(func_153()) + 24) && iLocal_173 == func_152(func_153()) + 5))
		{
			if (!iLocal_166)
			{
				set_variable_on_sound(iLocal_177, "countdown_fast", 1f);
				iLocal_166 = 1;
			}
		}
	}
	...
	if (iLocal_175)
	{
		...
		if (iLocal_60 == 1)
		{
			func_1(&uLocal_195, sLocal_178, "REHH1_TLATE", 4, 0, 0, 0);
		}
		if (!PED::IS_PED_INJURED(iLocal_85))
		{
			if (is_ped_in_any_vehicle(iLocal_85, 0))
			{
				_task_bring_vehicle_to_halt(get_vehicle_ped_is_in(iLocal_85, 0), 10.5f + 2f, 2, 0);
				task_leave_any_vehicle(iLocal_85, true, 0);
				remove_ped_from_group(iLocal_85);
				if (does_blip_exist(iLocal_83))
				{
					remove_blip(&iLocal_83);
...
auto func_158(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_159(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_162(auto uParam0, int iParam1)
{
			...
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), get_players_last_vehicle(), 0) && is_ped_in_vehicle(iLocal_85, get_players_last_vehicle(), 0))
			{
				...
				if (iLocal_60 == 1)
				{
					if (!func_54())
					{
						if (iLocal_60 == 1)
						{
							func_1(&uLocal_195, sLocal_178, "REHH1_WTA", 4, 0, 0, 0);
						}
				...
				{
					if (func_1(&uLocal_195, sLocal_178, "REHH2_WTB", 4, 0, 0, 0))
					{
						iLocal_111 = 1;
						settimera(false);
						iLocal_59 = 4;
				...
				{
					if (func_1(&uLocal_195, sLocal_178, "REHH3_WTC", 4, 0, 0, 0))
					{
						iLocal_111 = 1;
						settimera(false);
						iLocal_59 = 4;
				...
				{
					if (func_1(&uLocal_195, sLocal_178, "REHH5_WTE", 4, 0, 0, 0))
					{
						iLocal_111 = 1;
						settimera(false);
						iLocal_59 = 4;
	...
	switch (iLocal_140)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				{
					if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 24f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
					{
						...
						open_sequence_task(&iLocal_89);
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						task_go_to_entity(false, PLAYER::PLAYER_PED_ID(), -1, fLocal_184, 2f, 2f, 0);
						close_sequence_task(iLocal_89);
						task_perform_sequence(iLocal_85, iLocal_89);
						clear_sequence_task(&iLocal_89);
						iLocal_140++;
				...
				else if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 12f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
				{
					fLocal_184 = func_134(iLocal_85, PLAYER::PLAYER_PED_ID(), 1);
					fLocal_184 -= 0.25f;
					open_sequence_task(&iLocal_89);
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_87 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
					if (is_vehicle_driveable(iLocal_87, 0))
					{
						if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 25f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
						{
							if (is_ped_facing_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 150f))
							{
								clear_ped_secondary_task(iLocal_85);
								open_sequence_task(&iLocal_89);
								task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
								if (is_vehicle_seat_free(iLocal_87, false))
								{
									task_open_vehicle_door(false, iLocal_87, -1, 0, 2f);
								}
				...
				{
					task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 7000, 2052, 2);
					if (func_1(&uLocal_195, sLocal_178, "REHH5_NOV", 4, 0, 0, 0))
					{
						iLocal_141 = 1;
					}
				}
		...
		case 2:
			...
			{
				iLocal_87 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
				if (!PED::IS_PED_INJURED(iLocal_85) && is_vehicle_driveable(iLocal_87, 0))
				{
					if (func_134(iLocal_85, iLocal_87, 1) < 25f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
					{
						if (get_entity_speed(iLocal_87) < 2.5f)
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								if (func_1(&uLocal_195, sLocal_178, "REHH5_ASK", 4, 0, 0, 0))
								{
									settimera(false);
									iLocal_140++;
								}
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
				{
					open_sequence_task(&iLocal_89);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
					task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (is_vehicle_driveable(iLocal_87, 0))
					{
						if (get_entity_speed(iLocal_87) < 2.5f && func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 25f)
						{
							if (!func_54())
							{
								if (func_8() == 0)
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_RPA", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 1)
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_RPB", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 2)
								{
									func_1(&uLocal_195, sLocal_178, "REHH5_RPC", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
							}
		...
		case 4:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 25f)
				{
					if (func_114())
					{
						if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (is_vehicle_seat_free(get_players_last_vehicle(), false))
							{
								set_ped_as_group_member(iLocal_85, func_108());
								set_ped_never_leaves_group(iLocal_85, 1);
								set_ped_group_member_passenger_index(iLocal_85, false);
								task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								task_enter_vehicle(iLocal_85, get_players_last_vehicle(), -1, false, 2f, 1, 0);
								func_168();
								iLocal_140++;
							}
							else
							{
								iVar0 = get_ped_in_vehicle_seat(get_players_last_vehicle(), false);
								...
								else
								{
									...
									set_ped_as_group_member(iLocal_85, func_108());
									set_ped_never_leaves_group(iLocal_85, 1);
									set_ped_group_member_passenger_index(iLocal_85, true);
									task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
									iLocal_140++;
								}
							}
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (func_114())
				{
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH5_SLW", 4, 0, 0, 0))
						{
							func_53();
						}
					}
...
auto func_169(int iParam0, int iParam1)
{
	...
	switch (iLocal_140)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_ped_facing_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 90f))
				{
					if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 12f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
					{
						fLocal_184 = func_134(iLocal_85, PLAYER::PLAYER_PED_ID(), 1);
						if (fLocal_184 > 5f)
						{
						...
						open_sequence_task(&iLocal_89);
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						task_follow_to_offset_of_entity(false, PLAYER::PLAYER_PED_ID(), 2.5f, 0f, 0f, 1f, 5000, 0.1f, 1);
						close_sequence_task(iLocal_89);
						task_perform_sequence(iLocal_85, iLocal_89);
						clear_sequence_task(&iLocal_89);
						iLocal_140++;
				...
				else if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 8f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
				{
					fLocal_184 = func_134(iLocal_85, PLAYER::PLAYER_PED_ID(), 1);
					fLocal_184 -= 0.25f;
					open_sequence_task(&iLocal_89);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
					task_go_to_entity(false, PLAYER::PLAYER_PED_ID(), -1, fLocal_184, 1f, 2f, 0);
					close_sequence_task(iLocal_89);
					task_perform_sequence(iLocal_85, iLocal_89);
					clear_sequence_task(&iLocal_89);
					iLocal_140++;
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (is_vehicle_driveable(iLocal_87, 0))
					{
						if (func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 10f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
						{
							if (is_ped_facing_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 150f))
							{
								clear_ped_secondary_task(iLocal_85);
								...
								if (is_vehicle_seat_free(iLocal_87, false))
								{
									task_open_vehicle_door(false, iLocal_87, -1, 0, 1f);
								}
								task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
								close_sequence_task(iLocal_89);
								task_perform_sequence(iLocal_85, iLocal_89);
				...
				{
					task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 7000, 2052, 2);
					if (func_1(&uLocal_195, sLocal_178, "REHH3_NOV", 4, 0, 0, 0))
					{
						iLocal_141 = 1;
					}
				}
		...
		case 2:
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_85) && is_vehicle_driveable(iLocal_87, 0))
				{
					if (func_134(iLocal_85, iLocal_87, 1) < 13f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
					{
						if (get_entity_speed(iLocal_87) < 2.5f)
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								if (func_1(&uLocal_195, sLocal_178, "REHH3_ASK", 4, 0, 0, 0))
								{
									settimera(false);
									iLocal_140++;
								}
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_ped_getting_into_a_vehicle(iLocal_85))
				{
					open_sequence_task(&iLocal_89);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
					task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (is_vehicle_driveable(iLocal_87, 0))
					{
						if (get_entity_speed(iLocal_87) < 2.5f && func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 15f)
						{
							if (!func_54())
							{
								if (func_8() == 0)
								{
									func_1(&uLocal_195, sLocal_178, "REHH3_RPA", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 1)
								{
									func_1(&uLocal_195, sLocal_178, "REHH3_RPB", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 2)
								{
									func_1(&uLocal_195, sLocal_178, "REHH3_RPC", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
							}
		...
		case 4:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 15f)
				{
					if (func_114())
					{
						if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (is_vehicle_seat_free(get_players_last_vehicle(), false))
							{
								...
								set_ped_group_member_passenger_index(iLocal_85, false);
								task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								task_enter_vehicle(iLocal_85, get_players_last_vehicle(), -1, false, 1f, 1, 0);
								func_168();
								iLocal_140++;
							}
							else
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (func_114())
				{
					set_ped_max_move_blend_ratio(iLocal_85, 1f);
					if (is_ped_in_any_vehicle(iLocal_85, 0))
					{
						task_clear_look_at(iLocal_85);
						iLocal_111 = 1;
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH3_SLW", 4, 0, 0, 0))
						{
							func_53();
						}
					}
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				else if (!iLocal_141)
				{
					clear_ped_tasks(iLocal_85);
					task_look_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 7000, 2052, 2);
					if (func_1(&uLocal_195, sLocal_178, "REHH2_NOV", 4, 0, 0, 0))
					{
						iLocal_141 = 1;
					}
				}
				...
				if (!PED::IS_PED_INJURED(iLocal_85) && is_vehicle_driveable(iLocal_87, 0))
				{
					if (func_134(iLocal_85, iLocal_87, 1) < 13f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
					{
						if (get_entity_speed(iLocal_87) < 2.5f)
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								if (func_1(&uLocal_195, sLocal_178, "REHH2_ASK", 4, 0, 0, 0))
								{
									settimera(false);
									iLocal_140++;
								}
					...
					if (is_vehicle_driveable(iLocal_87, 0))
					{
						if (get_entity_speed(iLocal_87) < 2.5f && func_169(iLocal_85, PLAYER::PLAYER_PED_ID()) < 15f)
						{
							if (!func_54())
							{
								if (func_8() == 0)
								{
									func_1(&uLocal_195, sLocal_178, "REHH2_RPA", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 1)
								{
									func_1(&uLocal_195, sLocal_178, "REHH2_RPB", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
								else if (func_8() == 2)
								{
									func_1(&uLocal_195, sLocal_178, "REHH2_RPC", 4, 0, 0, 0);
									settimera(false);
									iLocal_140++;
								}
							}
			...
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (!iLocal_103)
				{
					if (is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
					{
						if (!func_54())
						{
							if (func_1(&uLocal_195, sLocal_178, "REHH2_INA", 4, 0, 0, 0))
							{
								iLocal_103 = 1;
							}
						}
				...
				if (func_114())
				{
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH2_SLW", 4, 0, 0, 0))
						{
							func_53();
						}
					}
...
void func_172()
{
	...
	switch (iLocal_140)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 12f || (is_player_pressing_horn(player_id()) && func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f))
				{
					task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 5000, 2052, 2);
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							open_sequence_task(&iLocal_89);
							task_look_at_entity(false, iLocal_87, 30000, 2054, 2);
							task_play_anim(iLocal_85, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
							close_sequence_task(iLocal_89);
							task_perform_sequence(iLocal_85, iLocal_89);
							clear_sequence_task(&iLocal_89);
						}
					...
					else if (!iLocal_141)
					{
						clear_ped_tasks(iLocal_85);
						open_sequence_task(&iLocal_89);
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2054, 2);
						task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), -1);
						close_sequence_task(iLocal_89);
						task_perform_sequence(iLocal_85, iLocal_89);
						clear_sequence_task(&iLocal_89);
						if (func_1(&uLocal_195, sLocal_178, "REHH1_NOV", 8, 0, 0, 0))
						{
							iLocal_141 = 1;
						}
					}
		...
		case 1:
			...
			if (func_114())
			{
				...
				{
					iLocal_87 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
					if (get_entity_speed(iLocal_87) < 10f)
					{
						if (!PED::IS_PED_INJURED(iLocal_85))
						{
							if (is_ped_facing_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								open_sequence_task(&iLocal_89);
								task_look_at_entity(false, iLocal_87, 10000, 2054, 2);
								if (is_vehicle_seat_free(iLocal_87, false))
								{
									task_open_vehicle_door(false, iLocal_87, -1, 0, 1f);
								}
							...
							{
								task_look_at_entity(iLocal_85, iLocal_87, 10000, 2054, 2);
								iLocal_140++;
							}
						}
					}
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_85) && is_vehicle_driveable(iLocal_87, 0))
			{
				if (get_entity_speed(iLocal_87) < 2.5f)
				{
					if (func_1(&uLocal_195, sLocal_178, "REHH1_ASK", 4, 0, 0, 0))
					{
						clear_ped_secondary_task(iLocal_85);
						settimera(false);
						iLocal_140++;
						...
						if (is_vehicle_driveable(iLocal_87, 0))
						{
							if (get_entity_speed(iLocal_87) < 2.5f)
							{
								if (!func_54())
								{
									if (func_8() == 0)
									{
										func_1(&uLocal_195, sLocal_178, "REHH1_RPA", 4, 0, 0, 0);
										settimera(false);
										iLocal_140++;
									}
									else if (func_8() == 1)
									{
										func_1(&uLocal_195, sLocal_178, "REHH1_RPB", 4, 0, 0, 0);
										settimera(false);
										iLocal_140++;
									}
									else if (func_8() == 2)
									{
										func_1(&uLocal_195, sLocal_178, "REHH1_RPC", 4, 0, 0, 0);
										settimera(false);
										iLocal_140++;
									}
								}
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				if (func_114())
				{
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH1_NOH", 4, 0, 0, 0))
						{
							func_53();
						}
					}
...
void func_173()
{
	...
	{
		iLocal_172 = get_closest_vehicle(get_entity_coords(iLocal_85, 0), 18f, false, 4);
	}
	if (iLocal_172 != 0)
	{
		iLocal_156++;
		...
		if (iLocal_156 > iVar0)
		{
			set_entity_as_mission_entity(iLocal_172, true, 0);
			if (is_vehicle_driveable(iLocal_172, 0))
			{
				if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_172, 0))
				{
					if (iLocal_60 == 1)
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH1_STO", 4, 0, 0, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								task_look_at_entity(iLocal_85, iLocal_172, 3000, 2052, 2);
							}
						}
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH2_STO", 4, 0, 0, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								task_look_at_entity(iLocal_85, iLocal_172, 3000, 2052, 2);
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH3_STO", 4, 0, 0, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								task_look_at_entity(iLocal_85, iLocal_172, 3000, 2052, 2);
					...
					{
						if (func_1(&uLocal_195, sLocal_178, "REHH5_STO", 4, 0, 0, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_85))
							{
								task_look_at_entity(iLocal_85, iLocal_172, 3000, 2052, 2);
...
void func_175()
{
	if (iLocal_60 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			...
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -3024.265f, 660.8264f, 1.1982f, -3140.823f, 803.707f, 35.131f, 93f, 0, true, 0) && !is_entity_occluded(iLocal_85)) || func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 12f)
				{
					func_176();
					iLocal_59 = 2;
				}
	...
	else if (iLocal_60 == 2)
	{
		if (!iLocal_167)
		{
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_90, 100f, 100f, 100f, false, true, 0) && !PED::IS_PED_INJURED(iLocal_85))
			{
				open_sequence_task(&iLocal_89);
				task_follow_nav_mesh_to_coord(false, 178.993f, 4413.097f, 73.6132f, 1f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, 159.6669f, 4413.197f, 74.8915f, 1f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, 142.7866f, 4415.111f, 74.3799f, 1f, -1, 0.25f, 1, 1193033728);
				close_sequence_task(iLocal_89);
				task_perform_sequence(iLocal_85, iLocal_89);
				clear_sequence_task(&iLocal_89);
				iLocal_167 = 1;
	...
	else if (iLocal_60 == 5)
	{
		if (!iLocal_167)
		{
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_90, 200f, 200f, 200f, false, true, 0) && !PED::IS_PED_INJURED(iLocal_85))
			{
				open_sequence_task(&iLocal_89);
				task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2052, 3);
				task_play_anim(false, "random@hitch_lift", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0, 0, 0, 0);
				task_follow_nav_mesh_to_coord(false, -337.3163f, 2828.018f, 55.2198f, 2f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, -343.4485f, 2826.222f, 54.5089f, 2f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, -356.4033f, 2811.062f, 51.5931f, 2f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, -365.6846f, 2809.158f, 48.7646f, 2f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, -382.4106f, 2818.384f, 44.078f, 2f, -1, 0.25f, 1, 1193033728);
				task_follow_nav_mesh_to_coord(false, -370.3838f, 2866.677f, 41.0979f, 2f, -1, 0.25f, 1, 1193033728);
				task_play_anim(false, "random@hitch_lift", "carjack_mainloop_female", 2f, -2f, -1, 33, 0, 0, 0, 0);
				close_sequence_task(iLocal_89);
				task_perform_sequence(iLocal_85, iLocal_89);
				clear_sequence_task(&iLocal_89);
				iLocal_167 = 1;
	...
	if (iLocal_60 != 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			if (!is_entity_dead(iLocal_85, 0))
			{
				if ((is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_85, 95f, 95f, 50f, 0, 1, 0) && !is_entity_occluded(iLocal_85)) || func_169(PLAYER::PLAYER_PED_ID(), iLocal_85) < 12f)
				{
					func_176();
					iLocal_59 = 2;
				}
...
void func_176()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_85))
	{
		if (!does_blip_exist(iLocal_121))
		{
			...
			{
				iLocal_121 = func_63(iLocal_85, 0, 145);
				_0x75A16C3DA34F1245(iLocal_121, false);
			}
		}
		if (!func_209())
		{
...
void func_177()
{
	...
	if (iLocal_60 == 1)
	{
		set_ped_component_variation(iLocal_85, false, false, true, 0);
		set_ped_component_variation(iLocal_85, 2, true, 2, 0);
		set_ped_component_variation(iLocal_85, 3, false, 2, 0);
		set_ped_component_variation(iLocal_85, 4, false, 2, 0);
		set_vehicle_model_is_suppressed(iLocal_102, true);
		iLocal_171 = create_vehicle(iLocal_102, -3088.068f, 730.4819f, 20.3028f, 332.2996f, 1, true);
	...
	{
		set_ped_component_variation(iLocal_85, false, false, true, 0);
		set_ped_component_variation(iLocal_85, 2, false, true, 0);
		set_ped_component_variation(iLocal_85, 3, false, false, 0);
		set_ped_component_variation(iLocal_85, 4, false, true, 0);
		set_ped_component_variation(iLocal_85, 8, true, false, 0);
		set_ped_component_variation(iLocal_85, 10, false, false, 0);
		task_play_anim(iLocal_85, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
	...
	{
		set_ped_component_variation(iLocal_85, false, false, false, 0);
		set_ped_component_variation(iLocal_85, 2, true, false, 0);
		set_ped_component_variation(iLocal_85, 3, false, false, 0);
		set_ped_component_variation(iLocal_85, 4, true, false, 0);
		set_ped_component_variation(iLocal_85, 8, false, false, 0);
		task_play_anim(iLocal_85, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
		add_scenario_blocking_area(vLocal_93 - Vector(20f, 50f, 50f), vLocal_93 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_60 == 5)
...
void func_180(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_26() == 0)
		{
			...
			func_43(func_181(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
bool func_187()
{
	switch (func_188(&Global_25179, 0, 5, 0, get_id_of_this_thread()))
	{
		case 1:
			return true;
			break;
...
int func_188(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
void func_189(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_193()
{
	...
	if (!is_entity_dead(iLocal_85, 0))
	{
		...
		if (!is_entity_dead(get_players_last_vehicle(), 0))
		{
			if (has_entity_been_damaged_by_entity(iLocal_85, get_players_last_vehicle(), 1))
			{
				return true;
			}
		}
		if (!iLocal_114)
		{
			if (is_bullet_in_area(get_entity_coords(iLocal_85, 1), 10f, 1) || is_projectile_in_area(get_entity_coords(iLocal_85, 1) - Vector(10f, 10f, 10f), get_entity_coords(iLocal_85, 1) + Vector(10f, 10f, 10f), 0))
			{
				return true;
			}
		}
		...
		{
			if (has_entity_been_damaged_by_entity(iLocal_86, PLAYER::PLAYER_PED_ID(), 1) && is_ped_armed(PLAYER::PLAYER_PED_ID(), 7))
			{
				if (!PED::IS_PED_INJURED(iLocal_85))
				{
					play_pain(iLocal_85, 6, 0f, 0);
				}
				return true;
			}
		}
		if ((!is_ped_in_group(iLocal_85) && is_ped_facing_ped(iLocal_85, PLAYER::PLAYER_PED_ID(), 90f)) && is_entity_at_entity(iLocal_85, PLAYER::PLAYER_PED_ID(), 50f, 50f, 50f, 0, 1, 0))
		{
			if (is_player_targetting_entity(player_id(), iLocal_85) || is_player_free_aiming_at_entity(player_id(), iLocal_85))
			{
				return true;
			}
		}
...
void func_194()
{
	...
	if (iLocal_60 == 1)
	{
		...
		AUDIO::REQUEST_SCRIPT_AUDIO_BANK("timer", false);
	}
	else if (iLocal_60 == 3)
	{
		request_anim_dict("facials@gen_female@base");
	}
	if (STREAMING::HAS_MODEL_LOADED(iLocal_100) && has_anim_dict_loaded("random@hitch_lift"))
	{
		if (iLocal_60 == 1 || iLocal_60 == 5)
		{
...
void func_198(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
int func_214(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
void func_218(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	func_219(func_153(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_219(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_220(Vector3 fParam0, float fParam1, float fParam2)
{
	float fVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_234()) || Global_100201) || Global_25122) || func_233()) || func_15(8, -1)) || func_232()) || func_231()) || func_230()) || func_229()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_234()) || Global_25122) || func_233()) || func_15(8, -1)) || func_230()) || func_232()) || func_231()) || func_229()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_234()) || Global_100201) || Global_25122) || func_233()) || func_15(8, -1)) || func_230()) || func_232()) || func_231()) || func_229()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_234()) || Global_100201) || Global_25122) || func_233()) || func_15(8, -1)) || func_232()) || func_231()) || func_229()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_234() || get_player_wanted_level(player_id()) > 0) || func_15(8, -1)) || func_229()) || func_228()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_234()) || Global_25122) || func_233()) || func_15(8, -1)) || func_231()) || func_230()) || func_229()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_234()) || Global_100201) || Global_25122) || func_233()) || func_15(8, -1)) || func_230()) || func_228()) || func_232()) || func_231()) || func_229())
						{
							return false;
						}
						break;
	...
	if (iLocal_143)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
		{
			if (!PED::IS_PED_INJURED(iLocal_85))
			{
				...
				if (get_script_task_status(iLocal_85, 1805844857) != 1 && get_script_task_status(iLocal_85, 1805844857) != 0)
				{
					set_blocking_of_non_temporary_events(iLocal_85, false);
				}
				set_ped_can_be_targetted(iLocal_85, true);
				if (is_ped_in_group(iLocal_85))
				{
					remove_ped_from_group(iLocal_85);
				}
...
void func_248(auto uParam0, int iParam1, int iParam2)
{
	auto uVar0;
	struct<16> Var1;
	...
	func_250(uParam0, &uVar0);
	Var1 = {func_249(&uVar0)};
}

struct<16> func_249(auto uParam0)
{
	char[64] cVar0;
	int iVar16;
	...
	StringConCat(&cVar0, "/", 64);
	StringIntConCat(&cVar0, func_158(*uParam0), 64);
	return cVar0;
}
...
void func_251(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_252(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_254(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_258(player_id())) && !func_256(player_id(), 0)) && !func_255())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_258(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_260(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
Vector3 func_264()
{
	...
	if (is_player_playing(player_id()))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_70, 1);
		iLocal_69 = 1;
		if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_73, 1) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_73, 1);
			iLocal_69 = 2;
		}
		if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_76, 1) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_76, 1);
			iLocal_69 = 3;
		}
		if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_79, 1) < fVar0)
		{
			fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_79, 1);
			iLocal_69 = 5;
		}
		if (iLocal_69 == 1)
		{
