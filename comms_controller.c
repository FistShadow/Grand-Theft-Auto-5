...
bool func_97()
{
	...
	{
		fVar0 = vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_98(212, 0));
		if (fVar0 > 22500f)
		{
			Global_86613 = -1;
			return true;
...
bool func_108()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (vdist2(func_98(181, 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 40000f)
		{
			return true;
		}
	}
...
void func_138(int iParam0, int iParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_101154.f_6378[Global_36258 /*15*/].f_1, true))
	{
		if (!Global_101154.f_6378.f_913)
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_6378[Global_36258 /*15*/].f_1), 10);
...
void func_144(auto uParam0, int iParam1, int iParam2)
{
	if (Global_117[uParam0 /*10*/].f_8 != 138)
	{
		...
		if (iParam2)
		{
			...
			Global_2893[1 /*6*/].f_5 = iParam1;
			GAMEPLAY::SET_BIT(&Global_2283, false);
		}
	}
}
...
bool func_220()
{
	...
	while (iVar17 <= iVar16 - 1)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(uVar0[iVar17], 0) && is_vehicle_driveable(uVar0[iVar17], 0))
			{
				return true;
			}
		}
