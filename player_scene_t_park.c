#region Local Var
	...
	int iLocal_85 = 0;
	char[64] cLocal_86 = 0;
	char[64] cLocal_102 = 0;
	char[64] cLocal_118 = 0;
	...
	auto uLocal_169 = 0;
	auto uLocal_170 = 0;
	char[64] cLocal_171 = 0;
	char[64] cLocal_187 = 0;
	char[64] cLocal_203 = 0;
	int iLocal_219 = 0;
	int iLocal_220 = 0;
#endregion
...
bool func_2()
{
	...
	if (!is_string_null_or_empty(&cLocal_86))
	{
		if (!does_particle_fx_looped_exist(iLocal_83))
		{
			vVar0 = {Vector(32.856f, 3819.65f, 1971.62f) - vLocal_79};
			iLocal_83 = start_particle_fx_looped_at_coord(&cLocal_86, vLocal_79 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_entity_playing_anim(player_ped_id(), &sLocal_139, &sLocal_155, 2))
		{
			fVar3 = get_synchronized_scene_phase(Global_88941);
			switch (iLocal_220)
			{
				case 0:
					if (fLocal_137 < 0f)
					...
					if (fVar3 > fLocal_137)
					{
						if (!does_entity_exist(iLocal_68) || iLocal_85 != -1)
						{
							if (start_particle_fx_non_looped_on_ped_bone(&cLocal_102, player_ped_id(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_85, 1f, 0, 0, 0))
							{
								if (are_strings_equal(&cLocal_102, "scr_meth_pipe_smoke"))
								{
									func_15(player_ped_id(), 0);
								}
								iLocal_219 = get_sound_id();
								play_sound_from_entity(iLocal_219, &cLocal_203, player_ped_id(), &cLocal_187, 0, 0);
								iLocal_220++;
							}
						}
				...
				case 2:
					if (!is_string_null_or_empty(&cLocal_118))
					{
						if (start_particle_fx_non_looped_at_coord(&cLocal_118, vLocal_79 + vLocal_134, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_220++;
						}
					}
		...
		else
		{
			if (iLocal_84 != 0)
			{
				...
				iLocal_84 = 0;
				stop_sound(iLocal_219);
				release_sound_id(iLocal_219);
			}
			if (does_entity_exist(iLocal_68))
			{
				if (is_entity_attached(iLocal_68))
...
bool func_3(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			if (((get_entity_model(*iParam0) != -1593767197 && get_entity_model(*iParam0) != joaat("v_res_tt_flusher")) && get_entity_model(*iParam0) != joaat("v_ilev_fh_lampa_on")) && get_entity_model(*iParam0) != joaat("prop_cs_remote_01"))
			{
				stop_synchronized_entity_anim(*iParam0, -8f, 1);
			}
		...
		case 9:
			...
			*iParam0 = create_object(iVar34, vVar27, 1, true, false);
			...
			if (func_6(iVar0, &sVar35, &sVar51, &iVar67))
			{
				...
				{
					if (!is_entity_playing_anim(*iParam0, &sVar68, &sVar35, 2))
					{
						play_synchronized_entity_anim(*iParam0, Global_88941, &sVar35, &sVar68, 1000f, -8f, iVar67, 1000f);
					}
				}
			}
...
bool func_4(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
bool func_6(int iParam0, char* sParam1, char* sParam2, auto uParam3)
{
	*uParam3 = 0;
	StringCopy(sParam2, "", 64);
	switch (iParam0)
...
bool func_31()
{
	if (!iLocal_69 == 0)
	{
		if (!does_entity_exist(iLocal_68))
		{
			...
			{
				iLocal_68 = create_object(iLocal_69, vLocal_79, 1, true, false);
				attach_entity_to_entity(iLocal_68, player_ped_id(), get_ped_bone_index(player_ped_id(), iLocal_76), vLocal_70, vLocal_73, 0, 0, 0, 0, 2, 1);
			}
			else
			{
...
void func_37()
{
	...
	{
		if (func_40(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
void func_46()
{
	...
	while (!iVar1 && iVar0 < 400)
	{
		...
		if (!is_string_null_or_empty(&cLocal_171))
		{
			if (!request_ambient_audio_bank(&cLocal_171, 0))
			{
				iVar1 = false;
			}
		}
...
void func_47()
{
	...
	func_51(iLocal_66, &vLocal_79, &uLocal_82, &sVar0);
	switch (iLocal_66)
	{
		case 273:
		case 274:
	...
	func_48(Var8, &Var117);
	func_4(iLocal_66, &sLocal_139, &sVar237, &sLocal_155, &uVar253, &uVar254);
}

bool func_48(struct<109> Param0, auto uParam1)
{
	*uParam109.f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 155:
			...
			*uParam109.f_109 = 1785177548;
			*uParam109.f_110 = 1785177548;
			func_49(uParam109, 17, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			*uParam109.f_118 = 1;
			return true;
			break;
		...
		case 158:
			...
			*uParam109.f_109 = 1785177548;
			*uParam109.f_110 = 1785177548;
			func_49(uParam109, 144, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			*uParam109.f_118 = 1;
			return true;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			...
			*uParam109.f_109 = 1785177548;
			*uParam109.f_110 = 1785177548;
			func_49(uParam109, 43, 1785177548, 1785177548, get_random_float_in_range(-5f, 5f), get_random_float_in_range(-5f, 5f), 0f, get_random_float_in_range(-180f, 180f));
			*uParam109.f_118 = 1;
			return true;
			break;
...
void func_49(auto uParam0, int iParam1, int iParam2, int iParam3, Vector3 vParam4, Vector3 fParam5)
{
...
bool func_51(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_54(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
	...
	switch (iParam0)
	{
		...
		case 11:
			if (func_57(iParam0, &vVar0, uParam1))
			{
...
int func_55(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_57(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
