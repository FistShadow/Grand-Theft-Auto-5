			...
			switch (Var0)
			{
					...
					if (func_429(&Var477, &Var508))
					{
						...
						switch (iLocal_386)
						{
							case 0:
								...
								if (!is_bit_set(Global_101115, false))
								{
						...
						{
							iVar1772 = get_random_int_in_range(false, 200);
							if (iLocal_332 == 2)
							{
								if (iVar1772 < 51)
								{
				...
				case 7:
					if (!is_bit_set(Global_101115, false))
					{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, false);
							Var0 = 8;
						}
					}
					else
				...
				case 8:
					...
					switch (iVar1773)
					{
						case 0:
							...
							{
								if (!is_bit_set(Global_101115, 10))
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 10);
								}
								else
								{
									clear_bit(&Global_101115, 10);
								}
								func_386(&Var508);
								iVar1773++;
							}
...
void func_54(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_56() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_56() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_58(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_56() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_116(auto uParam0, int iParam1)
{
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_136(uParam0.f_246.f_3, 250, 0))
		{
			return true;
		}
	}
	else if ((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) || func_136(uParam0.f_246.f_3, 250, 0))
	{
		return true;
	}
	return false;
		...
		if (!iLocal_304)
		{
			...
			else if (!iLocal_163)
			{
				if (func_3(uParam3.f_666, 18))
				{
					...
					{
						if (!is_bit_set(Global_101115, 3))
						{
							func_399("DARTS_INSTR_W", -1);
							GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 3);
						}
						func_312(uParam3.f_666, 21, 1);
					}
					else if (!func_3(uParam3.f_666, 20) && func_3(uParam3.f_666, 19))
					{
						if (!is_bit_set(Global_101115, 4))
						{
							func_399("DARTS_INSTR_B", -1);
							GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 4);
						}
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_284("DARTS_SHT_USE") && !func_284("DARTS_INSTR_W")) && !func_284("DARTS_INSTR_B")) && !func_284("DARTS_AIM_HLP")) && !func_284("DARTS_STD_HLP")) && !func_284("DARTS_FST_HLP"))
				{
					if (func_3(uParam3.f_666, 24))
					{
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17660.f_6), iLocal_324);
...
void func_267(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
	...
	if (!iParam4 && *uParam3.f_3 < 30)
	{
		...
		iVar6 = get_random_int_in_range(func_269(uParam3), 150);
		if (*uParam3.f_2 > 140)
		{
...
void func_281()
{
	...
	if (is_control_pressed(2, 229))
	{
		...
		{
			iLocal_95 = 1;
			if (!is_bit_set(Global_101115, true))
			{
				func_399("DARTS_SHT_USE", -1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, true);
			}
		}
	}
	else if (iLocal_94)
...
void func_285(int iParam0, int iParam1)
{
	if (iParam0 == 0)
	{
		if (!is_bit_set(Global_101115, 9))
		{
			if ((!func_284("DARTS_SHT_USE") && !func_284("DARTS_INSTR_W")) && !func_284("DARTS_INSTR_B"))
			{
				func_399("DARTS_AIM_HLP", -1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 9);
			}
		}
		else if (iParam1 && !is_bit_set(Global_101115, 7))
		{
			if ((!func_284("DARTS_AIM_HLP") && !func_284("DARTS_INSTR_W")) && !func_284("DARTS_INSTR_B"))
			{
				func_399("DARTS_CLOCK", -1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 7);
			}
		}
	}
	else if (iParam0 == 1)
	{
		if (!is_bit_set(Global_101115, 8))
		{
			if ((!func_284("DARTS_SHT_USE") && !func_284("DARTS_INSTR_W")) && !func_284("DARTS_INSTR_B"))
			{
				func_399("DARTS_STD_HLP", -1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 8);
			}
		}
	}
	else if (iParam0 == 2)
	{
		...
		{
			if (!is_bit_set(Global_101115, 2))
			{
				func_399("DARTS_FST_HLP", -1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_101115, 2);
			}
			iLocal_96 = 1;
		}
	}
...
bool func_306(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 < 8)
	{
		...
		*(uParam0.f_2[iVar0 /*15*/].f_3[0 /*2*/]).f_1 = iParam3;
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2[iVar0 /*15*/].f_12, false);
		if (iParam4 == 1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2[iVar0 /*15*/].f_13, false);
		}
...
bool func_313(int iParam0, auto uParam1)
{
	if (iParam0 >= 10)
	{
		if (!is_bit_set(Global_101154.f_17660.f_6, 12))
		{
			*uParam1 = 12;
			return true;
		}
