	...
	switch (iLocal_331)
	{
		...
		case 1:
			...
			else if (iLocal_332 == 0)
			{
				if (iLocal_313 == 3)
				{
					iLocal_332 = func_2(&uLocal_148, "FAN2AU", "FAN2_SCARED", 8, 1, 0, 0);
				}
			}
			break;
	}
...
void func_22()
{
	switch (iLocal_146)
	{
		...
		case 1:
			...
			if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 1.4f)
			{
				if ((!func_230() && func_229(Local_83.f_28[0])) && GAMEPLAY::GET_GAME_TIMER() - iLocal_323 > 5000)
				{
			...
			else if ((!is_message_being_displayed() && !func_230()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_322 > iLocal_324)
			{
				if (func_229(Local_83.f_28[0]))
				{
					if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 10f)
					{
						if (iLocal_325 < 5)
						{
			...
			if (func_229(Local_83.f_28[0]))
			{
				if (func_230())
				{
					if (iLocal_325 < 5)
					{
						if (!is_ped_headtracking_ped(Local_83.f_28[0], PLAYER::PLAYER_PED_ID()))
						{
							task_look_at_entity(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						}
					}
				}
				else if (is_ped_headtracking_ped(Local_83.f_28[0], PLAYER::PLAYER_PED_ID()))
				{
					task_clear_look_at(Local_83.f_28[0]);
				}
				if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 100f && !is_sphere_visible(get_entity_coords(Local_83.f_28[0], 1), 3f))
				{
					iLocal_146 = 3;
				}
				if ((((((_0x2F09F7976C512404(get_entity_coords(Local_83.f_28[0], 0), 5f) || is_bullet_in_area(get_entity_coords(Local_83.f_28[0], 0), 5f, 0)) || _0x34318593248C8FB2(get_entity_coords(Local_83.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, 0)) || _0x34318593248C8FB2(get_entity_coords(Local_83.f_28[0], 0), joaat("weapon_rpg"), 5f, 0)) || _0x34318593248C8FB2(get_entity_coords(Local_83.f_28[0], 0), joaat("weapon_grenade"), 5f, 0)) || _0x34318593248C8FB2(get_entity_coords(Local_83.f_28[0], 0), joaat("weapon_molotov"), 5f, 0)) || _0x34318593248C8FB2(get_entity_coords(Local_83.f_28[0], 0), joaat("weapon_flare"), 5f, 0))
				{
					trigger_music_event("EPS_FAIL");
					open_sequence_task(&iLocal_318);
					task_play_anim(false, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					close_sequence_task(iLocal_318);
					task_perform_sequence(Local_83.f_28[0], iLocal_318);
					iLocal_313 = 3;
					func_299(2);
				}
				if (PED::IS_PED_INJURED(Local_83.f_28[0]) || is_ped_ragdoll(Local_83.f_28[0]))
				{
					trigger_music_event("EPS_FAIL");
					task_perform_sequence(Local_83.f_28[0], iLocal_318);
					iLocal_313 = 2;
...
void func_28()
{
	...
	{
		func_217(13, floor(Global_101154.f_8884.f_3853));
	}
...
int func_52(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_94(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_94(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_94(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_55(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_64(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_73(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_100(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_100(vVar16.z)] = func_81(iParam1, vVar16.x, func_100(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_100(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
	...
	*uParam0.f_12 = func_110(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_108(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_89(func_107(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
...
void func_173(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_174(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_179()
{
	...
	{
		func_10();
		_0xBF59707B3E5ED531(func_180(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
bool func_201(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_206(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_219(int iParam0)
{
	...
	if (!Global_46152[iVar0 /*203*/].f_10[iVar2 /*48*/].f_1)
	{
		...
		MemCopy(&Var3, {func_224(Global_36852[uVar7 /*12*/].f_1)}, 4);
	}
	else
	{
...
void func_220(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	int iVar0;
	int iVar1;
	char[64] cVar2;
	...
	iVar0 = func_9();
	iVar1 = false;
	StringCopy(&cVar2, func_223(iParam1, &iVar1), 64);
	if (iVar0 == iParam0)
	{
		switch (iParam2)
		{
		...
		if (iVar1)
		{
			func_221(_set_notification_message(&cVar2, &cVar2, 0, 2, _get_label_text(func_222(iParam1)), 0));
		}
		else
		{
			func_221(_set_notification_message("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _get_label_text(func_222(iParam1)), 0));
		}
		switch (Global_14413)
		{
			case 0:
...
bool func_226(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar1 < Global_46152[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_227(Global_46152[iVar0 /*203*/].f_4[iVar1], Global_46152[iVar0 /*203*/].f_1, 1, iParam2, 0);
		}
		iVar1++;
	}
	return true;
...
void func_227(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iParam2)
	{
		...
		iVar2 = uVar20;
		Var3 = {func_224(Global_36852[uVar20 /*12*/].f_1)};
	...
	else
	{
		...
		{
			Var3 = {func_224(Global_36852[uVar26 /*12*/].f_1)};
		}
	}
	if (!iParam4)
	{
	...
	switch (iLocal_146)
	{
		case 0:
			...
			if (func_310())
			{
				...
				request_additional_text("EPS3", false);
				while (!has_cutscene_loaded() && !has_additional_text_loaded(false))
				{
					wait(0);
				}
				func_274(0, 0, 0);
			...
			else if (func_262(1, 1093140480, 0))
			{
				if (func_229(Local_83.f_28[0]))
				{
					register_entity_for_cutscene(Local_83.f_28[0], sLocal_147, 0, false, 0);
				}
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity(sLocal_147, false))
			{
				if (func_229(Local_83.f_28[0]))
				{
...
void func_240(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_244(player_id())) && !func_242(player_id(), 0)) && !func_241())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_244(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_247(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_251(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_252(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}
...
{
	func_268();
	if (func_229(Local_83.f_28[0]) && func_229(PLAYER::PLAYER_PED_ID()))
	{
		if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 9f)
		{
	...
	switch (iLocal_146)
	{
		case 0:
			...
			request_additional_text("EPS3", false);
			while (!has_anim_dict_loaded(sLocal_144) && !has_additional_text_loaded(false))
			{
				wait(0);
			}
			if (func_239(PLAYER::PLAYER_PED_ID()))
			{
				iLocal_320 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
			}
			...
			if (func_229(Local_83.f_28[0]))
			{
				set_blocking_of_non_temporary_events(Local_83.f_28[0], true);
				set_ped_keep_task(Local_83.f_28[0], true);
			}
			iLocal_314 = false;
			func_279(&uLocal_148, 3, Local_83.f_28[0], "MARNIE", 0, 1);
			open_sequence_task(&iLocal_317);
			task_follow_nav_mesh_to_coord(false, 1817.323f, 4708.106f, 38.1031f, 1f, 20000, 0.25f, 1, 40000f);
			task_wander_standard(false, 1193033728, 0);
			close_sequence_task(iLocal_317);
			if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			{
		...
		case 1:
			if (func_229(Local_83.f_28[0]))
			{
				if (iLocal_316 == 0)
				{
					if (((func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 3f && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1847.705f, 4703.014f, 36.58427f, 1844.084f, 4709.532f, 39.73755f, 5f, 0, true, 0)) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1842.977f, 4705.946f, 36.78089f, 1842.161f, 4707.852f, 40.10524f, 2.5f, 0, true, 0)) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1843.527f, 4704.969f, 36.83727f, 1844.178f, 4703.326f, 40.25331f, 2.5f, 0, true, 0))
					{
						if (is_gameplay_hint_active())
						{
						...
						task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 0);
						task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 7000, 0, 2);
						iLocal_316 = 1;
					}
				}
				if (func_231(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			...
			if (!iLocal_314)
			{
				...
				if (iLocal_314 && func_229(Local_83.f_28[0]))
				{
					task_look_at_entity(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
...
void func_279(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (*(uParam0[iParam1 /*10*/]).f_7 == 1)
	{
	}
...
struct<2> func_282(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 1:
			cVar0 = {func_290(iParam0)};
			break;
		
		case 7:
			cVar0 = {func_169(iParam0)};
			break;
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_289(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_288(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_287(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_286(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_285(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_284(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_283(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_289(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_291(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_293(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_273(0)) || func_292(1))
			{
			}
			else
			{
...
bool func_301(auto uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_302(uParam0.f_28[0], 60, vVar3, fVar6, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]) && func_239(PLAYER::PLAYER_PED_ID()))
					{
...
bool func_302(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_303(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_303(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_304(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_308(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
void func_311()
{
	...
	remove_scenario_blocking_area(iLocal_319, 0);
	if (func_326())
	{
	}
...
void func_312(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_327(int iParam0)
{
	...
	if (!func_344())
	{
		...
		{
			func_173(iVar0, 1, 0);
			func_328(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_329(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_335())
	{
		...
		{
			iVar33 = func_330(get_this_script_name());
			if (iVar33 > -1)
			{
...
int func_332(char* sParam0, int iParam1)
{
	int iVar0;
	int iVar1;
