#region Local Var
	...
	Vector3 vLocal_343 = 0;
	Vector3 vLocal_346 = 0;
	int iLocal_349 = 0;
	struct<2> Local_350 = 0;
	auto uLocal_352 = 0;
	auto uLocal_353 = 0;
	auto uLocal_354 = 0;
	auto uLocal_355 = 0;
...
void main()
{
	...
	vLocal_336 = {261.0173f, -1002.98f, -98.0086f};
	fLocal_342 = 230.5943f;
	vLocal_343 = {262.74f, -1004.344f, -99.575f};
	vLocal_346 = {0f, 0f, -162.36f};
	if ((has_force_cleanup_occurred(16) || func_73()) || Global_2460486.f_1711)
	{
		func_72();
	}
	...
	vLocal_339 = {Local_350.f_1[0 /*3*/]};
	vLocal_339 = {261.8297f, -1002.928f, -99.0062f};
	while (true)
	{
		wait(0);
		if ((!is_ped_injured(player_ped_id()) && (!is_player_switch_in_progress() || func_63() == 5)) && !func_52())
		{
			if (get_distance_between_coords(vLocal_339, get_entity_coords(player_ped_id(), 0), 1) < 3f)
			{
				switch (iLocal_321)
				{
					case 0:
			...
			else if (get_distance_between_coords(vLocal_339, get_entity_coords(player_ped_id(), 0), 1) > 3f + 2f)
			{
				func_72();
			}
		}
	...
	switch (iLocal_322)
	{
		case 0:
			...
			if (func_63() == 5)
			{
				...
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_326, sLocal_329, sLocal_331, 8f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_326);
				iLocal_322 = 7;
			}
			else if (func_48(8))
			{
				if ((((func_44(vLocal_339, vVar0) && get_interior_from_entity(player_ped_id()) == get_interior_at_coords(vLocal_339)) && is_entity_in_angled_area(player_ped_id(), vLocal_333, vLocal_336, 2f, 0, true, 0)) && func_43()) && !func_40(player_id()))
				{
					if (iLocal_328 == -1)
					{
		...
		case 1:
			if (func_38(1, 0, 1))
			{
				if (((((func_44(vLocal_339, vVar0) && func_48(8)) && get_interior_from_entity(player_ped_id()) == get_interior_at_coords(vLocal_339)) && is_entity_in_angled_area(player_ped_id(), vLocal_333, vLocal_336, 2f, 0, true, 0)) && func_43()) && !func_40(player_id()))
				{
					if (func_36(iLocal_328, 1))
					{
						...
						fLocal_342 = vVar3.z;
						task_go_straight_to_coord(player_ped_id(), vLocal_339, 1f, 5000, fLocal_342, 0.05f);
						if (get_follow_ped_cam_view_mode() == 4)
						{
							set_ped_desired_heading(player_ped_id(), func_15(get_entity_coords(player_ped_id(), 1), get_entity_coords(iLocal_41, 1)));
		...
		case 2:
			...
			if (get_script_task_status(player_ped_id(), 2106541073) != 1)
			{
				...
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_326, sLocal_329, sLocal_330, 4f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_326);
				iLocal_322 = 3;
			}
			break;
		...
		case 6:
			...
			if (!func_40(player_id()) && is_control_just_pressed(2, 222))
			{
				...
				func_8();
				iLocal_326 = network_create_synchronised_scene(vLocal_343, vLocal_346, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_326, sLocal_329, sLocal_332, 2f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_326);
				iLocal_322 = 8;
			}
			break;
		...
		case 7:
			if (((is_interior_ready(get_interior_at_coords(vLocal_339)) && !func_7()) && !func_5()) && Global_1312466.f_8 == 0)
			{
				iLocal_324 = true;
				iLocal_326 = network_create_synchronised_scene(vLocal_343, vLocal_346, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(player_ped_id(), iLocal_326, sLocal_329, sLocal_332, 1000f, -2f, 261, 0, 1000f, 0);
				network_start_synchronised_scene(iLocal_326);
				iLocal_322 = 8;
			}
			break;
...
float func_15(struct<2> Param0, Vector3 fParam1, struct<2> Param2, Vector3 fParam3)
{
...
void func_16(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((!is_ped_injured(player_ped_id()) && !func_21(player_id())) && !func_18(player_id(), 0)) && !func_17())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_21(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
int func_23(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
{
	return is_bit_set(Global_1338622.f_241.f_136[func_42(9) /*33*/][iParam0], func_41(9));
}
...
bool func_43()
{
	...
	if (iVar9 > 0)
	{
		...
		while (iVar10 <= 7)
		{
			...
			{
				if (is_entity_in_angled_area(uVar0[iVar10], vLocal_333, vLocal_336, 2f, 0, true, 0))
				{
					return false;
				}
			}
...
bool func_44(Vector3 vParam0, float fParam1, auto uParam2, auto uParam3)
{
	if (is_player_playing(player_id()))
	{
		if ((!is_ped_in_any_vehicle(player_ped_id(), 0) && !is_entity_on_fire(player_ped_id())) && is_player_control_on(player_id()))
		{
			...
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_37(0)) && !func_47())
				{
					if ((Global_88539 && Global_88540) || func_46())
					{
						return false;
					}
					if (func_45(get_entity_coords(player_ped_id(), 1), vParam0, fParam3, 0))
					{
						return true;
					}
				}
...
bool func_45(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if (((((is_bit_set(Global_1572919, iParam0) || Global_1572920 != -1) || func_50()) || is_player_free_aiming(player_id())) || is_player_targetting_anything(player_id())) || func_49())
	{
		return false;
	}
	return true;
...
bool func_51()
{
	request_anim_dict(sLocal_329);
	if (!has_anim_dict_loaded(sLocal_329))
	{
		return false;
	}
	iLocal_323 = 1;
...
bool func_52()
{
	...
	if (func_53() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_53()) == 0)
		{
			return true;
		}
	}
...
bool func_61(int iParam0, auto uParam1)
{
...
{
	return func_71(iParam0, Global_35711);
}
...
void func_72()
{
	...
	if (does_cam_exist(iLocal_325))
	{
		destroy_cam(iLocal_325, 0);
	}
	if (iLocal_323)
	{
		remove_anim_dict(sLocal_329);
	}
