...
void main()
{
	...
	while (true)
	{
		...
		{
			if (get_distance_between_coords(vLocal_339, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_321)
				{
					case 0:
			...
			else if (get_distance_between_coords(vLocal_339, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 3f + 2f)
			{
				func_72();
			}
		}
