...
void main()
{
	...
	fLocal_93 = 2.99f;
	fLocal_94 = 3.7f;
	if (network_is_game_in_progress() && func_192(player_id(), 0, 1))
	{
		func_179(Local_224);
	}
	else
		...
		if (Local_96 != 4)
		{
			...
			while (iLocal_222 < _network_get_num_participants_host())
			{
				if (network_is_participant_active(int_to_participantindex(iLocal_222)))
				{
					...
					if (is_bit_set(vLocal_124[iLocal_222 /*3*/].f_1, false))
					{
						if (!is_bit_set(Local_96.f_1, false))
						{
							Var0.f_2 = 109;
					...
					if (is_bit_set(vLocal_124[iLocal_222 /*3*/].f_1, true))
					{
	...
	if ((!network_does_network_id_exist(Local_96.f_3) && func_17(Local_96.f_5)) && network_does_network_id_exist(Local_96.f_2))
	{
		if (func_7(Local_96.f_2))
		{
			if (func_13(&(Local_96.f_3), Local_96.f_2, 22, Local_96.f_5, -1, 1, 1, 1))
			{
				...
				set_ped_relationship_group_hash(net_to_ped(Local_96.f_3), Global_1574232);
...
bool func_13(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_15(var uParam0, int iParam1, vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
void func_21()
{
	...
	if (network_does_network_id_exist(Local_96.f_2))
	{
		if (!is_bit_set(vLocal_124[participant_id_to_int() /*3*/].f_1, false))
		{
			if (!is_vehicle_driveable(net_to_veh(Local_96.f_2), 0))
			{
			}
			...
			if (is_entity_dead(net_to_veh(Local_96.f_2), 0))
			{
				if (player_id() == network_get_destroyer_of_network_id(Local_96.f_2, &uVar0))
				{
					...
					func_103(0, player_ped_id(), "XPT_KAIE", -875716015, -1219286988, iVar3, 1, -1, 0, 0);
					...
					set_bit(&(vLocal_124[participant_id_to_int() /*3*/].f_1), false);
				}
			}
			else
			{
				...
				if (network_has_control_of_network_id(Local_96.f_2))
				{
					...
					if (func_24())
					{
						if (func_23(Local_96.f_2) && func_23(Local_96.f_3))
						{
							...
							if (network_does_entity_exist_with_network_id(Local_96.f_3))
							{
								set_ped_keep_task(net_to_ped(Local_96.f_3), true);
...
void func_25()
{
	...
	if (func_7(Local_96.f_2) && !func_26(Local_96.f_3))
	{
		if (is_ped_in_vehicle(net_to_ped(Local_96.f_3), net_to_veh(Local_96.f_2), 0))
		{
			...
			else if (!is_bit_set(Local_96.f_1, 2) && !is_bit_set(vLocal_124[participant_id_to_int() /*3*/].f_1, true))
			{
				...
				set_bit(&(vLocal_124[participant_id_to_int() /*3*/].f_1), true);
			}
		}
	}
}
...
void func_28(int iParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
	var uVar0;
	int iVar1;
...
void func_29(var uParam0, char* sParam1, var uParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_46(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_47(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_54(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_76(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_75(1);
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_86(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_76(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_75(1);
			}
...
void func_105(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_107(player_ped_id()))
	{
		func_106(1);
	}
...
Vector3 func_108(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_109(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_113(vector3 vParam0, var uParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_190(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_176();
