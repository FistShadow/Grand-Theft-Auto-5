...
void func_130()
{
	...
	func_137();
	func_104();
	if (func_71(player_ped_id(), vLocal_106, 150f) && !is_entity_in_angled_area(player_ped_id(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, true, 0))
	{
...
var func_134(char* sParam0, int iParam1, char* sParam2)
{
...
int func_138(vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_139(network_is_game_in_progress(), 1f, 1f));
								...
								if (!func_159(iVar0))
								{
									if (func_152(iVar0) && !func_151())
									{
										if (!is_entity_a_mission_entity(iVar0))
										{
											...
											{
												func_65(9);
												set_bit(&iLocal_105, 19);
											}
											else if (func_66(player_ped_id()) == 0)
											{
												func_65(17);
											}
											else
...
bool func_163()
{
	...
	{
		iLocal_40 = 1;
		func_164(192, get_entity_coords(player_ped_id(), 1));
		return true;
	}
	return false;
}
...
int func_165(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_176(int iParam0, var uParam1)
{
	...
	func_177(&uLocal_1273, Local_44, player_ped_id(), Local_44.f_1, 0, 1);
