#region Local Var
	...
	int iLocal_272 = 0;
	int iLocal_273 = 0;
	struct<2> Local_274 = 0;
	int iLocal_276 = 0;
	int iLocal_277 = 0;
	int iLocal_278 = 0;
	int iLocal_279 = 0;
	int iLocal_280 = 0;
	var[] uLocal_281 = new var[2];
	var[] uLocal_284 = new var[6];
	var[] uLocal_291 = new var[6];
	var[] uLocal_298 = new var[6];
	int iLocal_305 = 0;
	int iLocal_306 = 0;
	int iLocal_307 = 0;
#endregion
...
void func_1()
{
	...
	{
		case 0:
			request_additional_text("PGANG", false);
			if (has_additional_text_loaded(false))
			{
				iVar4 = 0;
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_99866.f_225[iVar4]))
					{
						uLocal_284[iVar4] = Global_99866.f_225[iVar4];
						Global_99866.f_225[iVar4] = 0;
						set_entity_as_mission_entity(uLocal_284[iVar4], true, 1);
						if (iLocal_307 == 0)
						{
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_99866.f_222[iVar4]))
					{
						uLocal_281[iVar4] = Global_99866.f_222[iVar4];
						Global_99866.f_222[iVar4] = 0;
						set_entity_as_mission_entity(uLocal_281[iVar4], true, 1);
						if (iLocal_306 == 0)
						{
...
auto func_6(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_9()
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_284[iVar0]) && !PED::IS_PED_INJURED(uLocal_284[iVar0]))
		{
			...
			if (uLocal_291[iVar0] > 0)
			{
				...
				if (iVar3 == joaat("weapon_molotov"))
				{
					...
					{
						give_weapon_to_ped(uLocal_284[iVar0], joaat("weapon_microsmg"), -1, true, true);
					}
				}
			}
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					{
						task_combat_ped(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
					break;
	...
	switch (iLocal_272)
	{
		...
		case 1:
			...
			{
				cVar5 = {func_27("START")};
				if (func_10(&uLocal_107, &Local_274, &cVar5, 8, 0, 0, 0))
				{
					StringCopy(&cVar5, "", 16);
					iLocal_272++;
				}
		...
		case 3:
			if ((func_31() && GAMEPLAY::GET_GAME_TIMER() - iLocal_273 > 3000) && !is_ambient_speech_playing(PLAYER::PLAYER_PED_ID()))
			{
...
int func_10(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_33(int iParam0, Vector3 vParam1)
{
	...
	if (!func_36(vParam1))
	{
		...
		{
			task_shoot_at_coord(iParam0, vParam1, -1, -687903391);
		}
	}
...
Vector3 func_34(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
...
Vector3 func_35(Vector3 vParam0, Vector3 fParam1)
{
	float fVar0;
...
bool func_37(int iParam0)
{
	...
	if (((((((((((func_38(Global_99866.f_35, 134217728) || _0x6CD5A433374D4CFB(uLocal_284[iParam0], PLAYER::PLAYER_PED_ID())) || can_ped_hear_player(player_id(), uLocal_284[iParam0])) || has_entity_been_damaged_by_any_ped(uLocal_284[iParam0])) || is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f, 1)) || has_bullet_impacted_in_area(ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f, 1, 1)) || is_explosion_in_sphere(21, ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f)) || is_explosion_in_sphere(10, ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f)) || is_explosion_in_sphere(7, ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f)) || is_explosion_in_sphere(0, ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f)) || is_explosion_in_sphere(1, ENTITY::GET_ENTITY_COORDS(uLocal_284[iParam0], 1), 15f)) || iLocal_280)
	{
		return true;
	}
	return false;
...
void func_39()
{
	...
	while (iVar0 <= 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_281[iVar0]) && is_vehicle_driveable(uLocal_281[iVar0], 0))
		{
			iVar4 = 0;
			while (iVar4 <= 5)
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_284[iVar0]) && !PED::IS_PED_INJURED(uLocal_284[iVar0]))
		{
				...
				case 2:
					if (iLocal_276 != -1)
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_284[iLocal_276]))
						{
							...
							{
								iVar14 = get_vehicle_ped_is_in(uLocal_284[iLocal_276], 0);
							}
						}
					}
					if ((((((((iLocal_276 == -1 || !ENTITY::DOES_ENTITY_EXIST(uLocal_284[iLocal_276])) || PED::IS_PED_INJURED(uLocal_284[iLocal_276])) || !ENTITY::DOES_ENTITY_EXIST(iVar14)) || !is_vehicle_driveable(iVar14, 0)) || is_vehicle_tyre_burst(iVar14, false, 1)) || is_vehicle_tyre_burst(iVar14, true, 1)) || is_vehicle_tyre_burst(iVar14, 4, 1)) || is_vehicle_tyre_burst(iVar14, 5, 1))
					{
						iVar15 = -1;
						iVar16 = false;
						iVar11 = 0;
			...
			switch (uLocal_291[iVar0])
			{
				...
				case 1:
					...
					{
						task_vehicle_shoot_at_ped(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 20f);
					}
					break;
					...
					if (is_ped_in_any_vehicle(uLocal_284[iVar0], 0))
					{
						if (iLocal_276 == iVar0)
						{
							if (func_40(uLocal_284[iVar0], 0) != -1)
							{
								...
								{
									task_shuffle_to_next_vehicle_seat(uLocal_284[iVar0], get_vehicle_ped_is_in(uLocal_284[iVar0], 0));
								}
							}
							else if (!func_32(uLocal_284[iVar0], -1273030092, 1) || iLocal_276 != iLocal_277)
							{
								task_vehicle_mission_ped_target(uLocal_284[iVar0], get_vehicle_ped_is_in(uLocal_284[iVar0], 0), PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], -1273030092) == 1)
							{
								...
								{
									task_drive_by(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), false, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
								}
							}
						}
						else if (func_40(uLocal_284[iVar0], 0) == -1)
						{
							...
							{
								task_vehicle_escort(uLocal_284[iVar0], get_vehicle_ped_is_in(uLocal_284[iVar0], 0), get_vehicle_ped_is_in(uLocal_284[iLocal_276], 0), -1, 40f, 786468, -1082130432, 20, 20f);
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], -1273030092) == 1)
							{
								if (!is_driveby_task_underneath_driving_task(uLocal_284[iVar0]))
						...
						{
							iVar18 = get_ped_in_vehicle_seat(get_vehicle_ped_is_in(uLocal_284[iVar0], 0), -1);
	...
	switch (iLocal_272)
	{
		...
		case 1:
			if (func_31())
			{
				...
				if (func_10(&uLocal_107, &Local_274, &cVar20, 8, 0, 0, 0))
				{
					StringCopy(&cVar20, "", 16);
					iLocal_272++;
				}
...
void func_51(auto uParam0, int iParam1, int iParam2)
{
	switch (iParam1)
	{
		case 11:
...
void func_54(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_55()
{
	...
	set_ped_model_is_suppressed(iLocal_306, false);
	set_vehicle_model_is_suppressed(iLocal_307, false);
