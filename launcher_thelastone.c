...
bool func_165(var uParam0, vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
...
void func_170(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
var func_171(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
void func_172(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_234(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
