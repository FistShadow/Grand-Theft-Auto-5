...
bool func_165(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_156(2))
	{
		if (!func_130())
		{
			if (((func_111(player_ped_id()) && func_111(*uParam0.f_28[0])) && get_game_timer() - *uParam0.f_60 > iParam8) && func_171(player_ped_id(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_166(sParam5))
		{
			...
			{
				if (func_171(player_ped_id(), vParam1, 1) >= 20f)
				{
					func_128();
				}
			}
...
void func_172(int iParam0, auto uParam1, char* sParam2, Vector3 vParam3, Vector3 vParam4, Vector3 vParam5)
{
	...
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam2))
		{
			...
			{
				if (func_171(player_ped_id(), vParam3, 1) <= 100f)
				{
					func_175(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_171(player_ped_id(), vParam6, 1);
					fVar1 = func_171(player_ped_id(), vParam9, 1);
					fVar2 = fVar0 - fVar1;
					if (fVar2 < 0f)
					{
						fVar2 *= -1f;
				...
				if (func_171(player_ped_id(), vParam3, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_182(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), false);
						*uParam1.f_3 = 5;
					}
					else if ((func_183(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_182(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_219(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			iVar5 = true;
			*uParam0.f_28[0] = create_ped(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
