...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_236(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_179(Var0);
		func_172(&iLocal_93, &uLocal_94, &(Var0.f_9), vVar61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_165(&Var0, vVar61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_150(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
bool func_165(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	auto uVar0;
	...
	if (func_156(2))
	{
		if (!func_130())
		{
			if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*uParam0.f_28[0])) && GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_60 > iParam8) && func_171(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_170(&uVar0, iParam6, *uParam0.f_28[0], sParam7, 0, 1);
				func_168(&uVar0, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_166(sParam5))
		{
			...
			{
				if (func_171(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_128();
				}
			}
...
void func_168(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_169(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_170(auto uParam0, auto uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
auto func_171(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_172(int iParam0, auto uParam1, char* sParam2, Vector3 vParam3, Vector3 vParam4, Vector3 vParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam2))
		{
			...
			{
				if (func_171(PLAYER::PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_175(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_171(PLAYER::PLAYER_PED_ID(), vParam6, 1);
					fVar1 = func_171(PLAYER::PLAYER_PED_ID(), vParam9, 1);
					fVar2 = fVar0 - fVar1;
					if (fVar2 < 0f)
					{
						fVar2 *= -1f;
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								remove_cutscene();
								_request_cutscene_2(sParam2, 5, 8);
								func_173(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							remove_cutscene();
							_request_cutscene_2(sParam2, 6, 8);
							func_173(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_171(PLAYER::PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
...
bool func_180(auto uParam0, int iParam1)
{
	...
	if (func_184(uParam0.f_48) && iParam1)
	{
...
void func_181(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_183(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_182(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), false);
						*uParam1.f_3 = 5;
					}
					else if ((func_183(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_182(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_219(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_222(&iVar0) || !has_anim_dict_loaded("rcmlastone1")) || !has_weapon_asset_loaded(joaat("weapon_pumpshotgun"))) || !has_weapon_asset_loaded(joaat("weapon_sniperrifle")))
			{
				return false;
			}
			iLocal_91 = 2;
...
int func_227(int iParam0, char* sParam1)
{
...
bool func_233(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
...
bool func_234(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
bool func_235(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	func_240(uParam0.f_41, iParam1);
}

void func_240(auto uParam0, int iParam1)
{
	int iVar0;
