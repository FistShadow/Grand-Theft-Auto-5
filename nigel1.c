...
void func_1()
{
	switch (iLocal_323)
	{
		case 0:
			iLocal_324 = false;
			func_216(&uLocal_157, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_323 = 1;
			break;
			...
			switch (iLocal_326)
			{
				...
				case 1:
					if (is_cutscene_playing())
					{
						...
						{
							clear_area(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 1, 1, 0, false);
						}
...
void func_227(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_231(player_id())) && !func_229(player_id(), 0)) && !func_228())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_231(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_284(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_281(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_256(iParam0, 0, 0)) || func_256(iParam0, 1, 0)) || func_256(iParam0, 2, 0)) || func_275(iParam0) != 145) || func_255(iParam0)) || func_254(iParam0)) || func_253(iParam0)) || func_252(iParam0)) || !func_244(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_254(iParam0))
		{
		}
...
auto func_258()
{
	...
	func_266(&uVar0, TIME::GET_CLOCK_HOURS());
...
{
	return shift_right(iParam0, 26) & 31 * func_264(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
bool func_295(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_300(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
