...
void func_1()
{
	switch (iLocal_323)
	{
		case 0:
			iLocal_324 = false;
			func_216(&uLocal_157, 2, player_ped_id(), "TREVOR", 0, 1);
			iLocal_323 = 1;
			break;
		...
		case 1:
			if (!iLocal_324)
			{
				iLocal_324 = func_206(&uLocal_157, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			}
			else if (!func_205())
			{
				iLocal_323 = 2;
...
int func_206(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_215(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_216(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
			...
			switch (iLocal_326)
			{
				case 0:
					if (func_295(1, 1093140480, 0))
					{
						...
						{
							register_entity_for_cutscene(Local_96.f_28[0], "Nigel", 0, false, 0);
						}
						if (func_294(Local_96.f_28[1]))
						{
							register_entity_for_cutscene(Local_96.f_28[1], "MRS_Thornhill", 0, false, 0);
						}
						func_293();
				...
				case 1:
					if (is_cutscene_playing())
					{
						...
						{
							clear_area(get_entity_coords(player_ped_id(), 1), 100f, 1, 1, 0, false);
						}
				...
				case 2:
					if (!is_cutscene_playing())
					{
						...
						if (func_294(Local_96.f_35[0]))
						{
							...
							set_vehicle_on_ground_properly(Local_96.f_35[0]);
							...
							if (func_294(Local_96.f_28[0]))
							{
								...
								set_blocking_of_non_temporary_events(Local_96.f_28[0], true);
								set_ped_into_vehicle(Local_96.f_28[0], Local_96.f_35[0], -1);
								set_ped_keep_task(Local_96.f_28[0], true);
							}
							if (func_294(Local_96.f_28[1]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_96.f_28[1], 1862763509);
								clear_ped_tasks_immediately(Local_96.f_28[1]);
								set_blocking_of_non_temporary_events(Local_96.f_28[1], true);
								set_ped_into_vehicle(Local_96.f_28[1], Local_96.f_35[0], false);
								set_ped_keep_task(Local_96.f_28[1], true);
							}
							set_vehicle_engine_on(Local_96.f_35[0], true, 1, 0);
...
int func_220(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_221(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	...
	func_222(iParam0, iLocal_83, vParam1, fParam4);
	if (func_294(*iParam0))
	{
...
void func_222(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_223(iParam0);
...
void func_227(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_231(player_id())) && !func_229(player_id(), 0)) && !func_228())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_231(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
int func_233(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_236(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_237(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_239(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (does_entity_exist(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_284(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_281(get_entity_coords(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_240(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_240(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (does_entity_exist(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		func_272(iParam5, &Var0, vParam1, fParam4, func_275(iParam0));
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_256(iParam0, 0, 0)) || func_256(iParam0, 1, 0)) || func_256(iParam0, 2, 0)) || func_275(iParam0) != 145) || func_255(iParam0)) || func_254(iParam0)) || func_253(iParam0)) || func_252(iParam0)) || !func_244(get_entity_model(iParam0)))
	{
		if (func_254(iParam0))
		{
		}
...
auto func_258()
{
	...
	func_268(&uVar0, get_clock_seconds());
	func_267(&uVar0, get_clock_minutes());
	func_266(&uVar0, get_clock_hours());
	func_261(&uVar0, get_clock_day_of_month());
	func_260(&uVar0, get_clock_month());
	func_259(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return shift_right(iParam0, 26) & 31 * func_264(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_271(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_272(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_269(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
void func_273(auto uParam0, auto uParam1)
{
...
int func_276(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_281(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_282(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_282(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_285(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_286(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_286(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (does_entity_exist(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_288(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_288(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_290(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_289(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_289(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_289(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_289(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_289(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_289(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_289(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_289(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_289(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_289(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_289(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_289(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_289(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_289(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_289(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_289(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_289(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_295(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		{
			if (!func_300(get_vehicle_ped_is_in(player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&cVar0, func_305(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_311(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_313(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_316(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
...
void func_323(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (iParam1)
			{
				iLocal_95 = add_scenario_blocking_area(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				set_scenario_type_enabled("WORLD_HUMAN_GUARD_STAND", false);
				set_scenario_type_enabled("WORLD_HUMAN_CLIPBOARD", false);
				set_scenario_type_enabled("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (iParam1)
			{
				iLocal_95 = add_scenario_blocking_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (iParam1)
			{
				iLocal_95 = add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (iParam1)
			{
				iLocal_95 = add_scenario_blocking_area(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
bool func_325(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_326(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (does_entity_exist(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_326(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_331(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
...
void func_334(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_341(uParam0, iParam1);
	func_339(uParam0, iParam2);
	func_335(uParam0, iParam3);
}

void func_335(auto uParam0, int iParam1)
{
	func_336(uParam0.f_41, iParam1);
}
...
void func_341(auto uParam0, int iParam1)
{
