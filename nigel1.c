...
int func_233(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_272(int iParam0, var uParam1, vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_269(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
bool func_281(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
bool func_289(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_313(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
