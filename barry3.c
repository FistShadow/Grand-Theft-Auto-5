...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_209(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
void func_211(int iParam0)
{
	if (iParam0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_148))
		{
			...
			AI::TASK_PLAY_ANIM(false, sLocal_145, "barry_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_smart_flee_coord(false, ENTITY::GET_ENTITY_COORDS(iLocal_148, 0), 200f, -1, 0, 0);
...
void func_227()
{
	switch (iLocal_144)
	{
		case 0:
			...
			{
				clear_area_of_cops(ENTITY::GET_ENTITY_COORDS(iLocal_147, 1), 1000f, 0);
...
bool func_292()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_147))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_147, PLAYER::PLAYER_PED_ID(), 1) || func_309(PLAYER::PLAYER_PED_ID(), iLocal_147, 1))
		{
...
bool func_307(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_209(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_349(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_384(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_386(iParam0, uVar1[iVar6], 1) && func_385(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_380(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_387(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_349(iVar1 + 1));
			}
		}
