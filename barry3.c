...
bool func_225()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_148) && has_model_loaded(iLocal_153)) && has_model_loaded(iLocal_154))
	{
		vVar0 = {vLocal_354};
		fVar3 = fLocal_365;
...
void func_283()
{
	...
	if (iLocal_144 == 1)
	{
		if ((has_additional_text_loaded(false) && has_model_loaded(iLocal_155)) && has_anim_dict_loaded(sLocal_145))
		{
			if (func_410())
			{
				switch (func_290())
...
void func_387(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_349(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_349(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_390(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_389())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_349(iVar2 + 1)))
				{
