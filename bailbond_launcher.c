		...
		switch (Global_101154.f_29511.f_2)
		{
					...
					if (!func_219())
					{
						if (func_199(4, 62, 2, -1, 0))
						{
							if (func_196(Local_43.f_4, Local_43.f_5))
							{
								...
								uLocal_218 = func_181();
								func_173(&uLocal_218, 0, 0, 0, 10, 0, 0);
								Global_101154.f_29511.f_3 = uLocal_218;
								GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 9);
			...
			case 1:
				if (func_172() == 2)
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, 8))
					{
						if (!func_219())
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29511), 8);
						}
						else
						{
							wait(2000);
					...
					else if (func_219())
					{
						...
						else
						{
							if (GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, 8))
							{
								GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 8);
							}
							wait(2000);
						}
					}
...
void func_28(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29511), func_73(Local_43.f_4));
			if (iParam0 == 1)
			{
				func_72(0);
				iVar0 = 8;
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29511), func_71(Local_43.f_4));
			}
			else
			{
				func_72(1);
				iVar0 = 4;
				GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), func_71(Local_43.f_4));
			...
			if (func_36())
			{
				if (GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, func_71(Local_43.f_4)))
				{
					uLocal_218 = func_181();
					func_173(&uLocal_218, 0, 0, iVar0, 0, 0, 0);
					Global_101154.f_29511.f_3 = uLocal_218;
...
void func_30()
{
	...
	iVar0--;
	if (iVar0 >= 0 && GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, func_71(iVar0)))
	{
		Local_43.f_5 = 1;
	}
	else
...
int func_35()
{
	...
	while (iVar0 <= 4 - 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, iVar0))
		{
			return iVar0;
		}
		iVar0++;
...
void func_74(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_29511, 9))
	{
		if (func_17(Global_101154.f_29511.f_3))
		{
			if (func_221())
			{
				if (func_199(4, 62, 2, -1, 0))
				{
					...
					if (func_14(26, uVar0, 0))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29511), 9);
					}
				}
			}
		}
...
void func_77(char* sParam0, int iParam1, int iParam2)
{
	if (Global_91278 != 10 && Global_91278 != 9)
	{
		...
		func_79(&Global_93091, sParam0, 0, "Start", iParam1, iParam2);
		func_78();
		Global_85789 = 0;
	}
}
...
void func_79(auto uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_81(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_82(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_84(auto uParam0, int iParam1, int iParam2)
{
...
void func_89(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_92(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_93(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_94(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_95(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_96(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_96(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_99(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_101(iParam1)];
...
void func_104(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_105(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_107()
{
	...
	{
		if (func_98(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_109(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_113(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_110(Var9.f_1)) && iVar70 < 50)
			{
...
int func_112(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_116(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
int func_118(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_119(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_129())
		{
			*uParam0 = func_125(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_125(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_127(iVar0))
			{
				fVar1 = get_distance_between_coords(vParam0, func_126(iVar0, 0), 1);
...
struct<6> func_132(int iParam0)
{
	...
	{
		case 0:
			StringCopy(&cVar0, "BailBond1", 24);
			break;
		
		case 1:
			StringCopy(&cVar0, "BailBond2", 24);
			break;
		
		case 2:
			StringCopy(&cVar0, "BailBond3", 24);
			break;
		
		case 3:
			StringCopy(&cVar0, "BailBond4", 24);
			break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_142()) || Global_100201) || Global_25122) || func_148()) || func_147(8, -1)) || func_129()) || func_146()) || func_140()) || func_141()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_142()) || Global_25122) || func_148()) || func_147(8, -1)) || func_140()) || func_129()) || func_146()) || func_141()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_142()) || Global_100201) || Global_25122) || func_148()) || func_147(8, -1)) || func_129()) || func_146()) || func_141()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_142() || get_player_wanted_level(player_id()) > 0) || func_147(8, -1)) || func_141()) || func_145()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_142()) || Global_25122) || func_148()) || func_147(8, -1)) || func_146()) || func_140()) || func_141()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_142()) || func_146()) || Global_100201) || Global_25122) || func_148()) || Global_36839) || func_147(8, -1)) || func_140()) || func_145()) || func_141()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
...
void func_154(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_157(auto uParam0, auto uParam1)
{
	if (!*uParam0.f_7)
	{
		if (func_31(26, func_32(*uParam0.f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_171() && !is_ambient_speech_playing(PLAYER::PLAYER_PED_ID())) && !is_message_being_displayed())
				{
					func_170(uParam1, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int func_158(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_167(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_170(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_173(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_181()
{
	...
	func_177(&uVar0, get_clock_month());
...
void func_186(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_188() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_188() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_187(iParam0));
...
int func_190(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_188() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam3 != -1)
	{
		if (func_201(PLAYER::PLAYER_PED_ID(), iParam3, 0))
		{
			return false;
		}
	}
...
int func_208(float fParam0, int iParam1)
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
bool func_219()
{
	...
	vVar0 = {func_220(get_player_index())};
	fVar3 = Local_43.f_3;
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
	...
	if (iLocal_225 != 0)
	{
		...
		switch (iLocal_225)
		{
			...
			case 2:
				...
				if (has_scaleform_movie_loaded(iLocal_220))
				{
					_push_scaleform_movie_function(iLocal_220, "SHOW_SHARD_MIDSIZED_MESSAGE");
					_begin_text_component("BBS_MP");
					_end_text_component();
					_begin_text_component(sVar0);
					_add_text_component_item_string(sLocal_224);
					_end_text_component();
			...
			case 3:
				if (has_scaleform_movie_loaded(iLocal_220))
				{
					draw_scaleform_movie_fullscreen(iLocal_220, 255, 255, 255, 255, 0);
					_set_2d_layer(4);
					if (!iLocal_221)
					{
				...
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_223 > 7000)
				{
					if (!iLocal_52)
					{
						_push_scaleform_movie_function(iLocal_220, "SHARD_ANIM_OUT");
			...
			case 4:
				set_scaleform_movie_as_no_longer_needed(&iLocal_220);
				iLocal_52 = 0;
				func_223();
				break;
			}
...
void func_225()
{
	if (Global_101154.f_29511.f_1 == 0)
	{
		...
		{
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), false);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), true);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 2);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 3);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 4);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 5);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 6);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 7);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 8);
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_29511), 9);
			uLocal_218 = func_181();
			func_173(&uLocal_218, 0, 0, 1, 0, 0, 0);
			Global_101154.f_29511.f_3 = uLocal_218;
			Global_101154.f_29511.f_2 = 4;
		}
	}
