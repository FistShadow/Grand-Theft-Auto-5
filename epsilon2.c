	...
	switch (iLocal_148)
	{
		...
		case 1:
			if (func_44(player_ped_id()))
			{
				...
				if (!iLocal_155 && !is_entity_in_angled_area(player_ped_id(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
				{
					if (!is_entity_in_angled_area(player_ped_id(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
					{
...
void func_45()
{
	switch (iLocal_148)
	{
		...
		case 1:
			...
			{
				_0x81CBAE94390F9F89();
				force_ped_motion_state(player_ped_id(), -1871534317, false, 1, 1);
			}
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_53(player_id())) && !func_50(player_id(), 0)) && !func_49())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_53(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
bool func_208(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		{
			if (!func_215(get_vehicle_ped_is_in(player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_214(player_ped_id(), -828834893))
				{
