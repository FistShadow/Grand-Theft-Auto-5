	...
	switch (iLocal_148)
	{
		...
		case 1:
			if (func_44(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_155 && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
				{
					if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, true, 0))
					{
...
bool func_14(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_15(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_16(int iParam0, auto uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && _get_number_of_instances_of_streamed_script(Global_82399[26 /*34*/].f_6) == 0)
			{
				Global_101154.f_5951[iParam0] = 1;
				_set_door_acceleration_limit(*uParam1.f_5, Global_101154.f_5951[iParam0], 1, 1);
			}
...
{
	return shift_right(iParam0, 26) & 31 * func_25(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
bool func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	struct<10> Var0;
	struct<10> Var10;
	int iVar20;
...
bool func_35(struct<9> Param0, auto uParam1)
{
	if (Param0.f_8 == 0)
	{
		return false;
...
int func_39(struct<4> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, struct<4> Param7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	int iVar0;
	int iVar1;
...
struct<10> func_41(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, auto uParam9)
{
	struct<10> Var0;
...
void func_45()
{
	switch (iLocal_148)
	{
		...
		case 1:
			...
			{
				_0x81CBAE94390F9F89();
				force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -1871534317, false, 1, 1);
			}
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_53(player_id())) && !func_50(player_id(), 0)) && !func_49())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_53(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_55(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_58(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_71(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_71(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_71(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_102(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_71(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_71(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_71(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_62(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_174(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_67(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_69(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_174(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
bool func_74(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_93(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
void func_103(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_107(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_106(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_104(uVar2, iVar3, iVar0, 1);
	}
}

void func_104(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_105(iParam2)];
	if (iVar0 != 0)
	{
...
int func_106(auto uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_105(iParam1)];
...
int func_107(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_108(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_112(int iParam0)
{
	...
	func_113(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_113(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_118(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_106(func_116(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_114(iParam1, *uParam0.f_2, &uVar1))
			{
...
int func_114(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
void func_119(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_113(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_71(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_113(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_174(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_71(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_71(iParam1)))
	{
		return true;
	}
	return false;
...
void func_176(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_177(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_177(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_179(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_180(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_180(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_181(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
bool func_182(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_193(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_207(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_208(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_215(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_214(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_215(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_216(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_219(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 1:
			cVar0 = {func_227(iParam0)};
			break;
		
		case 7:
			cVar0 = {func_191(iParam0)};
			break;
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_226(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_225(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_224(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_223(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_222(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_221(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_220(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_226(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_228(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_231(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_230(0)) || func_229(1))
			{
			}
			else
			{
...
bool func_234(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
struct<2> func_239(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_241(int iParam0, int iParam1)
{
	struct<5> Var0;
...
bool func_248(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	int iVar0;
	int iVar1;
...
void func_253(int iParam0, int iParam1)
{
	...
	func_281(0, 0);
	MemCopy(&sVar1, {func_191(iVar0)}, 4);
	func_279(&sVar1, func_280());
	func_277();
...
void func_256()
{
	...
	{
		func_317(13, floor(Global_101154.f_8884.f_3853));
	}
...
int func_278(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_71(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_71(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_71(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
void func_283(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&sVar32, {func_192(iParam0)}, 4);
		playstats_mission_checkpoint(&sVar32, 0, Global_91315, 0);
		func_284(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_286()
{
	...
	{
		func_8();
		_0xBF59707B3E5ED531(func_287(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_301(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		...
		func_304(iParam0, iParam3, iParam4, 0);
...
bool func_305(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_310(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_321(int iParam0)
{
	...
	if (!func_340())
	{
		...
		{
			func_283(iVar0, 1, 0);
			func_322(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_323(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_329())
	{
		...
		{
			iVar33 = func_324(get_this_script_name());
			if (iVar33 > -1)
			{
