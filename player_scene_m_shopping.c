		...
		switch (iLocal_288)
		{
			...
			case 2:
				...
				else
				{
					...
					{
						vVar3 = {get_offset_from_entity_in_world_coords(PLAYER::PLAYER_PED_ID(), 5f, 0f, 0f)};
			...
			case 3:
				...
				{
					if (vdist2(ENTITY::GET_ENTITY_COORDS(*iParam0, 1), vLocal_298 + vLocal_302) < fLocal_305 * fLocal_305)
					{
						if (fLocal_305 == 0f)
						{
			...
			case 5:
				...
				else
				{
					...
					{
						if (vdist2(ENTITY::GET_ENTITY_COORDS(*iParam0, 1), vVar9) > 100f)
						{
			...
			case 8:
				...
				if (vdist2(ENTITY::GET_ENTITY_COORDS(*iParam0, 1), ENTITY::GET_ENTITY_COORDS(*iParam0, 1)) > 50f * 1.25f)
				{
					task_follow_nav_mesh_to_coord(*iParam0, vLocal_298 + vLocal_302, 1f, -1, fLocal_305 * 0.1f, 0, 1193033728);
...
void func_7(int iParam0)
{
	...
	if (PED::IS_PED_INJURED(iParam0))
	{
		if (!iLocal_378 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	else
	{
		...
		if (iLocal_376 > 0)
		{
			if (iLocal_377 == 0)
			{
				if (iLocal_376 + 15000 < GAMEPLAY::GET_GAME_TIMER())
				{
			...
			else if (iLocal_376 + 10000 < GAMEPLAY::GET_GAME_TIMER())
			{
...
void func_46(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_48() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_48() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_50(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_48() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_117()
{
	if (!func_119())
	{
		func_30(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
