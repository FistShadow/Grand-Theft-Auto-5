...
void func_1()
{
	...
	while (iVar0 < Global_99808)
	{
		...
		{
			iVar1 = iVar0;
			if (get_game_timer() > Global_99808[iVar0 /*28*/].f_21 && Global_99808[iVar0 /*28*/].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				if (Global_99808[iVar0 /*28*/].f_21 != -1)
				{
					if (!is_bit_set(Global_99808[iVar0 /*28*/].f_27, false))
					{
						...
						{
							set_bit(&(Global_99808[iVar0 /*28*/].f_27), false);
						}
					}
				}
			...
			else if (get_game_timer() - Global_99808[iVar0 /*28*/].f_22 > 1000)
			{
				func_2(iVar0);
			}
		}
