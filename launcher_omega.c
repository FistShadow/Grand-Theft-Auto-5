...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_248(&Var0, 1);
	}
	if (!func_245(&iVar64, &Var0, vVar61, 1f))
	{
		func_244();
	...
	while (true)
	{
		...
		func_183(Var0);
		func_176(&iLocal_93, &(Var0.f_9), vVar61);
		if (Var0 == 44)
		{
			func_168(&Var0, vVar61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_167();
		}
		else if (Var0 == 45)
		{
			func_168(&Var0, vVar61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_165(&Var0);
		}
		if (func_150(&Var0, 0))
		{
...
void func_165(int iParam0)
{
	...
	{
		if (func_111(*iParam0.f_28[0]) && !is_entity_on_screen(*iParam0.f_28[0]))
		{
			if (func_111(PLAYER::PLAYER_PED_ID()) && !func_166(PLAYER::PLAYER_PED_ID(), *iParam0.f_28[0], 50f, 1))
			{
...
void func_167()
{
	...
	_push_scaleform_movie_function(iLocal_96, "SET_COLOUR");
	...
	_push_scaleform_movie_function(iLocal_96, "SET_DISTANCE");
	_push_scaleform_movie_function_parameter_float(10f);
	_pop_scaleform_movie_function_void();
	set_text_render_id(iLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	draw_scaleform_movie(iLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if (GAMEPLAY::GET_GAME_TIMER() - iLocal_98 > 1250)
	{
...
bool func_168(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, auto uParam6)
{
	auto uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_156(2))
		{
			if (!func_130())
			{
				if ((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && func_175(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					...
					if (*uParam8 == 0)
					{
						...
						func_172(&uVar0, sParam4, sParam5, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
			...
			else if (func_170(sParam5))
			{
				if (!*uParam8 == 1)
				{
					...
					{
						if (func_175(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
						{
			...
			if (func_175(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_172(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_173(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_174(auto uParam0, auto uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
auto func_175(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_176(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
...
bool func_184(int iParam0, int iParam1)
{
	...
	if (func_188(iParam0.f_48) && iParam1)
	{
...
void func_185(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_187(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_186(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), false);
						*uParam1.f_3 = 5;
					}
					else if ((func_187(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_186(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
{
	return func_198(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_198(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_199(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_199(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_202(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = {func_204(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
float func_203(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
bool func_209(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_211(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_223()
{
	...
	while (!has_scaleform_movie_loaded(iLocal_96))
	{
		wait(0);
	}
	...
	if (is_named_rendertarget_registered("digiscanner"))
	{
		iLocal_97 = get_named_rendertarget_render_id("digiscanner");
	}
...
void func_226(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_227(iParam0);
...
void func_233(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
int func_239(int iParam0, char* sParam1)
{
...
bool func_245(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_246(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_246(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_246(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_247(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_247(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
