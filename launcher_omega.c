		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_187(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					else if ((func_187(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
