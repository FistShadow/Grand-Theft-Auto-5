...
void func_167()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() - iLocal_98 > 1250)
	{
		play_sound_from_coord(iLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = GAMEPLAY::GET_GAME_TIMER();
	}
}
		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_187(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					else if ((func_187(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
...
bool func_202(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_204(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
...
bool func_211(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_204(vParam1 - get_entity_coords(iParam0, 1))};
