...
void func_165(int iParam0)
{
	...
	if (get_game_timer() - iLocal_98 > 1250)
	{
		...
		{
			if (func_111(player_ped_id()) && !func_166(player_ped_id(), *iParam0.f_28[0], 50f, 1))
			{
...
bool func_168(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, auto uParam6)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_156(2))
		{
			if (!func_130())
			{
				if ((func_111(player_ped_id()) && func_111(*iParam0.f_28[0])) && func_175(player_ped_id(), vParam1, 1) < 20f)
				{
			...
			else if (func_170(sParam5))
			{
				if (!*uParam8 == 1)
				{
					...
					{
						if (func_175(player_ped_id(), vParam1, 1) >= 20f)
						{
			...
			if (func_175(player_ped_id(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_176(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_175(player_ped_id(), vParam2, 1) <= 100f)
				{
					func_179(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_175(player_ped_id(), vParam2, 1) > 120f)
				{
					func_181(iParam0);
				}
			}
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_186(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), false);
						*uParam1.f_3 = 5;
					}
					else if ((func_187(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_186(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_193(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
{
	return func_198(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
bool func_234(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_111(*uParam0.f_28[0]) && does_entity_exist(*uParam0.f_41[0])) && does_entity_exist(*uParam0.f_41[1]))
			{
