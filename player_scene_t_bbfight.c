#region Local Var
	...
	int[] iLocal_279 = new int[2];
	int[] iLocal_282 = new int[2];
	int iLocal_285 = 0;
	int[] iLocal_286 = new int[2];
	int[] iLocal_289 = new int[2];
	int[] iLocal_292 = new int[2];
	Vector3 vLocal_295 = 0;
	float fLocal_298 = 0;
	Vector3[] vLocal_299 = new Vector3[2];
	Vector3[] fLocal_306 = new Vector3[2];
	Vector3[] vLocal_309 = new Vector3[1];
	Vector3[] vLocal_313 = new Vector3[1];
	Vector3[] fLocal_317 = new Vector3[1];
	char* sLocal_319 = 0;
	auto uLocal_320 = 0;
	auto uLocal_321 = 0;
	auto uLocal_322 = 0;
	...
	auto uLocal_365 = 0;
	auto uLocal_366 = 0;
	char[64] cLocal_367 = 0;
	struct<16>[] Local_383 = new struct<16>[2];
	struct<16>[] Local_416 = new struct<16>[2];
	struct<16>[] Local_449 = new struct<16>[2];
	int[] iLocal_482 = new int[2];
	struct<4> Local_485 = 0;
	struct<4> Local_489 = 0;
	struct<4> Local_493 = 0;
	float fLocal_497 = 0;
	int iLocal_498 = 0;
#endregion
...
bool func_2()
{
		...
		if (func_20(iVar1))
		{
			if (!is_string_null_or_empty(&Local_493))
			{
				if (!iLocal_498)
				{
					...
					{
						if (!is_string_null_or_empty(&Local_485))
						{
	...
	if (vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_295) > 100f)
	{
		return true;
	}
	return false;
...
void func_14(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
		...
		if (!PED::IS_PED_INJURED(*iParam0[iVar0]))
		{
			switch (*iParam1[iVar0])
			{
				case 100:
					...
					{
						task_synchronized_scene(*iParam0[iVar0], Global_88940, &cLocal_367, &(Local_383[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						*iParam1[iVar0] = 101;
					}
				...
				case 101:
					if (is_synchronized_scene_running(Global_88941))
					{
						task_synchronized_scene(*iParam0[iVar0], Global_88941, &cLocal_367, &(Local_416[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						request_anim_dict(&cLocal_367);
						*iParam1[iVar0] = 102;
					}
					break;
				
				case 102:
					if (has_anim_dict_loaded(&cLocal_367) && is_entity_playing_anim(*iParam0[iVar0], &cLocal_367, &(Local_416[iVar0 /*16*/]), 2))
					{
						sVar1 = "victim_fall";
						fVar2 = -1f;
						fVar3 = -1f;
						if (find_anim_event_phase(&cLocal_367, &(Local_416[iVar0 /*16*/]), sVar1, &fVar2, &fVar3))
						{
							if (fVar2 < get_synchronized_scene_phase(Global_88941))
							{
						...
						if (iLocal_109 == 165)
						{
							if (!is_string_null_or_empty(&(Local_449[iVar0 /*16*/])))
							{
								sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								request_anim_dict(sVar4);
								if (0.95f < get_synchronized_scene_phase(Global_88941))
								{
									if (has_anim_dict_loaded(sVar4))
									{
										task_start_scenario_in_place(*iParam0[iVar0], &(Local_449[iVar0 /*16*/]), 0, 0);
						...
						if (iLocal_109 == 259)
						{
							if (0.95f < get_synchronized_scene_phase(Global_88941))
							{
								task_put_ped_directly_into_melee(*iParam0[iVar0], PLAYER::PLAYER_PED_ID(), 0f, -1f, 0f, 0);
								_0x2208438012482A1A(*iParam0[iVar0], 0, 0);
								wait(0);
								*iParam1[iVar0] = 10;
								break;
						...
						if (iLocal_109 == 246 && iVar0 == 0)
						{
							if (0.95f < get_synchronized_scene_phase(Global_88941))
							{
								...
								if (!PED::IS_PED_INJURED(*iParam0[iVar0]))
								{
									task_put_ped_directly_into_melee(PLAYER::PLAYER_PED_ID(), *iParam0[iVar0], 0f, -1f, 0f, 0);
									wait(0);
								}
								*iParam1[iVar0] = 10;
								break;
				...
				case 200:
					if (is_synchronized_scene_running(Global_88940))
					{
						task_play_anim(*iParam0[iVar0], &cLocal_367, &(Local_383[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						*iParam1[iVar0] = 201;
					}
					else if (is_synchronized_scene_running(Global_88941))
					{
				...
				case 201:
					if (is_synchronized_scene_running(Global_88941))
					{
						task_play_anim(*iParam0[iVar0], &cLocal_367, &(Local_416[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
						task_look_at_entity(*iParam0[iVar0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						request_anim_dict(&cLocal_367);
						*iParam1[iVar0] = 202;
					}
					break;
				...
				case 202:
					if (has_anim_dict_loaded(&cLocal_367) && is_entity_playing_anim(*iParam0[iVar0], &cLocal_367, &(Local_416[iVar0 /*16*/]), 1))
					{
						sVar5 = "victim_fall";
						fVar6 = -1f;
						fVar7 = -1f;
						if (find_anim_event_phase(&cLocal_367, &(Local_416[iVar0 /*16*/]), sVar5, &fVar6, &fVar7))
						{
							if (fVar6 < get_entity_anim_current_time(*iParam0[iVar0], &cLocal_367, &(Local_416[iVar0 /*16*/])))
							{
								if (!is_ped_running_ragdoll_task(*iParam0[iVar0]))
								{
									clear_ped_tasks(*iParam0[iVar0]);
						...
						{
							if (get_entity_anim_current_time(*iParam0[iVar0], &cLocal_367, &(Local_416[iVar0 /*16*/])) > 0.954f)
							{
								if (iLocal_109 == 108)
								{
								...
								task_follow_nav_mesh_to_coord(*iParam0[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
								force_ped_motion_state(*iParam0[iVar0], -668482597, false, 0, 0);
				...
				case 1:
					...
					{
						task_follow_nav_mesh_to_coord(*iParam0[iVar0], vVar21, 0.5f, -1, 0.25f, 0, 1193033728);
						break;
					}
					break;
				...
				case 11:
					if (vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_295) > 50f && vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(*iParam0[iVar0], 1)) > 50f)
					{
				...
				case 5:
					if (func_26(*iParam0[iVar0]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_286[iVar0]))
						{
							delete_object(&(iLocal_286[iVar0]));
							set_object_as_no_longer_needed(&(iLocal_286[iVar0]));
						}
						clear_ped_tasks(*iParam0[iVar0]);
					...
					if (!ped_has_use_scenario_task(*iParam0[iVar0]))
					{
						if (are_strings_equal(&(Local_449[iVar0 /*16*/]), "any"))
						{
							...
							{
								task_use_nearest_scenario_to_coord(*iParam0[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 20f, 0);
						...
						else
						{
							...
							task_start_scenario_in_place(*iParam0[iVar0], &(Local_449[iVar0 /*16*/]), 0, iVar26);
							iLocal_482[iVar0] = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_286[iVar0]))
					{
	...
	while (iVar0 < 263)
	{
		if (is_bit_set(Global_25433[iVar0 /*23*/].f_11, false))
		{
			...
			else
			{
				...
				if (vdist2(get_entity_coords(iParam0, 1), vVar1) < fParam1 * fParam1)
				{
					return true;
				}
				if (is_bit_set(Global_25433[iVar0 /*23*/].f_11, 19))
				{
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5)
					{
						...
						if (!func_24(vVar6))
						{
							if (vdist2(get_entity_coords(iParam0, 1), vVar6) < fParam1 * fParam1)
							{
								return true;
							}
						}
...
bool func_26(int iParam0)
{
	...
	while (iVar1 < 1)
	{
		...
		{
			if (func_27(PLAYER::PLAYER_PED_ID(), vLocal_295 + vLocal_309[iVar1 /*3*/], vLocal_313[iVar1 /*3*/], fLocal_298 + fLocal_317[iVar1], 0, 1, 0))
			{
				fVar2 = 50f;
				if (is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), fVar2))
				{
					return true;
				}
			}
...
bool func_27(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_30(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_32(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_34(vParam1 - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_34(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
int func_44(auto uParam0, auto uParam1)
{
...
void func_50()
{
	...
	while (!iVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_276)
		{
			...
			{
				request_model(iLocal_282[iVar0]);
				if (!has_model_loaded(iLocal_282[iVar0]))
				{
					iVar2 = false;
					request_model(iLocal_282[iVar0]);
				}
			...
			{
				request_model(iLocal_289[iVar0]);
				if (!has_model_loaded(iLocal_289[iVar0]))
				{
					iVar2 = false;
					request_model(iLocal_289[iVar0]);
				}
	...
	add_relationship_group("FIGHTERS", &iLocal_285);
	iVar0 = 0;
	while (iVar0 < iLocal_276)
	{
		if (iLocal_282[iVar0] != 0)
		{
			...
			if (iLocal_282[iVar0] == joaat("s_m_y_baywatch_01"))
			{
				if (get_ped_drawable_variation(iLocal_276[iVar0], 3) == 0)
				{
					...
					{
						set_ped_component_variation(iLocal_276[iVar0], 10, true, false, 0);
					}
				}
				else if (get_ped_drawable_variation(iLocal_276[iVar0], 10) == 1)
				{
					...
					{
						set_ped_component_variation(iLocal_276[iVar0], 10, false, false, 0);
					}
				}
			}
			...
			if (iLocal_109 == 285)
			{
				...
				set_entity_health(iLocal_276[iVar0], 105);
			}
		}
		if (iLocal_289[iVar0] != 0)
		{
			iLocal_286[iVar0] = create_object(iLocal_289[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 1, true, false);
			set_entity_heading(iLocal_286[iVar0], fLocal_298 + fLocal_306[iVar0]);
			attach_entity_to_entity(iLocal_286[iVar0], iLocal_276[iVar0], get_ped_bone_index(iLocal_276[iVar0], iLocal_292[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_285, 1862763509);
...
void func_51()
{
	...
	func_55(iLocal_109, &vLocal_295, &fLocal_298, &sVar0);
	func_53(iLocal_109, &sLocal_319, &sLocal_335, &sLocal_351, &uVar8, &uVar9);
	...
	switch (iLocal_109)
	{
		...
		case 166:
			...
			fLocal_306[0] = get_random_float_in_range(-180f, 180f);
		...
		case 259:
			vLocal_299[0 /*3*/] = {get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f};
			vLocal_299[1 /*3*/] = {get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f};
			fLocal_306[0] = get_random_float_in_range(-180f, 180f);
			fLocal_306[1] = get_random_float_in_range(-180f, 180f);
		...
		default:
			...
			iLocal_282[0] = joaat("a_m_y_musclbeac_01");
			iLocal_282[1] = joaat("a_m_y_musclbeac_01");
			vLocal_309[0 /*3*/] = {get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f};
			vLocal_313[0 /*3*/] = {1f, 1f, 1f};
			fLocal_317[0] = get_random_float_in_range(-180f, 180f);
			break;
	}
}
...
bool func_53(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
bool func_55(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_57(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
...
int func_58(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_60(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_62()
{
	...
	while (iVar0 < iLocal_282)
	{
		if (iLocal_282[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_282[iVar0]);
		}
		iVar0++;
	}
	remove_relationship_group(iLocal_285);
