...
void func_6()
{
	...
	{
		register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, joaat("player_one"), 0);
	}
	...
	while (is_cutscene_playing() || !iVar1)
	{
		_0x208784099002BC30("M_FinaleChoice", 0);
...
bool func_8(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_46(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_14(*iParam1, 0, &uVar0))
		{
...
bool func_10(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_11(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_13(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_14(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	if (!func_16(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_16(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_20(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_35(iParam0, 0, 0)) || func_35(iParam0, 1, 0)) || func_35(iParam0, 2, 0)) || func_34(iParam0) != 145) || func_33(iParam0)) || func_32(iParam0)) || func_15(iParam0)) || func_31(iParam0)) || !func_23(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_32(iParam0))
		{
		}
...
bool func_40(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_43(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_42(*uParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*uParam0, 24, func_42(*uParam0, *uParam1[38] - 1), false);
	}
	if (func_41(*uParam0))
	{
...
void func_45(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
bool func_47(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	struct<82> Var1;
	int iVar99;
...
void func_48(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_49(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_49(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_56(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
void func_52()
{
	...
	{
		if (func_55(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_56(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (((((((((((((((func_57(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_57(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_57(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_57(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_57(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_57(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_57(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_57(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_57(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_57(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_57(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_57(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_57(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_57(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_57(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_57(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_57(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_60(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_49(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

int func_61(Vector3 vParam0, int iParam1)
{
	return func_62(Global_93091.f_2311.f_12.f_66, vParam0, iParam3);
}

bool func_62(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_64(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_73(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
void func_76()
{
	...
	while (!has_cutscene_loaded())
	{
		...
		{
			func_77("FRANKLIN", PLAYER::PLAYER_PED_ID(), 0, 2);
		}
		wait(0);
	}
}
...
void func_78(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	struct<50> Var2;
...
bool func_87(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	auto uVar0;
	...
	*uParam0.f_12 = func_102(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_95(func_98(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_95(func_94(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
...
int func_99(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_100(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_101(uParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3))
	{
...
int func_101(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_158(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	auto uVar0;
...
void func_161(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_163(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_164(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_170(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_172(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_172(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
