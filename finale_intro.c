...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_46(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(uParam1.f_77, func_20(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_35(iParam0, 0, 0)) || func_35(iParam0, 1, 0)) || func_35(iParam0, 2, 0)) || func_34(iParam0) != 145) || func_33(iParam0)) || func_32(iParam0)) || func_15(iParam0)) || func_31(iParam0)) || !func_23(get_entity_model(iParam0)))
	{
		if (func_32(iParam0))
		{
		}
...
bool func_40(auto uParam0, auto uParam1, auto uParam2)
{
	...
	if (func_43(get_entity_model(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_42(*uParam0, *uParam1[38] - 1))
	{
...
void func_52()
{
	...
	{
		if (func_55(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
void func_76()
{
	...
	while (!has_cutscene_loaded())
	{
		...
		{
			func_77("FRANKLIN", player_ped_id(), 0, 2);
		}
		wait(0);
	}
}
