...
void func_84(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_86() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_86() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_88(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_86() /*10375*/].f_7704.f_10, iParam0);
}
...
float func_97(int iParam0)
{
	if (func_16(iParam0))
	{
		...
		{
			return func_14(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
int func_159(auto uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (!is_bit_set(uLocal_458[iVar0], true))
			{
		...
		else if (is_bit_set(uLocal_458[iVar0], true))
		{
			clear_bit(&(uLocal_458[iVar0]), true);
		}
		if (!is_vehicle_window_intact(*uParam0.f_4, iVar0))
		{
			iVar1 = 0;
			if (!is_bit_set(uLocal_453[iVar0], true))
			{
		...
		else if (is_bit_set(uLocal_453[iVar0], true))
		{
			clear_bit(&(uLocal_453[iVar0]), true);
		}
		iVar0++;
	}
	return iVar1;
