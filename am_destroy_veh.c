...
void main()
{
	...
	iLocal_247 = 20;
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_205(player_id(), 0, 1))
	{
		func_196(Local_284);
	}
	else
	...
	if (Local_96 != 4)
	{
		...
		while (iLocal_244 < _network_get_num_participants_host())
		{
			if (network_is_participant_active(int_to_participantindex(iLocal_244)))
			{
				...
				if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, false))
				{
					Var0.f_2 = 117;
					Var0.f_10 = iVar14;
					Local_96.f_8 = iVar14;
				...
				{
					if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, true))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_1), false);
					}
					if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, 2))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_1), false);
					}
				}
				else
				{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, 3))
						{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, 4))
						{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, 5))
						{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_145[iLocal_244 /*3*/].f_1, 6))
						{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_205(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_26(iVar1)))
					{
...
void func_41()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Local_96.f_1, false))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, true) && !GAMEPLAY::IS_BIT_SET(vLocal_145[participant_id_to_int() /*3*/].f_1, 3))
		{
			if (network_does_network_id_exist(Local_96.f_3))
			{
				if (network_has_control_of_network_id(Local_96.f_3) || (!_0xA1607996431332DF(Local_96.f_3) && network_is_host_of_this_script()))
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_145[participant_id_to_int() /*3*/].f_1), 3);
				}
			}
		}
		iVar0 = 0;
		while (iVar0 < 3)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 2 + iVar0) && !GAMEPLAY::IS_BIT_SET(vLocal_145[participant_id_to_int() /*3*/].f_1, 4 + iVar0))
			{
				if (network_does_network_id_exist(Local_96.f_4[iVar0]))
				{
					if (network_has_control_of_network_id(Local_96.f_4[iVar0]) || (!_0xA1607996431332DF(Local_96.f_4[iVar0]) && network_is_host_of_this_script()))
					{
						...
						if (!PED::IS_PED_INJURED(net_to_ped(Local_96.f_4[iVar0])))
						{
							task_combat_hated_targets_around_ped(net_to_ped(Local_96.f_4[iVar0]), 100f, 0);
						}
						GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_145[participant_id_to_int() /*3*/].f_1), 4 + iVar0);
					}
				}
			}
			iVar0++;
...
void func_46()
{
	...
	if (network_does_network_id_exist(Local_96.f_2))
	{
		if (!GAMEPLAY::IS_BIT_SET(vLocal_145[participant_id_to_int() /*3*/].f_1, false))
		{
			...
			if (is_entity_dead(net_to_veh(Local_96.f_2), 0))
			{
				if (player_id() == network_get_destroyer_of_network_id(Local_96.f_2, &uVar0))
				{
					func_166(2096, 1, -1);
					func_163(68, 1, -1);
					func_120(0, PLAYER::PLAYER_PED_ID(), "XPT_KAIE", -875716015, 1504756458, Global_262145.f_6474, 1, -1, 0, 0);
					if (func_14())
					{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_145[participant_id_to_int() /*3*/].f_1), false);
				}
			}
			else
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, false))
				{
					if (!GAMEPLAY::IS_BIT_SET(vLocal_145[participant_id_to_int() /*3*/].f_1, true))
					{
						if (func_53(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_2), 1))
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_145[participant_id_to_int() /*3*/].f_1), true);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(vLocal_145[participant_id_to_int() /*3*/].f_1, 2))
					{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(vLocal_145[participant_id_to_int() /*3*/].f_1), 2);
						}
					}
				}
				if (func_205(player_id(), 1, 1) && func_53(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_2), 0))
				{
...
void func_47()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_242, false))
	{
		if (func_52(27, -1) == 0)
		{
			if (func_205(player_id(), 1, 1))
			{
				if (func_53(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_2), 0))
				{
					if (func_6(&uLocal_282, 300000, 0))
					{
						func_50(27, 1, -1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_242, false);
					}
				}
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_86(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_85(1);
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_94(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_86(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_85(1);
			}
...
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332285.f_59[uParam0 /*16*/]), 5);
}

void func_113(int iParam0)
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332285.f_59[iParam0 /*16*/]), 4);
}
...
void func_115(int iParam0, auto uParam1, int iParam2)
{
	...
	if (iParam2)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332285.f_59[iParam0 /*16*/]), 2);
		GAMEPLAY::CLEAR_BIT(&(Global_1332285.f_59[iParam0 /*16*/]), 3);
	}
	else
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332285.f_59[iParam0 /*16*/]), 3);
...
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332285.f_59[iParam0 /*16*/]), false);
}
...
Vector3 func_125(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_126(PLAYER::PLAYER_PED_ID()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
