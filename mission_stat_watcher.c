...
void main()
{
	...
	while (!Global_55743)
	{
		if (Global_67844 > 0)
		{
			...
			else if (get_game_timer() - Global_55777 > 1000)
			{
				func_99();
			}
		}
...
int func_21(var uParam0, int iParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_72(var uParam0, float fParam1, int iParam2)
{
	if (iParam2)
	{
...
void func_74(var uParam0, float fParam1, int iParam2)
{
	if (iParam2)
	{
...
var func_76(var uParam0, int iParam1, int iParam2, int iParam3)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_91(int iParam0)
{
	...
	{
		case 0:
			stat_set_int(joaat("jewel_heist_raw_take"), Global_101154.f_1.f_126[iParam0 /*23*/], 1);
			break;
	}
	iVar7 = 0;
	iVar8 = 0;
			...
			switch (iVar4)
			{
				case 6:
					if (Global_67845[iVar2 /*9*/].f_6 != 0)
					{
						...
						else if (does_entity_exist(Global_67845[iVar2 /*9*/].f_6))
						{
				...
				case 5:
					if (iVar1)
					{
						if (Global_55761 == -1 || Global_55761 == Global_67845[iVar2 /*9*/])
						{
							if (!Global_55760 == 0)
							{
								if (does_entity_exist(Global_55760))
								{
...
void func_101()
{
	...
	if (Global_55778 > 0)
	{
		...
		while (iVar0 < 64)
		{
			...
			{
				if (!does_entity_exist(Global_55779[iVar0 /*2*/]))
				{
					Global_55779[iVar0 /*2*/] = 0;
					Global_55778--;
				}
						...
						if ((is_entity_a_ped(iVar5) && get_player_ped(get_player_index()) == get_ped_index_from_entity_index(iVar5)) || iVar14)
						{
							...
							if (Global_68030 > 0)
							{
								...
								while (!iVar8)
								{
									...
									{
										if (does_entity_exist(Global_67997[iVar1 /*2*/]))
										{
