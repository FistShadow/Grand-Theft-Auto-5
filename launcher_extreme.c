...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_265(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
	...
	if (Var0 == 17)
	{
		iLocal_97 = add_scenario_blocking_area(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		set_scenario_type_enabled("WORLD_VEHICLE_SALTON_DIRT_BIKE", false);
	}
	else if (Var0 == 18)
	{
		iLocal_97 = add_scenario_blocking_area(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		func_185(Var0);
		func_178(&iLocal_94, &(Var0.f_9), vVar61);
		if (Var0 == 18)
		{
			func_177(&Var0);
			func_172(&Var0, vVar61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0 == 19)
		{
			func_177(&Var0);
			if (has_sound_finished(iLocal_96))
			{
				func_172(&Var0, vVar61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_171() && func_170(Var0.f_28[0])) && !is_any_speech_playing(Var0.f_28[0])) && has_sound_finished(iLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false))
			{
				play_sound_from_entity(iLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_170(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
void func_130()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_131(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_131(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_145()
{
	return func_146(get_this_script_name(), 0);
}
...
int func_149(Vector3 vParam0, int iParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(vParam0);
	set_blip_scale(iVar0, func_150(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	set_blip_route(iVar0, iParam3);
	return iVar0;
}

float func_150(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
bool func_152(auto uParam0)
{
	if (*uParam0 == 18)
	{
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_153(PLAYER::PLAYER_PED_ID(), -828834893) && func_170(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && func_131(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
	...
	switch (*uParam0.f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_170(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
bool func_172(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_170(PLAYER::PLAYER_PED_ID()) && func_170(*iParam0.f_28[0])) && !func_171()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_176(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_175(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
		func_173(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_173(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_175(auto uParam0, auto uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
auto func_176(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_177(int iParam0)
{
	if (_0xB56BBBCC2955D9CB())
	{
		...
		{
			_0x2A56C06EBEF2B0D9("Dom", *iParam0.f_28[0], false);
		}
	}
}
...
void func_178(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_176(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_181(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_176(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_183(iParam0);
				}
			}
...
bool func_186(auto uParam0, int iParam1)
{
	...
	if (func_190(uParam0.f_48) && iParam1)
	{
...
void func_187(int iParam0, auto uParam1, int iParam2)
{
	...
	if (func_170(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_189(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_188(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_189(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_188(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_194(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_196(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_198(int iParam0, float fParam1)
{
	...
	if (func_170(PLAYER::PLAYER_PED_ID()) && func_170(iParam0))
	{
		if (func_209(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_200(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_200(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_201(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_201(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_204(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = {func_206(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
float func_205(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
bool func_211(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_213(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_226(int iParam0, Vector3 vParam1, Vector3 fParam2)
{
	func_227(iParam0, iLocal_93, vParam1, fParam4, 26);
...
void func_231(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
...
bool func_233(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
...
bool func_234(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]))
			{
				if (func_233(uParam0.f_28[0], 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
						task_look_at_entity(*uParam0.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					}
				}
				else
				{
...
void func_237(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_238(iParam0);
...
int func_244(int iParam0, char* sParam1)
{
...
bool func_250(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
...
bool func_251(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
bool func_252(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_255(auto uParam0, int iParam1, int iParam2, int iParam3)
{
