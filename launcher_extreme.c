...
void main()
{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((iLocal_95 == 0 && func_170(player_ped_id())) && is_entity_at_coord(player_ped_id(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
void func_130()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			if (func_131(get_vehicle_ped_is_in(player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_149(Vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_150(network_is_game_in_progress(), 1f, 1f));
...
bool func_152(auto uParam0)
{
	if (*uParam0 == 18)
	{
		if (is_entity_in_angled_area(player_ped_id(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), 0))
			{
			...
			else if ((!func_153(player_ped_id(), -828834893) && func_170(get_vehicle_ped_is_in(player_ped_id(), 0))) && func_131(get_vehicle_ped_is_in(player_ped_id(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
	...
	switch (*uParam0.f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (func_170(get_vehicle_ped_is_in(player_ped_id(), 0)))
					{
...
bool func_172(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_170(player_ped_id()) && func_170(*iParam0.f_28[0])) && !func_171()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_176(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_178(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_176(player_ped_id(), vParam2, 1) <= 100f)
				{
					func_181(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_176(player_ped_id(), vParam2, 1) > 120f)
				{
					func_183(iParam0);
				}
			}
	...
	if (func_170(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_188(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_189(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_188(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_195(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
bool func_198(int iParam0, float fParam1)
{
	...
	if (func_170(player_ped_id()) && func_170(iParam0))
	{
...
{
	return func_200(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
