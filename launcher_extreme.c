...
void main()
{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((iLocal_95 == 0 && func_170(PLAYER::PLAYER_PED_ID())) && is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				vVar69 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
				if (vVar69.z < 100f)
				{
					iLocal_95 = 1;
		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_189(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					else if ((func_189(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
...
bool func_204(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_206(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
...
bool func_213(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_206(vParam1 - get_entity_coords(iParam0, 1))};
