	...
	else
	{
		...
		switch (Local_413.f_410)
		{
			...
			case 17:
				...
				if (((ENTITY::IS_ENTITY_AT_COORD(Local_413.f_4, Local_413.f_17, 10f, 10f, 10f, false, true, 0) && ENTITY::IS_ENTITY_AT_COORD(Local_413.f_3, vLocal_848, 5f, 5f, 5f, false, true, 0)) && func_291(&Local_413)) && !iLocal_861)
				{
					if (!PED::IS_PED_INJURED(Local_413.f_3))
					{
				...
				if (iLocal_861)
				{
					if ((func_139(&Local_413, 6) > 8f && ENTITY::IS_ENTITY_AT_COORD(Local_413.f_4, Local_413.f_17, 10f, 10f, 10f, false, true, 0)) && func_291(&Local_413))
					{
						if (!PED::IS_PED_INJURED(Local_413.f_3))
						{
							if (ENTITY::IS_ENTITY_OCCLUDED(Local_413.f_3))
			...
			case 21:
				...
				{
					FIRE::ADD_EXPLOSION(344.5906f, -996.409f, 28.30219f, 4, 0.5f, 1, 0, 1f);
			...
			case 27:
				if (func_110() && !iLocal_866)
				{
					...
					iLocal_843 = create_object(joaat("p_banknote_s"), ENTITY::GET_ENTITY_COORDS(Local_413.f_3, 1), 1, true, false);
					...
					{
						AI::TASK_PLAY_ANIM(Local_413.f_3, "oddjobs@taxi@cyi", func_108(iVar1), 2f, -2f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@taxi@cyi", func_107(iVar1), 2f, -2f, -1, 0, 0, 0, 0, 0);
	...
	switch (iLocal_874)
	{
		...
		case 4:
			if (ENTITY::IS_ENTITY_DEAD(Local_413.f_3, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_955[0], 0))
				{
					AI::CLEAR_PED_TASKS(iLocal_955[0]);
					if (does_scenario_exist_in_area(-1036.502f, -2742.986f, 20.16969f, 5f, 1))
					{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_955[1], 0))
				{
					AI::CLEAR_PED_TASKS(iLocal_955[1]);
...
void func_165(auto uParam0, Vector3 vParam1)
{
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0) && is_ped_sitting_in_vehicle(*uParam0.f_3, *uParam0.f_4))
		{
...
int func_170(auto uParam0, float fParam1)
{
	...
	else if (((ENTITY::IS_ENTITY_AT_COORD(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_171(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_103(uParam0, 1, fParam1);
	}
	return 0;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 || ((func_156(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_172(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_172(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
					...
					case 1:
						...
						else
						{
							...
							else if (((AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 0) && AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 7) && func_227(uParam0, *uParam0.f_3) > 8f)
							{
...
float func_212(auto uParam0)
{
	...
	fVar0 = func_213(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), vVar1);
	return fVar0;
}
...
bool func_223(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
		if (!ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3) && func_155(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_139(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3)) || func_155(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
	...
	if (!is_gameplay_hint_active())
	{
		...
		else if (*uParam0.f_6 == 2)
		{
			if (func_281(iVar0))
			{
				...
				{
					if ((CAM::IS_SPHERE_VISIBLE(vParam1, 1f) && !is_help_message_being_displayed()) && iParam7)
					{
						if (!func_235(iVar0))
						{
							func_273(iVar0, -1);
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_16(&(Local_190[0 /*10*/].f_3))) && !func_16(&(Local_190[8 /*10*/].f_3))) && !func_16(&(Local_190[5 /*10*/].f_3))) && !func_16(&(Local_190[9 /*10*/].f_3))) && !func_16(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_16(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(ENTITY::GET_ENTITY_COORDS(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_156(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
...
int func_299(int iParam0)
{
	...
	vVar24 = {vVar24};
	return func_300(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar15, vVar18, vVar21);
}
...
void func_315(auto uParam0, char* sParam1, int iParam2)
{
	...
	func_420(2);
	Var0 = {func_111()};
	if ((!is_string_null_or_empty(&Var0) && func_121()) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "NULL"))
	{
	}
	else
	{
...
bool func_393(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_155(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
void func_410(auto uParam0)
{
	...
	switch (*uParam0.f_411)
	{
		...
		case 9:
			func_414(uParam0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 17));
			iVar0 = func_412(*uParam0.f_418.f_2 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 17), 0, 16);
