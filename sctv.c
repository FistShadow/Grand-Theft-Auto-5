#region Local Var
	...
	auto uLocal_221 = 0;
	auto uLocal_222 = 0;
	struct<152> Local_223 = 0;
	Vector3 vLocal_375 = 0;
	auto uLocal_378 = 0;
	auto uLocal_379 = 0;
	auto uLocal_380 = 0;
	auto uLocal_381 = 0;
...
void main()
{
	...
	while (true)
	{
		...
		{
			if (_0x46718ACEEDEAFC84())
			{
				iLocal_2640 = NETWORK::GET_NETWORK_TIME();
			}
...
void func_13()
{
	...
	clear_focus();
	set_scaleform_movie_as_no_longer_needed(&uLocal_2643);
	func_39(player_id(), 1);
	func_37();
	func_36();
	func_29();
	...
	set_ped_dies_in_water(PLAYER::PLAYER_PED_ID(), 1);
	Global_1573442 = -1;
	...
	func_21(0);
	func_17();
	GAMEPLAY::CLEAR_BIT(&(Local_386.f_47), 16);
	if (func_15())
	{
...
void func_22(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1))
		{
			...
			{
				if (!_0x9DE986FC9A87C474(player_id(), _network_get_ped_player(iParam1)))
				{
					iVar0 = 1;
				}
			}
	...
	if (iVar0 == 0)
	{
		if (iParam2 == 1)
		{
			...
			else if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, true))
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, 2))
				{
					iVar1 = 0;
					while (iVar1 < 7)
					{
						_0x2A2173E46DAECD12(iVar1, Global_2359301.f_58[iVar1]);
						iVar1++;
					}
				}
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_66), true);
			}
		}
...
void func_27()
{
	...
	if (!network_is_in_spectator_mode())
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, 2))
		{
			...
			while (iVar0 < 7)
			{
				Global_2359301.f_58[iVar0] = _0xEE778F8C7E1142E2(iVar0);
				iVar0++;
			}
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_66), 2);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_66), false);
		}
	}
}
...
void func_28(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (Global_2359299)
		{
			...
			set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 0);
		}
		if (iParam1)
		{
			set_entity_proofs(PLAYER::PLAYER_PED_ID(), false, false, false, iParam0, false, false, 0, false);
...
void func_40(auto uParam0, int iParam1)
{
	if (func_115(uParam0.f_1) != 0)
	{
		...
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 4);
	}
}
...
void func_41(auto uParam0)
{
	if (!func_24(player_id(), 0))
	{
		...
		else if (func_105(player_id()))
		{
		}
		else if (func_104(player_id()) == 3 || Global_1315837)
		{
			_0x6A5D89D7769A40D8(0);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_103()))
	{
		if (!PED::IS_PED_INJURED(func_103()))
		{
			set_ped_lod_multiplier(func_103(), 1f);
		}
	}
	if (!func_102() && !GAMEPLAY::IS_BIT_SET(Global_2359301, 13))
	{
		_0xFF300C7649724A0B(player_id(), 0);
	}
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, 3))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, false) || !is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_100())
			{
				if (!func_24(player_id(), 0) || Global_2359301.f_68 == Global_2359301.f_68.f_1)
				{
	...
	*uParam0.f_1.f_4 = 0;
	unlock_minimap_position();
	GAMEPLAY::CLEAR_BIT(uParam0.f_47, false);
	*uParam0.f_1.f_26 = 0;
	*uParam0.f_1.f_33 = 0;
	*uParam0.f_1.f_34 = 0;
	*uParam0.f_1.f_27 = 0;
	*uParam0.f_1.f_25 = 0;
	...
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, true);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, false);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, 10);
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, 2))
	{
	...
	func_67();
	func_66();
	_0xF46A1E03E8755980(0);
	func_65(uParam0.f_1.f_7, 0);
	_0xFC18DB55AE19E046(0);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 5);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 10);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 4);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 6);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 14);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, 12);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, 14);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, 9);
	if (Global_1587523[player_id() /*444*/] != 2)
	{
		func_64(uParam0.f_1, 0);
	}
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 9))
	{
		func_63();
	}
...
void func_45()
{
	...
	{
		set_scaleform_movie_as_no_longer_needed(&(Global_2428492.f_1358.f_687));
	}
	...
	func_50();
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_1358.f_743, 18))
	{
		func_49(0);
	}
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_1358.f_743, 7) && !func_48())
	{
		func_47(0);
	}
...
void func_56()
{
	if (_get_screen_effect_is_active("MP_race_crash"))
	{
		_stop_screen_effect("MP_race_crash");
	}
	func_59(0);
	func_58(0);
	func_57(0);
...
void func_57(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 2);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_2166.f_2), 2);
	}
}
...
void func_58(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), true);
	}
	else
	{
		if (_get_screen_effect_is_active("DeathFailMPDark"))
		{
			_stop_screen_effect("DeathFailMPDark");
		}
		if (_get_screen_effect_is_active("DeathFailMPIn"))
		{
			_stop_screen_effect("DeathFailMPIn");
		}
		_set_cam_effect(0);
		GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_2166.f_2), true);
	}
}
...
void func_59(int iParam0)
{
	...
	{
		_stop_screen_effect("MP_race_crash");
		if (_get_screen_effect_is_active("CrossLine"))
		{
			_stop_screen_effect("CrossLine");
		}
		if (_0x35FB78DC42B7BD21())
		{
			_start_screen_effect("DeathFailMPDark", false, 0);
		}
		else
		{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), false);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_2166.f_2), false);
	}
}

int func_60()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, true);
}
...
void func_63()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 8))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2359301, 9))
		{
			GAMEPLAY::CLEAR_BIT(&Global_2359301, 9);
		}
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 8);
	}
}
...
void func_65(auto uParam0, int iParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 6))
	{
		if (iParam1 == 1)
		{
			iVar0 = 0;
			while (iVar0 < 5)
			{
				if (*uParam0[iVar0] != 5)
				{
					_0x2A2173E46DAECD12(iVar0, *uParam0[iVar0]);
					*uParam0[iVar0] = 5;
				}
				iVar0++;
			}
...
void func_66()
{
	...
	{
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 27);
	}
}
...
void func_71(auto uParam0, int iParam1)
{
	*uParam0.f_3 = iParam1;
}
...
void func_73()
{
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 25);
}
...
{
	if (does_cam_exist(*uParam0.f_1.f_39))
	{
		if (get_rendering_cam() == *uParam0.f_1.f_39)
		{
			render_script_cams(false, false, 3000, 1, 0, 0);
		}
		destroy_cam(*uParam0.f_1.f_39, 0);
		if (func_82() && !func_81())
		{
			clear_focus();
		}
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 15);
		if ((!GAMEPLAY::IS_BIT_SET(Global_2359301, 18) && *uParam0.f_47.f_1467 != 10) && *uParam0.f_47.f_1467 != 11)
		{
			display_radar(true);
		}
		*uParam0.f_1.f_41 = 0;
		func_22(1, func_80(), 1);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
		func_79();
		func_78(0);
		func_76();
	}
	...
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 16);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 17))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 17);
	}
}
...
void func_78(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 8);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_4429), 8);
	}
}

void func_79()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 12))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 12);
	}
}
...
bool func_82()
{
	if (func_24(player_id(), 0))
	{
		if (Global_1587523[player_id() /*444*/].f_355 != func_46())
		{
			if (func_9(Global_1587523[player_id() /*444*/].f_355, 0, 1))
			{
				if (func_83(Global_1587523[player_id() /*444*/].f_355, 1, 0))
				{
					return false;
				}
			}
...
void func_87(auto uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 29))
	{
		display_hud(true);
		display_radar(true);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 29);
	}
	unk_0x2790F4B17D098E26(0);
	reset_hud_component_values(15);
	func_95(0);
	func_94(uParam0.f_47);
	if (func_93(uParam0.f_1) != 3)
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, 5))
		{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 18))
	{
		display_radar(true);
	}
	set_scaleform_movie_as_no_longer_needed(uParam0.f_47.f_1471);
	set_scaleform_movie_as_no_longer_needed(uParam0.f_47.f_1473);
	set_seethrough(0);
	func_52(uParam0.f_47.f_1474);
	set_scaleform_movie_as_no_longer_needed(uParam0.f_47.f_2161);
	...
	*uParam0.f_47.f_1469 = 99;
	...
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 11);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, false);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 12);
	GAMEPLAY::CLEAR_BIT(uParam0.f_47, 7);
	*uParam0.f_47.f_1465 = 0;
	set_fake_wanted_level(*uParam0.f_47.f_1465);
	*uParam0.f_47.f_1466 = 0;
	flash_wanted_display(*uParam0.f_47.f_1466);
	func_88(uParam0.f_47, 0);
}

void func_88(int iParam0, int iParam1)
{
	GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 6);
...
void func_90(auto uParam0)
{
	if (*uParam0.f_1455 != -1)
	{
		stop_sound(*uParam0.f_1455);
		release_sound_id(*uParam0.f_1455);
		*uParam0.f_1455 = -1;
	}
}
...
void func_94(auto uParam0)
{
	...
	while (iVar0 < 32)
	{
		*(uParam0.f_1063[iVar0 /*3*/]) = {vVar1};
		*(uParam0.f_1160[iVar0 /*3*/]) = {vVar1};
		*(uParam0.f_1257[iVar0 /*3*/]) = {vVar1};
		*(uParam0.f_1354[iVar0 /*3*/]) = {vVar1};
		iVar0++;
	}
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 2);
}
...
void func_95(int iParam0)
{
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 3))
		{
			_0x2F7CEB6520288061(1);
			set_audio_flag("AllowRadioDuringSwitch", 1);
			set_mobile_phone_radio_state(1);
			set_audio_flag("MobileRadioInGame", 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_1), 3);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 3))
	{
		_0x2F7CEB6520288061(0);
		set_audio_flag("AllowRadioDuringSwitch", 0);
		set_mobile_phone_radio_state(0);
		set_audio_flag("MobileRadioInGame", 0);
		GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_1), 3);
	}
}
...
void func_99(int iParam0, int iParam1, int iParam2)
{
	switch (iParam0)
	{
		...
		default:
			if (iParam1)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1338622.f_947), iParam0);
			}
			else
			{
				GAMEPLAY::CLEAR_BIT(&(Global_1338622.f_947), iParam0);
			}
			break;
	}
}
...
void func_108(auto uParam0, int iParam1)
{
	...
	if (Global_2359299)
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), _get_gameplay_cam_coords(), 0, true, 0, 0);
	}
	set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
	set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
	if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) && !is_entity_attached(PLAYER::PLAYER_PED_ID()))
	{
...
void func_109()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 24))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 24);
	}
}
...
void func_110(int iParam0)
{
	...
	if (func_112() == 0 || is_pause_menu_active())
	{
		func_111(1);
...
void func_114(int iParam0, int iParam1, int iParam2)
{
	...
	*iParam0.f_13 = {0f, 0f, 0f};
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 9);
	}
	else
	{
...
auto func_115(auto uParam0)
{
	return *uParam0.f_36;
}

int func_116(auto uParam0)
{
...
void func_117()
{
	...
	if (func_671())
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 9);
		func_670(0);
	}
	if (func_669() != 1)
	{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 9))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_386.f_1, 13))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_386.f_1), 13);
		}
		if (func_102())
		{
			func_668(0);
		}
		GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 9);
	}
...
void func_118()
{
	...
	switch (Global_2359301.f_68.f_3)
	{
		...
		case 1:
			iVar0 = false;
			if ((func_669() == 0 && Global_2359301.f_68.f_1 == 1) && is_player_switch_in_progress())
			{
				iVar0 = true;
			}
			else if (!is_screen_faded_out() && !func_100())
			{
		...
		case 2:
			...
			switch (func_669())
			{
				...
				case 2:
					...
					func_29();
					func_28(1, 0);
					GAMEPLAY::CLEAR_BIT(&Local_223, 10);
					Global_1573442 = -1;
					if (does_cam_exist(vLocal_375.x))
					{
						destroy_cam(vLocal_375.x, 0);
					}
					if (does_cam_exist(vLocal_375.y))
					{
						destroy_cam(vLocal_375.y, 0);
					}
		...
		case 3:
			...
			switch (Global_2359301.f_68.f_1)
			{
				...
				case 1:
					...
					{
						Local_386 = 2;
						func_262(&(Local_386.f_1), _get_gameplay_cam_coords(), _get_gameplay_cam_rot(2), _0x80EC114669DAEFF4(), 0);
						func_663();
						func_286();
					}
					break;
				...
				case 2:
					hide_hud_and_radar_this_frame();
					GAMEPLAY::GAMEPLAY::SET_BIT(&Local_223, 27);
					func_663();
					set_radar_zoom(1350);
					func_22(1, PLAYER::PLAYER_PED_ID(), 1);
					...
					if (func_284(Local_386.f_47.f_1009))
					{
						...
						{
							vVar8 = {get_entity_coords(iVar14, 1) + Vector(99f, 0f, 0f)};
						}
					}
					if (func_77(vVar8))
					{
						vVar8 = {239.1166f, -442.7514f, 374.2336f};
						vVar11 = {-35f, 0.0002f, 130.0562f};
					}
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_1.f_1), 2);
					func_260(Local_223, &vLocal_375, vVar8, vVar11);
					func_259();
					vVar1 = {get_cam_coord(vLocal_375.x)};
					if ((vVar1.x != 0f || vVar1.y != 0f) || vVar1.z != 0f)
					{
						_set_focus_area(vVar1, 0f, 0f, 0f);
					}
					func_286();
					iVar0 = true;
					break;
		...
		case 4:
			...
			if (iVar0)
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_47), true);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_47), 6);
				func_63();
				func_290(5);
			}
			break;
...
void func_119()
{
	...
	switch (func_669())
	{
		...
		case 1:
			if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 12))
			{
				if (func_235())
				{
					func_234(0, -1);
					set_player_team(player_id(), 9);
					Global_2359301.f_68.f_2 = 2;
					GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 12);
					func_1(&uLocal_2648);
					return;
				}
			}
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 4);
			}
			else
			{
				GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 4);
			...
			else if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 10))
			{
				if (func_3(&uLocal_2646, 10000, 0))
				{
					if (Global_1587523[player_id() /*444*/].f_355 > -1)
					{
						if (network_is_player_active(Global_1587523[player_id() /*444*/].f_355))
						{
							Var4.f_2 = 145;
							func_219(Var4, func_220(Global_1587523[player_id() /*444*/].f_355));
						}
					}
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 10);
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(func_103()))
			{
				if (is_ped_a_player(func_103()))
				{
					iVar3 = _network_get_ped_player(func_103());
					if (network_is_player_active(iVar3))
					{
						if (Global_1587523[player_id() /*444*/].f_355 != iVar3)
						{
							if (func_217())
							{
								if (Global_1587523[player_id() /*444*/].f_355 > -1)
								...
								func_216(iVar3);
								func_1(&uLocal_2646);
								GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 10);
							}
						}
					}
				}
			...
			{
				if ((is_screen_faded_in() && !func_208()) && func_207())
				{
					func_203(player_id(), 1, 2154496);
				}
			}
			break;
		
		case 2:
			if (!func_15() || ((network_is_activity_session() && Global_1587523[player_id() /*444*/].f_87 == 4) && Global_1587523[player_id() /*444*/].f_355 == func_46()))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 4);
				func_236(1);
			}
			...
			{
				hide_hud_and_radar_this_frame();
				if (GAMEPLAY::IS_BIT_SET(Local_223, 10) && GAMEPLAY::IS_BIT_SET(Local_223, 27))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 4);
				}
				else
				...
				func_174(&Local_386);
				func_150(&Local_223, &vLocal_375, -1, 1117782016, 0);
				func_146(vLocal_375.x, 0.015f);
				if (!is_player_switch_in_progress())
				{
					vVar0 = {get_cam_coord(vLocal_375.x)};
					if ((vVar0.x != 0f || vVar0.y != 0f) || vVar0.z != 0f)
					{
						_set_focus_area(vVar0, 0f, 0f, 0f);
					}
				}
			}
			if (!is_player_control_on(player_id()))
			{
				if (is_screen_faded_in() && func_207())
				{
					func_203(player_id(), 1, 2154496);
				}
			}
		...
		case 3:
			...
			if (absi(get_time_difference(iLocal_2641, NETWORK::GET_NETWORK_TIME())) > iVar18 && !func_120())
			{
				func_227(1);
...
bool func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_141() == 4)
	{
		if (is_player_switch_in_progress() == 0)
		{
			func_140(0);
		}
	}
	...
	if (!func_131())
	{
		...
		if (_0x6F72CD94F7B5B68C() == 0)
		{
			if (get_pause_menu_state() == 25)
			{
				_0xD2B32BE3FC1626C6();
			}
		}
		if (func_24(player_id(), 0) && func_130() == 0)
		{
			set_entity_coords(PLAYER::PLAYER_PED_ID(), _get_gameplay_cam_coords(), 0, false, 0, 0);
			iParam4 = true;
		}
		...
		if (is_ped_swimming(PLAYER::PLAYER_PED_ID()))
		{
			iParam4 = true;
		}
		if (is_cutscene_playing() || is_cutscene_active())
		{
			iParam4 = true;
		}
		if (iParam2 && !func_24(player_id(), 0))
		{
			func_128(1);
		}
		if ((func_207() && ((is_pause_menu_active() == 0 || iParam1 == 0) || (_0xC406BE343FC4B9AF() && is_warning_message_active()))) && _0x71E7B2E657449AAD())
		{
			if (!is_player_switch_in_progress())
			{
				if (is_srl_loaded())
			...
			if (iParam3 == 3)
			{
				...
				else if (get_ideal_player_switch_type(vVar1, vVar5) != 3)
				{
					iParam3 = 1;
				}
			}
			else if (iParam3 == 2)
			{
				...
				else if (get_ideal_player_switch_type(vVar1, vVar5) != 2 || get_ideal_player_switch_type(vVar1, vVar5) != 3)
				{
					iParam3 = 1;
				}
			}
			_0x22A249A53034450A(1);
			...
			if (iParam0)
			{
				...
				{
					_switch_out_player(PLAYER::PLAYER_PED_ID(), iVar4 | 32 | 128 | 16384, iParam3);
				}
				else
				{
					_switch_out_player(PLAYER::PLAYER_PED_ID(), iVar4 | 32 | 128, iParam3);
				}
			}
			else if (iParam13 || func_129())
			{
				_switch_out_player(PLAYER::PLAYER_PED_ID(), iVar4 | 32 | 16384, iParam3);
			}
			else
			{
				_switch_out_player(PLAYER::PLAYER_PED_ID(), iVar4 | 32, iParam3);
			}
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					StringCopy(&Global_2443035, get_player_radio_station_name(), 32);
		...
		if (func_141() == 1)
		{
			if (is_player_switch_in_progress())
			{
				if (get_player_switch_type() != 3)
				{
					if (get_player_switch_state() > 2)
					{
						func_123();
						func_128(0);
						if (((func_122() && _0xEF7D17BC6C85264C() == 0) && _0x88B588B41FF7868E() == 0) && _0x67FC09BC554A75E5() == 0)
						{
			...
			if (_0x933BBEEB8C61B5F4())
			{
				if (iParam8 == 0 || func_123())
				{
					if (iParam2)
					{
						if (iParam8)
...
void func_126()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_2444211))
	{
		if (does_entity_belong_to_this_script(Global_2444211, 0))
		{
			if (!is_entity_a_mission_entity(Global_2444211))
			{
...
void func_127()
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_1318697))
	{
...
{
	if ((func_112() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_111(0);
...
void func_132()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 27))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 27);
	}
}

int func_133()
{
	return GAMEPLAY::IS_BIT_SET(Global_2359301, 27);
}
...
void func_134()
{
	...
	if (_get_screen_effect_is_active("MenuMGTrevorIn"))
	{
		_stop_screen_effect("MenuMGTrevorIn");
	}
	if (_get_screen_effect_is_active("MenuMGMichaelIn"))
	{
		_stop_screen_effect("MenuMGMichaelIn");
	}
	if (_get_screen_effect_is_active("MenuMGFranklinIn"))
	{
		_stop_screen_effect("MenuMGFranklinIn");
	}
	if (_get_screen_effect_is_active("MenuMGTrevorOut"))
	{
		_stop_screen_effect("MenuMGTrevorOut");
	}
	if (_get_screen_effect_is_active("MenuMGMichaelOut"))
	{
		_stop_screen_effect("MenuMGMichaelOut");
	}
	if (_get_screen_effect_is_active("MenuMGFranklinOut"))
	{
		_stop_screen_effect("MenuMGFranklinOut");
	}
}
...
int func_135()
{
	...
	if (_get_screen_effect_is_active("MenuMGIn"))
	{
		_stop_screen_effect("MenuMGIn");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGSelectionIn"))
	{
		_stop_screen_effect("MenuMGSelectionIn");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGSelectionTint"))
	{
		_stop_screen_effect("MenuMGSelectionTint");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGTournamentIn"))
	{
		_stop_screen_effect("MenuMGTournamentIn");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGHeistIn"))
	{
		_stop_screen_effect("MenuMGHeistIn");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGHeistTint"))
	{
		_stop_screen_effect("MenuMGHeistTint");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGHeistIntro"))
	{
		_stop_screen_effect("MenuMGHeistIntro");
		iVar0 = 1;
	}
	if (_get_screen_effect_is_active("MenuMGTournamentTint"))
	{
		_stop_screen_effect("MenuMGTournamentTint");
		iVar0 = 1;
	}
	return iVar0;
}
...
void func_136()
{
	...
	hide_hud_component_this_frame(11);
	hide_hud_component_this_frame(12);
	hide_hud_component_this_frame(18);
	iVar0 = false;
	iVar0 = func_138("HQRHELP");
	if (!iVar0)
	{
		hide_help_text_this_frame();
	}
...
void func_144()
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_130() == 0)
		{
			network_resurrect_local_player(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 0f, 0, func_6(player_id(), 1), 1);
		}
		...
		{
			revive_injured_ped(PLAYER::PLAYER_PED_ID());
		}
	}
...
void func_146(int iParam0, float fParam1)
{
	...
	if (!is_pause_menu_active())
	{
		...
		{
			iVar2 = floor(_0x5B84D09CEC5209C5(2, 1) * 127f) * 2;
			iVar3 = floor(_0x5B84D09CEC5209C5(2, 2) * 127f) * -1;
		}
		if (func_24(player_id(), 0))
		{
			_0xC8B5C4A79CC18B94(iParam0);
			fVar7 = 0f;
		}
		else
		{
		...
		{
			vVar4 = {get_cam_rot(iParam0, 2)};
			if (!func_24(player_id(), 0))
			{
				if (get_cam_fov(iParam0) < 45f)
				{
					fVar8 = get_cam_fov(iParam0) + 1f;
					if (fVar8 >= 45f)
					{
						fVar8 = 45f;
					}
					set_cam_fov(iParam0, fVar8);
				}
				else if (get_cam_fov(iParam0) > 45f)
				{
					fVar9 = get_cam_fov(iParam0) - 1f;
					if (fVar9 <= 45f)
					{
						fVar9 = 45f;
					}
					set_cam_fov(iParam0, fVar9);
				}
			}
			if (vVar4.x < -89.9f)
			{
				...
				if (vVar4.x > -89.9f)
				{
					vVar4.x = -89.9f + 0.001f;
				}
			}
			else if (vVar4.x > fVar7 + 0.01f)
			{
				vVar4.x -= 3f;
				if (vVar4.x < fVar7)
				{
			...
			{
				vVar4 = {vVar4 + Vector(0f, 0f, IntToFloat(iVar3) * 0.01f + fParam1)};
				if (vVar4.x < -89.9f)
				{
					vVar4.x = -89.9f;
				}
			...
			{
				vVar4 = {vVar4 - Vector(IntToFloat(iVar2) * 0.01f + fParam1 * 2f, 0f, 0f)};
				set_cam_rot(iParam0, vVar4, 2);
			}
			set_cam_rot(iParam0, vVar4, 2);
		}
	}
...
void func_148(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
...
void func_150(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4)
{
	Vector3 vVar0;
	float fVar3;
	Vector3 vVar4;
	...
	if (GAMEPLAY::IS_BIT_SET(*iParam0, 27))
	{
		...
		{
			hide_hud_and_radar_this_frame();
			*iParam1.f_1 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
			set_cam_params(*iParam1.f_1, _get_gameplay_cam_coords(), _get_gameplay_cam_rot(2), _0x80EC114669DAEFF4(), false, 1, 1, 2);
			set_cam_active(*iParam1.f_1, true);
			*iParam1 = create_cam("DEFAULT_SCRIPTED_FLY_CAMERA", false);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!func_77(*iParam1.f_2))
				{
					set_cam_coord(*iParam1, *iParam1.f_2);
					set_cam_rot(*iParam1, -89.5f, 0f, 0f, 2);
				}
				else
				{
					vVar0 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
					fVar3 = _0x29C24BFBED8AB8FB(vVar0.x, vVar0.y);
					if (fParam3 > 0f)
					{
					}
					vVar0.z = fVar3 + 40f;
					set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 0);
					set_cam_coord(*iParam1, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1));
					set_cam_rot(*iParam1, -89.5f, 0f, 0f, 2);
					func_140(2);
					if (does_cam_exist(Global_17038.f_11))
					{
						if (is_cam_active(Global_17038.f_11))
						{
							set_cam_params(*iParam1.f_1, get_cam_coord(Global_17038.f_11), get_cam_rot(Global_17038.f_11, 2), get_cam_fov(Global_17038.f_11), false, 1, 1, 2);
							set_cam_params(*iParam1.f_1, get_cam_coord(*iParam1), get_cam_rot(*iParam1, 2), get_cam_fov(*iParam1), 1000, 1, 1, 2);
						}
						else
						{
							set_cam_params(*iParam1.f_1, _get_gameplay_cam_coords(), _get_gameplay_cam_rot(2), _0x80EC114669DAEFF4(), false, 1, 1, 2);
				...
				set_cam_active(*iParam1, false);
				render_script_cams(true, false, 3000, 1, 0, 0);
				set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
				set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
				set_ped_dies_in_water(PLAYER::PLAYER_PED_ID(), 0);
				freeze_entity_position(PLAYER::PLAYER_PED_ID(), true);
			}
		}
		else
		{
			...
			{
				_0xF9D02130ECDD1D77(*iParam1, 2450f);
			}
			else
			{
				_0xF9D02130ECDD1D77(*iParam1, 1300f);
			}
			if (func_173() == 0 && (func_207() || func_153(*iParam1, 1, 1, 1, 0, 1, 0, 1, 1)))
			{
				if (!is_cam_active(*iParam1))
				{
					if (does_cam_exist(*iParam1.f_1))
					{
						if (!is_cam_interpolating(*iParam1.f_1))
						{
							destroy_cam(*iParam1.f_1, 0);
							set_cam_active(*iParam1, true);
							GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 10);
						}
						else
						{
				...
				if (func_152(iParam0, &vVar4) && !iParam4)
				{
					set_cam_coord(*iParam1, vVar4);
					set_cam_rot(*iParam1, *iParam1.f_5, 2);
					vVar7 = {get_cam_rot(*iParam1, 2)};
					vVar7.x = -89.5f;
					set_cam_rot(*iParam1, vVar7, 2);
					*iParam0.f_9 = {vVar4};
					if (iParam2 == 0)
					{
				...
				{
					if (get_rendering_cam() != 0)
					{
						vVar10 = {get_cam_rot(get_rendering_cam(), 2)};
						vVar13 = {get_cam_coord(get_rendering_cam())};
					}
					if (!is_new_load_scene_active())
					{
						new_load_scene_start(vVar13, vVar10, 200f, 0);
					}
				...
				{
					if (_0x5C48A1D6E3B33179(*iParam1))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 19);
					}
					vVar16 = {get_cam_coord(*iParam1)};
					if (get_water_height_no_waves(vVar16, &fVar19) || get_ground_z_for_3d_coord(vVar16, &fVar19, 0))
					{
						*iParam0.f_5 = fVar19;
						fVar19 = vVar16.z - fVar19;
						fVar20 = fVar19 * 0.5f;
						fVar21 = fVar19 * 0.2f;
						if (fVar20 < 40f)
						{
						...
						*iParam0.f_4 = 1;
						_0x503F5920162365B2(*iParam1, fVar20, fVar21, 1128792064);
					}
					else
					{
						if (*iParam0.f_5 != 0f)
						{
							...
							_0x503F5920162365B2(*iParam1, fVar22, fVar23, 1128792064);
						}
						else
						{
							_0x503F5920162365B2(*iParam1, 40f, 40f, 1128792064);
						}
						*iParam0.f_4 = 0;
					}
					if (Global_2359299)
		...
		if (GAMEPLAY::IS_BIT_SET(*iParam0, 19))
		{
			if (func_24(player_id(), 0))
			{
			...
			{
				*iParam0.f_3 = GAMEPLAY::GET_GAME_TIMER() + 500;
				shake_cam(*iParam1, "VIBRATE_SHAKE", 0.5f);
				play_sound_frontend(-1, "HUD_FREEMODE_CANCEL_MASTER", 0, 1);
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > *iParam0.f_3)
			{
				*iParam0.f_3 = 0;
				shake_cam(*iParam1, "VIBRATE_SHAKE", 0f);
				GAMEPLAY::CLEAR_BIT(iParam0, 19);
			}
		}
	}
...
void func_151(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		vVar0 = {get_cam_rot(iParam1, 2)};
		if (func_24(player_id(), 0))
		{
			*iParam0.f_9 = {get_cam_coord(iParam1)};
		}
		else
		{
			*iParam0.f_9 = {_get_object_offset_from_coords(get_cam_coord(iParam1), vVar0.z, 0f, 0f, 0f)};
		}
		set_entity_coords(PLAYER::PLAYER_PED_ID(), *iParam0.f_9, 1, false, 0, 0);
		set_entity_rotation(PLAYER::PLAYER_PED_ID(), vVar0, 2, 1);
		set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
	}
}

bool func_152(int iParam0, auto uParam1)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		*uParam1 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
...
bool func_153(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	auto uVar0;
	auto uVar1;
	auto uVar2;
	...
	if (Global_2445441 != iParam7 && iParam7 == 1)
	{
		if (is_player_switch_in_progress())
		{
			get_posix_time(&uVar0, &uVar1, &uVar2, &uVar3, &uVar4, &uVar5);
			_0xAD5FDF34B81BFE79();
	...
	if (get_is_loading_screen_active())
	{
		if (Global_2444113 == 0)
		{
			...
			if (is_new_load_scene_active() == 0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_1318697))
				{
					if (is_entity_focus(Global_1318697))
					{
						clear_focus();
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
				{
					if (is_entity_focus(PLAYER::PLAYER_PED_ID()))
					{
						clear_focus();
					}
				}
	...
	if ((is_pause_menu_active() == 0 || (_0xC406BE343FC4B9AF() && is_warning_message_active())) || iParam1 == 0)
	{
		if (!func_207())
		{
			if (func_131())
				...
				if (func_168())
				{
					...
					if (is_player_switch_in_progress() == 0)
					{
						...
						if (does_cam_exist(iParam0) || iParam4)
						{
							...
							iVar9 = func_165(get_entity_coords(Global_1318697, 0), get_entity_coords(PLAYER::PLAYER_PED_ID(), 0));
							if (iVar9 == 3)
							{
								iVar9 = 2;
							}
						...
						if (iParam4 == 0)
						{
							start_player_switch(Global_1318697, PLAYER::PLAYER_PED_ID(), 513, iVar9);
						}
						else
						{
							start_player_switch(Global_1318697, PLAYER::PLAYER_PED_ID(), 8, iVar9);
						}
						if (does_cam_exist(iParam0))
						{
							vVar6 = {get_cam_coord(iParam0)};
							vVar10 = {get_cam_rot(iParam0, 2)};
							fVar13 = get_cam_fov(iParam0);
							uVar14 = get_cam_far_clip(iParam0);
							_0xC208B673CE446B61(vVar6, vVar10, fVar13, uVar14, 2);
						}
						func_140(4);
					}
					else if (_0x933BBEEB8C61B5F4())
					{
						if (does_cam_exist(iParam0))
						{
							...
							fVar18 = get_cam_fov(iParam0);
							uVar19 = get_cam_far_clip(iParam0);
							if (iParam5)
							{
								set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar6, 0, false, 0, 1);
							}
							if (func_164(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), vVar6, 5f, 0) || !iParam5)
							{
								...
								if (!func_161())
								{
									if (does_cam_exist(iParam0))
									{
										_0xC208B673CE446B61(vVar6, vVar15, fVar18, uVar19, 2);
									}
								}
								if (iParam7 == 0)
								{
		...
		if (func_141() == 4)
		{
			if (is_player_switch_in_progress())
			{
				if (!iParam6)
				{
					if (func_160() != 0)
					{
						if (func_160() < 33)
						{
							if (func_159())
							{
								if (!_get_screen_effect_is_active(func_156(0)))
								{
									_start_screen_effect(func_156(0), false, 1);
								}
							}
						}
					}
				}
				iVar20 = get_interior_from_entity(PLAYER::PLAYER_PED_ID());
				if (iVar20 != 0)
				{
					_0xBD605B8E0E18B3BB();
				}
				...
				{
					set_player_visible_locally(player_id(), 0);
				}
				if (get_player_switch_type() != 3)
				{
					if (get_player_switch_state() > 2)
			...
			if (is_player_switch_in_progress() == 0 || (iParam2 && get_player_switch_state() > 8))
			{
				if (!func_155(&Global_2443035))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							set_radio_to_station_name(&Global_2443035);
						}
					}
				}
				StringCopy(&Global_2443035, "", 32);
...
int func_157()
{
	return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2808, 12);
}
...
int func_158(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2812, iVar1);
	}
	if (iVar0 == 1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2813, iVar1);
	}
	if (iVar0 == 2)
	{
		return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2814, iVar1);
	}
	if (iVar0 == 3)
	{
		return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2815, iVar1);
	}
	if (iVar0 == 4)
	{
		return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2816, iVar1);
	}
	return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2817, iVar1);
}
...
auto func_160()
{
	return Global_1587523[player_id() /*444*/].f_180;
}

bool func_161()
{
	if (func_107(player_id()) || func_106(player_id()))
	{
...
int func_163()
{
	return GAMEPLAY::IS_BIT_SET(Global_1315817, 4);
}

bool func_164(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_165(Vector3 vParam0, Vector3 vParam1)
{
	if (func_166(vParam0, 99) || func_166(vParam3, 99))
	{
		return 3;
	}
	return get_ideal_player_switch_type(vParam0, vParam3);
}

bool func_166(Vector3 vParam0, int iParam1)
{
	struct<7> Var0;
	...
	switch (iParam3)
	{
		...
		case 10:
			...
			if (is_point_in_angled_area(vParam0, Var0, Var0.f_3, Var0.f_6, 0, true))
			{
				return true;
			}
			break;
...
struct<8> func_167(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 2:
...
bool func_168()
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_1318697))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("u_m_m_filmdirector")))
		{
			...
			set_entity_collision(Global_1318697, false, 0);
			set_entity_visible(Global_1318697, false, 0);
			if (!is_player_switch_in_progress())
			{
				set_focus_entity(Global_1318697);
			}
			set_model_as_no_longer_needed(joaat("u_m_m_filmdirector"));
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1724577[1]), 6);
		}
		else
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1724577[1]), 7);
		}
	}
	else
	{
...
bool func_169(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
...
void func_174(auto uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 2))
	{
		func_285(uParam0);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 2);
	}
	else
	{
...
void func_175(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			case 0:
				if (func_9(int_to_playerindex(iParam1), 0, 1))
				{
					if (func_190())
					{
						if (func_188(player_id(), 0))
						{
							if (func_186())
							{
								if (func_184(int_to_playerindex(iParam1), player_id(), 0))
								{
									vVar1.x = get_player_ped(int_to_playerindex(iParam1));
									func_181(uParam0, iVar0, vVar1, iParam1);
								}
							}
							else if (func_184(int_to_playerindex(iParam1), func_180(), 1))
							{
								if (player_id() != int_to_playerindex(iParam1))
								{
									vVar1.x = get_player_ped(int_to_playerindex(iParam1));
									func_181(uParam0, iVar0, vVar1, iParam1);
								}
...
void func_176(auto uParam0)
{
	...
	*uParam0.f_47.f_1008 = 0;
	...
	while (iVar0 < 5)
	{
		*uParam0.f_47.f_1002[iVar0] = *uParam0.f_47.f_996[iVar0];
		if (iVar0 == 0)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(*(uParam0.f_47.f_510[iVar0 /*97*/])[iVar1 /*3*/]))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iVar13, iVar1);
				}
				iVar1++;
			}
			iVar9 = -1;
			while (iVar13 != 0)
			{
				...
				while (iVar1 < *uParam0.f_47.f_1002[iVar0])
				{
					...
					iVar8 = -1;
					iVar15 = false;
					if (GAMEPLAY::IS_BIT_SET(iVar13, iVar1))
					{
						iVar10 = *(uParam0.f_47.f_510[iVar0 /*97*/])[iVar1 /*3*/];
						if (is_ped_a_player(iVar10) && _network_get_ped_player(iVar10) != -1)
						{
							iVar11 = _network_get_ped_player(iVar10);
							if (func_9(iVar11, 0, 1))
							{
								if (get_player_team(iVar11) > -1 && get_player_team(iVar11) < 15)
								{
									iVar6 = get_player_team(iVar11);
				...
				else
				{
					...
					iVar9 = iVar5;
					iVar14++;
					GAMEPLAY::CLEAR_BIT(&iVar13, iVar2);
				}
			}
			while (iVar14 < 32)
			{
		...
		switch (iVar0)
		{
			...
			case 2:
			case 4:
				*uParam0.f_47.f_1008 += *uParam0.f_47.f_1002[iVar0];
				break;
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 8);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 8))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 8);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 6);
	}
...
void func_178(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
bool func_179(Vector3 vParam0, Vector3 vParam1)
{
...
void func_181(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	
	if (func_284(vParam2.x))
	{
		iVar0 = true;
	}
	else if (iParam1 != 0)
	{
		...
		{
			case 1:
				*(uParam0.f_47.f_1063[iParam5 /*3*/]) = {vVar1};
				break;
			
			case 2:
				*(uParam0.f_47.f_1160[iParam5 /*3*/]) = {vVar1};
				break;
			
			case 3:
				*(uParam0.f_47.f_1257[iParam5 /*3*/]) = {vVar1};
				break;
			
			case 4:
				*(uParam0.f_47.f_1354[iParam5 /*3*/]) = {vVar1};
				break;
			}
	}
	if (iVar0)
	{
		func_182(uParam0, iParam1, vParam2);
	}
}

void func_182(auto uParam0, int iParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
	...
	{
		if (func_283(uParam0, vParam2.x, 1))
		{
			if (!is_ped_a_player(vParam2.x))
			{
				if (iParam1 != 0)
				{
					*(uParam0.f_47.f_510[iParam1 /*97*/][*uParam0.f_47.f_996[iParam1] /*3*/]) = {vParam2};
					iVar1 = true;
				}
			}
			else if (func_9(_network_get_ped_player(vParam2.x), 0, 1))
			{
				iVar0 = _network_get_ped_player(vParam2.x);
				if (iVar0 != -1)
				{
					if (func_183(iVar0) && !GAMEPLAY::IS_BIT_SET(Global_1587523[iVar0 /*444*/].f_131, 2))
					{
						*(uParam0.f_47.f_510[iParam1 /*97*/])[*uParam0.f_47.f_996[iParam1] /*3*/] = vParam2.x;
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_131, 6);
}
...
int func_190()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4659, false);
}
...
void func_191(auto uParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 20);
	if (Global_1315838)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 20);
		iVar0 = false;
		while (iVar0 < 32)
		{
			...
			if (func_9(iVar1, 1, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_1587523[iVar1 /*444*/].f_187, false))
				{
...
void func_192(int iParam0)
{
	...
	{
		*iParam0.f_1 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
	}
	set_cam_active(*iParam0.f_1, true);
	func_193(1, 1);
	render_script_cams(true, false, 3000, 1, 0, 0);
	set_cam_params(*iParam0.f_1, get_cam_coord(*iParam0), get_cam_rot(*iParam0, 2), get_cam_fov(*iParam0), false, 1, 1, 2);
	set_cam_params(*iParam0.f_1, get_cam_coord(*iParam0), get_cam_rot(*iParam0, 2), get_cam_fov(*iParam0), 1000, 1, 1, 2);
}
...
void func_195(auto uParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !iParam1)
	{
		if (!iParam2)
...
void func_203(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_206(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
...
int func_208()
{
	return GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 4);
}
...
void func_209()
{
	...
	if (((((!is_player_switch_in_progress() && !is_new_load_scene_active()) && func_669() == 1) && func_226(&(Local_386.f_1))) && ENTITY::DOES_ENTITY_EXIST(func_215())) && is_ped_a_player(func_215()))
	{
		iVar0 = _network_get_ped_player(func_215());
		if (is_screen_faded_in())
		{
			if (Global_1715399 == 0)
			{
				...
				{
					do_screen_fade_out(false);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_47), 16);
				}
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_386.f_47, 16) || func_212())
		{
			if (is_screen_faded_out())
			{
				if (!func_213(iVar0))
				{
					...
					GAMEPLAY::CLEAR_BIT(&(Local_386.f_47), 16);
					GAMEPLAY::CLEAR_BIT(&(Local_386.f_47), 19);
					func_211(0);
				}
			}
		}
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Local_386.f_47, 16) || func_210())
		{
			do_screen_fade_in(1000);
			GAMEPLAY::CLEAR_BIT(&(Local_386.f_47), 16);
			func_211(0);
...
int func_210()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 27);
}
...
void func_211(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 27);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_4429), 27);
	}
}
...
bool func_212()
{
	if (func_210())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_386.f_47, 19))
		{
			if (func_213(_network_get_ped_player(func_215())))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_47), 19);
			}
		}
		else
		{
...
{
	if (Global_1587523[player_id() /*444*/].f_355 != iParam0)
	{
		Global_1587523[player_id() /*444*/].f_355 = iParam0;
	}
	StringCopy(&Global_1715855, get_player_name(iParam0), 24);
}

bool func_217()
{
	if (func_218(player_id(), 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 8))
		{
			if (network_is_player_active(Global_1587523[player_id() /*444*/].f_355))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 11))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 11);
					if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 8))
					{
						GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 8);
					}
				}
				return false;
			}
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 8);
			}
		}
	}
	return true;
...
void func_219(struct<2> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, int iParam13)
{
	Param0 = 0;
...
void func_221(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	else
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 2);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 2);
		}
		if (func_224())
		{
			do_screen_fade_out(500);
		}
		Global_2435528.f_2842.f_190 = {func_223(player_id())};
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 4);
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 3);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 6);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 14);
...
{
	return GAMEPLAY::IS_BIT_SET(*uParam0, 4);
}
...
void func_227(int iParam0)
{
	if ((func_669() == 1 && func_287() != 3) || iParam0)
	{
		if (network_can_bail())
		{
			...
			{
				do_screen_fade_out(false);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_1), false);
				network_bail(15, 0, 0);
			}
		}
	}
...
bool func_228()
{
	...
	if (func_208() || func_231(player_id()))
	{
		return false;
	}
	if (func_230())
	...
	if ((func_16() && network_is_activity_session()) && func_10(player_id()))
	{
		return false;
	}
	if ((network_is_activity_session() || network_is_in_transition()) || func_229())
	{
		if (func_6(player_id(), 0))
		{
			if (!Global_2445400)
...
int func_230()
{
	return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2809, 6);
}
...
int func_231(int iParam0)
{
	...
	if (iVar0 != -1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_1708323[iVar0 /*199*/].f_198, true);
	}
	return false;
}
...
void func_232()
{
	...
	if (func_12())
	{
		...
		if (iVar0 == 0)
		{
			_0xABA17D7CE615ADBF("MP_SPINLOADING");
			_0xBD12F8228410D9B4(5);
			func_110(0);
			iLocal_2641 = NETWORK::GET_NETWORK_TIME();
			func_236(3);
		}
		else
		{
...
bool func_237()
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_238(get_player_ped(int_to_playerindex(iVar0)), 0))
			{
				return true;
			}
		}
...
bool func_239(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 1:
			iVar1 = _network_get_ped_player(iParam0);
			iVar2 = iVar1;
			if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar1 /*313*/].f_194, 31))
			{
				return false;
			}
			else
			{
				Global_2445399 = 0;
				if (!GAMEPLAY::IS_BIT_SET(Global_2418472[iVar1 /*313*/].f_194, 30))
				{
					return false;
				}
			}
			if (Global_2459550 && GAMEPLAY::IS_BIT_SET(Global_1609227[iVar2 /*34*/].f_27, 11))
			{
				return false;
			}
			if (func_250(iVar1))
			...
			if (iVar1 != -1)
			{
				if (!func_183(iVar1) && !GAMEPLAY::IS_BIT_SET(Global_1587523[iVar1 /*444*/].f_131, 2))
				{
					return false;
				}
			}
			...
			{
				if ((!func_24(player_id(), 0) || func_218(player_id(), 1)) || func_247(iVar1, 0))
				{
					return false;
				}
			}
			...
			if (GAMEPLAY::IS_BIT_SET(Global_1610316[iVar1 /*174*/].f_1, 14))
			{
				return false;
			}
			if (GAMEPLAY::IS_BIT_SET(Global_1610316[iVar1 /*174*/].f_169, 3))
			{
				return false;
			}
			if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar1 /*313*/].f_194, 29))
			{
			...
			if (iParam1 == 3)
			{
				...
				if (get_player_wanted_level(iVar1) < 1)
				{
					return false;
				}
			...
			else
			{
				...
				{
					vVar3 = {get_entity_coords(iParam0, 0)};
					if ((vVar3.z < -150f && !func_243(iVar1)) && !func_250(iVar1))
					{
						return false;
					}
				}
				...
				if (iParam4)
				{
					if (!func_243(iVar1))
					{
						...
						{
							if ((func_24(player_id(), 0) && !network_is_in_tutorial_session()) && (func_242(iVar1) || func_240(iVar1)))
							{
							}
							else
							{
					...
					if (iVar2 > -1)
					{
						if (GAMEPLAY::IS_BIT_SET(Global_1587523[iVar2 /*444*/].f_131, 2))
						{
							return false;
						}
					}
...
bool func_240(int iParam0)
{
	if (iParam0 > -1)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2418472[iParam0 /*313*/].f_194, 4))
		{
			return true;
		}
	}
...
bool func_242(int iParam0)
{
	if (iParam0 > -1)
	{
		if (Global_1587523[iParam0 /*444*/].f_250.f_9 != -1 || GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_250.f_7, 2))
		{
			return true;
		}
	}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_39.f_18, 14);
}
...
int func_248(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iVar0 /*444*/].f_39.f_18, 20);
}
...
bool func_249(int iParam0, int iParam1)
{
	if (decor_is_registered_as_type("MPBitset", 3))
	{
		if (decor_exist_on(get_player_ped_script_index(iParam0), "MPBitset"))
		{
			if (GAMEPLAY::IS_BIT_SET(decor_get_int(get_player_ped_script_index(iParam0), "MPBitset"), iParam1))
			{
				return true;
			}
		}
...
void func_253()
{
	...
	iVar3 = false;
	GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 5);
	if (!is_player_switch_in_progress() && !func_235())
	{
		if (!is_new_load_scene_active())
		{
			if (func_669() == 1)
				...
				if (func_226(&(Local_386.f_1)))
				{
					if (!iVar3)
					{
						if (func_24(player_id(), 0))
						{
							if (func_669() == 1)
							{
								if (ENTITY::DOES_ENTITY_EXIST(func_215()))
								{
									if (is_ped_a_player(func_215()))
									{
										iVar4 = _network_get_ped_player(func_215());
										if (network_is_player_active(iVar4))
										{
											if (func_256(iVar4, 0))
											{
												if (Global_2359299)
												{
													vVar0 = {get_entity_coords(func_215(), 0)};
												}
												GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 5);
												iVar3 = true;
											}
										}
									}
					...
					if (iVar3)
					{
						if (Global_2359299)
						{
							set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0, 1, true, 0, 0);
						}
						set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
						set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
					}
...
bool func_257(int iParam0)
{
	...
	else
	{
		switch (iLocal_2638)
		{
			...
			case 0:
				iLocal_2639 = iLocal_2640;
				iLocal_2638++;
				break;
			
			case 1:
				if ((is_new_load_scene_active() && !is_new_load_scene_loaded()) && get_time_difference(iLocal_2640, iLocal_2639) < 10000)
				{
				}
				else
				{
			...
			case 2:
				if ((is_screen_faded_in() || !iParam0) || func_100())
				{
					new_load_scene_stop();
					iLocal_2638 = -1;
					return true;
...
void func_261(auto uParam0, int iParam1)
{
	...
	{
		*uParam0 = create_cam("DEFAULT_SCRIPTED_FLY_CAMERA", false);
	}
	_0xF9D02130ECDD1D77(*uParam0, 820f);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_77(*uParam0.f_2))
		{
			set_cam_coord(*uParam0, *uParam0.f_2);
			set_cam_rot(*uParam0, *uParam0.f_5, 2);
		}
		else
		{
			if (get_closest_vehicle_node(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), &vVar0, 1, 3f, 0f))
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0 + Vector(1f, 0f, 0f), 1, true, 0, 0);
			}
			set_cam_coord(*uParam0, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) + Vector(iParam1, 0f, 0f));
		}
		func_192(uParam0);
		set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
		set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
...
void func_262(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, int iParam4)
{
	*uParam0.f_16 = 1;
	*uParam0.f_16.f_1 = {vParam1};
	*uParam0.f_16.f_4 = {vParam4};
...
auto func_263(auto uParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	
	vVar0 = {func_264(uParam0, iParam1, iParam2)};
	return vVar0.x;
}

Vector3 func_264(auto uParam0, int iParam1, int iParam2)
{
	return *(uParam0.f_24[iParam1 /*97*/][iParam2 /*3*/]);
}

bool func_265(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	int iVar2;
	...
	if (iParam5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_103()))
		{
			...
			{
				if (func_270(uParam0, iVar2, &uVar1, iParam3, iParam4))
				{
					*iParam1 = iVar2;
					*uParam2 = uVar1;
					return true;
		...
		if (ENTITY::DOES_ENTITY_EXIST(func_80()))
		{
			...
			{
				if (func_270(uParam0, iVar3, &uVar1, iParam3, iParam4))
				{
					*iParam1 = iVar3;
					*uParam2 = uVar1;
					return true;
	...
	while (iVar0 < 5)
	{
		...
		{
			if (func_270(uParam0, iVar0, &uVar1, iParam3, iParam4))
			{
				*iParam1 = iVar0;
				*uParam2 = uVar1;
				return true;
	...
	if ((func_268(player_id(), 2) || func_268(player_id(), 8)) || (func_268(player_id(), 0) && func_266()))
	{
...
int func_266()
{
	if (func_24(player_id(), 0))
	{
		if (_network_get_ped_player(func_103()) != func_46() && network_is_player_active(_network_get_ped_player(func_103())))
		{
			return func_267(_network_get_ped_player(func_103()));
		}
		else if (Global_1587523[player_id() /*444*/].f_355 != func_46() && network_is_player_active(Global_1587523[player_id() /*444*/].f_355))
		{
			return func_267(Global_1587523[player_id() /*444*/].f_355);
		}
	}
	else
	{
		return func_267(player_id());
	}
	return false;
}
...
bool func_270(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (func_284(iVar5))
				{
					if (func_24(player_id(), 0))
					{
						if (!iVar4)
						{
							...
							{
								if (func_9(_network_get_ped_player(iVar5), 1, 1))
								{
									if (are_strings_equal(&Global_1715855, get_player_name(_network_get_ped_player(iVar5))))
									{
										iVar4 = true;
										iVar1 = iVar0;
									}
					...
					if (!func_24(player_id(), 0) || !iVar4)
					{
						if (!iParam3 || iVar5 != func_103())
						{
							if (!iParam4 || iVar5 != func_80())
							{
								if (is_ped_a_player(iVar5))
								{
									if (func_9(_network_get_ped_player(iVar5), 1, 1))
									{
										if (get_player_team(_network_get_ped_player(iVar5)) == get_player_team(player_id()))
										{
											iVar3 = 1;
										}
									}
...
bool func_271(int iParam0, auto uParam1, auto uParam2)
{
	if (func_24(player_id(), 0))
	{
		if (!func_15())
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0))
			{
				if (_network_get_ped_player(iParam0) != func_46())
				{
					if (!func_272(_network_get_ped_player(iParam0)))
					{
						return false;
					}
				}
	...
	if ((func_267(player_id()) && !func_16()) && !GAMEPLAY::IS_BIT_SET(Global_2359301, 20))
	{
		if (get_player_team(player_id()) != -1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0))
			{
				if (get_player_team(_network_get_ped_player(iParam0)) != -1)
				{
					if (get_player_team(player_id()) != get_player_team(_network_get_ped_player(iParam0)))
					{
						return false;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (_network_get_ped_player(iParam0) != func_46())
		{
			if (func_231(_network_get_ped_player(iParam0)))
			{
				return false;
			}
		}
...
int func_272(int iParam0)
{
	...
	if (func_24(player_id(), 0) || Global_2459550)
	{
...
bool func_273(auto uParam0)
{
	...
	iVar0 = 1;
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 25))
	{
		iVar0 = 0;
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 3))
	{
	...
	if (func_24(player_id(), 0))
	{
		if (Global_2460486.f_276 != func_46())
		{
			...
			{
				iVar1 = func_249(Global_2460486.f_276, 9);
				iVar2 = func_231(Global_2460486.f_276);
			}
		}
		if (Global_2444467)
		{
		...
		if (func_105(player_id()) || GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 15))
		{
			if (iVar1 == 1)
			{
				iVar0 = 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_103()))
	{
		if (func_248(_network_get_ped_player(func_103())))
		{
			iVar0 = 0;
		}
		if (func_105(player_id()))
		{
			if (func_274(_network_get_ped_player(func_103())))
			{
				iVar0 = 0;
			}
		}
...
int func_274(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_187, false);
}
...
int func_276()
{
	return GAMEPLAY::IS_BIT_SET(Global_969327.f_8, 18);
}
...
bool func_278(auto uParam0, int iParam1)
{
...
void func_279(auto uParam0, int iParam1, int iParam2)
{
...
bool func_280(auto uParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_281(auto uParam0, int iParam1)
{
	...
	if (func_60())
	{
		Global_2460486.f_276 = _network_get_ped_player(iParam1);
	}
}
...
bool func_283(auto uParam0, int iParam1, int iParam2)
{
	if (func_239(iParam1, *uParam0.f_1.f_35, GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, false), GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, false), iParam2))
	{
		return true;
	}
	return false;
...
bool func_284(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (is_ped_a_player(iParam0))
		{
			if (network_is_player_active(_network_get_ped_player(iParam0)))
			{
				return true;
			}
		}
...
void func_286()
{
	...
	if (is_entity_visible(PLAYER::PLAYER_PED_ID()))
	{
		set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
	}
	set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
...
int func_288()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 15);
}
...
void func_289(int iParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 8))
	{
		if (iParam0)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 9);
		}
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 8);
	}
}
...
void func_291(auto uParam0)
{
	...
	{
		if ((!is_player_switch_in_progress() && !is_screen_faded_out()) && !is_screen_fading_out())
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_103()))
			{
				_0x8BBACBF51DA047A8(func_103());
			}
		}
	}
	if (func_669() == 1)
	...
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 13))
	{
		if (func_102())
		{
			...
			{
				func_40(uParam0, 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 13);
			}
		}
	}
	if (!func_24(player_id(), 0))
	...
	{
		func_174(uParam0);
		if (((func_632() && !func_24(player_id(), 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !is_player_switch_in_progress())
		{
	...
	if ((func_115(uParam0.f_1) == 0 || func_115(uParam0.f_1) == 1) || func_115(uParam0.f_1) == 6)
	{
		...
		{
			GAMEPLAY::CLEAR_BIT(uParam0.f_1, 5);
			GAMEPLAY::CLEAR_BIT(&Global_2359301, 4);
		}
	}
	else
	{
		...
		if (func_115(uParam0.f_1) == 3)
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 5))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 5);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 4);
			}
		}
	}
	if (((func_115(uParam0.f_1) == 0 || func_115(uParam0.f_1) == 4) || func_115(uParam0.f_1) == 5) || func_115(uParam0.f_1) == 6)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 6);
		}
	}
	else
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 6))
		{
			GAMEPLAY::CLEAR_BIT(uParam0.f_1, 6);
		}
		func_609(uParam0);
		func_608();
	}
	...
	if (func_564())
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 6);
		func_563();
		if (func_24(player_id(), 0) || (func_226(uParam0.f_1) && func_562(uParam0.f_1)))
		{
...
void func_292(auto uParam0)
{
	...
	iVar0 = false;
	if (!func_24(player_id(), 0) || func_669() == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 6))
		{
			if (!*uParam0.f_1.f_34)
			{
				if (!func_283(uParam0, func_103(), 1))
				{
					...
					{
						if (ENTITY::DOES_ENTITY_EXIST(func_103()) && !func_231(_network_get_ped_player(func_103())))
						{
							if (!func_81())
							{
								iVar0 = true;
	...
	if (iVar0)
	{
		...
		if (iVar1)
		{
			...
			if (!iVar4)
			{
				if (func_9(Global_2460486.f_276, 0, 1))
				{
					iVar5 = func_249(Global_2460486.f_276, 9);
					iVar6 = func_231(Global_2460486.f_276);
				}
				if (((((((((((*uParam0.f_47.f_2168 == 0 && !func_274(Global_1587523[player_id() /*444*/].f_355)) && !func_276()) && !func_248(_network_get_ped_player(func_103()))) && !func_274(_network_get_ped_player(func_103()))) && Global_1315839 == 0) && Global_1573850 == 0) && iVar5 == 0) && iVar6 == 0) && !func_208()) && !func_231(player_id())) && !func_310())
				{
					iVar7 = func_303();
					if (iVar7 == 1)
					{
		...
		if (!iVar4)
		{
			if (func_24(player_id(), 0))
			{
				...
				else if (func_6(player_id(), 0))
				{
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 13);
					}
				}
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 14);
		}
	}
	func_177(uParam0.f_47);
	func_301(uParam0);
...
void func_293(auto uParam0)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1708323[*uParam0.f_1.f_42 /*199*/].f_198, false) || Global_1725136)
		{
		...
		else if (_is_nightvision_inactive() && !func_294(Global_1617379.f_70365))
		{
...
void func_295(int iParam0)
{
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 9))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 9);
			func_79();
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 9))
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_4429), 9);
		func_79();
	}
}
...
void func_298()
{
	if (!Global_1573840)
	{
		if (network_is_activity_session())
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_103()))
			{
				if (func_299(_network_get_ped_player(func_103()), 102, 0) && !func_299(player_id(), 102, 0))
				{
					clear_area_of_vehicles(Global_1617379.f_29651, 3000f, 0, 0, 0, 0, false);
					clear_area_of_vehicles(Global_1617379.f_29651, 3000f, 0, 0, 1, 0, false);
					clear_area_of_vehicles(Global_1617379.f_29651, 3000f, 0, 0, 0, 1, false);
...
void func_301(auto uParam0)
{
	...
	if (func_24(player_id(), 0) || (func_226(uParam0.f_1) && func_562(uParam0.f_1)))
	{
		...
		{
			iVar0 = int_to_playerindex(*uParam0.f_1.f_43);
			iVar1 = _network_get_ped_player(Global_2359301.f_2);
			if (iVar0 != func_46() && iVar1 != func_46())
			{
				if (func_9(iVar0, 0, 1) && func_9(iVar1, 0, 1))
				{
					if (!func_7(player_id(), 1) || (func_15() && func_24(player_id(), 0)))
					{
						_0xDDF73E2B1FEC5AB4(iVar0, 1);
					}
					else if (!func_24(player_id(), 0) && func_105(player_id()))
					{
						_0xDDF73E2B1FEC5AB4(iVar0, 1);
						_0x97DD4C5944CC2E6A(iVar0, 1);
					}
					else if (func_302(iVar1, iVar0, -2, 1) || get_player_team(iVar1) == -1)
					{
						_0xDDF73E2B1FEC5AB4(iVar0, 1);
					}
					else
					{
						_0xDDF73E2B1FEC5AB4(iVar0, 0);
					}
				}
			}
		}
...
bool func_303()
{
	...
	if (func_306(201))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1312768, false);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_1312768, false))
	{
		if (func_305(201))
		{
			GAMEPLAY::CLEAR_BIT(&Global_1312768, false);
			return true;
		}
	}
	sVar0 = "HUD_CONNPROB";
	sVar1 = "NO_INDIV_SPEC";
	func_304();
	_set_warning_message_2(sVar0, sVar1, 2, 0, 0, -1, 0, 0, 1);
	return false;
}
...
{
	if (is_control_just_released(2, iParam0) || is_disabled_control_just_released(2, iParam0))
	{
		return true;
	}
	return false;
...
bool func_306(int iParam0)
{
	...
	iVar0 = iParam0;
	uVar1 = func_309(iVar0);
	iVar2 = func_308(iVar0);
	if ((is_control_just_released(2, iParam0) || is_disabled_control_just_released(2, iParam0)) || func_307(iParam0, &(Global_1338622.f_961), 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_1338622.f_950[uVar1], iVar2))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1338622.f_950[uVar1]), iVar2);
			return true;
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_1338622.f_950[uVar1], iVar2))
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1338622.f_950[uVar1]), iVar2);
	}
	return false;
}

bool func_307(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_310()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_3, true);
}

void func_311(auto uParam0)
{
	if ((((!func_202(8, -1) && !is_pause_menu_active()) && !is_player_switch_in_progress()) && !func_519()) && !func_81())
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, false) || func_24(player_id(), 0))
		{
		...
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, false) || func_24(player_id(), 0))
		{
			...
			_0x7669F9E39DC17063();
			if ((!func_24(player_id(), 0) || func_669() == 1) || func_669() == 2)
			{
				...
				else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, false) || (func_24(player_id(), 0) && (func_669() == 2 || func_669() == 1)))
				{
					...
					if ((*uParam0.f_1.f_4 || *uParam0.f_1.f_3 > 2) && !GAMEPLAY::IS_BIT_SET(Global_2359301, 28))
					{
						func_313(uParam0, func_461(uParam0.f_47));
					}
					if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 15))
					{
						if (func_3(uParam0.f_47.f_2172, 500, 0))
						{
							...
							GAMEPLAY::CLEAR_BIT(uParam0.f_47, 15);
						}
					}
				}
				func_312(uParam0);
...
void func_312(auto uParam0)
{
	...
	switch (*uParam0.f_47.f_1464)
	{
		case 0:
			if (func_93(uParam0.f_1) != 3)
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 14))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 14);
				}
				unk_0x2790F4B17D098E26(1);
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_2359301, 14))
			{
				GAMEPLAY::CLEAR_BIT(&Global_2359301, 14);
			}
			if (GAMEPLAY::IS_BIT_SET(Global_2359301, 29))
			{
				if (func_268(player_id(), 11))
				{
					display_hud(true);
					display_radar(true);
					GAMEPLAY::CLEAR_BIT(&Global_2359301, 29);
		...
		case 2:
			...
			if (func_93(uParam0.f_1) != 3)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2359301, 11))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 29))
					{
						display_hud(false);
						display_radar(true);
						GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 29);
					}
					hide_hud_component_this_frame(1);
				...
				else
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 11);
				}
			}
			break;
	}
...
void func_313(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam1 != 3)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2359301, false))
		{
			GAMEPLAY::CLEAR_BIT(&Global_2359301, false);
		}
	}
		...
		if (func_93(uParam0.f_1) != 3)
		{
			switch (iParam1)
			{
				...
				case 4:
					if (iVar0)
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 12))
						{
							if (has_scaleform_movie_loaded(*uParam0.f_47.f_1473) && *uParam0.f_47.f_1473 != -1)
							{
								func_342(uParam0.f_47.f_1473, 76);
								if (*uParam0.f_47.f_1008 > 8)
								{
									_0x25F87B30C382FCA7();
									if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 18))
									{
										GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 18);
									}
								}
								else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 18))
								{
									_0xA8FDB297A8D25FBA();
									GAMEPLAY::CLEAR_BIT(uParam0.f_47, 18);
								}
							}
						}
					}
				...
				case 3:
					if (!func_341(1))
					{
						if (iVar0)
						{
							if (!GAMEPLAY::IS_BIT_SET(Global_2359301, false))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, false);
							}
						}
					}
					break;
				...
				case 5:
					iVar4 = 36;
					iVar5 = Global_1587523[player_id() /*444*/];
					if (iVar5 == 3)
					{
						_set_warning_message_2("SPEC_LEAVE", "SPEC_SURE_HORD", iVar4, 0, 0, -1, 0, 0, 1);
					}
					else if (iVar5 == 0)
					{
						if (Global_1617379.f_2 == 5)
						{
							_set_warning_message_2("SPEC_LEAVE", "SPEC_SURE_LTS", iVar4, 0, 0, -1, 0, 0, 1);
						}
						else if (Global_1617379.f_2 == 6)
						{
							_set_warning_message_2("SPEC_LEAVE", "SPEC_SURE_CTF", iVar4, 0, 0, -1, 0, 0, 1);
						}
						else
						{
							_set_warning_message_2("SPEC_LEAVE", "SPEC_SURE_MISS", iVar4, 0, 0, -1, 0, 0, 1);
						}
					}
					else
					{
						_set_warning_message_2("SPEC_LEAVE", "SPEC_SURE", iVar4, 0, 0, -1, 0, 0, 1);
					}
					break;
				}
			}
	...
	if (iVar1)
	{
		if (!func_24(player_id(), 0) || !func_15())
		{
			if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 4))
			{
				if (func_93(uParam0.f_1) != 3)
				{
					if ((GAMEPLAY::IS_BIT_SET(*uParam0.f_47, true) || GAMEPLAY::IS_BIT_SET(Global_2359301, 13)) || _0x6CD79468A1E595C6(0))
					{
						...
						if (func_461(uParam0.f_47) == iParam1 && func_461(uParam0.f_47) != 5)
						{
							if (*uParam0.f_47.f_1464 == 0)
							{
								...
								if (iParam1 == 1)
								{
									if (!func_24(player_id(), 0) || func_669() == 1)
									{
										if (ENTITY::DOES_ENTITY_EXIST(func_336(uParam0.f_47)))
										{
											if (is_ped_a_player(func_336(uParam0.f_47)))
											{
												iVar7 = _network_get_ped_player(func_336(uParam0.f_47));
												if (iVar7 != -1)
												{
													if ((func_336(uParam0.f_47) != func_215() && func_272(iVar7)) && func_335(_network_get_ped_player(func_336(uParam0.f_47))))
													{
														iVar6 = true;
													}
												}
								...
								if (iVar6)
								{
									func_333(_get_control_action_name(2, func_334(1), true), "HUD_INPUT28", uParam0.f_47.f_1474, 0);
								}
							}
							if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 8))
							{
								if (func_93(uParam0.f_1) == 5)
								{
									func_333(_get_control_action_name(2, func_334(0), true), "HUD_INPUT3", uParam0.f_47.f_1474, 0);
								}
								else if (*uParam0.f_47.f_1464 == 0)
								{
									if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 2) || func_93(uParam0.f_1) == 4)
									{
										func_333(_get_control_action_name(0, func_334(0), true), "HUD_INPUT69", uParam0.f_47.f_1474, 0);
									}
								}
							}
							if (func_93(uParam0.f_1) == 5)
							{
								func_333(_get_control_action_name(0, func_332(222), true), "HUD_INPUT82", uParam0.f_47.f_1474, 0);
							}
							else if ((iParam1 == 1 || iParam1 == 2) || iParam1 == 3)
							{
								if (*uParam0.f_47.f_1464 == 0)
								{
									...
									{
										func_333(_get_control_action_name(0, func_332(222), true), "HUD_INPUT83", uParam0.f_47.f_1474, 0);
									}
									else if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 3))
									{
										func_333(_get_control_action_name(0, func_332(222), true), "HUD_SPECRY", uParam0.f_47.f_1474, 0);
									}
									else
									{
										func_333(_get_control_action_name(0, func_332(222), true), "HUD_SPECRN", uParam0.f_47.f_1474, 0);
									}
								}
								else if (*uParam0.f_47.f_1464 == 1)
								{
									func_333(_get_control_action_name(0, func_332(222), true), "HUD_INPUT39", uParam0.f_47.f_1474, 0);
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
							{
								if ((((Global_1587523[player_id() /*444*/] == 3 || Global_1587523[player_id() /*444*/] == 0) || Global_1587523[player_id() /*444*/] == 1) || Global_1587523[player_id() /*444*/] == 8) || Global_1587523[player_id() /*444*/] == 2)
								{
									if (func_331() && !GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
									{
										if (iParam1 == 1 || iParam1 == 2)
										{
											if (func_330(uParam0.f_47))
											{
												func_333(_get_control_action_name(0, func_332(224), true), "HUD_INPUT40", uParam0.f_47.f_1474, 0);
											}
										}
									}
								}
								if (iParam1 == 3)
								{
									if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
									{
										func_333(_get_control_action_name(0, func_332(224), true), "HUD_INPUT43", uParam0.f_47.f_1474, 0);
									}
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
							{
								if ((iParam1 == 1 || iParam1 == 2) || iParam1 == 3)
								{
									if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
									{
										func_333(_0x80C2FD58D720C801(0, func_329(19), true), "HUD_INPUT72", uParam0.f_47.f_1474, 0);
									}
									else if (!func_328())
									{
										func_333(_0x80C2FD58D720C801(0, func_329(19), true), "HUD_SPECSR", uParam0.f_47.f_1474, 0);
									}
								}
							}
							if (func_93(uParam0.f_1) == 5)
							{
								_0x7F4724035FDCA1DD(2);
								func_333(_get_control_action_name(2, 218, true), "HUD_INPUT75", uParam0.f_47.f_1474, 0);
							}
							if (*uParam0.f_47.f_1008 > 8)
							{
								if (*uParam0.f_47.f_23 != 3)
								{
									if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 12))
									{
										func_333(_get_control_action_name(0, func_332(230), true), "SCTV_FEED0", uParam0.f_47.f_1474, 0);
									}
									else
									{
										func_333(_get_control_action_name(0, func_332(230), true), "SCTV_FEED1", uParam0.f_47.f_1474, 0);
									}
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
							{
								if (iParam1 == 3)
								{
									...
									{
										func_333(_get_control_action_name(2, func_332(226), true), sVar8, uParam0.f_47.f_1474, 0);
									}
									else
									{
										func_333(_get_control_action_name(2, 0, true), sVar8, uParam0.f_47.f_1474, 0);
									}
								}
								else if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 15))
								{
									if (!func_24(player_id(), 0) || func_669() == 1)
									{
										if ((((((!func_268(player_id(), 15) && !func_268(player_id(), 11)) && !func_268(player_id(), 13)) && !func_268(player_id(), 12)) && !func_268(player_id(), 14)) && !func_268(player_id(), 23)) && !Global_2359296)
										{
											if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 5))
											{
												func_333(_get_control_action_name(0, 0, true), "HUD_INPUT87", uParam0.f_47.f_1474, 0);
											}
										}
									}
								}
								...
								if (iParam1 == 1)
								{
									if (!func_326())
									{
										if (func_24(player_id(), 0))
										{
											if (Global_2359296)
											{
												func_333(_get_control_action_name(0, func_332(231), true), "SCTV_HELI_OFF", uParam0.f_47.f_1474, 0);
											}
											else if (Global_2359297 == 1)
											{
												func_333(_get_control_action_name(0, func_332(231), true), "SCTV_HELI_ON", uParam0.f_47.f_1474, 0);
											}
										}
									}
								}
							...
							if (GAMEPLAY::IS_PC_VERSION())
							{
								if (*uParam0.f_47.f_1464 == 0)
								{
									func_333(_get_control_action_name(2, 199, true), "SPEC_PAUSE", uParam0.f_47.f_1474, 0);
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
							{
								if (iParam1 == 1)
								{
									if (!func_24(player_id(), 0) || func_669() == 1)
									{
										if ((((func_325(uParam0.f_47) && !func_268(player_id(), 13)) && !func_268(player_id(), 14)) && !func_268(player_id(), 15)) && !func_324(Global_1617379.f_70365))
										{
											func_333(_get_control_action_name(0, func_332(229), true), "HUD_SPECDN", uParam0.f_47.f_1474, 0);
										}
									}
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
							{
								if (iParam1 == 1)
								{
									if (!func_24(player_id(), 0) || func_669() == 1)
									{
										if ((((func_325(uParam0.f_47) && !func_268(player_id(), 13)) && !func_268(player_id(), 14)) && !func_268(player_id(), 15)) && !func_324(Global_1617379.f_70365))
										{
											func_333(_get_control_action_name(0, func_332(228), true), "HUD_SPECUP", uParam0.f_47.f_1474, 0);
										}
									}
								}
							}
							if (func_24(player_id(), 0) && func_15())
							{
								if ((iParam1 == 1 || iParam1 == 2) || iParam1 == 3)
								{
									if (func_669() == 2)
									{
										if (func_330(uParam0.f_47))
										{
											func_333(_get_control_action_name(0, func_332(227), true), "HUD_INPUT41", uParam0.f_47.f_1474, 0);
										}
									}
									else if (func_669() == 1)
									{
										func_333(_get_control_action_name(0, func_332(227), true), "HUD_INPUT51", uParam0.f_47.f_1474, 0);
									}
								}
							}
							else if (*uParam0.f_47.f_1464 == 0 && !func_60())
							{
								if ((iParam1 == 1 || iParam1 == 2) || iParam1 == 3)
								{
									if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
									{
										func_333(_get_control_action_name(0, func_332(227), true), "HUD_SPECRC", uParam0.f_47.f_1474, 0);
									}
									else if (!func_328())
									{
										func_333(_get_control_action_name(0, func_332(227), true), "HUD_SPECFC", uParam0.f_47.f_1474, 0);
									}
								}
							}
							if (*uParam0.f_47.f_1464 == 0)
								...
								if (iParam1 != 3)
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(iVar2))
									{
										if (is_ped_a_player(iVar2))
										{
											...
											{
												sVar9 = func_327();
												func_333(_get_control_action_name(0, func_332(226), true), sVar9, uParam0.f_47.f_1474, 0);
											}
										}
									}
								}
						...
						GAMEPLAY::CLEAR_BIT(uParam0.f_47, true);
						GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 13);
					}
					if (*uParam0.f_47.f_1464 == 0 || *uParam0.f_47.f_1464 == 1)
					{
						...
						if (_0xD422FCC5F239A915())
						{
							if (!does_cam_exist(*uParam0.f_1.f_39) || !func_268(player_id(), 122))
							{
								_0x10D373323E5B9C0D();
							}
						}
...
void func_314(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < *uParam2.f_680)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam2.f_676, iVar0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(*uParam2.f_677, iVar0))
					{
						...
						func_317(_get_control_action_name(iVar1, iVar2, true));
						if (iVar3 < 344)
						{
							func_317(_get_control_action_name(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_317(_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_315(int iParam0, auto uParam1)
{
...
void func_322(auto uParam0, float fParam1)
{
...
bool func_331()
{
	if ((((((((Global_1587523[player_id() /*444*/] == 1 || Global_1587523[player_id() /*444*/] == 8) || Global_1587523[player_id() /*444*/] == 2) || Global_1587523[player_id() /*444*/] == 4) || Global_1587523[player_id() /*444*/] == 9) || Global_1587523[player_id() /*444*/] == 7) || Global_1587523[player_id() /*444*/] == 10) || Global_1587523[player_id() /*444*/] == 165) || Global_1587523[player_id() /*444*/] == 0)
	{
		if (!Global_2359298)
		{
			return false;
...
void func_333(char* sParam0, char* sParam1, auto uParam2, char* sParam3)
{
	auto uVar0;
...
bool func_335(int iParam0)
{
	if (Global_1315838)
	{
		...
		{
			if (!func_24(player_id(), 0) && !func_246(player_id()))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 20))
				{
					if (get_player_team(iParam0) != -1)
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 14) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_80[get_player_team(iParam0) /*6968*/].f_3997, 6))
						{
...
auto func_336(auto uParam0)
{
	...
	vVar0 = {func_337(uParam0)};
	return vVar0.x;
}

Vector3 func_337(auto uParam0)
{
	int iVar0;
	int iVar1;
...
bool func_338(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_339(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
void func_342(auto uParam0, int iParam1)
{
	_set_screen_draw_position(iParam1, 84);
	if (iParam1 == 82)
	{
		draw_scaleform_movie(*uParam0, 0.14f, 0.3f, 0.28f, 0.6f, 255, 255, 255, 255, 0);
	}
	else if (iParam1 == 76)
	{
		draw_scaleform_movie(*uParam0, 0.14f, 0.3f, 0.28f, 0.6f, 255, 255, 255, 255, 0);
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 5))
	{
		if (func_461(uParam0.f_47) != 1)
		{
			func_88(uParam0.f_47, 1);
			GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_1), 5);
			GAMEPLAY::CLEAR_BIT(uParam0.f_47, 13);
		}
	}
}

bool func_345(auto uParam0)
{
	if (Global_1715399)
	{
		return true;
...
int func_346()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 11);
}
...
bool func_347(auto uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 4))
	{
		return true;
	}
	if (func_268(player_id(), 15))
	{
		return true;
	}
	if (func_268(player_id(), 11))
	...
	if (func_268(player_id(), 13))
	{
		return true;
	}
	if (func_268(player_id(), 12))
	{
		return true;
	}
	if (func_268(player_id(), 14))
	{
		return true;
	}
	if (func_268(player_id(), 23))
	{
		return true;
	}
	if (func_349())
...
bool func_348()
{
	if (Global_1573691 && !GAMEPLAY::IS_BIT_SET(Global_2359301, false))
	{
		return true;
	}
	return false;
...
int func_350()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 10);
}
...
void func_352()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 12))
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_4429), 12);
	}
}

int func_353()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 12);
}
...
bool func_355()
{
	...
	if (func_244(player_id()))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_103()))
		{
			iVar0 = _network_get_ped_player(func_103());
			if (iVar0 != func_46())
			{
				if (func_9(iVar0, 1, 0))
				{
...
void func_358(auto uParam0)
{
	...
	if ((!_is_input_disabled(2) && is_control_just_pressed(2, func_334(0))) || (_is_input_disabled(2) && is_control_just_pressed(2, 202)))
	{
		play_sound_frontend(-1, "CANCEL", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
		func_88(uParam0.f_47, *uParam0.f_47.f_1457);
	}
	if ((!_is_input_disabled(2) && is_control_just_pressed(2, func_334(1))) || (_is_input_disabled(2) && is_control_just_pressed(2, 201)))
	{
		if (!func_24(player_id(), 0))
		{
			if (func_374(player_id()))
			{
				func_368(1888, 1, -1);
			}
			else if (func_267(player_id()))
			{
				func_368(1891, 1, -1);
			}
			else if (func_268(player_id(), 0))
			{
				func_368(1885, 1, -1);
			}
			else if (func_268(player_id(), 3))
			{
				func_368(1894, 1, -1);
			}
			func_361();
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 6);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 7);
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 13);
			if (func_10(player_id()))
			{
				func_359();
			}
...
void func_365()
{
	GAMEPLAY::CLEAR_BIT(&Global_2434762, 20);
}

void func_366()
{
	GAMEPLAY::CLEAR_BIT(&Global_2434762, 2);
}

void func_367()
{
	GAMEPLAY::CLEAR_BIT(&(Global_969327.f_8), 8);
}
...
int func_372(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_373(iParam1)];
...
bool func_375(auto uParam0)
{
	if ((((!is_screen_faded_in() || GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 4)) || GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 2)) || is_pause_menu_active()) || _network_is_text_chat_active())
	{
		return false;
	}
	return true;
...
bool func_376(auto uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 14))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 6);
			func_88(uParam0.f_47, *uParam0.f_47.f_1456);
			GAMEPLAY::CLEAR_BIT(uParam0.f_47, 13);
			GAMEPLAY::CLEAR_BIT(uParam0.f_47, 14);
		}
	}
	return false;
}

void func_377(auto uParam0)
{
	if (_network_is_text_chat_active())
	{
		return;
	...
	if (*uParam0.f_47.f_1464 == 0)
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 2))
		{
			if (is_control_just_pressed(2, func_334(0)))
			{
				play_sound_frontend(-1, "CANCEL", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
		...
		if (is_control_just_pressed(2, func_332(224)))
		{
			play_sound_frontend(-1, "CANCEL", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
			func_88(uParam0.f_47, *uParam0.f_47.f_1456);
...
void func_378(auto uParam0)
{
	...
	if (func_15())
	{
		if (*uParam0.f_47.f_1464 == 0 || *uParam0.f_47.f_1464 == 1)
		{
			if (func_24(player_id(), 0))
			{
				if (is_screen_faded_in())
				{
					if (is_control_just_pressed(2, func_332(231)))
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 10))
						{
							_set_radar_bigmap_enabled(1, 0);
							_0x82CEDC33687E1F50(1);
							func_388(1);
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 10);
						}
						else
						{
							_set_radar_bigmap_enabled(0, 0);
							_0x82CEDC33687E1F50(0);
							func_388(0);
							GAMEPLAY::CLEAR_BIT(uParam0.f_47, 10);
						}
					}
				}
			}
	...
	if (*uParam0.f_47.f_1008 > 8)
	{
		if (*uParam0.f_47.f_23 != 3)
		{
			if (*uParam0.f_47.f_1464 == 0 || *uParam0.f_47.f_1464 == 1)
			{
				if (is_screen_faded_in())
				{
					if (is_control_just_pressed(2, func_332(230)) || is_disabled_control_just_pressed(2, func_332(230)))
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 12))
						{
							_0xA8FDB297A8D25FBA();
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 12);
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
						}
						else
						{
							GAMEPLAY::CLEAR_BIT(uParam0.f_47, 12);
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
						}
					}
				}
	...
	else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 12))
	{
		_0xA8FDB297A8D25FBA();
		GAMEPLAY::CLEAR_BIT(uParam0.f_47, 12);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
	...
	if (*uParam0.f_47.f_1464 == 0)
	{
		if (func_24(player_id(), 0))
		{
			if (is_screen_faded_in())
			{
				if (func_15())
				{
					if (is_control_just_pressed(2, func_332(227)))
					{
						if (func_387())
						{
							if (get_time_difference(NETWORK::GET_NETWORK_TIME(), *uParam0.f_47.f_1451) >= 0)
							{
								switch (func_669())
								{
									case 1:
								...
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 6);
							}
						}
					}
					if ((is_control_pressed(2, func_332(230)) && is_control_just_pressed(2, func_332(231))) || (is_control_pressed(2, func_332(231)) && is_control_just_pressed(2, func_332(230))))
					{
						func_386(1);
					}
				}
		...
		if (func_669() != 2)
		{
			if (is_control_just_pressed(2, func_332(226)) && *uParam0.f_47.f_23 != 3)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar0))
				{
					...
					{
						iVar1 = _network_get_ped_player(iVar0);
						if (func_9(iVar1, 0, 1))
						{
							play_sound_frontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
							Var2 = {func_385(iVar1)};
	...
	{
		if (is_disabled_control_just_pressed(2, func_332(234)))
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
			{
				if (!func_328())
		...
		if (is_disabled_control_just_pressed(2, func_332(235)))
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
			{
				if (!func_328())
		...
		if (is_control_just_pressed(2, func_332(227)))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 18);
			}
			else
			{
				GAMEPLAY::CLEAR_BIT(uParam0.f_1, 18);
			}
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
		}
		if (func_669() != 2 && !GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
		{
			switch (*uParam0.f_47.f_1464)
			{
				case 0:
					if (is_control_just_pressed(2, func_332(222)))
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
						{
							play_sound_frontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				...
				case 1:
					...
					else if ((((((((((is_control_just_pressed(2, func_334(1)) || is_control_just_pressed(2, func_334(0))) || is_control_just_pressed(2, func_332(233))) || is_control_just_pressed(2, func_332(226))) || is_control_just_pressed(2, 199)) || is_control_just_pressed(2, func_332(227))) || is_control_just_pressed(2, func_334(1))) || is_control_just_pressed(2, func_332(224))) || is_control_just_pressed(2, func_334(0))) || is_control_just_pressed(2, func_332(222))) || is_control_just_pressed(2, func_332(232)))
					{
						play_sound_frontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
						func_89(uParam0.f_47, 0);
				...
				case 2:
					if ((((((((((is_control_just_pressed(2, func_334(1)) || is_control_just_pressed(2, func_334(0))) || is_control_just_pressed(2, func_332(233))) || is_control_just_pressed(2, func_332(226))) || is_control_just_pressed(2, 199)) || is_control_just_pressed(2, func_332(227))) || is_control_just_pressed(2, func_334(1))) || is_control_just_pressed(2, func_332(224))) || is_control_just_pressed(2, func_334(0))) || is_control_just_pressed(2, func_332(222))) || is_control_just_pressed(2, func_332(232)))
					{
						play_sound_frontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
						func_89(uParam0.f_47, 0);
...
void func_380()
{
	if (Global_1347898 >= 0 && Global_1347898 < _max_radio_station_index())
	{
		set_radio_to_station_index(Global_1347898);
	}
	else
	{
		set_radio_to_station_name("OFF");
...
void func_383(int iParam0)
{
	...
	iVar0 = _max_radio_station_index();
	Global_1347898 += iParam0;
...
bool func_387()
{
	if (Global_2359301.f_68.f_2 == 1)
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 2))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 3))
				{
					if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 4))
					{
						return true;
					}
				}
...
void func_390(auto uParam0)
{
	...
	if (*uParam0.f_47.f_1464 == 0 && func_669() != 2)
	{
		if (func_93(uParam0.f_1) != 3)
		{
			if (func_330(uParam0.f_47))
			{
				if (Global_1587523[player_id() /*444*/] == 3 || Global_1587523[player_id() /*444*/] == 0)
				{
					if (is_control_just_pressed(2, func_332(224)))
					{
						play_sound_frontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
...
bool func_391(auto uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 2))
	{
	}
...
{
	if (func_457(iParam0) >= *iParam0.f_1462)
	{
		if (*iParam0.f_1460 > 0)
		{
		...
		func_177(iParam0);
		func_456(iParam0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 5);
	}
	...
	if (func_93(uParam0.f_1) != 3)
	{
		if (*uParam0.f_47.f_1464 == 0)
		{
			if (func_93(uParam0.f_1) != 5 && func_93(uParam0.f_1) != 4)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 2))
				{
					if (!Global_1715399 && !is_cutscene_playing())
					{
						if (!is_warning_message_active())
						{
							if (is_control_just_pressed(2, func_334(0)))
			...
			if (func_330(uParam0.f_47))
			{
				if ((Global_2359298 && func_669() != 2) && !GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 13))
				{
					if ((((Global_1587523[player_id() /*444*/] == 3 || Global_1587523[player_id() /*444*/] == 0) || Global_1587523[player_id() /*444*/] == 1) || Global_1587523[player_id() /*444*/] == 8) || Global_1587523[player_id() /*444*/] == 2)
					{
						if (is_control_just_pressed(2, func_332(224)))
		...
		if (func_330(uParam0.f_47))
		{
			if (is_control_just_pressed(2, func_334(1)) || GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 9))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_336(uParam0.f_47)) && _network_get_ped_player(func_336(uParam0.f_47)) != func_46())
				{
					if ((((func_336(uParam0.f_47) != func_215() && func_669() != 2) && func_272(_network_get_ped_player(func_336(uParam0.f_47)))) && !func_208()) && func_335(_network_get_ped_player(func_336(uParam0.f_47))))
					{
						GAMEPLAY::CLEAR_BIT(uParam0.f_47, 9);
			...
			if (func_325(uParam0.f_47))
			{
				...
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 5);
					func_394(uParam0.f_47, -iVar7);
				}
				else if ((((func_669() != 2 && !func_268(player_id(), 13)) && !func_268(player_id(), 14)) && !func_268(player_id(), 15)) && !func_208())
				{
					if (is_control_just_pressed(2, func_332(229)) || is_control_pressed(2, 180))
					{
						...
						if (!_is_input_disabled(2))
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 9);
						}
						*uParam0.f_47.f_2171 = 1;
						func_394(uParam0.f_47, 1);
					}
					else if (is_control_just_pressed(2, func_332(228)) || is_control_pressed(2, 181))
					{
						play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 5);
...
int func_395(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	*uParam2 = 0;
	...
	if (iParam3)
	{
		if (((is_disabled_control_pressed(2, 190) || get_control_normal(2, 218) > 0.3f) || func_399(iParam7, 1, iParam8)) || (iParam4 && is_control_just_released(2, 201)))
		{
			*uParam2 = 1;
		...
		if ((is_disabled_control_pressed(2, 189) || func_399(iParam7, -1, iParam8)) || get_control_normal(2, 218) < -0.3f)
		{
			*uParam2 = 1;
			if (absi(get_time_difference(*uParam0, NETWORK::GET_NETWORK_TIME())) > iVar1)
			{
		...
		if (_is_input_disabled(2) && func_398())
		{
			if (absi(get_time_difference(*uParam0, NETWORK::GET_NETWORK_TIME())) > iVar1)
			{
	...
	{
		if (((is_disabled_control_pressed(2, 188) || get_control_normal(2, 219) < -0.3f) || is_disabled_control_pressed(2, 241)) || (iParam4 && is_control_just_released(2, 201)))
		{
			*uParam2 = 1;
		...
		if ((is_disabled_control_pressed(2, 187) || get_control_normal(2, 219) > 0.3f) || is_disabled_control_pressed(2, 242))
		{
			*uParam2 = 1;
...
bool func_396(int iParam0, int iParam1, int iParam2)
{
	...
	fVar3 = vVar0.x + func_397(fVar3);
	fVar4 = vVar0.x + func_397(fVar4);
	fVar5 = vVar0.x + func_397(fVar5);
	if (_0x13C4B962653A5280() == -1)
	{
		return false;
	}
	if (iParam0 != _0x13C4B962653A5280())
	{
		return false;
	}
	if (iParam1 == 0)
	...
	fVar6 = get_control_normal(2, 239);
...
bool func_399(int iParam0, int iParam1, int iParam2)
{
	if (_is_input_disabled(2))
	{
		if (is_warning_message_active() || _network_is_text_chat_active())
		{
			return false;
		}
		if (is_disabled_control_just_released(2, 237))
		{
...
void func_404(auto uParam0, int iParam1)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_93(uParam0.f_1) != 3 && (*uParam0.f_47.f_1462 > 0 || func_24(player_id(), 0)))
	{
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 6) || GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 5))
		{
			iVar0 = true;
			if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 6))
			{
				iVar0 = false;
			}
			if (iVar0 == 0)
			...
			if (!func_24(player_id(), 0) || Global_2359301.f_68 == Global_2359301.f_68.f_1)
			{
					...
					case 1:
						...
						if ((!func_24(player_id(), 0) || func_669() == 1) || func_669() == 2)
						{
							if (!iVar0)
							{
								...
								if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 17))
								{
									func_1(uParam0.f_47.f_2169);
									GAMEPLAY::CLEAR_BIT(uParam0.f_47, 17);
								}
								iVar5 = false;
								while (iVar5 < *uParam0.f_47.f_1462)
								{
									iVar20 = iVar5 + iVar21;
									vVar1 = {func_447(uParam0.f_47, iVar20)};
									iVar4 = 3;
									if (func_284(vVar1.x))
									{
										if (PED::IS_PED_INJURED(vVar1.x))
										{
										}
										iVar19 = -1;
										iVar18 = -1;
										...
										if (iVar4 == 3)
										{
											if ((is_ped_a_player(vVar1.x) && _network_get_ped_player(vVar1.x) != -1) && func_9(_network_get_ped_player(vVar1.x), 0, 1))
											{
												if (func_442())
												{
													iVar18 = get_player_team(_network_get_ped_player(vVar1.x));
													if (iVar18 != -1 && iVar18 != 8)
													{
														iVar4 = func_441(iVar18, _network_get_ped_player(vVar1.x), 0);
													}
													else
													{
														iVar4 = func_425(_network_get_ped_player(vVar1.x), -2, 0, 0);
													}
												}
												else
												{
										...
										if (is_ped_a_player(vVar1.x))
										{
											if (iVar24 == 0 && iVar0 == 0)
											{
												_push_scaleform_movie_function(*uParam0.f_47.f_1473, "START_NEW_ORDER");
												_pop_scaleform_movie_function_void();
												iVar24 = 1;
											}
											if (((((((!Global_1315837 && !func_267(player_id())) && !func_424(player_id())) && func_104(player_id()) != 3) && func_423()) && func_93(uParam0.f_1) != 5) && func_93(uParam0.f_1) != 4) && !func_268(player_id(), 122))
											{
												iVar18 = get_player_team(_network_get_ped_player(vVar1.x));
												if (iVar18 > -1)
												{
												...
												if (iVar19 == -1)
												{
													if (_network_get_ped_player(vVar1.x) > -1)
													{
														iVar19 = Global_2359301.f_9[_network_get_ped_player(vVar1.x)];
													}
												}
											}
											if (iVar19 != -1)
											{
												if (func_104(player_id()) == 1)
												{
													if (!Global_1573829)
													{
														iVar19++;
												...
												else if (func_104(player_id()) == 0)
												{
													if (!func_374(player_id()) && iVar18 == -1)
													{
														iVar19++;
													}
												}
											...
											{
												func_416(_network_get_ped_player(vVar1.x), &Var6);
											}
											iVar11 = func_410(_network_get_ped_player(vVar1.x));
											sVar10 = "";
											if (iVar11 != 0)
											{
												sVar10 = get_pedheadshot_txd_string(iVar11);
											}
											if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 17))
											{
												if (is_string_null_or_empty(sVar10))
												{
													GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 17);
												}
											}
											iVar25 = true;
											iVar26 = _network_get_ped_player(vVar1.x);
											if (iVar26 != -1)
											{
												if (!func_272(iVar26))
												{
											...
											if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 11) && iVar17)
											{
												func_456(uParam0.f_47, iVar5);
												GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 11);
											}
											iVar27 = is_entity_dead(vVar1.x, 0);
											if (func_9(_network_get_ped_player(vVar1.x), 0, 1))
											{
												func_409(*uParam0.f_47.f_1473, iVar0, iVar5, vVar1.y, iVar4, get_player_name(vVar1.z), &Var6, sVar10, iVar17, iVar19, iVar25, iVar27);
											}
										}
									}
									iVar5++;
								...
								if (iVar24 == 1 && iVar0 == 0)
								{
									_push_scaleform_movie_function(*uParam0.f_47.f_1473, "END_NEW_ORDER");
									_pop_scaleform_movie_function_void();
									iVar24 = 0;
								}
								...
								if (func_105(player_id()))
								{
									...
									while (iVar5 < *uParam0.f_47.f_1462)
									{
										...
										if (func_284(vVar1.x))
										{
											...
											if (is_ped_a_player(vVar1.x))
											{
												iVar28 = _network_get_ped_player(vVar1.x);
												if (iVar28 != -1)
												{
													iVar29 = get_player_team(_network_get_ped_player(vVar1.x));
													if (iVar29 != -1)
													{
														if (!is_string_null_or_empty(&(Global_1574247[iVar29 /*16*/])) && !are_strings_equal("NULL", &(Global_1574247[iVar29 /*16*/])))
														{
															if (has_this_additional_text_loaded("FMMC", 2))
															{
																if (Global_1617379.f_28009[iVar29] == 38 && !GAMEPLAY::IS_BIT_SET(Global_1574312, iVar29))
																{
																	iVar30 = 0;
																}
																else
																...
																_push_scaleform_movie_function(*uParam0.f_47.f_1473, "SET_ITEM_TEXT_RIGHT");
																_push_scaleform_movie_function_parameter_int(iVar20);
																if (iVar30 == 0 && does_text_label_exist(&(Global_1574247[iVar29 /*16*/])))
																{
								...
								if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 7))
								{
									if (func_104(player_id()) == 0)
									{
										if (is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
										{
				...
				GAMEPLAY::CLEAR_BIT(uParam0.f_47, 6);
				GAMEPLAY::CLEAR_BIT(uParam0.f_47, 5);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, true);
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 17))
		{
...
{
	_push_scaleform_movie_function(*uParam0, "SET_HIGHLIGHT");
	_push_scaleform_movie_function_parameter_int(iParam1);
	_pop_scaleform_movie_function_void();
}

void func_406(auto uParam0, char* sParam1)
{
	_push_scaleform_movie_function(*uParam0, "SET_DESCRIPTION");
	func_316("");
	func_316("");
	func_316("");
	func_316(sParam1);
...
void func_408(auto uParam0, int iParam1, int iParam2)
{
	if (_push_scaleform_movie_function(*uParam0, "COLLAPSE"))
	{
	...
	if (iParam2 == 1)
	{
		if (_push_scaleform_movie_function(*uParam0, "DISPLAY_VIEW"))
		{
			_pop_scaleform_movie_function_void();
		}
	}
...
void func_409(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	char* sVar0;
	...
	if (iParam8)
	{
		_push_scaleform_movie_function_parameter_int(66);
	}
	else if (iParam10)
	{
		_push_scaleform_movie_function_parameter_int(false);
	...
	{
		_push_scaleform_movie_function_parameter_int(118);
	}
	if (iParam11)
	{
		_push_scaleform_movie_function_parameter_int(116);
	}
	else
	{
	...
	{
		_push_scaleform_movie_function_parameter_string("char_default");
		_push_scaleform_movie_function_parameter_string("char_default");
	}
	else
	{
...
int func_421(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12)
{
...
int func_425(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_245(player_id()) || (func_440() && func_439()))
	{
		iVar0 = func_103();
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (is_ped_a_player(iVar0))
			{
				...
				{
					if (func_9(_network_get_ped_player(iVar0), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_426(iParam0, _network_get_ped_player(iVar0), iParam1, iParam2, iParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_426(iParam0, player_id(), iParam1, iParam2, iParam3);
		}
	}
	return func_426(iParam0, player_id(), iParam1, iParam2, iParam3);
}
...
int func_426(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_302(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_438(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_437(1);
			}
			...
			{
				return func_432(iParam1, 1, iVar0, iParam4);
			}
		}
...
int func_432(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_438(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_437(1);
...
int func_441(int iParam0, int iParam1, int iParam2)
{
	...
	{
		iVar0 = func_432(iParam1, !iParam2, iParam0, 0);
	}
	return iVar0;
}
...
{
	return func_432(player_id(), iParam0, iParam1, iParam2);
}

Vector3 func_447(auto uParam0, int iParam1)
{
	auto uVar0;
	auto uVar1;
	
	func_339(uParam0, &uVar0, &uVar1, iParam1);
	return *(uParam0.f_24[uVar0 /*97*/][uVar1 /*3*/]);
}

void func_448(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	...
	if (has_scaleform_movie_loaded(*uParam0))
	{
		_push_scaleform_movie_function(*uParam0, "SET_TITLE");
		if (iParam3)
		{
			func_407(sParam1);
		}
...
auto func_457(int iParam0)
{
	return *iParam0.f_1463;
}

bool func_458(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_177(uParam0.f_47);
	*uParam0.f_47.f_1472 = get_default_script_rendertarget_render_id();
	if (func_464())
	{
		func_21(1);
	}
	if (!func_24(player_id(), 0) && !func_440())
	{
		if (func_93(uParam0.f_1) != 3)
		{
			if (func_104(player_id()) == 0)
			{
				...
				if (iVar2 < 1)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 7);
					iVar2++;
			...
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 26))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 7);
				}
			}
...
int func_460(int iParam0, auto uParam1, int iParam2)
{
	if (iParam0)
	{
...
void func_466(auto uParam0)
{
	int iVar0;
	int iVar1;
	
	if (((func_93(uParam0.f_1) != 3 && GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 4)) && !is_cutscene_playing()) && !func_523())
	{
		func_468();
		switch (*uParam0.f_47.f_2183)
		{
			case 0:
				if (ENTITY::DOES_ENTITY_EXIST(func_103()))
				{
					...
					if (iVar0 != func_46())
					{
						if (!func_9(iVar0, 1, 0))
						{
							if (!is_screen_faded_out() && *uParam0.f_1.f_3 == 0)
							{
								func_59(1);
			...
			case 1:
				...
				iVar1 = _network_get_ped_player(func_103());
				if (iVar1 != func_46())
				{
					if ((func_9(iVar1, 1, 0) && is_screen_faded_in()) && *uParam0.f_1.f_36 == 3)
					{
						func_43();
						func_467();
						*uParam0.f_47.f_2183 = 0;
...
void func_467()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 17))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 17);
	}
}

void func_468()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, false))
	{
		if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166)) > 1000)
		{
			func_59(0);
			func_58(1);
			func_57(1);
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 4))
		{
			if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166.f_1)) > 750)
			{
				if (func_469())
				{
					if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_17, 4))
					{
						play_sound_frontend(-1, "Wasted", "POWER_PLAY_General_Soundset", 1);
					}
					else
					{
						play_sound_frontend(-1, "MP_Flash", "WastedSounds", 1);
					}
				}
				Global_2428492.f_2166.f_1 = NETWORK::GET_NETWORK_TIME();
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 4);
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, true))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 3))
		{
			if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166)) > 333)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 3);
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 4) && !GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 5))
	{
		if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166.f_1)) > 1000)
		{
			if (func_469())
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_1617379.f_17, 4))
				{
					play_sound_frontend(-1, "MP_Impact", "WastedSounds", 1);
				}
			}
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 5);
		}
	}
}
	...
	switch (*uParam0.f_1467)
	{
		...
		case 11:
			if ((func_461(uParam0) != 3 && !func_208()) && !Global_1715399)
			{
				...
				{
					if (has_scaleform_movie_loaded(*uParam0.f_1471))
					{
						set_text_render_id(*uParam0.f_1472);
						draw_scaleform_movie_fullscreen(*uParam0.f_1471, 255, 255, 255, false, 0);
						if (!is_radar_hidden())
						{
							display_radar(false);
						}
...
void func_471(auto uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 17))
	{
		*uParam0.f_47.f_1469 = 0;
		GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 17);
	}
	switch (*uParam0.f_47.f_1469)
	{
		case 0:
			...
			*uParam0.f_47.f_1470 = GAMEPLAY::GET_GAME_TIMER();
			*uParam0.f_47.f_1469++;
			break;
		...
		case 2:
			switch (*uParam0.f_47.f_1468)
			{
				...
				case 10:
					*uParam0.f_47.f_1471 = unk_0x67D02A194A2FC2BD("BREAKING_NEWS");
					if (has_scaleform_movie_loaded(*uParam0.f_47.f_1471))
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 18))
						{
							display_radar(false);
				...
				case 11:
					...
					{
						*uParam0.f_47.f_1471 = unk_0x67D02A194A2FC2BD("SOCIAL_CLUB_TV");
						if (has_scaleform_movie_loaded(*uParam0.f_47.f_1471))
						{
							func_507(uParam0, 1);
							func_487(uParam0, 0);
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_47.f_1470 > 200)
			{
				*uParam0.f_47.f_1469++;
			}
			break;
		...
		case 99:
			if (*uParam0.f_47.f_1467 == 10)
			{
				...
				hide_hud_component_this_frame(15);
				Global_2444574 = 1;
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 12))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 12);
				}
				if (func_485())
				{
					func_508(uParam0);
				...
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
					if (get_time_difference(NETWORK::GET_NETWORK_TIME(), *uParam0.f_47.f_1453) >= 5000)
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 18))
						{
							display_radar(false);
						...
						*uParam0.f_47.f_1454++;
						...
						_push_scaleform_movie_function(*uParam0.f_47.f_1471, "DISPLAY_SCROLL_TEXT");
						_push_scaleform_movie_function_parameter_float(0f);
						_push_scaleform_movie_function_parameter_float(*uParam0.f_47.f_1454);
						_pop_scaleform_movie_function_void();
						*uParam0.f_47.f_1453 = NETWORK::GET_NETWORK_TIME();
					}
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_2359301, 12))
			{
				GAMEPLAY::CLEAR_BIT(&Global_2359301, 12);
			}
			if (*uParam0.f_47.f_1467 == 11)
			{
				...
				else if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 6))
				{
					func_487(uParam0, 0);
					GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 6);
				}
...
{
	if ((!func_16() || !network_is_activity_session()) || !func_24(player_id(), 0))
	{
		return;
	}
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				_push_scaleform_movie_function(*uParam0.f_4, "SHOW_TICKER");
				_push_scaleform_movie_function_parameter_bool(true);
				_pop_scaleform_movie_function_void();
				func_483(uParam0, 0);
				func_480(uParam0);
		...
		case 2:
			if (!Global_1573691)
			{
				draw_scaleform_movie_fullscreen(*uParam0.f_4, 255, 255, 255, 255, 0);
			}
			hide_hud_component_this_frame(6);
			hide_hud_component_this_frame(7);
			hide_hud_component_this_frame(8);
...
{
	_push_scaleform_movie_function(*uParam0.f_4, "ADD_FEED_TEXT");
	_push_scaleform_movie_function_parameter_int(false);
	_begin_text_component(&(Global_1724230.f_5[0 /*53*/].f_8));
	switch (Global_1724230.f_5[0 /*53*/])
	{
		case 2:
		case 8:
			_add_text_component_item_string(&(Global_1724230.f_5[0 /*53*/].f_12));
			break;
		
		case 3:
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[0]);
			break;
		
		case 4:
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[0]);
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[1]);
			break;
		
		case 5:
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[0]);
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[1]);
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[2]);
			break;
		
		case 6:
			add_text_component_float(Global_1724230.f_5[0 /*53*/].f_7, Global_1724230.f_5[0 /*53*/].f_6);
			add_text_component_integer(Global_1724230.f_5[0 /*53*/].f_2[2]);
			break;
		...
		case 12:
			_add_text_component_item_string(&(Global_1724230.f_5[0 /*53*/].f_12));
			_add_text_component_item_string(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			break;
		...
		case 14:
		case 15:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_12));
			break;
		
		case 16:
		case 17:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_12));
			add_text_component_substring_time(Global_1724230.f_5[0 /*53*/].f_2[0], 7);
			break;
		
		case 18:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_12));
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			add_text_component_substring_time(Global_1724230.f_5[0 /*53*/].f_2[0], 7);
			break;
		...
		case 23:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_12));
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[1 /*6*/]));
			break;
		...
		case 24:
			...
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[1 /*6*/]));
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[2 /*6*/]));
			break;
		...
		case 26:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_12));
			_add_text_component_item_string(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			_add_text_component_item_string(&(Global_1724230.f_5[0 /*53*/].f_28[1 /*6*/]));
			break;
		...
		case 31:
			add_text_component_substring_player_name(&(Global_1724230.f_5[0 /*53*/].f_28[0 /*6*/]));
			_0x5F68520888E69014(&(Global_1724230.f_5[0 /*53*/].f_12));
			break;
...
bool func_476()
{
	if (Global_1617379 == 0)
	{
		if (Global_2418472[player_id() /*313*/].f_114 == 4 || (Global_2418472[player_id() /*313*/].f_114 != 6 && Global_2418472[player_id() /*313*/].f_114 != 5))
		{
			return true;
		}
	}
...
int func_477(auto uParam0)
{
	...
	if (absi(get_time_difference(*uParam0.f_3, NETWORK::GET_NETWORK_TIME())) > 500 || *uParam0.f_3 == 0)
	{
		*uParam0.f_3 = NETWORK::GET_NETWORK_TIME();
		iVar0 = 0;
		while (iVar0 <= 1)
		{
			...
			if (!are_strings_equal(uParam0.f_5[iVar0 /*8*/].f_2, &(Global_1724230.f_271[iVar0 /*8*/].f_2)))
			{
...
void func_479(auto uParam0, int iParam1)
{
	int iVar0;
	...
	while (iVar0 <= 1)
	{
		_push_scaleform_movie_function(*uParam0.f_4, "SET_PLAYER_SCORE");
		_push_scaleform_movie_function_parameter_int(iVar0 + 1);
		if (!is_string_null_or_empty(&(Global_1724230.f_271[iVar0 /*8*/].f_2)) && iParam1)
		{
			_push_scaleform_movie_function_parameter_bool(true);
			_begin_text_component("FMMC_NO");
			add_text_component_integer(Global_1724230.f_271[iVar0 /*8*/]);
			_end_text_component();
			_begin_text_component("STRING");
			add_text_component_substring_player_name(&(Global_1724230.f_271[iVar0 /*8*/].f_2));
			_end_text_component();
			if (Global_1617379 == 2 && !Global_1573853)
			{
				...
				{
					add_text_component_substring_time(Global_1724230.f_271[iVar0 /*8*/].f_1, 7);
				}
				_end_text_component();
			}
			else
			{
				_begin_text_component("FMMC_NO");
				add_text_component_integer(Global_1724230.f_271[iVar0 /*8*/].f_1);
				_end_text_component();
			}
		}
		else
		{
			_push_scaleform_movie_function_parameter_bool(false);
			_begin_text_component("FMMC_NO");
			add_text_component_integer(false);
			_end_text_component();
			_begin_text_component("STRING");
			add_text_component_substring_player_name("");
			_end_text_component();
...
void func_480(auto uParam0)
{
	_push_scaleform_movie_function(*uParam0.f_4, "SET_TITLE");
	_begin_text_component("STRING");
	_add_text_component_item_string(func_482());
	_end_text_component();
	_begin_text_component("STRING");
	_0x5F68520888E69014(&(Global_1617379.f_70372));
	_end_text_component();
	_begin_text_component("TMLR0");
	if (func_476())
	{
		if (is_string_null(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[0 /*16*/])))
		{
			StringCopy(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[0 /*16*/]), "", 64);
		}
		if (is_string_null(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[1 /*16*/])))
		{
			StringCopy(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[1 /*16*/]), "", 64);
		}
		_0x5F68520888E69014(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[0 /*16*/]));
		_0x5F68520888E69014(&(Global_1617379.f_80[Global_1724230.f_2 /*6968*/].f_6420[1 /*16*/]));
	}
	else
	{
		_0x5F68520888E69014(func_481(Global_1724230.f_1));
		_0x5F68520888E69014("");
	}
	_end_text_component();
	_pop_scaleform_movie_function_void();
...
char* func_481(int iParam0)
{
	if (Global_1617379 == 0)
	{
		if (Global_2418472[player_id() /*313*/].f_114 == 6)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 21))
			{
				return "SCTV_TS_CTFG";
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 23))
			{
				return "SCTV_TS_CTFR";
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 20))
			...
			else if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 22))
			{
				return "SCTV_TS_CTFH";
			}
		}
		else if (Global_2418472[player_id() /*313*/].f_114 == 5)
		{
			switch (iParam0)
			{
				case 2:
...
char* func_482()
{
	switch (Global_1617379)
	{
		case 0:
			...
			else if (Global_2418472[player_id() /*313*/].f_114 == 4)
			{
				return "SCTV_T_VS";
			}
			else if (Global_2418472[player_id() /*313*/].f_114 == 5)
...
void func_483(auto uParam0, int iParam1)
{
	_push_scaleform_movie_function(*uParam0.f_4, "SHOW_POSITIONS");
	_push_scaleform_movie_function_parameter_bool(iParam1);
	_pop_scaleform_movie_function_void();
}
...
int func_485()
{
	return GAMEPLAY::IS_BIT_SET(Global_2359301, 22);
}
...
void func_486(auto uParam0)
{
	...
	if (Global_2359301.f_68 == 1)
	{
		if (has_scaleform_movie_loaded(*uParam0.f_47.f_1471))
		{
			func_416(_network_get_ped_player(func_103()), &sVar0);
			_push_scaleform_movie_function(*uParam0.f_47.f_1471, "ADD_TICKER_TEXT");
			_push_scaleform_movie_function_parameter_int(false);
			func_316("SPEC_CRWT");
			_push_scaleform_movie_function_parameter_int(true);
			func_407(get_player_name(_network_get_ped_player(func_103())));
			_push_scaleform_movie_function_parameter_int(2);
			func_316(&sVar0);
			_pop_scaleform_movie_function_void();
		}
...
void func_487(auto uParam0, int iParam1)
{
	struct<4> Var0;
	int iVar4;
	...
	if (has_scaleform_movie_loaded(*uParam0.f_47.f_1471))
	{
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SHOW_TICKER");
		_push_scaleform_movie_function_parameter_bool(iParam1);
		_pop_scaleform_movie_function_void();
		iVar4 = _network_get_ped_player(func_103());
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SET_TICKER_TITLE");
		switch (Global_1587523[player_id() /*444*/])
		{
			case 1:
			case 2:
			case 3:
			...
			default:
				...
				{
					case 0:
						MemCopy(&Var0, {func_488(func_491())}, 4);
						func_407(&Var0);
						*uParam0.f_47.f_2165 = 8000;
						*uParam0.f_47.f_2162++;
						break;
...
struct<2> func_488(int iParam0)
{
	...
	if (iVar2 < 10)
	{
		StringIntConCat(&cVar0, 0, 8);
	}
	StringIntConCat(&cVar0, iVar2, 8);
...
void func_492(auto uParam0, int iParam1)
{
	if (iParam1 <= 0)
	{
		return;
...
void func_493(auto uParam0, int iParam1)
{
...
void func_494(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
auto func_496(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_497(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
int func_498(auto uParam0)
{
	return uParam0 & 15;
}

void func_499(auto uParam0, int iParam1)
{
...
void func_500(auto uParam0, int iParam1)
{
...
void func_501(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_502(auto uParam0)
{
	...
	get_street_name_at_coord(_get_gameplay_cam_coords(), &iVar0, &iVar1);
	if (iVar1 != 0)
	{
		_begin_text_component("STRTNM2");
		_0x17299B63C7683A2B(iVar0);
		_0x17299B63C7683A2B(iVar1);
		_end_text_component();
	}
	else if (iVar0 != 0)
	{
		_begin_text_component("STRTNM1");
		_0x17299B63C7683A2B(iVar0);
		_end_text_component();
	}
	else
	{
		func_316(_format_time(NETWORK::GET_NETWORK_TIME()));
	}
	*uParam0.f_47.f_2165 = 8000;
	*uParam0.f_47.f_2162++;
}
...
void func_507(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	if (has_scaleform_movie_loaded(*uParam0.f_47.f_1471))
	{
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SHOW_LIVE_PANEL");
		_push_scaleform_movie_function_parameter_bool(iParam1);
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SET_LIVE_PANEL");
		func_316("SPEC_LIVE");
		if (Global_2359301.f_68 == 1)
		{
			if (is_ped_a_player(func_103()))
			{
				...
				if (func_9(iVar0, 0, 0))
				{
					...
					if (iVar1 != 0)
					{
						sVar2 = get_pedheadshot_txd_string(iVar1);
					}
					func_416(iVar0, &sVar3);
					func_316("SPEC_CRWT");
					func_407(get_player_name(iVar0));
					func_407(&sVar3);
					_push_scaleform_movie_function_parameter_string(sVar2);
					_push_scaleform_movie_function_parameter_string(sVar2);
				}
			}
		}
...
void func_508(auto uParam0)
{
	...
	iVar56 = _network_get_ped_player(func_103());
	_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SET_TEXT");
	switch (Global_1587523[player_id() /*444*/])
	{
		case 1:
		case 2:
		...
		case 0:
		case 8:
			func_316(func_513(Global_1587523[player_id() /*444*/]));
			func_407(&(Global_1617379.f_70372));
			break;
	...
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_47.f_1471, "CLEAR_SCROLL_TEXT");
	_push_scaleform_movie_function_parameter_int(false);
	_pop_scaleform_movie_function_void();
	if (network_is_player_active(iVar56))
	{
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SET_SCROLL_TEXT");
		_push_scaleform_movie_function_parameter_float(0f);
		_push_scaleform_movie_function_parameter_float(0f);
		func_512("MPTV_TICK0", get_player_name(iVar56));
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(*uParam0.f_47.f_1471, "SET_SCROLL_TEXT");
		_push_scaleform_movie_function_parameter_float(0f);
		_push_scaleform_movie_function_parameter_float(1f);
		Var0 = {func_385(_network_get_ped_player(func_103()))};
		if (func_420(&Var0))
		{
			Var13 = {func_418(_network_get_ped_player(func_103()))};
...
void func_509()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 22))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 22);
	}
}

void func_510(char* sParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16)
{
	_begin_text_component(sParam0);
...
struct<16> func_511(auto uParam0, auto uParam1)
{
	char[64] cVar0;
	
	if ((is_player_online() && _network_player_is_in_clan()) && network_clan_player_is_active(uParam0))
	{
		return *uParam1.f_1;
	}
	StringCopy(&cVar0, "CLAN_TT", 64);
	return cVar0;
}
...
void func_515(char* sParam0, char* sParam1)
{
	...
	iVar1 = get_random_int_in_range(false, 16);
	if (iVar0 == iVar1)
	{
		if (iVar0 > 8)
		{
...
void func_518(auto uParam0)
{
	if (*uParam0.f_1455 == -1)
	{
		*uParam0.f_1455 = get_sound_id();
		play_sound_frontend(*uParam0.f_1455, "Change_Cam", "MP_CCTV_SOUNDSET", 1);
	}
}
...
void func_520()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 31) && !is_screen_faded_out())
	{
		if (func_3(&(Global_2359301.f_5), 2500, 0))
		{
			func_521();
			func_1(&(Global_2359301.f_5));
			GAMEPLAY::CLEAR_BIT(&Global_2359301, 31);
		}
	}
}
...
void func_521()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 21))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 21);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 31);
		func_1(&(Global_2359301.f_5));
	}
}
...
int func_522()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_27.f_3, 9);
}

int func_523()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_27.f_3, false);
}
...
void func_524()
{
	...
	func_558(1);
	func_557(1);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !network_is_activity_session())
	{
		if (network_is_in_tutorial_session())
		{
			network_bail_transition(44, 0, 0);
		}
	}
	func_529(1, 1);
	func_528();
...
void func_528()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1312423, false);
}
...
void func_529(int iParam0, int iParam1)
{
	...
	func_534();
	func_532();
	GAMEPLAY::CLEAR_BIT(&(Global_2434762.f_2), 7);
	func_531();
...
void func_533(int iParam0)
{
	...
	_0xF314CF4F0211894E(Global_2454571[iParam0 /*5*/], Global_2454571[iParam0 /*5*/].f_1, Global_2454571[iParam0 /*5*/].f_2, Global_2454571[iParam0 /*5*/].f_3, Global_2454571[iParam0 /*5*/].f_4);
...
void func_550(int iParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			_0xC5BE134EC7BA96A0(Global_2435528.f_3283, Global_2435528.f_3283.f_1, Global_2435528.f_3283.f_2, Global_2435528.f_3283.f_3, iParam0);
		}
	}
	func_551();
}
...
void func_553(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0)
	{
		...
		if (player_id() != -1)
		{
			Global_1609227[player_id() /*34*/].f_2 = 0;
			Global_1609227[player_id() /*34*/] = 0;
		}
	}
}
...
void func_559()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 31))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 31);
		func_1(&(Global_2359301.f_5));
	}
}

void func_560(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_24(player_id(), 0) || (func_226(uParam0.f_1) && func_562(uParam0.f_1)))
	{
		...
		if (func_273(uParam0) && func_265(uParam0, &iVar0, &iVar1, 0, 0, 0))
		{
			...
			func_262(uParam0.f_1, _get_gameplay_cam_coords(), _get_gameplay_cam_rot(2), _0x80EC114669DAEFF4(), 1);
...
int func_562(auto uParam0)
{
	return GAMEPLAY::IS_BIT_SET(*uParam0, 5);
}
...
void func_563()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 21))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 21);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 31);
		func_1(&(Global_2359301.f_5));
	}
}
...
int func_564()
{
	return GAMEPLAY::IS_BIT_SET(Global_2359301, 21);
}
...
bool func_566(auto uParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 11))
	{
		if (is_screen_faded_in() || is_screen_fading_in())
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 11);
		}
		else if (!func_100())
		{
			do_screen_fade_in(250);
	...
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 11);
		return true;
	}
	return false;
}

void func_567(auto uParam0)
{
	if (func_80() != PLAYER::PLAYER_PED_ID())
	{
		func_282(uParam0, PLAYER::PLAYER_PED_ID());
		*uParam0.f_1.f_34 = 1;
	}
...
bool func_568(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (((func_80() != -1 && ENTITY::DOES_ENTITY_EXIST(func_80())) && (!iParam1 || func_283(uParam0, func_80(), 1))) && !func_231(_network_get_ped_player(func_80())))
	{
		iVar1 = func_80();
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (*uParam0.f_1.f_34)
		{
			switch (func_72(uParam0.f_1))
			{
				case 0:
					*uParam0.f_1.f_6 = 0;
					...
					else if (ENTITY::DOES_ENTITY_EXIST(iVar1))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(func_103()) && func_103() != iVar1)
						{
							vVar4 = {get_entity_coords(func_103(), 0)};
						}
						else
						{
							vVar4 = {_get_gameplay_cam_coords()};
						}
						fVar3 = vdist2(vVar4, get_entity_coords(iVar1, 0));
						if ((func_24(player_id(), 0) && is_player_switch_in_progress()) && func_588(_network_get_ped_player(func_215()), 0))
						{
							*uParam0.f_1.f_5 = 0;
							*uParam0.f_1.f_6 = 1;
						}
				...
				case 1:
					hide_hud_and_radar_this_frame();
					if ((!is_screen_faded_out() && Global_2435528.f_2842.f_84 == 0) && *uParam0.f_1.f_5 > 0)
					{
						if (!is_screen_fading_out())
						{
							func_586(uParam0);
							if ((!func_100() && !GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, 4)) && !func_288())
							{
								if (_0xEB3DAC2C86001E5E() == 1)
								{
									do_screen_fade_out(250);
								}
								else
				...
				case 2:
					...
					if (!func_24(player_id(), 0) || !func_588(_network_get_ped_player(func_215()), 0))
					{
						if (!func_231(_network_get_ped_player(func_215())))
						{
							func_193(1, 1);
						}
					}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar1))
					{
						...
						{
							if (does_cam_exist(Global_2435528.f_2842.f_19))
							{
								if (iVar1 == PLAYER::PLAYER_PED_ID())
								{
									GAMEPLAY::CLEAR_BIT(&Global_2359301, 10);
								...
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 10);
									if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 18) && func_93(uParam0.f_1) != 3)
									{
										display_radar(true);
									}
								}
						...
						if ((*uParam0.f_1.f_5 > 0 || *uParam0.f_1.f_6) && !is_player_switch_in_progress())
						{
							if (*uParam0.f_1.f_44 < 5 && !is_entity_focus(PLAYER::PLAYER_PED_ID()))
							{
								*uParam0.f_1.f_44++;
								return false;
							}
							*uParam0.f_1.f_44 = 0;
							...
							{
								*uParam0.f_1.f_30 = {get_cam_coord(*uParam0.f_1.f_39)};
							}
							else
							{
								*uParam0.f_1.f_30 = {get_entity_coords(iVar1, 0)};
							}
							if (Global_2359299)
							{
								vVar7 = {*uParam0.f_1.f_30};
								if (((func_93(uParam0.f_1) != 5 && func_93(uParam0.f_1) != 3) && func_93(uParam0.f_1) != 4) && !GAMEPLAY::IS_BIT_SET(Global_2359301, 16))
								{
									if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
									{
										if (is_entity_visible(PLAYER::PLAYER_PED_ID()))
									...
									set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar7, 0, true, 0, 0);
									set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
									if (func_9(player_id(), 1, 1))
									{
										set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
							...
							if (func_587(uParam0.f_1))
							{
								_set_focus_area(*uParam0.f_1.f_30, 0f, 0f, 0f);
							}
							else
							{
								set_focus_entity(iVar1);
							}
							if (!network_is_in_spectator_mode())
							{
								_new_load_scene_start_safe(*uParam0.f_1.f_30, 50f, 0);
							}
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 10);
						}
						else
						{
				...
				case 3:
					...
					if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 10))
					{
						if (is_new_load_scene_active() && is_new_load_scene_loaded())
						{
							...
							{
								if (_0x690A61A6D13583F6(_network_get_ped_player(iVar1)))
								{
									iVar0 = false;
								}
							}
						...
						else if (!func_587(uParam0.f_1))
						{
							...
							if (vdist2(*uParam0.f_1.f_30, get_entity_coords(iVar1, 0)) > 2500f)
							{
								new_load_scene_stop();
								GAMEPLAY::CLEAR_BIT(uParam0.f_1, 10);
								iVar0 = true;
							}
							if (get_entity_speed(iVar1) > 2f)
							{
								new_load_scene_stop();
								GAMEPLAY::CLEAR_BIT(uParam0.f_1, 10);
								iVar0 = false;
					...
					if (!iVar0)
					{
						if (get_time_difference(NETWORK::GET_NETWORK_TIME(), *uParam0.f_1.f_24) > *uParam0.f_1.f_5)
						{
							iVar0 = true;
						}
					}
					...
					if (iVar0)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iVar1))
						{
							if (!PED::IS_PED_INJURED(iVar1))
							{
								if (is_screen_faded_out())
								{
									set_ped_lod_multiplier(iVar1, 2.5f);
								}
							}
						}
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 12))
						{
							if (((*uParam0.f_1.f_35 != 3 && *uParam0.f_1.f_35 != 5) && *uParam0.f_1.f_35 != 4) && !func_24(player_id(), 0))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 14);
							}
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 12);
						}
						new_load_scene_stop();
						_0x22A249A53034450A(0);
						func_1(uParam0.f_2243);
				...
				case 4:
					...
					if (iParam2 && PED::IS_PED_INJURED(iVar1))
					{
					...
					else if (!is_screen_faded_in())
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 15))
						{
							...
							{
								if (!func_100() && !func_570(_network_get_ped_player(iVar1), 0))
								{
									if (func_81() || func_571())
									{
										do_screen_fade_in(250);
									...
									{
										GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 15);
									}
									func_1(uParam0.f_47.f_2172);
									_0x10D373323E5B9C0D();
									_set_control_normal(0, 98, 1f);
								}
								else
								{
									func_71(uParam0.f_1, 5);
	...
	{
		*uParam0.f_1.f_4 = 1;
		GAMEPLAY::CLEAR_BIT(uParam0.f_47, 2);
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 10);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, 6);
		func_569();
		func_281(uParam0, func_80());
		if (is_ped_a_player(func_80()))
		{
			*uParam0.f_1.f_42 = _network_get_ped_player(func_80());
		}
		else
		{
			*uParam0.f_1.f_42 = -1;
...
void func_569()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 22))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 22);
	}
}
...
bool func_570(int iParam0, int iParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, true) && !Global_1587523[iVar0 /*444*/].f_360)
	{
		if (iParam1)
		{
		}
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, 3))
	{
		if (iParam1)
		{
		}
...
bool func_571()
{
	if (func_24(player_id(), 0))
	{
		if ((Global_1315839 == 1 || Global_1573850 == 1) || func_248(player_id()))
		{
			return true;
		}
	}
...
int func_574(auto uParam0)
{
	return GAMEPLAY::IS_BIT_SET(Global_1609227[uParam0 /*34*/].f_27, false);
}

void func_575(auto uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, true))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 5))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2359301, 5);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_2359301, 5))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 5);
	}
}
...
void func_577(auto uParam0)
{
	...
	if (func_24(player_id(), 0))
	{
		request_streamed_texture_dict("GTAOlogo", false);
		if (has_streamed_texture_dict_loaded("GTAOlogo"))
		{
			if (!is_screen_faded_in() && !is_screen_fading_in())
			{
				...
				_0xF5A2C681787E579D(-0.0755f, -0.0755f, 0f, 0f);
				hide_hud_and_radar_this_frame();
				Var0 = *uParam0.f_47.f_2174;
				...
				func_580(&Var0);
				_set_2d_layer(7);
				draw_sprite("GTAOlogo", "GTAOTransitionLogo", func_579(Var0), func_578(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, 0);
				_set_2d_layer(4);
				_0xE3A3DB414A373DAB();
			}
		}
...
void func_581(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 6))
	{
		if (iParam1 == 1)
		{
			...
			{
				iVar0 = 3;
				if (_0xEE778F8C7E1142E2(iVar1) != iVar0)
				{
					*uParam0[iVar1] = _0xEE778F8C7E1142E2(iVar1);
					_0x2A2173E46DAECD12(iVar1, iVar0);
				}
				iVar1++;
			}
		}
...
void func_584(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (is_ped_in_any_vehicle(Global_2410688.f_2, 0) && ENTITY::DOES_ENTITY_EXIST(get_vehicle_ped_is_in(Global_2410688.f_2, 1)))
			{
				if (is_vehicle_driveable(get_vehicle_ped_is_in(Global_2410688.f_2, 1), 0))
				{
				}
				set_gameplay_entity_hint(get_vehicle_ped_is_in(Global_2410688.f_2, 1), 0f, 0f, 0f, 1, -1, 3000, 2000, 1844968929);
			}
			else
			{
				set_gameplay_entity_hint(Global_2410688.f_2, 0f, 0f, 0f, 1, -1, 3000, 2000, 1844968929);
			}
			break;
...
void func_585(int iParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, 2))
	{
		...
		else
		{
			...
			while (iVar0 < 7)
			{
				_0x2A2173E46DAECD12(iVar0, Global_2359301.f_58[iVar0]);
				iVar0++;
			}
			GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_66), 2);
		}
	}
}
...
int func_587(auto uParam0)
{
	return does_cam_exist(*uParam0.f_39);
}
...
bool func_588(int iParam0, int iParam1)
{
	...
	{
		iVar0 = iParam0;
		if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, 5))
		{
			if (iParam1)
			{
			}
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, 6))
		{
			if (iParam1)
			{
			}
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, 7))
		{
			if (is_player_switch_in_progress())
			{
				if (iParam1)
...
void func_589(auto uParam0)
{
	int iVar0;
	
	if (func_226(uParam0.f_1) && func_9(player_id(), 0, 0))
	{
		if (!func_154())
		{
			if (*uParam0.f_1.f_4)
			{
				if (func_24(player_id(), 0))
				{
					if (GAMEPLAY::IS_BIT_SET(Global_2359301, 28))
					{
						hide_hud_and_radar_this_frame();
						hide_hud_component_this_frame(1);
						hide_hud_component_this_frame(5);
				...
				enable_control_action(0, 199, 1);
				enable_control_action(2, 199, 1);
				_0xCC3FDDED67BCFC63();
				func_575(uParam0);
				if (func_598(uParam0))
				{
					if (get_player_ped(int_to_playerindex(*uParam0.f_1.f_42)) != func_103())
					{
						func_281(uParam0, get_player_ped(int_to_playerindex(*uParam0.f_1.f_42)));
						func_282(uParam0, get_player_ped(int_to_playerindex(*uParam0.f_1.f_42)));
				...
				if (func_284(func_80()))
				{
					if (func_80() != PLAYER::PLAYER_PED_ID())
					{
						if (is_ped_a_player(func_80()))
						{
							...
							iVar0 = get_player_wanted_level(_network_get_ped_player(func_80()));
							if (_0x56105E599CAB0EFA(_network_get_ped_player(func_80())) > iVar0)
							{
								iVar0 = _0x56105E599CAB0EFA(_network_get_ped_player(func_80()));
							}
							...
							if (func_9(_network_get_ped_player(func_80()), 1, 1))
							{
								if (are_player_stars_greyed_out(_network_get_ped_player(func_80())) != *uParam0.f_47.f_1466)
								{
									*uParam0.f_47.f_1466 = are_player_stars_greyed_out(_network_get_ped_player(func_80()));
									flash_wanted_display(*uParam0.f_47.f_1466);
								}
							}
							if ((*uParam0.f_1.f_35 == 3 || *uParam0.f_1.f_35 == 5) || *uParam0.f_1.f_35 == 4)
							{
								if (network_is_player_active(_network_get_ped_player(func_80())))
								{
									if (func_243(_network_get_ped_player(func_80())))
									{
										func_521();
					...
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, false))
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 3))
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_47, false);
							func_285(uParam0);
						}
					}
...
void func_592(auto uParam0)
{
	*uParam0.f_47.f_1467 = 0;
	...
	else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, false))
	{
		func_285(uParam0);
		func_71(uParam0.f_1, 0);
		*uParam0.f_1.f_34 = 1;
...
bool func_593()
{
	if (((network_is_activity_session() && player_id() != -1) && func_10(player_id())) && Global_1587523[player_id() /*444*/] == -1)
	{
		return true;
	}
	return false;
...
void func_594(auto uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 11))
	{
		if ((func_588(Global_1587523[player_id() /*444*/].f_355, 0) && !func_245(Global_1587523[player_id() /*444*/].f_355)) && !func_248(Global_1587523[player_id() /*444*/].f_355))
		{
			if (Global_1617379 == 2 || Global_1617379 == 8)
			{
				if (Global_1587523[player_id() /*444*/].f_355 == _network_get_ped_player(func_80()))
				{
					iVar0 = true;
				}
			}
		...
		if (func_588(_network_get_ped_player(func_80()), 0))
		{
			iVar0 = true;
		}
	}
	else if (func_588(_network_get_ped_player(func_80()), 0))
	{
		iVar0 = true;
	}
	if (iVar0 == 1)
	...
	else
	{
		...
		switch (func_101())
		{
			...
			case 2:
				if (get_time_difference(NETWORK::GET_NETWORK_TIME(), *uParam0.f_1.f_28) > 8000)
				{
					func_68(3);
				}
				break;
...
void func_595()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2359301, 24))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 24);
	}
}

void func_596(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	iVar0 = _network_get_ped_player(func_80());
	iVar1 = false;
	iVar2 = false;
	if (iVar0 > -1)
	{
		if ((func_83(_network_get_ped_player(func_80()), 1, 0) || Global_1587523[iVar0 /*444*/].f_356) || GAMEPLAY::IS_BIT_SET(Global_1587523[iVar0 /*444*/].f_250.f_7, 2))
		{
			iVar1 = true;
		}
	}
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 25))
	{
		iVar2 = true;
	}
	...
	if (func_213(_network_get_ped_player(func_80())) || Global_1715399 == 1)
	{
		iVar2 = true;
	}
	if (func_24(player_id(), 0))
	...
	if (!iVar2)
	{
		if (func_570(_network_get_ped_player(func_80()), 0) && !iVar1)
		{
			if ((!is_screen_faded_out() && !is_screen_fading_out()) && !is_screen_fading_in())
			{
				if (!func_100())
		...
		else if (GAMEPLAY::IS_BIT_SET(Global_2418472[iVar0 /*313*/].f_194, false) && !iVar1)
		{
			if ((!is_screen_faded_out() && !is_screen_fading_out()) && !is_screen_fading_in())
			{
				if (!func_100())
		...
		else if (!func_570(_network_get_ped_player(func_80()), 0) || func_80() == 0)
		{
			if ((is_screen_faded_out() && !is_screen_fading_in()) && !is_screen_fading_out())
			{
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 16))
				{
					if (!func_100())
					{
						do_screen_fade_in(500);
...
int func_597()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 6);
}

bool func_598(auto uParam0)
{
	if (*uParam0.f_1.f_42 != -1)
	{
		if (network_is_player_active(int_to_playerindex(*uParam0.f_1.f_42)))
		{
...
int func_600(int iParam0)
{
	...
	iVar0 = iParam0 / 32;
	iVar1 = iParam0 % 32;
	return GAMEPLAY::IS_BIT_SET(Global_1312764[iVar0], iVar1);
}

void func_601(auto uParam0)
{
	struct<14> Var0;
	...
	if (!func_24(player_id(), 0))
	{
		...
		{
			_0x6A5D89D7769A40D8(1);
		}
	}
	func_581(uParam0.f_1.f_7, 0);
	func_604();
	if ((((!func_24(player_id(), 0) && *uParam0.f_1.f_35 != 3) && *uParam0.f_1.f_35 != 5) && *uParam0.f_1.f_35 != 4) && (!func_105(player_id()) || func_246(player_id())))
	{
		if ((func_104(player_id()) != 3 || is_player_dead(player_id())) || func_246(player_id()))
		{
			Var0.f_2 = 157;
	...
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 14);
	GAMEPLAY::CLEAR_BIT(uParam0.f_1, 7);
	GAMEPLAY::CLEAR_BIT(&Global_2359301, 13);
	func_73();
	if (func_602())
	{
		if (func_24(player_id(), 0))
		{
			_0xF46A1E03E8755980(1);
			network_set_talker_proximity(0f);
		}
	}
	else if (!func_105(player_id()) || func_24(player_id(), 0))
	{
		_0xF46A1E03E8755980(1);
		network_set_talker_proximity(0f);
	}
	Global_1573484 = 1;
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_60())
	{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, true);
}
...
void func_605(auto uParam0)
{
	...
	*uParam0.f_1.f_34 = 1;
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, false))
	{
		func_282(uParam0, PLAYER::PLAYER_PED_ID());
		func_281(uParam0, PLAYER::PLAYER_PED_ID());
	}
	else
	{
		iVar0 = func_80();
	...
	set_pad_shake(0, false, false);
	network_set_override_spectator_mode(true);
	GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, false);
}

void func_606(auto uParam0)
{
	if (func_226(uParam0.f_1))
	{
...
void func_609(auto uParam0)
{
	...
	if (func_587(uParam0.f_1) && get_rendering_cam() == *uParam0.f_1.f_39)
	{
		_0x271401846BD26E92(1, 1);
		set_scripted_conversion_coord_this_frame(_get_gameplay_cam_coords());
		if ((!is_player_switch_in_progress() && !is_new_load_scene_active()) && !is_player_teleport_active())
		{
			vVar2 = {get_cam_coord(*uParam0.f_1.f_39)};
			if (func_255())
			{
				vVar2 = {func_254()};
			}
			if (!func_77(vVar2))
			{
				_set_focus_area(vVar2, 0f, 0f, 0f);
			}
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (is_ped_a_player(iVar0))
		{
			iVar5 = _network_get_ped_player(iVar0);
					...
					if (!is_player_switch_in_progress())
					{
						if (!iVar9)
						{
							if (Global_2418472[iVar6 /*313*/].f_232 != -1)
							{
								if (func_241(Global_2418472[iVar6 /*313*/].f_232) != 3)
								{
									...
									if (!func_587(uParam0.f_1))
									{
										if (func_621(Global_2418472[iVar6 /*313*/].f_232, &vVar10, &vVar13, &fVar23))
										{
											*uParam0.f_1.f_41 = 1;
											func_620(uParam0, fVar1, vVar10, vVar13, fVar23, 1, 0);
										}
									}
								}
							}
						...
						if (!iVar9)
						{
							if (func_616(iVar5))
							{
								...
								if (!func_587(uParam0.f_1))
								{
									vVar10 = {_get_gameplay_cam_coords()};
									vVar13 = {_get_gameplay_cam_rot(2)};
									fVar23 = _0x80EC114669DAEFF4();
									*uParam0.f_1.f_41 = 7;
									func_620(uParam0, fVar1, vVar10, vVar13, fVar23, 1, 0);
								}
							}
						...
						if (!iVar9)
						{
							if (Global_1587523[iVar6 /*444*/].f_361 == 1)
							{
								...
								if (!func_587(uParam0.f_1))
								{
									func_615(&uVar16, &uVar19, &vVar10, &vVar13, &uVar22, Global_1617379.f_83464, 1);
									*uParam0.f_1.f_41 = 8;
									func_620(uParam0, fVar1, vVar10, vVar13, 40f, 1, 0);
								}
							}
						}
						if (!iVar9)
						{
							if (((Global_1587523[iVar6 /*444*/].f_362 == 1 || Global_1587523[iVar6 /*444*/].f_363 == 1) || _0x1AD5B71586B94820(iVar5, "AM_ROLLERCOASTER", -1)) || _0x1AD5B71586B94820(iVar5, "AM_FERRISWHEEL", -1))
							{
								iVar9 = true;
								func_618(uParam0);
								if (!func_587(uParam0.f_1))
						...
						if (!iVar9)
						{
							if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 5))
							{
								iVar9 = true;
								if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 16))
								{
						...
						if (!iVar9)
						{
								...
								if ((func_243(iVar5) && func_573(iVar5) < 37) && !func_83(iVar5, 1, 0))
								{
									if ((func_115(uParam0.f_1) == 3 && func_613(iVar5)) && Global_1617379.f_71008)
									{
										...
										else
										{
											...
											{
												vVar10 = {Global_1617379.f_64};
												vVar13 = {Global_1617379.f_67};
											}
											func_128(0);
											*uParam0.f_1.f_41 = 11;
											func_620(uParam0, fVar1, vVar10, vVar13, fVar23, 1, 0);
									...
									else if (Global_2418472[iVar6 /*313*/].f_195.f_2 > 0f)
									{
										...
										if (func_77(vVar10))
										{
											vVar10 = {Global_2418472[iVar6 /*313*/].f_195};
											vVar10.x += 0f;
											vVar10.y += -2.3332f;
											vVar10.z += 3.2914f;
											vVar13 = {-40.6168f, 0f, 0f};
											fVar23 = 40.3433f;
										}
										*uParam0.f_1.f_41 = 12;
										func_620(uParam0, fVar1, vVar10, vVar13, fVar23, 1, 0);
							...
							else if (func_256(iVar5, 0))
							{
								...
								if (!func_587(uParam0.f_1))
								{
									if (func_612(func_223(iVar5), &vVar10, &vVar13, &fVar23))
									{
										*uParam0.f_1.f_41 = 13;
										func_620(uParam0, fVar1, vVar10, vVar13, fVar23, 1, 0);
									}
...
int func_610()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 8);
}

bool func_611(auto uParam0, int iParam1)
{
	if (network_is_player_active(iParam1))
	{
		if (iParam1 > -1)
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_1587523[iParam1 /*444*/].f_250.f_7, 2))
			{
				if (!_0x919B3C98ED8292F9(iParam1))
				{
					if (!GAMEPLAY::IS_BIT_SET(Global_2418472[iParam1 /*313*/].f_194, 4))
					{
						if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 16))
						{
							if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 17))
							{
								if (GAMEPLAY::GET_GAME_TIMER() > *uParam0.f_1.f_40)
								{
									return true;
								}
							}
							...
							{
								*uParam0.f_1.f_40 = GAMEPLAY::GET_GAME_TIMER() + 3000;
								GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 17);
							}
						}
						else
						{
...
bool func_612(Vector3 vParam0, auto uParam1, auto uParam2, Vector3 fParam3)
{
	*fParam5 = 0f;
	if (vdist2(vParam0, 368.8175f, -702.3699f, 16.7201f) < 10000f)
	{
		*uParam3 = {411.5287f, -690.7221f, 34.686f};
		*uParam4 = {-7.6054f, 0.0001f, 153.5167f};
		*fParam5 = 36.7018f;
	}
	if (*fParam5 == 0f && vdist2(vParam0, 310.2254f, 278.9754f, 90.1912f) < 10000f)
	{
		*uParam3 = {278.9962f, 170.2905f, 107.3217f};
		*uParam4 = {5.8711f, 0f, -38.8062f};
		*fParam5 = 35.6667f;
	}
	if (*fParam5 == 0f && vdist2(vParam0, -1436.233f, -229.583f, 22.9699f) < 10000f)
	{
...
void func_615(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	if (iParam5 == 0)
	{
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 30);
}

void func_617(Vector3 vParam0)
{
	if (func_143())
	{
		Global_2359301.f_81 = {vParam0};
		_set_focus_area(vParam0, 0f, 0f, 0f);
		Global_2359299 = 1;
	}
}

void func_618(auto uParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 16))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 16);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 17))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 17);
...
void func_620(auto uParam0, float fParam1, Vector3 vParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6)
{
	if (iParam10 == 0)
	{
		if (func_81())
	...
	if (!does_cam_exist(*uParam0.f_1.f_39))
	{
		*uParam0.f_1.f_39 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
		set_cam_coord(*uParam0.f_1.f_39, vParam2);
		set_cam_rot(*uParam0.f_1.f_39, vParam5, 2);
		set_cam_fov(*uParam0.f_1.f_39, fParam8);
		set_cam_active(*uParam0.f_1.f_39, true);
		shake_cam(*uParam0.f_1.f_39, "HAND_SHAKE", fParam1);
		render_script_cams(true, false, 3000, 1, 0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, 15);
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 18))
		{
			display_radar(!iParam9);
		}
		if (func_255())
		{
			vParam2 = {func_254()};
		...
		if (!func_77(vParam2))
		{
			if (!is_player_switch_in_progress() && !is_new_load_scene_active())
			{
				_set_focus_area(vParam2, 0f, 0f, 0f);
			}
		}
		_0xFC18DB55AE19E046(1);
		func_22(0, 0, 1);
...
bool func_621(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	*uParam3 = 0f;
	switch (iParam0)
	{
...
void func_623(int iParam0, int iParam1)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(*iParam0, 9))
	{
		if (GAMEPLAY::IS_BIT_SET(*iParam0, 3))
		{
			...
			{
				if (func_624(*iParam0.f_13, 0f, 0, 0, 0, 0, 1, 0, 1, 0))
				{
					*iParam0.f_13 = {0f, 0f, 0f};
					iVar0 = true;
				}
			...
			if (iVar0)
			{
				if (!GAMEPLAY::IS_BIT_SET(*iParam0.f_2, true) || iParam1)
				{
					set_entity_visible(PLAYER::PLAYER_PED_ID(), true, 0);
					set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
					freeze_entity_position(PLAYER::PLAYER_PED_ID(), false);
...
bool func_624(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	if (!func_149())
	{
		if (func_627(player_id(), 1))
		{
			if (((iParam9 && func_9(player_id(), 1, 0)) && is_player_switch_in_progress()) && Global_2418472[player_id() /*313*/].f_220 == 1)
			{
			}
			else
			{
	...
	if (((!vParam0.x == Global_2428492.f_726 || !vParam0.y == Global_2428492.f_726.f_1) || !vParam0.z == Global_2428492.f_726.f_2) || !fParam3 == Global_2428492.f_729)
	{
		...
		{
			if (get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_730) < func_626(0))
			{
				return false;
			}
			stop_player_teleport();
	...
	if (Global_2428492.f_724)
	{
		...
		if (iParam9)
		{
			if (vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Global_2428492.f_726) < 2f)
			{
				if (is_player_teleport_active())
				{
					stop_player_teleport();
...
void func_630(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_103()))
	{
		if (is_entity_dead(func_103(), 0))
		{
		}
		vVar1 = {get_entity_coords(func_103(), 0)};
		...
		lock_minimap_angle(iVar7);
		lock_minimap_position(vVar1.x, vVar1.y);
		if (is_ped_in_any_vehicle(func_103(), 0))
		{
			set_radar_zoom(900);
			iVar0 = true;
		}
	...
	if (!GAMEPLAY::IS_BIT_SET(*iParam0, 9))
	{
		if (!GAMEPLAY::IS_BIT_SET(*iParam0, 3))
		{
			...
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					set_entity_collision(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), false, 0);
					freeze_entity_position(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), true);
					set_entity_visible(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), false, 0);
					clear_ped_tasks_immediately(PLAYER::PLAYER_PED_ID());
				}
			}
			else if (!is_entity_attached(PLAYER::PLAYER_PED_ID()))
			{
				freeze_entity_position(PLAYER::PLAYER_PED_ID(), true);
				set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
			}
			_0xF4F2C0D4EE209E20();
			*iParam0.f_13 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - Vector(1f, 0f, 0f)};
			set_everyone_ignore_player(player_id(), 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, 3);
		}
		else
		{
			set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
...
void func_634()
{
	...
	if (func_669() == 1)
	{
		if (func_284(func_103()) && func_283(&Local_386, func_103(), 0))
		{
			if (is_ped_a_player(func_103()))
			{
				if (func_9(_network_get_ped_player(func_103()), 1, 1))
				{
					...
					iVar0 = _network_get_ped_player(func_103());
					if (network_has_player_started_transition(iVar0))
					{
						if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 7))
						{
							if (func_653() && !func_652())
							{
								func_651();
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_1), true);
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 7);
						}
					}
					else if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 7))
					{
						GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 7);
					}
				}
			}
		}
...
bool func_635(auto uParam0, int iParam1)
{
	int iVar0;
	...
	switch (*uParam0)
	{
		case 0:
			...
			{
				network_bail_transition(31, 0, 0);
			}
			func_649(uParam0, 1);
			break;
		
		case 1:
			if (!network_is_activity_spectator())
			{
				network_set_activity_spectator(1);
			}
			*uParam0.f_1 = iParam1;
		...
		case 2:
			if (*uParam0.f_1 == iParam1)
			{
				...
				else if (network_has_player_started_transition(iParam1))
				{
					if (_0x2615AA2A695930C1(iParam1))
					{
						if (func_640(iParam1) > 0)
						{
							if (network_join_transition(iParam1))
							{
								func_641(uParam0, iParam1);
							}
							else
		...
		case 3:
			if (network_is_transition_busy() && !func_637())
			{
				func_636(1);
				func_650(uParam0);
				return true;
...
void func_636(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2808), 3);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2808), 3);
	}
}

int func_637()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, false);
}
...
bool func_639()
{
	...
	if (network_is_transition_started())
	{
		if (network_is_transition_busy())
		{
			return false;
		}
		else
...
auto func_640(int iParam0)
{
	return Global_1587523[iParam0 /*444*/].f_3;
}

void func_641(auto uParam0, int iParam1)
{
	func_645(iParam1);
	if (func_644(iParam1))
	{
...
void func_642()
{
	GAMEPLAY::CLEAR_BIT(&(Global_2434762.f_2), 16);
}

void func_643()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2434762.f_2), 16);
}

int func_644(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_39.f_18, 5);
}
...
int func_647()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, 23);
}
...
void func_649(auto uParam0, int iParam1)
{
	*uParam0 = iParam1;
}

void func_650(auto uParam0)
{
	struct<4> Var0;
...
int func_659(int iParam0, char* sParam1)
{
	_0x0A24DA3A41B718F5(sParam1);
	return _0x10BDDBFC529428DD(1 + iParam0);
}

int func_660(int iParam0, char* sParam1, int iParam2)
{
	_0x0A24DA3A41B718F5(sParam1);
...
int func_661(int iParam0, char* sParam1, char* sParam2)
{
	_0x0A24DA3A41B718F5(sParam1);
...
int func_662(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	_0x0A24DA3A41B718F5(sParam1);
	_add_text_component_item_string(sParam2);
...
void func_667(auto uParam0)
{
	disable_all_control_actions(0);
	disable_all_control_actions(2);
	enable_control_action(2, func_334(1), 1);
	enable_control_action(2, func_334(0), 1);
	...
	enable_control_action(2, func_332(224), 1);
	enable_control_action(2, 204, 1);
	enable_control_action(2, 218, 1);
	enable_control_action(2, 219, 1);
	enable_control_action(2, func_332(228), 1);
	enable_control_action(2, func_332(229), 1);
	enable_control_action(2, func_332(230), 1);
	enable_control_action(2, func_332(231), 1);
	enable_control_action(2, func_332(226), 1);
	enable_control_action(2, func_332(227), 1);
	enable_control_action(2, func_334(1), 1);
	enable_control_action(2, func_332(224), 1);
	enable_control_action(2, func_332(222), 1);
	enable_control_action(2, func_334(0), 1);
	enable_control_action(2, func_332(234), 1);
	enable_control_action(2, func_332(235), 1);
	enable_control_action(2, func_332(232), 1);
	enable_control_action(2, func_332(233), 1);
	...
	if (func_24(player_id(), 0))
	{
		enable_control_action(0, func_332(230), 1);
		enable_control_action(0, func_332(231), 1);
		if (func_669() == 2)
		{
			enable_control_action(0, func_332(228), 1);
			enable_control_action(0, func_332(229), 1);
			enable_control_action(0, func_332(230), 1);
			enable_control_action(0, func_332(231), 1);
			...
			enable_control_action(0, 1, 1);
			enable_control_action(0, 2, 1);
			enable_control_action(0, 21, 1);
			enable_control_action(0, 9, 1);
			enable_control_action(0, 8, 1);
			enable_control_action(0, 11, 1);
			enable_control_action(0, 10, 1);
			enable_control_action(2, func_334(1), 1);
			enable_control_action(2, func_332(224), 1);
			enable_control_action(2, func_332(222), 1);
			enable_control_action(2, func_334(0), 1);
	...
	CONTROLS::DISABLE_CONTROL_ACTION(2, 85, 1);
	...
	if (func_461(uParam0.f_47) != 5)
	{
		enable_control_action(2, 245, 1);
		enable_control_action(2, 246, 1);
	}
	if (_network_is_text_chat_active())
	{
...
void func_672()
{
	...
	switch (func_680())
	{
		case 0:
			...
			{
				if (((Global_1587523[player_id() /*444*/].f_355 != func_46() && (Global_1587523[player_id() /*444*/].f_87 <= 4 || Global_1587523[player_id() /*444*/].f_87 == 5)) && Global_1587523[player_id() /*444*/].f_87 >= 3) && !func_678())
				{
					if (func_9(Global_1587523[player_id() /*444*/].f_355, 0, 0))
					{
						if ((((func_573(Global_1587523[player_id() /*444*/].f_355) >= 8 && !func_677(Global_1587523[player_id() /*444*/].f_355)) && func_573(Global_1587523[player_id() /*444*/].f_355) != 38) && func_573(Global_1587523[player_id() /*444*/].f_355) != 37) && !func_7(player_id(), 0))
						{
							if (!network_is_activity_session())
							{
								Global_1587523[player_id() /*444*/].f_87 = 4;
								func_676();
								func_638(1);
							}
							else if (func_675(Global_1587523[player_id() /*444*/].f_355))
							{
								Global_1587523[player_id() /*444*/].f_87 = 4;
								func_638(1);
							}
		...
		case 1:
			if (func_674())
			{
				if (Global_1587523[player_id() /*444*/].f_355 != func_46())
				{
					if (func_572(Global_1587523[player_id() /*444*/].f_355))
					{
						func_638(3);
					}
				}
		...
		case 4:
			if (Global_1587523[player_id() /*444*/].f_87 != 4)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_386.f_47), true);
				func_638(0);
			}
...
void func_673()
{
	if (Global_1587523[player_id() /*444*/].f_355 != func_46() && func_9(Global_1587523[player_id() /*444*/].f_355, 0, 0))
	{
		if (!func_243(Global_1587523[player_id() /*444*/].f_355))
		{
			func_75(&Local_386);
			func_638(4);
		}
...
int func_674()
{
	return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_2808, 5);
}
...
void func_676()
{
	GAMEPLAY::CLEAR_BIT(&(Global_2434762.f_2), 22);
}

bool func_677(auto uParam0)
{
	if ((((func_573(uParam0) == 36 || func_573(uParam0) == 39) || func_573(uParam0) == 33) || func_573(uParam0) == 34) || func_573(uParam0) == 35)
	{
		return true;
	}
	return false;
...
int func_678()
{
	return GAMEPLAY::IS_BIT_SET(Global_969327.f_8, 24);
}

int func_679()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, 22);
}
...
void func_681()
{
	if ((func_142() == 64 || func_142() == 65) || func_684())
	{
		...
		GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_1), false);
		GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_1), true);
		func_683();
		if (func_15())
		{
...
bool func_687()
{
	...
	if (func_688() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_688()) == 0)
		{
			return true;
		}
	}
...
bool func_695(int iParam0, auto uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_698(int iParam0, int iParam1)
{
	...
	set_scaleform_movie_as_no_longer_needed(&Global_1721440);
	Global_1721440 = 0;
	set_scaleform_movie_as_no_longer_needed(&(Global_1721440.f_1));
	Global_1721440.f_1 = 0;
	set_scaleform_movie_as_no_longer_needed(&(Global_1721440.f_2));
...
void func_700(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 <= 4)
	{
		if (*uParam0.f_358[iVar1] != 0)
		{
			...
			{
				if (does_entity_belong_to_this_script(*uParam0.f_76[iVar1], 0))
				{
					delete_object(uParam0.f_76[iVar1]);
					if (iParam2)
					{
						set_model_as_no_longer_needed(*uParam0.f_358[iVar1]);
					}
				}
				else
				{
	...
	if (iParam1)
	{
		if (does_cam_exist(*uParam0.f_9))
		{
			...
			if (is_cam_active(*uParam0.f_9))
			{
				set_cam_active(*uParam0.f_9, false);
			}
			destroy_cam(*uParam0.f_9, 1);
		}
	}
	if (*uParam0.f_412)
	{
	...
	if (!is_string_null_or_empty(uParam0.f_84))
	{
		remove_anim_dict(uParam0.f_84);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_83))
	{
		delete_object(uParam0.f_83);
	}
	if (!*uParam0.f_403 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_403))
		{
			...
			if (does_entity_belong_to_this_script(*uParam0.f_403, 0))
			{
				delete_ped(uParam0.f_403);
				if (iParam2)
				{
	...
	if (!*uParam0.f_404 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_404))
		{
			...
			if (does_entity_belong_to_this_script(*uParam0.f_404, 0))
			{
				delete_ped(uParam0.f_404);
				if (iParam2)
				{
					set_model_as_no_longer_needed(iVar2);
				}
	...
	*uParam0.f_406 = 0;
	...
	if (iParam3)
	{
		func_203(player_id(), 1, 0);
	}
	*uParam0.f_420 = 0;
}

void func_701(auto uParam0)
{
	*uParam0.f_405 = 0;
	*uParam0.f_406 = 0;
	*uParam0.f_407 = 0;
...
void func_702(auto uParam0, int iParam1)
{
	*uParam0.f_5 = iParam1;
}

void func_703(auto uParam0, int iParam1)
{
	*uParam0.f_410 = iParam1;
}

auto func_704(auto uParam0)
{
	return *uParam0.f_410;
}

void func_705(auto uParam0)
{
	int iVar0;
	char* sVar1;
	char[64] cVar2;
	
	StringCopy(&cVar2, sVar1, 64);
	*uParam0 = 0;
	*uParam0.f_1 = -1;
	*uParam0.f_2 = 0;
	*uParam0.f_3 = 0;
...
{
	network_set_voice_active(iParam0);
...
void func_709(auto uParam0)
{
	...
	iVar0[6] = -711771128;
	iVar0[7] = 103339342;
	iVar9 = Global_1587523[player_id() /*444*/].f_250.f_9;
	func_711(&vVar10, 93, iVar9);
	...
	if (*uParam0.f_82 != 0)
	{
		delete_object(uParam0.f_82);
		iVar13 = 0;
		while (iVar13 <= iVar0 - 1)
		{
			set_model_as_no_longer_needed(iVar0[iVar13]);
			iVar13++;
		}
	}
}

bool func_710(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
	if (are_strings_equal(&uParam0, "APA_NAR_INT"))
	{
		return true;
	}
	return false;
...
bool func_711(auto uParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	...
	switch (iParam2)
	{
		...
		case 42:
		case 43:
			func_712(iParam2, iParam1, &vVar0, -1);
			*uParam0 = {vVar0};
			return true;
		...
		case 64:
		case 65:
			func_712(iParam2, iParam1, &vVar0, 61);
			*uParam0 = {vVar0};
			return true;
		...
		case 84:
		case 85:
			func_712(iParam2, iParam1, &vVar0, 83);
			*uParam0 = {vVar0};
			return true;
		...
		case 81:
		case 82:
			func_712(iParam2, iParam1, &vVar0, 77);
			*uParam0 = {vVar0};
			return true;
		...
		case 75:
		case 76:
			func_712(iParam2, iParam1, &vVar0, 73);
			*uParam0 = {vVar0};
			return true;
			return false;
	}
...
void func_712(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	...
	*uParam2 = {func_714(iParam1, iParam3)};
	...
	vVar13 = {func_713(vVar13, -Var0[0 /*6*/].f_3.f_2)};
	vVar13 = {func_713(vVar13, Var0[1 /*6*/].f_3.f_2)};
...
Vector3 func_713(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
void func_722(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 <= 1)
	{
		texture_download_release(Global_1717830.f_358[iVar0 /*5*/]);
	...
	Global_1605479[network_player_id_to_int() /*76*/].f_10 = 0;
...
void func_728()
{
	...
	while (iVar0 <= 16)
	{
		...
		Global_1717830.f_306[iVar0 /*3*/] = {vVar5};
		iVar0++;
	}
}
...
auto func_737(int iParam0, int iParam1)
{
	auto uVar0;
	int iVar1;
	int iVar2;
...
void func_738(auto uParam0, int iParam1, int iParam2)
{
	if (does_cam_exist(*uParam0))
	{
		if (iParam2)
...
void func_744(int iParam0, int iParam1)
{
	if (iParam1)
	{
		...
		{
			if (is_pedheadshot_valid(Global_1717830.f_197[iParam0 /*9*/].f_1))
			{
				unregister_pedheadshot(Global_1717830.f_197[iParam0 /*9*/].f_1);
			}
		}
...
void func_747()
{
	...
	while (iVar0 <= 4)
	{
		...
		func_751(&(Global_1721010.f_1[iVar0 /*5*/]), 1, iVar1);
		iVar0++;
	}
	iVar0 = 0;
	...
	while (iVar0 <= 4)
	{
		_0x5A34CD9C3C5BEC44(Global_1721010.f_27[iVar0 /*60*/].f_58);
...
void func_749(auto uParam0, int iParam1, int iParam2)
{
	*uParam0.f_1 = iParam1;
	*uParam0.f_2 = iParam1;
	if (iParam2)
...
void func_751(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0 != 0)
	{
		if (iParam2)
...
void func_754(int iParam0)
{
	...
	while (iVar0 <= 6)
	{
		...
		{
			texture_download_release(Global_1715897.f_1574[iVar0 /*5*/]);
		}
		_0x5A34CD9C3C5BEC44(Global_1715897.f_111[iVar0 /*204*/].f_43);
		iVar0++;
	}
	iVar0 = 0;
	...
	func_755(has_scaleform_movie_loaded(Global_1721440.f_1));
	Global_1605479[player_id() /*76*/].f_13 = 0;
	Global_2435528.f_5751 = 0;
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_POSTITS"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_HIGHLIGHTS"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_AREAS"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_ARROWS"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_TEXT"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (_push_scaleform_movie_function(iParam0, "REMOVE_ALL_PINS"))
	{
		_pop_scaleform_movie_function_void();
	}
}
...
void func_775()
{
	...
	while (iVar55 <= 6)
	{
		...
		Global_1715897.f_111[iVar55 /*204*/].f_24 = {vVar23};
