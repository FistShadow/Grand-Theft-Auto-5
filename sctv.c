	...
	if (iVar0 == 0)
	{
		if (iParam2 == 1)
		{
			...
			else if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, true))
			{
				...
				GAMEPLAY::SET_BIT(&(Global_2359301.f_66), true);
			}
		}
...
void func_27()
{
	...
	if (!network_is_in_spectator_mode())
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_66, 2))
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2359301.f_66), 2);
			GAMEPLAY::SET_BIT(&(Global_2359301.f_66), false);
		}
	}
}
...
void func_28(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iParam1)
		{
			ENTITY::SET_ENTITY_PROOFS(PLAYER::PLAYER_PED_ID(), false, false, false, iParam0, false, false, 0, false);
...
void func_41(auto uParam0)
{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_2, false) || !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_100())
			{
...
void func_57(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 2);
	}
	else
	{
...
void func_58(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), true);
	}
	else
	{
...
void func_59(int iParam0)
{
	if (iParam0)
	{
		...
		GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), false);
	}
	else
	{
...
void func_75(auto uParam0)
{
	if (does_cam_exist(*uParam0.f_1.f_39))
	{
		...
		*uParam0.f_1.f_41 = 0;
		func_22(1, func_80(), 1);
		GAMEPLAY::SET_BIT(uParam0.f_47, true);
		func_79();
		func_78(0);
		func_76();
	}
...
void func_78(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 8);
	}
	else
	{
...
void func_79()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 12);
	}
}
...
void func_94(auto uParam0)
{
	...
	GAMEPLAY::SET_BIT(&Global_2359301, 2);
}
...
void func_95(int iParam0)
{
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_1, 3))
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2359301.f_1), 3);
		}
	}
...
void func_99(int iParam0, int iParam1, int iParam2)
{
	switch (iParam0)
	{
		...
		default:
			if (iParam1)
			{
				GAMEPLAY::SET_BIT(&(Global_1338622.f_947), iParam0);
			}
			else
			{
...
void func_109()
{
	...
	{
		GAMEPLAY::SET_BIT(&Global_2359301, 24);
	}
}
...
void func_117()
{
	...
	if (func_671())
	{
		GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 9);
		func_670(0);
	}
	if (func_669() != 1)
	{
	...
	switch (Global_2359301.f_68.f_3)
	{
			...
			switch (Global_2359301.f_68.f_1)
			{
				...
				case 2:
					...
					if (func_284(Local_386.f_47.f_1009))
					{
						...
						{
							vVar8 = {ENTITY::GET_ENTITY_COORDS(iVar14, 1) + Vector(99f, 0f, 0f)};
						}
					}
					if (func_77(vVar8))
					{
					...
					GAMEPLAY::SET_BIT(&(Local_386.f_1.f_1), 2);
		...
		case 4:
			...
			if (iVar0)
			{
				...
				GAMEPLAY::SET_BIT(&(Local_386.f_47), true);
				GAMEPLAY::SET_BIT(&(Local_386.f_47), 6);
				func_63();
				func_290(5);
			}
			break;
...
void func_119()
{
	...
	switch (func_669())
	{
		...
		case 1:
			...
			{
				GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 4);
			}
			else
			{
				GAMEPLAY::CLEAR_BIT(&(Global_2359301.f_68.f_5), 4);
			...
			else if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 10))
			{
				if (func_3(&uLocal_2646, 10000, 0))
				{
					...
					GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 10);
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(func_103()))
			{
...
void func_144()
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_130() == 0)
		{
			network_resurrect_local_player(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 0f, 0, func_6(player_id(), 1), 1);
		}
			...
			*iParam1 = create_cam("DEFAULT_SCRIPTED_FLY_CAMERA", false);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				else
				{
					...
					vVar0.z = fVar3 + 40f;
					set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 0);
					set_cam_coord(*iParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
					set_cam_rot(*iParam1, -89.5f, 0f, 0f, 2);
					func_140(2);
...
void func_151(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), vVar0, 2, 1);
		set_entity_collision(PLAYER::PLAYER_PED_ID(), false, 0);
	}
}
				...
				if (func_168())
				{
					...
					if (is_player_switch_in_progress() == 0)
					{
						...
						if (does_cam_exist(iParam0) || iParam4)
						{
							...
							iVar9 = func_165(ENTITY::GET_ENTITY_COORDS(Global_1318697, 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0));
							if (iVar9 == 3)
							{
								iVar9 = 2;
							}
					...
					else if (_0x933BBEEB8C61B5F4())
					{
						if (does_cam_exist(iParam0))
						{
							...
							if (func_164(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar6, 5f, 0) || !iParam5)
							{
...
bool func_168()
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_1318697))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("u_m_m_filmdirector")))
		{
			...
			GAMEPLAY::SET_BIT(&(Global_1724577[1]), 6);
		}
		else
		{
			GAMEPLAY::SET_BIT(&(Global_1724577[1]), 7);
		}
	}
	else
	{
...
void func_176(auto uParam0)
{
	...
	*uParam0.f_47.f_1008 = 0;
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 8))
	{
		...
		GAMEPLAY::SET_BIT(uParam0.f_47, 6);
	}
...
void func_191(auto uParam0)
{
	...
	if (Global_1315838)
	{
		GAMEPLAY::SET_BIT(&Global_2359301, 20);
		iVar0 = false;
		while (iVar0 < 32)
		{
	...
	if (((((!is_player_switch_in_progress() && !is_new_load_scene_active()) && func_669() == 1) && func_226(&(Local_386.f_1))) && ENTITY::DOES_ENTITY_EXIST(func_215())) && is_ped_a_player(func_215()))
	{
		...
		if (is_screen_faded_in())
		{
			if (Global_1715399 == 0)
			{
				...
				{
					do_screen_fade_out(false);
					GAMEPLAY::SET_BIT(&(Local_386.f_47), 16);
				}
			}
		}
...
void func_211(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 27);
	}
	else
	{
...
bool func_212()
{
	if (func_210())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_386.f_47, 19))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_386.f_47), 19);
			}
		}
		else
		{
	...
	if (func_218(player_id(), 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 8))
		{
			if (network_is_player_active(Global_1587523[player_id() /*444*/].f_355))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 11);
					if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 8))
					{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 8);
			}
		}
	}
	return true;
...
void func_221(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			GAMEPLAY::SET_BIT(&Global_2359301, 2);
			GAMEPLAY::SET_BIT(uParam0.f_47, 2);
		}
		if (func_224())
		{
		...
		GAMEPLAY::SET_BIT(&Global_2359301, 3);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 6);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 14);
...
void func_227(int iParam0)
{
	if ((func_669() == 1 && func_287() != 3) || iParam0)
	{
		if (network_can_bail())
		{
			...
			{
				do_screen_fade_out(false);
				GAMEPLAY::SET_BIT(&(Global_2359301.f_1), false);
				network_bail(15, 0, 0);
			}
		}
	}
	...
	switch (iVar0)
	{
		...
		case 1:
			...
			else
			{
				...
				{
					vVar3 = {ENTITY::GET_ENTITY_COORDS(iParam0, 0)};
									...
									if (is_ped_a_player(func_215()))
									{
										...
										if (network_is_player_active(iVar4))
										{
											if (func_256(iVar4, 0))
											{
												if (Global_2359299)
												{
													vVar0 = {ENTITY::GET_ENTITY_COORDS(func_215(), 0)};
												}
												GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 5);
												iVar3 = true;
											}
										}
									}
...
void func_261(auto uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (get_closest_vehicle_node(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &vVar0, 1, 3f, 0f))
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar0 + Vector(1f, 0f, 0f), 1, true, 0, 0);
			}
			set_cam_coord(*uParam0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(iParam1, 0f, 0f));
		}
		func_192(uParam0);
		set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
		set_entity_invincible(PLAYER::PLAYER_PED_ID(), true);
					...
					if (func_24(player_id(), 0))
					{
						if (!iVar4)
						{
							if (is_ped_a_player(iVar5))
							{
								...
								{
									if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_1715855, get_player_name(_network_get_ped_player(iVar5))))
									{
										iVar4 = true;
										iVar1 = iVar0;
									}
...
void func_289(int iParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 8))
	{
		if (iParam0)
		{
			GAMEPLAY::SET_BIT(&Global_2359301, 9);
		}
		GAMEPLAY::SET_BIT(&Global_2359301, 8);
	}
}
	...
	else
	{
		...
		if (func_115(uParam0.f_1) == 3)
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 5))
			{
				...
				GAMEPLAY::SET_BIT(&Global_2359301, 4);
			}
		}
	}
...
void func_292(auto uParam0)
{
	...
	if (iVar0)
	{
		...
		if (!iVar4)
		{
			if (func_24(player_id(), 0))
			{
				...
				else if (func_6(player_id(), 0))
				{
					...
					{
						GAMEPLAY::SET_BIT(uParam0.f_47, 13);
					}
				}
			}
		}
		...
		{
			GAMEPLAY::SET_BIT(uParam0.f_47, 14);
		}
	}
	func_177(uParam0.f_47);
	func_301(uParam0);
...
void func_295(int iParam0)
{
	if (iParam0 == 1)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_2460486.f_4429), 9);
			func_79();
		}
	}
...
bool func_303()
{
	...
	if (func_306(201))
	{
		GAMEPLAY::SET_BIT(&Global_1312768, false);
	}
...
bool func_306(int iParam0)
{
	...
	if ((is_control_just_released(2, iParam0) || is_disabled_control_just_released(2, iParam0)) || func_307(iParam0, &(Global_1338622.f_961), 1))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_1338622.f_950[uVar1]), iVar2);
			return true;
		}
	}
	...
	switch (*uParam0.f_47.f_1464)
	{
		case 0:
			if (func_93(uParam0.f_1) != 3)
			{
				...
				{
					GAMEPLAY::SET_BIT(&Global_2359301, 14);
				}
			...
			if (func_93(uParam0.f_1) != 3)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2359301, 11))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 29))
					{
						display_hud(false);
						display_radar(true);
						GAMEPLAY::SET_BIT(&Global_2359301, 29);
					}
					hide_hud_component_this_frame(1);
				...
				else
				{
					...
					GAMEPLAY::SET_BIT(&Global_2359301, 11);
				}
			}
			break;
	}
						...
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 12))
						{
							if (has_scaleform_movie_loaded(*uParam0.f_47.f_1473) && *uParam0.f_47.f_1473 != -1)
							{
								...
								if (*uParam0.f_47.f_1008 > 8)
								{
									...
									{
										GAMEPLAY::SET_BIT(uParam0.f_47, 18);
									}
								}
				...
				case 3:
					if (!func_341(1))
					{
						if (iVar0)
						{
							if (!GAMEPLAY::IS_BIT_SET(Global_2359301, false))
							{
								GAMEPLAY::SET_BIT(&Global_2359301, false);
							}
						}
					}
					break;
...
void func_358(auto uParam0)
{
	...
	if ((!_is_input_disabled(2) && is_control_just_pressed(2, func_334(1))) || (_is_input_disabled(2) && is_control_just_pressed(2, 201)))
	{
		if (!func_24(player_id(), 0))
		{
			...
			func_361();
			GAMEPLAY::SET_BIT(uParam0.f_47, true);
			GAMEPLAY::SET_BIT(&Global_2359301, 6);
			GAMEPLAY::SET_BIT(uParam0.f_1, 7);
			GAMEPLAY::SET_BIT(&Global_2359301, 13);
			if (func_10(player_id()))
			{
				func_359();
			}
...
void func_378(auto uParam0)
{
				...
				if (is_screen_faded_in())
				{
					if (is_control_just_pressed(2, func_332(231)))
					{
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 10))
						{
							...
							func_388(1);
							GAMEPLAY::SET_BIT(uParam0.f_47, 10);
						}
						else
						{
							_set_radar_bigmap_enabled(0, 0);
			...
			if (*uParam0.f_47.f_1464 == 0 || *uParam0.f_47.f_1464 == 1)
			{
				if (is_screen_faded_in())
				{
					if (is_control_just_pressed(2, func_332(230)) || is_disabled_control_just_pressed(2, func_332(230)))
					{
						...
						{
							_0xA8FDB297A8D25FBA();
							GAMEPLAY::SET_BIT(uParam0.f_47, 12);
							GAMEPLAY::SET_BIT(uParam0.f_47, true);
						}
						else
						{
					...
					if (is_control_just_pressed(2, func_332(227)))
					{
						if (func_387())
						{
							if (get_time_difference(NETWORK::GET_NETWORK_TIME(), *uParam0.f_47.f_1451) >= 0)
							{
								...
								GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 6);
							}
						}
					}
					if ((CONTROLS::IS_CONTROL_PRESSED(2, func_332(230)) && is_control_just_pressed(2, func_332(231))) || (CONTROLS::IS_CONTROL_PRESSED(2, func_332(231)) && is_control_just_pressed(2, func_332(230))))
					{
						func_386(1);
					}
				}
	...
	if (func_93(uParam0.f_1) != 3 && func_669() != 2)
	{
		...
		if (is_control_just_pressed(2, func_332(227)))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 18))
			{
				GAMEPLAY::SET_BIT(uParam0.f_1, 18);
			}
			else
			{
			...
			if (func_325(uParam0.f_47))
			{
				...
				else if ((((func_669() != 2 && !func_268(player_id(), 13)) && !func_268(player_id(), 14)) && !func_268(player_id(), 15)) && !func_208())
				{
					if (is_control_just_pressed(2, func_332(229)) || CONTROLS::IS_CONTROL_PRESSED(2, 180))
					{
						...
						if (!_is_input_disabled(2))
						{
							GAMEPLAY::SET_BIT(uParam0.f_47, 9);
						}
						*uParam0.f_47.f_2171 = 1;
						func_394(uParam0.f_47, 1);
					}
					else if (is_control_just_pressed(2, func_332(228)) || CONTROLS::IS_CONTROL_PRESSED(2, 181))
					{
						play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
						GAMEPLAY::SET_BIT(uParam0.f_47, true);
						GAMEPLAY::SET_BIT(uParam0.f_47, 5);
									...
									if (func_284(vVar1.x))
									{
										...
										if (is_ped_a_player(vVar1.x))
										{
											...
											if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 17))
											{
												...
												{
													GAMEPLAY::SET_BIT(uParam0.f_47, 17);
												}
											}
											iVar25 = true;
											...
											if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 11) && iVar17)
											{
												...
												GAMEPLAY::SET_BIT(uParam0.f_47, 11);
											}
											iVar27 = ENTITY::IS_ENTITY_DEAD(vVar1.x, 0);
										...
										if (func_284(vVar1.x))
										{
											...
											if (is_ped_a_player(vVar1.x))
											{
												...
												if (iVar28 != -1)
												{
													...
													if (iVar29 != -1)
													{
														if (!is_string_null_or_empty(&(Global_1574247[iVar29 /*16*/])) && !GAMEPLAY::ARE_STRINGS_EQUAL("NULL", &(Global_1574247[iVar29 /*16*/])))
														{
	...
	if (!func_24(player_id(), 0) && !func_440())
	{
		if (func_93(uParam0.f_1) != 3)
		{
			if (func_104(player_id()) == 0)
			{
				...
				if (iVar2 < 1)
				{
					GAMEPLAY::SET_BIT(uParam0.f_47, 7);
					iVar2++;
...
void func_467()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 17);
	}
}
...
void func_468()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, false))
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 4))
		{
			if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166.f_1)) > 750)
			{
				...
				Global_2428492.f_2166.f_1 = NETWORK::GET_NETWORK_TIME();
				GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 4);
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, true))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 3))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 3);
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 4) && !GAMEPLAY::IS_BIT_SET(Global_2428492.f_2166.f_2, 5))
	{
		if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2428492.f_2166.f_1)) > 1000)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2428492.f_2166.f_2), 5);
		}
	}
}
	...
	switch (*uParam0.f_47.f_1469)
	{
		...
		case 99:
			if (*uParam0.f_47.f_1467 == 10)
			{
				...
				{
					GAMEPLAY::SET_BIT(&Global_2359301, 12);
				}
				if (func_485())
				{
					func_508(uParam0);
	...
	if (absi(get_time_difference(*uParam0.f_3, NETWORK::GET_NETWORK_TIME())) > 500 || *uParam0.f_3 == 0)
	{
		*uParam0.f_3 = NETWORK::GET_NETWORK_TIME();
		...
		while (iVar0 <= 1)
		{
			...
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(uParam0.f_5[iVar0 /*8*/].f_2, &(Global_1724230.f_271[iVar0 /*8*/].f_2)))
			{
...
void func_515(char* sParam0, char* sParam1)
{
	...
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 16);
	if (iVar0 == iVar1)
	{
		if (iVar0 > 8)
		{
...
void func_521()
{
	...
	{
		GAMEPLAY::SET_BIT(&Global_2359301, 21);
		GAMEPLAY::CLEAR_BIT(&Global_2359301, 31);
		func_1(&(Global_2359301.f_5));
	}
}
...
void func_559()
{
	...
	{
		GAMEPLAY::SET_BIT(&Global_2359301, 31);
		func_1(&(Global_2359301.f_5));
	}
}
...
bool func_566(auto uParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 11))
	{
		if (is_screen_faded_in() || is_screen_fading_in())
		{
			GAMEPLAY::SET_BIT(uParam0.f_1, 11);
		}
		else if (!func_100())
		{
			do_screen_fade_in(250);
				...
				case 0:
					*uParam0.f_1.f_6 = 0;
					...
					else if (ENTITY::DOES_ENTITY_EXIST(iVar1))
					{
						...
						{
							vVar4 = {ENTITY::GET_ENTITY_COORDS(func_103(), 0)};
						}
						else
						{
							vVar4 = {_get_gameplay_cam_coords()};
						}
						fVar3 = vdist2(vVar4, ENTITY::GET_ENTITY_COORDS(iVar1, 0));
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar1))
					{
						...
						if (Global_2435528.f_2842.f_25)
						{
							if (does_cam_exist(Global_2435528.f_2842.f_19))
							{
								...
								{
									GAMEPLAY::SET_BIT(&Global_2359301, 10);
						...
						if ((*uParam0.f_1.f_5 > 0 || *uParam0.f_1.f_6) && !is_player_switch_in_progress())
						{
							...
							*uParam0.f_1.f_44 = 0;
							...
							{
								*uParam0.f_1.f_30 = {ENTITY::GET_ENTITY_COORDS(iVar1, 0)};
							}
							if (Global_2359299)
							{
				...
				case 3:
					...
					if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 10))
					{
						...
						else if (!func_587(uParam0.f_1))
						{
							...
							if (vdist2(*uParam0.f_1.f_30, ENTITY::GET_ENTITY_COORDS(iVar1, 0)) > 2500f)
							{
								new_load_scene_stop();
								GAMEPLAY::CLEAR_BIT(uParam0.f_1, 10);
								iVar0 = true;
						...
						if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, 15))
						{
							if (!is_screen_fading_in())
							{
								if (!func_100() && !func_570(_network_get_ped_player(iVar1), 0))
								{
									...
									{
										GAMEPLAY::SET_BIT(uParam0.f_47, 15);
									}
...
void func_569()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 22))
	{
		GAMEPLAY::SET_BIT(&Global_2359301, 22);
	}
}
...
void func_575(auto uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1.f_1, true))
	{
		...
		{
			GAMEPLAY::SET_BIT(&Global_2359301, 5);
		}
	}
			...
			if (*uParam0.f_1.f_4)
			{
				...
				if (func_284(func_80()))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_47, false))
					{
						...
						{
							GAMEPLAY::SET_BIT(uParam0.f_47, false);
							func_285(uParam0);
						}
					}
...
void func_601(auto uParam0)
{
	...
	GAMEPLAY::SET_BIT(uParam0.f_1, true);
}
...
void func_605(auto uParam0)
{
	...
	*uParam0.f_1.f_34 = 1;
	...
	GAMEPLAY::SET_BIT(uParam0.f_1, false);
}
						...
						if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 16))
						{
							...
							else
							{
								*uParam0.f_1.f_40 = GAMEPLAY::GET_GAME_TIMER() + 3000;
								GAMEPLAY::SET_BIT(uParam0.f_1, 17);
							}
						}
						else
						{
...
void func_618(auto uParam0)
{
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 16))
	{
		GAMEPLAY::SET_BIT(uParam0.f_1, 16);
	}
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_1, 17))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_1, 17);
...
void func_630(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_103()))
	{
		if (ENTITY::IS_ENTITY_DEAD(func_103(), 0))
		{
		}
		vVar1 = {ENTITY::GET_ENTITY_COORDS(func_103(), 0)};
...
void func_631(int iParam0, int iParam1)
{
	if (!GAMEPLAY::IS_BIT_SET(*iParam0, 9))
	{
		if (!GAMEPLAY::IS_BIT_SET(*iParam0, 3))
		{
			...
			_0xF4F2C0D4EE209E20();
			*iParam0.f_13 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(1f, 0f, 0f)};
			set_everyone_ignore_player(player_id(), 1);
				...
				if (func_9(_network_get_ped_player(func_103()), 1, 1))
				{
					...
					if (network_has_player_started_transition(iVar0))
					{
						if (GAMEPLAY::IS_BIT_SET(Global_2359301.f_68.f_5, 7))
						{
							...
							{
								func_651();
								GAMEPLAY::SET_BIT(&(Global_2359301.f_1), true);
						...
						{
							GAMEPLAY::SET_BIT(&(Global_2359301.f_68.f_5), 7);
						}
					}
...
void func_636(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2808), 3);
	}
	else
	{
...
void func_643()
{
	GAMEPLAY::SET_BIT(&(Global_2434762.f_2), 16);
}
...
{
	if (GAMEPLAY::ARE_STRINGS_EQUAL(&uParam0, "APA_NAR_INT"))
	{
		return true;
	}
	return false;
