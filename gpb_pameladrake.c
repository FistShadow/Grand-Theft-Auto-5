...
void main()
{
	...
	if (vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_100())
	{
		func_107(0);
	}
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_240) && func_78(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !is_world_point_within_brain_activation_range())
		{
			func_107(1);
		}
		wait(0);
...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_448) && !ENTITY::IS_ENTITY_DEAD(iLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		if (!iLocal_449)
		{
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_240, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 15f)
			{
				task_flush_route();
		...
		else
		{
			...
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_448, 1), 377.4565f, 154.6708f, 102.0838f, 1) > 25f)
			{
				set_ped_as_no_longer_needed(&iLocal_448);
				iLocal_450 = 1;
			}
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_448, 1), ENTITY::GET_ENTITY_COORDS(iLocal_240, 1), 1) < 3f && iLocal_451 == 0)
			{
				iLocal_451 = 1;
			}
		}
