...
bool func_239()
{
	...
	{
		if (has_model_loaded(1938952078))
		{
...
void func_407(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_369(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_369(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_410(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_409())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_369(iVar2 + 1)))
				{
...
bool func_432()
{
	if ((has_model_loaded(iLocal_617) && has_model_loaded(iLocal_619)) && has_additional_text_loaded(false))
	{
		return true;
	}
	return false;
