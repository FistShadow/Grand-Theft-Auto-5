...
bool func_139()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_851, 0) && is_vehicle_driveable(Local_410.f_4, 0))
	{
		switch (iLocal_1128)
		{
			...
			case 5:
				Local_902 = {func_140()};
				if (func_155(&Local_410, 19) > 15f || GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_896, &Local_902))
				{
...
void func_319(int iParam0, char* sParam1, int iParam2)
{
	...
	func_416(2);
	Var0 = {func_140()};
	if ((!is_string_null_or_empty(&Var0) && func_157()) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "NULL"))
	{
	}
	else
	{
