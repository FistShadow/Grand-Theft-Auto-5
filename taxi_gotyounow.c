	...
	else
	{
		...
		switch (Local_410.f_410)
		{
			...
			case 9:
				...
				if (iLocal_853 >= 2)
				{
					if (!iLocal_863 && ((((((is_ped_injured(iLocal_851) || is_entity_dead(iLocal_850, 0)) || (!is_entity_dead(iLocal_851, 0) && has_entity_been_damaged_by_any_vehicle(iLocal_851))) || (!is_entity_dead(iLocal_850, 0) && has_entity_been_damaged_by_any_vehicle(iLocal_850))) || (!is_entity_dead(iLocal_851, 0) && has_entity_been_damaged_by_weapon(iLocal_851, false, 2))) || (!is_entity_dead(iLocal_850, 0) && has_entity_been_damaged_by_weapon(iLocal_850, false, 2))) || ((!is_entity_dead(iLocal_851, 0) && !is_ped_in_any_vehicle(player_ped_id(), 0)) && func_317(iLocal_851, 1) < 1f)))
					{
						...
						if ((!is_entity_dead(iLocal_851, 0) && !is_ped_in_any_vehicle(player_ped_id(), 0)) && func_317(iLocal_851, 1) < 1f)
						{
			...
			case 10:
				if (func_161())
				{
					...
					if (!is_entity_dead(iLocal_851, 0))
					{
						...
						task_turn_ped_to_face_entity(iLocal_851, player_ped_id(), false);
			...
			case 11:
				...
				else if (is_entity_in_angled_area(player_ped_id(), vLocal_886, vLocal_889, fLocal_895, 0, true, 0))
				{
			...
			case 18:
				if (func_148(player_ped_id(), iLocal_851, 1) < 3f && !func_147())
				{
					func_145();
					Local_410.f_115 = 1;
	...
	if (iParam1)
	{
		if (!iVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					set_bit(&(Global_2097152[func_79() /*10375*/].f_7704.f_747), iParam0);
					func_105(15, 0);
					break;
			}
			func_104(iVar1);
...
int func_136(Vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_137(network_is_game_in_progress(), 1f, 1f));
...
bool func_147()
{
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		if (get_ped_in_vehicle_seat(get_vehicle_ped_is_using(player_ped_id()), -1) == player_ped_id())
		{
			return true;
		}
	}
...
int func_160(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_137(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
		...
		case 8:
			if (func_155(&Local_410, 0) > 0.3f)
			{
				if ((!is_ped_injured(player_ped_id()) && !is_ped_injured(Local_410.f_3)) && is_vehicle_driveable(Local_410.f_4, 0))
				{
					...
					set_entity_coords(player_ped_id(), vVar9, 1, false, 0, 1);
					set_entity_coords(Local_410.f_3, vVar6, 1, false, 0, 1);
					set_entity_heading(player_ped_id(), func_162(get_entity_coords(player_ped_id(), 1), get_entity_coords(Local_410.f_3, 1)));
					set_entity_heading(Local_410.f_3, func_162(get_entity_coords(Local_410.f_3, 1), get_entity_coords(player_ped_id(), 1)));
					func_154(&(Local_410.f_3));
				}
...
{
	if (func_178() && get_game_timer() >= iParam0 + 1000)
	{
...
void func_211()
{
	...
	{
		case -1:
			if (!does_entity_exist(iLocal_850))
			{
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_148(player_ped_id(), *uParam0.f_3, 1) < 20f && func_159(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_159(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
bool func_252(auto uParam0, int iParam1)
{
	...
	if (func_138(*uParam0.f_44, 8))
	{
		if (!func_138(*uParam0.f_44, 128))
		{
			if (is_ped_jacking(player_ped_id()) && !func_138(*uParam0.f_44, 256))
			{
				func_55(uParam0.f_44, 256);
			}
			if (func_138(*uParam0.f_44, 256) && is_ped_in_any_vehicle(player_ped_id(), 0))
			{
	...
	if (!func_256(uParam0, iParam1))
	{
		...
		if ((is_ped_injured(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_317(*uParam0.f_3, 1) > 400f)
		{
...
bool func_325(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_148(player_ped_id(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
...
bool func_390(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_391(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_148(player_ped_id(), iParam0, 1) < 40f)
						{
