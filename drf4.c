...
void main()
{
	...
	iLocal_70 = func_121();
	func_120(&sLocal_49, iLocal_70);
	iVar1 = func_119(0) < func_118(iLocal_70);
	while (true)
	{
		wait(0);
		switch (iLocal_48)
		{
			case 0:
				...
				{
					func_78(&uLocal_74, &uLocal_335, &uLocal_524, &iLocal_1261, &uLocal_769, &uLocal_878, &iLocal_1262, &uLocal_1043, &uLocal_1152, &iLocal_1263, &sLocal_49, iLocal_70);
					Global_88072 = 0;
					func_112(&uLocal_239, &uLocal_335, iLocal_1261);
					func_112(&uLocal_287, &uLocal_524, iLocal_1261);
			...
			case 3:
				...
				if (is_ped_jumping_out_of_vehicle(PLAYER::PLAYER_PED_ID()) || is_entity_in_water(PLAYER::PLAYER_PED_ID()))
				{
					func_47(0);
				}
				if (func_46())
				{
					if ((!iVar1 && iVar3) && ((func_121() == 2 && iVar0 >= 8) || (func_121() == 3 && iVar0 >= 10)))
					{
						iLocal_48 = 4;
					}
					else
...
void func_3(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_5(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_5(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
int func_13(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_14(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}

bool func_14(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_17(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_19() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_19() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_18(iParam0));
...
int func_21(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_19() /*10375*/].f_7704.f_10, iParam0);
}
...
void func_30(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
void func_51(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2283, 24);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&Global_2283, 24);
	}
}
...
bool func_54(auto uParam0, float fParam1)
{
	if (func_58(uParam0))
	{
...
{
	*iParam0.f_1 = func_56(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1;
...
bool func_64(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
	int iVar0;
	int iVar1;
	
	if (GAMEPLAY::IS_BIT_SET(Global_2284, 9))
	{
		return false;
	}
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2284, 9);
...
int func_65(int iParam0, auto uParam1, int iParam2, char* sParam3, auto uParam4, auto uParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
bool func_66(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_76(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_77(int iParam0, auto uParam1, int iParam2, char* sParam3, auto uParam4, auto uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_78(auto uParam0, auto uParam1, auto uParam2, int iParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, char* sParam10, int iParam11)
{
	int iVar0;
	struct<4> Var1;
	auto uVar5;
...
void func_79(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, int iParam6)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
void func_80(auto uParam0, auto uParam1, auto uParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	char[16] cVar0;
	int iVar4;
	int iVar5;
...
void func_81(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	int iVar0;
...
void func_82(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
struct<4> func_83(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	char[16] cVar0;
	int iVar4;
	...
	StringCopy(&cVar0, "DRF_PR_", 16);
	switch (iVar4)
	{
		case 1:
			StringConCat(&cVar0, "1_A", 16);
			*uParam1 = 3;
			break;
		
		case 2:
			StringConCat(&cVar0, "1_B", 16);
			*uParam1 = 5;
			break;
		
		case 3:
			StringConCat(&cVar0, "1_C", 16);
			*uParam1 = 3;
			break;
		
		case 4:
			StringConCat(&cVar0, "1_D", 16);
			*uParam1 = 3;
			break;
		
		case 5:
			StringConCat(&cVar0, "1_STR", 16);
			*uParam1 = 3;
			break;
		
		case 6:
			StringConCat(&cVar0, "5_T1B", 16);
			*uParam1 = 5;
			break;
		
		case 7:
			StringCopy(&cVar0, "5_T1C", 16);
			*uParam1 = 4;
			break;
		
		case 8:
			StringConCat(&cVar0, "5PROA", 16);
			*uParam1 = 5;
			break;
		
		case 9:
			StringConCat(&cVar0, "5PROB", 16);
			*uParam1 = 5;
			break;
		
		case 10:
			StringConCat(&cVar0, "5STRA", 16);
			*uParam1 = 7;
			break;
		
		case 11:
			StringConCat(&cVar0, "5STRB", 16);
			*uParam1 = 4;
			break;
		
		case 12:
			StringConCat(&cVar0, "5_NON", 16);
			*uParam1 = 5;
			break;
	}
	return cVar0;
...
int func_89(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 > 12)
	{
		return false;
...
void func_92(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_93(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
struct<4> func_94(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	char[16] cVar0;
	int iVar4;
	int iVar5;
	...
	if ((((!func_99(&(Global_101154.f_18651), 8) && iParam1) && iParam0 != 4) && func_97(3) > 0) && get_random_float_in_range(0f, 1f) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
...
void func_95(auto uParam0, int iParam1, int iParam2)
{
...
int func_98(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_100(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
void func_101(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
...
void func_102(auto uParam0, auto uParam1, auto uParam2, char* sParam3, int iParam4)
{
	int iVar0;
...
struct<4> func_106(int iParam0, auto uParam1, auto uParam2, int iParam3)
{
	char[16] cVar0;
...
void func_110(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	char[16] cVar0;
	int iVar4;
	...
	func_80(uParam0, uParam1, uParam2, &cVar0, 0, iVar4, 0);
	switch (iParam3)
	{
		case 2:
			StringCopy(&cVar0, "DRF_OVR_2", 16);
			break;
		
		case 3:
			StringCopy(&cVar0, "DRF_OVR_5", 16);
			break;
	}
	StringCopy(uParam0[*uParam2 /*4*/], "DRF_OVR", 16);
	*(uParam1[*uParam2 /*4*/]) = {cVar0};
	*uParam2++;
}
...
void func_112(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
auto func_113(auto uParam0)
{
	return uParam0;
}

bool func_114(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	if (Global_88072 != 0 && GAMEPLAY::GET_GAME_TIMER() - Global_88072 < 1800000)
	{
		return false;
	}
	request_additional_text("SHRINK", false);
	...
	func_111(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_111(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_88072 = GAMEPLAY::GET_GAME_TIMER();
	return true;
}

bool func_115(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
void func_116(auto uParam0, int iParam1)
{
	...
	*uParam0 -= (*uParam0 && shift_left(3, 5));
