#region Local Var
	...
	int iLocal_235 = 0;
	int iLocal_236 = 0;
	struct<7> Local_237 = 0;
	struct<7> Local_244 = 0;
	struct<6> Local_251 = 0;
	struct<6> Local_257 = 0;
	int iLocal_263 = 0;
	int iLocal_264 = 0;
	int iLocal_265 = 0;
	int iLocal_266 = 0;
	...
	auto uLocal_440 = 0;
	auto uLocal_441 = 0;
	auto uLocal_442 = 1000;
	auto uLocal_443 = 1000;
	auto uLocal_444 = 0;
	char* sLocal_445 = 0;
	char* sLocal_446 = 0;
	char* sLocal_447 = 0;
...
void func_13(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_15(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_15(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_31()
{
	if (iLocal_92 == 1)
	{
		if ((func_225(1000) && iLocal_207) && !iLocal_202)
		{
			iLocal_92 = 3;
		}
	}
	...
	switch (iLocal_92)
	{
		case 0:
			...
			if (func_192(1, 0, 1))
			{
				...
				{
					func_186("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
				}
...
void func_32(int iParam0, Vector3 vParam1, Vector3 fParam2)
{
	if (func_424(iParam0))
	{
...
int func_33(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_50(int iParam0)
{
	if (iParam0)
	{
		if (!is_ped_dead_or_dying(PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				set_ped_can_be_shot_in_vehicle(PLAYER::PLAYER_PED_ID(), 0);
			}
			...
			clear_entity_last_weapon_damage(PLAYER::PLAYER_PED_ID());
		}
	...
	else
	{
		if (!is_ped_dead_or_dying(PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				set_ped_can_be_shot_in_vehicle(PLAYER::PLAYER_PED_ID(), 1);
			}
			set_entity_can_be_damaged(PLAYER::PLAYER_PED_ID(), 1);
...
void func_51(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
bool func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (is_bit_set(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_63(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_63(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_63(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_94(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_63(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_63(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_63(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_54(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_166(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_59(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_166(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_63(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						*iParam0[func_82(vVar16.z)] = func_76(iParam1, vVar16.x, func_82(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_63(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
void func_95(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_99(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_98(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_96(uVar2, iVar3, iVar0, 1);
	}
}

void func_96(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_97(iParam2)];
	if (iVar0 != 0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_97(iParam1)];
...
int func_99(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_100(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
	...
	*uParam0.f_12 = func_110(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_98(func_108(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_106(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_98(uVar1, Global_69309, 0);
				if (!is_bit_set(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
void func_111(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_63(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
bool func_166(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_63(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_63(iParam1)))
	{
		return true;
	}
	return false;
...
void func_168(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_169(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_169(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_173(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_171(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_172(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_172(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_173(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_175(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_174(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_174(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_174(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_174(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_174(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_174(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_174(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_174(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_174(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_174(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_174(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_174(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_174(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_174(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_174(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_174(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_174(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_175(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_177(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_169(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}
...
bool func_181(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_185(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_184(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_185(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_187(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<50> Var2;
...
void func_188(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_189(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_97(iParam1)];
...
void func_190(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_191(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
bool func_193(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_219(1, vLocal_209, 0))
			{
				if (!func_427())
				{
					if ((((func_219(3, Local_237.f_1, Local_237.f_4) && func_219(4, Local_244.f_1, Local_244.f_4)) && func_219(8, Local_251.f_1, Local_251.f_4)) && func_219(5, Local_251.f_1, Local_251.f_4)) && func_219(6, Local_257.f_1, Local_257.f_4))
					{
						...
						{
							func_217(Local_237, 0);
						}
						if (func_424(Local_244))
						{
							func_217(Local_244, 0);
						}
		...
		case 1:
			...
			{
				func_215();
				if (((((((func_219(2, vLocal_209, 0) && func_219(3, Local_237.f_1, Local_237.f_4)) && func_219(4, Local_244.f_1, Local_244.f_4)) && func_219(8, Local_251.f_1, Local_251.f_4)) && func_219(9, vLocal_209, 0)) && func_219(5, Local_251.f_1, Local_251.f_4)) && func_219(7, vLocal_209, 0)) && func_219(6, Local_257.f_1, Local_257.f_4))
				{
					set_vehicle_colour_combination(Local_257, true);
					iLocal_231 = 0;
					iLocal_232 = false;
					if (!func_427())
					{
			...
			else if (func_219(9, vLocal_209, 0) && func_219(7, vLocal_209, 0))
			{
				return true;
			}
			break;
		...
		case 2:
			if (iParam1)
			{
				if ((((((func_219(3, Local_237.f_1, Local_237.f_4) && func_219(4, Local_244.f_1, Local_244.f_4)) && func_219(8, Local_251.f_1, Local_251.f_4)) && func_206(&Local_257, Local_257.f_5, Local_257.f_1, Local_257.f_4, 1)) && func_219(9, vLocal_209, 0)) && func_219(5, Local_251.f_1, Local_251.f_4)) && func_219(7, vLocal_209, 0))
				{
					set_vehicle_colour_combination(Local_257, true);
					iLocal_231 = 0;
					iLocal_232 = false;
					...
					{
						set_ped_movement_clipset(iLocal_263, "move_injured_generic", 0.25f);
						task_follow_nav_mesh_to_coord(iLocal_263, vLocal_212, 1f, 60000, 0.25f, 0, 1193033728);
					}
					if (func_424(Local_237))
					{
					...
					if (func_424(Local_244))
					{
						set_ped_into_vehicle(Local_244, Local_251, false);
					}
					set_entity_coords(Local_251, -1106.365f, -579.0142f, 31.1366f, 1, true, 0, 1);
					...
					if (!func_205())
					{
						...
						iLocal_265 = func_204(-1176.525f, -550.9145f, 27.73062f, 15f);
						...
						set_ped_using_action_mode(PLAYER::PLAYER_PED_ID(), true, -1, "DEFAULT_ACTION");
		...
		case 4:
			if (iParam1)
			{
				...
				{
					set_vehicle_colour_combination(Local_257, true);
					set_ped_using_action_mode(PLAYER::PLAYER_PED_ID(), false, -1, "DEFAULT_ACTION");
					iLocal_231 = 1;
					iLocal_232 = false;
					if (!func_427())
					{
		...
		case 6:
			if (iParam1)
			{
				...
				while (!has_cutscene_loaded())
				{
					if (_0xB56BBBCC2955D9CB())
					{
						_0x2A56C06EBEF2B0D9("Michael", PLAYER::PLAYER_PED_ID(), false);
					}
					wait(false);
				}
				iLocal_202 = false;
...
struct<2> func_196(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_203(Vector3 fParam0, Vector3 fParam1)
{
	if (func_8(Local_251) && func_424(Local_237))
	{
		set_vehicle_engine_on(Local_251, true, 1, 0);
		set_vehicle_forward_speed(Local_251, fParam0);
		set_entity_load_collision_flag(Local_237, true);
		task_vehicle_drive_to_coord(Local_237, Local_251, -1106.365f, -579.0142f, 31.1366f, fParam1, 0, false, 36438053, 2f, 0.5f);
		set_vehicle_tyres_can_burst(Local_251, false);
		iLocal_222 = GAMEPLAY::GET_GAME_TIMER();
		iLocal_94 = 1;
	}
}

int func_204(Vector3 vParam0, float fParam1)
{
	Vector3 vVar0;
...
bool func_206(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_208(int iParam0, char* sParam1, int iParam2)
{
...
void func_209(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
bool func_219(int iParam0, Vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
			if (func_222(vParam1, vLocal_209, 1056964608, 0) && fParam4 == 0f)
			{
				return true;
			}
			break;
		...
		case 1:
			...
			request_additional_text(sLocal_204, false);
		...
		case 8:
			if (func_8(Global_88108[0]))
			{
				...
				Local_251 = Global_88108[0];
				if (func_8(Local_251))
				{
					set_vehicle_model_is_suppressed(Local_251.f_5, true);
		...
		case 6:
			if (func_8(Global_88108[1]))
			{
				...
				Local_257 = Global_88108[1];
				if (func_8(Local_257))
				{
					set_vehicle_colour_combination(Local_257, true);
					set_vehicle_model_is_suppressed(Local_257.f_5, true);
		...
		case 5:
			if (func_424(Global_88108.f_9[2]))
			{
				...
				if (func_424(iLocal_263))
				{
					...
					set_ped_can_be_targetted(iLocal_263, false);
					set_entity_proofs(iLocal_263, true, false, false, false, true, false, 0, false);
					return true;
				}
			}
...
bool func_220(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_208(iParam1, "Loading", 0))
...
bool func_222(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_227()
{
	...
	{
		case 0:
			if (func_193(iLocal_91, iLocal_202))
			{
				func_241(0);
				func_194(24, 0);
				func_240(1);
		...
		case 1:
			...
			{
				if (func_236(PLAYER::PLAYER_PED_ID(), vLocal_212, 4f) || iLocal_96 != 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_235(5f, 6))
				...
				{
					is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_212, 4f, 4f, 2f, true, true, 0);
					func_232(&iLocal_206, vLocal_212, 0);
					if (iLocal_229 == 0)
					{
						_0x3D3D15AF7BCAAF83(12, 1, 0);
						_0xA905192A6781C41B(vLocal_215);
...
void func_232(int iParam0, Vector3 vParam1, int iParam2)
{
	if (!does_blip_exist(*iParam0))
	{
		*iParam0 = func_233(vParam1, 5, iParam4);
	}
}
...
bool func_234()
{
	switch (iLocal_96)
	{
		case 0:
			...
			task_go_straight_to_coord(PLAYER::PLAYER_PED_ID(), -1011.155f, -479.7716f, 38.97575f, 1f, -1, 40000f, 0.2f);
			_disable_first_person_cam_this_frame();
			iLocal_96 = 1;
			break;
		
		case 1:
			iLocal_208 = create_camera_with_params(26379945, -1017f, -483.5f, 40.7f, 49.6f, 0f, -78.9f, 50f, 0, 2);
			shake_cam(iLocal_208, "hand_shake", 0.5f);
			set_cam_active(iLocal_208, true);
			render_script_cams(true, true, 3500, 1, 1, 0);
			iLocal_222 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_96 = 2;
			break;
...
bool func_235(float fParam0, int iParam1)
{
	int iVar0;
...
int func_236(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_237()
{
	if (iLocal_91 == 2)
	{
		if (func_238(&uLocal_97, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
		{
			request_cutscene("sol_2_ext_concat", 8);
			if (_0xB56BBBCC2955D9CB())
			{
	...
	else if (func_236(PLAYER::PLAYER_PED_ID(), vLocal_212, 100f))
	{
		request_cutscene("sol_2_ext_concat", 8);
		if (_0xB56BBBCC2955D9CB())
		{
	...
	else if (!func_236(PLAYER::PLAYER_PED_ID(), vLocal_212, 120f))
	{
		if (has_cutscene_loaded())
		{
			remove_cutscene();
...
int func_238(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_242()
{
	if (!is_audio_scene_active("SOL_2_CAR_CHASE"))
	{
		if (iLocal_91 == 2)
		{
			if ((func_8(Local_251) && func_424(Local_237)) && is_ped_in_vehicle(Local_237, Local_251, 0))
			{
				_0x153973AB99FE8980(Local_251, "SOL_2_ROCCOS_CAR", 0f);
				start_audio_scene("SOL_2_CAR_CHASE");
			}
		}
	}
	else if (func_424(Local_237))
	{
		if (func_8(Local_251))
		{
			if (!is_ped_in_any_vehicle(Local_237, 0))
			{
				_0x18EB48CFC41F2EA0(Local_251, 0f);
			}
		}
	}
...
void func_243()
{
	...
	switch (iLocal_92)
	{
		case 0:
			...
			if (func_193(iLocal_91, iLocal_202))
			{
				func_221(&uLocal_268, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
bool func_244(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
int func_248(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	...
	Global_2621441 = 0;
	return func_249(sParam3, iParam4, iParam11);
}
...
void func_256(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_319(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_312(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_259(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_260(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_260(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_299();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_276())
		{
			func_188(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_262(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_263(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_265(auto uParam0, int iParam1, int iParam2)
{
...
void func_270(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_271(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_272(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_273(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_275(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
int func_287(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_288(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_298())
		{
			*uParam0 = func_294(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_290(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_292() == 0)
		{
			return is_bit_set(func_98(func_291(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_294(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_302(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
auto func_304(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_305(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_322()
{
	...
	switch (iLocal_92)
	{
		...
		case 1:
			...
			if (!func_236(PLAYER::PLAYER_PED_ID(), vLocal_218, 60f))
			{
				iLocal_92 = 2;
			}
			break;
	...
	switch (iLocal_92)
	{
		case 0:
			if (func_193(iLocal_91, iLocal_202))
			{
				...
				{
					set_entity_visible(iLocal_264, false, 0);
					set_entity_collision(iLocal_264, false, 0);
				}
				else
				{
					iLocal_264 = get_closest_object_of_type(-1172.767f, -555.1904f, 27.75178f, 6f, joaat("prop_roadcone02a"), 1, 0, 1);
				}
				iLocal_95 = 2;
				if (func_427())
				{
		...
		case 1:
			...
			if (!func_424(Local_237))
			{
				...
				if (!iLocal_448)
				{
					if (func_374(0, &iLocal_448, "SOL2_MKT", 1092616192, 7))
					{
						if (prepare_music_event("SOL2_STOP"))
						{
							trigger_music_event("SOL2_STOP");
						}
						vLocal_218 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
						if (func_8(Local_251))
						{
				...
				if ((!func_424(Local_244) && iLocal_449) && iLocal_448)
				{
					_set_unk_map_flag(0);
					iLocal_92 = 2;
				}
			...
			{
				func_349();
				func_348(Local_237.f_6, Local_237, 550f, 0.65f, 0);
				if (!func_30())
				{
					func_230("SOL2_KILL");
				}
				func_326(&uLocal_433, Local_237, 0, 0, 1, 1, 1);
			}
			break;
...
{
	func_327(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_327(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	func_328(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}
...
void func_329(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	if (func_345(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
		...
		if (!is_gameplay_hint_active())
		{
			if (func_340(uParam0, iParam7, iParam9, 0))
			{
				func_337(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
bool func_334(char* sParam0)
{
	if (!func_335(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_347(sParam0)) || func_347("CMN_HINT"))
		{
			clear_help(1);
		}
		return false;
...
void func_337(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_340(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_343(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				if (*uParam0.f_6 == 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
					{
						if (func_342(iParam1, iParam2, iParam3))
						{
							*uParam0.f_5 = 0;
						}
					}
					else if (func_341(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_341(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				else if (*uParam0.f_6 == 2)
				{
					...
					else if (func_342(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
void func_349()
{
	if (iLocal_235 != -1)
	{
		if (func_353() > 20f)
		{
			...
			{
				if (func_352(PLAYER::PLAYER_PED_ID(), Local_237, 30f, 1))
				{
				...
				else if (!func_352(PLAYER::PLAYER_PED_ID(), Local_237, 365f, 1) && func_352(PLAYER::PLAYER_PED_ID(), Local_237, 480f, 1))
				{
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_235 > 5000)
					{
				...
				else if ((!func_352(PLAYER::PLAYER_PED_ID(), Local_237, 260f, 1) && func_352(PLAYER::PLAYER_PED_ID(), Local_237, 365f, 1)) && func_352(PLAYER::PLAYER_PED_ID(), Local_237, 480f, 1))
				{
...
int func_350(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
float func_353()
{
	if (func_424(iLocal_263))
	{
		return func_354(iLocal_263, PLAYER::PLAYER_PED_ID(), 1);
	}
	return 50f;
}

auto func_354(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_355(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
...
void func_356()
{
	if (func_424(Local_244))
	{
		if (iLocal_91 == 4)
		{
			if (!func_352(PLAYER::PLAYER_PED_ID(), Local_244, 200f, 1))
			{
		...
		if (iLocal_95 != 3)
		{
			...
			{
				task_combat_ped(Local_244, PLAYER::PLAYER_PED_ID(), 0, 16);
				func_358(&(Local_244.f_6), Local_244, 0, 1);
				iLocal_95 = 3;
			}
			if (!func_424(Local_237))
			{
		...
		{
			case 1:
				if (!func_184(Local_244, 2104565373))
				{
					iLocal_95 = 2;
				}
				break;
			...
			case 2:
				if (!iLocal_221)
				{
					if (!func_238(&uLocal_97, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)) && !func_238(&uLocal_97, get_entity_coords(Local_244, 1)))
					{
						iLocal_221 = 1;
					}
				}
				else if (func_352(Local_244, PLAYER::PLAYER_PED_ID(), 20f, 1))
				{
					task_drive_by(Local_244, PLAYER::PLAYER_PED_ID(), false, vLocal_209, 35f, 65, 0, -753768974);
				}
				break;
			...
			case 3:
				if (!iLocal_453)
				{
					if (!is_ped_in_any_vehicle(Local_244, 0))
					{
						func_374(Local_244, &iLocal_453, "SOL2_GSG", 20f, 7);
					}
				}
				break;
		}
	...
	else
	{
		if (!iLocal_449)
		{
			func_374(0, &iLocal_449, "SOL2_MKT", 1092616192, 7);
			if (func_424(Local_237) && ENTITY::DOES_ENTITY_EXIST(Local_244))
			{
				if (func_352(Local_244, Local_237, 10f, 1) && func_352(Local_237, PLAYER::PLAYER_PED_ID(), 10f, 1))
				{
...
void func_357(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_358(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		*uParam0 = func_359(iParam1, iParam3, iParam2, 5);
	}
}
...
void func_360()
{
		...
		switch (iLocal_94)
		{
			...
			case 2:
				if (func_8(Local_251))
				{
					if (is_ped_in_vehicle(Local_237, Local_251, 0))
					{
						if (func_236(Local_237, -1106.365f, -579.0142f, 31.1366f, 8f))
						{
							func_365(Local_237, "Sol1Roco1", 0, 520);
							iLocal_94 = 3;
						}
					}
					else
				...
				if (func_8(Local_251))
				{
					if (is_ped_in_vehicle(Local_237, Local_251, 0))
					{
						if (is_waypoint_playback_going_on_for_vehicle(Local_251))
						{
							...
							{
								task_vehicle_mission_ped_target(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 550f, 2f, 1);
								set_vehicle_tyres_can_burst(Local_251, true);
								iLocal_94 = 4;
							}
						}
					}
			...
			case 5:
				if (is_ped_in_any_vehicle(Local_237, 0) && !func_184(Local_237, -828834893))
				{
					task_leave_any_vehicle(Local_237, false, 0);
				}
				else
				{
					func_364(Local_237, 0);
				}
				break;
			...
			case 7:
				if (func_236(Local_237, -1844.916f, -1224.451f, 12.01705f, 6f))
				{
					func_364(Local_237, 1);
					iLocal_94 = 5;
				}
	...
	{
		if (func_424(Local_244) && ENTITY::DOES_ENTITY_EXIST(Local_237))
		{
			if (func_352(Local_237, Local_244, 10f, 1) && func_352(Local_244, PLAYER::PLAYER_PED_ID(), 10f, 1))
			{
...
void func_364(int iParam0, int iParam1)
{
	if (func_424(iParam0))
	{
		if (!func_184(iParam0, 1805844857))
		{
			...
			task_smart_flee_ped(iParam0, PLAYER::PLAYER_PED_ID(), 550f, -1, 1, 0);
...
void func_365(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	if (func_424(iParam0))
	{
		...
		{
			task_vehicle_follow_waypoint_recording(iParam0, Local_251, sParam1, 786468, iParam2, iParam3, -1, -1f, 0, 2f);
		}
	}
}
...
void func_366()
{
	if ((iLocal_94 > 3 && iLocal_94 != 5) && iLocal_94 != 7)
	{
		if (func_8(Local_251))
		{
			if (!iLocal_230)
			{
				if (func_352(Local_237, PLAYER::PLAYER_PED_ID(), 120f, 1))
				{
					task_vehicle_mission_ped_target(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 50f, 34340900, 200f, 2f, 1);
					iLocal_230 = 1;
				}
			}
			else if (!func_352(Local_237, PLAYER::PLAYER_PED_ID(), 145f, 1))
			{
				task_vehicle_mission_ped_target(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 200f, 2f, 1);
				iLocal_230 = 0;
			}
		}
	}
...
void func_367()
{
	if (iLocal_94 != 7)
	{
		if (is_entity_in_angled_area(Local_237, -1737.935f, -1125.939f, 12.01733f, -1751.796f, -1114.709f, 16.0172f, 8.77f, 0, true, 0))
		{
			if (func_8(Local_251))
			{
...
void func_368()
{
	if (func_8(Local_251))
	{
		if (is_ped_in_vehicle(Local_237, Local_251, 1))
		{
			...
			{
				func_369(&(Local_237.f_6), Local_251, 0);
				iLocal_226 = 1;
			}
		}
		...
		{
			func_358(&(Local_237.f_6), Local_237, 0, 1);
		}
	}
	else if (does_blip_exist(Local_237.f_6))
	{
...
void func_369(auto uParam0, int iParam1, int iParam2)
{
	if (!does_blip_exist(*uParam0))
	{
...
void func_371()
{
	if (!iLocal_231)
	{
		if (func_424(iLocal_263))
		{
			if (!func_352(PLAYER::PLAYER_PED_ID(), iLocal_263, 100f, 1))
			{
				iLocal_231 = 1;
				func_9(&iLocal_263);
			}
			...
			{
				if (func_352(PLAYER::PLAYER_PED_ID(), iLocal_263, 15f, 1))
				{
					if (iLocal_233 == -1)
					{
						if (!func_30())
					...
					{
						if (GAMEPLAY::GET_GAME_TIMER() - iLocal_233 > 15000 && !is_message_being_displayed())
						{
	...
	if (!iLocal_232)
	{
		if (func_8(Local_257))
		{
			if (!func_352(PLAYER::PLAYER_PED_ID(), Local_257, 100f, 1))
			{
				func_6(&Local_257);
			}
...
auto func_374(int iParam0, int iParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*iParam1)
	{
		if (!func_30() && is_screen_faded_in())
		{
			...
			{
				*iParam1 = func_350(&uLocal_268, sLocal_267, sParam2, iParam4, 0, 0, 0);
			}
		}
	}
...
bool func_377(int iParam0, float fParam1)
{
	...
	{
		if (func_354(PLAYER::PLAYER_PED_ID(), iParam0, 0) <= fParam1 && func_378(iParam0, PLAYER::PLAYER_PED_ID()))
		{
			return true;
		}
	}
...
void func_379()
{
	...
	switch (iLocal_92)
	{
		case 0:
			if (!iLocal_202)
			{
				...
				if (func_192(1, 0, 1))
				{
					...
					if (func_181(1, 1093140480, 0))
					{
						if (((func_424(iLocal_263) && func_8(Local_251)) && func_424(Local_237)) && func_424(Local_244))
						{
							register_entity_for_cutscene(iLocal_263, "Soloman", 0, joaat("cs_solomon"), 0);
							register_entity_for_cutscene(Local_251, "getaway_car", 0, false, 0);
							register_entity_for_cutscene(Local_237, "Rocco", 0, false, 0);
							register_entity_for_cutscene(Local_244, "Rocco_Goon", 0, false, 0);
						}
						start_cutscene(0);
						_0x208784099002BC30("M_TheBalladOfRocco", 0);
						_0x48621C9FCA3EBD28(4);
		...
		case 1:
			...
			{
				set_ped_using_action_mode(PLAYER::PLAYER_PED_ID(), true, -1, "DEFAULT_ACTION");
				force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -530524, false, 1, 1);
				simulate_player_input_gait(player_id(), 2f, 2000, 0, 1, 0);
			}
			if (can_set_exit_state_for_registered_entity("Rocco", false))
			{
				if (func_424(Local_237) && func_8(Local_251))
				{
					set_ped_into_vehicle(Local_237, Local_251, -1);
					_0x2208438012482A1A(Local_237, 0, 0);
				}
			}
			if (can_set_exit_state_for_registered_entity("Rocco_Goon", false))
			{
				if (func_424(Local_244) && func_8(Local_251))
				{
					set_ped_into_vehicle(Local_244, Local_251, false);
					_0x2208438012482A1A(Local_244, 0, 0);
				}
			}
			if (can_set_exit_state_for_registered_entity("getaway_car", false))
			{
				if (func_8(Local_251))
				{
					if (!was_cutscene_skipped())
		...
		case 2:
			...
			{
				set_ped_movement_clipset(iLocal_263, "move_injured_generic", 0.25f);
				task_follow_nav_mesh_to_coord(iLocal_263, vLocal_212, 0.2f, 60000, 0.25f, 0, 1193033728);
			}
			_0x81CBAE94390F9F89();
			func_228(0);
			break;
...
void func_380(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_408(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_405(get_entity_coords(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_381(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_381(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		if (func_287(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_398(iParam5, &Var0, vParam1, fParam4, func_267(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_171(iParam0, 0, 0)) || func_171(iParam0, 1, 0)) || func_171(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_396(iParam0)) || func_395(iParam0)) || func_394(iParam0)) || func_393(iParam0)) || !func_385(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_395(iParam0))
		{
		}
...
int func_397(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_398(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_397(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
bool func_405(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_406(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_406(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_412(int iParam0)
{
	...
	func_415();
	func_414();
	remove_relationship_group(iLocal_266);
	if (func_424(PLAYER::PLAYER_PED_ID()))
	{
		set_ped_using_action_mode(PLAYER::PLAYER_PED_ID(), false, -1, "DEFAULT_ACTION");
	}
	...
	_0x3DDA37128DD1ACA8(0);
	func_241(0);
	remove_scenario_blocking_area(iLocal_265, 0);
...
void func_423()
{
	if (func_424(Local_237))
	{
		if (!func_352(PLAYER::PLAYER_PED_ID(), Local_237, 550f, 1))
		{
			func_422(1);
		}
	}
...
void func_433(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0.f_46 = *uParam1.f_46;
	while (iVar1 < *uParam1.f_46)
	{
		...
		if (func_238(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = {-vVar9};
		}
...
void func_435(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
struct<7> func_438(Vector3 vParam0, float fParam1, int iParam2)
{
	struct<7> Var0;
...
struct<6> func_440(Vector3 vParam0, float fParam1, int iParam2)
{
	struct<6> Var0;
...
void func_441()
{
	func_240(1);
	func_442(1);
	set_vehicle_model_is_suppressed(Local_251.f_5, false);
	set_vehicle_model_is_suppressed(Local_257.f_5, false);
	set_ped_model_is_suppressed(Local_244.f_5, false);
	_set_unk_map_flag(0);
	if (is_audio_scene_active("SOL_2_CAR_CHASE"))
	{
		stop_audio_scene("SOL_2_CAR_CHASE");
