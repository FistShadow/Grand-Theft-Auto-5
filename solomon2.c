...
void func_237()
{
	if (iLocal_91 == 2)
	{
		if (func_238(&uLocal_97, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
		{
			request_cutscene("sol_2_ext_concat", 8);
			if (_0xB56BBBCC2955D9CB())
			{
...
bool func_288(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_298())
		{
			*uParam0 = func_294(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_294(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_297(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_295(iVar0, 0), 1);
	...
	if (func_424(Local_244))
	{
		...
		switch (iLocal_95)
		{
			...
			case 2:
				if (!iLocal_221)
				{
					if (!func_238(&uLocal_97, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) && !func_238(&uLocal_97, ENTITY::GET_ENTITY_COORDS(Local_244, 1)))
					{
						iLocal_221 = 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_408(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_405(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
