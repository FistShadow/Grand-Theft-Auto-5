...
void main()
{
	...
	while (true)
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Global_91330.f_295 = get_room_key_from_entity(PLAYER::PLAYER_PED_ID());
		}
		else
		{
	...
	if (!iLocal_150 || iLocal_151 < 45)
	{
		...
		while (iVar1 < 2)
		{
			...
			if (iVar0 < 45)
			{
				...
				func_64(iVar4);
				if (!GAMEPLAY::IS_BIT_SET(iLocal_209[iVar4 / 32], iVar4 % 32))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(iLocal_209[iVar4 / 32]), iVar4 % 32);
		...
		while (iVar0 < iVar5)
		{
			...
			if (func_47(iLocal_163[iVar0]) && (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_46(iLocal_227)))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_209[iLocal_163[iVar0] / 32], iLocal_163[iVar0] % 32))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(iLocal_209[iLocal_163[iVar0] / 32]), iLocal_163[iVar0] % 32);
...
void func_3(int iParam0, int iParam1)
{
	...
	if (Global_91330.f_156[iParam0] || iParam1)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (func_30(iParam0))
			{
				if ((GAMEPLAY::IS_BIT_SET(Global_101154.f_668[iParam0], false) && (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 5) || !func_29(iParam0))) && !func_27(iParam0))
				{
					iVar0 = true;
				}
				if (func_26(iVar2))
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (func_90() == 0)
			{
				if ((((((((!Global_91330.f_8 && !Global_91330.f_9[func_31(iParam0)]) && GAMEPLAY::IS_BIT_SET(func_88(func_89(iParam0), -1, 0), false)) && (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 5) || !func_29(iParam0))) && func_11(iParam0)) && !iLocal_146) && !func_27(iParam0)) && !Global_1315838) && !Global_1573828)
				{
					iVar0 = true;
				}
				switch (iVar2)
...
int func_5(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_90() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_88(func_89(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_17(int iParam0)
{
	switch (iParam0)
	{
		...
		case 28:
			if (((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_22(37)) && !func_21(37)) && !func_18(2))
			{
				return 363;
			}
			else
...
void func_23(int iParam0, int iParam1)
{
	...
	if (iParam1 == GAMEPLAY::IS_BIT_SET(Global_25433[iVar0 /*23*/].f_11, true))
	{
		return;
	}
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), true);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_25433[iVar0 /*23*/].f_11), true);
	}
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
...
int func_26(auto uParam0)
{
	...
	{
		return GAMEPLAY::IS_BIT_SET(Global_101154.f_668.f_47, iVar0);
	}
	return false;
}
...
void func_48(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 17) || (!func_47(iParam0) && (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 16) || _get_number_of_instances_of_streamed_script(get_hash_key(&Var0)) == 0)))
			{
				func_51(iParam0);
			}
		}
		...
		{
			if (((func_47(iParam0) && (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_46(iLocal_227))) && !GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 16)) && ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_11(iParam0)) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_30(iParam0))))
			{
			...
			if (SCRIPT::HAS_SCRIPT_LOADED(&Var0) && (iVar8 == 1 || SCRIPT::HAS_SCRIPT_LOADED(&Var4)))
			{
				if (_get_free_stack_slots_count(2224) >= uVar9[0] && _get_free_stack_slots_count(2816) >= uVar9[1])
				{
					if (!network_is_script_active(&Var0, iParam0, 1, 0) && (iVar8 == 1 || !network_is_script_active(&Var4, iParam0, 1, 0)))
					{
						...
						Global_91330.f_63[iParam0] = NETWORK::NETWORK_IS_GAME_IN_PROGRESS();
						SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Var0);
						if (iVar8 == 2)
						{
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Var4);
						}
...
void func_51(int iParam0)
{
	if (Global_91330.f_17[iParam0])
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 7))
		{
			switch (func_31(iParam0))
			{
				case 0:
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 7);
					}
					break;
		...
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 17);
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 10);
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 11);
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 19);
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 16);
		func_57(iParam0, 0);
		func_4(iParam0, 1, 1);
		func_4(iParam0, 10, 1);
		func_4(iParam0, 11, 1);
					...
					if (Global_101154.f_668.f_58[iLocal_227 /*5*/])
					{
						if (!Global_101154.f_668.f_58[iLocal_227 /*5*/].f_2)
						{
							if (!Global_101154.f_24643[iLocal_227 /*43*/].f_40)
							{
								...
								{
									if (GAMEPLAY::GET_GAME_TIMER() - iLocal_94 > get_milliseconds_per_game_minute() * 60)
									{
										iLocal_94 = GAMEPLAY::GET_GAME_TIMER();
										Global_101154.f_668.f_58[iLocal_227 /*5*/].f_3--;
									}
...
{
	Global_91330.f_248[iParam0] = get_distance_between_coords(func_8(iParam0, 0), get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 1);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87(iParam0))
		{
			uLocal_95[iParam0] = GAMEPLAY::GET_GAME_TIMER() + 10000;
		}
	}
	if (func_83(iParam0, uParam1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], false))
		{
			func_50("Opening shop", iParam0);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), false);
			func_56(iParam0);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], false))
	{
		func_50("Closing shop", iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), false);
		func_56(iParam0);
	}
	GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iParam0]), 11);
}
...
{
	if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 6))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam1, false))
		{
			func_86(iParam0, "unavailable");
			return false;
		}
		if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 2))
		{
			func_86(iParam0, "temporarily unavailable");
			return false;
		}
		if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], true))
		{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 4))
			{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 13);
			...
			if (GAMEPLAY::GET_GAME_TIMER() < uLocal_95[iParam0])
			{
		...
		else if (func_90() == 0)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 12);
			...
			if (network_is_activity_session())
			{
				if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_13, 26))
				{
...
void func_91()
{
	...
	if (iLocal_158)
	{
		if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && GAMEPLAY::GET_GAME_TIMER() - iLocal_156 > 10000) || (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && is_time_more_than(NETWORK::GET_NETWORK_TIME(), get_time_offset(iLocal_157, 10000))))
		{
			iVar2 = true;
		}
	}
	...
	while (iVar0 < 45)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iVar0], 16))
		{
			if (iVar2)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_91330.f_1300[iVar0]), 16);
				func_57(iVar0, 0);
				func_4(iVar0, 1, 1);
				func_4(iVar0, 10, 1);
				func_4(iVar0, 11, 1);
	...
	iLocal_152 = 0;
	iLocal_153 = GAMEPLAY::GET_GAME_TIMER();
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_154 = NETWORK::GET_NETWORK_TIME();
	}
	iLocal_155 = 0;
	if (GAMEPLAY::IS_BIT_SET(iLocal_229, false))
	{
		set_ped_dies_in_water(PLAYER::PLAYER_PED_ID(), 1);
		set_ped_dies_in_sinking_vehicle(PLAYER::PLAYER_PED_ID(), 1);
		set_audio_flag("SuppressPlayerScubaBreathing", 1);
		GAMEPLAY::CLEAR_BIT(&iLocal_229, false);
	}
	Global_91330.f_15 = 1;
	Global_91330.f_16 = 0;
	iLocal_90 = 1;
	...
	while (iVar0 <= 44)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (func_30(iVar0))
			{
				...
				func_15(iVar1, GAMEPLAY::IS_BIT_SET(Global_101154.f_668[iVar0], false), 0);
				func_93(iVar1, 1);
			}
		}
		iVar0++;
...
void func_93(int iParam0, int iParam1)
{
	...
	if (iParam1 != GAMEPLAY::IS_BIT_SET(Global_25433[iVar0 /*23*/].f_11, 17))
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 17);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_25433[iVar0 /*23*/].f_11), 17);
		}
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 18);
	}
}
...
void func_96(int iParam0, int iParam1)
{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 16);
...
void func_99()
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_168(0))
	{
		return;
	}
	if (func_22(36) || func_21(36))
...
void func_181()
{
	...
	if (!iLocal_226 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_185()
{
	...
	iVar1 = 0;
	iVar2 = false;
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !func_211(player_id()))
	{
		iVar2 = true;
	}
	if (iVar2)
	{
		iVar3 = get_ped_prop_index(PLAYER::PLAYER_PED_ID(), 2) * 1000 + get_ped_prop_texture_index(PLAYER::PLAYER_PED_ID(), 2);
		if (iLocal_301 != iVar3)
		{
			iVar4 = get_hash_name_for_prop(PLAYER::PLAYER_PED_ID(), 2, get_ped_prop_index(PLAYER::PLAYER_PED_ID(), 2), get_ped_prop_texture_index(PLAYER::PLAYER_PED_ID(), 2));
		...
		iVar3 = get_ped_prop_index(PLAYER::PLAYER_PED_ID(), false) * 1000 + get_ped_prop_texture_index(PLAYER::PLAYER_PED_ID(), false);
		if (iLocal_302 != iVar3)
		{
			iVar4 = get_hash_name_for_prop(PLAYER::PLAYER_PED_ID(), false, get_ped_prop_index(PLAYER::PLAYER_PED_ID(), false), get_ped_prop_texture_index(PLAYER::PLAYER_PED_ID(), false));
			iVar5 = get_hash_name_for_component(PLAYER::PLAYER_PED_ID(), 11, get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 11), get_ped_texture_variation(PLAYER::PLAYER_PED_ID(), 11));
			if (_0x341DE7ED1D2A1BFD(iVar4, -713698407, true) && _0x341DE7ED1D2A1BFD(iVar5, -713698407, false))
			{
				if (ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()) == joaat("mp_m_freemode_01"))
				{
					...
					set_ped_component_variation(PLAYER::PLAYER_PED_ID(), 7, Var6.f_3, Var6.f_4, 0);
				}
			...
			{
				iVar23 = get_hash_name_for_component(PLAYER::PLAYER_PED_ID(), 7, get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 7), get_ped_texture_variation(PLAYER::PLAYER_PED_ID(), 7));
		...
		if ((iLocal_303 && _0x7350823473013C02(PLAYER::PLAYER_PED_ID())) && has_ped_head_blend_finished(PLAYER::PLAYER_PED_ID()))
		{
			_0x4668D80430D6C299(PLAYER::PLAYER_PED_ID());
			iLocal_303 = 0;
		}
		iVar3 = get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), true) * 1000 + get_ped_texture_variation(PLAYER::PLAYER_PED_ID(), true);
		if (iLocal_304 != iVar3 || GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 22))
		{
			if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 22))
			{
				if (!is_player_switch_in_progress())
				{
					GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_4429), 22);
				}
				else
				{
					return;
			...
			iVar1 = 1;
			iVar4 = get_hash_name_for_component(PLAYER::PLAYER_PED_ID(), true, get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), true), get_ped_texture_variation(PLAYER::PLAYER_PED_ID(), true));
			if (_0x341DE7ED1D2A1BFD(iVar4, 1827025211, false) && func_210())
			{
				...
				if (vVar24.z > -140f)
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_229, false))
					{
						...
						set_ped_dies_in_sinking_vehicle(PLAYER::PLAYER_PED_ID(), 0);
						set_audio_flag("SuppressPlayerScubaBreathing", 0);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_229, false);
					}
					iVar1 = 0;
				}
			}
		...
		{
			iVar27 = PLAYER::PLAYER_PED_ID();
			if (ENTITY::DOES_ENTITY_EXIST(Global_2561288) && !PED::IS_PED_INJURED(Global_2561288))
			{
				iVar27 = Global_2561288;
			}
			iVar3 = get_ped_drawable_variation(iVar27, true) * 1000 + get_ped_texture_variation(iVar27, true);
			if ((iLocal_305 != iVar3 || GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 22)) || iLocal_306 != func_342())
			{
				iVar0 = 1;
		...
		iVar28 = get_hash_name_for_component(PLAYER::PLAYER_PED_ID(), true, get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), true), get_ped_texture_variation(PLAYER::PLAYER_PED_ID(), true));
		...
		if ((_0x35FB78DC42B7BD21() && !func_208()) && !func_211(player_id()))
		{
			if (iVar0 || !func_206())
			{
				...
				{
					if (!GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 30))
					{
						func_204(0, 1);
					}
				}
...
void func_186()
{
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_229, false))
	{
		...
		if (((!is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && func_200(PLAYER::PLAYER_PED_ID())) || ((is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && func_200(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && !is_ped_in_any_sub(PLAYER::PLAYER_PED_ID()))) || iLocal_300)
		{
			...
			iLocal_300 = 0;
			if ((is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && is_entity_in_water(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && !is_ped_in_any_sub(PLAYER::PLAYER_PED_ID()))
			{
				iLocal_300 = 1;
			}
		}
...
void func_204(int iParam0, int iParam1)
{
	...
	if (iParam0 == 1)
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1708323[player_id() /*199*/].f_198), false);
	}
	else
	{
		if (iParam1)
		...
		GAMEPLAY::CLEAR_BIT(&(Global_1708323[player_id() /*199*/].f_198), false);
	}
	func_205(!iParam0);
}
...
bool func_206()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 14))
	{
		return false;
	}
	if (func_207())
	...
	if (iVar0 >= 0 && iVar0 < 4)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_80[iVar0 /*6968*/].f_3997, 8))
		{
			return false;
		}
	}
...
bool func_210()
{
	...
	if (((GAMEPLAY::IS_BIT_SET(Global_2460486.f_4429, 15) || func_88(2038, -1, 0) == 0) || Global_1715399) || vVar0.z < -140f)
	{
		return false;
	}
	return true;
...
void func_215()
{
	...
	if (iLocal_307 > 0)
	{
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || !func_216(player_id(), 0, 1))
		{
			iLocal_307 = 99;
		}
	}
	switch (iLocal_307)
	{
		...
		case 1:
			...
			if (func_216(iVar2, 1, 1))
			{
				...
				if (!PED::IS_PED_INJURED(iVar0) && is_ped_in_any_vehicle(iVar0, 0))
				{
					iVar1 = get_vehicle_ped_is_in(iVar0, 0);
					if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && is_vehicle_driveable(iVar1, 0)) && get_ped_in_vehicle_seat(iVar1, -1) == iVar0) && ENTITY::GET_ENTITY_MODEL(iVar1) == joaat("rhino"))
					{
						iLocal_309++;
					}
				}
...
void func_217()
{
	...
	iVar0 = get_time_difference(GAMEPLAY::GET_GAME_TIMER(), iLocal_159);
	if (iVar0 >= 6000)
	{
		iLocal_161 = 0;
		func_219(&iLocal_159, 1, 0);
...
void func_218(int iParam0)
{
	...
	{
		iVar4 = 6;
		iVar1 = get_closest_vehicle(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 500f, iVar0, iVar4);
...
bool func_220()
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || is_player_switch_in_progress())
	{
		return false;
	}
	if (Global_2562051)
...
void func_225()
{
	...
	if (!func_243() || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return;
	}
	if (!GAMEPLAY::GET_FRAME_COUNT() % 1500 == 0)
	{
		return;
	}
	if (func_242())
	...
	if (((iVar2 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !func_240()) && !func_239())
	{
		if (func_238() == -1)
		{
			iVar3 = true;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					if (get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 6) == 35)
					{
						PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 389, true);
					}
					else
					{
						PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 389, false);
					}
				}
				else if (get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 6) == 34)
				{
					PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 389, true);
				}
				else
...
void func_246()
{
	...
	while (iVar1 < 5)
	{
		...
		if (Global_2558146[iVar1 /*73*/].f_72 != 0 && !func_342())
		{
			...
			if (GAMEPLAY::GET_FRAME_COUNT() - Global_2558146[iVar1 /*73*/].f_72 > iVar2 * 35)
			{
				Global_2558146[iVar1 /*73*/].f_72 = 0;
			}
		}
...
void func_254(int iParam0)
{
	...
	if (iVar3 || get_event_data(1, iParam0, &vVar0, 3))
	{
		...
		if (iVar5 != -1)
		{
			...
			{
				Global_2558146[iVar5 /*73*/].f_72 = GAMEPLAY::GET_FRAME_COUNT();
			}
		}
		iVar79 = true;
		switch (vVar0.z)
...
void func_264()
{
	...
	if (!Global_2561952)
	{
		if (iLocal_325 > 0)
		{
			if ((((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || !func_216(player_id(), 0, 1)) || !func_266()) || !_network_player_is_in_clan()) || iLocal_376 != func_81())
			{
				if (iLocal_325 == 2)
				{
		...
		{
			case 0:
				if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_216(player_id(), 0, 1)) && func_266()) && _network_player_is_in_clan())
				{
					iLocal_376 = func_81();
	...
	else if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || !func_216(player_id(), 0, 1)) || !func_266())
	{
		Global_2561952 = 0;
	}
}
...
void func_268()
{
	...
	if (get_player_has_reserve_parachute(player_id()))
	{
		if (!iLocal_314)
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + iLocal_313))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + iLocal_313);
			}
			iLocal_314 = 1;
		}
	}
	else if (iLocal_314)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + iLocal_313))
		{
			GAMEPLAY::CLEAR_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + iLocal_313);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + iLocal_313))
	{
		set_player_has_reserve_parachute(player_id());
	}
	if (Global_91278 == 7)
	{
		if (iLocal_317[0] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 0);
			iLocal_314 = 0;
		}
		if (iLocal_317[1] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 1))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 1);
			iLocal_314 = 0;
		}
		if (iLocal_317[2] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 2))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 2);
			iLocal_314 = 0;
		}
	}
	else if (Global_91278 == 8)
	{
		if (iLocal_321[0] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 0);
			iLocal_314 = 0;
		}
		if (iLocal_321[1] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 1))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 1);
			iLocal_314 = 0;
		}
		if (iLocal_321[2] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 2))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 2);
			iLocal_314 = 0;
		}
	...
	else
	{
		...
		{
			iLocal_317[0] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 0);
			iLocal_317[1] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 1);
			iLocal_317[2] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 2);
			iLocal_315 = Global_91315;
		}
		if (iLocal_149 != iLocal_316)
		{
			iLocal_321[0] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 0);
			iLocal_321[1] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 1);
			iLocal_321[2] = GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 2);
...
void func_269()
{
	...
	{
		case 0:
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_342())
			{
...
void func_273()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 31))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 31);
	}
}
...
void func_275()
{
	...
	if (iLocal_284 && (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_278(player_id(), 0) == -1))
	{
		if (!iLocal_285)
		{
		...
		{
			if (get_room_key_from_entity(PLAYER::PLAYER_PED_ID()) == 0)
			{
				if (!iLocal_286)
				{
	...
	if (((!Global_262145.f_7249 && iLocal_290) && !func_277(player_id())) && func_90() != 2)
	{
		...
		{
			vVar2 = {0f, 0f, -87.66f};
			STREAMING::REQUEST_MODEL(118627012);
			iLocal_283 = 1;
			if (STREAMING::HAS_MODEL_LOADED(118627012) && (get_distance_between_coords(vVar2, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 1) > 150f || !func_276()))
			{
...
void func_288()
{
	...
	if (Global_2558636)
	{
		if (func_232(Global_2558641, Global_2558639, Global_2558640) == 1)
		{
			...
			{
				if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), iLocal_293)) > 500) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && GAMEPLAY::GET_GAME_TIMER() - iLocal_292 > 500))
				{
...
void func_290()
{
	...
	if (Global_91330.f_1352)
	{
		...
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && Global_2444100 != 31)
			{
...
void func_301()
{
	...
	if (!iLocal_155)
	{
		...
		else if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && is_time_more_than(NETWORK::GET_NETWORK_TIME(), get_time_offset(iLocal_154, 30000))) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && GAMEPLAY::GET_GAME_TIMER() - iLocal_153 > 30000))
		{
			iVar0 = 0;
			while (iVar0 < 32)
			{
...
void func_302(int iParam0, int iParam1, char* sParam2, char* sParam3)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_152, iParam0))
	{
		...
		if (iVar0 != 0)
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_152, iParam0);
		}
		else
		{
			iLocal_155 = 0;
...
void func_312()
{
	if (iLocal_90 != 0 && iLocal_89 != 2)
	{
		...
		{
			if ((((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_317()) && !func_313()) || !func_177(player_id())) || func_90() != 0)
			{
				iLocal_89 = 2;
			}
		}
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (_get_number_of_instances_of_streamed_script(joaat("wardrobe_mp")) == 0)
		{
			...
			if (func_337(1))
			{
				...
				if (!func_331(Local_215[0 /*5*/].f_1, 0f, 0f, 0f, 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Local_215[0 /*5*/].f_1, 1) < 2.5f)
				{
					iVar0 = 0;
				}
			}
			else if (Global_1587523[player_id() /*444*/].f_250.f_9 > 0)
			{
				...
				if (!func_331(Local_215[1 /*5*/].f_1, 0f, 0f, 0f, 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Local_215[1 /*5*/].f_1, 1) < 7.5f)
				{
					iVar0 = 1;
				}
			}
...
void func_339()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_341(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
