	...
	if (!iLocal_150 || iLocal_151 < 45)
	{
		...
		while (iVar1 < 2)
		{
			...
			if (iVar0 < 45)
			{
				...
				{
					GAMEPLAY::SET_BIT(&(iLocal_209[iVar4 / 32]), iVar4 % 32);
		...
		while (iVar0 < iVar5)
		{
			...
			if (func_47(iLocal_163[iVar0]) && (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_46(iLocal_227)))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(iLocal_209[iLocal_163[iVar0] / 32]), iLocal_163[iVar0] % 32);
...
void func_23(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), true);
	}
	else
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 7))
		{
			switch (func_31(iParam0))
			{
				case 0:
					...
					{
						GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 7);
					}
					break;
...
{
	Global_91330.f_248[iParam0] = get_distance_between_coords(func_8(iParam0, 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87(iParam0))
		{
	...
	if (func_83(iParam0, uParam1))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], false))
		{
			...
			GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), false);
			func_56(iParam0);
		}
	}
...
bool func_83(int iParam0, auto uParam1)
{
	if (!GAMEPLAY::IS_BIT_SET(Global_91330.f_1300[iParam0], 6))
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 13);
		...
		else if (func_90() == 0)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_91330.f_1300[iParam0]), 12);
...
void func_93(int iParam0, int iParam1)
{
	...
	if (iParam1 != GAMEPLAY::IS_BIT_SET(Global_25433[iVar0 /*23*/].f_11, 17))
	{
		if (iParam1)
		{
			GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 17);
		}
		else
		{
...
void func_96(int iParam0, int iParam1)
{
	...
	GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 16);
			...
			if (_0x341DE7ED1D2A1BFD(iVar4, 1827025211, false) && func_210())
			{
				...
				if (vVar24.z > -140f)
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_229, false))
					{
						...
						GAMEPLAY::SET_BIT(&iLocal_229, false);
					}
					iVar1 = 0;
				}
			}
...
void func_204(int iParam0, int iParam1)
{
	...
	if (iParam0 == 1)
	{
		...
		GAMEPLAY::SET_BIT(&(Global_1708323[player_id() /*199*/].f_198), false);
	}
	else
	{
		if (iParam1)
...
void func_218(int iParam0)
{
	...
	{
		iVar4 = 6;
		iVar1 = get_closest_vehicle(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 500f, iVar0, iVar4);
...
void func_268()
{
	...
	if (get_player_has_reserve_parachute(player_id()))
	{
		if (!iLocal_314)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + iLocal_313);
			}
			iLocal_314 = 1;
		}
	}
	...
	if (Global_91278 == 7)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 0);
			iLocal_314 = 0;
		}
		if (iLocal_317[1] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 1))
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 1);
			iLocal_314 = 0;
		}
		if (iLocal_317[2] && !GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_1469[4], 28 + 2))
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 28 + 2);
			iLocal_314 = 0;
		}
	}
...
void func_273()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_1469[4]), 31);
	}
}
...
void func_275()
{
	...
	if (iLocal_284 && (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_278(player_id(), 0) == -1))
	{
		if (!iLocal_285)
		{
			...
			if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SNOW_FOOTSTEPS", false) && has_named_ptfx_asset_loaded("core_snow"))
			{
	...
	if (((!Global_262145.f_7249 && iLocal_290) && !func_277(player_id())) && func_90() != 2)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_282))
		{
			...
			iLocal_283 = 1;
			if (STREAMING::HAS_MODEL_LOADED(118627012) && (get_distance_between_coords(vVar2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 150f || !func_276()))
			{
...
void func_302(int iParam0, int iParam1, char* sParam2, char* sParam3)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_152, iParam0))
	{
		...
		if (iVar0 != 0)
		{
			...
			GAMEPLAY::SET_BIT(&iLocal_152, iParam0);
		}
		else
		{
			iLocal_155 = 0;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (_get_number_of_instances_of_streamed_script(joaat("wardrobe_mp")) == 0)
		{
			...
			if (func_337(1))
			{
				...
				if (!func_331(Local_215[0 /*5*/].f_1, 0f, 0f, 0f, 0) && get_distance_between_coords(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_215[0 /*5*/].f_1, 1) < 2.5f)
				{
					iVar0 = 0;
				}
			}
			else if (Global_1587523[player_id() /*444*/].f_250.f_9 > 0)
			{
				...
				if (!func_331(Local_215[1 /*5*/].f_1, 0f, 0f, 0f, 0) && get_distance_between_coords(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_215[1 /*5*/].f_1, 1) < 7.5f)
				{
					iVar0 = 1;
				}
			}
