...
void func_5()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 16))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 20))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_1), 20);
			}
		}
	}
}
			...
			if (network_is_player_active(iVar4))
			{
				if (network_is_player_a_participant(iVar4))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 7))
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_96.f_1), 7);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 11))
					{
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 8))
					{
						...
						{
							Local_96.f_6 = iVar4;
							GAMEPLAY::SET_BIT(&(Local_96.f_1), 8);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 10))
					{
						if (GAMEPLAY::IS_BIT_SET(Local_161[iLocal_356 /*6*/].f_1, 11))
						{
							...
							GAMEPLAY::SET_BIT(&(Local_96.f_1), 10);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 15))
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_96.f_1), 15);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 18))
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_96.f_1), 18);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, false))
					{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, true))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 4))
			{
				if (Local_96.f_5 != iVar0)
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_96.f_1), 16);
					}
				}
			}
		}
				...
				if (func_21(Local_96.f_29[iParam1]))
				{
					...
					else if (Local_96.f_9 > -1)
					{
						...
						if (network_is_player_active(iVar1))
						{
							...
							{
								GAMEPLAY::SET_BIT(&(Local_96.f_2), iParam0);
							}
						}
					}
					if (iVar2)
...
void func_23()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 17))
	{
		...
		GAMEPLAY::SET_BIT(&(Local_96.f_1), 17);
	}
}
		...
		if (STREAMING::HAS_MODEL_LOADED(iParam1))
		{
			if (can_register_mission_entities(0, 1, 0, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_10, iParam0))
				{
					...
					GAMEPLAY::SET_BIT(&(Local_96.f_10), iParam0);
				}
				if (func_31(vParam2, 1f, 1065353216, 1065353216, 1084227584, 1, 1, 1, 1123024896, 0, -1, 1, 50f, 0, 0, 0, 0))
				{
					if (func_30(&(Local_96.f_29[iParam0]), iParam1, vParam2, fParam5, 1, 1, 1, 0, 1, 1))
					{
						...
						ENTITY::FREEZE_ENTITY_POSITION(net_to_veh(Local_96.f_29[iParam0]), false);
						...
						if (func_769() == 1)
						{
							if (iParam1 == joaat("rhino"))
							{
								...
								fVar1 = func_29();
								fVar0 *= fVar1;
								ENTITY::SET_ENTITY_HEALTH(net_to_veh(Local_96.f_29[iParam0]), round(fVar0));
	...
	if (iParam4 && !iParam7)
	{
		if (func_833(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_37(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_33(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_37(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
				...
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_33(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_37(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			if (can_register_mission_objects(1))
			{
				...
				else if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 19))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_96.f_1), 19);
					}
				}
			}
		}
		...
		if (STREAMING::HAS_MODEL_LOADED(iParam1))
		{
			if (can_register_mission_entities(1, 0, 0, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_11, iParam0))
				{
					...
					GAMEPLAY::SET_BIT(&(Local_96.f_11), iParam0);
				}
				if (func_31(vParam2, 1f, 1065353216, 1065353216, 1084227584, 1, 1, 1, 1123024896, 0, -1, 1, 50f, 0, 0, 0, 0))
				{
					if (func_176(&(Local_96.f_13[iParam0]), 26, iParam1, vParam2, fParam5, 1, 1, 1))
					{
						...
						ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_96.f_13[iParam0]), 200);
		...
		if (GAMEPLAY::IS_BIT_SET(iLocal_354, 28))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 25))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 26))
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_354, 26);
					}
				}
				if (GAMEPLAY::IS_BIT_SET(iLocal_354, 26))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 27))
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_354, 27);
						}
					}
					if (GAMEPLAY::IS_BIT_SET(iLocal_354, 27))
					{
						GAMEPLAY::SET_BIT(&iLocal_354, 25);
					}
				}
			}
		}
														...
														if (is_entity_a_ped(Var0.f_1))
														{
															...
															if (is_ped_a_player(iVar10))
															{
																...
																if (network_is_player_a_participant(iVar12))
																{
																	if (iVar12 == player_id())
																	{
																		GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 11);
																...
																{
																	GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 16);
																}
															}
															else
															{
																GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 15);
															}
														}
													}
												}
									...
									if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
									{
										if (is_entity_a_ped(Var0.f_1))
										{
											...
											if (is_ped_a_player(iVar10))
											{
												...
												if (iVar12 == player_id())
												{
													GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_2), iVar15);
												}
											}
										}
									}
...
void func_326()
{
	...
	switch (Local_161[participant_id_to_int() /*6*/].f_5)
	{
		...
		case 2:
			...
			{
				GAMEPLAY::SET_BIT(&iLocal_354, 24);
				Local_161[participant_id_to_int() /*6*/].f_5 = 4;
			}
			break;
...
void func_327()
{
	...
	if (func_769() == 1)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_29[0]))
		{
			vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_29[0]), 0)};
		}
	}
	else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
	{
		vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_12), 0)};
	}
...
void func_345(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_346())
	{
		return;
	}
			...
			if (func_783())
			{
				if (func_305(player_id()) >= 1)
				{
					if (Local_96.f_5 != -1 || Local_96.f_7 != -1)
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_354, 15);
						}
					}
				}
			}
...
void func_458()
{
	...
	if (func_769() == 0)
	{
		...
		{
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, func_459(), 1) < 200f)
			{
				if (get_player_wanted_level(player_id()) > 0)
				{
					GAMEPLAY::SET_BIT(&iLocal_355, 7);
				}
			}
		}
		else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, func_459(), 1) < 121f)
		{
...
void func_460()
{
	...
	{
		GAMEPLAY::SET_BIT(&iLocal_354, 18);
	}
}
			...
			if (func_470())
			{
				if (!func_469())
				{
					if (!func_468())
					{
						...
						GAMEPLAY::SET_BIT(&iLocal_354, 10);
	...
	if (Local_96.f_5 != -1)
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 11))
		{
			if (Local_96.f_5 == participant_id_to_int())
			{
				...
				set_player_wanted_level(player_id(), func_467(), 0);
				set_player_wanted_level_now(player_id(), 0);
				GAMEPLAY::SET_BIT(&iLocal_354, 11);
			}
			else if (func_464())
			{
				iVar0 = func_463();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 8))
		{
			...
			if (iVar1 > 0)
			{
				if (func_783())
				{
					fVar2 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_459(), 1);
					if (fVar2 < 150f)
					{
						_0xBC9490CA15AEA8FB(player_id());
						_0x4669B3ED80F24B4E(player_id());
	...
	switch (iVar0)
	{
		case 0:
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar1, func_459(), 1) < 121f)
				{
					return true;
				}
			}
		...
		case 3:
			...
			{
				vVar1 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)};
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar1, func_459(), 1) < 200f)
				{
					return true;
				}
			}
	...
	if (func_310())
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_355, 11))
		{
			if (!func_473())
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
				{
					GAMEPLAY::SET_BIT(&iLocal_355, 11);
					_0x92AEFB5F6E294023(net_to_obj(Local_96.f_12), 1, 1);
				}
			}
			else
			...
			if (func_21(Local_96.f_29[0]))
			{
				if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_29[0])))
				{
					if (get_ped_in_vehicle_seat(net_to_veh(Local_96.f_29[0]), -1) == PLAYER::PLAYER_PED_ID())
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 8);
							func_323();
							func_325(0);
		...
		if (network_has_control_of_network_id(Local_96.f_29[0]))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 9))
			{
				if (iVar0 == player_id())
				{
					if (!PED::IS_PED_INJURED(get_player_ped(iVar0)))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(get_player_ped(iVar0), vVar1, 6f, 6f, 2f, true, true, 0))
						{
							...
							GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 9);
						}
					}
				}
			}
...
void func_546()
{
	...
	if (func_783())
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_354, false))
		{
			...
			GAMEPLAY::SET_BIT(&iLocal_354, false);
		}
	}
}
...
void func_550(int iParam0, auto uParam1, int iParam2)
{
	...
	if (!is_thread_active(Global_2412879.f_691[iParam0]) || Global_2412879.f_691[iParam0] == get_id_of_this_thread())
	{
		if (iParam2)
		{
			GAMEPLAY::SET_BIT(&(Global_2412879.f_388), iVar0);
...
void func_557()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 2))
			{
				if (is_entity_attached_to_entity(net_to_obj(Local_96.f_12), PLAYER::PLAYER_PED_ID()))
				{
					GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 2);
					func_576(1);
					func_323();
					if (func_320())
					{
						func_325(0);
						GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 6);
					}
					if (!Global_1572925)
					{
						Global_1572925 = 1;
					...
					if (is_ped_in_any_sub(PLAYER::PLAYER_PED_ID()))
					{
						if (network_has_control_of_network_id(Local_96.f_12))
						{
							...
							GAMEPLAY::SET_BIT(&iLocal_354, 12);
						}
					}
				...
				if (GAMEPLAY::IS_BIT_SET(iLocal_354, 12))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 13))
					{
						if (func_499(0, 1, 1, 1))
						{
							...
							GAMEPLAY::SET_BIT(&iLocal_354, 13);
						}
					}
				}
			}
				...
				if (func_305(player_id()) >= 1)
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_13[0]))
					{
						if (!func_10(Local_96.f_13[0]))
						{
							...
							draw_marker(2, ENTITY::GET_ENTITY_COORDS(net_to_ped(Local_96.f_13[0]), 1) + Vector(2f, 0f, 0f), 0f, 0f, 0f, 180f, 0f, 0f, 0.5f, 0.5f, 0.5f, iVar3, iVar4, iVar5, 100, 1, 1, 2, 0, 0, 0, false);
						}
					}
				}
			}
					...
					if (iVar0 != func_18())
					{
						...
						if (iVar7)
						{
							if (!PED::IS_PED_INJURED(get_player_ped(iVar0)))
							{
								...
								{
									draw_marker(2, ENTITY::GET_ENTITY_COORDS(get_player_ped(iVar0), 1) + Vector(2f, 0f, 0f), 0f, 0f, 0f, 180f, 0f, 0f, 0.5f, 0.5f, 0.5f, iVar3, iVar4, iVar5, 100, 1, 1, 2, 0, 0, 0, false);
								}
							}
						}
					}
	...
	{
		GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 4);
	}
	if (func_472())
	{
		if (func_305(player_id()) > 2)
...
void func_558()
{
	...
	if (func_305(player_id()) >= 1)
	{
		if (network_does_network_id_exist(Local_96.f_12) && !ENTITY::IS_ENTITY_DEAD(net_to_obj(Local_96.f_12), 0))
		{
			if (!is_entity_attached_to_any_ped(net_to_obj(Local_96.f_12)))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 3) && !GAMEPLAY::IS_BIT_SET(Local_96.f_1, true))
				{
					...
					draw_marker(2, ENTITY::GET_ENTITY_COORDS(net_to_ent(Local_96.f_12), 1) + Vector(1f, 0f, 0f), 0f, 0f, 0f, 180f, 0f, 0f, 0.5f, 0.5f, 0.5f, iVar0, iVar1, iVar2, 100, 1, 1, 2, 0, 0, 0, false);
				}
			}
		}
	}
...
void func_559()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 3))
	{
		if (iVar0 == player_id())
		{
			if (!PED::IS_PED_INJURED(get_player_ped(iVar0)))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(get_player_ped(iVar0), vVar1, 6f, 6f, 2f, false, true, 0))
				{
					GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 3);
				}
			}
		}
	}
...
void func_560()
{
	...
	switch (iLocal_494)
	{
		case 0:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
			{
				vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_ent(Local_96.f_12), 1)};
		...
		case 1:
			if (Local_96.f_5 == -1)
			{
				if (network_has_control_of_network_id(Local_96.f_12))
				{
					...
					if (func_357(vLocal_496, 0f, 0f, 0f, 0))
					{
						vLocal_496 = {ENTITY::GET_ENTITY_COORDS(net_to_ent(Local_96.f_12), 1)};
					}
				}
			}
...
void func_578()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 5))
	{
		if (!func_783())
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 5);
				_0x78857FC65CADB909(1);
...
void func_587()
{
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_355, 12))
		{
			...
			{
				GAMEPLAY::SET_BIT(&iLocal_355, 12);
				_0x92AEFB5F6E294023(net_to_obj(Local_96.f_12), 1, 1);
			}
...
void func_588()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, true))
	{
			...
			if (GAMEPLAY::IS_BIT_SET(Local_96.f_1, true) || GAMEPLAY::IS_BIT_SET(Local_96.f_1, 8))
			{
				...
				if (func_472())
				{
					...
					if (iVar0 == player_id())
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_354, 17);
							func_714(1, 1);
						}
						func_602(159, 1, &Var2);
		...
		if (GAMEPLAY::IS_BIT_SET(iLocal_355, 6))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 29))
			{
				GAMEPLAY::SET_BIT(&iLocal_354, 29);
			}
			if (func_589(&uLocal_505, 1))
			{
				GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), true);
			}
		}
	}
}
...
int func_698(int iParam0)
{
	...
	if (func_705(iParam0))
	{
		...
		if (iVar1 < func_699(iParam0))
		{
			...
			{
				iVar0 += func_703(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
...
void func_716()
{
	if (func_215(player_id(), 20) || func_307(player_id()))
	{
		...
		else if (Local_96.f_5 == -1 && Local_96.f_7 == -1)
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 22))
			{
				if (Local_161[participant_id_to_int() /*6*/].f_5 > 1)
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_354, 22);
		...
		else if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 23))
		{
			...
			{
				GAMEPLAY::SET_BIT(&iLocal_354, 23);
				if (GAMEPLAY::IS_BIT_SET(iLocal_354, 22))
				{
	...
	if (func_473())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 10))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_29[0]))
			{
				if (!func_21(Local_96.f_29[0]))
				{
					GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 10);
				}
			}
		}
	}
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 11))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 12))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 12);
				}
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 12))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 13))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 13);
				}
			}
		}
	}
			...
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_13[iVar0]))
			{
				if (!func_10(Local_96.f_13[iVar0]))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 14))
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 14);
						}
					}
				}
			}
...
void func_721()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_1, 7))
	{
		...
		if (func_470())
		{
			GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_1), 7);
		}
	}
	func_367();
}
	...
	if (((iVar12 && func_472()) && GAMEPLAY::IS_BIT_SET(iLocal_354, 3)) && !func_482(player_id(), 0, 0))
	{
		if (func_783())
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 16))
			{
				...
				{
					fVar6 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar8, 0);
					if (func_769() == 1)
					{
						fVar7 = 350f;
					}
					...
					if (fVar6 < fVar7)
					{
						...
						func_730();
						GAMEPLAY::SET_BIT(&iLocal_354, 16);
					}
				}
				else
				{
...
Vector3 func_729()
{
	...
	if (func_473())
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_29[0]))
		{
			if (func_21(Local_96.f_29[0]))
			{
				vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_29[0]), 1)};
			}
		}
	}
	else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12))
	{
		vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_12), 1)};
	}
	return vVar0;
}
...
void func_732()
{
	...
	{
		vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_12), 1)};
	}
	if (!func_357(vVar0, 0f, 0f, 0f, 0))
	{
		if (func_472())
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 3))
				{
					if (fVar6 <= 250000f)
					{
						GAMEPLAY::SET_BIT(&iLocal_354, 3);
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 6))
					{
						if (func_471(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 3, 1000, 0))
						{
							GAMEPLAY::SET_BIT(&iLocal_354, 3);
						}
					}
				...
				{
					if (GAMEPLAY::IS_BIT_SET(Local_96.f_1, 6) || (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 6) && !func_471(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 3, 1000, 0)))
					{
			...
			if (func_305(player_id()) >= 1)
			{
				if (!func_505(84))
				{
					if (func_499(0, 1, 1, 1))
					{
						...
						func_594(&Var0, -1);
						func_492(1);
						GAMEPLAY::SET_BIT(&iLocal_354, true);
					}
				}
			}
		}
		...
		if (func_783())
		{
			if (((Local_96.f_5 != -1 || Local_96.f_7 != -1) || GAMEPLAY::IS_BIT_SET(Local_96.f_1, 16)) || GAMEPLAY::IS_BIT_SET(Local_96.f_1, 20))
			{
				if (func_499(0, 1, 1, 1))
				{
					...
					func_492(1);
					GAMEPLAY::SET_BIT(&iLocal_355, 10);
				}
			}
		}
	}
...
void func_741(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 30))
	{
		if (iParam0 <= 35000)
		{
			...
			{
				GAMEPLAY::SET_BIT(&iLocal_354, 30);
				GAMEPLAY::SET_BIT(&iLocal_354, 28);
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(iLocal_354, 28))
		...
		if (iParam0 <= 30000)
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_355, false))
			{
				if (prepare_music_event("APT_COUNTDOWN_30S_KILL"))
				{
					...
					GAMEPLAY::SET_BIT(&iLocal_355, false);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_354, 31))
			{
				...
				{
					GAMEPLAY::SET_BIT(&iLocal_354, 31);
				}
			}
			if (GAMEPLAY::IS_BIT_SET(iLocal_354, 31))
			{
				if (iParam0 <= 27000)
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_355, true))
					{
						set_user_radio_control_enabled(1);
						set_audio_flag("AllowScoreAndRadio", 0);
						GAMEPLAY::SET_BIT(&iLocal_355, true);
					}
					if (iParam0 <= 500)
					{
						if (trigger_music_event("APT_FADE_IN_RADIO"))
				...
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_13[iVar0]))
				{
					if (func_754(Local_96.f_13[iVar0]))
					{
						if (network_has_control_of_network_id(Local_96.f_13[iVar0]))
						{
							if (!func_10(Local_96.f_13[iVar0]))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_13[iVar0]), -1442466670) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_13[iVar0]), -1442466670) != 0)
								{
									if (func_769() == 2)
									{
				...
				if (iVar1 != player_id())
				{
					if (network_is_player_a_participant(iVar1))
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_161[participant_id_to_int() /*6*/].f_3, iVar0))
						{
							...
							GAMEPLAY::SET_BIT(&(Local_161[participant_id_to_int() /*6*/].f_3), iVar0);
						}
					}
