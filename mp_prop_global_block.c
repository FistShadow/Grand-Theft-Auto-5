...
void func_27(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3)
{
	struct<6> Var0;
	struct<6> Var6;
	struct<6> Var12;
...
void func_28(struct<4> Param0, var uParam1, var uParam2, struct<6> Param3, struct<4> Param4, var uParam5, var uParam6, var uParam7)
{
	vector3 vVar0;
