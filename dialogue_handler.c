...
void main()
{
	...
	{
		wait(0);
		if (GAMEPLAY::IS_BIT_SET(Global_2284, true))
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_2283, 20))
			{
				if (is_mobile_phone_call_ongoing())
				{
					...
					GAMEPLAY::CLEAR_BIT(&Global_2284, true);
				}
			}
		}
		if (GAMEPLAY::IS_BIT_SET(Global_14578, false))
		{
			if (!func_104())
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_14578, true))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&Global_14578, true);
		...
		if (!is_player_playing(player_id()) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_17, 4))
		{
			if (Global_15712 != 0)
			{
...
void func_2()
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_2283, 11))
	{
		func_3();
	}
	Global_15718 = 0;
	...
	GAMEPLAY::CLEAR_BIT(&Global_2284, 23);
	GAMEPLAY::CLEAR_BIT(&Global_2285, false);
	GAMEPLAY::CLEAR_BIT(&Global_2284, 9);
	GAMEPLAY::CLEAR_BIT(&Global_2284, 31);
	GAMEPLAY::CLEAR_BIT(&Global_2284, 17);
	GAMEPLAY::CLEAR_BIT(&Global_2285, 5);
	Global_16696 = 0;
	Global_16695 = 0;
	...
	else
	{
		Global_15712 = 0;
		Global_16723 = 0;
		Global_16734 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
void func_7()
{
	...
	if (is_mobile_phone_call_ongoing() == 0 && Global_15725 == 0)
	{
		if (Global_15765 == 1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2284, 23);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&Global_2284, 23);
		...
		if (!Global_15767)
		{
			while (Global_15765 == 1)
			{
				...
				else
				{
					...
					if (func_45(2, Global_14383, 0) || GAMEPLAY::IS_BIT_SET(Global_2283, 24))
					{
						func_43();
						Global_14339 = 0.19f;
						Global_15765 = 0;
...
void func_13()
{
	...
	switch (Global_14415)
	{
		...
		case 6:
			if (GAMEPLAY::IS_BIT_SET(Global_2284, 5))
			{
				Global_14415 = 6;
...
void func_53()
{
	if (func_45(2, Global_14390, 0))
	{
		if (Global_16723 == 0)
		{
			if (Global_15718)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2284, 17))
				{
				}
				else
				{
...
void func_54()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_55() && is_ped_in_cover(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar1 = 1;
		}
	}
...
void func_57()
{
			...
			if (is_player_playing(player_id()))
			{
				if (is_player_control_on(player_id()))
				{
					...
					else
					{
						...
						if (!Global_15723)
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2284, 5);
						}
						func_13();
						Global_14413.f_1 = Global_14415;
						func_8();
	...
	else
	{
		...
		if (!Global_15725)
		{
			if (Global_16729 == 0)
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2285, 5))
				{
					start_preloaded_conversation();
				}
				GAMEPLAY::CLEAR_BIT(&Global_2285, 5);
...
void func_87()
{
	...
	while (iVar0 <= 15)
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_15001[iVar0 /*10*/]) || Global_15001[iVar0 /*10*/] == 0)
			{
	...
	if (Global_2563585 == 1)
	{
		...
		while (iVar0 <= 19)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2563404[iVar0 /*9*/]) || Global_2563404[iVar0 /*9*/] == 0)
				{
...
void func_95()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_2283, 20))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2284, true);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&Global_2284, true);
	...
	else
	{
		...
		if (Global_15722 == 0)
		{
			...
			if (Global_16729 == 0)
			{
				...
				Global_14579 = 1;
				settimerb(0);
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2283, 27);
				settimera(0);
			}
			else
			{
...
float func_98(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3, float fParam4, int iParam5)
{
	...
	fVar3 = func_100(to_float(GAMEPLAY::GET_GAME_TIMER() - iLocal_18) / fParam12, 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (iParam13)
