	...
	switch (iLocal_153)
	{
		case 0:
			...
			if (func_292(iLocal_149))
			{
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0f, 0, 0, 0);
					remove_cutscene();
					func_291(1);
		...
		case 4:
			if (is_cutscene_playing())
			{
				...
				if (func_292(PLAYER::PLAYER_PED_ID()) && can_set_exit_state_for_registered_entity("Michael", 0))
				{
					_0x81CBAE94390F9F89();
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 0.25f, 0, 40000f);
					task_look_at_coord(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
		...
		case 5:
			if ((iLocal_155 == 0 && get_follow_ped_cam_view_mode() == 4) && GAMEPLAY::GET_GAME_TIMER() > iLocal_152 - 300)
			{
				_start_screen_effect("CamPushInNeutral", 0, 0);
				play_sound_frontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
				iLocal_155 = 1;
			}
			if (func_217(1000) || GAMEPLAY::GET_GAME_TIMER() > iLocal_152)
			{
				...
				{
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					task_look_at_coord(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, 5000, 0, 2);
				}
				func_3();
			}
...
void func_207(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_211(player_id())) && !func_209(player_id(), 0)) && !func_208())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_211(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_271(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_268(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_243(iParam0, 0, 0)) || func_243(iParam0, 1, 0)) || func_243(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_242(iParam0)) || func_241(iParam0)) || func_240(iParam0)) || func_239(iParam0)) || !func_231(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_241(iParam0))
		{
		}
...
auto func_245()
{
	...
	func_253(&uVar0, TIME::GET_CLOCK_HOURS());
...
{
	return shift_right(iParam0, 26) & 31 * func_251(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_265(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_288()
{
	if (func_292(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_154 == 0)
		{
			if (func_292(iLocal_149))
			{
				if (func_289(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 4f || (get_entity_speed(PLAYER::PLAYER_PED_ID()) > 2f && func_289(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 6f))
				{
