#region Local Var
	...
	auto uLocal_208 = 0;
	auto uLocal_209 = 0;
	struct<11>[] Local_210 = new struct<11>[15];
	int iLocal_376 = 0;
#endregion
...
void main()
{
	...
	if (_get_number_of_instances_of_streamed_script(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		...
		{
			if ((((!func_45() && !is_ped_fleeing(iLocal_44)) && !PED::IS_PED_RAGDOLL(iLocal_44)) && !is_ped_prone(iLocal_44)) && !PED::IS_PED_INJURED(iLocal_44))
			{
	...
	while (iVar0 < 15)
	{
		...
		{
			if (has_object_been_broken(Local_210[iVar0 /*11*/]) || func_24(Local_210[iVar0 /*11*/]))
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_8739.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_108, iVar0))
		{
...
bool func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return false;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_11()
{
	...
	if (iLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				if (!is_screen_faded_out())
				{
					...
					if (has_scaleform_movie_loaded(iLocal_41))
					{
						...
						play_sound_frontend(iVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_40++;
					}
				}
				break;
			...
			case 1:
				_push_scaleform_movie_function(iLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
				_begin_text_component("FS_TITLE");
				_end_text_component();
				_begin_text_component("FS_DESTROY");
			...
			case 2:
				if (timerb() > 7000)
				{
					_push_scaleform_movie_function(iLocal_41, "SHARD_ANIM_OUT");
...
void func_13(auto uParam0, int iParam1, int iParam2, float fParam3)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, fParam3) && !ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			...
			*uParam0 = create_object(iParam1, *uParam0.f_3, 1, true, false);
			*uParam0.f_10 = 1;
...
int func_15(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_16(int iParam0, auto uParam1)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*iParam0, 1), 1) >= 110f && !is_entity_on_screen(*iParam0))
		{
			func_17(iParam0);
			*uParam1 = 0;
		}
...
int func_27(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_43(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_49(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_62()
{
	...
	{
		func_64(13, floor(Global_101154.f_8884.f_3853));
	}
