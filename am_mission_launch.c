#region Local Var
	...
	float fLocal_94 = 0;
	auto uLocal_95 = 0;
	struct<22> Local_96 = 0;
	auto uLocal_118 = 0;
	int iLocal_119 = 0;
	int iLocal_120 = 0;
	struct<14> Local_121 = 0;
	Vector3[] vLocal_135 = new Vector3[32];
	auto uLocal_232 = 0;
	int iLocal_233 = 0;
	int iLocal_234 = 0;
	auto uLocal_235 = 0;
...
void main()
{
	...
	{
		func_341();
		if (func_331() || !func_330(player_id(), 0, 1))
		{
			func_328();
		}
		switch (func_327(participant_id_to_int()))
		{
			case 0:
				if (func_326() == 2)
				{
					vLocal_135[participant_id_to_int() /*3*/].f_1 = 2;
				}
				else if (func_326() == 6)
				{
					vLocal_135[participant_id_to_int() /*3*/].f_1 = 5;
				}
				break;
			...
			case 2:
				...
				if (((func_46(player_id(), 1) || func_43(player_id())) || GAMEPLAY::IS_BIT_SET(iLocal_234, 8)) || GAMEPLAY::IS_BIT_SET(iLocal_234, 16))
				{
					vLocal_135[participant_id_to_int() /*3*/].f_1 = 6;
				}
				break;
			
			case 5:
				func_42(&(Local_96.f_19));
				if (func_41(&(Local_96.f_19)))
				{
					vLocal_135[participant_id_to_int() /*3*/].f_1 = 6;
				}
				break;
...
int func_2()
{
	return GAMEPLAY::IS_BIT_SET(Local_96, 6);
}
...
void func_3()
{
	if (network_is_host_of_this_script())
	{
		...
		{
			case 0:
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 10))
				{
					if (func_33(&(Local_96.f_17), 300000, 0))
					{
						GAMEPLAY::SET_BIT(&Local_96, 10);
					}
				}
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 10))
				{
					if (GAMEPLAY::IS_BIT_SET(Local_96, false))
					{
						Local_96.f_5 = func_32();
						Local_96.f_2 = 1;
						Local_96.f_4 = 0;
					}
				}
			...
			case 1:
				if (func_6())
				{
					GAMEPLAY::SET_BIT(&Local_96, 3);
					GAMEPLAY::CLEAR_BIT(&Local_96, 13);
					func_40(&(Local_96.f_21), 0, 0);
					Local_96.f_2 = 2;
				}
				break;
			
			case 2:
				if (GAMEPLAY::IS_BIT_SET(Local_96, 4))
				{
					func_4(Local_96.f_5);
					Local_96.f_2 = 7;
				}
...
void func_4(int iParam0)
{
	...
	{
		case 0:
			func_5(&(Local_96.f_9[0]));
			func_5(&(Local_96.f_12[0]));
			break;
	}
}
...
bool func_6()
{
	if (Local_96.f_5 == 0)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_96, true))
		{
			...
			Local_96.f_3 = -1;
			Local_96.f_4 = 0;
			GAMEPLAY::SET_BIT(&Local_96, true);
		}
		if (!GAMEPLAY::IS_BIT_SET(Local_96, 2))
		{
			if (func_31())
			{
				GAMEPLAY::SET_BIT(&Local_96, 2);
			}
		}
		else if (func_7())
		{
...
bool func_7()
{
	...
	iVar0 = func_30();
	iVar1 = func_29();
	if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
	{
		if (Local_96.f_15 == 0)
		{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_96, 13))
		{
		...
		if (GAMEPLAY::IS_BIT_SET(Local_96, 13))
		{
			if (func_21(iVar1))
			{
				if (func_21(iVar0))
				{
					if (func_12(&vVar2, &fVar5))
					{
						if (func_11(&(Local_96.f_12[0]), iVar1, vVar2, fVar5, 1, 1, 1, 0, 1, 1))
						{
							set_entity_only_damaged_by_player(net_to_veh(Local_96.f_12[0]), true);
							if (decor_is_registered_as_type("Not_Allow_As_Saved_Veh", 3))
							{
								decor_set_int(net_to_veh(Local_96.f_12[0]), "Not_Allow_As_Saved_Veh", true);
							}
							Local_96.f_15 = 1;
						}
					}
	...
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
	{
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
		{
			if (Local_96.f_16 == 0)
			{
			...
			if (can_register_mission_peds(1))
			{
				if (func_21(iVar0))
				{
					if (func_9(Local_96.f_12[0]))
					{
						if (network_has_control_of_network_id(Local_96.f_12[0]))
						{
							if (func_8(&(Local_96.f_9[0]), Local_96.f_12[0], 26, iVar0, -1, 1, 1, 1))
							{
								set_entity_only_damaged_by_player(net_to_ped(Local_96.f_9[0]), true);
								set_entity_is_target_priority(net_to_ped(Local_96.f_9[0]), 1, 0f);
								set_blocking_of_non_temporary_events(net_to_ped(Local_96.f_9[0]), true);
								PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(net_to_ped(Local_96.f_9[0]), Global_1574233);
								set_entity_is_target_priority(net_to_ped(Local_96.f_9[0]), 1, 0f);
								ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_96.f_9[0]), round(200f * Global_262145.f_151));
								Local_96.f_16 = 1;
							}
						}
					}
	...
	if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]) || !network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
	{
		return false;
	}
	return true;
...
bool func_11(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
bool func_12(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		case 0:
			if (GAMEPLAY::IS_BIT_SET(Local_96.f_4, iLocal_243))
			{
	...
	if (iLocal_243 < 5)
	{
		if (!func_20(vVar0, 0f, 0f, 0f, 0))
		{
			if (Local_96.f_3 == -1)
			{
				Local_96.f_3 = network_add_entity_area(vVar0, vVar3);
			}
			else if (_0xE64A3CA08DFA37A9(Local_96.f_3))
			{
				if (_0x4DF7CFFF471A7FB1(Local_96.f_3))
				{
					if (!_0x4A2D4E8BF4265B0F(Local_96.f_3))
					{
						if (!func_13(vVar6, 1084227584, 1, 1, 1123024896, 0, -1, 0, 0))
						{
							*uParam0 = {vVar6};
							*uParam1 = fVar9;
							network_remove_entity_area(Local_96.f_3);
							return true;
						}
						else
						{
...
bool func_13(Vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, int iParam5, int iParam6, float fParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam4 && !iParam7)
	{
		if (func_330(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_18(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
	...
	{
		iVar1 = iVar0;
		if (func_330(iVar1, 1, 1))
		{
			if (!func_15(iVar1, 0) && _0x9DE986FC9A87C474(player_id(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_14(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_18(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
...
{
	return func_23(0, iParam0, 1, iParam1, iParam2);
}

bool func_23(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if ((iParam2 && !iParam3) && iParam1 <= func_27(iParam0) - func_26(iParam0, 0))
	{
		return true;
	}
	else
...
{
	return func_23(1, iParam0, 1, iParam1, iParam2);
}
...
bool func_31()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Local_96, true))
	{
		...
		if (iLocal_120 == 0)
		{
			GAMEPLAY::SET_BIT(&iLocal_234, true);
		}
		if (iLocal_242 < 5)
		{
			iVar9 = iLocal_120;
			if (network_is_participant_active(int_to_participantindex(iVar9)))
			{
				...
				if (func_330(iVar0, 1, 1))
				{
					...
					if (GAMEPLAY::IS_BIT_SET(iLocal_234, true))
					{
						vVar2 = {func_19(Local_96.f_5, iLocal_242)};
						vVar5 = {ENTITY::GET_ENTITY_COORDS(iVar1, 0)};
						fVar8 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar2, vVar5, 1);
						if (fVar8 < 300f)
						{
							GAMEPLAY::CLEAR_BIT(&iLocal_234, true);
						}
					}
				}
			}
			...
			if (iLocal_120 == vLocal_135.x)
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, true))
				{
					GAMEPLAY::SET_BIT(&(Local_96.f_4), iLocal_242);
				}
			}
		}
		else
	...
	if (network_is_host_of_this_script())
	{
		switch (Local_96.f_6)
		{
			...
			case 1:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
				{
					if (!func_35(Local_96.f_9[0]))
					{
						if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
						{
							if (func_9(Local_96.f_12[0]))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_9[0]), net_to_veh(Local_96.f_12[0])))
								{
									if (GAMEPLAY::IS_BIT_SET(Local_96, 7))
									{
										GAMEPLAY::SET_BIT(&Local_96, 9);
										Local_96.f_6 = 2;
									}
									else if (GAMEPLAY::IS_BIT_SET(Local_96, 14))
									{
										GAMEPLAY::SET_BIT(&Local_96, 9);
										Local_96.f_6 = 2;
									}
									else if (GAMEPLAY::IS_BIT_SET(Local_96, 19))
									{
										Local_96.f_6 = 3;
									}
								}
			...
			case 2:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
				{
					if (!func_35(Local_96.f_9[0]))
					{
						if (!is_ped_sitting_in_any_vehicle(net_to_ped(Local_96.f_9[0])))
						{
							Local_96.f_6 = 4;
						}
						else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
						{
							if (!func_9(Local_96.f_12[0]))
							{
								Local_96.f_6 = 3;
			...
			case 3:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
				{
					if (!func_35(Local_96.f_9[0]))
					{
						if (!is_ped_in_any_vehicle(net_to_ped(Local_96.f_9[0]), 0))
						{
							Local_96.f_6 = 4;
						}
					}
...
void func_36()
{
	...
	if (network_is_host_of_this_script())
	{
		if (iLocal_119 >= vLocal_135.x)
		{
			iLocal_119 = 0;
			iLocal_241 = 0;
			GAMEPLAY::CLEAR_BIT(&iLocal_234, false);
			GAMEPLAY::SET_BIT(&iLocal_234, 5);
			GAMEPLAY::CLEAR_BIT(&Local_96, 5);
			GAMEPLAY::CLEAR_BIT(&Local_96, 17);
			GAMEPLAY::CLEAR_BIT(&iLocal_234, 14);
			GAMEPLAY::CLEAR_BIT(&iLocal_234, 19);
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 16))
			{
				if (GAMEPLAY::IS_BIT_SET(Local_96, 18))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_96, 4))
					{
						GAMEPLAY::SET_BIT(&Local_96, 16);
					}
				}
			}
			if (func_39(&(Local_96.f_21)))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 12))
				{
					if (func_33(&(Local_96.f_21), 360000, 0))
					{
						GAMEPLAY::SET_BIT(&Local_96, 12);
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_96, 15))
					{
						if (func_33(&(Local_96.f_21), 240000, 0))
						{
							GAMEPLAY::SET_BIT(&Local_96, 15);
						}
					}
				}
				else
				{
					GAMEPLAY::SET_BIT(&iLocal_234, 9);
				}
			}
		}
		iVar0 = iLocal_119;
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			iVar2 = iVar3;
			if (GAMEPLAY::IS_BIT_SET(iLocal_234, 5))
			{
				if (vLocal_135[iVar0 /*3*/].f_2 < 7)
				{
					GAMEPLAY::CLEAR_BIT(&iLocal_234, 5);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_96, false))
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], false))
				{
					iLocal_241++;
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 2))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 17))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_7, iVar2))
					{
						if (vLocal_135[iVar0 /*3*/].f_2 > 4)
						{
							GAMEPLAY::SET_BIT(&(Local_96.f_7), iVar2);
							GAMEPLAY::SET_BIT(&Local_96, 17);
						}
					}
				}
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 5))
				{
					GAMEPLAY::SET_BIT(&Local_96, 5);
				}
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 4))
				{
					if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], true))
					{
						Local_96.f_8 = iVar3;
						GAMEPLAY::SET_BIT(&Local_96, 4);
						GAMEPLAY::CLEAR_BIT(&iLocal_234, 15);
						GAMEPLAY::CLEAR_BIT(&Local_96, 18);
					}
				}
				if (!GAMEPLAY::IS_BIT_SET(Local_96, 4))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_96, 18))
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 7))
						{
							GAMEPLAY::SET_BIT(&Local_96, 18);
						}
					}
				}
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, 9))
				{
					if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 5))
					{
						GAMEPLAY::CLEAR_BIT(&iLocal_234, 9);
					}
				}
				if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 14))
				{
					if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 6))
					{
						GAMEPLAY::SET_BIT(&iLocal_234, 14);
					}
				}
				if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 20))
				{
					if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 8))
					{
						GAMEPLAY::SET_BIT(&iLocal_234, 20);
					}
				}
			}
		}
		...
		if (iLocal_119 >= vLocal_135.x)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 16))
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
				{
					if (func_35(Local_96.f_9[0]))
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_96, 4))
						{
							if (GAMEPLAY::IS_BIT_SET(iLocal_234, 15))
							{
								if (!func_39(&uLocal_239))
								{
									func_40(&uLocal_239, 0, 0);
								}
								else if (func_33(&uLocal_239, 2000, 0))
								{
									GAMEPLAY::SET_BIT(&Local_96, 16);
								}
							}
			...
			GAMEPLAY::SET_BIT(&iLocal_234, false);
			if (!GAMEPLAY::IS_BIT_SET(Local_96, false))
			{
				if (iLocal_241 >= 1)
				{
					GAMEPLAY::SET_BIT(&Local_96, false);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 14))
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, 14))
				{
					GAMEPLAY::SET_BIT(&Local_96, 14);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 19))
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, 20))
				{
					GAMEPLAY::SET_BIT(&Local_96, 19);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 6))
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, 5))
				{
					if (Local_96.f_2 > 1 && Local_96.f_2 <= 7)
					{
						GAMEPLAY::SET_BIT(&Local_96, 6);
					}
					else if (GAMEPLAY::IS_BIT_SET(Local_96, 10))
					{
						GAMEPLAY::SET_BIT(&Local_96, 6);
					}
				}
			...
			{
				GAMEPLAY::CLEAR_BIT(&Local_96, 17);
				GAMEPLAY::CLEAR_BIT(&Local_96, 15);
				GAMEPLAY::CLEAR_BIT(&Local_96, 12);
				func_37(&(Local_96.f_21));
				func_40(&(Local_96.f_21), 0, 0);
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_96, 11))
			{
				if (GAMEPLAY::IS_BIT_SET(Local_96, 12))
				{
					if (GAMEPLAY::IS_BIT_SET(iLocal_234, 9))
					{
						GAMEPLAY::SET_BIT(&Local_96, 11);
					}
				}
			}
		}
...
void func_38(int iParam0)
{
	if (network_is_host_of_this_script())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_96, 7))
		{
			if (GAMEPLAY::IS_BIT_SET(vLocal_135[iParam0 /*3*/], 3))
			{
				GAMEPLAY::SET_BIT(&Local_96, 7);
			}
		}
	}
}
...
void func_49()
{
	...
	if (GAMEPLAY::IS_BIT_SET(Local_96, 10))
	{
		if (vLocal_135[participant_id_to_int() /*3*/].f_2 < 6)
		{
			vLocal_135[participant_id_to_int() /*3*/].f_2 = 6;
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Local_96, 4))
	{
	...
	if (vLocal_135[participant_id_to_int() /*3*/].f_2 > 0)
	{
		if (vLocal_135[participant_id_to_int() /*3*/].f_2 < 6)
		{
			if ((((func_46(player_id(), 1) || func_304()) || func_303() > 0) || func_44(player_id(), 1)) || func_302())
			{
				vLocal_135[participant_id_to_int() /*3*/].f_2 = 6;
			}
		}
	...
	switch (vLocal_135[participant_id_to_int() /*3*/].f_2)
	{
		case 0:
			if (GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], false))
			{
				if (GAMEPLAY::IS_BIT_SET(Local_96, 3))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_96, 15))
					{
						GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 2);
						func_299(11, 1);
						vLocal_135[participant_id_to_int() /*3*/].f_2 = 3;
					}
					else
					{
						vLocal_135[participant_id_to_int() /*3*/].f_2 = 6;
						GAMEPLAY::SET_BIT(&iLocal_234, 16);
					}
				}
			}
			break;
		...
		case 3:
			if (func_298(Local_96.f_5))
			{
				func_297(Local_96.f_5);
				vLocal_135[participant_id_to_int() /*3*/].f_2 = 4;
			}
			break;
		...
		case 4:
			if (!func_296())
			{
				if (func_186())
				{
					vLocal_135[participant_id_to_int() /*3*/].f_2 = 5;
					func_184(88, 1);
					func_183();
				}
				else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 8))
				{
					vLocal_135[participant_id_to_int() /*3*/].f_2 = 6;
				}
			}
			...
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_234, 8))
				{
					vLocal_135[participant_id_to_int() /*3*/].f_2 = 6;
				}
				if (GAMEPLAY::IS_BIT_SET(Local_96, 15))
		...
		case 6:
			vLocal_135[participant_id_to_int() /*3*/] = 0;
			GAMEPLAY::CLEAR_BIT(&iLocal_234, 3);
			GAMEPLAY::CLEAR_BIT(&iLocal_234, 4);
			iLocal_233 = 0;
			func_161(12, 116);
			if (does_blip_exist(Global_1715375))
			{
				remove_blip(&Global_1715375);
			}
			func_57(&Local_246);
			func_50();
			func_299(11, 0);
			vLocal_135[participant_id_to_int() /*3*/].f_2 = 7;
			break;
		
		case 7:
			if (Local_96.f_2 == 0 && !GAMEPLAY::IS_BIT_SET(Local_96, 10))
			{
				vLocal_135[participant_id_to_int() /*3*/].f_2 = 0;
			}
			break;
	}
}
	...
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
	{
		if (!func_35(Local_96.f_9[0]))
		{
			if (does_blip_exist(Global_1715375))
			{
				if (func_159())
				{
					set_blip_display(Global_1715375, 0);
				}
				else
				{
					set_blip_display(Global_1715375, 4);
				}
			}
			else
			{
				Global_1715375 = add_blip_for_entity(net_to_ped(Local_96.f_9[0]));
				set_blip_colour(Global_1715375, 1);
				set_blip_scale(Global_1715375, 0f);
			}
			if (does_blip_exist(Local_246))
			{
				if (func_159())
				{
					set_blip_display(Local_246, 0);
				}
				else
				{
					set_blip_display(Local_246, 4);
				}
				if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 10))
				{
					set_blip_name_from_text_file(Local_246, "FM_GDM_BLP");
					GAMEPLAY::SET_BIT(&iLocal_234, 10);
				}
			}
			if (does_blip_exist(Local_246.f_1))
			{
				if (func_159())
				{
					set_blip_display(Local_246.f_1, 0);
				}
				else
				{
					set_blip_display(Local_246.f_1, 4);
				}
				if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 12))
				{
					set_blip_name_from_text_file(Local_246.f_1, "FM_GDM_BLP");
					GAMEPLAY::SET_BIT(&iLocal_234, 12);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 6))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2359301, 7) && !func_156(player_id(), 0, 0))
				{
					if (is_player_control_on(player_id()))
					{
						if (!func_159())
						{
							func_150("FM_GDM_KIL", 0);
						}
						GAMEPLAY::SET_BIT(&iLocal_234, 6);
					}
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_2359301, 7))
			{
				func_50();
				GAMEPLAY::CLEAR_BIT(&iLocal_234, 6);
			}
			...
			else if (func_156(player_id(), 0, 0))
			{
				func_50();
				GAMEPLAY::CLEAR_BIT(&iLocal_234, 6);
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 6))
		{
			func_50();
			GAMEPLAY::CLEAR_BIT(&iLocal_234, 6);
		}
		if (!GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], true))
		{
			iVar1 = network_get_destroyer_of_network_id(Local_96.f_9[0], &uVar0);
			if (iVar1 == player_id())
			{
				GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), true);
				iVar2 = func_147(func_149(player_id(), 1), 1);
				if (iVar2 > 100)
				{
					iVar2 = 100;
				}
				iVar3 = iVar2 * 20;
				iVar3 = round(Global_262145.f_4222 * IntToFloat(iVar3));
				func_110(2, "XPT_KAIE", -1859646258, 2131309714, iVar3, 1, -1, 0);
				if (Global_262145.f_2418 != 0f)
				{
					iVar4 = round(Global_262145.f_2418);
				}
				else
				{
					iVar4 = 2000;
				}
				if (Global_262145.f_2414 != 0f)
				{
					iVar5 = round(Global_262145.f_2414);
				}
				else
				{
					iVar5 = 8000;
				...
				if (func_70())
				{
					if (iVar8 > 0)
					{
						func_61(-352356931, iVar8, &uVar9, 0, 0, 0);
						Global_2558146[uVar9 /*73*/].f_8 = -1146479277;
					}
				}
				else
				{
					_0x515B4A22E4D3C6D7(iVar8, -1146479277);
				}
				func_60(5, iVar8);
			}
			else if (iVar1 != func_59())
			{
				...
				{
					if (!GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], 7))
					{
						if (!network_is_player_a_participant(iVar1))
						{
							GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 7);
						}
					}
				}
			}
...
void func_61(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_62(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!iVar0)
	{
		if (!_0xB24F0944DA203D9E(func_17()) || _0x810E8431C0614BF9())
		{
			Global_2558637 = 1;
			return false;
		}
...
void func_64(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_65(&(Global_2558146[iParam0 /*73*/]));
	}
}
...
int func_69(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8)
{
	int iVar0;
...
void func_71(int iParam0, int iParam1)
{
	...
	if (*iParam0 > 0)
	{
		if (!func_108())
		{
			if (func_107(0))
			{
				if (network_is_player_active(func_106()))
				{
					if (func_105() == 100)
					{
						iVar0 = *iParam0;
...
void func_72(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_330(iParam0, 0, 1))
	{
		Var0 = 447;
		Var0.f_1 = player_id();
		Var0.f_2 = iParam1;
		Var0.f_3 = iParam2;
		trigger_script_event(1, &Var0, 5, func_73(iParam0));
	}
}

auto func_73(int iParam0)
{
	auto uVar0;
...
int func_75(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	struct<16> Var1;
	...
	if (_0x9DE986FC9A87C474(player_id(), iParam1) || iParam5)
	{
		...
		_0x39BBF623FC803EAC(func_82(iParam1, -2, 1, 0));
		add_text_component_substring_player_name(func_80(&Var1));
		if (!iParam3 == 0)
		{
...
void func_76(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_79() || !network_is_activity_session()) || !func_15(player_id(), 0))
	{
		return;
	}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_300(player_id()) || (func_102() && func_101()))
	{
		iVar0 = func_100();
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (is_ped_a_player(iVar0))
			{
				...
				{
					if (func_330(_network_get_ped_player(iVar0), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_90(iParam0, _network_get_ped_player(iVar0), iParam1, iParam2, iParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_90(iParam0, player_id(), iParam1, iParam2, iParam3);
		}
	}
	return func_90(iParam0, player_id(), iParam1, iParam2, iParam3);
}
...
{
	return func_84(player_id(), iParam0, iParam1, iParam2);
}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_89(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_88(1);
...
int func_85(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_86(Global_1617379.f_70365))
	{
		if (iVar0 == 1)
		{
			iVar0 = 0;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_98(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_89(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_88(1);
			}
			...
			{
				return func_84(iParam1, 1, iVar0, iParam4);
			}
		}
...
int func_93(int iParam0)
{
	if (!iParam0 == func_59())
	{
		...
		{
			return Global_2413760.f_1946.f_11[func_94(iParam0)];
		}
	}
	return -1;
}
...
int func_95(int iParam0, int iParam1)
{
	...
	return Global_1610316[iParam0 /*174*/].f_10 != func_59();
}
...
int func_96(int iParam0)
{
	if (iParam0 != func_59())
	{
		if (Global_1610316[iParam0 /*174*/].f_10 != func_59())
		{
...
int func_99(int iParam0, int iParam1, int iParam2)
{
	...
	{
		iVar0 = func_84(iParam1, !iParam2, iParam0, 0);
	}
	return iVar0;
}
...
{
	return func_95(player_id(), iParam0);
}
...
auto func_110(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	return func_111(iParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7);
}
...
int func_112(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (func_143())
	{
		...
		if (iParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_123(func_131(player_id()) + iVar1, iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (iParam7)
		{
			if (iParam6 == -1)
			{
				func_113(func_115(player_id()) + iVar1);
			}
			else
			{
				func_113(func_115(player_id()) + iParam6);
			}
		}
		if (iParam7)
		{
...
void func_117(int iParam0)
{
	...
	if (_network_player_is_in_clan())
	{
		if (network_clan_player_is_active(&Var0))
		{
			...
			if (iVar13 == 0)
			{
				func_119(&Global_1347641, iParam0);
				func_118(joaat("mpply_crew_local_xp_0"), Global_1347641);
			}
			else if (iVar13 == 1)
			{
				func_119(&Global_1347642, iParam0);
				func_118(joaat("mpply_crew_local_xp_1"), Global_1347642);
			}
			else if (iVar13 == 2)
			{
				func_119(&Global_1347643, iParam0);
				func_118(joaat("mpply_crew_local_xp_2"), Global_1347643);
			}
			else if (iVar13 == 3)
			{
				func_119(&Global_1347644, iParam0);
				func_118(joaat("mpply_crew_local_xp_3"), Global_1347644);
			}
			else if (iVar13 == 4)
			{
				func_119(&Global_1347645, iParam0);
				func_118(joaat("mpply_crew_local_xp_4"), Global_1347645);
			}
		}
	}
}
...
void func_123(int iParam0, int iParam1, int iParam2)
{
	if (func_143())
	{
		...
		if (Global_262145.f_7571 == 0 && iParam1 != -1076930708)
		{
			if (iParam2 == 0)
			{
				if (iParam0 < Global_1347756[func_130(-1)])
				{
					playstats_award_xp(iParam0, -523908350, iParam1);
					return;
				}
				else if (iParam0 == Global_1347756[func_130(-1)])
				{
					return;
				}
			}
		...
		if (func_129(player_id()))
		{
			...
			Global_1587523[player_id() /*444*/].f_195.f_6 = func_147(iParam0, 1);
		}
		func_128(632, iParam0, -1, 1);
		func_127(633, func_147(iParam0, 1), -1, 1);
		Global_1347756[func_130(-1)] = iParam0;
		func_124(7, 0);
	}
}
...
bool func_126(int iParam0, auto uParam1)
{
	if (Global_1315901)
	{
		return false;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_130(iParam2)];
	if (iVar0 != 0)
	{
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 780:
			Global_1347702[func_130(iParam2)] = iParam1;
			break;
		
		case 781:
			Global_1347708[func_130(iParam2)] = iParam1;
			break;
		
		case 782:
			Global_1347714[func_130(iParam2)] = iParam1;
			break;
		
		case 783:
			Global_1347720[func_130(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_1347678[func_130(iParam2)] = iParam1;
			break;
		
		case 771:
			Global_1347684[func_130(iParam2)] = iParam1;
			break;
		
		case 772:
			Global_1347690[func_130(iParam2)] = iParam1;
			break;
		
		case 773:
			Global_1347696[func_130(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_1347654[func_130(iParam2)] = iParam1;
			break;
		
		case 761:
			Global_1347660[func_130(iParam2)] = iParam1;
			break;
		
		case 762:
			Global_1347666[func_130(iParam2)] = iParam1;
			break;
		
		case 763:
			Global_1347672[func_130(iParam2)] = iParam1;
			break;
		
		case 750:
			Global_1347726[func_130(iParam2)] = iParam1;
			break;
		
		case 751:
			Global_1347732[func_130(iParam2)] = iParam1;
			break;
		
		case 752:
			Global_1347738[func_130(iParam2)] = iParam1;
			break;
		
		case 753:
			Global_1347744[func_130(iParam2)] = iParam1;
			break;
		
		case 1296:
			Global_1347750[func_130(iParam2)] = iParam1;
			break;
		
		case 632:
			Global_1347756[func_130(iParam2)] = iParam1;
			break;
		
		case 1271:
			Global_1347762[func_130(iParam2)] = iParam1;
			break;
		
		case 1868:
			Global_2492924[0 /*6*/][func_130(iParam2)] = iParam1;
			break;
		
		case 2259:
			Global_2492924[1 /*6*/][func_130(iParam2)] = iParam1;
			break;
		
		case 2907:
			Global_2492924[2 /*6*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3036:
			Global_2492924[3 /*6*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3891:
			Global_2492986[func_130(iParam2)] = iParam1;
			break;
		
		case 757:
			Global_1347768[func_130(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_1347774[func_130(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_1347780[func_130(iParam2)] = iParam1;
			break;
		
		case 1229:
			Global_1347786[func_130(iParam2)] = iParam1;
			break;
		
		case 3031:
			Global_2492955[0 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3032:
			Global_2492955[1 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3033:
			Global_2492955[2 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3034:
			Global_2492955[3 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3035:
			Global_2492955[4 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3216:
			Global_2492991[0 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3217:
			Global_2492991[1 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3218:
			Global_2492991[2 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3219:
			Global_2492991[3 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3220:
			Global_2492991[4 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3221:
			Global_2493017[0 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3222:
			Global_2493017[1 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3223:
			Global_2493017[2 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3224:
			Global_2493017[3 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3225:
			Global_2493017[4 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3199:
			Global_2492955[5 /*5*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3205:
			Global_2492924[4 /*6*/][func_130(iParam2)] = iParam1;
			break;
		
		case 3243:
			Global_2493043[func_130(iParam2)] = iParam1;
			break;
		
		case 3244:
			Global_2493058[func_130(iParam2)] = iParam1;
			break;
		
		case 3245:
			Global_2493048[func_130(iParam2)] = iParam1;
			break;
		
		case 3246:
			Global_2493063[func_130(iParam2)] = iParam1;
			break;
		
		case 3247:
			Global_2493053[func_130(iParam2)] = iParam1;
			break;
		
		case 3248:
			Global_2493068[func_130(iParam2)] = iParam1;
			break;
		
		case 3269:
			Global_2493073[func_130(iParam2)] = iParam1;
			break;
...
int func_131(int iParam0)
{
	if (Global_1312466.f_9 == 0)
	{
		if (iParam0 > -1)
		{
			if (iParam0 == player_id())
			{
				return Global_1347756[func_130(-1)];
			}
...
int func_134(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_130(iParam1)];
	if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
void func_135(int iParam0)
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		...
		if (network_is_participant_active(iVar4))
		{
			...
			{
				if (get_player_team(iVar5) == iVar1 || func_89(get_player_team(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != player_id())
					{
	...
	if (iVar3)
	{
		iVar6 = round(func_136(*iParam0, 100) * 10f * Global_262145.f_4211);
	}
	if (iVar2 > 4)
	{
		iVar2 = 4;
	...
	if (iVar2 >= 2)
	{
		iVar7 = round(func_136(*iParam0, 100) * 20f * Global_262145.f_4204);
	}
	*iParam0 += iVar6;
	*iParam0 += iVar7;
}
...
bool func_137(int iParam0, int iParam1)
{
	if (_network_player_is_in_clan())
	{
		Global_2459440 = {func_122(iParam0)};
		Global_2459453 = {func_122(iParam1)};
...
void func_138(int iParam0, int iParam1)
{
	...
	else
	{
		...
		{
			iVar4 = iVar0;
			if (func_330(iVar4, 1, 1))
			{
				if (iVar4 != player_id())
				{
					if (func_139(player_id(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_137(player_id(), iVar4))
						{
	...
	if (iVar2)
	{
		iVar5 = round(func_136(*iParam1, 100) * 10f * Global_262145.f_4211);
	}
	if (iVar1 > 4)
	{
		iVar1 = 4;
	...
	if (iVar1 >= 1)
	{
		iVar6 = round(func_136(*iParam1, 100) * 20f * Global_262145.f_4204);
	}
	*iParam1 += iVar5;
	*iParam1 += iVar6;
}
...
{
	return vdist(func_18(iParam0), func_18(iParam1));
	return 0f;
}
...
auto func_140(int iParam0)
{
	...
	iVar0 = round(func_136(*iParam0, 100) * 25f);
	*iParam0 += iVar0;
	return *iParam0;
}
...
int func_141(int iParam0)
{
	if (iParam0 < 0)
	{
		if (absi(iParam0) > func_131(player_id()))
		{
			iParam0 = -func_131(player_id());
		}
	}
	if (func_142(8000, 0, 0) > 0)
	{
		if (func_142(8000, 0, 0) < iParam0 + func_131(player_id()))
		{
			iParam0 = func_142(8000, 0, 0) - func_131(player_id());
		}
	}
	return iParam0;
}
...
int func_157(int iParam0)
{
	if (iParam0 != func_59())
	{
		if (func_330(iParam0, 1, 1))
		{
			...
			{
				return func_158(Global_2418472[iParam0 /*313*/].f_305.f_1) == 0;
			}
		}
	}
	return false;
...
void func_161(int iParam0, int iParam1)
{
	...
	if (!Global_2394116[iVar0 /*44*/].f_3 && Global_2394116[iVar0 /*44*/])
	{
		Global_2394116[iVar0 /*44*/].f_3 = 1;
		func_165();
	}
	func_162(iVar0);
}
...
void func_164(int iParam0)
{
	...
	Global_2394116[iParam0 /*44*/].f_4 = func_59();
...
void func_165()
{
	...
	if (Global_16775 < 0)
	{
		func_172("[MMM][NewJobInv][JobList] Calling Reset_New_Invites_Indicator from Decrement_New_Invites_Indicator");
	}
	func_166();
}
...
void func_166()
{
	if (!Global_14572)
	{
		...
		{
			func_171(Global_14394, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_167(1);
			func_171(Global_14394, "DISPLAY_VIEW", 1f, to_float(Global_14393), -1082130432, -1082130432, -1082130432);
		}
	}
}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (Global_2443081)
							{
								if (iVar1 == 14)
								{
									func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16775), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2852[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16780), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_69489)
								{
									...
									func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14413)
									...
									func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar5), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2290[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar8), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_168(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(false), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2852[iVar0] = 1;
						}
					}
...
void func_168(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_171(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	_push_scaleform_movie_function(iParam0, sParam1);
	_push_scaleform_movie_function_parameter_int(round(fParam2));
	if (fParam3 != -1f)
...
bool func_174()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 17))
	{
		func_176(12, 116, "", 1);
		GAMEPLAY::SET_BIT(&iLocal_234, 17);
	}
	else if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 18))
	{
		if (func_175(12, 116))
		{
			GAMEPLAY::SET_BIT(&iLocal_234, 18);
		}
	}
	else
	{
...
void func_176(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar2 = false;
	StringCopy(&Var3, "", 32);
	func_177(iParam1, iVar1, iVar2, sParam2, &Var3, iParam3, -1, -1, -1);
}

void func_177(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, auto uParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_2394116[iVar4 /*44*/].f_4 = iVar0;
	Global_2394116[iVar4 /*44*/].f_5 = iVar1;
	Global_2394116[iVar4 /*44*/].f_6 = iParam2;
	...
	if (is_durango_version())
	{
		if (iParam2)
		{
			...
			{
				Var6 = {func_122(iVar0)};
				iVar19 = _0x36391F397731595D(&Var6);
				if (iVar19 != -1)
				{
...
int func_179()
{
	...
	while (iVar6 < 7)
	{
		...
		{
			case 0:
				StringCopy(&cVar0, func_180(47, -1), 24);
				break;
			
			case 1:
				StringCopy(&cVar0, func_180(48, -1), 24);
				break;
			
			case 2:
				StringCopy(&cVar0, func_180(49, -1), 24);
				break;
			
			case 3:
				StringCopy(&cVar0, func_180(50, -1), 24);
				break;
			
			case 4:
				StringCopy(&cVar0, func_180(51, -1), 24);
				break;
			
			case 5:
				StringCopy(&cVar0, func_180(52, -1), 24);
				break;
			
			case 6:
				StringCopy(&cVar0, func_180(53, -1), 24);
				break;
	...
	while (iVar6 < iVar7)
	{
		...
		if (iVar9 != -1)
		{
			if (!GAMEPLAY::IS_BIT_SET(iVar8, iVar9))
			{
				return 7;
			}
		}
...
char* func_180(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2491657[iParam0 /*5*/][func_130(iParam1)];
...
void func_183()
{
	...
	iVar0 = Global_1347750[func_130(-1)];
	GAMEPLAY::SET_BIT(&iVar0, 8);
	func_128(1296, iVar0, -1, 1);
}
...
void func_184(int iParam0, int iParam1)
{
	...
	{
		case 59:
			Global_2097152[func_185() /*10375*/].f_7704.f_19 = iVar0;
			break;
		
		case 19:
			Global_2097152[func_185() /*10375*/].f_7704.f_18 = iVar0;
			break;
		
		case 74:
			Global_2097152[func_185() /*10375*/].f_7704.f_12 = iVar0;
			break;
		
		case 20:
			Global_2097152[func_185() /*10375*/].f_7704.f_13 = iVar0;
			break;
		
		case 29:
			Global_2097152[func_185() /*10375*/].f_7704.f_14 = iVar0;
			break;
		
		case 8:
			Global_2097152[func_185() /*10375*/].f_7704.f_15 = iVar0;
			break;
		
		case 31:
			Global_2097152[func_185() /*10375*/].f_7704.f_16 = iVar0;
			break;
		
		case 3:
			Global_2097152[func_185() /*10375*/].f_7704.f_20 = iVar0;
			break;
		
		case 6:
			Global_2097152[func_185() /*10375*/].f_7704.f_17 = iVar0;
			break;
		...
		case 98:
		case 105:
			Global_2097152[func_185() /*10375*/].f_7704.f_23 = iVar0;
			break;
		
		case 76:
			Global_2097152[func_185() /*10375*/].f_7704.f_24 = iVar0;
			break;
		
		case 93:
			Global_2097152[func_185() /*10375*/].f_7704.f_25 = iVar0;
			break;
		...
		case 77:
		case 81:
			Global_2097152[func_185() /*10375*/].f_7704.f_26 = iVar0;
			break;
		
		case 65:
		case 75:
		case 95:
			Global_2097152[func_185() /*10375*/].f_7704.f_27 = iVar0;
			break;
			break;
		
		case 97:
			Global_2097152[func_185() /*10375*/].f_7704.f_29 = iVar0;
			break;
		
		case 88:
			Global_2097152[func_185() /*10375*/].f_7704.f_28 = iVar0;
			break;
		
		case 100:
			Global_2097152[func_185() /*10375*/].f_7704.f_31 = iVar0;
			break;
		
		case 106:
			Global_2097152[func_185() /*10375*/].f_7704.f_32 = iVar0;
			break;
		
		case 99:
			Global_2097152[func_185() /*10375*/].f_7704.f_30 = iVar0;
			break;
	}
}
...
bool func_186()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 4))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 8) || (GAMEPLAY::IS_BIT_SET(iLocal_234, 8) && func_33(&uLocal_237, 600000, 0)))
		{
			if (func_192(Local_96.f_5))
			{
				GAMEPLAY::SET_BIT(&iLocal_234, 4);
				GAMEPLAY::CLEAR_BIT(&iLocal_234, 8);
			}
		}
	}
	else if (!func_191())
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 19))
		{
			if (func_190())
			{
				GAMEPLAY::SET_BIT(&iLocal_234, 19);
			}
			else if (!func_189() && !func_187())
			{
				GAMEPLAY::SET_BIT(&iLocal_234, 8);
				GAMEPLAY::CLEAR_BIT(&iLocal_234, 4);
				func_40(&uLocal_237, 0, 0);
				iLocal_233 = 0;
			}
		}
		else if (!func_187())
...
bool func_192(int iParam0)
{
	...
	switch (iLocal_233)
	{
		...
		case 1:
			...
			func_283(iParam0);
			if (func_193(&uLocal_254, iVar0, "FM_1AU", sLocal_419, 0, 0))
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_234, 11);
				iLocal_233++;
			}
			break;
...
int func_193(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
	char* sVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = false;
	iVar2 = -99;
	return func_194(uParam0, iParam1, sParam2, sParam3, 1, iParam5, iParam4, sVar0, iVar1, iVar2, sVar0, sVar0, -1);
}

int func_194(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, char* sParam10, char* sParam11, int iParam12)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = func_279(sParam2, sParam3);
	iVar2 = 0;
	if (!is_string_null_or_empty(sParam7))
	{
	...
	if (func_270(iVar0, iVar1, iVar2))
	{
		...
		func_268();
		return func_201(uParam0, iParam1, iParam12, sParam2, sParam3, iParam4, iParam5, iParam6, sParam7, iParam8, iParam9, sParam10, sParam11);
	}
	if (!func_200(iParam4))
	{
		return 0;
	}
	func_195(iVar0, iVar1, iVar2, sParam3, iParam4, iParam5, iParam6);
	return 0;
}

void func_195(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_201(auto uParam0, int iParam1, auto uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, char* sParam12)
{
	struct<4> Var0;
	...
	if (iParam5 == 8)
	{
		return func_264(uParam0, sParam3, sParam4);
	}
	if (iParam5 == 4)
	{
		StringCopy(&Var0, "CELL_226", 16);
		return func_261(uParam0, iParam1, sParam3, sParam4, &Var0);
	}
	if (iParam5 == 1 || iParam5 == 7)
	{
		...
		return func_245(uParam0, iParam1, sParam3, sParam4, iParam7);
	}
	if (iParam5 == 5)
	{
		return func_244(iParam1, uParam2, sParam4, iParam7, sParam8, iParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 2)
	{
		return func_234(iParam1, uParam2, sParam4, iParam7, sParam8, iParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 3)
	{
		return func_233(iParam1, uParam2, sParam4, iParam7, sParam8, iParam9, iParam10, sParam11, sParam12);
	}
	if (iParam5 == 6)
	{
		return func_202(iParam1, uParam2, sParam4, iParam7, sParam8, iParam9, iParam10, sParam11, sParam12);
	}
	return 0;
}

bool func_202(int iParam0, auto uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
	
	func_232();
	iVar0 = true;
	if (func_204(iParam0, uParam1, sParam2, iVar0, iParam3, sParam4, iParam5, iParam6, sParam7, sParam8))
	{
		func_203(120000);
		return true;
	}
...
bool func_204(int iParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar3 = 0;
	sVar4 = func_225(sParam5, iParam6, &iVar3);
	uVar5 = func_223(iParam7, &iVar3);
	iVar6 = 0;
	if (!is_string_null_or_empty(sParam8))
	{
		iVar6++;
	...
	{
		iVar12 = func_222(iParam0, sParam2, iVar10, sVar4, uVar5, sVar2, iVar3, iVar11, 1, iVar9, 0, iVar7, iVar8, 0, iVar6, sParam8, sParam9);
	}
	else
	{
		iVar12 = func_208(iParam0, sParam2, iVar10, iVar11, 1, iVar9, 0, iVar7, iVar8, 0);
	}
	if (!iVar12)
	{
		return false;
...
bool func_208(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_209(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (iParam7 == 1)
		{
			Global_2990 = iParam6;
...
bool func_209(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_213()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_214(Global_2562132[iVar2 /*104*/].f_18, Global_2562132[Global_2563381 /*104*/].f_18))
		{
...
bool func_214(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_218()
{
	...
	{
		if (func_221(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_220(PLAYER::PLAYER_PED_ID());
			if (func_219(iVar0) && (!func_170(14) || Global_100106))
			{
				if (Global_101154.f_1826.f_539.f_3549 != iVar0 && func_219(Global_101154.f_1826.f_539.f_3549))
				{
...
bool func_222(int iParam0, char* sParam1, int iParam2, char* sParam3, auto uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
	...
	iVar0 = 3;
	if (func_209(iParam0, sParam1, iParam2, iParam6, sParam3, sParam5, uParam4, iParam7, iParam8, iParam9, iParam11, iParam12, iParam13, iParam14, sParam15, sParam16, iVar0) == 1)
	{
		if (iParam11 == 1)
		{
...
char* func_225(char* sParam0, int iParam1, int iParam2)
{
	if (is_string_null_or_empty(sParam0))
	{
		return sLocal_18;
...
void func_230(int iParam0)
{
	...
	func_231(&(Global_1348553[iVar32 /*5*/]));
	Global_1348714--;
}
...
int func_233(int iParam0, auto uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
	
	func_232();
	iVar0 = false;
	return func_204(iParam0, uParam1, sParam2, iVar0, iParam3, sParam4, iParam5, iParam6, sParam7, sParam8);
}

int func_234(int iParam0, auto uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
	
	iVar0 = false;
	return func_235(iParam0, uParam1, sParam2, iVar0, iParam3, sParam4, iParam5, iParam6, sParam7, sParam8);
}

bool func_235(int iParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	if (!iVar3 == 0 || !is_string_null_or_empty(sVar2))
	{
		iVar12 = func_243(iParam0, sParam2, iVar10, sVar4, uVar5, sVar2, iVar3, iVar11, 1, iVar9, 0, iVar7, iVar8, 0, iVar6, sParam8, sParam9);
	}
	else
	{
		iVar12 = func_237(iParam0, sParam2, iVar10, iVar11, 1, iVar9, 0, iVar7, iVar8, 0);
	}
	if (!iVar12)
	{
		return false;
...
bool func_237(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_238(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (iParam7 == 1)
		{
			Global_2990 = iParam6;
...
bool func_238(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_240()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_241(Global_101154.f_12831[iVar2 /*104*/].f_18, Global_101154.f_12831[Global_16779 /*104*/].f_18))
		{
			Global_16779 = iVar2;
		}
		iVar2++;
...
bool func_241(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
bool func_243(int iParam0, char* sParam1, int iParam2, char* sParam3, auto uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
	...
	GAMEPLAY::CLEAR_BIT(&Global_2283, 10);
	iVar0 = 3;
	if (func_238(iParam0, sParam1, iParam2, iParam6, sParam3, sParam5, uParam4, iParam7, iParam8, iParam9, iParam11, iParam12, iParam13, iParam14, sParam15, sParam16, iVar0) == 1)
	{
		if (iParam11 == 1)
		{
			Global_2990 = iParam10;
...
bool func_244(int iParam0, auto uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
	...
	func_236();
	iVar0 = true;
	if (func_235(iParam0, uParam1, sParam2, iVar0, iParam3, sParam4, iParam5, iParam6, sParam7, sParam8))
	{
		func_203(120000);
		return true;
	}
...
bool func_245(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		iVar0 = func_260(uParam0, iParam1, sParam2, sParam3, iVar1, 0, 0, 1);
	}
	else
	{
		iVar0 = func_251(uParam0, iParam1, sParam2, sParam3, iVar1, 0, 0, 1);
	}
	if (iVar0)
	{
...
int func_251(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	Global_15766 = 0;
	Global_2621441 = 0;
	return func_252(sParam3, iParam4, iParam7);
}
...
void func_259(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_260(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	func_259(uParam0, iParam1, sParam2, iParam5, iParam6, 0);
	Global_15760 = 1;
	Global_15719 = 1;
...
bool func_261(auto uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	}
	...
	if (func_263(uParam0, iParam1, sParam2, sParam3, 9, sParam4, 0, 0, 1))
	{
		func_262();
		func_248();
		func_206();
...
int func_263(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Global_2621441 = 0;
	return func_252(sParam3, iParam4, iParam8);
}

bool func_264(auto uParam0, char* sParam1, char* sParam2)
{
	if (func_266(uParam0, sParam1, sParam2, 12, 0, 0, 0))
	{
		func_265();
		func_206();
		func_247();
...
int func_266(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_278(int iParam0, int iParam1, int iParam2)
{
	...
	return func_270(iParam0, iParam1, iParam2);
}

int func_279(char* sParam0, char* sParam1)
{
	char[64] cVar0;
...
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 11))
	{
		switch (iParam0)
		{
			case 0:
				sLocal_419 = "FMA_KIL1";
				GAMEPLAY::SET_BIT(&iLocal_234, 11);
				break;
			}
	}
}
...
void func_285(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			func_287(12, 3, 0);
			func_286(&uLocal_254, 1, 0, "Lester", 0, 1);
			break;
	}
}

void func_286(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_297(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
			{
				Global_2428492.f_3188.f_1[0] = net_to_veh(Local_96.f_12[0]);
			}
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				Global_2428492.f_3188.f_4[0] = net_to_ped(Local_96.f_9[0]);
			}
			break;
	}
}
...
bool func_298(int iParam0)
{
	...
	{
		case 0:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				return true;
			}
			break;
...
void func_305(struct<2> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, int iParam13)
{
	Param0 = 0;
...
void func_307()
{
	if (vLocal_135[participant_id_to_int() /*3*/].f_2 >= 5 && vLocal_135[participant_id_to_int() /*3*/].f_2 < 6)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_96, 4))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 3))
			{
				if (func_330(Local_96.f_8, 0, 1))
				{
					func_308("FM_TGDM_KIL", Local_96.f_8, 0, 0, 0, 1, 1, 0);
				}
				GAMEPLAY::SET_BIT(&iLocal_234, 3);
			}
		}
	}
}

int func_308(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	struct<16> Var2;
	...
	if (_0x9DE986FC9A87C474(player_id(), iParam1) || iParam3)
	{
		...
		if ((iVar1 != -1 && network_is_activity_session()) && iVar1 < 4)
		{
			...
			{
				_0x39BBF623FC803EAC(func_99(iVar1, iParam1, 0));
			}
			else
			{
				_0x39BBF623FC803EAC(func_82(iParam1, -2, 1, 0));
		...
		add_text_component_substring_player_name(func_80(&Var2));
		if (!iParam4)
		{
			iVar0 = _draw_notification(0, 1);
		}
		...
		{
			Global_2459440 = {func_122(iParam1)};
...
void func_310()
{
	...
	if (iLocal_244 != Local_96.f_15)
	{
		iLocal_244 = Local_96.f_15;
		reserve_network_mission_vehicles(iLocal_244);
	}
	if (iLocal_245 != Local_96.f_16)
	{
		iLocal_245 = Local_96.f_16;
		reserve_network_mission_peds(iLocal_245);
	}
	if (func_330(player_id(), 0, 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], false))
		{
			if (vLocal_135[participant_id_to_int() /*3*/].f_2 == 0)
			{
				if (func_303() == 0)
				{
					GAMEPLAY::SET_BIT(&(vLocal_135[iVar0 /*3*/]), false);
				}
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], false))
		{
			if ((func_46(player_id(), 1) || func_43(player_id())) || func_303() > 0)
			{
				func_37(&uLocal_235);
				GAMEPLAY::CLEAR_BIT(&(vLocal_135[iVar0 /*3*/]), false);
			}
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!is_player_control_on(player_id()))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 7))
					{
						GAMEPLAY::SET_BIT(&iLocal_234, 7);
						func_318();
					}
				}
				else if (GAMEPLAY::IS_BIT_SET(iLocal_234, 7))
				{
					GAMEPLAY::CLEAR_BIT(&iLocal_234, 7);
					if (!func_44(player_id(), 0))
					{
						func_316();
					}
				}
		...
		if (!GAMEPLAY::IS_BIT_SET(vLocal_135[iVar0 /*3*/], 3))
		{
			if (vLocal_135[participant_id_to_int() /*3*/].f_2 > 3 && vLocal_135[participant_id_to_int() /*3*/].f_2 < 6)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2428492.f_3188, true))
				{
					GAMEPLAY::SET_BIT(&(vLocal_135[iVar0 /*3*/]), 3);
				}
			}
		}
		if (vLocal_135[participant_id_to_int() /*3*/].f_2 > 3)
		{
			if (!GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], 5))
			{
				if (func_315(Local_96.f_5))
				{
					GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 5);
				}
			}
			else if (!func_315(Local_96.f_5))
			{
				GAMEPLAY::CLEAR_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 5);
			}
			if (!GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], 6))
			{
				if (func_312(Local_96.f_5))
				{
					GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 6);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(vLocal_135[participant_id_to_int() /*3*/], 8))
			{
				if (func_311())
				{
					GAMEPLAY::SET_BIT(&(vLocal_135[participant_id_to_int() /*3*/]), 8);
				}
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(iLocal_234, 13))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				if (!func_35(Local_96.f_9[0]))
				{
					set_entity_is_target_priority(net_to_ped(Local_96.f_9[0]), 1, 0f);
					GAMEPLAY::SET_BIT(&iLocal_234, 13);
				}
			}
		}
	}
...
bool func_311()
{
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
	{
		if (func_9(Local_96.f_12[0]))
		{
			if (is_vehicle_stuck_timer_up(net_to_veh(Local_96.f_12[0]), 0, 7000) || is_vehicle_stuck_timer_up(net_to_veh(Local_96.f_12[0]), 1, 40000))
			{
				return true;
			}
		}
		...
		case 0:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				if (!func_35(Local_96.f_9[0]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (func_313(net_to_ped(Local_96.f_9[0])))
						{
							return true;
						}
					}
		...
		case 0:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				if (!func_35(Local_96.f_9[0]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(net_to_ped(Local_96.f_9[0]), 1)) < 40000f)
						{
							return true;
						}
					}
...
void func_319()
{
	switch (Local_96.f_6)
	{
				...
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_12[0]))
				{
					if (func_9(Local_96.f_12[0]))
					{
						if (!func_35(Local_96.f_9[0]))
						{
							if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_9[0]), net_to_veh(Local_96.f_12[0])))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -258271821) != 0)
								{
									task_vehicle_drive_wander(net_to_ped(Local_96.f_9[0]), net_to_veh(Local_96.f_12[0]), 20f, 786603);
								}
							}
						}
					}
					...
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
					{
						if (func_9(Local_96.f_12[0]))
						{
							if (!func_35(Local_96.f_9[0]))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_9[0]), net_to_veh(Local_96.f_12[0])))
								{
									if ((AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -258271821) != 0) || GAMEPLAY::IS_BIT_SET(Local_96, 9))
									{
										task_vehicle_drive_wander(net_to_ped(Local_96.f_9[0]), net_to_veh(Local_96.f_12[0]), 30f, 786469);
										if (GAMEPLAY::IS_BIT_SET(Local_96, 9))
										{
											GAMEPLAY::CLEAR_BIT(&Local_96, 9);
										}
									}
								}
							}
		...
		case 3:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				if (!func_35(Local_96.f_9[0]))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -828834893) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), -828834893) != 0)
					{
						if (func_323(Local_96.f_9[0]))
						{
							if (network_has_control_of_network_id(Local_96.f_9[0]))
							{
								task_leave_any_vehicle(net_to_ped(Local_96.f_9[0]), 0, 0);
							}
						}
					}
				}
		...
		case 4:
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
			{
				if (!func_35(Local_96.f_9[0]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), 1805844857) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_9[0]), 1805844857) != 0)
						{
							if (func_323(Local_96.f_9[0]))
							{
								if (network_has_control_of_network_id(Local_96.f_9[0]))
								{
									AI::TASK_SMART_FLEE_PED(net_to_ped(Local_96.f_9[0]), PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 1);
								}
							}
						}
					}
	...
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_9[0]))
	{
		if ((vLocal_135[participant_id_to_int() /*3*/].f_2 >= 5 && vLocal_135[participant_id_to_int() /*3*/].f_2 < 6) && !func_156(player_id(), 0, 0))
		{
			func_320(Local_96.f_9[0], &Local_246, -1082130432, 0, 1, 0, 0, -1);
		}
		else
		{
			func_57(&Local_246);
...
void func_320(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7)
{
	if (network_does_network_id_exist(iParam0))
	{
		if (func_322())
		...
		if (iParam3)
		{
			func_321(net_to_ped(iParam0), iParam1, 1, Global_2428492, iParam4, iParam5, fParam2, sParam6, iParam7);
		}
		else
		{
			func_321(net_to_ped(iParam0), iParam1, -1, Global_2428492, iParam4, iParam5, fParam2, sParam6, iParam7);
...
bool func_321(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_328()
{
	...
	func_299(11, 0);
	func_161(12, 116);
	GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_3188), false);
	GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_3188), true);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (network_is_host_of_this_script())
		{
			if (_0xE64A3CA08DFA37A9(Local_96.f_3))
			{
				network_remove_entity_area(Local_96.f_3);
			}
			Local_96.f_3 = -1;
...
bool func_331()
{
	...
	if (func_332() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_332()) == 0)
		{
			return true;
		}
	}
...
bool func_340(int iParam0, auto uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_342(struct<20> Param0)
{
	func_345(func_346(Param0), Param0);
	func_344(0, -1, 0);
	network_register_host_broadcast_variables(&Local_96, 23);
	network_register_player_broadcast_variables(&vLocal_135, 97);
	set_this_script_can_be_paused(0);
	if (!func_343())
	{
		func_328();
	}
	GAMEPLAY::SET_BIT(&(Global_2428492.f_3188), false);
	GAMEPLAY::CLEAR_BIT(&(Global_2428492.f_3188), true);
}
...
void func_345(int iParam0, struct<17> Param1, auto uParam2, auto uParam3, auto uParam4)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_329();
