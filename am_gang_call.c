...
void func_2()
{
	...
	if (is_bit_set(Local_88.f_10[iLocal_315 /*7*/].f_2, true) || is_bit_set(Local_88.f_10[iLocal_315 /*7*/].f_2, 6))
	{
		if (network_does_network_id_exist(Local_88.f_10[iLocal_315 /*7*/]))
		{
			if (does_entity_exist(net_to_ped(Local_88.f_10[iLocal_315 /*7*/])))
			{
				if (is_entity_dead(net_to_ped(Local_88.f_10[iLocal_315 /*7*/]), 0))
				{
					if (!is_bit_set(Local_88.f_10[iLocal_315 /*7*/].f_2, 6))
					{
						if (iLocal_307 == 0)
						{
							Local_88.f_48++;
							if (!is_bit_set(Local_88.f_2, 12))
							{
								if (network_get_destroyer_of_network_id(Local_88.f_10[iLocal_315 /*7*/], &uVar0) == iLocal_309)
								{
									set_bit(&(Local_88.f_2), 12);
								}
							}
							if ((Local_88.f_42 == iLocal_315 && !is_bit_set(Local_88.f_2, 5)) || Local_88.f_48 == func_385(iLocal_307))
							{
								Var1.f_2 = 155;
								...
								{
									set_bit(&(Local_88.f_2), 5);
								}
							}
							else if (!is_bit_set(Local_88.f_2, 5))
							{
								Var1.f_2 = 154;
								Var1.f_11 = iLocal_308;
								func_20(Var1, func_21(1));
						...
						set_bit(&(Local_88.f_10[iLocal_315 /*7*/].f_2), 6);
					}
				}
				else
				{
					if (!is_bit_set(Local_88.f_10[iLocal_315 /*7*/].f_2, 5))
					{
						set_bit(&iLocal_301, 2);
					}
					set_bit(&iLocal_301, true);
				}
			}
		}
	}
	...
	{
		iLocal_315 = 0;
		if (is_bit_set(Local_88.f_1, false))
		{
			if (!is_bit_set(iLocal_301, true))
			{
				if (!is_bit_set(Local_88.f_1, true))
				{
					set_bit(&(Local_88.f_1), true);
				}
			}
			if (!is_bit_set(iLocal_301, 2))
			{
				if (!is_bit_set(Local_88.f_1, 9))
				{
					set_bit(&(Local_88.f_1), 9);
				}
			}
		}
		clear_bit(&iLocal_301, true);
		clear_bit(&iLocal_301, 2);
	}
}
...
void func_3(int iParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		if (network_does_network_id_exist(Local_88.f_10[iParam0 /*7*/]))
		{
			...
			{
				if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 9))
				{
					iVar2 = false;
					...
					if (iVar2)
					{
						set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 9);
					}
				}
				switch (Local_88.f_10[iParam0 /*7*/].f_5)
				{
					...
					case 1:
						...
						{
							if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 7))
							{
								if ((((get_navmesh_route_result(iVar0) == 2 || (Global_2418472[iLocal_309 /*313*/].f_232 != -1 && func_18(Global_2418472[iLocal_309 /*313*/].f_232) == 4)) || Global_1587523[iLocal_309 /*444*/].f_362) || func_16(iLocal_309)) || func_9(iLocal_309))
								{
									...
									set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 7);
								}
							}
							...
							if (is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 2))
							{
								if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 3))
								{
									if (get_ped_desired_move_blend_ratio(iVar0) == 3f && !get_ped_config_flag(iVar0, 118, 1))
									{
										set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 3);
									}
								}
							}
						}
						if (is_bit_set(Local_88.f_2, true))
						{
							set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 2);
							func_7(iParam0, 3);
						}
					...
					case 3:
						if (Local_88.f_10[iParam0 /*7*/].f_4 == 0)
						{
							if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 4))
							{
								if (get_ped_config_flag(iVar0, 118, 1))
								{
									set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 4);
								}
							}
						}
						break;
...
bool func_19(int iParam0, int iParam1)
{
	if (decor_is_registered_as_type("AttributeDamage", 3))
	{
		...
		{
			if (is_bit_set(decor_get_int(iParam0, "AttributeDamage"), iParam1))
			{
				return true;
			}
		}
...
bool func_22()
{
	if (is_bit_set(Local_88.f_1, false))
	{
		if (iLocal_307 == 1)
		{
			if (is_bit_set(Local_88.f_1, 4))
			{
				set_bit(&(Local_88.f_3), 11);
				return true;
			}
		}
		else if (is_bit_set(Local_88.f_1, true))
		{
			set_bit(&(Local_88.f_3), false);
			return true;
		}
	}
	else if (is_bit_set(Local_88.f_1, 2))
	{
		set_bit(&(Local_88.f_3), true);
		set_bit(&Global_1706779, iLocal_307);
		return true;
	}
	if (is_bit_set(Local_88.f_3, 12))
	{
		return true;
	}
	if (iLocal_307 == 0)
	{
		if (is_bit_set(Local_88.f_2, 2))
		{
			set_bit(&(Local_88.f_3), 2);
			return true;
		}
		if (is_bit_set(Local_88.f_2, 8))
		{
			set_bit(&(Local_88.f_3), 8);
			return true;
		}
		if (is_bit_set(Local_88.f_2, 5))
		{
			set_bit(&(Local_88.f_3), 3);
			return true;
		}
		if (is_bit_set(Local_88.f_2, 9))
		{
			set_bit(&(Local_88.f_3), 9);
			return true;
		}
		if (is_bit_set(Local_88.f_1, 15))
		{
			set_bit(&(Local_88.f_3), 10);
			return true;
		}
	}
	if (!func_6(iLocal_309, 0, 1))
	{
		if (iLocal_307 != 0 || !is_bit_set(Local_88.f_2, true))
		{
			set_bit(&(Local_88.f_3), 4);
			return true;
		}
	}
	else
	{
		...
		{
			set_bit(&(Local_88.f_2), 13);
			set_bit(&(Local_88.f_3), 8);
			return true;
		}
		if (func_33(iLocal_309, 131) || is_bit_set(Global_1610316[iLocal_309 /*174*/].f_1, 11))
		{
			set_bit(&(Local_88.f_2), 13);
			set_bit(&(Local_88.f_2), 8);
			return true;
		}
		...
		else
		{
			if (iLocal_307 == 1)
			{
				if (func_33(iLocal_309, 146))
				{
					set_bit(&(Local_88.f_3), 7);
					return true;
				}
				if (!is_bit_set(Local_88.f_1, 16))
				{
	...
	if (func_6(int_to_playerindex(iLocal_316), 0, 1))
	{
		if (iLocal_307 == 1)
		{
			if (int_to_playerindex(iLocal_316) == iLocal_309)
			{
				if (!is_bit_set(Local_88.f_1, 16))
				{
					if (is_bit_set(Local_140[iLocal_316 /*5*/].f_1, 3))
					{
						set_bit(&(Local_88.f_1), 16);
					}
				}
			}
		}
		...
		{
			if (!is_bit_set(Local_88.f_1, 11))
			{
				if (func_42(int_to_playerindex(iLocal_316)))
				{
					if (!is_bit_set(Local_88.f_4, iLocal_316))
					{
						set_bit(&(Local_88.f_1), 11);
						set_bit(&(Local_88.f_4), iLocal_316);
					}
				}
				else if (is_bit_set(Local_88.f_4, iLocal_316))
				{
					set_bit(&(Local_88.f_1), 11);
					clear_bit(&(Local_88.f_4), iLocal_316);
				}
			}
			else if (is_bit_set(Local_140[iLocal_316 /*5*/].f_1, 2))
			{
				clear_bit(&(Local_88.f_1), 11);
			}
			if (iLocal_307 == 0)
			{
				if (is_bit_set(Local_140[iLocal_316 /*5*/].f_1, false))
				{
					if (Local_140[iLocal_316 /*5*/].f_2 != -1)
					{
						if (!is_bit_set(Local_88.f_2, true))
						{
							set_bit(&(Local_88.f_2), true);
					...
					else if (!is_bit_set(Local_88.f_2, 9))
					{
						if (!func_41())
						{
							func_39();
						...
						set_bit(&(Local_88.f_2), 9);
						set_bit(&(Local_88.f_2), true);
					}
				}
				if (func_41())
				{
					if (!is_bit_set(iLocal_301, 17))
					{
						if (is_bit_set(Local_140[iLocal_316 /*5*/].f_1, 5))
						{
							func_40();
							set_bit(&iLocal_301, 17);
						}
						else if (is_bit_set(Local_140[iLocal_316 /*5*/].f_1, 6))
						{
							func_39();
							set_bit(&iLocal_301, 17);
						}
				...
				if (!is_bit_set(Local_140[iLocal_316 /*5*/].f_1, true))
				{
					if (!is_bit_set(iLocal_301, 3))
					{
						set_bit(&iLocal_301, 3);
					}
				}
				else if (int_to_playerindex(iLocal_316) == iLocal_309)
				{
					if (iLocal_307 == 0)
					{
						if (!is_bit_set(Local_88.f_2, true))
						{
							if (!is_bit_set(Local_88.f_2, 6))
							{
								set_bit(&(Local_88.f_2), 6);
							}
						}
					}
				}
...
void func_37()
{
	if (is_bit_set(Local_88.f_2, 3))
	{
		clear_bit(&(Local_88.f_2), 3);
	}
}
...
int func_42(int iParam0)
{
	...
	return is_bit_set(Global_1338622.f_241.f_136[func_44(10) /*33*/][iParam0], func_43(10));
}
	...
	if (iLocal_307 == 0)
	{
		if (is_bit_set(Local_88.f_2, 3))
		{
			if (get_time_difference(iLocal_314, Local_88.f_6) > 10000)
			{
				if (is_bit_set(Local_88.f_2, true))
				{
					set_bit(&(Local_88.f_2), 2);
				}
			}
		}
		if (is_bit_set(Local_88.f_1, 8))
		{
			if (!is_bit_set(Local_88.f_2, true))
			{
				if (func_50())
		...
		if (!is_bit_set(Local_88.f_2, true))
		{
			...
			{
				set_bit(&(Local_88.f_1), 15);
			}
		}
	}
	if (is_bit_set(Local_88.f_1, false))
	{
		if (is_bit_set(Local_88.f_1, 5))
		{
			if (!is_bit_set(Local_88.f_1, 4))
			{
				if (get_time_difference(iLocal_314, Local_88.f_5) > 600000)
				{
					set_bit(&(Local_88.f_1), 4);
				}
			}
		}
		if (!is_bit_set(Local_88.f_3, 12))
...
bool func_50()
{
	if ((((((((is_bit_set(Local_88.f_2, 6) || is_player_dead(iLocal_309)) || func_25(iLocal_309, 1, 0)) || func_52(iLocal_309)) || func_32(iLocal_309, 0)) || func_32(iLocal_309, 7)) || func_24(iLocal_309)) || Global_2418472[iLocal_309 /*313*/].f_234) || func_51(get_player_ped(iLocal_309), joaat("titan")))
	{
		return true;
	}
	if (iLocal_309 != -1)
	{
		if (is_bit_set(Local_140[iLocal_309 /*5*/].f_1, 4))
		{
			return true;
		}
	}
		...
		else
		{
			switch (iLocal_307)
			{
				case 0:
					...
					while (iVar0 < func_385(iLocal_307))
					{
						if ((!network_does_network_id_exist(Local_88.f_10[iVar0 /*7*/]) && !is_bit_set(Local_88.f_10[iVar0 /*7*/].f_2, true)) && !is_bit_set(Local_88.f_10[iVar0 /*7*/].f_2, 6))
						{
			...
			if (iLocal_307 != 1)
			{
				...
				while (iVar0 < func_385(iLocal_307))
				{
					...
					{
						if (!is_bit_set(Local_88.f_10[iVar0 /*7*/].f_2, 6))
						{
							return false;
						}
					}
			...
			set_bit(&iLocal_301, 2);
			set_bit(&iLocal_301, 3);
			set_bit(&iLocal_301, 4);
			set_bit(&(Local_88.f_1), false);
			set_bit(&Global_1706780, iLocal_307);
			return true;
		}
	}
	return false;
...
void func_57(int iParam0, var uParam1, vector3 vParam2, float fParam3)
{
	if (network_is_host_of_this_script())
	{
		if (!network_does_network_id_exist(Local_88.f_10[iParam0 /*7*/]))
...
void func_58(int iParam0)
{
	...
	if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, true))
	{
		if (!is_entity_dead(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 0))
		{
			if (Local_88.f_10[iParam0 /*7*/].f_4 == 0)
			{
				set_ped_relationship_group_hash(net_to_ped(Local_88.f_10[iParam0 /*7*/]), Global_1574232);
			...
			set_ped_combat_ability(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 2);
			set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 13, true);
			set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 41, true);
			set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 20, true);
			set_ped_config_flag(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 132, true);
			set_ped_config_flag(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 118, false);
			set_ped_config_flag(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 311, true);
			...
			switch (Local_88.f_10[iParam0 /*7*/].f_4)
			{
				case 0:
					func_7(iParam0, 1);
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 0, false);
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 2, false);
					...
					set_ped_config_flag(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 32, true);
					...
					if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, false))
					{
						set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), 2);
					}
					set_ped_flee_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 512, true);
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 17, false);
			...
			if (!is_bit_set(Local_88.f_1, 8))
			{
				set_bit(&(Local_88.f_1), 8);
			}
			set_bit(&(Local_88.f_10[iParam0 /*7*/].f_2), true);
		}
	}
}

bool func_59(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
bool func_62(vector3 vParam0, float fParam1, var uParam2, var uParam3, struct<13> Param4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16)
{
	struct<11> Var0;
	struct<18> Var18;
	vector3 vVar44;
...
bool func_63(var uParam0, var uParam1, var uParam2)
{
	...
	if (iVar25)
	{
		if (Global_2404956.f_1482 == 1)
		{
			if (is_thread_active(Global_2404956.f_1491))
			{
				...
				{
					if (get_time_difference(get_network_time(), Global_2404956.f_1488) < func_195(0))
					{
						return false;
					}
				}
				else if (get_time_difference(get_network_time(), Global_2404956.f_1488) < func_195(0))
				{
					return false;
				}
			}
	...
	if (Global_2404956.f_1482)
	{
		...
		{
			if (func_167() || get_time_difference(get_network_time(), Global_2404956.f_1489) > 10000)
			{
				Global_2404956.f_1489 = get_network_time();
				Global_2404956.f_1483 = 4;
			}
...
void func_66(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5, var uParam6)
{
	vector3 vVar0;
	var uVar3;
	struct<56> Var4;
...
bool func_68(vector3 vParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
...
bool func_69(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	float fVar0;
	var uVar1;
	var uVar8;
...
bool func_78(vector3 vParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_79(var uParam0, vector3 vParam1, float fParam2, float fParam3, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_81(var uParam0, int iParam1, int iParam2)
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
...
void func_83(var uParam0, var uParam1, float fParam2, int iParam3, int iParam4)
{
	if (iParam4)
	{
		switch (*uParam1.f_10)
...
void func_84(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_87(var uParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, float fParam5, int iParam6)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
bool func_89(vector3 vParam0, var uParam1)
{
	int iVar0;
	int iVar1;
...
int func_90(vector3 vParam0, var uParam1, float fParam2, int iParam3, int iParam4)
{
	switch (*uParam3.f_10)
	{
		case 0:
...
bool func_92(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
...
bool func_99(vector3 vParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_104(var uParam0, var uParam1, var uParam2, int iParam3)
{
	vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
...
int func_106(vector3 vParam0, var uParam1)
{
	return is_point_in_angled_area(vParam0, *uParam3, *uParam3.f_3, *uParam3.f_6, 0, true);
}

int func_107(struct<2> Param0, var uParam1)
{
...
void func_109(vector3 vParam0, Vector3 fParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_126(vector3 vParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
bool func_136(vector3 vParam0, var uParam1, var uParam2, float fParam3)
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
...
bool func_137(var uParam0, var uParam1, int iParam2, float fParam3)
{
	int iVar0;
	vector3 vVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_6(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_112(iVar1)))
					{
...
void func_156(vector3 vParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	struct<4> Var2;
...
void func_161(vector3 vParam0, vector3 vParam1, var uParam2, var uParam3, var uParam4)
{
	float fVar0;
...
void func_175(var uParam0, var uParam1, var uParam2, vector3 vParam3)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && player_id() != iVar1) || iParam9 == 0)
		{
			if (func_6(iVar1, iParam5, iParam6))
			{
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam8 || (!is_ped_injured(get_player_ped(iVar1)) && func_112(iVar1)))
					{
...
bool func_188(vector3 vParam0, var uParam1)
{
	if (*uParam3.f_18)
	{
		switch (*uParam3.f_26)
...
bool func_199()
{
	...
	if (!is_bit_set(Local_88.f_2, false))
	{
		set_bit(&(Local_88.f_2), false);
		if (iLocal_307 != 0)
		{
			return true;
		}
					...
					while (iVar0 < iVar3)
					{
						if (iVar4)
						{
							...
							while (iVar1 < func_385(iLocal_307))
							{
								if (iVar5 == -1)
								{
									if (((!network_does_network_id_exist(Local_88.f_10[iVar1 /*7*/]) && !is_bit_set(Local_88.f_10[iVar1 /*7*/].f_2, true)) && !is_bit_set(Local_88.f_10[iVar1 /*7*/].f_2, 6)) && !is_bit_set(Local_88.f_10[iVar1 /*7*/].f_2, 8))
									{
										iVar5 = iVar1;
										iVar4 = true;
									}
							...
							if (iVar5 != -1)
							{
								if (does_entity_exist(uLocal_492[iVar0]))
								{
									if (!is_entity_dead(uLocal_492[iVar0], 0))
									{
										if (!is_ped_a_player(uLocal_492[iVar0]))
										{
											if (func_201(get_entity_model(uLocal_492[iVar0])))
											{
												if (!is_entity_a_mission_entity(uLocal_492[iVar0]))
												{
													if (!is_ped_in_any_vehicle(uLocal_492[iVar0], 0))
													{
														if (func_5(get_entity_coords(uLocal_492[iVar0], 1), get_entity_coords(iVar2, 1), 625f))
														{
															...
															set_bit(&(Local_88.f_10[iVar5 /*7*/].f_2), 8);
															if (!is_bit_set(Local_88.f_1, 12))
															{
																Local_88.f_8 = iLocal_314;
																set_bit(&(Local_88.f_1), 12);
															}
														}
													}
												}
	...
	else if (is_bit_set(Local_88.f_1, 12))
	{
		iVar6 = 0;
		iVar7 = 0;
		iVar8 = false;
		...
		{
			if (is_bit_set(Local_88.f_10[iVar6 /*7*/].f_2, true) || is_bit_set(Local_88.f_10[iVar6 /*7*/].f_2, 6))
			{
				iVar7++;
			}
			else if (is_bit_set(Local_88.f_10[iVar6 /*7*/].f_2, 8))
			{
				if (!is_entity_dead(uLocal_492[Local_88.f_10[iVar6 /*7*/].f_6], 0))
				{
					if (is_entity_a_mission_entity(uLocal_492[Local_88.f_10[iVar6 /*7*/].f_6]))
					{
						...
						{
							remove_all_ped_weapons(uLocal_492[Local_88.f_10[iVar6 /*7*/].f_6], 1);
		...
		if (!iVar8 || get_time_difference(iLocal_314, Local_88.f_8) > 5000)
		{
			...
			while (iVar6 < func_385(iLocal_307))
			{
				if (is_bit_set(Local_88.f_10[iVar6 /*7*/].f_2, 8))
				{
...
void func_205(int iParam0)
{
	...
	{
		set_bit(&(Local_88.f_1), 17);
	}
	else
	{
		clear_bit(&(Local_88.f_1), 17);
	}
}
...
bool func_207()
{
	...
	if (network_is_host_of_this_script())
	{
		...
		else
		{
			...
			{
				case 0:
					if (is_bit_set(Local_88.f_2, 11))
					{
						if (func_6(iLocal_309, 1, 1))
						{
							if (vdist2(func_8(iLocal_309), Local_88.f_39) > 625f)
							{
								clear_bit(&(Local_88.f_2), 11);
								clear_bit(&iLocal_301, 8);
							}
						}
					}
					else
...
bool func_209()
{
	if (!is_bit_set(Local_88.f_1, 18))
	{
		if (get_time_difference(iLocal_314, Local_88.f_5) > 5000)
		{
			set_bit(&(Local_88.f_1), 18);
			return true;
		}
	}
...
void func_211()
{
	if (!is_bit_set(Local_88.f_1, 14))
	{
		Local_88.f_9 = iLocal_314;
		set_bit(&(Local_88.f_1), 14);
	}
}
...
void func_213()
{
	if (!is_bit_set(Local_88.f_1, 10))
	{
		Local_88.f_45 = func_385(iLocal_307);
		Local_88.f_46 = 0;
		Local_88.f_47 = 0;
		set_bit(&(Local_88.f_1), 10);
	}
}
...
void func_216()
{
	...
	set_bit(&iLocal_301, 7);
	if (is_bit_set(Local_88.f_3, true))
	{
	}
	if (is_bit_set(Local_88.f_3, 2))
	{
	}
	if (is_bit_set(Local_88.f_3, 3))
	{
	}
	if (is_bit_set(Local_88.f_3, 9))
	{
	}
	if (is_bit_set(Local_88.f_3, 4))
	{
	}
	if (is_bit_set(Local_88.f_3, 5))
	{
	}
	if (is_bit_set(Local_88.f_3, 11))
	{
		if (player_id() == iLocal_308)
		{
			clear_bit(&iLocal_301, 7);
	...
	if (is_bit_set(Local_88.f_3, false))
	{
		if (player_id() == iLocal_308)
		{
			if (!is_bit_set(Local_88.f_2, true))
...
void func_217()
{
	clear_bit(&(Global_1587523[network_player_id_to_int() /*444*/].f_132), iLocal_307);
...
var func_232(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	return func_233(iParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7);
}

var func_233(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
var func_264(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
void func_270(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_271(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_278(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
bool func_287(char* sParam0, char* sParam1, int iParam2)
{
	...
	{
		if (!is_bit_set(iLocal_306, false))
		{
			func_384(&uLocal_326, 3, 0, sParam1, 0, 1);
			if (func_289(&uLocal_326, iParam2, "CT_AUD", sParam0, 0, 0))
			{
				set_bit(&iLocal_306, false);
			}
		}
		else if (!is_bit_set(iLocal_306, true))
		{
			if (func_288(0))
			{
				set_bit(&iLocal_306, true);
			}
		}
		else if (!func_288(0))
		{
...
int func_289(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
int func_290(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, char* sParam10, char* sParam11, int iParam12)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_297(var uParam0, int iParam1, var uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, char* sParam12)
{
	struct<4> Var0;
...
bool func_298(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
...
bool func_300(int iParam0, var uParam1, char* sParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_305(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_318()
{
	...
	{
		if (func_321(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
bool func_322(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
...
int func_333(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
...
int func_334(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
...
bool func_335(int iParam0, var uParam1, char* sParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, char* sParam8, char* sParam9)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_343(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16)
{
	int iVar0;
...
bool func_344(int iParam0, var uParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6, char* sParam7, char* sParam8)
{
	int iVar0;
...
bool func_345(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_351(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_361(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	func_360(uParam0, iParam1, sParam2, iParam5, iParam6, 0);
	Global_15760 = 1;
	Global_15719 = 1;
...
bool func_362(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4)
{
	if (!is_ped_injured(player_ped_id()))
	{
	}
...
int func_364(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8)
{
...
bool func_365(var uParam0, char* sParam1, char* sParam2)
{
...
int func_367(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_389()
{
	if (network_does_entity_exist_with_network_id(Local_88.f_10[iLocal_317 /*7*/]) && !is_entity_dead(net_to_ped(Local_88.f_10[iLocal_317 /*7*/]), 0))
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (func_5(get_entity_coords(net_to_ped(Local_88.f_10[iLocal_317 /*7*/]), 1), get_entity_coords(player_ped_id(), 1), 50625f))
			{
				if (!is_bit_set(iLocal_301, 4))
				{
					set_bit(&iLocal_301, 4);
				}
			}
			else if (!is_bit_set(iLocal_301, 5))
			{
				if (Local_88.f_42 != -1)
				{
					if (iLocal_317 == Local_88.f_42)
					{
						if (!is_bit_set(iLocal_301, 5))
						{
							set_bit(&iLocal_301, 5);
						}
					}
				}
			}
	...
	{
		if ((!is_bit_set(iLocal_301, 4) && is_bit_set(Local_88.f_1, 8)) || is_bit_set(iLocal_301, 5))
		{
			if (!is_bit_set(Local_140[network_player_id_to_int() /*5*/].f_1, true))
			{
				set_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), true);
			}
		}
		else if (is_bit_set(Local_140[network_player_id_to_int() /*5*/].f_1, true))
		{
			clear_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), true);
		}
		clear_bit(&iLocal_301, 4);
		clear_bit(&iLocal_301, 5);
		iLocal_317 = 0;
	}
}
...
void func_390(int iParam0)
{
	...
	if (network_does_network_id_exist(Local_88.f_10[iParam0 /*7*/]))
	{
		...
		if (player_id() == iLocal_308)
		{
			if (is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, true))
			{
				if (!is_bit_set(iLocal_302[iParam0], false))
				{
					set_bit(&Global_1572922, false);
					set_bit(&(iLocal_302[iParam0]), false);
				}
				if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 9))
				{
					if (!is_bit_set(iLocal_302[iParam0], true))
					{
						iVar6 = true;
					}
				}
				else if (is_bit_set(iLocal_302[iParam0], true))
				{
					clear_bit(&(iLocal_302[iParam0]), true);
				}
			}
		}
		if (iVar6)
		...
		if (network_has_control_of_network_id(Local_88.f_10[iParam0 /*7*/]))
		{
			if (player_id() == iLocal_308)
			{
				if (!is_bit_set(Local_88.f_10[iParam0 /*7*/].f_2, 9) && !is_bit_set(iLocal_302[iParam0], true))
				{
					if (_0x0EDE326D47CD0F3E(iVar0, player_id()))
					{
						...
						set_bit(&(iLocal_302[iParam0]), true);
					}
				}
			}
			if (!is_entity_dead(iVar0, 0) && !is_ped_injured(iVar0))
			{
				switch (Local_88.f_10[iParam0 /*7*/].f_5)
				{
					...
					case 1:
						...
						{
							set_bit(&(Global_2460486.f_4427), false);
						}
						else
						{
							clear_bit(&(Global_2460486.f_4427), false);
						}
					...
					case 2:
						...
						if (player_id() == iLocal_309)
						{
							if (!is_bit_set(Local_140[network_player_id_to_int() /*5*/].f_1, false))
							{
								if (!is_entity_dead(player_ped_id(), 0))
								{
									if ((func_4(get_entity_coords(iVar0, 1), get_entity_coords(player_ped_id(), 1)) && (is_ped_on_foot(player_ped_id()) || is_ped_hanging_on_to_vehicle(player_ped_id()))) || (is_ped_jacking(iVar0) && get_jack_target(iVar0) == player_ped_id()))
									{
										...
										set_ped_relationship_group_hash(iVar0, Global_1574237);
										set_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), false);
										set_bit(&(Global_2460486.f_4427), 2);
									}
								}
							}
						}
					...
					case 3:
						...
						if (!(is_ped_jacking(iVar0) && get_jack_target(iVar0) == get_player_ped(iLocal_309)))
						{
							if (!is_ped_fleeing(iVar0))
							{
								if (func_410(iVar0))
								{
									if ((is_ped_in_any_vehicle(iVar0, 1) || is_ped_jacking(iVar0)) && !is_bit_set(Local_88.f_2, 10))
									{
										if (!func_411(iVar0, -258271821) && !func_411(iVar0, -1273030092))
										{
											if (is_ped_sitting_in_any_vehicle(iVar0))
											{
												...
												{
													task_heli_mission(iVar0, iVar9, false, player_ped_id(), 0f, 0f, 0f, 8, 20f, 0f, -1f, 80, 80, -1f, 0);
												}
												else if (is_this_model_a_plane(iVar10))
												{
													task_plane_mission(iVar0, iVar9, false, player_ped_id(), 0f, 0f, 0f, 8, 25f, 0f, -1f, 80, 80);
												}
												else if (get_entity_model(iVar9) == joaat("taxi"))
												{
				...
				if (is_bit_set(Local_88.f_2, 13))
				{
					...
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 17, true);
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 6, false);
					set_ped_combat_attributes(net_to_ped(Local_88.f_10[iParam0 /*7*/]), 1, false);
				}
				func_391(iVar0);
			}
		}
...
void func_391(int iParam0)
{
	...
	if (is_bit_set(iLocal_301, 16))
	{
		iVar0 = Local_140[network_player_id_to_int() /*5*/].f_3;
		iVar1 = func_392(iVar0);
		if (iVar1 == 1)
		{
			clear_bit(&iLocal_301, 15);
			clear_bit(&iLocal_301, 16);
			if (!func_41())
			{
			...
			set_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), 5);
		}
		else if (iVar1 == 0)
		{
			clear_bit(&iLocal_301, 15);
			clear_bit(&iLocal_301, 16);
			set_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), 6);
		}
		else
		{
			return;
...
{
	if (!is_bit_set(Local_88.f_10[uParam0 /*7*/].f_2, 2))
	{
		return 1f;
	}
	return 3f;
...
void func_414()
{
	...
	iVar0 = is_bit_set(Local_88.f_2, 6);
	iVar1 = is_bit_set(Local_88.f_2, 10);
	func_419();
	if (iLocal_307 != 1)
	{
		if (is_bit_set(Local_88.f_3, 12))
	...
	if (network_is_host_of_this_script())
	{
		...
		while (iVar3 < func_385(iLocal_307))
		{
			iVar2 = is_bit_set(Local_88.f_10[iVar3 /*7*/].f_2, 6);
			Local_88.f_10[iVar3 /*7*/].f_2 = 0;
			Local_88.f_10[iVar3 /*7*/].f_6 = -1;
			if (iVar2)
			{
				set_bit(&(Local_88.f_10[iVar3 /*7*/].f_2), 6);
			}
			iVar3++;
		}
	}
	...
	if (iVar1)
	{
		set_bit(&(Local_88.f_2), 11);
		set_bit(&iLocal_301, 8);
	}
	set_bit(&iLocal_301, 4);
	set_bit(&iLocal_301, 11);
}
...
void func_417()
{
	...
	if (network_is_game_in_progress())
	{
		...
		while (iVar0 < 32)
		{
			set_relationship_between_groups(3, Global_1574198[iVar0], -1467815081);
			set_relationship_between_groups(3, -1467815081, Global_1574198[iVar0]);
			iVar0++;
		}
	}
}
...
void func_418(var uParam0)
{
	...
	if (network_is_game_in_progress())
	{
		...
		while (iVar0 < 32)
		{
			set_relationship_between_groups(3, Global_1574198[iVar0], *uParam0);
			set_relationship_between_groups(3, *uParam0, Global_1574198[iVar0]);
			iVar0++;
		}
	}
}
...
void func_421()
{
	...
	if (iLocal_307 == 1)
	{
		if (player_id() == iLocal_309)
		{
			if (is_bit_set(Local_88.f_1, false))
			{
				...
				if (Global_2460486.f_1610)
				{
					if (!is_bit_set(Local_140[network_player_id_to_int() /*5*/].f_1, 3))
					{
						set_bit(&(Local_140[network_player_id_to_int() /*5*/].f_1), 3);
					}
				}
			}
		}
	...
	else if (iLocal_307 == 0)
	{
		if (Local_88.f_42 != -1)
		{
			if (network_does_entity_exist_with_network_id(Local_88.f_10[Local_88.f_42 /*7*/]))
			{
			...
			if (player_id() == iLocal_308)
			{
				if (!is_bit_set(iLocal_301, 14))
				{
					if (func_287("MPCT_mugsuc", "LAMAR", 19))
					{
						set_bit(&iLocal_301, 14);
					}
				}
			}
		}
...
bool func_423(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_428()
{
	if (player_id() == iLocal_309)
	{
		if (Global_25270)
		{
			if (!is_bit_set(Local_140[iLocal_316 /*5*/].f_1, 4))
			{
				set_bit(&(Local_140[iLocal_316 /*5*/].f_1), 4);
			}
		}
		else
		{
			clear_bit(&(Local_140[iLocal_316 /*5*/].f_1), 4);
		}
	}
}
...
void func_429()
{
	...
	if (player_id() == iLocal_308)
	{
		if (is_bit_set(Global_1572922, false))
		{
			clear_bit(&Global_1572922, false);
			iVar0 = true;
		}
		if (!is_bit_set(Local_140[iLocal_308 /*5*/].f_1, 2))
		{
			if (is_bit_set(Local_88.f_1, 11))
			{
				set_bit(&(Local_140[iLocal_308 /*5*/].f_1), 2);
				iVar0 = true;
			}
		}
		else if (!is_bit_set(Local_88.f_1, 11))
		{
			clear_bit(&(Local_140[iLocal_308 /*5*/].f_1), 2);
		}
		if (iVar0)
		{
...
void func_431(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			set_relationship_between_groups(1, Global_1574198[iVar0], -1467815081);
			set_relationship_between_groups(1, -1467815081, Global_1574198[iVar0]);
		}
		else
		{
			set_relationship_between_groups(3, Global_1574198[iVar0], -1467815081);
...
void func_432(var uParam0, int iParam1)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			set_relationship_between_groups(1, Global_1574198[iVar0], *uParam0);
			set_relationship_between_groups(1, *uParam0, Global_1574198[iVar0]);
		}
		else
		{
			set_relationship_between_groups(3, Global_1574198[iVar0], *uParam0);
...
void func_434()
{
	switch (iLocal_307)
	{
		case 0:
			...
			else if (!is_bit_set(iLocal_301, 13))
			{
				if (!is_bit_set(Local_88.f_2, 11))
				{
					if (is_bit_set(Local_88.f_1, 8))
					...
					if (is_bit_set(Local_88.f_3, 6))
					{
						if (player_id() == iLocal_308)
						{
							if (func_6(iLocal_309, 0, 1))
							{
								...
								set_bit(&iLocal_301, 10);
							}
						}
					}
				}
			}
			if (!is_bit_set(iLocal_301, 9))
			{
				if (is_bit_set(Local_88.f_1, false))
				{
					if (is_bit_set(Local_88.f_3, 7))
...
int func_446(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_118(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_450(1);
...
int func_451(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_149(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_118(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_450(1);
			}
