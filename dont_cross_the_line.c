#region Local Var
	...
	auto uLocal_108 = 0;
	auto uLocal_109 = 0;
	struct<6>[] Local_110 = new struct<6>[16];
	var[] uLocal_207 = new var[4];
	int iLocal_212 = 0;
	int iLocal_213 = 0;
	int iLocal_214 = 0;
	auto uLocal_215 = 0;
	auto uLocal_216 = 0;
	struct<16>[] Local_217 = new struct<16>[4];
	struct<78> Local_282 = 0;
	struct<2>[] Local_360 = new struct<2>[4];
	auto uLocal_369 = 0;
	auto uLocal_370 = 0;
	auto uLocal_371 = 0;
	auto uLocal_372 = 0;
...
void func_4(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		iVar2 = false;
		iVar3 = false;
		while (iVar3 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar3)) && Local_360[iVar3 /*2*/] > -1)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar3 /*2*/].f_1, 6))
				{
					iVar2 = true;
				}
				if (GAMEPLAY::IS_BIT_SET(Local_360[iVar3 /*2*/].f_1, 2))
				{
					iVar1 = true;
				}
				if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar3 /*2*/].f_1, 4))
				{
					iVar0 = false;
				}
			}
			else if (Local_282.f_7[iVar3] != 0)
			{
				Local_282.f_7[iVar3] = 0;
			}
			iVar3++;
		}
		if (!func_11(uParam0.f_28))
		{
			if (!iVar1)
			{
		...
		else if (func_9(uParam0.f_28, 1000, 0))
		{
			if (iVar0)
			{
				func_8(uParam0, 10);
		...
		else
		{
			...
			if (func_9(uParam0.f_26, 10000, 0))
			{
				func_6(0);
				func_5(0, 0);
				Local_282.f_77 = 0;
...
void func_5(int iParam0, int iParam1)
{
	if (iParam0)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_1610316[player_id() /*174*/].f_3, false))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1715393, 7);
		}
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_3), false);
	}
	else
	{
		if (iParam1)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_1715393, 4))
			{
				GAMEPLAY::CLEAR_BIT(&Global_1715393, 4);
			}
			if (GAMEPLAY::IS_BIT_SET(Global_1715393, false))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1715393, true);
				GAMEPLAY::CLEAR_BIT(&Global_1715393, false);
			}
		}
		GAMEPLAY::CLEAR_BIT(&(Global_1610316[player_id() /*174*/].f_3), false);
	}
}
...
void func_6(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_3), true);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1610316[player_id() /*174*/].f_3), true);
	}
}
...
void func_12(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		if (!func_11(uParam0.f_22))
		{
			func_10(uParam0.f_22, 0, 0);
			if (Local_282.f_1 != -1)
			{
				Local_282.f_7[Local_282.f_1]++;
			}
			iVar0 = false;
			while (iVar0 <= _network_get_num_participants_host() - 1)
			{
				...
				{
					Local_282.f_7[iVar0] = 0;
				}
				iVar0++;
			}
		}
		else if (func_9(uParam0.f_22, 3000, 0))
		{
			iVar1 = true;
			iVar0 = false;
			while (iVar0 <= _network_get_num_participants_host() - 1)
			{
				if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar0 /*2*/].f_1, 2))
					{
						iVar1 = false;
					}
					else
...
void func_13(auto uParam0)
{
	...
	func_7(uParam0.f_30);
	func_7(uParam0.f_24);
	GAMEPLAY::CLEAR_BIT(uParam0.f_2, false);
	GAMEPLAY::CLEAR_BIT(uParam0.f_2, true);
	...
	while (iVar0 <= _network_get_num_participants_host() - 1)
	{
		...
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			func_15(uParam0.f_35, 0, iVar0);
		}
		else
		{
			func_14(uParam0.f_35[iVar0 /*79*/].f_18);
			func_15(uParam0.f_35, 3, iVar0);
		}
		iVar0++;
	}
}
...
void func_15(auto uParam0, int iParam1, int iParam2)
{
...
void func_16(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		if (iVar1 <= 1)
		{
			if (!func_11(uParam0.f_24))
			{
				func_10(uParam0.f_24, 0, 0);
			}
			else if (func_9(uParam0.f_24, 1000, 0))
			{
				func_8(uParam0, 8);
			}
			else if (func_9(uParam0.f_24, 500, 0))
			{
				if (iVar2 > -1)
				{
					Local_282.f_1 = iVar2;
...
void func_17(auto uParam0)
{
	if (network_is_host_of_this_script())
	{
		if (func_11(uParam0.f_18))
		{
			if (func_9(uParam0.f_18, 2000, 0) && !GAMEPLAY::IS_BIT_SET(iLocal_213, true))
			{
				func_18(NETWORK::_0x89023FBBF9200E9F() + 1250);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, true);
			}
			if (func_9(uParam0.f_18, 3000, 0))
			{
				func_8(uParam0, 7);
				GAMEPLAY::CLEAR_BIT(&iLocal_213, true);
			}
		}
	}
}
...
void func_21(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		if (func_11(uParam0.f_16))
		{
			if (func_9(uParam0.f_16, 2000, 0))
			{
				func_8(uParam0, 6);
			}
		}
...
void func_22(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		if (!func_11(uParam0.f_32))
		{
			func_10(uParam0.f_32, 0, 0);
		}
		else if (func_9(uParam0.f_32, 1000, 0))
		{
			iVar0 = network_get_num_participants();
			if (iVar0 == 1)
			{
			...
			iVar4 = true;
			switch (Local_282.f_77)
			{
				case 0:
					iVar1 = false;
					while (iVar1 <= _network_get_num_participants_host() - 1)
					{
						if (network_is_participant_active(int_to_participantindex(iVar1)) && Local_360[iVar1 /*2*/] > -1)
						{
							Local_282.f_2[iVar1] = Local_360[iVar1 /*2*/];
						}
						else
						{
							Local_282.f_2[iVar1] = -1;
						}
						iVar1++;
					}
					Local_282.f_77 = 1;
				...
				case 1:
					...
					while (iVar1 <= _network_get_num_participants_host() - 1)
					{
						if (network_is_participant_active(int_to_participantindex(iVar1)))
						{
							if (Local_282.f_2[iVar1] == -1)
							{
								Local_282.f_2[iVar1] = func_23();
							}
						}
						iVar1++;
					}
				...
				case 2:
					...
					while (iVar1 <= _network_get_num_participants_host() - 1)
					{
						if (network_is_participant_active(int_to_participantindex(iVar1)))
						{
							...
							while (iVar2 <= _network_get_num_participants_host() - 1)
							{
								...
								{
									if (iVar2 != iVar1 && (Local_282.f_2[iVar1] == Local_282.f_2[iVar2] || Local_282.f_2[iVar1] == -1))
									{
										Local_282.f_2[iVar1] = -1;
										Local_282.f_77 = 1;
										return;
					...
					while (iVar1 <= _network_get_num_participants_host() - 1)
					{
						if (network_is_participant_active(int_to_participantindex(iVar1)))
						{
							...
							{
								iVar3 = func_23();
								if (iVar3 != -1 && iVar3 < Local_282.f_2[iVar1])
								{
									Local_282.f_2[iVar1] = iVar3;
									return;
								}
							}
						}
				...
				case 3:
					...
					while (iVar1 <= _network_get_num_participants_host() - 1)
					{
						if (network_is_participant_active(int_to_participantindex(iVar1)))
						{
							if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar1 /*2*/].f_1, 5))
							{
								iVar4 = false;
							}
						}
...
void func_24(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		while (iVar2 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar2)) && Local_360[iVar2 /*2*/] > -1)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar2 /*2*/].f_1, 6))
				{
					iVar1 = true;
				}
				if (GAMEPLAY::IS_BIT_SET(Local_360[iVar2 /*2*/].f_1, 2))
				{
					iVar0 = 0;
				}
			}
		...
		else
		{
			...
			if ((iVar0 && iVar3 > 1) || func_9(uParam0.f_14, 30000, 0))
			{
				if (!func_11(uParam0.f_12))
				{
					func_10(uParam0.f_12, 0, 0);
				}
				else if (func_9(uParam0.f_12, 1000, 0))
				{
					func_7(uParam0.f_12);
					if (iVar3 == 1)
					{
...
void func_25(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		while (iVar1 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)) && Local_360[iVar1 /*2*/] > -1)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar1 /*2*/].f_1, true))
				{
					iVar0 = false;
				}
				else
...
void func_26(auto uParam0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		while (iVar1 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)) && Local_360[iVar1 /*2*/] > -1)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_360[iVar1 /*2*/].f_1, false))
				{
					iVar0 = false;
				}
				else
...
void func_28(auto uParam0)
{
	...
	{
		stop_sound(*(uParam0.f_35[participant_id_to_int() /*79*/]).f_5);
	}
	...
	func_41();
	Global_1617379.f_84068 = 0;
	func_40();
	Global_1587523[player_id() /*444*/].f_364 = 0;
	func_39(0, 1, 1, 0);
	func_38();
	func_37();
...
{
	Global_1715393.f_1 = 0;
	Global_1715393 = 0;
	if (player_id() != -1)
	{
		Global_1610316[player_id() /*174*/].f_3 = 0;
	}
	if (iParam0)
	{
		func_10(&(Global_1715393.f_2), 0, 0);
	}
	else
	{
		func_7(&(Global_1715393.f_2));
	}
}
...
void func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_34(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
...
void func_37()
{
	...
	GAMEPLAY::CLEAR_BIT(&Global_1715393, 6);
	GAMEPLAY::CLEAR_BIT(&Global_1715393, 7);
}
...
void func_43(auto uParam0)
{
	...
	if (!func_11(uParam0.f_30))
	{
		func_10(uParam0.f_30, 0, 0);
	}
	else if (func_9(uParam0.f_30, 5000, 0))
	{
		func_176(uParam0, 11);
	}
...
void func_44(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "HIDE_LOBBY");
...
void func_45(auto uParam0)
{
	...
	{
		func_46(uParam0, "DCTL_GAMEOVER", 0, 1);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 12);
	}
}

void func_46(auto uParam0, char* sParam1, int iParam2, int iParam3)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "SET_CENTRAL_MESSAGE");
		func_48(sParam1);
...
void func_49(auto uParam0)
{
	...
	iVar0 = 255;
	func_50(0f, 0f, 1f, 1f, 0, 0, 0, iVar0);
	draw_sprite("LineArcadeMinigame", "Degenatron_DontCrossTheLine_Game", 0.5f, 0.5f, 1f * *uParam0.f_9, 1f, 0f, 255, 255, 255, iVar0, 0);
}

void func_50(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_51(auto uParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 3) && !GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 4))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 4))
		{
			display_help_text_this_frame("DCTL_REPLAYHELP", 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 5);
		}
	}
	func_53(uParam0, 1);
	func_52(uParam0);
	if (Local_282 == 10)
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 4);
		func_176(uParam0, 10);
		func_6(0);
		func_5(0, 0);
	}
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 4) || GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 2))
		{
			func_176(uParam0, 11);
			return;
		}
		GAMEPLAY::CLEAR_BIT(&iLocal_213, false);
		func_13(uParam0);
		func_6(0);
		func_5(0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 4);
...
void func_52(auto uParam0)
{
	...
	while (iVar0 < 4)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_360[iVar0 /*2*/].f_1, 3) && !GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, 2))
			{
				play_sound_frontend(*uParam0.f_6, "Insert_Coin", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_35[iVar0 /*79*/].f_3, 2);
				if (GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, 3))
				{
					GAMEPLAY::CLEAR_BIT(uParam0.f_35[iVar0 /*79*/].f_3, 3);
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Local_360[iVar0 /*2*/].f_1, 4) && !GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, 3))
			{
				play_sound_frontend(*uParam0.f_6, "Cancel", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_35[iVar0 /*79*/].f_3, 3);
...
void func_53(auto uParam0, int iParam1)
{
	...
	if (Local_282.f_2[iLocal_212] != Local_360[iLocal_212 /*2*/])
	{
		Local_360[iLocal_212 /*2*/] = Local_282.f_2[iLocal_212];
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_213, 2))
	{
		iVar0 = false;
		while (iVar0 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar0)))
			{
				if (Local_360[iVar0 /*2*/] > -1 && (is_string_null_or_empty(&(Local_282.f_12[iVar0 /*16*/])) || is_string_null_or_empty(&(Local_217[iVar0 /*16*/]))))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, 2);
				}
			}
			else if (!(is_string_null_or_empty(&(Local_282.f_12[iVar0 /*16*/])) || is_string_null_or_empty(&(Local_217[iVar0 /*16*/]))))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, 2);
			}
			iVar0++;
	...
	if (GAMEPLAY::IS_BIT_SET(iLocal_213, 2))
	{
		...
		if (iVar1 == 1)
		{
			if (iParam1)
			{
				func_54(uParam0, "DCTL_REPLAY", 0);
			}
			else
			{
				func_54(uParam0, "DCTL_INSERT", 0);
			}
			GAMEPLAY::CLEAR_BIT(&iLocal_213, 2);
		}
	}
}

void func_54(auto uParam0, char* sParam1, int iParam2)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "INIT_LOBBY");
		func_48(sParam1);
		_push_scaleform_movie_function_parameter_int(iParam2);
		func_55(0);
		func_55(1);
		func_55(2);
		func_55(3);
		if (iLocal_212 > -1 && Local_360[iLocal_212 /*2*/] > -1)
		{
			_push_scaleform_movie_function_parameter_int(Local_360[iLocal_212 /*2*/]);
		}
		_pop_scaleform_movie_function_void();
	}
}
...
void func_55(int iParam0)
{
	...
	Var16 = {func_56(iParam0)};
	_push_scaleform_movie_function_parameter_string(&Var16);
	func_47(&Var0);
}

struct<16> func_56(int iParam0)
{
	char[64] cVar0;
	int iVar16;
	
	StringCopy(&cVar0, func_57(), 64);
	iVar16 = false;
	while (iVar16 < 4)
	{
		if (network_is_participant_active(int_to_participantindex(iVar16)) && Local_360[iVar16 /*2*/] == iParam0)
		{
			cVar0 = {Local_217[iVar16 /*16*/]};
		}
		iVar16++;
	}
	return cVar0;
...
struct<16> func_58(int iParam0)
{
	...
	while (iVar16 < 4)
	{
		if (network_is_participant_active(int_to_participantindex(iVar16)) && Local_360[iVar16 /*2*/] == iParam0)
		{
			cVar0 = {Local_282.f_12[iVar16 /*16*/]};
		}
		iVar16++;
	}
	return cVar0;
...
void func_59()
{
	...
	while (iVar0 <= _network_get_num_participants_host() - 1)
	{
		if (iVar0 < 4)
		{
			if (network_is_host_of_this_script())
			{
				StringCopy(&(Local_282.f_12[iVar0 /*16*/]), "", 64);
			}
			StringCopy(&(Local_217[iVar0 /*16*/]), func_57(), 64);
		}
		if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
		{
			if (network_is_host_of_this_script())
			{
				StringCopy(&(Local_282.f_12[iVar0 /*16*/]), get_player_name(network_get_player_index(int_to_participantindex(iVar0))), 64);
			}
			iVar1 = func_60(network_get_player_index(int_to_participantindex(iVar0)));
			if (iVar1 != 0)
			{
				StringCopy(&(Local_217[iVar0 /*16*/]), get_pedheadshot_txd_string(iVar1), 64);
			}
		}
		iVar0++;
	}
...
void func_64(int iParam0)
{
	...
	func_65(&(Global_1348553[iVar32 /*5*/]));
	Global_1348714--;
}
...
{
	GAMEPLAY::CLEAR_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 2);
	GAMEPLAY::CLEAR_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 3);
	GAMEPLAY::CLEAR_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 4);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_360[iLocal_212 /*2*/].f_1), iParam0);
}
...
void func_68(auto uParam0)
{
	...
	{
		func_54(uParam0, "DCTL_REPLAY", 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 16);
	}
	func_71(uParam0);
	func_69(uParam0);
}
...
void func_69(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "SET_MICS");
		_push_scaleform_movie_function_parameter_int(func_70(0));
		_push_scaleform_movie_function_parameter_int(func_70(1));
		_push_scaleform_movie_function_parameter_int(func_70(2));
		_push_scaleform_movie_function_parameter_int(func_70(3));
		_pop_scaleform_movie_function_void();
	}
}
...
int func_70(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] == iParam0)
		{
...
void func_71(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "UPDATE_LOBBY");
		func_72(0);
		func_72(1);
		func_72(2);
		func_72(3);
...
void func_72(int iParam0)
{
	...
	iVar0 = false;
	iVar1 = false;
	while (iVar1 < Local_360)
	{
		if (network_is_participant_active(int_to_participantindex(iVar1)) && Local_360[iVar1 /*2*/] == iParam0)
		{
			iVar0 = true;
			if (GAMEPLAY::IS_BIT_SET(Local_360[iVar1 /*2*/].f_1, 3))
			{
				_push_scaleform_movie_function_parameter_int(2);
			}
			else if (GAMEPLAY::IS_BIT_SET(Local_360[iVar1 /*2*/].f_1, 4))
			{
...
void func_73(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "HIDE_HUD");
		_pop_scaleform_movie_function_void();
	}
}
...
void func_74(auto uParam0)
{
	...
	if (Local_282 >= 9)
	{
		...
		iVar0 = func_114(3350, -1, 0);
		iVar0++;
		func_113(3350, iVar0, -1, 1);
		if (Local_282.f_1 == iLocal_212)
		{
			iVar1 = func_114(3349, -1, 0);
			iVar1++;
			func_113(3349, iVar1, -1, 1);
			if (iVar1 >= Global_262145.f_13667)
			{
				func_112(7551, 1, -1, 1);
				if (ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()) == joaat("mp_m_freemode_01"))
				{
					func_75(func_109(-621355603, 3), 1, 1, 0, 0, -1);
				}
				else
				{
					func_75(func_109(-46521805, 4), 1, 1, 0, 0, -1);
				}
			}
		}
		func_59();
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 2))
	{
		func_67(2);
	}
}
...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam1)
	{
		...
		if (iParam2 && iParam0 < 129)
		{
			...
			{
				func_96(12, func_101(iParam0, 3), func_100(iParam0, 3), func_99(iParam0, 3), func_98(iParam0, 3), -1, 0, 0, 0, -1);
				func_95(iParam0, 1);
			}
		}
		if (iParam3)
		{
			func_90(iParam0, 1, iParam5);
		}
	...
	{
		if (func_107(iParam0, iParam5))
		{
			func_104(iParam0, 0, iParam5);
			func_85(1231, -1, iParam5);
		}
		if (func_102(iParam0) == 1)
		{
			func_95(iParam0, 0);
		}
		if (func_84(iParam0, iParam5))
		{
			func_76(iParam0, 0, iParam5);
		}
	}
}
...
void func_76(int iParam0, int iParam1, int iParam2)
{
	if (iParam1)
	{
		...
		{
			func_77(iParam0, 1, iParam2);
		}
	}
	else if (func_84(iParam0, iParam2))
	{
		func_77(iParam0, 0, iParam2);
	}
}
...
void func_77(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, func_82(iVar1));
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&iVar0, func_82(iVar1));
		}
		func_113(func_78(iParam0), iVar0, iParam2, 1);
	}
}
...
int func_78(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_81(iVar0);
	if ((func_80() == 0 || func_79() == 0) || (func_80() == 999 && func_79() == 999))
	{
		switch (iVar1)
		{
			case 0:
...
auto func_83(int iParam0, int iParam1)
{
	...
	uVar0 = func_114(func_78(iParam0), iParam1, 0);
	return uVar0;
}
...
void func_85(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_114(iParam0, func_88(iParam2), 0);
	iVar0 += iParam1;
	if (!func_87(iParam0))
	{
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 780:
			Global_1347702[func_88(iParam2)] = iParam1;
			break;
		
		case 781:
			Global_1347708[func_88(iParam2)] = iParam1;
			break;
		
		case 782:
			Global_1347714[func_88(iParam2)] = iParam1;
			break;
		
		case 783:
			Global_1347720[func_88(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_1347678[func_88(iParam2)] = iParam1;
			break;
		
		case 771:
			Global_1347684[func_88(iParam2)] = iParam1;
			break;
		
		case 772:
			Global_1347690[func_88(iParam2)] = iParam1;
			break;
		
		case 773:
			Global_1347696[func_88(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_1347654[func_88(iParam2)] = iParam1;
			break;
		
		case 761:
			Global_1347660[func_88(iParam2)] = iParam1;
			break;
		
		case 762:
			Global_1347666[func_88(iParam2)] = iParam1;
			break;
		
		case 763:
			Global_1347672[func_88(iParam2)] = iParam1;
			break;
		
		case 750:
			Global_1347726[func_88(iParam2)] = iParam1;
			break;
		
		case 751:
			Global_1347732[func_88(iParam2)] = iParam1;
			break;
		
		case 752:
			Global_1347738[func_88(iParam2)] = iParam1;
			break;
		
		case 753:
			Global_1347744[func_88(iParam2)] = iParam1;
			break;
		
		case 1296:
			Global_1347750[func_88(iParam2)] = iParam1;
			break;
		
		case 632:
			Global_1347756[func_88(iParam2)] = iParam1;
			break;
		
		case 1271:
			Global_1347762[func_88(iParam2)] = iParam1;
			break;
		
		case 1868:
			Global_2492924[0 /*6*/][func_88(iParam2)] = iParam1;
			break;
		
		case 2259:
			Global_2492924[1 /*6*/][func_88(iParam2)] = iParam1;
			break;
		
		case 2907:
			Global_2492924[2 /*6*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3036:
			Global_2492924[3 /*6*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3891:
			Global_2492986[func_88(iParam2)] = iParam1;
			break;
		
		case 757:
			Global_1347768[func_88(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_1347774[func_88(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_1347780[func_88(iParam2)] = iParam1;
			break;
		
		case 1229:
			Global_1347786[func_88(iParam2)] = iParam1;
			break;
		
		case 3031:
			Global_2492955[0 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3032:
			Global_2492955[1 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3033:
			Global_2492955[2 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3034:
			Global_2492955[3 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3035:
			Global_2492955[4 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3216:
			Global_2492991[0 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3217:
			Global_2492991[1 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3218:
			Global_2492991[2 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3219:
			Global_2492991[3 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3220:
			Global_2492991[4 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3221:
			Global_2493017[0 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3222:
			Global_2493017[1 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3223:
			Global_2493017[2 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3224:
			Global_2493017[3 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3225:
			Global_2493017[4 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3199:
			Global_2492955[5 /*5*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3205:
			Global_2492924[4 /*6*/][func_88(iParam2)] = iParam1;
			break;
		
		case 3243:
			Global_2493043[func_88(iParam2)] = iParam1;
			break;
		
		case 3244:
			Global_2493058[func_88(iParam2)] = iParam1;
			break;
		
		case 3245:
			Global_2493048[func_88(iParam2)] = iParam1;
			break;
		
		case 3246:
			Global_2493063[func_88(iParam2)] = iParam1;
			break;
		
		case 3247:
			Global_2493053[func_88(iParam2)] = iParam1;
			break;
		
		case 3248:
			Global_2493068[func_88(iParam2)] = iParam1;
			break;
		
		case 3269:
			Global_2493073[func_88(iParam2)] = iParam1;
			break;
...
void func_91(auto uParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		...
		func_113(func_92(uParam0), iVar0, iParam2, 1);
	}
}

int func_92(auto uParam0)
{
	int iVar0;
	int iVar1;
...
auto func_93(auto uParam0)
{
	...
	uVar0 = func_114(func_92(uParam0), -1, 0);
	return uVar0;
}

int func_94(auto uParam0)
{
	int iVar0;
	int iVar1;
...
void func_95(int iParam0, int iParam1)
{
	...
	if (iVar0 > -1)
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2467971.f_1027[func_81(iVar0)]), func_82(iVar0));
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2467971.f_1027[func_81(iVar0)]), func_82(iVar0));
		}
	}
}

void func_96(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9)
{
	auto uVar0;
	
	uVar0 = func_97(&Global_1344708);
...
auto func_103(int iParam0)
{
	...
	uVar0 = Global_2467971.f_1027[func_81(iParam0)];
	return uVar0;
}
...
void func_104(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		...
		func_113(func_106(iParam0), iVar0, iParam2, 1);
	}
}

auto func_105(auto uParam0, int iParam1)
{
	auto uVar0;
	
	uVar0 = func_114(func_106(uParam0), iParam1, 0);
	return uVar0;
}
...
void func_108(int iParam0, int iParam1)
{
	...
	iVar0 = func_114(iParam0, func_88(iParam1), 0);
	iVar0++;
	if (!func_87(iParam0))
	{
...
void func_115(auto uParam0)
{
	...
	if (Local_282.f_1 != -1)
	{
		...
		{
			Var0 = {func_58(Local_360[Local_282.f_1 /*2*/])};
			iVar16 = func_117(Local_360[Local_282.f_1 /*2*/]);
			func_116(uParam0, "DCTL_WINNERV2", &Var0, 0, 1, iVar16);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 11);
		}
	}
	else if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 11))
	{
		func_46(uParam0, "DCTL_DRAW", 0, 1);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 11);
	}
}

void func_116(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "SET_CENTRAL_MESSAGE");
...
void func_118(auto uParam0)
{
	...
	func_137(uParam0);
	func_136(uParam0);
	if (GAMEPLAY::IS_BIT_SET(iLocal_213, false))
	{
		iVar0 = false;
		while (iVar0 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
			{
				func_121(uParam0, uParam0.f_35, iVar0);
				if (GAMEPLAY::IS_BIT_SET(iLocal_213, 11 + iVar0))
				{
					GAMEPLAY::CLEAR_BIT(&iLocal_213, 11 + iVar0);
				}
				if (GAMEPLAY::IS_BIT_SET(iLocal_213, 7 + iVar0))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, 11 + iVar0);
					GAMEPLAY::CLEAR_BIT(&iLocal_213, 7 + iVar0);
				}
			}
			else if (*uParam0.f_35[iVar0 /*79*/] == 2)
			{
		...
		if (!func_11(&uLocal_215))
		{
			func_10(&uLocal_215, 0, 0);
		}
		else if (func_9(&uLocal_215, 500, 0))
		{
			...
			func_119(4, func_120(*(uParam0.f_35[iLocal_212 /*79*/]).f_14, *(uParam0.f_35[iLocal_212 /*79*/]).f_15, 9974), iLocal_212, -1);
			func_7(&uLocal_215);
		}
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 4) && *uParam0.f_35[iLocal_212 /*79*/] == 2)
		{
		...
		if (Local_282 >= 8)
		{
			...
			while (iVar0 <= 3)
			{
				stop_sound(*(uParam0.f_35[iVar0 /*79*/]).f_5);
				iVar0++;
			}
			if (is_stream_playing())
			{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, false);
	}
}

void func_119(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	struct<6> Var0;
	int iVar6;
	...
	if (!iVar6 == 0)
	{
		trigger_script_event(1, &Var0, 6, iVar6);
	}
}

float func_120(float fParam0, float fParam1, int iParam2)
{
	Vector3 fVar0;
	Vector3 fVar1;
...
void func_121(auto uParam0, auto uParam1, int iParam2)
{
	switch (*uParam1[iParam2 /*79*/])
	{
		case 0:
			switch (iParam2)
			{
				case 0:
					...
					*(uParam1[iParam2 /*79*/]).f_9 = -1;
					func_135(Local_360[iParam2 /*2*/], uParam1[iParam2 /*79*/].f_2, uParam1[iParam2 /*79*/].f_14, uParam1[iParam2 /*79*/].f_15, uParam1[iParam2 /*79*/].f_8);
					break;
			...
			func_14(uParam1[iParam2 /*79*/].f_18);
			func_15(uParam1, 1, iParam2);
			break;
		
		case 1:
			if (Local_282 == 7)
			{
				func_15(uParam1, 2, iParam2);
			}
			break;
		
		case 2:
			if (iParam2 == iLocal_212)
			{
				if (!is_pause_menu_active())
				{
					func_133(uParam1);
			...
			if (!GAMEPLAY::IS_BIT_SET(iLocal_213, 3 + iParam2))
			{
				func_129(uParam0, uParam1, iParam2);
			}
			GAMEPLAY::CLEAR_BIT(&iLocal_213, 3 + iParam2);
			if (iParam2 == iLocal_212)
			{
				func_125(uParam0, uParam1, 1);
				if (func_124(uParam0, uParam1, iLocal_212))
				{
					func_123(iLocal_212);
				}
			}
			else if (func_124(uParam0, uParam1, iParam2))
			{
				*(uParam1[iParam2 /*79*/]).f_17 = 0f;
			}
			break;
...
void func_122(auto uParam0, int iParam1)
{
	...
	fVar0 = to_float(*(uParam0[iParam1 /*79*/]).f_1);
	fVar0 -= 300f * timestep();
	if (fVar0 < 0f)
	{
		fVar0 = 0f;
	}
	*(uParam0[iParam1 /*79*/]).f_1 = floor(fVar0);
}
...
bool func_124(auto uParam0, auto uParam1, int iParam2)
{
	float fVar0;
	float fVar1;
...
void func_125(auto uParam0, auto uParam1, int iParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar0 = 0.5f - 0.5f - *(uParam1[iLocal_212 /*79*/]).f_14 * *uParam0.f_9;
	fVar1 = 0.0068f * *uParam0.f_9;
	iVar20 = *(uParam1[iLocal_212 /*79*/]).f_4 - 1;
	if (iVar20 > -1 && iVar20 < 59)
	{
		func_128(*(uParam1[iLocal_212 /*79*/].f_18)[iVar20], &fVar12, &fVar13, 9974);
		if (*(uParam1[iLocal_212 /*79*/]).f_2 == 2)
		{
			fVar14 = *(uParam1[iLocal_212 /*79*/]).f_14 + fVar1 * 0.5f;
			fVar15 = *(uParam1[iLocal_212 /*79*/]).f_15;
			if (fVar14 > fVar12)
			{
				fVar14 = fVar12;
			}
		}
		else if (*(uParam1[iLocal_212 /*79*/]).f_2 == 3)
		{
			fVar14 = *(uParam1[iLocal_212 /*79*/]).f_14 - fVar1 * 0.5f;
			fVar15 = *(uParam1[iLocal_212 /*79*/]).f_15;
			if (fVar14 < fVar12)
		...
		else if (*(uParam1[iLocal_212 /*79*/]).f_2 == 0)
		{
			fVar14 = *(uParam1[iLocal_212 /*79*/]).f_14;
			fVar15 = *(uParam1[iLocal_212 /*79*/]).f_15 + 0.012f * 0.5f;
			if (fVar15 > fVar13)
			{
				fVar15 = fVar13;
			}
		}
		else if (*(uParam1[iLocal_212 /*79*/]).f_2 == 1)
		{
			fVar14 = *(uParam1[iLocal_212 /*79*/]).f_14;
			fVar15 = *(uParam1[iLocal_212 /*79*/]).f_15 - 0.012f * 0.5f;
			if (fVar15 < fVar13)
	...
	{
		iVar23 = false;
		if (iVar21 == iLocal_212)
		{
		}
		else if (*uParam1[iVar21 /*79*/] == 2 && *uParam1[iLocal_212 /*79*/] == 2)
		{
			iVar22 = 0;
			while (iVar22 <= 59)
			{
				func_128(*(uParam1[iVar21 /*79*/].f_18)[iVar22], &fVar2, &fVar3, 9974);
				if (fVar2 != 0f || fVar3 != 0f)
				{
					...
					{
						func_128(*(uParam1[iVar21 /*79*/].f_18)[iVar22 + 1], &fVar4, &fVar5, 9974);
					...
					iVar26 = false;
					if (*(uParam1[iLocal_212 /*79*/]).f_2 == 2 || *(uParam1[iLocal_212 /*79*/]).f_2 == 3)
					{
						iVar26 = func_127(fVar0, *(uParam1[iLocal_212 /*79*/]).f_15, fVar1 * 0.42f, 0.012f * 0.42f, fVar24, fVar9, fVar25 * 0.95f, fVar11);
					}
					if (*(uParam1[iLocal_212 /*79*/]).f_2 == 0 || *(uParam1[iLocal_212 /*79*/]).f_2 == 1)
					{
						iVar26 = func_127(fVar0, *(uParam1[iLocal_212 /*79*/]).f_15, fVar1 * 0.42f, 0.012f * 0.42f, fVar24, fVar9, fVar25, fVar11 * 0.95f);
					}
					if (iVar26)
					{
						if (iParam2)
					...
					else if (!GAMEPLAY::IS_BIT_SET(iLocal_213, 7 + iVar21) && GAMEPLAY::IS_BIT_SET(iLocal_213, 11 + iVar21))
					{
						if (iVar22 == *(uParam1[iVar21 /*79*/]).f_4 - 1)
						{
							if (((fVar12 != 0f && fVar13 != 0f) && fVar14 != 0f) && fVar15 != 0f)
							{
								func_126(uParam0, fVar12, fVar13, fVar14, fVar15, &fVar16, &fVar17, &fVar18, &fVar19, 0.0015f);
								if (func_127(fVar24, fVar9, fVar25, fVar11, fVar16, fVar17, fVar18, fVar19))
								{
									if (iParam2)
									{
										func_123(iLocal_212);
			...
			if (!iVar23)
			{
				...
				if (func_127(fVar0, *(uParam1[iLocal_212 /*79*/]).f_15, fVar1 * 0.42f, 0.012f * 0.42f, fVar27, *(uParam1[iVar21 /*79*/]).f_15, fVar1 * 0.42f, 0.012f * 0.42f))
				{
					if (iParam2)
					{
						func_123(iLocal_212);
...
void func_126(auto uParam0, float fParam1, float fParam2, float fParam3, float fParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, float fParam9)
{
	float fVar0;
	float fVar1;
...
bool func_127(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7)
{
...
void func_128(float fParam0, float fParam1, float fParam2, int iParam3)
{
...
void func_129(auto uParam0, auto uParam1, int iParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (network_is_participant_active(int_to_participantindex(iParam2)) && *uParam1[iParam2 /*79*/] == 2)
	{
		if (has_sound_finished(*(uParam1[iParam2 /*79*/]).f_5))
		{
			if (Local_360[iParam2 /*2*/] == 0)
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_5, "Trail_1", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			}
			else if (Local_360[iParam2 /*2*/] == 1)
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_5, "Trail_2", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			}
			else if (Local_360[iParam2 /*2*/] == 2)
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_5, "Trail_3", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			}
			else
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_5, "Trail_4", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			}
		}
		if (!has_sound_finished(*(uParam1[iParam2 /*79*/]).f_5))
		{
			set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_5, "X", *(uParam1[iParam2 /*79*/]).f_14);
			set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_5, "Y", *(uParam1[iParam2 /*79*/]).f_15);
		}
	}
	if (*(uParam1[iParam2 /*79*/]).f_9 != *(uParam1[iParam2 /*79*/]).f_2 && *(uParam1[iParam2 /*79*/]).f_4 > 0)
	{
		func_128(*(uParam1[iParam2 /*79*/].f_18)[*(uParam1[iParam2 /*79*/]).f_4 - 1], &fVar0, &fVar1, 9974);
		fVar4 = 0.2f;
		...
		if (fVar2 >= fVar3)
		{
			if (iParam2 == iLocal_212)
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_7, "Turn", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
				func_119(*(uParam1[iParam2 /*79*/]).f_9, func_120(*(uParam1[iParam2 /*79*/]).f_14, *(uParam1[iParam2 /*79*/]).f_15, 9974), iLocal_212, uLocal_207[iLocal_212]);
				func_7(&uLocal_215);
				uLocal_207[iLocal_212]++;
			}
			else
			{
				play_sound_frontend(*(uParam1[iParam2 /*79*/]).f_7, "Turn_NPC", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			}
			set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_7, "X", *(uParam1[iParam2 /*79*/]).f_14);
			set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_7, "Y", *(uParam1[iParam2 /*79*/]).f_15);
			if (!has_sound_finished(*(uParam1[iParam2 /*79*/]).f_5))
			{
				set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_5, "Turning", 1f);
			}
	...
	else if (!has_sound_finished(*(uParam1[iParam2 /*79*/]).f_5))
	{
		set_variable_on_sound(*(uParam1[iParam2 /*79*/]).f_5, "Turning", 0f);
	}
	func_131(uParam0, iParam2);
	func_130(uParam0, uParam1, iParam2);
	func_134(uParam1, iParam2);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, 3 + iParam2);
}

void func_130(auto uParam0, auto uParam1, int iParam2)
{
	float fVar0;
	float fVar1;
	...
	{
		case 0:
			*(uParam1[iParam2 /*79*/]).f_15 -= fVar1 * timestep();
			break;
		...
		case 2:
			*(uParam1[iParam2 /*79*/]).f_14 -= fVar0 * timestep();
			break;
...
void func_131(auto uParam0, int iParam1)
{
	...
	{
		*(uParam0.f_35[iParam1 /*79*/].f_18)[*(uParam0.f_35[iParam1 /*79*/]).f_4] = func_120(*(uParam0.f_35[iParam1 /*79*/]).f_14, *(uParam0.f_35[iParam1 /*79*/]).f_15, 9974);
	...
	if (*(uParam0.f_35[iParam1 /*79*/]).f_2 != *(uParam0.f_35[iParam1 /*79*/]).f_8)
	{
		if (*(uParam0.f_35[iParam1 /*79*/]).f_4 >= 60)
		{
			...
			while (iVar0 <= 59)
			{
				if (iVar0 == 59)
				{
					*(uParam0.f_35[iParam1 /*79*/].f_18)[iVar0] = func_120(*(uParam0.f_35[iParam1 /*79*/]).f_14, *(uParam0.f_35[iParam1 /*79*/]).f_15, 9974);
				}
				else
				{
					fVar1 = 0f;
					fVar2 = 0f;
					func_128(*(uParam0.f_35[iParam1 /*79*/].f_18)[iVar0 + 1], &fVar1, &fVar2, 9974);
					*(uParam0.f_35[iParam1 /*79*/].f_18)[iVar0] = func_120(fVar1, fVar2, 9974);
				}
				iVar0++;
			}
		}
...
void func_133(auto uParam0)
{
	...
	if (*(uParam0[iLocal_212 /*79*/]).f_9 < 0)
	{
		*(uParam0[iLocal_212 /*79*/]).f_9 = *(uParam0[iLocal_212 /*79*/]).f_2;
	}
	if (GAMEPLAY::GET_GAME_TIMER() - *(uParam0[iLocal_212 /*79*/]).f_13 >= 66)
	{
...
void func_135(int iParam0, auto uParam1, float fParam2, float fParam3, auto uParam4)
{
	switch (iParam0)
	{
		case 0:
...
void func_136(auto uParam0)
{
	...
	else if (iVar1 > 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 3))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 3);
		}
	}
...
void func_137(auto uParam0)
{
	...
	{
		func_138(uParam0);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 15);
	}
	func_69(uParam0);
}
...
void func_138(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "SHOW_HUD");
		func_139(0);
		func_139(1);
		func_139(2);
		func_139(3);
...
void func_139(int iParam0)
{
	...
	Var0 = {func_58(iParam0)};
	Var16 = {func_56(iParam0)};
	iVar32 = func_140(iParam0);
	_push_scaleform_movie_function_parameter_int(iVar32);
	_push_scaleform_movie_function_parameter_string(&Var16);
	func_47(&Var0);
}
...
void func_141(auto uParam0)
{
	if (!func_9(uParam0.f_20, 1000, 0))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 10))
		{
			func_46(uParam0, "DCTL_COUNTDOWNGO", 0, 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 10);
		}
	}
...
void func_142(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "CLEAR_CENTRAL_MESSAGE");
		_pop_scaleform_movie_function_void();
	}
}
...
void func_143(auto uParam0)
{
	...
	while (iVar0 <= _network_get_num_participants_host() - 1)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
		{
			...
			{
				func_144(uParam0, uParam0.f_35, iVar0);
			}
		}
		iVar0++;
	}
...
void func_144(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_145(Local_360[iParam2 /*2*/], &iVar0, &iVar1, &iVar2);
	...
	while (iVar5 < 60)
	{
		func_128(*(uParam1[iParam2 /*79*/].f_18)[iVar5], &fVar7, &fVar8, 9974);
		if (fVar7 != 0f || fVar8 != 0f)
		{
			...
			{
				func_128(*(uParam1[iParam2 /*79*/].f_18)[iVar5 + 1], &fVar9, &fVar10, 9974);
			...
			draw_sprite("LineArcadeMinigame", "Tail", fVar18, fVar14, fVar19, fVar17, fVar15, iVar0, iVar1, iVar2, *(uParam1[iParam2 /*79*/]).f_1, 0);
			if (iParam2 == iLocal_212)
			{
				if (*uParam1[iParam2 /*79*/] == 2)
				{
					...
					{
						iVar20 = func_127(fVar3, *(uParam1[iParam2 /*79*/]).f_15, fVar4 * 0.42f, 0.012f * 0.42f, fVar18, fVar14, fVar19 * 0.95f, fVar17);
					}
					if (*(uParam1[iParam2 /*79*/]).f_2 == 0 || *(uParam1[iParam2 /*79*/]).f_2 == 1)
					{
						iVar20 = func_127(fVar3, *(uParam1[iParam2 /*79*/]).f_15, fVar4 * 0.42f, 0.012f * 0.42f, fVar18, fVar14, fVar19, fVar17 * 0.95f);
					}
					if (iVar20)
					{
						iVar21 = false;
	...
	draw_sprite("LineArcadeMinigame", "HeadPixel", fVar3, *(uParam1[iParam2 /*79*/]).f_15, fVar4, 0.012f, *(uParam1[iParam2 /*79*/]).f_16, iVar0, iVar1, iVar2, *(uParam1[iParam2 /*79*/]).f_1, 0);
}

void func_145(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	auto uVar0;
	
	func_146(func_147(func_117(iParam0)), uParam1, uParam2, uParam3, &uVar0);
}

void func_146(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
...
auto func_147(int iParam0)
{
	...
	return func_148(iVar0, iVar1, iVar2, iVar3);
}

auto func_148(int iParam0, int iParam1, int iParam2, int iParam3)
{
	auto uVar0;
...
void func_149(auto uParam0)
{
	...
	{
		if (get_event_at_index(1, iVar0) == 168)
		{
			if (GAMEPLAY::IS_BIT_SET(iLocal_213, false))
			{
				if (get_event_data(1, iVar0, &Var1, 6))
				{
					if (Var1 == 495)
					{
						if (iVar206 < 16)
						{
							...
							if (!GAMEPLAY::IS_BIT_SET(iLocal_213, 7 + Var1.f_4))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_213, 7 + Var1.f_4);
							}
							iVar206++;
						}
					}
	...
	while (iVar210 <= 15)
	{
		if (Local_110[iVar210 /*6*/].f_5 > -1)
		{
			Var13[iVar206 + iVar210 /*6*/] = {Local_110[iVar210 /*6*/]};
			Local_110[iVar210 /*6*/] = {Var212};
			iVar211++;
		}
		iVar210++;
	}
	...
	while (iVar0 <= iVar206 - 1)
	{
		func_128(Var13[iVar0 /*6*/].f_3, &fVar208, &fVar209, 9974);
		if (Var13[iVar0 /*6*/].f_5 > -1)
		{
			if (!uLocal_207[Var13[iVar0 /*6*/].f_4] == Var13[iVar0 /*6*/].f_4 * 10000)
			{
				if (Var13[iVar0 /*6*/].f_5 > uLocal_207[Var13[iVar0 /*6*/].f_4] + 2)
				{
					iVar218 = 0;
					if (func_151(&iVar218))
					{
						Local_110[iVar218 /*6*/] = {Var13[iVar0 /*6*/]};
					}
					if (Var13[iVar0 /*6*/].f_5 > uLocal_207[Var13[iVar0 /*6*/].f_4] + 4)
					{
						uLocal_207[Var13[iVar0 /*6*/].f_4]++;
					}
					Jump @2163; //curOff = 1540
				}
				else if (Var13[iVar0 /*6*/].f_5 < uLocal_207[Var13[iVar0 /*6*/].f_4])
				{
				}
				else
				{
					if (Var13[iVar0 /*6*/].f_5 == uLocal_207[Var13[iVar0 /*6*/].f_4] + 2)
					{
						...
						{
							func_128(*(uParam0.f_35[Var13[iVar0 /*6*/].f_4 /*79*/].f_18)[*(uParam0.f_35[Var13[iVar0 /*6*/].f_4 /*79*/]).f_4 - 1], &fVar221, &fVar222, 9974);
						}
						else
						{
							func_135(Local_360[Var13[iVar0 /*6*/].f_4 /*2*/], &uVar224, &fVar221, &fVar222, &uVar225);
						}
						...
						func_150(uParam0, Var13[iVar0 /*6*/].f_4, iVar223, fVar219, fVar220, &iVar207);
						func_129(uParam0, uParam0.f_35, Var13[iVar0 /*6*/].f_4);
						func_150(uParam0, Var13[iVar0 /*6*/].f_4, Var13[iVar0 /*6*/].f_2, fVar208, fVar209, &iVar207);
						func_129(uParam0, uParam0.f_35, Var13[iVar0 /*6*/].f_4);
					}
					else
					{
						if (!Var13[iVar0 /*6*/].f_5 == uLocal_207[Var13[iVar0 /*6*/].f_4] + 1 && !Var13[iVar0 /*6*/].f_5 == Var13[iVar0 /*6*/].f_4 * 10000)
						{
						}
						func_128(Var13[iVar0 /*6*/].f_3, &fVar208, &fVar209, 9974);
						func_150(uParam0, Var13[iVar0 /*6*/].f_4, Var13[iVar0 /*6*/].f_2, fVar208, fVar209, &iVar207);
					...
					uLocal_207[Var13[iVar0 /*6*/].f_4] = Var13[iVar0 /*6*/].f_5;
					Jump @2163; //curOff = 2094
					if (Var13[iVar0 /*6*/].f_2 == 4)
					{
...
void func_150(auto uParam0, int iParam1, int iParam2, float fParam3, float fParam4, int iParam5)
{
	...
	*(uParam0.f_35[iParam1 /*79*/]).f_15 = fParam4;
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam5, iParam1);
	}
}
...
void func_152(auto uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_153(uParam0, iParam1, iParam2);
	if (iParam1 < iVar0 - 1)
	{
		func_152(uParam0, iParam1, iVar0 - 1);
	}
	if (iVar0 < iParam2)
	{
		func_152(uParam0, iVar0, iParam2);
	}
}

int func_153(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<6> Var2;
...
{
	if (!has_sound_finished(*(uParam0[iParam1 /*79*/]).f_5))
	{
		stop_sound(*(uParam0[iParam1 /*79*/]).f_5);
	}
	if (iParam1 == iLocal_212)
	{
		play_sound_frontend(*(uParam0[iParam1 /*79*/]).f_6, "Crash", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
	}
	else
	{
		play_sound_frontend(*(uParam0[iParam1 /*79*/]).f_6, "Crash_NPC", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
	}
	set_variable_on_sound(*(uParam0[iParam1 /*79*/]).f_6, "X", *(uParam0[iParam1 /*79*/]).f_14);
	set_variable_on_sound(*(uParam0[iParam1 /*79*/]).f_6, "Y", *(uParam0[iParam1 /*79*/]).f_15);
	func_15(uParam0, 3, iParam1);
}
...
void func_156()
{
	...
	while (iVar0 <= 3)
	{
		uLocal_207[iVar0] = iVar0 * 10000;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 15)
	{
		Local_110[iVar0 /*6*/] = {Var1};
		iVar0++;
	}
}
...
{
	if (!func_9(uParam0.f_18, 1000, 0))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 2))
		{
			play_sound_frontend(-1, "321", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 2);
		}
	}
	else if (!func_9(uParam0.f_18, 2000, 0))
	{
		if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, true))
		{
			play_sound_frontend(-1, "321", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, true);
		}
	}
	else if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, false))
	{
		play_sound_frontend(-1, "321", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, false);
	}
}
...
void func_158(auto uParam0)
{
	if (!func_9(uParam0.f_18, 1000, 0))
	{
		...
		{
			func_46(uParam0, "DCTL_COUNTDOWN3", 0, 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 7);
		}
	}
	else if (!func_9(uParam0.f_18, 2000, 0))
	{
		...
		{
			func_46(uParam0, "DCTL_COUNTDOWN2", 0, 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 8);
		}
	}
	else if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 9))
	{
		func_46(uParam0, "DCTL_COUNTDOWN1", 0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 9);
	}
}
...
void func_159(auto uParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 18))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 18);
	}
	func_143(uParam0);
	func_160(uParam0);
	func_137(uParam0);
...
void func_160(auto uParam0)
{
	...
	{
		func_46(uParam0, "DCTL_READY", 0, 2);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 6);
	}
}
...
void func_161(auto uParam0)
{
	...
	if (Local_282.f_77 == 3 && !GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 5))
	{
		iVar0 = true;
		iVar1 = false;
		while (iVar1 <= _network_get_num_participants_host() - 1)
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)))
			{
				...
				else
				{
					...
					{
						Local_360[iLocal_212 /*2*/] = Local_282.f_2[iLocal_212];
						func_135(Local_360[iVar1 /*2*/], uParam0.f_35[iVar1 /*79*/].f_2, uParam0.f_35[iVar1 /*79*/].f_14, uParam0.f_35[iVar1 /*79*/].f_15, uParam0.f_35[iVar1 /*79*/].f_8);
					}
					else if (Local_360[iVar1 /*2*/] == Local_282.f_2[iVar1])
					{
						func_135(Local_360[iVar1 /*2*/], uParam0.f_35[iVar1 /*79*/].f_2, uParam0.f_35[iVar1 /*79*/].f_14, uParam0.f_35[iVar1 /*79*/].f_15, uParam0.f_35[iVar1 /*79*/].f_8);
					}
					else
				...
				if (iVar0)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 5);
				}
				if (Local_282 == 10)
				{
					stop_sound(*uParam0.f_3);
				...
				else if (Local_282 >= 5)
				{
					*uParam0.f_5 = network_get_num_participants();
					...
					func_59();
					func_176(uParam0, 5);
					GAMEPLAY::CLEAR_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 5);
				}
			}
...
void func_162(auto uParam0)
{
	...
	{
		func_46(uParam0, "DCTL_LOADING", 0, 2);
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 13);
	}
}
...
void func_163(auto uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 14))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 17);
	}
	func_49(uParam0);
	func_165(uParam0);
	if (GAMEPLAY::IS_PC_VERSION())
	...
	if ((!GAMEPLAY::IS_BIT_SET(*uParam0.f_2, 4) && !GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 3)) && !GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, 4))
	{
...
void func_164(auto uParam0)
{
	...
	while (iVar0 < 4)
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)) && Local_360[iVar0 /*2*/] > -1)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_360[iVar0 /*2*/].f_1, 3) && !GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, false))
			{
				play_sound_frontend(*uParam0.f_6, "Insert_Coin", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_35[iVar0 /*79*/].f_3, false);
				if (GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, true))
				{
					GAMEPLAY::CLEAR_BIT(uParam0.f_35[iVar0 /*79*/].f_3, true);
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Local_360[iVar0 /*2*/].f_1, 4) && !GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, true))
			{
				play_sound_frontend(*uParam0.f_6, "Cancel", "DLC_EXEC_ARC_MAC_SOUNDS", 1);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_35[iVar0 /*79*/].f_3, true);
				if (GAMEPLAY::IS_BIT_SET(*(uParam0.f_35[iVar0 /*79*/]).f_3, false))
				{
					GAMEPLAY::CLEAR_BIT(uParam0.f_35[iVar0 /*79*/].f_3, false);
				}
			}
		}
		iVar0++;
...
void func_166(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "HIDE_LOADING_SCREEN");
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (!GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, true))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			func_31(player_id(), 0, 0);
			func_170();
		}
		else
		{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 14);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_360[iLocal_212 /*2*/].f_1), true);
	}
	else
	{
		switch (*uParam0.f_1)
		...
		if (func_9(uParam0.f_10, 2200, 0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, 17);
		}
		if (func_9(uParam0.f_10, 6000, 0) || ((*uParam0.f_1 == 3 && func_9(uParam0.f_10, 3000, 0)) && is_control_just_pressed(2, 201)))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_360[iLocal_212 /*2*/].f_1), 6);
			func_59();
			if (Local_282 == 9)
			{
				func_176(uParam0, 9);
...
void func_169(auto uParam0)
{
	if (has_scaleform_movie_loaded(*uParam0.f_34))
	{
		_push_scaleform_movie_function(*uParam0.f_34, "SHOW_LOADING_SCREEN");
		_pop_scaleform_movie_function_void();
	}
}
...
{
	if (!GAMEPLAY::IS_BIT_SET(Local_360[iLocal_212 /*2*/].f_1, false))
	{
		func_173();
		*uParam0.f_34 = unk_0x67D02A194A2FC2BD("dont_cross_the_line");
		if (func_172() && has_scaleform_movie_loaded(*uParam0.f_34))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_360[iLocal_212 /*2*/].f_1), false);
			func_176(uParam0, 2);
		}
	}
}
...
bool func_173()
{
	if (SCRIPT::REQUEST_SCRIPT_audio_bank("DLC_EXEC1/OFFICE_BOARDROOM", false))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1715393, 6);
		return true;
	}
	return false;
}
...
void func_174(auto uParam0)
{
	...
	if (iLocal_212 == -1)
	{
		...
		*uParam0.f_7 = get_sound_id();
		...
		iLocal_212 = participant_id_to_int();
		Local_360[iLocal_212 /*2*/] = -1;
		*uParam0.f_34 = 0;
		func_67(2);
		func_168(uParam0, 0);
	}
	if (Local_360[iLocal_212 /*2*/] == -1)
	{
		if (Local_282.f_2[iLocal_212] > -1)
		{
			Local_360[iLocal_212 /*2*/] = Local_282.f_2[iLocal_212];
		}
	}
...
void func_177(auto uParam0)
{
	...
	func_178(uParam0);
	if (!is_pause_menu_active() && Local_282 > 2)
	{
		hide_hud_and_radar_this_frame();
		_set_2d_layer(1);
	}
	if (network_is_host_of_this_script() && !Local_282 == 4)
	{
		iVar1 = false;
		while (iVar1 <= 3)
		{
...
{
	*uParam0.f_8 = func_175();
	*uParam0.f_9 = func_179(*uParam0.f_8);
}
...
{
	if (func_187(Global_1587523[iParam0 /*444*/].f_250.f_9))
	{
		return true;
	}
	return false;
...
bool func_202(int iParam0, auto uParam1)
{
...
void func_204(int iParam0)
{
	if (iParam0)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_1610316[player_id() /*174*/].f_3, 3))
		{
			func_173();
		}
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_3), 3);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1610316[player_id() /*174*/].f_3), 3);
	}
}
...
void func_205(struct<20> Param0)
{
	func_209(4, Param0);
	func_207(0, -1, 0);
	network_register_host_broadcast_variables(&Local_282, 78);
	network_register_player_broadcast_variables(&Local_360, 9);
	if (!func_206())
	{
		func_193();
	}
