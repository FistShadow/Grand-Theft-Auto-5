...
void main()
{
	...
	int iVar1087;
	int iVar1088;
	int[] iVar1089 = new int[3];
	int iVar1093;
	auto uVar1094;
	int iVar1095;
	int iVar1096;
	int[] iVar1097 = new int[6];
	int iVar1104;
	int iVar1105;
	int iVar1106;
	int iVar1107;
	...
	iVar1148 = -1;
	iVar1151 = -1;
	iVar1155 = Global_101154.f_17657;
	iVar1158 = 1;
	iVar1159 = -1;
	iVar1178 = false;
	iVar1183 = true;
	...
	iVar1190 = false;
	iVar1191 = false;
	if (ENTITY::DOES_ENTITY_EXIST(Local_617.f_1))
	{
		iVar1093 = Local_617.f_1;
	}
	else
	{
		iVar1093 = get_players_last_vehicle();
	}
	iVar1189 = has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), 0);
	iVar1190 = get_player_has_reserve_parachute(player_id());
	if (iVar1189)
	{
		get_player_parachute_tint_index(player_id(), &iVar1164);
		get_player_parachute_pack_tint_index(player_id(), &uVar1165);
	}
	if (iVar1190)
	{
		get_player_reserve_parachute_tint_index(player_id(), &uVar1166);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar1093))
	{
		set_entity_as_mission_entity(iVar1093, true, 1);
	}
	...
	{
		func_528(&Var16, &uVar1110, &iVar1083, &iVar1084, &iVar1086, &iVar1089, &iVar1093, &uVar918, &iVar1095, &iVar1096, &iVar1097, iVar1163, &iVar1158, iVar1104, iVar1105, iVar867, &uVar1094, iVar1189);
	}
	if (iVar1155 < 0)
	{
		return;
	}
	if (is_bit_set(Global_101154.f_17657.f_1, iVar1155))
	{
		fVar1143 = 0.1f;
	}
	iVar867 = iVar1155;
	...
	set_mission_flag(1);
	func_526(23, 1);
	_set_minimap_attitude_indicator_level(1500f, 0);
	func_500(&Var16, iVar867);
	if (ENTITY::DOES_ENTITY_EXIST(iVar1095))
	{
		set_entity_as_mission_entity(iVar1095, true, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar1083))
	{
		set_entity_as_mission_entity(iVar1083, true, 1);
		if (func_499(&Var16) != 0 && ENTITY::GET_ENTITY_MODEL(iVar1083) == func_499(&Var16))
		{
			iVar1086 = iVar1083;
			iVar1083 = false;
		}
	...
	while (true)
	{
		...
		func_471(&Var111, iVar714, iVar867, iVar1171);
		switch (iVar714)
		{
			case 0:
				func_470();
				...
				if (iVar867 == 0)
				{
					...
					uVar1094 = _0x54B0F614960F4A5F(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f);
				}
				else if (iVar867 == 5)
				{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_617.f_2))
					{
						set_entity_as_mission_entity(Local_617.f_2, true, 1);
						delete_object(&(Local_617.f_2));
					}
			...
			case 1:
				if (is_screen_faded_out() || (((iVar867 == 5 || iVar867 == 6) || iVar867 == 12) && !iVar1171))
				{
					if (!iVar1171)
					{
						if ((iVar867 != 5 && iVar867 != 6) && iVar867 != 12)
						{
							vVar1121 = {func_444(iVar867)};
							vVar1121 = {func_443(cos(vVar1121.z), sin(vVar1121.z), tan(vVar1121.x))};
							if (func_442(iVar867))
							{
								new_load_scene_start(func_441(iVar867), vVar1121, 4000f, 0);
							}
						}
						func_435(&Var16, iVar867, &uVar0, &iVar14, &iVar15, &uVar1110, &iVar1162);
					}
					else if (func_433(func_434(iVar867)))
					{
						vVar1136 = {Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos(-97.4239f + func_432(&Var16)), sin(-97.4239f + func_432(&Var16)))};
						vVar1133 = {get_offset_from_entity_in_world_coords(iVar1083, 1.12046f, -0.317773f, 1.3385f)};
						vVar1136 = {func_431(vVar1136, 8.909f)};
						if (func_442(iVar867))
						{
							new_load_scene_start(vVar1133 + vVar1136, vVar1136, 4000f, 0);
						}
					}
					else
					{
						vVar1121 = {-10f, 0f, func_432(&Var16)};
						vVar1121 = {func_443(cos(vVar1121.z), sin(vVar1121.z), tan(vVar1121.x))};
						if (func_442(iVar867))
						{
							new_load_scene_start(func_441(iVar867), vVar1121, 4000f, 0);
					...
					if (((iVar1171 || iVar867 == 4) || iVar867 == 8) || iVar867 == 3)
					{
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							_0xF9ACF4A08098EA25(PLAYER::PLAYER_PED_ID(), 1);
						}
						set_entity_coords(PLAYER::PLAYER_PED_ID(), func_441(iVar867), 0, false, 0, 1);
						set_entity_heading(PLAYER::PLAYER_PED_ID(), func_432(&Var16));
						freeze_entity_position(PLAYER::PLAYER_PED_ID(), true);
						set_player_control(player_id(), false, 0);
					}
					iVar714 = 2;
				}
				else if (!is_screen_fading_out() && (!func_430(&iVar891) || func_429(&iVar891) > 0.05f))
				{
					if (is_ped_in_any_heli(PLAYER::PLAYER_PED_ID()))
					{
			...
			case 2:
				if (func_427(&uVar0, &iVar870, &uVar1110, iVar867, iVar1162, ((iVar867 != 5 && iVar867 != 6) && iVar867 != 12)))
				{
					func_426(&iVar870);
					func_403(&Var16, &uVar918, &iVar1150, &iVar1083, &iVar1084, &iVar1086, &iVar1085, &iVar1087, &iVar1095, &iVar1096, iVar14, iVar15, &iVar879, iVar867, &iVar1159);
					_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 1, 0);
					if (!iVar1171 && !iVar1180)
					{
			...
			case 3:
				if (!func_430(&iVar870) && !iVar1171)
				{
					func_402(0, 0, 1);
					func_454(&iVar870);
				}
				else if ((func_430(&iVar870) && func_429(&iVar870) > 0.2f) || iVar1171)
				{
					if (func_433(func_434(iVar867)) && !is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3))
					{
					}
					else if (iVar1171)
					{
						...
						if (func_499(&Var16) != 0)
						{
							freeze_entity_position(iVar1086, false);
							func_454(&iVar888);
						}
						iVar714 = 4;
					}
					else
					{
						...
						{
							wait(1000);
							set_cam_active_with_interp(func_401(&uVar107, 1), func_401(&uVar107, 0), 10000, 1, 1);
						...
						if (!func_399(func_400(iVar867)) && !is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							set_entity_coords(PLAYER::PLAYER_PED_ID(), func_400(iVar867), 1, false, 0, 1);
							set_entity_heading(PLAYER::PLAYER_PED_ID(), func_398(func_400(iVar867), func_441(iVar867)));
							set_ped_reset_flag(PLAYER::PLAYER_PED_ID(), 177, true);
							if (func_396() == 0)
							{
								set_ped_component_variation(PLAYER::PLAYER_PED_ID(), 9, 5, 0, 0);
							}
							else if (func_396() == 1)
							{
								set_ped_component_variation(PLAYER::PLAYER_PED_ID(), 8, 1, 0, 0);
							}
							else if (func_396() == 2)
							{
								set_ped_component_variation(PLAYER::PLAYER_PED_ID(), 8, 3, 0, 0);
							}
							open_sequence_task(&iVar1107);
							if (func_395(iVar867) > 0)
							{
								task_stand_still(false, func_395(iVar867));
							}
							task_go_straight_to_coord(false, func_441(iVar867), 1f, -1, func_432(&Var16), 0.5f);
							close_sequence_task(iVar1107);
							task_perform_sequence(PLAYER::PLAYER_PED_ID(), iVar1107);
							clear_sequence_task(&iVar1107);
						}
						if (!func_433(func_434(iVar867)))
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								get_ped_nearby_vehicles(PLAYER::PLAYER_PED_ID(), &iVar1089);
							}
							iVar1160 = 0;
							while (iVar1160 < iVar1089)
							{
								if (ENTITY::DOES_ENTITY_EXIST(iVar1089[iVar1160]) && !is_entity_dead(iVar1089[iVar1160], 0))
								{
									if (vdist2(get_entity_coords(iVar1089[iVar1160], 0), get_entity_coords(PLAYER::PLAYER_PED_ID(), 0)) < 2500f)
									{
										set_entity_lod_dist(iVar1089[iVar1160], 1000);
										set_vehicle_lod_multiplier(iVar1089[iVar1160], 5f);
										set_entity_load_collision_flag(iVar1089[iVar1160], true);
									}
								}
								iVar1160++;
							}
			...
			case 4:
				...
				else if (is_screen_faded_out())
				{
					...
					if (func_433(func_434(iVar867)))
					{
						func_385(&uVar107, &Var16, &vVar1118, &vVar1133, &vVar1136, iVar1083, &uVar1139, &uVar1142);
						iVar1163 = get_sound_id();
						if (iVar1188)
						{
							play_sound_from_entity(iVar1163, "Helicopter_Wind_Idle", iVar1083, "BASEJUMPS_SOUNDS", 0, 0);
						}
						if (iVar1187)
						{
					...
					_0x6585D955A68452A5(PLAYER::PLAYER_PED_ID());
				...
				else
				{
					if (!iVar1182)
					{
						...
						else if (func_429(&iVar912) > 4f || (func_433(func_434(iVar867)) && func_429(&iVar912) > 0.5f))
						{
							func_374(&uVar918, "OJBJAUD", func_384(&Var16), 8, 0, 0, 0);
							iVar1182 = true;
						}
					}
					if (!is_screen_fading_out() && !iVar1171)
					{
						if (func_352(&Var16, iVar867, &iVar1086, &uVar107, &uVar101, &iVar873, &iVar876, &iVar888, &iVar906, iVar1162, &iVar1172, &iVar1184, iVar1176))
						{
							clear_help(1);
							iVar1176 = false;
							if (func_351(&Var16))
			...
			case 5:
				...
				if (is_screen_faded_out())
				{
					if (iVar1171 && iVar1181)
					{
						set_clock_time(func_347(iVar869), func_346(iVar869), func_345(iVar869));
					}
					wait(2000);
					if (iVar1171)
					{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar1084) && !is_entity_dead(iVar1084, 0))
				{
					iVar1104 = add_blip_for_coord(get_offset_from_entity_in_world_coords(iVar1084, func_343(&Var16)));
					set_blip_colour(iVar1104, 5);
					_0x75A16C3DA34F1245(iVar1104, true);
					set_blip_name_from_text_file(iVar1104, "BJ_BLIP_TGT");
				}
				else
				{
					iVar1104 = add_blip_for_coord(func_342(&Var16, 0));
					set_blip_colour(iVar1104, 5);
					if (iVar1150 == 1)
					{
						set_blip_name_from_text_file(iVar1104, "BJ_BLIP_TGT");
					...
					{
						set_blip_name_from_text_file(iVar1104, "BJ_BLIP_CHK");
					}
				}
				set_blip_scale(iVar1104, 1.2f);
				if (iVar1150 > 1)
				{
					iVar1105 = add_blip_for_coord(func_342(&Var16, 1));
					set_blip_colour(iVar1105, 5);
					_0x75A16C3DA34F1245(iVar1104, true);
					set_blip_scale(iVar1105, 0.7f);
					if (iVar1150 == 2)
					{
						set_blip_name_from_text_file(iVar1105, "BJ_BLIP_TGT");
					}
					else
					{
						set_blip_name_from_text_file(iVar1105, "BJ_BLIP_CHK");
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar1084) && !is_entity_dead(iVar1084, 0))
				{
					set_entity_lod_dist(iVar1084, 2000);
					if (ENTITY::DOES_ENTITY_EXIST(iVar1096) && !PED::IS_PED_INJURED(iVar1096))
					{
						clear_ped_tasks(iVar1096);
					}
					if (func_340(func_341(&Var16)))
					{
						delete_mission_train(&iVar1084);
					}
					else
					{
						set_entity_coords(iVar1084, func_342(&Var16, 0), 1, false, 0, 1);
					}
				}
				if (is_bit_set(Global_101154.f_17657.f_1, func_339(&Var16) - 125))
				{
					set_player_can_leave_parachute_smoke_trail(player_id(), true);
					set_player_parachute_smoke_trail_color(player_id(), get_random_int_in_range(false, 256), get_random_int_in_range(false, 256), get_random_int_in_range(false, 256));
				}
				...
				if (!func_351(&Var16))
				{
					...
					{
						if ((func_334(&Var16) && !iVar1184) && !iVar1171)
						{
							_0xC819F3CBB62BF692(1, 0f, 3, 0);
						}
						else if (iVar867 == 4 && !func_333())
						{
							set_cam_coord(func_401(&uVar107, 0), -76.7226f, -829.9866f, 326.0427f);
							set_cam_rot(func_401(&uVar107, 0), 0.8541f, 0f, -17.012f, 2);
							set_cam_fov(func_401(&uVar107, 0), 53.883f);
							set_cam_active(func_401(&uVar107, 0), true);
						}
						else
						{
							if (_0xC912AF078AF19212())
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (iVar1189)
					{
						if (!has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), 0))
						{
							give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true, false, true);
						}
						set_ped_parachute_tint_index(PLAYER::PLAYER_PED_ID(), iVar1164);
						if (iVar1190)
						{
							...
							set_ped_reserve_parachute_tint_index(PLAYER::PLAYER_PED_ID(), uVar1166);
						}
					}
					else
					{
						give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true, false, true);
						set_ped_parachute_tint_index(PLAYER::PLAYER_PED_ID(), get_random_int_in_range(false, 65535) % 8);
					}
				}
			...
			case 6:
				...
				else if ((iVar1175 || iVar1174) || func_332(&Var16, iVar867, &iVar1177))
				{
					clear_help(1);
					clear_prints();
					iVar714 = 10;
				...
				else
				{
					if (iVar867 == 5)
					{
						PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 146, is_entity_in_area(PLAYER::PLAYER_PED_ID(), -118.4f, -973.1f, 295.2f, -117.1f, -975.7f, 297.7f, 0, 1, 0));
					}
					if (iVar1176)
					{
						vVar1124 = {func_342(&Var16, iVar1150 - 1)};
						vVar1124.z += 100f;
						set_entity_coords(PLAYER::PLAYER_PED_ID(), vVar1124, 1, false, 0, 1);
						iVar1176 = false;
					}
					if (!iVar1179)
					{
						if (iVar867 == 4)
						{
							if (((((is_control_pressed(0, 71) || is_control_pressed(0, 72)) || is_control_pressed(0, 1)) || is_control_pressed(0, 2)) || is_control_pressed(0, 75)) || !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
							{
					...
					func_331(&iVar879);
					func_321(&Var16, iVar1084, iVar1095, &iVar1097, &iVar1108, &iVar1109, &iVar1149, &iVar1151, &iVar1152, iVar1150, &iVar1153, &iVar1104, &iVar1105, &iVar1148, &iVar868, &uVar1144, &uVar1145, &uVar1146, &uVar1173, 0, 1, fVar1143);
					func_320(&uVar1111);
					if (func_430(&iVar870))
					{
						if (func_429(&iVar870) > 10f)
						{
							func_316(&iVar882, &iVar1158);
						}
					}
					else
					{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar1086) && !is_entity_dead(iVar1086, 0))
					{
						if (!is_entity_on_screen(iVar1086) && vdist2(get_entity_coords(iVar1086, 1), get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)) > 40000f)
						{
							iVar1192 = get_ped_in_vehicle_seat(iVar1086, -1);
							if (!PED::IS_PED_INJURED(iVar1192))
							{
								delete_ped(&iVar1192);
							}
							delete_vehicle(&iVar1086);
						}
					}
					if (!is_bit_set(iVar1156, false))
					{
						if (is_message_being_displayed() || !func_430(&iVar915))
						{
							func_344(&iVar915);
						}
						else if (func_429(&iVar915) > 0.25f)
						{
							Var1114 = {func_314(iVar867)};
							func_313(&Var1114, 7500, 0);
							func_426(&iVar915);
							GAMEPLAY::GAMEPLAY::SET_BIT(&iVar1156, false);
						}
					}
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						func_312(&Var111, 1);
						iVar1088 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1);
						if (is_vehicle_driveable(iVar1088, 0) && is_entity_in_air(iVar1088))
						{
							if (!is_bit_set(iVar1156, true))
							{
								if (!func_430(&iVar894))
								{
									func_454(&iVar894);
								}
								else if (func_429(&iVar894) > 0.15f)
								{
									func_311("BJ_VEHHELP", -1);
									func_426(&iVar894);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iVar1156, true);
								}
							}
						}
						else
						{
							clear_bit(&iVar1156, true);
			...
			case 7:
				...
				else
				{
					...
					func_321(&Var16, iVar1084, iVar1095, &iVar1097, &iVar1108, &iVar1109, &iVar1149, &iVar1151, &iVar1152, iVar1150, &iVar1153, &iVar1104, &iVar1105, &iVar1148, &iVar868, &uVar1144, &uVar1145, &uVar1146, &uVar1173, 0, 1, fVar1143);
					func_320(&uVar1111);
					if (func_433(func_434(iVar867)) && !is_entity_dead(iVar1083, 0))
					{
					...
					if (func_305(&Var16, &uVar107, &uVar101, &iVar876, &vVar1118, &uVar1130, vVar1133, vVar1136) || iVar1176)
					{
						func_426(&iVar870);
						clear_help(1);
						if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iVar1083) && !is_entity_dead(iVar1083, 0))
							{
								set_entity_coords(iVar1083, func_441(iVar867), 1, false, 0, 1);
								set_entity_heading(iVar1083, func_432(&Var16));
								freeze_entity_position(iVar1083, true);
								iVar1159 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
								attach_synchronized_scene_to_entity(iVar1159, iVar1083, get_entity_bone_index_by_name(iVar1083, "Chassis"));
								task_synchronized_scene(PLAYER::PLAYER_PED_ID(), iVar1159, "oddjobs@basejump@", "Heli_jump", 4f, -4f, 7, 0, 1000f, 0);
								set_synchronized_scene_phase(iVar1159, 0.6f);
								func_303(iVar1083, &uVar107, &iVar873);
								new_load_scene_stop();
							}
						}
						if (iVar1187)
						...
						play_sound_from_entity(iVar1163, "Helicopter_Wind", iVar1083, "BASEJUMPS_SOUNDS", 0, 0);
						iVar1176 = false;
						iVar714 = 8;
					}
				}
			...
			case 8:
				...
				func_331(&iVar879);
				func_321(&Var16, iVar1084, iVar1095, &iVar1097, &iVar1108, &iVar1109, &iVar1149, &iVar1151, &iVar1152, iVar1150, &iVar1153, &iVar1104, &iVar1105, &iVar1148, &iVar868, &uVar1144, &uVar1145, &uVar1146, &uVar1173, 0, 1, fVar1143);
				if (is_synchronized_scene_running(iVar1159))
				{
					if (get_synchronized_scene_phase(iVar1159) > 0.92f)
					{
						open_sequence_task(&iVar1106);
						task_force_motion_state(0, -1161760501, 0);
						task_parachute(false, 1, 0);
						close_sequence_task(iVar1106);
						task_perform_sequence(PLAYER::PLAYER_PED_ID(), iVar1106);
						clear_sequence_task(&iVar1106);
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iVar1083))
				{
					if (func_302(&uVar107, &iVar873, vVar1133, vVar1136, vVar1118, &uVar1139, &uVar1142))
					{
						set_entity_no_collision_entity(PLAYER::PLAYER_PED_ID(), iVar1083, 0);
						if (!is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_jump", 3))
						{
							set_player_control(player_id(), true, 0);
							display_radar(true);
							if (_0xC912AF078AF19212())
			...
			case 9:
				...
				else if (func_301(&uVar101, 3, 1000) && !Global_17118.f_135)
				{
					...
					{
						func_321(&Var16, iVar1084, iVar1096, &iVar1097, &iVar1108, &iVar1109, &iVar1149, &iVar1151, &iVar1152, iVar1150, &iVar1153, &iVar1104, &iVar1105, &iVar1148, &iVar868, &uVar1144, &uVar1145, &uVar1146, &uVar1173, 0, 1, fVar1143);
						wait(0);
					}
					func_258(&Var16, &uVar1110, &Var111, &iVar1156, &iVar1096, &iVar1097, &iVar1093, &iVar1084, &iVar1085, &iVar1086, &iVar1089, &iVar1108, &iVar1109, iVar1104, iVar1105, &iVar1149, &iVar1151, &iVar1152, &iVar1158, &iVar1153, iVar867, &iVar715, &iVar868, &iVar885, &vVar903, &uVar1130, &uVar1144, &uVar1145, &uVar1146, &uVar1173, &iVar1172, &iVar1174, &iVar1175, &iVar1176, &iVar1178, &iVar1170, &uVar1094);
					iVar1171 = true;
					iVar714 = 0;
				}
				else
				{
					...
					if (func_340(func_341(&Var16)))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iVar1084) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), func_342(&Var16, 0), 0) <= 200f)
						{
							iVar1084 = create_mission_train(6, func_342(&Var16, 0), 1);
							if (!is_entity_dead(iVar1084, 0))
							{
								set_train_cruise_speed(iVar1084, 7.5f);
							}
						}
					}
					else if ((ENTITY::DOES_ENTITY_EXIST(iVar1084) && !is_entity_dead(iVar1084, 0)) && !func_399(func_342(&Var16, 0)))
					{
						...
						if (func_252(PLAYER::PLAYER_PED_ID(), iVar1084, 0) <= 325f)
						{
							...
							if (get_script_task_status(iVar1096, -1273030092) != 1)
							{
								if (iVar867 == 5)
								{
									task_vehicle_mission_coors_target(iVar1096, iVar1084, vVar1193, 4, 5f, 16785408, 5f, 10f, 1);
								}
								else
								{
									task_vehicle_mission_coors_target(iVar1096, iVar1084, vVar1193, 4, 5f, 16777216, 4f, -1f, 1);
								}
							}
							else
							{
					...
					iVar715 = func_321(&Var16, iVar1084, iVar1096, &iVar1097, &iVar1108, &iVar1109, &iVar1149, &iVar1151, &iVar1152, iVar1150, &iVar1153, &iVar1104, &iVar1105, &iVar1148, &iVar868, &uVar1144, &uVar1145, &uVar1146, &uVar1173, 1, 1, fVar1143);
					if (iVar715 == 1 || iVar715 >= 2)
					{
						...
						{
							clear_ped_tasks(iVar1096);
							PED::SET_PED_CONFIG_FLAG(iVar1096, 296, true);
						}
						iVar1196 = 0;
						while (iVar1196 < iVar1097)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iVar1097[iVar1196]) && !is_entity_dead(iVar1097[iVar1196], 0))
							{
								clear_ped_tasks(iVar1097[iVar1196]);
								iVar1097[iVar1196] = 0;
							}
							iVar1196++;
						}
			...
			case 10:
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar1096) && !is_entity_dead(iVar1096, 0))
				{
					if (get_script_task_status(iVar1096, -982327190) != 0 && get_script_task_status(iVar1096, -982327190) != 1)
					{
						clear_ped_tasks(iVar1096);
						task_stand_still(iVar1096, -1);
					}
				}
				if ((!iVar1174 && !iVar1175) && !iVar1177)
				{
					if (!func_430(&iVar885))
					{
						if (!func_430(&iVar876))
						...
						if (does_blip_exist(iVar1104))
						{
							remove_blip(&iVar1104);
						}
						if (does_blip_exist(iVar1105))
						{
							remove_blip(&iVar1105);
						}
						if (iVar1151 > -1)
						{
							delete_checkpoint(iVar1108);
							delete_checkpoint(iVar1109);
							iVar1151 = -1;
						}
						func_315(&iVar885, 0f);
					}
					...
					if (func_341(&Var16) == 0)
					{
						func_245(func_342(&Var16, iVar1150 - 1), vVar903);
					}
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar1084) && !is_entity_dead(iVar1084, 0)) && !is_entity_dead(PLAYER::PLAYER_PED_ID(), 0)) && is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iVar1084, vVar1127, 0, 1, 0)) || is_entity_at_coord(PLAYER::PLAYER_PED_ID(), func_342(&Var16, iVar1149), vVar1127, false, true, 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID()))
						{
							iVar1197 = false;
							if (is_entity_in_air(PLAYER::PLAYER_PED_ID()) && (ENTITY::DOES_ENTITY_EXIST(iVar1084) && !is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iVar1084)))
							{
								iVar1197 = true;
							}
							else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))
							{
								iVar1197 = true;
							}
							if (iVar1197)
				...
				if (((iVar1174 || iVar1175) || iVar1177) || (func_430(&iVar885) && func_429(&iVar885) > 0.25f))
				{
					if (func_430(&iVar885) && func_429(&iVar885) > 0.25f)
					{
					...
					{
						iVar717 = func_240();
						while (!has_scaleform_movie_loaded(iVar717))
						{
							wait(0);
							if (func_341(&Var16) == 0)
							{
						...
						{
							iVar1157 = 125;
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17657.f_1), func_339(&Var16) - iVar1157);
							...
							while (iVar1161 < 13)
							{
								if (!is_bit_set(Global_101154.f_17657.f_1, iVar1161))
								{
					...
					else if ((iVar1175 || iVar1177) || iVar715 >= 2)
					{
						clear_help(1);
						clear_prints();
						if (!iVar1177)
			...
			case 11:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					iVar1186 = is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0);
				}
				if (func_341(&Var16) == 0)
				{
					func_245(func_342(&Var16, iVar1150 - 1), vVar903);
				...
				if (!iVar1191)
				{
					iVar716 = func_71(iVar867, &Var111, &uVar1110, &uVar101, iVar1152, iVar1150, iVar1153, &iVar1154, fVar1143, &iVar1178);
					iVar1191 = iVar716 == true;
				}
				if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (iVar1155 == 0)
					...
					func_70(&Var16, &uVar1110, &iVar1083, &iVar1084, &iVar1086, &iVar1089, iVar1093, &uVar918, &iVar1095, &iVar1096, &iVar1097, iVar1163, &iVar1158, iVar1104, iVar1105, iVar867, &uVar1094, iVar1189);
				}
				else if (!is_screen_fading_out() && (!func_69() || func_429(&iVar897) >= 2f))
				{
					...
					if (func_430(&iVar876))
					{
						if ((iVar716 == 1 || func_429(&iVar876) >= 60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_jacking(PLAYER::PLAYER_PED_ID())) || (!iVar1186 && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))))
						{
							if (!iVar1191)
							{
								func_68(&(Var111.f_26));
			...
			case 12:
				...
				if (!iVar1181 && PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
				...
				if (iVar1181)
				{
					iVar1185 = func_16(&uVar861, &Var722, &iVar717, sVar1112, sVar1113, &iVar1171, 78);
				}
				else
				{
					iVar1185 = func_3(&iVar717, &Var722, sVar1112, sVar1113, &iVar1171, 79, 7, 1, 1097859072, 1);
				}
				if (iVar1185)
				{
					if (iVar1171)
					...
					else
					{
						...
						func_2(iVar1181, &Var16, &uVar1110, &iVar1083, &iVar1084, &iVar1086, &iVar1089, iVar1093, &uVar918, &iVar1095, &iVar1096, &iVar1097, iVar1163, &iVar1158, iVar1104, iVar1105, iVar867, &uVar1094, iVar1189);
					}
					func_1(&iVar717);
				}
				iVar715 = 0;
...
void func_2(int iParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, auto uParam17, int iParam18)
{
	if (iParam0)
	{
		func_528(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &iParam7, uParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, iParam15, iParam16, uParam17, iParam18);
	}
	else
	{
		func_528(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &iParam7, uParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, iParam15, iParam16, uParam17, iParam18);
...
bool func_3(int iParam0, auto uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	switch (*uParam1)
	{
		case 0:
		...
		case 1:
			_push_scaleform_movie_function(*iParam0, "SHOW_CENTERED_MP_MESSAGE_LARGE");
			...
			if (func_15(iParam5, 32))
			{
				if (!*uParam1.f_136)
				{
					_push_scaleform_movie_function(*iParam0, "TRANSITION_UP");
		...
		case 2:
			...
			func_11(iParam0, 0, 0);
			if (!func_15(iParam5, 16) && (func_429(uParam1.f_1) >= *uParam1.f_135 || is_screen_faded_out()))
			{
				func_5(uParam1.f_10, 1128792064, iParam6, iParam7, 1, 1065353216);
...
void func_5(auto uParam0, Vector3 fParam1, int iParam2, int iParam3, int iParam4, Vector3 fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_15(*uParam0.f_1, 256) || (func_15(*uParam0.f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			_push_scaleform_movie_function_parameter_bool(func_15(*uParam0.f_1, 4096));
			_pop_scaleform_movie_function_void();
		}
		iVar5 = false;
		iVar6 = 0;
...
void func_7(auto uParam0, int iParam1)
{
	*uParam0 = (*uParam0 || iParam1);
}
...
bool func_11(auto uParam0, int iParam1, int iParam2)
{
	...
	if (func_429(uParam0.f_2) * 1000f > to_float(*uParam0.f_1))
	{
...
bool func_12(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_13(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (*uParam0 == 0)
	{
...
bool func_16(auto uParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			...
			if (IntToFloat(timera()) > 1500f * 0.2f)
			{
				...
				func_3(iParam2, uParam1, sParam3, sParam4, iParam5, iParam6 - 4 & iParam6 - 2 & iParam6 | 16, 7, 1, 1097859072, 0);
			}
			break;
		
		case 2:
			if (func_3(iParam2, uParam1, sParam3, sParam4, iParam5, iParam6 - 8 & iParam6 - 4 & iParam6 - 2 & iParam6, 7, 1, 1097859072, 1))
			{
				func_20(0, 1);
				func_18(0, 1);
				func_32();
...
void func_18(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_43, true);
		func_19(1, 2, 0);
		_set_cam_effect(2);
	}
	else
	{
		if (is_bit_set(iLocal_43, true) || iParam1)
		{
			_stop_screen_effect("DeathFailOut");
			func_19(0, 2, 1);
			_set_cam_effect(0);
		}
		clear_bit(&iLocal_43, true);
	}
}
...
void func_19(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_43, 2);
...
void func_20(int iParam0, int iParam1)
{
	...
	if (iParam0 == 1)
	{
		if (!is_bit_set(iLocal_43, false) || iParam1)
		{
			_start_screen_effect(sVar0, false, 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_43, false);
			func_19(1, 1, 0);
			_set_cam_effect(1);
		}
	}
...
void func_22(auto uParam0, auto uParam1)
{
...
bool func_24()
{
	if (!is_bit_set(iLocal_43, false) && !is_bit_set(iLocal_43, true))
	{
		settimera(0);
		func_20(1, 0);
	}
	...
	if (iVar0 == 0)
	{
		if (iParam0 == 1)
		{
			if (!is_bit_set(iLocal_43, 3))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_43, 3);
			}
		}
...
void func_37(auto uParam0, int iParam1, int iParam2)
{
...
void func_41(auto uParam0)
{
	...
	if (!Global_69757)
	{
		if (!is_player_dead(get_player_index()))
		{
			if (!Global_69758)
			{
				if (is_screen_faded_out() && !func_43(0))
				{
					do_screen_fade_in(800);
				}
			}
...
int func_44(auto uParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	*uParam0.f_574 = get_frame_count();
	...
	if (!*uParam0.f_563)
	{
		switch (func_34(get_player_ped(get_player_index())))
		{
			case 1:
	...
	if (*uParam0.f_560 == 0f)
	{
		*uParam0.f_560 += func_66(30f);
		*uParam0.f_560 += IntToFloat(*uParam0.f_56) * func_66(25f);
		if (*uParam0.f_56 > 0)
		{
			*uParam0.f_560 += func_66(25f * 0.5f);
		}
		if (*uParam0.f_549)
		{
			*uParam0.f_560 += func_66(30f) - func_66(2f);
		}
	}
	iVar0 = true;
	while (iVar0)
		...
		*uParam0.f_548 = func_46(*uParam0.f_548, 0f, 1f);
		...
		if ((*uParam0.f_565 || *uParam0.f_566) && *uParam0.f_56 != 0)
		{
			if (IntToFloat(*uParam0.f_572) > IntToFloat(*uParam0.f_558 + 1165) - 15000f * fParam2)
			{
				...
				*uParam0.f_559 = func_46(*uParam0.f_559 + 1f / 0.3f * *uParam0.f_573 * timestep(), 0f, 1f);
				*uParam0.f_573 = func_46(*uParam0.f_573 + 0.07f, 0.75f, 1.15f);
			}
		}
		else
		{
			*uParam0.f_559 = func_46(*uParam0.f_559 - 1f / 0.3f * *uParam0.f_573 * 0.01f * timestep(), 0f, 1f);
			*uParam0.f_573 = func_46(*uParam0.f_573 + 0.07f, 0.75f, 1.15f);
		}
...
void func_45(auto uParam0, int iParam1)
{
	...
	func_9(_get_control_action_name(2, 215, true));
	func_14("ES_HELP");
	if (is_pc_version())
	{
		_push_scaleform_movie_function_parameter_bool(true);
	...
	if (iParam1)
	{
		...
		func_9(_get_control_action_name(2, 216, true));
		func_14("ES_XPAND");
		if (is_pc_version())
		{
			_push_scaleform_movie_function_parameter_bool(true);
...
void func_47(auto uParam0, float fParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	fVar1 -= func_66(6f);
	fVar1 += func_66(30f) - func_66(2f * 2f);
	fVar11 = fVar2 - func_66(2f * 14f);
	if (fVar11 >= 0f)
	{
		fVar12 = func_46(fVar11 / 0.6f * func_66(25f), 0f, 1f);
		func_64();
		draw_rect(0.5f, fVar1 - func_66(2f - 0.5f) - 0.001388889f, fVar6, func_59(1f), iVar13, iVar14, iVar15, round(fVar12 * IntToFloat(iVar16)), 0);
	}
	else
	{
		return;
	}
	fVar1 += func_66(2f * 0.3f);
	if (*uParam0.f_56 > 0)
	{
		fVar1 += func_66(25f * 0.2f);
	}
	iVar17 = 0;
	iVar17 = 0;
	while (iVar17 < *uParam0.f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_56(uParam0, iVar17, fVar1 + func_66(2f), fVar9, fVar10, round(IntToFloat(iVar0) * fVar12));
		}
		else
		{
			return;
	...
	if (*uParam0.f_56 > 0)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			fVar12 = func_46(fVar11 / 0.6f * func_66(25f), 0f, 1f);
			func_64();
			draw_rect(0.5f, fVar1 + func_66(2f * 0.5f), fVar6, func_59(1f), iVar13, iVar14, iVar15, round(fVar12 * IntToFloat(iVar16)), 0);
		}
	}
	if (*uParam0.f_549)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			switch (*uParam0.f_556)
			{
				case 0:
					...
					_draw_text(fVar20, fVar1 + func_66(2f * 2f), 0);
					break;
...
void func_49(char* sParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
...
bool func_50(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4, int iParam5)
{
	char* sVar0;
	char* sVar1;
	int iVar2;
	...
	if (get_hash_key(sVar1) != 0)
	{
		...
		vVar7.x *= func_51(iParam0) / fVar4;
		vVar7.y *= func_51(iParam0) / fVar4;
		if (!iParam2)
		{
			vVar7.x -= 2f;
			vVar7.y -= 2f;
...
auto func_53(int iParam0, int iParam1)
{
	char*[] sVar0 = new char*[2];
	
	if (!is_string_null_or_empty(&(Global_17257.f_6687[iParam0 /*16*/])))
	{
		return func_54(&(Global_17257.f_6687[iParam0 /*16*/]));
	}
	switch (iParam0)
	{
		case 3:
...
void func_56(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (*uParam0.f_517[iParam1])
	{
		...
		case 1:
			...
			draw_sprite("CommonMenu", func_53(7, 0), fParam4 - 0.006f, fParam2 + func_66(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
		
		case 2:
			func_50(5, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_53(5, 0), fParam4 - 0.006f, fParam2 + func_66(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
		
		case 3:
			func_50(6, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_53(6, 0), fParam4 - 0.006f, fParam2 + func_66(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
	}
...
void func_70(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, auto uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, auto uParam16, int iParam17)
{
	func_528(uParam0, uParam1, iParam2, iParam3, iParam4, iParam5, &iParam6, uParam7, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, iParam15, uParam16, iParam17);
}

int func_71(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	if (!func_239(iParam1, 5))
	{
		clear_help(1);
		func_172(iParam1, func_176(iParam0), iParam4, iParam5 - 1, iParam6, iParam7, fParam8);
		func_195(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 344, 0, 344, 0);
		func_202(iParam1, 5, 1);
		settimera(0);
	}
	if (!func_239(iParam1, 6))
	{
		if (func_168(iParam1.f_26, 0, 0))
		{
			func_202(iParam1, 6, 1);
		}
		else
		{
			return 2;
	...
	if (func_239(iParam1, 27) && is_player_online())
	{
		if (!func_239(iParam1, 26))
		{
			func_195(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 344, 0, 344, 0);
		}
		func_202(iParam1, 27, 0);
	}
	if (timera() > 1000)
	{
		if (*iParam9)
		{
			...
			else if (func_73(&iLocal_611, 0))
			{
				iLocal_611 = 0;
				*iParam9 = 0;
				func_195(iParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 344, 0);
			}
		}
		else
		{
			if (!func_239(iParam1, 10))
			{
				play_sound_frontend(-1, "BASE_JUMP_PASSED", "HUD_AWARDS", 1);
				func_202(iParam1, 10, 1);
			}
		...
		if (*iParam9)
		{
			if (is_player_online())
			{
				if (!func_239(iParam1, 28) && func_72(&uLocal_174))
				{
					func_202(iParam1, 28, 1);
					func_195(iParam1, 0, 202, "HUD_INPUT53", 217, "SCLB_PROFILE", 344, 0, 344, 0);
				}
			}
		...
		else if ((!*iParam9 && func_301(uParam3, 8, 1000)) && (!is_player_online() || func_239(iParam1, 26)))
		{
			*iParam9 = 1;
			if (is_player_online())
			{
				...
				{
					func_202(iParam1, 28, 0);
					func_195(iParam1, 0, 202, "HUD_INPUT53", 344, 0, 344, 0, 344, 0);
				}
			}
		}
	}
...
bool func_73(int iParam0, int iParam1)
{
	...
	if ((is_orbis_version() && (((iVar1 == 4 || iVar1 == 2) || iVar1 == 1) || iVar1 == 5)) || (!func_82() && network_is_signed_online()))
	{
	...
	{
		func_79(&(Global_1840922.f_3), func_81(&(Global_1840922.f_3)));
		if ((func_76(&(Global_1840922.f_49)) && !func_74(&(Global_1840922.f_49), 2000, 1)) && !network_is_signed_online())
		{
...
bool func_74(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
	}
	func_75(uParam0, iParam2, 0);
...
void func_75(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_1 == 0)
	{
...
void func_86(int iParam0)
{
	...
	if (_0x6CD79468A1E595C6(2))
	{
		...
		{
			if (*iParam0.f_3[iVar0] != 344)
			{
				*iParam0.f_12[iVar0] = _get_control_action_name(2, *iParam0.f_3[iVar0], true);
			}
			iVar0++;
		}
		func_87(iParam0.f_1, 4);
	}
	if (!func_23(*iParam0.f_1, 4))
	{
		_push_scaleform_movie_function(*iParam0, "SET_CLEAR_SPACE");
		_push_scaleform_movie_function_parameter_float(200f);
		_pop_scaleform_movie_function_void();
		...
		while (iVar2 < 4)
		{
			if (!is_string_null_or_empty(*iParam0.f_21[iVar2]))
			{
				if (!is_string_null_or_empty(*iParam0.f_12[iVar2 + 4]))
				{
					...
					_push_scaleform_movie_function_parameter_float(fVar1);
		...
		_push_scaleform_movie_function_parameter_float(to_float(*iParam0.f_2));
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(*iParam0, "SET_BACKGROUND_COLOUR");
		_push_scaleform_movie_function_parameter_float(0f);
		_push_scaleform_movie_function_parameter_float(0f);
		_push_scaleform_movie_function_parameter_float(0f);
		_push_scaleform_movie_function_parameter_float(80f);
				...
				if (does_text_label_exist(&(Global_1835390.f_2780.f_1)))
				{
					if (!func_155(*uParam1.f_44))
					{
						if (Global_1835390.f_2780.f_26 > 0)
						{
							...
							func_154(*uParam0, &(Global_1835390.f_2780.f_1), &sVar25, &Var9, Global_1835390.f_2780.f_25, Global_1835390.f_2780.f_26);
						}
						else
						{
							func_154(*uParam0, &(Global_1835390.f_2780.f_1), &sVar25, &(Global_1835390.f_2780.f_9), Global_1835390.f_2780.f_25, -1);
						}
					}
					else if (!Global_1835390.f_2780.f_27)
					{
						...
						if (Global_1835390.f_2780.f_26 > 0)
						{
							func_154(*uParam0, &(Global_1835390.f_2780.f_1), &Var9, &(Global_1835390.f_2780.f_9), Global_1835390.f_2780.f_25, Global_1835390.f_2780.f_26);
						}
						else
						{
							func_154(*uParam0, &(Global_1835390.f_2780.f_1), &Var9, &(Global_1835390.f_2780.f_9), Global_1835390.f_2780.f_25, -1);
						}
					}
					else
					{
				...
				if (!is_bit_set(*uParam1.f_42, false))
				{
					...
					if (does_text_label_exist(&(Global_1835390.f_2780.f_1)))
					{
						if (!func_155(*uParam1.f_44))
						{
							...
							{
								Var9 = {Global_1835390.f_2780.f_9};
								func_154(*uParam0, &(Global_1835390.f_2780.f_1), &sVar25, &Var9, 1, Global_1835390.f_2780.f_26);
							}
							else
							{
								func_154(*uParam0, &(Global_1835390.f_2780.f_1), &sVar25, &(Global_1835390.f_2780.f_9), Global_1835390.f_2780.f_25, -1);
							...
							if (func_107(Global_1839721[iVar0 /*100*/].f_32))
							{
								...
								if (!iVar63)
								{
									...
									if (func_155(*uParam1.f_44))
									{
										...
										func_105(*uParam0, iVar6, iVar31, Global_1839721[iVar0 /*100*/].f_59, &Var9, &(Global_1839721[iVar0 /*100*/].f_80));
...
bool func_93(auto uParam0, int iParam1)
{
	auto uVar0;
	int iVar1;
	auto uVar2;
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_74(uParam0.f_246.f_3, 250, 0))
		{
			return true;
		}
	}
	else if ((!is_control_pressed(2, iParam1) && !is_disabled_control_pressed(2, iParam1)) || func_74(uParam0.f_246.f_3, 250, 0))
	{
		return true;
	}
	return false;
...
void func_94(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
...
void func_97(struct<30> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, int iParam14, Vector3 fParam15, int iParam16)
{
...
float func_98(Vector3 fParam0)
{
	return fParam0 / 0.3048f;
}

float func_99(Vector3 fParam0)
{
	return fParam0 / 1609.344f;
}

void func_100(struct<30> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, int iParam14, int iParam15, int iParam16, int iParam17)
{
	...
	switch (Param0.f_29[iParam43])
	{
		...
		case 8:
			...
			{
				_begin_text_component(func_101(func_104(iParam44), 0));
				_end_text_component();
			}
			else
			{
		...
		case 16:
			if (iParam45)
			{
				...
				if (!_0xD3D15555431AB793())
				{
					...
					{
						iParam44 = floor(func_99(to_float(iParam44)));
					}
					else
					{
						iParam44 = floor(func_98(to_float(iParam44)));
					}
				}
				_begin_text_component("NUMBER");
				add_text_component_integer(iParam44);
...
auto func_102(auto uParam0)
{
	return uParam0;
}

int func_103(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5)
{
...
bool func_106(auto uParam0, auto uParam1)
{
	if (!func_107(*uParam0))
	{
		return false;
...
int func_107(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12)
{
...
bool func_112(auto uParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
	...
	else if (*uParam2 == 1)
	{
		...
		else
		{
			if (Global_1835390.f_2775[iParam3] < 0)
			{
				...
				*(uParam0[iParam1 /*100*/].f_32) = {func_157(player_id())};
...
void func_114(int iParam0, int iParam1, int iParam2, char* sParam3)
{
...
void func_116(auto uParam0)
{
	...
	Global_1838575.f_87[iVar2 /*3*/] = {func_117(player_id())};
}
...
bool func_121(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	auto uVar0;
	int iVar35;
...
void func_122(auto uParam0, char* sParam1)
{
	_0xF45352426FF3A4F0(uParam0, 35, sParam1);
}

bool func_123(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_127(auto uParam0, auto uParam1, char* sParam2)
{
	if (*uParam0 == 2)
	{
		return true;
...
bool func_130(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16, char* sParam17)
{
	struct<13> Var0;
...
bool func_131(auto uParam0, char* sParam1, char* sParam2, auto uParam3, auto uParam4)
{
	int iVar0;
...
bool func_134(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_136()
{
	if (is_pause_menu_active() && !func_159())
	{
		return true;
	}
	return false;
...
void func_139(auto uParam0, auto uParam1, auto uParam2)
{
	*uParam0 = 0;
	*uParam1 = 0;
	Global_1835008 = 0;
...
void func_141(auto uParam0, char* sParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	else
	{
		...
		*sParam1.f_32 = {func_157(player_id())};
	}
...
bool func_144(auto uParam0, auto uParam1, auto uParam2, int iParam3, auto uParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	auto uVar0;
	auto uVar1;
...
bool func_147(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6, int iParam7)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_149(struct<4> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16, auto uParam17, auto uParam18, auto uParam19, auto uParam20, auto uParam21, auto uParam22, auto uParam23, auto uParam24, auto uParam25, auto uParam26, auto uParam27, auto uParam28, auto uParam29, auto uParam30, auto uParam31, auto uParam32, auto uParam33, auto uParam34, auto uParam35, auto uParam36, auto uParam37, auto uParam38, auto uParam39, auto uParam40, auto uParam41, auto uParam42, auto uParam43, auto uParam44, auto uParam45, auto uParam46, auto uParam47, auto uParam48, auto uParam49, auto uParam50, auto uParam51, auto uParam52, auto uParam53, auto uParam54, auto uParam55, auto uParam56, auto uParam57, auto uParam58, auto uParam59, auto uParam60, auto uParam61, auto uParam62, auto uParam63, auto uParam64, auto uParam65)
{
	int iVar0;
...
void func_153(int iParam0, char* sParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_154(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_167(auto uParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !iParam1)
	{
		if (!iParam2)
...
bool func_168(auto uParam0, int iParam1, int iParam2)
{
...
void func_169(auto uParam0)
{
	...
	func_9(_get_control_action_name(2, 188, true));
	func_14("ES_HELP_TU");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "SET_DATA_SLOT");
	_push_scaleform_movie_function_parameter_int(true);
	func_9(_get_control_action_name(2, 187, true));
	func_14("ES_HELP_TD");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "SET_DATA_SLOT");
	_push_scaleform_movie_function_parameter_int(false);
	func_9(_get_control_action_name(2, 202, true));
	func_14("ES_HELP_AB");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	_pop_scaleform_movie_function_void();
...
void func_172(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, auto uParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_175(iParam0.f_26);
		func_174(iParam0.f_26, "BJ_SC_PASS", sParam1, 0);
	...
	*uParam5 = iVar1 + iVar2 + iVar0 + iVar3;
	if (iParam3 > 1)
	{
		if (iVar0 > 0)
		{
			func_173(iParam0.f_26, 3, "BJ_SC_ALLG_RWD", "", iVar0, 0, 2, 0);
		}
		else
		{
			func_173(iParam0.f_26, 3, "BJ_SC_ALLG_RWD", "", 0, 0, 1, 0);
		}
		func_173(iParam0.f_26, 2, "BJ_SC_GATES", "", iParam2, iParam3, 0, 0);
	}
	func_173(iParam0.f_26, 11, "BJ_SC_LAND_ACC", "", iParam4, 0, 0, 0);
	if (iParam3 > 1)
	{
		func_173(iParam0.f_26, 3, "BJ_SC_GATE_RWD", "", iVar3, 0, 0, 0);
	}
	func_173(iParam0.f_26, 3, "BJ_SC_ACC_RWD", "", round(50f + 1.5f * IntToFloat(iParam4) * fParam6), 0, 0, 0);
	func_173(iParam0.f_26, 3, "BJ_SC_TOT_RWD", "", *uParam5, 0, 0, 0);
}

void func_173(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	auto uVar0;
...
void func_174(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
...
bool func_185(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	switch (*uParam0)
	{
		case 0:
...
void func_187(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_188(int iParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<68> Var0;
	int iVar68;
	struct<13> Var69;
...
void func_190(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	char[32] cVar0;
	char[32] cVar8;
	int iVar16;
	...
	Global_1835390.f_2826 = func_191(cVar0, *uParam0.f_44, iParam1, iParam4, iParam5, iParam6);
}

int func_191(char[32] cParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	char[64] cVar0;
...
void func_195(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	if (*iParam0 == 0)
	{
	...
	*iParam0.f_3[6] = 344;
	*iParam0.f_3[7] = 344;
	*iParam0.f_12[0] = func_196(iParam2 != 344, _get_control_action_name(2, iParam2, true), "");
	*iParam0.f_12[1] = func_196(iParam4 != 344, _get_control_action_name(2, iParam4, true), "");
	*iParam0.f_12[2] = func_196(iParam6 != 344, _get_control_action_name(2, iParam6, true), "");
	*iParam0.f_12[3] = func_196(iParam8 != 344, _get_control_action_name(2, iParam8, true), "");
	*iParam0.f_12[4] = 0;
	*iParam0.f_12[5] = 0;
	*iParam0.f_12[6] = 0;
	*iParam0.f_12[7] = 0;
...
char* func_196(int iParam0, char* sParam1, char* sParam2)
{
	if (iParam0)
	{
		return sParam1;
...
{
	_play_ambient_speech1(iParam0, sParam1, func_199(iParam2), 1);
}
...
void func_202(int iParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam0.f_602, iParam1);
	}
	else
	{
		clear_bit(iParam0.f_602, iParam1);
	}
}

bool func_203(auto uParam0, int iParam1, auto uParam2, auto uParam3, float fParam4)
{
	int iVar0;
	...
	*uParam3 = 0;
	*uParam3 += ceil(fParam4 * 50f + fParam4 * IntToFloat(iVar0));
	*uParam3 += ceil(fParam4 * 1.5f * to_float(*uParam2));
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	func_205(Global_101154.f_32575[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (iParam3)
	{
		iVar0 = false;
		if (iParam4)
...
void func_208(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_210() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_210() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_209(iParam0));
...
int func_212(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_210() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_215(int iParam0, int iParam1)
{
	...
	if (func_225(&Global_2563627))
	{
		if (func_223(&Global_2563627, iParam0))
		{
			return false;
		}
...
bool func_216(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_219(auto uParam0)
{
	...
	func_221(uParam0, Global_2563626 - 0.5f);
}
...
void func_221(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
auto func_222(auto uParam0)
{
	return *uParam0.f_72;
}

int func_223(auto uParam0, int iParam1)
{
	return func_224(uParam0, iParam1) != -1;
}

int func_224(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_232()
{
	...
	{
		func_228(13, floor(Global_101154.f_8884.f_3853));
	}
...
{
	return is_bit_set(*iParam0.f_602, iParam1);
}
...
void func_241(Vector3 vParam0, int iParam1, int iParam2, int iParam3, auto uParam4, float fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = false;
	iVar2 = PED::IS_PED_INJURED(iVar0);
	if (iVar2)
	{
		*iParam5 = 2;
		return;
	...
	uVar4 = get_ped_parachute_landing_type(iVar0);
	iVar5 = is_entity_in_air(iVar0);
	iVar6 = is_ped_ragdoll(iVar0);
	iVar7 = ENTITY::DOES_ENTITY_EXIST(iParam3);
	iVar8 = (iVar7 && is_ped_on_specific_vehicle(iVar0, iParam3));
	iVar9 = ((iVar7 && !PED::IS_PED_INJURED(iParam4)) && is_entity_touching_entity(iVar0, iParam4));
	iVar10 = (iVar7 && get_vehicle_trailer_vehicle(iParam3, &iVar1));
	iVar11 = ((iVar10 && !is_entity_dead(iVar1, 0)) && is_ped_on_specific_vehicle(iVar0, iVar1));
	iVar12 = (!iVar7 && !func_399(vParam0));
	if (iVar12)
	{
		vVar13 = {get_entity_coords(iVar0, 1)};
		vVar16 = {vVar13 - vParam0};
		fVar19 = sqrt(vVar16.x * vVar16.x + vVar16.y * vVar16.y);
		*fParam7 = fVar19;
		if ((vVar16.z < 5f && vVar16.z > -2f) && fVar19 < 15f)
		{
			*uParam6 = func_244(ceil(100f * 15f - fVar19 / 15f) + 4, 0, 100);
			*iParam5 = 1;
		}
		else
		{
	...
	if (iVar10)
	{
		get_vehicle_trailer_vehicle(iParam3, &iVar20);
		vVar21 = {get_entity_coords(iVar0, 1)};
		vVar24 = {get_entity_coords(iVar20, 1)};
	}
}
...
bool func_242(int iParam0, int iParam1)
{
	...
	if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(iParam0)) && is_vehicle_driveable(iParam0, 0))
	{
		vVar5 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
		if (func_340(ENTITY::GET_ENTITY_MODEL(iParam0)))
		{
			iVar8 = 0;
			iVar8 = 0;
			while (iVar8 < 6)
			{
				iVar1 = get_train_carriage(iParam0, iVar8);
				if (ENTITY::DOES_ENTITY_EXIST(iVar1))
				{
					vVar2 = {get_entity_coords(iParam0, 1)};
					if (is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), iVar1))
					{
						return true;
					}
				}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		{
			...
			if ((is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), iParam0) || is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iParam0)) || ((ENTITY::DOES_ENTITY_EXIST(iParam1) && !is_entity_dead(iParam1, 0)) && is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iParam1)))
			{
				if (vVar2.z < vVar5.z)
				{
					return true;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			...
			{
				if (is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), iVar0))
				{
					return true;
				}
				else if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iVar0))
				{
					vVar9 = {get_offset_from_entity_given_world_coords(iVar0, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1))};
					vVar9.x = func_243(absf(vVar9.x) - 1.305f, 0f);
					if (vVar9.y >= 0f)
					{
...
void func_245(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	float fVar0;
	int iVar1;
...
void func_246(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	if (!func_239(iParam0, 1) && !Global_17118.f_135)
	{
	...
	else if (!func_239(iParam0, 3))
	{
		if (get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == -1 || get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 3)
		{
			clear_help(1);
...
void func_247(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::DOES_ENTITY_EXIST(get_entity_attached_to(PLAYER::PLAYER_PED_ID())))
		{
			vVar0 = {get_entity_speed_vector(get_entity_attached_to(PLAYER::PLAYER_PED_ID()), 0)};
		}
		else
		{
			vVar0 = {get_entity_speed_vector(PLAYER::PLAYER_PED_ID(), 1)};
		}
		fVar21 = vVar0.y;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0) && is_vehicle_driveable(*iParam0, 0))
	{
		...
		vVar6.z = 0f;
		vVar18 = {get_entity_velocity(*iParam0)};
	}
	if (is_vehicle_driveable(*iParam0, 0))
	{
		get_entity_matrix(*iParam0, &vVar9, &uVar15, &uVar15, &uVar15);
		vVar9.z = 0f;
	}
	vVar12 = {vVar3 - vVar6};
	vVar12.z = 0f;
	fVar23 = absf(func_251(vVar12, vVar9));
	if (func_250(*iParam0))
	{
	...
	if (((ENTITY::DOES_ENTITY_EXIST(*iParam0) && is_vehicle_driveable(*iParam0, 0)) && vVar18.y > 2f) && vVar18.y < _0x53AF99BAA671CA47(*iParam0))
	{
		set_drive_task_max_cruise_speed(get_ped_in_vehicle_seat(*iParam0, -1), fVar24);
	}
}
...
float func_248(float fParam0, float fParam1, float fParam2)
{
	...
	fVar0 = 1f - cos(func_249(fParam2 * 3.141593f)) * 0.5f;
...
bool func_250(int iParam0)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		get_entity_matrix(iParam0, &vVar12, &uVar6, &uVar6, &vVar3);
	}
	vVar9 = {vVar0 - vVar3};
	vVar9.z = 0f;
	vVar12.z = 0f;
...
float func_251(Vector3 vParam0, Vector3 vParam1)
{
...
void func_255(int iParam0, auto uParam1)
{
	var[] uVar0 = new var[6];
	int iVar7;
	Vector3 vVar8;
	...
	iVar12 = get_ped_nearby_peds(PLAYER::PLAYER_PED_ID(), &uVar0, -1);
	iVar13 = 0;
	while (iVar13 < 6)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(*uParam1[iVar13]) && !is_entity_dead(*uParam1[iVar13], 0)) && !PED::IS_PED_INJURED(*uParam1[iVar13]))
		{
			...
			{
				vVar8 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - get_entity_coords(*uParam1[iVar13], 1)};
	...
	if (iVar12 > 0)
	{
		...
		while (iVar13 < iVar12)
		{
			if ((((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar13]) && !is_entity_dead(uVar0[iVar13], 0)) && !PED::IS_PED_INJURED(uVar0[iVar13])) && is_ped_human(uVar0[iVar13])) && !is_ped_in_any_vehicle(uVar0[iVar13], 1))
			{
				if (func_257(uVar0[iVar13], uParam1) == -1)
				{
					vVar8 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - get_entity_coords(uVar0[iVar13], 1)};
					fVar11 = vVar8.x * vVar8.x + vVar8.y * vVar8.y;
					if (vVar8.z * vVar8.z > 3f * fVar11)
					{
						iVar15 = false;
						...
						while (iVar14 < *uParam1)
						{
							if (!ENTITY::DOES_ENTITY_EXIST(*uParam1[iVar14]) || PED::IS_PED_INJURED(*uParam1[iVar14]))
							{
								*uParam1[iVar14] = uVar0[iVar13];
								...
								task_play_anim(false, "oddjobs@basejump@", "ped_a_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
								task_play_anim(false, "oddjobs@basejump@", "ped_a_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
								close_sequence_task(iVar7);
								task_perform_sequence(uVar0[iVar13], iVar7);
...
int func_257(int iParam0, auto uParam1)
{
	int iVar0;
...
void func_258(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, auto uParam25, auto uParam26, auto uParam27, auto uParam28, auto uParam29, int iParam30, int iParam31, int iParam32, int iParam33, int iParam34, int iParam35, auto uParam36)
{
	...
	*iParam30 = 0;
	func_300(iParam2);
	if (func_430(iParam24))
	{
		func_426(iParam24);
	}
	if (func_430(iParam23))
	{
		func_426(iParam23);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*iParam7))
	{
		...
		else
		{
			...
			{
				iVar1 = get_ped_in_vehicle_seat(*iParam7, -1);
				if (ENTITY::DOES_ENTITY_EXIST(iVar1))
				{
					delete_ped(&iVar1);
				}
	...
	while (iVar2 < *iParam5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam5[iVar2]) && !is_entity_dead(*iParam5[iVar2], 0))
		{
	...
	{
		if (!func_299(*iParam9) && ENTITY::DOES_ENTITY_EXIST(get_ped_in_vehicle_seat(*iParam9, -1)))
		{
			iVar3 = get_ped_in_vehicle_seat(*iParam9, -1);
			delete_ped(&iVar3);
		}
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		{
			_0xF9ACF4A08098EA25(PLAYER::PLAYER_PED_ID(), 1);
			set_entity_coords(PLAYER::PLAYER_PED_ID(), get_entity_coords(iVar0, 1) + Vector(0f, 0f, 2f), 1, false, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(*iParam6) && iVar0 == *iParam6)
			{
				set_players_last_vehicle(*iParam6);
				func_262(*iParam6, func_298(iParam20), func_297(iParam20), 24, 0);
				set_entity_velocity(iVar0, 0f, 0f, 0f);
				set_entity_coords(iVar0, func_298(iParam20), 1, false, 0, 1);
				set_vehicle_on_ground_properly(iVar0);
				set_entity_heading(iVar0, func_297(iParam20));
			}
			else
			{
	...
	*iParam35 = 0;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam10[iVar4]) && !is_entity_dead(*iParam10[iVar4], 0))
		{
			set_vehicle_lod_multiplier(*iParam10[iVar4], 1f);
			set_entity_load_collision_flag(*iParam10[iVar4], false);
		}
		*iParam10[iVar4] = 0;
		iVar4++;
	}
...
void func_262(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
...
void func_263(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_281(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (is_vehicle_driveable(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_101154.f_18807.f_4801 = func_488();
			}
...
void func_264(int iParam0, int iParam1)
{
	...
	func_292(iParam0, &(Global_101154.f_18807.f_5510));
}

bool func_265(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_278(iParam0, 0, 0)) || func_278(iParam0, 1, 0)) || func_278(iParam0, 2, 0)) || func_290(iParam0) != 145) || func_277(iParam0)) || func_276(iParam0)) || func_275(iParam0)) || func_274(iParam0)) || !func_266(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_276(iParam0))
		{
		}
...
bool func_278(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_279(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_279(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
int func_281(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_18 = {0f, 0f, 0f};
	...
	if (is_bit_set(*uParam0.f_9, 10))
	{
		*uParam0.f_4 = Global_101154.f_18807.f_69[*uParam0.f_14 /*78*/].f_66;
		...
		if (!func_291(Global_101154.f_18807.f_1864[*uParam0.f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_291(Global_101154.f_1826.f_539.f_2816[1 /*10*/][*uParam0.f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_291(Global_101154.f_1826.f_539.f_2816[0 /*10*/][*uParam0.f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_283(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_284(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_281(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_289(iParam0);
			func_288(uParam1, &(Global_101154.f_18807.f_69[Global_68319.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_288(auto uParam0, auto uParam1)
{
...
int func_291(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
void func_292(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_293(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_294(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_301(auto uParam0, int iParam1, int iParam2)
{
...
bool func_302(auto uParam0, int iParam1, Vector3 vParam2, Vector3 vParam3, Vector3 vParam4, auto uParam5, auto uParam6)
{
	Vector3 vVar0;
	...
	{
		case 0:
			if (func_429(iParam1) >= 0f)
			{
				vParam8.z = func_46(vParam8.z, -8.909f, 8.909f);
				*uParam11.f_2 += vParam8.z;
				vVar0 = {func_431(vParam5, vParam8.z)};
				set_cam_params(func_401(uParam0, 0), vParam2 + vVar0, *uParam11, *uParam12, 300, 1, 1, 2);
				set_cam_active_with_interp(func_401(uParam0, 1), func_401(uParam0, 0), floor(1000f * 1.1f - 0f), 2, 1);
				*uParam0.f_3 = 1;
			}
			break;
...
void func_303(int iParam0, auto uParam1, int iParam2)
{
	...
	iVar3 = func_401(uParam1, 0);
	iVar4 = func_401(uParam1, 1);
	set_cam_near_clip(iVar4, func_304());
	vVar5 = {get_offset_from_entity_in_world_coords(iParam0, 2f, -0.3f, -7.7824f)};
	set_cam_coord(iVar4, vVar5);
	vVar0 = {get_cam_rot(iVar3, 2)};
	vVar0.x = 0f;
	set_cam_rot(iVar4, vVar0, 2);
	set_cam_fov(iVar4, get_cam_fov(iVar3));
	render_script_cams(true, false, 3000, 1, 0, 0);
	*uParam1.f_3 = 0;
	func_344(iParam2);
}
...
bool func_305(auto uParam0, auto uParam1, auto uParam2, int iParam3, auto uParam4, auto uParam5, Vector3 vParam6, Vector3 vParam7)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	
	iVar0 = func_401(uParam1, 0);
	vVar1 = {func_308(uParam2)};
	if (is_look_inverted())
	{
		vVar1.y *= -1f;
	}
	if (!_is_input_disabled(2))
	{
		*uParam5.f_2 -= vVar1.x * get_frame_time() * 100f;
		*uParam5 += vVar1.y * get_frame_time() * 100f;
		if (absf(*uParam5.f_2) > 0.001f)
		{
			*uParam5.f_2 -= *uParam5.f_2 * get_frame_time() * 4f;
		}
		else
		{
			*uParam5.f_2 = 0f;
		...
		{
			*uParam5 -= *uParam5 * get_frame_time() * 5f;
		}
		else
		{
			*uParam5 = 0f;
	...
	*uParam4.f_2 += *uParam5.f_2 * get_frame_time();
	...
	*uParam4 += *uParam5 * get_frame_time();
	...
	vVar4 = {func_431(vParam9, *uParam4.f_2)};
	set_cam_coord(iVar0, vParam6 + vVar4);
	set_cam_rot(iVar0, -33f + *uParam4, 0f, -88.515f + func_432(uParam0) + *uParam4.f_2, 2);
	set_cam_near_clip(iVar0, func_304());
	if (!is_screen_faded_in() || !func_430(iParam3))
	{
		func_344(iParam3);
	}
	else
	{
		...
		if (func_430(iParam3) && func_429(iParam3) > 0.5f)
		{
...
int func_306(auto uParam0, int iParam1)
{
...
Vector3 func_308(auto uParam0)
{
	return *uParam0, *uParam0.f_1, 0f;
}

void func_309(int iParam0, Vector3 vParam1)
{
	float fVar0;
	float fVar1;
	float fVar2;
	
	fVar0 = 0.006f * sin(0.25f * 0.5f * to_float(GAMEPLAY::GET_GAME_TIMER()) + 1.5f);
	fVar1 = 0.006f * sin(0.25f * 0.4f * to_float(GAMEPLAY::GET_GAME_TIMER()) + 3f);
	fVar2 = 0.006f * sin(0.25f * 1f * to_float(GAMEPLAY::GET_GAME_TIMER()));
	if (!is_entity_dead(iParam0, 0))
	{
...
void func_312(auto uParam0, int iParam1)
{
	if (iParam1)
	{
...
struct<4> func_314(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 12:
		case 6:
			StringCopy(&cVar0, "BJ_OBJ_JCL", 16);
			break;
		
		case 4:
			StringCopy(&cVar0, "BJ_OBJ_JDB", 16);
			break;
		
		case 5:
			StringCopy(&cVar0, "BJ_OBJ_JCR", 16);
			break;
		
		case 8:
			StringCopy(&cVar0, "BJ_OBJ_JB", 16);
			break;
...
void func_316(int iParam0, int iParam1)
{
	if (func_430(iParam0))
	{
		if (func_318(iParam0, 7.5f * IntToFloat(*iParam1)))
		{
			*iParam1++;
...
void func_320(auto uParam0)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		get_current_ped_weapon(PLAYER::PLAYER_PED_ID(), uParam0, 1);
		...
		{
			give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), -1, false, true);
		}
		disable_control_action(0, 37, 1);
...
int func_321(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, int iParam9, auto uParam10, int iParam11, int iParam12, int iParam13, int iParam14, auto uParam15, auto uParam16, auto uParam17, auto uParam18, int iParam19, int iParam20, float fParam21)
{
	Vector3 vVar0;
	auto uVar3;
	auto uVar6;
	...
	vVar12 = {func_342(uParam0, *iParam6)};
	iVar37 = *iParam6 == iParam9 - 1;
	*iParam3[0] = *iParam3[0];
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		get_entity_matrix(PLAYER::PLAYER_PED_ID(), &vVar0, &uVar3, &uVar6, &vVar9);
	}
	if (iVar37)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1) && !is_entity_dead(iParam1, 0))
		{
			vVar27 = {get_offset_from_entity_in_world_coords(iParam1, func_343(uParam0))};
			fVar36 = vVar27.z - vVar12.z;
			if (iParam20)
			{
				if (does_blip_exist(*iParam11))
				{
					set_blip_coords(*iParam11, vVar27);
				}
				else
				{
					*iParam11 = add_blip_for_coord(vVar27);
					set_blip_colour(*iParam11, 5);
					set_blip_scale(*iParam11, 1.2f);
					set_blip_name_from_text_file(*iParam11, "BJ_BLIP_TGT");
				}
			}
			vVar30 = {func_342(uParam0, 0)};
			vVar27.z = vVar30.z + fVar36;
			vVar12 = {vVar27};
		}
		else if (func_341(uParam0) != 0)
		{
			vVar27 = {func_342(uParam0, 0)};
			vVar12 = {vVar27};
		}
		else
		{
		...
		{
			draw_marker(6, vVar27, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_330(vVar27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
			draw_marker(6, vVar27, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_330(vVar27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
			draw_marker(6, vVar27, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_330(vVar27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
		}
		if (*iParam7 != -1)
		{
	...
	{
		get_hud_colour(134, &iVar39, &iVar40, &iVar41, &uVar42);
		vVar18 = {vVar9 - vVar12};
		vVar15 = {func_342(uParam0, *iParam6 + 1)};
		draw_marker(6, vVar12, func_443(vVar18), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_330(vVar12, 25, 200), 0, 0, 2, 0, 0, 0, 0);
		if (*iParam7 != *iParam6)
		{
			if (*iParam7 >= 0)
			{
			...
			*iParam4 = create_checkpoint(15, vVar12, vVar15, 9f, iVar39, iVar40, iVar41, func_330(vVar27, 25, ceil(200f * to_float(113) / to_float(170))), 0);
			if (*iParam6 < iParam9 - 2)
			{
				*iParam5 = create_checkpoint(15, vVar15, func_342(uParam0, *iParam6 + 2), 9f * 0.5f, iVar39, iVar40, iVar41, func_330(vVar27, 25, ceil(200f * to_float(113) / to_float(170))), 0);
			}
			*iParam7 = *iParam6;
		}
		if (*iParam6 + 1 == iParam9 - 1)
		{
			draw_marker(6, vVar15, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 4f, 0.5f * 4f, 0.5f * 4f, 240, 200, 80, func_330(vVar15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
			draw_marker(6, vVar15, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 9f, 0.5f * 9f, 0.5f * 9f, 240, 200, 80, func_330(vVar15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
			draw_marker(6, vVar15, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 14f, 0.5f * 14f, 0.5f * 14f, 240, 200, 80, func_330(vVar15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
		}
		else
		{
			draw_marker(6, vVar15, func_443(vVar9 - vVar15), 0f, 0f, 0f, 0.5f * 14f, 0.5f * 14f, 0.5f * 14f, 240, 200, 80, func_330(vVar15, 25, 200), 0, 0, 2, 0, 0, 0, 0);
		}
		if (*iParam4 != 0)
		{
			set_checkpoint_rgba(*iParam4, iVar39, iVar40, iVar41, func_330(vVar12, 25, ceil(200f * to_float(113) / to_float(170))));
		}
		if (*iParam5 != 0)
		{
			set_checkpoint_rgba(*iParam5, iVar39, iVar40, iVar41, func_330(vVar15, 25, ceil(200f * to_float(113) / to_float(170))));
		}
	}
	if (!iParam19)
	{
	...
	if ((get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 0 || get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 1) || (get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 2 && !is_control_pressed(0, 80)))
	{
		if (!_world3d_to_screen2d(vVar12, &uVar43, &uVar44))
		{
			if (iLocal_612)
			{
				func_328(vVar12, uParam15, uParam16, uParam17);
				if (func_430(&iLocal_614))
				{
					func_426(&iLocal_614);
				}
			}
			else if (func_430(&iLocal_614))
			{
				if (func_326(&iLocal_614) > 0.5f)
				{
					func_426(&iLocal_614);
					iLocal_612 = 1;
				}
	...
	if (func_325(iParam14, uParam18, &iParam1))
	{
		...
		if (((vVar18.z < 5f && vVar18.z > -2f) && fVar34 < 15f) || func_242(iParam1, iParam2))
		{
			*uParam10 = func_244(ceil(100f * 15f - fVar34 / 15f) + 4, 0, 100);
			return 1;
		}
		else
		{
	...
	else if (!iVar37)
	{
		...
		if (fVar33 < 22f * 22f)
		{
			...
			else if (func_251(vVar0, -vVar18 / FtoV(sqrt(fVar33))) < 0.08f)
			{
				iVar38 = true;
			}
			if (iVar38)
			{
				*uParam8++;
				func_323(iParam13, 1);
				func_204(func_396(), 1, floor(30f * fParam21), 0, 0);
				iLocal_613 = 0;
			}
			if (!iVar38 && !iLocal_613)
			{
				iLocal_613 = 1;
			}
		}
		else if (get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 0 || get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == -1)
		{
			if (vVar18.z < -22f)
			{
				func_323(iParam13, 0);
		...
		{
			vVar24 = {get_entity_forward_vector(PLAYER::PLAYER_PED_ID())};
			vVar24.z = 0f;
			vVar24 = {func_443(vVar24)};
			vVar21 = {-vVar18.x, -vVar18.y, 0f};
			vVar21 = {func_443(vVar21)};
			fVar35 = vVar9.z - 32f + 32f * func_322(vVar24, vVar21);
			fVar34 = sqrt(vVar18.x * vVar18.x + vVar18.y * vVar18.y);
		...
		if (iVar38)
		{
			*iParam6++;
			...
			if (*iParam6 < iParam9 - 1)
			{
				if (!does_blip_exist(*iParam12))
				{
					*iParam12 = add_blip_for_coord(func_342(uParam0, *iParam6 + 1));
			...
			task_look_at_coord(PLAYER::PLAYER_PED_ID(), func_342(uParam0, *iParam6), -1, 0, 2);
		}
	}
	return 0;
}

float func_322(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
bool func_324()
{
	if (((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) && (get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 3 || get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == -1)) && get_entity_height_above_ground(PLAYER::PLAYER_PED_ID()) > 50f) && !get_player_has_reserve_parachute(player_id()))
	{
		return true;
	}
	return false;
...
int func_325(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	return (((is_entity_in_water(PLAYER::PLAYER_PED_ID()) || (get_ped_parachute_state(iVar0) == 3 && !is_entity_in_air(iVar0))) || (get_ped_parachute_state(iVar0) == -1 && !is_entity_in_air(iVar0))) || (((ENTITY::DOES_ENTITY_EXIST(*iParam2) && !PED::IS_PED_INJURED(iVar0)) && !is_entity_dead(*iParam2, 0)) && is_ped_on_specific_vehicle(iVar0, *iParam2)));
}
...
float func_326(int iParam0)
{
	if (func_430(iParam0))
	{
		...
		{
			return func_40(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return 0f;
}
...
void func_328(Vector3 vParam0, auto uParam1, auto uParam2, auto uParam3)
{
	auto uVar0;
	auto uVar1;
	float fVar2;
	...
	if (_world3d_to_screen2d(vParam0, &uVar0, &uVar1))
	{
	}
	fVar4 = 0f;
	fVar5 = 0.05f;
	fVar6 = 0.05f;
	func_329(vParam0, &fVar2, &fVar3);
...
void func_329(Vector3 vParam0, auto uParam1, auto uParam2)
{
	float fVar0;
	float fVar1;
	Vector3 vVar2;
	
	if (!func_291(vParam0, 0f, 0f, 0f, 0))
	{
		_0xF9904D11F1ACBEC3(vParam0, &fVar0, &fVar1);
	}
	if (fVar0 >= 0.5f)
	{
		vVar2.x = fVar0 - 0.5f;
...
{
	if (func_430(iParam0) && func_429(iParam0) > 7.5f)
	{
		func_426(iParam0);
	}
}

bool func_332(auto uParam0, int iParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
	{
		...
		else if (!get_ground_z_for_3d_coord(get_entity_coords(iVar0, 1), &fVar7, 0))
		{
			return false;
		}
	...
	if (is_entity_in_air(PLAYER::PLAYER_PED_ID()))
	{
		return false;
	}
	else if (!get_ground_z_for_3d_coord(vVar1, &fVar7, 0))
	{
		return false;
	}
	else if (vVar1.z >= fVar7 + 1.5f)
	...
	{
		if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), func_441(iParam1)) > 3600f)
		{
			*uParam2 = 1;
			return true;
		}
...
void func_335(int iParam0, int iParam1)
{
	...
	vVar2 = {get_entity_coords(*iParam0, 1)};
	fVar8 = _0x53AF99BAA671CA47(*iParam0);
	iVar1 = get_ped_in_vehicle_seat(*iParam0, -1);
	freeze_entity_position(*iParam0, false);
	open_sequence_task(&iVar0);
	if (!iParam1)
	{
		task_vehicle_mission_coors_target(false, *iParam0, get_entity_coords(*iParam0, 1), 4, 0f, 786469, 2f, 0f, 1);
	}
	task_vehicle_mission_coors_target(false, *iParam0, vVar2 + Vector(5f, 5f, 5f) * get_entity_forward_vector(*iParam0) + Vector(20f, 0f, 0f), 4, 0.3f * fVar8, 786469, 5f, 10f, 1);
	vVar5 = {Vector(1000f, 1000f, 1000f) * get_entity_forward_vector(*iParam0)};
	vVar5.z = 200f;
	task_vehicle_mission_coors_target(false, *iParam0, vVar2 + vVar5, 4, fVar8, 262144, 15f, 10f, 1);
...
auto func_341(auto uParam0)
{
	return *uParam0.f_1;
}

Vector3 func_342(auto uParam0, int iParam1)
{
...
auto func_351(auto uParam0)
{
	return *uParam0.f_83;
}

bool func_352(auto uParam0, int iParam1, int iParam2, auto uParam3, auto uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, auto uParam10, auto uParam11, auto uParam12)
{
	if (is_cam_interpolating(func_401(uParam3, 1)))
	{
		func_344(iParam5);
	}
	if (!*uParam10)
	{
		if (func_430(iParam7) && func_429(iParam7) >= func_373(uParam0))
		{
			func_335(iParam2, 0);
			func_426(iParam7);
			*uParam10 = 1;
	...
	if (func_430(iParam5) && func_429(iParam5) > 0.2f)
	{
		func_426(iParam5);
		func_426(iParam6);
		return true;
	...
	else if ((uParam12 && is_screen_faded_in()) || (func_429(iParam6) > 0.5f && func_306(uParam4, 2)))
	{
		*uParam11 = 1;
		func_426(iParam5);
		func_426(iParam6);
	...
	if (func_430(iParam8))
	{
		...
		else if (func_429(iParam8) > func_394(iParam1, iParam9))
		{
			switch (iParam9)
			{
				case 0:
					task_play_anim(PLAYER::PLAYER_PED_ID(), "amb@world_human_hiker_standing@male@idle_a", "idle_a", 8f, -1.4f, -1, 48, 0, 0, 0, 0);
					break;
				
				case 1:
					task_play_anim(PLAYER::PLAYER_PED_ID(), "amb@world_human_muscle_flex@arms_at_side@base", "base", 8f, -1.4f, -1, 48, 0.681f, 0, 0, 0);
					break;
				
				case 2:
					task_play_anim(PLAYER::PLAYER_PED_ID(), "playidles_cold", "blow_hands", 8f, -1.4f, -1, 48, 0.537f, 0, 0, 0);
					break;
			}
			func_426(iParam8);
		}
	...
	if (Global_69743 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !is_screen_faded_out())
			{
				...
				Var4 = {func_357(Global_69744, Global_69746, iParam10)};
				if (fVar7 == -0.014f)
				{
				}
...
struct<2> func_357(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_364(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_363(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_362(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_361(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_360(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_359(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_358(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_364(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_368(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_370(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_30(0)) || func_369(1))
			{
			}
			else
			{
...
{
	return func_372(iParam0, Global_35711);
}
...
auto func_373(auto uParam0)
{
	return *uParam0.f_80;
}

int func_374(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_383(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
auto func_384(auto uParam0)
{
	return *uParam0.f_4;
}

void func_385(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	iVar0 = func_401(uParam0, 0);
	if (ENTITY::DOES_ENTITY_EXIST(iParam5) && !is_entity_dead(iParam5, 0))
	{
		*uParam2 = {10.2986f, 0f, 8.909f};
		*uParam4 = {Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos(-97.4239f + func_432(uParam1)), sin(-97.4239f + func_432(uParam1)))};
		*uParam3 = {get_offset_from_entity_in_world_coords(iParam5, 1.12046f, -0.317773f, 1.3385f)};
		vVar1 = {func_431(*uParam4, *uParam2.f_2)};
		vVar7 = {*uParam3 + vVar1};
		*uParam6 = {-33f + *uParam2, 0f, -88.515f + func_432(uParam1)};
		*uParam7 = 26f;
		vVar4 = {*uParam6};
		vVar4.z += *uParam2.f_2;
		set_cam_coord(iVar0, vVar7);
		set_cam_rot(iVar0, vVar4, 2);
...
void func_386(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_390(player_id())) && !func_388(player_id(), 0)) && !func_387())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_390(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_392(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_397()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_35(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(iVar0) && (!func_227(14) || Global_100106))
			{
...
float func_398(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
int func_401(auto uParam0, int iParam1)
{
	if (iParam1 >= 2)
	{
		return 0;
...
void func_403(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	{
		set_all_vehicle_generators_active_in_area(func_425(uParam0), func_424(uParam0), false, 1);
	}
	iVar5 = 0;
	while (iVar5 < 12)
	{
	...
	set_player_control(player_id(), false, 0);
	WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), false);
	give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), true, false, false);
	set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
	if (iParam13 == 4)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			...
			{
				vVar2 = {get_entity_coords(iVar1, 1)};
	...
	if (iVar0 != 0)
	{
		if (!is_entity_dead(*iParam3, 0) || ENTITY::DOES_ENTITY_EXIST(*iParam3))
		{
			set_vehicle_fixed(*iParam3);
			set_entity_coords(*iParam3, func_441(iParam13), 1, false, 0, 1);
			set_entity_heading(*iParam3, func_432(uParam0));
		}
		else
		{
			*iParam3 = create_vehicle(iVar0, func_441(iParam13), func_432(uParam0), 1, 1);
		}
		if (func_433(iVar0))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(*iParam8) || is_entity_dead(*iParam8, 0))
			{
			...
			func_418(uParam1, PLAYER::PLAYER_PED_ID(), func_420());
			set_heli_blades_speed(*iParam3, 0.7f);
			freeze_entity_position(*iParam3, true);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), *iParam3, 0))
				{
					detach_entity(PLAYER::PLAYER_PED_ID(), 1, true);
					freeze_entity_position(PLAYER::PLAYER_PED_ID(), false);
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), *iParam3, 2);
				}
				else if (func_417(PLAYER::PLAYER_PED_ID(), *iParam3) == 1)
				{
					freeze_entity_position(PLAYER::PLAYER_PED_ID(), false);
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), *iParam3, 2);
				}
			...
			if (!is_entity_dead(*iParam3, 0))
			{
				*iParam14 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
				...
				task_synchronized_scene(PLAYER::PLAYER_PED_ID(), *iParam14, "oddjobs@basejump@", "Heli_door_loop", 4f, -4f, 65, 0, 1000f, 0);
		...
		else if (func_338(iVar0))
		{
			func_418(uParam1, PLAYER::PLAYER_PED_ID(), func_420());
			freeze_entity_position(PLAYER::PLAYER_PED_ID(), false);
			set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), *iParam3, -1);
			give_ped_helmet(PLAYER::PLAYER_PED_ID(), 0, 4096, -1);
			func_454(iParam12);
		}
	}
	else
	{
		...
		if (func_351(uParam0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || is_ped_on_vehicle(PLAYER::PLAYER_PED_ID())))
			{
				_0xF9ACF4A08098EA25(PLAYER::PLAYER_PED_ID(), 1);
			}
			set_entity_coords(PLAYER::PLAYER_PED_ID(), func_441(iParam13), 1, false, 0, 1);
			set_entity_heading(PLAYER::PLAYER_PED_ID(), func_432(uParam0));
			task_stand_still(PLAYER::PLAYER_PED_ID(), -1);
			if (ENTITY::DOES_ENTITY_EXIST(*iParam3))
			{
				iVar6 = -1;
				while (iVar6 <= get_vehicle_max_number_of_passengers(*iParam3) - 1)
				{
					if (!is_vehicle_seat_free(*iParam3, iVar6))
					{
						iVar7 = get_ped_in_vehicle_seat(*iParam3, iVar6);
						delete_ped(&iVar7);
					}
					iVar6++;
				}
	...
	{
		clear_area(func_342(uParam0, 0), 100f, 1, 0, 0, false);
		if (ENTITY::DOES_ENTITY_EXIST(*iParam4) && is_entity_dead(*iParam4, 0))
		{
			delete_vehicle(iParam4);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(*iParam4))
		{
			*iParam4 = create_vehicle(iVar0, func_342(uParam0, 0), func_408(uParam0), 1, 1);
			...
			set_entity_load_collision_flag(*iParam4, true);
		}
		else if (!is_entity_dead(*iParam4, 0))
		{
			set_vehicle_fixed(*iParam4);
			set_entity_coords(*iParam4, func_342(uParam0, 0), 1, false, 0, 1);
			set_entity_heading(*iParam4, func_408(uParam0));
		}
		if (func_407(func_341(uParam0)))
		{
			if (ENTITY::DOES_ENTITY_EXIST(*iParam6) && is_entity_dead(*iParam6, 0))
			{
				delete_vehicle(iParam6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(*iParam6))
			{
				*iParam6 = create_vehicle(joaat("trflat"), get_offset_from_entity_in_world_coords(*iParam4, 0f, -10f, 0f), func_408(uParam0), 1, 1);
				set_entity_load_collision_flag(*iParam6, true);
			...
			{
				attach_vehicle_to_trailer(*iParam4, *iParam6, 1f);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(*iParam9) && is_entity_dead(*iParam9, 0))
		{
			delete_ped(iParam9);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(*iParam9))
		{
			*iParam9 = PED::CREATE_PED_inside_vehicle(*iParam4, 26, iParam11, -1, 1, true);
			...
			func_405(*iParam9, iParam13);
			if (iParam13 == 0)
			{
				func_404(uParam1, 2, *iParam9, "EX3MERC1", 0, 1);
			}
		}
		else
		{
			set_entity_health(*iParam9, get_entity_max_health(*iParam9));
			reset_ped_visible_damage(*iParam9);
			clear_ped_tasks(*iParam9);
			if (!is_ped_in_vehicle(*iParam9, *iParam4, 0) || get_ped_in_vehicle_seat(*iParam4, -1) != *iParam9)
			{
		...
		set_entity_load_collision_flag(*iParam9, true);
	}
	if (func_396() == 0)
	{
		set_ped_component_variation(PLAYER::PLAYER_PED_ID(), 9, 5, 0, 0);
...
void func_404(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_405(int iParam0, int iParam1)
{
	...
	{
		case 0:
			set_ped_component_variation(iParam0, false, 1, 0, 0);
		...
		case 7:
			...
			set_ped_prop_index(iParam0, false, 0, 2, false);
			break;
	}
}
...
void func_409(auto uParam0, int iParam1)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam1))
	{
		*iParam1 = create_vehicle(func_412(uParam0), func_411(uParam0), func_410(uParam0), 1, 1);
	}
...
auto func_410(auto uParam0)
{
	return *uParam0.f_79;
}

Vector3 func_411(auto uParam0)
{
	return *uParam0.f_9;
}

auto func_412(auto uParam0)
{
	return *uParam0.f_3;
}

void func_413(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (!func_299(*uParam1) && ENTITY::DOES_ENTITY_EXIST(get_ped_in_vehicle_seat(*uParam1, -1)))
		{
			iVar1 = get_ped_in_vehicle_seat(*uParam1, -1);
		}
		iVar2 = *uParam1;
	}
	...
	if (iVar0 != 0)
	{
		...
		{
			iVar2 = create_vehicle(func_499(uParam0), func_415(uParam0), func_414(uParam0), 1, 1);
		}
		else
		{
			set_entity_coords(iVar2, func_415(uParam0), 1, false, 0, 1);
			set_entity_heading(iVar2, func_414(uParam0));
		}
	...
	else
	{
		...
		set_ped_helmet(iVar1, 0);
		set_ped_prop_index(iVar1, false, 2, 0, false);
		set_ped_prop_index(iVar1, true, 0, 0, false);
	}
	set_vehicle_engine_on(iVar2, true, 1, 0);
...
auto func_414(auto uParam0)
{
	return *uParam0.f_78;
}

Vector3 func_415(auto uParam0)
{
	return *uParam0.f_70;
}
...
void func_418(auto uParam0, int iParam1, char* sParam2)
{
	int iVar0;
...
void func_421(auto uParam0, int iParam1, char* sParam2)
{
	int iVar0;
...
Vector3 func_424(auto uParam0)
{
	return *uParam0.f_67;
}

Vector3 func_425(auto uParam0)
{
	return *uParam0.f_64;
}
...
bool func_427(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	char[64] cVar0;
	
	if (!func_433(func_434(iParam3)))
	{
		request_additional_collision_at_coord(func_441(iParam3));
	}
	if (func_430(iParam1))
	{
		if (func_429(iParam1) >= 5f)
		{
			return true;
		}
	}
			...
			if (has_additional_text_loaded(2))
			{
				if (has_streamed_texture_dict_loaded("basejumping"))
				{
					if (((has_anim_dict_loaded("oddjobs@basejump@") && has_anim_dict_loaded("skydive@freefall")) && has_anim_dict_loaded("skydive@parachute@chute")) && has_anim_dict_loaded("skydive@parachute@"))
					{
						...
						{
							if (!iParam5 || is_screen_faded_out())
							{
								return true;
							}
						}
...
Vector3 func_431(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
void func_435(auto uParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	int iVar0;
	int iVar1;
	...
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
	{
		set_ped_lod_multiplier(PLAYER::PLAYER_PED_ID(), 2f);
	}
	switch (iParam1)
	{
		case 0:
	...
	if (is_screen_faded_out())
	{
		clear_area(func_441(iParam1), 5000f, 1, 0, 0, false);
	}
	...
	*uParam5 = func_158();
	...
	{
		*uParam6 = get_random_int_in_range(false, 2);
		switch (*uParam6)
		{
			case 0:
	...
	if (func_434(iParam1) == 0)
	{
		request_additional_collision_at_coord(func_441(iParam1));
	}
}

void func_436(auto uParam0)
{
	int iVar0;
...
bool func_438(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_25277, iParam0);
...
bool func_442(int iParam0)
{
	if (is_screen_faded_out())
	{
		if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), func_441(iParam0), 15f, 15f, 15f, false, true, 0))
		{
			return true;
		}
		set_entity_coords(PLAYER::PLAYER_PED_ID(), func_441(iParam0), 0, false, 0, 1);
		if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), func_441(iParam0), 15f, 15f, 15f, false, true, 0))
		{
			return true;
		}
...
void func_445(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 fVar6;
	...
	vVar0 = {func_453(uParam1)};
	vVar3 = {func_452(uParam1)};
	fVar6 = func_451(uParam1);
	if (!does_cam_exist(func_401(uParam0, 0)))
	{
		func_450(uParam0, 0, create_camera_with_params(26379945, vVar0, vVar3, 65f, 0, 2), 1);
	}
	else
	{
		set_cam_coord(func_401(uParam0, 0), vVar0);
		set_cam_rot(func_401(uParam0, 0), vVar3, 2);
	}
	set_cam_fov(func_401(uParam0, 0), fVar6);
	set_cam_active(func_401(uParam0, 0), true);
	if (iParam3)
	{
		vVar7 = {vVar0};
		vVar7.z += 8f;
		set_cam_params(func_401(uParam0, 0), vVar7, vVar3, fVar6, func_449(iParam2), 1, 1, 2);
	}
	vVar0 = {func_448(uParam1)};
	vVar3 = {func_447(uParam1)};
	fVar6 = func_446(uParam1);
	if (!does_cam_exist(func_401(uParam0, 1)))
	{
		func_450(uParam0, 1, create_camera_with_params(26379945, vVar0, vVar3, 65f, 0, 2), 1);
	}
	else
	{
		set_cam_coord(func_401(uParam0, 1), vVar0);
		set_cam_rot(func_401(uParam0, 1), vVar3, 2);
	}
	set_cam_fov(func_401(uParam0, 1), fVar6);
	if (!is_screen_faded_out())
	{
		set_cam_active_with_interp(func_401(uParam0, 1), func_401(uParam0, 0), func_449(iParam2), 1, 1);
	}
	render_script_cams(true, false, 3000, 1, 0, 0);
...
Vector3 func_447(auto uParam0)
{
	return *uParam0.f_58;
}

Vector3 func_448(auto uParam0)
{
	return *uParam0.f_55;
}
...
void func_450(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam1 >= 2)
	{
		return;
...
auto func_451(auto uParam0)
{
	return *uParam0.f_81;
}

Vector3 func_452(auto uParam0)
{
	return *uParam0.f_52;
}

Vector3 func_453(auto uParam0)
{
	return *uParam0.f_49;
}
...
void func_456(int iParam0)
{
	...
	if (func_281(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		...
		if (is_bit_set(Global_68319.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_287(iParam0, 0)) && Global_69228.f_66 == 0) && Global_101154.f_18807.f_1958[Global_68319.f_555[0 /*21*/].f_14] != 0) && Global_101154.f_18807.f_1958[Global_68319.f_555[0 /*21*/].f_14] > 3) && (!func_457(0, Global_68319.f_555[0 /*21*/].f_12) || !func_457(1, Global_68319.f_555[0 /*21*/].f_12)))
			{
				func_288(&(Global_101154.f_18807.f_69[Global_68319.f_555[0 /*21*/].f_14 /*78*/]), &Global_69228);
...
int func_457(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_458(&(Global_101154.f_18807.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_267(Global_101154.f_18807.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}

auto func_458(auto uParam0)
{
	return *uParam0;
}
...
void func_459(char* sParam0, int iParam1)
{
	...
	{
		if (func_310(sParam0) && !is_help_message_fading_out())
		{
			clear_help(0);
		}
	}
	...
	while (iVar0 < Global_101154.f_24935.f_145)
	{
		if (are_strings_equal(sParam0, &(Global_101154.f_24935[iVar0 /*16*/])))
		{
			...
			func_461(Global_101154.f_24935.f_145 - 1);
...
void func_462(int iParam0, auto uParam1)
{
...
void func_471(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	if (iParam1 < 11)
	{
		...
		{
			if ((iParam1 == 4 && !iParam3) && (is_screen_faded_in() || is_screen_fading_in()))
			{
		...
		else if (!func_239(uParam0, 22))
		{
			if (iParam1 == 9)
			{
				iVar0 = get_ped_parachute_state(PLAYER::PLAYER_PED_ID());
				if (iVar0 == 1 || iVar0 == 2)
				{
		...
		else if (!func_239(uParam0, 23) && !is_player_playing(player_id()))
		{
			stop_audio_scenes();
		}
	}
...
void func_472(char* sParam0, int iParam1, int iParam2)
{
	if (!is_bit_set(*iParam1, iParam2))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam1, iParam2);
	}
}

bool func_473(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	if (!is_bit_set(*iParam2, iParam3))
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(iParam2, iParam3);
			return true;
		}
	}
	else
...
char* func_474(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 20:
			...
			else if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && func_338(ENTITY::GET_ENTITY_MODEL(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))))
			{
...
void func_475(auto uParam0, int iParam1)
{
	if (iParam1 < 11)
	{
...
bool func_476(char* sParam0, int iParam1, int iParam2)
{
	if (!is_bit_set(*iParam1, iParam2))
	{
...
bool func_477(char* sParam0, int iParam1, int iParam2)
{
	if (!is_bit_set(*iParam1, iParam2))
	{
		if (prepare_music_event(sParam0))
...
void func_479(auto uParam0)
{
	...
	func_486(&uVar3, &uVar4, &iVar5, &iVar6, is_player_control_on(player_id()), _is_input_disabled(2));
	Var0 = to_float(iVar5) / 128f;
	Var0.f_1 = to_float(iVar6) / -128f;
	func_483(uParam0, Var0, Var0.f_1);
	func_482(uParam0);
...
void func_481(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_2, iParam1);
	}
	else
	{
...
void func_482(auto uParam0)
{
	*uParam0.f_3 = *uParam0.f_2;
	*uParam0.f_2 = 0;
}

void func_483(auto uParam0, auto uParam1, auto uParam2)
{
	func_485(uParam0, uParam1);
	func_484(uParam0, uParam2);
}

void func_484(auto uParam0, auto uParam1)
{
	*uParam0.f_1 = uParam1;
}

void func_485(auto uParam0, auto uParam1)
{
	*uParam0 = uParam1;
}

void func_486(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_489(auto uParam0, int iParam1)
{
	if (iParam1 <= 0)
	{
		return;
...
void func_490(auto uParam0, int iParam1)
{
...
void func_491(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
auto func_493(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_494(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
int func_495(auto uParam0)
{
	return uParam0 & 15;
}

void func_496(auto uParam0, int iParam1)
{
...
void func_497(auto uParam0, int iParam1)
{
...
void func_501(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_67 = {vParam1};
}

void func_502(auto uParam0, Vector3 vParam1)
{
...
void func_504(auto uParam0, int iParam1)
{
	*uParam0.f_83 = iParam1;
}

void func_505(auto uParam0, float fParam1)
{
	*uParam0.f_82 = fParam1;
}

void func_506(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_58 = {vParam1};
}

void func_507(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_55 = {vParam1};
}

void func_508(auto uParam0, float fParam1)
{
	*uParam0.f_81 = fParam1;
}

void func_509(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_52 = {vParam1};
}

void func_510(auto uParam0, Vector3 vParam1)
{
...
void func_512(auto uParam0, char* sParam1)
{
	*uParam0.f_4 = sParam1;
}

void func_513(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_6 = {vParam1};
}

void func_514(auto uParam0, float fParam1)
{
	*uParam0.f_77 = fParam1;
}

void func_515(auto uParam0, int iParam1, Vector3 vParam2)
{
	if (iParam1 < 0 || iParam1 >= 12)
	{
		return;
...
void func_516(auto uParam0, float fParam1)
{
	*uParam0.f_79 = fParam1;
}

void func_517(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_9 = {vParam1};
}

void func_518(auto uParam0, int iParam1)
{
	*uParam0.f_3 = iParam1;
}

void func_519(auto uParam0, float fParam1)
{
	*uParam0.f_80 = fParam1;
}

void func_520(auto uParam0, float fParam1)
{
...
void func_522(auto uParam0, int iParam1)
{
	*uParam0.f_2 = iParam1;
}

void func_523(auto uParam0, float fParam1)
{
	*uParam0.f_76 = fParam1;
}

void func_524(auto uParam0, int iParam1)
{
	*uParam0.f_1 = iParam1;
}

void func_525(auto uParam0, int iParam1)
{
	*uParam0 = iParam1;
}
...
void func_528(auto uParam0, auto uParam1, int iParam2, auto uParam3, int iParam4, auto uParam5, int iParam6, auto uParam7, int iParam8, auto uParam9, auto uParam10, auto uParam11, int iParam12, int iParam13, int iParam14, int iParam15, auto uParam16, int iParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_530(uParam7);
	func_259();
	_set_minimap_attitude_indicator_level(0f, 0);
	...
	{
		set_ped_reset_flag(PLAYER::PLAYER_PED_ID(), 177, false);
		PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 36, false);
		set_player_invincible(player_id(), 0);
		set_ped_can_be_knocked_off_vehicle(PLAYER::PLAYER_PED_ID(), 0);
		if (!iParam17)
		{
			remove_weapon_from_ped(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"));
		}
		set_ped_lod_multiplier(PLAYER::PLAYER_PED_ID(), 1f);
		set_ped_helmet(PLAYER::PLAYER_PED_ID(), 1);
	}
	iVar1 = 0;
	while (iVar1 < *uParam10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam10[iVar1]) && !is_entity_dead(*uParam10[iVar1], 0))
		{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(*iParam6) && *iParam6 != get_players_last_vehicle()) && !is_entity_dead(*iParam6, 0))
	{
		set_players_last_vehicle(*iParam6);
		func_262(*iParam6, func_298(iParam15), func_297(iParam15), 24, 0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		...
		{
			if ((!is_entity_dead(*iParam2, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), *iParam2, 0))
			{
				_0xF9ACF4A08098EA25(PLAYER::PLAYER_PED_ID(), 1);
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam4) && !is_entity_dead(*iParam4, 0))
	{
		iVar0 = get_ped_in_vehicle_seat(*iParam4, -1);
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			delete_ped(&iVar0);
		}
	...
	while (iVar2 < *uParam5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam5[iVar2]) && !is_entity_dead(*uParam5[iVar2], 0))
		{
			set_vehicle_lod_multiplier(*uParam5[iVar2], 1f);
			set_entity_load_collision_flag(*uParam5[iVar2], false);
		}
		iVar2++;
	}
	*iParam12 = 1;
...
void func_531(auto uParam0, int iParam1)
{
	if (*(uParam0[iParam1 /*10*/]).f_7 == 1)
	{
