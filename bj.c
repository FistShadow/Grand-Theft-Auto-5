				...
				else
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(iVar1156, false))
					{
						...
						else if (func_429(&iVar915) > 0.25f)
						{
							...
							func_426(&iVar915);
							GAMEPLAY::SET_BIT(&iVar1156, false);
						}
					}
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (is_vehicle_driveable(iVar1088, 0) && is_entity_in_air(iVar1088))
						{
							if (!GAMEPLAY::IS_BIT_SET(iVar1156, true))
							{
								...
								else if (func_429(&iVar894) > 0.15f)
								{
									...
									func_426(&iVar894);
									GAMEPLAY::SET_BIT(&iVar1156, true);
								}
							}
						}
						else
			...
			case 10:
				...
				if (((iVar1174 || iVar1175) || iVar1177) || (func_430(&iVar885) && func_429(&iVar885) > 0.25f))
				{
					...
					if (iVar1174 || iVar715 == 1)
					{
						...
						{
							iVar1157 = 125;
							GAMEPLAY::SET_BIT(&(Global_101154.f_17657.f_1), func_339(&Var16) - iVar1157);
...
void func_202(int iParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		GAMEPLAY::SET_BIT(iParam0.f_602, iParam1);
	}
	else
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_293(iVar0 + 1));
			}
			iVar0++;
		}
