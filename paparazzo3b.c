		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_472 + 10000)
		{
			if (!func_221())
			{
				if (func_240(PLAYER::PLAYER_PED_ID(), Local_332, 1) < 50f)
				{
					...
					{
						iLocal_471++;
						iLocal_472 = GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 4000);
					}
				}
			}
		}
...
void func_279()
{
	...
	switch (iLocal_276)
	{
		case 0:
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_391, false);
			}
		...
		case 1:
			...
			if (iLocal_438)
			{
				...
				else
				{
					...
					if (!iLocal_440)
					{
						if ((GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "PAP3_DEALER_20") && is_synchronized_scene_running(iLocal_294)) && get_synchronized_scene_phase(iLocal_294) < 0.758f)
						{
							if (func_224(Local_332))
							{
...
void func_310()
{
	...
	{
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "PAP3_DEALER") && get_current_scripted_conversation_line() > 0)
		{
			if (iLocal_475 == 0)
			{
...
void func_377()
{
	...
	switch (iLocal_276)
	{
		...
		case 2:
			...
			{
				Var0 = {func_247()};
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "PAP3_CONTACT_4") || GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "PAP3_CONTACT_5"))
				{
					iLocal_477++;
					if (iLocal_477 > 30)
					{
...
void func_380()
{
	...
	{
		ENTITY::FREEZE_ENTITY_POSITION(Local_397, false);
	}
	if (func_227(Local_391))
	{
		ENTITY::FREEZE_ENTITY_POSITION(Local_391, false);
	...
	if (func_448(uParam0))
	{
		...
		if (func_447(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_440(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(get_this_script_name(), "startup_positioning"))
				{
