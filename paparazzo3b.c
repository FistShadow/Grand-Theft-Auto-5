...
void main()
{
	...
	while (true)
	{
		...
		else if (func_464(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_275)
			{
				case 0:
...
void func_3()
{
	...
	switch (iLocal_276)
	{
		case 0:
			iLocal_416 = 0;
			iLocal_276 = 1;
			if ((func_224(Local_332) && func_223(Local_332, PLAYER::PLAYER_PED_ID(), 150f, 1)) && iLocal_433 == 1)
			{
		...
		case 1:
			...
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_451 || iLocal_277 == 5)
			{
				if (get_player_wanted_level(player_id()) == 0)
				{
					...
					if ((((!func_221() && !is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) && !is_ped_getting_up(PLAYER::PLAYER_PED_ID())) && !is_ped_prone(PLAYER::PLAYER_PED_ID())) && !is_ped_falling(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_416)
						{
							func_220(&uLocal_761, 3, 0, "BEVERLY", 0, 1);
							func_220(&uLocal_761, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							if (iLocal_419)
							{
...
void func_155()
{
	...
	{
		if (func_151(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_204(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2283, 28);
	}
	else
	{
...
void func_205(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2284, 28);
	}
	else
	{
	...
	if (func_224(Local_295[0 /*9*/]) && is_ped_in_any_vehicle(Local_295[0 /*9*/], 0))
	{
		if (is_entity_in_angled_area(Local_295[0 /*9*/], 1158.52f, -759.3739f, 56.32278f, 1116.869f, -759.6908f, 61.70632f, 13.75f, 0, true, 0))
		{
			if (get_script_task_status(Local_295[0 /*9*/], -1273030092) != 1)
			{
				...
				task_vehicle_mission_ped_target(Local_295[0 /*9*/], get_vehicle_ped_is_in(Local_295[0 /*9*/], 0), PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 20f, 20f, 1);
			}
		}
		if (func_224(Local_295[2 /*9*/]) && func_464(Local_378[1 /*6*/]))
		{
...
void func_230()
{
	...
	switch (iLocal_276)
	{
		...
		case 1:
			if (func_224(Local_295[0 /*9*/]))
			{
				if (!is_ped_in_combat(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID()))
				{
					task_combat_ped(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
			}
			if (func_224(Local_295[3 /*9*/]))
			{
				if (!is_ped_in_combat(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID()))
				{
					task_combat_ped(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
			}
			if (!func_224(Local_350[0 /*9*/]))
			{
				if (func_224(Local_295[1 /*9*/]))
				{
					if (!is_ped_in_combat(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID()))
					{
						task_combat_ped(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
				}
			}
			if (func_224(Local_295[2 /*9*/]))
			{
				if (iLocal_468 == 0)
				{
					if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1114.697f, -787.0848f, 56.64847f, 1051.764f, -787.1609f, 64.14056f, 23f, 0, true, 0))
					{
						if (func_464(Local_378[1 /*6*/]))
						{
							...
							{
								task_combat_ped(Local_295[2 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
								iLocal_468 = 1;
							}
						}
					}
			...
			if (iLocal_410 == 1)
			{
				...
				else
				{
					...
					if (has_entity_been_damaged_by_entity(Local_332, PLAYER::PLAYER_PED_ID(), 1))
					{
						func_1(3);
					}
					if (iLocal_480 == 2)
			...
			if (func_224(Local_332) && is_ped_in_any_vehicle(Local_332, 0))
			{
				...
				if (is_entity_in_angled_area(Local_332, 1158.52f, -759.3739f, 56.32278f, 1116.869f, -759.6908f, 61.70632f, 13.75f, 0, true, 0))
				{
					...
					{
						task_vehicle_mission_ped_target(Local_332, get_vehicle_ped_is_in(Local_332, 0), PLAYER::PLAYER_PED_ID(), 8, 50f, 786469, 20f, 20f, 1);
					}
				}
			}
			break;
...
bool func_231()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!func_223(PLAYER::PLAYER_PED_ID(), Local_295[iVar0 /*9*/], 200f, 1))
			{
...
void func_238()
{
	if (iLocal_471 < 2)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_472 + 10000)
		{
			if (!func_221())
			{
				if (func_240(PLAYER::PLAYER_PED_ID(), Local_332, 1) < 50f)
				{
					if (func_239(&uLocal_761, "pap3bau", "PAP3_SHOCK", 7, 1, 0, 0))
					{
						iLocal_471++;
						iLocal_472 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(false, 4000);
					}
				}
			}
		}
...
void func_248()
{
	switch (iLocal_276)
	{
		...
		case 1:
			...
			if (((GAMEPLAY::GET_GAME_TIMER() > iLocal_452 && func_254()) || (GAMEPLAY::GET_GAME_TIMER() > iLocal_453 && (func_254() || iLocal_414))) || func_252())
			{
				if (iLocal_415 == 0)
				{
					func_220(&uLocal_761, 3, 0, "BEVERLY", 0, 1);
					...
					if (func_254() || iLocal_414 == 1)
					{
						if (func_208(&uLocal_761, 50, "pap3bau", "PAP3_ENDCAL1", 9, 1, 0, 0, 0))
						{
							...
							if (func_224(Local_295[0 /*9*/]))
							{
								...
								task_turn_ped_to_face_entity(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), -1);
							}
						}
					}
	...
	if (iLocal_414 == 0)
	{
		if (iParam0 == 1)
		{
			if (func_224(Local_295[0 /*9*/]))
			{
				if (func_224(Local_350[0 /*9*/]))
				{
					task_aim_gun_at_entity(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), -1, 0);
					iLocal_481[0] = 9;
					iLocal_486[0] = 1;
		...
		if (func_224(Local_295[1 /*9*/]))
		{
			...
			{
				task_turn_ped_to_face_entity(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID(), -1);
				iLocal_481[1] = 9;
				iLocal_486[1] = 1;
				uLocal_455 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				uLocal_454 = GAMEPLAY::GET_GAME_TIMER() + 2000;
		...
		if (func_224(Local_295[3 /*9*/]))
		{
			if (func_224(PLAYER::PLAYER_PED_ID()))
			{
				task_go_to_coord_while_aiming_at_entity(Local_295[3 /*9*/], 1094.245f, -791.3043f, 57.2632f, PLAYER::PLAYER_PED_ID(), 3f, false, 9f, 15f, true, 0, 0, -957453492, 20000);
				iLocal_481[3] = 10;
			}
		}
		if (func_224(Local_332))
...
void func_250(int iParam0, int iParam1)
{
	if (func_224(iParam0))
	{
		if (iParam1 == 0)
		{
			...
			task_smart_flee_ped(iParam0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		...
		else
		{
			...
			set_ped_flee_attributes(iParam0, 64, false);
			task_smart_flee_ped(iParam0, PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
			set_ped_keep_task(iParam0, true);
		}
	}
}
...
bool func_251()
{
	...
	while (iVar0 <= 3)
	{
		if (func_464(Local_295[iVar0 /*9*/]))
		{
			...
			if (_0x6CD5A433374D4CFB(Local_295[iVar0 /*9*/], PLAYER::PLAYER_PED_ID()))
			{
				return true;
			}
		}
...
bool func_252()
{
	if (func_253(&uLocal_551, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
	{
		return false;
	}
	return true;
...
bool func_254()
{
	if (func_253(&uLocal_655, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
	{
		return true;
	}
	return false;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_369))
	{
		if (!is_entity_dead(Local_369, 0))
		{
			...
			else if (func_256(Local_369, 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				...
				{
					task_smart_flee_ped(Local_369, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
				func_1(5);
			}
			else if (has_entity_been_damaged_by_entity(Local_369, PLAYER::PLAYER_PED_ID(), 1))
			{
				set_blocking_of_non_temporary_events(Local_369, false);
				_0xF1C03A5352243A30(Local_369);
				if (!is_ped_fleeing(Local_369))
...
void func_275()
{
	...
	if (iLocal_410 == 0)
	{
		if (func_278(0))
		{
			...
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_341, 17, true);
...
void func_277(int iParam0, int iParam1)
{
	...
	{
		*iParam0 = PED::CREATE_PED(26, *iParam0.f_5, *iParam0.f_1, *iParam0.f_4, 1, true);
		if (iParam1 == 1)
		{
...
void func_279()
{
	...
	switch (iLocal_276)
	{
		case 0:
			...
			if (func_224(Local_332))
			{
				iLocal_929 = func_374(PLAYER::PLAYER_PED_ID(), Local_332, 0f);
			}
		...
		case 1:
			...
			if ((func_224(Local_369) && has_entity_been_damaged_by_entity(Local_369, PLAYER::PLAYER_PED_ID(), 1)) && !is_any_speech_playing(Local_214.f_28[0]))
			{
			...
			if (iLocal_438)
			{
				...
				else
				{
					...
					if (iLocal_412 && !func_241(PLAYER::PLAYER_PED_ID(), 1087.297f, -791.3091f, 57.2626f, 60f))
					{
						iLocal_433 = 1;
						clear_relationship_between_groups(5, iLocal_759, 1862763509);
						func_225();
			...
			if (iLocal_433 == 0)
			{
				...
				if (iLocal_427 == 0)
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1114.694f, -779.025f, 54.92999f, 1104.67f, -779.1714f, 60.32433f, 5f, 0, true, 0))
					{
						if (func_224(Local_295[3 /*9*/]))
						{
							task_look_at_entity(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							_play_ambient_speech_with_voice(Local_295[3 /*9*/], "PAP3B_BCAA", "Paparazzo3BBodyGuard1", "SPEECH_PARAMS_STANDARD", 0);
							iLocal_427 = 1;
						}
					}
				}
				else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1114.694f, -779.025f, 54.92999f, 1104.67f, -779.1714f, 60.32433f, 5f, 0, true, 0))
				{
					iLocal_436 = 0;
					iLocal_469++;
					if (iLocal_470 == 0)
					{
						if (iLocal_469 >= 50)
						{
							if (func_224(Local_295[3 /*9*/]))
							{
								...
								task_aim_gun_at_entity(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), 8000, 0);
								iLocal_470 = 1;
							}
						}
					}
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1114.719f, -786.1467f, 57.15265f, 1095.79f, -786.2317f, 60.53243f, 9.75f, 0, true, 0) && (get_player_current_stealth_noise(player_id()) > 1f || is_ped_facing_ped(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), 90f)))
				{
					if (iLocal_424 == 0)
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_759, 1862763509);
					...
					if (func_224(Local_295[3 /*9*/]))
					{
						if (!is_ped_facing_ped(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), 30f))
						{
							task_turn_ped_to_face_entity(Local_295[3 /*9*/], PLAYER::PLAYER_PED_ID(), false);
							vLocal_496 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
							iLocal_478 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_479 = 1;
						}
					}
				}
				if ((iLocal_479 == 1 && GAMEPLAY::GET_GAME_TIMER() > iLocal_478 + 1000) && func_224(Local_295[3 /*9*/]))
				{
					task_follow_nav_mesh_to_coord(Local_295[3 /*9*/], vLocal_496, 1f, -1, 0.25f, 0, 1193033728);
					iLocal_479 = 2;
				}
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1078.845f, -796.3937f, 57.01259f, 1091.735f, -796.5964f, 60.38212f, 6f, 0, true, 0))
				{
					if (func_224(Local_295[0 /*9*/]))
					{
						if (!is_ped_in_combat(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID()))
				...
				if (iLocal_424 == 0)
				{
					...
					if (((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1071.381f, -793.3854f, 57.05151f, 1101.543f, -793.3998f, 61.01268f, 11.75f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1095.905f, -786.5956f, 57.1032f, 1114.59f, -786.7163f, 60.15023f, 15.25f, 0, true, 0)) || (ENTITY::DOES_ENTITY_EXIST(get_players_last_vehicle()) && is_entity_in_angled_area(get_players_last_vehicle(), 1071.381f, -793.3854f, 57.05151f, 1101.543f, -793.3998f, 61.01268f, 11.75f, 0, true, 0))) || (ENTITY::DOES_ENTITY_EXIST(get_players_last_vehicle()) && is_entity_in_angled_area(get_players_last_vehicle(), 1095.905f, -786.5956f, 57.1032f, 1114.59f, -786.7163f, 60.15023f, 15.25f, 0, true, 0)))
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_759, 1862763509);
						iLocal_424 = 1;
					}
					...
					{
						if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1051.458f, -794.5156f, 55.68565f, 1117.848f, -794.2987f, 77.44183f, 33.75f, 0, true, 0))
						{
							if (func_224(Local_295[0 /*9*/]))
							{
								if (!is_ped_in_combat(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID()))
				...
				if (func_224(Local_295[0 /*9*/]))
				{
					if (func_240(PLAYER::PLAYER_PED_ID(), Local_295[0 /*9*/], 1) < 12f && get_player_current_stealth_noise(player_id()) > 20f)
					{
						if (!is_ped_in_combat(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID()))
						{
							task_combat_ped(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				...
				if (iLocal_428 == 0)
				{
					if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1051.791f, -793.2307f, 57.1418f, 1071.548f, -793.1798f, 60.55063f, 11.75f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1064.095f, -784.5695f, 56.83767f, 1061.792f, -789.8588f, 60.01268f, 11.75f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1058.49f, -785.6928f, 53.26268f, 1057.05f, -791.674f, 60.01268f, 9.5f, 0, true, 0))
					{
						...
						if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1051.507f, -792.2719f, 60.62209f, 1070.429f, -792.2669f, 57.01259f, 9.5f, 0, true, 0))
						{
							iLocal_462 += 2;
						...
						if (iLocal_462 > 1000)
						{
							if (iLocal_428 == 0)
							{
								...
								{
									task_look_at_entity(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									if (!is_ped_facing_ped(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), 20f))
									{
										task_turn_ped_to_face_entity(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), -1);
									}
					...
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1067.675f, -788.5863f, 53.27134f, 1067.798f, -798.8701f, 60.04082f, 8.25f, 0, true, 0))
					{
					...
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1084.465f, -800.1337f, 57.39651f, 1081.145f, -800.1677f, 59.99038f, 1.5f, 0, true, 0) && !get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()))
					{
						if (iLocal_428 == 0)
						{
							if (func_464(Local_295[0 /*9*/]))
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1087.937f, -793.1239f, 54.7728f, 1100.255f, -793.1273f, 61.01268f, 12.25f, 0, true, 0) || (ENTITY::DOES_ENTITY_EXIST(get_players_last_vehicle()) && is_entity_in_angled_area(get_players_last_vehicle(), 1087.937f, -793.1239f, 54.7728f, 1100.255f, -793.1273f, 61.01268f, 12.25f, 0, true, 0)))
				{
					if (func_224(Local_295[1 /*9*/]))
					{
						if (!is_ped_facing_ped(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID(), 45f))
						{
							set_blocking_of_non_temporary_events(Local_295[1 /*9*/], false);
							task_look_at_entity(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							task_turn_ped_to_face_entity(Local_295[1 /*9*/], PLAYER::PLAYER_PED_ID(), -1);
						}
					}
				}
				if (iLocal_428 == 1)
				{
					...
					else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_464 + 1200)
					{
						if (func_224(Local_295[0 /*9*/]))
						{
							if (is_ped_facing_ped(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), 50f))
							{
								if (get_script_task_status(Local_295[0 /*9*/], 1630799643) != 1 && get_script_task_status(Local_295[0 /*9*/], 1630799643) != 0)
								{
									...
									task_aim_gun_at_entity(Local_295[0 /*9*/], PLAYER::PLAYER_PED_ID(), 5000, 0);
					...
					if (is_ped_in_combat(Local_295[iVar12 /*9*/], false))
					{
						if (func_224(Local_332))
						{
							if (func_464(Local_378[0 /*6*/]))
							{
								...
								{
									task_look_at_entity(Local_332, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									...
									if (func_224(Local_295[2 /*9*/]))
									{
										task_combat_ped(Local_295[2 /*9*/], PLAYER::PLAYER_PED_ID(), 67108864, 16);
									}
									if (iLocal_412 == 1)
									{
										iLocal_275 = 6;
				...
				else
				{
					if (iLocal_433 == 0)
					{
						...
						else
						{
							...
							if (!func_223(Local_332, PLAYER::PLAYER_PED_ID(), 60f, 1))
							{
								Var6 = {func_229()};
								if (are_strings_equal(&Var6, "PAP3_DEALER"))
								{
					...
					if (iLocal_433 == 0)
					{
						...
						{
							if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1071.562f, -787.9003f, 56.7723f, 1071.65f, -793.4357f, 59.30243f, 3.25f, 0, true, 0) && is_ped_in_cover(PLAYER::PLAYER_PED_ID(), 0))
							{
							...
							if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1095.303f, -789.9751f, 62.40207f, 1078.776f, -789.9934f, 64.40999f, 1.5f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1078.399f, -785.0526f, 60.16986f, 1071.268f, -785.0859f, 62.19881f, 4.25f, 0, true, 0))
							{
								iLocal_463++;
								if (iLocal_463 > 50)
								{
					...
					if (func_224(Local_295[0 /*9*/]) && is_ped_in_any_vehicle(Local_295[0 /*9*/], 0))
					{
						if (is_entity_in_angled_area(Local_295[0 /*9*/], 1158.52f, -759.3739f, 56.32278f, 1116.869f, -759.6908f, 61.70632f, 13.75f, 0, true, 0))
						{
							if (get_script_task_status(Local_295[0 /*9*/], -1273030092) != 1)
							{
								task_vehicle_mission_ped_target(Local_295[0 /*9*/], get_vehicle_ped_is_in(Local_295[0 /*9*/], 0), PLAYER::PLAYER_PED_ID(), 8, 50f, 786469, 20f, 20f, 1);
								iLocal_277 = 5;
								iLocal_275 = 7;
								iLocal_276 = 0;
							}
					...
					if (func_464(Local_332) && !func_223(PLAYER::PLAYER_PED_ID(), Local_332, 209f, 1))
					{
						iLocal_275 = 7;
						iLocal_276 = 0;
					}
			...
			if (iLocal_410 == 1)
			{
				...
				else if (has_entity_been_damaged_by_entity(Local_332, PLAYER::PLAYER_PED_ID(), 1))
				{
					func_1(3);
				}
			}
...
bool func_281()
{
	if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1060.736f, -776.3729f, 56.7626f, 1087.983f, -792.0965f, 59.31259f, 8.25f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1051.626f, -768.4251f, 56.18585f, 1104.971f, -768.8157f, 60.03636f, 28.5f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1057.153f, -785.1578f, 59.00606f, 1057.153f, -782.0903f, 60.70669f, 1.95f, 0, true, 0))
	{
		return false;
	}
	if (func_224(Local_332))
	{
		...
		{
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1095.334f, -783.0236f, 61.67838f, 1078.834f, -783.1444f, 64.36657f, 15.75f, 0, true, 0))
			{
				if (has_entity_clear_los_to_entity(PLAYER::PLAYER_PED_ID(), Local_332, 126) && has_entity_clear_los_to_entity(PLAYER::PLAYER_PED_ID(), Local_341, 17))
				{
					return true;
				}
				else
			...
			else if (has_entity_clear_los_to_entity(PLAYER::PLAYER_PED_ID(), Local_332, 126) && has_entity_clear_los_to_entity(PLAYER::PLAYER_PED_ID(), Local_341, 17))
			{
				if (!func_223(Local_332, PLAYER::PLAYER_PED_ID(), 50f, 1))
				{
					iLocal_430 = 1;
					return false;
				}
...
void func_301()
{
	...
	if (func_253(&uLocal_707, vVar0) && vVar0.z < 61f)
	{
		if (iLocal_423)
		{
			if (!get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()))
			{
				set_ped_stealth_movement(PLAYER::PLAYER_PED_ID(), 1, 0);
			}
			iLocal_423 = 0;
		}
	}
...
void func_310()
{
	...
	if (!is_string_null_or_empty(&Var0))
	{
		if (are_strings_equal(&Var0, "PAP3_DEALER") && get_current_scripted_conversation_line() > 0)
		{
			if (iLocal_475 == 0)
			{
				if (func_240(PLAYER::PLAYER_PED_ID(), Local_332, 1) > 40f)
				{
					iLocal_287 = 1;
					iLocal_475 = 1;
					iLocal_476 = 1;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_326(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_347(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_356())
		{
			*uParam0 = func_352(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
void func_377()
{
	...
	if (iLocal_410)
	{
		...
		while (iVar6 <= 3)
		{
			...
			{
				if (is_ped_in_combat(Local_295[iVar6 /*9*/], PLAYER::PLAYER_PED_ID()))
				{
					set_blocking_of_non_temporary_events(Local_295[iVar6 /*9*/], false);
					func_1(2);
					return;
				}
				else if (func_223(Local_295[iVar6 /*9*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					task_combat_ped(Local_295[iVar6 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
			}
			else
			{
	...
	{
		if (!is_ped_headtracking_ped(Local_369, PLAYER::PLAYER_PED_ID()))
		{
			task_look_at_entity(Local_369, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
		}
	}
	switch (iLocal_276)
	{
		...
		case 1:
			...
			if (iLocal_410 == 1)
			{
				...
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_490, 5f, 5f, 2f, false, true, 0) && func_224(Local_369))
				{
					if (!is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))
					{
						func_220(&uLocal_761, 8, Local_369, "Paparazzo3BDealerGoon1", 0, 1);
						...
						if (func_239(&uLocal_761, "pap3bau", "PAP3_CONTACT", 8, 0, 0, 0))
						{
							...
							task_turn_ped_to_face_entity(Local_369, PLAYER::PLAYER_PED_ID(), -1);
							func_234(&iLocal_288);
							iLocal_276 = 2;
						}
					}
				}
				if ((is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_490, 15f, 15f, 2f, false, true, 0) && func_224(Local_369)) && get_script_task_status(Local_369, 993674639) == 1)
				{
		...
		case 2:
			...
			if ((!func_221() || func_240(PLAYER::PLAYER_PED_ID(), Local_369, 1) > 5f * 2f) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1071.164f, -783.0585f, 53.73021f, 1062.915f, -782.8473f, 59.3433f, 3f, 0, true, 0))
			{
				func_236();
...
bool func_378()
{
	if ((((((func_224(Local_332) && func_223(Local_332, PLAYER::PLAYER_PED_ID(), 55f, 1)) && is_entity_on_screen(Local_332)) && is_sphere_visible(get_world_position_of_entity_bone(Local_332, get_ped_bone_index(Local_332, 31086)), 0.1f)) && !is_entity_occluded(Local_332)) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1114.024f, -758.6504f, 54.94576f, 1054.396f, -758.6326f, 64.53705f, 47.5f, 0, true, 0)) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1046.05f, -754.8271f, 56.04185f, 1144.92f, -755.2141f, 59.98388f, 20.75f, 0, true, 0))
	{
		return true;
	}
	if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1051.438f, -791.6494f, 56.68583f, 1114.935f, -791.4409f, 66.16802f, 15.5f, 0, true, 0))
	{
		return true;
	}
	return false;
...
void func_379()
{
	...
	if (iLocal_410)
	{
		...
		while (iVar0 <= 3)
		{
			...
			{
				if (is_ped_in_combat(Local_295[iVar0 /*9*/], PLAYER::PLAYER_PED_ID()))
				{
					set_blocking_of_non_temporary_events(Local_295[iVar0 /*9*/], false);
					func_1(2);
					return;
				}
				else if (func_223(Local_295[iVar0 /*9*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					task_combat_ped(Local_295[iVar0 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
			}
			else
			{
	...
	switch (iLocal_276)
	{
		...
		case 1:
			...
			if (iLocal_410 == 1)
			{
				...
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_490, 20f, 20f, 2f, false, true, 0))
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
	...
	switch (iLocal_276)
	{
		...
		case 1:
			...
			else if (func_221())
			{
				...
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_490, 20f, 20f, 2f, false, true, 0) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1046.05f, -754.8271f, 56.04185f, 1144.92f, -755.2141f, 59.98388f, 20.75f, 0, true, 0))
				{
					func_297(0);
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
...
void func_387(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_391(player_id())) && !func_389(player_id(), 0)) && !func_388())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_391(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
void func_401(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_329(iParam0, 0, 0)) || func_329(iParam0, 1, 0)) || func_329(iParam0, 2, 0)) || func_321(iParam0) != 145) || func_421(iParam0)) || func_420(iParam0)) || func_406(iParam0)) || func_419(iParam0)) || !func_411(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_420(iParam0))
		{
		}
...
bool func_425(int iParam0, auto uParam1, auto uParam2)
{
	...
	if (func_428(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_427(*iParam0, *uParam1[38] - 1))
	{
...
void func_430(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_323(iParam0, iParam1))
				{
...
void func_443(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_326(iVar1 + 1));
			}
		}
...
void func_488(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2285, 4);
	}
	else
	{
