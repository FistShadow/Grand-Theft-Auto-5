...
void func_21(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((!is_ped_injured(player_ped_id()) && !func_26(player_id())) && !func_23(player_id(), 0)) && !func_22())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_26(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
void func_79(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_81() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_81() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_83(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_81() /*10375*/].f_7704.f_10, iParam0);
}
...
int func_109(int iParam0)
{
	...
	set_blip_scale(iVar0, func_110(network_is_game_in_progress(), 0.7f, 0.7f));
	return iVar0;
}
...
bool func_127(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_130(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(player_ped_id(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (get_game_timer() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), 1) || func_128(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
int func_135(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_110(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_187(player_ped_id(), *uParam0.f_3, 1) < 20f && func_166(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_166(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
bool func_244(auto uParam0, int iParam1)
{
	...
	if (!func_247(uParam0, iParam1))
	{
		...
		if ((is_ped_injured(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_186(*uParam0.f_3, 1) > 400f)
		{
...
bool func_312(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_187(player_ped_id(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
...
bool func_377(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_378(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_187(player_ped_id(), iParam0, 1) < 40f)
						{
