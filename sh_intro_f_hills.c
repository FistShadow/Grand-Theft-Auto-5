	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_45)
		{
			case 0:
				...
				{
					if ((is_new_load_scene_active() && is_new_load_scene_loaded()) || GAMEPLAY::GET_GAME_TIMER() - iLocal_53 > 9000)
					{
						clear_prints();
			...
			case 1:
				if (iLocal_47 == 0)
				{
					if (_0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4 && GAMEPLAY::GET_GAME_TIMER() - iLocal_51 >= iVar0 - 300)
					{
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_35(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_35(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
...
void func_129()
{
	...
	{
		if (func_132(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_138(player_id())) && !func_136(player_id(), 0)) && !func_135())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_138(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
bool func_145(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_152(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_151(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_168()
{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17223.f_23, iVar0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17223.f_23), iVar0);
		}
	}
	_0x0B40ED49D7D6FF84();
	_0x4D953DF78EBF8158();
