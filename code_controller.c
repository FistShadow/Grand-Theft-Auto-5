...
void main()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	iLocal_80 = _0x4A9923385BDB9DAD();
	iLocal_81 = _get_blip_info_id_iterator();
	...
	while (true)
	{
		...
		while (iVar0 < 235)
		{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() >= Global_101154.f_7303.f_236[iVar0])
				{
					switch (iVar0)
					{
						case 1:
						...
						case 81:
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_8706.f_25), 5);
							break;
...
void func_1()
{
	if (!is_bit_set(Global_101154.f_17264.f_382, 6))
	{
		func_2(-1067764575, 6, 2, 144, 1000, 5000, -1, 0, -1, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_382), 6);
	}
}

bool func_2(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	struct<10> Var0;
	struct<10> Var10;
	int iVar20;
...
bool func_3(struct<9> Param0, auto uParam1)
{
	if (Param0.f_8 == 0)
	{
		return false;
...
int func_7(struct<4> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, struct<4> Param7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	int iVar0;
	int iVar1;
...
struct<10> func_9(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, auto uParam9)
{
	struct<10> Var0;
...
void func_29(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_31() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_33(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_31() /*10375*/].f_7704.f_10, iParam0);
}
...
void func_55()
{
	...
	{
		if (func_57(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_80(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_85(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_85(vVar16.z)] = func_78(iParam1, vVar16.x, func_85(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_85(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
int func_87(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_90(int iParam0)
{
	...
	func_91(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_91(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_100(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_94(func_97(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_92(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_94(uVar1, Global_69309, 0);
				if (!is_bit_set(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_92(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_94(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
...
void func_101(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_91(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_80(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_91(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_156(int iParam0, int iParam1, int iParam2, int iParam3)
{
	Global_69311[1 /*14*/] = {func_88(iParam0, iParam1, iParam2)};
	if (is_bit_set(Global_69311[1 /*14*/].f_6, false) && !is_bit_set(Global_69311[1 /*14*/].f_6, 6))
	{
...
void func_158()
{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 19);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 20);
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 12);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 13);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 14);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 15);
	func_160(33, iVar0, 0);
	func_159(2);
}
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar3 == 0 && !is_bit_set(iParam1, true))
	{
		return;
	}
	iVar3 *= 3;
...
void func_163()
{
	...
	iVar0 = false;
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, false);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 16);
...
void func_165()
{
	...
	iVar0 = false;
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 17);
	GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 3);
...
{
	clear_bit(&(Global_101154.f_17264[iParam0 /*6*/]), false);
	clear_bit(&(Global_101154.f_17264[iParam0 /*6*/]), true);
	clear_bit(&(Global_101154.f_17264[iParam0 /*6*/]), 2);
}
...
void func_172()
{
	...
	{
		case 2:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 2);
			if (vdist2(func_175(player_id()), func_174(88, 0)) < 43681f)
			{
		...
		case 3:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 3);
			if (vdist2(func_175(player_id()), func_174(89, 0)) < 43681f)
			{
		...
		case 4:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 4);
			if (vdist2(func_175(player_id()), func_174(90, 0)) < 43681f)
			{
...
bool func_181(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
{
	if (is_bit_set(Global_88544[iParam0 /*17*/].f_10.f_1, 6))
	{
	...
	if (is_bit_set(Global_88544[iParam0 /*17*/].f_10.f_1, 7))
	{
		if (Global_87457 != 4 && Global_87457 != 5)
		{
			func_229(Global_88544[iParam0 /*17*/].f_5);
	...
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), false);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), true);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 2);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 3);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 6);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 7);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 8);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 9);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 10);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 11);
	clear_bit(&(Global_88544[iParam0 /*17*/].f_10.f_1), 12);
}
...
void func_235()
{
	remove_model_hide(-18.3539f, -1438.784f, 31.305f, 3f, joaat("v_ilev_frnkwarddr1"), false);
	remove_model_hide(-18.3594f, -1438.133f, 31.305f, 3f, joaat("v_ilev_frnkwarddr2"), false);
}
...
void func_236()
{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 3);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 4))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 4);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 5))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 5);
	}
}
...
void func_237()
{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), false);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, true))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), true);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 2))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 2);
	}
}
...
void func_240()
{
	...
	if (iVar0 != -1)
	{
		Global_101154.f_6378[iVar0 /*15*/].f_4 = GAMEPLAY::GET_GAME_TIMER() + 100000;
	}
...
bool func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	struct<15> Var0;
	int iVar15;
...
{
	set_scenario_group_enabled("LOST_BIKERS", iParam0);
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_8706.f_25), 2);
	}
	else
	{
		clear_bit(&(Global_101154.f_8706.f_25), 2);
	}
}

void func_250(int iParam0)
{
	func_230(109, iParam0, 0);
}

void func_251(int iParam0)
{
	func_230(97, iParam0, 0);
}
...
void func_255()
{
	Global_36263[12] = GAMEPLAY::GET_GAME_TIMER() + 120000;
}

void func_256()
{
	Global_36263[15] = GAMEPLAY::GET_GAME_TIMER() + 120000;
}

void func_257()
{
	Global_36263[14] = GAMEPLAY::GET_GAME_TIMER() + 120000;
}

void func_258()
{
	Global_36263[17] = GAMEPLAY::GET_GAME_TIMER() + 120000;
}
...
void func_270()
{
	...
	clear_area(689.6588f, -962.4214f, 22.4975f, 25f, 1, 0, 0, false);
	if (!func_245(88))
	{
		if (!func_234(88))
		{
...
void func_276(int iParam0)
{
	...
	if (is_bit_set(Global_25433[iVar0 /*23*/].f_11, 9))
	{
		return;
	}
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 9);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_192() == 0)
		{
			...
			func_280(func_281(iParam0), iVar0, -1, 1);
		}
	}
	else
	{
...
void func_280(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_95(iParam2)];
	if (iVar0 != 0)
	{
...
int func_286(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_192() == 0)
		{
			return is_bit_set(func_94(func_281(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_289(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iParam0 == 1)
		{
			...
			iVar5 = 0;
			vVar0.z += 1.5f;
			iVar3 = test_vertical_probe_against_all_water(vVar0, 1, &fVar4);
			if (iVar3 == 1)
			{
				iVar5 = 1;
			}
			else if (is_entity_in_water(PLAYER::PLAYER_PED_ID()))
			{
				iVar5 = 1;
			}
			if (iVar5 == 1)
...
void func_290(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (iParam0 == 1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91278.f_20), 15);
		...
		else if (is_bit_set(Global_91278.f_20, 15))
		{
			iVar0 = false;
			if (is_entity_attached(PLAYER::PLAYER_PED_ID()))
			{
				iVar1 = get_entity_attached_to(PLAYER::PLAYER_PED_ID());
			...
			clear_bit(&(Global_91278.f_20), 15);
		}
	}
}
...
void func_291(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		if (!is_bit_set(Global_91278.f_20, 19))
		{
			...
			set_entity_only_damaged_by_player(PLAYER::PLAYER_PED_ID(), true);
			...
			vVar0 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
			clear_area(vVar0, 100f, 1, 0, 0, false);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_91278.f_20), 19);
		}
	}
	else if (is_bit_set(Global_91278.f_20, 19))
	{
		func_292();
		clear_bit(&(Global_91278.f_20), 19);
	}
}
...
void func_292()
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			set_ped_gravity(PLAYER::PLAYER_PED_ID(), 1);
		}
...
void func_295(char* sParam0, int iParam1)
{
	...
	{
		if (func_299(sParam0) && !is_help_message_fading_out())
		{
			clear_help(0);
		}
	}
...
bool func_304(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<15> Var0;
	int iVar15;
	...
	if (Global_101154.f_6378.f_136 < 9)
	{
		...
		Var0.f_1 = iParam12;
		iVar15 = 0;
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar15, iParam5);
		Var0.f_2 = iVar15;
		Var0.f_6 = iParam6;
		Var0.f_14 = iParam7;
		Var0.f_7 = iParam10;
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Var0.f_1), 13);
		clear_bit(&(Var0.f_1), true);
		if (iParam4 == 0)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Var0.f_1), 10);
...
bool func_307(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<15> Var0;
	int iVar15;
...
auto func_312(int iParam0)
{
	return Global_101154.f_1.f_73[iParam0 /*3*/];
}

auto func_313(int iParam0)
{
...
void func_318()
{
	if (does_blip_exist(Global_68319.f_208[14]))
	{
		set_blip_flashes(Global_68319.f_208[14], 1);
		set_blip_flash_timer(Global_68319.f_208[14], 10000);
	}
...
void func_321(int iParam0, int iParam1)
{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1.f_116), iParam0);
	switch (iParam0)
	{
		case 10:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1.f_119), 14);
			break;
		
		case 13:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1.f_119), 16);
			break;
		
		case 12:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1.f_119), 15);
			break;
		
		case 11:
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_1.f_119), 17);
			break;
	}
	if (!iParam1)
	{
		...
		_add_text_component_item_string(func_323(iParam0));
...
void func_334()
{
	...
	if (!func_11(0))
	{
		stat_get_float(joaat("sp0_dist_running"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1583[0] = uVar1;
		stat_get_int(joaat("sp0_unarmed_hits"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1587[0] = iVar0;
		stat_get_int(joaat("sp0_number_near_miss"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1591[0] = iVar0;
		stat_get_float(joaat("sp0_dist_walk_st"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1595[0] = uVar1;
		stat_get_int(joaat("sp0_kills_stealth"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1599[0] = iVar0;
		stat_get_int(joaat("sp0_hits_mission"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1603[0] = iVar0;
		stat_get_int(joaat("sp0_hits_peds_vehicles"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1607[0] = iVar0 - Global_101154.f_1826.f_539.f_1603[0];
		stat_get_float(joaat("sp1_dist_running"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1583[1] = uVar1;
		stat_get_int(joaat("sp1_unarmed_hits"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1587[1] = iVar0;
		stat_get_int(joaat("sp1_number_near_miss"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1591[1] = iVar0;
		stat_get_float(joaat("sp1_dist_walk_st"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1595[1] = uVar1;
		stat_get_int(joaat("sp1_kills_stealth"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1599[1] = iVar0;
		stat_get_int(joaat("sp1_hits_mission"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1603[1] = iVar0;
		stat_get_int(joaat("sp0_hits_peds_vehicles"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1607[1] = iVar0 - Global_101154.f_1826.f_539.f_1603[1];
		stat_get_float(joaat("sp2_dist_running"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1583[2] = uVar1;
		stat_get_int(joaat("sp2_unarmed_hits"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1587[2] = iVar0;
		stat_get_int(joaat("sp2_number_near_miss"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1591[2] = iVar0;
		stat_get_float(joaat("sp2_dist_walk_st"), &uVar1, -1);
		Global_101154.f_1826.f_539.f_1595[2] = uVar1;
		stat_get_int(joaat("sp2_kills_stealth"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1599[2] = iVar0;
		stat_get_int(joaat("sp2_hits_mission"), &iVar0, -1);
		Global_101154.f_1826.f_539.f_1603[2] = iVar0;
		stat_get_int(joaat("sp2_hits_peds_vehicles"), &iVar0, -1);
...
void func_335(int iParam0)
{
	...
	if (!Global_101154.f_25089.f_232 && func_70(53))
	{
		...
		stat_set_int(joaat("sp0_money_total_spent"), false, 1);
		stat_set_int(joaat("sp1_money_total_spent"), false, 1);
		stat_set_int(joaat("sp2_money_total_spent"), false, 1);
	...
	if (!func_342() && func_17(iParam0))
	{
		if (!func_341(iParam0) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				clear_area_of_projectiles(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 5f, 0);
			}
			return true;
		}
	}
...
void func_346()
{
	...
	{
		iVar0 = round(IntToFloat(func_344(0)) * 0.8f);
		if (iVar0 > 5000)
		{
			iVar0 = 5000;
		}
...
void func_348()
{
	...
	if (func_260(136))
	{
		func_26(0, 1, 32, round(IntToFloat(iVar0) + IntToFloat(iVar2) / 2f), 0);
		func_26(1, 1, 32, round(IntToFloat(iVar1) + IntToFloat(iVar2) / 2f), 0);
	}
...
void func_353(int iParam0, int iParam1)
{
	...
	func_354(Global_36852[uVar1 /*12*/].f_3, iParam0, 0, 0, iParam1);
	iVar3 = 0;
	while (iVar3 < iVar2)
	{
		...
		{
			func_354(Global_40177[iParam0 /*46*/].f_3[iVar3], iParam0, 0, 0, iParam1);
		}
		iVar3++;
	}
	if (Global_40177[iParam0 /*46*/].f_31 == Global_40177[iParam0 /*46*/].f_30)
...
void func_354(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iParam2)
	{
		...
		iVar2 = uVar20;
		Var3 = {func_359(Global_36852[uVar20 /*12*/].f_1)};
	...
	else
	{
		...
		{
			Var3 = {func_359(Global_36852[uVar26 /*12*/].f_1)};
		}
	}
	if (!iParam4)
	{
...
void func_355(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	int iVar0;
	int iVar1;
	char[64] cVar2;
	...
	iVar0 = func_54();
	iVar1 = false;
	StringCopy(&cVar2, func_358(iParam1, &iVar1), 64);
	if (iVar0 == iParam0)
	{
		switch (iParam2)
		{
		...
		if (iVar1)
		{
			func_356(_set_notification_message(&cVar2, &cVar2, 0, 2, _get_label_text(func_357(iParam1)), 0));
		}
		else
		{
			func_356(_set_notification_message("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _get_label_text(func_357(iParam1)), 0));
		}
		switch (Global_14413)
		{
			case 0:
...
bool func_360(auto uParam0, auto uParam1)
{
...
void func_377(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_390(iParam1, iParam0, &iVar0))
	{
		...
		func_378(iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_16793.f_175[iVar0 /*19*/].f_18), true);
		Global_87346++;
	}
}
...
{
	*iParam0.f_1 = func_381(is_bit_set(*iParam0, 4)) - fParam1;
...
bool func_390(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
void func_391()
{
	...
	{
		set_blip_flashes(Global_25433[iVar0 /*23*/].f_19, 1);
		set_blip_flash_timer(Global_25433[iVar0 /*23*/].f_19, 10000);
	}
}
...
bool func_393(int iParam0)
{
	...
	iVar1 = is_bit_set(Global_25433[iVar0 /*23*/].f_11, false);
	iVar2 = is_bit_set(Global_25433[iVar0 /*23*/].f_11, 15);
	if (iVar1 && iVar2)
	{
		return true;
	}
...
void func_394()
{
	...
	iVar0 = get_first_blip_info_id(66);
	if (does_blip_exist(iVar0))
	{
		set_blip_flashes(iVar0, 1);
		set_blip_flash_timer(iVar0, 10000);
	}
}
...
void func_395()
{
	...
	while (iVar0 <= 262)
	{
		if ((func_396(iVar0) && !is_radar_hidden()) && !is_frontend_fading())
		{
			set_blip_flashes(Global_25433[iVar0 /*23*/].f_19, 1);
			set_blip_flash_timer(Global_25433[iVar0 /*23*/].f_19, 10000);
		}
...
void func_398(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
bool func_407(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar5 = "NULL";
	sVar6 = "NULL";
	if (func_408(iParam0, sParam2, iParam3, iVar0, sVar1, sVar3, iVar2, iParam4, iParam5, iParam6, iParam8, iParam9, iParam10, iVar4, sVar5, sVar6, iParam1) == 1)
	{
		if (iParam8 == 1)
		{
			Global_2990 = iParam7;
...
bool func_408(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_14572)
	{
		if (Global_14413.f_1 == 6)
		{
			...
			func_409(1);
			func_412(Global_14394, "DISPLAY_VIEW", 1f, to_float(Global_14393), -1082130432, -1082130432, -1082130432);
		}
	}
	return true;
}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (Global_2443081)
							{
								if (iVar1 == 14)
								{
									func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16775), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2852[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16780), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_69489)
								{
									...
									func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14413)
									...
									func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar5), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2290[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar8), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_410(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(false), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2852[iVar0] = 1;
						}
					}
...
void func_410(int iParam0, char* sParam1, Vector3 fParam2, Vector3 fParam3, Vector3 fParam4, Vector3 fParam5, Vector3 fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_412(int iParam0, char* sParam1, Vector3 fParam2, Vector3 fParam3, Vector3 fParam4, Vector3 fParam5, Vector3 fParam6)
{
	_push_scaleform_movie_function(iParam0, sParam1);
	_push_scaleform_movie_function_parameter_int(round(fParam2));
	if (fParam3 != -1f)
...
bool func_417(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_426(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_5919[iParam0]), true);
	}
	else
	{
		clear_bit(&(Global_101154.f_5919[iParam0]), true);
	}
	if (Global_86649[iParam0 /*10*/].f_7 != 263)
	{
		func_275(Global_86649[iParam0 /*10*/].f_7, is_bit_set(Global_101154.f_5919[iParam0], true), 0);
	}
}
...
void func_427(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_5919[iParam0]), false);
	}
	else
	{
...
bool func_434(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_435(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_436(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_437(iParam0) && _get_number_of_instances_of_streamed_script(Global_82399[26 /*34*/].f_6) == 0)
			{
				Global_101154.f_5951[iParam0] = 1;
				_set_door_acceleration_limit(*uParam1.f_5, Global_101154.f_5951[iParam0], 1, 1);
			}
...
auto func_444(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_445(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
	...
	switch (iParam0)
	{
		...
		case 1:
			if (func_452(1))
			{
				...
				set_save_house(Global_86649[0 /*10*/].f_8, func_452(0), 0);
			}
			else if (func_452(0))
			{
				set_save_house(Global_86649[0 /*10*/].f_8, true, 1);
				set_save_house(Global_86649[1 /*10*/].f_8, func_452(1), 0);
			}
			break;
		...
		case 4:
			if (func_452(3))
			{
				...
				set_save_house(Global_86649[4 /*10*/].f_8, func_452(4), 0);
				set_save_house(Global_86649[2 /*10*/].f_8, func_452(2), 0);
			}
			else if (func_452(4))
			{
				set_save_house(Global_86649[4 /*10*/].f_8, true, 1);
				set_save_house(Global_86649[3 /*10*/].f_8, func_452(3), 0);
				set_save_house(Global_86649[2 /*10*/].f_8, func_452(2), 0);
			}
			else if (func_452(2))
			{
		...
		case 6:
			if (func_452(6))
			{
				...
				set_save_house(Global_86649[5 /*10*/].f_8, func_452(5), 0);
			}
			else if (func_452(5))
			{
				set_save_house(Global_86649[5 /*10*/].f_8, true, 1);
				set_save_house(Global_86649[6 /*10*/].f_8, func_452(6), 0);
			}
			break;
	}
}
...
void func_455(int iParam0)
{
	...
	func_230(Global_86649[iParam0 /*10*/].f_7, iVar0, 0);
}
...
void func_468(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_17(iParam0))
	{
		...
		if (iParam2)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, iVar2);
		}
		else
		{
			clear_bit(&iVar0, iVar2);
		}
...
void func_471(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iVar1)
	{
		case 0:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_0"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_0"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_0"), iParam3, 1);
					break;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_1"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_1"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_1"), iParam3, 1);
					break;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_2"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_2"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_2"), iParam3, 1);
					break;
			}
			break;
		...
		case 3:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_3"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_3"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_3"), iParam3, 1);
					break;
			}
			break;
		...
		case 4:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_4"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_4"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_4"), iParam3, 1);
					break;
			}
			break;
		...
		case 5:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_5"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_5"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_5"), iParam3, 1);
					break;
			}
			break;
		...
		case 6:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_addon_unlock_6"), iParam3, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_addon_unlock_6"), iParam3, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_addon_unlock_6"), iParam3, 1);
					break;
			}
			break;
...
auto func_476(int iParam0, int iParam1, int iParam2)
{
	auto uVar0;
	int iVar1;
	int iVar2;
...
int func_478(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
void func_479(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iVar1)
	{
		case 0:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_unlock_0"), iParam2, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_unlock_0"), iParam2, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_unlock_0"), iParam2, 1);
					break;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_unlock_1"), iParam2, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_unlock_1"), iParam2, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_unlock_1"), iParam2, 1);
					break;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					stat_set_int(joaat("sp0_weap_unlock_2"), iParam2, 1);
					break;
				
				case 1:
					stat_set_int(joaat("sp1_weap_unlock_2"), iParam2, 1);
					break;
				
				case 2:
					stat_set_int(joaat("sp2_weap_unlock_2"), iParam2, 1);
					break;
			}
			break;
...
auto func_484(int iParam0, int iParam1)
{
	auto uVar0;
	int iVar1;
	int iVar2;
...
void func_486(int iParam0, int iParam1)
{
	...
	if (iParam1 != is_bit_set(Global_25433[iVar0 /*23*/].f_11, 13))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 18);
	}
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 13);
	}
	else
	{
		clear_bit(&(Global_25433[iVar0 /*23*/].f_11), 13);
	}
}
...
void func_489(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam1 == -1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (iParam0 == 0)
			{
				...
				{
					iVar1 = iVar0 * 3;
					iVar2 = func_496(get_hash_key(sParam2));
					if (iVar2 != -1)
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar1 + iVar2 / 32]), iVar2 % 32);
					}
					iVar0++;
				}
			}
			else
			{
				...
				{
					iVar4 = iVar3 * 3;
					iVar5 = func_496(get_hash_key(sParam2));
					if (iVar5 != -1)
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar4 + iVar5 / 32]), iVar5 % 32);
					}
				}
				iVar6 = func_494(iParam0, iParam3, iParam4, iParam5);
				if (iVar6 > 0)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_2022[iVar6 / 32]), iVar6 % 32);
				}
			}
		}
		return;
	...
	if (iParam0 == 0)
	{
		...
		while (iVar7 < 175)
		{
			if (func_490(iParam1))
			{
				...
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar8]), iParam1 % 32);
				}
				else
				{
	...
	else if (func_490(iParam1))
	{
		...
		if (iVar9 != -1)
		{
			...
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar10]), iParam1 % 32);
			}
			else
			{
...
int func_491(int iParam0, int iParam1)
{
	...
	iVar1 = iParam0;
	return is_bit_set(iVar0, func_481(iVar1));
}

auto func_492(auto uParam0, int iParam1)
{
	auto uVar0;
...
void func_501(int iParam0, int iParam1)
{
	...
	if (iVar0 < 31)
	{
		...
		{
			clear_bit(&(Global_101154.f_29520), iVar0);
		}
	}
	else
	{
		...
		{
			clear_bit(&(Global_101154.f_29520.f_1), iVar0);
		}
	}
}
...
void func_514()
{
	...
	func_276(95);
	func_230(95, 1, 0);
	_0x6D6840CEE8845831("launcher_stunts");
	func_272(95);
...
{
	func_485(0, 8, 1);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), false);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), true);
	if (vdist2(func_175(player_id()), func_174(87, 0)) < 43681f)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_3), true);
	}
	if (vdist2(func_175(player_id()), func_174(86, 0)) < 43681f)
	{
...
void func_526()
{
	...
	func_230(137, 1, 0);
	iVar0 = 125;
	if (is_bit_set(Global_101154.f_17657.f_1, 125 - iVar0))
	{
		func_527(125, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 126 - iVar0))
	{
		func_527(126, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 127 - iVar0))
	{
		func_527(127, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 128 - iVar0))
	{
		func_527(128, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 129 - iVar0))
	{
		func_527(129, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 130 - iVar0))
	{
		func_527(130, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 131 - iVar0))
	{
		func_527(131, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 132 - iVar0))
	{
		func_527(132, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 133 - iVar0))
	{
		func_527(133, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 134 - iVar0))
	{
		func_527(134, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 135 - iVar0))
	{
		func_527(135, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 136 - iVar0))
	{
		func_527(136, 1);
	}
	if (is_bit_set(Global_101154.f_17657.f_1, 137 - iVar0))
	{
		func_527(137, 1);
	}
	func_485(0, 0, 1);
