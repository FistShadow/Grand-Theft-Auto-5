				...
				if (GAMEPLAY::GET_GAME_TIMER() >= Global_101154.f_7303.f_236[iVar0])
				{
					switch (iVar0)
					{
						...
						case 81:
							...
							GAMEPLAY::SET_BIT(&(Global_101154.f_8706.pSasquatchFlags), 5);
							break;
...
void func_1()
{
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264.f_382, 6))
	{
		...
		GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_382), 6);
	}
}
...
void func_172()
{
	...
	{
		case 2:
			GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 2);
		...
		case 3:
			GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 3);
		...
		case 4:
			GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), 4);
...
void func_236()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 3);
	}
	else if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_6378.f_923, 4))
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 4);
	}
	else if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_6378.f_923, 5))
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 5);
	}
}
...
void func_237()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), false);
	}
	else if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_6378.f_923, true))
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), true);
	}
	else if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_6378.f_923, 2))
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_6378.f_923), 2);
	}
}
...
void func_249(int iParam0)
{
	...
	if (iParam0)
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_8706.pSasquatchFlags), 2);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_8706.pSasquatchFlags), 2);
	}
}
...
void func_276(int iParam0)
{
	...
	GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 9);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_290(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (iParam0 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_91278.f_20), 15);
...
void func_291(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_91278.f_20, 19))
		{
			...
			GAMEPLAY::SET_BIT(&(Global_91278.f_20), 19);
		}
	}
...
void func_377(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_390(iParam1, iParam0, &iVar0))
	{
		...
		func_378(iVar0, 0);
		GAMEPLAY::SET_BIT(&(Global_101154.f_16793.f_175[iVar0 /*19*/].f_18), true);
		Global_87346++;
	}
}
...
void func_426(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_5919[iParam0]), true);
	}
	else
	{
...
void func_427(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_5919[iParam0]), false);
	}
	else
	{
...
void func_486(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 13);
	}
	else
	{
...
void func_489(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (iParam0 == 0)
			{
				...
				while (iVar0 < 175)
				{
					...
					if (iVar2 != -1)
					{
						GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar1 + iVar2 / 32]), iVar2 % 32);
					}
					iVar0++;
				}
			}
			else
			{
				...
				if (iVar3 != -1)
				{
					...
					if (iVar5 != -1)
					{
						GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar4 + iVar5 / 32]), iVar5 % 32);
					}
				}
				iVar6 = func_494(iParam0, iParam3, iParam4, iParam5);
				if (iVar6 > 0)
				{
					GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_2022[iVar6 / 32]), iVar6 % 32);
				}
			}
		}
		return;
	...
	if (iParam0 == 0)
	{
		...
		while (iVar7 < 175)
		{
			if (func_490(iParam1))
			{
				...
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
					GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar8]), iParam1 % 32);
				}
				else
				{
	...
	else if (func_490(iParam1))
	{
		...
		if (iVar9 != -1)
		{
			...
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				GAMEPLAY::SET_BIT(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar10]), iParam1 % 32);
			}
			else
			{
...
{
	func_485(0, 8, 1);
	GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), false);
