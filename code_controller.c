...
void main()
{
	...
	while (true)
	{
		...
		while (iVar0 < 235)
		{
			...
			{
				if (get_game_timer() >= Global_101154.f_7303.f_236[iVar0])
				{
					switch (iVar0)
					{
						case 1:
						...
						case 81:
							...
							set_bit(&(Global_101154.f_8706.f_25), 5);
							break;
...
void func_1()
{
	if (!is_bit_set(Global_101154.f_17264.f_382, 6))
	{
		...
		set_bit(&(Global_101154.f_17264.f_382), 6);
	}
}
...
void func_55()
{
	...
	{
		if (func_57(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
void func_172()
{
	...
	{
		case 2:
			set_bit(&(Global_101154.f_29504.f_1), 2);
		...
		case 3:
			set_bit(&(Global_101154.f_29504.f_1), 3);
		...
		case 4:
			set_bit(&(Global_101154.f_29504.f_1), 4);
...
void func_236()
{
	...
	{
		set_bit(&(Global_101154.f_6378.f_923), 3);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 4))
	{
		set_bit(&(Global_101154.f_6378.f_923), 4);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 5))
	{
		set_bit(&(Global_101154.f_6378.f_923), 5);
	}
}
...
void func_237()
{
	...
	{
		set_bit(&(Global_101154.f_6378.f_923), false);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, true))
	{
		set_bit(&(Global_101154.f_6378.f_923), true);
	}
	else if (!is_bit_set(Global_101154.f_6378.f_923, 2))
	{
		set_bit(&(Global_101154.f_6378.f_923), 2);
	}
}
...
void func_240()
{
	...
	if (iVar0 != -1)
	{
		Global_101154.f_6378[iVar0 /*15*/].f_4 = get_game_timer() + 100000;
	}
...
void func_249(int iParam0)
{
	...
	if (iParam0)
	{
		set_bit(&(Global_101154.f_8706.f_25), 2);
	}
	else
	{
...
void func_255()
{
	Global_36263[12] = get_game_timer() + 120000;
}

void func_256()
{
	Global_36263[15] = get_game_timer() + 120000;
}

void func_257()
{
	Global_36263[14] = get_game_timer() + 120000;
}

void func_258()
{
	Global_36263[17] = get_game_timer() + 120000;
}
...
void func_276(int iParam0)
{
	...
	set_bit(&(Global_25433[iVar0 /*23*/].f_11), 9);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_289(int iParam0)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		if (iParam0 == 1)
		{
			...
			else if (is_entity_in_water(player_ped_id()))
			{
				iVar5 = 1;
			}
			if (iVar5 == 1)
...
void func_290(int iParam0)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		else if (is_bit_set(Global_91278.f_20, 15))
		{
			...
			if (is_entity_attached(player_ped_id()))
			{
				iVar1 = get_entity_attached_to(player_ped_id());
				if (does_entity_exist(iVar1))
				{
					if (!is_this_model_a_boat(get_entity_model(iVar1)))
					{
...
void func_321(int iParam0, int iParam1)
{
	...
	set_bit(&(Global_101154.f_1.f_116), iParam0);
	switch (iParam0)
	{
		case 10:
			set_bit(&(Global_101154.f_1.f_119), 14);
			break;
		
		case 13:
			set_bit(&(Global_101154.f_1.f_119), 16);
			break;
		
		case 12:
			set_bit(&(Global_101154.f_1.f_119), 15);
			break;
		
		case 11:
			set_bit(&(Global_101154.f_1.f_119), 17);
			break;
	}
	if (!iParam1)
	{
...
bool func_340(int iParam0, int iParam1)
{
	...
	{
		if (!func_341(iParam0) || network_is_game_in_progress())
		{
			...
			if (!is_ped_injured(player_ped_id()))
			{
				...
				clear_area_of_projectiles(get_entity_coords(player_ped_id(), 1), 5f, 0);
			}
			return true;
		}
	}
...
void func_377(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_390(iParam1, iParam0, &iVar0))
	{
		...
		func_378(iVar0, 0);
		set_bit(&(Global_101154.f_16793.f_175[iVar0 /*19*/].f_18), true);
		Global_87346++;
	}
}
...
void func_426(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		set_bit(&(Global_101154.f_5919[iParam0]), true);
	}
	else
	{
...
bool func_434(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				iVar0 = get_entity_model(func_435(get_vehicle_ped_is_in(player_ped_id(), 1)));
				switch (iVar0)
				{
...
void func_486(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		set_bit(&(Global_25433[iVar0 /*23*/].f_11), 13);
	}
	else
	{
...
void func_489(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
		...
		if (network_is_game_in_progress())
		{
			if (iParam0 == 0)
			{
				...
				while (iVar0 < 175)
				{
					...
					if (iVar2 != -1)
					{
						set_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar1 + iVar2 / 32]), iVar2 % 32);
					}
					iVar0++;
				}
			}
			else
			{
				...
				if (iVar3 != -1)
				{
					...
					if (iVar5 != -1)
					{
						set_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_1496[iVar4 + iVar5 / 32]), iVar5 % 32);
					}
				}
				iVar6 = func_494(iParam0, iParam3, iParam4, iParam5);
				if (iVar6 > 0)
				{
					set_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_2022[iVar6 / 32]), iVar6 % 32);
				}
			}
		}
		return;
	...
	if (iParam0 == 0)
	{
		...
		while (iVar7 < 175)
		{
			if (func_490(iParam1))
			{
				...
				if (network_is_game_in_progress())
				{
					set_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar8]), iParam1 % 32);
				}
				else
				{
	...
	else if (func_490(iParam1))
	{
		...
		if (iVar9 != -1)
		{
			...
			if (network_is_game_in_progress())
			{
				set_bit(&(Global_2097152[func_31() /*10375*/].f_7704.f_45[iVar10]), iParam1 % 32);
			}
			else
			{
...
void func_501(int iParam0, int iParam1)
{
	...
	if (iVar0 < 31)
	{
		if (iParam1)
		{
			set_bit(&(Global_101154.f_29520), iVar0);
		}
		else
		{
	...
	else
	{
		...
		if (iParam1)
		{
			set_bit(&(Global_101154.f_29520.f_1), iVar0);
		}
		else
		{
