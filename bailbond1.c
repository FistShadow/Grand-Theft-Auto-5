...
auto func_143()
{
	...
	func_151(&uVar0, TIME::GET_CLOCK_HOURS());
				...
				if (!iLocal_397)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_111(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_103(Local_112.f_9, vLocal_628, 30f))
									{
	...
	if (func_22(Local_112.f_9))
	{
		...
		if (!is_ped_performing_stealth_kill(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 31:
					if (func_111(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_103(Local_112.f_9, vLocal_628, 25f))
					{
						...
						{
							if (func_111(iLocal_411, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_111(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_103(Local_112.f_9, vLocal_628, 20f))
							{
	...
	if (func_454(uParam0))
	{
		...
		if (func_453(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_446(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(get_this_script_name(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				...
				{
					if ((!iParam4 || func_164(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
