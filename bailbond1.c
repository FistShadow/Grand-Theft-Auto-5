		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_22(Local_336))
				{
					...
					{
						if (func_103(Local_336, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_173(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_170(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
			...
			switch (Local_112.f_10)
			{
				...
				case 23:
					if (func_348(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_347())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_112.f_9) && !is_ped_being_stunned(Local_112.f_9, 0)) && !is_ped_being_jacked(Local_112.f_9)) && !func_63(Local_112.f_9, -828834893))
						{
							task_look_at_entity(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_344(Local_112.f_19, 10) && func_103(Local_112.f_9, vLocal_628, 50f)) || !func_111(iLocal_429, 2000))
							{
								...
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !is_player_targetting_entity(player_id(), Local_112.f_9)) && !func_347()) || is_entity_in_water(Local_112.f_9))
								{
									task_turn_ped_to_face_entity(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
				...
				case 24:
					if (func_348(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_347())
					{
						if (!func_63(Local_112.f_9, -1519143300))
						{
							...
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || is_player_targetting_entity(player_id(), Local_112.f_9)) || func_347())
								{
									Local_112.f_10 = 23;
								}
							}
...
void func_379(int iParam0, int iParam1, Vector3 vParam2)
{
	...
	fVar2 = 1600f;
	fVar3 = 4900f;
	fVar4 = vdist2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam2);
...
bool func_397(int iParam0)
{
	if (func_22(Local_336))
	{
		...
		if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(Local_336, 1), 15f))
		{
			return true;
		}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				...
				{
					if ((!iParam4 || func_164(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
...
void func_465()
{
	...
	if (func_22(Local_112.f_9))
	{
		...
		{
			Local_285 = create_object(joaat("prop_phone_ing"), ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0), 1, true, false);
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_487()) || Global_100201) || Global_25122) || func_493()) || func_87(8, -1)) || func_492()) || func_491()) || func_485()) || func_486()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_487()) || Global_100201) || Global_25122) || func_493()) || func_87(8, -1)) || func_485()) || func_492()) || func_491()) || func_486()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_487()) || Global_100201) || Global_25122) || func_493()) || func_87(8, -1)) || func_492()) || func_491()) || func_486()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_487()) || Global_25122) || func_493()) || func_87(8, -1)) || func_491()) || func_485()) || func_486()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_487()) || func_491()) || Global_100201) || Global_25122) || func_493()) || Global_36839) || func_87(8, -1)) || func_485()) || func_490()) || func_486()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_487()) || Global_100201) || Global_25122) || func_493()) || func_87(8, -1)) || func_485()) || func_490()) || func_492()) || func_491()) || func_486())
						{
							return false;
						}
						break;
