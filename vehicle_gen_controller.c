...
auto func_46()
{
	...
	func_54(&uVar0, TIME::GET_CLOCK_HOURS());
			...
			case 4:
				...
				else
				{
					...
					*uParam1.f_6 = 27;
					...
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(&sVar6, "ORANGE") && iVar10 == 1)
						{
							*uParam1.f_5 = uVar11;
							*uParam1.f_6 = uVar12;
							iVar5 = -99;
			...
			case 5:
				...
				else
				{
					...
					*uParam1.f_6 = 0;
					...
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(&sVar14, "LIME_GREEN") && iVar18 == 1)
						{
							*uParam1.f_5 = uVar19;
							*uParam1.f_6 = uVar20;
							iVar13 = -99;
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar12) && is_vehicle_driveable(iVar12, 0))
					{
						if (_is_vehicle_engine_on(iVar12) || is_ped_on_any_bike(PLAYER::PLAYER_PED_ID()))
						{
							...
							{
								if ((((_0x4F8A26A890FD62FB(0, 71) != 0f || is_control_just_pressed(0, 71)) || CONTROLS::IS_CONTROL_PRESSED(0, 71)) || is_disabled_control_just_pressed(0, 71)) || is_disabled_control_pressed(0, 71))
								{
									iVar193 = 1;
								}
								if ((((_0x4F8A26A890FD62FB(0, 72) != 0f || is_control_just_pressed(0, 72)) || CONTROLS::IS_CONTROL_PRESSED(0, 72)) || is_disabled_control_just_pressed(0, 72)) || is_disabled_control_pressed(0, 72))
								{
									iVar193 = 1;
								}
							}
...
bool func_175(int iParam0, struct<4> Param1, auto uParam2, auto uParam3, Vector3 vParam4, float fParam5, struct<4> Param6, int iParam7, float fParam8)
{
	...
	if (iLocal_1033 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1037) && is_vehicle_driveable(iLocal_1037, 0))
		{
			...
			{
				ENTITY::SET_ENTITY_ROTATION(iLocal_1037, func_176(0f - vVar3.x, 0f - vVar3.y, vVar3.z + 180f, 0f - vVar9.x, 0f - vVar9.y, vVar9.z + 180f, fVar16, fVar17, fVar18), 2, 1);
			}
			else
			{
				...
				ENTITY::SET_ENTITY_ROTATION(iLocal_1037, func_176(vVar3, vVar9, fVar16, fVar17, fVar18), 2, 1);
			}
...
bool func_192(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		if (Global_90747[iVar0 /*98*/] == *uParam0.f_66 && GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_90747[iVar0 /*98*/].f_27), uParam0.f_1))
		{
...
void func_193(int iParam0, char* sParam1)
{
	...
	if (!Global_101154.f_18807.f_5596[iParam0])
	{
		...
		{
			case 0:
				func_194("IMPOUND_HELPM", sParam1, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 6000), -1, 10000, 1, 0, 0, 0);
				break;
			
			case 1:
				func_194("IMPOUND_HELPF", sParam1, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 6000), -1, 10000, 2, 0, 0, 0);
				break;
			
			case 2:
				func_194("IMPOUND_HELPT", sParam1, 2, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 6000), -1, 10000, 4, 0, 0, 0);
				break;
		}
...
void func_276()
{
	...
	if (_get_number_of_instances_of_streamed_script(joaat("startup_positioning")) == 0)
	{
		if (Global_101154.f_18807.f_5588)
		{
			...
			else
			{
				...
				if (((Global_101154.f_18807.f_5590 != func_371() && Global_90747[Global_101154.f_18807.f_5590 /*98*/] == Global_101154.f_18807.f_5510.f_66) && GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_90747[Global_101154.f_18807.f_5590 /*98*/].f_27), &(Global_101154.f_18807.f_5510.f_1))) && !is_player_switch_in_progress())
				{
	...
	switch (iLocal_667)
	{
		...
		case 3:
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 431.4f, -997.33f, 24.76f, 1) > 20f && !func_278())
			{
				func_30(iLocal_671, func_371());
				iLocal_667 = 99;
			}
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 431.4f, -997.33f, 24.76f, 1) > 100f)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_671))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_671, 0))
					{
						if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_671, 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_671, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 100f)
						{
		...
		if (!GAMEPLAY::IS_BIT_SET(*iParam0, 6))
		{
			if (func_26(13) && func_14(func_16()))
			{
				...
				*iParam0.f_6 = {func_329(iVar0)};
				...
				{
					func_3(1);
					Var1 = {func_328("til_P_", "Exec_U", "xer_Scene", "B_Mi")}; // Exec_Util_P_B_Mixer_Scene
...
void func_299(int iParam0)
{
	...
	Var0 = {func_328("til_P_", "Exec_U", "xer_Scene", "B_Mi")}; // Exec_Util_P_B_Mixer_Scene
...
void func_300(int iParam0)
{
	...
	iVar3 = joaat_cyclist_or_dune(iVar1);
	if (iVar2 != 0)
	{
...
int joaat_cyclist_or_dune(int iParam0)
{
	switch (iParam0)
	{
		case 17:
...
void func_312(auto uParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3)
{
	...
	iVar1 = joaat_cyclist_or_dune(49);
...
void func_314(auto uParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	...
	iVar1 = joaat_cyclist_or_dune(17);
	if (STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1))
	{
...
void func_332()
{
	...
	while (iVar0 < iLocal_866)
	{
		...
		if (func_57(&Local_674, iVar1))
		{
			...
			{
				fLocal_941[iVar1] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_695.f_55, 0);
			}
			else
			{
				fLocal_941[iVar1] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_674, 0);
			}
			if (func_369())
			{
				func_368(iVar1);
...
void func_334(int iParam0)
{
	...
	{
		fVar2 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_186[iParam0 /*3*/], 1);
	}
	else
	{
		fVar2 = 99999.99f;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_68319.f_139[iParam0]))
	{
		if (is_vehicle_driveable(Global_68319.f_139[iParam0], 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((GAMEPLAY::IS_BIT_SET(uLocal_48[iParam0], true) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Global_68319.f_139[iParam0], 1), vLocal_186[iParam0 /*3*/], 1) > fVar5) || (!GAMEPLAY::IS_BIT_SET(uLocal_48[iParam0], true) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Global_68319.f_139[iParam0], 1), Local_674, 1) > fVar5))
				{
	...
	else
	{
		...
		else
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Local_674.f_9, 8))
			{
				...
				ENTITY::FREEZE_ENTITY_POSITION(Global_68319.f_139[iParam0], true);
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_68319.f_139[iParam0]))
...
bool func_347(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam1, 1) < fVar6 * 0.5f)
	{
		func_339("player is in vehicle bounds - fLength: ", fVar6);
		func_339("player is in vehicle bounds - fDistance: ", INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam1, 1));
		return true;
	}
	return false;
}
...
void func_360(int iParam0)
{
	...
	if (iVar0 && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar1, 1) < 250f)
	{
	...
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_858[iVar5]) && !is_entity_on_screen(iLocal_858[iVar5])) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar1, 1) > 255f)
		{
