...
int func_401(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_27() == 0)
		{
			return is_bit_set(func_88(func_402(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	return shift_right(iParam0, 26) & 31 * func_415(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_439()
{
	...
	request_waypoint_recording("Fan3_RollingStart");
	request_additional_text("FATIC3", false);
	while ((!get_is_waypoint_recording_loaded("Fan3_RollingStart") || !has_additional_text_loaded(false)) || !has_model_loaded(iLocal_160))
	{
		func_436();
