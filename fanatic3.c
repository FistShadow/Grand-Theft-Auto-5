#region Local Var
	...
	int iLocal_180 = 0;
	int iLocal_181 = 0;
	Vector3[] vLocal_182 = new Vector3[7];
	Vector3[] vLocal_204 = new Vector3[11];
	Vector3[] vLocal_238 = new Vector3[11];
	Vector3 vLocal_272 = 0;
	Vector3 vLocal_275 = 0;
	Vector3 vLocal_278 = 0;
	Vector3 vLocal_281 = 0;
	Vector3 fLocal_284 = 0;
	Vector3 fLocal_285 = 0;
	Vector3 fLocal_286 = 0;
	Vector3 fLocal_287 = 0;
	Vector3 vLocal_288 = 0;
	int iLocal_291 = 0;
	int iLocal_292 = 0;
	int iLocal_293 = 0;
	int iLocal_294 = 0;
	...
	int iLocal_347 = 0;
	int iLocal_348 = 0;
	Vector3 vLocal_349 = 0;
	Vector3 vLocal_352 = 0;
	float fLocal_355 = 0;
	int iLocal_356 = 0;
	int iLocal_357 = 0;
	float fLocal_358 = 0;
	...
	int iLocal_366 = 0;
	int iLocal_367 = 0;
	struct<7>[] Local_368 = new struct<7>[5];
	auto uLocal_404 = 16;
	auto uLocal_405 = 0;
	auto uLocal_406 = 0;
	auto uLocal_407 = 0;
	...
	switch (iLocal_316)
	{
		case 0:
			...
			if (has_anim_dict_loaded("rcmfanatic3leadinoutef_3_mcs_1"))
			{
				...
				{
					func_4(&iLocal_169);
					iLocal_169 = create_vehicle(joaat("scorcher"), vLocal_170, fLocal_173, 1, 1);
					set_vehicle_on_ground_properly(iLocal_169);
				}
				else
				{
					set_entity_coords(iLocal_169, vLocal_170, 1, false, 0, 1);
		...
		case 1:
			iLocal_839 = create_cam_with_params("DEFAULT_ANIMATED_CAMERA", 71.2335f, 7032.092f, 25.1157f, -2.4036f, 0f, 17.3552f, 25f, 0, 2);
			iLocal_316++;
			clear_area_of_peds(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 25f, 0);
		...
		case 2:
			if (func_495(iLocal_307))
			{
				...
				if (iLocal_347)
				{
					set_entity_coords(iLocal_307, 64.0768f, 7045.163f, 14.9558f, 1, false, 0, 1);
					set_entity_heading(iLocal_307, 70.469f);
				}
				else
				{
					set_entity_coords(iLocal_307, 65.61f, 7038.87f, 13.69f, 1, false, 0, 1);
					set_entity_heading(iLocal_307, 13.469f);
				}
				if (iLocal_347)
				{
					open_sequence_task(&iLocal_366);
					AI::TASK_PLAY_ANIM(false, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 8f, -4f, -1, 0, 0.164f, 0, 0, 0);
					close_sequence_task(iLocal_366);
				}
				else
				{
					open_sequence_task(&iLocal_366);
					AI::TASK_PLAY_ANIM(false, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 8f, -4f, -1, 0, 0, 0, 0, 0);
					close_sequence_task(iLocal_366);
				}
				task_perform_sequence(iLocal_307, iLocal_366);
				clear_sequence_task(&iLocal_366);
				if (func_495(PLAYER::PLAYER_PED_ID()))
				{
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					set_ped_stealth_movement(PLAYER::PLAYER_PED_ID(), 0, 0);
					set_ped_max_move_blend_ratio(PLAYER::PLAYER_PED_ID(), 0f);
					func_261(PLAYER::PLAYER_PED_ID(), vLocal_281, fLocal_287, 1, 1);
					set_player_control(player_id(), false, 0);
				}
				play_cam_anim(iLocal_839, "leadout_ef_3_mcs_maryann_cam", "rcmfanatic3leadinoutef_3_mcs_1", ENTITY::GET_ENTITY_COORDS(iLocal_307, 1), get_entity_rotation(iLocal_307, 2), 0, 2);
				set_cam_active(iLocal_839, true);
			}
			_0x48621C9FCA3EBD28(1);
			func_247();
			render_script_cams(true, false, 3000, 1, 0, 0);
			func_246(500, 0);
			func_245(&uLocal_404, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_245(&uLocal_404, 3, iLocal_307, "MARYANN", 0, 1);
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_307, -1, 0, 2);
			wait(1000);
					...
					if (is_entity_playing_anim(iLocal_307, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 3))
					{
						...
						if (get_entity_anim_current_time(iLocal_307, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann") >= 0.98f)
						{
							if (iLocal_348 == 0)
							{
								...
								{
									open_sequence_task(&iLocal_366);
									task_go_straight_to_coord(false, get_offset_from_entity_in_world_coords(iLocal_169, -2.5f, 0f, 0f), 2f, 20000, 1193033728, 0.5f);
									task_enter_vehicle(false, iLocal_169, 20000, -1, 2f, 1, 0);
									task_vehicle_mission_coors_target(false, iLocal_169, 104.65f, 7003.12f, 6.43f, 4, 10f, 262144, 1f, -1f, 1);
									task_vehicle_drive_wander(false, iLocal_169, 15f, 786599);
									close_sequence_task(iLocal_366);
									task_perform_sequence(iLocal_307, iLocal_366);
				...
				if (func_495(iLocal_307))
				{
					if (!is_entity_playing_anim(iLocal_307, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 3))
					{
						if (iLocal_348 == 0)
						{
							...
							{
								open_sequence_task(&iLocal_366);
								task_go_straight_to_coord(false, 86.6f, 7032.51f, 11.35f, 2f, 20000, 1193033728, 1.5f);
								task_enter_vehicle(false, iLocal_169, 20000, -1, 2f, 1, 0);
								task_vehicle_mission_coors_target(false, iLocal_169, 104.65f, 7003.12f, 6.43f, 4, 10f, 262144, 1f, -1f, 1);
								close_sequence_task(iLocal_366);
								task_perform_sequence(iLocal_307, iLocal_366);
...
void func_17()
{
	...
	{
		if (func_20(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_26()
{
	...
	{
		func_28(13, floor(Global_101154.f_8884.f_3853));
	}
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_93(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_93(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_93(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_93(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_93(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_93(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_84(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_93(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_93(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_93(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_58(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_63(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_93(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_93(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_85(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_89(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_88(uVar2, iVar0, 0);
		GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_86(uVar2, iVar3, iVar0, 1);
	}
}

void func_86(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_87(iParam2)];
	if (iVar0 != 0)
	{
...
int func_89(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_90(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_99(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_99(vVar16.z)] = func_80(iParam1, vVar16.x, func_99(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_99(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_103(int iParam0)
{
	...
	func_104(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_104(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_109(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			if (func_105(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_88(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_105(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_108(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_110(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_104(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_93(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_104(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_165(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_93(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_93(iParam1)))
	{
		return true;
	}
	return false;
...
void func_219(int iParam0)
{
	...
	if (iLocal_348 == 0)
	{
		if (func_495(iLocal_307) && func_5(iLocal_169))
		{
			...
			force_ped_motion_state(iLocal_307, -530524, false, 0, 0);
		}
	}
	if (func_495(iLocal_307))
	{
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_226(player_id())) && !func_224(player_id(), 0)) && !func_223())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_226(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_237(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_244(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_245(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_248(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_249(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_251(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_252(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_252(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_254(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_255(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_255(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_256(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
bool func_257(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_261(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_267()
{
	...
	if (iLocal_292 != 0)
	{
		...
		if (iLocal_293 > 0)
		{
			...
			set_checkpoint_rgba(iLocal_292, iVar0, iVar1, iVar2, iLocal_293);
			_set_checkpoint_icon_rgba(iLocal_292, iVar0, iVar1, iVar2, iLocal_293);
		}
		else
		{
	...
	switch (iLocal_159)
	{
		...
		case 1:
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_238[iLocal_301 /*3*/], 1) > 75f)
			{
				if (!iLocal_345)
				{
		...
		case 2:
			if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "rcmfanatic3leadinoutef_3_mcs_1", "Fra_outofbreath_intro", 3))
			{
				if (get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), "rcmfanatic3leadinoutef_3_mcs_1", "Fra_outofbreath_intro") >= 0.9f)
				{
...
bool func_268(auto uParam0)
{
	...
	fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, *(uParam0[iLocal_301 /*3*/]), 0);
	if (fVar3 < 5.5f)
	{
		func_10(&iLocal_294);
		func_10(&iLocal_295);
		...
		if (iLocal_291 != 0)
		{
			...
			get_hud_colour(1, &iVar4, &iVar5, &iVar6, &iLocal_293);
			iLocal_293 = 180;
			...
			if (iLocal_301 == iLocal_300 - 1)
			{
				...
				iLocal_292 = create_checkpoint(9, vVar7, vVar11, 3.2f, iVar4, iVar5, iVar6, iLocal_293, 0);
			}
			else
			{
				...
				if (iLocal_157 == 1 && iLocal_301 == 0)
				{
					...
					iLocal_292 = create_checkpoint(5, vVar7, vVar14, 3.2f, iVar4, iVar5, iVar6, iLocal_293, 0);
				}
				else if (iLocal_157 == 3 && iLocal_301 == 0)
				{
					vVar7 = {vVar7 - Vector(0.3f, 0f, 0f)};
					iLocal_292 = create_checkpoint(6, vVar7, vVar14, 3.2f, iVar4, iVar5, iVar6, iLocal_293, 0);
				}
				else
				{
					iLocal_292 = create_checkpoint(func_271(iLocal_301, uParam0), vVar7, vVar14, 3.2f, iVar4, iVar5, iVar6, iLocal_293, 0);
				}
			}
			set_checkpoint_rgba(iLocal_292, iVar4, iVar5, iVar6, iLocal_293);
			_set_checkpoint_icon_rgba(iLocal_292, iVar4, iVar5, iVar6, iLocal_293);
		}
		delete_checkpoint(iLocal_291);
		iLocal_301++;
		...
		else
		{
			...
			set_blip_colour(iLocal_294, 5);
			set_blip_scale(iLocal_294, 1.2f);
			_0x75A16C3DA34F1245(iLocal_294, false);
			if (iLocal_301 == iLocal_300 - 1)
			{
				set_blip_sprite(iLocal_294, 38);
			}
			if (iLocal_301 < iLocal_300 - 1)
			{
				iLocal_295 = func_270(*(uParam0[iLocal_301 + 1 /*3*/]), 5, 0);
				set_blip_colour(iLocal_295, 5);
				if (iLocal_301 == iLocal_300 - 2)
				{
					set_blip_scale(iLocal_295, 1.2f);
					set_blip_sprite(iLocal_295, 38);
					_0x75A16C3DA34F1245(iLocal_295, false);
				}
				else
				{
					set_blip_scale(iLocal_295, 0.7f);
					_0x75A16C3DA34F1245(iLocal_295, false);
				}
			}
			if (iLocal_301 == iLocal_300 - 1)
			{
				...
				get_hud_colour(iLocal_306, &iVar20, &iVar21, &iVar22, &iVar23);
				switch (iLocal_157)
				{
					case 1:
						iLocal_291 = create_checkpoint(9, *(uParam0[iLocal_301 /*3*/]) + Vector(1.7f, 0f, 0f), vVar17, 3.2f, iVar20, iVar21, iVar22, iVar23, 0);
						break;
				...
				get_hud_colour(13, &iVar20, &iVar21, &iVar22, &iVar23);
				set_checkpoint_rgba(iLocal_291, iVar20, iVar21, iVar22, iVar23);
				get_hud_colour(134, &iVar20, &iVar21, &iVar22, &iVar23);
				_set_checkpoint_icon_rgba(iLocal_291, iVar20, iVar21, iVar22, iVar23);
				set_checkpoint_cylinder_height(iLocal_291, 1.6f, 1.6f, 100f);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					fVar24 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*(uParam0[iLocal_301 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
					if (iLocal_291 != 0)
					{
						if (fVar24 > 100f)
						{
			...
			{
				iLocal_306 = func_269(func_271(iLocal_301, uParam0));
				get_hud_colour(iLocal_306, &iVar25, &iVar26, &iVar27, &iVar28);
				...
				if (iLocal_157 == 1)
				{
					...
					iLocal_291 = create_checkpoint(func_271(iLocal_301, uParam0), *(uParam0[iLocal_301 /*3*/]) + Vector(fVar29, 0f, 0f), vVar17, 3.2f, iVar25, iVar26, iVar27, iVar28, 0);
				}
				else if (iLocal_157 == 3)
				{
					iLocal_291 = create_checkpoint(func_271(iLocal_301, uParam0), *(uParam0[iLocal_301 /*3*/]) + Vector(2f, 0f, 0f), vVar17, 3.2f, iVar25, iVar26, iVar27, iVar28, 0);
				}
				else
				{
					iLocal_291 = create_checkpoint(func_271(iLocal_301, uParam0), *(uParam0[iLocal_301 /*3*/]) + Vector(2f, 0f, 0f), vVar17, 3.2f, iVar25, iVar26, iVar27, iVar28, 0);
				}
				get_hud_colour(13, &iVar25, &iVar26, &iVar27, &iVar28);
				set_checkpoint_rgba(iLocal_291, iVar25, iVar26, iVar27, iVar28);
				get_hud_colour(134, &iVar25, &iVar26, &iVar27, &iVar28);
				_set_checkpoint_icon_rgba(iLocal_291, iVar25, iVar26, iVar27, iVar28);
				set_checkpoint_cylinder_height(iLocal_291, 1.6f, 1.6f, 100f);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					fVar30 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*(uParam0[iLocal_301 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
					if (iLocal_291 != 0)
					{
						if (fVar30 > 100f)
						{
	...
	{
		iLocal_306 = func_269(func_271(iLocal_301, uParam0));
		get_hud_colour(iLocal_306, &iVar31, &iVar32, &iVar33, &iVar34);
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar35 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*(uParam0[iLocal_301 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
			if (iLocal_291 != 0)
			{
				if (fVar35 > 100f)
				{
					get_hud_colour(13, &iVar31, &iVar32, &iVar33, &iVar34);
					iVar34 = 240;
					set_checkpoint_rgba(iLocal_291, iVar31, iVar32, iVar33, iVar34);
					get_hud_colour(134, &iVar31, &iVar32, &iVar33, &iVar34);
					iVar34 = 240;
					_set_checkpoint_icon_rgba(iLocal_291, iVar31, iVar32, iVar33, iVar34);
				}
				else
				{
					get_hud_colour(13, &iVar31, &iVar32, &iVar33, &iVar34);
...
int func_270(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
int func_271(int iParam0, auto uParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
void func_273()
{
	...
	switch (iLocal_315)
	{
		case 0:
			if (func_495(PLAYER::PLAYER_PED_ID()))
			{
				if (func_296(PLAYER::PLAYER_PED_ID(), 52.11f, 6965.68f, 9.73f, 5f))
				{
		...
		case 2:
			if (func_495(iLocal_180))
			{
				if (is_waypoint_playback_going_on_for_ped(iLocal_180))
				{
					if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_180) < 16f)
					{
						if (!func_264())
						{
							func_245(&uLocal_569, 5, iLocal_180, "FAN3DOGOWNER", 0, 1);
							func_245(&uLocal_569, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							if (func_237(&uLocal_569, "FAN3AUD", "FAN3_DOG", 7, 0, 0, 0))
							{
								task_look_at_entity(iLocal_180, PLAYER::PLAYER_PED_ID(), 6000, 0, 2);
								task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_180, 6000, 0, 2);
								iLocal_315++;
							}
						}
					}
		...
		case 4:
			if (func_495(iLocal_180))
			{
				if (!func_264())
				{
					set_ped_keep_task(iLocal_180, true);
	...
	if (func_495(iLocal_180))
	{
		if (func_276(iLocal_180, 1, 1116471296, 1126825984, 0, 0, 0, 0) || is_ped_in_combat(iLocal_180, false))
		{
...
void func_274(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_276(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
...
int func_279(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_280(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_280(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_281(iParam4, iParam7)};
...
bool func_283(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_258(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	{
		vVar3 = {func_258(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_284(vVar3, vVar0);
...
int func_288(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_289(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_495(PLAYER::PLAYER_PED_ID()) && func_495(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_293(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_290(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_290(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_292(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_258(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
int func_296(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_297()
{
	if (func_495(PLAYER::PLAYER_PED_ID()))
	{
		if (func_296(PLAYER::PLAYER_PED_ID(), vLocal_238[1 /*3*/], 5f))
		{
...
void func_298()
{
		...
		switch (iLocal_312)
		{
			case 0:
				if (func_276(iLocal_176, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					set_ped_flee_attributes(iLocal_176, 2, true);
					set_ped_keep_task(iLocal_176, true);
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_181))
					{
						detach_entity(iLocal_181, 1, true);
					}
					func_299(iLocal_176, "GENERIC_CURSE_MED", 4);
					if (func_5(iLocal_168))
					{
						open_sequence_task(&iLocal_366);
						task_enter_vehicle(false, iLocal_168, 20000, -1, 3f, 8, 0);
						task_vehicle_mission_ped_target(false, iLocal_168, PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 300f, 10f, 1);
						close_sequence_task(iLocal_366);
						task_perform_sequence(iLocal_176, iLocal_366);
						clear_sequence_task(&iLocal_366);
					...
					{
						open_sequence_task(&iLocal_366);
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
						close_sequence_task(iLocal_366);
						task_perform_sequence(iLocal_176, iLocal_366);
						clear_sequence_task(&iLocal_366);
				...
				{
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_168, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_181))
						{
							detach_entity(iLocal_181, 1, true);
			...
			case 1:
				if (func_5(iLocal_168))
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_176);
						set_ped_flee_attributes(iLocal_176, 2, false);
						set_ped_keep_task(iLocal_176, true);
						open_sequence_task(&iLocal_366);
						if (is_ped_in_vehicle(iLocal_176, iLocal_168, 0))
						{
							task_leave_any_vehicle(false, 0, 320);
						}
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
						close_sequence_task(iLocal_366);
						task_perform_sequence(iLocal_176, iLocal_366);
				...
				if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_176, 1) > 300f)
				{
			...
			case 2:
				if (func_495(iLocal_176))
				{
					if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_176, 1) > 100f)
					{
						func_9("iBinocStage = 3");
						iLocal_312 = 3;
					}
	...
	else if (ENTITY::IS_ENTITY_DEAD(iLocal_176, 0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_181))
		{
			if (is_entity_attached(iLocal_181))
			{
				detach_entity(iLocal_181, 1, true);
			}
		}
...
{
	_play_ambient_speech1(iParam0, sParam1, func_300(iParam2), 1);
}
...
void func_303()
{
	if (!func_305(&uLocal_734, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (iLocal_337)
		{
...
int func_305(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_306()
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (func_307(ENTITY::GET_ENTITY_MODEL(iVar0)))
			{
				return;
			}
		}
		if (iLocal_157 != 7)
		{
			if (!func_307(ENTITY::GET_ENTITY_MODEL(iVar0)))
			{
				if (func_495(iLocal_307) && func_495(PLAYER::PLAYER_PED_ID()))
				{
					if (!func_264() && !is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_307) < 20f)
						{
...
void func_308()
{
	if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 59.70891f, 6931.386f, 10.60823f, 69.71092f, 6899.878f, 15.37432f, 11f, 0, true, 0))
	{
		if (!iLocal_343)
		{
			if (func_495(iLocal_307))
			{
				if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) < 20f)
				{
	...
	else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 42.00794f, 6994.05f, 5.189813f, 51.55843f, 6969.847f, 12.56655f, 7f, 0, true, 0))
	{
		if (!iLocal_344)
		{
			if (func_495(iLocal_307))
...
void func_309()
{
	if (!func_264())
	{
		...
		{
			if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) < 30f && iLocal_158 == iLocal_157)
			{
				if (iLocal_157 == 1)
				{
					if (func_495(iLocal_307))
					{
						if (is_ped_swimming(iLocal_307) && is_ped_swimming(PLAYER::PLAYER_PED_ID()))
						{
							func_310();
						}
					}
	...
	else if (func_495(iLocal_307))
	{
		if (!iLocal_342)
		{
			if ((func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) > 40f && !iLocal_328) && iLocal_334)
			{
		...
		else if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) < 30f)
		{
			restart_scripted_conversation();
...
void func_314(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
			...
			if (func_495(iLocal_307))
			{
				task_go_straight_to_coord(iLocal_307, vLocal_182[iLocal_302 /*3*/], 2f, 20000, 1193033728, 0.5f);
			}
			break;
		...
		case 2:
			...
			{
				if (is_vehicle_seat_free(iLocal_163, -1))
				{
					iLocal_165 = iLocal_163;
				}
				else if (is_vehicle_seat_free(iLocal_162, -1))
				{
		...
		case 4:
			if (func_495(iLocal_307) && func_5(iLocal_165))
			{
				...
				{
					_task_bring_vehicle_to_halt(iLocal_165, 5f, 10, 0);
...
void func_318()
{
	...
	{
		case 1:
			task_go_straight_to_coord(iLocal_307, vLocal_182[iLocal_302 /*3*/], 3f, 20000, 0.25f, 0.5f);
		...
		case 3:
			if (func_495(iLocal_307) && func_5(iLocal_165))
			{
				if (!is_waypoint_playback_going_on_for_vehicle(iLocal_165) && iLocal_329 == 0)
				{
					...
					task_vehicle_follow_waypoint_recording(iLocal_307, iLocal_165, sLocal_308, 786485, 0, 24, -1, -1f, 0, 2f);
					func_10(&iLocal_296);
				}
			}
			break;
...
bool func_320(auto uParam0)
{
	...
	if (func_495(iLocal_307))
	{
		if (iLocal_302 < iLocal_303)
		{
			...
			fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, *(uParam0[iLocal_302 /*3*/]), 1);
			if (fVar3 < 6f)
			{
				iLocal_302++;
	...
	if (iLocal_158 == 3 && iLocal_157 == 3)
	{
		if (iLocal_304 == 1)
		{
			if (func_495(iLocal_307) && func_495(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar0);
					if ((INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_307, 1), 1) > 65f && iVar0 > 26) && is_waypoint_playback_going_on_for_vehicle(iLocal_165))
					{
						if (func_495(iLocal_165))
						{
							if (is_waypoint_playback_going_on_for_vehicle(iLocal_165))
							{
								waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(iLocal_165, 1), &uVar1);
								waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar0);
							}
							iVar0 -= 5;
							...
							{
								fVar8 = get_entity_speed(iLocal_307);
								set_entity_coords(iLocal_165, vVar2, 1, false, 0, 1);
								func_323(iLocal_165, vVar5);
								if (!is_ped_in_vehicle(iLocal_307, iLocal_165, 0))
								{
									set_ped_into_vehicle(iLocal_307, iLocal_165, -1);
								}
								task_vehicle_follow_waypoint_recording(iLocal_307, iLocal_165, sLocal_308, 786485, 0, 24, -1, -1f, 0, 2f);
								set_vehicle_forward_speed(iLocal_165, fVar8);
...
void func_323(int iParam0, Vector3 vParam1)
{
	Vector3 fVar0;
	
	fVar0 = func_324(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1, 1);
	set_entity_heading(iParam0, fVar0);
}

float func_324(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3, int iParam4)
{
	float fVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_326()
{
	if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -151.0294f, 6589.512f, 7.479042f, -164.0833f, 6577.416f, 9.015114f, 6f, 0, true, 0))
	{
		iLocal_331 = 0;
	...
	if (!iLocal_331)
	{
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -149.3777f, 6592.478f, 1.723418f, -167.0964f, 6574.677f, 7.915183f, 21.25f, 0, true, 0))
		{
			if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) < 30f)
			{
				if (!func_264())
				{
		...
		if (is_ped_in_vehicle(iLocal_307, iLocal_165, 0))
		{
			if (is_audio_scene_active("FANATIC_MIX_SCENE"))
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_165))
				{
					...
					_0x153973AB99FE8980(iLocal_165, "FANATIC_MIX_MARY_BIKE", 0f);
				}
			}
			func_313(3);
		}
		else if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_165, 1))
		{
...
void func_328()
{
	...
	fVar2 = 2f;
	fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_307, 1), 1);
	if (fVar0 > 45f)
	{
		fVar0 = 45f;
	}
		...
		else if (iLocal_158 == 3)
		{
			...
			if (func_495(iLocal_165))
			{
				if (get_is_waypoint_recording_loaded("Fan3_pedBike") && get_is_waypoint_recording_loaded("Fan3_pedBikePrep"))
				{
					if (is_waypoint_playback_going_on_for_vehicle(iLocal_165))
					{
						waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(iLocal_165, 1), &iVar3);
						if (are_strings_equal(sLocal_308, "Fan3_pedBike"))
						{
							if (iVar3 < 98 || iVar3 >= 107)
							{
								...
								if (iLocal_338)
								{
									...
									func_330("Actual entity speed is ", get_entity_speed(iLocal_307));
								}
							...
							if (iVar3 > 93 && iVar3 < 98)
							{
								...
								task_vehicle_follow_waypoint_recording(iLocal_307, iLocal_165, sLocal_308, 262144, 0, 24, -1, -1f, 0, 2f);
							}
						}
						else
						{
	...
	else if (iLocal_158 == 1)
	{
		if (func_495(iLocal_307))
		{
			...
			if (iLocal_338)
			{
				func_330("fDist is ", fVar0);
				func_330("Setting fMoveRatio to ", fVar2);
				func_330("Actual speed is ", get_entity_speed(iLocal_307));
			}
		}
	}
	else if (iLocal_158 == 5)
	...
	else if (iLocal_158 == 3)
	{
		if (func_495(iLocal_165))
		{
			if (is_waypoint_playback_going_on_for_vehicle(iLocal_165))
			{
				waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(iLocal_165, 1), &iVar5);
				if (are_strings_equal(sLocal_308, "Fan3_pedBike"))
				{
					...
					if (iVar5 > 93 && iVar5 < 98)
					{
						func_9("**** SWITCHING TO JUMP PREP");
						sLocal_308 = "Fan3_pedBikePrep";
						task_vehicle_follow_waypoint_recording(iLocal_307, iLocal_165, sLocal_308, 262160, 0, 24, -1, -1f, 0, 2f);
					}
				}
				else
				{
...
void func_329(int iParam0)
{
	...
	if (func_495(iLocal_165))
	{
		...
		{
			waypoint_recording_get_closest_waypoint(sLocal_308, ENTITY::GET_ENTITY_COORDS(iLocal_165, 1), &iParam0);
...
void func_332(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
	...
	{
		*iParam0 = func_333(ENTITY::GET_ENTITY_COORDS(iParam1, 1), 0);
		if (iParam2)
		{
...
int func_333(Vector3 vParam0, int iParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(vParam0);
	set_blip_scale(iVar0, func_334(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	set_blip_route(iVar0, iParam3);
	return iVar0;
}

float func_334(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_336()
{
	...
	func_10(&iLocal_297);
	set_ped_keep_task(iLocal_307, true);
	if (is_ped_in_any_vehicle(iLocal_307, 0))
	{
		task_vehicle_mission_ped_target(iLocal_307, get_vehicle_ped_is_in(iLocal_307, 0), PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 100f, 0.1f, 1);
		set_ped_flee_attributes(iLocal_307, 2, true);
	...
	if (func_495(iLocal_176))
	{
		set_ped_flee_attributes(iLocal_176, 130, true);
		set_ped_keep_task(iLocal_307, true);
		AI::TASK_SMART_FLEE_PED(iLocal_307, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
	func_266(7);
...
void func_338()
{
	if (func_495(iLocal_307))
	{
		if ((func_289(iLocal_307, 1, 0, 0, 0) || is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(iLocal_307, 1), 40f, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_307, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_336();
		}
		if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_307) < 1f)
		{
			if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()))
			{
				func_336();
		...
		{
			if (!func_305(&uLocal_786, ENTITY::GET_ENTITY_COORDS(iLocal_307, 1)))
			{
		...
		if (iLocal_304 == 2)
		{
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_307, 1), 1) >= 300f)
			{
				func_266(3);
			}
		}
...
void func_339()
{
	...
	if (iLocal_157 != 7 || !is_screen_faded_out())
	{
		if (iLocal_157 < 2)
		{
			if (iLocal_301 < 7)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_182[iLocal_301 /*3*/], 1);
			}
			else if (iLocal_301 == 7)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_182[6 /*3*/], 1);
			}
		}
		else if (iLocal_157 < 4)
		{
			if (iLocal_301 < 11)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_204[iLocal_301 /*3*/], 1);
			}
			else if (iLocal_301 == 11)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_204[10 /*3*/], 1);
			}
		}
		else if (iLocal_157 == 4 || iLocal_157 == 5)
		{
			if (iLocal_301 < 11)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_238[iLocal_301 /*3*/], 1);
			}
			else if (iLocal_301 == 11)
			{
				fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_238[iLocal_301 - 1 /*3*/], 1);
			}
		}
		else
		{
		...
		if (iLocal_158 < 2)
		{
			fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_288, vLocal_182[iLocal_302 /*3*/], 1);
		}
		else if (iLocal_158 < 4)
		{
			if (iLocal_302 < 11)
			{
				fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_288, vLocal_204[iLocal_302 /*3*/], 1);
			}
			else if (iLocal_302 == 11)
			{
				fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_288, vLocal_204[10 /*3*/], 1);
			}
		}
		else if (iLocal_158 != 6)
		{
			fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_288, vLocal_238[iLocal_302 /*3*/], 1);
		}
		if (!iLocal_322)
		{
...
void func_352()
{
	...
	switch (iLocal_159)
	{
		...
		case 1:
			...
			{
				if (func_361(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 7f, 10, 1056964608, 0, 1, 0))
				{
					task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
		...
		case 2:
			...
			if (iLocal_346)
			{
				iLocal_294 = func_270(vLocal_238[iLocal_301 /*3*/], 5, 0);
				set_blip_colour(iLocal_294, 5);
				if (iLocal_301 == iLocal_300 - 1)
				{
					iLocal_306 = func_269(func_271(iLocal_301, &vLocal_238));
					get_hud_colour(iLocal_306, &uVar4, &uVar5, &uVar6, &uVar7);
				...
				{
					iLocal_306 = func_269(func_271(iLocal_301, &vLocal_238));
					get_hud_colour(iLocal_306, &uVar11, &uVar12, &uVar13, &uVar14);
					vVar15 = {vLocal_238[iLocal_301 + 1 /*3*/]};
					iLocal_291 = create_checkpoint(func_271(iLocal_301, &vLocal_238), vLocal_238[iLocal_301 /*3*/], vVar15, 3.2f, 254, 207, 12, 100, 0);
				}
				iLocal_346 = 0;
			}
			else
...
void func_354(auto uParam0)
{
	...
	{
		iLocal_306 = func_269(func_271(iLocal_301, uParam0));
		get_hud_colour(iLocal_306, &iVar0, &iVar1, &iVar2, &iVar3);
		switch (iLocal_157)
		{
			case 1:
				iLocal_291 = create_checkpoint(9, *(uParam0[iLocal_301 /*3*/]), vLocal_204[0 /*3*/], 3.2f, iVar0, iVar1, iVar2, iVar3, 0);
				break;
			
			case 2:
			case 3:
				iLocal_291 = create_checkpoint(9, *(uParam0[iLocal_301 /*3*/]) + Vector(2f, 0f, 0f), vLocal_238[0 /*3*/], 3.2f, iVar0, iVar1, iVar2, iVar3, 0);
				break;
			
			case 5:
				iLocal_291 = create_checkpoint(9, *(uParam0[iLocal_301 /*3*/]) + Vector(0.1f, 0f, 0f), *(uParam0[iLocal_301 /*3*/]), 3.2f, iVar0, iVar1, iVar2, iVar3, 0);
				break;
		}
		set_checkpoint_cylinder_height(iLocal_291, 1.6f, 1.6f, 100f);
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*(uParam0[iLocal_301 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
			if (iLocal_291 != 0)
			{
				if (fVar4 > 100f)
				{
					...
					iVar3 = 240;
					set_checkpoint_rgba(iLocal_291, iVar0, iVar1, iVar2, iVar3);
					get_hud_colour(134, &iVar0, &iVar1, &iVar2, &iVar3);
					iVar3 = 240;
					_set_checkpoint_icon_rgba(iLocal_291, iVar0, iVar1, iVar2, iVar3);
				}
				else
				{
					get_hud_colour(13, &iVar0, &iVar1, &iVar2, &iVar3);
	...
	{
		iLocal_306 = func_269(func_271(iLocal_301, uParam0));
		get_hud_colour(iLocal_306, &iVar5, &iVar6, &iVar7, &iVar8);
		if (iLocal_157 == 1 && iLocal_301 == 0)
		{
			iLocal_306 = func_269(5);
			get_hud_colour(iLocal_306, &iVar5, &iVar6, &iVar7, &iVar8);
			iLocal_291 = create_checkpoint(5, *(uParam0[iLocal_301 /*3*/]) + Vector(2f, 0f, 0f), *(uParam0[iLocal_301 + 1 /*3*/]), 3.2f, iVar5, iVar6, iVar7, iVar8, 0);
		}
		else
		{
			iLocal_306 = func_269(5);
			get_hud_colour(iLocal_306, &iVar5, &iVar6, &iVar7, &iVar8);
			iLocal_291 = create_checkpoint(func_271(iLocal_301, uParam0), *(uParam0[iLocal_301 /*3*/]) + Vector(1.7f, 0f, 0f), *(uParam0[iLocal_301 + 1 /*3*/]), 3.2f, iVar5, iVar6, iVar7, iVar8, 0);
		}
		get_hud_colour(13, &iVar5, &iVar6, &iVar7, &iVar8);
		set_checkpoint_rgba(iLocal_291, iVar5, iVar6, iVar7, iVar8);
		get_hud_colour(134, &iVar5, &iVar6, &iVar7, &iVar8);
		_set_checkpoint_icon_rgba(iLocal_291, iVar5, iVar6, iVar7, iVar8);
		set_checkpoint_cylinder_height(iLocal_291, 1.6f, 1.6f, 100f);
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar9 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(*(uParam0[iLocal_301 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
			if (iLocal_291 != 0)
			{
				if (fVar9 > 100f)
				{
...
bool func_355()
{
	...
	if ((((((((((!has_anim_dict_loaded("rcmfanatic3") || !has_anim_dict_loaded("rcmfanatic1maryann_stretchidle_b")) || !STREAMING::HAS_MODEL_LOADED(joaat("baller"))) || !STREAMING::HAS_MODEL_LOADED(joaat("scorcher"))) || !STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beachvesp_01"))) || !STREAMING::HAS_MODEL_LOADED(joaat("a_f_y_runner_01"))) || !STREAMING::HAS_MODEL_LOADED(iLocal_161)) || !STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_musclbeac_02"))) || !get_is_waypoint_recording_loaded("fan3_pedJog")) || !get_is_waypoint_recording_loaded("fan3_dogroute")) || !get_is_waypoint_recording_loaded("fan3_ownerroute"))
	{
		return false;
	}
	iLocal_312 = 0;
	...
	iLocal_315 = 0;
	func_4(&iLocal_168);
	iLocal_168 = create_vehicle(joaat("baller"), 12.08639f, 6967.021f, 10.15097f, 0.588968f, 1, 1);
	if (func_5(iLocal_168))
	{
		set_vehicle_on_ground_properly(iLocal_168);
	...
	iLocal_181 = create_object(joaat("prop_binoc_01"), 14.1481f, 6966.537f, 9.486f, 1, true, false);
	if (func_495(iLocal_176))
	{
		set_blocking_of_non_temporary_events(iLocal_176, true);
		set_ped_component_variation(iLocal_176, false, 0, 0, 0);
		...
		attach_entity_to_entity(iLocal_181, iLocal_176, get_ped_bone_index(iLocal_176, 18905), 0.12f, 0f, 0.1f, -22f, 90f, -20f, 1, 0, 0, 0, 2, 1);
	...
	if (func_495(iLocal_177))
	{
		set_blocking_of_non_temporary_events(iLocal_177, true);
		set_ped_component_variation(iLocal_177, false, 0, 0, 0);
	...
	if (func_495(iLocal_178))
	{
		set_blocking_of_non_temporary_events(iLocal_178, true);
...
void func_357(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
bool func_361(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_362()
{
	if (iLocal_157 == 3)
	{
		...
		{
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -402.2801f, 6407.981f, 9.086394f, -382.6009f, 6364.857f, 16.76248f, 5f, 0, true, 0))
			{
				if (!iLocal_328)
				{
					func_9("Starting bad driver");
					set_entity_load_collision_flag(iLocal_167, true);
					func_245(&uLocal_569, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					task_vehicle_follow_waypoint_recording(iLocal_174, iLocal_167, "Fan3_baddriver", 786469, 0, 0, -1, -1f, 0, 2f);
					iLocal_328 = 1;
				}
			}
			else if (iLocal_328)
			{
				if (func_295(iLocal_167, PLAYER::PLAYER_PED_ID(), 1) < 15f)
				{
					start_vehicle_horn(iLocal_167, 4000, 0, 0);
				}
				if (func_295(iLocal_167, PLAYER::PLAYER_PED_ID(), 1) < 6f)
				{
				...
				if (!is_waypoint_playback_going_on_for_vehicle(iLocal_167))
				{
					...
					set_entity_load_collision_flag(iLocal_167, false);
					_0x3910051CCECDB00C(iLocal_167, true);
					func_230(&iLocal_167);
					iLocal_328 = 0;
				}
			}
...
void func_366(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_423(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
...
void func_367(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_368(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_368(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_409();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_387())
		{
			func_383(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_370(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_371(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_373(auto uParam0, int iParam1, int iParam2)
{
...
void func_378(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
bool func_381(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_382(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_383(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_384(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_87(iParam1)];
...
void func_385(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_386(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_389(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_393(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_390(Var9.f_1)) && iVar70 < 50)
			{
...
int func_392(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_396(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_397(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
int func_398(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_399(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_408())
		{
			*uParam0 = func_404(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_401(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_27() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_88(func_402(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_404(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_406(iVar0))
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_405(iVar0, 0), 1);
...
auto func_409()
{
	...
	func_419(&uVar0, get_clock_seconds());
	func_418(&uVar0, get_clock_minutes());
	func_417(&uVar0, TIME::GET_CLOCK_HOURS());
	func_412(&uVar0, get_clock_day_of_month());
	func_411(&uVar0, get_clock_month());
...
auto func_414(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_415(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_418(auto uParam0, int iParam1)
{
...
auto func_426(char* sParam0, int iParam1, char* sParam2)
{
...
void func_428()
{
	if (func_495(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (func_495(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
		{
			if (!iLocal_367)
			{
				if (is_entity_in_angled_area(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -162.9305f, 6574.679f, 11.03543f, -166.7214f, 6578.559f, 15.14065f, 3.5f, 0, true, 0))
				{
			...
			else if ((is_entity_in_angled_area(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -152.1211f, 6592.195f, 8.325163f, -149.1945f, 6588.718f, 13.28955f, 5.25f, 0, true, 0) || is_entity_in_angled_area(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -183.9688f, 6611.616f, -1.050815f, -146.163f, 6575.147f, 7.485405f, 46.5f, 0, true, 0)) || !is_entity_in_angled_area(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -182.5904f, 6607.474f, 0.027168f, -143.88f, 6571.712f, 37.02929f, 70.75f, 0, true, 0))
			{
				_0x81CBAE94390F9F89();
				iLocal_367 = 0;
...
void func_429()
{
	...
	switch (iLocal_159)
	{
		...
		case 1:
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				iLocal_164 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
				if (iLocal_162 == get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0) || iLocal_163 == get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))
				{
					func_10(&iLocal_294);
					func_10(&iLocal_296);
					_0x293220DA1B46CEBC(5f, 15f, 1);
		...
		case 2:
			...
			else
			{
				...
				{
					iLocal_294 = func_270(vLocal_204[iLocal_301 /*3*/], 5, 0);
					set_blip_colour(iLocal_294, 5);
					if (iLocal_301 == iLocal_300 - 1)
					{
						set_blip_sprite(iLocal_294, 38);
					...
					if (iLocal_301 == iLocal_300 - 2)
					{
						iLocal_295 = func_270(vLocal_204[iLocal_301 + 1 /*3*/], 5, 0);
						set_blip_scale(iLocal_295, 1.2f);
						set_blip_sprite(iLocal_295, 38);
						_0x75A16C3DA34F1245(iLocal_295, false);
					}
...
bool func_430()
{
	...
	request_anim_dict("rcmfanatic3");
	if ((((((!STREAMING::HAS_MODEL_LOADED(joaat("patriot")) || !STREAMING::HAS_MODEL_LOADED(joaat("a_f_m_ktown_02"))) || !STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_dockwork_01"))) || !get_is_waypoint_recording_loaded("Fan3_baddriver")) || !has_vehicle_recording_been_loaded(500, "Fan3_MaryAnnBikeJump")) || !get_is_waypoint_recording_loaded("Fan3_pedBike")) || !has_anim_dict_loaded("rcmfanatic3"))
	{
		func_9("Waiting for bike resources");
		return false;
	}
	func_4(&iLocal_167);
	iLocal_167 = create_vehicle(joaat("patriot"), -206.0824f, 6557.376f, 11.0625f, 220.94f, 1, 1);
	func_3(&iLocal_174);
	if (func_5(iLocal_167) && !func_495(iLocal_174))
	{
	...
	{
		set_blocking_of_non_temporary_events(iLocal_174, true);
	}
	...
	clear_angled_area_of_vehicles(vLocal_349, vLocal_352, fLocal_355, 0, 0, 0, 0, 0);
	func_358(&uLocal_734);
...
void func_438()
{
	...
	else if (iLocal_324 == 0)
	{
		...
		if (_0xB56BBBCC2955D9CB())
		{
			...
			if (func_495(iLocal_307))
			{
				_0x2A56C06EBEF2B0D9("Mary_Ann", iLocal_307, false);
			}
			if (func_495(PLAYER::PLAYER_PED_ID()))
			{
				_0x2A56C06EBEF2B0D9("Franklin", PLAYER::PLAYER_PED_ID(), false);
			}
		}
		iLocal_321 = 0;
		if (func_446(1, 1093140480, 0))
		{
			...
			if (func_495(iLocal_307))
			{
				register_entity_for_cutscene(iLocal_307, "Mary_Ann", 0, false, 0);
			}
			if (func_495(PLAYER::PLAYER_PED_ID()))
			{
	...
	else
	{
		...
		request_additional_text("FATIC3", false);
		if (iLocal_321 == 0)
		{
			set_gameplay_cam_relative_pitch(0f, 1f);
			set_gameplay_cam_relative_heading(0f);
		...
		else if (iLocal_321 == 1)
		{
			...
			if (!is_cutscene_active())
			{
				...
				if (iLocal_325 == 1)
				{
					if (func_495(iLocal_307))
					{
						set_entity_coords(iLocal_307, -903.2273f, 6142.639f, 4.1911f, 1, true, 0, 1);
				...
				if (!is_audio_scene_active("FANATIC_MIX_SCENE"))
				{
					...
					if (func_495(iLocal_307))
					{
						_0x153973AB99FE8980(iLocal_307, "FANATIC_MIX_MARY_ANNE", 0f);
					}
				}
				func_439();
			}
...
void func_439()
{
	...
	request_waypoint_recording("Fan3_RollingStart");
	request_additional_text("FATIC3", false);
	while ((!get_is_waypoint_recording_loaded("Fan3_RollingStart") || !has_additional_text_loaded(false)) || !STREAMING::HAS_MODEL_LOADED(iLocal_160))
	{
		func_436();
...
void func_441(int iParam0, int iParam1)
{
	...
	func_248(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
void func_443()
{
	if (can_set_exit_state_for_registered_entity("Mary_Ann", joaat("ig_maryann")))
	{
		...
		{
			set_ped_min_move_blend_ratio(iLocal_307, 3f);
			force_ped_motion_state(iLocal_307, -1115154469, false, 1, 0);
			task_go_straight_to_coord(iLocal_307, vLocal_182[0 /*3*/], 2f, 20000, 1193033728, 0.5f);
...
bool func_446(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_361(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_449(PLAYER::PLAYER_PED_ID(), -828834893))
				{
					task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
			}
...
void func_451(int iParam0, int iParam1)
{
	...
	if (iParam0 == 0)
	{
		if (is_audio_scene_active("FANATIC_MIX_SCENE"))
		{
			if (func_495(iLocal_307))
			{
				_0x18EB48CFC41F2EA0(iLocal_307, 0f);
			}
	...
	switch (iLocal_157)
	{
		case 0:
			if (func_495(iLocal_307))
			{
				...
				set_entity_coords(iLocal_307, -910.3204f, 6144.248f, 4.2755f, 1, false, 0, 1);
		...
		case 3:
			if (func_495(iLocal_307))
			{
				...
				set_entity_coords(iLocal_307, -674.4872f, 6134.139f, 1.072f, 1, false, 0, 1);
		...
		case 5:
			...
			if (func_495(iLocal_307))
			{
				...
				set_entity_coords(iLocal_307, 51.1448f, 6773.212f, 19.2801f, 1, false, 0, 1);
...
void func_455()
{
	...
	if (!func_440())
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_278, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_286);
		func_459(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	if (func_495(iLocal_307))
	{
		AI::CLEAR_PED_TASKS_immediately(iLocal_307);
	...
	{
		set_entity_coords(iLocal_162, 49.01611f, 6771.453f, 20.0558f, 1, false, 0, 1);
		set_entity_heading(iLocal_162, -62.49037f);
	}
	if (func_5(iLocal_163))
	{
		set_entity_coords(iLocal_163, 52.37f, 6767.48f, 20.66f, 1, false, 0, 1);
...
void func_458()
{
	if (func_5(iLocal_165))
	{
		if (is_audio_scene_active("FANATIC_MIX_SCENE"))
		{
			_0x18EB48CFC41F2EA0(iLocal_165, 0f);
		}
	}
	if (func_5(iLocal_162) && func_5(iLocal_163))
	{
		...
		set_entity_coords(iLocal_162, -664.34f, 6138.38f, 1.2f, 1, false, 0, 1);
		set_entity_heading(iLocal_162, 235f);
		set_vehicle_doors_locked(iLocal_162, 1);
		set_entity_coords(iLocal_163, -664.32f, 6133.73f, 2.4f, 1, false, 0, 1);
		set_entity_heading(iLocal_163, -84.69f);
		set_vehicle_doors_locked(iLocal_163, 1);
		set_vehicle_on_ground_properly(iLocal_162);
		set_vehicle_on_ground_properly(iLocal_163);
	}
	else
	{
		if (!func_5(iLocal_162))
		{
			iLocal_162 = create_vehicle(iLocal_160, -664.34f, 6138.38f, 1.2f, 235f, 1, 1);
			set_entity_heading(iLocal_162, 235f);
			set_vehicle_colour_combination(iLocal_162, 1);
		}
		if (!func_5(iLocal_163))
		{
			iLocal_163 = create_vehicle(iLocal_160, -664.32f, 6133.73f, 2.4f, -84.69f, 1, 1);
			set_entity_heading(iLocal_163, -84.69f);
...
void func_459(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_465()
{
	if (!func_440())
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_275, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_285);
		func_459(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
...
void func_466()
{
	...
	if (!func_440())
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_272, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_284);
		func_459(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
...
void func_467()
{
	...
	iLocal_309 = 0;
	iLocal_310 = -1;
	set_entity_coords(PLAYER::PLAYER_PED_ID(), -909.0488f, 6142.617f, 4.2883f, 1, false, 0, 1);
	func_454();
	func_435(1, 1, 1);
}
...
void func_468()
{
	...
	func_356(&uLocal_786);
	func_469(-888.0333f, 6142.658f, 2.3874f, -679.05f, 6139.86f, 0.7f, &vLocal_182, 7);
	iLocal_160 = joaat("scorcher");
	sLocal_308 = "Fan3_pedBike";
	if (func_507())
	{
	...
	set_roads_in_angled_area(vLocal_349, vLocal_352, fLocal_355, 0, false, 1);
	set_wanted_level_multiplier(0.1f);
	STREAMING::REQUEST_MODEL(iLocal_160);
	request_anim_set("FEMALE_FAST_RUNNER");
	while (!STREAMING::HAS_MODEL_LOADED(iLocal_160) || !has_anim_set_loaded("FEMALE_FAST_RUNNER"))
	{
		wait(0);
	}
	func_458();
	if (func_495(iLocal_307))
	{
		...
		set_blocking_of_non_temporary_events(iLocal_307, true);
		set_entity_only_damaged_by_player(iLocal_307, true);
		set_ped_can_be_targetted(iLocal_307, false);
		set_entity_load_collision_flag(iLocal_307, true);
		set_ped_can_be_knocked_off_vehicle(iLocal_307, 1);
		set_ped_movement_clipset(iLocal_307, "FEMALE_FAST_RUNNER", 0.25f);
		set_ped_can_ragdoll_from_player_impact(iLocal_307, 0);
	}
}

void func_469(Vector3 vParam0, Vector3 vParam1, auto uParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	...
	switch (iLocal_159)
	{
		case 0:
			...
			if (func_507() && !iLocal_341)
			{
				...
				if (func_495(iLocal_307))
				{
					freeze_entity_position(iLocal_307, false);
				}
				iVar0 = func_506();
				func_319("ReplayStage: ", iVar0);
				if (Global_85788 == 1)
				...
				switch (iVar0)
				{
					case 0:
						if (func_507())
						{
							func_474(vLocal_272, fLocal_284, 1, 0);
						}
						func_451(1, 1);
						break;
					...
					case 1:
						if (func_507())
						{
							func_474(vLocal_275, fLocal_285, 1, 0);
						}
						func_451(2, 1);
						break;
					...
					case 2:
						if (func_507())
						{
							func_474(vLocal_278, fLocal_286, 1, 0);
						}
						func_451(3, 1);
						break;
					...
					case 3:
						if (func_507())
						{
							func_474(vLocal_281, fLocal_287, 1, 0);
						}
						func_451(4, 1);
						break;
			...
			func_245(&uLocal_404, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_245(&uLocal_404, 3, iLocal_307, "MARYANN", 0, 1);
			if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) <= 1.5f)
			{
				if (func_264())
				{
					func_262();
				...
				if (func_495(iLocal_307))
				{
					if (is_entity_playing_anim(iLocal_307, "rcmfanatic3", "ef_3_rcm_loop_maryann", 3))
					{
						if (get_entity_anim_current_time(iLocal_307, "rcmfanatic3", "ef_3_rcm_loop_maryann") < 0.1f)
						{
							...
							freeze_entity_position(iLocal_307, false);
							remove_cutscene();
							_request_cutscene_2("EF_3_RCM_CONCAT", 2, 8);
							iLocal_323 = 1;
							if (!is_gameplay_hint_active())
							{
								if (func_495(iLocal_307))
								{
									...
									if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) <= 7f)
									{
		...
		case 1:
			if (func_221(iLocal_307))
			{
				if (is_entity_playing_anim(iLocal_307, "rcmfanatic3", "ef_3_rcm_action_maryann", 3))
				{
					...
					if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_307, 1) <= 2.5f)
					{
						task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), iLocal_307, 0);
						set_player_control(player_id(), false, 0);
						func_9("Player too close to Mary Ann, starting cutscene early");
					}
				}
...
void func_474(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	if (func_507())
	{
...
struct<2> func_478(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_485(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_484(iParam2)};
					break;
				...
				default:
					StringCopy(&cVar0, func_479(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_485(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_487(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	...
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_464(0)) || func_488(1))
			{
			}
			else
			{
...
void func_493()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_361(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_496()
{
	if (func_495(Local_96.f_28[0]))
	{
		...
		set_ped_flee_attributes(iLocal_307, 2, true);
		add_relationship_group("Buddy", &iLocal_356);
...
bool func_499(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_500(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_500(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_501(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_505(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
void func_508()
{
	...
	if (func_495(iLocal_307))
	{
		if (func_5(iLocal_169))
		{
			...
			{
				open_sequence_task(&iLocal_366);
				task_enter_vehicle(false, iLocal_169, 20000, -1, 1f, 1, 0);
				task_go_to_coord_any_means(false, 253.0988f, 6751.997f, 14.2161f, 1f, 0, 0, 786603, -1082130432);
				task_vehicle_drive_wander(false, iLocal_169, 15f, 786599);
				close_sequence_task(iLocal_366);
				task_perform_sequence(iLocal_307, iLocal_366);
				clear_sequence_task(&iLocal_366);
	...
	if (func_495(iLocal_176))
	{
		set_ped_flee_attributes(iLocal_176, 2, true);
		set_ped_keep_task(iLocal_176, true);
		if (func_495(iLocal_168) && func_495(PLAYER::PLAYER_PED_ID()))
		{
			open_sequence_task(&iLocal_366);
			task_enter_vehicle(false, iLocal_168, 20000, -1, 3f, 8, 0);
			AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
bool func_514(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_517())
	{
		...
		{
			iVar33 = func_420(get_this_script_name());
			if (iVar33 > -1)
			{
