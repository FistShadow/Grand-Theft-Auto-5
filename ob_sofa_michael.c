...
void main()
{
	...
	while (true)
	{
		...
		{
			if (get_distance_between_coords(vLocal_372, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
			...
			else if (get_distance_between_coords(vLocal_372, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f)
			{
				func_85();
			}
		}
