...
void main()
{
	...
	fLocal_93 = 2.99f;
	fLocal_94 = 3.7f;
	if (network_is_game_in_progress() && func_228(player_id(), 0, 1))
	{
		func_220(Local_253);
	}
	else
	...
	if (Local_96 == 1)
	{
		if (network_is_participant_active(int_to_participantindex(iLocal_251)))
		{
			...
			if (func_228(iVar0, 1, 1))
			{
				if (!is_bit_set(Local_96.f_1, false))
				{
					if (is_bit_set(Local_116[iLocal_251 /*4*/].f_1, false))
					{
						iLocal_252 = 1;
...
void func_14()
{
	...
	if (!is_bit_set(iLocal_245, true))
	{
		if ((is_bit_set(Local_116[participant_id_to_int() /*4*/].f_1, false) && get_player_wanted_level(player_id()) >= Local_96.f_16 - 1) && Local_116[participant_id_to_int() /*4*/].f_2 < 10)
		{
...
int func_30(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_35(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_34(1);
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_44(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_35(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_34(1);
			}
...
void func_56(int iParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5)
{
	var uVar0;
	int iVar1;
...
void func_57(var uParam0, char* sParam1, var uParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_63(int iParam0, var uParam1, int iParam2)
{
...
void func_69(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_70(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_99()
{
	...
	{
		case 0:
			if (is_entity_at_coord(player_ped_id(), Local_96.f_2, Local_96.f_5, Local_96.f_5, 1000f, false, true, 0))
			{
				func_172();
				set_bit(&(Local_116[participant_id_to_int() /*4*/].f_1), false);
				set_bit(&(Global_2460486.f_4430), false);
...
void func_101()
{
	if (!is_bit_set(iLocal_245, 5))
	{
		if (!is_bit_set(iLocal_245, 4))
		{
			if (Local_96.f_17 == 0)
			{
				set_bit(&iLocal_245, 4);
			}
			else
			{
				set_bit(&iLocal_245, 5);
			}
		}
...
void func_109()
{
	if (func_9(&uLocal_247, 30000, 0))
	{
		...
		func_110(0, player_ped_id(), "XPT_DSC", -1636175450, 2048546661, Global_262145.f_6473 * Local_96.f_16, 1, -1, 0, 0);
		Local_116[participant_id_to_int() /*4*/].f_2++;
		func_5(&uLocal_247);
	}
}
...
void func_111(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_113(player_ped_id()))
	{
		func_112(1);
	}
...
Vector3 func_114(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_115(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
var func_120(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
var func_150(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
void func_159()
{
	...
	else if (!is_entity_at_coord(player_ped_id(), Local_96.f_2, Local_96.f_6, Local_96.f_6, 950f, false, true, 0))
	{
		if (!is_bit_set(iLocal_245, false) && is_bit_set(iLocal_245, 3))
		{
	...
	else
	{
		...
		{
			set_bit(&iLocal_245, 3);
		}
		if (is_bit_set(iLocal_245, false))
		{
			clear_bit(&iLocal_245, false);
		}
	}
}
...
void func_162()
{
	...
	func_5(&uLocal_249);
	func_163();
	clear_bit(&(Local_116[participant_id_to_int() /*4*/].f_1), false);
	clear_bit(&iLocal_245, 3);
	set_bit(&(Global_2460486.f_4430), false);
	if (!is_bit_set(iLocal_245, 5))
	{
		set_bit(&iLocal_245, 5);
...
void func_174(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	func_175(vParam0, 0f, 0f, 0f, uParam3, 0, iParam4, iParam5);
}

void func_175(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3, var uParam4, var uParam5)
{
	struct<12> Var0;
...
void func_176(struct<12> Param0, var uParam1)
{
...
bool func_179(vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10)
{
	int iVar0;
...
void func_192(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	struct<12> Var0;
...
void func_193(struct<12> Param0, var uParam1)
{
...
void func_226(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_218();
