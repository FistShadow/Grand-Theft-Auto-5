#region Local Var
	...
	auto uLocal_98 = 0;
	auto uLocal_99 = 0;
	auto uLocal_100 = 1132396544;
	auto uLocal_101 = 1132396544;
	auto uLocal_102 = 1132396544;
	auto uLocal_103 = 0;
	auto uLocal_104 = -1082130432;
	auto uLocal_105 = 0;
	auto uLocal_106 = 0;
	auto uLocal_107 = 8;
	auto uLocal_108 = 0;
	...
	auto uLocal_163 = 0;
	auto uLocal_164 = -1;
	auto uLocal_165 = 1092616192;
	auto uLocal_166 = 0;
	auto uLocal_167 = 0;
	int iLocal_168 = 0;
	struct<21> Local_169 = 0;
	struct<10>[] Local_190 = new struct<10>[15];
	int iLocal_341 = 0;
	Vector3 fLocal_342 = 0;
	struct<2> Local_343 = 0;
	auto uLocal_345 = 0;
	auto uLocal_346 = 0;
	auto uLocal_347 = 0;
	auto uLocal_348 = 0;
	...
	auto uLocal_407 = 0;
	auto uLocal_408 = 0;
	Vector3[] vLocal_409 = new Vector3[1];
	int iLocal_413 = 0;
	int iLocal_414 = 0;
	int iLocal_415 = 0;
	int iLocal_416 = 0;
	int[] iLocal_417 = new int[3];
	int iLocal_421 = 0;
	int iLocal_422 = 0;
	struct<418> Local_423 = 0;
	auto uLocal_841 = -1;
	auto uLocal_842 = -1;
	auto uLocal_843 = -1;
	auto uLocal_844 = -1;
	...
	int iLocal_914 = 0;
	int iLocal_915 = 0;
	Vector3 vLocal_916 = 0;
	Vector3 vLocal_919 = 0;
	Vector3 vLocal_922 = 0;
	Vector3 vLocal_925 = 0;
	Vector3 vLocal_928 = 0;
	Vector3 vLocal_931 = 0;
	Vector3 vLocal_934 = 0;
	Vector3 vLocal_937 = 0;
	Vector3 vLocal_940 = 0;
	Vector3 vLocal_943 = 0;
	Vector3 vLocal_946 = 0;
	Vector3 vLocal_949 = 0;
	auto uLocal_952 = 0;
	auto uLocal_953 = 0;
	auto uLocal_954 = 0;
	Vector3 vLocal_955 = 0;
	Vector3 vLocal_958 = 0;
	Vector3 vLocal_961 = 0;
	Vector3 vLocal_964 = 0;
	Vector3 vLocal_967 = 0;
	Vector3 fLocal_970 = 0;
	Vector3 fLocal_971 = 0;
	float fLocal_972 = 0;
	Vector3 fLocal_973 = 0;
	Vector3 fLocal_974 = 0;
	int iLocal_975 = 0;
	char[16] cLocal_976 = 0;
	char[64] cLocal_980 = 0;
	char[64] cLocal_996 = 0;
	char[64] cLocal_1012 = 0;
	char[64] cLocal_1028 = 0;
	Vector3 vLocal_1044 = 0;
	Vector3 vLocal_1047 = 0;
	Vector3 fLocal_1050 = 0;
	int iLocal_1051 = 0;
	struct<28> Local_1052 = -1;
	auto uLocal_1080 = 0;
	auto uLocal_1081 = 0;
	auto uLocal_1082 = 5;
	auto uLocal_1083 = 0;
	...
	auto uLocal_1125 = 0;
	auto uLocal_1126 = 0;
	auto uLocal_1127 = 1097859072;
	auto uLocal_1128 = 1500;
	auto uLocal_1129 = 45;
	auto uLocal_1130 = 1103626240;
	auto uLocal_1131 = 5;
	auto uLocal_1132 = 0;
	auto uLocal_1133 = 0;
	auto uLocal_1134 = 0;
	...
	else
	{
		...
		switch (Local_423.f_410)
		{
			case 0:
				...
				func_295(&Local_423, vLocal_916, vLocal_919, "TaxiKeyla", iLocal_886, 41.1334f, 15f);
				func_294(&Local_423);
			...
			case 1:
				if (func_291())
				{
					func_290();
					func_270();
					func_269(&(vLocal_409[0 /*3*/]), "TAXI_SC_BN_04", 100);
					func_268(&Local_423, &vLocal_409);
					func_267(&Local_423);
					set_all_vehicle_generators_active_in_area(vLocal_928, vLocal_931, false, 1);
			...
			case 3:
				if (func_262(&Local_423, 1))
				{
					...
					{
						set_ped_component_variation(Local_423.f_3, false, false, true, 0);
						set_ped_component_variation(Local_423.f_3, 2, true, 2, 0);
						set_ped_component_variation(Local_423.f_3, 3, false, 2, 0);
						set_ped_component_variation(Local_423.f_3, 4, true, 3, 0);
						set_ped_component_variation(Local_423.f_3, 8, true, false, 0);
					}
					...
					set_roads_in_area(1346.9f, -1606.52f, 31.16f, 1457.25f, -1508.19f, 83.05f, false, 1);
			...
			case 17:
				...
				if (!ENTITY::DOES_ENTITY_EXIST(Local_853.f_3))
				{
					if (func_229())
					{
						func_228(&Local_853, vLocal_937, fLocal_972);
					}
				}
				else
				{
				...
				if (func_201(&Local_423, 9f, 1097859072, 1117782016))
				{
					...
					{
						set_blip_route(Local_423.f_9, false);
					}
			...
			case 9:
				...
				if (func_191(Local_853.f_2, Local_853.f_3))
				{
					...
					iLocal_894 = add_scenario_blocking_area(vLocal_946, vLocal_949, 0, 1, 1, 1);
				...
				if (func_189(&Local_423))
				{
					...
					if (func_149())
					{
						if (is_playback_using_ai_going_on_for_vehicle(Local_853.f_3))
						{
							...
							remove_vehicle_recording(false, "taxi_oj_fc3");
						}
			...
			case 14:
				...
				{
					if ((is_entity_at_coord(Local_853.f_3, vLocal_922, 20f, 20f, 60f, true, true, 0) && get_entity_speed(Local_853.f_3) < 5f) || Local_853.f_31 > 2)
					{
						if (!is_entity_dead(iLocal_890, 0))
						{
							clear_ped_tasks(iLocal_890);
							set_entity_coords(iLocal_890, vLocal_943, 1, false, 0, 1);
						}
			...
			case 21:
				...
				if (is_vehicle_driveable(Local_423.f_4, 0))
				{
					if (is_ped_in_vehicle(Local_423.f_2, Local_423.f_4, 0))
					{
						if (is_entity_at_coord(Local_423.f_4, -684.526f, -1105.76f, 13.52571f, 1f, 1f, 2f, !Local_423.f_140, true, 0))
						{
						}
						if (is_entity_in_angled_area(Local_423.f_4, -685.0081f, -1101.297f, 13.527f, -678.677f, -1110.64f, 15.5871f, 2.25f, 0, true, 0) || is_entity_in_angled_area(Local_423.f_4, -704.1705f, -1115.226f, 13.525f, -700.2585f, -1121.292f, 15.4336f, 2.25f, 0, true, 0))
						{
							if (is_entity_in_angled_area(Local_423.f_4, -685.0081f, -1101.297f, 13.527f, -678.677f, -1110.64f, 15.5871f, 2.25f, 0, true, 0))
							{
								iLocal_413 = 0;
							}
							else
			...
			case 30:
				clear_this_print("TAXI_OBJ_DRIVE");
				if ((!PED::IS_PED_INJURED(Local_423.f_3) && has_entity_been_damaged_by_entity(iLocal_890, Local_423.f_3, 1)) && has_entity_been_damaged_by_entity(Local_853.f_2, Local_423.f_3, 1))
				{
					...
					{
						iLocal_421 = get_random_vehicle_in_sphere(vLocal_940, 10f, joaat("ambulance"), 0);
						if (is_vehicle_driveable(iLocal_421, 0))
						{
							iLocal_910 = 1;
						}
						iLocal_891 = get_random_ped_at_coord(vLocal_940, 5f, 5f, 5f, -1);
						...
						if (!iLocal_911)
						{
							if (create_incident(5, vLocal_940, 1, 0f, &uLocal_895))
							{
								settimera(false);
								iLocal_911 = 1;
							}
				...
				else if ((PED::IS_PED_INJURED(Local_423.f_3) || has_entity_been_damaged_by_entity(iLocal_890, PLAYER::PLAYER_PED_ID(), 1)) || has_entity_been_damaged_by_entity(Local_853.f_2, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (!PED::IS_PED_INJURED(Local_423.f_3))
					{
						set_blocking_of_non_temporary_events(Local_423.f_3, true);
						clear_ped_tasks(Local_423.f_3);
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						task_cower(false, 2000);
						task_smart_flee_coord(false, Local_423.f_17, 1000f, -1, 0, 0);
						close_sequence_task(iLocal_414);
						task_perform_sequence(Local_423.f_3, iLocal_414);
						clear_sequence_task(&iLocal_414);
						set_ped_keep_task(Local_423.f_3, true);
					}
					if (!PED::IS_PED_INJURED(iLocal_890))
					{
						set_blocking_of_non_temporary_events(iLocal_890, true);
						clear_ped_tasks(iLocal_890);
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						task_cower(false, 1000);
						task_smart_flee_coord(false, Local_423.f_17, 1000f, -1, 0, 0);
						close_sequence_task(iLocal_414);
						task_perform_sequence(iLocal_890, iLocal_414);
						clear_sequence_task(&iLocal_414);
						set_ped_keep_task(iLocal_890, true);
					}
					if (!PED::IS_PED_INJURED(Local_853.f_2))
					{
						set_blocking_of_non_temporary_events(Local_853.f_2, true);
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						if (iLocal_908)
						{
							task_play_anim(false, "MOVE_DUCK_FOR_COVER", "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						task_stand_still(false, 500);
						task_smart_flee_coord(false, Local_423.f_17, 1000f, -1, 0, 0);
						close_sequence_task(iLocal_414);
						task_perform_sequence(Local_853.f_2, iLocal_414);
						clear_sequence_task(&iLocal_414);
						set_ped_keep_task(Local_853.f_2, true);
					}
					func_51(1, &Local_423, 1);
					func_434();
				}
				else if ((iLocal_904 && !func_193()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_900 > 500)
				{
					if (!PED::IS_PED_INJURED(Local_423.f_3))
					{
						set_blocking_of_non_temporary_events(Local_423.f_3, true);
						...
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						task_shoot_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, -957453492);
						close_sequence_task(iLocal_414);
						task_perform_sequence(Local_423.f_3, iLocal_414);
						clear_sequence_task(&iLocal_414);
						set_ped_keep_task(Local_423.f_3, true);
...
void func_9(auto uParam0, int iParam1)
{
	...
	if (func_21(Global_101154.f_17787, 4))
	{
		...
		set_vehicle_model_is_suppressed(func_18(), false);
	}
	if (iParam1)
	{
		func_17(uParam0);
	...
	playstats_oddjob_done(round(func_10(&iLocal_90) * 1000f), 12, 0);
}

float func_10(auto uParam0)
{
	if (func_13(uParam0))
	{
		if (func_12(uParam0))
...
struct<8> func_15(int iParam0)
{
	...
	{
		case 0:
			StringCopy(&cVar0, "TAXI_SC_N_NE", 32);
			break;
		
		case 1:
			StringCopy(&cVar0, "TAXI_SC_N_TE", 32);
			break;
		
		case 2:
			StringCopy(&cVar0, "TAXI_SC_N_DL", 32);
			break;
		
		case 3:
			StringCopy(&cVar0, "TAXI_SC_N_GB", 32);
			break;
		
		case 4:
			StringCopy(&cVar0, "TAXI_SC_N_TB", 32);
			break;
		
		case 5:
			StringCopy(&cVar0, "TAXI_SC_N_CY", 32);
			break;
		
		case 6:
			StringCopy(&cVar0, "TAXI_SC_N_GN", 32);
			break;
		
		case 7:
			StringCopy(&cVar0, "TAXI_SC_N_CC", 32);
			break;
		
		case 8:
			StringCopy(&cVar0, "TAXI_SC_N_FC", 32);
			break;
		
		case 9:
			StringCopy(&cVar0, "TAXI_BLIP_CAR", 32);
			break;
		
		default:
			StringCopy(&cVar0, "InvalidEnum", 32);
			break;
	}
	return cVar0;
}
...
{
	_0x1033371FC8E842A7(*uParam0.f_51[0]);
}
...
void func_22(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_27(player_id())) && !func_24(player_id(), 0)) && !func_23())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_27(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_29(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_36(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_38(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
auto func_47(int iParam0, int iParam1)
{
	return func_48(iParam0, iParam1, 1);
}

auto func_48(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
{
	return func_50(get_player_ped(get_player_index()), vParam0, iParam3);
}

float func_50(int iParam0, Vector3 vParam1, int iParam2)
{
	if (is_entity_dead(iParam0, 0))
	{
		return -1f;
...
void func_52(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		case 5:
			Global_101154.f_17787.f_22[5] += iParam1;
		...
		case 6:
			...
			{
				Global_101154.f_17787.f_22[6] += iParam1;
			}
		...
		case 7:
			if (iParam1 > 0)
			{
				Global_101154.f_17787.f_22[7] += iParam1;
			}
			else
			{
		...
		case 10:
			Global_101154.f_17787.f_22[10] += iParam1;
			func_53("Total Money Earned = ", Global_101154.f_17787.f_22[10]);
			break;
		
		case 11:
			Global_101154.f_17787.f_22[11] += iParam1;
...
void func_56()
{
	...
	{
		func_60(13, floor(Global_101154.f_8884.f_3853));
	}
...
void func_72(auto uParam0, int iParam1)
{
	*uParam0[iParam1] = 70;
}

void func_73(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
bool func_80(int iParam0, auto uParam1)
{
	switch (iLocal_168)
	{
		case 0:
			if (!func_193() && func_107(iParam0, 0) > 1f)
			{
				if (func_32())
				{
					set_player_control(player_id(), true, 0);
				...
				func_104(uParam1, "TAXI_FARE_TITLE", *iParam0.f_50, *iParam0.f_56, *iParam0.f_50 + *iParam0.f_56 + *iParam0.f_105, *iParam0.f_105, func_105(iParam0), "TAXI_FARE_MID", 4000, 1);
				*uParam1.f_1 = 4000;
...
void func_86(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_88() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_88() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_90(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_88() /*10375*/].f_7704.f_10, iParam0);
}
...
void func_96()
{
	...
	{
		if (func_4(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_3(PLAYER::PLAYER_PED_ID());
...
void func_100(auto uParam0, Vector3 fParam1)
{
...
void func_104(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7, int iParam8, int iParam9)
{
	_push_scaleform_movie_function(*uParam0, "SHOW_SHARD_MIDSIZED_MESSAGE");
	_begin_text_component("STRING");
	_0x39BBF623FC803EAC(iParam9);
...
void func_110(int iParam0)
{
	...
	if (*iParam0.f_56 < *iParam0.f_58)
	{
		if (*iParam0.f_411 == 0)
		{
			func_236(iParam0, 105, 1, 0, 0);
		}
		else
		{
			func_236(iParam0, 103, 1, 0, 0);
		}
		func_111(1);
	}
	else if (*iParam0.f_56 >= *iParam0.f_59)
	{
		func_236(iParam0, 101, 1, 0, 0);
	}
	else
	{
		func_236(iParam0, 102, 1, 0, 0);
	}
...
bool func_117(auto uParam0, int iParam1, float fParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
int func_120(Vector3 vParam0, int iParam1)
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		...
		if (PED::IS_PED_INJURED(iParam1))
		{
			if (iParam3)
			{
				...
				{
					clear_ped_tasks(iLocal_890);
					task_smart_flee_ped(iLocal_890, PLAYER::PLAYER_PED_ID(), 100f, 20000, 0, 0);
					set_ped_keep_task(iLocal_890, true);
				}
				func_337(iParam0, "Target injured.", 13);
			}
			else
			{
				...
				{
					clear_ped_tasks(Local_853.f_2);
					task_smart_flee_ped(Local_853.f_2, PLAYER::PLAYER_PED_ID(), 100f, 20000, 0, 0);
					set_ped_keep_task(Local_853.f_2, true);
				}
				func_337(iParam0, "Mistress injured.", 14);
			}
		}
		else if (has_player_damaged_at_least_one_ped(player_id()))
		{
			if ((has_ped_been_damaged_by_weapon(iParam1, joaat("weapon_stungun"), 0) || has_ped_been_damaged_by_weapon(iParam1, false, 2)) || has_ped_been_damaged_by_weapon(iParam1, false, 1))
			{
				if (!is_entity_dead(iLocal_890, 0))
				{
					clear_ped_tasks(iLocal_890);
				...
				func_337(iParam0, "Passenger injured by player with weapon.", 14);
			}
			if (!iParam3)
			{
...
void func_123(int iParam0, auto uParam1)
{
	stat_get_float(*iParam0.f_428, uParam1, -1);
	...
	switch (iLocal_1143)
	{
		case 0:
			if (func_139(1, 1, 1) && !Local_423.f_142)
			{
				...
				func_233(vLocal_958, 0, 15f);
				func_233(vLocal_961, 0, 15f);
		...
		case 1:
			...
			{
				func_132(0, 0, 1);
				clear_area_of_vehicles(vLocal_958, 30f, 0, 0, 0, 0, false);
				clear_area_of_vehicles(vLocal_961, 30f, 0, 0, 0, 0, false);
				clear_area_of_peds(vLocal_958, 30f, 0);
				clear_area_of_peds(vLocal_961, 30f, 0);
				func_130(vLocal_958, 1114636288, 1);
				func_130(vLocal_961, 1114636288, 1);
				set_all_vehicle_generators_active_in_area(vLocal_946, vLocal_949, false, 1);
				func_236(&Local_423, 35, 1, 1, 0);
				set_cam_coord(Local_423, func_129(0));
				set_cam_rot(Local_423, func_128(0), 2);
				set_cam_fov(Local_423, 44.5167f);
				shake_cam(Local_423, "HAND_SHAKE", 0.1f);
				set_cam_active(Local_423, true);
				render_script_cams(true, false, 3000, 1, 0, 0);
				if (is_vehicle_driveable(Local_853.f_3, 0))
				{
					set_entity_coords(Local_853.f_3, vLocal_955, 1, false, 0, 1);
					...
					if (!is_entity_dead(Local_853.f_2, 0))
					{
						task_vehicle_follow_waypoint_recording(Local_853.f_2, Local_853.f_3, &cLocal_976, iLocal_1124, iLocal_899 + 4, 0, -1, -1f, 0, 2f);
					}
				}
				func_297(&Local_423, 19, 0, 0);
				iLocal_1143 = 2;
		...
		case 3:
			if (is_vehicle_driveable(Local_853.f_3, 0))
			{
				set_entity_coords(Local_853.f_3, vLocal_922, 1, false, 0, 1);
			...
			if (is_vehicle_driveable(Local_423.f_4, 0))
			{
				...
				if (is_vehicle_driveable(Local_853.f_3, 0))
				{
					...
					if (!is_entity_dead(Local_853.f_2, 0))
					{
						...
						set_entity_coords(Local_853.f_2, -691.1571f, -1117.732f, 13.52498f, 1, false, 0, 1);
						set_entity_heading(Local_853.f_2, -49.27436f);
					}
				}
				destroy_cam(Local_423, 0);
				destroy_cam(iLocal_422, 0);
				func_125(1, 1, 1);
				render_script_cams(false, false, 3000, 1, 0, 0);
...
void func_130(Vector3 vParam0, float fParam1, int iParam2)
{
	float fVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	vVar4 = {func_37(vVar1, func_131(fVar0), fParam3, fParam3, 5f)};
	vVar7 = {func_37(vVar1, fVar0, fParam3, fParam3, -5f)};
	vVar7.z -= 22f;
	vVar4.z += 22f;
	if (iParam4)
	{
		set_roads_in_area(vVar7, vVar4, false, 1);
	}
	else
	{
...
void func_134()
{
	...
	set_ped_component_variation(iLocal_890, 3, true, 2, 0);
	set_ped_component_variation(iLocal_890, 4, false, true, 0);
	set_ped_component_variation(iLocal_890, 2, true, 2, 0);
	...
	if (!is_entity_dead(iLocal_890, 0))
	{
		...
		task_stand_still(false, 2500);
		task_play_anim(false, "oddjobs@towingcome_here", "come_here_idle_a", 8f, -1.5f, 2000, 0, 0, 0, 0, 0);
		task_go_to_coord_any_means(false, vLocal_943, 1f, 0, 0, 786603, -1082130432);
		close_sequence_task(iVar0);
		task_perform_sequence(iLocal_890, iVar0);
		clear_sequence_task(&iVar0);
	}
}

void func_135(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
		*uParam0 = create_camera_with_params(26379945, vParam1, vParam4, fParam7, 0, 2);
	}
}

void func_136(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		*uParam0 = 0;
...
{
	if (func_143() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_147(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
...
bool func_149()
{
	if (func_107(&Local_423, 20) > 2f)
	{
		if (!Local_423.f_142)
		{
			func_170(&Local_423, &Local_853, GAMEPLAY::GET_GAME_TIMER() - iLocal_975 > 15000, 0);
		}
	}
	if (is_vehicle_driveable(Local_853.f_3, 0))
	{
		if (is_vehicle_driveable(Local_423.f_4, 0))
		{
			if (is_entity_in_angled_area(Local_423.f_4, vLocal_1044, vLocal_1047, fLocal_1050, 0, true, 0))
			{
				_task_bring_vehicle_to_halt(Local_423.f_4, 5f, 1, 0);
				return true;
			}
		}
		...
		if (!iLocal_903)
		{
			if (!is_entity_dead(Local_853.f_2, 0))
			{
				if (!is_playback_going_on_for_vehicle(Local_853.f_3) && IntToFloat(GAMEPLAY::GET_GAME_TIMER() - iLocal_975) > get_total_duration_of_vehicle_recording(120, "txm_fc_h1_"))
				{
...
void func_150(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_151(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_151(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	*uParam0.f_6 = 0;
	func_152(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_152(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_168(iParam1) && is_entity_visible(iParam1))
	{
		...
		if (!is_gameplay_hint_active())
		{
			if (func_163(uParam0, iParam7, iParam9, 0))
			{
				func_160(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
bool func_157(char* sParam0)
{
	if (!func_158(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_148(sParam0)) || func_148("CMN_HINT"))
		{
			clear_help(1);
		}
		return false;
...
void func_160(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_163(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		case 0:
			*uParam0.f_7 = 0;
			if (*uParam0.f_6 == 0)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					if (func_167(iParam1, iParam2, iParam3))
					{
				...
				else if (func_166(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
			...
			{
				if (func_166(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
		...
		case 2:
			...
			{
				if (!func_166(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
			else if (*uParam0.f_6 == 2)
			{
				...
				else if (!func_167(iParam1, iParam2, iParam3))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				if (*uParam0.f_6 == 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
					{
						if (func_165(iParam1, iParam2, iParam3))
						{
							*uParam0.f_5 = 0;
						}
					}
					else if (func_164(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_164(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				else if (*uParam0.f_6 == 2)
				{
					...
					else if (func_165(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
void func_170(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	if (!is_entity_dead(*uParam1.f_2, 0))
	{
		if (has_entity_been_damaged_by_entity(*uParam1.f_2, PLAYER::PLAYER_PED_ID(), 0))
		{
			func_337(iParam0, "Taxi shot up the car", 12);
		}
	}
	else
	{
		func_337(iParam0, "Followee died", 13);
	}
	if ((get_player_wanted_level(player_id()) > 0 && is_vehicle_driveable(*uParam1.f_3, 0)) && !is_entity_dead(*uParam1.f_2, 0))
	{
		task_vehicle_mission(*uParam1.f_2, *uParam1.f_3, *iParam0.f_4, 8, 100f, 786468, 1000f, 1000f, 1);
		set_ped_keep_task(*uParam1.f_2, true);
		func_337(iParam0, "Player went wanted", 4);
	}
	func_179(iParam0, uParam1);
	if (is_vehicle_driveable(*uParam1.f_3, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (iParam3)
		{
			...
			{
				draw_debug_sphere(get_entity_coords(*uParam1.f_3, 1), func_176(uParam1.f_3), 255, 0, 0, 60);
			}
		...
		if ((get_vehicle_engine_health(*uParam1.f_3) < *uParam1.f_15 || has_entity_been_damaged_by_entity(*uParam1.f_3, PLAYER::PLAYER_PED_ID(), 1)) || get_vehicle_petrol_tank_health(*uParam1.f_3) < *uParam1.f_16)
		{
			if (has_entity_been_damaged_by_entity(*uParam1.f_3, PLAYER::PLAYER_PED_ID(), 0))
			{
				func_337(iParam0, "Taxi shot up the car", 12);
			}
			if (func_107(iParam0, 13) > 5f)
			{
				func_174(iParam0, uParam1, 1);
			}
			else
			{
		...
		if (func_48(*iParam0.f_4, *uParam1.f_3, 1) >= 120f)
		{
			...
			{
				func_236(iParam0, 143, 0, 0, 0);
				func_337(iParam0, "Taxi let the Chasee lose him", 2);
			}
			else if (!*uParam1.f_21)
			{
				if ((func_173(iParam0.f_409, get_entity_coords(*iParam0.f_4, 1), get_entity_coords(*uParam1.f_3, 1), 0) == -1 && func_48(*iParam0.f_4, *uParam1.f_3, 1) >= 150f) && func_107(iParam0, 8) > 10f)
				{
					*uParam1.f_21 = 1;
					*uParam1.f_23 = 0;
					*uParam1.f_9++;
					func_297(iParam0, 8, 0, 0);
					if (*uParam1.f_9 > 3)
					{
					...
					{
						func_172(iParam0, 6, 1);
					}
					else
					{
						func_172(iParam0, 1, 1);
					}
					func_236(iParam0, 13, 1, 0, 0);
				}
			}
		...
		else if (((func_48(*iParam0.f_4, *uParam1.f_3, 1) < 22.5f && func_178(uParam1.f_3)) || (func_48(*iParam0.f_4, *uParam1.f_3, 1) < 13f && func_175(uParam1.f_3))) || (func_48(*iParam0.f_4, *uParam1.f_3, 1) < func_176(uParam1.f_3) && func_177(uParam1.f_3)))
		{
			if (!*uParam1.f_22 || func_171(iParam0, 21))
			{
				if ((has_entity_clear_los_to_entity(*iParam0.f_4, *uParam1.f_3, 17) && func_107(iParam0, 8) > 10f) && iParam2)
				{
					*uParam1.f_22 = 1;
					*uParam1.f_23 = 0;
					*uParam1.f_8++;
					*uParam1.f_9++;
					func_297(iParam0, 8, 0, 0);
					if (!func_171(iParam0, 21))
					{
						func_297(iParam0, 21, 0, 0);
					}
					if (*uParam1.f_9 > 3)
					{
						if (!func_193())
						{
							...
							func_337(iParam0, "Taxi was ID'd by the Chasee", 3);
						}
						else
						{
							func_141();
		...
		else
		{
			...
			if (*uParam1.f_21)
			{
				if (func_48(*iParam0.f_4, *uParam1.f_3, 1) < 150f && has_entity_clear_los_to_entity(*iParam0.f_4, *uParam1.f_3, 17))
				{
					*uParam1.f_21 = 0;
					func_297(iParam0, 8, 0, 0);
				}
			...
			else
			{
				...
				{
					if (func_107(iParam0, 8) > 15f && !func_193())
					{
						func_172(iParam0, 9, 1);
						func_236(iParam0, 13, 1, 0, 0);
						func_297(iParam0, 8, 0, 0);
					}
				}
...
int func_173(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3)
{
	auto uVar0;
	auto uVar3;
	int iVar6;
	...
	if (*uParam0 == 0)
	{
		*uParam0 = _0x7EE9F5D83DD4F90E(vParam1, vParam4, 511, false, 7);
		if (iParam7)
		{
		}
	}
	...
	{
		iVar8 = _get_raycast_result(*uParam0, &iVar6, &uVar0, &uVar3, &uVar7);
		if (iVar8 == 2)
		{
			if (iParam7)
			{
...
void func_174(int iParam0, auto uParam1, int iParam2)
{
	*uParam1.f_6++;
	*uParam1.f_9++;
	if (*uParam1.f_6 >= 1)
	...
	{
		func_297(iParam0, 13, 0, 0);
		clear_entity_last_damage_entity(*uParam1.f_3);
		func_172(iParam0, 10, 1);
...
void func_179(int iParam0, auto uParam1)
{
	if (is_vehicle_driveable(*uParam1.f_3, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_48(*iParam0.f_4, *uParam1.f_3, 1) < 120f)
...
void func_181(int iParam0, Vector3 vParam1, float fParam2, auto uParam3, int iParam4)
{
	if (!func_193())
	{
	...
	if (get_player_wanted_level(get_player_index()) < 1)
	{
		if (PED::IS_PED_INJURED(iParam0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					set_player_wanted_level(get_player_index(), true, 0);
...
{
	if (is_vehicle_driveable(*iParam0.f_4, 0))
	{
		if (get_ped_in_vehicle_seat(*iParam0.f_4, -1) == PLAYER::PLAYER_PED_ID())
		{
			return true;
		}
	}
	...
	switch (iLocal_1144)
	{
		case 0:
			if (func_139(1, 1, 1))
			{
				...
				if (func_200(&Local_853, vLocal_934, fLocal_973))
				{
					set_roads_in_area(1346.9f, -1606.52f, 31.16f, 1457.25f, -1508.19f, 83.05f, true, 1);
					func_135(&Local_423, 0f, 0f, 0f, 0f, 0f, 0f, 1112014848);
			...
			if (func_107(&Local_423, 19) > 3f)
			{
				if (!PED::IS_PED_INJURED(Local_853.f_2))
				{
					...
					if (is_vehicle_driveable(Local_853.f_3, 0))
					{
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						task_enter_vehicle(false, Local_853.f_3, 20000, -1, 1f, 1, 0);
						task_play_anim(false, "veh@truck@ds@base", "start_engine", 8f, -8f, -1, 0, 0, 0, 0, 0);
						close_sequence_task(iLocal_414);
						task_perform_sequence(Local_853.f_2, iLocal_414);
						set_vehicle_doors_locked(Local_853.f_3, 1);
					}
				}
				set_ped_coords_keep_vehicle(PLAYER::PLAYER_PED_ID(), Local_423.f_17);
				set_cam_coord(Local_423, func_199(0));
				set_cam_rot(Local_423, func_198(0), 2);
		...
		case 2:
			iLocal_422 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
			set_cam_coord(iLocal_422, func_199(4));
			set_cam_rot(iLocal_422, func_198(0), 2);
			set_cam_fov(iLocal_422, 17.2f);
			shake_cam(iLocal_422, "HAND_SHAKE", 0.1f);
			set_cam_active_with_interp(iLocal_422, Local_423, 6000, 1, 1);
			func_297(&Local_423, 19, 0, 0);
			iLocal_1144 = 3;
			break;
		...
		case 3:
			...
			{
				set_cam_coord(Local_423, func_199(2));
		...
		case 4:
			set_cam_coord(iLocal_422, func_199(2));
			point_cam_at_entity(iLocal_422, Local_853.f_3, 0f, 0f, 0f, 1);
			set_cam_fov(iLocal_422, 45f);
			shake_cam(iLocal_422, "HAND_SHAKE", 0.2f);
			set_cam_active_with_interp(iLocal_422, Local_423, 10000, 1, 1);
			func_297(&Local_423, 19, 0, 0);
			iLocal_1144 = 11;
			break;
		...
		case 11:
			...
			{
				set_state_of_closest_door_of_type(1230099731, 413.8f, -1416.19f, 29.26f, false, 0.85f, 0);
			}
...
void func_195()
{
	...
	if (!PED::IS_PED_INJURED(Local_853.f_2))
	{
		if (is_vehicle_driveable(Local_853.f_3, 0))
		{
			...
			{
				set_entity_coords(Local_853.f_3, 406.612f, -1419.937f, 29.00375f, 1, false, 0, 1);
				...
				set_entity_load_collision_flag(Local_853.f_3, true);
				set_entity_load_collision_flag(Local_853.f_2, true);
				if (!does_blip_exist(Local_853.f_4))
				{
...
int func_197(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_121(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
	else if (is_entity_an_object(iParam0))
	{
...
bool func_200(auto uParam0, Vector3 vParam1, Vector3 fParam2)
{
	...
	{
		set_ped_component_variation(*uParam0.f_2, false, true, false, 0);
		set_ped_component_variation(*uParam0.f_2, 3, false, false, 0);
		set_ped_component_variation(*uParam0.f_2, 4, false, true, 0);
		set_ped_component_variation(*uParam0.f_2, 8, false, false, 0);
		set_ped_component_variation(*uParam0.f_2, 11, false, true, 0);
...
int func_201(auto uParam0, float fParam1, float fParam2, float fParam3)
{
...
int func_202(auto uParam0, float fParam1)
{
	if (func_63(uParam0) == 2)
	{
		...
		if (((func_203(*uParam0.f_4, *uParam0.f_17, 1) <= fParam1 + 1f && get_player_wanted_level(get_player_index()) < 1) && func_139(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
		{
			return func_117(uParam0, 1, fParam1);
		}
	}
	else if (((is_entity_at_coord(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_139(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_117(uParam0, 1, fParam1);
	}
	return 0;
...
auto func_203(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_204(auto uParam0)
{
	...
	if ((func_205(uParam0) && func_21(*uParam0.f_81, 67108864)) && get_player_wanted_level(player_id()) == 0)
	{
...
void func_206(auto uParam0, float fParam1, float fParam2)
{
	...
	{
		if ((is_vehicle_stopped(*uParam0.f_4) || get_entity_speed(*uParam0.f_4) < 3f) && func_189(uParam0))
		{
		...
		switch (*uParam0.f_412)
		{
			case 0:
				if (get_player_wanted_level(get_player_index()) >= 1)
				{
					...
					{
						func_212(uParam0, get_player_wanted_level(get_player_index()));
						if (*uParam0.f_410 != 22)
						{
			...
			case 3:
				if (is_player_wanted_level_greater(get_player_index(), func_210(uParam0)))
				{
					func_212(uParam0, get_player_wanted_level(get_player_index()));
					func_52(6, 0);
				}
...
auto func_211(char* sParam0, int iParam1, char* sParam2)
{
...
auto func_215(int iParam0, int iParam1)
{
	return func_48(get_player_ped(get_player_index()), iParam0, iParam1);
}
...
void func_217(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1)
	{
		func_418(uParam0);
...
void func_219()
{
	...
	{
		play_sound_from_entity(-1, "Radio_Off", iVar0, "TAXI_SOUNDS", 0, 0);
	}
}

void func_220(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
bool func_223(auto uParam0)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		if (get_ped_in_vehicle_seat(*uParam0.f_4, -1) == *uParam0.f_2)
		{
			if (func_171(uParam0, 14))
			{
				func_224(uParam0);
...
void func_226()
{
	...
	if (is_vehicle_driveable(iVar0, 0))
	{
		play_sound_from_entity(-1, "Radio_On", iVar0, "TAXI_SOUNDS", 0, 0);
	}
}

void func_227(int iParam0, auto uParam1)
{
	func_122(iParam0, *uParam1.f_2, 1, 1);
	if (is_vehicle_driveable(*uParam1.f_3, 0))
	{
		if (has_entity_been_damaged_by_entity(*uParam1.f_3, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_193())
			{
...
bool func_228(auto uParam0, Vector3 vParam1, float fParam2)
{
	*uParam0.f_17 = {vParam1};
	*uParam0.f_10 = fParam4;
	*uParam0.f_3 = create_vehicle(*uParam0.f_1, *uParam0.f_17, *uParam0.f_10, 1, true);
	set_vehicle_model_is_suppressed(*uParam0.f_1, true);
	set_model_as_no_longer_needed(*uParam0.f_1);
	iLocal_417[0] = create_vehicle(iLocal_888, 404.9912f, -1423.974f, 28.4638f, 227.5235f, 1, true);
	iLocal_417[1] = create_vehicle(iLocal_888, 402.2958f, -1427.018f, 28.4632f, 226.6982f, 1, true);
	iLocal_417[2] = create_vehicle(iLocal_889, 398.415f, -1428.167f, 28.4504f, 226.4081f, 1, true);
	set_vehicle_doors_locked(iLocal_417[0], 2);
	set_vehicle_doors_locked(iLocal_417[1], 2);
	set_vehicle_doors_locked(iLocal_417[2], 2);
	set_vehicle_number_plate_text(iLocal_417[0], "BRAVEST");
	set_vehicle_number_plate_text(iLocal_417[1], "BOLDEST");
	set_vehicle_number_plate_text(iLocal_417[2], "BADDEST");
	set_entity_health(*uParam0.f_3, 800);
	...
	*uParam0.f_31 = 1;
	...
	func_233(vLocal_958, 1, 15f);
	func_233(vLocal_961, 1, 15f);
...
bool func_229()
{
	...
	if (!has_vehicle_recording_been_loaded(false, "taxi_oj_fc3"))
	{
...
void func_230(int iParam0, auto uParam1)
{
	if (is_vehicle_driveable(*iParam0.f_4, 0))
	{
		if (!is_ped_in_vehicle(*iParam0.f_2, *iParam0.f_4, 0))
		{
			if (!func_171(iParam0, 14))
			{
				...
				func_236(iParam0, 2, 1, 0, 0);
			}
			else if (func_107(iParam0, 14) > 20f)
			{
				func_337(iParam0, "Player not in taxi - HANDLE BLIPS", 8);
			}
		}
		else
		{
...
void func_232(auto uParam0, int iParam1)
{
	...
	if (iParam1 > 0)
	{
		render_script_cams(false, true, iParam1, 1, 0, 0);
	}
	else
	{
		render_script_cams(false, false, 3000, 1, 0, 0);
...
void func_233(Vector3 vParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
	...
	if (!iParam3)
	{
		set_roads_in_area(vVar0, vVar3, false, 1);
	}
	else
	{
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	*iParam0.f_416 = iParam1;
	...
	func_261(iParam0, iParam2, iParam3);
}

bool func_237(auto uParam0)
{
	struct<6> Var0;
	struct<6> Var6;
...
bool func_240(auto uParam0)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		if (!PED::IS_PED_INJURED(*uParam0.f_3))
		{
			if ((is_ped_getting_into_a_vehicle(*uParam0.f_3) && GAMEPLAY::GET_GAME_TIMER() - iLocal_89 > 500) || is_ped_in_vehicle(*uParam0.f_3, *uParam0.f_4, 1))
			{
				return true;
			}
		}
...
void func_241()
{
	...
	request_vehicle_recording(false, "taxi_oj_fc3");
	request_waypoint_recording(&cLocal_976);
	request_anim_dict("veh@truck@ds@base");
}

bool func_242(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_48(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_203(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_203(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
					...
					case 1:
								...
								*uParam0.f_7 = func_253(*uParam0.f_4, *uParam0.f_3);
								...
								if (!is_entity_dead(iVar0, 0))
								{
									if (iVar1 == *uParam0.f_7)
									{
										...
										task_leave_any_vehicle(iVar0, false, iVar2);
									}
									else
									{
										task_leave_any_vehicle(iVar0, false, 0);
									}
								}
								if (*uParam0.f_411 == 0)
								{
									if (_0x639431E895B9AA57(*uParam0.f_3, *uParam0.f_4, 0, 0, false))
									{
										if (*uParam0.f_7 == 2)
										{
											*uParam0.f_7 = 0;
						...
						else
						{
							...
							else if (((get_script_task_status(*uParam0.f_3, 242628503) != 1 && get_script_task_status(*uParam0.f_3, 242628503) != 0) && get_script_task_status(*uParam0.f_3, 242628503) != 7) && func_258(uParam0, *uParam0.f_3) > 8f)
							{
...
bool func_244(auto uParam0)
{
	...
	if ((iLocal_86 < 7 && iLocal_86 > 0) && !iLocal_94)
	{
	...
	switch (iLocal_86)
	{
				...
				*uParam0.f_7 = func_253(*uParam0.f_4, *uParam0.f_3);
				...
				if (!is_entity_dead(iVar9, 0))
				{
					if (iVar10 == *uParam0.f_7)
					{
						...
						task_leave_any_vehicle(iVar9, false, iVar11);
					}
					else
					{
						task_leave_any_vehicle(iVar9, false, 0);
					}
				}
				if (*uParam0.f_411 == 0)
				{
		...
		case 2:
			...
			iVar12 = func_173(uParam0.f_409, get_offset_from_entity_in_world_coords(*uParam0.f_4, 0f, 2.2f, 0.275f), get_offset_from_entity_in_world_coords(*uParam0.f_4, vVar0), 1);
			if (iVar12 == 1)
			{
				vVar0.z += 1.5f;
				if (*uParam0.f_7 == 2)
			...
			if (iVar12 != -1)
			{
				...
				set_entity_coords(*uParam0.f_3, vVar13, 1, false, 0, 1);
				set_entity_heading(*uParam0.f_3, func_246(uParam0));
		...
		case 7:
			if (!is_entity_dead(*uParam0.f_3, 0) && !is_entity_dead(*uParam0.f_4, 0))
			{
				if (!is_ped_in_any_vehicle(*uParam0.f_3, 0))
				{
					...
					set_vehicle_door_shut(*uParam0.f_4, func_245(*uParam0.f_7), 1);
				}
				render_script_cams(false, false, 3000, 1, 0, 0);
				destroy_cam(*uParam0, 0);
...
float func_246(auto uParam0)
{
	...
	fVar0 = func_247(get_entity_coords(*uParam0.f_3, 1), vVar1);
	return fVar0;
}

float func_247(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
...
bool func_249(auto uParam0)
{
	if ((get_entity_speed(*uParam0.f_4) > 3f && func_107(uParam0, 5) > 15f) || is_entity_upsidedown(*uParam0.f_4))
	{
		return true;
	}
	return false;
...
bool func_251(auto uParam0, int iParam1)
{
	int[] iVar0 = new int[3];
	int iVar4;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		iVar0[0] = get_ped_in_vehicle_seat(*uParam0.f_4, true);
		iVar0[1] = get_ped_in_vehicle_seat(*uParam0.f_4, 2);
		iVar0[2] = get_ped_in_vehicle_seat(*uParam0.f_4, false);
		iVar4 = 0;
		while (iVar4 < 3)
		{
...
int func_252(auto uParam0, auto uParam1)
{
	int iVar0;
	
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		iVar0 = get_ped_in_vehicle_seat(*uParam0.f_4, true);
		...
		{
			iVar0 = get_ped_in_vehicle_seat(*uParam0.f_4, 2);
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				*uParam1 = 2;
				return iVar0;
			...
			{
				iVar0 = get_ped_in_vehicle_seat(*uParam0.f_4, false);
				if (ENTITY::DOES_ENTITY_EXIST(iVar0))
				{
					*uParam1 = 0;
					return iVar0;
...
int func_253(int iParam0, int iParam1)
{
	...
	{
		if (_0x639431E895B9AA57(iParam1, iParam0, 2, 0, false))
		{
			iVar3 = 2;
		}
		else if (_0x639431E895B9AA57(iParam1, iParam0, 1, 0, false))
		{
			iVar3 = 1;
		}
		else
	...
	else if (_0x639431E895B9AA57(iParam1, iParam0, 2, 0, false))
	{
		iVar3 = 2;
	}
	else
...
bool func_254(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (!is_entity_occluded(*uParam0.f_3) && func_215(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_107(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !is_entity_occluded(*uParam0.f_3)) || func_215(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
...
bool func_255(auto uParam0, float fParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_48(*uParam0.f_4, *uParam0.f_3, 0) <= fParam1 && !*uParam0.f_142) && absf(vVar0.z - vVar3.z) < 5f)
			{
				if (*uParam0.f_409 == 0)
				{
					*uParam0.f_409 = _0x7EE9F5D83DD4F90E(vVar0, vVar3, 511, false, 7);
				}
				else
				{
					iVar17 = _get_raycast_result(*uParam0.f_409, &iVar15, &uVar9, &uVar12, &uVar16);
					if (iVar17 == 2)
					{
						if (iVar15 == 0)
						{
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_257(iParam3), 0);
}
...
float func_258(auto uParam0, int iParam1)
{
	if (!is_entity_dead(iParam1, 0))
	{
		if (func_189(uParam0))
...
bool func_262(auto uParam0, int iParam1)
{
	...
	if (func_21(*uParam0.f_44, 8))
	{
		if (!func_21(*uParam0.f_44, 128))
		{
			if (is_ped_jacking(PLAYER::PLAYER_PED_ID()) && !func_21(*uParam0.f_44, 256))
			{
				func_64(uParam0.f_44, 256);
			}
			if (func_21(*uParam0.f_44, 256) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
	...
	if (!func_265(uParam0, iParam1))
	{
		...
		if ((PED::IS_PED_INJURED(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_215(*uParam0.f_3, 1) > 400f)
		{
...
bool func_265(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_268(auto uParam0, auto uParam1)
{
	int iVar0;
	...
	if (*uParam1 <= 5)
	{
		...
		while (iVar0 <= 4)
		{
			GAMEPLAY::CLEAR_BIT(uParam0.f_60[iVar0 /*3*/], true);
			iVar0++;
		}
		iVar0 = 0;
		iVar0 = 0;
...
void func_269(auto uParam0, char* sParam1, int iParam2)
{
	*uParam0 = 0;
	*uParam0.f_1 = iParam2;
	*uParam0.f_2 = sParam1;
...
{
	Local_343 = 0;
	func_287(44438/*func_289*/, 44413/*func_288*/, 1);
	func_287(44174/*func_285*/, 44150/*func_284*/, 1);
	func_287(44088/*func_283*/, 44063/*func_282*/, 1);
	func_287(43991/*func_281*/, 43967/*func_280*/, 1);
	func_287(43857/*func_279*/, 43836/*func_278*/, 1);
	func_287(43783/*func_276*/, 43758/*func_275*/, 1);
	func_287(43616/*func_272*/, 43592/*func_271*/, 1);
}

bool func_271(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Taxi Not Driveable", 1);
	return true;
}

bool func_272(auto uParam0)
{
...
bool func_275(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Didn't lose police in time.", 9);
	return true;
}

bool func_276(auto uParam0)
{
	if (get_player_wanted_level(player_id()) > 0)
	{
...
int func_277(auto uParam0, int iParam1)
{
	return (uParam0 && iParam1) != 0;
}

bool func_278(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_273(uParam0, 11);
	return true;
...
bool func_280(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Taxi Is Flipped", 0);
	return true;
}

bool func_281(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_4, 0))
	{
...
bool func_282(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Stayed stopped for too long.", 9);
	return true;
}

bool func_283(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_4, 0))
	{
		if (is_vehicle_driveable(*uParam0.f_4, 0))
...
bool func_284(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Taxi Not Driveable", 0);
	return true;
}

bool func_285(auto uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_4))
	{
...
bool func_288(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_337(iParam0, "Passenger injured.", 15);
	return true;
}

bool func_289(auto uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_3))
	{
...
bool func_294(auto uParam0)
{
	if (!PED::IS_PED_INJURED(*uParam0.f_3))
	{
		*uParam0.f_8 = func_196(*uParam0.f_3, 0, 0);
		...
		task_look_at_entity(*uParam0.f_3, PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
	}
	return true;
}

bool func_295(auto uParam0, Vector3 vParam1, Vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_3))
	{
		...
		*uParam0.f_14 = {vParam4};
		...
		else if (ENTITY::DOES_ENTITY_EXIST(Global_99866.f_225[0]))
		{
...
void func_296(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_51[0] = _0x2CE544C68FB812A0(vParam1, 20f, 5f, 0);
}

void func_297(int iParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
...
bool func_305(auto uParam0)
{
	...
	if ((((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_13(&(Local_190[0 /*10*/].f_3))) && !func_13(&(Local_190[1 /*10*/].f_3))) && !func_13(&(Local_190[5 /*10*/].f_3))) && !func_13(&(Local_190[9 /*10*/].f_3))) && !func_13(&(Local_190[7 /*10*/].f_3))) && !func_13(&(Local_190[8 /*10*/].f_3)))
	{
		...
		if (absf(vVar0.x) > 2.5f && !func_13(&(Local_190[0 /*10*/].f_3)))
		{
			...
			else if (func_99(&(Local_190[11 /*10*/].f_3)) < 1.5f && absf(fLocal_342) - absf(vVar0.x) < 0f)
			{
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_13(&(Local_190[0 /*10*/].f_3))) && !func_13(&(Local_190[8 /*10*/].f_3))) && !func_13(&(Local_190[5 /*10*/].f_3))) && !func_13(&(Local_190[9 /*10*/].f_3))) && !func_13(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_13(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(get_entity_coords(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_48(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!is_entity_dead(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
					func_108(&(Local_190[14 /*10*/].f_3));
				}
			}
		}
		else if ((func_99(&(Local_190[14 /*10*/].f_3)) < 1.5f && func_48(*uParam0.f_5, *uParam0.f_4, 1) > 4.5f) && !has_entity_been_damaged_by_any_vehicle(*uParam0.f_5))
		{
...
int func_308(int iParam0)
{
	...
	vVar24 = {vVar24};
	return func_309(get_entity_coords(iParam0, 1), vVar15, vVar18, vVar21);
}

bool func_309(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_313(auto uParam0)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		if (get_ped_in_vehicle_seat(*uParam0.f_4, -1) == PLAYER::PLAYER_PED_ID())
		{
			if (has_player_damaged_at_least_one_ped(player_id()))
			{
				return true;
...
{
	*uParam0.f_76 += Local_190[uParam1 /*10*/];
}
...
void func_325()
{
	...
	if ((Local_423.f_410 >= 28 && !iLocal_905) && ((has_entity_been_damaged_by_entity(Local_423.f_3, PLAYER::PLAYER_PED_ID(), 1) || has_entity_been_damaged_by_entity(iLocal_890, PLAYER::PLAYER_PED_ID(), 1)) || has_entity_been_damaged_by_entity(Local_853.f_2, PLAYER::PLAYER_PED_ID(), 1)))
	{
		iLocal_905 = 1;
	}
	...
	if (iLocal_1142 >= 4)
	{
		if (func_215(Local_423.f_3, 1) < 3f && !iLocal_904)
		{
			if (!func_193())
			{
				...
				task_aim_gun_at_entity(Local_423.f_3, PLAYER::PLAYER_PED_ID(), -1, 0);
	...
	switch (iLocal_1142)
	{
		case 0:
			...
			{
				add_relationship_group("TAXI_Whore", &iLocal_893);
				iLocal_892 = get_ped_relationship_group_hash(Local_423.f_3);
				...
				set_blocking_of_non_temporary_events(Local_853.f_2, true);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_853.f_2, 17, true);
				set_entity_health(Local_853.f_2, 130);
				set_ped_suffers_critical_hits(Local_853.f_2, 1);
				set_ped_dies_when_injured(Local_853.f_2, true);
				clear_ped_tasks(Local_853.f_2);
				set_blocking_of_non_temporary_events(iLocal_890, true);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_890, 17, true);
				set_entity_health(iLocal_890, 130);
				set_ped_suffers_critical_hits(iLocal_890, 1);
				set_ped_dies_when_injured(iLocal_890, true);
				clear_ped_tasks(iLocal_890);
				iLocal_1142 = 1;
			}
			break;
		...
		case 1:
			if (((!is_entity_dead(Local_853.f_2, 0) && !is_entity_dead(Local_423.f_3, 0)) && !is_entity_dead(iLocal_890, 0)) && !is_entity_dead(Local_853.f_3, 0))
			{
				clear_sequence_task(&iLocal_414);
				open_sequence_task(&iLocal_414);
				task_turn_ped_to_face_entity(false, iLocal_890, false);
				task_play_anim(false, &cLocal_980, "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
				task_play_anim(false, &cLocal_996, "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
				close_sequence_task(iLocal_414);
				task_perform_sequence(Local_853.f_2, iLocal_414);
				clear_sequence_task(&iLocal_414);
				clear_sequence_task(&iLocal_415);
				open_sequence_task(&iLocal_415);
				task_turn_ped_to_face_entity(false, Local_853.f_2, false);
				task_play_anim(false, &cLocal_1012, "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				close_sequence_task(iLocal_415);
				task_perform_sequence(iLocal_890, iLocal_415);
				clear_sequence_task(&iLocal_415);
				iLocal_1142 = 2;
			}
			break;
		...
		case 2:
			if (iLocal_906)
			{
				if (!is_entity_dead(iLocal_890, 0) && !is_entity_dead(Local_423.f_3, 0))
				{
					...
					set_entity_health(Local_423.f_3, 105);
					clear_ped_tasks(Local_423.f_3);
					clear_sequence_task(&iLocal_416);
					open_sequence_task(&iLocal_416);
					task_stand_still(false, 5000);
					func_327(&Local_423, -691.48f, -1113.31f, 13.53f);
					task_go_to_coord_while_aiming_at_entity(0, func_326(iLocal_413), iLocal_890, 3f, true, 0.5f, 4f, true, 0, 0, -957453492, 20000);
					task_shoot_at_entity(false, iLocal_890, -1, -957453492);
					close_sequence_task(iLocal_416);
					task_perform_sequence(Local_423.f_3, iLocal_416);
					clear_sequence_task(&iLocal_416);
					iLocal_902 = 1;
					set_player_control(player_id(), false, 256);
					give_weapon_to_ped(Local_423.f_3, joaat("weapon_pistol"), 100, true, true);
					iLocal_1142 = 3;
				}
			}
			else if (!iLocal_909)
			{
				if (!PED::IS_PED_INJURED(Local_853.f_2) && !PED::IS_PED_INJURED(iLocal_890))
				{
					if (func_215(Local_853.f_2, 1) < 2f || func_215(iLocal_890, 1) < 2f)
					{
						clear_ped_tasks(Local_853.f_2);
						clear_ped_tasks(iLocal_890);
						task_look_at_entity(Local_853.f_2, PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
						clear_sequence_task(&iLocal_414);
						open_sequence_task(&iLocal_414);
						task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
						close_sequence_task(iLocal_414);
						task_perform_sequence(Local_853.f_2, iLocal_414);
						task_look_at_entity(iLocal_890, PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
						clear_sequence_task(&iLocal_415);
						open_sequence_task(&iLocal_415);
						task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
						close_sequence_task(iLocal_415);
		...
		case 3:
			...
			if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_dead(Local_423.f_3, 0))
			{
			...
			if (((!PED::IS_PED_INJURED(iLocal_890) && has_entity_been_damaged_by_any_ped(iLocal_890)) && !is_entity_dead(Local_853.f_2, 0)) && !iLocal_908)
			{
				task_look_at_entity(Local_853.f_2, Local_423.f_3, -1, 2048, 4);
				clear_sequence_task(&iLocal_414);
				open_sequence_task(&iLocal_414);
				task_stand_still(false, 500);
				task_play_anim(false, "MOVE_DUCK_FOR_COVER", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
				task_play_anim(false, "MOVE_DUCK_FOR_COVER", "loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
				task_turn_ped_to_face_entity(false, Local_423.f_3, false);
				close_sequence_task(iLocal_414);
				task_perform_sequence(Local_853.f_2, iLocal_414);
				iLocal_908 = true;
			}
			if (!is_entity_dead(Local_423.f_3, 0) && !is_entity_dead(Local_853.f_2, 0))
			{
				if (get_sequence_progress(Local_423.f_3) > 2)
				{
					...
					task_aim_gun_at_entity(false, Local_853.f_2, 2000, 0);
					close_sequence_task(iLocal_416);
					task_perform_sequence(Local_423.f_3, iLocal_416);
					iLocal_1142 = 4;
				}
			...
			if (is_entity_dead(iLocal_890, 0))
			{
				if (!is_entity_dead(Local_853.f_2, 0))
				{
					if (!is_entity_dead(Local_423.f_3, 0))
					{
						clear_sequence_task(&iLocal_415);
						open_sequence_task(&iLocal_415);
						task_go_to_coord_while_aiming_at_entity(0, -691.48f, -1113.31f, 13.53f, Local_853.f_2, 1f, false, 0.5f, 4f, true, 0, 0, -957453492, 20000);
						task_aim_gun_at_entity(false, Local_853.f_2, -1, 1);
						close_sequence_task(iLocal_415);
						task_perform_sequence(Local_423.f_3, iLocal_415);
					}
				}
				iLocal_1142 = 6;
			}
		...
		case 7:
			...
			if (is_entity_dead(Local_853.f_2, 0) && !is_entity_dead(Local_423.f_3, 0))
			{
				...
				open_sequence_task(&iLocal_416);
				task_aim_gun_at_coord(false, vVar0, 1000, 0, 0);
				task_swap_weapon(false, 0);
				task_stand_still(false, 500);
				task_smart_flee_coord(false, -691.48f, -1113.31f, 13.53f, 1000f, -1, 0, 0);
				close_sequence_task(iLocal_416);
				task_perform_sequence(Local_423.f_3, iLocal_416);
				clear_sequence_task(&iLocal_416);
				set_ped_keep_task(Local_423.f_3, true);
...
void func_327(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		if (!is_entity_dead(*uParam0.f_3, 0))
		{
			...
			{
				task_leave_vehicle(false, *uParam0.f_4, 512);
			}
		}
	}
}

int func_328(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_329(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_336(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_337(int iParam0, char* sParam1, int iParam2)
{
	...
	func_438(2);
	Var0 = {func_344()};
	if ((!is_string_null_or_empty(&Var0) && func_193()) && !are_strings_equal(&Var0, "NULL"))
	{
	}
	else
	{
		...
		*iParam0.f_415 = iParam2;
		...
		if (iParam2 == 8 || iParam2 == 18)
		{
			...
			{
				func_256(*iParam0.f_3, "TAXI_FAIL", *iParam0.f_145, 4);
			}
		...
		else if (iParam2 == 14)
		{
			...
			{
				func_256(*iParam0.f_3, "CALL_COPS_COMMIT", *iParam0.f_145, 4);
			}
		...
		else if (iParam2 == 11)
		{
			...
			{
				func_256(*iParam0.f_3, "GENERIC_INSULT_MED", *iParam0.f_145, 4);
			}
			func_339(iParam0, 0, 0);
			func_342(iParam0, &Var0);
		...
		else if (iParam2 == 19)
		{
			...
			func_338(&Var0);
			func_328(iParam0.f_244, "OJTXAUD", &Var0, 7, 0, 0, 0);
...
void func_339(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		...
		clear_ped_tasks(*uParam0.f_3);
		if ((func_50(*uParam0.f_3, *uParam0.f_29, 1) <= 200f && !func_341(*uParam0.f_29)) && !iParam2)
		{
			func_340(uParam0);
		}
		else
...
void func_340(auto uParam0)
{
	...
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		...
		else
		{
			...
			task_set_blocking_of_non_temporary_events(false, 0);
			task_follow_nav_mesh_to_coord(false, *uParam0.f_29, 1f, -1, 0.25f, 0, 1193033728);
			if (*uParam0.f_411 == 2)
			{
			...
			{
				task_climb_ladder(false, 1);
				task_follow_nav_mesh_to_coord(false, 813.9421f, 1172.681f, 329.7988f, 1f, -1, 0.25f, 0, 1193033728);
				task_achieve_heading(false, 151.7794f, 0);
				task_start_scenario_in_place(false, "WORLD_HUMAN_SMOKING_POT", 0, 0);
			}
			else if (*uParam0.f_411 == 4)
			{
				task_use_nearest_scenario_to_coord(false, *uParam0.f_29, 15f, 0);
			}
			else if (*uParam0.f_411 == 1)
			{
				task_use_nearest_scenario_to_coord(false, *uParam0.f_29, 15f, 20000);
				task_wander_standard(false, 1193033728, 0);
			}
			else
			{
...
void func_342(auto uParam0, char* sParam1)
{
	if (func_343(uParam0))
	{
...
bool func_343(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_48(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
...
void func_346()
{
		...
		switch (Local_1052.f_27)
		{
			case 0:
				if (Local_423.f_410 == 17)
				{
					...
					{
						if (func_373("TAXI_OBJ_FTC1") || does_blip_exist(Local_423.f_9))
						{
							Local_1052.f_27++;
						}
	...
	func_347(&Local_423, &uLocal_1082, &Local_1052, iLocal_1051);
}

bool func_347(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	...
	if (!*uParam0.f_109)
	{
		switch (*uParam2)
		{
			...
			case 2:
				...
				{
					func_65(uParam2.f_26, round(pow(2f, to_float(*uParam2.f_27))));
					*uParam2.f_27++;
					func_350(uParam1);
...
int func_348(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
struct<6> func_352(auto uParam0)
{
	int iVar0;
	struct<6> Var1;
...
void func_355(auto uParam0, auto uParam1)
{
	struct<6> Var0;
	struct<6> Var6;
	int iVar12;
	...
	else if (func_171(uParam0, 14))
	{
		...
		switch (func_180(uParam0))
		{
			case 55:
				...
				Var6 = {Var0};
				func_372(uParam0.f_93, 3, &Var6, 0, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
		...
		switch (func_180(uParam0))
		{
			...
			case 4:
				...
				if (!func_21(*uParam0.f_44, 128))
				{
					...
					{
						func_372(uParam0.f_99, 4, &Var6, 0, 1, 0);
						func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					}
					else
					{
			...
			case 38:
				...
				if (!func_21(*uParam0.f_82, 268435456))
				{
					if (iVar14 > 80)
					{
						StringConCat(&Var6, "_1", 24);
					}
					else if (iVar14 > 40)
					{
						StringConCat(&Var6, "_2", 24);
					}
					else
					{
						StringConCat(&Var6, "_3", 24);
					}
					func_64(uParam0.f_82, 268435456);
				}
				else if (iVar14 > 80)
				{
					StringConCat(&Var6, "_4", 24);
				}
				else if (iVar14 > 40)
				{
					StringConCat(&Var6, "_5", 24);
				}
				else
				{
					StringConCat(&Var6, "_6", 24);
				}
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
			...
			case 72:
				...
				else if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_372(uParam0.f_95, 5, &Var6, 1, 0, 1);
					func_328(uParam0.f_244, *uParam0.f_144, &Var6, 8, 0, 0, 0);
				}
				else
				{
					...
					if (*uParam0.f_411 == 0)
					{
						func_372(uParam0.f_95, 8, &Var6, 1, 1, 0);
					}
					else
					{
						func_372(uParam0.f_95, 5, &Var6, 1, 1, 0);
					}
					func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
				func_370(2, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
				break;
			...
			case 79:
				...
				{
					func_365(uParam0, 4096, Var0, "_sideW1", iVar24, 8);
				}
				else if (!func_21(*uParam0.f_81, 8192))
				{
					func_365(uParam0, 8192, Var0, "_sideW2", iVar24, 8);
				}
			...
			case 80:
				...
				{
					func_365(uParam0, 16384, Var0, "_opLne1", iVar24, 8);
				}
				else if (!func_21(*uParam0.f_81, 32768))
				{
					func_365(uParam0, 32768, Var0, "_opLne2", iVar24, 8);
				}
			...
			case 83:
				...
				if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_372(uParam0.f_93, 6, &Var6, 0, 1, 0);
					func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_370(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
					func_297(uParam0, 16, 0, 0);
					func_261(uParam0, 0, 0);
			...
			case 92:
				...
				Var6 = {Var0};
				func_372(uParam0.f_96, 2, &Var6, 0, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_370(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
			...
			case 93:
				...
				Var6 = {Var0};
				func_372(uParam0.f_97, 2, &Var6, 0, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_370(12, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
					...
					if (!*uParam0.f_109 && !func_193())
					{
						switch (*uParam0.f_414)
						{
							...
							case 8:
								StringConCat(&Var0, "_good1", 24);
								Var6 = {Var0};
								func_372(uParam0.f_93, 6, &Var6, 1, 1, 0);
								func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
								func_370(23, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
								func_297(uParam0, 16, 0, 0);
								func_261(uParam0, 0, 0);
								break;
			...
			case 78:
				...
				Var6 = {Var0};
				func_372(uParam0.f_87, 6, &Var6, 1, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 48:
				...
				Var6 = {Var0};
				func_372(uParam0.f_86, 4, &Var6, 0, 1, 0);
				if (*uParam0.f_411 != 9)
				{
					func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 67:
				...
				Var6 = {Var0};
				func_372(uParam0.f_88, 4, &Var6, 0, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_370(16, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
				break;
			...
			case 51:
				...
				else
				{
					StringConCat(&Var0, "_copBa1", 24);
					Var6 = {Var0};
					func_372(uParam0.f_85, 6, &Var6, 1, 1, 0);
					func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_297(uParam0, 16, 0, 0);
					func_261(uParam0, 0, 0);
				}
			...
			case 87:
				...
				Var6 = {Var0};
				StringConCat(&Var6, "_", 24);
				StringIntConCat(&Var6, *uParam0.f_418.f_3, 24);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
				break;
			...
			case 58:
				if (*uParam0.f_411 == 6)
				{
					...
					Var6 = {Var0};
					func_372(uParam0.f_93, 6, &Var6, 1, 1, 1);
					func_238(&Var0);
					func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 115:
				...
				Var6 = {Var0};
				func_372(uParam0.f_91, 5, &Var6, 1, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
				break;
			...
			case 116:
				...
				Var6 = {Var0};
				func_372(uParam0.f_92, 5, &Var6, 1, 1, 0);
				func_371(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_297(uParam0, 16, 0, 0);
				func_261(uParam0, 0, 0);
				break;
...
void func_356(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_357(auto uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
	...
	func_371(uParam0.f_244, *uParam0.f_144, &Param1, &Var0, iParam7, 0, 0);
	func_297(uParam0, 16, 0, 0);
}

void func_358(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_64(uParam0.f_82, iParam1);
	func_297(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_360(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_361(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_362(char[24] cParam0, auto uParam1)
{
	int iVar0;
...
void func_365(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_64(uParam0.f_81, iParam1);
	func_297(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_366(auto uParam0, char[24] cParam1, char* sParam2)
{
	func_297(uParam0, 16, 0, 0);
	func_297(uParam0, 17, 0f, 1);
...
char* func_368(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 72:
...
int func_369(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_297(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_370(int iParam0, auto uParam1, auto uParam2, auto uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
int func_371(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_336(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_372(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
int func_375(auto uParam0, auto uParam1)
{
	return ((*uParam1 == -1 && *uParam0.f_412 == 0) && !func_171(uParam0, 9));
}

void func_376(auto uParam0)
{
	if (func_171(uParam0, 17))
	{
		if (!func_171(uParam0, 14))
...
auto func_377(auto uParam0)
{
	return *uParam0.f_117;
}

void func_378(auto uParam0, auto uParam1, int iParam2)
{
	if (!func_21(*uParam0.f_55, 1))
	{
		...
		{
			case 0:
				if (!is_string_null_or_empty(uParam0.f_124) && func_193())
				{
					*uParam1++;
				}
				break;
...
void func_379(auto uParam0)
{
	...
	if (*uParam0.f_410 >= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_4))
		{
			if (Local_343 > 0 && !func_277(Local_343.f_1[4 /*4*/], 4))
			{
				iVar0 = 0;
				iVar0 = 0;
...
bool func_380(auto uParam0, auto uParam1)
{
	auto uVar0;
	...
	if ((((!is_player_control_on(player_id()) && (does_cam_exist(*uParam0) && !is_cam_active(*uParam0))) && (does_cam_exist(*uParam0.f_1) && !is_cam_active(*uParam0.f_1))) && !is_message_being_displayed()) && !func_193())
	{
...
void func_381(auto uParam0)
{
	if (!func_401(*uParam0.f_429))
	{
		*uParam0.f_429 = func_400();
		func_391(uParam0.f_429, 0, 0, get_random_int_in_range(4, 7), 0, 0, 0);
	}
...
auto func_389(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_390(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_391(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_392(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_397(auto uParam0, int iParam1)
{
...
void func_398(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_402(auto uParam0)
{
	...
	if (*uParam0.f_410 < 7 && !*uParam0.f_138)
	{
		if (((*uParam0.f_411 == 9 && func_404()) && !func_189(uParam0)) || ((*uParam0.f_411 != 9 && func_265(uParam0, 1)) && !func_189(uParam0)))
		{
			...
			*uParam0.f_4 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
			set_entity_as_mission_entity(*uParam0.f_4, true, 0);
			func_224(uParam0);
			func_216(uParam0, 0);
		}
	}
	...
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (is_vehicle_driveable(iVar0, 0))
			{
				if (get_ped_in_vehicle_seat(iVar0, -1) == PLAYER::PLAYER_PED_ID())
				{
					if (is_vehicle_model(iVar0, func_18()))
					{
						return true;
					}
				}
...
void func_405(auto uParam0, auto uParam1, auto uParam2)
{
	switch (*uParam1)
	{
		case 1:
...
bool func_406(auto uParam0, int iParam1, int iParam2)
{
...
bool func_407(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!is_entity_dead(iVar0, 0) && !is_entity_dead(iParam0, 0))
	{
		...
		if (!func_21(*uParam2, 4))
		{
			if (func_411(iVar0, iParam0, uParam2, iParam5))
			{
				*uParam3 = 4;
				return true;
			}
		...
		iVar1 = !func_21(*uParam2, 128);
		if (iParam4)
		{
			if (func_408(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_408(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_408(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (iParam3)
	{
		if (!iLocal_79)
		{
			iLocal_80 = get_entity_health(iParam0);
			iLocal_79 = true;
		}
	...
	if (func_409(PLAYER::PLAYER_PED_ID(), iParam0))
	{
		return true;
	}
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_215(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
bool func_410(int iParam0, int iParam1, auto uParam2)
{
...
bool func_411(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_412(iVar3))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
...
bool func_413(int iParam0, auto uParam1)
{
	if (!is_entity_dead(iParam0, 0))
	{
...
void func_414(auto uParam0)
{
	if (!func_21(*uParam0.f_98, 2))
	{
		if (is_vehicle_driveable(*uParam0.f_4, 0))
		{
			...
			{
				clear_area_of_vehicles(*uParam0.f_17, 25f, 0, 0, 0, 0, false);
...
void func_421(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_423(auto uParam0, int iParam1)
{
	func_433(1);
	func_226();
	func_6(uParam0.f_244);
...
auto func_424(auto uParam0)
{
	return Global_101154.f_17787.f_39[uParam0];
}
...
void func_426(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
void func_427(auto uParam0)
{
	...
	switch (*uParam0.f_411)
	{
		...
		case 9:
			func_431(uParam0, get_random_int_in_range(false, 17));
			iVar0 = func_429(*uParam0.f_418.f_2 + get_random_int_in_range(true, 17), 0, 16);
...
void func_430(auto uParam0, int iParam1)
{
	*uParam0.f_418.f_1 = iParam1;
}

void func_431(auto uParam0, int iParam1)
{
...
void func_434()
{
	set_all_vehicle_generators_active_in_area(vLocal_928, vLocal_931, true, 1);
	set_all_vehicle_generators_active_in_area(vLocal_946, vLocal_949, true, 1);
	func_130(vLocal_958, 60f, 0);
	func_130(vLocal_961, 60f, 0);
	clear_ped_non_creation_area();
	remove_scenario_blocking_area(iLocal_894, 0);
	remove_relationship_group(iLocal_893);
	remove_relationship_group(iLocal_892);
	remove_waypoint_recording(&cLocal_976);
	func_233(385.1685f, -1372.719f, 29.8554f, 1, 50f);
	func_437();
	func_436();
	func_435();
	set_vehicle_model_is_suppressed(Local_853.f_1, false);
	func_147(&uLocal_45, 0, 0);
