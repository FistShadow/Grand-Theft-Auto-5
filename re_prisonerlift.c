								...
								switch (iLocal_55)
								{
									...
									case 1:
										if (iLocal_56 == 0)
										{
											if (!is_ped_injured(iLocal_72))
											{
												if ((is_entity_at_entity(player_ped_id(), iLocal_72, 100f, 100f, 100f, 0, 1, 0) && !is_entity_occluded(iLocal_72)) || is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0))
												{
													func_101();
													if (!func_124())
													{
												...
												if (is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0))
												{
										...
										else if (iLocal_56 == 1)
										{
											if (!is_ped_injured(iLocal_72))
											{
												if ((is_entity_at_entity(player_ped_id(), iLocal_72, 105f, 105f, 105f, 0, 1, 0) && !is_entity_occluded(iLocal_72)) || is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0))
												{
													func_101();
													if (!func_124())
													{
													...
													if (is_vehicle_driveable(get_players_last_vehicle(), 0))
													{
														if (!func_71(get_players_last_vehicle()))
														{
															if (is_entity_at_entity(get_players_last_vehicle(), iLocal_72, 40f, 40f, 20f, 0, 1, 0) && has_entity_clear_los_to_entity(iLocal_72, get_players_last_vehicle(), 17))
															{
																...
																task_vehicle_mission_ped_target(iLocal_72, get_players_last_vehicle(), player_ped_id(), 8, 22f, 786469, 1f, 1f, 1);
																set_ped_keep_task(iLocal_72, true);
																iLocal_55 = 13;
															}
															else if (is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0) && has_entity_clear_los_to_entity(iLocal_72, player_ped_id(), 17))
															{
											...
											if (func_70())
											{
												if (!is_entity_dead(iLocal_72, 0))
												{
													...
													{
														if (func_69(player_ped_id(), iLocal_72) < 2.5f)
														{
													...
													else if (func_69(player_ped_id(), iLocal_72) < 10f)
													{
														if (get_entity_speed(iLocal_75) < 1f)
														{
															func_68();
									...
									case 6:
										if (!iLocal_104 && !is_ped_injured(iLocal_72))
										{
										...
										if (func_64())
										{
											if (!is_ped_injured(iLocal_72))
											{
												...
												task_smart_flee_coord(iLocal_72, get_entity_coords(player_ped_id(), 0), 300f, -1, 0, 0);
												set_ped_keep_task(iLocal_72, true);
												wait(false);
											}
											func_86();
									...
									case 10:
										...
										if (iLocal_100)
										{
											...
											{
												if (!is_player_wanted_level_greater(player_id(), 0) || func_5(player_ped_id(), iLocal_85, 1) > 200f)
												{
									...
									case 11:
										...
										if (is_vehicle_driveable(iLocal_75, 0))
										{
											if (!func_71(iLocal_75))
											{
												if (!iLocal_101)
												{
													if (!is_ped_in_any_vehicle(player_ped_id(), 0) && !is_ped_in_any_vehicle(iLocal_72, 0))
													{
														if (!is_ped_injured(iLocal_72))
														{
															if (!iLocal_103)
													...
													if (!is_ped_injured(iLocal_72))
													{
														if (((has_entity_been_damaged_by_entity(iLocal_72, player_ped_id(), 1) || (is_player_free_aiming_at_entity(player_id(), iLocal_72) && is_ped_armed(player_ped_id(), 6))) || (is_player_targetting_entity(player_id(), iLocal_72) && is_ped_armed(player_ped_id(), 6))) || (get_entity_speed(iLocal_75) > 2.5f && is_ped_in_vehicle(player_ped_id(), iLocal_75, 0)))
														{
											...
											else
											{
												...
												if (!is_ped_injured(iLocal_72))
												{
													...
													task_smart_flee_coord(false, get_entity_coords(player_ped_id(), 0), 300f, -1, 0, 0);
													close_sequence_task(iLocal_74);
													task_perform_sequence(iLocal_72, iLocal_74);
													clear_sequence_task(&iLocal_74);
													set_ped_keep_task(iLocal_72, true);
										...
										if (!is_ped_injured(iLocal_72))
										{
											if (!is_entity_at_entity(player_ped_id(), iLocal_72, 150f, 150f, 150f, 0, 1, 0))
											{
												open_sequence_task(&iLocal_74);
												task_smart_flee_coord(false, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, 0, 0);
												task_smart_flee_coord(false, get_entity_coords(player_ped_id(), 0), 300f, -1, 0, 0);
											...
											if (is_vehicle_driveable(iLocal_75, 0))
											{
												if (!func_71(iLocal_75))
												{
													if (is_ped_in_vehicle(iLocal_72, iLocal_75, 0))
													{
														...
														task_vehicle_mission_ped_target(iLocal_72, iLocal_75, player_ped_id(), 8, 22f, 786469, 1f, 1f, 1);
														set_ped_keep_task(iLocal_72, true);
														iLocal_55 = 13;
													}
													else if (is_ped_in_vehicle(player_ped_id(), iLocal_75, 0))
													{
														if (iLocal_110)
														{
															task_combat_ped(iLocal_72, player_ped_id(), 0, 16);
									...
									case 13:
										...
										if (!is_ped_injured(iLocal_72))
										{
											...
											if (is_ped_in_any_vehicle(iLocal_72, 0))
											{
												...
												if (is_ped_on_specific_vehicle(player_ped_id(), get_vehicle_ped_is_in(iLocal_72, 0)))
												{
													open_sequence_task(&iLocal_74);
												...
												if (!is_entity_at_entity(player_ped_id(), iLocal_72, 245f, 245f, 245f, 0, 1, 0))
												{
													func_86();
												}
											}
											...
											else if (!is_entity_at_entity(player_ped_id(), iLocal_72, 200f, 200f, 200f, 0, 1, 0))
											{
												func_16();
											}
										}
...
bool func_1(int iParam0)
{
	...
	if ((func_4(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), 0)) && func_2(iParam0))
	{
...
var func_5(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (!is_ped_injured(iLocal_72))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			if (!func_88())
			{
				...
				{
					task_go_to_entity(iLocal_72, player_ped_id(), -1, 6f, 2f, 2f, 0);
				}
				if (is_ped_in_any_vehicle(iLocal_72, 0))
				{
...
void func_10()
{
	if (!is_ped_injured(iLocal_72))
	{
		if (is_entity_at_entity(player_ped_id(), iLocal_72, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!is_player_wanted_level_greater(player_id(), 0))
			{
				if (is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (is_ped_in_vehicle(iLocal_72, get_vehicle_ped_is_in(player_ped_id(), 0), 0))
					{
						if (does_blip_exist(iLocal_105))
						{
							remove_blip(&iLocal_105);
...
void func_13()
{
	switch (iLocal_106)
	{
			...
			if (func_14())
			{
				if (timera() > 2000)
				{
					if (is_vehicle_driveable(iLocal_75, 0))
					{
						...
						task_vehicle_temp_action(player_ped_id(), iLocal_75, 24, 2000);
						iLocal_106++;
					}
				}
			}
		...
		case 4:
			if (is_vehicle_driveable(iLocal_75, 0))
			{
				if (!is_ped_injured(iLocal_72) && !is_ped_in_vehicle(iLocal_72, iLocal_75, 0))
				{
					task_smart_flee_coord(iLocal_72, get_entity_coords(player_ped_id(), 0), 300f, -1, 0, 0);
					set_ped_keep_task(iLocal_72, true);
					func_51();
...
bool func_14()
{
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		iLocal_75 = get_vehicle_ped_is_in(player_ped_id(), 0);
		if (is_vehicle_driveable(iLocal_75, 0))
		{
			if (!is_ped_injured(iLocal_72))
			{
...
void func_15()
{
	if ((!iLocal_104 && !is_ped_injured(iLocal_72)) && is_vehicle_driveable(iLocal_75, 0))
	{
		remove_ped_from_group(iLocal_72);
		open_sequence_task(&iLocal_74);
		task_look_at_entity(false, player_ped_id(), 5000, 2048, 2);
...
void func_54()
{
	...
	if (!is_entity_at_coord(player_ped_id(), get_entity_coords(iLocal_79, 0), 10f, 10f, 10f, false, false, 0) || is_player_wanted_level_greater(player_id(), 0))
	{
		func_56();
	}
	if (!is_ped_injured(iLocal_72))
	{
		if (((!is_player_wanted_level_greater(player_id(), 0) && is_entity_in_angled_area(iLocal_72, 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, true, 0)) && is_entity_in_angled_area(player_ped_id(), 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, true, 0)) || (is_entity_at_coord(iLocal_72, vLocal_86, Global_19, true, true, 0) && func_55(1, 0, 1)))
		{
			settimera(false);
			if (func_14())
			{
...
var func_59(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
bool func_62()
{
	if (!is_ped_injured(iLocal_72))
	{
		if (is_ped_in_group(iLocal_72))
		{
			if ((((((((is_entity_at_coord(player_ped_id(), vLocal_114, 50f, 50f, 50f, false, true, 0) || is_entity_at_coord(player_ped_id(), vLocal_117, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_120, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_123, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_126, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_129, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_132, 50f, 50f, 50f, false, true, 0)) || is_entity_at_coord(player_ped_id(), vLocal_135, 50f, 50f, 50f, false, true, 0)) || func_59(player_ped_id(), vLocal_138, 1) < 205f)
			{
				return true;
			}
		}
...
void func_63()
{
	if (!is_ped_injured(iLocal_72) && func_88())
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), 0), 0))
		{
			if (is_ped_sitting_in_vehicle(player_ped_id(), get_vehicle_ped_is_in(player_ped_id(), 0)) && is_ped_sitting_in_vehicle(iLocal_72, get_vehicle_ped_is_in(player_ped_id(), 0)))
			{
				settimera(false);
				if (!is_ped_in_group(iLocal_72))
				{
...
bool func_64()
{
	...
	if (!is_ped_injured(iLocal_72))
	{
		...
		if (!is_entity_at_entity(player_ped_id(), iLocal_72, 250f, 250f, 250f, 0, 1, 0))
		{
			return true;
		}
		if (iLocal_56 == 0)
		...
		if (iLocal_55 < 2)
		{
			...
			if (iLocal_56 == 0)
			{
				if (does_entity_exist(iLocal_79))
				{
					...
					{
						task_smart_flee_ped(iLocal_72, player_ped_id(), 1000f, -1, 0, 0);
						set_ped_keep_task(iLocal_72, true);
						return true;
					}
				}
			...
			if ((is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0) && has_entity_clear_los_to_entity_in_front(iLocal_72, player_ped_id())) && is_ped_armed(player_ped_id(), 6))
			{
	...
	if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), 0), 0))
	{
		if (!is_ped_injured(iLocal_72))
		{
			if (!func_83())
			{
				...
				clear_ped_tasks(iLocal_72);
				open_sequence_task(&iLocal_74);
				task_aim_gun_at_entity(false, player_ped_id(), 500, 1);
				task_go_to_entity_while_aiming_at_entity(false, player_ped_id(), player_ped_id(), 1f, 0, 1f, 0.5f, 1, 0, -957453492);
...
void func_84()
{
	...
	{
		if (!is_ped_in_vehicle(player_ped_id(), iLocal_79, 0) && !is_vehicle_seat_free(iLocal_79, -1))
		{
	...
	switch (iLocal_108)
	{
		case 0:
			if (!is_ped_injured(iLocal_72))
			{
				if (is_entity_at_entity(player_ped_id(), iLocal_72, 20f, 20f, 8f, 0, 1, 0))
				{
					if (get_entity_speed(player_ped_id()) < 2.5f || !(is_ped_in_any_vehicle(player_ped_id(), 0) && is_entity_at_entity(player_ped_id(), iLocal_72, 15f, 15f, 8f, 0, 1, 0)))
					{
						open_sequence_task(&iLocal_74);
						task_look_at_entity(false, player_ped_id(), 30000, 2050, 2);
		...
		case 1:
			...
			if (is_ped_in_any_vehicle(player_ped_id(), 1))
			{
				...
				{
					fLocal_109 = func_5(iLocal_72, player_ped_id(), 1);
					open_sequence_task(&iLocal_74);
					task_look_at_entity(false, player_ped_id(), 7000, 2048, 2);
					task_go_to_entity(false, player_ped_id(), -1, fLocal_109 - 3f, 1f, 2f, 0);
					close_sequence_task(iLocal_74);
					task_perform_sequence(iLocal_72, iLocal_74);
					clear_sequence_task(&iLocal_74);
					if (!func_83())
		...
		case 5:
			if (func_88())
			{
				if (is_vehicle_driveable(get_vehicle_ped_is_in(player_ped_id(), 0), 0))
				{
					if (!is_ped_injured(iLocal_72))
					{
						if (is_ped_sitting_in_vehicle(iLocal_72, get_vehicle_ped_is_in(player_ped_id(), 0)))
						{
							if (does_blip_exist(iLocal_105))
							{
								remove_blip(&iLocal_105);
...
void func_87(var uParam0)
{
	switch (*uParam0)
	{
		case 0:
			if (!is_ped_injured(iLocal_72))
			{
				if (!is_ped_facing_ped(iLocal_72, player_ped_id(), 90f))
				{
					task_turn_ped_to_face_entity(iLocal_72, player_ped_id(), false);
					*uParam0++;
				}
			}
			break;
...
void func_89()
{
	...
	{
		iLocal_75 = get_vehicle_ped_is_in(player_ped_id(), 0);
		if ((is_vehicle_driveable(iLocal_75, 0) && !is_ped_injured(iLocal_72)) && !iLocal_99)
		{
			fLocal_109 = func_5(iLocal_72, player_ped_id(), 1);
			if (fLocal_109 > 5f)
			{
			...
			if (iLocal_56 == 0)
			{
				...
				task_go_to_entity_while_aiming_at_entity(false, player_ped_id(), player_ped_id(), 1f, 0, fLocal_109, 1f, 1, 0, -957453492);
			}
			else if (iLocal_56 == 1)
			{
				task_look_at_entity(false, iLocal_75, 10000, 2052, 2);
				task_play_anim(false, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0, 0, 0, 0);
				task_follow_to_offset_of_entity(false, player_ped_id(), -1f, 0f, 0f, 1f, -1, 0.5f, 1);
			}
			close_sequence_task(iLocal_74);
			task_perform_sequence(iLocal_72, iLocal_74);
			clear_sequence_task(&iLocal_74);
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_162()) || Global_100201) || Global_25122) || func_161()) || func_80(8, -1)) || func_160()) || func_159()) || func_158()) || func_157()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_162()) || Global_100201) || Global_25122) || func_161()) || func_80(8, -1)) || func_160()) || func_159()) || func_157()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || func_162()) || func_159()) || Global_100201) || Global_25122) || func_161()) || Global_36839) || func_80(8, -1)) || func_158()) || func_156()) || func_157()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
