#region Local Var
	...
	int[] iLocal_73 = new int[12];
	int[] iLocal_86 = new int[12];
	Vector3[] vLocal_99 = new Vector3[12];
	var[] uLocal_136 = new var[12];
	int[] iLocal_149 = new int[4];
	int[] iLocal_154 = new int[4];
	Vector3[] vLocal_159 = new Vector3[4];
	var[] uLocal_172 = new var[4];
	int[] iLocal_177 = new int[4];
	int[] iLocal_182 = new int[4];
	Vector3[] vLocal_187 = new Vector3[4];
	var[] uLocal_200 = new var[4];
	int[] iLocal_205 = new int[4];
	int[] iLocal_210 = new int[4];
	Vector3[] vLocal_215 = new Vector3[4];
	var[] uLocal_228 = new var[4];
	Vector3 vLocal_233 = 0;
	float fLocal_236 = 0;
	int iLocal_237 = 0;
	auto uLocal_238 = 0;
	auto uLocal_239 = 0;
	...
	if (func_5(&iLocal_237, 0f))
	{
		...
		if (!is_entity_dead(iLocal_73[iVar0], 0))
		{
			...
			if (!is_ped_injured(iVar1))
			{
				...
				start_vehicle_horn(iLocal_73[iVar0], round(fVar2 * 1000f), false, 0);
				func_3(&iLocal_237, fVar3);
			}
		}
	}
	if (get_distance_between_coords(get_entity_coords(player_ped_id(), 1), vLocal_233, 1) > 100f)
	{
		return true;
	}
	return false;
...
bool func_11()
{
	...
	{
		func_13();
		func_12(&iLocal_237, get_random_float_in_range(1.75f, 2.25f));
		return true;
	}
	if (!func_9(&iLocal_237))
	{
		func_12(&iLocal_237, get_random_float_in_range(1.75f, 2.25f) * 2f);
	}
	return false;
}

void func_12(int iParam0, Vector3 fParam1)
{
	if (!func_9(iParam0))
	{
...
void func_14(int iParam0, int iParam1, Vector3 fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	int iVar6;
	...
	vVar0 = {0f, fParam2, 0f};
	vVar3 = {get_offset_from_entity_in_world_coords(iParam1, vVar0)};
	open_sequence_task(&iVar6);
	task_vehicle_drive_to_coord(false, iParam1, vVar3, fParam2, 0, get_entity_model(iParam1), iParam3, 2f, 5f);
	task_vehicle_drive_wander(false, iParam1, fParam2, iParam3);
...
int func_22(auto uParam0, auto uParam1)
{
...
void func_32()
{
	...
	{
		request_model(iLocal_86[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_154)
	{
		request_model(iLocal_154[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_182)
	{
		request_model(iLocal_182[iVar0]);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_210)
	{
		request_model(iLocal_210[iVar0]);
		iVar0++;
	}
	iVar1 = 0;
	iVar2 = false;
	while (!iVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 12)
		{
			...
			{
				if (!has_model_loaded(iLocal_86[iVar0]))
				{
					request_model(iLocal_86[iVar0]);
					iVar2 = false;
				}
				...
				{
					clear_area(vLocal_233 + vLocal_99[iVar0 /*3*/], 10f, 1, 0, 0, false);
					iLocal_73[iVar0] = create_vehicle(iLocal_86[iVar0], vLocal_233 + vLocal_99[iVar0 /*3*/], fLocal_236 + uLocal_136[iVar0], 1, true);
		...
		while (iVar0 < 4)
		{
			if (!does_entity_exist(iLocal_149[iVar0]))
			{
				if (!has_model_loaded(iLocal_154[iVar0]))
				{
					request_model(iLocal_154[iVar0]);
					iVar2 = false;
				}
				...
				{
					clear_area(vLocal_233 + vLocal_159[iVar0 /*3*/], 10f, 1, 0, 0, false);
					iLocal_149[iVar0] = create_vehicle(iLocal_154[iVar0], vLocal_233 + vLocal_159[iVar0 /*3*/], fLocal_236 + uLocal_172[iVar0], 1, true);
					set_entity_lod_dist(iLocal_149[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_149[iVar0], 2f);
					_0x3910051CCECDB00C(iLocal_149[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!does_entity_exist(iLocal_177[iVar0]))
			{
				if (!has_model_loaded(iLocal_182[iVar0]))
				{
					request_model(iLocal_182[iVar0]);
					iVar2 = false;
				}
				...
				{
					clear_area(vLocal_233 + vLocal_187[iVar0 /*3*/], 10f, 1, 0, 0, false);
					iLocal_177[iVar0] = create_vehicle(iLocal_182[iVar0], vLocal_233 + vLocal_187[iVar0 /*3*/], fLocal_236 + uLocal_200[iVar0], 1, true);
					set_entity_lod_dist(iLocal_177[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_177[iVar0], 2f);
					_0x3910051CCECDB00C(iLocal_177[iVar0], true);
				}
			}
			iVar0++;
		}
		...
		while (iVar0 < 4)
		{
			if (!does_entity_exist(iLocal_205[iVar0]))
			{
				if (!has_model_loaded(iLocal_210[iVar0]))
				{
					request_model(iLocal_210[iVar0]);
					iVar2 = false;
				}
				...
				{
					clear_area(vLocal_233 + vLocal_215[iVar0 /*3*/], 10f, 1, 0, 0, false);
					iLocal_205[iVar0] = create_vehicle(iLocal_210[iVar0], vLocal_233 + vLocal_215[iVar0 /*3*/], fLocal_236 + uLocal_228[iVar0], 1, true);
					set_entity_lod_dist(iLocal_205[iVar0], 250);
					set_vehicle_lod_multiplier(iLocal_205[iVar0], 2f);
					_0x3910051CCECDB00C(iLocal_205[iVar0], true);
				}
			}
			iVar0++;
		}
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_149[iVar0], 0))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_149[iVar0]) > 0)
			{
				...
				set_model_as_no_longer_needed(iLocal_154[iVar0]);
			}
		}
		iVar0++;
	}
	if (!get_vehicle_max_number_of_passengers(iLocal_149[2]) > 0)
	{
		attach_vehicle_to_trailer(iLocal_149[0], iLocal_149[2], 1f);
	}
	if (!get_vehicle_max_number_of_passengers(iLocal_149[3]) > 0)
	{
		attach_vehicle_to_trailer(iLocal_149[1], iLocal_149[3], 1f);
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_177[iVar0], 0))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_177[iVar0]) > 0)
			{
				...
				set_model_as_no_longer_needed(iLocal_182[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 4)
	{
		if (!is_entity_dead(iLocal_205[iVar0], 0))
		{
			if (get_vehicle_max_number_of_passengers(iLocal_205[iVar0]) > 0)
			{
				...
				set_model_as_no_longer_needed(iLocal_210[iVar0]);
			}
		}
		iVar0++;
	}
...
void func_33(int iParam0)
{
	...
	if (get_entity_model(iParam0) == joaat("a_m_m_salton_01"))
	{
		if (get_ped_drawable_variation(iParam0, 3) == 1)
		{
			if (func_34())
			{
				set_ped_component_variation(iParam0, 3, false, get_ped_texture_variation(iParam0, 3), 0);
			}
			else
			{
...
int func_35()
{
	...
	{
		if (has_model_loaded(iLocal_68[iVar6]))
		{
...
void func_36()
{
	...
	func_48(iLocal_66, &vLocal_233, &fLocal_236, &sVar0);
	func_37(iLocal_66, &iLocal_68, &iLocal_86, &vLocal_99, &uLocal_136, &iLocal_154, &vLocal_159, &uLocal_172, &iLocal_182, &vLocal_187, &uLocal_200, &iLocal_210, &vLocal_215, &uLocal_228);
}

void func_37(int iParam0, int iParam1, int iParam2, auto uParam3, auto uParam4, int iParam5, auto uParam6, auto uParam7, int iParam8, auto uParam9, auto uParam10, int iParam11, auto uParam12, auto uParam13)
{
	Vector3 vVar0;
	float fVar3;
	char* sVar4;
	...
	switch (iParam0)
	{
		case 105:
			...
			func_48(iParam0, &vVar0, &fVar3, &sVar4);
		...
		case 23:
			func_47(uParam3, uParam4, uParam6, uParam7, uParam9, uParam10);
			func_46(iParam1, iParam2, iParam5, iParam8, iParam11);
			func_48(iParam0, &vVar12, &fVar15, &sVar16);
...
void func_38(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_39(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
void func_40(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_41(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
void func_42(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	int iVar0;
...
void func_43(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
Vector3 func_44(float fParam0, Vector3 fParam1)
{
	return get_random_float_in_range(fParam0, fParam1), get_random_float_in_range(fParam0, fParam1), 0f;
}

void func_45(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
void func_46(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	int iVar0;
...
void func_47(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
	Vector3 vVar0;
	int iVar3;
...
bool func_48(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_50(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_51(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
...
int func_52(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_53(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_55()
{
	...
	{
		set_vehicle_as_no_longer_needed(&(iLocal_149[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_177)
	{
		set_vehicle_as_no_longer_needed(&(iLocal_177[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_205)
	{
		set_vehicle_as_no_longer_needed(&(iLocal_205[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_68)
