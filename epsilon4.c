#region Local Var
	...
	Vector3 fLocal_150 = 0;
	Vector3 vLocal_151 = 0;
	Vector3 fLocal_154 = 0;
	Vector3 vLocal_155 = 0;
	Vector3 fLocal_158 = 0;
	int iLocal_159 = 0;
	int iLocal_160 = 0;
	char* sLocal_161 = 0;
	int iLocal_162 = 0;
	...
	int iLocal_361 = 0;
	int iLocal_362 = 0;
	struct<43>[] Local_363 = new struct<43>[4];
	int iLocal_536 = 0;
	int iLocal_537 = 0;
	struct<6>[] Local_538 = new struct<6>[11];
	int iLocal_605 = 0;
	struct<8>[] Local_606 = new struct<8>[2];
	int iLocal_623 = 0;
	int iLocal_624 = 0;
	struct<15> Local_625 = 0;
	Vector3 fLocal_640 = 0;
	int iLocal_641 = 0;
	auto uLocal_642 = 15;
	auto uLocal_643 = 0;
	auto uLocal_644 = 0;
	...
	float fLocal_770 = 0;
	float fLocal_771 = 0;
	struct<10> Local_772 = 0;
	int iLocal_782 = 0;
	struct<61> Local_783 = 0;
#endregion
...
void main()
{
	...
	iLocal_160 = get_weapontype_model(iLocal_159);
	sLocal_161 = "empty";
	iLocal_339 = 1;
	iLocal_764 = -1;
	iLocal_765 = -1;
	...
	iLocal_162 = func_386();
	iLocal_163 = func_385(1855.08f, 4755.85f, 36.81f, 25f);
	...
	func_359(&(Local_606[0 /*8*/]), vLocal_151, fLocal_154, Local_83.f_28[0], 0);
	func_359(&(Local_606[1 /*8*/]), vLocal_155, fLocal_158, Local_83.f_28[1], 0);
	if (func_396())
	{
		if (func_358() == 0)
		{
			func_357(vLocal_147, fLocal_150, 1, 0);
			func_356(1);
	...
	while (true)
	{
		...
		{
			if (func_333(PLAYER::PLAYER_PED_ID()) == iLocal_159)
			{
...
void func_11()
{
	...
	while (func_333(PLAYER::PLAYER_PED_ID()) == iLocal_159)
	{
		wait(0);
		hide_hud_component_this_frame(2);
		if (has_anim_dict_loaded("weapons@holster_1h"))
		{
			if (!is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 3))
			{
				task_play_anim(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster") >= 0.5f)
			{
...
bool func_14(struct<9> Param0, auto uParam1)
{
	if (Param0.f_8 == 0)
	{
		return false;
...
int func_18(struct<4> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, struct<4> Param7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	int iVar0;
	int iVar1;
...
struct<10> func_20(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, auto uParam9)
{
	struct<10> Var0;
...
bool func_56(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
...
void func_83(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_84(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_87(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_88(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_102(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
...
int func_103(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_106(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_170()
{
	...
	{
		if (func_166(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_208(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_225()
{
	switch (Local_772.f_1)
	{
		case 0:
			...
			hide_hud_component_this_frame(2);
			remove_weapon_from_ped(PLAYER::PLAYER_PED_ID(), iLocal_159);
			Local_772.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (has_entity_been_damaged_by_entity(Local_606[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && has_entity_been_damaged_by_weapon(Local_606[0 /*8*/], false, 2))
			{
				func_235(6);
				Local_772.f_9 = 4;
				Local_772.f_1 = 3;
			}
			else if (has_entity_been_damaged_by_entity(Local_606[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && has_entity_been_damaged_by_weapon(Local_606[1 /*8*/], false, 2))
			{
				func_235(6);
				Local_772.f_9 = 5;
				Local_772.f_1 = 3;
			...
			{
				if (func_226(PLAYER::PLAYER_PED_ID(), Local_606[0 /*8*/], 1) >= 50f)
				{
...
bool func_230(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_232(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_234(vParam1 - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_234(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
void func_236()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (_0xB56BBBCC2955D9CB())
		{
			...
			{
				func_286("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
			}
	...
	if (Local_772.f_1 == 0)
	{
		...
		{
			iLocal_362 = create_vehicle(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1);
			set_vehicle_colours(iLocal_362, 157, 157);
			set_vehicle_extra_colours(iLocal_362, 5, 157);
			set_vehicle_on_ground_properly(iLocal_362);
		}
		...
		if (func_334(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_353 == 0)
			{
				...
				{
					register_entity_for_cutscene(Local_606[1 /*8*/], "Jimmy_Boston", 0, false, 0);
				}
				if (func_227(Local_606[0 /*8*/]))
				{
					register_entity_for_cutscene(Local_606[0 /*8*/], "Marnie", 0, false, 0);
				}
				if (func_227(PLAYER::PLAYER_PED_ID()))
				{
					register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), "Michael", 0, false, 0);
				}
				if (func_227(Local_625))
				{
					iLocal_641 = func_267(PLAYER::PLAYER_PED_ID(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					register_entity_for_cutscene(iLocal_641, "Artefact_Detector", 0, false, 0);
				}
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_363[iLocal_353 /*43*/].f_1, "EPS_TV", 0, false, 0);
				}
			}
			else if (iLocal_353 == 1)
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_363[iLocal_353 /*43*/].f_1, "EPS_Battery", 0, false, 0);
				}
			}
			else
			{
				...
				if (func_227(Local_363[iLocal_353 /*43*/].f_1))
				{
					register_entity_for_cutscene(Local_363[iLocal_353 /*43*/].f_1, "Old_Boot", 0, false, 0);
				}
			}
			start_cutscene(0);
			...
			if (iLocal_353 >= 2)
			{
				if (func_227(PLAYER::PLAYER_PED_ID()))
				{
					give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), -1, true, true);
				}
			}
			...
			if (iLocal_353 >= 2)
			{
				if (is_cutscene_playing())
				{
					if (get_cutscene_time() > 17000)
					{
						if (!is_new_load_scene_active())
						{
							new_load_scene_start(1847.472f, 4756.157f, 36.6968f, func_251(271.4718f), 145f, 0);
						}
					}
				}
			}
...
void func_238(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_242(player_id())) && !func_240(player_id(), 0)) && !func_239())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_242(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_244(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_246()
{
	_push_scaleform_movie_function(iLocal_165, "SET_COLOUR");
	...
	_push_scaleform_movie_function(iLocal_165, "SET_DISTANCE");
	...
	if (func_227(PLAYER::PLAYER_PED_ID()))
	{
		if (can_set_exit_state_for_registered_entity("Michael", false))
		{
			...
			else
			{
				...
				if (func_333(PLAYER::PLAYER_PED_ID()) != iLocal_159)
				{
					give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), iLocal_159, -1, true, true);
				}
				force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -1871534317, false, 1, 0);
				return true;
			}
	...
	if (func_227(Local_606[1 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Jimmy_Boston", false))
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					open_sequence_task(&iLocal_782);
					task_warp_ped_into_vehicle(false, iLocal_362, 0);
					close_sequence_task(iLocal_782);
					task_perform_sequence(Local_83.f_28[1], iLocal_782);
					clear_sequence_task(&iLocal_782);
					func_384("Did Jimmy pass exit");
				}
			}
			else
			{
				task_go_straight_to_coord(Local_83.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 0.5f);
				func_384("Did Jimmy regular exit");
			}
			force_ped_motion_state(Local_606[1 /*8*/], -668482597, false, 1, 0);
		}
	}
}
...
void func_249()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Marnie", false))
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					open_sequence_task(&iLocal_782);
					task_warp_ped_into_vehicle(false, iLocal_362, -1);
					task_vehicle_drive_to_coord(false, iLocal_362, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					task_vehicle_drive_wander(false, iLocal_362, 30f, 262275);
					close_sequence_task(iLocal_782);
					task_perform_sequence(Local_83.f_28[0], iLocal_782);
					clear_sequence_task(&iLocal_782);
			...
			{
				task_follow_nav_mesh_to_coord(Local_83.f_28[0], get_offset_from_entity_in_world_coords(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 40000f);
				func_384("Did Marnie regular exit");
			}
			force_ped_motion_state(Local_606[0 /*8*/], -668482597, false, 1, 0);
		}
	}
}
...
void func_250()
{
	...
	{
		if (can_set_exit_state_for_registered_entity("Artefact_Detector", false))
		{
			if (iLocal_353 < 2)
			{
				func_384("*** Detector exit");
				give_weapon_object_to_ped(iLocal_641, PLAYER::PLAYER_PED_ID());
				func_5(&iLocal_641);
				if (!ENTITY::DOES_ENTITY_EXIST(Local_625))
				{
					func_384("*** Recreating gDetector.hObj after cutscene...");
					Local_625 = get_current_ped_weapon_entity_index(PLAYER::PLAYER_PED_ID());
				}
			}
			else
			{
...
Vector3 func_251(Vector3 fParam0)
{
...
void func_253(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_258(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_259(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_259(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_261(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_262(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_262(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_263(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_234(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
...
bool func_264(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_267(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_269(iVar2, iVar8) != 0)
	{
		if (!is_entity_dead(iParam0, 0))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_269(iVar2, iVar8)))
			{
				if (func_268(func_269(iVar2, iVar8)))
				{
					iVar9 = get_weapon_component_type_model(func_269(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_269(iVar2, iVar8) != 0)
	{
		if (!is_entity_dead(iParam0, 0))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_269(iVar2, iVar8)))
			{
				give_weapon_component_to_weapon_object(iVar1, func_269(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
int func_270(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_271(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_278(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
{
	_push_scaleform_movie_function(iLocal_165, "SET_COLOUR");
	_push_scaleform_movie_function_parameter_int(67);
	_push_scaleform_movie_function_parameter_int(200);
	_push_scaleform_movie_function_parameter_int(255);
	_push_scaleform_movie_function_parameter_int(255);
	_push_scaleform_movie_function_parameter_int(209);
	_push_scaleform_movie_function_parameter_int(67);
	_push_scaleform_movie_function_parameter_int(255);
	...
	if (iParam0 == 1)
	{
		if (func_283())
		{
			if ((are_strings_equal(Local_625.f_14, "NO_RECENT_ANIM") || !is_entity_playing_anim(Local_625, "rcm_epsilonism4", Local_625.f_14, 3)) || get_entity_anim_current_time(Local_625, "rcm_epsilonism4", Local_625.f_14) >= 0.98f)
			{
				...
				play_entity_anim(Local_625, Local_625.f_14, "rcm_epsilonism4", 16f, false, 0, 0, 0f, 0);
			}
		}
	}
	else if (func_283())
...
void func_287(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<50> Var2;
...
void func_288(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_295()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			if (!func_322())
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_147, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_150);
			}
			func_279(&(Local_606[1 /*8*/]), 1);
			func_279(&(Local_606[0 /*8*/]), 1);
			if (func_334(Local_606[1 /*8*/]))
			{
				...
				get_ground_z_for_3d_coord(1829.75f, 4693.5f, 38.51f, &fVar1, 0);
				set_entity_coords(Local_606[1 /*8*/], vVar2.x, vVar2.y, fVar1, 1, false, 0, 1);
				func_384("Setting Jimmy position (0)");
			}
			if (func_334(Local_606[0 /*8*/]))
			{
				set_entity_coords(Local_606[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, false, 0, 1);
		...
		{
			set_entity_coords(PLAYER::PLAYER_PED_ID(), 1754.634f, 4675.789f, 42.9068f, 1, false, 0, 1);
			set_entity_heading(PLAYER::PLAYER_PED_ID(), 293.2275f);
			if (func_334(Local_606[1 /*8*/]))
			{
				set_entity_coords(Local_606[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, false, 0, 1);
				set_entity_heading(Local_606[1 /*8*/], 262.4368f);
				func_384("Setting Jimmy position (1)");
			}
			if (func_334(Local_606[0 /*8*/]))
			{
				set_entity_coords(Local_606[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, false, 0, 1);
		...
		{
			set_entity_coords(PLAYER::PLAYER_PED_ID(), 1758.454f, 4829.431f, 39.729f, 1, false, 0, 1);
			set_entity_heading(PLAYER::PLAYER_PED_ID(), 168.2012f);
			if (func_334(Local_606[0 /*8*/]))
			{
				set_entity_coords(Local_606[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, false, 0, 1);
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (iLocal_353 == 0)
		{
			...
			if (func_334(Local_606[1 /*8*/]))
			{
				...
				task_follow_nav_mesh_to_coord(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 40000f);
			}
		...
		else if (iLocal_353 == 2)
		{
			...
			func_318(&(Local_606[1 /*8*/]), uLocal_761);
			iLocal_748 = 11;
			iLocal_749 = 12;
			iLocal_751 = 0;
			iLocal_750 = 0;
		...
		func_317(&uLocal_168, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	if (Local_772.f_1 == 1)
	{
		...
		else if (!func_315(&uLocal_694, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
		{
			func_235(6);
			Local_772.f_9 = 8;
			Local_772.f_1 = 3;
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_363[iLocal_353 /*43*/].f_1))
			{
				if (iLocal_353 == 0)
				{
					if (func_226(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
					{
						if (!has_cutscene_loaded())
						{
					...
					else if (func_226(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f)
					{
						if (has_cutscene_loaded())
						{
				...
				else if (func_226(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f)
				{
					if (!has_cutscene_loaded())
					{
			...
			if (iLocal_353 == 0)
			{
				...
				{
					if (is_control_just_pressed(0, 25) || iLocal_747 < GAMEPLAY::GET_GAME_TIMER())
					{
						clear_help(1);
						iLocal_747 = GAMEPLAY::GET_GAME_TIMER() + 1000;
						iLocal_746++;
			...
			{
				func_309(&iLocal_164);
				if (!func_315(&uLocal_642, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
				{
					iLocal_339 = 0;
					stop_scripted_conversation(false);
					clear_prints();
				...
				else if (iLocal_340 == 0)
				{
					if (are_strings_equal(Local_363[iLocal_353 /*43*/].f_36, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!are_strings_equal(Local_363[iLocal_353 /*43*/].f_36, sLocal_161))
						{
							...
							{
								task_look_at_entity(iLocal_361, PLAYER::PLAYER_PED_ID(), 10000, 0, 2);
							}
						}
						iLocal_759 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_340 = 1;
					...
					if (!func_275() && GAMEPLAY::GET_GAME_TIMER() - iLocal_358 >= 7500)
					{
						if ((are_strings_equal(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!are_strings_equal(Local_363[iLocal_353 /*43*/].f_37, sLocal_161))
							{
								if (func_227(iLocal_361))
								{
									task_look_at_entity(iLocal_361, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
								}
							}
							iLocal_341 = 1;
							iLocal_759 = GAMEPLAY::GET_GAME_TIMER();
				...
				else if (iLocal_338 == 0 && !func_298(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 9f))
				{
					if (func_298(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 20f))
					{
						if (!iLocal_343)
						{
							if (!func_275())
					...
					{
						if (func_297(PLAYER::PLAYER_PED_ID(), iLocal_361, 30f, 1) || iLocal_353 == 2)
						{
							if (!func_275() && GAMEPLAY::GET_GAME_TIMER() - iLocal_356 > 15000)
							{
								if (iLocal_336)
								{
									if (iLocal_352 == 0)
									{
										if (iLocal_750 < iLocal_748)
										{
											if (are_strings_equal(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_300(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_40, 7, 0, 0, 0))
											{
												...
												{
													task_look_at_entity(iLocal_361, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
												}
												iLocal_356 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_750++;
												if (iLocal_353 == 2)
							...
							else if (iLocal_336 != Local_625.f_1)
							{
								iLocal_336 = Local_625.f_1;
								if (Local_625.f_1 == 0)
								{
									iLocal_352 = 0;
								}
				...
				if (iLocal_353 == 0)
				{
					if (iLocal_753 < 5)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_755 > 7500 && !func_275()) && !is_message_being_displayed())
						{
							if (func_227(Local_606[0 /*8*/]))
							{
								if (func_226(Local_606[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
				...
				else if (iLocal_353 == 1)
				{
					if (iLocal_753 < 4)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_755 > 7500 && !func_275()) && !is_message_being_displayed())
						{
							if (func_227(Local_606[1 /*8*/]))
							{
								if (func_226(Local_606[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
				...
				if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, false, false, 1))
				{
					if (iLocal_359 == -1)
					{
				...
				else if (!func_298(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 9f + 2f))
				{
					iLocal_337 = 0;
				}
			}
			else
			{
				...
				{
					iLocal_164 = func_296(vLocal_144, 5, 0);
				}
				iLocal_336 = Local_625.f_1;
				if (func_315(&uLocal_642, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
				{
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
...
int func_296(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
int func_298(int iParam0, Vector3 vParam1, float fParam2)
{
...
int func_300(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_308(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_311(auto uParam0)
{
	...
	fVar0 = vdist(*uParam0.f_2, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1));
	vVar1 = {get_entity_forward_vector(PLAYER::PLAYER_PED_ID())};
	if (fVar0 > Local_625.f_11)
	{
		fVar7 = 0f;
		if (Local_625.f_8 > 0f)
		{
			fVar7 += sin(fVar0 - Local_625.f_11 * 360f / Local_625.f_8) * Local_625.f_10;
		}
		if (Local_625.f_9 > 0f)
		{
			fVar7 += sin(fVar0 - Local_625.f_11 * 360f / Local_625.f_9) * Local_625.f_10 * -0.7f;
		}
	...
	vVar8 = {*uParam0.f_2 - get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
	vVar11 = {*uParam0.f_2 - get_offset_from_entity_in_world_coords(PLAYER::PLAYER_PED_ID(), 0f, -5f, 0f)};
	iVar14 = vVar8.x * vVar4.x + vVar8.y * vVar4.y > 0f;
	...
	iVar16 = (fVar15 > Local_625.f_12 && iVar14);
	Local_625.f_1 = iVar16;
	if (Local_625.f_6 == 1)
	{
		set_pad_shake(0, 200, 150);
		if (fVar0 > 6.5f || iVar16 == 0)
		{
			stop_sound(Local_625.f_4);
			Local_625.f_6 = 0;
			iLocal_354 = 0;
	...
	{
		if (fVar0 <= 6.5f && iVar16)
		{
			stop_sound(Local_625.f_3);
			play_sound_from_entity(Local_625.f_4, "CONTINUAL_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_6 = 1;
		}
		else
		{
			...
			play_sound_from_entity(Local_625.f_3, "IDLE_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
			if (iVar16)
			{
				set_pad_shake(0, 200, 150);
			}
	...
	if (is_aim_cam_active())
	{
		if (Local_625.f_7 == 0)
		{
			play_sound_from_entity(Local_625.f_5, "SCAN", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
			Local_625.f_7 = 1;
		}
		else if (iVar16)
		{
	...
	else
	{
		...
		_push_scaleform_movie_function(iLocal_165, "SET_DISTANCE");
		_push_scaleform_movie_function_parameter_float(fLocal_640);
		_pop_scaleform_movie_function_void();
		set_text_render_id(iLocal_166);
		draw_scaleform_movie(iLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
...
void func_312(auto uParam0)
{
	...
	if (func_334(*uParam0) && is_ped_in_group(*uParam0))
	{
	...
	switch (*uParam0.f_1)
	{
			...
			else if (*uParam0.f_2 == 0)
			{
				...
				while (*uParam0.f_3 == -1)
				{
					if (Local_538[iVar0 /*6*/].f_5 == 0)
					{
						...
						{
							if (!is_entity_at_coord(*uParam0, Local_538[iVar0 /*6*/], 3f, 3f, 3f, false, true, 0))
							{
				...
				task_follow_nav_mesh_to_coord(*uParam0, Local_538[*uParam0.f_3 /*6*/], 1f, -1, 0.25f, 5, 40000f);
				*uParam0.f_2 = 1;
			}
		...
		case 2:
			...
			else if (*uParam0.f_2 == 0)
			{
				...
				open_sequence_task(&iLocal_167);
				if (Local_538[*uParam0.f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_606[1 /*8*/])
					{
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_538[*uParam0.f_3 /*6*/].f_4 == 2)
				{
					task_achieve_heading(false, Local_538[*uParam0.f_3 /*6*/].f_3, 0);
					task_play_anim(false, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_538[*uParam0.f_3 /*6*/].f_4 == 3)
				{
					task_play_anim(false, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				close_sequence_task(iLocal_167);
				task_perform_sequence(*uParam0, iLocal_167);
				clear_sequence_task(&iLocal_167);
				*uParam0.f_2 = 1;
			}
			else if (*uParam0.f_2 == 1)
			{
		...
		case 4:
			...
			{
				if (!is_entity_at_coord(PLAYER::PLAYER_PED_ID(), *uParam0.f_4, 1f, 1f, 1f, false, true, 0) || iLocal_353 > 0)
				{
					if (!is_ped_in_group(*uParam0))
					{
						clear_ped_tasks(*uParam0);
						set_ped_as_group_member(*uParam0, func_313());
						PED::SET_PED_CONFIG_FLAG(*uParam0, 167, true);
					}
					iLocal_756 = GAMEPLAY::GET_GAME_TIMER();
					if (iLocal_353 == 0)
					{
						set_group_formation(func_313(), 0);
					}
					else
					{
						set_group_formation(func_313(), 0);
					}
					set_group_formation_spacing(func_313(), 4f, -1f, -1f);
					*uParam0.f_2 = 1;
				}
			}
			else if (*uParam0.f_2 == 1)
			{
				...
				if (is_ped_sprinting(PLAYER::PLAYER_PED_ID()) || is_ped_jumping(PLAYER::PLAYER_PED_ID()))
				{
					if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_757 > 7500 && !func_275()) && !is_message_being_displayed()) && !iLocal_337)
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
				...
				{
					if ((((iLocal_758 < 4 && !func_275()) && !is_message_being_displayed()) && !iLocal_337) && !func_335())
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
		...
		case 5:
			...
			{
				task_go_to_entity(*uParam0, PLAYER::PLAYER_PED_ID(), 20000, 4.5f, 2f, 2f, 0);
				*uParam0.f_2 = 1;
			}
			else if (*uParam0.f_2 == 1)
			{
...
{
	if (func_334(iParam0) && func_227(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_623 == 0)
		{
			if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iParam0) && is_ped_ragdoll(iParam0))
			{
...
int func_315(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_316(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	play_sound_from_entity(Local_625.f_2, "DEVICE", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
	if (Local_625.f_13 == 0)
	{
...
void func_317(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_318(auto uParam0, auto uParam1)
{
	if (func_334(*uParam0))
	{
		if (*uParam0.f_1 == 2)
		{
			Local_538[uParam1 /*6*/].f_5 = 0;
		}
		*uParam0.f_1 = 2;
		*uParam0.f_2 = 0;
		Local_538[uParam1 /*6*/].f_5 = 1;
		*uParam0.f_3 = uParam1;
		if (is_ped_in_group(*uParam0))
		{
			remove_ped_from_group(*uParam0);
		...
		clear_ped_tasks_immediately(*uParam0);
		set_entity_coords(*uParam0, Local_538[uParam1 /*6*/], 1, false, 0, 1);
		set_entity_heading(*uParam0, Local_538[uParam1 /*6*/].f_3);
	}
	else
	{
		*uParam0.f_1 = 0;
...
{
	if (func_334(*uParam0) && func_334(PLAYER::PLAYER_PED_ID()))
	{
		*uParam0.f_1 = 4;
		*uParam0.f_2 = 0;
		task_look_at_entity(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
		if (iParam1)
		{
			task_turn_ped_to_face_entity(*uParam0, PLAYER::PLAYER_PED_ID(), 0);
		}
		*uParam0.f_4 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
	}
	else
	{
		*uParam0.f_1 = 0;
...
bool func_325()
{
	...
	if (!has_model_loaded(iLocal_160) || !has_model_loaded(joaat("bison")))
	{
		return false;
	}
	return true;
...
bool func_326()
{
	request_additional_text("EPS4", false);
...
void func_327()
{
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (func_271(1, 1093140480, 0))
		{
			...
			{
				register_entity_for_cutscene(Local_83.f_28[0], "Marnie", 0, false, 0);
			}
			if (func_334(Local_83.f_28[1]))
			{
				freeze_entity_position(Local_83.f_28[1], false);
				if (func_227(get_current_ped_weapon_entity_index(Local_83.f_28[1])))
				{
					iLocal_641 = func_267(Local_83.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					register_entity_for_cutscene(iLocal_641, "Artefact_Detector", 0, false, 0);
				}
				register_entity_for_cutscene(Local_83.f_28[1], "Jimmy_Boston", 0, false, 0);
			}
			if (func_334(PLAYER::PLAYER_PED_ID()))
			{
				register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), "Michael", 0, false, 0);
	...
	if (Local_772.f_1 == 1)
	{
		...
		if (func_227(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				func_384("*** Forcing Michael's move state");
				func_330(PLAYER::PLAYER_PED_ID(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), iLocal_159, -1, true, true);
			}
		}
...
void func_328()
{
	...
	if (func_227(Local_606[1 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Jimmy_Boston", false))
		{
			get_ground_z_for_3d_coord(1829.8f, 4693.48f, 38.5f, &fVar0, 0);
			set_entity_coords(Local_606[1 /*8*/], 1829.8f, 4693.48f, fVar0, 1, false, 0, 1);
		}
	}
}
...
void func_329()
{
	if (func_227(Local_606[0 /*8*/]))
	{
		if (can_set_exit_state_for_registered_entity("Marnie", false))
		{
			...
			task_go_straight_to_coord(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 0.5f);
			force_ped_motion_state(Local_606[0 /*8*/], -668482597, false, 1, 1);
			Local_606[0 /*8*/].f_7 = 1;
...
int func_330(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_332()
{
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (!func_395(0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
	...
	if (Local_772.f_1 == 1)
	{
		...
		if (!func_395(0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
			if (func_226(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 3f)
			{
				if (!is_gameplay_hint_active())
				{
					if (!iLocal_333)
					{
						if (func_227(Local_83.f_28[0]))
						{
							...
							{
								open_sequence_task(&iLocal_167);
								task_look_at_entity(false, Local_83.f_28[0], 15000, 0, 2);
								task_follow_nav_mesh_to_coord(false, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 40000f);
								task_turn_ped_to_face_entity(false, Local_83.f_28[0], 0);
								close_sequence_task(iLocal_167);
								task_perform_sequence(PLAYER::PLAYER_PED_ID(), iLocal_167);
								clear_sequence_task(&iLocal_167);
			...
			if (!iLocal_334)
			{
				...
				{
					task_look_at_entity(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					task_play_anim(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					remove_cutscene();
					_request_cutscene_2("EP_4_RCM_CONCAT", 2, 8);
			...
			else if (func_334(Local_83.f_28[0]))
			{
				if (is_entity_playing_anim(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					...
					if (func_226(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 1.5f)
					{
						set_player_control(player_id(), false, 0);
						clear_ped_tasks(PLAYER::PLAYER_PED_ID());
					}
...
void func_336(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_338(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_345(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_344(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_343(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_342(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_341(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_340(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_339(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_345(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_347(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_349(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_221(0)) || func_348(1))
			{
			}
			else
			{
...
void func_357(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_396())
	{
...
bool func_359(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
...
void func_360(auto uParam0)
{
	...
	*uParam0.f_1 = create_object_no_offset(*uParam0, vVar0, 1, 1, 0);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_1))
	{
		...
		func_361("Rock actual position: ", get_entity_coords(*uParam0.f_1, 0));
		set_entity_can_be_damaged(*uParam0.f_1, 0);
		freeze_entity_position(*uParam0.f_1, true);
	}
}

void func_361(char* sParam0, Vector3 vParam1)
{
	sParam0 = sParam0;
	vParam1 = {vParam1};
}
...
void func_362()
{
	...
	while (!has_scaleform_movie_loaded(iLocal_165))
	{
		wait(0);
	}
	...
	link_named_rendertarget(iLocal_160);
	if (is_named_rendertarget_registered("digiscanner"))
	{
		iLocal_166 = get_named_rendertarget_render_id("digiscanner");
	}
}
...
void func_364()
{
	...
	uLocal_761 = func_369(1846.512f, 4705.614f, 38.1214f, 25.7591f, 3);
...
void func_365(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0.f_46 = *uParam1.f_46;
	while (iVar1 < *uParam1.f_46)
	{
		...
		if (func_315(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = {-vVar9};
		}
...
void func_367(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
void func_376(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	int iVar0;
...
void func_377(Vector3 vParam0, float fParam1)
{
	int iVar0;
...
void func_379(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	int iVar0;
...
void func_380(int iParam0, Vector3 vParam1, Vector3 vParam2)
{
	int iVar0;
...
void func_382()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_278(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_385(Vector3 vParam0, float fParam1)
{
	Vector3 vVar0;
...
void func_397()
{
	...
	if (func_334(PLAYER::PLAYER_PED_ID()))
	{
		...
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
		clear_ped_tasks(PLAYER::PLAYER_PED_ID());
		set_ped_capsule(PLAYER::PLAYER_PED_ID(), 0f);
	}
	if (is_new_load_scene_active())
	{
		new_load_scene_stop();
	...
	remove_scenario_blocking_area(iLocal_163, 0);
...
void func_400(int iParam0)
{
	...
	if (!func_415())
	{
		...
		{
			func_175(iVar0, 1, 0);
			func_401(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_402(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_408())
	{
		...
		{
			iVar33 = func_403(get_this_script_name());
			if (iVar33 > -1)
			{
