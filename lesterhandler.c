...
void main()
{
	...
	while ((!has_anim_dict_loaded("MISSHEIST_JEWEL@HACKING") || !STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_walking_stick"))) || !STREAMING::HAS_MODEL_LOADED(joaat("prop_laptop_lester2")))
	{
		wait(0);
	}
	...
	while (!GAMEPLAY::IS_BIT_SET(iLocal_216, true))
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_216, false))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					iLocal_47 = create_object(joaat("prop_cs_walking_stick"), 706.9874f, -967.0945f, 30.4f, 0, false, false);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_46, 0))
			{
				...
				if (Global_69753 == 86)
				{
					if (!Global_101149 == 1 && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, 0, true, 0))
					{
						func_3(7, 1);
						Global_101145 = 0;
						Global_101149 = 1;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_21(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(iVar0) && (!func_11(14) || Global_100106))
			{
...
void func_22(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
