...
void main()
{
	...
	while (true)
	{
		...
		{
			func_363();
			if (is_entity_in_angled_area(player_ped_id(), 237.926f, 360.2992f, 103.6515f, 244.6899f, 357.8277f, 107.3224f, 4.75f, 0, true, 0))
			{
		...
		else if (Var0 == 12)
		{
			...
			func_341();
			if (is_entity_in_angled_area(player_ped_id(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
			{
				if (!is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (!func_340(player_ped_id(), 713668775))
					{
...
void func_128()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			if (func_129(get_vehicle_ped_is_in(player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
	...
	switch (*uParam0)
	{
		...
		case 16:
			if (func_92(0))
			{
				...
				func_182(player_ped_id(), 12, 28, 0, -1, 0, 0, 0, -1, -1, -1, 0);
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_206(get_entity_model(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_206(get_entity_model(iParam0), iVar1, 14, 4);
		}
	}
...
{
	if (func_362(player_ped_id()))
	{
		switch (iParam0)
		{
			case 15:
				if (func_184(player_ped_id(), 12, 8))
				{
					return true;
				}
				break;
			...
			case 16:
				if (func_184(player_ped_id(), 12, 8) || func_184(player_ped_id(), 12, 28))
				{
					return true;
				}
				break;
	...
	switch (*uParam0.f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (func_362(get_vehicle_ped_is_in(player_ped_id(), 0)))
					{
						...
						{
							if (_is_cargobob_hook_active(get_vehicle_ped_is_in(player_ped_id(), 0)) && is_vehicle_attached_to_cargobob(get_vehicle_ped_is_in(player_ped_id(), 0), *uParam0.f_35[0]))
							{
								if (func_303(3))
								{
									return true;
			...
			if (is_entity_in_angled_area(player_ped_id(), *(uParam0.f_17[0 /*3*/]), *(uParam0.f_17[1 /*3*/]), *uParam0.f_24, 0, true, 0))
			{
				if (*uParam0 == 45)
				{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_77()) || func_308()) || func_307()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_307()) || func_77()) || func_308()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_77()) || func_308()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (does_entity_exist(player_ped_id()))
						{
							if ((((((((((((((is_ped_in_combat(player_ped_id(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_311()) || Global_25122) || func_310()) || func_309(8, -1)) || func_308()) || func_307()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || func_311()) || func_308()) || Global_100201) || Global_25122) || func_310()) || Global_36839) || func_309(8, -1)) || func_307()) || func_305()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(player_ped_id())) || is_ped_in_any_vehicle(player_ped_id(), 1)) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_ped_swimming(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_307()) || func_305()) || func_77()) || func_308()) || func_306())
						{
							return false;
						}
						break;
...
void func_313(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_317(player_ped_id(), vParam2, 1) <= 100f)
				{
					func_316(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_317(player_ped_id(), vParam2, 1) > 120f)
				{
					func_319(iParam0);
				}
			}
...
void func_322()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_317(player_ped_id(), -726.45f, 33.33f, 43.23f, 1) < 9f)
			{
			...
			if (func_317(player_ped_id(), -666.55f, 49.19f, 42.08f, 1) < 9f)
			{
...
bool func_335(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_303(2))
	{
		if (!func_334())
		{
			if (((func_362(player_ped_id()) && func_362(*uParam0.f_28[0])) && get_game_timer() - *uParam0.f_60 > iParam8) && func_317(player_ped_id(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_336(sParam5))
		{
			if (func_362(player_ped_id()))
			{
				if (func_317(player_ped_id(), vParam1, 1) >= 20f)
				{
					func_333();
				}
			}
...
void func_339()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_317(player_ped_id(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_264 == 0)
			{
		...
		case 2:
			...
			else if (func_317(player_ped_id(), 1826.45f, 4699.58f, 38.15f, 1) >= 28f)
			{
				func_333();
				iLocal_97 = 0;
			}
...
int func_342(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_362(player_ped_id()) && func_362(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_355(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
...
{
	return func_345(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
bool func_361(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_362(player_ped_id()) && func_362(*uParam0.f_28[0])) && !func_334()) && get_game_timer() - *uParam0.f_60 > iParam8) && func_317(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_403(&uVar0, iParam6, *uParam0.f_28[0], sParam7, 0, 1);
		func_338(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_363()
{
	...
	if (is_entity_in_angled_area(player_ped_id(), 244.9669f, 374.6696f, 104.4579f, 239.6119f, 360.3045f, 107.7523f, 9.0625f, 0, true, 0))
	{
		Global_2288 = 1;
	}
	else
...
bool func_369(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			...
			{
				iVar0 = get_entity_model(func_370(get_vehicle_ped_is_in(player_ped_id(), 1)));
				switch (iVar0)
				{
...
void func_380()
{
	...
	if (func_317(player_ped_id(), -726.45f, 33.33f, 43.23f, 1) <= func_317(player_ped_id(), -666.55f, 49.19f, 42.08f, 1))
	{
	...
	if (func_362(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_384(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_385(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_384(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_390(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
bool func_408(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			set_ped_relationship_group_hash(*uParam0.f_28[0], iLocal_94);
			set_ped_relationship_group_hash(*uParam0.f_28[1], iLocal_94);
			set_ped_relationship_group_hash(*uParam0.f_28[2], iLocal_94);
			set_ped_relationship_group_hash(*uParam0.f_28[3], iLocal_94);
...
bool func_415(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_362(*uParam0.f_28[0]) && func_110(player_ped_id()))
			{
...
bool func_416(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				if (func_417(uParam0.f_28[0], 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_110(player_ped_id()))
				{
					iVar4 = get_ped_relationship_group_hash(player_ped_id());
					set_ped_relationship_group_hash(*uParam0.f_28[0], iVar4);
					set_ped_config_flag(*uParam0.f_28[0], 132, true);
				}
				else
				{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!does_entity_exist(*uParam0.f_28[1]))
			{
				...
				{
					set_ped_relationship_group_hash(*uParam0.f_28[1], iVar5);
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!does_entity_exist(*uParam0.f_28[0]))
			{
				...
				{
					if (does_entity_exist(*uParam0.f_28[0]) && func_110(player_ped_id()))
					{
						iVar8 = get_ped_relationship_group_hash(player_ped_id());
						set_ped_can_ragdoll_from_player_impact(*uParam0.f_28[0], 0);
						set_ped_relationship_group_hash(*uParam0.f_28[0], iVar8);
						set_ped_config_flag(*uParam0.f_28[0], 132, true);
...
void func_430(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		set_bit(&(Global_31487[Var0.f_1]), Var0);
	}
	else
	{
