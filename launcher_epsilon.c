#region Local Var
	...
	int iLocal_272 = 0;
	int iLocal_273 = 0;
	Vector3[] vLocal_274 = new Vector3[3];
	struct<2> Local_284 = 0;
	auto uLocal_286 = 0;
	auto uLocal_287 = 0;
	auto uLocal_288 = 0;
	auto uLocal_289 = 0;
...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_464(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_449(&Var0, 1);
	}
	if (!func_446(&iVar65, &Var0, vVar61, 5f))
	{
		func_445();
	...
	while (true)
	{
		...
		{
			func_363();
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 237.926f, 360.2992f, 103.6515f, 244.6899f, 357.8277f, 107.3224f, 4.75f, 0, true, 0))
			{
		...
		else if (Var0 == 11)
		{
			...
			{
				if (!is_ped_fleeing(Var0.f_28[0]) && !PED::IS_PED_RAGDOLL(Var0.f_28[0]))
				{
					func_361(&Var0, vVar61, "EPS3AUD", "EP3_AMB", 3, "MARNIE", 500, 1101004800);
				}
				if (func_342(Var0.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (has_anim_dict_loaded("rcmepsilonism3"))
					{
						...
						AI::TASK_PLAY_ANIM(false, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						close_sequence_task(iLocal_267);
						task_perform_sequence(Var0.f_28[0], iLocal_267);
					}
					else
					{
		...
		else if (Var0 == 12)
		{
			...
			func_341();
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
			{
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (!func_340(PLAYER::PLAYER_PED_ID(), 713668775))
					{
						set_player_control(player_id(), false, 256);
						task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
					}
				}
			}
			func_339();
		...
		else if (Var0 == 13)
		{
			if (func_362(Var0.f_28[0]))
			{
				if (!is_ped_fleeing(Var0.f_28[0]) && !PED::IS_PED_RAGDOLL(Var0.f_28[0]))
				{
					if (func_335(&Var0, vVar61, "EPS5AUD", "EP5_AMB", 4, "MARNIE", 1500))
					{
		...
		func_321(Var0);
		func_313(&iLocal_96, &(Var0.f_9), vVar61);
...
void func_3(int iParam0, char* sParam1)
{
	...
	while (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 5))
	{
		if (_get_number_of_instances_of_streamed_script(joaat("mission_stat_watcher")) > 0)
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_17264[iParam0 /*6*/]), 5);
		}
	}
	func_4(iParam0);
}
...
void func_25(auto uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_27(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_28(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_30(auto uParam0, int iParam1, int iParam2)
{
...
void func_37(int iParam0, auto uParam1)
{
	int iVar0;
...
bool func_39(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_41(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_43(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_46(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_51(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_57(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_67(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_77())
		{
			*uParam0 = func_73(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_73(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_76(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_74(iVar0, 0), 1);
...
{
	return shift_right(iParam0, 26) & 31 * func_84(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_94(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_114(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_121(player_id())) && !func_119(player_id(), 0)) && !func_118())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_121(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_123(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_128()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_129(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_129(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_138(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_143()
{
	return func_144(get_this_script_name(), 0);
}
...
void func_146(int iParam0, int iParam1)
{
	...
	{
		case 0:
			*iParam1 = func_147(-1604.668f, 5239.1f, 3.01f, 0);
			set_blip_sprite(*iParam1, 66);
			set_blip_colour(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_147(-1592.84f, 5214.04f, 3.01f, 0);
		...
		case 2:
		case 3:
			*iParam1 = func_147(190.26f, -956.35f, 29.63f, 0);
			if ((GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[2 /*6*/], 3) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[4 /*6*/], 3)) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[4 /*6*/], 3))
			{
		...
		case 4:
			*iParam1 = func_147(414f, -761f, 29f, 0);
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[2 /*6*/], 3) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[3 /*6*/], 3))
			{
				set_blip_sprite(*iParam1, 381);
			}
			else
		...
		case 9:
			*iParam1 = func_147(-1622.89f, 4204.87f, 83.3f, 0);
			set_blip_sprite(*iParam1, 66);
			set_blip_colour(*iParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*iParam1 = func_147(1835.53f, 4705.86f, 38.1f, 0);
			}
			else if (iParam0 == 12)
			{
				*iParam1 = func_147(1826.13f, 4698.88f, 38.92f, 0);
			}
			else
			{
				*iParam1 = func_147(637.02f, 119.7093f, 89.5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*iParam1 = func_147(-954.19f, -2760.05f, 14.64f, 0);
			}
			else
			{
				*iParam1 = func_147(-63.8f, -809.5f, 321.8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*iParam1 = func_147(-1877.82f, -440.649f, 45.05f, 0);
			}
			else
			{
				*iParam1 = func_147(-915.6f, 6139.2f, 5.5f, 0);
			}
			if ((GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[21 /*6*/], 3) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[22 /*6*/], 3)) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[23 /*6*/], 3))
			{
		...
		case 27:
			*iParam1 = func_147(-1104.93f, 291.25f, 64.3f, 0);
			set_blip_sprite(*iParam1, 66);
			set_blip_colour(*iParam1, 44);
			break;
		...
		case 34:
			*iParam1 = func_147(-303.82f, 6211.29f, 31.05f, 0);
			set_blip_sprite(*iParam1, 386);
			set_blip_colour(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_147(-44.75f, -1288.67f, 28.21f, 0);
			set_blip_sprite(*iParam1, 149);
			set_blip_colour(*iParam1, 44);
			break;
		
		case 46:
			*iParam1 = func_147(-149.75f, 285.81f, 93.67f, 0);
			set_blip_sprite(*iParam1, 66);
			set_blip_colour(*iParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*iParam1 = func_147(-70.71f, 301.43f, 106.79f, 0);
			}
			else
			{
				*iParam1 = func_147(-257.22f, 292.85f, 90.63f, 0);
			}
...
int func_147(Vector3 vParam0, int iParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(vParam0);
	set_blip_scale(iVar0, func_148(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	set_blip_route(iVar0, iParam3);
	return iVar0;
}

float func_148(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
	...
	switch (*uParam0)
	{
		...
		case 16:
			if (func_92(0))
			{
				...
				func_182(PLAYER::PLAYER_PED_ID(), 12, 28, 0, -1, 0, 0, 0, -1, -1, -1, 0);
...
bool func_156(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_159(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_161() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_161() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_160(iParam0));
...
int func_163(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_161() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_167(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_168(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_172(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_175(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_193(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_193(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_193(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_224(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_193(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_193(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_193(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_184(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_193(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_193(iParam1)))
	{
		return true;
	}
	return false;
...
bool func_189(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_196(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		if (!_is_dlc_data_empty(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						*iParam0[vVar16.z] = func_206(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_193(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_212(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_212(vVar16.z)] = func_206(iParam1, vVar16.x, func_212(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_212(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_193(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar0 = func_215(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar1 = func_215(iParam0, iParam2, 1, 4);
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_215(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
	...
	while (iVar4 <= iVar2 - 1)
	{
		...
		else
		{
			...
			while (iVar5 <= iVar6 - 1)
			{
				...
				{
					iVar3 += func_220(iParam0, iParam3);
					return iVar3;
				}
				else
				{
...
void func_225(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_227(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_47(uVar2, iVar0, 0);
		GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_226(uVar2, iVar3, iVar0, 1);
	}
}

void func_226(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_48(iParam2)];
	if (iVar0 != 0)
	{
...
int func_227(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_228(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_232(int iParam0)
{
	...
	func_233(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_233(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_238(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			if (func_234(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_47(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_234(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_237(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_239(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_233(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_193(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_233(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_296(int iParam0)
{
	if (func_362(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			case 15:
				if (func_184(PLAYER::PLAYER_PED_ID(), 12, 8))
				{
					return true;
				}
				break;
			...
			case 16:
				if (func_184(PLAYER::PLAYER_PED_ID(), 12, 8) || func_184(PLAYER::PLAYER_PED_ID(), 12, 28))
				{
					return true;
				}
				break;
...
bool func_297(auto uParam0, int iParam1)
{
	switch (*uParam0.f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					...
					{
						if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*uParam0.f_28[0], 1), 1) < 3f)
						{
							if (func_303(2))
							{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[0]))
			{
				...
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*uParam0.f_35[0], 1), 1) < *uParam0.f_15)
					{
						if (func_303(2))
						{
							if (func_301(*uParam0.f_27))
		...
		case 3:
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), *(uParam0.f_17[0 /*3*/]), 1) < *uParam0.f_15)
			{
				if (func_303(2))
				{
					if (func_301(*uParam0.f_27))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_362(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
bool func_299(auto uParam0)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && *uParam0.f_27)
	{
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*uParam0.f_28[0], 1), 1) < *uParam0.f_15 + fVar0)
		{
			return true;
		}
	}
	else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*uParam0.f_28[0], 1), 1) < *uParam0.f_15)
	{
		return true;
	}
	return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_77()) || func_308()) || func_307()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_311()) || Global_25122) || func_310()) || func_309(8, -1)) || func_307()) || func_77()) || func_308()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_307()) || func_77()) || func_308()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_77()) || func_308()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_311() || get_player_wanted_level(player_id()) > 0) || func_309(8, -1)) || func_306()) || func_305()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_311()) || Global_25122) || func_310()) || func_309(8, -1)) || func_308()) || func_307()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_311()) || func_308()) || Global_100201) || Global_25122) || func_310()) || Global_36839) || func_309(8, -1)) || func_307()) || func_305()) || func_306()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_311()) || Global_100201) || Global_25122) || func_310()) || func_309(8, -1)) || func_307()) || func_305()) || func_77()) || func_308()) || func_306())
						{
							return false;
						}
						break;
...
void func_312(auto uParam0, int iParam1)
{
	if (!*iParam1)
	{
		if (is_player_playing(player_id()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), *(uParam0.f_17[0 /*3*/]), 1) > 25f)
				{
...
void func_313(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_317(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_316(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_317(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_319(iParam0);
				}
			}
...
auto func_317(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_322()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_317(PLAYER::PLAYER_PED_ID(), -726.45f, 33.33f, 43.23f, 1) < 9f)
			{
			...
			if (func_317(PLAYER::PLAYER_PED_ID(), -666.55f, 49.19f, 42.08f, 1) < 9f)
			{
...
void func_331(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_362(*iParam0.f_28[0]))
	{
		switch (iLocal_272)
		{
			...
			case 1:
				...
				{
					task_follow_nav_mesh_to_coord(*iParam0.f_28[0], vLocal_274[iLocal_273 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
			...
			case 2:
				if (func_317(*iParam0.f_28[0], vLocal_274[iLocal_273 /*3*/], 1) <= 1.2f)
				{
					iLocal_272 = 3;
...
bool func_335(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	auto uVar0;
	...
	if (func_303(2))
	{
		if (!func_334())
		{
			if (((func_362(PLAYER::PLAYER_PED_ID()) && func_362(*uParam0.f_28[0])) && GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_60 > iParam8) && func_317(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_403(&uVar0, iParam6, *uParam0.f_28[0], sParam7, 0, 1);
				func_338(&uVar0, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_336(sParam5))
		{
			if (func_362(PLAYER::PLAYER_PED_ID()))
			{
				if (func_317(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_333();
				}
			}
...
void func_339()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_317(PLAYER::PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_264 == 0)
			{
		...
		case 2:
			...
			else if (func_317(PLAYER::PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) >= 28f)
			{
				func_333();
				iLocal_97 = 0;
			}
...
void func_341()
{
	_push_scaleform_movie_function(iLocal_268, "SET_COLOUR");
	_push_scaleform_movie_function_parameter_int(255);
	...
	_push_scaleform_movie_function(iLocal_268, "SET_DISTANCE");
	_push_scaleform_movie_function_parameter_float(10f);
	_pop_scaleform_movie_function_void();
	set_text_render_id(iLocal_269);
	draw_scaleform_movie(iLocal_268, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
...
int func_342(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	
	if (func_362(PLAYER::PLAYER_PED_ID()) && func_362(iParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		if (func_356(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_355(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
...
bool func_343(int iParam0, float fParam1)
{
	...
	if (func_362(PLAYER::PLAYER_PED_ID()) && func_362(iParam0))
	{
		if (func_354(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_345(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_345(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_346(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_346(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_347(iParam4, iParam7)};
...
bool func_349(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_351(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	{
		vVar3 = {func_351(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_350(vVar3, vVar0);
...
float func_350(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}

Vector3 func_351(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_355(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_356(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_362(PLAYER::PLAYER_PED_ID()) && func_362(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_360(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_357(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_357(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_358(int iParam0, float fParam1)
{
	...
	{
		if (func_359(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_359(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_351(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_361(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_362(PLAYER::PLAYER_PED_ID()) && func_362(*uParam0.f_28[0])) && !func_334()) && GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_60 > iParam8) && func_317(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_403(&uVar0, iParam6, *uParam0.f_28[0], sParam7, 0, 1);
		func_338(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_363()
{
	...
	if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 244.9669f, 374.6696f, 104.4579f, 239.6119f, 360.3045f, 107.7523f, 9.0625f, 0, true, 0))
	{
		Global_2288 = 1;
	}
	else
...
bool func_369(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_370(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_371(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_372(iParam0) && _get_number_of_instances_of_streamed_script(Global_82399[26 /*34*/].f_6) == 0)
			{
				Global_101154.f_5951[iParam0] = 1;
				_set_door_acceleration_limit(*uParam1.f_5, Global_101154.f_5951[iParam0], 1, 1);
			}
...
void func_380()
{
	...
	if (func_317(PLAYER::PLAYER_PED_ID(), -726.45f, 33.33f, 43.23f, 1) <= func_317(PLAYER::PLAYER_PED_ID(), -666.55f, 49.19f, 42.08f, 1))
	{
	...
	if (func_362(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= *iParam0.f_28 - 1)
		{
			if (func_110(*iParam0.f_28[iVar0]))
			{
				...
				task_combat_ped(*iParam0.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
...
bool func_382(auto uParam0, int iParam1)
{
	struct<27> Var0;
...
void func_383(int iParam0, auto uParam1, int iParam2)
{
	...
	if (func_362(iParam0))
	{
		switch (*uParam1.f_3)
		{
					...
					if (has_anim_dict_loaded(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_385(uParam1))
								{
									AI::TASK_PLAY_ANIM_advanced(false, *uParam1, *uParam1.f_2, *uParam1.f_5, *uParam1.f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									AI::TASK_PLAY_ANIM_advanced(false, *uParam1, *uParam1.f_1, *uParam1.f_5, *uParam1.f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								AI::TASK_PLAY_ANIM_advanced(false, *uParam1, *uParam1.f_1, *uParam1.f_5, *uParam1.f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
			...
			case 2:
				if (!func_385(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_384(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_385(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 3:
				...
				if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
				{
					AI::TASK_PLAY_ANIM(false, *uParam1, *uParam1.f_2, 4f, -4f, -1, 262144, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM_advanced(false, *uParam1, *uParam1.f_2, *uParam1.f_5, *uParam1.f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					AI::TASK_PLAY_ANIM_advanced(false, *uParam1, *uParam1.f_1, *uParam1.f_5, *uParam1.f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_384(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (func_110(*uParam0.f_28[iVar0]))
			{
				...
				switch (*uParam0)
				{
					...
					case 8:
						...
						open_sequence_task(&iVar1);
						AI::TASK_PLAY_ANIM(false, "rcmcollect_paperleadinout@", "meditate_getup", 8f, -8f, -1, 8, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
						close_sequence_task(iVar1);
					...
					case 1:
						...
						open_sequence_task(&iVar1);
						AI::TASK_PLAY_ANIM(false, "rcmabigail", "breakout_base", 8f, -8f, -1, 8, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
						close_sequence_task(iVar1);
						task_perform_sequence(*uParam0.f_28[iVar0], iVar1);
						clear_sequence_task(&iVar1);
					...
					case 32:
						...
						if (iVar0 == 0)
						{
							AI::TASK_PLAY_ANIM(false, "rcmminute1", "base_to_idle_joe", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						else
						{
							AI::TASK_PLAY_ANIM(false, "rcmminute1", "base_to_idle_josef", 8f, -8f, -1, 32776, 0, 0, 0, 0);
						}
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
						close_sequence_task(iVar1);
						task_perform_sequence(*uParam0.f_28[iVar0], iVar1);
					...
					case 24:
						...
						open_sequence_task(&iVar1);
						AI::TASK_PLAY_ANIM(false, "special_ped@hao@base", "hao_exit", 8f, -8f, -1, 520, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
						close_sequence_task(iVar1);
						task_perform_sequence(*uParam0.f_28[iVar0], iVar1);
						clear_sequence_task(&iVar1);
...
bool func_389(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(*uParam0.f_35[iVar0], PLAYER::PLAYER_PED_ID()) && get_entity_speed(PLAYER::PLAYER_PED_ID()) > 5f)
						{
					...
					else
					{
						...
						if (func_302(iVar3))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(*uParam0.f_35[iVar0], iVar3) && get_entity_speed(iVar3) > 6f)
							{
						...
						if (*uParam0 == 16)
						{
							if (func_390(PLAYER::PLAYER_PED_ID(), *uParam0.f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(*uParam0.f_28[iVar0]))
				{
					...
					if (func_393(*uParam0))
					{
						...
						if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(*uParam0.f_28[iVar0], 1), 15f))
						{
							if (iParam2 == 0)
							{
								func_387(uParam0);
					...
					if (!func_392(*uParam0))
					{
						if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(*uParam0.f_28[iVar0], 1), 5f))
						{
							if (iParam2 == 0)
							{
								func_387(uParam0);
...
void func_394(int iParam0)
{
	...
	if (func_362(PLAYER::PLAYER_PED_ID()) && func_362(iParam0))
	{
		...
		open_sequence_task(&iVar0);
		AI::TASK_PLAY_ANIM(false, "rcmextreme3", "jump_fall", 1000f, -8f, -1, 8, 0, 0, 0, 0);
...
void func_402()
{
	...
	while (!has_scaleform_movie_loaded(iLocal_268))
	{
		wait(0);
	}
	...
	if (is_named_rendertarget_registered("digiscanner"))
	{
		iLocal_269 = get_named_rendertarget_render_id("digiscanner");
	}
	iLocal_271 = AUDIO::GET_SOUND_ID();
	iLocal_270 = GAMEPLAY::GET_GAME_TIMER();
}

void func_403(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_408(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			set_ped_component_variation(*uParam0.f_28[0], 4, 0, true, 0);
			set_ped_component_variation(*uParam0.f_28[0], 8, 1, false, 0);
			set_ped_component_variation(*uParam0.f_28[0], 11, 1, false, 0);
			...
			set_ped_component_variation(*uParam0.f_28[1], 3, 0, true, 0);
			...
			set_ped_component_variation(*uParam0.f_28[2], false, 0, true, 0);
			set_ped_component_variation(*uParam0.f_28[2], 3, 0, true, 0);
			set_ped_component_variation(*uParam0.f_28[2], 4, 0, true, 0);
			set_ped_component_variation(*uParam0.f_28[2], 8, 0, false, 0);
			set_ped_component_variation(*uParam0.f_28[2], 11, 0, false, 0);
			set_ped_component_variation(*uParam0.f_28[3], false, 1, false, 0);
			set_ped_component_variation(*uParam0.f_28[3], 3, 0, 2, 0);
			set_ped_component_variation(*uParam0.f_28[3], 4, 0, 2, 0);
			set_ped_component_variation(*uParam0.f_28[3], 8, 1, false, 0);
			set_ped_component_variation(*uParam0.f_28[3], 11, 0, true, 0);
			add_relationship_group("gang", &iLocal_94);
...
void func_409(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	func_410(iParam0);
...
void func_411(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_412(iParam0);
...
bool func_415(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_413(&iVar0) || !has_anim_dict_loaded(sVar5))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_362(*uParam0.f_28[0]) && func_110(PLAYER::PLAYER_PED_ID()))
			{
...
bool func_416(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				if (func_417(uParam0.f_28[0], 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_110(PLAYER::PLAYER_PED_ID()))
				{
					iVar4 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
...
bool func_417(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_418(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_418(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_419(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_421(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
bool func_422(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_110(PLAYER::PLAYER_PED_ID()))
			{
				iVar5 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
			}
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]))
			{
...
int func_423(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_424(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]))
			{
				if (func_417(uParam0.f_28[0], 60, vVar3, fVar6, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]) && func_110(PLAYER::PLAYER_PED_ID()))
					{
						iVar8 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
...
struct<2> func_429(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_431(int iParam0, int iParam1)
{
	struct<5> Var0;
...
bool func_446(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_447(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_447(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_447(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_448(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_448(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_454(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_455(auto uParam0, int iParam1)
{
	func_456(uParam0.f_41, iParam1);
}

void func_456(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_458(auto uParam0, int iParam1)
{
	func_459(uParam0.f_35, iParam1);
}
