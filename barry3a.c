...
bool func_239()
{
	if (is_cop_ped_in_area_3d(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(70f, 70f, 70f), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(70f, 70f, 70f)))
	{
		return true;
	}
	return false;
		...
		case 1:
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
...
bool func_285(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_294())
		{
			*uParam0 = func_290(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_290(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_293(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_291(iVar0, 0), 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_338(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_335(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
bool func_355(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_357(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
