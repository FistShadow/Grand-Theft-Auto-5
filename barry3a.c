#region Local Var
	...
	int[] iLocal_164 = new int[2];
	Vector3[] vLocal_167 = new Vector3[6];
	struct<29>[] Local_186 = new struct<29>[2];
	int iLocal_245 = 0;
	int iLocal_246 = 0;
	int iLocal_247 = 0;
	int iLocal_248 = 0;
	...
	auto uLocal_414 = 0;
	auto uLocal_415 = 0;
	struct<2>[] Local_416 = new struct<2>[4];
	int iLocal_425 = 0;
	int iLocal_426 = 0;
	int iLocal_427 = 0;
	int iLocal_428 = 0;
...
void main()
{
	...
	if (func_426())
	{
		...
		switch (iVar0)
		{
			...
			case 1:
				func_424(vLocal_161, 298.7f, 1, 0);
				func_421(1);
				break;
...
void func_1()
{
	switch (iLocal_143)
	{
		case 0:
			func_212(&iLocal_144);
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				if (get_player_wanted_level(player_id()) < 1)
				{
					iLocal_437 = 1;
					iLocal_438 = 0;
					iLocal_144 = func_211(vLocal_161, 5, 1);
				}
				else
				{
					iLocal_437 = 1;
					iLocal_438 = 1;
					if (get_profile_setting(203) == 0 || !func_210())
					{
						func_208(2);
						iLocal_436 = 0;
					}
		...
		case 1:
			if (!func_205(Local_145.f_4, vLocal_161, 125f))
			{
			...
			else if (!iLocal_437)
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
				{
					...
					{
						iLocal_438 = 0;
						if (is_entity_at_coord(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
						{
							func_212(&iLocal_144);
							iLocal_143 = 0;
							iLocal_142 = 6;
			...
			else if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				clear_prints();
				iLocal_437 = 0;
				iLocal_436 = 1;
			...
			else if (is_entity_at_coord(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
			{
				func_212(&iLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
...
int func_205(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_208(int iParam0)
{
	if (func_207(iParam0))
	{
		func_209(vLocal_167[iParam0 /*3*/].f_2, 7500, 1);
...
void func_213()
{
	...
	{
		case 0:
			if (is_entity_at_coord(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				func_212(&iLocal_144);
				_set_unk_map_flag(0);
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
		...
		case 1:
			if (is_entity_at_coord(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_215();
					if (!func_214(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 55f, 1) && !is_entity_on_screen(Local_145.f_4))
					{
						iLocal_143 = 2;
					}
					else if ((iLocal_433 && func_207(5)) && (get_profile_setting(203) == 0 || !func_210()))
					{
						func_208(5);
					}
				}
...
int func_216(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Global_2621441 = 0;
	return func_217(sParam3, iParam4, iParam8);
}
...
void func_227(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_228()
{
	...
	while (iLocal_250 <= 5)
	{
		if (func_229(vLocal_167[iLocal_250 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_250++;
...
auto func_229(char* sParam0, int iParam1, char* sParam2)
{
...
void func_231(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_233(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_234()
{
	switch (iLocal_143)
	{
		case 0:
			func_212(&iLocal_144);
			if (!func_210() || get_profile_setting(203) == 0)
			{
				func_208(2);
				func_245(&uLocal_450);
				iLocal_431 = 0;
		...
		case 1:
			func_240(&uLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &sLocal_457);
...
void func_237()
{
	...
	{
		if (!func_210() && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_427 > Local_416[iLocal_426 /*2*/].f_1 && (func_239() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || get_entity_speed(Local_145.f_4) > 10f)
				{
					if (func_228() || get_profile_setting(203) == 0)
					{
...
int func_238(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_239()
{
	if (is_cop_ped_in_area_3d(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - Vector(70f, 70f, 70f), get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) + Vector(70f, 70f, 70f)))
	{
		return true;
	}
	return false;
...
void func_240(auto uParam0, auto uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 4:
			if (!is_scripted_conversation_ongoing() && func_241(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
int func_241(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_246()
{
	switch (iLocal_143)
	{
		case 0:
			func_212(&iLocal_144);
			iLocal_144 = func_206(Local_145.f_4, 1, 5);
			set_blip_route(iLocal_144, true);
			if (func_207(3) && (get_profile_setting(203) == 0 || !func_210()))
			{
				func_208(3);
				func_245(&uLocal_450);
			}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				func_212(&iLocal_144);
				iLocal_144 = func_211(vLocal_161, 5, 1);
				if (func_207(0) && (get_profile_setting(203) == 0 || !func_210()))
				{
					func_208(0);
					func_245(&uLocal_450);
				}
		...
		case 1:
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_145.f_4) && is_entity_at_coord(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
					if (!iLocal_432)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_427 > 8000 && iLocal_426 >= 4) && !func_210())
						{
...
void func_250(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_309(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_199(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_251(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_252(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_252(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_295();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_274(PLAYER::PLAYER_PED_ID(), 0);
...
void func_254(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_255(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_257(auto uParam0, int iParam1, int iParam2)
{
...
void func_263(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_264(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_265(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
int func_284(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_285(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_294())
		{
			*uParam0 = func_290(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_7() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_68(func_288(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
auto func_295()
{
	...
	func_305(&uVar0, get_clock_seconds());
	func_304(&uVar0, get_clock_minutes());
	func_303(&uVar0, get_clock_hours());
	func_298(&uVar0, get_clock_day_of_month());
	func_297(&uVar0, get_clock_month());
	func_296(&uVar0, get_clock_year());
	return uVar0;
}
...
auto func_300(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_301(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_313(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_338(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_335(get_entity_coords(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_314(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_314(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		if (func_284(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_331(iParam5, &Var0, vParam1, fParam4, func_259(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_267(iParam0, 0, 0)) || func_267(iParam0, 1, 0)) || func_267(iParam0, 2, 0)) || func_259(iParam0) != 145) || func_329(iParam0)) || func_328(iParam0)) || func_327(iParam0)) || func_326(iParam0)) || !func_318(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_328(iParam0))
		{
		}
...
int func_330(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_331(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_330(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
bool func_335(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_336(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_336(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	switch (Local_186[iParam0 /*29*/].f_24)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
			{
				...
				{
					Local_186[iParam0 /*29*/] = create_vehicle(iLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, 1, 1);
				}
			}
			else if (!is_entity_dead(Local_186[iParam0 /*29*/].f_1, 0))
			{
				set_ped_as_cop(Local_186[iParam0 /*29*/].f_1, 1);
				set_blocking_of_non_temporary_events(Local_186[iParam0 /*29*/].f_1, true);
				...
				if (func_202(Local_186[iParam0 /*29*/].f_2))
				{
					...
					set_blocking_of_non_temporary_events(Local_186[iParam0 /*29*/].f_2, true);
		...
		case 1:
			if (func_205(PLAYER::PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (func_362(iParam0))
				{
...
void func_346(auto uParam0, int iParam1)
{
	...
	if (func_202(Local_186[uParam0 /*29*/].f_1))
	{
		set_blocking_of_non_temporary_events(Local_186[uParam0 /*29*/].f_1, false);
		_0x52D59AB61DDC05DD(Local_186[uParam0 /*29*/].f_1, 1);
		func_344(&(Local_186[uParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_202(Local_186[uParam0 /*29*/].f_2))
	{
		set_ped_as_cop(Local_186[uParam0 /*29*/].f_2, 1);
		set_blocking_of_non_temporary_events(Local_186[uParam0 /*29*/].f_2, false);
		_0x52D59AB61DDC05DD(Local_186[uParam0 /*29*/].f_2, 1);
		func_344(&(Local_186[uParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_202(Local_186[uParam0 /*29*/]))
	{
		set_vehicle_engine_on(Local_186[uParam0 /*29*/], true, 1, 0);
		func_347(&(Local_186[uParam0 /*29*/]));
	}
...
bool func_348(int iParam0)
{
	...
	if (func_202(iParam0))
	{
		...
		if (is_ped_being_jacked(iParam0) && func_214(iParam0, PLAYER::PLAYER_PED_ID(), 2f, 1))
		{
			return true;
		}
...
bool func_349(int iParam0, float fParam1)
{
	...
	{
		if (func_360(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
{
	return func_351(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_351(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_352(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_352(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_353(iParam4, iParam7)};
...
bool func_355(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_357(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_357(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_356(vVar3, vVar0);
...
float func_356(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
{
	if (is_entity_in_angled_area(Local_145.f_4, Local_186[uParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[uParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[uParam0 /*29*/].f_7[0 /*8*/].f_7, 0, true, 0))
	{
		return true;
	}
	else if (Local_186[uParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && is_entity_in_angled_area(Local_145.f_4, Local_186[uParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[uParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[uParam0 /*29*/].f_7[1 /*8*/].f_7, 0, true, 0))
	{
		return true;
	}
	return false;
...
bool func_366()
{
	switch (iLocal_439)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_443 && GAMEPLAY::GET_GAME_TIMER() >= iLocal_441) && !func_210())
				{
...
void func_375()
{
	...
	if (iLocal_442)
	{
		if ((!is_cutscene_playing() && !func_379(0)) && !func_374())
		{
...
void func_380(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				case 10:
					cVar0 = {func_386(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_385(iParam2)};
					break;
				...
				default:
					StringCopy(&cVar0, func_383(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_389(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_391(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_393(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_379(0)) || func_392(1))
			{
			}
			else
			{
...
void func_396()
{
	if (func_202(Local_145.f_4))
	{
		set_vehicle_strong(Local_145.f_4, true);
		set_vehicle_has_strong_axles(Local_145.f_4, true);
		_0x51BB2D88D31A914B(Local_145.f_4, false);
		_0x192547247864DFDD(Local_145.f_4, false);
		if (!iLocal_152)
		{
...
void func_398(auto uParam0, auto uParam1)
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_399(auto uParam0, auto uParam1)
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_405(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_409(player_id())) && !func_407(player_id(), 0)) && !func_406())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_409(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_411(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_413(int iParam0)
{
	...
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -1243.316f, -1041.637f, 7.5121f, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 28.2f);
	}
	func_402(500, 1);
}
...
void func_418(Vector3 vParam0, Vector3 fParam1, int iParam2)
{
	...
	func_204(&iLocal_155);
	func_201(&(Local_145.f_4));
	Local_145.f_4 = create_vehicle(Local_145.f_5, vParam0, fParam3, 1, 1);
	set_vehicle_colour_combination(Local_145.f_4, 1);
	if (iParam4)
	{
		func_419(PLAYER::PLAYER_PED_ID(), Local_145.f_4, -1);
	}
	_0x51BB2D88D31A914B(Local_145.f_4, false);
	_0x192547247864DFDD(Local_145.f_4, false);
	set_vehicle_strong(Local_145.f_4, true);
	set_vehicle_has_strong_axles(Local_145.f_4, true);
	add_vehicle_upsidedown_check(Local_145.f_4);
	set_vehicle_extra(Local_145.f_4, 1, true);
	set_vehicle_extra(Local_145.f_4, 2, true);
	set_vehicle_extra(Local_145.f_4, 3, true);
	iLocal_155 = create_object(iLocal_159, vParam0, 1, true, false);
	attach_entity_to_entity(iLocal_155, Local_145.f_4, 0, vLocal_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	set_entity_collision(iLocal_155, true, 0);
	iLocal_152 = true;
	func_397(Local_145.f_4, 0);
...
void func_427()
{
	request_additional_text("BARR3A", false);
	Local_145.f_5 = joaat("dloader");
	Local_145 = {1199.8f, -1259.22f, 34.23f};
	Local_145.f_3 = 174.7f;
	if (func_202(PLAYER::PLAYER_PED_ID()))
	{
		func_231(&uLocal_251, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_432 = 0;
	iLocal_443 = 0;
	iLocal_426 = 0;
	...
	sLocal_449 = "DEFAULT";
	func_428(49, 1, 0);
	iLocal_164[0] = add_scenario_blocking_area(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_164[1] = add_scenario_blocking_area(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_431()
{
	vLocal_167[0 /*3*/] = {func_432("B3ADELV", 1)};
	vLocal_167[1 /*3*/] = {func_432("B3AGETIN", 1)};
	vLocal_167[2 /*3*/] = {func_432("B3AWAN1", -1)};
	vLocal_167[3 /*3*/] = {func_432("B3ARTV", 1)};
	vLocal_167[4 /*3*/] = {func_432("B3AEXIT", 1)};
	vLocal_167[5 /*3*/] = {func_432("B3ALEAVE", 1)};
}
...
void func_434()
{
	...
	remove_scenario_blocking_area(iLocal_164[0], 0);
	remove_scenario_blocking_area(iLocal_164[1], 0);
	_set_unk_map_flag(0);
	terminate_this_thread();
}

void func_435(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_443(int iParam0)
{
	...
	if (!func_459())
	{
		...
		{
			func_157(iVar0, 1, 0);
			func_444(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_445(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_448())
	{
		...
		{
			iVar33 = func_306(get_this_script_name());
			if (iVar33 > -1)
			{
