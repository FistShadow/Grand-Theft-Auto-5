	...
	switch (iLocal_143)
	{
		...
		case 1:
			if (is_entity_at_coord(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_215();
					if (!func_214(player_ped_id(), Local_145.f_4, 55f, 1) && !is_entity_on_screen(Local_145.f_4))
					{
						iLocal_143 = 2;
					}
...
void func_237()
{
	...
	{
		if (!func_210() && is_ped_in_vehicle(player_ped_id(), Local_145.f_4, 0))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if (get_game_timer() - iLocal_427 > Local_416[iLocal_426 /*2*/].f_1 && (func_239() || iLocal_426 == 0))
			{
		...
		case 1:
			if (is_ped_in_vehicle(player_ped_id(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (is_ped_sitting_in_vehicle(player_ped_id(), Local_145.f_4) && is_entity_at_coord(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
					if (!iLocal_432)
					{
						if ((get_game_timer() - iLocal_427 > 8000 && iLocal_426 >= 4) && !func_210())
						{
...
void func_274(int iParam0, int iParam1)
{
	...
	iVar0 = func_147(iParam0);
	if (func_149(iVar0) && !is_ped_injured(iParam0))
	{
		if (iParam0 == player_ped_id())
		{
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_267(iParam0, 0, 0)) || func_267(iParam0, 1, 0)) || func_267(iParam0, 2, 0)) || func_259(iParam0) != 145) || func_329(iParam0)) || func_328(iParam0)) || func_327(iParam0)) || func_326(iParam0)) || !func_318(get_entity_model(iParam0)))
	{
		if (func_328(iParam0))
		{
		}
...
void func_343(int iParam0)
{
	switch (Local_186[iParam0 /*29*/].f_24)
	{
		...
		case 1:
			if (func_205(player_ped_id(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (func_362(iParam0))
				{
...
bool func_348(int iParam0)
{
	...
	if (func_202(iParam0))
	{
		...
		if (is_ped_being_jacked(iParam0) && func_214(iParam0, player_ped_id(), 2f, 1))
		{
			return true;
		}
...
bool func_349(int iParam0, float fParam1)
{
	...
	if (func_202(player_ped_id()) && func_202(iParam0))
	{
...
{
	return func_351(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
...
bool func_366()
{
	switch (iLocal_439)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_443 && get_game_timer() >= iLocal_441) && !func_210())
				{
...
void func_405(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((!is_ped_injured(player_ped_id()) && !func_409(player_id())) && !func_407(player_id(), 0)) && !func_406())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_409(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
void func_413(int iParam0)
{
	...
	{
		set_entity_coords(player_ped_id(), -1243.316f, -1041.637f, 7.5121f, 1, false, 0, 1);
...
void func_418(Vector3 vParam0, Vector3 fParam1, int iParam2)
{
	...
	if (iParam4)
	{
		func_419(player_ped_id(), Local_145.f_4, -1);
	}
	_0x51BB2D88D31A914B(Local_145.f_4, false);
	_0x192547247864DFDD(Local_145.f_4, false);
	set_vehicle_strong(Local_145.f_4, true);
...
void func_427()
{
	...
	if (func_202(player_ped_id()))
	{
		func_231(&uLocal_251, 1, player_ped_id(), "FRANKLIN", 0, 1);
	}
	iLocal_432 = 0;
	iLocal_443 = 0;
	iLocal_426 = 0;
