...
void main()
{
	...
	while (true)
	{
		...
		if (func_182(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_180(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_180(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_169(&uLocal_105, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_168(Var0))
...
void func_169(auto uParam0, Vector3 vParam1, char* sParam2, char* sParam3)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 25f)
			{
				func_127();
				*uParam0 = 0;
			}
...
int func_170(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_177(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_179(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	...
	uParam1.f_7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, uParam1.f_6);
	open_sequence_task(&iVar0);
	AI::TASK_PLAY_ANIM(false, *iParam0.f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0, 0, 0, 0);
	AI::TASK_PLAY_ANIM(false, *iParam0.f_48, *iParam0.f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0, 0, 0, 0);
...
bool func_180(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_182(PLAYER::PLAYER_PED_ID()) && func_182(*iParam0.f_28[0])) && !func_129()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_181(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_229()
{
	...
	if (func_182(PLAYER::PLAYER_PED_ID()))
	{
		if (func_230(PLAYER::PLAYER_PED_ID(), vVar0, fVar3))
		{
			func_133();
		}
	}
...
void func_231(int iParam0)
{
	if (func_182(*iParam0.f_28[0]))
	{
		...
		if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(*iParam0.f_28[0], 1), 5.1f))
		{
			func_232(iParam0);
			if (func_182(*iParam0.f_28[0]))
			{
...
void func_233(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_236(auto uParam0, char* sParam1)
{
...
void func_252(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
...
bool func_268(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
void func_277(auto uParam0, int iParam1, int iParam2, int iParam3)
{
