#region Local Var
	...
	auto uLocal_444 = 1000;
	auto uLocal_445 = 0;
	int iLocal_446 = 0;
	int[] iLocal_447 = new int[4];
	int[] iLocal_452 = new int[4];
	int iLocal_457 = 0;
	int[] iLocal_458 = new int[4];
	int[] iLocal_463 = new int[4];
	Vector3[] vLocal_468 = new Vector3[4];
	Vector3[] fLocal_481 = new Vector3[4];
	int iLocal_486 = 0;
	int iLocal_487 = 0;
	Vector3 vLocal_488 = 0;
	float fLocal_491 = 0;
	char[16] cLocal_492 = 0;
	int[] iLocal_496 = new int[4];
	Vector3 fLocal_501 = 0;
	float fLocal_502 = 0;
	struct<4> Local_503 = 0;
	struct<4> Local_507 = 0;
	int iLocal_511 = 0;
	int iLocal_512 = 0;
	int iLocal_513 = 0;
	char[16] cLocal_514 = 0;
	struct<4> Local_518 = 0;
	int iLocal_522 = 0;
	auto uLocal_523 = 0;
	auto uLocal_524 = 0;
	int[] iLocal_525 = new int[4];
	float[] fLocal_530 = new float[4];
	float fLocal_535 = 0;
	int iLocal_536 = 0;
#endregion
...
void main()
{
	...
	iLocal_446 = 1;
	iLocal_457 = 4;
	StringCopy(&cLocal_492, "null", 16);
	StringCopy(&Local_503, "null", 16);
	StringCopy(&Local_507, "null", 16);
	iLocal_511 = -1;
	iLocal_512 = 5;
	StringCopy(&cLocal_514, "null", 16);
...
bool func_2()
{
	...
	if (!is_string_null_or_empty(&Local_503))
	{
		...
		fVar3 = vdist2(get_entity_coords(iLocal_447[iVar1], 0), get_entity_coords(PLAYER::PLAYER_PED_ID(), 0));
		if (fVar3 < 150f * 150f || is_gameplay_hint_active())
		{
			func_31(&uLocal_434, iLocal_447[iVar1], &Local_503, 0, 1, 1, 1);
			if (is_gameplay_hint_active())
			{
				iLocal_536 = iVar1;
			}
	...
	func_3(&Local_507, &iLocal_522, &iVar1);
	return false;
}
...
bool func_3(char* sParam0, int iParam1, int iParam2)
{
	...
	fVar4 = 10f + to_float(iLocal_513) / to_float(iLocal_512) * 10f;
	...
	fVar5 = vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iLocal_447[*iParam2], 0));
	if (fVar5 > 30f * 30f)
	{
		if (fVar5 > 150f * 150f)
		{
...
void func_24(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_31(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_32(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_32(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	func_33(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_33(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	*uParam0.f_6 = 2;
	func_34(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}

void func_34(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_52(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
		...
		if (!is_gameplay_hint_active())
		{
			if (func_47(uParam0, iParam7, iParam9, 0))
			{
				func_43(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
bool func_39(char* sParam0)
{
	if (!func_40(1, 1, 0))
	{
		if ((!is_string_null_or_empty(sParam0) && func_54(sParam0)) || func_54("CMN_HINT"))
		{
			clear_help(1);
		}
		return false;
...
void func_43(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_46(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_47(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		case 0:
			*uParam0.f_7 = 0;
			if (*uParam0.f_6 == 0)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					if (func_51(iParam1, iParam2, iParam3))
					{
				...
				else if (func_50(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
			...
			{
				if (func_50(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
		...
		case 2:
			...
			{
				if (!func_50(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
			else if (*uParam0.f_6 == 2)
			{
				...
				else if (!func_51(iParam1, iParam2, iParam3))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				if (*uParam0.f_6 == 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
					{
						if (func_49(iParam1, iParam2, iParam3))
						{
							*uParam0.f_5 = 0;
						}
					}
					else if (func_48(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_48(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				else if (*uParam0.f_6 == 2)
				{
					...
					else if (func_49(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
	...
	if (!func_40(iParam1, iParam2, iParam3))
	{
		*uParam0.f_5 = 0;
		*uParam0.f_7 = 0;
	}
...
{
	if (!func_40(iParam0, iParam1, iParam2))
	{
		return false;
	}
...
void func_55(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
...
bool func_56(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!func_65(iLocal_447[iParam0], iLocal_458[iParam0], &(iLocal_525[iParam0]), -1, -2))
			{
				return false;
			}
			...
			if (fLocal_502 >= 0f)
			{
				if (is_vehicle_driveable(iLocal_458[iParam0], 0))
				{
					if (!is_playback_going_on_for_vehicle(iLocal_458[iParam0]))
					{
						start_playback_recorded_vehicle(iLocal_458[iParam0], iLocal_496[iParam0], &cLocal_492, 1);
					}
					else if (is_player_switch_in_progress())
					{
						if (get_player_switch_state() == 8 && _0x78C0D93253149435() == 0)
						{
							skip_time_in_playback_recorded_vehicle(iLocal_458[iParam0], fLocal_502 - get_time_position_in_recording(iLocal_458[iParam0]));
		...
		case 1:
			...
			if (!is_ped_sitting_in_vehicle(iLocal_447[iParam0], iLocal_458[iParam0]))
			{
			...
			if (is_playback_going_on_for_vehicle(iLocal_458[iParam0]))
			{
				...
				if (!is_entity_dead(iVar0, 0) && is_playback_going_on_for_vehicle(iVar0))
				{
				...
				else
				{
					...
					{
						func_57(iLocal_458[iParam0], PLAYER::PLAYER_PED_ID(), &(fLocal_530[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, iVar1);
					}
					else
					{
						fLocal_530[iParam0] = 1f;
						fVar2 = get_entity_speed(PLAYER::PLAYER_PED_ID());
						fVar3 = get_entity_speed(iLocal_458[iParam0]);
						fLocal_530[iParam0] = 1f;
						if (fVar3 > fVar2)
						{
				...
				{
					stop_playback_recorded_vehicle(iLocal_458[iParam0]);
					return false;
				}
				set_playback_speed(iLocal_458[iParam0], fLocal_530[iParam0]);
				fVar4 = get_time_position_in_recording(iLocal_458[iParam0]) / get_total_duration_of_vehicle_recording(iLocal_496[iParam0], &cLocal_492);
				if (!is_playback_using_ai_going_on_for_vehicle(iLocal_458[iParam0]))
				{
					if (!get_ped_type(iLocal_447[iParam0]) == 6)
					{
						if (is_area_occupied(get_entity_coords(iLocal_458[iParam0], 1) - Vector(1f, 1f, 1f), get_entity_coords(iLocal_458[iParam0], 1) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, false, 0))
						{
							set_playback_to_use_ai(iLocal_458[iParam0], iLocal_266);
						}
					}
					else
					{
				...
				if (has_entity_been_damaged_by_entity(iLocal_447[iParam0], PLAYER::PLAYER_PED_ID(), 1) || has_entity_been_damaged_by_entity(iLocal_458[iParam0], PLAYER::PLAYER_PED_ID(), 1))
				{
					stop_playback_recorded_vehicle(iLocal_458[iParam0]);
					return false;
				}
				if (has_entity_been_damaged_by_any_vehicle(iLocal_458[iParam0]))
				{
					stop_playback_recorded_vehicle(iLocal_458[iParam0]);
					return false;
				}
				if (get_ped_type(iLocal_447[iParam0]) == 6)
				{
					...
					{
						if (ENTITY::DOES_ENTITY_EXIST(get_vehicle_ped_is_using(PLAYER::PLAYER_PED_ID())) && !is_playback_going_on_for_vehicle(get_vehicle_ped_is_using(PLAYER::PLAYER_PED_ID())))
						{
							stop_playback_recorded_vehicle(iLocal_458[iParam0]);
							return false;
						}
			...
			else
			{
				...
				if (!get_ped_type(iLocal_447[iParam0]) == 6)
				{
					task_vehicle_drive_wander(iLocal_447[iParam0], iLocal_458[iParam0], fLocal_265, iLocal_266);
					set_ped_keep_task(iLocal_447[iParam0], true);
					if (iLocal_268 == 281)
					{
						set_vehicle_engine_health(iLocal_458[iParam0], 0f);
					}
					iLocal_525[iParam0] = 2;
				}
				else
				{
					task_combat_ped(iLocal_447[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		case 4:
			...
			if (!is_ped_sitting_in_vehicle(iLocal_447[iParam0], iLocal_458[iParam0]))
			{
				...
				{
					task_enter_vehicle(iLocal_447[iParam0], iLocal_458[iParam0], 20000, -1, 2f, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!PED::IS_PED_INJURED(iLocal_447[iParam0]))
			{
				if (get_script_task_status(iLocal_447[iParam0], 1805844857) != 1)
				{
					...
					task_smart_flee_ped(iLocal_447[iParam0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
				}
			}
			else
			{
...
void func_57(int iParam0, int iParam1, auto uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	func_58(iParam0, iParam1, uParam2, fParam8, fParam4, fParam3, fVar2, fVar0, 1f, fVar1, iParam9);
}

void func_58(int iParam0, int iParam1, auto uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_62(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
bool func_64(auto uParam0, auto uParam1)
{
	if (*uParam1 < 0)
	{
		*uParam1 = uParam0;
...
bool func_65(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		*uParam2 = iParam3;
...
bool func_67()
{
	...
	if (!is_entity_dead(iVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (is_vehicle_driveable(iLocal_458[iVar1], 0) && !PED::IS_PED_INJURED(iLocal_447[iVar1]))
				{
					if (!is_string_null_or_empty(&cLocal_492) && iLocal_496[iVar1] > 0)
					{
						start_playback_recorded_vehicle(iLocal_458[iVar1], iLocal_496[iVar1], &cLocal_492, 1);
						skip_time_in_playback_recorded_vehicle(iLocal_458[iVar1], fLocal_501);
						task_vehicle_mission(iLocal_447[iVar1], iLocal_458[iVar1], false, 15, 20f, iLocal_266, 0.5f, 2f, 1);
						if (get_ped_type(iLocal_447[iVar1]) == 6)
						{
							set_vehicle_siren(iLocal_458[iVar1], true);
						}
					}
				}
				iVar1++;
...
int func_70(auto uParam0, auto uParam1)
{
...
void func_76()
{
	...
	while (!iVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 4)
		{
			...
			{
				request_model(iLocal_452[iVar0]);
				if (!has_model_loaded(iLocal_452[iVar0]))
				{
					request_model(iLocal_452[iVar0]);
					iVar2 = false;
				}
			...
			{
				request_model(iLocal_463[iVar0]);
				if (!has_model_loaded(iLocal_463[iVar0]))
				{
					request_model(iLocal_463[iVar0]);
					iVar2 = false;
				}
			}
			if (!is_string_null_or_empty(&cLocal_492) && iLocal_496[iVar0] > 0)
			{
				request_vehicle_recording(iLocal_496[iVar0], &cLocal_492);
				if (!has_vehicle_recording_been_loaded(iLocal_496[iVar0], &cLocal_492))
				{
					request_vehicle_recording(iLocal_496[iVar0], &cLocal_492);
					iVar2 = false;
				}
	...
	while (iVar0 < 4)
	{
		if (iLocal_463[iVar0] != 0)
		{
			clear_area(vLocal_488 + vLocal_468[iVar0 /*3*/], 20f, 1, 0, 0, false);
			iLocal_458[iVar0] = create_vehicle(iLocal_463[iVar0], vLocal_488 + vLocal_468[iVar0 /*3*/], fLocal_491 + fLocal_481[iVar0], 1, true);
			set_vehicle_colour_combination(iLocal_458[iVar0], iLocal_486);
			set_model_as_no_longer_needed(iLocal_463[iVar0]);
			_0x3910051CCECDB00C(iLocal_458[iVar0], true);
		}
		if (iLocal_452[iVar0] != 0)
		{
			...
			{
				set_ped_helmet(iLocal_447[iVar0], 1);
			}
			if (iLocal_457 != 6)
			{
...
void func_77()
{
	...
	func_79(iLocal_268, &vLocal_488, &fLocal_491, &sVar0);
	func_78(iLocal_268, &cLocal_492, &uVar8, &fLocal_501, &fLocal_502, &uVar9, &uVar10, &uVar11);
	switch (iLocal_268)
	{
		case 281:
			...
			StringCopy(&Local_507, "PST_CHSCRaR", 16);
			StringCopy(&cLocal_514, "PST_CHSCRaG", 16);
		...
		case 282:
			...
			iLocal_496[3] = -1;
			StringCopy(&Local_503, "CMN_HINT", 16);
			StringCopy(&Local_507, "PST_CHSCRbR", 16);
			StringCopy(&cLocal_514, "PST_CHSCRbG", 16);
		...
		case 283:
			...
			iLocal_496[3] = -1;
			StringCopy(&Local_503, "CMN_HINT", 16);
			StringCopy(&Local_507, "PST_CHSCRcR", 16);
			StringCopy(&cLocal_514, "", 16);
		...
		case 284:
			...
			iLocal_496[3] = -1;
			StringCopy(&Local_503, "CMN_HINT", 16);
			StringCopy(&Local_507, "PST_CHSCRdR", 16);
			StringCopy(&cLocal_514, "PST_CHSCRdG", 16);
		...
		case 275:
			...
			fLocal_481[1] = get_random_float_in_range(-5f, 5f);
			fLocal_481[2] = get_random_float_in_range(-5f, 5f);
			fLocal_481[3] = get_random_float_in_range(-5f, 5f);
			...
			StringCopy(&Local_507, "PST_POLaR", 16);
			StringCopy(&cLocal_514, "", 16);
		...
		case 276:
			...
			iLocal_496[3] = 5;
			StringCopy(&Local_503, "", 16);
			StringCopy(&Local_507, "PST_POLbR", 16);
			StringCopy(&cLocal_514, "", 16);
			StringCopy(&Local_518, "", 16);
			iLocal_512 = 5;
			iLocal_511 = 1;
		...
		case 277:
			...
			fLocal_481[0] = get_random_float_in_range(-5f, 5f);
			fLocal_481[1] = get_random_float_in_range(-5f, 5f);
			fLocal_481[2] = get_random_float_in_range(-5f, 5f);
			fLocal_481[3] = get_random_float_in_range(-5f, 5f);
			iLocal_452[0] = joaat("s_m_y_ranger_01");
			...
			iLocal_496[3] = 5;
			StringCopy(&Local_503, "", 16);
			StringCopy(&Local_507, "PST_POLcR", 16);
			StringCopy(&cLocal_514, "", 16);
			StringCopy(&Local_518, "", 16);
			iLocal_512 = 5;
			iLocal_511 = 1;
		...
		default:
			fVar12 = fLocal_491 + 90f + get_random_float_in_range(-5f, 5f);
			vLocal_468[0 /*3*/] = {Vector(0f, cos(fVar12), sin(fVar12)) * FtoV(get_random_float_in_range(15f, 25f))};
			fLocal_481[0] = get_random_float_in_range(-5f, 5f);
			iLocal_486 = false;
			iLocal_452[0] = joaat("a_m_y_genstreet_01");
			iLocal_452[1] = 0;
...
bool func_78(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	switch (iParam0)
	{
		case 231:
...
bool func_79(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_81(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
	...
	switch (iParam0)
	{
		...
		case 11:
			if (func_84(iParam0, &vVar0, uParam1))
			{
...
int func_82(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_84(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_86()
{
	...
	while (iVar0 < 4)
	{
		...
		set_vehicle_as_no_longer_needed(&(iLocal_458[iVar0]));
		if (iLocal_452[iVar0] != 0)
		{
			set_model_as_no_longer_needed(iLocal_452[iVar0]);
		}
		...
		if (!is_string_null_or_empty(&cLocal_492) && iLocal_496[iVar0] > 0)
		{
			remove_vehicle_recording(iLocal_496[iVar0], &cLocal_492);
		}
		iVar0++;
	}
	func_55(&uLocal_434, 0, 0);
