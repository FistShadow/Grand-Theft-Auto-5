...
void func_70()
{
	...
	if (!func_76(iVar0) || iVar0 == 52)
	{
		if (!is_bit_set(Global_101154.f_17264.f_390[iLocal_52], iLocal_51))
		{
			...
			if (iVar0 == 58)
			{
				set_bit(&(Global_101154.f_17264.f_390[iLocal_52]), iLocal_51);
			}
...
void func_77(int iParam0)
{
	...
	if (!is_bit_set(Global_101154.f_17264[iParam0 /*6*/], true))
	{
		if (!Var0.f_23)
		{
			set_bit(&(Global_101154.f_17264[iParam0 /*6*/]), true);
		}
	}
	...
	if (!is_bit_set(Global_101154.f_17264[iParam0 /*6*/], 4))
	{
		...
		{
			set_bit(&(Global_101154.f_17264[iParam0 /*6*/]), 4);
		}
		else if (iVar62 == 2)
		{
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (!iParam3)
		{
			...
			set_bit(&(Global_25433[iVar0 /*23*/].f_11), 8);
		}
		else
		{
			...
			set_bit(&(Global_25433[iVar0 /*23*/].f_11), 10);
		}
		set_bit(&(Global_25433[iVar0 /*23*/].f_11), 18);
	}
	else
...
void func_92(int iParam0, int iParam1)
{
	...
	set_bits_in_range(&(Global_25433[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_96(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		set_bit(&(Global_25433[iVar0 /*23*/].f_11), 28);
	}
	else
	{
