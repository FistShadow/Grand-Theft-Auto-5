...
void func_70()
{
	...
	if (!func_76(iVar0) || iVar0 == 52)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264.f_390[iLocal_52], iLocal_51))
		{
			...
			if (iVar0 == 58)
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_390[iLocal_52]), iLocal_51);
			}
...
void func_77(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], true))
	{
		if (!Var0.f_23)
		{
			GAMEPLAY::SET_BIT(&(Global_101154.f_17264[iParam0 /*6*/]), true);
		}
	}
...
void func_92(int iParam0, int iParam1)
{
	...
	GAMEPLAY::SET_BITs_in_range(&(Global_25433[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_96(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 28);
	}
	else
	{
