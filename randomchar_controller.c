#region Local Var
	...
	int iLocal_51 = 0;
	int iLocal_52 = 0;
	int[] iLocal_53 = new int[20];
	int[] iLocal_74 = new int[20];
	int iLocal_95 = 0;
	int iLocal_96 = 0;
#endregion
				...
				if (!func_42(74))
				{
					...
					else if (func_22(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (does_blip_exist(Global_25433[iVar34 /*23*/].f_19))
								{
									set_blip_flashes(Global_25433[iVar34 /*23*/].f_19, 1);
									set_blip_flash_timer(Global_25433[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
void func_7(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
auto func_29(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_30(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_34(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_45()
{
	if (!func_44(39))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[27 /*6*/], 3))
		{
...
auto func_50(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_53()
{
	if (func_69())
	{
		if (!func_42(114))
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[46 /*6*/], 3))
			{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[51 /*6*/], 3))
			{
...
bool func_66(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_70()
{
	...
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264.f_390[iLocal_52], iLocal_51))
		{
			func_17(iVar0, &Var1);
			if (iVar0 == 58)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_390[iLocal_52]), iLocal_51);
			}
			else if (_0x6E31B91145873922(Var1.f_6))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264.f_390[iLocal_52]), iLocal_51);
			}
			else if (Global_100241[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (GAMEPLAY::IS_BIT_SET(Global_25433[iLocal_74[Global_100241[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
...
void func_77(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], true))
	{
		if (!Var0.f_23)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264[iParam0 /*6*/]), true);
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], false) && !GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 3))
	{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 2) && !GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 3))
	{
		iVar59 = true;
		if (func_122(iParam0))
		{
	...
	else if (Global_100241[iParam0 /*10*/].f_3)
	{
		...
		if (!func_114() && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Var0.f_6, 0) > fVar61)
		{
			Global_100241[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar62 = 0;
	if ((((iVar60 && !GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 3)) && GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], false)) && GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], true)) && GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 2))
	{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 4))
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_101154.f_17264[iParam0 /*6*/]), 4);
		}
		else if (iVar62 == 2)
		{
	...
	if (is_player_playing(player_id()))
	{
		if (!func_44(35))
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 2) && !GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[iParam0 /*6*/], 3))
			{
				...
				{
					if (vdist2(Var0.f_6, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)) < 81f)
					{
						sVar64 = "";
						if (GAMEPLAY::IS_BIT_SET(Var0.f_26, true))
						{
							sVar64 = "TRIG_RC_F";
						}
						else if (GAMEPLAY::IS_BIT_SET(Var0.f_26, false))
						{
							sVar64 = "TRIG_RC_M";
						}
						else
...
bool func_79(int iParam0)
{
	if (iParam0 == 2)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[3 /*6*/], 3) && Global_100241[3 /*10*/].f_3 == 1)
		{
			return true;
		}
	}
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[2 /*6*/], 3) && Global_100241[2 /*10*/].f_3 == 1)
		{
			return true;
		}
	}
...
bool func_80(int iParam0)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[2 /*6*/], false) && GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[3 /*6*/], false))
		{
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (!iParam3)
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 8);
		}
		else
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 10);
		}
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 18);
	}
	else
...
void func_89(int iParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_25433[iVar0 /*23*/].f_11, 8) || GAMEPLAY::IS_BIT_SET(Global_25433[iVar0 /*23*/].f_11, 10))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 18);
	}
	GAMEPLAY::CLEAR_BIT(&(Global_25433[iVar0 /*23*/].f_11), 8);
	GAMEPLAY::CLEAR_BIT(&(Global_25433[iVar0 /*23*/].f_11), 10);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 18);
}
...
void func_90(int iParam0, int iParam1)
{
	...
	{
		if ((GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[2 /*6*/], 3) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[3 /*6*/], 3)) || GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[4 /*6*/], 3))
		{
...
void func_92(int iParam0, int iParam1)
{
	...
	GAMEPLAY::GAMEPLAY::SET_BITs_in_range(&(Global_25433[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
	}
...
void func_96(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_25433[iVar0 /*23*/].f_11), 28);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_25433[iVar0 /*23*/].f_11), 28);
	}
	if (Global_25430 == 1)
	{
		Global_25431 = 1;
...
bool func_106(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_107(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_108(int iParam0, auto uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_109(iParam0) && _get_number_of_instances_of_streamed_script(Global_82399[26 /*34*/].f_6) == 0)
			{
				Global_101154.f_5951[iParam0] = 1;
				_set_door_acceleration_limit(*uParam1.f_5, Global_101154.f_5951[iParam0], 1, 1);
			}
...
void func_116(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	func_117(func_41(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_117(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_118(Vector3 fParam0, float fParam1, float fParam2)
{
	float fVar0;
