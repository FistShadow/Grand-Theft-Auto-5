...
void main()
{
	...
	{
		vLocal_722 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)};
	}
	func_319();
	if (!iLocal_510)
	{
...
bool func_26(int iParam0, int iParam1)
{
	...
	if (iVar8 > 0)
	{
		if (iVar10 + iVar11 < iVar8)
		{
			...
			{
				func_57(GAMEPLAY::GET_HASH_KEY(&cVar1), iVar8, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
				return false;
			}
	...
	if (iVar9 > 0)
	{
		...
		{
			func_57(GAMEPLAY::GET_HASH_KEY(&cVar1), iVar9, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
			return false;
		}
	...
	else if (iVar9 < 0)
	{
		...
		network_buy_property(iVar7, GAMEPLAY::GET_HASH_KEY(&cVar1), false, true);
		if (func_51())
		{
			func_27(func_32());
		}
...
bool func_115(int iParam0)
{
	...
	unk_0x30FD873ECE50E9F6(false, iParam0, GAMEPLAY::GET_HASH_KEY(&cVar1), 0, 1);
	if (func_51())
	{
		func_27(func_32());
	}
...
void func_132(int iParam0)
{
	...
	{
		iLocal_525 = 1;
		GAMEPLAY::SET_BIT(&iLocal_530, iParam0);
	}
	if (func_20(iParam0))
	{
	...
	*iParam1 = -1;
	...
	if (iVar83 > 0)
	{
		if (iVar85 + iVar86 < iVar83)
		{
			...
			{
				func_57(GAMEPLAY::GET_HASH_KEY(&cVar77), iVar83, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
				return false;
			}
	...
	if (iVar84 > 0)
	{
		...
		{
			func_57(GAMEPLAY::GET_HASH_KEY(&cVar77), iVar84, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
			return false;
		}
...
bool func_169(auto uParam0, auto uParam1, int iParam2)
{
	...
	GAMEPLAY::SET_BIT(uParam0.f_72, true);
	if (func_231(0, -1, 0))
	{
		if (func_106(player_id(), 1, 1))
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_72, false))
			{
				...
				GAMEPLAY::SET_BIT(uParam0.f_72, false);
					...
					if (iVar3 <= 0 || func_128(iVar3, iParam2))
					{
						if ((func_181() || (func_180() && Global_2562129 == *uParam0.f_69)) || (is_warning_message_active() && is_control_just_pressed(2, 201)))
						{
							...
							if (iVar5 + iVar6 >= iVar1 - iVar4)
							{
								...
								{
									func_177(1, -1);
									GAMEPLAY::SET_BIT(uParam0.f_75, 2);
							...
							{
								GAMEPLAY::SET_BIT(uParam0.f_72, 2);
							}
							GAMEPLAY::SET_BIT(uParam0.f_75, false);
						}
					}
				}
				...
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2))
				{
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 4))
					{
						if ((is_control_pressed(2, 172) || is_disabled_control_just_pressed(2, 172)) || func_174(0, 0, 0))
						{
							...
							*uParam0.f_69--;
							GAMEPLAY::SET_BIT(uParam0.f_75, 4);
							GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
					...
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 5))
					{
						if ((is_control_pressed(2, 173) || is_disabled_control_just_pressed(2, 173)) || func_171(0, 0, 0))
						{
							play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FREEMODE_SOUNDSET", 1);
							*uParam0.f_69++;
							GAMEPLAY::SET_BIT(uParam0.f_75, 5);
							GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
							func_173(uParam0.f_73);
						}
					}
...
void func_259()
{
	...
	if (!iLocal_511 && !iLocal_529)
	{
		if (func_262(7654, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 6))
		{
			sVar0 = "WH_TUT_1";
			iLocal_705 = 5500;
			GAMEPLAY::SET_BIT(&Global_1728812, 6);
		...
		else if (func_262(7655, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 7))
		{
			sVar0 = "WH_TUT_2";
			iLocal_705 = 5500;
			GAMEPLAY::SET_BIT(&Global_1728812, 7);
		...
		else if (func_262(7656, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 8))
		{
			sVar0 = "WH_TUT_3";
			iLocal_705 = 5500;
			GAMEPLAY::SET_BIT(&Global_1728812, 8);
		...
		else if ((func_262(7657, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 9)) && func_260(iLocal_702))
		{
			sVar0 = "WH_TUT_SPEC";
			iLocal_705 = 5500;
			GAMEPLAY::SET_BIT(&Global_1728812, 9);
...
void func_266()
{
	...
	if (!iLocal_512 && !iLocal_529)
	{
		if (iLocal_703 == 2 && func_267(0))
		{
			...
			iLocal_705 = 8000;
			GAMEPLAY::SET_BIT(&Global_1728812, false);
		...
		else if ((func_267(1) && func_249()) && !func_256())
		{
			sVar0 = "SECURO_WH_TUT";
			iLocal_705 = 6000;
			GAMEPLAY::SET_BIT(&Global_1728812, true);
		...
		else if (((iLocal_703 == 2 && func_239()) && !iLocal_516) && func_267(2))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::SET_BIT(&Global_1728812, 2);
		...
		else if ((func_267(3) && func_256()) && func_249())
		{
			...
			iLocal_705 = 9000;
			GAMEPLAY::SET_BIT(&Global_1728812, 3);
		...
		else if (iLocal_703 == 1 && func_267(4))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::SET_BIT(&Global_1728812, 4);
		...
		else if (func_267(5))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::SET_BIT(&Global_1728812, 5);
