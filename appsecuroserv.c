#region Local Var
	...
	int iLocal_710 = 0;
	int iLocal_711 = 0;
	int[] iLocal_712 = new int[5];
	Vector3 fLocal_718 = 0;
	Vector3 fLocal_719 = 0;
	Vector3 fLocal_720 = 0;
	Vector3 fLocal_721 = 0;
	Vector3 vLocal_722 = 0;
	int[] iLocal_725 = new int[10];
	struct<16>[] Local_736 = new struct<16>[10];
	auto uLocal_897 = 0;
	auto uLocal_898 = 0;
#endregion
...
void main()
{
	...
	fLocal_720 = 0f;
	fLocal_721 = 0f;
	iLocal_510 = func_346(player_id());
	if (iLocal_510)
	{
		iLocal_496 = unk_0x67D02A194A2FC2BD("warehouse");
	}
	else
	{
		iLocal_496 = unk_0x67D02A194A2FC2BD("securoserv");
		Global_68062 = 1;
		Global_68063 = 0;
	}
	func_344(1);
	func_342(1);
	while (!has_scaleform_movie_loaded(iLocal_496))
	{
		wait(0);
	}
	if (iLocal_510)
	{
		iLocal_702 = func_340(player_id());
		func_334(player_id(), 0, 32768);
		func_321(1);
	}
	else if (func_320(Global_1587523[player_id() /*444*/].f_250.f_9))
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_250.f_7, true))
		{
			func_321(1);
		}
		else
	...
	{
		vLocal_722 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
	}
	func_319();
	if (!iLocal_510)
	{
		func_318();
		if (network_is_player_active(player_id()) && func_317(player_id()))
		{
			func_309(player_id(), player_id());
		}
	}
	iLocal_522 = func_308();
	iLocal_523 = func_307();
	...
	while (Global_68058)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_250.f_7, 14) || func_303(PLAYER::PLAYER_PED_ID(), vLocal_722, 1) > 5f)
		{
			func_299();
		}
...
void func_3()
{
	...
	iVar0 = iLocal_704;
	if (network_is_player_active(iVar0) && func_317(iVar0))
	{
		if (!func_6())
		{
...
void func_4()
{
	...
	{
		_push_scaleform_movie_function(iLocal_496, "REMOVE_ACTIVE_USER");
		unk_0x77FE3402004CD1B0(&(Local_736[iVar1 /*16*/]));
...
void func_7()
{
	...
	if (iLocal_501 == 0 || iLocal_501 == 1)
	{
		...
		if (is_control_just_pressed(2, 201) || is_control_just_pressed(2, 237))
		{
			if (!iLocal_517)
			{
				_push_scaleform_movie_function(iLocal_496, "GET_CURRENT_SELECTION");
				uLocal_497 = _pop_scaleform_movie_function();
				_push_scaleform_movie_function(iLocal_496, "GET_SELECTED_WAREHOUSE_ID");
				uLocal_498 = _pop_scaleform_movie_function();
				iLocal_517 = 1;
			}
			_push_scaleform_movie_function(iLocal_496, "GET_CURRENT_SCREEN_ID");
			uLocal_499 = _pop_scaleform_movie_function();
			iLocal_509 = 0;
			iLocal_514 = 1;
			iLocal_501 = 0;
		}
	}
	if (is_control_just_pressed(2, 202) && iLocal_509)
	{
		_push_scaleform_movie_function(iLocal_496, "GET_CURRENT_SCREEN_ID");
		uLocal_499 = _pop_scaleform_movie_function();
		iLocal_509 = 0;
	}
	if (_0x768FF8961BA904D6(uLocal_499) && !iLocal_509)
	{
		iLocal_703 = _0x2DE7EFA66B906036(uLocal_499);
		iLocal_509 = 1;
	}
	if (iLocal_703 == 2)
	{
		if (iLocal_514)
		{
			_push_scaleform_movie_function(iLocal_496, "IS_WAREHOUSE_PANEL_SHOWING");
			uLocal_500 = _pop_scaleform_movie_function();
			iLocal_514 = 0;
		}
		else if (_0x768FF8961BA904D6(uLocal_500))
		{
			iLocal_513 = unk_0xD80A80346A45D761(uLocal_500);
			iLocal_514 = 0;
		}
	}
	if (iLocal_501 == 0)
	{
		if (_0x768FF8961BA904D6(uLocal_497) && _0x768FF8961BA904D6(uLocal_498))
		{
			iVar0 = _0x2DE7EFA66B906036(uLocal_497);
			iLocal_517 = 0;
			iLocal_502 = func_245(_0x2DE7EFA66B906036(uLocal_498));
			switch (iVar0)
			{
				case 1001:
					break;
	...
	if ((iLocal_501 == 3008 || iLocal_501 == 3009) || iLocal_501 == 3010)
	{
		...
		{
			Var1 = {func_240()};
			func_243("WHOUSE_SHI", &Var1, "WHOUSE_CONF", "WHOUSE_CANC", 1);
		}
		iLocal_501 = 0;
	}
	if (iLocal_501 == 3012)
	{
		if (iLocal_507)
		{
			...
			else
			{
				...
				if (iLocal_515)
				{
					sVar8 = "WHSE_PURCHF_NM";
				}
				else if (Global_262145.f_12737)
				{
					sVar8 = "WHSE_PURCHF_TU";
				}
				func_243("WHOUSE_PURFA", sVar8, "WHOUSE_CONF", "", 0);
			}
			iLocal_502 = -1;
			iLocal_503 = -1;
			iLocal_501 = 1;
		...
		else if (iLocal_508)
		{
			...
			else
			{
				...
				iLocal_701 = func_63(player_id(), 168, 0);
				sVar9 = func_62(0, iLocal_502);
				func_243("MP_WH_SELL", sVar9, "WHOUSE_CONF", "", 0);
				iLocal_505 = 1;
				iLocal_502 = -1;
				iLocal_501 = 1;
				iLocal_508 = 0;
		...
		else
		{
			...
			if (iVar10 > 0 && func_26(iVar10, iLocal_503))
			{
				iVar11 = 0;
				Global_68063 = 1;
				if (iLocal_519 && iLocal_503 == 1)
				{
					iVar11 = 1;
				}
				func_100(167, iVar10, iLocal_503, iLocal_518, iVar11);
				if (!func_23(7550, -1, -1) && !iLocal_511)
				{
					iLocal_699 = 4;
					iLocal_524 = 1;
				}
			...
			{
				sVar12 = func_62(1, iVar10);
				func_243("WHOUSE_PURFA", sVar12, "WHOUSE_CONF", "", 0);
				iLocal_505 = 1;
			}
			iLocal_502 = -1;
			iLocal_501 = 1;
...
void func_8(int iParam0)
{
	...
	else if (iLocal_707 == 4)
	{
		...
		func_243(sVar0, sVar1, "WHOUSE_CONF", "WHOUSE_CANC", 1);
	}
	else
	{
		iLocal_508 = 1;
...
bool func_10(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
...
int func_14(int iParam0)
{
	...
	if (func_21(iParam0))
	{
		if (func_20(iParam0))
		{
			...
			iVar2 = iVar1 + func_15() - _get_posix_time();
			return iVar2;
		}
	}
	return -1;
...
bool func_26(int iParam0, int iParam1)
{
	...
	if (iLocal_519 && iParam1 == 1)
	{
		iVar7 = func_58(func_59(iLocal_518));
		iVar5 = true;
	}
	iVar8 = iVar7 - iVar6;
	iVar10 = _0x76EF28DA05EA395A();
	iVar11 = _0xA40F9C2623F6A8B5(-1);
	if (iVar8 > 0)
	{
		if (iVar10 + iVar11 < iVar8)
		{
			...
			{
				func_57(get_hash_key(&cVar1), iVar8, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
				return false;
			}
			if (iVar8 <= 0 || (iVar8 > 0 && _has_item_been_unlocked(iVar8, false, true, 0, -1)))
			{
				func_57(get_hash_key(&cVar1), iVar8, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
	...
	if (iVar9 > 0)
	{
		...
		{
			func_57(get_hash_key(&cVar1), iVar9, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
			return false;
		}
		if (!_has_item_been_unlocked(iVar9, false, true, 0, -1))
		{
			func_57(get_hash_key(&cVar1), iVar9, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
	...
	if (!func_56(player_id(), 167, 0))
	{
		play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
		iLocal_701 = func_63(player_id(), 167, 0);
		return false;
	}
	...
	if (func_51())
	{
		iLocal_504 = 1;
		iLocal_700 = 0;
		uVar12 = func_49(1, iParam1, iVar5, func_59(iLocal_518));
	...
	if (iVar9 >= 0 && (iVar9 == 0 || (iVar9 > 0 && (func_51() || _has_item_been_unlocked(iVar9, false, true, 0, -1)))))
	{
		if (iVar9 > 0)
		{
		...
		if (func_51())
		{
			_0x9507D4271988E1AE(func_31(func_32()));
		}
		unk_0x30FD873ECE50E9F6(iVar7, iParam0, get_hash_key(&cVar1), 0, 1);
		if (func_51())
		{
			func_27(func_32());
		}
	...
	else if (iVar9 < 0)
	{
		...
		network_buy_property(iVar7, get_hash_key(&cVar1), false, true);
		if (func_51())
		{
			func_27(func_32());
		}
...
bool func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_42()
{
	...
	if (!iVar0)
	{
		if (!_0xB24F0944DA203D9E(func_2()) || _0x810E8431C0614BF9())
		{
...
bool func_46(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, auto uParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_47(uVar3, uParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5);
		return true;
	}
	return false;
}

int func_47(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8)
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_50(&sVar0, iParam0, iParam1, iParam2, iParam3);
	return get_hash_key(&sVar0);
}

void func_50(char* sParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	if (iParam1)
	{
		if (iParam2 == -1)
...
{
	return func_63(iParam0, iParam1, iParam2) == -1;
}

void func_57(int iParam0, int iParam1, int iParam2)
{
	if (!network_is_activity_session() && _0x883D79C4071E18B3())
	{
...
char* func_62(int iParam0, int iParam1)
{
	...
	if (func_54(player_id()) || network_is_activity_session())
	{
...
int func_63(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if ((func_76() || func_75()) || ((!iParam2 && func_74() != 0) && func_77(iParam1) == 1))
		{
			return 2;
		}
	}
...
auto func_74()
{
	return Global_1610316[player_id() /*174*/].f_10.f_72;
}
...
bool func_78(auto uParam0)
{
	...
	while (iVar0 < func_79())
	{
		iVar1 = Global_1610316[uParam0 /*174*/].f_10.f_10[iVar0];
		if (iVar1 != func_68())
		{
			if (network_is_player_active(iVar1))
			{
...
bool func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if ((func_92(iParam0, iParam3, iParam4) || func_91(iParam1, iParam3, iParam4)) || func_85(iParam2, iParam3, iParam4))
	{
		return true;
	}
	return false;
...
{
	return func_86(2, iParam0, 0, iParam1, iParam2);
}
...
bool func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam2 && !iParam3) && iParam1 <= func_90(iParam0) - func_89(iParam0, 0))
	{
		return true;
	}
	else
...
{
	return func_86(1, iParam0, 0, iParam1, iParam2);
}

int func_92(int iParam0, int iParam1, int iParam2)
{
	return func_86(0, iParam0, 0, iParam1, iParam2);
}
...
void func_101(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	if (func_110())
	{
...
void func_102(auto uParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
	struct<7> Var0;
...
{
	Global_1610316[player_id() /*174*/].f_10.f_27 = uParam0;
}
...
void func_114(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	Global_1610316[player_id() /*174*/].f_10.f_119 = uParam0;
	Global_1610316[player_id() /*174*/].f_10.f_119.f_1 = uParam1;
	Global_1610316[player_id() /*174*/].f_10.f_119.f_2 = uParam2;
	Global_1610316[player_id() /*174*/].f_10.f_119.f_3 = uParam3;
}
...
bool func_115(int iParam0)
{
	...
	unk_0x30FD873ECE50E9F6(false, iParam0, get_hash_key(&cVar1), 0, 1);
	if (func_51())
	{
		func_27(func_32());
	}
...
void func_116(int iParam0)
{
	...
	if (!func_123(iVar0, iParam0))
	{
		...
		{
			func_118(sVar1, 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar2, iVar3);
...
void func_119(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_122() || !network_is_activity_session()) || !func_104(player_id(), 0))
	{
		return;
	}
...
bool func_123(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 4)
	{
		if ((Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/] != 0 && Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/] != iParam1) && func_124(Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/]) == iParam0)
		{
			return true;
		}
		iVar0++;
...
void func_125(int iParam0, int iParam1)
{
	...
	if (!func_131(iParam1))
	{
		if (func_20(iParam0) && func_128(iParam0, iParam1))
		{
			...
			Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/] = iParam1;
		}
	}
}
...
void func_132(int iParam0)
{
	...
	StringCopy(&Var0, func_61(iParam0), 16);
	vVar4 = {func_155(iParam0)};
	StringCopy(&Var7, get_name_of_zone(vVar4), 16);
	StringCopy(&Var11, func_154(iParam0), 16);
	StringCopy(&cVar15, func_153(iParam0), 16);
	iVar19 = func_152(iParam0);
	iVar20 = func_20(iParam0);
	...
	if (iVar25 <= 0)
	{
		if (!func_53())
		{
			iVar25 = Global_262145.f_12476 - absi(get_time_difference(GAMEPLAY::GET_GAME_TIMER(), Global_2459488.f_55));
		}
	}
	if (iVar25 > 0)
	{
		iLocal_525 = 1;
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_530, iParam0);
	}
	if (func_20(iParam0))
	{
	...
	_push_scaleform_movie_function(iLocal_496, "ADD_WAREHOUSE");
	_push_scaleform_movie_function_parameter_int(func_139(iParam0));
	_push_scaleform_movie_function_parameter_float(vVar4.x);
	_push_scaleform_movie_function_parameter_float(vVar4.y);
	_push_scaleform_movie_function_parameter_int(iVar19);
	func_138(&Var0);
	func_138(&Var7);
	func_138(&Var11);
	unk_0x77FE3402004CD1B0(&cVar15);
	_push_scaleform_movie_function_parameter_bool(iVar20);
	_push_scaleform_movie_function_parameter_int(iVar21);
	_push_scaleform_movie_function_parameter_int(iVar22);
	_push_scaleform_movie_function_parameter_int(iVar23);
	_push_scaleform_movie_function_parameter_int(iVar24);
	_push_scaleform_movie_function_parameter_int(iVar28);
	_push_scaleform_movie_function_parameter_int(iVar25);
	_push_scaleform_movie_function_parameter_int(iVar26);
	_push_scaleform_movie_function_parameter_int(iVar27);
	_pop_scaleform_movie_function_void();
	Var29 = {func_137(Global_1728678)};
	_push_scaleform_movie_function(iLocal_496, "ADD_WAREHOUSE_SHIPMENTS");
	_push_scaleform_movie_function_parameter_int(func_139(iParam0));
	iVar35 = func_60(1);
	iVar36 = func_60(2);
	iVar37 = func_60(3);
	...
	_push_scaleform_movie_function_parameter_int(iVar35);
	func_138(&Var29);
	...
	_push_scaleform_movie_function_parameter_int(iVar37);
	_push_scaleform_movie_function_parameter_bool(iLocal_519);
	_push_scaleform_movie_function_parameter_int(iVar38);
	_push_scaleform_movie_function_parameter_int(iVar39);
	_push_scaleform_movie_function_parameter_int(iVar40);
	_pop_scaleform_movie_function_void();
}
...
struct<6> func_137(auto uParam0)
{
	char[24] cVar0;
	
	StringCopy(&cVar0, "CONTRATP_", 24);
	StringIntConCat(&cVar0, uParam0, 24);
	StringConCat(&cVar0, "W", 24);
	return cVar0;
}
...
int func_143(int iParam0)
{
	...
	if (func_21(iParam0))
	{
		uVar0 = func_144(func_19(iParam0));
		return func_16(uVar0, -1, 0);
	}
	return 0;
}
...
int func_148(int iParam0)
{
	...
	if (func_21(iParam0))
	{
		if (func_20(iParam0))
		{
			...
			iVar2 = iVar1 + func_149() - _get_posix_time();
			return iVar2;
		}
	}
	return -1;
	...
	if ((!func_131(iParam0) && !func_20(iParam0)) && func_157() < 5)
	{
		...
		while (iVar0 <= 4)
		{
			if (Global_2492991[iVar0 /*5*/][func_17(-1)] == 0)
			{
				...
				Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/] = iParam0;
				Global_1587523[player_id() /*444*/].f_250.f_68[iVar0 /*2*/].f_1 = 0;
				return;
			}
			iVar0++;
		}
...
bool func_159(int iParam0, int iParam1)
{
	...
	*iParam1 = -1;
	...
	iVar81 = 0;
	iVar82 = ceil(to_float(func_152(iParam0)) * Global_262145.f_77);
	iVar83 = iVar82 - iVar81;
	iVar85 = _0x76EF28DA05EA395A();
	iVar86 = _0xA40F9C2623F6A8B5(-1);
	iVar87 = false;
	if (iVar83 > 0)
	{
		if (iVar85 + iVar86 < iVar83)
		{
			...
			{
				func_57(get_hash_key(&cVar77), iVar83, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
				return false;
			}
			if (iVar83 <= 0 || (iVar83 > 0 && _has_item_been_unlocked(iVar83, false, true, 0, -1)))
			{
				func_57(get_hash_key(&cVar77), iVar83, 0);
				play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				iLocal_515 = 1;
	...
	if (iVar84 > 0)
	{
		...
		{
			func_57(get_hash_key(&cVar77), iVar84, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
			return false;
		}
		if (!_has_item_been_unlocked(iVar84, false, true, 0, -1))
		{
			func_57(get_hash_key(&cVar77), iVar84, 0);
			play_sound_frontend(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
			iLocal_515 = 1;
	...
	Var93 = iParam0;
	Var93.f_1 = iVar84;
	Var93.f_16 = func_160(0, player_id());
	Var93.f_17 = func_160(1, player_id());
	Var93.f_18 = func_160(2, player_id());
	Var93.f_14 = func_124(iParam0);
	if (iVar84 >= 0 && (iVar84 == 0 || (iVar84 > 0 && (func_51() || _has_item_been_unlocked(iVar84, false, true, 0, -1)))))
	{
		if (iVar84 > 0)
		{
...
bool func_161(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4, auto uParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_164(char* sParam0, auto uParam1)
{
	StringCopy(sParam0, "WH_INDEX_", 64);
	StringIntConCat(sParam0, uParam1, 64);
	StringConCat(sParam0, "_t0_v0", 64);
}

int func_165(int iParam0)
{
	return ceil(IntToFloat(func_152(iParam0)) * 0.5f);
}
...
bool func_169(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = false;
	if (((((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || func_238()) || !func_106(player_id(), 1, 1)) || Global_1315839) || iVar0) || Global_2435528.f_3287.f_32)
	{
		if (iVar0)
		{
		}
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_72, true);
	if (func_231(0, -1, 0))
	{
		if (func_106(player_id(), 1, 1))
		{
			if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_72, false))
			{
				func_212(uParam0, iParam2);
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_72, false);
				func_209(uParam0, iParam2);
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2))
				{
					func_183(1, -1, 1, 0, 1, -1082130432, 0, 0);
				}
			}
			else if ((!is_pause_menu_active() && !func_182(8, -1)) && !Global_2434762.f_658.f_5)
			{
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, false))
				{
					...
					{
						if ((func_181() || (func_180() && Global_2562129 == *uParam0.f_69)) || (is_warning_message_active() && is_control_just_pressed(2, 201)))
						{
							play_sound_frontend(-1, "Popup_Confirm_Success", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
							iVar5 = _0x76EF28DA05EA395A();
							iVar6 = _0xA40F9C2623F6A8B5(-1);
							if (iVar5 + iVar6 >= iVar1 - iVar4)
							{
								if ((!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2) && *uParam0.f_1[*uParam0.f_69] != 0) && iVar3 > 0)
								{
									func_177(1, -1);
									GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_75, 2);
									GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
									return false;
								}
							...
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_72, 2);
							}
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_75, false);
						}
					}
				}
				else if (!is_control_just_released(2, 176) && !is_disabled_control_just_pressed(2, 176))
				{
					GAMEPLAY::CLEAR_BIT(uParam0.f_75, false);
				}
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, true))
				{
					if ((func_176() || (func_175() && Global_2562129 > -1)) || (is_warning_message_active() && is_control_just_pressed(2, 202)))
					{
						...
						{
							GAMEPLAY::CLEAR_BIT(uParam0.f_75, 2);
							GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
						}
						GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_75, true);
					}
				}
				...
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2))
				{
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 4))
					{
						if ((is_control_pressed(2, 172) || is_disabled_control_just_pressed(2, 172)) || func_174(0, 0, 0))
						{
							...
							*uParam0.f_69--;
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_75, 4);
							GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
					...
					{
						GAMEPLAY::CLEAR_BIT(uParam0.f_75, 4);
					}
					if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 5))
					{
						if ((is_control_pressed(2, 173) || is_disabled_control_just_pressed(2, 173)) || func_171(0, 0, 0))
						{
							play_sound_frontend(-1, "NAV_UP_DOWN", "HUD_FREEMODE_SOUNDSET", 1);
							*uParam0.f_69++;
							GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_75, 5);
							GAMEPLAY::CLEAR_BIT(uParam0.f_72, false);
							func_173(uParam0.f_73);
						}
					}
					...
					{
						GAMEPLAY::CLEAR_BIT(uParam0.f_75, 5);
					}
				}
				if (func_180())
				{
				...
				func_209(uParam0, iParam2);
				if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2) && !is_warning_message_active())
				{
					func_183(1, -1, 1, 0, 1, -1082130432, 0, 0);
				}
			}
...
void func_177(int iParam0, int iParam1)
{
	...
	if (iParam0)
	{
		func_178(&(Global_17257.f_5530[uVar0 /*10*/]));
...
bool func_179(auto uParam0, int iParam1, int iParam2)
{
	char[64] cVar0;
	int iVar16;
	int iVar17;
...
void func_183(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_17257)
	{
		if (func_205(29, 1, 1, &fVar35, &fVar36, iParam7))
		{
			fVar55 = fVar36;
			fVar55 += 0f;
		}
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17257.f_5598)
		{
			...
			else
			{
				if (Global_17257)
				{
					draw_sprite(func_203(29), func_201(29, 1), Global_17254 + fParam5 * 0.5f, Global_17255 + fVar55 - 0f * 0.5f, fParam5, fVar55 - 0f, 0f, 255, 255, 255, 255, 0);
				}
			...
			if (get_hash_key(&(Global_17257.f_4562)) != 0 && Global_17257.f_4636 != -1)
			{
				...
				{
					func_205(Global_17257.f_4638, 1, 1, &fVar35, &fVar36, iParam7);
				...
				if (Global_17257.f_4638 != 0)
				{
					...
					draw_sprite(func_203(Global_17257.f_4638), func_201(Global_17257.f_4638, 1), Global_17254 + fVar35 * 0.5f + 0.00078125f * 2f, fVar49 + fVar36 * 0.5f - 0.00138888f * 4f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
				}
			...
			if (get_hash_key(&(Global_2562053.f_21)) != 0 && Global_2562053.f_65 != -1)
			{
				...
				{
					func_205(Global_2562053.f_67, 1, 1, &fVar35, &fVar36, iParam7);
					fVar41 = Global_17254 + fVar35 + 0.00078125f * 4f - 0.00078125f * 1f;
				}
				func_196(fVar41);
				...
				if (Global_2562053.f_67 != 0)
				{
					...
					draw_sprite(func_203(Global_2562053.f_67), func_201(Global_2562053.f_67, 1), Global_17254 + fVar35 * 0.5f + 0.00078125f * 2f, fVar49 + fVar36 * 0.5f - 0.00138888f * 4f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
				}
				fVar49 += _get_text_scale_height(0.35f, 0) * IntToFloat(iVar6) + 0.00138888f * 13f + 0.00138888f * 5f * IntToFloat(iVar6 - 1);
			...
			func_191(iVar57, iParam1, 0, 0, 0, 0, iParam4, 1, 0);
			_set_screen_draw_position(76, 84);
			_0xF5A2C681787E579D(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17257.f_5598)
							...
							switch (Global_17257.f_4926[iVar8])
							{
									...
									if (iVar5 == 1 && iVar32)
									{
										if (!Global_17257.f_5599)
										{
											...
											if (get_hash_key(&(Global_17257.f_73[iVar24 /*6*/])) != 0)
											{
												...
												func_189(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, iVar70, iVar50);
											...
											if (iVar28 > 0)
											{
												...
												while (iVar14 < iVar28)
												{
													if (func_205(Global_17257.f_4433[iVar22 + iVar14], iVar31, 0, &fVar35, &fVar36, iParam7))
													{
														fVar43 += fVar35;
														if (iVar14 > 0)
														{
										...
										if (iVar51)
										{
											if (func_205(26, 1, 0, &fVar35, &fVar36, iParam7))
											{
												if (Global_17257.f_4953[iVar8] == 2)
												{
													fVar41 -= fVar35 * 2f;
												...
												fVar44 = fVar35 * 0.5f;
												if (func_205(26, 1, 1, &fVar35, &fVar36, iParam7))
												{
													func_195(26, 1, &iVar46, &iVar47, &iVar48);
													draw_sprite(func_203(26), func_201(26, 1), fVar33 + fVar41 + fVar44, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
												}
											}
											if (func_205(27, 1, 0, &fVar35, &fVar36, iParam7))
											{
												fVar41 += fVar35;
												fVar44 = fVar35 * 0.5f;
												if (func_205(27, 1, 1, &fVar35, &fVar36, iParam7))
												{
													func_195(27, 1, &iVar46, &iVar47, &iVar48);
													draw_sprite(func_203(27), func_201(27, 1), fVar33 + fVar41 + fVar44 + fVar42 + fVar43, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
												}
											}
										}
										iVar25 = 0;
										...
										if (get_hash_key(&(Global_17257.f_73[iVar24 /*6*/])) != 0)
										{
											...
											func_189(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, 0, iVar50);
										...
										while (iVar14 < 4)
										{
											...
											else if (Global_17257.f_2124[iVar24 /*5*/][iVar14] == 4)
											{
												...
												{
													if (func_205(Global_17257.f_4433[iVar22 + iVar28], iVar31, 0, &fVar35, &fVar36, iParam7))
													{
														fVar41 += fVar35 * 0.5f;
														if (func_205(Global_17257.f_4433[iVar22 + iVar28], iVar31, 1, &fVar35, &fVar36, iParam7))
														{
															func_195(Global_17257.f_4433[iVar22 + iVar28], iVar31, &iVar46, &iVar47, &iVar48);
															if (Global_17257.f_4953[iVar8] == 2)
															{
																draw_sprite(func_203(Global_17257.f_4433[iVar22 + iVar28]), func_201(Global_17257.f_4433[iVar22 + iVar28], iVar31), fVar33 + fVar41 - 0.00078125f * 8f + 0.00078125f * 4f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else
															{
																draw_sprite(func_203(Global_17257.f_4433[iVar22 + iVar28]), func_201(Global_17257.f_4433[iVar22 + iVar28], iVar31), fVar33 + fVar41 - 0.00078125f * 8f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
										...
										if (iVar28 > 0)
										{
											...
											while (iVar14 < iVar28)
											{
												if (Global_17257.f_4433[iVar22 + iVar14] != 2 && Global_17257.f_4433[iVar22 + iVar14] != 48)
												{
													...
													{
														fVar41 += fVar35 * 0.5f;
														if (func_205(Global_17257.f_4433[iVar22 + iVar14], iVar31, 1, &fVar35, &fVar36, iParam7))
														{
															func_195(Global_17257.f_4433[iVar22 + iVar14], iVar31, &iVar46, &iVar47, &iVar48);
															if (Global_17257.f_4433[iVar22 + iVar14] == 30)
															{
																draw_sprite(func_203(Global_17257.f_4433[iVar22 + iVar14]), func_201(Global_17257.f_4433[iVar22 + iVar14], iVar31), Global_17254 + fVar35 * 0.5f, fVar34 + 0.00277776f + fVar36 * 0.5f - 0.00078125f * 11f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else if (Global_17257.f_4953[iVar8] == 2)
															{
																draw_sprite(func_203(Global_17257.f_4433[iVar22 + iVar14]), func_201(Global_17257.f_4433[iVar22 + iVar14], iVar31), fVar33 + fVar41 + fVar42 - 0.00078125f * 8f + 0.00078125f * 4f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else
															{
																draw_sprite(func_203(Global_17257.f_4433[iVar22 + iVar14]), func_201(Global_17257.f_4433[iVar22 + iVar14], iVar31), fVar33 + fVar41 + fVar42 - 0.00078125f * 12f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
														}
								...
								case 2:
									if (iVar5 == 1 && iVar32)
									{
										if (!Global_17257.f_5599)
										{
											func_189(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, 0, 0);
											if (Global_17257.f_7858 && Global_17257.f_7859 == iVar6)
											{
												func_188(iVar31);
											}
								...
								case 4:
									if (iVar5 == 1 && iVar32)
									{
										if (func_205(Global_17257.f_4433[iVar22], iVar31, 0, &fVar35, &fVar36, iParam7))
										{
											if (!Global_17257.f_5599)
											{
												fVar43 = fVar35;
											...
											if (func_205(Global_17257.f_4433[iVar22], iVar31, 1, &fVar35, &fVar36, iParam7))
											{
												func_195(Global_17257.f_4433[iVar22], iVar31, &iVar46, &iVar47, &iVar48);
												draw_sprite(func_203(Global_17257.f_4433[iVar22]), func_201(Global_17257.f_4433[iVar22], iVar31), fVar33 + fVar41 + fVar35 * 0.5f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35 * func_185(Global_17257.f_4433[iVar22]), fVar36 * func_185(Global_17257.f_4433[iVar22]), 0f, iVar46, iVar47, iVar48, 255, 0);
											}
										}
									}
									iVar40 = true;
...
void func_186(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)
{
...
void func_189(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_191(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	auto uVar0;
	int iVar1;
	int iVar2;
	...
	iParam0 = iParam0;
	if (iParam3 && !func_207(iParam4, iParam8))
	{
		return;
	}
	if (func_193())
...
bool func_205(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4, int iParam5)
{
	char* sVar0;
	char* sVar1;
	int iVar2;
	...
	if (get_hash_key(sVar1) != 0)
	{
		...
		vVar7.x *= func_206(iParam0) / fVar4;
		vVar7.y *= func_206(iParam0) / fVar4;
		if (!iParam2)
		{
			vVar7.x -= 2f;
			vVar7.y -= 2f;
...
bool func_207(int iParam0, int iParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_182(8, -1) && func_208() != 64)) || (get_pause_menu_state() != 0 && !iParam1)) || (is_player_switch_in_progress() && !iParam0)) || _0x2EAC52B4019E2782()) || Global_69749) || Global_17257.f_7861) || is_warning_message_active()) || Global_91330.f_1352)
	{
		return false;
	}
	return true;
...
void func_209(auto uParam0, int iParam1)
{
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2))
	{
		...
		func_211(iVar3, iVar0);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_72, 4);
		GAMEPLAY::CLEAR_BIT(uParam0.f_72, 3);
		if (GAMEPLAY::IS_BIT_SET(*uParam0.f_72, 2))
		{
			func_210("REP_WHOUSE_4", 100, 0);
		}
		else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_72, 5))
		{
			func_210("MP_PROP_HEI_0", 100, 0);
		}
		else if (GAMEPLAY::IS_BIT_SET(*uParam0.f_72, 6))
		{
...
void func_212(auto uParam0, int iParam1)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_75, 2))
	{
		...
		while (iVar1 >= 0)
		{
			...
			if (iVar3 > 0)
			{
				iVar4 = func_128(iVar3, iParam1);
				func_222(iVar0, "PIM_DNAME", 1, iVar4, 0, 0);
				if (func_221())
				{
					func_220(_get_label_text(func_61(iVar3)), 0, 0);
				}
				else
				{
					func_219(_get_label_text(func_61(iVar3)), 0, 1);
				}
				func_222(iVar0, "CUST_GAR_COST", 1, iVar4, 0, 0);
		...
		GAMEPLAY::CLEAR_BIT(uParam0.f_72, 2);
		GAMEPLAY::CLEAR_BIT(uParam0.f_72, 5);
		*uParam0.f_71 = iVar0;
		func_170(*uParam0.f_69, 1, 1);
...
int func_231(char* sParam0, int iParam1, int iParam2)
{
	auto uVar0;
	int iVar1;
	int iVar2;
	
	if (!func_179(&uVar0, 1, iParam1))
	{
		return false;
	}
	iVar1 = true;
	...
	iVar2 = func_232(&(Global_17257.f_5530[uVar0 /*10*/]));
	if (!iVar1 || !iVar2)
	{
	}
	return (iVar1 && iVar2);
...
struct<4> func_240()
{
	...
	StringCopy(&cVar0, "", 16);
	iVar4 = iLocal_518;
	uVar5 = func_59(iLocal_518);
	iVar6 = iLocal_503;
	if (func_241() && iVar6 == 1)
	{
		StringCopy(&cVar0, "WHOUSE_SHISI", 16);
		StringIntConCat(&cVar0, uVar5, 16);
	}
	else
	{
		StringCopy(&cVar0, "WHOUSE_SHI", 16);
...
void func_243(char* sParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4)
{
	_push_scaleform_movie_function(iLocal_496, "SHOW_OVERLAY");
	func_138(sParam0);
	func_138(sParam1);
	func_138(sParam2);
	func_138(sParam3);
...
void func_244()
{
	_push_scaleform_movie_function(iLocal_496, "HIDE_OVERLAY");
	_pop_scaleform_movie_function_void();
}

auto func_245(int iParam0)
{
	return iParam0 + 1;
}
...
void func_246()
{
	if (Global_68112)
	{
		if (Global_68111)
		{
			if (is_control_just_pressed(2, 201) || (is_control_just_pressed(2, 237) && !is_warning_message_active()))
			{
				...
				Global_68112 = 0;
				iLocal_515 = 0;
				_0xFAE628F1E9ADB239(Global_68113, Global_68114, 0);
				_0x58C21165F6545892("", "", 4);
				while (_0x2EAC52B4019E2782())
				{
					func_289();
					wait(0);
				}
	...
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(205), -1f, -1f, -1082130432, -1082130432);
	}
	...
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_RELEASE_EVENT", to_float(208), -1f, -1f, -1082130432, -1082130432);
	}
	func_250();
	enable_control_action(2, 201, 1);
	if (is_control_just_pressed(2, 201))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(201), -1f, -1f, -1082130432, -1082130432);
	}
	enable_control_action(2, 202, 1);
	if (is_control_just_pressed(2, 202))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(202), -1f, -1f, -1082130432, -1082130432);
	...
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(203), -1f, -1f, -1082130432, -1082130432);
	}
	if (!iLocal_510)
	{
		enable_control_action(2, 201, 1);
		...
		{
			_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_RELEASE_EVENT", to_float(201), -1f, -1f, -1082130432, -1082130432);
		}
	}
	if (_is_input_just_disabled(2))
	{
		...
		if (!iLocal_510)
		{
			...
			{
				_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_RELEASE_EVENT", to_float(237), -1f, -1f, -1082130432, -1082130432);
			}
		}
		if (!iLocal_510)
		{
			...
			{
				_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_RELEASE_EVENT", to_float(238), -1f, -1f, -1082130432, -1082130432);
			}
		}
		enable_control_action(2, 241, 1);
	...
	if (is_control_just_pressed(2, 204) || is_disabled_control_just_pressed(2, 204))
	{
		func_299();
	}
}
...
void func_247()
{
	...
	{
		_push_scaleform_movie_function(iLocal_496, "SET_ANALOG_STICK_INPUT");
		iLocal_708 = iVar0;
		iLocal_709 = iVar1;
		_push_scaleform_movie_function_parameter_bool(true);
		_push_scaleform_movie_function_parameter_int(iLocal_708);
		_push_scaleform_movie_function_parameter_int(iLocal_709);
		_pop_scaleform_movie_function_void();
	}
	...
	if (((iVar2 != 127 || iLocal_710 != 127) || iVar3 != 127) || iLocal_711 != 127)
	{
		...
		iLocal_711 = iVar3;
		_push_scaleform_movie_function_parameter_bool(false);
		_push_scaleform_movie_function_parameter_int(iLocal_710);
		_push_scaleform_movie_function_parameter_int(iLocal_711);
		_pop_scaleform_movie_function_void();
	}
}
...
void func_248()
{
	fLocal_718 = get_disabled_control_normal(2, 239);
	fLocal_719 = get_disabled_control_normal(2, 240);
	if (fLocal_718 != fLocal_720 || fLocal_719 != fLocal_721)
	{
		_push_scaleform_movie_function(iLocal_496, "SET_MOUSE_INPUT");
		_push_scaleform_movie_function_parameter_float(fLocal_718);
		_push_scaleform_movie_function_parameter_float(fLocal_719);
		_pop_scaleform_movie_function_void();
	...
	if (is_control_just_pressed(2, 237))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(237), -1f, -1f, -1082130432, -1082130432);
	}
	enable_control_action(2, 238, 1);
	if (is_control_just_pressed(2, 238))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(238), -1f, -1f, -1082130432, -1082130432);
		if (iLocal_703 == 1 || iLocal_703 == 0)
		{
			func_299();
		}
...
void func_250()
{
	...
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(188), -1f, -1f, -1082130432, -1082130432);
	}
	enable_control_action(2, 187, 1);
	if (is_control_just_pressed(2, 187))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(187), -1f, -1f, -1082130432, -1082130432);
	}
	enable_control_action(2, 189, 1);
	if (is_control_just_pressed(2, 189))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(189), -1f, -1f, -1082130432, -1082130432);
	}
	enable_control_action(2, 190, 1);
	if (is_control_just_pressed(2, 190))
	{
		_call_scaleform_movie_function_float_params(iLocal_496, "SET_INPUT_EVENT", to_float(190), -1f, -1f, -1082130432, -1082130432);
	}
}
...
void func_251()
{
	...
	if (iLocal_501 == 0 && _0x768FF8961BA904D6(uLocal_497))
	{
		iVar0 = _0x2DE7EFA66B906036(uLocal_497);
		if (iVar0 > 0 && iVar0 < 5)
		{
	...
	if (iLocal_501 == 3012)
	{
		if (!func_115(iLocal_702))
		{
			...
			iLocal_707 = 0;
			iLocal_701 = func_63(player_id(), 168, 0);
			sVar1 = func_62(0, iLocal_702);
			func_243("MP_WH_SELL", sVar1, "WHOUSE_CONF", "", 0);
			play_sound_frontend(-1, "Error", "GTAO_Exec_SecuroServ_Warehouse_PC_Sounds", 1);
			iLocal_505 = 1;
		}
		else
...
int func_252(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		return round(IntToFloat(iVar2) * to_float(Global_262145.f_13560) / 100f);
	}
	else if (iParam0 == 2)
	{
		return round(IntToFloat(iVar2) * to_float(Global_262145.f_13561) / 100f);
	}
	else if (iParam0 == 3)
	{
		return round(IntToFloat(iVar2) * to_float(Global_262145.f_13562) / 100f);
	}
	else if (iParam0 == 4)
	{
		return iVar1;
...
void func_254()
{
	...
	if (iLocal_510)
	{
		if ((!iLocal_511 && !iLocal_528) && iLocal_526)
		{
	...
	else if (!iLocal_512 && !iLocal_529)
	{
		...
		if (func_249())
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(iLocal_530, func_255()))
				{
			...
			if (((!iLocal_528 && !iLocal_529) && iLocal_526) && func_256())
			{
				func_258("SECURO_SELL_CD", 5000);
				iLocal_529 = 1;
				iLocal_528 = 1;
...
void func_257()
{
	...
	if (iLocal_531 == 180)
	{
		...
		while (iVar0 < 5)
		{
			...
			if (iVar1 != 0 && GAMEPLAY::IS_BIT_SET(iLocal_530, iVar1))
			{
				...
				if (iVar2 <= 0)
				{
					if (!func_53())
					{
						iVar2 = Global_262145.f_12476 - absi(get_time_difference(GAMEPLAY::GET_GAME_TIMER(), Global_2459488.f_55));
					}
				}
				if (iVar2 <= 0)
				{
					GAMEPLAY::CLEAR_BIT(&iLocal_530, iVar1);
				}
			}
			iVar0++;
		}
...
void func_259()
{
	...
	if (!iLocal_511 && !iLocal_529)
	{
		if (func_262(7654, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 6))
		{
			sVar0 = "WH_TUT_1";
			iLocal_705 = 5500;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 6);
			iVar1 = func_262(7654, -1, -1);
			iVar1++;
			func_261(7654, iVar1, -1, 1);
		}
		else if (func_262(7655, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 7))
		{
			sVar0 = "WH_TUT_2";
			iLocal_705 = 5500;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 7);
			iVar2 = func_262(7655, -1, -1);
			iVar2++;
			func_261(7655, iVar2, -1, 1);
		}
		else if (func_262(7656, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 8))
		{
			sVar0 = "WH_TUT_3";
			iLocal_705 = 5500;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 8);
			iVar3 = func_262(7656, -1, -1);
			iVar3++;
			func_261(7656, iVar3, -1, 1);
		}
		else if ((func_262(7657, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 9)) && func_260(iLocal_702))
		{
			sVar0 = "WH_TUT_SPEC";
			iLocal_705 = 5500;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 9);
			iVar4 = func_262(7657, -1, -1);
			iVar4++;
			func_261(7657, iVar4, -1, 1);
		}
	}
	if (!is_string_null_or_empty(sVar0) && !iLocal_511)
	{
...
auto func_261(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_266()
{
	...
	if (!iLocal_512 && !iLocal_529)
	{
		if (iLocal_703 == 2 && func_267(0))
		{
			sVar0 = "SECURO_MAP_TUT";
			iLocal_705 = 8000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, false);
		...
		else if ((func_267(1) && func_249()) && !func_256())
		{
			sVar0 = "SECURO_WH_TUT";
			iLocal_705 = 6000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, true);
		...
		else if (((iLocal_703 == 2 && func_239()) && !iLocal_516) && func_267(2))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 2);
		...
		else if ((func_267(3) && func_256()) && func_249())
		{
			...
			iLocal_705 = 9000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 3);
		...
		else if (iLocal_703 == 1 && func_267(4))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 4);
		...
		else if (func_267(5))
		{
			...
			iLocal_705 = 6000;
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1728812, 5);
			iVar6 = func_262(7663, -1, -1);
			iVar6++;
			func_261(7663, iVar6, -1, 1);
		}
	}
	if (!is_string_null_or_empty(sVar0) && !iLocal_512)
	{
		func_258(sVar0, iLocal_705);
		iLocal_512 = true;
	}
...
bool func_267(int iParam0)
{
	...
	{
		case 0:
			if (func_262(7658, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, false))
			{
				return true;
			}
			break;
		...
		case 1:
			if (func_262(7660, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, true))
			{
				return true;
			}
			break;
		...
		case 2:
			if (func_262(7659, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 2))
			{
				return true;
			}
			break;
		...
		case 3:
			if (func_262(7661, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 3))
			{
				return true;
			}
			break;
		...
		case 4:
			if (func_262(7662, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 4))
			{
				return true;
			}
			break;
		...
		case 5:
			if ((func_262(7663, -1, -1) < 3 && !GAMEPLAY::IS_BIT_SET(Global_1728812, 5)) && func_268())
			{
				return true;
			}
			break;
...
int func_271(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_272(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_279()
{
	...
	{
		if (func_282(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_286(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_289()
{
	...
	_set_2d_layer(1);
	draw_scaleform_movie_fullscreen(iLocal_496, 255, 255, 255, 255, 0);
	func_292();
	func_166();
	func_290();
}
...
void func_297()
{
	...
	_set_warning_message_2(sVar0, sVar1, iVar2, iVar3, 0, -1, 0, 0, 1);
}
...
{
	Global_68058 = 0;
	set_scaleform_movie_as_no_longer_needed(&iLocal_496);
	func_342(0);
	if (!iLocal_510)
	{
		Global_68062 = 1;
...
float func_303(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_306(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_309(int iParam0, int iParam1)
{
	...
	int iVar2;
	int iVar3;
	struct<16>[] Var4 = new struct<16>[3];
	int iVar53;
	int iVar54;
	...
	_push_scaleform_movie_function(iLocal_496, "ADD_ACTIVE_USER");
	unk_0x77FE3402004CD1B0(sVar1);
	unk_0x77FE3402004CD1B0(func_310(iParam0));
...
char* func_311(int iParam0)
{
	...
	if (((func_55(iParam0, 28) || func_55(player_id(), 28)) || func_314(iParam0)) && !func_312(iParam0))
	{
		return _get_label_text("GB_REST_ACC");
	}
...
void func_321(int iParam0)
{
	...
	if (iLocal_510)
	{
		StringCopy(&Var0, func_61(iLocal_702), 16);
		vVar4 = {func_155(iLocal_702)};
		StringCopy(&Var7, get_name_of_zone(vVar4), 16);
		...
		if (iVar52 <= 0)
		{
			if (!func_9())
			{
				iVar52 = Global_262145.f_12477 - absi(get_time_difference(GAMEPLAY::GET_GAME_TIMER(), Global_2459488.f_53));
			}
		}
		iLocal_526 = iVar52 > 0;
		...
		func_330(&iVar50, &Var15, &Var31, 0, iVar49);
		iVar53 = func_329();
		iVar54 = floor(func_327(to_float(iVar53) / to_float(func_328()) * 100f, 0f, 100f));
		_push_scaleform_movie_function(iLocal_496, "SET_PLAYER_DATA");
		unk_0x77FE3402004CD1B0(get_player_name(player_id()));
		unk_0x77FE3402004CD1B0(func_310(player_id()));
		_push_scaleform_movie_function_parameter_float(to_float(iVar54));
		_push_scaleform_movie_function_parameter_int(iVar53);
		_push_scaleform_movie_function_parameter_int(func_326());
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(iLocal_496, "SET_BUYER_DATA");
		func_138(&Var15);
		unk_0x77FE3402004CD1B0(&Var31);
		_push_scaleform_movie_function_parameter_int(iVar50);
		func_330(&iVar50, &Var15, &Var31, 1, iVar49);
		func_138(&Var15);
		unk_0x77FE3402004CD1B0(&Var31);
		_push_scaleform_movie_function_parameter_int(iVar50);
		func_330(&iVar50, &Var15, &Var31, 2, iVar49);
		func_138(&Var15);
		unk_0x77FE3402004CD1B0(&Var31);
		_push_scaleform_movie_function_parameter_int(iVar50);
		func_330(&iVar50, &Var15, &Var31, 3, iVar49);
		func_138(&Var15);
		unk_0x77FE3402004CD1B0(&Var31);
		_push_scaleform_movie_function_parameter_int(iVar50);
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(iLocal_496, "SET_WAREHOUSE_DATA");
		func_138(&Var0);
		func_138(&Var7);
		unk_0x77FE3402004CD1B0(&cVar11);
		_push_scaleform_movie_function_parameter_int(iVar47);
		_push_scaleform_movie_function_parameter_int(iVar48);
		_push_scaleform_movie_function_parameter_int(iVar49);
		_push_scaleform_movie_function_parameter_int(iVar50);
		_push_scaleform_movie_function_parameter_int(iVar51);
		_push_scaleform_movie_function_parameter_int(iVar52);
		_pop_scaleform_movie_function_void();
	}
	else
	{
		iVar55 = func_325();
		iVar56 = func_329();
		iVar57 = floor(func_327(to_float(iVar55) / to_float(func_324()) * 100f, 0f, 100f));
		iVar58 = floor(func_327(to_float(iVar56) / to_float(func_328()) * 100f, 0f, 100f));
		_push_scaleform_movie_function(iLocal_496, "SET_PLAYER_DATA");
		unk_0x77FE3402004CD1B0(get_player_name(player_id()));
		_push_scaleform_movie_function_parameter_bool(iParam0);
		_push_scaleform_movie_function_parameter_float(to_float(func_326()));
		_push_scaleform_movie_function_parameter_int(iVar55);
		_push_scaleform_movie_function_parameter_float(to_float(iVar57));
		_push_scaleform_movie_function_parameter_int(iVar56);
		_push_scaleform_movie_function_parameter_float(to_float(iVar58));
		unk_0x77FE3402004CD1B0(func_310(player_id()));
		_pop_scaleform_movie_function_void();
		iVar59 = true;
		while (iVar59 <= 22)
...
int func_323()
{
	...
	while (iVar1 <= 4)
	{
		if (Global_1587523[player_id() /*444*/].f_250.f_68[iVar1 /*2*/] != 0)
		{
			iVar2 = func_124(Global_1587523[player_id() /*444*/].f_250.f_68[iVar1 /*2*/]);
			if (iVar2 < iVar0)
			{
				iVar0 = iVar2;
			}
...
void func_330(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4)
{
	...
	{
		uVar4 = func_19(iLocal_702);
		StringCopy(sParam2, "", 64);
		if (is_string_null_or_empty(sParam1) || is_string_null_or_empty(sParam2))
		{
		}
		switch (iParam3)
		{
			case 0:
				iVar3 = round(IntToFloat(iVar2) * to_float(Global_262145.f_13560) / 100f);
				*iParam0 = func_147(iVar3) * iVar3;
				MemCopy(sParam1, {func_331(Global_1728817[uVar4])}, 16);
				IntToString(sParam2, iVar3, 64);
				iVar0 = iVar3 == true;
				break;
			
			case 1:
				iVar3 = round(IntToFloat(iVar2) * to_float(Global_262145.f_13561) / 100f);
				*iParam0 = func_147(iVar3) * iVar3;
				MemCopy(sParam1, {func_331(Global_1728823[uVar4])}, 16);
				IntToString(sParam2, iVar3, 64);
				iVar0 = iVar3 == true;
				break;
			
			case 2:
				iVar3 = round(IntToFloat(iVar2) * to_float(Global_262145.f_13562) / 100f);
				*iParam0 = func_147(iVar3) * iVar3;
				MemCopy(sParam1, {func_331(Global_1728829[uVar4])}, 16);
				IntToString(sParam2, iVar3, 64);
				iVar0 = iVar3 == true;
				break;
			...
			case 3:
				*iParam0 = func_142(iLocal_702);
				MemCopy(sParam1, {func_331(Global_1728835[uVar4])}, 16);
				break;
		}
		if (iParam3 == 3)
		{
...
struct<4> func_331(auto uParam0)
{
	char[16] cVar0;
	
	StringCopy(&cVar0, "CONTRA_BUYER", 16);
...
void func_334(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_337(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
