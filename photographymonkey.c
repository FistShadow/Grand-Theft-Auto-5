#region Local Var
	...
	int iLocal_52 = 0;
	int iLocal_53 = 0;
	struct<8>[] Local_54 = new struct<8>[50];
	Vector3 vLocal_455 = 0;
	int iLocal_458 = 0;
	int iLocal_459 = 0;
	int iLocal_460 = 0;
	int iLocal_461 = 0;
		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					iLocal_461 = GAMEPLAY::IS_BIT_SET(Global_2284, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
							...
							if (((((fVar15 >= 0.35f && func_97(vVar1, 0f, 1f)) && func_97(vVar4, 0f, 1f)) && func_97(vVar7, 0f, 1f)) && func_97(vVar10, 0f, 1f)) || ((((fVar15 < 0.35f && func_97(vVar1, 0.05f, 0.95f)) && func_97(vVar4, 0.05f, 0.95f)) && func_97(vVar7, 0.05f, 0.95f)) && func_97(vVar10, 0.05f, 0.95f)))
							{
								if (fVar13 >= 0.08f && fVar14 >= 0.101f)
								{
									...
									iVar16 = false;
									iVar17 = 0;
									while (iVar17 < 10 && !iVar16)
									{
										iVar16 = ((((is_tracked_point_visible(iLocal_49) && is_tracked_point_visible(iLocal_50)) && is_tracked_point_visible(iLocal_51)) && is_tracked_point_visible(iLocal_52)) && is_tracked_point_visible(iLocal_53));
										iVar17++;
										wait(0);
									}
									if (iVar16)
...
int func_9(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_13(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
...
int func_14(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_16(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_17(iParam1)];
...
int func_20(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
int func_21(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_23(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_24(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_3044[0 /*166*/][iParam1 /*11*/][iParam2 / 32]), iParam2 % 32);
			}
			break;
		...
		case joaat("player_two"):
			...
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_3044[1 /*166*/][iParam1 /*11*/][iParam2 / 32]), iParam2 % 32);
			}
			if (!iParam3 || GAMEPLAY::IS_BIT_SET(Global_101154.f_5919[4], false))
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_1826.f_539.f_3044[2 /*166*/][iParam1 /*11*/][iParam2 / 32]), iParam2 % 32);
			}
			break;
	}
}

bool func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_24(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_89(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_89(vVar16.z)] = func_83(iParam1, vVar16.x, func_89(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_89(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
int func_93(int iParam0)
{
	...
	func_94(iParam0, &uVar0, &iVar1);
	return GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_135[uVar0], iVar1);
}

void func_94(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = iParam0 / 32;
	*uParam2 = iParam0 % 32;
}
...
void func_95(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_101154.f_8739.f_135[uVar0]), iVar1);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_8739.f_135[uVar0]), iVar1);
	}
}
...
bool func_97(Vector3 vParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	
	if (_world3d_to_screen2d(vParam0, &fVar0, &fVar1))
	{
...
void func_98(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, float fParam4)
{
	...
	_world3d_to_screen2d(vParam0, &vVar0, &(vVar0.f_1));
	_world3d_to_screen2d(vParam3, &vVar3, &(vVar3.f_1));
	_world3d_to_screen2d(vParam6, &vVar6, &(vVar6.f_1));
	*fParam9 = vdist(vVar0, vVar3);
	*fParam10 = vdist(vVar0, vVar6);
}

void func_99(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
int func_105()
{
	...
	return Global_101154.f_8739.f_135[iVar0] == round(pow(2f, to_float(iVar1 + 1))) - 1;
}
...
void func_106()
{
	if (iLocal_460)
	{
		if (has_scaleform_movie_loaded(iLocal_459))
		{
			draw_scaleform_movie(iLocal_459, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_458)
		{
			case 0:
			...
			case 2:
				if (has_scaleform_movie_loaded(iLocal_459) || iLocal_462 < GAMEPLAY::GET_GAME_TIMER())
				{
					if (iLocal_462 < GAMEPLAY::GET_GAME_TIMER())
					{
						iLocal_460 = false;
			...
			case 3:
				_push_scaleform_movie_function(iLocal_459, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
				_push_scaleform_movie_function_parameter_int(50);
				func_111("PM_PASS");
				func_111("PM_CHALLENGE");
				_push_scaleform_movie_function_parameter_int(func_92());
			...
			case 4:
				if ((((((iLocal_462 < GAMEPLAY::GET_GAME_TIMER() || is_screen_faded_out()) || !is_player_playing(player_id())) || func_112()) || !is_player_control_on(player_id())) || func_110()) || func_109())
				{
					_push_scaleform_movie_function(iLocal_459, "SHARD_ANIM_OUT");
			...
			case 6:
				set_scaleform_movie_as_no_longer_needed(&iLocal_459);
				if (func_105())
				{
