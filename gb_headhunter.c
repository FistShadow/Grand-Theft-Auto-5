...
void main()
{
	...
	fLocal_94 = 3.7f;
	iLocal_1424 = -1;
	if (network_is_game_in_progress() && func_617(player_id(), 0, 1))
	{
		func_604(Local_1716);
	}
	else
...
void func_11()
{
	...
	if (network_is_host_of_this_script())
	{
		...
		while (iVar0 < 4)
		{
			...
			{
				case 0:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (Local_96.f_2[iVar0 /*26*/] == 0)
						{
							if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
							{
						...
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
						{
							if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
							{
								if (func_12(Local_96.f_2[iVar0 /*26*/].f_2))
								{
									...
									{
										if (is_bit_set(Local_96.f_109, iVar0))
										{
											set_bit(&(Local_96.f_108), iVar0);
											Local_96.f_2[iVar0 /*26*/].f_17 = 2;
										}
										else if (is_bit_set(Local_96.f_110, iVar0))
										{
											set_bit(&(Local_96.f_108), iVar0);
											Local_96.f_2[iVar0 /*26*/].f_17 = 2;
										}
										else if (is_bit_set(Local_96.f_111, iVar0))
										{
											set_bit(&(Local_96.f_108), iVar0);
											Local_96.f_2[iVar0 /*26*/].f_17 = 2;
										}
										else if (is_bit_set(Local_96.f_112, iVar0))
										{
				...
				case 2:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
						{
							...
							else if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
							{
								if (!func_12(Local_96.f_2[iVar0 /*26*/].f_2))
								{
									Local_96.f_2[iVar0 /*26*/].f_17 = 3;
				...
				case 5:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
						{
							if (is_bit_set(Local_96.f_110, iVar0))
							{
								Local_96.f_2[iVar0 /*26*/].f_17 = 4;
							}
							else if (is_bit_set(Local_96.f_111, iVar0))
			...
			while (iVar1 < 3)
			{
				...
				{
					case 0:
						if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
						{
							if (Local_96.f_2[iVar0 /*26*/] == 0)
							{
...
void func_15()
{
	...
	while (iVar0 < 4)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
		{
			if (!is_bit_set(Local_96.f_116, iVar0))
			{
				if (func_20(iVar0))
				{
					if (func_12(Local_96.f_2[iVar0 /*26*/].f_2))
...
bool func_20(int iParam0)
{
	...
	if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_1))
	{
		return false;
	}
	...
	while (iVar0 < 3)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_3[iVar0]))
		{
...
void func_21()
{
	...
	if (Local_96 != 4)
	{
			...
			if (network_is_participant_active(int_to_participantindex(iLocal_1419)))
			{
				...
				if (!func_17(iVar3, 0))
				{
					...
					if (!is_bit_set(Local_96.f_1, 2))
					{
						if (!iVar2)
						{
							if ((is_bit_set(Local_96.f_1, true) || is_bit_set(Local_96.f_1, 3)) || is_bit_set(Local_96.f_1, 5))
							{
								if (!is_bit_set(Local_968[iLocal_1419 /*14*/].f_1, 4))
								{
									iVar2 = true;
								}
							}
		...
		while (iVar1 < 4)
		{
			if (is_bit_set(Local_96.f_113, iVar1))
			{
				iVar0++;
			}
			iVar1++;
...
void func_22()
{
	...
	while (iVar0 < 4)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
		{
			if (!is_bit_set(Local_96.f_113, iVar0))
			{
...
void func_23(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (!is_bit_set(Local_96.f_109, iVar0))
		{
			if (is_bit_set(Local_968[iParam0 /*14*/].f_5, iVar0))
			{
				set_bit(&(Local_96.f_109), iVar0);
			}
		}
		if (!is_bit_set(Local_96.f_110, iVar0))
		{
			if (is_bit_set(Local_968[iParam0 /*14*/].f_2, iVar0))
			{
				set_bit(&(Local_96.f_110), iVar0);
			}
		}
		if (!is_bit_set(Local_96.f_112, iVar0))
		{
			if (is_bit_set(Local_968[iParam0 /*14*/].f_3, iVar0))
			{
				set_bit(&(Local_96.f_112), iVar0);
			}
		}
		if (!is_bit_set(Local_96.f_111, iVar0))
		{
			if (is_bit_set(Local_968[iParam0 /*14*/].f_4, iVar0))
			{
				set_bit(&(Local_96.f_111), iVar0);
			}
		}
		if (!is_bit_set(Local_96.f_113, iVar0))
		{
			if (is_bit_set(Local_968[iParam0 /*14*/].f_6, iVar0))
			{
				set_bit(&(Local_96.f_113), iVar0);
			}
			else if (is_bit_set(Local_968[iParam0 /*14*/].f_7, iVar0))
			{
				set_bit(&(Local_96.f_113), iVar0);
			}
		}
		if (Local_96.f_2[iVar0 /*26*/] == 2)
		{
			if (!Local_96.f_2[iVar0 /*26*/].f_24)
			{
				if (is_bit_set(Local_968[iParam0 /*14*/].f_12, iVar0))
				{
			...
			if (!Local_96.f_2[iVar0 /*26*/].f_25)
			{
				if (is_bit_set(Local_968[iParam0 /*14*/].f_13, iVar0))
				{
...
void func_24(int iParam0)
{
	...
	if (!is_bit_set(Local_96.f_114, iParam0))
	{
		iVar0 = 0;
		while (iVar0 < 4)
		{
				...
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (func_12(Local_96.f_2[iVar0 /*26*/].f_2))
						{
							...
							set_bit(&(Local_96.f_114), iParam0);
						}
					}
				}
			}
...
bool func_27(int iParam0)
{
	...
	while (iVar1 < 3)
	{
		...
		{
			if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_7[iVar1]))
			{
				return false;
			}
		}
		...
		if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_7[iVar1]))
		{
			...
			if (!func_28(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (can_register_mission_vehicles(1))
				{
					if (func_31(iVar2))
					{
						if (!is_bit_set(Local_96.f_2[iParam0 /*26*/].f_23, iVar1))
						{
							clear_area(vVar3, 10f, 1, 0, 0, true);
							set_bit(&(Local_96.f_2[iParam0 /*26*/].f_23), iVar1);
						}
	...
	if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_1))
	{
		switch (Local_96.f_2[iParam0 /*26*/])
		{
			case 0:
				...
				{
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_2))
					{
						iVar0 = func_41();
						iVar1 = false;
						while (iVar1 < 3)
						{
							if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_3[iVar1]))
							{
...
bool func_39(var uParam0, int iParam1, int iParam2, vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
bool func_40(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!can_register_mission_peds(1))
	{
		return false;
...
void func_51(vector3 vParam0)
{
	...
	while (iVar1 < 5)
	{
		if (iVar0 == -1)
		{
			if (!is_bit_set(Local_96.f_871, iVar1))
			{
				iVar0 = iVar1;
			}
		}
...
bool func_52(int iParam0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
	...
	{
		case 1:
			iVar0 = get_random_int_in_range(false, Local_96.f_122);
	...
	if (iParam4 && !iParam7)
	{
		if (func_617(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_56(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_55(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (get_distance_between_coords(func_56(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
...
bool func_57(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_617(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_55(iVar1)))
					{
...
void func_73()
{
	...
	if (Local_96.f_119 > -1)
	{
		if (iVar3 > -1)
		{
			vVar0 = {get_entity_coords(net_to_ped(Local_96.f_2[iVar3 /*26*/].f_1), 0)};
		}
	}
...
void func_74(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	Vector3 fVar0;
	float fVar1;
	
	if (((func_114(player_id()) && !func_113(player_id())) && !is_bit_set(Global_1610316[player_id() /*174*/].f_1, 8)) && (func_112(player_id()) || func_111(player_id())))
	{
		return;
	}
...
float func_126(int iParam0, int iParam1)
{
	...
	while (iVar2 < 4)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar2 /*26*/].f_1))
		{
			if (Local_96.f_2[iVar2 /*26*/] == 2 || !iParam1)
			{
				if (!func_14(Local_96.f_2[iVar2 /*26*/].f_1))
				{
					vVar6 = {get_entity_coords(net_to_ped(Local_96.f_2[iVar2 /*26*/].f_1), 1)};
...
void func_127(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	if (func_246() || iParam2 == 24)
	{
		...
		{
			func_196(1);
			if ((!func_194() && !func_192()) || is_bit_set(Global_2460486.f_4426, true))
			{
				if (func_191())
				{
					func_188();
				...
				else
				{
					...
					if (*uParam3.f_27 == 0)
					{
						...
						{
							iVar35 = int_to_playerindex(iVar52);
							if (func_617(iVar35, 0, 1) && !is_bit_set(iVar49, iVar35))
							{
								iVar35 = int_to_playerindex(iVar52);
							}
							else
...
int func_132(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
...
void func_141(char* sParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_149(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, var uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, Vector3 fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_158(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_162(iParam3))
	{
...
bool func_191()
{
	if (is_bit_set(Global_2460486.f_4426, false) && func_190())
	{
		return true;
	}
	if (is_bit_set(Global_2460486.f_4426, true) && func_190())
	{
		return true;
	}
	return false;
...
bool func_197(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
...
int func_249()
{
	...
	if (iVar0 != -1)
	{
		return is_bit_set(Local_968[iVar0 /*14*/].f_1, true);
	}
	return false;
}
...
void func_252(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &Var0, 10))
	{
		...
		while (iVar29 < 4)
		{
			if (!is_bit_set(Local_96.f_113, iVar29))
			{
				if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_6, iVar29))
				{
					if (does_entity_exist(Var0))
					{
						if (is_entity_a_vehicle(Var0))
						{
							if (!is_bit_set(Local_96.f_109, iVar29))
							{
								if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_5, iVar29))
								{
									if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar29 /*26*/].f_2))
									{
										if (does_entity_exist(net_to_veh(Local_96.f_2[iVar29 /*26*/].f_2)))
										{
												...
												if (does_entity_exist(Var0.f_1))
												{
													if (is_entity_a_ped(Var0.f_1))
													{
														if (get_ped_index_from_entity_index(Var0.f_1) == player_ped_id())
														{
															...
															{
																set_bit(&(Local_968[participant_id_to_int() /*14*/].f_5), iVar29);
															}
														}
													}
												}
								...
								if (does_entity_exist(Var0.f_1))
								{
									if (is_entity_a_ped(Var0.f_1))
									{
										...
										if (is_ped_a_player(iVar10))
										{
											...
											if (network_is_player_a_participant(iVar13))
											{
												if (Var0.f_3)
												{
													if (iVar13 == player_id())
													{
														...
														set_bit(&(Local_968[participant_id_to_int() /*14*/].f_6), iVar29);
														Var15.f_2 = 144;
											...
											else if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_7, iVar29))
											{
												if (Var0.f_3)
												{
													iVar13 = _network_get_ped_player(iVar10);
													set_bit(&(Local_968[participant_id_to_int() /*14*/].f_7), iVar29);
												}
											}
										}
										else if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_7, iVar29))
...
void func_260()
{
	...
	if (!func_17(player_id(), 0))
	{
		if (is_bit_set(iLocal_1417, 14))
		{
			clear_bit(&iLocal_1417, 14);
		}
		return;
	}
	...
	if (!is_bit_set(iLocal_1417, 14))
	{
		...
		set_bit(&iLocal_1417, 14);
	}
	if (!is_bit_set(iLocal_1417, 15))
	{
		set_bit(&iLocal_1417, 15);
		func_508();
	}
...
void func_261()
{
	...
	if (!is_bit_set(Local_968[iVar10 /*14*/].f_1, 4))
	{
		if (!is_bit_set(iLocal_1417, 9))
		{
			if (is_bit_set(Local_96.f_1, true))
			{
				if (iVar10 == Local_96.f_118 || func_573() == Local_96.f_118)
				{
					...
					if (iVar11 == player_id())
					{
						if (!is_bit_set(iLocal_1417, 6))
						{
							func_447(1, 1);
							set_bit(&iLocal_1417, 6);
						}
						Var0 = func_446();
						Var0.f_1 = func_445();
						func_328(166, 1, &Var0);
		...
		{
			func_508();
			if (!is_bit_set(iLocal_1418, 8))
			{
				func_274();
				func_70();
				set_bit(&iLocal_1418, 8);
			}
			if (!is_bit_set(iLocal_1417, 10))
			{
			}
			if (func_262(&uLocal_1425, 0))
			{
				...
				{
					set_bit(&(Local_968[participant_id_to_int() /*14*/].f_1), 4);
				}
			}
			else if (is_bit_set(iLocal_1417, 17))
			{
				if (func_6(&uLocal_1712, 10000, 0))
				{
					set_max_wanted_level(iLocal_1711);
					clear_bit(&iLocal_1417, 17);
				}
			}
		}
	}
...
void func_266()
{
	...
	{
		if ((((((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_617(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out()) && !func_92(player_id(), 22)) && func_116(player_id()) != 0) && !func_269(func_270()))
		{
...
void func_274()
{
	...
	if (is_bit_set(iLocal_1417, 18))
	{
		func_286();
		clear_bit(&iLocal_1417, 18);
	}
	func_283();
	func_275();
}
...
void func_275()
{
	...
	if (!is_bit_set(iLocal_1417, 7))
	{
		set_bit(&iLocal_1417, 7);
		iVar0 = false;
		while (iVar0 < 32)
		{
			iVar1 = int_to_playerindex(iVar0);
			if (network_is_player_active(iVar1))
			{
				if (iVar1 != player_id())
				{
					if (is_bit_set(Local_968[participant_id_to_int() /*14*/].f_8, iVar0))
					{
...
void func_276(int iParam0, var uParam1, int iParam2)
{
	...
	if (get_hash_key(get_this_script_name()) == func_278())
	{
		return;
	}
	iVar0 = iParam0;
...
void func_283()
{
	if (is_bit_set(iLocal_1417, 16))
	{
		func_79();
		func_284();
		clear_bit(&iLocal_1417, 16);
	}
}
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_299(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_298(1);
...
int func_300(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_302(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_299(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_298(1);
			}
...
bool func_308()
{
	...
	if (!func_17(player_id(), 0))
	{
		if (!func_309(1))
		{
			if (is_bit_set(Local_968[participant_id_to_int() /*14*/].f_1, 6))
			{
				clear_bit(&(Local_968[participant_id_to_int() /*14*/].f_1), 6);
			}
			return false;
		}
		if (func_118())
		...
		if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_1, 6))
		{
			set_bit(&(Local_968[participant_id_to_int() /*14*/].f_1), 6);
		}
	}
	else
	{
		...
		if (!is_bit_set(Local_968[iVar0 /*14*/].f_1, 6))
		{
			return false;
		}
	}
...
void func_328(int iParam0, int iParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iVar1 > 0)
	{
		...
		func_392();
		func_346(0, player_ped_id(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
	}
	if (iVar0 > 0)
	{
...
void func_333(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_334(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_341(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
void func_348(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_350(player_ped_id()))
	{
		func_349(1);
	}
...
Vector3 func_351(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_352(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_356(vector3 vParam0, var uParam1, var uParam2)
{
	Vector3 fVar0;
	float fVar1;
	float fVar2;
...
var func_357(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
var func_387(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
int func_429(int iParam0)
{
	...
	if (func_436(iParam0))
	{
		...
		if (iVar1 < func_430(iParam0))
		{
			...
			{
				iVar0 += func_434(get_random_int_in_range(true, 6));
				iVar2++;
			}
		}
	}
...
int func_448(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int func_449(var uParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, var uParam10, var uParam11, var uParam12, var uParam13)
{
	struct<72> Var0;
...
void func_463(int iParam0)
{
	...
	if (!is_bit_set(iLocal_1418, 15))
	{
		if (iParam0 <= 35000)
		{
			if (trigger_music_event("APT_PRE_COUNTDOWN_STOP"))
			{
				set_bit(&iLocal_1418, 15);
				set_bit(&iLocal_1418, 9);
	...
	if (is_bit_set(iLocal_1418, 9))
	{
		if (iParam0 <= 30000)
		{
			if (!is_bit_set(iLocal_1418, 11))
			{
				if (prepare_music_event("APT_COUNTDOWN_30S_KILL"))
				{
					set_bit(&iLocal_1418, 11);
				}
			}
			else
			{
				is_bit_set(iLocal_1418, 11);
				if (!is_bit_set(iLocal_1418, 14))
				{
					if (trigger_music_event("APT_COUNTDOWN_30S"))
					{
						set_bit(&iLocal_1418, 14);
					}
				}
			}
			if (is_bit_set(iLocal_1418, 14))
	...
	if (is_bit_set(iLocal_1418, 8))
	{
		if (is_bit_set(iLocal_1418, 9))
		{
			if (!is_bit_set(iLocal_1418, 10))
			{
				...
				if (!is_bit_set(iLocal_1418, 16))
				{
					if (trigger_music_event("APT_COUNTDOWN_30S_KILL"))
					{
						set_bit(&iLocal_1418, 16);
					}
				}
				if (is_bit_set(iLocal_1418, 16))
				{
					if (!is_bit_set(iLocal_1418, 13))
					{
						if (trigger_music_event("APT_FADE_IN_RADIO"))
						{
							set_bit(&iLocal_1418, 13);
						}
					}
					if (is_bit_set(iLocal_1418, 13))
					{
						set_bit(&iLocal_1418, 10);
					}
				}
			}
		}
...
void func_467()
{
	...
	else if (!is_bit_set(Local_968[iVar18 /*14*/].f_1, 6))
	{
		func_508();
		return;
	}
...
void func_468(char* sParam0, char* sParam1, var uParam2, int iParam3)
{
...
bool func_469(char* sParam0, char* sParam1, int iParam2, var uParam3)
{
...
void func_485()
{
	...
	if (!is_bit_set(iLocal_1417, true))
	{
...
bool func_492(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_504()
{
	...
	{
		if (func_507(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
int func_510()
{
	return ((is_bit_set(Local_96.f_1, true) || is_bit_set(Local_96.f_1, 3)) || is_bit_set(Local_96.f_1, 5));
}
...
void func_514()
{
	...
	if (fVar4 < 62500f)
	{
		if (iVar0 > -1)
		{
			...
			{
				vVar1 = {get_entity_coords(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 0)};
				func_82(10, 0, 0);
				func_515(vVar1, 0f, 250f, 1, 75f, 0, 1, 65f, 1, 0);
				iLocal_1424 = iVar0;
				set_bit(&iLocal_1417, 16);
			}
		}
	}
...
void func_531()
{
	if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_1, true))
	{
		if (!func_572())
		{
			if (is_bit_set(Local_96.f_1, 6))
			{
				func_95(1);
				set_bit(&(Local_968[participant_id_to_int() /*14*/].f_1), true);
			}
		}
	}
}
...
void func_532()
{
	...
	while (iVar0 < 4)
	{
		if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_2, iVar0))
		{
			if (!is_bit_set(Local_96.f_110, iVar0))
			{
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
					...
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (!is_ped_injured(player_ped_id()))
						{
							if (func_573() == Local_96.f_118)
							{
								...
								{
									set_bit(&(Local_968[participant_id_to_int() /*14*/].f_2), iVar0);
								}
							}
						}
					}
		...
		if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_3, iVar0))
		{
			if (!is_bit_set(Local_96.f_112, iVar0))
			{
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
				{
					if (func_548(iVar0))
					{
						set_bit(&(Local_968[participant_id_to_int() /*14*/].f_3), iVar0);
					}
				}
			}
		}
		if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_4, iVar0))
		{
			if (!is_bit_set(Local_96.f_111, iVar0))
			{
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (is_bullet_in_area(get_entity_coords(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 1), 10f, 1))
						{
							set_bit(&(Local_968[participant_id_to_int() /*14*/].f_4), iVar0);
						}
					}
				}
			}
		...
		if (func_308())
		{
			...
			else if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
			{
				if (func_14(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					remove_blip(&(iLocal_1432[iVar0]));
		...
		switch (Local_96.f_2[iVar0 /*26*/].f_17)
		{
					...
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_2))
					{
						if (func_12(Local_96.f_2[iVar0 /*26*/].f_2))
						{
							if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), net_to_veh(Local_96.f_2[iVar0 /*26*/].f_2)))
								{
									if (get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -258271821) != 1 && get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -258271821) != 0)
									{
						...
						if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
						{
							if (func_12(Local_96.f_2[iVar0 /*26*/].f_2))
							{
								if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
								{
									if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), net_to_veh(Local_96.f_2[iVar0 /*26*/].f_2)))
									{
										if ((get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -258271821) != 1 && get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -258271821) != 0) || is_bit_set(Local_96.f_108, iVar0))
										{
											task_vehicle_drive_wander(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), net_to_veh(Local_96.f_2[iVar0 /*26*/].f_2), 30f, 786469);
											if (is_bit_set(Local_96.f_108, iVar0))
											{
												clear_bit(&(Local_96.f_108), iVar0);
											}
										}
									}
								}
			...
			case 3:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -828834893) != 1 && get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -828834893) != 0)
						{
			...
			case 5:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (!is_ped_injured(player_ped_id()))
						{
							if (get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -1146898486) != 1 && get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -1146898486) != 0)
							{
								if (func_541(Local_96.f_2[iVar0 /*26*/].f_1))
								{
									if (network_has_control_of_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
			...
			case 4:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						if (!is_ped_injured(player_ped_id()))
						{
							if (get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 1805844857) != 1 && get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 1805844857) != 0)
							{
								if (func_541(Local_96.f_2[iVar0 /*26*/].f_1))
								{
									if (network_has_control_of_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
									{
										...
										{
											task_smart_flee_ped(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), iVar2, 500f, -1, 0, 1);
										}
									}
								}
							}
			...
			case 6:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						...
						iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), -1442466670);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_541(Local_96.f_2[iVar0 /*26*/].f_1))
							{
			...
			case 9:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						...
						iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 1910705116);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_541(Local_96.f_2[iVar0 /*26*/].f_1))
							{
			...
			case 8:
				if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_1))
				{
					if (!func_14(Local_96.f_2[iVar0 /*26*/].f_1))
					{
						iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_1), 993674639);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_541(Local_96.f_2[iVar0 /*26*/].f_1))
							{
			...
			switch (Local_96.f_2[iVar0 /*26*/].f_18[iVar1])
			{
				...
				case 8:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
					{
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
						{
							iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]), 993674639);
							if (iVar3 != 1 && iVar3 != 0)
							{
				...
				case 7:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
					{
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
						{
							iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]), -1442466670);
							if (iVar3 != 1 && iVar3 != 0)
							{
								if (func_541(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
								{
				...
				case 3:
					if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
					{
						if (!func_14(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
						{
							...
							{
								iVar3 = get_script_task_status(net_to_ped(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]), -828834893);
								if (iVar3 != 1 && iVar3 != 0)
								{
									if (func_541(Local_96.f_2[iVar0 /*26*/].f_3[iVar1]))
									{
...
bool func_536(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
int func_538(int iParam0, var uParam1)
{
	...
	iVar0 = func_60();
	fVar1 = 1E+08f;
	vVar3 = {get_entity_coords(net_to_ped(Local_96.f_2[iParam0 /*26*/].f_1), 1)};
	iVar6 = false;
	while (iVar6 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar6)))
		{
			...
			if (!func_17(iVar7, 0))
			{
				...
				{
					if (!is_ped_injured(iVar8))
					{
						fVar2 = vdist2(get_entity_coords(iVar8, 1), vVar3);
						if (fVar2 < fVar1)
						{
							fVar1 = fVar2;
							iVar0 = iVar7;
...
int func_540(var uParam0)
{
	...
	fVar1 = 1E+10f;
	fVar2 = 0f;
	vVar4 = {get_entity_coords(net_to_ped(Local_96.f_2[uParam0 /*26*/].f_1), 0)};
	iVar3 = false;
	while (iVar3 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar3)))
		{
			...
			if (func_151(iVar7, 1))
			{
				if (!is_bit_set(Local_968[iVar3 /*14*/].f_1, true))
				{
					if (func_61(iVar7) == network_get_player_index(int_to_participantindex(Local_96.f_118)))
					{
						if (!is_ped_injured(iVar8))
						{
							fVar2 = vdist2(get_entity_coords(iVar8, 1), vVar4);
							if (fVar2 < fVar1)
							{
								fVar1 = fVar2;
								iVar0 = iVar7;
...
void func_543(int iParam0)
{
	...
	if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_1))
	{
		if (!func_14(Local_96.f_2[iParam0 /*26*/].f_1))
		{
			...
			{
				vVar4 = {get_entity_coords(net_to_ped(Local_96.f_2[iParam0 /*26*/].f_1), 1)};
...
void func_545(int iParam0)
{
	...
	if (is_bit_set(Local_968[participant_id_to_int() /*14*/].f_13, iParam0))
	{
		return;
	}
	if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_1))
	...
	if (func_14(Local_96.f_2[iParam0 /*26*/].f_1))
	{
		set_bit(&(Local_968[participant_id_to_int() /*14*/].f_12), iParam0);
		return;
	}
	iVar0 = net_to_ped(Local_96.f_2[iParam0 /*26*/].f_1);
	vVar1 = {get_entity_coords(player_ped_id(), 0)};
	vVar4 = {get_entity_coords(iVar0, 0)};
	if (vdist2(vVar1, vVar4) < 5625f)
	{
		set_bit(&(Local_968[participant_id_to_int() /*14*/].f_13), iParam0);
		return;
	}
	if (is_ped_injured(player_ped_id()))
	{
	...
	while (iVar7 < 3)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_3[iVar7]))
		{
...
void func_546(int iParam0)
{
	...
	if (is_bit_set(Local_968[participant_id_to_int() /*14*/].f_12, iParam0))
	{
		return;
	}
	if (!network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_1))
	...
	while (iVar8 < 3)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iParam0 /*26*/].f_3[iVar8]))
		{
...
void func_551()
{
	...
	if (Local_96 != 4)
	{
		...
		if (network_is_player_active(iVar1))
		{
				...
				if (!func_510())
				{
					if (!func_572())
					{
						if (func_151(iVar1, 1))
						{
							...
							{
								if (!is_bit_set(Local_968[participant_id_to_int() /*14*/].f_8, iLocal_1420))
								{
									func_281(iVar1, 432, 1);
									func_276(iVar1, func_280(iLocal_1709), 1);
									set_bit(&(Local_968[participant_id_to_int() /*14*/].f_8), iLocal_1420);
								}
							}
						}
					}
			...
			else if (is_bit_set(Local_968[participant_id_to_int() /*14*/].f_8, iLocal_1420))
			{
				func_281(iVar1, 432, 0);
				func_276(iVar1, func_280(iLocal_1709), 0);
				clear_bit(&(Local_968[participant_id_to_int() /*14*/].f_8), iLocal_1420);
			}
		}
	}
	iLocal_1420++;
...
void func_555()
{
	...
	while (iVar1 < 4)
	{
		if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar1 /*26*/].f_1))
		{
			if (Local_96.f_2[iVar1 /*26*/] == 2)
			{
				if (func_43(iVar1))
				{
					...
					while (iVar2 < 3)
					{
						if (network_does_entity_exist_with_network_id(Local_96.f_2[iVar1 /*26*/].f_3[iVar2]))
						{
...
void func_586()
{
	...
	if (network_is_game_in_progress())
	{
		if (network_is_host_of_this_script())
		{
			...
			while (iVar3 < 5)
			{
				if (is_bit_set(Local_96.f_871, iVar3))
				{
...
void func_610()
{
	...
	iVar0 = get_relationship_between_groups(get_ped_relationship_group_hash(player_ped_id()), -1533126372);
	iVar1 = 0;
	while (iVar1 < 32)
	{
...
void func_615(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_587();
