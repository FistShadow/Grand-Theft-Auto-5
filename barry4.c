	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_254(iVar0 + 1));
			}
			iVar0++;
		}
	...
	if (func_299(uParam0))
	{
		...
		if (func_298(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_291(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(get_this_script_name(), "startup_positioning"))
				{
...
bool func_291(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_293(iParam0, uVar1[iVar6], 1) && func_292(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_287(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_294(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_254(iVar1 + 1));
			}
		}
