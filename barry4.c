...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_214(&uLocal_145, 1, player_ped_id(), "FRANKLIN", 0, 1);
...
bool func_248(int iParam0, int iParam1, auto uParam2)
{
	...
	*uParam2 = 0;
	...
	{
		if ((func_249(iParam0) && get_entity_model(iParam0) != joaat("sentinel2")) && get_entity_model(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				set_bit(uParam1.f_77, func_254(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_266(iParam0)) || func_265(iParam0)) || func_249(iParam0)) || func_264(iParam0)) || !func_256(get_entity_model(iParam0)))
	{
		if (func_265(iParam0))
		{
		}
...
bool func_273(int iParam0, auto uParam1, auto uParam2)
{
	...
	if (func_276(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_275(*iParam0, *uParam1[38] - 1))
	{
...
void func_279(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_88942[iVar0]) == func_280(iParam0, iParam1))
				{
...
void func_294(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(uParam1.f_77, func_254(iVar1 + 1));
			}
		}
