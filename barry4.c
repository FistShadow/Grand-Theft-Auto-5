...
void func_294(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_254(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_254(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_297(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_296())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_254(iVar2 + 1)))
				{
