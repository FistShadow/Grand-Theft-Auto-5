...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_214(&uLocal_145, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_202(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Global_2621441 = 0;
	return func_203(sParam3, iParam4, iParam8);
}
...
void func_213(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_214(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_223(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_308())
	{
...
void func_224(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_226(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_233(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_232(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_231(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_230(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_229(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_228(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_227(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_233(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_235(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_238(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_237(0)) || func_236(1))
			{
			}
			else
			{
...
void func_241(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_288(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		func_281(vParam1, 5f, 0);
		if (func_150(iParam12))
		{
			func_279(iParam12, 0);
			while (!func_242(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_242(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_243(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_248(*iParam1, 0, &uVar0))
		{
...
bool func_244(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_245(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_247(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_248(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_250(iVar0, iParam1, uParam2))
	{
		return false;
	}
	...
	{
		if ((func_249(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_250(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_254(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_266(iParam0)) || func_265(iParam0)) || func_249(iParam0)) || func_264(iParam0)) || !func_256(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_265(iParam0))
		{
		}
...
bool func_268(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_269(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_269(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_273(int iParam0, auto uParam1, auto uParam2)
{
	...
	if (func_276(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_275(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_275(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_274(*iParam0))
	{
...
void func_279(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_280(iParam0, iParam1))
				{
...
void func_281(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_288(Vector3 vParam0, Vector3 fParam1)
{
	return func_289(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_289(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_299(uParam0))
	{
		...
		if (func_298(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_291(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_291(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_293(iParam0, uVar1[iVar6], 1) && func_292(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_287(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_292(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_294(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_254(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_254(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_254(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_297(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_296())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_254(iVar2 + 1)))
				{
...
void func_310(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
bool func_328(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_334())
	{
		...
		{
			iVar33 = func_329(get_this_script_name());
			if (iVar33 > -1)
			{
