#region Local Var
	...
	char[24] cLocal_671 = 0;
	struct<6> Local_677 = 0;
	char[24] cLocal_683 = 0;
	...
	Vector3 vLocal_707 = 0;
	Vector3 vLocal_710 = 0;
	int iLocal_713 = 0;
	struct<8> Local_714 = 0;
#endregion
...
void main()
{
	...
	if (func_469())
	{
		...
		{
			case 0:
				if (is_this_model_a_plane(Global_95496.f_2311.f_12.f_66))
				{
				...
				func_426(vLocal_698, fLocal_458, 1, 0);
				iLocal_101 = 2;
				func_415(1, 0);
				break;
			...
			case 1:
				...
				func_426(vLocal_689, 254.9762f, 0, 0);
				func_415(4, 0);
				break;
	...
	else if (func_414(0))
	{
		...
		{
			func_412(PLAYER::PLAYER_PED_ID(), vLocal_698, fLocal_458, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_692 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
			func_401();
			func_400();
			switch (iLocal_98)
			{
	...
	if (func_21(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_98)
		{
					...
					if (iLocal_473 > 0)
					{
						...
						while (iVar0 <= iLocal_473 - 1)
						{
							if (func_21(Local_132[iVar0 /*20*/]))
							{
								...
								set_entity_health(Local_132[iVar0 /*20*/], false);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					func_412(Local_112.f_9, vLocal_689, 0f, 0, 0);
					if (!func_68())
					{
						func_412(PLAYER::PLAYER_PED_ID(), vLocal_689, 254.9762f, 0, 0);
						set_gameplay_cam_relative_heading(0f);
						set_gameplay_cam_relative_pitch(0f, 1f);
						if (iLocal_443 == 0)
						{
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_21(Local_385))
				{
					...
					func_104(Local_385, 0);
					if (!is_ambient_speech_playing(Local_385))
					{
						if (func_103(Local_385, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
							stop_ped_speaking(Local_385, 0);
							func_101(Local_385, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
				if (func_21(Local_385))
			...
			else
			{
				if (!iLocal_434)
				{
					...
					if (iLocal_102 == 4)
					{
						if (func_21(Local_385))
						{
							if (func_103(Local_385, vLocal_692, 35f))
							{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_21(Local_385))
					{
						if (!func_62(Local_385, 1805844857))
						{
							...
							{
								if (!is_entity_playing_anim(Local_385, func_100(), func_71(), 3))
								{
									func_70(&Local_385);
	...
	switch (iLocal_100)
	{
		case 0:
			...
			while (iVar0 <= iLocal_473 - 1)
			{
				if (func_21(Local_132[iVar0 /*20*/]))
				{
					PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0 /*20*/], iLocal_664);
...
void func_112(int iParam0)
{
	if (func_21(Local_132[iParam0 /*20*/]))
	{
		...
		set_ped_flee_attributes(Local_132[iParam0 /*20*/], 512, true);
		...
		task_look_at_entity(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		task_combat_ped(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
		set_blocking_of_non_temporary_events(Local_132[iParam0 /*20*/], false);
	...
	if (func_21(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				func_341(&vLocal_710, vLocal_707);
			...
			case 1:
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_314(Local_112.f_9, vLocal_692, iVar0, 0, 1, iLocal_478))
						{
							if ((func_111(iLocal_476, 5000) || func_163(vLocal_710, 0f, 0f, 0f, 0)) || (!func_57(vVar1, vLocal_710, 8.5f) && !func_57(vVar1, vLocal_707, 8.5f)))
							{
								func_313();
						...
						else
						{
							if (!iLocal_417)
							{
								if (!func_111(iLocal_463, 2500))
								{
									if (!func_60())
									{
										if (func_103(Local_112.f_9, vLocal_692, 30f))
										{
											if (func_72(&uLocal_499, sLocal_492, "BB2_J7", 4, 0, 0, 0))
											{
												iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_417 = 1;
											}
							...
							{
								if (func_111(iLocal_463, get_random_int_in_range(5000, 12000)))
								{
									if (func_103(Local_112.f_9, vLocal_692, 30f))
									{
										if (is_ped_fleeing(Local_112.f_9))
										{
											...
											else if (func_72(&uLocal_499, sLocal_492, "BB2_FLEE", 4, 0, 0, 0))
											{
												iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
											}
										}
							...
							func_310(Local_112.f_9, vLocal_692, iLocal_476, 925353388);
						}
					}
					else
					{
				...
				{
					func_313();
					if (!func_103(Local_112.f_9, vLocal_692, 10f))
					{
						if (!iLocal_437)
						{
...
void func_342()
{
	...
	if (func_21(Local_112.f_9))
	{
		if (iLocal_253 == 0)
		{
			func_353(&(Local_112.f_9), &iLocal_455);
			if (func_352())
			{
		...
		if (!is_ped_performing_stealth_kill(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_103(Local_112.f_9, vLocal_692, 20f))
					{
				...
				case 6:
					if (!func_103(Local_112.f_9, vLocal_692, 3.5f))
					{
				...
				case 15:
					...
					{
						if ((!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) && func_103(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_349(get_entity_heading(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) || is_ped_being_jacked(Local_112.f_9)) || !func_103(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) || !func_349(get_entity_heading(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
						...
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_344())
							{
								...
								if (!is_ped_in_vehicle(Local_112.f_9, iVar1, 0))
								{
									...
									if (fVar3 < 1.75f && func_103(Local_112.f_9, vLocal_692, 8f))
									{
				...
				case 23:
					if (func_347(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_346())
					{
						...
						{
							task_look_at_entity(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_343(Local_112.f_19, 10) && func_103(Local_112.f_9, vLocal_692, 50f)) || !func_111(iLocal_481, 2000))
							{
								if (is_ped_in_any_vehicle(Local_112.f_9, 1))
								{
									task_leave_any_vehicle(Local_112.f_9, 0, 0);
					...
					if (func_347(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_346())
					{
						if (!func_62(Local_112.f_9, -1519143300))
						{
							if (!func_62(Local_112.f_9, -875674219))
							{
								if (is_ped_in_any_vehicle(Local_112.f_9, 0))
								{
									if (!func_343(Local_112.f_19, 10) && func_103(Local_112.f_9, vLocal_692, 50f))
									{
										task_leave_any_vehicle(Local_112.f_9, 0, 0);
										Local_112.f_10 = 23;
									}
							...
							else if (!func_343(Local_112.f_19, 10) && func_103(Local_112.f_9, vLocal_692, 50f))
							{
...
bool func_347(int iParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5, int iParam6)
{
	...
	if (func_21(iParam0))
	{
		...
		if (func_103(iParam0, vLocal_692, fParam2))
		{
...
void func_363()
{
	if (func_57(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 100f))
	{
		if (!func_364())
		{
			request_cutscene(&Local_677, 8);
			func_64();
			iLocal_453 = 1;
		}
	}
	...
	{
		if (!func_57(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 120f))
		{
			if (has_cutscene_loaded())
			{
				remove_cutscene();
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					func_108(&(Local_112.f_8));
					if (!func_103(Local_112.f_9, vLocal_692, 25f))
					{
				...
				else if (func_103(Local_112.f_9, vLocal_692, 8f))
				{
					...
					if (!func_60())
					{
						if (Local_112.f_10 == 21 || Local_112.f_10 == 22)
						{
							...
							else if (func_72(&uLocal_499, sLocal_492, "BB2_J5", 4, 0, 0, 0))
							{
								iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
							}
						}
...
void func_366()
{
	...
	if (func_21(Local_112.f_9))
	{
		...
		if (!iLocal_421)
		{
			if (func_72(&uLocal_499, sLocal_492, "BB2_J6", 4, 0, 0, 0))
			{
				iLocal_421 = 1;
			}
		}
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (is_ped_in_any_vehicle(Local_112.f_9, 0) && get_vehicle_ped_is_in(Local_112.f_9, 0) == iVar0)
			{
						...
						if (get_entity_speed(iVar0) < 0.5f)
						{
							if (!iLocal_433)
							{
								if (!func_60())
								{
									...
									{
										if (func_72(&uLocal_499, sLocal_492, "BB2_STOP", 4, 0, 0, 0))
										{
											iLocal_433 = 1;
										}
									}
				...
				{
					if (func_72(&uLocal_499, sLocal_492, "BB2_J9", 4, 0, 0, 0))
					{
						iLocal_420 = 1;
					}
				}
			...
			if (is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_428)
				{
					...
					else if (!func_308("BBC_T8", 1) && !func_308("BB2_WTF", 1))
					{
						...
						else if (func_72(&uLocal_499, sLocal_492, "BB2_WTF", 4, iVar1, 0, 0))
						{
							iLocal_428 = 1;
						}
					}
				...
				else if (!iLocal_432)
				{
					if (func_367(&iVar0))
					{
						...
						{
							if (func_72(&uLocal_499, sLocal_492, "BB2_JACK", 4, iVar1, 0, 0))
							{
								iLocal_432 = 1;
							}
						}
			...
			else
			{
				...
				if (is_ped_in_any_vehicle(Local_112.f_9, 0))
				{
					if (!iLocal_429)
					{
						if (!func_308("BBC_T7", 1) && !func_308("BB2_OUT", 1))
						{
							...
							else if (func_72(&uLocal_499, sLocal_492, "BB2_OUT", 4, iVar1, 0, 0))
							{
								iLocal_429 = 1;
							}
						}
				...
				else if (Local_112.f_10 == 24 && func_62(Local_112.f_9, -1519143300))
				{
					if (func_103(Local_112.f_9, vLocal_692, 25f))
					{
						...
						{
							if (func_111(iLocal_464, get_random_int_in_range(2500, 5000)))
							{
								if (func_60())
								{
									func_3();
								}
								if (func_72(&uLocal_499, sLocal_492, "BB2_J10", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_60())
					{
						if (func_111(iLocal_463, get_random_int_in_range(3000, 6000)))
						{
							if (!func_103(Local_112.f_9, vLocal_692, 20f))
							{
								if (func_72(&uLocal_499, sLocal_492, "BB2_J4", 4, 0, 0, 0))
								{
									iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
								}
							}
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					{
						if (!does_blip_exist(iLocal_456))
						{
							if (iLocal_436)
							{
								iLocal_456 = func_375(vLocal_689, 5, 1);
							}
						}
						if (!iLocal_419)
						{
						...
						{
							func_366();
							func_373(&Local_385, vLocal_692, &iLocal_465, 5000, 1101004800);
						}
						if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_689, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_103(PLAYER::PLAYER_PED_ID(), vLocal_689, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_103(PLAYER::PLAYER_PED_ID(), vLocal_689, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
				...
				else
				{
					...
					if (func_103(Local_112.f_9, vLocal_692, 8f))
					{
						if (Local_112.f_10 == 25 || Local_112.f_10 == 26)
						{
							Local_112.f_18 = GAMEPLAY::GET_GAME_TIMER();
				...
				if (!iLocal_446)
				{
					iLocal_446 = func_371(vLocal_692, Local_103, 180f);
				}
				if (func_303(&(Local_112.f_9)))
				{
					iLocal_454 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!iLocal_446)
					{
						iLocal_446 = func_371(vLocal_692, Local_103, 0f);
					}
					func_122(4);
				}
				break;
...
bool func_371(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	int iVar0;
	
	if (!func_372(vParam0, vParam3, fParam6))
	{
...
int func_372(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	Vector3 vVar0;
...
bool func_373(int iParam0, Vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	Vector3 vVar0;
	auto uVar3;
	char* sVar168;
		...
		if (!func_60())
		{
			...
			if (vdist2(vParam1, vVar0) < fParam6 * fParam6)
			{
				if (GAMEPLAY::GET_GAME_TIMER() - *iParam4 > iParam5 + get_random_int_in_range(0, 2000))
				{
					...
					sVar168 = "BBCAUD";
					sVar169 = "BBC_loiter";
					func_374(&uVar3, sVar168, sVar169, 4, 0, 0);
					*iParam4 = GAMEPLAY::GET_GAME_TIMER();
					return true;
				}
			}
...
void func_374(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_314(Local_112.f_9, vLocal_692, iVar0, 0, 1, 170))
						{
							func_313();
							func_378(iLocal_473);
							Local_112.f_17 = GAMEPLAY::GET_GAME_TIMER();
					...
					else if ((iLocal_468 > 0 && func_103(Local_112.f_9, vLocal_692, 85f)) || get_entity_health(Local_112.f_9) < 200)
					{
						Local_112.f_10 = 13;
						Local_112.f_18 = GAMEPLAY::GET_GAME_TIMER() - 5000;
						iLocal_475 = GAMEPLAY::GET_GAME_TIMER();
					...
					{
						if (func_111(iLocal_463, get_random_int_in_range(3500, 7000)))
						{
							if (func_103(Local_112.f_9, vLocal_692, 30f))
							{
								if (get_random_int_in_range(0, 101) < 30)
								{
									if (func_72(&uLocal_499, sLocal_493, "BBC_T2", 4, 0, 0, 0))
									{
										iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
									}
								}
								else if (func_72(&uLocal_499, sLocal_492, "BB2_SHOOT", 4, 0, 0, 0))
								{
									iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
								}
							}
				...
				switch (iLocal_101)
				{
					case 2:
						...
						else
						{
							...
							if (func_103(Local_112.f_9, vLocal_692, 22f) && func_392(Local_112.f_9, vLocal_692, 10f))
							{
								...
								else if (func_103(Local_112.f_9, vLocal_692, 5f))
								{
									iLocal_101 = 0;
								}
								else if (func_391(&(Local_112.f_19)))
								{
									if (func_103(Local_112.f_9, vLocal_692, 22f - 1.5f))
									{
										iLocal_101 = 1;
										iLocal_430 = 0;
										if (Local_112.f_10 != 3 && Local_112.f_10 != 4)
					...
					case 1:
						if (!iLocal_430)
						{
							...
							if (func_72(&uLocal_499, sLocal_492, "BB2_J2", 4, 0, 0, 0))
							{
								Local_112.f_17 = GAMEPLAY::GET_GAME_TIMER();
								iLocal_463 = GAMEPLAY::GET_GAME_TIMER();
								iLocal_430 = 1;
...
void func_386()
{
	if (!iLocal_431)
	{
		if (!func_60())
		{
			if (func_103(Local_112.f_9, vLocal_692, 22f + 5f))
			{
				iLocal_457 = 0;
				if (is_message_being_displayed())
				{
				...
				if (is_string_null_or_empty(&cLocal_683))
				{
					if (func_72(&uLocal_499, sLocal_492, "BB2_AMB", 1, iLocal_457, 0, 0))
					{
						iLocal_431 = 1;
					}
				}
				else if (func_388(&uLocal_499, sLocal_492, "BB2_AMB", &cLocal_683, 1, iLocal_457, 0))
				{
					iLocal_431 = 1;
					StringCopy(&cLocal_683, "", 24);
				}
	...
	{
		if (!func_103(Local_112.f_9, vLocal_692, 22f + 10f))
		{
			cLocal_683 = {func_387()};
			if (!is_string_null_or_empty(&cLocal_683))
			{
...
bool func_388(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam5 == 0)
	{
		if (is_message_being_displayed())
...
int func_389(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_390(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4)
{
	if (func_413(iParam0))
	{
		if (!func_343(iParam1, 10))
		{
			if (iParam2)
			{
				if (!func_103(Local_112.f_9, vLocal_692, fParam3))
				{
					return false;
				}
				if (!func_392(iParam0, vLocal_692, fParam4))
				{
					return false;
				}
			}
...
void func_394(auto uParam0, auto uParam1)
{
	if (!*uParam0.f_7)
	{
...
void func_402()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_112.f_9))
	{
		if (!is_entity_dead(Local_112.f_9, 0) && !PED::IS_PED_INJURED(Local_112.f_9))
		{
			...
			{
				if (!func_103(Local_112.f_9, vLocal_692, 150f))
				{
					if (is_entity_occluded(Local_112.f_9))
					{
						iLocal_102 = 2;
			...
			{
				if (!func_103(Local_112.f_9, vLocal_692, 80f))
				{
					if (is_entity_occluded(Local_112.f_9))
					{
						iLocal_102 = 2;
...
bool func_405(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_407(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_409(int iParam0, float fParam1)
{
	...
	if (func_413(PLAYER::PLAYER_PED_ID()) && func_413(iParam0))
	{
		if (func_411(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
void func_412(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
...
void func_427(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_449(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_163(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_444(iParam12, 0);
			while (!func_428(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_428(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_429(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_81(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_433(*iParam1, 0, &uVar0))
		{
...
bool func_430(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_431(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_433(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_434(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_439(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_442(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_441(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_441(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_440(*iParam0))
	{
...
bool func_443(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_449(Vector3 vParam0, Vector3 fParam1)
{
	return func_450(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_450(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_460(uParam0))
	{
		...
		if (func_459(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_452(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_452(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_454(iParam0, uVar1[iVar6], 1) && func_453(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
bool func_453(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_455(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_458(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_457())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
...
bool func_464(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_470()
{
	...
	clear_area(Local_103, 15f, 0, 0, 0, false);
...
void func_471()
{
	...
	if (func_21(Local_112.f_9))
	{
		...
		Local_112.f_10 = 0;
		set_ped_component_variation(Local_112.f_9, false, 0, 0, 0);
		...
		open_sequence_task(&iLocal_484);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "idle_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		task_play_anim(false, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
	...
	while (iVar0 <= 5)
	{
		if (func_21(Local_132[iVar0 /*20*/]))
		{
			...
			{
				give_weapon_to_ped(Local_132[iVar0 /*20*/], Local_132[iVar0 /*20*/].f_5, -1, true, true);
			}
			...
			if (func_93(Local_254[0 /*6*/]))
			{
				...
				{
					set_ped_into_vehicle(Local_132[iVar0 /*20*/], Local_254[0 /*6*/], true);
				}
			}
			switch (iVar0)
			{
				case 0:
					set_ped_component_variation(Local_132[iVar0 /*20*/], false, 0, 2, 0);
				...
				case 1:
					set_ped_component_variation(Local_132[iVar0 /*20*/], false, 0, 3, 0);
				...
				case 2:
					set_ped_component_variation(Local_132[iVar0 /*20*/], false, 1, 1, 0);
				...
				case 3:
					set_ped_component_variation(Local_132[iVar0 /*20*/], false, 0, 0, 0);
			...
			if (iVar0 == 0)
			{
				...
				set_sequence_to_repeat(iLocal_484, 1);
				close_sequence_task(iLocal_484);
				task_perform_sequence(Local_132[iVar0 /*20*/], iLocal_484);
				clear_sequence_task(&iLocal_484);
				if (func_21(Local_132[iVar0 /*20*/]))
				{
...
bool func_474(auto uParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4, int iParam5)
{
	if (!does_pickup_exist(*uParam0))
	{
		if (func_54(iParam6))
...
bool func_475(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_54(iParam1))
...
Vector3 func_476(struct<5> Param0, auto uParam1, auto uParam2, auto uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_493()) || Global_100201) || Global_25122) || func_499()) || func_86(8, -1)) || func_498()) || func_497()) || func_491()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_493()) || Global_25122) || func_499()) || func_86(8, -1)) || func_491()) || func_498()) || func_497()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_493()) || Global_100201) || Global_25122) || func_499()) || func_86(8, -1)) || func_491()) || func_498()) || func_497()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_493()) || Global_100201) || Global_25122) || func_499()) || func_86(8, -1)) || func_498()) || func_497()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_493() || get_player_wanted_level(player_id()) > 0) || func_86(8, -1)) || func_492()) || func_496()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_493()) || Global_25122) || func_499()) || func_86(8, -1)) || func_497()) || func_491()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_493()) || func_497()) || Global_100201) || Global_25122) || func_499()) || Global_36839) || func_86(8, -1)) || func_491()) || func_496()) || func_492()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_493()) || Global_100201) || Global_25122) || func_499()) || func_86(8, -1)) || func_491()) || func_496()) || func_498()) || func_497()) || func_492())
						{
							return false;
						}
						break;
...
bool func_504(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_515())
	{
		...
		{
			iVar33 = func_505(get_this_script_name());
			if (iVar33 > -1)
			{
...
void func_506(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
