...
int func_6(vector3 vParam0, var uParam1, float fParam2, int iParam3)
{
	var uVar0;
	vector3 vVar1;
...
bool func_430(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_431(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_450(var uParam0, vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_474(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, int iParam5)
{
	if (!does_pickup_exist(*uParam0))
	{
		if (func_54(iParam6))
...
bool func_475(var uParam0, int iParam1, vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (!does_entity_exist(*uParam0))
	{
		if (func_54(iParam1))
...
Vector3 func_476(struct<5> Param0, var uParam1, var uParam2, var uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_507(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	*uParam0.f_4 = iParam5;
	*uParam0 = sParam1;
	*uParam0.f_1 = {Param2};
