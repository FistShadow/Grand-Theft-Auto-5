...
var func_154(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
var func_194(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
bool func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
bool func_264(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
