...
void main()
{
	...
	while (true)
	{
		...
		if (!func_195(&Var0, 1))
		{
			if (Var0 == 30)
			{
				if (func_194(player_ped_id(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
	...
	if (*uParam0 == 30)
	{
		if (func_182(*uParam0.f_28[0]))
		{
			if (iLocal_263)
			{
				if (!is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (func_154(player_ped_id(), *uParam0.f_28[0], 1) <= 15f)
					{
						func_284("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_154(player_ped_id(), *uParam0.f_28[0], 1) <= 10f)
				{
...
bool func_155(auto uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_194(player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), 0))
			{
			...
			else if ((!func_156(player_ped_id(), -828834893) && func_182(get_vehicle_ped_is_in(player_ped_id(), 0))) && func_132(get_vehicle_ped_is_in(player_ped_id(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
...
bool func_157(auto uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_194(player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), 0))
			{
			...
			else if ((!func_156(player_ped_id(), -828834893) && func_182(get_vehicle_ped_is_in(player_ped_id(), 0))) && func_132(get_vehicle_ped_is_in(player_ped_id(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_172()) || Global_100201) || Global_25122) || func_171()) || func_170(8, -1)) || func_77()) || func_169()) || func_168()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_172()) || Global_100201) || Global_25122) || func_171()) || func_170(8, -1)) || func_77()) || func_169()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (does_entity_exist(player_ped_id()))
						{
							if ((((((((((((((is_ped_in_combat(player_ped_id(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_172()) || Global_25122) || func_171()) || func_170(8, -1)) || func_169()) || func_168()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(player_ped_id())) || is_ped_in_any_vehicle(player_ped_id(), 1)) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_ped_swimming(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_172()) || Global_100201) || Global_25122) || func_171()) || func_170(8, -1)) || func_168()) || func_166()) || func_77()) || func_169()) || func_167())
						{
							return false;
						}
						break;
...
void func_173()
{
	...
	{
		case 0:
			if (get_game_timer() - iLocal_262 > 100 && iLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
		...
		case 1:
			if (func_194(player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_194(player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_127();
				iLocal_263 = true;
				iLocal_96 = 0;
...
bool func_183(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_182(player_ped_id()) && func_182(*iParam0.f_28[0])) && !func_129()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_194(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_203(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
{
	return func_208(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
