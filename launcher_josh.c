...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_266(&Var0, 1);
	}
	if (!func_263(&iVar64, &Var0, vVar61, 1f))
	{
		func_262();
	...
	while (true)
	{
		...
		if (!func_195(&Var0, 1))
		{
			if (Var0 == 30)
			{
				if (func_194(PLAYER::PLAYER_PED_ID(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_192(Var0);
		func_185(&iLocal_95, &(Var0.f_9), vVar61);
		if (Var0 == 27)
		{
			func_183(&Var0, vVar61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0 == 28)
		{
			func_183(&Var0, vVar61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 29)
		{
			func_183(&Var0, vVar61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 30)
		{
			if (iLocal_265 == 0)
			{
				if (_0xB56BBBCC2955D9CB())
				{
					if (func_182(Var0.f_28[1]))
					{
						...
						_0x2A56C06EBEF2B0D9("Cop_standing_idle", Var0.f_28[1], false);
					}
					if (func_182(Var0.f_28[2]))
					{
						func_284("Josh 4: Trying to set Cop 2 component variation");
						_0x2A56C06EBEF2B0D9("Cop_with_notepad", Var0.f_28[2], false);
					}
					iLocal_265 = 1;
				}
			}
	...
	if (*uParam0 == 30)
	{
		if (func_182(*uParam0.f_28[0]))
		{
			if (iLocal_263)
			{
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_154(PLAYER::PLAYER_PED_ID(), *uParam0.f_28[0], 1) <= 15f)
					{
						func_284("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_154(PLAYER::PLAYER_PED_ID(), *uParam0.f_28[0], 1) <= 10f)
				{
...
auto func_154(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_155(auto uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_194(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_156(PLAYER::PLAYER_PED_ID(), -828834893) && func_182(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && func_132(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
bool func_157(auto uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_194(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_156(PLAYER::PLAYER_PED_ID(), -828834893) && func_182(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && func_132(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
bool func_158(auto uParam0, int iParam1)
{
	switch (*uParam0.f_16)
	{
		case 0:
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_182(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
					{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_172()) || Global_100201) || Global_25122) || func_171()) || func_170(8, -1)) || func_77()) || func_169()) || func_168()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_172()) || Global_25122) || func_171()) || func_170(8, -1)) || func_168()) || func_77()) || func_169()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_172()) || Global_100201) || Global_25122) || func_171()) || func_170(8, -1)) || func_77()) || func_169()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_172() || get_player_wanted_level(player_id()) > 0) || func_170(8, -1)) || func_167()) || func_166()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_172()) || Global_25122) || func_171()) || func_170(8, -1)) || func_169()) || func_168()) || func_167()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
...
void func_173()
{
	...
	{
		case 0:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_262 > 100 && iLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
		...
		case 1:
			if (func_194(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_194(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_127();
				iLocal_263 = true;
				iLocal_96 = 0;
...
int func_174(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_183(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_182(PLAYER::PLAYER_PED_ID()) && func_182(*iParam0.f_28[0])) && !func_129()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_232(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
		func_184(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_184(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
auto func_194(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_195(auto uParam0, int iParam1)
{
	struct<27> Var0;
	...
	if (func_199(uParam0.f_48) && iParam1)
	{
...
void func_196(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_182(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_197(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_198(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_197(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_204(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_206(int iParam0, float fParam1)
{
	...
	if (func_182(PLAYER::PLAYER_PED_ID()) && func_182(iParam0))
	{
		if (func_217(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
int func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_209(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_209(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_212(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = {func_214(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
bool func_219(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_221(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_232(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_235(int iParam0, int iParam1)
{
	...
	func_236(iParam0, iLocal_93, vVar0, fVar3);
...
void func_236(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_237(iParam0);
...
bool func_240(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
...
bool func_241(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_247(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
bool func_248(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_246(&iVar0) || !has_anim_dict_loaded("rcmjosh3"))
			{
				return false;
			}
			iLocal_91 = 2;
...
{
	func_236(iParam0, iLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	set_vehicle_colour_combination(*iParam0, 4);
...
bool func_250(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_246(&iVar0) || !has_anim_dict_loaded("rcmjosh2"))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 3:
			if (func_182(*uParam0.f_28[0]))
			{
				...
				iLocal_94 = create_synchronized_scene(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				set_synchronized_scene_looped(iLocal_94, true);
				task_synchronized_scene(*uParam0.f_28[0], iLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1000f, 0);
			}
...
int func_257(int iParam0, char* sParam1)
{
...
bool func_263(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_264(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_264(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_264(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_265(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_265(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_266(int iParam0, int iParam1)
{
	...
	if (does_blip_exist(iLocal_264))
	{
		remove_blip(&iLocal_264);
	}
...
void func_273(auto uParam0, int iParam1, int iParam2, int iParam3)
{
