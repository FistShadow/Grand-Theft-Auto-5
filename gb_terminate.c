...
void func_1()
{
	switch (Local_98.f_8)
	{
		...
		case 2:
			if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, 5))
			{
				func_27(3);
			}
			func_25();
...
void func_2()
{
	if (!func_10(func_24()))
	{
		func_9(1);
		func_27(2);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), 2);
	}
	if (func_8() == func_7() || !func_6(func_8(), 0, 1))
	{
		func_9(3);
		func_27(2);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), 3);
	}
	if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, false))
	{
		if (func_3(&(Local_98.f_4), func_5(), 0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), 4);
		}
	}
	if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, 4))
	{
		func_9(2);
		func_27(2);
	}
	if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, true))
	{
		func_9(0);
		func_27(2);
	}
...
int func_11(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_1338622.f_241.f_136[func_13(10) /*33*/][iParam0], func_12(10));
}
...
void func_25()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_29() < 2)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, true))
			{
				func_26(int_to_playerindex(iVar2));
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), true);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, false))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), false);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, 2))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), 4);
			}
		}
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
	...
	if (func_29() == 2)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_98.f_1), 5);
		}
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_48(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_47(1);
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_54(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_48(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_47(1);
			}
...
void func_67()
{
	switch (func_443())
	{
		...
		case 1:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_96, 2))
			{
				func_425();
			}
			func_419();
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_108[participant_id_to_int() /*4*/].f_1, 3))
			{
				func_244(0, func_246());
				func_200();
				func_68();
...
void func_68()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_108[participant_id_to_int() /*4*/].f_1, 3))
	{
		if ((GAMEPLAY::IS_BIT_SET(Local_98.f_1, 2) || GAMEPLAY::IS_BIT_SET(Local_98.f_1, 4)) || GAMEPLAY::IS_BIT_SET(Local_98.f_1, 4))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), 3);
			return;
		}
		if (func_199())
		{
		...
		func_69(151, GAMEPLAY::IS_BIT_SET(Local_108[participant_id_to_int() /*4*/].f_1, true), &Var0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), 3);
	}
}

void func_69(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iVar1 > 0)
	{
		...
		func_135();
		func_85(0, PLAYER::PLAYER_PED_ID(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
	}
	if (iVar0 > 0)
	{
...
void func_74(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_75(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_82(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8)
{
	int iVar0;
...
void func_84(int iParam0, auto uParam1, auto uParam2)
{
...
void func_87(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_89(PLAYER::PLAYER_PED_ID()))
	{
		func_88(1);
	}
...
Vector3 func_90(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_91(PLAYER::PLAYER_PED_ID()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_95(Vector3 vParam0, auto uParam1, auto uParam2)
{
	Vector3 fVar0;
	float fVar1;
	float fVar2;
...
auto func_96(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	auto uVar0;
...
auto func_130(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
void func_136(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_158(int iParam0, auto uParam1, auto uParam2)
{
	struct<4> Var0;
...
auto func_168(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_189(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
void func_200()
{
	...
	if ((!GAMEPLAY::IS_BIT_SET(Local_98.f_1, 2) && !GAMEPLAY::IS_BIT_SET(Local_98.f_1, 4)) && !GAMEPLAY::IS_BIT_SET(Local_98.f_1, 3))
	{
	...
	else if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, 3))
	{
	}
	else
	{
		func_202(86, "GB_WORK_OVER", "GBTER_BIG_FLEE", 1, -1, 2);
		if (GAMEPLAY::IS_BIT_SET(Local_98.f_1, 4) || func_18(func_24(), 1, 0))
		{
...
void func_201(struct<2> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, int iParam13)
{
	Param0 = 0;
...
void func_210(auto uParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4)
{
	*uParam1.f_16 = func_7();
	*uParam1.f_17 = func_7();
	*uParam1.f_18 = func_7();
...
int func_211(int iParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7)
{
	struct<72> Var0;
...
int func_212(int iParam0, auto uParam1, auto uParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	struct<72> Var0;
...
void func_247(auto uParam0, int iParam1, int iParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	if (func_352() || iParam2 == 24)
	{
		...
		{
			func_311(1);
			if ((!func_310() && !func_309()) || GAMEPLAY::IS_BIT_SET(Global_2460486.f_4426, true))
			{
				if (func_308())
				{
					func_307();
...
void func_252(auto uParam0, auto uParam1, int iParam2)
{
	*uParam0.f_38[uParam1 /*2*/] = iParam2;
}

int func_253(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12)
{
	return network_is_handle_valid(&uParam0, 13);
}

auto func_254(auto uParam0, auto uParam1)
{
...
void func_262(char* sParam0, int iParam1, auto uParam2, int iParam3, char* sParam4, auto uParam5, auto uParam6, auto uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_270(int iParam0, auto uParam1, int iParam2, char* sParam3, auto uParam4, auto uParam5, auto uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, Vector3 fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_276(auto uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_280(iParam3))
	{
...
void func_288(auto uParam0, char* sParam1)
{
...
bool func_308()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4426, false) && func_214())
	{
		return true;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4426, true) && func_214())
	{
		return true;
	}
	return false;
...
bool func_312(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
...
void func_337(int iParam0, auto uParam1, int iParam2)
{
...
int func_355(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_274(iParam0) && !func_297(iParam0)) && !GAMEPLAY::IS_BIT_SET(Global_1610316[iParam0 /*174*/].f_1, 8));
...
void func_360(int iParam0, Vector3 vParam1, auto uParam2, float fParam3, float fParam4, int iParam5)
{
	Vector3 fVar0;
	float fVar1;
	
	if (((func_274(player_id()) && !func_297(player_id())) && !GAMEPLAY::IS_BIT_SET(Global_1610316[player_id() /*174*/].f_1, 8)) && (func_358(player_id()) || func_357(player_id())))
	{
		return;
	}
...
void func_391(int iParam0)
{
	...
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && is_entity_a_ped(Var0.f_1)) && get_ped_index_from_entity_index(Var0.f_1) == PLAYER::PLAYER_PED_ID())
		{
			if ((ENTITY::DOES_ENTITY_EXIST(Var0) && is_entity_a_ped(Var0)) && get_ped_index_from_entity_index(Var0) == get_player_ped(func_24()))
			{
				if (Var0.f_3)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), true);
				}
			}
		}
	}
...
void func_392()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_96, 3))
	{
		if (func_6(func_24(), 1, 1) && network_is_player_active(func_24()))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_96, 3);
		}
	}
}
...
void func_393(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2412879.f_367), iVar0);
			GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_372), iVar0);
			set_blip_flashes(Global_2412879[iVar0], 1);
			set_blip_flash_interval(Global_2412879[iVar0], 250);
			func_394(iParam0);
			if (iParam2 < 0)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2412879.f_372), iVar0);
			}
			else
			{
				Global_2412879.f_198[iVar0] = get_time_offset(NETWORK::GET_NETWORK_TIME(), iParam2);
			}
		}
		else
		{
	...
	if (!iParam1)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_367), iVar0);
		GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_372), iVar0);
...
void func_394(int iParam0)
{
	...
	if (func_6(iParam0, 0, 1))
	{
		if (does_blip_exist(Global_2412879[iVar0]))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Global_2412879.f_383, iVar0) || GAMEPLAY::IS_BIT_SET(Global_2412879.f_382, iVar0))
			{
				iVar2 = 1;
			}
			else if ((GAMEPLAY::IS_BIT_SET(Global_2412879.f_368, iVar0) || GAMEPLAY::IS_BIT_SET(Global_2412879.f_367, iVar0)) || GAMEPLAY::IS_BIT_SET(Global_2412879.f_385, iVar0))
			{
				iVar2 = func_397(10);
			}
			else
...
int func_399()
{
	...
	if (iVar0 > -1 && iVar0 < 4)
	{
		return GAMEPLAY::IS_BIT_SET(Global_1617379.f_80[iVar0 /*6968*/].f_3997, 4);
	}
	return false;
}
...
void func_400(int iParam0, char[8] cParam1, int iParam2)
{
	...
	if (!is_thread_active(Global_2412879.f_726) || Global_2412879.f_726 == get_id_of_this_thread())
	{
		if (iParam3)
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_2412879.f_392, iVar1))
			{
				iVar0 = true;
			}
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2412879.f_392), iVar1);
		...
		else
		{
			...
			GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_392), iVar1);
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_2412879.f_392, iParam0))
	{
		...
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_392), iParam0);
		}
	}
	return false;
}
...
void func_403(int iParam0, int iParam1)
{
	...
	if (!is_thread_active(Global_2412879.f_724) || Global_2412879.f_724 == get_id_of_this_thread())
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2412879.f_389), iVar0);
			Global_2412879.f_724 = get_id_of_this_thread();
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2412879.f_389), iVar0);
...
void func_409(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
int func_424(auto uParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !iParam1)
	{
		if (!iParam2)
...
void func_425()
{
	...
	if (player_id() != func_153())
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_96, false))
		{
			if (!func_214())
			{
				func_427("GBTER_START", get_player_name(func_24()), 0, -1);
				func_426(1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_96, 2);
			}
		}
		else
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), false);
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(iLocal_96, false))
	{
		if (!func_214())
		{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_96, false);
}
...
bool func_457(int iParam0, auto uParam1)
{
...
void func_460(int iParam0)
{
	...
	if (Global_1610316[player_id() /*174*/].f_10.f_28 != -1)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_1573883.f_1, 14) && !func_274(player_id()))
		{
			func_375(0);
		}
	}
...
bool func_463(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
...
bool func_473(auto uParam0, int iParam1)
{
