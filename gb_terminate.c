...
void func_25()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_29() < 2)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, true))
			{
				...
				GAMEPLAY::SET_BIT(&(Local_98.f_1), true);
			}
			if (GAMEPLAY::IS_BIT_SET(Local_108[iVar2 /*4*/].f_1, false))
			{
				GAMEPLAY::SET_BIT(&(Local_98.f_1), false);
			}
	...
	if (func_29() == 2)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_98.f_1), 5);
		}
...
void func_68()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_108[participant_id_to_int() /*4*/].f_1, 3))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), 3);
			return;
		}
		if (func_199())
		{
...
int func_175(int iParam0)
{
	...
	if (func_182(iParam0))
	{
		...
		if (iVar1 < func_176(iParam0))
		{
			...
			{
				iVar0 += func_180(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
...
void func_377(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_378())
	{
		return;
	}
	...
	if (get_event_data(1, iParam0, &Var0, 10))
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && is_entity_a_ped(Var0.f_1)) && get_ped_index_from_entity_index(Var0.f_1) == PLAYER::PLAYER_PED_ID())
		{
			if ((ENTITY::DOES_ENTITY_EXIST(Var0) && is_entity_a_ped(Var0)) && get_ped_index_from_entity_index(Var0) == get_player_ped(func_24()))
			{
				if (Var0.f_3)
				{
					GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), true);
				}
			}
		}
	}
...
void func_393(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_2412879.f_367), iVar0);
			...
			if (iParam2 < 0)
			{
				GAMEPLAY::SET_BIT(&(Global_2412879.f_372), iVar0);
			}
			else
			{
...
void func_400(int iParam0, char[8] cParam1, int iParam2)
{
	...
	if (!is_thread_active(Global_2412879.f_726) || Global_2412879.f_726 == get_id_of_this_thread())
	{
		if (iParam3)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2412879.f_392), iVar1);
...
void func_403(int iParam0, int iParam1)
{
	...
	if (!is_thread_active(Global_2412879.f_724) || Global_2412879.f_724 == get_id_of_this_thread())
	{
		if (iParam1)
		{
			GAMEPLAY::SET_BIT(&(Global_2412879.f_389), iVar0);
...
void func_425()
{
	...
	if (player_id() != func_153())
	{
		...
		else
		{
			...
			GAMEPLAY::SET_BIT(&(Local_108[participant_id_to_int() /*4*/].f_1), false);
		}
	}
	...
	GAMEPLAY::SET_BIT(&iLocal_96, false);
}
