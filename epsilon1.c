#region Local Var
	...
	auto uLocal_316 = 0;
	auto uLocal_317 = 0;
	Vector3 vLocal_318 = 0;
	Vector3 vLocal_321 = 0;
	float fLocal_324 = 0;
	int iLocal_325 = 0;
	int iLocal_326 = 0;
	int iLocal_327 = 0;
...
void func_5()
{
	...
	if (func_212(PLAYER::PLAYER_PED_ID()))
	{
		set_ped_reset_flag(PLAYER::PLAYER_PED_ID(), 334, true);
	}
...
bool func_8(struct<9> Param0, auto uParam1)
{
	if (Param0.f_8 == 0)
	{
		return false;
...
int func_12(struct<4> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, struct<4> Param7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	int iVar0;
	int iVar1;
...
struct<10> func_14(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8, auto uParam9)
{
	struct<10> Var0;
...
void func_20()
{
	...
	{
		func_6(13, floor(Global_101154.f_8884.f_3853));
	}
...
bool func_45(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_159(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_51(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_56(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar0 = func_65(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar1 = func_65(iParam0, iParam2, 1, 4);
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_65(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
void func_78(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_82(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_81(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_79(uVar2, iVar3, iVar0, 1);
	}
}

void func_79(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_80(iParam2)];
	if (iVar0 != 0)
	{
...
int func_81(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_80(iParam1)];
...
int func_82(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_83(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_159(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!_is_dlc_data_empty(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						*iParam0[vVar16.z] = func_73(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_92(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_92(vVar16.z)] = func_73(iParam1, vVar16.x, func_92(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_92(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_97(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_103(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_81(func_100(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			{
				iVar0 = func_81(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_98(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_101(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_165()
{
	...
	{
		if (func_161(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_170(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_171(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}

void func_171(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_172(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_176()
{
	...
	{
		func_165();
		_0xBF59707B3E5ED531(func_177(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		...
		func_195(iParam0, iParam3, iParam4, 0);
...
int func_210()
{
	return func_211(get_this_script_name(), 0);
}
...
void func_213()
{
	...
	switch (iLocal_145)
	{
		case 0:
			...
			func_235(PLAYER::PLAYER_PED_ID(), vLocal_318, 201.2074f, 0, 1);
			if (!is_new_load_scene_active())
			{
				_new_load_scene_start_safe(vLocal_318, 100f, 1);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_150))
			{
				iLocal_150 = create_vehicle(iLocal_149, 1970.362f, 2859.594f, 49.2307f, 151.6095f, 1, 1);
			}
			if (func_212(iLocal_147))
			{
				set_ped_can_be_targetted(iLocal_147, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_147, 1862763509);
				set_ped_keep_task(iLocal_147, true);
				if (func_212(iLocal_150))
				{
					set_vehicle_colours(iLocal_150, false, false);
					set_vehicle_extra_colours(iLocal_150, false, false);
					set_vehicle_on_ground_properly(iLocal_150);
					set_vehicle_number_plate_text_index(iLocal_150, false);
					task_warp_ped_into_vehicle(iLocal_147, iLocal_150, -1);
					set_vehicle_doors_locked(iLocal_150, 3);
					set_vehicle_engine_on(iLocal_150, true, 1, 0);
				}
			}
			if (func_212(PLAYER::PLAYER_PED_ID()))
			{
				task_play_anim(PLAYER::PLAYER_PED_ID(), sLocal_152, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 1:
			if (is_new_load_scene_active())
			{
				...
				{
					new_load_scene_stop();
					iLocal_330 = create_camera_with_params(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
					set_cam_active(iLocal_330, true);
					iLocal_331 = create_camera_with_params(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
				...
				if (func_212(iLocal_150))
				{
					if (func_233(iLocal_147, iLocal_150, -1))
					{
						if (iLocal_329)
						{
							if (!iLocal_326)
							{
								iLocal_326 = func_221(&uLocal_153, "EPS1AU", "EPS1_CAR", 8, 0, 0, 0);
							}
							else if (!func_220())
							{
								task_vehicle_drive_wander(iLocal_147, iLocal_150, fLocal_324, 786599);
								func_216(PLAYER::PLAYER_PED_ID(), 30000, 0);
								_0xC819F3CBB62BF692(0, 0f, 3, 0);
								set_cam_active(iLocal_331, false);
								func_237(0);
								iLocal_145 = 2;
							}
							else if (timera() > 10000)
							{
								if (!is_cam_active(iLocal_331))
								{
									set_cam_active(iLocal_331, true);
									set_cam_active(iLocal_330, false);
									set_cam_params(iLocal_331, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
								}
							}
						}
						else if (func_212(PLAYER::PLAYER_PED_ID()))
						{
							if (get_script_task_status(PLAYER::PLAYER_PED_ID(), -2017877118) == 1)
							{
								set_ped_to_ragdoll(PLAYER::PLAYER_PED_ID(), 16000, 16000, 0, 1, 1, 0);
								apply_force_to_entity(PLAYER::PLAYER_PED_ID(), 2, 0f, -5f, 2f, 0f, 0.5f, 0f, 3, 1, 1, 1, 0, 1);
								iLocal_329 = 1;
								wait(1000);
								settimera(0);
								func_215(2000, 0);
								set_cam_params(iLocal_330, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
							}
						}
					}
					else
...
int func_221(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_232(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
int func_235(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_236()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147))
	{
		iLocal_147 = PED::CREATE_PED(26, iLocal_148, vLocal_321, 0, 1, true);
	}
	if (func_212(iLocal_147))
	{
		set_entity_only_damaged_by_player(iLocal_147, true);
		set_blocking_of_non_temporary_events(iLocal_147, true);
		set_ped_keep_task(iLocal_147, true);
	}
}
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (func_272(1, 1093140480, 0))
			{
				...
				clear_area_of_vehicles(-1630.38f, 4200.79f, 83.01f, 70f, 0, 0, 0, 0, false);
				iLocal_145 = 1;
			}
			break;
...
void func_244(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_248(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_252(player_id())) && !func_250(player_id(), 0)) && !func_249())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_252(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_254(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_259(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_260(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_262(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_263(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_263(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_265(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_266(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_266(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_267(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_269(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
...
bool func_268(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_281()
{
	...
	switch (iLocal_145)
	{
		...
		case 1:
			if (!iLocal_328)
			{
				iLocal_328 = func_221(&uLocal_153, "EPS1AU", "EPS1_TRUCK", 8, 0, 0, 0);
			}
			else if (!func_220())
			{
				if (timerb() > 1000)
...
void func_282()
{
	...
	request_additional_text("EPS1", false);
	request_anim_dict(sLocal_152);
	while (((!has_anim_dict_loaded(sLocal_152) || !has_additional_text_loaded(false)) || !STREAMING::HAS_MODEL_LOADED(iLocal_149)) || !STREAMING::HAS_MODEL_LOADED(iLocal_148))
	{
		wait(0);
	}
	set_wanted_level_multiplier(0.1f);
	_0xF92099527DB8E2A7(128, 0);
	func_234(&uLocal_153, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	if (func_212(PLAYER::PLAYER_PED_ID()))
	{
...
void func_284(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_288(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_285(Var9.f_1)) && iVar70 < 50)
			{
...
int func_287(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_300(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	...
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_240(0)) || func_301(1))
			{
			}
			else
			{
...
void func_307(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_308(iParam0);
...
void func_312()
{
	...
	if (func_331())
	{
		...
		if (func_212(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_323(PLAYER::PLAYER_PED_ID(), 1, 0);
		}
		if (func_212(get_players_last_vehicle()))
		{
...
void func_313(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_323(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_162(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		func_324(iParam0, &(Global_101154.f_1826.f_539.f_298[iVar0 /*284*/]), iParam1);
		iVar1 = 0;
		while (iVar1 <= 8 - 1)
		{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < get_num_dlc_weapons())
			{
				...
				{
					if (!_is_dlc_data_empty(Var9) && !func_285(Var9.f_1))
					{
						if (iVar7 == 0)
						{
...
int func_325(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_railgun"):
			if (!func_326() || NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				return false;
			}
			break;
	...
	while (iVar0 < get_num_dlc_weapons())
	{
		if (get_dlc_weapon_data(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (_is_dlc_data_empty(Var1) || func_285(Var1.f_1))
				{
					return false;
				}
			}
...
bool func_334(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_340())
	{
		...
		{
			iVar33 = func_335(get_this_script_name());
			if (iVar33 > -1)
			{
