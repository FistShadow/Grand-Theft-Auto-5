							...
							if (func_68() || ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[0]))
								{
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_91[0], 0))
									{
										...
										AI::CLEAR_PED_TASKS(iLocal_91[0]);
										AI::TASK_SMART_FLEE_PED(iLocal_91[0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
								...
								if (func_68() || ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[1]))
									{
										if (!PED::IS_PED_INJURED(iLocal_91[1]))
										{
											...
											AI::CLEAR_PED_TASKS(iLocal_91[1]);
											AI::TASK_SMART_FLEE_PED(iLocal_91[1], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
...
void func_1()
{
	if (((iLocal_54 == 1 && iLocal_55 == 7) && iLocal_64 == 5) && iLocal_110)
	{
		...
		if (func_2())
		{
			...
			{
				vLocal_160 = {get_entity_speed_vector(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)};
			}
		}
	}
}
		...
		if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			if (iLocal_54 == 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_91[0]))
					{
						if (is_ped_in_vehicle(iLocal_91[0], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							return true;
						}
					}
			...
			if (iLocal_54 == 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_91[1]))
				{
					...
					{
						if (is_ped_in_vehicle(iLocal_91[0], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) && is_ped_in_vehicle(iLocal_91[1], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							return true;
						}
					}
...
bool func_3()
{
	if (iLocal_54 == 2)
	{
		...
		{
			if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_94, 200f, 200f, 200f, 0, 1, 0))
			{
				return true;
			}
			...
			if (has_entity_been_damaged_by_weapon(iLocal_94, false, 2) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_94, PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_91[0]))
				{
					AI::CLEAR_PED_TASKS(iLocal_91[0]);
...
bool func_68()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_91[0]))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_91[0], PLAYER::PLAYER_PED_ID(), 1) || is_entity_in_water(iLocal_91[0]))
		{
			return true;
		}
		if (!ENTITY::IS_ENTITY_DEAD(get_players_last_vehicle(), 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_91[0], get_players_last_vehicle(), 1))
			{
				return true;
			}
		}
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			...
			{
				if (_0x6CD5A433374D4CFB(iLocal_91[0], PLAYER::PLAYER_PED_ID()))
				{
					return true;
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[1]))
	{
		if (!PED::IS_PED_INJURED(iLocal_91[1]))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(get_players_last_vehicle(), 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_91[1], get_players_last_vehicle(), 1))
				{
					return true;
				}
			}
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				...
				{
					if (_0x6CD5A433374D4CFB(iLocal_91[1], PLAYER::PLAYER_PED_ID()))
					{
						return true;
					}
				}
...
void func_70()
{
	...
	switch (iLocal_55)
	{
		case 0:
			if (iLocal_54 == 1)
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1017.461f, -1259.868f, 3.9183f, -1061.891f, -1424.029f, 24.4253f, 171.75f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_152, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_152, 15f, 15f, 15f, false, true, 0))
				{
					...
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1011.144f, -1378.79f, 4.1997f, -1039.685f, -1337.61f, 9.7035f, 37.875f, 0, true, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_91[0]) && !PED::IS_PED_INJURED(iLocal_91[1]))
						{
							func_144();
							AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_1", "drunk_argument_dd1", 2f, -2f, -1, 0, 0, 0, 0, 0);
							AI::TASK_PLAY_ANIM(iLocal_91[1], "random@drunk_driver_1", "drunk_argument_dd2", 2f, -2f, -1, 0, 0, 0, 0, 0);
			...
			if (iLocal_54 == 2)
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1820.238f, 3671.948f, 30.8437f, 1957.818f, 3751.887f, 55.4436f, 159.9375f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_152, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_152, 15f, 15f, 15f, false, true, 0))
				{
					func_143();
					if (!func_186())
					{
					...
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1877.761f, 3727.7f, 31.882f, 1896.962f, 3693.83f, 34.9925f, 19.1875f, 0, true, 0))
					{
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iLocal_91[0]))
			{
				if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 8f, 8f, 4f, 0, 1, 0))
				{
					if (is_ped_facing_ped(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 80f))
					{
						iLocal_121 = true;
						settimera(false);
						iLocal_55 = 4;
				...
				else if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 30f, 30f, 30f, 0, 1, 0))
				{
		...
		case 3:
			...
			if (iLocal_54 == 2)
			{
				if (!PED::IS_PED_INJURED(iLocal_91[0]))
				{
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 30f, 30f, 30f, 0, 1, 0))
					{
						func_142();
						if (func_141())
						{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_68, 15f, 15f, 15f, false, true, 0) && !is_ped_trying_to_enter_a_locked_vehicle(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(iLocal_91[0]))
					{
						if (is_ped_facing_ped(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 80f))
						{
							if (_0x6CD5A433374D4CFB(iLocal_91[0], PLAYER::PLAYER_PED_ID()))
							{
								...
								{
									open_sequence_task(&iLocal_99);
									task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
									AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "exit_1", 8f, -8f, -1, 0, 0, 0, 0, 0);
								...
								if (!PED::IS_PED_INJURED(iLocal_91[1]))
								{
									task_look_at_entity(iLocal_91[1], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								}
								settimera(false);
								iLocal_55 = 4;
							}
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1889.121f, 3715.057f, 31.844f, 1895.608f, 3703.586f, 34.8272f, 12.4375f, 0, true, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_91[0]))
					{
						open_sequence_task(&iLocal_99);
				...
				{
					if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_94, 1.5f, 1.5f, 5f, 0, 1, 0) && is_ped_trying_to_enter_a_locked_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						if (func_141())
						{
							func_56(0);
						...
						if (func_61(&uLocal_173, "REDR2AU", "REDR2_TRY", 4, 0, 0, 0))
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_91[0]))
							{
								AI::CLEAR_PED_TASKS_immediately(iLocal_91[0]);
							}
							iLocal_55 = 4;
						}
					}
			...
			if (iLocal_54 == 1)
			{
				switch (iLocal_170)
				{
					case 0:
						if (!PED::IS_PED_INJURED(iLocal_91[0]) && !PED::IS_PED_INJURED(iLocal_91[1]))
						{
							if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 8f, 8f, 4f, 0, 1, 0) || iLocal_121)
							{
								_0xB542DE8C3D1CB210(0);
								task_look_at_entity(iLocal_91[0], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								task_look_at_entity(iLocal_91[1], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], -1, 2060, 4);
								if (GAMEPLAY::GET_GAME_TIMER() + 50000 > iLocal_123 || is_player_pressing_horn(player_id()))
								{
									func_6();
									if (iLocal_121)
									{
					...
					case 1:
						if (!func_4())
						{
							if (func_138())
							{
								...
								{
									open_sequence_task(&iLocal_99);
									AI::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_breakout_dd1", 2f, -2f, -1, 0, 0, 0, 0, 0);
									...
									{
										open_sequence_task(&iLocal_99);
										AI::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_breakout_dd2", 2f, -2f, -1, 0, 0, 0, 0, 0);
										task_turn_ped_to_face_entity(false, iLocal_91[0], false);
							...
							else
							{
								if (!PED::IS_PED_INJURED(iLocal_91[0]))
								{
									if (is_ped_facing_ped(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 80f))
									{
										task_look_at_entity(iLocal_91[0], PLAYER::PLAYER_PED_ID(), 10000, 2060, 4);
										task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 10000, 2060, 4);
										func_6();
										wait(false);
										iLocal_170++;
									}
					...
					case 3:
						if (!iLocal_104)
						{
							if (timera() > 1500)
							{
								...
								{
									open_sequence_task(&iLocal_99);
									task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), 10000, 2060, 4);
									task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
					...
					case 5:
						if (func_138())
						{
							...
							if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
							{
								if (get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0) != iLocal_94)
								{
									if (!func_4())
									{
										if (func_17() == 0)
			...
			if (iLocal_54 == 2)
			{
				switch (iLocal_170)
				{
					case 0:
						if (!PED::IS_PED_INJURED(iLocal_91[0]) && !PED::IS_PED_INJURED(iLocal_91[1]))
						{
							if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 10f, 10f, 10f, 0, 1, 0))
							{
								if (is_ped_facing_ped(iLocal_91[0], PLAYER::PLAYER_PED_ID(), 50f))
								{
									task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], -1, 2060, 4);
									task_look_at_entity(iLocal_91[0], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
									task_look_at_entity(iLocal_91[1], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
					...
					case 2:
						...
						if (!func_4())
						{
							if (!PED::IS_PED_INJURED(iLocal_91[0]))
							{
								if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 20f, 20f, 20f, 0, 1, 0) && timera() > 9500)
								{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
						{
							if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_94, 1))
							{
								iLocal_55 = 7;
							}
						}
						...
						if (func_61(&uLocal_173, "REDR1AU", "REDR1_FU", 4, 0, 0, 0))
						{
							if (is_vehicle_driveable(iLocal_94, 0) && !is_vehicle_stuck_on_roof(iLocal_94))
							{
								if (!PED::IS_PED_INJURED(iLocal_91[0]))
								{
									...
									else if (get_ped_in_vehicle_seat(iLocal_94, -1) == PLAYER::PLAYER_PED_ID())
									{
										iLocal_55 = 7;
									}
									else
			...
			if (iLocal_54 == 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_91[0]))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
					{
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iLocal_91[0], 355471868) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_91[0], 355471868) != 0)
							{
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_91[0]))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_91[0], 242628503) == 1)
				{
		...
		case 7:
			if (iLocal_54 == 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_91[1]))
				{
					if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[1], 50f, 50f, 50f, 0, 1, 0))
					{
						...
						if (timera() > 1000)
						{
							if (!PED::IS_PED_INJURED(iLocal_91[0]))
							{
								if (func_138())
								{
									...
									{
										fLocal_164 = func_134(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 1);
										iLocal_64++;
									}
								}
								else if (!iLocal_119)
					...
					case 2:
						...
						if (!PED::IS_PED_INJURED(iLocal_91[0]))
						{
							if (func_138())
							{
								if (!iLocal_118)
								{
									if (func_134(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 1) > fLocal_164 + 5f)
									{
						...
						if (!PED::IS_PED_INJURED(iLocal_91[0]))
						{
							if (func_134(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 1) > 50f)
							{
								func_60();
							}
						}
			...
			if (iLocal_54 == 2)
			{
				switch (iLocal_64)
				{
					...
					case 5:
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_94, 0))
						{
							if ((!PED::IS_PED_INJURED(iLocal_91[0]) && !PED::IS_PED_INJURED(iLocal_91[1])) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_94, 0))
							{
...
void func_71()
{
	switch (iLocal_126)
	{
		case 0:
			...
			{
				remove_ped_from_group(iLocal_91[0]);
				task_look_at_entity(iLocal_91[1], PLAYER::PLAYER_PED_ID(), 10000, 2060, 4);
			}
...
void func_76(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_78() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_78() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_80(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_78() /*10375*/].f_7704.f_10, iParam0);
}
				...
				if (is_vehicle_stopped(iLocal_94))
				{
					if (is_vehicle_driveable(iLocal_94, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_91[0]))
						{
							AI::CLEAR_PED_TASKS(iLocal_91[0]);
							remove_ped_from_group(iLocal_91[0]);
							task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 4000, 2060, 4);
						}
						if (!PED::IS_PED_INJURED(iLocal_91[1]))
						{
							AI::CLEAR_PED_TASKS(iLocal_91[1]);
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_106(player_id())) && !func_104(player_id(), 0)) && !func_103())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_106(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
	...
	switch (iLocal_126)
	{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_91[0]))
			{
				open_sequence_task(&iLocal_99);
				task_leave_any_vehicle(false, false, 0);
				task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 1800);
				task_follow_nav_mesh_to_coord(false, vLocal_84, 1f, -1, 0.25f, 0, 1193033728);
				AI::TASK_PLAY_ANIM(false, "random@drunk_driver_1", "drunk_fall_over", 2f, -2f, -1, 2359304, 0, 0, 0, 0);
				close_sequence_task(iLocal_99);
				task_perform_sequence(iLocal_91[0], iLocal_99);
				clear_sequence_task(&iLocal_99);
				set_ped_keep_task(iLocal_91[0], true);
...
void func_114()
{
	...
	if ((is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_enter_m", 3) || is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3)) || is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 3))
	{
		iVar0 = 0;
		...
		if ((((((((func_119(64) || CONTROLS::IS_CONTROL_PRESSED(0, 86)) || CONTROLS::IS_CONTROL_PRESSED(0, 71)) || CONTROLS::IS_CONTROL_PRESSED(0, 72)) || CONTROLS::IS_CONTROL_PRESSED(0, 76)) || CONTROLS::IS_CONTROL_PRESSED(0, 73)) || CONTROLS::IS_CONTROL_PRESSED(0, 68)) || CONTROLS::IS_CONTROL_PRESSED(0, 75)) || iVar0)
		{
	...
	switch (iLocal_346)
	{
		case 0:
			if (func_118())
			{
				...
				{
					open_sequence_task(&iLocal_99);
					AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_intro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
					close_sequence_task(iLocal_99);
					task_perform_sequence(iLocal_91[0], iLocal_99);
					clear_sequence_task(&iLocal_99);
					open_sequence_task(&iLocal_99);
					AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_intro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "cardrunkflirt_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
					close_sequence_task(iLocal_99);
					task_perform_sequence(iLocal_91[1], iLocal_99);
					clear_sequence_task(&iLocal_99);
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_347 > 15000)
			{
				if (func_118())
				{
					AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_intro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(iLocal_91[1], "random@drunk_driver_2", "cardrunksex_intro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_346++;
				}
			}
			break;
		...
		case 4:
			if (func_118())
			{
				...
				if (is_entity_playing_anim(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_intro_m", 3))
				{
					...
					{
						AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(iLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
						iLocal_347 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_346++;
					}
				}
		...
		case 5:
			if (func_118())
			{
				func_116();
				func_115();
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), get_vehicle_ped_is_in(iLocal_91[1], 0), 0))
				{
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_347 > 15000)
					{
						iVar3 = false;
						...
						{
							open_sequence_task(&iLocal_99);
							AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "driver_enter_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							AI::TASK_PLAY_ANIM(false, "random@drunk_driver_2", "driver_idle_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
							close_sequence_task(iLocal_99);
							task_perform_sequence(PLAYER::PLAYER_PED_ID(), iLocal_99);
							clear_sequence_task(&iLocal_99);
						}
						if (func_17() == 0)
						{
			...
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_347 > 5000 && func_118())
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), get_vehicle_ped_is_in(iLocal_91[1], 0), 0))
				{
					if (is_entity_playing_anim(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m", 3))
					{
						...
						{
							if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3))
							{
								AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							}
							AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							AI::TASK_PLAY_ANIM(iLocal_91[1], "random@drunk_driver_2", "cardrunksex_outro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
							iLocal_346++;
						}
					}
				}
		...
		case 7:
			...
			if (func_118())
			{
				if (is_entity_playing_anim(iLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
				{
					...
					{
						ENTITY::APPLY_FORCE_TO_ENTITY(get_vehicle_ped_is_in(iLocal_91[0], 0), 0, 0f, 0f, 20f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						iLocal_347 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_346++;
					}
				}
	...
	if (!PED::IS_PED_INJURED(iLocal_91[1]))
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(iLocal_91[0], 0), 0))
		{
			if (is_entity_playing_anim(iLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f", 3))
			{
				...
				{
					ENTITY::APPLY_FORCE_TO_ENTITY(get_vehicle_ped_is_in(iLocal_91[0], 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
...
void func_122()
{
	...
	else if ((iLocal_108 && !iLocal_132) && iLocal_149 < GAMEPLAY::GET_GAME_TIMER())
	{
		if (!func_4())
		{
...
void func_123()
{
	...
	{
		if ((get_time_since_player_hit_vehicle(player_id()) > 0 && get_time_since_player_hit_vehicle(player_id()) < 100) || has_entity_collided_with_anything(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
		{
...
void func_124(Vector3 vParam0, int iParam1)
{
	...
	if (func_2())
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			vVar0 = {get_entity_speed_vector(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)};
		}
	}
	vVar3 = {vVar0 - vParam0};
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!is_vehicle_on_all_wheels(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) && !func_27("REDR1_SWV"))
			{
				if (iLocal_165 == -1)
				{
		...
		switch (iLocal_111)
		{
			...
			case 1:
				if (timerb() > 3000 || !func_4())
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_91[0]);
						AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_1", sLocal_114, 8f, -8f, -1, 0, 0, 0, 0, 0);
						iLocal_111++;
					}
				}
				break;
			...
			case 3:
				...
				{
					AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_1", sLocal_113, 2f, -4f, -1, 1, 0, 0, 0, 0);
					iLocal_105 = 0;
					iLocal_111++;
				}
				break;
...
void func_128()
{
	if (iLocal_54 == 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_91[0]))
		{
			if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 150f, 150f, 150f, 0, 1, 0))
			{
				func_60();
			}
			if (func_138() || is_ped_on_foot(PLAYER::PLAYER_PED_ID()))
			{
				if (!is_ped_in_group(iLocal_91[0]))
				{
					set_ped_as_group_member(iLocal_91[0], func_57());
			...
			if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 8f, 8f, 8f, 0, 1, 0) || is_ped_in_any_taxi(PLAYER::PLAYER_PED_ID()))
			{
				if (does_blip_exist(uLocal_155[0]))
				{
					remove_blip(&(uLocal_155[0]));
	...
	if (iLocal_54 == 2)
	{
		...
		{
			if (!is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[0], 150f, 150f, 150f, 0, 1, 0) || !is_entity_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_91[1], 150f, 150f, 150f, 0, 1, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_91[0]))
			...
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_94, 0))
			{
...
int func_131(Vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_132(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	...
	if (!PED::IS_PED_INJURED(iLocal_91[0]))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_138())
			{
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_91[0], 1227113341) != 1 && AI::GET_SCRIPT_TASK_STATUS(iLocal_91[0], 1227113341) != 0)
				{
					task_go_to_entity(iLocal_91[0], PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 2f, 0);
				}
				if (is_ped_in_any_vehicle(iLocal_91[0], 0))
				{
...
bool func_138()
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			if ((((((!is_ped_on_any_bike(PLAYER::PLAYER_PED_ID()) && !is_ped_in_any_heli(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_plane(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_boat(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_sub(PLAYER::PLAYER_PED_ID())) && !is_ped_in_any_train(PLAYER::PLAYER_PED_ID())) && !is_ped_in_model(PLAYER::PLAYER_PED_ID(), joaat("rhino")))
			{
				if (get_vehicle_max_number_of_passengers(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) >= iVar0)
				{
					return true;
				}
			}
...
int func_140(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_132(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
bool func_158()
{
	...
	if (is_ped_in_any_vehicle(iLocal_91[0], 0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(get_vehicle_ped_is_in(iLocal_91[0], 0), 0))
		{
...
void func_161()
{
	if (!iLocal_61)
	{
		...
		if (iLocal_54 == 1)
		{
			AI::TASK_PLAY_ANIM(iLocal_91[0], "random@drunk_driver_1", "drunk_driver_stand_loop_dd1", 8f, -2f, -1, 1, 0, 0, 0, 0);
			AI::TASK_PLAY_ANIM(iLocal_91[1], "random@drunk_driver_1", "drunk_driver_stand_loop_dd2", 8f, -2f, -1, 1, 0, 0, 0, 0);
...
void func_171()
{
	...
	if (((STREAMING::HAS_MODEL_LOADED(iLocal_96) && STREAMING::HAS_MODEL_LOADED(iLocal_98)) && has_anim_set_loaded("MOVE_M@DRUNK@MODERATEDRUNK")) && STREAMING::HAS_MODEL_LOADED(iLocal_97))
	{
		if (iLocal_54 == 1)
		{
			if (((has_ptfx_asset_loaded() && has_anim_dict_loaded("random@drunk_driver_1")) && has_anim_set_loaded("MOVE_M@DRUNK@VERYDRUNK")) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false))
			{
				iLocal_56 = 1;
			}
		}
...
bool func_173()
{
	if (is_player_playing(player_id()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_184())
		{
			return false;
		}
	}
...
{
	return shift_right(iParam0, 26) & 31 * func_204(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_224()) || Global_100201) || Global_25122) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_220()) || func_219()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_224()) || Global_100201) || Global_25122) || func_223()) || func_24(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_224()) || Global_100201) || Global_25122) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_219()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_224()) || Global_25122) || func_223()) || func_24(8, -1)) || func_221()) || func_220()) || func_219()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_224()) || func_221()) || Global_100201) || Global_25122) || func_223()) || Global_36839) || func_24(8, -1)) || func_220()) || func_218()) || func_219()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
...
void func_232()
{
	...
	if (iLocal_172)
	{
		...
		{
			if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_95, 0) && func_134(PLAYER::PLAYER_PED_ID(), iLocal_95, 1) > 50f)
			{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_263(iParam0, 0, 0)) || func_263(iParam0, 1, 0)) || func_263(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_261(iParam0)) || func_260(iParam0)) || func_259(iParam0)) || func_258(iParam0)) || !func_251(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_260(iParam0))
		{
		}
...
Vector3 func_267()
{
	...
	if (is_player_playing(player_id()))
	{
		fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_339, 1);
		iLocal_338 = 1;
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_342, 1) < fVar0)
		{
			fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_342, 1);
			iLocal_338 = 2;
		}
		if (iLocal_338 == 1)
		{
