...
int func_61(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_150(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
