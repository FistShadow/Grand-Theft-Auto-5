...
void main()
{
	...
	while (true)
	{
		...
		if (func_61(player_ped_id(), vVar2, 0) > 100f + 20f)
		{
			func_69();
		}
		iVar0 = false;
...
bool func_12(var uParam0, char* sParam1, int iParam2)
{
...
int func_17(var uParam0)
{
	...
	if (*uParam0.f_11 == 0)
	{
		return !func_20(player_ped_id(), *uParam0.f_1, *uParam0.f_10 + 2f);
	}
...
bool func_21(var uParam0, char* sParam1)
{
	if (is_string_null_or_empty(sParam1))
	{
		return false;
...
int func_40(var uParam0)
{
	...
	return func_20(player_ped_id(), *uParam0.f_1, *uParam0.f_10);
}
...
void func_55(int iParam0)
{
	...
	if (iLocal_117[iParam0] == 0)
	{
		...
		{
			iLocal_117[iParam0] = _0xE6AC6C45FBE83004(vLocal_107[iParam0 /*3*/], vLocal_107[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, get_vehicle_ped_is_in(player_ped_id(), 0), 4);
		}
	}
	else
	{
...
var func_61(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
void func_64(var uParam0, vector3 vParam1, float fParam2)
{
...
void func_66(var uParam0, int iParam1, char* sParam2, vector3 vParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	*uParam0.f_5 = sParam2;
	*uParam0.f_1 = {vParam3};
	*uParam0.f_4 = sParam7;
