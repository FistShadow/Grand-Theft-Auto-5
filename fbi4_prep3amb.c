...
bool func_134()
{
	...
	{
		iLocal_40 = 1;
		func_135(192, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1));
		return true;
	}
	return false;
}
...
void func_160()
{
	if ((GAMEPLAY::IS_BIT_SET(iLocal_105, false) && Global_35711 == 15) && !func_190())
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_105, true))
			{
				if (!func_71(PLAYER::PLAYER_PED_ID(), vLocal_106, 5f))
				{
					...
					{
						if ((func_232(PLAYER::PLAYER_PED_ID()) && !GAMEPLAY::IS_BIT_SET(uLocal_101[0], 17)) && !GAMEPLAY::IS_BIT_SET(uLocal_101[1], 18))
						{
									...
									if (!func_188() && func_168(get_entity_coords(iLocal_109, 1)))
									{
										if (func_165(iLocal_109))
										{
											if (func_164(iLocal_109))
											{
												...
												vLocal_106 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
												return;
											}
										}
									}
					...
					else if (!func_12())
					{
						if ((is_ped_stopped(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && !GAMEPLAY::IS_BIT_SET(iLocal_105, 20))
						{
							if (iLocal_1438 != -1)
							{
								...
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_105, 20);
								}
							}
							else
							{
...
bool func_184()
{
	...
	iVar0 = func_186(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 145, 1);
	fVar1 = vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Global_86649[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_12())
		{
...
bool func_188()
{
	if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_12())
		{
			func_65(28);
	...
	else if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_12())
		{
			func_65(29);
		...
		if (!is_player_switch_in_progress())
		{
			...
			else if (func_80(iLocal_109))
			{
				if (!func_18(PLAYER::PLAYER_PED_ID(), iLocal_109, 80f, 1))
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(uLocal_101[func_5(5)]), 5);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_105, 8);
					}
					else
					{
...
bool func_203(auto uParam0)
{
	...
	if (func_232(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		iVar0 = get_players_last_vehicle();
		if (func_80(iVar0))
		{
		...
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_204[iLocal_1265 /*261*/].f_259 > 500)
			{
				if (!is_string_null_or_empty(sLocal_1263) && !is_string_null_or_empty(Local_204[iLocal_1265 /*261*/][iLocal_1264 /*8*/]))
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_204[iLocal_1265 /*261*/].f_258), iLocal_1264);
					}
					else
					{
...
void func_205()
{
	...
	if (((((((Global_35711 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(iLocal_105, 5)) && !func_190()) && Global_69486 == -1) && !func_215()) && !func_79(9)) || func_98(35))
	{
		func_214();
		func_212();
		switch (iLocal_39)
...
auto func_213(char* sParam0, int iParam1, char* sParam2)
{
...
int func_228(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_91() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_229(func_231(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_229(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
