...
int func_171(Vector3 vParam0, int iParam1)
{
	...
	while (iVar0 <= 7 - 1)
	{
		if (Global_86750[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, Global_86750[iVar0 /*9*/].f_3, 1);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
bool func_188()
{
	...
	else if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_12())
		{
			func_65(29);
