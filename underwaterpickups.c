		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar5, &iVar9))
		{
			if (func_2(vVar5, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (iLocal_24)
					{
						iLocal_3[iVar0] = create_pickup(iVar1, vVar2, iVar8, iVar9, 1, false);
					}
				}
				else if (vdist2(vVar2, vLocal_25) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (iLocal_24)
						{
							iLocal_3[iVar0] = create_pickup(iVar1, vVar2, iVar8, -1, 1, false);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (iLocal_24)
					{
						iLocal_3[iVar0] = create_pickup_rotate(iVar1, vVar2, vVar5, iVar8, 10000, 2, 1, false);
					}
				}
				else if (vdist2(vVar2, vLocal_25) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = create_pickup_rotate(iVar1, vVar2, vVar5, iVar8, -1, 2, 1, false);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (iLocal_24)
...
int func_2(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_3(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam3 = {0f, 0f, 0f};
	*uParam4 = -1;
	switch (iLocal_2)
...
void func_15(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_16(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
