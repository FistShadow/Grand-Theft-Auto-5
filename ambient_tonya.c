...
void main()
{
	...
	if (_get_number_of_instances_of_streamed_script(joaat("ambient_tonya")) > 1)
	{
...
void func_24(char* sParam0, int iParam1, int iParam2)
{
	if (Global_91278 != 10 && Global_91278 != 9)
	{
		...
		func_26(&Global_93091, sParam0, 0, "Start", iParam1, iParam2);
		func_25();
		Global_85789 = 0;
	}
}
...
void func_26(auto uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_28(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_29(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_31(auto uParam0, int iParam1, int iParam2)
{
...
void func_36(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_39(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_40(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_42(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_47(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_49(iParam1)];
...
int func_51(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_49(iParam1)];
...
void func_52(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_58(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_62(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_59(Var9.f_1)) && iVar70 < 50)
			{
...
int func_61(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_65(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
int func_67(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_68(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_78())
		{
			*uParam0 = func_74(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_70(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_72() == 0)
		{
			return is_bit_set(func_48(func_71(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_74(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
{
	return shift_right(iParam0, 26) & 31 * func_85(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_92(char* sParam0, auto uParam1, int iParam2)
{
	...
	playstats_mission_started(sParam0, uParam1, iParam2, func_168(0));
}
...
void func_97(int iParam0)
{
	...
	func_98(iParam0);
	iLocal_248 = SYSTEM::START_NEW_SCRIPT(sVar0, 18000);
...
{
	if ((func_121() && Global_91278.f_11 == 6) && iParam0 == func_120(&(Global_91278.f_3), 0))
	{
		return true;
	}
	return false;
...
{
	return func_123(iParam0, Global_35711);
}
...
int func_125()
{
	return func_120(get_this_script_name(), 0);
}
...
bool func_126(int iParam0)
{
	...
	iVar0 = func_128(&(Global_100241[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return false;
	}
...
int func_128(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_139()) || Global_100201) || Global_25122) || func_138()) || func_137(8, -1)) || func_78()) || func_136()) || func_135()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_139()) || Global_25122) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_139()) || Global_100201) || Global_25122) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_139()) || Global_100201) || Global_25122) || func_138()) || func_137(8, -1)) || func_78()) || func_136()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_139() || get_player_wanted_level(player_id()) > 0) || func_137(8, -1)) || func_134()) || func_133()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_139()) || Global_25122) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_139()) || func_136()) || Global_100201) || Global_25122) || func_138()) || Global_36839) || func_137(8, -1)) || func_135()) || func_133()) || func_134()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_139()) || Global_100201) || Global_25122) || func_138()) || func_137(8, -1)) || func_135()) || func_133()) || func_78()) || func_136()) || func_134())
						{
							return false;
						}
						break;
	...
	switch (iLocal_80)
	{
		case 0:
			if (!func_156())
			{
				if (func_141(103))
				{
					func_155(&uLocal_81, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_145(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_154(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_155(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
