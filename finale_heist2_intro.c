...
bool func_5(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_13(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
