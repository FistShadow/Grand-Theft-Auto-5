...
bool func_2()
{
	...
	{
		if (does_entity_exist(iLocal_265))
		{
...
void func_31()
{
	...
	request_ptfx_asset();
	while (!does_entity_exist(Global_91064) || !has_model_loaded(iLocal_266))
	{
		wait(0);
	}
...
bool func_35(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
bool func_37(struct<109> Param0, var uParam1)
{
	*uParam109.f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_38(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, Vector3 fParam5)
{
...
bool func_40(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	int iVar0;
