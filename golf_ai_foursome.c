...
void main()
{
	...
	while (true)
	{
		...
		switch (iVar227)
		{
			...
			case 4:
				if (!is_ped_injured(player_ped_id()) && func_322(get_clock_hours()))
				{
					if (((!is_sphere_visible(func_321(&Var171, 2 + iVar265 * 2), 10f) && !is_entity_at_coord(player_ped_id(), func_321(&Var171, 2 + iVar265 * 2), 10f, 10f, 10f, false, true, 0)) || ((func_320() || is_player_switch_in_progress()) || is_screen_faded_out())) || func_319(4))
					{
						if (iVar266 == 0)
						{
...
void func_1(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	struct<7> Var2;
	...
	func_294(uParam2.f_15[*uParam2.f_165 /*34*/], player_ped_id(), uParam2, *uParam2.f_165, uParam1);
	*uParam2.f_165++;
	if (*uParam2.f_165 >= func_314(uParam2))
	{
		*uParam2.f_165 = 0;
	}
	iVar1 = get_player_wanted_level(player_id()) > 0;
	Var2.f_2 = 1097859072;
	Var2.f_3 = 1500;
	Var2.f_4 = 45;
	Var2.f_5 = 1103626240;
	...
	while (iVar0 < func_314(uParam2))
	{
		if (does_entity_exist(func_293(uParam2.f_15[iVar0 /*34*/])))
		{
			if (is_entity_dead(func_293(uParam2.f_15[iVar0 /*34*/]), 0) && !func_292(uParam2, iVar0, 16777216))
			{
				func_290(uParam2);
				return;
			}
			if (iVar1 && func_289(func_293(uParam2.f_15[iVar0 /*34*/]), 1) < 100f)
			{
				func_290(uParam2);
				return;
			}
	...
	{
		if (get_vehicle_ped_is_in(player_ped_id(), 0) == func_288(uParam2, 0))
		{
			set_entity_as_mission_entity(func_288(uParam2, 0), false, 0);
			set_vehicle_as_no_longer_needed(uParam2.f_152[0]);
			func_279(uParam2, 0, 0);
			if (does_entity_exist(func_278(uParam2, 0)) && !is_entity_dead(func_278(uParam2, 0), 0))
			{
				if (get_script_task_status(func_278(uParam2, 0), -1794415470) != 1)
				{
					clear_ped_tasks(func_278(uParam2, 0));
					task_turn_ped_to_face_entity(func_278(uParam2, 0), player_ped_id(), -1);
				}
			}
			if (does_entity_exist(func_278(uParam2, 1)) && !is_entity_dead(func_278(uParam2, 1), 0))
			{
				if (get_script_task_status(func_278(uParam2, 1), -1794415470) != 1)
				{
					clear_ped_tasks(func_278(uParam2, 1));
					task_turn_ped_to_face_entity(func_278(uParam2, 1), player_ped_id(), -1);
				}
			}
		}
		if (get_vehicle_ped_is_in(player_ped_id(), 0) == func_288(uParam2, 1))
		{
			set_entity_as_mission_entity(func_288(uParam2, 1), false, 0);
	...
	if (func_273(uParam0, 1) || func_319(1))
	{
		...
		while (iVar0 < func_314(uParam2))
		{
			if (does_entity_exist(func_293(uParam2.f_15[iVar0 /*34*/])))
			{
				if (!is_entity_dead(func_293(uParam2.f_15[iVar0 /*34*/]), 0))
				{
					set_entity_coords(func_293(uParam2.f_15[iVar0 /*34*/]), func_272(uParam2.f_15[iVar0 /*34*/]), 1, false, 0, 1);
				}
			}
			iVar0++;
		}
	...
	switch (func_270(uParam2))
	{
		case 5:
			...
			{
				if ((((does_entity_exist(func_268(uParam2, *uParam2.f_165)) && !is_entity_dead(func_268(uParam2, *uParam2.f_165), 0)) && does_entity_exist(func_278(uParam2, *uParam2.f_165))) && !func_292(uParam2, *uParam2.f_165, 16777216)) && func_267(func_268(uParam2, *uParam2.f_165), func_278(uParam2, *uParam2.f_165), 1) < 25f)
				{
					if (get_script_task_status(func_278(uParam2, *uParam2.f_165), -1794415470) != 1 && !func_292(uParam2, *uParam2.f_165, 67108864))
					{
						clear_ped_tasks(func_278(uParam2, *uParam2.f_165));
						if (!is_ped_in_vehicle(func_278(uParam2, *uParam2.f_165), func_268(uParam2, *uParam2.f_165), 0))
						{
							if (*uParam2.f_165 == func_265(uParam2, func_266(uParam2, *uParam2.f_165)))
							{
								if (!does_entity_exist(func_278(uParam2, *uParam2.f_165 + 1)) || !is_ped_getting_into_a_vehicle(func_278(uParam2, *uParam2.f_165 + 1)))
								{
									task_enter_vehicle(func_278(uParam2, *uParam2.f_165), func_268(uParam2, *uParam2.f_165), -1, -1, 1f, 1, 0);
								}
							}
							else
							{
								task_enter_vehicle(func_278(uParam2, *uParam2.f_165), func_268(uParam2, *uParam2.f_165), -1, false, 1f, 1, 0);
							}
						}
					}
				}
				else
				{
					...
					while (iVar0 < func_314(uParam2))
					{
						if (iVar0 != func_264(uParam2))
						{
							...
							if (does_entity_exist(func_278(uParam2, iVar0)) && !is_entity_dead(func_278(uParam2, iVar0), 0))
							{
								clear_ped_tasks(func_278(uParam2, iVar0));
								task_follow_nav_mesh_to_coord(func_278(uParam2, iVar0), vVar13, 1f, -1, 0.25f, 0, 1193033728);
							}
						}
						iVar0++;
					}
			...
			if (func_63(uParam2, -1, 0))
			{
				...
				*uParam2.f_157 = 0;
				...
				if (func_269(uParam2, 1048576))
				{
					...
					task_turn_ped_to_face_coord(func_64(uParam2), func_41(uParam1, func_307(uParam2)), 0);
				}
			}
...
void func_2(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	while (iVar0 < func_314(uParam0))
	{
		...
		if (does_entity_exist(func_293(uParam0.f_15[iVar0 /*34*/])))
		{
			if (!is_entity_dead(func_293(uParam0.f_15[iVar0 /*34*/]), 0))
			{
				set_entity_coords(func_293(uParam0.f_15[iVar0 /*34*/]), func_260(uParam1, iVar1, iVar0), 1, false, 0, 1);
			}
		}
		iVar0++;
	}
	if (iParam2)
	{
		...
		if (func_3(func_321(uParam1, iVar1), func_41(uParam1, iVar1), &vVar2, &fVar8, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			...
			while (iVar9 < 2)
			{
				if (does_entity_exist(func_288(uParam0, iVar9)))
				{
					if (!is_entity_dead(func_288(uParam0, iVar9), 0) && !is_sphere_visible(vVar2 + FtoV(to_float(iVar9)) * vVar5, 5f))
					{
...
bool func_3(Vector3 vParam0, struct<2> Param1, auto uParam2, auto uParam3, float fParam4, Vector3 vParam5, struct<2> Param6, float fParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	{
		if (!get_nth_closest_vehicle_node_with_heading(vParam0, iVar1, uParam6, fParam7, &uVar2, 1, 3f, 0f))
		{
			return false;
		}
...
bool func_4(auto uParam0, float fParam1, float fParam2)
{
	float fVar0;
	
	if (get_ground_z_for_3d_coord(*uParam0 + Vector(fParam2, 0f, 0f), &fVar0, 0))
	{
...
float func_5(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
void func_9(auto uParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4)
{
...
void func_10(auto uParam0, Vector3 vParam1, int iParam2, int iParam3)
{
	if (iParam5)
	{
	}
...
void func_17(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
	}
...
bool func_18(auto uParam0, auto uParam1)
{
	...
	if (vdist2(get_entity_coords(func_64(uParam0), 1), func_41(uParam1, func_307(uParam0))) < IntToFloat(iVar1))
	{
		if (does_entity_exist(func_25(uParam0)) && !is_entity_dead(func_288(uParam0, func_247(uParam0)), 0))
		{
			if (vdist2(get_entity_coords(func_25(uParam0), 1), func_41(uParam1, func_307(uParam0))) > IntToFloat(iVar1))
			{
				return true;
			}
			func_20(uParam0, uParam1, func_247(uParam0), 1, 37516/*func_262*/, 7470/*func_41*/);
		}
		return false;
	}
...
Vector3 func_19(auto uParam0)
{
	return func_272(uParam0.f_15[*uParam0.f_157 /*34*/]);
}

void func_20(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	while (iVar0 < func_314(uParam0))
	{
		if (((iParam2 == 0 && (iVar0 == 0 || iVar0 == 1)) || (iParam2 == 1 && (iVar0 == 2 || iVar0 == 3))) && func_23(uParam0, iVar0) == 4)
		{
			...
			Stack.Push(iVar0);
			Call_Loc(iParam4);
			task_follow_nav_mesh_to_coord(StackVal, StackVal, StackVal, StackVal, 1f, -1, 0.25f, 0, 1193033728);
			Stack.Push(0);
			Stack.Push(uParam1);
			Stack.Push(func_307(uParam0));
			Call_Loc(iParam5);
			...
			task_perform_sequence(func_278(uParam0, iVar0), *(uParam0.f_15[iVar0 /*34*/]).f_21);
...
int func_26(auto uParam0, auto uParam1)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
auto func_28(auto uParam0)
{
	return *uParam0.f_23;
}

bool func_29(auto uParam0, auto uParam1)
{
	int iVar0;
...
int func_30(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	if (iParam2 == -1)
	{
...
Vector3 func_41(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f, 0f, 0f;
...
void func_42(auto uParam0, int iParam1, Vector3 vParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	int iVar1;
	Vector3 vVar2;
	...
	if (iParam6)
	{
		if (get_ground_z_for_3d_coord(vParam2 + Vector(50f, 0f, 0f), &uVar0, 0))
		{
			vParam2.z = uVar0;
		}
	}
	set_entity_coords(func_278(uParam0, iParam1), vParam2, 0, false, 0, 1);
	iVar1 = func_266(uParam0, iParam1);
	if (does_entity_exist(func_288(uParam0, iVar1)) && iParam7)
	{
		vVar2 = {0f, 0f, 0f};
		vVar5 = {0f, 0f, 0f};
		fVar8 = 0f;
		...
		if (!is_entity_dead(func_288(uParam0, iVar1), 0))
		{
			if (func_292(uParam0, iParam1, 1048576))
			{
				uVar9 = func_43(vParam2 + vVar5, func_41(uParam5, func_307(uParam0)), &vVar2, &fVar8);
			}
			else
			{
...
bool func_43(Vector3 vParam0, struct<2> Param1, auto uParam2, auto uParam3, float fParam4)
{
...
void func_44(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_46(auto uParam0, auto uParam1)
{
	*uParam0.f_13 = uParam1;
}

float func_47(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f;
...
void func_48(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_7 = {vParam1};
}

void func_49(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_10 = {vParam1};
}

void func_50(auto uParam0, Vector3 vParam1)
{
...
bool func_52(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	int iVar0;
...
void func_58(auto uParam0, Vector3 vParam1)
{
	func_50(uParam0.f_15[*uParam0.f_157 /*34*/], vParam1);
}

void func_59(auto uParam0, Vector3 vParam1, int iParam2)
{
...
bool func_63(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	while (iVar0 < func_314(uParam0))
	{
		...
		{
			if ((func_22(uParam0.f_15[iVar0 /*34*/]) != 10 && (func_24(uParam0.f_15[iVar0 /*34*/]) != 4 || !iParam2)) && !func_292(uParam0, iVar0, 16777216))
			{
				return false;
			}
		}
...
bool func_66(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
void func_67(auto uParam0, auto uParam1, auto uParam2)
{
	Vector3 vVar0;
	...
	switch (func_34(uParam2))
	{
		case 0:
			...
			if (!does_entity_exist(func_244(uParam2)))
			{
				func_239(uParam2, func_241(vVar0, func_242(func_243(uParam1, func_307(uParam2)), func_19(uParam2))));
			}
			else if (!func_238())
			{
				set_entity_coords(func_244(uParam2), vVar0, 1, false, 0, 1);
			}
			func_237(uParam2, get_entity_coords(func_244(uParam2), 1));
			...
			set_entity_records_collisions(func_244(uParam2), 0);
		...
		case 4:
			if (func_169(player_ped_id(), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_2, 0) < 1f)
			{
				if (is_entity_touching_entity(player_ped_id(), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_2))
				{
					clear_ped_tasks_immediately(*(uParam2.f_15[func_264(uParam2) /*34*/]).f_2);
					func_202(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_271(uParam2, 0);
					func_257(uParam2, 1);
			...
			{
				if (((*uParam2.f_1 == 4 || *uParam2.f_1 == 6) || func_269(uParam2, 1048576)) && does_entity_exist(func_244(uParam2)))
				{
					if (((func_155(func_64(uParam2)) || func_170(uParam2.f_162, 2.5f)) || func_269(uParam2, 1048576)) && does_entity_have_physics(func_244(uParam2)))
					{
						if (func_269(uParam2, 1048576))
						{
							if (iLocal_0)
				...
				else if (!does_entity_exist(func_244(uParam2)))
				{
					*uParam2.f_1 = 0;
					func_257(uParam2, 0);
				}
		...
		case 6:
			func_118(uParam0, uParam2, 1);
			if ((func_88(uParam2) || func_87(uParam2)) || func_7(get_entity_coords(func_244(uParam2), 1)))
			{
				func_86(uParam2);
			}
			else
		...
		case 8:
			...
			{
				clear_ped_tasks(func_64(uParam2));
				open_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
				task_go_to_coord_any_means(false, func_262(uParam1, func_307(uParam2), func_264(uParam2)), 1f, 0, 0, 786603, -1082130432);
				task_turn_ped_to_face_coord(false, func_41(uParam1, func_307(uParam2)), 0);
				close_sequence_task(*(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
				task_perform_sequence(func_64(uParam2), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
				clear_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
			}
			break;
			...
			if (!func_118(uParam0, uParam2, 0))
			{
				if (func_70(uParam1, uParam2) && !func_261(uParam2, func_264(uParam2)))
				{
					if (!func_269(uParam2, 1048576))
					{
						...
						clear_ped_tasks(func_64(uParam2));
						open_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
						task_follow_nav_mesh_to_coord(false, func_260(uParam1, func_307(uParam2), func_264(uParam2)), 1f, -1, 0.25f, 0, 1193033728);
						task_turn_ped_to_face_coord(false, func_321(uParam1, func_307(uParam2)), 0);
						close_sequence_task(*(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
						task_perform_sequence(func_64(uParam2), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
						clear_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
					}
					...
					{
						set_entity_coords(func_64(uParam2), func_260(uParam1, func_307(uParam2), func_264(uParam2)), 1, false, 0, 1);
					}
				}
				else if (func_193(uParam2) || func_269(uParam2, 67108864))
				{
					if (!func_269(uParam2, 1048576))
					{
						if (!func_63(uParam2, func_264(uParam2), 0))
						{
							...
							clear_ped_tasks(func_64(uParam2));
							open_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
							task_follow_nav_mesh_to_coord(false, func_262(uParam1, func_307(uParam2), func_264(uParam2)), 1f, -1, 0.25f, 0, 1193033728);
							task_turn_ped_to_face_coord(false, func_41(uParam1, func_307(uParam2)), 0);
							close_sequence_task(*(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
							task_perform_sequence(func_64(uParam2), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
							clear_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
					...
					{
						set_entity_coords(func_64(uParam2), func_262(uParam1, func_307(uParam2), func_264(uParam2)), 1, false, 0, 1);
					}
				}
				else if (!func_269(uParam2, 1048576))
				{
					if (!func_63(uParam2, func_264(uParam2), 0) && does_entity_exist(func_25(uParam2)))
					{
						if (!is_entity_dead(func_25(uParam2), 0))
						{
							clear_ped_tasks(func_64(uParam2));
							open_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
							task_enter_vehicle(false, func_25(uParam2), -1, func_68(uParam2), 1f, 1, 0);
							close_sequence_task(*(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
							task_perform_sequence(func_64(uParam2), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_21);
							clear_sequence_task(uParam2.f_15[func_264(uParam2) /*34*/].f_21);
						}
...
bool func_70(auto uParam0, auto uParam1)
{
...
void func_77(auto uParam0, auto uParam1)
{
	if (!iLocal_234)
	{
		...
		func_237(uParam1, get_entity_coords(func_244(uParam1), 1));
		func_84(uParam1, vdist(func_19(uParam1), func_41(uParam0, func_307(uParam1))));
	}
	else
	{
		set_entity_coords(func_244(uParam1), func_19(uParam1) + Vector(0.05f, 0f, 0f), 1, false, 0, 1);
		func_82(uParam1);
		func_80(uParam1);
	}
	set_entity_max_speed(func_244(uParam1), 150f);
	func_201(func_244(uParam1), 1);
	func_65(uParam1, 2);
	func_78(uParam1, 0f);
}

void func_78(auto uParam0, Vector3 fParam1)
{
	func_79(uParam0.f_15[*uParam0.f_157 /*34*/], fParam1);
}

void func_79(auto uParam0, auto uParam1)
{
...
void func_84(auto uParam0, Vector3 fParam1)
{
...
void func_89(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	float fVar4;
	...
	vVar8 = {get_entity_coords(iVar0, 1)};
	...
	*uParam2.f_1.f_6 = 0f;
	...
	{
		func_59(uParam2, get_entity_coords(iVar0, 1), func_99(get_last_material_hit_by_entity(iVar0)));
		func_74(uParam2, 2);
		func_305(uParam0, 268435456);
		if (does_entity_exist(iVar11))
		{
			if (is_entity_touching_entity(iVar0, iVar11) && !func_269(uParam2, 268435456))
			{
				play_sound_from_entity(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_244(uParam2), 0, 0, 0);
				set_entity_collision(iVar11, false, 0);
	...
	{
		if (!func_273(uParam0, 268435456) && vdist2(vVar8, vVar5) < 0.3f * 0.3f)
		{
			play_sound_from_entity(-1, "GOLF_BALL_CUP_MISS_MASTER", func_244(uParam2), 0, 0, 0);
	...
	if (((fVar4 < 0.25f || (fVar4 < 6f && func_98(uParam1, uParam2))) || func_269(uParam2, 256)) || func_97())
	{
		...
		if ((!func_98(uParam1, uParam2) && (((func_269(uParam2, 256) || vdist2(vVar8, vVar5) < 0.1601f * 0.1601f) || func_97()) || func_93(uParam1, uParam2))) && 0)
		{
...
Vector3 func_90(auto uParam0)
{
	return func_91(uParam0.f_15[*uParam0.f_157 /*34*/]);
}

Vector3 func_91(auto uParam0)
{
	return *uParam0.f_10;
}

void func_92(int iParam0, struct<2> Param1, Vector3 fParam2, struct<2> Param3, auto uParam4)
{
	Vector3 vVar0;
...
bool func_93(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	float fVar3;
	...
	if (vdist(vVar0, func_41(uParam0, func_307(uParam1))) > fVar3)
	{
		return false;
	}
	return true;
...
bool func_98(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	
	if (!does_entity_exist(func_244(uParam1)))
	{
		return false;
	}
	vVar0 = {get_entity_coords(func_244(uParam1), 0)};
...
bool func_100(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
{
	play_sound_from_entity(-1, "GOLF_BALL_IN_WATER_MASTER", func_244(uParam0), 0, 0, 0);
	return;
	start_particle_fx_non_looped_at_coord("scr_golf_landing_water", get_entity_coords(func_244(uParam0), 1), 0f, 0f, func_242(get_entity_coords(func_244(uParam0), 1), func_19(uParam0)), 1f, 0, 0, 0);
}

int func_102(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0;
...
void func_105(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	unk_0x0A25F80D5BADC013(get_entity_coords(iVar0, 1), get_entity_coords(iVar0, 1) + func_6(vVar17), 0, 0, 0, 255);
	if (func_100(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (has_entity_collided_with_anything(iVar0))
	{
		...
		if (!iLocal_237)
		{
			...
			apply_force_to_entity(iVar0, 0, vVar17, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
		}
		...
		if (!func_273(uParam0, 64))
		{
			...
			{
				_0x8BDC7BFC57A81E76(get_entity_coords(iVar0, 1) + Vector(1f, 0f, 0f), &uVar6, &vVar27);
				vVar30 = {FtoV(func_8(vLocal_244, vVar27)) * vVar27};
				vVar24 = {Vector(-1f + fVar21, -1f + fVar21, -1f + fVar21) * vVar30 + vLocal_244};
				vVar33 = {vLocal_244 - vVar30};
				vVar24 = {vVar24 - vVar33 * Vector(fVar23, fVar23, fVar23)};
				set_entity_velocity(iVar0, vVar24);
			}
			func_125(uParam0, 64);
		...
		else
		{
			...
			if (fVar20 != 1f)
			{
				...
				set_entity_velocity(iVar0, vVar36);
			}
		}
	}
	else
	...
	if (!func_269(uParam2, 2))
	{
		...
		if (has_entity_collided_with_anything(iVar0) && func_251(uParam2.f_159, 0.2f))
		{
			...
			func_78(uParam2, vdist(get_entity_coords(iVar0, 1), func_19(uParam2)));
			func_74(uParam2, 2);
			func_168(uParam2.f_159);
			func_106(uParam2);
		}
	...
	{
		func_92(iVar0, get_entity_coords(iVar0, 1), func_41(uParam1, func_307(uParam2)));
	}
...
void func_106(auto uParam0)
{
	...
	sVar0 = "";
	switch (get_last_material_hit_by_entity(func_244(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_107(sVar0))
	{
		start_particle_fx_non_looped_at_coord(sVar0, get_entity_coords(func_244(uParam0), 1), 0f, 0f, func_242(get_entity_coords(func_244(uParam0), 1), func_19(uParam0)), 1f, 0, 0, 0);
	}
}
...
void func_112(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
	...
	if (!func_107(sVar0))
	{
		if (iParam1)
		{
			play_sound_from_coord(-1, sVar0, get_entity_coords(func_244(uParam0), 1), 0, 0, 0, 0);
		}
		else
		{
			play_sound_from_entity(-1, sVar0, func_244(uParam0), 0, 0, 0);
		}
	}
}
...
auto func_116(auto uParam0)
{
	return func_117(uParam0.f_15[*uParam0.f_157 /*34*/]);
}

auto func_117(auto uParam0)
{
	return *uParam0.f_14;
}

bool func_118(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	char* sVar1;
	char[32] cVar2;
...
char* func_121(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
bool func_124(int iParam0, float fParam1)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		else if (is_entity_playing_anim(iParam0, func_119(0), &cVar8, 3))
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar8) >= fParam1)
			{
				return true;
			}
		}
		else if (is_entity_playing_anim(iParam0, func_119(0), &cVar16, 3))
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar16) >= fParam1)
			{
				return true;
			}
		}
		else if (is_entity_playing_anim(iParam0, func_119(0), &cVar24, 3))
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar24) >= fParam1)
			{
				return true;
			}
		}
...
bool func_126(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	set_entity_records_collisions(func_244(uParam2), 1);
	set_object_physics_params(func_244(uParam2), -1f, -1f, 0f, 0f, 0.01f, -1f, -1f, -1f, -1f, -1f, -1f);
	iVar0 = func_85(uParam2) == 4;
	fVar1 = func_142(uParam2.f_15[func_264(uParam2) /*34*/], uParam0, uParam2.f_1, iVar0, !iLocal_235, 0);
	fVar2 = 1f;
	...
	switch (*uParam2.f_1)
	{
		...
		case 6:
			if (!func_193(uParam2))
			{
				fVar1 *= get_random_float_in_range(0.15f, 0.25f);
				fVar3 *= get_random_float_in_range(0.25f, 1.25f);
			}
	...
	else
	{
		...
		vVar6 = {Vector(-1f * fVar1, -1f * fVar1, -1f * fVar1) * vVar18};
	}
	if (iLocal_0)
	{
	...
	set_entity_velocity(func_244(uParam2), vVar6);
	set_entity_max_speed(func_244(uParam2), 150f);
	func_125(uParam0, 32);
...
void func_127(auto uParam0, auto uParam1, auto uParam2)
{
	char* sVar0;
	...
	if (!func_107(sVar0))
	{
		start_particle_fx_non_looped_at_coord(sVar0, func_19(uParam0), 0f, 0f, func_116(uParam0), 1f, 0, 0, 0);
	}
}
...
void func_128(auto uParam0, int iParam1)
{
	...
	return;
	if (!func_193(uParam0) && does_entity_exist(func_244(uParam0)))
	{
		iVar0 = start_particle_fx_looped_on_entity("scr_golf_ball_trail", func_244(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
		if (iParam1)
		{
			set_particle_fx_looped_colour(iVar0, 240f / 255f, 200f / 255f, 80f / 255f, 0);
		}
	}
}

void func_129(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4)
{
	char* sVar0;
	...
	if (!func_107(sVar0))
	{
		if (iParam2 || !does_entity_exist(func_244(uParam1)))
		{
			play_sound_from_coord(-1, sVar0, func_19(uParam1), 0, 0, 0, 0);
		}
		else
		{
			play_sound_from_entity(-1, sVar0, func_244(uParam1), 0, 0, 0);
		}
	}
}

bool func_130(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
Vector3 func_131(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
Vector3 func_132(int iParam0, Vector3 vParam1, Vector3 vParam2)
{
	if (iParam0)
	{
		return vParam1;
...
Vector3 func_133(auto uParam0)
{
	return func_134(uParam0.f_15[*uParam0.f_157 /*34*/]);
}

Vector3 func_134(auto uParam0)
{
	return *uParam0.f_25;
}
...
float func_138(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0f;
...
float func_139(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0f;
...
float func_142(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_144(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0f;
...
float func_145(auto uParam0, int iParam1)
{
	float fVar0;
...
auto func_147(int iParam0, int iParam1)
{
	auto uVar0;
	auto uVar1;
...
void func_148(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_150()
{
	...
	{
		if (func_154(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
...
bool func_155(int iParam0)
{
	...
	if (!is_ped_injured(iParam0))
	{
		...
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar8) > 0.134f)
			{
				return true;
			}
		}
		...
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar16) > 0.119f)
			{
				return true;
			}
		}
		...
		{
			if (get_entity_anim_current_time(iParam0, func_119(0), &cVar24) > 0.159f)
			{
				return true;
			}
		}
...
void func_156(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	iVar1 = func_269(uParam0, 131072);
	fVar2 = 0f;
	fVar3 = func_27(iVar1, 2f, 1f);
	if (*uParam2.f_12 > 0)
	{
		*uParam2.f_12 += floor(get_frame_time() * 1000f);
	}
...
void func_157(auto uParam0, float fParam1)
{
	func_158(uParam0.f_15[*uParam0.f_157 /*34*/], fParam1);
}

void func_158(auto uParam0, float fParam1)
{
	*uParam0.f_14 += fParam1;
}

void func_159(auto uParam0, float fParam1)
{
	if (fParam1 > 100f)
	{
		fParam1 = 100f;
...
void func_160(auto uParam0, float fParam1)
{
	*uParam0.f_15 = fParam1;
}

void func_161(auto uParam0, auto uParam1, int iParam2, float fParam3)
{
	iParam2 = iParam2;
	fParam3 = fParam3;
...
float func_164(auto uParam0, int iParam1)
{
...
bool func_170(auto uParam0, float fParam1)
{
...
bool func_171(auto uParam0, auto uParam1)
{
	int iVar0;
	Vector3 vVar1;
	...
	vVar1 = {get_entity_coords(func_244(uParam1), 0)};
	if (func_35(uParam1) != 3 && vdist2(vVar1, func_41(uParam0, func_307(uParam1))) > 0.7f * 0.7f)
	{
		return false;
	}
	if (vdist2(vVar1, func_41(uParam0, func_307(uParam1))) > 55f * 55f)
	{
		return false;
	}
	return true;
...
void func_175(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (!is_ped_injured(iVar0))
	{
		...
		switch (func_167(uParam1))
		{
			...
			case 1:
				...
				if (!is_entity_playing_anim(iVar0, func_119(0), &cVar17, 3))
				{
					task_play_anim(iVar0, func_119(0), &cVar17, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (iLocal_0)
					{
					}
				}
				...
				{
					fVar4 = get_entity_anim_current_time(iVar0, func_119(0), &cVar17);
					if (get_entity_anim_current_time(iVar0, func_119(0), &cVar17) >= 0.975f)
					{
						if (iLocal_0)
						{
						}
						set_entity_anim_speed(iVar0, func_119(0), &cVar17, 0f);
						if (*uParam2.f_10 == 0)
						{
					...
					{
						set_entity_anim_speed(iVar0, func_119(0), &cVar17, 0.6f);
					}
					if (fVar4 < fVar2)
					{
						set_entity_anim_current_time(iVar0, func_119(0), &cVar17, fVar2);
						set_entity_anim_speed(iVar0, func_119(0), &cVar17, 0.8f);
					}
				}
				break;
			...
			case 3:
				...
				if (is_entity_playing_anim(iVar0, func_119(0), &cVar17, 3))
				{
					...
					{
						set_entity_anim_current_time(iVar0, func_119(0), &cVar17, fVar4 - fVar3);
						if (iLocal_0)
						{
						}
					}
			...
			case 4:
				...
				if (!is_entity_playing_anim(iVar0, func_119(0), &cVar25, 3))
				{
					if (has_entity_anim_finished(iVar0, func_119(0), &cVar17, 3))
					{
						task_play_anim(iVar0, func_119(0), &cVar25, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (iLocal_0)
						{
						}
					}
					else if (is_entity_playing_anim(iVar0, func_119(0), &cVar17, 3))
					{
						fVar1 = get_entity_anim_current_time(iVar0, func_119(0), &cVar17);
						task_play_anim(iVar0, func_119(0), &cVar25, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (iLocal_0)
						{
						}
...
char* func_177(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	vVar2 = {get_entity_coords(func_293(uParam0), 1)};
	if (iParam3)
	{
	...
	vVar2.z += fVar10;
	vVar11 = {get_entity_forward_vector(func_293(uParam0))};
...
void func_178(auto uParam0, Vector3 fParam1, Vector3 vParam2)
{
	Vector3 fVar0;
	Vector3 fVar1;
...
void func_182(int iParam0, float fParam1, auto uParam2, auto uParam3)
{
	if (func_183())
	{
		if (iParam0 <= 5)
...
void func_184(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
{
	*iParam0.f_1 = func_190(is_bit_set(*iParam0, 4)) - fParam1;
...
void func_191(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	func_42(uParam0, iParam1, func_259(uParam0, iParam1), uParam2, iParam3, iParam4);
}

bool func_192(auto uParam0)
{
...
void func_194(auto uParam0, Vector3 vParam1)
{
	func_49(uParam0.f_15[*uParam0.f_157 /*34*/], vParam1);
}

Vector3 func_195(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	{
		vVar0 = {_get_object_offset_from_coords(func_19(uParam0), func_116(uParam0) + fVar3, -func_144(uParam1, func_140(uParam0)) * func_196(func_136(uParam0)) * func_143(func_28(uParam0.f_15[func_264(uParam0) /*34*/])) * func_164(uParam0, 1) * fVar4 / 100f, 0f, 0f)};
	}
	else if (func_35(uParam0) != 3)
	{
		vVar0 = {_get_object_offset_from_coords(func_19(uParam0), func_116(uParam0), -func_144(uParam1, func_140(uParam0)) * func_196(func_136(uParam0)) * func_143(func_28(uParam0.f_15[func_264(uParam0) /*34*/])) * func_164(uParam0, 1) / 100f, 0f, 0f)};
	}
	else
	{
	...
	if (get_ground_z_for_3d_coord(vVar0, &uVar5, 0))
	{
		vVar0.z = uVar5;
	}
	else
...
void func_198(auto uParam0, auto uParam1, auto uParam2)
{
...
auto func_199(auto uParam0, auto uParam1)
{
	auto uVar0;
	
	uVar0 = func_200(uParam1, func_140(uParam0));
	return uVar0;
}

float func_200(auto uParam0, int iParam1)
{
	switch (*uParam0[iParam1])
	{
		case 1:
...
void func_202(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	fVar3 = func_242(vVar0, func_19(uParam1)) + 90f;
	func_203(uParam1.f_15[func_264(uParam1) /*34*/], uParam2, fVar3, 0, iParam3, iParam4, iParam6, iParam7);
}

void func_203(auto uParam0, auto uParam1, Vector3 fParam2, int iParam3, auto uParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	{
		task_stand_still(func_293(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	vVar1 = {_get_object_offset_from_coords(func_272(uParam0), func_117(uParam0), func_223(iVar0))};
	vVar4 = {get_entity_coords(func_293(uParam0), 1)};
	if (iParam3)
	{
		clear_ped_tasks_immediately(func_293(uParam0));
	}
	if (iParam5 || func_40(uParam0, 1048576))
	{
		...
		if (get_ground_z_for_3d_coord(vVar1 + Vector(1f, 0f, 0f), &fVar7, 0))
		{
			if ((absf(fVar7 - vVar4.z) < 0.35f || fVar7 < vVar1.z) || iParam7)
			{
				vVar1.z = fVar7;
			}
		}
		...
		else
		{
			...
			if (iVar8)
			{
				set_entity_heading(func_293(uParam0), func_117(uParam0));
				set_entity_coords(func_293(uParam0), vVar1, 0, true, 1, 1);
			}
		}
	}
	else
	{
		clear_ped_tasks(func_293(uParam0));
		open_sequence_task(uParam0.f_21);
		if (func_238() || func_185(uParam0))
		{
			task_follow_nav_mesh_to_coord(false, vVar1, 1f, -1, 0.25f, 512, fParam2);
			task_play_anim(false, "mini@golfai", "putt_approach_no_ball", 2f, -4f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "mini@golfai", "putt_approach_no_ball", 4f, -4f, -1, 2, 0.999f, 0, 0, 0);
		}
		else
		{
			task_follow_nav_mesh_to_coord(false, vVar1, 1f, -1, 0.25f, 512, fParam2);
		...
		task_perform_sequence(func_293(uParam0), *uParam0.f_21);
...
void func_204(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!iParam2 || iVar2)
	{
		...
		{
			attach_entity_to_entity(func_163(uParam0), iVar3, get_ped_bone_index(iVar3, 28422), func_206(iVar3, iVar0), func_205(iVar3, iVar0), 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_208(auto uParam0, auto uParam1)
{
	int iVar0;
	
	func_38(uParam0);
	iVar0 = create_object_no_offset(func_210(uParam1, func_123(uParam0)), func_272(uParam0), 0, 1, 0);
	return iVar0;
}
...
int func_210(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
...
void func_211(auto uParam0, auto uParam1)
{
	float fVar0;
	char* sVar1;
	int iVar2;
	...
	func_212(func_293(uParam0), &cVar3, &cVar11, iVar2, fVar0, 1f, 10, 0f, 0f, 0f, 0);
	if (!func_40(uParam0, 32768))
	{
		_0x2208438012482A1A(func_293(uParam0), 1, 0);
		_0xED3C76ADFA6D07C4(func_293(uParam0));
		func_57(uParam0, 32768);
	}
}

void func_212(int iParam0, char[4] cParam1, char[4] cParam2, int iParam3, float fParam4, float fParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10)
{
	struct<20> Var0;
	struct<21> Var22;
	...
	Var22.f_20 = iParam6;
	task_scripted_animation(iParam0, &Var22, &Var0, &Var0, fParam8, fParam9);
}

auto func_213(auto uParam0)
{
	return uParam0;
}

bool func_214(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	if (!func_219())
	{
		...
		{
			if (((iParam9 && func_217(player_id(), 1, 0)) && is_player_switch_in_progress()) && Global_2418472[player_id() /*313*/].f_220 == 1)
			{
			}
			else
			{
...
void func_225(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
bool func_230(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	Vector3 vVar1;
...
void func_233(auto uParam0, auto uParam1)
{
...
bool func_236(auto uParam0, auto uParam1, int iParam2)
{
	...
	if (iParam2)
	{
		if (does_entity_exist(func_244(uParam1)))
		{
			vVar0 = {get_entity_coords(func_244(uParam1), 1)};
		}
	}
	if (vdist2(vVar0, func_41(uParam0, func_307(uParam1))) > 0.7f * 0.7f)
	{
		return false;
	}
	return true;
...
void func_237(auto uParam0, Vector3 vParam1)
{
...
int func_241(Vector3 vParam0, Vector3 fParam1)
{
	int iVar0;
	...
	iVar0 = create_object(joaat("prop_golf_ball"), vParam0, 1, true, false);
	_0xC6033D32241F6FB5(iVar0, 1);
	_0x3910051CCECDB00C(iVar0, false);
	set_entity_heading(iVar0, fParam3);
	if (iLocal_0)
	{
	}
	return iVar0;
...
float func_242(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
	return get_heading_from_vector_2d(Param3 - Param0, Param3.f_1 - Param0.f_1);
}

Vector3 func_243(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f, 0f, 0f;
...
auto func_244(auto uParam0)
{
	return func_245(uParam0.f_15[*uParam0.f_157 /*34*/]);
}

auto func_245(auto uParam0)
{
	return *uParam0.f_3;
}

int func_246(auto uParam0, int iParam1, int iParam2)
{
...
auto func_247(auto uParam0)
{
	return func_266(uParam0, func_264(uParam0));
}

void func_248(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (is_entity_dead(func_268(uParam0, iParam1), 0))
	{
		func_271(uParam0, 2);
		return;
	}
	fVar1 = 144f;
	iVar10 = vdist2(get_entity_coords(func_288(uParam0, func_266(uParam0, iParam1)), 1), *(uParam0.f_15[iParam1 /*34*/].f_10)) < fVar1;
	if (!is_ped_in_vehicle(iVar2, func_268(uParam0, iParam1), 0) && !iVar10)
	{
		if (get_script_task_status(iVar2, -1794415470) != 1)
		{
			task_enter_vehicle(iVar2, func_268(uParam0, iParam1), -1, -1, 1f, 1, 0);
		}
		return;
	}
	iVar11 = 786603;
	...
	if (((does_entity_exist(iVar2) && !is_entity_dead(iVar2, 0)) && get_script_task_status(iVar2, -1817882002) != 1) && !func_40(uParam0.f_15[iParam1 /*34*/], 33554432))
	{
		...
		func_3(vVar4 + vVar7, func_41(uParam2, func_307(uParam0)), uParam0.f_15[iParam1 /*34*/].f_10, &fVar0, 0f, 0f, 0f, 0f, 0f, 0f, 0);
		task_vehicle_drive_to_coord(func_278(uParam0, func_250(uParam0, iParam1)), func_268(uParam0, iParam1), *(uParam0.f_15[iParam1 /*34*/].f_10), 4f, 0, false, iVar11, 4f, -1f);
	}
	if (iVar10)
	{
		clear_ped_tasks(func_278(uParam0, func_250(uParam0, iParam1)));
		func_57(uParam0.f_15[iParam1 /*34*/], 33554432);
		if (!func_261(uParam0, -1))
		{
			task_everyone_leave_vehicle(func_268(uParam0, iParam1));
			iVar12 = 1;
			func_20(uParam0, uParam2, func_266(uParam0, iParam1), 0, 35783/*func_260*/, 44618/*func_321*/);
			iVar3 = 0;
			while (iVar3 < func_314(uParam0))
			{
				if (does_entity_exist(func_278(uParam0, iVar3)) && !is_entity_dead(func_278(uParam0, iVar3), 0))
				{
					if (is_ped_in_any_vehicle(func_278(uParam0, iVar3), 0))
					{
						iVar12 = 0;
					}
				}
		...
		else if ((vdist2(func_259(uParam0, iParam1), func_41(uParam2, func_307(uParam0))) < 1600f && vdist2(get_entity_coords(func_268(uParam0, iParam1), 1), func_41(uParam2, func_307(uParam0))) < 1600f) && !func_292(uParam0, iParam1, 67108864))
		{
			func_20(uParam0, uParam2, func_266(uParam0, iParam1), 1, 37516/*func_262*/, 7470);
			if (iParam3)
			{
				func_271(uParam0, 2);
			}
		}
		else if (is_ped_in_any_vehicle(func_278(uParam0, iParam1), 0))
		{
			task_vehicle_park(func_278(uParam0, func_250(uParam0, iParam1)), func_268(uParam0, iParam1), get_entity_coords(func_268(uParam0, iParam1), 1), 0f, 3, 360f, 0);
			if (iParam3)
			{
				task_leave_any_vehicle(func_278(uParam0, iParam1), 0, 0);
				func_271(uParam0, 2);
...
void func_249(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return;
...
auto func_250(auto uParam0, int iParam1)
{
	return func_265(uParam0, func_266(uParam0, iParam1));
}

bool func_251(auto uParam0, float fParam1)
{
	if (func_96(uParam0))
	{
...
bool func_256(auto uParam0, int iParam1)
{
	...
	while (iVar0 < func_314(uParam0))
	{
		if (iVar0 >= iParam1)
		{
			if (!is_entity_dead(func_278(uParam0, iVar0), 0) && !is_entity_dead(func_268(uParam0, iVar0), 0))
			{
				if ((!is_ped_in_vehicle(func_278(uParam0, iVar0), func_268(uParam0, iVar0), 0) && !func_292(uParam0, iVar0, 16777216)) && !func_292(uParam0, iVar0, 67108864))
				{
					return false;
				}
			}
...
bool func_258(auto uParam0, auto uParam1)
{
	if (func_307(uParam1) < 0 || func_307(uParam1) >= func_53(uParam0))
	{
		return false;
...
Vector3 func_259(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0f, 0f, 0f;
...
Vector3 func_260(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f, 0f, 0f;
...
bool func_261(auto uParam0, int iParam1)
{
	int iVar0;
...
Vector3 func_262(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f, 0f, 0f;
...
bool func_263(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	Vector3 vVar1;
	...
	vVar1 = {get_entity_coords(func_245(uParam1.f_15[iParam2 /*34*/]), 0)};
	if (vdist2(vVar1, func_41(uParam0, func_307(uParam1))) > 55f * 55f)
	{
		return false;
	}
...
auto func_264(auto uParam0)
{
	return *uParam0.f_157;
}

auto func_265(auto uParam0, auto uParam1)
{
	return *uParam0.f_167[uParam1];
}

auto func_266(auto uParam0, int iParam1)
{
	return *(uParam0.f_15[iParam1 /*34*/]).f_31;
}

auto func_267(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_269(auto uParam0, int iParam1)
{
...
Vector3 func_272(auto uParam0)
{
	return *uParam0.f_7;
}

int func_273(auto uParam0, int iParam1)
{
	return (*uParam0.f_22 && iParam1) != 0;
}

void func_274(auto uParam0, auto uParam1, int iParam2)
{
...
bool func_275(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_277(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
bool func_280(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!is_entity_dead(iVar0, 0) && !is_entity_dead(iParam0, 0))
	{
		...
		iVar1 = !func_287(*uParam2, 128);
		if (iParam4)
		{
			if (func_281(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_281(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_281(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (iParam3)
	{
		if (!iLocal_250)
		{
			iLocal_251 = get_entity_health(iParam0);
			iLocal_250 = true;
		}
		iLocal_252 = get_entity_health(iParam0);
	...
	if (func_282(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_289(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
bool func_283(int iParam0, int iParam1, auto uParam2)
{
...
bool func_284(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_285(iVar3))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_267(player_ped_id(), iParam0, 1) < 40f)
						{
...
int func_287(auto uParam0, int iParam1)
{
	return (uParam0 && iParam1) != 0;
}

auto func_288(auto uParam0, int iParam1)
{
	return *uParam0.f_152[iParam1];
}

auto func_289(int iParam0, int iParam1)
{
	return func_267(get_player_ped(get_player_index()), iParam0, iParam1);
}
...
int func_292(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0;
...
auto func_293(auto uParam0)
{
	return *uParam0.f_2;
}

void func_294(auto uParam0, int iParam1, auto uParam2, int iParam3, auto uParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	if (!does_entity_exist(func_293(uParam0)))
	{
		return;
	}
	if (is_entity_dead(func_293(uParam0), 0) || is_ped_injured(func_293(uParam0)))
	{
		return;
	}
	...
	if (get_script_task_status(func_293(uParam0), -1794415470) == 1)
	{
		return;
	}
	vVar0 = {func_272(uParam0)};
	vVar3 = {get_entity_coords(iParam1, 1)};
	vVar6 = {get_entity_coords(func_293(uParam0), 1)};
	...
	else
	{
		if (func_40(uParam0, 262144))
		{
			if (does_entity_exist(*uParam0.f_3))
			{
				if (!is_entity_dead(*uParam0.f_3, 0))
				{
					...
					if (get_ground_z_for_3d_coord(vVar10, &uVar9, 0))
					{
		...
		if (func_40(uParam0, 524288) && func_261(uParam2, -1))
		{
			...
			if (get_script_task_status(func_293(uParam0), 1435919172) == 1)
			{
				clear_ped_tasks(func_293(uParam0));
			}
		}
	...
	else if (func_40(uParam0, 524288))
	{
		...
		{
			func_261(uParam2, -1);
			if (get_ground_z_for_3d_coord(vVar6, &uVar9, 0))
			{
				vVar6.z = uVar9;
				set_entity_coords(*uParam0.f_2, vVar6, 1, false, 0, 1);
			}
		}
...
void func_295(auto uParam0, int iParam1)
{
	if (does_entity_exist(func_278(uParam0, iParam1)) && !is_entity_dead(func_278(uParam0, iParam1), 0))
	{
		if (!has_entity_clear_los_to_entity(func_278(uParam0, iParam1), player_ped_id(), 17))
		{
		...
		{
			task_smart_flee_ped(func_278(uParam0, iParam1), player_ped_id(), 150f, -1, 0, 0);
		}
		if (is_ped_in_melee_combat(func_278(uParam0, iParam1)))
		{
			clear_ped_tasks(func_278(uParam0, iParam1));
			task_smart_flee_ped(func_278(uParam0, iParam1), player_ped_id(), 150f, -1, 0, 0);
		}
	}
...
void func_297(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	int iVar3;
	...
	func_54(uParam0, 2);
	func_44(uParam1, uParam0);
	if (!is_ped_injured(func_278(uParam0, 0)))
	{
		...
		set_entity_coords(func_278(uParam0, 0), -1241.802f, 107.3439f, 55.7186f, 1, false, 0, 1);
		set_entity_heading(func_278(uParam0, 0), 342.8433f);
	}
	if (!is_ped_injured(func_278(uParam0, 1)))
	{
		vVar0 = {-1236.201f, 112.7829f, 56.23418f};
		iVar3 = func_303(uParam0, 1);
		clear_ped_tasks_immediately(func_278(uParam0, 1));
		if (does_entity_exist(iVar3))
		{
			delete_object(&iVar3);
		}
		...
		set_entity_coords(func_278(uParam0, 1), -1243.465f, 104.3183f, 55.5857f, 1, false, 0, 1);
		set_entity_heading(func_278(uParam0, 1), 306.093f);
	}
	if (does_entity_exist(func_288(uParam0, 0)) && is_vehicle_driveable(func_288(uParam0, 0), 0))
	{
		set_entity_coords(func_288(uParam0, 0), -1257.234f, 94.0251f, 54.784f, 0, false, 0, 1);
		set_entity_heading(func_288(uParam0, 0), 240.9284f);
	}
	func_271(uParam0, 2);
}

void func_298(auto uParam0, int iParam1, float fParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return;
...
void func_299(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return;
...
void func_301(auto uParam0, int iParam1, auto uParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return;
...
void func_302(auto uParam0, int iParam1, Vector3 vParam2)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return;
...
int func_303(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_15)
	{
		return 0;
...
void func_306(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	{
		if (!does_entity_exist(func_288(uParam1, iVar4)))
		{
			if (iVar4 == 1)
			{
				vVar5 = {Vector(10f, 10f, 10f) * get_entity_forward_vector(func_288(uParam1, 0))};
			}
			if (func_43(func_321(uParam0, iParam2) + vVar5, func_41(uParam0, func_307(uParam1)), &vVar0, &fVar3))
			{
				func_279(uParam1, create_vehicle(joaat("caddy"), vVar0, fVar3, 1, true), iVar4);
				set_vehicle_extra(func_288(uParam1, iVar4), 5, true);
				_0x3910051CCECDB00C(func_288(uParam1, iVar4), true);
			}
		}
		iVar4++;
	}
...
void func_308(auto uParam0, auto uParam1, int iParam2)
{
	Vector3 vVar0;
	int iVar3;
	int iVar4;
	...
	if (!does_entity_exist(func_278(uParam1, iParam2)))
	{
		...
		{
			set_ped_weapon_movement_clipset(func_278(uParam1, iParam2), "move_m@golfer@");
		}
		_0x2F3C3D9F50681DE4(func_278(uParam1, iParam2), 1);
	}
}
...
void func_309(auto uParam0, int iParam1, int iParam2)
{
	...
	func_310(uParam0.f_15[iParam1 /*34*/], iParam2);
}
...
{
	if (get_random_float_in_range(0f, 1065353216) < fParam1)
	{
		*iParam0 = 4;
...
void func_313(auto uParam0, auto uParam1)
{
	*uParam0.f_1 = uParam1;
}

auto func_314(auto uParam0)
{
	return *uParam0.f_156;
}

void func_315(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	func_54(uParam1, iParam2);
	func_318(uParam1, iParam3);
...
void func_317(auto uParam0, int iParam1, int iParam2)
{
...
Vector3 func_321(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= *uParam0.f_28)
	{
		return 0f, 0f, 0f;
...
bool func_324(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_325(auto uParam0, auto uParam1)
{
	*uParam0 = uParam1;
}
...
void func_333(auto uParam0)
{
	...
	{
		*uParam0[iVar0 /*3*/] = vdist(func_321(uParam0, iVar0), func_243(uParam0, iVar0)) + vdist(func_243(uParam0, iVar0), func_41(uParam0, iVar0));
