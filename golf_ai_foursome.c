...
void func_1(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	...
	*uParam2.f_165++;
	...
	while (iVar0 < func_314(uParam2))
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(func_293(uParam2.f_15[iVar0 /*34*/]), 0) && !func_292(uParam2, iVar0, 16777216))
			{
				func_290(uParam2);
				return;
			}
	...
	switch (func_270(uParam2))
	{
		case 5:
			...
			{
				if ((((ENTITY::DOES_ENTITY_EXIST(func_268(uParam2, *uParam2.f_165)) && !ENTITY::IS_ENTITY_DEAD(func_268(uParam2, *uParam2.f_165), 0)) && ENTITY::DOES_ENTITY_EXIST(func_278(uParam2, *uParam2.f_165))) && !func_292(uParam2, *uParam2.f_165, 16777216)) && func_267(func_268(uParam2, *uParam2.f_165), func_278(uParam2, *uParam2.f_165), 1) < 25f)
				{
					if (AI::GET_SCRIPT_TASK_STATUS(func_278(uParam2, *uParam2.f_165), -1794415470) != 1 && !func_292(uParam2, *uParam2.f_165, 67108864))
					{
				...
				else
				{
					...
					while (iVar0 < func_314(uParam2))
					{
						if (iVar0 != func_264(uParam2))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(func_278(uParam2, iVar0)) && !ENTITY::IS_ENTITY_DEAD(func_278(uParam2, iVar0), 0))
							{
...
bool func_18(auto uParam0, auto uParam1)
{
	...
	if (vdist2(ENTITY::GET_ENTITY_COORDS(func_64(uParam0), 1), func_41(uParam1, func_307(uParam0))) < IntToFloat(iVar1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_25(uParam0)) && !ENTITY::IS_ENTITY_DEAD(func_288(uParam0, func_247(uParam0)), 0))
		{
			if (vdist2(ENTITY::GET_ENTITY_COORDS(func_25(uParam0), 1), func_41(uParam1, func_307(uParam0))) > IntToFloat(iVar1))
			{
				return true;
			}
...
void func_67(auto uParam0, auto uParam1, auto uParam2)
{
	...
	switch (func_34(uParam2))
	{
		...
		case 4:
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), *(uParam2.f_15[func_264(uParam2) /*34*/]).f_2))
				{
...
void func_89(auto uParam0, auto uParam1, auto uParam2)
{
	...
	*uParam2.f_1.f_6 = 0f;
	...
	{
		func_59(uParam2, ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_99(get_last_material_hit_by_entity(iVar0)));
		func_74(uParam2, 2);
...
void func_101(auto uParam0)
{
	...
	return;
	start_particle_fx_non_looped_at_coord("scr_golf_landing_water", ENTITY::GET_ENTITY_COORDS(func_244(uParam0), 1), 0f, 0f, func_242(ENTITY::GET_ENTITY_COORDS(func_244(uParam0), 1), func_19(uParam0)), 1f, 0, 0, 0);
}
...
void func_105(auto uParam0, auto uParam1, auto uParam2)
{
	...
	unk_0x0A25F80D5BADC013(ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_COORDS(iVar0, 1) + func_6(vVar17), 0, 0, 0, 255);
	if (func_100(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (has_entity_collided_with_anything(iVar0))
	{
		...
		if (!func_273(uParam0, 64))
		{
			...
			{
				_0x8BDC7BFC57A81E76(ENTITY::GET_ENTITY_COORDS(iVar0, 1) + Vector(1f, 0f, 0f), &uVar6, &vVar27);
...
void func_106(auto uParam0)
{
	...
	if (!func_107(sVar0))
	{
		start_particle_fx_non_looped_at_coord(sVar0, ENTITY::GET_ENTITY_COORDS(func_244(uParam0), 1), 0f, 0f, func_242(ENTITY::GET_ENTITY_COORDS(func_244(uParam0), 1), func_19(uParam0)), 1f, 0, 0, 0);
	}
}
...
void func_203(auto uParam0, auto uParam1, Vector3 fParam2, int iParam3, auto uParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	else
	{
		...
		if (func_238() || func_185(uParam0))
		{
			...
			AI::TASK_PLAY_ANIM(false, "mini@golfai", "putt_approach_no_ball", 2f, -4f, -1, 0, 0, 0, 0, 0);
			AI::TASK_PLAY_ANIM(false, "mini@golfai", "putt_approach_no_ball", 4f, -4f, -1, 2, 0.999f, 0, 0, 0);
		}
		else
		{
			task_follow_nav_mesh_to_coord(false, vVar1, 1f, -1, 0.25f, 512, fParam2);
...
void func_248(auto uParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	...
	fVar1 = 144f;
	iVar10 = vdist2(ENTITY::GET_ENTITY_COORDS(func_288(uParam0, func_266(uParam0, iParam1)), 1), *(uParam0.f_15[iParam1 /*34*/].f_10)) < fVar1;
	...
	if (iVar10)
	{
		...
		if (!func_261(uParam0, -1))
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_278(uParam0, iVar3)) && !ENTITY::IS_ENTITY_DEAD(func_278(uParam0, iVar3), 0))
				{
		...
		else if ((vdist2(func_259(uParam0, iParam1), func_41(uParam2, func_307(uParam0))) < 1600f && vdist2(ENTITY::GET_ENTITY_COORDS(func_268(uParam0, iParam1), 1), func_41(uParam2, func_307(uParam0))) < 1600f) && !func_292(uParam0, iParam1, 67108864))
		{
		...
		{
			task_vehicle_park(func_278(uParam0, func_250(uParam0, iParam1)), func_268(uParam0, iParam1), ENTITY::GET_ENTITY_COORDS(func_268(uParam0, iParam1), 1), 0f, 3, 360f, 0);
			if (iParam3)
			{
...
bool func_256(auto uParam0, int iParam1)
{
	...
	while (iVar0 < func_314(uParam0))
	{
		if (iVar0 >= iParam1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(func_278(uParam0, iVar0), 0) && !ENTITY::IS_ENTITY_DEAD(func_268(uParam0, iVar0), 0))
			{
...
{
	if (ENTITY::DOES_ENTITY_EXIST(func_278(uParam0, iParam1)) && !ENTITY::IS_ENTITY_DEAD(func_278(uParam0, iParam1), 0))
	{
