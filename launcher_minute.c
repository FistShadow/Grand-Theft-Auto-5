...
void main()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_188(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608))
				{
...
bool func_168(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && !func_130()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_172(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_173(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, auto uParam8)
{
	auto uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_159(2))
		{
			if (!func_130())
			{
				if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && func_111(*iParam0.f_28[1])) && func_172(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			else if (((func_175(sParam5) && !*uParam10 == 1) && func_111(PLAYER::PLAYER_PED_ID())) && func_172(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_271("pause conversation");
				func_174(1);
				*uParam10 = 1;
			}
			if (func_172(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_177(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_172(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_180(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_172(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_182(iParam0);
				}
			}
...
bool func_197(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_198(PLAYER::PLAYER_PED_ID(), *uParam0.f_35[iVar0]))
							{
...
{
	return func_203(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_204(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
void func_237(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
...
bool func_252(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
...
void func_259(auto uParam0, int iParam1, int iParam2, int iParam3)
{
