			...
			case 9:
				...
				if (func_124(&Local_409, func_164(), 7f, 30f))
				{
					if (!func_167())
					{
						...
						{
							PED::SET_PED_CONFIG_FLAG(player_ped_id(), 26, true);
						}
...
void func_19(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_24(player_id())) && !func_21(player_id(), 0)) && !func_20())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_24(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
float func_90(int iParam0)
{
	if (func_96(iParam0))
	{
		...
		{
			return func_91(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
{
	*iParam0.f_1 = func_91(is_bit_set(*iParam0, 4)) - fParam1;
...
int func_125(auto uParam0, float fParam1)
{
	...
	else if (((is_entity_at_coord(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_126(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_111(uParam0, 1, fParam1);
	}
	return 0;
...
int func_154(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_155(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_155(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
{
	return shift_right(iParam0, 26) & 31 * func_198(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_149(player_ped_id(), *uParam0.f_3, 1) < 20f && func_127(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_127(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
float func_209(auto uParam0)
{
	...
	fVar0 = func_210(get_entity_coords(*uParam0.f_3, 1), vVar1);
	return fVar0;
}
...
{
	if (func_214() && get_game_timer() >= iParam0 + 1000)
	{
...
bool func_223(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (!is_entity_occluded(*uParam0.f_3) && func_148(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_381(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !is_entity_occluded(*uParam0.f_3)) || func_148(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
...
bool func_231(auto uParam0, int iParam1)
{
	...
	if (!func_235(uParam0, iParam1))
	{
		...
		if ((is_ped_injured(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_148(*uParam0.f_3, 1) > 400f)
		{
...
bool func_288(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_149(player_ped_id(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_96(&(Local_190[0 /*10*/].f_3))) && !func_96(&(Local_190[8 /*10*/].f_3))) && !func_96(&(Local_190[5 /*10*/].f_3))) && !func_96(&(Local_190[9 /*10*/].f_3))) && !func_96(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_96(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(get_entity_coords(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_149(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!is_entity_dead(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
...
int func_334(int iParam0)
{
	...
	vVar24 = {vVar24};
	return func_335(get_entity_coords(iParam0, 1), vVar15, vVar18, vVar21);
}
...
bool func_374(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_375(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_148(iParam0, 1) < 1.5f)
		{
			return true;
		}
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_149(player_ped_id(), iParam0, 1) < 40f)
						{
...
void func_400()
{
	if (!is_ped_injured(player_ped_id()))
	{
		PED::SET_PED_CONFIG_FLAG(player_ped_id(), 26, false);
	}
	func_401();
	func_104();
