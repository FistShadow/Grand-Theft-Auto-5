	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_149(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_127(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_127(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
bool func_288(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_149(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
