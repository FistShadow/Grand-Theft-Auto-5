#region Local Var
	...
	auto uLocal_936 = 0;
	auto uLocal_937 = 0;
	auto uLocal_938 = 1097859072;
	auto uLocal_939 = 1500;
	auto uLocal_940 = 45;
	auto uLocal_941 = 1103626240;
	auto uLocal_942 = 5;
	int iLocal_943 = 0;
	auto uLocal_944 = 0;
	auto uLocal_945 = 0;
	...
	int iLocal_954 = 0;
	int iLocal_955 = 0;
	float[] fLocal_956 = new float[7];
	float[] fLocal_964 = new float[22];
	float[] fLocal_987 = new float[22];
	int iLocal_1010 = 0;
	int iLocal_1011 = 0;
	int iLocal_1012 = 0;
	int iLocal_1013 = 0;
	...
	else
	{
		...
		switch (Local_409.f_410)
		{
			...
			case 1:
				...
				{
					func_261();
					func_260(&(vLocal_840[0 /*3*/]), "TAXI_SC_BN_03", 200);
					func_259(&Local_409, &vLocal_840);
			...
			case 3:
				if (func_231(&Local_409, 1))
				{
					...
					{
						set_ped_component_variation(Local_409.f_3, false, false, false, 0);
						set_ped_component_variation(Local_409.f_3, 2, true, false, 0);
						set_ped_component_variation(Local_409.f_3, 3, true, false, 0);
						set_ped_component_variation(Local_409.f_3, 4, false, true, 0);
						set_ped_component_variation(Local_409.f_3, 8, true, true, 0);
					}
			...
			case 9:
				func_169();
				if (func_168(&iLocal_852) > fLocal_847 + 10f)
				{
					if (!func_167())
					{
				...
				if (func_105(&Local_409, 1))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_409.f_3, 0))
					{
						...
						else
						{
							...
							task_follow_nav_mesh_to_coord(false, Local_409.f_29, 2f, 20000, 0.25f, 0, 1193033728);
							task_follow_nav_mesh_to_coord(false, 322.1072f, 442.4288f, 140.6772f, 2f, 20000, 0.25f, 0, 1193033728);
							task_start_scenario_in_place(false, "WORLD_HUMAN_STAND_MOBILE", 0, 0);
							close_sequence_task(iLocal_848);
							task_perform_sequence(Local_409.f_3, iLocal_848);
							set_ped_keep_task(Local_409.f_3, true);
						}
					}
...
void func_10(auto uParam0, int iParam1)
{
	...
	if (func_18(Global_101154.f_17787, 4))
	{
		...
		set_vehicle_model_is_suppressed(func_15(), false);
	}
	if (iParam1)
	{
		func_14(uParam0);
	...
	playstats_oddjob_done(round(func_168(&iLocal_90) * 1000f), 12, 0);
}
...
int func_18(auto uParam0, int iParam1)
{
...
void func_19(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_24(player_id())) && !func_21(player_id(), 0)) && !func_20())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_24(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_26(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_33(Vector3 vParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_35(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_93(auto uParam0, Vector3 fParam1)
{
...
int func_101(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
void func_103(int iParam0)
{
	...
	{
		func_104();
		set_state_of_closest_door_of_type(joaat("prop_casino_door_01l"), 929.6144f, 46.3955f, 80.0993f, iParam0, 0f, 0);
		set_state_of_closest_door_of_type(joaat("prop_casino_door_01r"), 928.6238f, 44.9848f, 80.0993f, iParam0, 0f, 0);
		set_state_of_closest_door_of_type(joaat("prop_casino_door_01l"), 928.1625f, 43.7989f, 79.8993f, iParam0, 0f, 0);
		set_state_of_closest_door_of_type(joaat("prop_casino_door_01r"), 927.4266f, 42.1881f, 80.0884f, iParam0, 0f, 0);
	}
	else
	{
		_door_control(joaat("prop_casino_door_01l"), 929.6144f, 46.3955f, 80.0993f, iParam0, 0f, 50f, 0);
		_door_control(joaat("prop_casino_door_01r"), 928.6238f, 44.9848f, 80.0993f, iParam0, 0f, 50f, 0);
		_door_control(joaat("prop_casino_door_01l"), 928.1625f, 43.7989f, 79.8993f, iParam0, 0f, 50f, 0);
		_door_control(joaat("prop_casino_door_01r"), 927.4266f, 42.1881f, 80.0884f, iParam0, 0f, 50f, 0);
	}
}

void func_104()
{
	_door_control(joaat("prop_casino_door_01l"), 929.6144f, 46.3955f, 80.0993f, true, 1f, 50f, 0);
	_door_control(joaat("prop_casino_door_01r"), 928.6238f, 44.9848f, 80.0993f, true, 1f, 50f, 0);
	_door_control(joaat("prop_casino_door_01l"), 928.1625f, 43.7989f, 79.8993f, true, 1f, 50f, 0);
	_door_control(joaat("prop_casino_door_01r"), 927.4266f, 42.1881f, 80.0884f, true, 1f, 50f, 0);
}
...
void func_107(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_111(auto uParam0, int iParam1, float fParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
int func_124(auto uParam0, float fParam1, float fParam2, float fParam3)
{
	if ((((is_screen_faded_in() && !is_screen_fading_in()) && !is_screen_fading_out()) && !is_screen_faded_out()) && !*uParam0.f_142)
	{
		if (func_146(uParam0))
		{
			...
			func_128(uParam0);
			return func_125(uParam0, fParam1);
		}
	}
	return 0;
}

int func_125(auto uParam0, float fParam1)
{
	if (func_54(uParam0) == 2)
	{
		...
		if (((func_127(*uParam0.f_4, *uParam0.f_17, 1) <= fParam1 + 1f && get_player_wanted_level(get_player_index()) < 1) && func_126(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
		{
			return func_111(uParam0, 1, fParam1);
		}
	}
	else if (((ENTITY::IS_ENTITY_AT_COORD(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_126(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_111(uParam0, 1, fParam1);
	}
	return 0;
...
auto func_127(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_128(auto uParam0)
{
	...
	if ((func_114(uParam0) && func_18(*uParam0.f_81, 67108864)) && get_player_wanted_level(player_id()) == 0)
	{
...
float func_129(Vector3 vParam0, int iParam1)
{
	return func_130(get_player_ped(get_player_index()), vParam0, iParam3);
}

float func_130(int iParam0, Vector3 vParam1, int iParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		return -1f;
...
void func_131(auto uParam0, float fParam1, float fParam2)
{
	if (func_114(uParam0) && func_18(*uParam0.f_44, 4))
	{
		if ((is_vehicle_stopped(*uParam0.f_4) || get_entity_speed(*uParam0.f_4) < 3f) && func_135(uParam0))
		{
		...
		switch (*uParam0.f_412)
		{
			case 0:
				if (get_player_wanted_level(get_player_index()) >= 1)
				{
					...
					{
						func_144(uParam0, get_player_wanted_level(get_player_index()));
						if (*uParam0.f_410 != 22)
						{
			...
			case 3:
				if (is_player_wanted_level_greater(get_player_index(), func_142(uParam0)))
				{
					func_144(uParam0, get_player_wanted_level(get_player_index()));
					func_43(6, 0);
				}
...
auto func_143(char* sParam0, int iParam1, char* sParam2)
{
...
void func_145(auto uParam0, auto uParam1)
{
...
{
	return func_149(get_player_ped(get_player_index()), iParam0, iParam1);
}

auto func_149(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_154(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_155(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_155(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_155(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_169()
{
	...
	iVar0 = round(fLocal_847 - func_168(&iLocal_852) * 1000f);
	if (iVar0 < 0)
	{
		iVar0 = false;
		iLocal_1010 = true;
...
void func_177(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
struct<2> func_182(int iParam0)
{
	...
	StringCopy(&sVar2, func_184(func_186(iParam0)), 4);
	StringConCat(&cVar0, &sVar2, 8);
	StringConCat(&cVar0, ":", 8);
	if (func_183(iParam0) < 10)
	{
		StringConCat(&cVar0, "0", 8);
	}
	StringCopy(&sVar3, func_184(func_183(iParam0)), 4);
	StringConCat(&cVar0, &sVar3, 8);
	return cVar0;
}
...
{
	if (func_183(*uParam0) + iParam1 > 59)
	{
		func_189(uParam0, func_183(*uParam0) + iParam1 - 60);
		func_190(uParam0, 1);
	}
	else
	{
		func_189(uParam0, func_183(*uParam0) + iParam1);
	}
}
...
{
	if (func_186(*uParam0) + iParam1 > 23)
	{
		func_191(uParam0, func_186(*uParam0) + iParam1 - 24);
	}
	else
	{
		func_191(uParam0, func_186(*uParam0) + iParam1);
	}
}
...
{
	return shift_right(iParam0, 26) & 31 * func_198(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
bool func_202(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 || ((func_149(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_127(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_127(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
bool func_204(auto uParam0)
{
	...
	switch (iLocal_86)
	{
		...
		case 2:
			...
			iVar12 = func_212(uParam0.f_409, get_offset_from_entity_in_world_coords(*uParam0.f_4, 0f, 2.2f, 0.275f), get_offset_from_entity_in_world_coords(*uParam0.f_4, vVar0), 1);
			if (iVar12 == 1)
			{
				vVar0.z += 1.5f;
				if (*uParam0.f_7 == 2)
			...
			if (iVar12 != -1)
			{
				...
				set_entity_heading(*uParam0.f_3, func_209(uParam0));
		...
		case 7:
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(*uParam0.f_4, 0))
			{
				if (!is_ped_in_any_vehicle(*uParam0.f_3, 0))
				{
					...
					set_vehicle_door_shut(*uParam0.f_4, func_207(*uParam0.f_7), 1);
				}
				render_script_cams(false, false, 3000, 1, 0, 0);
				destroy_cam(*uParam0, 0);
...
void func_208(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
...
float func_210(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
...
int func_212(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3)
{
	auto uVar0;
	auto uVar3;
	int iVar6;
...
bool func_218(auto uParam0)
{
	if ((get_entity_speed(*uParam0.f_4) > 3f && func_381(uParam0, 5) > 15f) || is_entity_upsidedown(*uParam0.f_4))
	{
		return true;
	}
	return false;
...
int func_221(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_223(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
		if (!ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3) && func_148(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_381(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3)) || func_148(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
...
bool func_224(auto uParam0, float fParam1)
{
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_149(*uParam0.f_4, *uParam0.f_3, 0) <= fParam1 && !*uParam0.f_142) && absf(vVar0.z - vVar3.z) < 5f)
			{
				if (*uParam0.f_409 == 0)
				{
...
bool func_231(auto uParam0, int iParam1)
{
	...
	if (func_18(*uParam0.f_44, 8))
	{
		if (!func_18(*uParam0.f_44, 128))
		{
			if (is_ped_jacking(PLAYER::PLAYER_PED_ID()) && !func_18(*uParam0.f_44, 256))
			{
				func_55(uParam0.f_44, 256);
			}
			if (func_18(*uParam0.f_44, 256) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
	...
	if (!func_235(uParam0, iParam1))
	{
		...
		if ((PED::IS_PED_INJURED(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_148(*uParam0.f_3, 1) > 400f)
		{
...
{
	Local_343 = 0;
	func_256(32428/*func_258*/, 32403/*func_257*/, 1);
	func_256(32164/*func_254*/, 32141/*func_253*/, 1);
	func_256(32079/*func_252*/, 32054/*func_251*/, 1);
	func_256(31982/*func_250*/, 31958/*func_249*/, 1);
	func_256(31848/*func_248*/, 31827/*func_247*/, 1);
	func_256(31774/*func_245*/, 31749/*func_244*/, 1);
	func_256(31607/*func_241*/, 31584/*func_240*/, 1);
}
...
void func_242(auto uParam0, int iParam1)
{
	*uParam0.f_117 = 1;
...
int func_246(auto uParam0, int iParam1)
{
	return (uParam0 && iParam1) != 0;
}
...
bool func_249(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_253(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_257(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
void func_259(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_260(auto uParam0, char* sParam1, int iParam2)
{
	*uParam0 = 0;
	*uParam0.f_1 = iParam2;
	*uParam0.f_2 = sParam1;
...
bool func_262()
{
	...
	if (!has_scaleform_movie_loaded(iLocal_943))
	{
		return false;
	}
...
{
	return func_154(iParam0, !iParam1, iParam2);
}

bool func_267(auto uParam0, Vector3 vParam1, Vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_3))
	{
...
void func_268(auto uParam0, Vector3 vParam1)
{
...
void func_270(auto uParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
...
void func_274(auto uParam0, char* sParam1, int iParam2)
{
	struct<6> Var0;
	...
	func_402(2);
	Var0 = {func_289()};
	if ((!is_string_null_or_empty(&Var0) && func_167()) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, "NULL"))
	{
	}
	else
	{
...
bool func_276(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_283(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_285(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
		...
		AI::CLEAR_PED_TASKS(*uParam0.f_3);
		if ((func_130(*uParam0.f_3, *uParam0.f_29, 1) <= 200f && !func_109(*uParam0.f_29)) && !iParam2)
		{
			func_286(uParam0);
		}
		else
...
void func_287(auto uParam0, char* sParam1)
{
	if (func_288(uParam0))
	{
...
void func_291()
{
		...
		switch (Local_862.f_27)
		{
			case 0:
				if (Local_409.f_410 == 9)
				{
					...
					{
						if (func_322("TX_OBJ_DL_DO") || does_blip_exist(Local_409.f_9))
						{
							Local_862.f_27++;
						}
			...
			case 2:
				if (func_381(&Local_409, 18) > get_random_float_in_range(8f, 14f))
				{
	...
	func_292(&Local_409, &uLocal_892, &Local_862, iLocal_861);
}

bool func_292(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
...
int func_293(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
struct<6> func_298(auto uParam0)
{
	int iVar0;
	struct<6> Var1;
...
void func_301(auto uParam0, auto uParam1)
{
	struct<6> Var0;
	struct<6> Var6;
	int iVar12;
		...
		switch (func_321(uParam0))
		{
			...
			case 72:
				...
				else if (*uParam0.f_411 == 1)
				{
					...
					func_275(uParam0.f_244, *uParam0.f_144, &Var6, 8, 0, 0, 0);
				}
				else
				{
				...
				func_317(2, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_270(uParam0, 16, 0, 0);
				func_230(uParam0, 0, 0);
				break;
			...
			case 79:
				...
				{
					func_311(uParam0, 4096, Var0, "_sideW1", iVar24, 8);
				}
				else if (!func_18(*uParam0.f_81, 8192))
				{
					func_311(uParam0, 8192, Var0, "_sideW2", iVar24, 8);
				}
			...
			case 80:
				...
				{
					func_311(uParam0, 16384, Var0, "_opLne1", iVar24, 8);
				}
				else if (!func_18(*uParam0.f_81, 32768))
				{
					func_311(uParam0, 32768, Var0, "_opLne2", iVar24, 8);
				}
					...
					if (!*uParam0.f_109 && !func_167())
					{
						switch (*uParam0.f_414)
						{
							...
							case 8:
								...
								func_318(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
								func_317(23, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
								func_270(uParam0, 16, 0, 0);
								func_230(uParam0, 0, 0);
								break;
			...
			case 67:
				...
				func_318(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_317(16, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_270(uParam0, 16, 0, 0);
				func_230(uParam0, 0, 0);
				break;
...
void func_302(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_303(auto uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
...
void func_304(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_55(uParam0.f_82, iParam1);
	func_270(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_306(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_307(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_308(char[24] cParam0, auto uParam1)
{
	int iVar0;
...
void func_311(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_55(uParam0.f_81, iParam1);
	func_270(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
int func_312(Vector3 vParam0, int iParam1)
{
	int iVar0;
...
void func_313(auto uParam0, char[24] cParam1, char* sParam2)
{
	func_270(uParam0, 16, 0, 0);
	func_270(uParam0, 17, 0f, 1);
	...
	if (!PED::IS_PED_INJURED(*uParam0.f_3))
	{
		interrupt_conversation(*uParam0.f_3, &cParam1, func_314(uParam0));
	}
}

char* func_314(auto uParam0)
{
	char* sVar0;
...
char* func_315(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 72:
...
int func_316(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_270(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_317(int iParam0, auto uParam1, auto uParam2, auto uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
int func_324(auto uParam0, auto uParam1)
{
...
void func_327(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_411 == 0)
	{
		if (get_player_wanted_level(player_id()) == 0)
...
bool func_328(auto uParam0)
{
	...
	{
		if ((!is_ped_stopped(*uParam0.f_2) && !func_96(&(Local_190[0 /*10*/].f_3))) && !func_96(&(Local_190[1 /*10*/].f_3)))
		{
...
bool func_331(auto uParam0)
{
	...
	if ((((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_96(&(Local_190[0 /*10*/].f_3))) && !func_96(&(Local_190[1 /*10*/].f_3))) && !func_96(&(Local_190[5 /*10*/].f_3))) && !func_96(&(Local_190[9 /*10*/].f_3))) && !func_96(&(Local_190[7 /*10*/].f_3))) && !func_96(&(Local_190[8 /*10*/].f_3)))
	{
		vVar0 = {get_entity_speed_vector(*uParam0.f_4, 1)};
		if (absf(vVar0.x) > 2.5f && !func_96(&(Local_190[0 /*10*/].f_3)))
		{
...
{
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_96(&(Local_190[0 /*10*/].f_3))) && !func_96(&(Local_190[8 /*10*/].f_3))) && !func_96(&(Local_190[5 /*10*/].f_3))) && !func_96(&(Local_190[9 /*10*/].f_3))) && !func_96(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_96(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(ENTITY::GET_ENTITY_COORDS(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_149(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
					func_181(&(Local_190[14 /*10*/].f_3));
				}
			}
		}
		else if ((func_90(&(Local_190[14 /*10*/].f_3)) < 1.5f && func_149(*uParam0.f_5, *uParam0.f_4, 1) > 4.5f) && !has_entity_been_damaged_by_any_vehicle(*uParam0.f_5))
		{
...
{
	if (((is_vehicle_driveable(*uParam0.f_4, 0) && !func_96(&(Local_190[9 /*10*/].f_3))) && !func_96(&(Local_190[7 /*10*/].f_3))) && !func_96(&(Local_190[4 /*10*/].f_3)))
	{
		if (!func_334(*uParam0.f_4) && get_entity_speed(*uParam0.f_4) > 15f)
		{
...
int func_334(int iParam0)
{
	...
	vVar9 = {func_338(vVar3.x - vVar0.x, vVar3.y - vVar0.y, 0f)};
	vVar12 = {func_337(vVar9, 0) * Vector(fVar27, fVar27, fVar27)};
	...
	vVar24 = {vVar24};
	return func_335(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar15, vVar18, vVar21);
}

bool func_335(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	...
	vParam6.z = 0f;
	vParam9.z = 0f;
	vVar0 = {func_338(vParam6 - vParam3)};
	vVar3 = {func_338(vParam9 - vParam3)};
	fVar6 = func_336(vParam0, vVar0);
	fVar7 = func_336(vParam3, vVar0);
	fVar8 = func_336(vParam6, vVar0);
	fVar9 = func_336(vParam0, vVar3);
	fVar10 = func_336(vParam3, vVar3);
	fVar11 = func_336(vParam9, vVar3);
	if (fVar7 > fVar8)
	{
		fVar12 = fVar7;
		fVar7 = fVar8;
...
float func_336(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}

Vector3 func_337(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
...
Vector3 func_338(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_344(auto uParam0)
{
	...
	{
		vVar0 = {get_entity_speed_vector(*uParam0.f_4, 1)};
		if (absf(vVar0.x) > 3f && !func_96(&(Local_190[0 /*10*/].f_3)))
		{
...
void func_348(auto uParam0, auto uParam1)
{
...
void func_352(auto uParam0)
{
	...
	if (*uParam0.f_410 >= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_4))
		{
			if (Local_343 > 0 && !func_246(Local_343.f_1[4 /*4*/], 4))
			{
				iVar0 = 0;
				iVar0 = 0;
...
void func_353(auto uParam0, auto uParam1, int iParam2)
{
	if (!func_18(*uParam0.f_55, 1))
	{
		switch (*uParam1)
		{
			case 0:
				if (!is_string_null_or_empty(uParam0.f_124) && func_167())
				{
					*uParam1++;
				}
				break;
...
void func_354()
{
	if (round(func_381(&Local_409, 7) * 1000f) % 10000 < 50)
	{
	}
...
bool func_358(auto uParam0, int iParam1, float fParam2)
{
	if (*uParam0.f_410 < 29)
	{
...
bool func_359(auto uParam0, auto uParam1)
{
	auto uVar0;
	...
	if ((((!is_player_control_on(player_id()) && (does_cam_exist(*uParam0) && !is_cam_active(*uParam0))) && (does_cam_exist(*uParam0.f_1) && !is_cam_active(*uParam0.f_1))) && !is_message_being_displayed()) && !func_167())
	{
...
void func_360(auto uParam0)
{
	if (!func_367(*uParam0.f_429))
	{
		*uParam0.f_429 = func_192();
		func_365(uParam0.f_429, 0, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4, 7), 0, 0, 0);
	}
...
void func_366(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (is_vehicle_driveable(iVar0, 0))
			{
				if (get_ped_in_vehicle_seat(iVar0, -1) == PLAYER::PLAYER_PED_ID())
				{
					if (is_vehicle_model(iVar0, func_15()))
					{
						return true;
					}
				}
...
void func_371(auto uParam0, auto uParam1, auto uParam2)
{
	switch (*uParam1)
	{
		case 1:
...
bool func_372(auto uParam0, int iParam1, int iParam2)
{
...
bool func_373(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		if (!func_18(*uParam2, 4))
		{
			if (func_377(iVar0, iParam0, uParam2, iParam5))
			{
				*uParam3 = 4;
				return true;
			}
		...
		iVar1 = !func_18(*uParam2, 128);
		if (iParam4)
		{
			if (func_374(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_374(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_374(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_148(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
bool func_376(int iParam0, int iParam1, auto uParam2)
{
...
bool func_377(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_378(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
...
bool func_379(int iParam0, auto uParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
float func_381(auto uParam0, int iParam1)
{
...
bool func_384(auto uParam0, int iParam1)
{
	if (iParam1)
	{
		return true;
...
void func_392(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
void func_393(auto uParam0)
{
	...
	switch (*uParam0.f_411)
	{
		...
		case 9:
			func_397(uParam0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 17));
			iVar0 = func_395(*uParam0.f_418.f_2 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 17), 0, 16);
