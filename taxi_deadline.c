...
void func_93(var uParam0, Vector3 fParam1)
{
...
bool func_111(var uParam0, int iParam1, float fParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
int func_124(var uParam0, float fParam1, float fParam2, float fParam3)
{
...
var func_127(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
var func_143(char* sParam0, int iParam1, char* sParam2)
{
...
var func_149(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_208(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
...
float func_210(struct<2> Param0, Vector3 fParam1, struct<2> Param2, var uParam3)
{
...
int func_212(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)
{
	var uVar0;
	var uVar3;
	int iVar6;
...
bool func_253(var uParam0, var uParam1)
{
	uParam1 = uParam1;
...
bool func_267(var uParam0, vector3 vParam1, vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!does_entity_exist(*uParam0.f_3))
	{
...
bool func_292(var uParam0, var uParam1, var uParam2, int iParam3)
{
...
void func_302(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_303(var uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
...
void func_304(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_55(uParam0.f_82, iParam1);
	func_270(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_306(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_307(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_308(char[24] cParam0, var uParam1)
{
	int iVar0;
...
void func_311(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_55(uParam0.f_81, iParam1);
	func_270(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_313(var uParam0, char[24] cParam1, char* sParam2)
{
	func_270(uParam0, 16, 0, 0);
	func_270(uParam0, 17, 0f, 1);
...
int func_316(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_270(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_317(int iParam0, var uParam1, var uParam2, var uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
bool func_373(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
...
bool func_377(int iParam0, int iParam1, var uParam2, int iParam3)
{
	vector3 vVar0;
	int iVar3;
