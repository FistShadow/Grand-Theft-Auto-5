...
bool func_33(int iParam0)
{
	...
	switch (iLocal_160)
	{
		case 0:
			...
			iLocal_160 = 1;
			stop_fire_in_range(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f);
			break;
		...
		case 1:
			...
			vVar0 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - get_gameplay_cam_coord()};
	...
	if (func_53(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_346)
		{
			if (func_69(&(Local_346[iVar0 /*19*/])))
			{
				...
				task_smart_flee_coord(Local_346[iVar0 /*19*/].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
			...
			if (iVar1 != 0 && iVar1 != 1993361168)
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						{
							if (GAMEPLAY::IS_BIT_SET(*(uParam1[iVar5 /*3*/]).f_2, iVar6) && has_ped_got_weapon(iParam0, iVar3, 0))
							{
			...
			if (iVar8 != -1 && !func_267(Var9.f_1))
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						{
							if (GAMEPLAY::IS_BIT_SET(*(uParam1.f_133[iVar70 /*3*/]).f_2, iVar6) && has_ped_got_weapon(iParam0, iVar3, 0))
							{
								set_ped_weapon_tint_index(iParam0, iVar3, iVar6 - 20);
								iVar6 = false;
							}
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_316(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_332(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_341())
		{
			*uParam0 = func_337(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_334(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_78() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_138(func_335(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_337(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_340(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_338(iVar0, 0), 1);
...
auto func_342()
{
	...
	func_350(&uVar0, TIME::GET_CLOCK_HOURS());
...
{
	return shift_right(iParam0, 26) & 31 * func_348(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
float func_371(auto uParam0)
{
	if (func_374(uParam0))
	{
		...
		{
			return func_372(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - *uParam0.f_1;
		}
	}
	return *uParam0.f_1;
}
...
{
	*iParam0.f_1 = func_372(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1;
...
void func_383(int iParam0)
{
	...
	fVar0 = func_384(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
bool func_391(auto uParam0)
{
	...
	ENTITY::SET_ENTITY_HEALTH(Local_834[uParam0 /*11*/], 100);
...
bool func_400(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	*uParam0.f_3 = create_vehicle(iLocal_546, vParam1, fParam4, 1, 1);
	...
	ENTITY::SET_ENTITY_HEALTH(*uParam0.f_3, floor(fVar0));
	*uParam0.f_8 = 0;
	*uParam0.f_9 = 0;
...
bool func_431(auto uParam0, char* sParam1, Vector3 fParam2)
{
	if (*uParam0.f_2 == 0)
	{
		if (!is_entity_playing_anim(*uParam0.f_3, sLocal_343, sParam1, 3))
		{
			...
			AI::TASK_PLAY_ANIM(*uParam0.f_3, sLocal_343, uParam0.f_7, 8f, -1f, -1, 0, fParam2, 0, 0, 0);
		}
		else
		{
			return true;
...
bool func_434(auto uParam0, int iParam1)
{
	...
	switch (*uParam0[iParam1 /*7*/])
	{
		...
		case 4:
			if (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK(*(uParam0[iParam1 /*7*/]).f_3, false))
			{
				return false;
			}
			break;
...
bool func_435(auto uParam0, int iParam1)
{
	...
	switch (*uParam0[iParam1 /*7*/])
	{
		...
		case 4:
			AUDIO::REQUEST_SCRIPT_AUDIO_BANK(*(uParam0[iParam1 /*7*/]).f_3, false);
			break;
...
bool func_452(auto uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)
{
	...
	switch (iParam2)
	{
		...
		case 4:
			AUDIO::REQUEST_SCRIPT_AUDIO_BANK(sParam3, false);
			break;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_482(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_479(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
void func_490(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_41(PLAYER::PLAYER_PED_ID()))
	{
		if (iParam2 == 1)
		{
			clear_area_of_peds(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0);
		}
		if (iParam3 == 1)
		{
...
bool func_499(auto uParam0)
{
	...
	if (iLocal_159 != 9)
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vLocal_169, 1) > fLocal_172)
		{
			return false;
		}
	}
...
bool func_505(auto uParam0)
{
	...
	if (*uParam0.f_9 == 0)
	{
		if (func_515(*uParam0.f_3, PLAYER::PLAYER_PED_ID(), 1) < fLocal_581 || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*uParam0.f_3, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	if (iLocal_213)
	{
		if (*uParam0.f_9 == 0)
		{
			func_514(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), fLocal_581, 255, 0, 0, 255, 32);
		}
		else
		{
			func_514(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), fLocal_581, 0, 0, 255, 255, 32);
		}
	}
	switch (*uParam0.f_2)
	{
		...
		case 16:
			if (GAMEPLAY::GET_GAME_TIMER() > *uParam0.f_6)
			{
				start_particle_fx_non_looped_at_coord("scr_clown_death", ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 0), get_entity_rotation(*uParam0.f_3, 2), 3f, 0, 0, 0);
		...
		case 17:
			if (GAMEPLAY::GET_GAME_TIMER() > *uParam0.f_6)
			{
				*uParam0.f_5 -= get_frame_time() * 512f;
				...
				if (*uParam0.f_5 <= 0f)
				{
					stop_fire_in_range(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), 2f);
...
void func_520(auto uParam0)
{
	...
	if (!func_531(uParam0))
	{
		if ((ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0) || PED::IS_PED_INJURED(*uParam0.f_3)) || PED::IS_PED_DEAD_OR_DYING(*uParam0.f_3, 0))
		{
			...
			func_530("CLOWN_DEATH", "CLOWNS", ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), 10);
			*uParam0.f_2 = 15;
	...
	switch (*uParam0.f_2)
	{
		...
		case 3:
			...
			freeze_entity_position(*uParam0.f_3, true);
			set_entity_invincible(*uParam0.f_3, true);
			start_particle_fx_non_looped_at_coord("scr_clown_appears", ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), get_entity_rotation(*uParam0.f_3, 2), 1.5f, 0, 0, 0);
		...
		case 12:
			...
			if (func_529(uParam0) == 4 && AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) <= 1)
			{
				return;
			}
...
void func_534(int iParam0)
{
	if (Local_834[iParam0 /*11*/].f_1 == iLocal_808)
	{
		...
		{
			AI::TASK_PLAY_ANIM(Local_834[iParam0 /*11*/], sLocal_814, sLocal_815, 8f, -8f, -1, 1, get_random_float_in_range(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!is_entity_playing_anim(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 3))
	{
		AI::TASK_PLAY_ANIM(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 8f, -8f, -1, 1, get_random_float_in_range(0f, 0.5f), 0, 0, 0);
	}
}
	...
	while (iVar3 < Local_834)
	{
		if (iVar3 != iParam0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar3 /*11*/]))
			{
				...
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, ENTITY::GET_ENTITY_COORDS(Local_834[iVar3 /*11*/], 0), 0) < 20f)
					{
						return true;
					}
				}
