...
void func_2()
{
	if (GAMEPLAY::IS_BIT_SET(Local_128.f_1, 12) && !GAMEPLAY::IS_BIT_SET(Local_128.f_1, 17))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 24);
		}
	}
}
...
void func_5()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Local_128.f_1), 22);
		func_8(3);
		func_15(3);
	}
	...
	{
		GAMEPLAY::SET_BIT(&(Local_128.f_1), 18);
		func_8(4);
		func_15(3);
	}
}
...
void func_9()
{
	...
	while (iVar1 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar1)))
		{
			if (func_17() < 3)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Local_187[iVar1 /*4*/].f_1, 14))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, 17))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_128.f_1), 17);
					}
					iVar0++;
				}
			}
			...
			{
				GAMEPLAY::SET_BIT(&(Local_128.f_1), 12);
			}
		}
		iVar1++;
	}
	if (func_17() < 3)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 14);
		}
		...
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 15);
		}
		if (Local_128.f_34 == func_14())
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 13);
		}
		if (Local_128.f_35 == func_14())
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 21);
		}
		if (GAMEPLAY::IS_BIT_SET(Local_128.f_1, 12))
		{
			if (func_3(&(Local_128.f_49), func_10(), 0))
			{
				GAMEPLAY::SET_BIT(&(Local_128.f_1), 16);
			}
		}
	}
	else if (func_17() == 3)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 20);
		}
		else if (func_3(&(Local_128.f_51), 15000, 0))
		{
			GAMEPLAY::SET_BIT(&(Local_128.f_1), 23);
		}
	}
}
...
bool func_19()
{
	...
	if (!iLocal_97)
	{
		iLocal_96 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
...
void func_21(int iParam0)
{
	...
	if (iVar0 > 0)
	{
		iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, iVar0);
...
void func_87()
{
	switch (func_519())
	{
		...
		case 3:
			...
			{
				GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 21);
			}
			if (func_17() > 3)
			{
				func_499(4);
...
void func_122()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_187[participant_id_to_int() /*4*/].f_1, 20))
	{
		if (func_256())
		{
			GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 20);
			return;
		}
		if (func_108())
		{
...
int func_232(int iParam0)
{
	...
	if (func_239(iParam0))
	{
		...
		if (iVar1 < func_233(iParam0))
		{
			...
			{
				iVar0 += func_237(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
		...
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_25(iVar0)))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar0) && !GAMEPLAY::IS_BIT_SET(Local_187[participant_id_to_int() /*4*/].f_1, iVar0))
			{
				if (func_17() < 3)
				{
					...
					{
						func_428();
						GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 15);
						if (get_ped_in_vehicle_seat(net_to_veh(func_25(iVar0)), -1) == PLAYER::PLAYER_PED_ID())
						{
							GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 14);
						}
						if (!GAMEPLAY::IS_BIT_SET(iLocal_98, 4))
						{
							if (ENTITY::IS_ENTITY_AT_COORD(net_to_veh(func_25(iVar0)), func_24(iVar0), IntToFloat(func_427()), IntToFloat(func_427()), IntToFloat(func_427()), false, true, 0))
							{
						...
						while (iVar1 < func_14())
						{
							if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar1 + 4))
							{
								if (GAMEPLAY::IS_BIT_SET(Local_187[participant_id_to_int() /*4*/].f_1, 16))
								{
									...
									{
										if (ENTITY::IS_ENTITY_AT_COORD(net_to_veh(func_25(iVar0)), func_426(iVar1), 2f, 1f, 2f, true, true, 0))
										{
											func_425(net_to_veh(func_25(iVar0)), 4f, 1, 0.5f, 0, 0, 0);
											GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar0);
											GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar1 + 4);
											GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 18);
											GAMEPLAY::CLEAR_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 14);
											GAMEPLAY::CLEAR_BIT(&iLocal_98, 4);
											GAMEPLAY::CLEAR_BIT(&iLocal_98, 8);
											Var2.f_10 = player_id();
								...
								else if (ENTITY::IS_ENTITY_AT_COORD(net_to_veh(func_25(iVar0)), func_426(iVar1), IntToFloat(func_424()), IntToFloat(func_424()), IntToFloat(func_424()), false, true, 0))
								{
									...
									set_player_wanted_level_now(player_id(), 0);
									GAMEPLAY::CLEAR_BIT(&iLocal_98, 4);
									GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 16);
...
void func_430()
{
	...
	else if (!GAMEPLAY::IS_BIT_SET(Local_187[participant_id_to_int() /*4*/].f_1, 17))
	{
		...
		else
		{
			...
			{
				GAMEPLAY::CLEAR_BIT(&iLocal_98, 8);
				GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 17);
			}
...
void func_433()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_187[participant_id_to_int() /*4*/].f_1, 13))
	{
		if (func_6(player_id(), 1, 1))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_24(0), 100f, 100f, 100f, false, true, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 13);
			}
		}
...
void func_452(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_453())
	{
		return;
	}
		...
		while (iVar3 < func_14())
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_25(iVar3)) && !GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar3))
			{
				if (ENTITY::DOES_ENTITY_EXIST(net_to_veh(func_25(iVar3))) && ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
				{
					if (func_6(player_id(), 1, 1))
					{
						vLocal_110 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)};
					}
					if (!ENTITY::IS_ENTITY_DEAD(net_to_veh(func_25(iVar3)), 0))
					{
						if (func_465(vVar0))
						{
							vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(func_25(iVar3)), 1)};
							vLocal_113 = {vVar0};
						}
						else if (vdist(vLocal_110, vVar0) > vdist(vLocal_110, ENTITY::GET_ENTITY_COORDS(net_to_veh(func_25(iVar3)), 1)))
						{
							vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(func_25(iVar3)), 1)};
						}
					}
...
void func_466()
{
	...
	else
	{
		...
		while (iVar1 < func_14())
		{
			if ((((network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_25(iVar1)) && !ENTITY::IS_ENTITY_DEAD(net_to_veh(func_25(iVar1)), 0)) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(func_25(iVar1)), 0)) && !GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar1)) && !func_275())
			{
	...
	while (iVar0 < func_14())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar0))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_25(iVar0)))
			{
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(net_to_veh(func_25(iVar0)), 0))
					{
						if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(func_25(iVar0)), 0))
						{
							if (func_518(func_7(), 1))
...
void func_493()
{
		...
		if (!func_121())
		{
			if (func_518(func_7(), 1))
			{
				...
				else
				{
					...
					func_94(1);
					GAMEPLAY::SET_BIT(&iLocal_98, true);
				}
			}
			else
			{
	...
	else
	{
		...
		func_494();
		GAMEPLAY::SET_BIT(&iLocal_98, false);
		GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), 12);
	}
}
	...
	while (iVar2 < func_14())
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar2) && !GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar2 + 8))
		{
			if (player_id() == func_7())
			{
				...
				{
					if (ENTITY::IS_ENTITY_DEAD(net_to_veh(func_25(iVar2)), 0))
					{
						...
						{
							GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar2 + 8);
						}
					}
				}
			}
			...
			if (is_entity_a_vehicle(Var0))
			{
				...
				while (iVar10 < func_14())
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar10) && !GAMEPLAY::IS_BIT_SET(Local_128.f_1, iVar10 + 8))
					{
						...
						{
							if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_25(iVar10)) && ENTITY::IS_ENTITY_DEAD(net_to_veh(func_25(iVar10)), 0))
							{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && is_entity_a_ped(Var0.f_1))
							{
								if (get_ped_index_from_entity_index(Var0.f_1) == PLAYER::PLAYER_PED_ID())
								{
									if (func_108())
									{
										if (Var0.f_3)
										{
											GAMEPLAY::SET_BIT(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar10 + 8);
											func_528(func_76());
										}
									}
