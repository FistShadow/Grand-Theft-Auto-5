...
void func_1()
{
	switch (Local_128.f_55)
	{
		...
		case 3:
			if (is_bit_set(Local_128.f_1, 23))
			{
				func_15(4);
			}
			func_9();
...
void func_2()
{
	if (is_bit_set(Local_128.f_1, 12) && !is_bit_set(Local_128.f_1, 17))
	{
		if (func_3(&(Local_128.f_53), 600000, 0))
		{
			set_bit(&(Local_128.f_1), 24);
		}
	}
}
...
void func_5()
{
	if (is_bit_set(Local_128.f_1, 19))
	{
		func_8(2);
		func_15(3);
	}
	if (is_bit_set(Local_128.f_1, 22))
	{
		func_8(0);
		func_15(3);
	}
	if (is_bit_set(Local_128.f_1, 21))
	{
		func_8(1);
		func_15(3);
	}
	if (is_bit_set(Local_128.f_1, 16))
	{
		set_bit(&(Local_128.f_1), 22);
		func_8(3);
		func_15(3);
	}
	if (is_bit_set(Local_128.f_1, 13))
	{
		func_8(0);
		func_15(3);
	}
...
void func_9()
{
	...
	while (iVar1 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar1)))
		{
			if (func_17() < 3)
			{
				...
				while (iVar2 < func_14())
				{
					if (is_bit_set(Local_187[iVar1 /*4*/].f_1, iVar2) && !is_bit_set(Local_128.f_1, iVar2))
					{
						set_bit(&(Local_128.f_1), iVar2);
						Local_128.f_34++;
					}
					if (is_bit_set(Local_187[iVar1 /*4*/].f_1, iVar2 + 4) && !is_bit_set(Local_128.f_1, iVar2 + 4))
					{
						set_bit(&(Local_128.f_1), iVar2 + 4);
					}
					if (is_bit_set(Local_187[iVar1 /*4*/].f_1, iVar2 + 8) && !is_bit_set(Local_128.f_1, iVar2 + 8))
					{
						set_bit(&(Local_128.f_1), iVar2 + 8);
						Local_128.f_35++;
					}
					iVar2++;
				}
				if (is_bit_set(Local_187[iVar1 /*4*/].f_1, 14))
				{
					if (!is_bit_set(Local_128.f_1, 17))
					{
						func_11(int_to_playerindex(iVar1));
						set_bit(&(Local_128.f_1), 17);
					}
					iVar0++;
				}
			}
			...
			{
				if (is_bit_set(Local_187[iVar1 /*4*/].f_1, 21))
				{
					iVar0++;
				}
			}
			if (is_bit_set(Local_187[iVar1 /*4*/].f_1, 12))
			{
				set_bit(&(Local_128.f_1), 12);
			}
		}
		iVar1++;
	}
	if (func_17() < 3)
	{
		...
		{
			set_bit(&(Local_128.f_1), 14);
		}
		else if (iVar0 == 1 && is_bit_set(Local_128.f_1, 15))
		{
			set_bit(&(Local_128.f_1), 14);
		}
		else if (is_bit_set(Local_128.f_1, 14))
		{
			clear_bit(&(Local_128.f_1), 14);
		}
		...
		{
			set_bit(&(Local_128.f_1), 15);
		}
		if (Local_128.f_34 == func_14())
		{
			set_bit(&(Local_128.f_1), 13);
		}
		if (Local_128.f_35 == func_14())
		{
			set_bit(&(Local_128.f_1), 21);
		}
		if (is_bit_set(Local_128.f_1, 12))
		{
			if (func_3(&(Local_128.f_49), func_10(), 0))
			{
				set_bit(&(Local_128.f_1), 16);
			}
		}
	}
	else if (func_17() == 3)
	{
		...
		{
			set_bit(&(Local_128.f_1), 20);
		}
		else if (func_3(&(Local_128.f_51), 15000, 0))
		{
			set_bit(&(Local_128.f_1), 23);
		}
	}
}
...
bool func_22(var uParam0, int iParam1, vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_53(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_52(1);
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_62(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_53(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_52(1);
			}
...
void func_87()
{
	switch (func_519())
	{
		...
		case 2:
			if (is_bit_set(Local_128.f_1, 17) || is_bit_set(Local_128.f_1, 24))
			{
		...
		case 3:
			...
			func_487();
			func_418();
			if (((is_bit_set(iLocal_98, 11) && is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 20)) && !func_121()) && func_88(&uLocal_120, 1))
			{
				set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 21);
			}
			if (func_17() > 3)
			{
				func_499(4);
...
void func_93()
{
	...
	{
		if ((((((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_6(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out()) && !func_98(player_id(), 22)) && func_103(player_id()) != 0) && !func_96(func_97()))
		{
...
int func_103(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_119(iParam0) && !func_118(iParam0)) && !is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 8));
...
void func_122()
{
	...
	Var0.f_4 = 1;
	Var0.f_9 = -1;
	if (!is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 20))
	{
		if (func_256())
		{
			set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 20);
			return;
		}
		if (func_108())
		{
...
void func_141(int iParam0, int iParam1, var uParam2)
{
	...
	if (iVar1 > 0)
	{
		...
		func_206();
		func_157(0, player_ped_id(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
	}
	if (iVar0 > 0)
	{
...
void func_146(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_147(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_154(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
void func_159(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_161(player_ped_id()))
	{
		func_160(1);
	}
...
Vector3 func_162(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_163(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_167(vector3 vParam0, var uParam1, var uParam2)
{
	Vector3 fVar0;
	float fVar1;
	float fVar2;
...
var func_168(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
void func_257()
{
	...
	{
		if (is_bit_set(Local_128.f_1, 22) || is_bit_set(Local_128.f_1, 16))
		{
			iVar4 = func_138(1, 0);
		...
		else if (is_bit_set(Local_128.f_1, 18))
		{
...
int func_272(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int func_273(var uParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, var uParam10, var uParam11, var uParam12, var uParam13)
{
	struct<72> Var0;
...
void func_296(int iParam0)
{
	...
	if (Global_1727386 != 0)
	{
		if (is_bit_set(Global_1727386, true))
		{
			if (func_136())
			{
				if (func_297(82, "GB_INTTXT_YA", 2, 0, 0, 0, 0, 1, 0, 1))
				{
					clear_bit(&Global_1727386, true);
				}
			}
...
bool func_298(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_311()
{
	...
	{
		if (func_314(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_313(player_ped_id());
...
void func_315(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	if (func_415() || iParam2 == 24)
	{
		...
		{
			func_374(1);
			if ((!func_373() && !func_372()) || is_bit_set(Global_2460486.f_4426, true))
			{
				if (func_371())
				{
					func_369();
...
int func_320(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
...
void func_329(char* sParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_336(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, var uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, Vector3 fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_340(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_344(iParam3))
	{
...
bool func_371()
{
	if (is_bit_set(Global_2460486.f_4426, false) && func_121())
	{
		return true;
	}
	if (is_bit_set(Global_2460486.f_4426, true) && func_121())
	{
		return true;
	}
	return false;
...
bool func_375(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
...
void func_418()
{
	...
	if (!is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		clear_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 14);
		clear_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 15);
	}
	iVar0 = false;
	while (iVar0 < func_14())
	{
		if (network_does_entity_exist_with_network_id(func_25(iVar0)))
		{
			if (!is_bit_set(Local_128.f_1, iVar0) && !is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, iVar0))
			{
				if (func_17() < 3)
				{
					if (is_ped_in_vehicle(player_ped_id(), net_to_veh(func_25(iVar0)), 0))
					{
						func_428();
						set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 15);
						if (get_ped_in_vehicle_seat(net_to_veh(func_25(iVar0)), -1) == player_ped_id())
						{
							set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 14);
						}
						...
						while (iVar1 < func_14())
						{
							if (!is_bit_set(Local_128.f_1, iVar1 + 4))
							{
								if (is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 16))
								{
									if (get_player_wanted_level(player_id()) == 0 && get_ped_in_vehicle_seat(net_to_veh(func_25(iVar0)), -1) == player_ped_id())
									{
										if (is_entity_at_coord(net_to_veh(func_25(iVar0)), func_426(iVar1), 2f, 1f, 2f, true, true, 0))
										{
											...
											set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar0);
											set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar1 + 4);
											set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 18);
											clear_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 14);
											clear_bit(&iLocal_98, 4);
											clear_bit(&iLocal_98, 8);
											Var2.f_10 = player_id();
								...
								else if (is_entity_at_coord(net_to_veh(func_25(iVar0)), func_426(iVar1), IntToFloat(func_424()), IntToFloat(func_424()), IntToFloat(func_424()), false, true, 0))
								{
									...
									set_player_wanted_level_now(player_id(), 0);
									clear_bit(&iLocal_98, 4);
									set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 16);
...
void func_430()
{
	...
	else if (!is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 17))
	{
		if (!func_6(player_id(), 1, 1))
		{
			set_bit(&iLocal_98, 7);
		}
		else if (is_bit_set(iLocal_98, 7))
		{
			if (is_player_control_on(player_id()))
			{
				if (iLocal_117 > 0)
		...
		else
		{
			...
			{
				clear_bit(&iLocal_98, 8);
				set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 17);
			}
	...
	else if (is_bit_set(iLocal_98, 4) && !is_bit_set(iLocal_98, 8))
	{
		if (func_32())
		{
			set_player_wanted_level(player_id(), func_432(), 0);
...
void func_433()
{
	if (!is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 13))
	{
		if (func_6(player_id(), 1, 1))
		{
			if (is_entity_at_coord(player_ped_id(), func_24(0), 100f, 100f, 100f, false, true, 0))
			{
				set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 13);
			}
		}
		if (is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 15) || is_bit_set(Local_128.f_1, 14))
		{
			set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 13);
		}
	}
...
void func_435(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	
	if (((func_119(player_id()) && !func_118(player_id())) && !is_bit_set(Global_1610316[player_id() /*174*/].f_1, 8)) && (func_107(player_id()) || func_106(player_id())))
	{
		return;
	}
...
void func_464()
{
	...
	if (func_3(&uLocal_118, 5000, 0))
	{
		...
		while (iVar3 < func_14())
		{
			if (network_does_entity_exist_with_network_id(func_25(iVar3)) && !is_bit_set(Local_128.f_1, iVar3))
			{
				if (does_entity_exist(net_to_veh(func_25(iVar3))) && does_entity_exist(player_ped_id()))
				{
					if (func_6(player_id(), 1, 1))
					{
						vLocal_110 = {get_entity_coords(player_ped_id(), 1)};
					}
...
void func_466()
{
	...
	if (!is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 13) && func_518(func_7(), 1))
	{
		if (!does_blip_exist(iLocal_109))
		{
	...
	else
	{
		...
		while (iVar1 < func_14())
		{
			if ((((network_does_entity_exist_with_network_id(func_25(iVar1)) && !is_entity_dead(net_to_veh(func_25(iVar1)), 0)) && !is_ped_in_vehicle(player_ped_id(), net_to_veh(func_25(iVar1)), 0)) && !is_bit_set(Local_128.f_1, iVar1)) && !func_275())
			{
			...
			if (func_518(func_7(), 1))
			{
				if (((is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 15) || is_bit_set(Local_128.f_1, 14)) && !is_bit_set(Local_128.f_1, iVar1 + 4)) && !func_275())
				{
...
void func_469()
{
	...
	if (is_bit_set(Local_128.f_1, 17) || is_bit_set(Local_128.f_1, 24))
	{
		...
		while (iVar0 < func_14())
		{
			if (!is_bit_set(Local_128.f_1, iVar0) && !is_bit_set(Local_128.f_1, iVar0 + 8))
			{
				if (network_does_network_id_exist(func_25(iVar0)))
				{
...
void func_470()
{
	...
	if (!is_bit_set(iLocal_98, 10))
	{
		...
		while (iVar0 < func_14())
		{
			if (is_bit_set(Local_128.f_1, iVar0 + 8))
			{
				if (!is_help_message_being_displayed())
				{
					if (func_518(func_7(), 1))
...
void func_471()
{
	...
	if (!is_bit_set(Global_2460486.f_1643, 22))
	{
		iVar0 = func_363(player_id());
		if (iVar0 != -1)
		{
...
void func_474()
{
	...
	while (iVar0 < func_14())
	{
		if (!is_bit_set(Local_128.f_1, iVar0))
		{
			if (network_does_entity_exist_with_network_id(func_25(iVar0)))
			{
				if (does_entity_exist(player_ped_id()) && does_entity_exist(net_to_veh(func_25(iVar0))))
				{
					if (!is_entity_dead(player_ped_id(), 0) && !is_entity_dead(net_to_veh(func_25(iVar0)), 0))
					{
						if (!is_ped_in_vehicle(player_ped_id(), net_to_veh(func_25(iVar0)), 0))
						{
							if (func_518(func_7(), 1))
...
void func_476()
{
	...
	if (func_518(func_7(), 1))
	{
		...
		else if ((is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 16) && is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 15)) && get_player_wanted_level(player_id()) > 0)
		{
			func_478("GB_BB_COPS", 0);
		}
		else if (is_bit_set(Local_128.f_1, 15))
		{
			if (is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 15))
			{
		...
		else if (is_bit_set(Local_187[participant_id_to_int() /*4*/].f_1, 15))
		{
			func_478("GB_BB_GT_UDLVR", 0);
		}
		else if (is_bit_set(Local_128.f_1, 14))
	...
	{
		if (is_bit_set(Local_128.f_1, 15))
		{
...
void func_493()
{
	...
	if (is_bit_set(iLocal_98, false))
	{
		if (!func_121())
		{
			if (func_518(func_7(), 1))
			{
				if (is_bit_set(iLocal_98, true))
				{
					if (!is_help_message_being_displayed())
					{
						if (func_14() == 1)
	...
	else
	{
		...
		func_494();
		set_bit(&iLocal_98, false);
		set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), 12);
	}
}
...
void func_525()
{
	...
	while (iVar2 < func_14())
	{
		if (!is_bit_set(Local_128.f_1, iVar2) && !is_bit_set(Local_128.f_1, iVar2 + 8))
		{
			if (player_id() == func_7())
			{
				if (network_does_entity_exist_with_network_id(func_25(iVar2)))
				{
					if (is_entity_dead(net_to_veh(func_25(iVar2)), 0))
					{
						...
						{
							set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar2 + 8);
						}
					}
				}
			}
	...
	if (get_event_data(1, iParam0, &Var0, 10))
	{
		if (does_entity_exist(Var0))
		{
			if (is_entity_a_vehicle(Var0))
			{
				...
				{
					if (!is_bit_set(Local_128.f_1, iVar10) && !is_bit_set(Local_128.f_1, iVar10 + 8))
					{
						if (get_vehicle_index_from_entity_index(Var0) == net_to_veh(func_25(iVar10)))
						{
							if (network_does_entity_exist_with_network_id(func_25(iVar10)) && is_entity_dead(net_to_veh(func_25(iVar10)), 0))
							{
							...
							if (does_entity_exist(Var0.f_1) && is_entity_a_ped(Var0.f_1))
							{
								if (get_ped_index_from_entity_index(Var0.f_1) == player_ped_id())
								{
									if (func_108())
									{
										if (Var0.f_3)
										{
											set_bit(&(Local_187[participant_id_to_int() /*4*/].f_1), iVar10 + 8);
											func_528(func_76());
										}
									}
...
void func_540(int iParam0)
{
	...
	if (Global_1610316[player_id() /*174*/].f_10.f_28 != -1)
	{
		...
		if (!is_bit_set(Global_1573883.f_1, 14) && !func_119(player_id()))
		{
			func_450(0);
		}
	}
...
void func_554()
{
	...
	while (iVar0 < func_14())
	{
		if (network_does_entity_exist_with_network_id(func_25(iVar0)))
		{
			...
			if (!is_entity_dead(iVar1, 0))
			{
				if (is_ped_in_vehicle(player_ped_id(), iVar1, 0))
				{
...
void func_558(int iParam0)
{
	...
	if (is_bit_set(Local_128.f_1, 18))
	{
		iVar1 = 8;
	}
	else if (is_bit_set(Local_128.f_1, 16))
	{
		iVar1 = 7;
	}
	if (iParam0)
...
void func_570(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_567();
