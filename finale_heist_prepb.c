	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				...
				{
					if ((!iParam4 || func_86(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
		...
		if (is_vehicle_driveable(iLocal_33, 0))
		{
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_33, 0))
			{
				if (is_vehicle_attached_to_trailer(iLocal_33))
				{
					...
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_119, vLocal_132, 1) < 100f)
					{
						if (get_player_wanted_level(player_id()) == 0)
						{
							if (iLocal_316 == 1)
	...
	if (iLocal_62 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_88108[3]))
		{
			if (is_vehicle_driveable(Global_88108[3], 0))
			{
				...
				if (((is_this_model_a_car(ENTITY::GET_ENTITY_MODEL(Global_88108[3])) || is_this_model_a_bike(ENTITY::GET_ENTITY_MODEL(Global_88108[3]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_88108[3]))) || is_this_model_a_quadbike(ENTITY::GET_ENTITY_MODEL(Global_88108[3])))
				{
					set_entity_as_mission_entity(Global_88108[3], true, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_150(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_147(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
...
void func_156()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_49))
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 45f, -616.2f, 30.8f, 1) < 150f)
		{
			STREAMING::REQUEST_MODEL(joaat("s_m_m_security_01"));
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 45f, -616.2f, 30.8f, 1) < 50f)
	{
		if (iLocal_457 == 0)
		{
	...
	switch (iLocal_31)
	{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_43[0]))
						{
							if (!is_ped_being_stealth_killed(iLocal_43[0]))
							{
								...
								{
									if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_43[0], 1), 863.1551f, -1564.572f, 29.3231f, 1) > 3f)
									{
										if (iLocal_459[0] == 0)
										{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[1]))
					{
						if (!PED::IS_PED_INJURED(iLocal_43[1]))
						{
							if (!is_ped_being_stealth_killed(iLocal_43[1]))
							{
								...
								{
									if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iLocal_43[1], 1), 940.2881f, -1573.877f, 29.3866f, 1) > 3f)
									{
										if (iLocal_459[1] == 0)
										{
		...
		case 2:
					...
					if (!PED::IS_PED_INJURED(iLocal_43[0]))
					{
						...
						else if (iLocal_448[0] == 0)
						{
							if (iLocal_445[0] == 0)
							{
								...
								task_follow_nav_mesh_to_coord(iLocal_43[0], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3f, -1, 0.25f, 0, 1193033728);
								func_168(iLocal_43[0]);
								iLocal_448[0] = 1;
							}
							if (iLocal_445[0] == 1)
					...
					if (!PED::IS_PED_INJURED(iLocal_43[1]))
					{
						...
						else if (iLocal_448[1] == 0)
						{
							if (iLocal_445[1] == 0)
							{
								...
								task_follow_nav_mesh_to_coord(iLocal_43[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3f, -1, 0.25f, 0, 1193033728);
								func_168(iLocal_43[1]);
								iLocal_448[1] = 1;
							}
							if (iLocal_445[1] == 1)
			...
			if (!func_165())
			{
				if (iLocal_414 == 0)
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 893.2f, -1556.5f, 30f, 1) < 18f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
						{
							if (!PED::IS_PED_INJURED(iLocal_43[0]))
							...
							if (func_158(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) > 4f)
							{
								...
								else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_96[0] + 500)
								{
									if (iLocal_439[0] == 0)
									{
										...
										task_follow_nav_mesh_to_coord(iLocal_43[0], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, -1, 0.25f, 0, 1193033728);
										func_168(iLocal_43[0]);
										iLocal_439[0] = 1;
									}
								}
							...
							if (func_158(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 1) > 4f)
							{
								...
								else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_96[1] + 500)
								{
									if (iLocal_439[1] == 0)
									{
										...
										task_follow_nav_mesh_to_coord(iLocal_43[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, -1, 0.25f, 0, 1193033728);
										func_168(iLocal_43[1]);
										iLocal_439[1] = 1;
									}
								}
...
void func_171()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
	{
		if (!PED::IS_PED_INJURED(iLocal_43[0]))
		{
			vLocal_125[0 /*3*/] = {ENTITY::GET_ENTITY_COORDS(iLocal_43[0], 1)};
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[1]))
	{
		if (!PED::IS_PED_INJURED(iLocal_43[1]))
		{
			vLocal_125[1 /*3*/] = {ENTITY::GET_ENTITY_COORDS(iLocal_43[1], 1)};
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
	{
	...
	if (iLocal_31 != 2)
	{
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_119, vLocal_132, 1) < 36f)
		{
			if (iLocal_404[0] == 1)
			{
				if (_0x6CD5A433374D4CFB(iLocal_43[0], PLAYER::PLAYER_PED_ID()))
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
						{
							if (!PED::IS_PED_INJURED(iLocal_35[0]))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
								{
									if (is_vehicle_driveable(iLocal_33, 0))
									{
										if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_33, 1) && ENTITY::IS_ENTITY_AT_COORD(iLocal_33, 919.2f, -1554.4f, 30f, 4f, 4f, 4f, false, true, 0))
										{
											...
											task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 0);
											AI::TASK_PLAY_ANIM(false, "misscarsteal4@director_grip", "mcs_2_loop_grip1", 8f, -8f, -1, 1, 0, 0, 0, 0);
											close_sequence_task(iLocal_57);
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (is_ped_in_vehicle(iParam0, get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0) && get_ped_in_vehicle_seat(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -1) == iParam0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
				{
					if (is_vehicle_driveable(iLocal_33, 0))
					{
						if ((is_ped_in_vehicle(iParam0, iLocal_33, 0) && get_ped_in_vehicle_seat(iLocal_33, -1) == iParam0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_33, vLocal_116, 3f, 3f, 3f, false, true, 0))
						{
