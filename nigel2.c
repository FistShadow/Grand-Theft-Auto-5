...
bool func_127(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
bool func_132(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
...
int func_155(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_156(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_170(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	var uVar1;
...
int func_174(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
var func_338(char* sParam0, int iParam1, char* sParam2)
{
...
void func_339(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_340(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_340(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5, int iParam6)
{
	func_341(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_341(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	if (!is_ped_in_any_vehicle(player_ped_id(), 1))
	{
...
void func_342(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
			...
			if (Local_3525[iVar7 /*2*/].f_1 == 0)
			{
				if (!iVar0)
				{
					if (fLocal_3266 >= 500f)
					{
						...
						{
							Local_3525[iVar7 /*2*/] = create_ped(26, iVar1, vVar2, fVar5, 1, true);
				...
				if (!iVar0)
				{
					if (fLocal_3266 >= 111161f && iLocal_3263 > 1)
					{
						if (is_valid_interior(iLocal_3262) && is_interior_ready(iLocal_3262))
						{
							...
							if (has_model_loaded(iVar1))
							{
								Local_3506[iVar7 /*2*/] = create_ped(26, iVar1, vVar2, fVar5, 1, true);
...
void func_373()
{
	if (!iLocal_3209)
	{
		...
		{
			request_script_audio_bank("NIGEL_02_CRASH_A", false);
			request_script_audio_bank("NIGEL_02_CRASH_B", false);
			request_script_audio_bank("PANIC_WALLA_INTERIOR", false);
			if ((request_script_audio_bank("NIGEL_02_CRASH_A", false) && request_script_audio_bank("NIGEL_02_CRASH_B", false)) && request_script_audio_bank("PANIC_WALLA_INTERIOR", false))
			{
				iLocal_3209 = 1;
			}
		}
...
void func_381(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_388(var uParam0, int iParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, int iParam12, float fParam13, float fParam14, int iParam15)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (iVar0)
		{
			...
			if (has_model_loaded(iParam1))
			{
				...
				iVar2 = create_ped_inside_vehicle(iParam0, iParam2, iParam1, -1, 0, false);
				if (func_392(get_entity_model(iParam0)))
				{
					set_ped_relationship_group_hash(iVar2, iLocal_2599);
				}
				...
				set_ped_config_flag(iVar2, 32, false);
				if (iLocal_153)
				{
...
bool func_395(var uParam0, int iParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	float fVar0;
...
bool func_401(var uParam0, int iParam1, int iParam2)
{
	...
	if (!is_entity_dead(*uParam0, 0))
	{
		if (is_vehicle_seat_free(*uParam0, -1))
		{
			if (iParam1 == 2)
			{
				iVar0 = create_ped_inside_vehicle(*uParam0, 6, func_86(), -1, 0, false);
				set_ped_relationship_group_hash(iVar0, iLocal_2599);
				set_model_as_no_longer_needed(func_86());
			}
			else if (iParam1 == 1)
			{
			...
			{
				iVar0 = create_ped_inside_vehicle(*uParam0, 4, func_89(), -1, 0, false);
				if (iLocal_152)
				{
					set_model_as_no_longer_needed(func_89());
				}
	...
	if (func_13(Local_3534[2 /*2*/]))
	{
		if (Local_3504.f_1 == 0)
		{
			...
			if (has_model_loaded(iLocal_3270))
			{
				...
				{
					Local_3504 = create_ped_inside_vehicle(Local_3534[2 /*2*/], 26, iLocal_3270, -1, 1, true);
...
void func_421()
{
	if (func_20(Local_3483))
	{
		...
		set_ped_config_flag(Local_3483, 32, false);
		set_ped_config_flag(Local_3483, 29, false);
		set_ped_config_flag(Local_3483, 116, false);
		...
		set_ped_relationship_group_hash(Local_3483, iLocal_3286);
...
void func_424()
{
	if (func_20(Local_3469))
	{
		...
		set_ped_config_flag(Local_3469, 32, false);
		set_ped_config_flag(Local_3469, 132, true);
		set_ped_config_flag(Local_3469, 29, false);
		set_ped_config_flag(Local_3469, 116, false);
		if (is_ped_in_group(Local_3469))
		{
			remove_ped_from_group(Local_3469);
		}
		set_ped_relationship_group_hash(Local_3469, iLocal_3287);
...
void func_425()
{
	if (func_20(Local_3476))
	{
		...
		set_ped_config_flag(Local_3476, 32, false);
		set_ped_config_flag(Local_3476, 132, true);
		set_ped_config_flag(Local_3476, 29, false);
		set_ped_config_flag(Local_3476, 116, false);
		if (is_ped_in_group(Local_3476))
		{
			remove_ped_from_group(Local_3476);
		}
		set_ped_relationship_group_hash(Local_3476, iLocal_3287);
...
void func_436()
{
	...
	if (func_13(Local_3490))
	{
		if (!does_entity_exist(Local_3469))
		{
			Local_3469 = create_ped_inside_vehicle(Local_3490, 26, Local_3469.f_1, 2, 1, true);
			func_424();
		}
		func_55(&(Local_3108.f_28[0]));
		if (!does_entity_exist(Local_3476))
		{
			Local_3476 = create_ped_inside_vehicle(Local_3490, 26, Local_3476.f_1, false, 1, true);
			func_425();
		}
	}
	...
	if (func_13(Local_3497))
	{
		if (!does_entity_exist(Local_3483))
		{
			Local_3483 = create_ped_inside_vehicle(Local_3497, 26, Local_3483.f_1, -1, 1, true);
			func_421();
		}
	}
...
bool func_460(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
bool func_481(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_483(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
bool func_493(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_511(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_534()
{
	...
	set_relationship_between_groups(5, iLocal_3286, 1862763509);
	set_relationship_between_groups(5, 1862763509, iLocal_3286);
	set_relationship_between_groups(5, iLocal_3286, iLocal_3287);
	set_relationship_between_groups(5, iLocal_3287, iLocal_3286);
	set_relationship_between_groups(1, iLocal_3287, 1862763509);
	set_relationship_between_groups(1, 1862763509, iLocal_3287);
}
