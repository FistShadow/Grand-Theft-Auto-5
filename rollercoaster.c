#region Local Var
	...
	auto uLocal_157 = 0;
	auto uLocal_158 = 0;
	Vector3[] vLocal_159 = new Vector3[234];
	Vector3 vLocal_862 = 0;
	int iLocal_865 = 0;
	int iLocal_866 = 0;
	float fLocal_867 = 0;
	struct<12> Local_868 = 0;
	struct<10> Local_880 = 0;
	auto uLocal_890 = 0;
	auto uLocal_891 = 0;
	int iLocal_892 = 0;
	struct<22> Local_893 = 0;
	auto uLocal_915 = 0;
	auto uLocal_916 = 0;
	auto uLocal_917 = 0;
	auto uLocal_918 = 0;
	...
	float fLocal_939 = 0;
	int iLocal_940 = 0;
	Vector3[] vLocal_941 = new Vector3[32];
	int iLocal_1038 = 0;
	int iLocal_1039 = 0;
#endregion
...
void main()
{
	...
	GAMEPLAY::SET_BIT(&Global_69737, 7);
	if (!does_cam_exist(iLocal_930))
	{
		iLocal_930 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
		set_cam_params(iLocal_930, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, false, 1, 1, 2);
	...
	if (func_53(PLAYER::PLAYER_PED_ID()))
	{
		...
		clear_area_of_projectiles(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 60f, 0);
	...
	if (does_cam_exist(iLocal_930))
	{
		set_cam_params(iLocal_930, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
		iVar12 = GAMEPLAY::GET_GAME_TIMER() + 5000;
	}
	while (!func_47(&uLocal_41) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_50();
		func_53(PLAYER::PLAYER_PED_ID());
		wait(false);
	...
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -1648.4f, -1127.6f, 18.3f, 1, false, 0, 1);
		attach_entity_to_entity(PLAYER::PLAYER_PED_ID(), Local_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		set_entity_visible(PLAYER::PLAYER_PED_ID(), false, 0);
	}
	...
	if (func_53(PLAYER::PLAYER_PED_ID()))
	{
		Local_893.f_20 = 60;
		Local_893.f_21 = 20;
		vVar1 = {get_ped_bone_coords(PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f)};
		...
		attach_cam_to_entity(Local_893, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
	}
	wait(false);
	if (func_53(PLAYER::PLAYER_PED_ID()) && func_53(Local_880.f_9))
	{
		func_12(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(Local_880.f_9, 1), &fVar10, &fVar11, 1);
	...
	while (true)
	{
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_936)
		{
			if (fLocal_939 > 0.01f)
			{
				if (fLocal_939 > 0.5f)
				{
					_play_ambient_speech1(PLAYER::PLAYER_PED_ID(), "ROLLERCOASTER_CHAT_EXCITED", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				else
				{
...
float func_7(float fParam0, Vector3 fParam1, Vector3 fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7)
{
	int[] iVar0 = new int[4];
	float fVar5;
	float fVar6;
...
void func_11(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
...
void func_12(Vector3 vParam0, Vector3 vParam1, auto uParam2, auto uParam3, int iParam4)
{
	Vector3 vVar0;
...
void func_13(Vector3 vParam0, auto uParam1, auto uParam2, int iParam3)
{
	Vector3 fVar0;
...
void func_14(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, auto uParam4, auto uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, int iParam11)
{
	*uParam0.f_1 = {vParam1};
	*uParam0.f_4 = {vParam4};
	*uParam0.f_7 = fParam7;
...
void func_16(int iParam0, int iParam1)
{
	...
	func_12(get_entity_coords(iParam0, 1), get_entity_coords(iParam1, 1), &fVar0, &fVar1, 1);
...
void func_17(auto uParam0)
{
	...
	fVar0 = *uParam0.f_3;
	*uParam0.f_3 += fLocal_867 * fLocal_939 * fLocal_938 * timestep();
	if (*uParam0.f_3 >= 1f)
	{
		*uParam0.f_3--;
...
Vector3 func_18(auto uParam0, auto uParam1, auto uParam2, auto uParam3, float fParam4)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	switch (iLocal_892)
	{
		...
		case 1:
			if (Local_868.f_4[1] == 224 && iLocal_866 == 0)
			{
				...
				if (func_53(PLAYER::PLAYER_PED_ID()))
				{
					play_sound_from_entity(-1, "BIG_STOP", PLAYER::PLAYER_PED_ID(), 0, 0, 0);
				}
			}
			break;
		
		case 2:
			fLocal_867 -= get_frame_time();
			if (fLocal_867 <= 0f)
			{
				fLocal_867 = 0f;
				iLocal_892 = 3;
...
void func_26(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_27()
{
	...
	while (iVar0 < iLocal_925)
	{
		...
		{
			set_entity_as_mission_entity(iLocal_925[iVar0], true, 0);
			set_entity_visible(iLocal_925[iVar0], false, 0);
			set_entity_collision(iLocal_925[iVar0], false, 0);
...
void func_32(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_33(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_33(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_35(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_36(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_36(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_38()
{
	...
	{
		if (func_42(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_43(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (((((((((((((((func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_44(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_46(int iParam0, int iParam1)
{
	...
	get_model_dimensions(ENTITY::GET_ENTITY_MODEL(iParam0), &Var0, &Var3);
...
bool func_51(auto uParam0, int iParam1, int iParam2)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_113, iParam1) || GAMEPLAY::IS_BIT_SET(*uParam0.f_114, iParam1))
	{
		return true;
...
void func_54(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_57(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
bool func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_68(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_68(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_68(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_99(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_68(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_68(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_68(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_59(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_172(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_64(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_172(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
bool func_71(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						*iParam0[func_87(vVar16.z)] = func_81(iParam1, vVar16.x, func_87(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_90(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
void func_100(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_105(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_104(uVar2, iVar0, 0);
		GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_101(uVar2, iVar3, iVar0, 1);
	}
}

void func_101(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_102(iParam2)];
	if (iVar0 != 0)
	{
...
int func_104(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_102(iParam1)];
...
int func_105(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_106(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
	...
	*uParam0.f_12 = func_116(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_104(func_114(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_104(func_113(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
...
void func_117(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_68(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
bool func_172(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_68(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_68(iParam1)))
	{
		return true;
	}
	return false;
...
void func_174(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_178(player_id())) && !func_176(player_id(), 0)) && !func_175())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_178(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_180(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_182(int iParam0)
{
	...
	{
		clear_help(1);
		GAMEPLAY::CLEAR_BIT(&Global_69737, 7);
		func_1(500, 1);
	}
	func_219(303, 0, 0);
...
int func_185(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_186(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_189(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_191() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_191() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_190(iParam0));
...
int func_193(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_191() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_198(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_199(auto uParam0, int iParam1)
{
...
void func_202(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_204(auto uParam0, int iParam1)
{
	return func_205(uParam0, iParam1) != -1;
}

int func_205(auto uParam0, int iParam1)
{
	int iVar0;
...
Vector3 func_214(int iParam0, Vector3 vParam1)
{
	auto uVar0;
...
void func_215()
{
	...
	{
		iLocal_925[0] = create_object(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, 1, true, false);
	}
	if (!func_53(iLocal_925[1]))
	{
		iLocal_925[1] = create_object(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, 1, true, false);
	}
	if (!func_53(iLocal_925[2]))
	{
		iLocal_925[2] = create_object(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, 1, true, false);
	}
	if (!func_53(iLocal_925[3]))
	{
		iLocal_925[3] = create_object(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, 1, true, false);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_925)
	{
...
void func_218(auto uParam0, int iParam1, int iParam2)
{
...
void func_220()
{
	...
	{
		func_208(13, floor(Global_101154.f_8884.f_3853));
	}
	if (!_0xBEDB96A7584AA8CF())
	{
		if (!Global_69489)
		{
			if (func_223() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
