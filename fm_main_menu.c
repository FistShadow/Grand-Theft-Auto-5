...
bool func_3()
{
	if ((((_get_number_of_instances_of_streamed_script(joaat("fm_mission_creator")) > 0 || _get_number_of_instances_of_streamed_script(joaat("fm_deathmatch_creator")) > 0) || _get_number_of_instances_of_streamed_script(joaat("fm_race_creator")) > 0) || _get_number_of_instances_of_streamed_script(joaat("fm_capture_creator")) > 0) || _get_number_of_instances_of_streamed_script(joaat("fm_lts_creator")) > 0)
	{
		return true;
	}
	return false;
