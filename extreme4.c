...
bool func_248(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
bool func_250(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
