...
void func_259()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((CONTROLS::IS_CONTROL_PRESSED(0, 30) || CONTROLS::IS_CONTROL_PRESSED(0, 31)) || CONTROLS::IS_CONTROL_PRESSED(0, 23)) || CONTROLS::IS_CONTROL_PRESSED(0, 21)) || CONTROLS::IS_CONTROL_PRESSED(0, 22)) || (func_271() && CONTROLS::IS_CONTROL_PRESSED(0, 1))) || (func_271() && CONTROLS::IS_CONTROL_PRESSED(0, 2))) || (func_271() && CONTROLS::IS_CONTROL_PRESSED(0, 32)))
			{
...
void func_261()
{
	if (!func_258())
	{
		if (iLocal_368 < 5)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_369 + 8000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2000))
			{
