...
void main()
{
	...
	if (!func_322())
	{
		if ((func_309(Local_82.f_28[0]) && func_309(PLAYER::PLAYER_PED_ID())) && !func_308(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		{
			if (func_309(PLAYER::PLAYER_PED_ID()) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_309(Local_155))
				{
					if (func_308(PLAYER::PLAYER_PED_ID(), Local_155, 10f, 1))
					{
						func_289();
					}
				}
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			...
			{
				if (!is_entity_dead(iLocal_178, 0))
				{
					if (func_308(PLAYER::PLAYER_PED_ID(), iLocal_178, 1f, 1))
					{
						give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), true, false, false);
						delete_object(&iLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
			...
			if (func_309(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_375 == 0)
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_221(Local_155))
				{
					if (timera() > 5000)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_370 + 25000 || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_370 + 25000 || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_149 = 2;
				}
			}
		...
		case 2:
			if (((!is_ped_falling(PLAYER::PLAYER_PED_ID()) && !is_ped_in_parachute_free_fall(PLAYER::PLAYER_PED_ID())) && get_entity_height_above_ground(PLAYER::PLAYER_PED_ID()) < 2f) && !is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))
			{
...
int func_76(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_75(iParam1)];
...
void func_222()
{
	...
	if (!does_cam_exist(iLocal_352))
	{
	}
	if (!does_cam_exist(iLocal_353))
	{
	}
	if (!does_cam_exist(iLocal_354))
	{
	}
	if (!does_cam_exist(iLocal_355))
	{
	}
	if (!does_cam_exist(iLocal_356))
	{
	}
	if (!does_cam_exist(iLocal_357))
	{
	}
	if (!does_cam_exist(iLocal_358))
	{
	}
	if (!does_cam_exist(iLocal_359))
	{
	}
	if (!does_cam_exist(iLocal_360))
	{
	}
	...
	while (GAMEPLAY::GET_GAME_TIMER() < iLocal_374 + 11000 && !is_screen_faded_out())
	{
		if (!is_synchronized_scene_running(iLocal_371) && !is_synchronized_scene_running(iLocal_372))
		{
			if (func_235(400))
			{
				iLocal_381 = true;
		...
		if (!iLocal_379)
		{
			if (is_synchronized_scene_running(iLocal_371))
			{
				if (get_synchronized_scene_phase(iLocal_371) == 1f)
				{
					if (func_309(Local_155))
					{
						iLocal_372 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						iLocal_364 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
						task_synchronized_scene(Local_155, iLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1000f, 0);
						_0x394B9CD12435C981(iLocal_372, false);
						set_cam_active(iLocal_364, true);
						play_synchronized_cam_anim(iLocal_364, iLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						render_script_cams(true, false, 3000, 1, 0, 0);
						_0x2208438012482A1A(Local_155, 0, 0);
						destroy_cam(iLocal_363, 0);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (is_synchronized_scene_running(iLocal_372) && get_synchronized_scene_phase(iLocal_372) >= 0.2f)
			{
				if (!is_synchronized_scene_running(iLocal_373))
				{
					prepare_synchronized_audio_event("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (is_synchronized_scene_running(iLocal_372) && get_synchronized_scene_phase(iLocal_372) == 1f)
			{
				if (func_309(Local_155))
				{
					iLocal_373 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					iLocal_365 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
					task_synchronized_scene(Local_155, iLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1000f, 0);
					_0x394B9CD12435C981(iLocal_373, true);
					set_cam_active(iLocal_365, true);
					play_synchronized_cam_anim(iLocal_365, iLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
					play_synchronized_audio_event(iLocal_373);
					render_script_cams(true, false, 3000, 1, 0, 0);
					_0x2208438012482A1A(Local_155, 0, 0);
					destroy_cam(iLocal_364, 0);
					iLocal_380 = 1;
				}
			}
		}
		else if (is_synchronized_scene_running(iLocal_373) && get_synchronized_scene_phase(iLocal_373) >= 0.323f)
		{
			if (!iLocal_376)
			{
			...
			{
				if (is_synchronized_scene_running(iLocal_373) && get_synchronized_scene_phase(iLocal_373) >= 0.44f)
				{
					iLocal_180 = start_particle_fx_looped_at_coord("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
					set_particle_fx_looped_alpha(iLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				destroy_cam(iLocal_365, 0);
				iLocal_362 = create_cam("DEFAULT_SCRIPTED_CAMERA", true);
				set_cam_params(iLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, false, 1, 1, 2);
				render_script_cams(true, false, 3000, 1, 0, 0);
	...
	if (iLocal_381)
	{
		if (is_synchronized_scene_running(iLocal_373))
		{
			stop_synchronized_audio_event(iLocal_373);
		}
	...
	if (func_309(Local_155))
	{
		if (iVar0 < 3)
		{
			set_entity_health(Local_155, 101);
			...
			set_entity_coords(Local_155, 1657.046f, -17.4571f, fVar7, 1, false, 0, 1);
		}
	}
	_0x81CBAE94390F9F89();
	func_224(1, 1, 1, 1);
	...
	if (func_221(Local_155))
	{
		if (is_synchronized_scene_running(iLocal_373))
		{
			set_synchronized_scene_phase(iLocal_373, 1f);
		}
		clear_ped_tasks_immediately(Local_155);
		_0x2208438012482A1A(Local_155, 0, 0);
		set_entity_coords(Local_155, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		set_entity_health(Local_155, false);
	}
	func_223(&uLocal_182, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_209(&uLocal_182, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}

void func_223(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_225(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(player_id())) && !func_227(player_id(), 0)) && !func_226())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_231(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_238()
{
	...
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
				_request_cutscene_2("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				_request_cutscene_2("es_4_rcm_p2_concat", 5, 8);
			}
			stop_sound(iLocal_367);
			if (_0xB56BBBCC2955D9CB())
			{
				set_cutscene_ped_component_variation("Dom", 8, 2, 0, false);
			}
			if (!func_258())
			{
				if (func_253(1, 20f, 1))
				{
					if ((!iLocal_383 || GAMEPLAY::GET_GAME_TIMER() > iLocal_384 + 3000) || is_entity_at_coord(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						if (func_309(Local_155))
						{
							freeze_entity_position(Local_155, false);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_179) && !is_entity_dead(iLocal_179, 0))
						{
							set_entity_visible(iLocal_179, false, 0);
						}
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_172 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
							iLocal_181 = ENTITY::GET_ENTITY_MODEL(iLocal_172);
							if (is_this_model_a_car(iLocal_181) == 1 || is_this_model_a_bike(iLocal_181) == 1)
							{
							...
							func_244(1654.721f, 4.166876f, 172.5245f, 1662.562f, -8.920052f, 178.2742f, 6.25f, vLocal_348, fLocal_351, 1, 1, 1, 0, 0);
						}
						else
						{
							vLocal_348 = {1649.793f, 11.7826f, 172.7745f};
							fLocal_351 = 220.9923f;
							func_243(vLocal_348, fLocal_351);
						}
						func_240(1660.186f, -7.492f, 172.774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						clear_area_of_peds(1660.186f, -7.492f, 172.774f, 200f, 0);
						iLocal_366 = add_scenario_blocking_area(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_149 = 1;
					}
				}
			}
		...
		case 1:
			if (is_cutscene_playing())
			{
				if (can_set_exit_state_for_camera(0))
				{
					if (!iLocal_154)
					{
						if (!is_synchronized_scene_running(iLocal_371))
						{
							if (func_309(Local_155))
							{
								if (!does_cam_exist(iLocal_363))
								{
									iLocal_363 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
								}
								set_cam_active(iLocal_363, true);
								render_script_cams(true, false, 3000, 1, 0, 0);
								iLocal_371 = create_synchronized_scene(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								task_synchronized_scene(Local_155, iLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1000f, 0);
								_0x394B9CD12435C981(iLocal_371, true);
								set_cam_active(iLocal_363, true);
								play_synchronized_cam_anim(iLocal_363, iLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								render_script_cams(true, false, 3000, 1, 0, 0);
								_0x2208438012482A1A(Local_155, 0, 0);
								iLocal_154 = 1;
							}
				...
				if (func_309(Local_155))
				{
					if (can_set_exit_state_for_registered_entity("Dom", false))
					{
						iLocal_149 = 2;
					}
				}
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_179) && !is_entity_dead(iLocal_179, 0))
			{
				set_entity_visible(iLocal_179, true, 0);
			}
			if (iLocal_151 == 0)
			{
...
void func_240(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_243(Vector3 vParam0, Vector3 fParam1)
{
	int iVar0;
...
void func_244(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_245(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_245(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_249(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_247(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_248(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_248(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_249(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_251(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_250(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_250(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_250(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_250(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_250(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_250(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_250(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_250(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_250(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_250(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_250(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_250(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_250(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_250(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_250(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_250(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_250(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_251(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_253(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_257(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_256(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_257(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_259()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((is_control_pressed(0, 30) || is_control_pressed(0, 31)) || is_control_pressed(0, 23)) || is_control_pressed(0, 21)) || is_control_pressed(0, 22)) || (func_271() && is_control_pressed(0, 1))) || (func_271() && is_control_pressed(0, 2))) || (func_271() && is_control_pressed(0, 32)))
			{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			iLocal_170 = func_269(Local_155, 1, 1, 5);
			settimera(0);
			iLocal_149 = 1;
			break;
		...
		case 1:
			...
			if (func_309(PLAYER::PLAYER_PED_ID()))
			{
				if (func_309(Local_155))
				{
					if (func_308(PLAYER::PLAYER_PED_ID(), Local_155, 100f, 1))
					{
						_request_cutscene_2("es_4_rcm_p2_concat", 6, 8);
						if (_0xB56BBBCC2955D9CB())
						{
					...
					if (func_308(PLAYER::PLAYER_PED_ID(), Local_155, 32f, 1))
					{
						if (func_263(Local_155, 1, 0, 0, 0))
						{
							if (iLocal_169 == 0)
							{
								if (!func_258())
						...
						else
						{
							if (!iLocal_378)
							{
								if (func_308(PLAYER::PLAYER_PED_ID(), Local_155, 30f, 1) && !func_258())
								{
							...
							func_261();
							if (!is_ped_headtracking_ped(PLAYER::PLAYER_PED_ID(), Local_155))
							{
								task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_155, -1, 0, 2);
							}
						}
					}
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_149 = 2;
		...
		case 2:
			...
			if (func_309(PLAYER::PLAYER_PED_ID()))
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					_task_bring_vehicle_to_halt(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 5f, 1, 0);
					wait(600);
					task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
			}
...
void func_260()
{
	if (func_309(Local_155))
	{
		...
		{
			task_perform_sequence(Local_155, iLocal_171);
		}
	}
}
...
void func_261()
{
	if (!func_258())
	{
		if (iLocal_368 < 5)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_369 + 8000 + get_random_int_in_range(false, 2000))
			{
	...
	if (!func_258())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false))
		{
			if (has_sound_finished(iLocal_367))
			{
				play_sound_from_entity(iLocal_367, "DOM", Local_155, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
bool func_263(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_221(PLAYER::PLAYER_PED_ID()) && func_221(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_268(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_264(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_264(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_266(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_251(vParam1 - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_251(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_267(vVar3, vVar0);
...
float func_267(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}

bool func_268(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
void func_272()
{
	...
	else
	{
		...
		task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
		func_237(800, 0);
		iLocal_152 = 1;
		func_279(1, 1, 1);
	}
...
void func_273()
{
	...
	task_follow_nav_mesh_to_coord(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 1193033728);
	set_scenario_type_enabled("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	clear_area_of_vehicles(Local_155.f_1, 20f, 0, 0, 0, 0, false);
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_173))
	{
		iLocal_173 = create_vehicle(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_174))
	{
		iLocal_174 = create_vehicle(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_176))
	{
		iLocal_176 = create_object(1165008631, 1666.282f, -11.20408f, 172.7773f, 1, true, false);
		set_entity_rotation(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_177))
	{
		iLocal_177 = create_object(1165008631, 1667.076f, -12.07778f, 173.2611f, 1, true, false);
		set_entity_rotation(iLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_309(Local_155))
	{
		if (get_script_task_status(Local_155, 242628503) != 1)
		{
			open_sequence_task(&iLocal_171);
			task_play_anim(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			task_play_anim(false, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
			set_sequence_to_repeat(iLocal_171, 1);
			close_sequence_task(iLocal_171);
			task_perform_sequence(Local_155, iLocal_171);
		}
	}
	if (func_309(Local_155))
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_155, get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID()));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_179))
	{
		iLocal_179 = create_ambient_pickup(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	set_entity_rotation(iLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	play_entity_anim(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, false, 1, 0, 0.99f, 0);
	func_239(1);
}

void func_274(int iParam0, Vector3 vParam1, Vector3 fParam2)
{
	func_275(iParam0, iLocal_81, vParam1, fParam4, 26);
...
int func_277(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_282(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_322())
	{
...
void func_283()
{
	switch (iLocal_150)
	{
		...
		case 2:
			func_277(PLAYER::PLAYER_PED_ID(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -668482597, false, 1, 0);
			set_ped_min_move_blend_ratio(PLAYER::PLAYER_PED_ID(), 1f);
			task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
			set_gameplay_cam_relative_pitch(0f, 1f);
...
bool func_285(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_288()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_322() && func_309(Local_82.f_28[0])) && func_309(PLAYER::PLAYER_PED_ID())) && iLocal_383 == 1)
	{
		if (!is_gameplay_hint_active())
		{
			set_player_control(player_id(), false, 0);
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], -1, 0, 2);
			task_follow_to_offset_of_entity(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
		...
		{
			if (func_308(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
			{
				iLocal_384 -= 10000;
			}
...
void func_289()
{
	...
	if (iLocal_383)
	{
		if (!is_gameplay_hint_active())
		{
			set_player_control(player_id(), false, 0);
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_155, -1, 0, 2);
			task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			get_is_multiplayer_brief(1);
...
void func_290()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(Local_155, 1), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				if (does_blip_exist(iLocal_170))
				{
					set_blip_flashes(iLocal_170, 1);
				}
			}
			else if (does_blip_exist(iLocal_170))
			{
				set_blip_flashes(iLocal_170, 0);
			}
		}
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&cVar0, func_294(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_300(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_302(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	...
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_304(0)) || func_303(1))
			{
			}
			else
			{
...
void func_310()
{
	...
	request_additional_text("EXT4", false);
	...
	{
		iLocal_175 = create_object_no_offset(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		set_entity_rotation(iLocal_175, 90f, 0f, -63f, 2, 1);
...
bool func_311(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
...
bool func_312(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_314(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		while ((((!STREAMING::HAS_MODEL_LOADED(Local_155.f_5) || !STREAMING::HAS_MODEL_LOADED(joaat("sanchez"))) || !has_anim_dict_loaded("rcmextreme4")) || !has_anim_dict_loaded("skydive@parachute@")) || !has_ptfx_asset_loaded())
		{
			wait(0);
		}
	}
...
void func_321(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
...
void func_338(int iParam0)
{
	...
	if (!func_357())
	{
		...
		{
			func_165(iVar0, 1, 0);
			func_339(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_340(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_346())
	{
		...
		{
			iVar33 = func_341(get_this_script_name());
			if (iVar33 > -1)
			{
