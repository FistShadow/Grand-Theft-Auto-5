...
void func_145()
{
	...
	if (func_285(40))
	{
		if (func_285(39))
		{
			if (((has_cutscene_loaded() && STREAMING::HAS_MODEL_LOADED(joaat("player_two"))) && has_anim_dict_loaded("MISSHEISTPALETOSCORE1LEADINOUT")) && has_ptfx_asset_loaded())
			{
...
bool func_247(int iParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_230(func_92()) != iParam1 || iVar0)
		{
			...
			else if (!((GAMEPLAY::IS_BIT_SET(Global_101154.f_7775.f_2[27 /*3*/], true) && !Global_3) && !func_110(0)))
			{
				if (*iParam0.f_23)
				{
					iVar1 = true;
