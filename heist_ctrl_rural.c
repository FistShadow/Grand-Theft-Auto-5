		...
		else if (is_cutscene_playing())
		{
			...
			if (can_set_exit_state_for_registered_entity("Trevor", false))
			{
				...
				if (!func_110(0))
				{
					...
					AI::TASK_PLAY_ANIM_advanced(false, "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_PUKING_LEADOUT", 1396.911f, 3603.942f, 38.925f, 0f, 0f, 108f, 1000f, -4f, -1, 0, 0f, 2, 0);
...
auto func_170()
{
	...
	func_178(&uVar0, TIME::GET_CLOCK_HOURS());
