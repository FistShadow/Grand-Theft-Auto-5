...
void main()
{
	...
	while (!func_285(5))
	{
		if (!Global_69758 && !func_284(14))
		{
			...
			func_260(&Local_176);
			func_145();
			if (func_143(0) || is_bit_set(Local_176.f_449, 2))
			{
				func_67(&Local_176);
				func_4(&Local_176);
				func_3(&Local_176);
		...
		if (_get_number_of_instances_of_streamed_script(joaat("rural_bank_heist")) > 0)
		{
			func_2();
		}
		wait(0);
...
void func_77(auto uParam0)
{
	...
	*uParam0.f_466 = sVar0;
	...
	func_78(uParam0.f_649, is_bit_set(*uParam0.f_449, 4), (is_bit_set(*uParam0.f_449, 5) && !iVar1), 1, 0, 1045220557, 1, 1065353216);
	if (is_bit_set(*uParam0.f_449, 7))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_141()) || Global_100201) || Global_25122) || func_140()) || func_98(8, -1)) || func_139()) || func_138()) || func_137()) || func_136()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_141()) || Global_100201) || Global_25122) || func_140()) || func_98(8, -1)) || func_137()) || func_139()) || func_138()) || func_136()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_141()) || Global_100201) || Global_25122) || func_140()) || func_98(8, -1)) || func_139()) || func_138()) || func_136()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_141()) || Global_100201) || Global_25122) || func_140()) || func_98(8, -1)) || func_137()) || func_135()) || func_139()) || func_138()) || func_136())
						{
							return false;
						}
						break;
...
void func_145()
{
	...
	if (func_285(39))
	{
		...
		{
			set_cutscene_ped_component_variation("LESTER", false, 0, false, false);
			set_cutscene_ped_component_variation("LESTER", 2, 0, false, false);
			set_cutscene_ped_component_variation("LESTER", 3, 0, true, false);
			set_cutscene_ped_component_variation("LESTER", 4, 1, true, false);
			set_cutscene_ped_component_variation("LESTER", 5, 0, false, false);
			set_cutscene_ped_component_variation("LESTER", 7, 0, false, false);
			set_cutscene_ped_component_variation("LESTER", 8, 1, false, false);
	...
	if (func_285(40))
	{
		if (func_285(39))
		{
			if (((has_cutscene_loaded() && has_model_loaded(joaat("player_two"))) && has_anim_dict_loaded("MISSHEISTPALETOSCORE1LEADINOUT")) && has_ptfx_asset_loaded())
			{
				...
				{
					register_entity_for_cutscene(iLocal_128, "LESTER", 1, false, 0);
				}
		...
		else if (is_cutscene_playing())
		{
			...
			set_gameplay_cam_relative_heading(0);
			set_gameplay_cam_relative_pitch(0, 1f);
			if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity("Trevor", false)))
			{
				if (!is_bit_set(iLocal_41, 7))
				{
					iLocal_132[2] = get_ped_index_from_entity_index(get_entity_index_of_registered_entity("Trevor", false));
			...
			if (can_set_exit_state_for_registered_entity("Trevor", false))
			{
				if (func_92() != 2)
				{
					if (func_247(&iLocal_132, 2))
					{
						func_186(&iLocal_132, 0, 0, 0);
					}
				}
				...
				if (!func_110(0))
				{
					...
					task_play_anim_advanced(false, "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_PUKING_LEADOUT", 1396.911f, 3603.942f, 38.925f, 0f, 0f, 108f, 1000f, -4f, -1, 0, 0f, 2, 0);
					close_sequence_task(iVar3);
					task_perform_sequence(PLAYER::PLAYER_PED_ID(), iVar3);
					_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 11);
					iLocal_130 = 0;
				}
				else
				{
		...
		else if (is_bit_set(iLocal_41, 11))
		{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_184(&(Local_176.f_484), 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 1, 1);
					if (func_86(&(Local_176.f_484), "RBS1AUD", "RBS1_VOMIT", 8, 0, 0, 0))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 12);
					}
				}
				if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_PUKING_LEADOUT", 3))
				{
					fVar4 = get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_PUKING_LEADOUT");
					...
					if (fVar4 < 1f && fVar4 >= 0f)
					{
						if (fVar4 > 0.092f && fVar4 < 0.184f)
						{
							if (!is_bit_set(iLocal_41, 13))
							{
								if (iLocal_130 == 0)
								{
									iLocal_130 = start_particle_fx_looped_on_ped_bone("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
						...
						else if (fVar4 > 0.34f && fVar4 < 0.36f)
						{
							if (!is_bit_set(iLocal_41, 15))
							{
								...
								{
									iLocal_130 = start_particle_fx_looped_on_ped_bone("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 15);
								}
							}
						}
						else if (fVar4 > 0.4222f && fVar4 < 0.516f)
						{
							if (!is_bit_set(iLocal_41, 16))
							{
								...
								{
									iLocal_130 = start_particle_fx_looped_on_ped_bone("SCR_TREV_PUKE", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1f, 0, 0, 0);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 16);
								}
							}
						}
						...
						if (fVar4 > 0.98f)
						{
							...
							if (get_follow_ped_cam_view_mode() == 4)
							{
								task_play_anim(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LeadOut_FPS", 4f, -1.5f, -1, 48, 0, 0, 0, 0);
							}
							else
							{
								task_play_anim(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LEADOUT", 4f, -1.5f, -1, 48, 0, 0, 0, 0);
							}
		...
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_42)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				...
				{
					_set_vehicle_door_breakable(iLocal_46, 0, true);
				}
			}
			func_154(&iLocal_44);
			...
			if (iLocal_126 != -1)
			{
				if (_0x0EAEB0DB4B132399(iLocal_126))
				{
					remove_navmesh_blocking_object(iLocal_126);
				}
			}
			clear_ped_non_creation_area();
			set_ped_paths_in_area(Local_176.f_1.f_394 - Local_176.f_1.f_397, Local_176.f_1.f_394 + Local_176.f_1.f_397, true, 0);
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LEADOUT", 3) || is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LeadOut_FPS", 3))
		{
...
void func_147(int iParam0, int iParam1)
{
	...
	if (!func_39(10) && is_bit_set(Global_101154.f_29520.f_8[4], false))
	{
		func_151(9, 1);
	}
	if (!func_39(13) && is_bit_set(Global_101154.f_29520.f_8[16], false))
	{
		func_151(12, 1);
	}
	if (!func_39(12))
...
bool func_156(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<98> Var1;
	auto uVar99;
...
int func_157(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	*uParam2.f_3 = 1000;
	*uParam2.f_1 = 0;
	*uParam2.f_84 = 255;
...
bool func_159(int iParam0, auto uParam1, int iParam2)
{
...
int func_168(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_169(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
auto func_170()
{
	...
	func_173(&uVar0, get_clock_day_of_month());
	func_172(&uVar0, get_clock_month());
	func_171(&uVar0, get_clock_year());
	return uVar0;
}
...
{
	return shift_right(iParam0, 26) & 31 * func_176(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_181(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_169(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
void func_184(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((!PED::IS_PED_INJURED(*iParam0[*iParam0.f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && *iParam0[*iParam0.f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		*iParam0.f_7 = 4;
		...
		if (is_player_playing(player_id()))
		{
			set_auto_give_parachute_when_enter_plane(player_id(), func_285(67));
		}
		if (is_player_playing(player_id()))
		{
			_0xD2B315B6689D537D(player_id(), func_285(68));
		}
...
void func_216()
{
	...
	if ((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !func_94(func_92())) || !func_222())
	{
		return;
	}
	Var0 = 12;
...
bool func_247(int iParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_230(func_92()) != iParam1 || iVar0)
		{
			iVar1 = false;
			...
			else if (!((is_bit_set(Global_101154.f_7775.f_2[27 /*3*/], true) && !Global_3) && !func_110(0)))
			{
				if (*iParam0.f_23)
				{
					iVar1 = true;
...
void func_252(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_256(player_id())) && !func_254(player_id(), 0)) && !func_253())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_256(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_258(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_262(auto uParam0, float fParam1, float fParam2)
{
	float fVar0;
...
void func_268(auto uParam0)
{
	...
	while (iVar0 < *uParam0.f_1.f_33)
	{
		if (func_32(*uParam0, *uParam0.f_1.f_75[iVar0]))
		{
			...
			vVar4 = {func_269(uParam0, uParam0.f_1.f_34[iVar0 /*2*/])};
...
Vector3 func_269(auto uParam0, auto uParam1)
{
	float fVar0;
	float fVar1;
	float fVar2;
		...
		while (iVar0 < *uParam0.f_1.f_33)
		{
			if (func_32(*uParam0, *uParam0.f_1.f_75[iVar0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_428[iVar0]))
				{
					...
					vVar6 = {func_269(uParam0, uParam0.f_1.f_34[iVar0 /*2*/])};
		...
		if (!func_110(0))
		{
			if (func_285(37))
			{
				if (!is_bit_set(iLocal_41, 8))
				{
					...
					_request_cutscene_2("RBHS_MCS_3", 5, 8);
			...
			else
			{
				if (!is_bit_set(iLocal_41, 9))
				{
					...
					_request_cutscene_2("RBHS_MCS_3", 6, 8);
			...
			if (func_150(91))
			{
				if (func_143(0))
				{
					...
					{
						func_281();
						iLocal_125 = add_scenario_blocking_area(Local_176.f_1.f_394 - Local_176.f_1.f_397, Local_176.f_1.f_394 + Local_176.f_1.f_397, 0, 1, 1, 1);
						...
						set_ped_paths_in_area(Local_176.f_1.f_394 - Local_176.f_1.f_397, Local_176.f_1.f_394 + Local_176.f_1.f_397, false, 0);
						if (is_player_playing(player_id()))
						{
				...
				if (func_280("RBHS_MCS_3"))
				{
					if (!is_cutscene_playing())
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
						{
							if (is_vehicle_driveable(iLocal_46, 0))
							{
								_set_vehicle_door_breakable(iLocal_46, 0, false);
							}
						}
						...
						if (func_92() == 0)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_132[2]) && !is_entity_dead(iLocal_132[2], 0))
							{
								register_entity_for_cutscene(iLocal_132[2], "TREVOR", 0, joaat("player_two"), 0);
							}
							else
						...
						else if (func_92() == 2)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_129) && !is_entity_dead(iLocal_129, 0))
							{
								register_entity_for_cutscene(iLocal_129, "MICHAEL", 0, joaat("player_zero"), 0);
							}
							else
					...
					else
					{
						...
						if (!is_bit_set(iLocal_41, 19))
						{
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 19);
						}
						...
						{
							if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity("Trevor", joaat("player_two"))))
							{
						...
						{
							if ((get_cutscene_time() > 43160 && func_285(38)) || (get_cutscene_time() > 42740 && func_285(37)))
							{
								func_107(2, 0, 1);
								func_107(2, 1, 1);
						...
						{
							if (!is_bit_set(iLocal_41, false))
							{
								func_279();
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, false);
							}
							...
							if (!is_bit_set(iLocal_41, 18))
							{
								...
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 18);
							}
						}
						if (was_cutscene_skipped())
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 20);
						}
...
void func_288(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	char[8] cVar0;
...
void func_289(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_33 < 20)
	{
...
void func_290(auto uParam0, int iParam1, int iParam2, char* sParam3)
{
	char[32] cVar0;
...
void func_291(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (*uParam0.f_117 < 22)
	{
...
void func_292(auto uParam0, int iParam1, char* sParam2)
{
	char[8] cVar0;
...
void func_293(auto uParam0, int iParam1, char* sParam2, char* sParam3)
{
	char[8] cVar0;
	char[8] cVar2;
...
void func_294(auto uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8)
{
	char[16] cVar0;
	char[16] cVar4;
	char[16] cVar8;
...
void func_295(auto uParam0, float fParam1, float fParam2, float fParam3)
{
	*uParam0.f_9 = fParam1;
...
void func_297(auto uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, auto uParam10, Vector3 vParam11, Vector3 vParam12)
{
	*uParam0.f_1 = iParam1;
