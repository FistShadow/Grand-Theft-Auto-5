...
void func_1()
{
	...
	if (is_bit_set(Global_1617379.f_83830, true))
	{
		if (iLocal_294 == player_id())
		{
			if (!iLocal_281)
			{
				disable_vehicle_weapon(1, joaat("vehicle_weapon_space_rocket"), iLocal_291, player_ped_id());
				iLocal_281 = 1;
			}
		}
	}
	...
	else if (iLocal_294 == player_id())
	{
		if (iLocal_281)
		{
			disable_vehicle_weapon(0, joaat("vehicle_weapon_space_rocket"), iLocal_291, player_ped_id());
			iLocal_281 = 0;
		}
	}
	func_79();
	...
	switch (Local_298[participant_id_to_int() /*2*/].f_1)
	{
		...
		case 2:
			...
			if (Global_2428492.f_3422.f_1)
			{
				if (iLocal_284)
				{
					play_sound_from_coord(-1, "Prison_Finale_Buzzard_Rocket", func_4(), "DLC_HEISTS_GENERIC_SOUNDS", 1, 50, 0);
					iLocal_284 = 0;
				}
			}
			else
...
void func_6()
{
	...
	while (iVar0 < 32)
	{
		iVar16 = is_bit_set(Global_1573747, iVar0);
		iVar2 = iVar0;
		if (iVar2 != player_id())
		{
			if (func_16(iVar2, 1, 1))
			{
				...
				vVar3 = {get_entity_coords(iVar1, 1)};
...
int func_15(int iParam0, int iParam1)
{
	if (iParam1 == -1)
	{
		return is_bit_set(Global_2418472[player_id() /*313*/].f_32, iParam0);
	}
						...
						if (!is_entity_dead(player_ped_id(), 0))
						{
							if (does_cam_exist(Local_65.f_32))
							{
								if (is_cam_active(Local_65.f_32))
								{
									...
									shoot_single_bullet_between_coords(func_4(), Local_65.f_45, iVar0, 1, joaat("weapon_passenger_rocket"), player_ped_id(), 1, 1, -1082130432);
									play_sound_from_coord(-1, "Prison_Finale_Buzzard_Rocket_Player", func_4(), "DLC_HEISTS_GENERIC_SOUNDS", 0, 0, 0);
		...
		if (*uParam0.f_86 == 1)
		{
			...
			if (*uParam0.f_87 == 0)
			{
				...
				while (iVar4 < *uParam0.f_175)
				{
					if (is_bit_set(*(uParam0.f_175[iVar4 /*10*/]).f_2, 9))
					{
						if (does_entity_exist(*uParam0.f_175[iVar4 /*10*/]))
						{
							...
							{
								if (is_bit_set(*(uParam0.f_175[iVar4 /*10*/]).f_2, false))
								{
							...
							if (does_entity_exist(*uParam0.f_175[iVar4 /*10*/]))
							{
								if (!is_entity_dead(*uParam0.f_175[iVar4 /*10*/], 0) && !is_entity_dead(player_ped_id(), 0))
								{
									...
									if (is_entity_on_screen(*uParam0.f_175[iVar4 /*10*/]))
									{
										...
										if (timera() - *(uParam0.f_175[iVar4 /*10*/]).f_1 < 1500 || is_bit_set(*(uParam0.f_175[iVar4 /*10*/]).f_2, false))
										{
				...
				*uParam0.f_49 = 0;
				...
				{
					if (!is_bit_set(*(uParam0.f_175[*uParam0.f_92 /*10*/]).f_2, false))
					{
							...
							if (*uParam0.f_77 / *uParam0.f_40 * fVar16 > 0.5f)
							{
								...
								*uParam0.f_49 = 1;
								...
								else
								{
									...
									set_bit(uParam0.f_175[*uParam0.f_92 /*10*/].f_2, false);
...
bool func_32(var uParam0, var uParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	if (is_bit_set(*(uParam0.f_175[uParam1 /*10*/]).f_2, 8))
	{
	}
	iVar4 = 24;
	while (iVar4 <= 31)
	{
		if (is_bit_set(*(uParam0.f_175[uParam1 /*10*/]).f_5, iVar4))
		{
...
bool func_37(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam1)
	{
		case 0:
...
void func_38(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_40(var uParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4)
{
	var uVar0;
	vector3 vVar1;
	vector3 vVar4;
...
float func_41(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, int iParam4)
{
	float fVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_42(var uParam0)
{
	if (*uParam0.f_194 == 0)
	{
		...
		{
			*uParam0.f_194 = 1;
			*uParam0.f_196 = get_sound_id();
			*uParam0.f_197 = get_sound_id();
			*uParam0.f_199 = get_sound_id();
			*uParam0.f_198 = get_sound_id();
			*uParam0.f_200 = get_sound_id();
			*uParam0.f_201 = get_sound_id();
...
void func_44(var uParam0)
{
	...
	if (((does_cam_exist(*uParam0.f_32) && *uParam0.f_7 == 0) && *uParam0.f_35) && !*uParam0.f_4)
	{
		...
		while (iVar13 < *uParam0.f_175)
		{
			...
			{
				if (func_45(get_entity_coords(*uParam0.f_175[iVar13 /*10*/], 1), 0.4f, 0.4f, 0.6f, 0.6f))
				{
					iVar18 = 1;
					iVar19 = 1;
...
void func_46()
{
	if (iLocal_282)
	{
		if (is_ped_in_vehicle(player_ped_id(), iLocal_291, 0))
		{
			switch (iLocal_290)
			{
				case 0:
...
void func_58()
{
	if (does_entity_exist(Local_65.f_9))
	{
		if (!is_entity_dead(Local_65.f_9, 0))
		{
			if (get_entity_model(Local_65.f_9) != joaat("valkyrie") && get_entity_model(Local_65.f_9) != joaat("savage"))
			{
...
bool func_64(var uParam0, int iParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
int func_70()
{
	...
	if (((!is_pause_menu_active() && !func_3()) && !func_2(0)) && !Global_1315839)
	{
		...
		{
			if (!is_bit_set(Global_1617379.f_15, 12) && !Global_2443115)
			{
			...
			if (is_ped_sitting_in_any_vehicle(iVar0))
			{
				if (is_vehicle_driveable(iLocal_291, 0))
				{
					...
					if (!is_vehicle_seat_free(iLocal_291, -1))
					{
						...
						iLocal_277 = does_entity_exist(iLocal_292);
						if (iLocal_277)
						{
							iLocal_278 = is_entity_dead(iLocal_292, 0);
					...
					if (!is_vehicle_seat_free(iLocal_291, false))
					{
						...
						iLocal_279 = does_entity_exist(iLocal_293);
						if (iLocal_279)
						{
							iLocal_280 = is_entity_dead(iLocal_293, 0);
...
void func_89()
{
	...
	{
		if (iLocal_292 == player_ped_id() && network_has_control_of_entity(iLocal_291))
		{
			disable_vehicle_weapon(0, joaat("vehicle_weapon_space_rocket"), iLocal_291, player_ped_id());
		}
	}
	...
	if (does_entity_exist(player_ped_id()))
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), 0))
			{
				...
				{
					iLocal_272 = get_entity_model(get_vehicle_ped_is_using(player_ped_id()));
					iLocal_291 = get_vehicle_ped_is_using(player_ped_id());
				}
			}
		}
	}
...
void func_117(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_90();
