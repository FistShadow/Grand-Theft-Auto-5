#region Local Var
	...
	int iLocal_582 = 0;
	int iLocal_583 = 0;
	struct<33> Local_584 = 15;
	auto uLocal_617 = 1;
	int[] iLocal_618 = new int[3];
	int iLocal_622 = 0;
	int iLocal_623 = 0;
	int iLocal_624 = 0;
	int iLocal_625 = 0;
...
void main()
{
	...
	else if (Global_101154.f_18725[iLocal_568] > 0)
	{
		if (func_285())
		{
			func_283(iLocal_568, Local_68.f_486.f_9.f_2, &vVar13, &vVar16);
			clear_area_of_peds(Local_68.f_181, 15f, 0);
			iLocal_567 = add_scenario_blocking_area(vVar13, vVar16, 0, 1, 1, 1);
			if (!func_290())
			{
				func_286(1);
			}
		...
		{
			iLocal_64 = 10;
			iVar19 = get_random_int_in_range(false, 3);
			if (iVar19 == 0)
			{
				Local_68.f_2.f_12 = 1;
			}
...
int func_1(auto uParam0, int iParam1)
{
...
void func_5()
{
	...
	if (!PED::IS_PED_INJURED(Local_68.f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (get_current_ped_weapon(PLAYER::PLAYER_PED_ID(), &iVar1, 1))
		{
			...
			{
				if ((((is_player_free_aiming(player_id()) && is_ped_facing_ped(PLAYER::PLAYER_PED_ID(), Local_68.f_2, 45f)) && is_entity_at_entity(PLAYER::PLAYER_PED_ID(), Local_68.f_2, 5f, 5f, 2f, 0, 1, 0)) || is_player_free_aiming_at_entity(player_id(), Local_68.f_2)) || is_player_targetting_entity(player_id(), Local_68.f_2))
				{
					if (!func_25() && !is_first_person_aim_cam_active())
					{
						iLocal_576 = true;
					}
				}
	...
	if (iLocal_576)
	{
		if (!iLocal_577 && func_1(Local_68.f_470, 4))
		{
			...
			if (iVar3 == 416676503)
			{
				...
				task_play_anim(PLAYER::PLAYER_PED_ID(), "mp_am_hold_up", sLocal_578, 8f, -8f, -1, 305, 0, 0, 0, 0);
			}
	...
	else if (iLocal_577)
	{
		...
		{
			if (is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "mp_am_hold_up", sLocal_578, 3))
			{
				stop_anim_task(PLAYER::PLAYER_PED_ID(), "mp_am_hold_up", sLocal_578, -8f);
			}
		}
		iLocal_577 = 0;
	}
	switch (iLocal_64)
	{
		case 0:
			...
			else if (!func_290() && func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1))
			{
				iLocal_64 = 12;
			}
			break;
		...
		case 7:
			...
			{
				func_18();
				GAMEPLAY::CLEAR_BIT(&Global_87462, 3);
				iLocal_64 = 13;
			}
			break;
				...
				if (func_16())
				{
					if (!is_entity_dead(Local_68.f_2, 0))
					{
						if (!is_ped_ragdoll(Local_68.f_2))
						{
							...
							{
								task_smart_flee_ped(Local_68.f_2, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
								iLocal_60 = 10;
							}
						}
					}
...
void func_6()
{
	...
	task_follow_nav_mesh_to_coord(false, Local_68.f_2.f_6, 2f, -1, 0.25f, 0, Local_68.f_2.f_9);
	task_cower(false, -1);
	close_sequence_task(iVar0);
	task_perform_sequence(Local_68.f_2, iVar0);
...
{
	if (get_player_wanted_level(get_player_index()) < iParam0 && (!iLocal_574 || (iLocal_574 && iParam0 < iLocal_571)))
	{
		...
		case 0:
			...
			if (!is_ped_dead_or_dying(Local_68.f_2, 1))
			{
				if (!is_entity_dead(Local_68.f_28, 0))
				{
					if (Local_68.f_486 >= 0)
					{
						set_entity_collision(Local_68.f_28, true, 0);
						set_entity_dynamic(Local_68.f_28, 1);
						task_synchronized_scene(Local_68.f_2, Local_68.f_486, Local_68.f_486.f_1, Local_68.f_486.f_3, 8f, -1.5f, 25, 0, 1000f, 0);
						play_synchronized_entity_anim(Local_68.f_28, Local_68.f_486, Local_68.f_486.f_4, Local_68.f_486.f_1, 1000f, 8f, 137, 1000f);
						play_synchronized_entity_anim(Local_68.f_96.f_1, Local_68.f_486, Local_68.f_486.f_5, Local_68.f_486.f_1, 1000f, 8f, 137, 1000f);
					}
					else
					{
						return true;
				...
				if (is_synchronized_scene_running(Local_68.f_486))
				{
					if (get_synchronized_scene_phase(Local_68.f_486) > 0.447f)
					{
						if (!is_entity_dead(Local_68.f_28, 0))
						{
							...
							{
								set_entity_visible(Local_68.f_28, true, 0);
							}
						}
					}
					if (Local_68.f_467)
...
void func_18()
{
	if (!is_entity_dead(Local_68.f_2, 0))
	{
		...
		task_combat_hated_targets_around_ped(false, 25f, 0);
...
bool func_20(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_21(iVar3))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
...
auto func_22(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_23()
{
	...
	if (!is_entity_dead(Local_68, 0))
	{
		if (is_ped_in_any_vehicle(Local_68, 0))
		{
			iVar1 = get_vehicle_ped_is_in(Local_68, 0);
			iVar0 = true;
		}
	...
	if (iVar0)
	{
		...
		{
			if (is_entity_in_angled_area(iVar1, Local_68.f_186, Local_68.f_189, Local_68.f_192, 0, true, 0))
			{
				return true;
			}
			else if (is_entity_in_angled_area(iVar1, Local_68.f_200, Local_68.f_203, Local_68.f_206, 0, true, 0))
			{
				return true;
			}
			else if (is_entity_in_angled_area(iVar1, Local_68.f_207, Local_68.f_210, Local_68.f_213, 0, true, 0))
			{
				return true;
			}
			else if (Local_68.f_199 != -1f)
			{
				if (is_entity_in_angled_area(iVar1, Local_68.f_193, Local_68.f_196, Local_68.f_199, 0, true, 0))
				{
					return true;
				}
			}
...
void func_28(char* sParam0, int iParam1)
{
	...
	{
		if (func_27(sParam0) && !is_help_message_fading_out())
		{
			clear_help(0);
		}
	}
...
void func_36()
{
	...
	switch (iLocal_53)
	{
		...
		case 2:
			if (!is_entity_dead(Local_68.f_2, 0))
			{
				func_47(Local_68.f_2, func_45(iLocal_582, "SHOP_THREATENED", func_45(func_46(), "SHOP_NO_COPS_START", "SHOP_NO_COPS_END")), 3);
			}
			iLocal_53 = 14;
			break;
			...
			if (func_44() || func_43())
			{
				...
				else if (func_8(&(Local_68.f_483)) > 10f)
				{
					if (!func_1(Local_68.f_470, 32))
					{
						...
						{
							task_play_anim(Local_68.f_2, "misscommon@response", "numbnuts", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						iLocal_53 = 36;
						func_15(1, 0);
		...
		case 12:
			if (!is_ambient_speech_playing(PLAYER::PLAYER_PED_ID()))
			{
		...
		case 24:
			...
			{
				set_vehicle_siren(Local_68.f_46.f_4[0], false);
			}
		...
		case 33:
			if (!is_ambient_speech_playing(PLAYER::PLAYER_PED_ID()) && !is_ambient_speech_playing(Local_68.f_2))
			{
				if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
				{
...
bool func_43()
{
	if (!is_entity_dead(Local_68, 0))
	{
		if (is_entity_in_angled_area(Local_68, Local_68.f_200, Local_68.f_203, Local_68.f_206, 0, true, 0))
		{
			return true;
		}
	}
...
bool func_44()
{
	if (!is_entity_dead(Local_68, 0))
	{
		if (is_entity_in_angled_area(Local_68, Local_68.f_214, Local_68.f_217, Local_68.f_220, 0, true, 0))
		{
			return true;
		}
	}
...
{
	_play_ambient_speech1(iParam0, sParam1, func_48(iParam2), 1);
}
...
bool func_52(int iParam0)
{
	if (!is_entity_dead(iParam0, 0))
	{
		...
		else if (is_entity_in_angled_area(iParam0, Local_68.f_186, Local_68.f_189, Local_68.f_192, 0, true, 0))
		{
			return true;
		}
		else if (is_entity_in_angled_area(iParam0, Local_68.f_200, Local_68.f_203, Local_68.f_206, 0, true, 0))
		{
			return true;
		}
		else if (is_entity_in_angled_area(iParam0, Local_68.f_207, Local_68.f_210, Local_68.f_213, 0, true, 0))
		{
			return true;
		}
		else if (Local_68.f_199 != -1f)
		{
			if (is_entity_in_angled_area(iParam0, Local_68.f_193, Local_68.f_196, Local_68.f_199, 0, true, 0))
			{
				return true;
			}
		}
...
void func_53()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_290())
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_68.f_162.f_18, false))
			{
				iVar12 = 0;
				iVar13 = 0;
				iVar12 = get_ped_nearby_peds(PLAYER::PLAYER_PED_ID(), &uVar1, -1);
				iVar0 = 0;
				...
				while (iVar13 < iVar12)
				{
					...
					{
						if ((ENTITY::DOES_ENTITY_EXIST(uVar1[iVar13]) && !PED::IS_PED_INJURED(uVar1[iVar13])) && !is_ped_in_any_vehicle(uVar1[iVar13], 0))
						{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_68.f_162.f_18), false);
			}
			iVar0 = 0;
			while (iVar0 < Local_68.f_162)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_68.f_162[iVar0]) && !PED::IS_PED_INJURED(Local_68.f_162[iVar0])) && !is_ped_in_any_vehicle(Local_68.f_162[iVar0], 0))
				{
					if (GAMEPLAY::IS_BIT_SET(Local_68.f_162.f_18, true))
					{
						if (GAMEPLAY::GET_GAME_TIMER() % 1500 < 50)
						{
						}
						set_entity_visible(Local_68.f_162[iVar0], false, 0);
						set_entity_collision(Local_68.f_162[iVar0], false, 0);
						freeze_entity_position(Local_68.f_162[iVar0], true);
					...
					{
						set_entity_visible(Local_68.f_162[iVar0], true, 0);
						set_entity_collision(Local_68.f_162[iVar0], true, 0);
						freeze_entity_position(Local_68.f_162[iVar0], false);
						set_entity_coords_no_offset(Local_68.f_162[iVar0], Local_68.f_162.f_5[iVar0 /*3*/], 1, 1, 1);
					}
				}
				iVar0++;
		...
		else
		{
			if (GAMEPLAY::IS_BIT_SET(Local_68.f_162.f_18, false))
			{
				GAMEPLAY::CLEAR_BIT(&(Local_68.f_162.f_18), false);
			}
			iVar0 = 0;
			while (iVar0 < Local_68.f_162)
			{
	...
	switch (iLocal_622)
	{
		case 0:
			if (func_290())
			{
				...
				request_streamed_texture_dict(func_63(iLocal_568), false);
		...
		case 1:
			...
			if (!func_1(Local_68.f_470, 4))
			{
				...
				{
					iLocal_618[0] = create_object(func_60(0), func_59(0), 1, true, false);
					iLocal_618[1] = create_object(func_60(1), func_59(1), 1, true, false);
					iLocal_618[2] = create_object(func_60(2), func_59(2), 1, true, false);
					set_entity_visible(iLocal_618[0], false, 0);
					set_entity_visible(iLocal_618[1], false, 0);
					set_entity_visible(iLocal_618[2], false, 0);
...
void func_55()
{
	...
	set_streamed_texture_dict_as_no_longer_needed(func_63(iLocal_568));
...
int func_61(char* sParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_62(&(Global_17257.f_5530[uVar0 /*10*/]));
	if (!iVar1 || !iVar2)
	{
	}
	return (iVar1 && iVar2);
...
void func_66()
{
	...
	func_177();
	if (((((iLocal_60 == 1 || iLocal_60 == 2) && get_player_wanted_level(player_id()) == 0) && !PED::IS_PED_INJURED(Local_68)) && !func_176(-1082130432)) && !PED::IS_PED_INJURED(Local_68.f_2))
	{
		iVar1 = get_entity_health(PLAYER::PLAYER_PED_ID());
		iVar2 = get_entity_max_health(PLAYER::PLAYER_PED_ID());
		...
		switch (iLocal_66)
		{
			case 0:
				if (func_1(Local_68.f_470, 4) && func_24(Local_68) == joaat("weapon_unarmed"))
				{
					if (func_175(iLocal_568, &(Local_68.f_486.f_6), Local_68.f_486.f_9.f_2, &(Local_68.f_102.f_26[0 /*3*/]), &(Local_68.f_102.f_26[1 /*3*/]), &(Local_68.f_102.f_33), &(Local_68.f_102.f_36)))
					{
						...
						{
							if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), Local_68.f_102.f_26[0 /*3*/], Local_68.f_102.f_26[1 /*3*/], Local_68.f_102.f_36, 0, true, 0))
							{
								if (_0xFCF37A457CB96DC0(PLAYER::PLAYER_PED_ID(), Local_68.f_102.f_33, 135f))
								{
									if (GAMEPLAY::GET_GAME_TIMER() % 1000 < 50)
									{
									}
									...
									GAMEPLAY::CLEAR_BIT(&(Local_68.f_162.f_18), true);
									GAMEPLAY::CLEAR_BIT(&(Local_68.f_162.f_18), false);
									iLocal_66 = 1;
								}
							}
			...
			case 1:
				if (!_0xFCF37A457CB96DC0(PLAYER::PLAYER_PED_ID(), Local_68.f_102.f_33, 135f) || !func_24(Local_68) == joaat("weapon_unarmed"))
				{
					if (func_27("SHR_MENU"))
					{
						clear_help(1);
				...
				if ((!is_ped_running(PLAYER::PLAYER_PED_ID()) && !is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) && !is_ped_jumping(PLAYER::PLAYER_PED_ID()))
				{
					if (func_168(Local_68.f_469, 1))
					{
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_68.f_162.f_18), true);
						func_12(&(Local_68.f_102.f_53));
						func_171(&(Local_68.f_469));
						func_167(23, 1);
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(Local_68.f_2))
						{
							task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_68.f_2, false);
						}
						iLocal_66 = 2;
					}
				}
			...
			case 2:
				if (!does_cam_exist(iLocal_641))
				{
					iLocal_641 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 50f, 0, 2);
				}
				func_166(iLocal_568, Local_68.f_486.f_6, Local_68.f_486.f_9.f_2, &(Local_68.f_102), &(Local_68.f_102.f_3), &uVar8);
				set_cam_coord(iLocal_641, Local_68.f_102);
				set_cam_rot(iLocal_641, Local_68.f_102.f_3, 2);
				set_cam_fov(iLocal_641, 35f);
				shake_cam(iLocal_641, "HAND_SHAKE", 0.1f);
				set_cam_active(iLocal_641, true);
			...
			case 4:
				...
				switch (Local_68.f_102.f_23)
				{
					case 0:
						...
						if (iVar1 + 10 > iVar2)
						{
							set_entity_health(PLAYER::PLAYER_PED_ID(), iVar2);
						}
						else
						{
							set_entity_health(PLAYER::PLAYER_PED_ID(), iVar1 + 10);
						}
						break;
					...
					case 1:
						...
						{
							set_entity_health(PLAYER::PLAYER_PED_ID(), iVar1 + 20);
						}
						break;
					...
					case 2:
						...
						{
							set_entity_health(PLAYER::PLAYER_PED_ID(), iVar1 + 15);
						}
						break;
				}
			...
			case 6:
				...
				if (!PED::IS_PED_INJURED(Local_68.f_2) && func_1(Local_68.f_470, 4))
				{
					task_play_anim(Local_68.f_2, "misscommon@response", "give_me_a_break", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
	...
	else
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Local_68.f_162.f_18, true) && iLocal_624 < 2)
		{
			GAMEPLAY::CLEAR_BIT(&(Local_68.f_162.f_18), true);
		}
		if (func_1(Local_68.f_470, 4))
...
void func_67()
{
	...
	if (does_cam_exist(iLocal_641))
	{
		destroy_cam(iLocal_641, 0);
	}
}

int func_68(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_69(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_72(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_74() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_74() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_73(iParam0));
...
int func_76(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_74() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_80(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_82(auto uParam0, int iParam1)
{
...
void func_85(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_88(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_96()
{
	...
	{
		if (func_99(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_101()
{
	...
	{
		Local_68.f_102.f_40 = func_102(func_98(PLAYER::PLAYER_PED_ID())) >= func_154(Local_68.f_102.f_23);
		Local_68.f_102.f_41 = 1;
	}
	if (!Local_68.f_102.f_42)
	{
		Local_68.f_102.f_43 = get_entity_health(PLAYER::PLAYER_PED_ID()) < get_entity_max_health(PLAYER::PLAYER_PED_ID());
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_17257)
	{
		if (func_136(29, 1, 1, &fVar35, &fVar36, iParam7))
		{
			fVar55 = fVar36;
			fVar55 += 0f;
		}
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17257.f_5598)
		{
			...
			else
			{
				if (Global_17257)
				{
					draw_sprite(func_134(29), func_132(29, 1), Global_17254 + fParam5 * 0.5f, Global_17255 + fVar55 - 0f * 0.5f, fParam5, fVar55 - 0f, 0f, 255, 255, 255, 255, 0);
				}
			...
			if (get_hash_key(&(Global_17257.f_4562)) != 0 && Global_17257.f_4636 != -1)
			{
				...
				{
					func_136(Global_17257.f_4638, 1, 1, &fVar35, &fVar36, iParam7);
				...
				if (Global_17257.f_4638 != 0)
				{
					...
					draw_sprite(func_134(Global_17257.f_4638), func_132(Global_17257.f_4638, 1), Global_17254 + fVar35 * 0.5f + 0.00078125f * 2f, fVar49 + fVar36 * 0.5f - 0.00138888f * 4f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
				}
			...
			if (get_hash_key(&(Global_2562053.f_21)) != 0 && Global_2562053.f_65 != -1)
			{
				...
				{
					func_136(Global_2562053.f_67, 1, 1, &fVar35, &fVar36, iParam7);
					fVar41 = Global_17254 + fVar35 + 0.00078125f * 4f - 0.00078125f * 1f;
				}
				func_127(fVar41);
				...
				if (Global_2562053.f_67 != 0)
				{
					...
					draw_sprite(func_134(Global_2562053.f_67), func_132(Global_2562053.f_67, 1), Global_17254 + fVar35 * 0.5f + 0.00078125f * 2f, fVar49 + fVar36 * 0.5f - 0.00138888f * 4f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
				}
				fVar49 += _get_text_scale_height(0.35f, 0) * IntToFloat(iVar6) + 0.00138888f * 13f + 0.00138888f * 5f * IntToFloat(iVar6 - 1);
			...
			func_118(iVar57, iParam1, 0, 0, 0, 0, iParam4, 1, 0);
			_set_screen_draw_position(76, 84);
			_0xF5A2C681787E579D(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17257.f_5598)
							...
							switch (Global_17257.f_4926[iVar8])
							{
									...
									if (iVar5 == 1 && iVar32)
									{
										if (!Global_17257.f_5599)
										{
											...
											if (get_hash_key(&(Global_17257.f_73[iVar24 /*6*/])) != 0)
											{
												...
												func_116(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, iVar70, iVar50);
											...
											if (iVar28 > 0)
											{
												...
												while (iVar14 < iVar28)
												{
													if (func_136(Global_17257.f_4433[iVar22 + iVar14], iVar31, 0, &fVar35, &fVar36, iParam7))
													{
														fVar43 += fVar35;
														if (iVar14 > 0)
														{
										...
										if (iVar51)
										{
											if (func_136(26, 1, 0, &fVar35, &fVar36, iParam7))
											{
												if (Global_17257.f_4953[iVar8] == 2)
												{
													fVar41 -= fVar35 * 2f;
												...
												fVar44 = fVar35 * 0.5f;
												if (func_136(26, 1, 1, &fVar35, &fVar36, iParam7))
												{
													func_126(26, 1, &iVar46, &iVar47, &iVar48);
													draw_sprite(func_134(26), func_132(26, 1), fVar33 + fVar41 + fVar44, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
												}
											}
											if (func_136(27, 1, 0, &fVar35, &fVar36, iParam7))
											{
												fVar41 += fVar35;
												fVar44 = fVar35 * 0.5f;
												if (func_136(27, 1, 1, &fVar35, &fVar36, iParam7))
												{
													func_126(27, 1, &iVar46, &iVar47, &iVar48);
													draw_sprite(func_134(27), func_132(27, 1), fVar33 + fVar41 + fVar44 + fVar42 + fVar43, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
												}
											}
										}
										iVar25 = 0;
										...
										if (get_hash_key(&(Global_17257.f_73[iVar24 /*6*/])) != 0)
										{
											...
											func_116(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, 0, iVar50);
										...
										while (iVar14 < 4)
										{
											...
											else if (Global_17257.f_2124[iVar24 /*5*/][iVar14] == 4)
											{
												...
												{
													if (func_136(Global_17257.f_4433[iVar22 + iVar28], iVar31, 0, &fVar35, &fVar36, iParam7))
													{
														fVar41 += fVar35 * 0.5f;
														if (func_136(Global_17257.f_4433[iVar22 + iVar28], iVar31, 1, &fVar35, &fVar36, iParam7))
														{
															func_126(Global_17257.f_4433[iVar22 + iVar28], iVar31, &iVar46, &iVar47, &iVar48);
															if (Global_17257.f_4953[iVar8] == 2)
															{
																draw_sprite(func_134(Global_17257.f_4433[iVar22 + iVar28]), func_132(Global_17257.f_4433[iVar22 + iVar28], iVar31), fVar33 + fVar41 - 0.00078125f * 8f + 0.00078125f * 4f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else
															{
																draw_sprite(func_134(Global_17257.f_4433[iVar22 + iVar28]), func_132(Global_17257.f_4433[iVar22 + iVar28], iVar31), fVar33 + fVar41 - 0.00078125f * 8f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
										...
										if (iVar28 > 0)
										{
											...
											while (iVar14 < iVar28)
											{
												if (Global_17257.f_4433[iVar22 + iVar14] != 2 && Global_17257.f_4433[iVar22 + iVar14] != 48)
												{
													...
													{
														fVar41 += fVar35 * 0.5f;
														if (func_136(Global_17257.f_4433[iVar22 + iVar14], iVar31, 1, &fVar35, &fVar36, iParam7))
														{
															func_126(Global_17257.f_4433[iVar22 + iVar14], iVar31, &iVar46, &iVar47, &iVar48);
															if (Global_17257.f_4433[iVar22 + iVar14] == 30)
															{
																draw_sprite(func_134(Global_17257.f_4433[iVar22 + iVar14]), func_132(Global_17257.f_4433[iVar22 + iVar14], iVar31), Global_17254 + fVar35 * 0.5f, fVar34 + 0.00277776f + fVar36 * 0.5f - 0.00078125f * 11f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else if (Global_17257.f_4953[iVar8] == 2)
															{
																draw_sprite(func_134(Global_17257.f_4433[iVar22 + iVar14]), func_132(Global_17257.f_4433[iVar22 + iVar14], iVar31), fVar33 + fVar41 + fVar42 - 0.00078125f * 8f + 0.00078125f * 4f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
															else
															{
																draw_sprite(func_134(Global_17257.f_4433[iVar22 + iVar14]), func_132(Global_17257.f_4433[iVar22 + iVar14], iVar31), fVar33 + fVar41 + fVar42 - 0.00078125f * 12f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35, fVar36, 0f, iVar46, iVar47, iVar48, 255, 0);
															}
														}
								...
								case 2:
									if (iVar5 == 1 && iVar32)
									{
										if (!Global_17257.f_5599)
										{
											func_116(iVar31, Global_17257.f_1610[iVar24], Global_17257.f_1867[iVar24], iVar53, 0, 0);
											if (Global_17257.f_7858 && Global_17257.f_7859 == iVar6)
											{
												func_115(iVar31);
											}
								...
								case 4:
									if (iVar5 == 1 && iVar32)
									{
										if (func_136(Global_17257.f_4433[iVar22], iVar31, 0, &fVar35, &fVar36, iParam7))
										{
											if (!Global_17257.f_5599)
											{
												fVar43 = fVar35;
											...
											if (func_136(Global_17257.f_4433[iVar22], iVar31, 1, &fVar35, &fVar36, iParam7))
											{
												func_126(Global_17257.f_4433[iVar22], iVar31, &iVar46, &iVar47, &iVar48);
												draw_sprite(func_134(Global_17257.f_4433[iVar22]), func_132(Global_17257.f_4433[iVar22], iVar31), fVar33 + fVar41 + fVar35 * 0.5f, fVar34 - 0.00277776f + fVar54 * 0.5f, fVar35 * func_112(Global_17257.f_4433[iVar22]), fVar36 * func_112(Global_17257.f_4433[iVar22]), 0f, iVar46, iVar47, iVar48, 255, 0);
											}
										}
									}
									iVar40 = true;
...
void func_113(float fParam0, float fParam1, char* sParam2, Vector3 fParam3, int iParam4)
{
...
void func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	auto uVar0;
	int iVar1;
	int iVar2;
	...
	iParam0 = iParam0;
	if (iParam3 && !func_138(iParam4, iParam8))
	{
		return;
	}
	if (func_124())
...
bool func_136(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4, int iParam5)
{
	char* sVar0;
	char* sVar1;
	int iVar2;
	...
	sVar1 = func_132(iParam0, iParam1);
	if (get_hash_key(sVar1) != 0)
	{
		...
		vVar7.x *= func_137(iParam0) / fVar4;
		vVar7.y *= func_137(iParam0) / fVar4;
		if (!iParam2)
		{
			vVar7.x -= 2f;
			vVar7.y -= 2f;
...
bool func_138(int iParam0, int iParam1)
{
	...
	if ((((((((!is_screen_faded_in() || (func_140(8, -1) && func_139() != 64)) || (get_pause_menu_state() != 0 && !iParam1)) || (is_player_switch_in_progress() && !iParam0)) || _0x2EAC52B4019E2782()) || Global_69749) || Global_17257.f_7861) || is_warning_message_active()) || Global_91330.f_1352)
	{
		return false;
	}
	return true;
...
void func_149(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_155(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_166(int iParam0, Vector3 vParam1, Vector3 fParam2, auto uParam3, auto uParam4, auto uParam5)
{
	switch (iParam0)
	{
		case 0:
...
void func_172(auto uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
bool func_175(int iParam0, auto uParam1, Vector3 fParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	switch (iParam0)
	{
		case 0:
...
void func_177()
{
	...
	{
		case 0:
			set_entity_visible(iLocal_618[iLocal_634], true, 0);
			iLocal_632 = create_synchronized_scene(_get_object_offset_from_coords(Local_68.f_486.f_6, Local_68.f_486.f_9.f_2, -0.07f, 0.06f, -0.02f), Local_68.f_486.f_9, 2);
			if (!PED::IS_PED_INJURED(Local_68.f_2))
			{
				task_synchronized_scene(Local_68.f_2, iLocal_632, "mp_am_hold_up", "purchase_chocbar_shopkeeper", 1.5f, -1.5f, 0, 0, 1000f, 0);
				play_synchronized_entity_anim(iLocal_618[iLocal_634], iLocal_632, "purchase_chocbar", "mp_am_hold_up", 1000f, 8f, 1, 1000f);
				iLocal_630 = 1;
			}
			break;
		
		case 1:
			if (is_synchronized_scene_running(iLocal_632))
			{
				if (get_synchronized_scene_phase(iLocal_632) == 1f)
				{
					if (!PED::IS_PED_INJURED(Local_68.f_2))
					{
					...
					{
						set_entity_dynamic(iLocal_618[iLocal_634], 1);
					}
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_633 > 1000)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_618[iLocal_634]))
				{
					set_entity_visible(iLocal_618[iLocal_634], false, 0);
					set_entity_coords(iLocal_618[iLocal_634], func_59(iLocal_634), 1, false, 0, 1);
					set_entity_dynamic(iLocal_618[iLocal_634], 0);
				}
				iLocal_630 = 3;
			}
			break;
	...
	if (iLocal_54 != 6)
	{
		switch (iLocal_54)
		{
			...
			case 3:
				if (!is_entity_dead(Local_68.f_86, 0))
				{
					if ((func_181(&(Local_68.f_86.f_7), 5f) || func_179(Local_68.f_2, &(Local_68.f_451))) || is_ped_ragdoll(Local_68.f_86))
					{
						iLocal_54 = 4;
					}
				}
...
bool func_179(int iParam0, auto uParam1)
{
	if (!is_entity_dead(iParam0, 0))
	{
...
auto func_180(int iParam0, int iParam1)
{
	return func_22(get_player_ped(get_player_index()), iParam0, iParam1);
}

bool func_181(auto uParam0, float fParam1)
{
	if (func_14(uParam0))
	{
...
void func_182()
{
	if (!is_entity_dead(Local_68.f_86, 0))
	{
		...
		task_turn_ped_to_face_entity(false, Local_68, false);
		task_look_at_entity(false, Local_68, 2500, 0, 2);
		task_hands_up(false, 2500, false, -1, 0);
...
bool func_183()
{
	...
	if (!is_entity_dead(Local_68.f_86, 0))
	{
		...
		{
			set_entity_as_mission_entity(Local_68.f_86, true, 0);
			set_blocking_of_non_temporary_events(Local_68.f_86, true);
			return true;
		}
	}
	return false;
...
void func_184()
{
	...
	{
		case 0:
			if ((((is_entity_dead(Local_68.f_2, 0) || !func_205()) || func_1(Local_68.f_470, 128)) && iLocal_57 < 3) && get_number_of_fires_in_range(Local_68.f_2.f_1, 1.5f) == 0)
			{
				if ((func_44() && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && !func_204(0))
				{
				...
				if (func_168(Local_68.f_469, 1))
				{
					if (!is_entity_dead(Local_68, 0))
					{
						if (!is_entity_dead(get_players_last_vehicle(), 0))
						{
							...
							if (is_entity_in_angled_area(iVar3, Local_68.f_214, Local_68.f_217, Local_68.f_220, 0, true, 0))
							{
								set_entity_coords(iVar3, _get_object_offset_from_coords(Local_68.f_486.f_6, Local_68.f_486.f_9.f_2, -0.7961f, -1.562f, -0.4215f), 0, false, 0, 1);
							}
						}
					}
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_68.f_162.f_18), true);
					...
					func_171(&(Local_68.f_469));
					iVar2 = get_current_ped_weapon(PLAYER::PLAYER_PED_ID(), &iLocal_628, 1);
					if (iVar2)
					{
		...
		case 2:
			if (is_entity_dead(Local_68.f_2, 0))
			{
				set_entity_collision(Local_68.f_2, false, 0);
				freeze_entity_position(Local_68.f_2, true);
			}
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), _get_object_offset_from_coords(Local_68.f_2.f_1, Local_68.f_2.f_4, -0.75f, 0f, -1f), 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), Local_68.f_2.f_4);
				clear_sequence_task(&iLocal_566);
				open_sequence_task(&iLocal_566);
				task_play_anim(false, "oddjobs@shop_robbery@rob_till", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
				task_play_anim(false, "oddjobs@shop_robbery@rob_till", "loop", 8f, -8f, 4000, 1, 0, 0, 0, 0);
				task_play_anim(false, "oddjobs@shop_robbery@rob_till", "exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				close_sequence_task(iLocal_566);
				task_perform_sequence(PLAYER::PLAYER_PED_ID(), iLocal_566);
				if (!does_cam_exist(iLocal_625))
				{
					iLocal_625 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 50f, 0, 2);
				}
				attach_cam_to_entity(iLocal_625, PLAYER::PLAYER_PED_ID(), -0.1878f, 3.0635f, 0.68f, 1);
				point_cam_at_entity(iLocal_625, PLAYER::PLAYER_PED_ID(), -0.0129f, 0.0927f, 0.3008f, 1);
				set_cam_fov(iLocal_625, 35f);
				shake_cam(iLocal_625, "HAND_SHAKE", 0.1f);
				set_cam_active(iLocal_625, true);
				render_script_cams(true, false, 3000, 1, 0, 0);
			}
			iLocal_624 = 3;
			break;
		...
		case 3:
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!does_cam_exist(iLocal_626))
				{
					iLocal_626 = create_camera_with_params(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 50f, 0, 2);
				}
				attach_cam_to_entity(iLocal_626, PLAYER::PLAYER_PED_ID(), -1.0346f, 2.9183f, 0.68f, 1);
				point_cam_at_entity(iLocal_626, PLAYER::PLAYER_PED_ID(), -0.0574f, 0.1074f, 0.3008f, 1);
				set_cam_fov(iLocal_626, 35f);
				shake_cam(iLocal_626, "HAND_SHAKE", 0.3f);
				set_cam_active_with_interp(iLocal_626, iLocal_625, 8000, 1, 1);
			}
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_629 > 4800 || (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))) || get_number_of_fires_in_range(Local_68.f_2.f_1, 3f) > 0)
			{
				iLocal_624 = 5;
			}
			...
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), "oddjobs@shop_robbery@rob_till", "loop", 3))
			{
		...
		case 5:
			if (is_entity_dead(Local_68.f_2, 0))
			{
				set_entity_collision(Local_68.f_2, true, 0);
				freeze_entity_position(Local_68.f_2, false);
			}
			set_gameplay_cam_relative_heading(0);
			set_gameplay_cam_relative_pitch(0, 1f);
			if (does_cam_exist(iLocal_625))
			{
				destroy_cam(iLocal_625, 0);
			}
			if (does_cam_exist(iLocal_626))
			{
				destroy_cam(iLocal_626, 0);
			}
			render_script_cams(false, false, 3000, 1, 0, 0);
			if (!is_entity_dead(get_players_last_vehicle(), 0))
			{
		...
		case 6:
			...
			{
				set_cam_active(iLocal_626, false);
				render_script_cams(false, false, 3000, 1, 0, 0);
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
...
void func_186()
{
	...
	{
		func_91(13, floor(Global_101154.f_8884.f_3853));
	}
...
void func_197(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_199(player_id())) && !func_121(player_id(), 0)) && !func_198())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_199(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_201(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
bool func_205()
{
	if (!is_entity_dead(Local_68.f_2, 0))
	{
		...
		else if (is_entity_in_angled_area(Local_68.f_2, Local_68.f_186, Local_68.f_189, Local_68.f_192, 0, true, 0))
		{
			return true;
		}
		else if (is_entity_in_angled_area(Local_68.f_2, Local_68.f_200, Local_68.f_203, Local_68.f_206, 0, true, 0))
		{
			return true;
		}
		else if (is_entity_in_angled_area(Local_68.f_2, Local_68.f_207, Local_68.f_210, Local_68.f_213, 0, true, 0))
		{
			return true;
		}
		else if (Local_68.f_199 != -1f)
		{
			if (is_entity_in_angled_area(Local_68.f_2, Local_68.f_193, Local_68.f_196, Local_68.f_199, 0, true, 0))
			{
				return true;
			}
		}
...
void func_207()
{
	...
	{
		get_current_ped_weapon(Local_68, &iVar0, 1);
		if ((iLocal_60 == 1 && iLocal_622 == 2) && ((has_player_damaged_at_least_one_ped(player_id()) || func_220()) || func_219()))
		{
			clear_player_has_damaged_at_least_one_ped(player_id());
			func_15(1, 0);
			iLocal_60 = 9;
	...
	switch (iLocal_60)
	{
		case 1:
			if (func_290())
			{
				if ((func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1) || (func_179(Local_68.f_2, &(Local_68.f_451)) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))) && iVar0 != joaat("weapon_unarmed"))
				{
					func_214();
					set_all_random_peds_flee(player_id(), 1);
					iLocal_53 = 12;
					iLocal_52 = 3;
					iLocal_60 = 5;
					GAMEPLAY::GAMEPLAY::SET_BIT(&Global_87462, 3);
					func_213();
				}
		...
		case 4:
			if (func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1) && func_290())
			{
				func_214();
				if (Local_68.f_2.f_12)
				{
		...
		case 5:
			...
			if (iLocal_55 >= 1 && iLocal_55 < 7)
			{
				...
				if (func_210(Local_68.f_2, 0, 1, 0, 1, 1) || !is_synchronized_scene_running(Local_68.f_486))
				{
					iLocal_60 = 6;
				}
			}
		...
		case 8:
			if (((func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1) || func_179(Local_68.f_2, &(Local_68.f_451))) && func_290()) && iVar0 != joaat("weapon_unarmed"))
			{
				if (!Local_68.f_2.f_12)
				{
					iLocal_53 = 10;
		...
		case 10:
			if ((((func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1) || func_179(Local_68.f_2, &(Local_68.f_451))) && func_290()) && iVar0 != joaat("weapon_unarmed")) && !func_14(&(Local_68.f_480)))
			{
...
void func_208()
{
	if (!is_entity_dead(Local_68.f_2, 0))
	{
		set_blocking_of_non_temporary_events(Local_68.f_2, false);
	}
}
...
bool func_210(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (func_211(PLAYER::PLAYER_PED_ID(), iParam0))
	{
		return true;
	}
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_180(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
void func_212()
{
	...
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && func_290())
	{
		iVar3 = get_ped_nearby_peds(PLAYER::PLAYER_PED_ID(), &uVar0, -1);
		iVar4 = 0;
		while (iVar4 < iVar3)
		{
			if ((((uVar0[iVar4] != PLAYER::PLAYER_PED_ID() && uVar0[iVar4] != Local_68.f_2) && !PED::IS_PED_INJURED(uVar0[iVar4])) && !is_entity_a_mission_entity(uVar0[iVar4])) && !is_ped_in_combat(uVar0[iVar4], false))
			{
				set_entity_as_mission_entity(uVar0[iVar4], true, 1);
				task_smart_flee_ped(uVar0[iVar4], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
			iVar4++;
		}
	}
...
void func_213()
{
	...
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && func_290())
	{
		...
		while (iVar4 < iVar3)
		{
			if ((uVar0[iVar4] != PLAYER::PLAYER_PED_ID() && uVar0[iVar4] != Local_68.f_2) && !is_entity_a_mission_entity(uVar0[iVar4]))
			{
				set_entity_as_mission_entity(uVar0[iVar4], true, 1);
				clear_sequence_task(&iLocal_566);
				open_sequence_task(&iLocal_566);
				...
				task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
				close_sequence_task(iLocal_566);
				task_perform_sequence(uVar0[iVar4], iLocal_566);
			}
			iVar4++;
		}
	}
...
void func_216()
{
	switch (iLocal_59)
	{
		...
		case 2:
			...
			{
				if (!PED::IS_PED_INJURED(Local_68.f_2) && is_ped_fleeing(Local_68.f_2))
				{
					Local_68.f_2.f_14 = 1;
				}
			}
...
void func_217()
{
	if (GAMEPLAY::GET_GAME_TIMER() - Local_68.f_2.f_10 > 5000)
	{
		...
		task_turn_ped_to_face_entity(false, Local_68, false);
		task_look_at_entity(false, Local_68, -1, 0, 2);
...
bool func_223()
{
	if (!is_entity_dead(Local_68, 0))
	{
		if (is_entity_in_angled_area(Local_68, Local_68.f_186, Local_68.f_189, Local_68.f_192, 0, true, 0))
		{
			return true;
		}
	}
	...
	switch (iLocal_57)
	{
		...
		case 2:
			if (Local_68.f_486 >= 0)
			{
				if (is_synchronized_scene_running(Local_68.f_486))
				{
					if (get_synchronized_scene_phase(Local_68.f_486) > 0.894f || (get_synchronized_scene_phase(Local_68.f_486) > 0.871f && vdist2(get_entity_coords(Local_68.f_28, 1), get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)) < 1f))
					{
						iLocal_57 = 3;
					}
				}
		...
		case 4:
			func_15(1, 0);
			func_226(1);
			set_entity_visible(Local_68.f_28, false, 0);
			iLocal_57 = 5;
			break;
		
		case 5:
			if (is_entity_attached_to_entity(Local_68.f_28, PLAYER::PLAYER_PED_ID()))
			{
		...
		case 6:
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_28) && is_entity_attached_to_entity(Local_68.f_28, PLAYER::PLAYER_PED_ID()))
				{
...
{
	Local_68.f_28.f_3 = 0;
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_68.f_28.f_3), 3);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_68.f_28.f_3), 4);
	if (!iParam0)
	{
	...
	else
	{
		...
		Local_68.f_28.f_1 = create_pickup(joaat("pickup_money_variable"), get_entity_coords(Local_68.f_28, 1), Local_68.f_28.f_3, iLocal_569, 1, false);
		if (!does_blip_exist(Local_68.f_28.f_2))
		{
...
int func_227(int iParam0)
{
	...
	set_blip_scale(iVar0, func_228(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return iVar0;
}

float func_228(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
int func_230(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_228(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
...
void func_231()
{
	...
	if (Local_68.f_464)
	{
		switch (iLocal_61)
		{
			...
			case 3:
				if (GAMEPLAY::GET_GAME_TIMER() - Local_68.f_46.f_39 > get_random_int_in_range(1000, 3000))
				{
					if (is_vehicle_driveable(Local_68.f_46.f_4[0], 0))
					{
						set_vehicle_siren(Local_68.f_46.f_4[0], true);
					}
					iLocal_61 = 4;
				}
				break;
			...
			case 6:
				...
				while (iVar0 < 3)
				{
					if ((((PED::IS_PED_INJURED(Local_68.f_46[iVar0]) || (!is_entity_dead(Local_68.f_46[iVar0], 0) && has_entity_been_damaged_by_weapon(Local_68.f_46[iVar0], false, 2))) || PED::IS_PED_INJURED(Local_68.f_2)) || (!is_entity_dead(Local_68.f_2, 0) && has_entity_been_damaged_by_weapon(Local_68.f_2, false, 2))) || func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1))
					{
						func_15(2, 0);
						iVar1 = 0;
						while (iVar1 < 3)
						{
							...
							{
								task_combat_ped(Local_68.f_46[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
								set_blocking_of_non_temporary_events(Local_68.f_46[iVar1], false);
							}
							iVar1++;
						}
						iLocal_61 = 0;
...
void func_232()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			set_blocking_of_non_temporary_events(Local_68.f_46[iVar0], false);
		}
		iVar0++;
	}
}
...
void func_235()
{
	...
	while (iVar0 < 3)
	{
		...
		set_entity_as_mission_entity(Local_68.f_46.f_4[iVar0], true, 0);
		if (!(is_entity_dead(Local_68.f_46[iVar0], 0) && is_entity_dead(Local_68.f_46.f_4[iVar0], 0)))
		{
			...
			give_weapon_to_ped(Local_68.f_46[iVar0], joaat("weapon_pistol"), 99, false, true);
		}
		open_sequence_task(&(Local_68.f_46.f_35[iVar0]));
		task_vehicle_drive_to_coord(false, Local_68.f_46.f_4[iVar0], Local_68.f_46.f_22, _0x53AF99BAA671CA47(Local_68.f_46.f_4[iVar0]) - 8f, 1, Local_68.f_46.f_27, 786981, Local_68.f_46.f_25, -1f);
		task_leave_any_vehicle(false, false, 0);
		task_aim_gun_at_entity(false, Local_68, -1, 0);
...
void func_236()
{
	...
	switch (iLocal_62)
	{
		...
		case 5:
			if (((((func_24(Local_68) != joaat("weapon_unarmed") && iVar0 != joaat("weapon_bat")) && iVar0 != joaat("weapon_hammer")) && iVar0 != joaat("weapon_crowbar")) && iVar0 != joaat("weapon_bottle")) && func_290())
			{
				iLocal_62 = 7;
			}
			break;
		...
		case 6:
			if (func_24(Local_68) != joaat("weapon_unarmed") && func_290())
			{
				if (iVar0 == joaat("weapon_bat"))
				{
					iLocal_62 = 8;
		...
		case 13:
			if (get_entity_speed(Local_68) < 0.1f && !func_238())
			{
				func_237();
				iLocal_62 = 14;
			}
...
bool func_238()
{
	if (!is_entity_dead(Local_68, 0))
	{
		if (is_entity_in_angled_area(Local_68, Local_68.f_46.f_28, Local_68.f_46.f_31, Local_68.f_46.f_34, 0, true, 0))
		{
			return false;
		}
	}
...
bool func_240()
{
	...
	{
		if ((is_ped_ragdoll(Local_68.f_2) || (has_entity_been_damaged_by_entity(Local_68.f_2, Local_68, 1) && iVar0 == joaat("weapon_unarmed"))) || func_241(Local_68.f_2, Local_68.f_2.f_1, 1) > 1.15f)
		{
			if (is_ped_ragdoll(Local_68.f_2))
			{
			}
			...
			if (!is_entity_at_coord(Local_68.f_2, Local_68.f_2.f_1, 0.35f, 0.35f, 1f, false, true, 0))
			{
...
auto func_241(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_244()
{
	...
	iVar0 = get_random_int_in_range(true, 11);
	iVar1 = get_random_int_in_range(true, 5);
	iVar2 = get_random_int_in_range(true, 5);
	iVar3 = get_random_int_in_range(true, 3);
	iVar4 = get_random_int_in_range(true, 6);
	iVar5 = get_random_int_in_range(true, 4);
	iVar6 = get_random_int_in_range(true, 5);
	iVar7 = get_random_int_in_range(true, 4);
	iVar8 = get_random_int_in_range(true, 4);
	iVar9 = get_random_int_in_range(true, 5);
	iVar10 = get_random_int_in_range(true, 5);
	iVar11 = get_random_int_in_range(true, 5);
	iVar12 = get_random_int_in_range(true, 5);
	iVar13 = get_random_int_in_range(true, 9);
	iVar14 = get_random_int_in_range(true, 3);
	iVar15 = get_random_int_in_range(true, 5);
	iVar16 = get_random_int_in_range(true, 3);
	iVar17 = get_random_int_in_range(true, 6);
	iVar18 = get_random_int_in_range(true, 5);
	iVar19 = get_random_int_in_range(true, 4);
	iVar20 = get_random_int_in_range(true, 4);
	iVar21 = get_random_int_in_range(true, 4);
	iVar22 = get_random_int_in_range(true, 6);
	iVar23 = get_random_int_in_range(true, 6);
	iVar24 = get_random_int_in_range(true, 6);
	iVar25 = get_random_int_in_range(true, 6);
	iVar26 = get_random_int_in_range(true, 4);
	iVar27 = get_random_int_in_range(true, 3);
	iVar28 = get_random_int_in_range(true, 4);
	iVar29 = get_random_int_in_range(true, 4);
	if (func_95() == 0)
	{
		switch (iVar12)
		{
...
void func_245()
{
	...
	Local_68.f_96.f_1 = create_object(Local_68.f_96, Local_68.f_486.f_6, 1, true, false);
	set_entity_heading(Local_68.f_96.f_1, Local_68.f_96.f_5);
	freeze_entity_position(Local_68.f_96.f_1, true);
}

void func_246()
{
	Local_68.f_28 = create_portable_pickup(joaat("pickup_portable_crate_unfixed"), Local_68.f_28.f_7, false, Local_68.f_28.f_13);
...
void func_247()
{
	...
	set_ped_component_variation(Local_68.f_2, 2, iVar1, iVar0, 0);
	func_251(&iVar1, &iVar0);
	set_ped_component_variation(Local_68.f_2, 3, iVar1, iVar0, 0);
	func_250(&iVar1, &iVar0);
	set_ped_component_variation(Local_68.f_2, 4, iVar1, iVar0, 0);
	func_249(&iVar1, &iVar0);
	set_ped_component_variation(Local_68.f_2, 8, iVar1, iVar0, 0);
	set_blocking_of_non_temporary_events(Local_68.f_2, true);
	if (Local_68.f_2.f_12)
	{
		func_248();
	}
...
{
	*iParam0 = get_random_int_in_range(false, 2);
	if (*iParam0 == 0)
	{
		*iParam1 = get_random_int_in_range(false, 2);
	}
	else
	{
		*iParam1 = 0;
...
{
	*iParam0 = get_random_int_in_range(false, 2);
	*iParam1 = get_random_int_in_range(false, 3);
}

void func_252(int iParam0, int iParam1)
{
	*iParam0 = get_random_int_in_range(false, 3);
	if (*iParam0 > 0)
	{
		*iParam1 = get_random_int_in_range(false, 2);
	}
...
void func_253(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 0:
		...
		case 4:
			*uParam1 = 0;
			*uParam2 = get_random_int_in_range(false, 3);
			break;
...
void func_260(auto uParam0, int iParam1)
{
	func_261(uParam0, 0, iParam1, 0);
}

void func_261(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_265(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 0:
...
void func_266(int iParam0)
{
	...
	vVar0 = {func_267(Local_68.f_186, Local_68.f_189)};
	switch (iParam0)
	{
		case 0:
		case 1:
...
Vector3 func_267(Vector3 vParam0, Vector3 vParam1)
{
	Vector3 vVar0;
...
void func_268(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9)
{
	if (!func_269(iParam0))
	{
		return;
...
{
	func_279(iParam0, "NULL", *iParam0.f_1);
}
...
bool func_280()
{
	...
	iVar0 = get_clock_day_of_month() - Global_101154.f_18725.f_42[iLocal_568];
	iLocal_573 = 2;
	if (iVar0 < 0)
	{
		iVar0 = get_clock_day_of_month() + 31;
		iVar0 -= Global_101154.f_18725.f_42[iLocal_568];
	}
	if (iVar0 < iLocal_573)
	{
		return false;
...
void func_282(auto uParam0, auto uParam1)
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_283(int iParam0, Vector3 fParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
		...
		case 3:
		case 4:
			*uParam2 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, 5.95155f, -8.251f, -0.2377f)};
			*uParam3 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, -12.7268f, 7.21174f, 2.93854f)};
			break;
		...
		case 8:
		case 9:
			*uParam2 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, -6.52428f, -8.8002f, -0.657398f)};
			*uParam3 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, 3.54253f, 16.8382f, 3.20474f)};
			break;
		...
		case 17:
		case 18:
			*uParam2 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, -4.55363f, -7.52366f, -0.75f)};
			*uParam3 = {_get_object_offset_from_coords(func_284(iParam0), fParam1, 11.8868f, 7.00122f, 3.9688f)};
			break;
	}
	return true;
}
...
bool func_285()
{
	...
	iVar0 = get_clock_hours() - Global_101154.f_18725.f_21[iLocal_568];
	iVar1 = get_clock_day_of_month() - Global_101154.f_18725.f_42[iLocal_568];
	iLocal_572 = 2;
	if (iVar0 < 0)
	{
		iVar0 = get_clock_hours() + 24;
		iVar0 -= Global_101154.f_18725.f_21[iLocal_568];
		iVar2 = 1;
	}
...
void func_286(int iParam0)
{
	...
	var[] uVar1 = new var[2];
	var[] uVar4 = new var[2];
	Vector3[] vVar7 = new Vector3[2];
	
	func_287(iLocal_568, &uVar1, &uVar4, &vVar7);
...
void func_287(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_289(auto uParam0, auto uParam1)
{
	*uParam0 -= (*uParam0 && uParam1);
}
...
bool func_290()
{
	if (!is_entity_dead(Local_68, 0))
	{
		...
		else if (is_entity_in_angled_area(Local_68, Local_68.f_200, Local_68.f_203, Local_68.f_206, 0, true, 0))
		{
			return true;
		}
		else if (is_entity_in_angled_area(Local_68, Local_68.f_207, Local_68.f_210, Local_68.f_213, 0, true, 0))
		{
			return true;
		}
		else if (Local_68.f_199 != -1f)
		{
			if (is_entity_in_angled_area(Local_68, Local_68.f_193, Local_68.f_196, Local_68.f_199, 0, true, 0))
			{
				return true;
			}
		}
...
Vector3 func_293(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
void func_295(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11)
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_296(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16, auto uParam17)
{
	switch (iParam0)
	{
		case 0:
...
int func_301()
{
	...
	while (iVar1 < 19)
	{
		iVar0 += Global_101154.f_18725[iVar1];
		iVar1++;
	}
	return iVar0;
}

void func_302(auto uParam0, auto uParam1, auto uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
	...
	*uParam2 = 0;
	fVar0 = vdist2(func_284(0), *uParam0);
	fVar2 = 0f;
	iVar1 = 1;
	while (iVar1 <= 19 - 1)
	{
		fVar2 = vdist2(*uParam0, func_284(iVar1));
		if (fVar2 < fVar0)
		{
			*uParam2 = iVar1;
			fVar0 = fVar2;
...
void func_308()
{
	if (((iLocal_65 == 1 || iLocal_65 == 2) || iLocal_624 == 7) || (is_entity_dead(Local_68.f_2, 0) && iLocal_67 == 1))
	{
		...
		Global_101154.f_18725.f_21[iLocal_568] = get_clock_hours();
		Global_101154.f_18725.f_42[iLocal_568] = get_clock_day_of_month();
	}
	if ((network_is_signed_online() && func_320()) && Local_68.f_468)
	{
	...
	set_all_random_peds_flee(player_id(), 0);
	remove_scenario_blocking_area(iLocal_567, 0);
	func_28("SHR_HOLDUP_1", 1);
	func_28("SHR_SNK_TUT", 1);
	...
	if (func_1(Local_68.f_470, 1024))
	{
		...
		{
			delete_object(&(iLocal_618[0]));
			delete_object(&(iLocal_618[1]));
			delete_object(&(iLocal_618[2]));
		}
	}
	if (iLocal_623 == 2)
	{
...
void func_309(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_314()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_96.f_1))
	{
		...
		remove_model_hide(Local_68.f_486.f_6, 0.5f, 303280717, false);
		remove_model_hide(Local_68.f_486.f_6, 0.5f, joaat("prop_till_02"), false);
		remove_model_hide(Local_68.f_486.f_6, 0.5f, joaat("prop_till_03"), false);
	}
...
void func_315(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	struct<6>[] Var1 = new struct<6>[3];
	struct<8>[] Var20 = new struct<8>[2];
	
	iVar0 = func_319(*uParam1, 1, 0);
	StringCopy(&(Var20[0 /*8*/]), "GameType", 32);
	StringCopy(&(Var20[1 /*8*/]), "Location", 32);
	StringCopy(&(Var1[0 /*6*/]), "SP", 24);
	MemCopy(&(Var1[1 /*6*/]), {func_318(uParam0)}, 6);
	if (func_316(276, &Var1, &Var20, 2, -1, 0, 0))
	{
		_0x0BCA1D2C47B0D269(131, *uParam2, to_float(*uParam2));
		_0x0BCA1D2C47B0D269(114, iVar0, to_float(iVar0));
	}
}

bool func_316(int iParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<68> Var0;
	int iVar68;
	struct<13> Var69;
...
struct<8> func_318(auto uParam0)
{
	char[32] cVar0;
	...
	switch (*uParam0)
	{
		...
		case 3:
		case 4:
			StringCopy(&cVar0, "SHR_GAS", 32);
			break;
		
		case 5:
			StringCopy(&cVar0, "SHR_LIQ1", 32);
			break;
