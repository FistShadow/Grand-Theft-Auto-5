...
void main()
{
	...
	else if (Global_101154.f_18725[iLocal_568] > 0)
	{
		...
		{
			iLocal_64 = 10;
			iVar19 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
			if (iVar19 == 0)
			{
				Local_68.f_2.f_12 = 1;
			}
	...
	if (((((iLocal_60 == 1 || iLocal_60 == 2) && get_player_wanted_level(player_id()) == 0) && !PED::IS_PED_INJURED(Local_68)) && !func_176(-1082130432)) && !PED::IS_PED_INJURED(Local_68.f_2))
	{
		...
		switch (iLocal_66)
		{
			case 0:
				if (func_1(Local_68.f_470, 4) && func_24(Local_68) == joaat("weapon_unarmed"))
				{
					if (func_175(iLocal_568, &(Local_68.f_486.f_6), Local_68.f_486.f_9.f_2, &(Local_68.f_102.f_26[0 /*3*/]), &(Local_68.f_102.f_26[1 /*3*/]), &(Local_68.f_102.f_33), &(Local_68.f_102.f_36)))
					{
						...
						if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar3, Local_68.f_102.f_33, 1) < 5f)
						{
			...
			case 1:
				...
				if ((!is_ped_running(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !is_ped_jumping(PLAYER::PLAYER_PED_ID()))
				{
	...
	if (iLocal_54 != 6)
	{
		switch (iLocal_54)
		{
			...
			case 3:
				if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_86, 0))
				{
					if ((func_181(&(Local_68.f_86.f_7), 5f) || func_179(Local_68.f_2, &(Local_68.f_451))) || PED::IS_PED_RAGDOLL(Local_68.f_86))
					{
						iLocal_54 = 4;
					}
				}
...
void func_184()
{
	...
	{
		case 0:
			if ((((ENTITY::IS_ENTITY_DEAD(Local_68.f_2, 0) || !func_205()) || func_1(Local_68.f_470, 128)) && iLocal_57 < 3) && get_number_of_fires_in_range(Local_68.f_2.f_1, 1.5f) == 0)
			{
		...
		case 1:
			if (func_44())
			{
				if (func_168(Local_68.f_469, 1))
				{
					...
					func_171(&(Local_68.f_469));
					iVar2 = WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_628, 1);
					if (iVar2)
					{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				clear_sequence_task(&iLocal_566);
				open_sequence_task(&iLocal_566);
				AI::TASK_PLAY_ANIM(false, "oddjobs@shop_robbery@rob_till", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, "oddjobs@shop_robbery@rob_till", "loop", 8f, -8f, 4000, 1, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, "oddjobs@shop_robbery@rob_till", "exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				close_sequence_task(iLocal_566);
		...
		case 4:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_629 > 4800 || (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))) || get_number_of_fires_in_range(Local_68.f_2.f_1, 3f) > 0)
			{
				iLocal_624 = 5;
			}
...
void func_212()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && func_290())
	{
	...
	switch (iLocal_57)
	{
		...
		case 2:
			if (Local_68.f_486 >= 0)
			{
				if (is_synchronized_scene_running(Local_68.f_486))
				{
					if (get_synchronized_scene_phase(Local_68.f_486) > 0.894f || (get_synchronized_scene_phase(Local_68.f_486) > 0.871f && vdist2(ENTITY::GET_ENTITY_COORDS(Local_68.f_28, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 1f))
					{
						iLocal_57 = 3;
					}
				}
		...
		case 5:
			...
			else if (!ENTITY::IS_ENTITY_DEAD(Local_68.f_28, 0) && is_entity_visible(Local_68.f_28))
			{
			}
			break;
...
void func_226(int iParam0)
{
	...
	else
	{
		...
		Local_68.f_28.f_1 = create_pickup(joaat("pickup_money_variable"), ENTITY::GET_ENTITY_COORDS(Local_68.f_28, 1), Local_68.f_28.f_3, iLocal_569, 1, false);
		if (!does_blip_exist(Local_68.f_28.f_2))
		{
	...
	if (Local_68.f_464)
	{
		switch (iLocal_61)
		{
			...
			case 6:
				...
				while (iVar0 < 3)
				{
					if ((((PED::IS_PED_INJURED(Local_68.f_46[iVar0]) || (!ENTITY::IS_ENTITY_DEAD(Local_68.f_46[iVar0], 0) && has_entity_been_damaged_by_weapon(Local_68.f_46[iVar0], false, 2))) || PED::IS_PED_INJURED(Local_68.f_2)) || (!ENTITY::IS_ENTITY_DEAD(Local_68.f_2, 0) && has_entity_been_damaged_by_weapon(Local_68.f_2, false, 2))) || func_20(Local_68, Local_68.f_2, &(Local_68.f_451), 1))
					{
						func_15(2, 0);
						iVar1 = 0;
						while (iVar1 < 3)
...
bool func_240()
{
	...
	{
		if ((PED::IS_PED_RAGDOLL(Local_68.f_2) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_68.f_2, Local_68, 1) && iVar0 == joaat("weapon_unarmed"))) || func_241(Local_68.f_2, Local_68.f_2.f_1, 1) > 1.15f)
		{
			if (PED::IS_PED_RAGDOLL(Local_68.f_2))
			{
			}
...
void func_244()
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 11);
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 3);
	iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar5 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar6 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar8 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar9 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar10 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar11 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar12 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar13 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 9);
	iVar14 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 3);
	iVar15 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar16 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 3);
	iVar17 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar18 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 5);
	iVar19 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar20 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar21 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar22 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar23 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar24 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar25 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6);
	iVar26 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar27 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 3);
	iVar28 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	iVar29 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
	if (func_95() == 0)
	{
		switch (iVar12)
		{
...
{
	*iParam0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
	if (*iParam0 == 0)
	{
		*iParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
	}
	else
	{
		*iParam1 = 0;
...
{
	*iParam0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
	*iParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
}

void func_252(int iParam0, int iParam1)
{
	*iParam0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
	if (*iParam0 > 0)
	{
		*iParam1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
	}
...
void func_253(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		...
		case 4:
			*uParam1 = 0;
			*uParam2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
			break;
...
bool func_270()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_68, 0))
	{
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, Local_68.f_181, 1) < 50f)
		{
			return true;
		}
	}
...
bool func_275()
{
	...
	{
		vVar0 = {ENTITY::GET_ENTITY_COORDS(Local_68, 1)};
		fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, Local_68.f_181, 1);
...
bool func_285()
{
	...
	iVar0 = TIME::GET_CLOCK_HOURS() - Global_101154.f_18725.f_21[iLocal_568];
...
void func_308()
{
	if (((iLocal_65 == 1 || iLocal_65 == 2) || iLocal_624 == 7) || (ENTITY::IS_ENTITY_DEAD(Local_68.f_2, 0) && iLocal_67 == 1))
	{
		...
		Global_101154.f_18725.f_21[iLocal_568] = TIME::GET_CLOCK_HOURS();
...
void func_314()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_68.f_96.f_1))
	{
		...
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(Local_68.f_486.f_6, 0.5f, 303280717, false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(Local_68.f_486.f_6, 0.5f, joaat("prop_till_02"), false);
		ENTITY::ENTITY::REMOVE_MODEL_HIDE(Local_68.f_486.f_6, 0.5f, joaat("prop_till_03"), false);
	}
