...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_250(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_234(&Var0, 1);
	}
	iVar64[0] = 31;
	if (!func_231(&iVar64, &Var0, vVar61, 1f))
	{
		func_230();
	...
	while (true)
	{
		...
		func_173(Var0);
		func_165(&iLocal_93, &(Var0.f_9), vVar61);
		if (func_150(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
void func_165(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
...
bool func_174(auto uParam0, int iParam1)
{
	struct<27> Var0;
	...
	if (func_178(uParam0.f_48) && iParam1)
	{
...
void func_175(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_177(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_176(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_177(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_176(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_182(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_183(PLAYER::PLAYER_PED_ID(), *uParam0.f_35[iVar0]))
							{
...
int func_188(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_189(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_189(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_190(iParam4, iParam7)};
...
bool func_192(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_194(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	{
		vVar3 = {func_194(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_193(vVar3, vVar0);
...
bool func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_202(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_199(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_199(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_201(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_194(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_202(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
bool func_213(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_218(&iVar0) || !has_anim_dict_loaded("special_ped@maude@base"))
			{
				return false;
			}
			iLocal_91 = 2;
...
bool func_214(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_215(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_215(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_217(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_180(iParam0);
...
void func_219(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (iParam1)
			{
				iLocal_92 = add_scenario_blocking_area(vVar0, vVar3, 0, 1, 1, 1);
...
int func_225(int iParam0, char* sParam1)
{
...
bool func_231(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_232(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_232(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_232(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_233(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_233(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_236(auto uParam0, int iParam1, int iParam2, int iParam3)
{
