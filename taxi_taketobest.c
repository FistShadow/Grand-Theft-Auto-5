#region Local Var
	...
	auto uLocal_407 = 0;
	auto uLocal_408 = 0;
	struct<428> Local_409 = 0;
	auto uLocal_837 = 0;
	auto uLocal_838 = 0;
	int iLocal_839 = 0;
	int iLocal_840 = 0;
	int iLocal_841 = 0;
	Vector3[] vLocal_842 = new Vector3[1];
	var[] uLocal_846 = new var[3];
	int iLocal_850 = 0;
	Vector3 vLocal_851 = 0;
	Vector3 vLocal_854 = 0;
	Vector3[] vLocal_857 = new Vector3[45];
	Vector3[] vLocal_993 = new Vector3[45];
	Vector3[] vLocal_1129 = new Vector3[45];
	Vector3[] vLocal_1265 = new Vector3[45];
	Vector3 vLocal_1401 = 0;
	auto uLocal_1404 = 0;
	int iLocal_1405 = 0;
	int iLocal_1406 = 0;
	int iLocal_1407 = 0;
	...
	auto uLocal_1410 = 0;
	int iLocal_1411 = 0;
	float[] fLocal_1412 = new float[45];
	int iLocal_1458 = 0;
	struct<28> Local_1459 = -1;
	auto uLocal_1487 = 0;
	auto uLocal_1488 = 0;
	auto uLocal_1489 = 5;
	auto uLocal_1490 = 0;
	...
	auto uLocal_1530 = 0;
	auto uLocal_1531 = 0;
	auto uLocal_1532 = 1097859072;
	auto uLocal_1533 = 1500;
	auto uLocal_1534 = 45;
	auto uLocal_1535 = 1103626240;
	auto uLocal_1536 = 5;
	int iLocal_1537 = 0;
	auto uLocal_1538 = 0;
	auto uLocal_1539 = 0;
	...
	else
	{
		...
		switch (Local_409.f_410)
		{
			case 0:
				...
				func_264(&Local_409, vLocal_851, vLocal_854, "TaxiMiranda", iLocal_841, 0f, 10f);
				func_262(&Local_409);
			...
			case 1:
				if (func_259())
				{
					func_258();
					func_238();
					func_237(&(vLocal_842[0 /*3*/]), "TAXI_SC_BN_08", 500);
					func_236(&Local_409, &vLocal_842);
			...
			case 3:
				if (func_228(&Local_409, 1))
				{
					...
					{
						set_ped_component_variation(Local_409.f_3, 3, false, 2, 0);
			...
			case 27:
				if (func_105(&Local_409, 1))
				{
					...
					clear_sequence_task(&iLocal_850);
					open_sequence_task(&iLocal_850);
					task_leave_any_vehicle(false, false, 0);
					task_follow_nav_mesh_to_coord(false, Local_409.f_29, 1f, -1, 0.25f, 0, 1193033728);
					task_use_nearest_scenario_to_coord(false, Local_409.f_29, 15f, 5000);
					task_set_blocking_of_non_temporary_events(false, 0);
					task_follow_nav_mesh_to_coord(false, vLocal_1401, 1f, -1, 0.25f, 0, 1193033728);
					task_use_nearest_scenario_to_coord(false, vLocal_1401, 15f, 0);
					close_sequence_task(iLocal_850);
					task_perform_sequence(Local_409.f_3, iLocal_850);
			...
			case 29:
				if (func_78(&Local_409, &iLocal_1537))
				{
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_28(player_id())) && !func_25(player_id(), 0)) && !func_24())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_28(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_30(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_37(Vector3 vParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_39(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_40(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_126(auto uParam0, float fParam1, float fParam2, float fParam3)
{
	if ((((is_screen_faded_in() && !is_screen_fading_in()) && !is_screen_fading_out()) && !is_screen_faded_out()) && !*uParam0.f_142)
	{
		if (func_149(uParam0))
		{
			...
			func_130(uParam0);
			return func_127(uParam0, fParam1);
		}
	}
	return 0;
}

int func_127(auto uParam0, float fParam1)
{
	if (func_61(uParam0) == 2)
	{
		...
		if (((func_129(*uParam0.f_4, *uParam0.f_17, 1) <= fParam1 + 1f && get_player_wanted_level(get_player_index()) < 1) && func_128(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
		{
			return func_111(uParam0, 1, fParam1);
		}
	}
	else if (((ENTITY::IS_ENTITY_AT_COORD(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_128(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_111(uParam0, 1, fParam1);
	}
	return 0;
...
auto func_129(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_130(auto uParam0)
{
	...
	if ((func_114(uParam0) && func_22(*uParam0.f_81, 67108864)) && get_player_wanted_level(player_id()) == 0)
	{
...
float func_131(Vector3 vParam0, int iParam1)
{
	return func_132(get_player_ped(get_player_index()), vParam0, iParam3);
}

float func_132(int iParam0, Vector3 vParam1, int iParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		return -1f;
...
void func_133(auto uParam0, float fParam1, float fParam2)
{
	if (func_114(uParam0) && func_22(*uParam0.f_44, 4))
	{
		if ((is_vehicle_stopped(*uParam0.f_4) || get_entity_speed(*uParam0.f_4) < 3f) && func_138(uParam0))
		{
...
void func_134(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
		...
		switch (*uParam0.f_412)
		{
			case 0:
				if (get_player_wanted_level(get_player_index()) >= 1)
				{
					...
					{
						func_147(uParam0, get_player_wanted_level(get_player_index()));
						if (*uParam0.f_410 != 22)
						{
			...
			case 3:
				if (is_player_wanted_level_greater(get_player_index(), func_145(uParam0)))
				{
					func_147(uParam0, get_player_wanted_level(get_player_index()));
					func_50(6, 0);
				}
...
auto func_146(char* sParam0, int iParam1, char* sParam2)
{
...
auto func_151(int iParam0, int iParam1)
{
	return func_152(get_player_ped(get_player_index()), iParam0, iParam1);
}

auto func_152(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_154(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1)
	{
		func_387(uParam0);
...
int func_157(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_158(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_158(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_158(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_160(auto uParam0, int iParam1, int iParam2)
{
...
void func_167()
{
	...
	iLocal_840 = func_168(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
	if (iLocal_840 != -1)
	{
		uVar0 = func_168(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
		if (!func_40(Local_409.f_17, vLocal_857[uVar0 /*3*/], 0))
		{
			Local_409.f_17 = {vLocal_857[uVar0 /*3*/]};
			Local_409.f_29 = {vLocal_993[uVar0 /*3*/]};
			Local_409.f_26 = {vLocal_1129[uVar0 /*3*/]};
			Local_409.f_34 = fLocal_1412[uVar0];
			vLocal_1401 = {vLocal_1265[uVar0 /*3*/]};
		}
	}
}

int func_168(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_170(iVar0))
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_169(iVar0, 0), 1);
...
int func_171(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_172(func_174(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_172(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_173(iParam1)];
...
void func_181()
{
	...
	if (iLocal_839 != -1)
	{
		fVar0 = func_132(PLAYER::PLAYER_PED_ID(), func_169(iLocal_839, 0), 1);
...
void func_183(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	*iParam0 = add_blip_for_coord(func_169(iParam1, 0));
	set_blip_sprite(*iParam0, iParam2);
	set_blip_colour(*iParam0, iParam3);
	set_blip_name_from_text_file(*iParam0, func_184(iParam1));
...
void func_186()
{
	...
	vLocal_993[0 /*3*/] = {-815.6819f, -183.7194f, 36.5695f};
	vLocal_993[1 /*3*/] = {136.1871f, -1712.069f, 28.2916f};
	vLocal_993[7 /*3*/] = {84.2585f, -1379.562f, 28.2919f};
	vLocal_993[14 /*3*/] = {-1206.156f, -777.4578f, 16.3283f};
	vLocal_993[18 /*3*/] = {-716.0551f, -160.1741f, 35.98816f};
	vLocal_993[22 /*3*/] = {342.1741f, 172.9035f, 102.1543f};
	vLocal_993[28 /*3*/] = {22.1268f, -1109.868f, 28.797f};
	vLocal_1265[7 /*3*/] = {76.3885f, -1397.665f, 28.3719f};
	vLocal_1265[14 /*3*/] = {-1193.429f, -769.2299f, 16.3289f};
	vLocal_1265[18 /*3*/] = {-710.8855f, -152.4612f, 36.4106f};
	vLocal_1129[0 /*3*/] = {-821.3112f, -207.0323f, 36.3333f};
	vLocal_1129[1 /*3*/] = {138.4111f, -1726.907f, 28.0569f};
	vLocal_1129[7 /*3*/] = {96.1429f, -1407.346f, 28.1563f};
	vLocal_1129[14 /*3*/] = {-1202.809f, -795.3967f, 15.2069f};
	vLocal_1129[18 /*3*/] = {-710.7402f, -178.9253f, 35.8931f};
	vLocal_1129[22 /*3*/] = {348.4406f, 156.2108f, 101.9483f};
	vLocal_1129[28 /*3*/] = {40.1115f, -1113.923f, 28.1427f};
...
void func_194(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
bool func_199(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 || ((func_152(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_129(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_129(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
bool func_201(auto uParam0)
{
	...
	switch (iLocal_86)
	{
		...
		case 2:
			...
			iVar12 = func_209(uParam0.f_409, get_offset_from_entity_in_world_coords(*uParam0.f_4, 0f, 2.2f, 0.275f), get_offset_from_entity_in_world_coords(*uParam0.f_4, vVar0), 1);
			if (iVar12 == 1)
			{
				vVar0.z += 1.5f;
				if (*uParam0.f_7 == 2)
			...
			if (iVar12 != -1)
			{
				...
				set_entity_heading(*uParam0.f_3, func_206(uParam0));
		...
		case 7:
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(*uParam0.f_4, 0))
			{
				if (!is_ped_in_any_vehicle(*uParam0.f_3, 0))
				{
					...
					set_vehicle_door_shut(*uParam0.f_4, func_204(*uParam0.f_7), 1);
				}
				render_script_cams(false, false, 3000, 1, 0, 0);
				destroy_cam(*uParam0, 0);
...
void func_205(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
...
float func_206(auto uParam0)
{
	...
	fVar0 = func_207(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), vVar1);
	return fVar0;
}

float func_207(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
...
int func_209(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3)
{
	auto uVar0;
	auto uVar3;
	int iVar6;
...
{
	if (func_211() && GAMEPLAY::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
{
	if ((get_entity_speed(*uParam0.f_4) > 3f && func_383(uParam0, 5) > 15f) || is_entity_upsidedown(*uParam0.f_4))
	{
		return true;
	}
	return false;
...
int func_218(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_220(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
		...
		if (((func_383(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3)) || func_151(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
...
bool func_221(auto uParam0, float fParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_152(*uParam0.f_4, *uParam0.f_3, 0) <= fParam1 && !*uParam0.f_142) && absf(vVar0.z - vVar3.z) < 5f)
			{
				if (*uParam0.f_409 == 0)
				{
...
void func_222(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_223(iParam3), 0);
}
...
bool func_228(auto uParam0, int iParam1)
{
	...
	if (func_22(*uParam0.f_44, 8))
	{
		if (!func_22(*uParam0.f_44, 128))
		{
			if (is_ped_jacking(PLAYER::PLAYER_PED_ID()) && !func_22(*uParam0.f_44, 256))
			{
				func_62(uParam0.f_44, 256);
			}
			if (func_22(*uParam0.f_44, 256) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
	...
	if (!func_232(uParam0, iParam1))
	{
		...
		if ((PED::IS_PED_INJURED(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_151(*uParam0.f_3, 1) > 400f)
		{
...
bool func_232(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_237(auto uParam0, char* sParam1, int iParam2)
{
	*uParam0 = 0;
	*uParam0.f_1 = iParam2;
	*uParam0.f_2 = sParam1;
...
{
	Local_343 = 0;
	func_255(35778/*func_257*/, 35753/*func_256*/, 1);
	func_255(35514/*func_253*/, 35491/*func_252*/, 1);
	func_255(35429/*func_251*/, 35404/*func_250*/, 1);
	func_255(35332/*func_249*/, 35308/*func_248*/, 1);
	func_255(35198/*func_247*/, 35177/*func_246*/, 1);
	func_255(35124/*func_244*/, 35099/*func_243*/, 1);
	func_255(34957/*func_240*/, 34934/*func_239*/, 1);
}

bool func_239(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
int func_245(auto uParam0, int iParam1)
{
	return (uParam0 && iParam1) != 0;
}
...
bool func_256(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_259()
{
	...
	if (!has_scaleform_movie_loaded(iLocal_1537))
	{
		return false;
	}
...
{
	return func_157(iParam0, !iParam1, iParam2);
}

bool func_264(auto uParam0, Vector3 vParam1, Vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_3))
	{
...
void func_265(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_51[0] = _0x2CE544C68FB812A0(vParam1, 20f, 5f, 0);
}

void func_266(auto uParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_15(&(Local_190[0 /*10*/].f_3))) && !func_15(&(Local_190[8 /*10*/].f_3))) && !func_15(&(Local_190[5 /*10*/].f_3))) && !func_15(&(Local_190[9 /*10*/].f_3))) && !func_15(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_15(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(ENTITY::GET_ENTITY_COORDS(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_152(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
					func_136(&(Local_190[14 /*10*/].f_3));
				}
			}
		}
		else if ((func_97(&(Local_190[14 /*10*/].f_3)) < 1.5f && func_152(*uParam0.f_5, *uParam0.f_4, 1) > 4.5f) && !has_entity_been_damaged_by_any_vehicle(*uParam0.f_5))
		{
...
bool func_276(auto uParam0)
{
	...
	{
		if (!func_277(*uParam0.f_4) && get_entity_speed(*uParam0.f_4) > 15f)
		{
...
int func_277(int iParam0)
{
	...
	vVar24 = {vVar24};
	return func_278(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar15, vVar18, vVar21);
}

bool func_278(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_290(int iParam0, auto uParam1)
{
...
void func_294(auto uParam0, char* sParam1, int iParam2)
{
	struct<6> Var0;
...
int func_295(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_303(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_305(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_307(auto uParam0, char* sParam1)
{
	if (func_308(uParam0))
	{
		...
		switch (Local_1459.f_27)
		{
			case 0:
				if (Local_409.f_410 == 9)
				{
					...
					{
						if (func_340("TX_OBJ_TTB_DO") || does_blip_exist(Local_409.f_9))
						{
							Local_1459.f_27++;
						}
			...
			case 2:
				if (func_383(&Local_409, 18) > get_random_float_in_range(2f, 10f))
				{
			...
			case 5:
				if (func_383(&Local_409, 18) > get_random_float_in_range(8f, 16f))
				{
				}
				break;
			}
	}
	func_312(&Local_409, &uLocal_1489, &Local_1459, iLocal_1458);
}

bool func_312(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
...
int func_313(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
struct<6> func_317(auto uParam0)
{
	int iVar0;
	struct<6> Var1;
	...
	else if (func_137(uParam0, 14))
	{
		...
		switch (func_339(uParam0))
		{
			case 55:
				...
				Var6 = {Var0};
				func_338(uParam0.f_93, 3, &Var6, 0, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
		...
		switch (func_339(uParam0))
		{
			...
			case 4:
				...
				if (!func_22(*uParam0.f_44, 128))
				{
					...
					{
						func_338(uParam0.f_99, 4, &Var6, 0, 1, 0);
						func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					}
					else
					{
			...
			case 72:
				...
				else if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_338(uParam0.f_95, 5, &Var6, 1, 0, 1);
					func_295(uParam0.f_244, *uParam0.f_144, &Var6, 8, 0, 0, 0);
				}
				else
				{
					...
					if (*uParam0.f_411 == 0)
					{
						func_338(uParam0.f_95, 8, &Var6, 1, 1, 0);
					}
					else
					{
						func_338(uParam0.f_95, 5, &Var6, 1, 1, 0);
					}
					func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
				func_336(2, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
				break;
			...
			case 79:
				...
				{
					func_330(uParam0, 4096, Var0, "_sideW1", iVar24, 8);
				}
				else if (!func_22(*uParam0.f_81, 8192))
				{
					func_330(uParam0, 8192, Var0, "_sideW2", iVar24, 8);
				}
			...
			case 80:
				...
				{
					func_330(uParam0, 16384, Var0, "_opLne1", iVar24, 8);
				}
				else if (!func_22(*uParam0.f_81, 32768))
				{
					func_330(uParam0, 32768, Var0, "_opLne2", iVar24, 8);
				}
			...
			case 83:
				...
				if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_338(uParam0.f_93, 6, &Var6, 0, 1, 0);
					func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_336(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
					func_266(uParam0, 16, 0, 0);
					func_227(uParam0, 0, 0);
			...
			case 92:
				...
				Var6 = {Var0};
				func_338(uParam0.f_96, 2, &Var6, 0, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_336(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
			...
			case 93:
				...
				Var6 = {Var0};
				func_338(uParam0.f_97, 2, &Var6, 0, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_336(12, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
					...
					if (!*uParam0.f_109 && !func_49())
					{
						switch (*uParam0.f_414)
						{
							...
							case 8:
								StringConCat(&Var0, "_good1", 24);
								Var6 = {Var0};
								func_338(uParam0.f_93, 6, &Var6, 1, 1, 0);
								func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
								func_336(23, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
								func_266(uParam0, 16, 0, 0);
								func_227(uParam0, 0, 0);
								break;
			...
			case 78:
				...
				Var6 = {Var0};
				func_338(uParam0.f_87, 6, &Var6, 1, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 48:
				...
				Var6 = {Var0};
				func_338(uParam0.f_86, 4, &Var6, 0, 1, 0);
				if (*uParam0.f_411 != 9)
				{
					func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 67:
				...
				Var6 = {Var0};
				func_338(uParam0.f_88, 4, &Var6, 0, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_336(16, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
				break;
			...
			case 51:
				...
				else
				{
					StringConCat(&Var0, "_copBa1", 24);
					Var6 = {Var0};
					func_338(uParam0.f_85, 6, &Var6, 1, 1, 0);
					func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_266(uParam0, 16, 0, 0);
					func_227(uParam0, 0, 0);
				}
			...
			case 58:
				if (*uParam0.f_411 == 6)
				{
					...
					Var6 = {Var0};
					func_338(uParam0.f_93, 6, &Var6, 1, 1, 1);
					func_196(&Var0);
					func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 115:
				...
				Var6 = {Var0};
				func_338(uParam0.f_91, 5, &Var6, 1, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
				break;
			...
			case 116:
				...
				Var6 = {Var0};
				func_338(uParam0.f_92, 5, &Var6, 1, 1, 0);
				func_337(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_266(uParam0, 16, 0, 0);
				func_227(uParam0, 0, 0);
				break;
...
void func_321(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_322(auto uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
...
void func_323(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_62(uParam0.f_82, iParam1);
	func_266(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_325(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_326(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_327(char[24] cParam0, auto uParam1)
{
	int iVar0;
...
void func_330(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_62(uParam0.f_81, iParam1);
	func_266(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_332(auto uParam0, char[24] cParam1, char* sParam2)
{
	func_266(uParam0, 16, 0, 0);
	func_266(uParam0, 17, 0f, 1);
	...
	if (!PED::IS_PED_INJURED(*uParam0.f_3))
	{
		interrupt_conversation(*uParam0.f_3, &cParam1, func_333(uParam0));
	}
}

char* func_333(auto uParam0)
{
	char* sVar0;
...
char* func_334(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 72:
...
int func_335(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_266(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_336(int iParam0, auto uParam1, auto uParam2, auto uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
void func_338(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
int func_342(auto uParam0, auto uParam1)
{
...
void func_347(auto uParam0, auto uParam1, int iParam2)
{
	if (!func_22(*uParam0.f_55, 1))
	{
		...
		{
			case 0:
				if (!is_string_null_or_empty(uParam0.f_124) && func_49())
				{
					*uParam1++;
				}
				break;
...
bool func_348(auto uParam0, auto uParam1)
{
	auto uVar0;
	...
	if ((((!is_player_control_on(player_id()) && (does_cam_exist(*uParam0) && !is_cam_active(*uParam0))) && (does_cam_exist(*uParam0.f_1) && !is_cam_active(*uParam0.f_1))) && !is_message_being_displayed()) && !func_49())
	{
...
auto func_357(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_358(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_359(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_368()
{
	...
	func_366(&uVar0, get_clock_seconds());
	func_365(&uVar0, get_clock_minutes());
	func_364(&uVar0, TIME::GET_CLOCK_HOURS());
	func_362(&uVar0, get_clock_day_of_month());
	func_363(&uVar0, get_clock_month());
	func_361(&uVar0, get_clock_year());
	return uVar0;
}
...
void func_373(auto uParam0, auto uParam1, auto uParam2)
{
	switch (*uParam1)
	{
		case 1:
...
bool func_374(auto uParam0, int iParam1, int iParam2)
{
...
bool func_375(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		if (!func_22(*uParam2, 4))
		{
			if (func_379(iVar0, iParam0, uParam2, iParam5))
			{
				*uParam3 = 4;
				return true;
			}
		...
		iVar1 = !func_22(*uParam2, 128);
		if (iParam4)
		{
			if (func_376(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_376(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_376(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (func_377(PLAYER::PLAYER_PED_ID(), iParam0))
	{
		return true;
	}
	if (iParam2)
...
bool func_378(int iParam0, int iParam1, auto uParam2)
{
...
bool func_379(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_380(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
...
float func_383(auto uParam0, int iParam1)
{
...
bool func_386(auto uParam0, int iParam1)
{
	if (iParam1)
	{
		return true;
...
void func_394(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
