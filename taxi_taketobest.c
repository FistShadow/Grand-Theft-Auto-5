...
int func_127(auto uParam0, float fParam1)
{
	...
	else if (((is_entity_at_coord(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_128(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_111(uParam0, 1, fParam1);
	}
	return 0;
...
void func_167()
{
	...
	iLocal_840 = func_168(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
	if (iLocal_840 != -1)
	{
		uVar0 = func_168(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Local_409.f_427, -1, 0, 1, -1);
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_152(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_129(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_129(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
float func_206(auto uParam0)
{
	...
	fVar0 = func_207(get_entity_coords(*uParam0.f_3, 1), vVar1);
	return fVar0;
}
...
bool func_220(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (!is_entity_occluded(*uParam0.f_3) && func_151(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_383(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !is_entity_occluded(*uParam0.f_3)) || func_151(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_15(&(Local_190[0 /*10*/].f_3))) && !func_15(&(Local_190[8 /*10*/].f_3))) && !func_15(&(Local_190[5 /*10*/].f_3))) && !func_15(&(Local_190[9 /*10*/].f_3))) && !func_15(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_15(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(get_entity_coords(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_152(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!is_entity_dead(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
...
int func_277(int iParam0)
{
	...
	vVar24 = {vVar24};
	return func_278(get_entity_coords(iParam0, 1), vVar15, vVar18, vVar21);
}
...
bool func_308(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_152(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
...
bool func_376(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_151(iParam0, 1) < 1.5f)
		{
			return true;
		}
