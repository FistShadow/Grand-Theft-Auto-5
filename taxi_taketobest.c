...
int func_126(var uParam0, float fParam1, float fParam2, float fParam3)
{
...
var func_129(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
var func_146(char* sParam0, int iParam1, char* sParam2)
{
...
void func_205(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
...
float func_207(struct<2> Param0, Vector3 fParam1, struct<2> Param2, var uParam3)
{
...
int func_209(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)
{
	var uVar0;
	var uVar3;
	int iVar6;
...
bool func_220(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
...
bool func_264(var uParam0, vector3 vParam1, vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!does_entity_exist(*uParam0.f_3))
	{
...
void func_265(var uParam0, vector3 vParam1)
{
	*uParam0.f_51[0] = _0x2CE544C68FB812A0(vParam1, 20f, 5f, 0);
}

void func_266(var uParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
...
void func_321(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_323(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_62(uParam0.f_82, iParam1);
	func_266(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_325(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_330(var uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_62(uParam0.f_81, iParam1);
	func_266(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_332(var uParam0, char[24] cParam1, char* sParam2)
{
	func_266(uParam0, 16, 0, 0);
	func_266(uParam0, 17, 0f, 1);
...
int func_335(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_266(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_336(int iParam0, var uParam1, var uParam2, var uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
bool func_375(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
...
bool func_379(int iParam0, int iParam1, var uParam2, int iParam3)
{
	vector3 vVar0;
	int iVar3;
