		...
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			while (iVar3 < 1)
			{
				...
				if (func_431(iVar1, 1, 1))
				{
					...
					if (ENTITY::IS_ENTITY_AT_COORD(iVar2, Local_96.f_2.f_68[iVar3 /*104*/].f_1, 100f, 100f, 100f, false, true, 0))
					{
						GAMEPLAY::CLEAR_BIT(&(Local_96.f_2.f_1[0 /*66*/].f_65), 10);
						GAMEPLAY::CLEAR_BIT(&(Local_96.f_2.f_1[iVar3 /*66*/].f_65), 13);
					}
					else if (ENTITY::IS_ENTITY_AT_COORD(iVar2, Local_96.f_2.f_68[iVar3 /*104*/].f_1, 180f, 180f, 180f, false, true, 0))
					{
						GAMEPLAY::CLEAR_BIT(&(Local_96.f_2.f_1[iVar3 /*66*/].f_65), 13);
					}
				}
...
{
	if (AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60) != -1)
	{
		if (network_does_network_id_exist(Local_96.f_2.f_1[iParam0 /*66*/].f_1))
		{
			if (!has_sound_finished(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60)))
			{
				stop_sound(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60));
				release_sound_id(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60));
			}
		}
		else if (!has_sound_finished(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60)))
		{
			stop_sound(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60));
			release_sound_id(AUDIO::GET_SOUND_ID_from_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_60));
		}
			...
			if (func_35(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/].f_1))
			{
				if (func_21(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/].f_2, 1086324736, 1065353216, 1065353216, 1084227584, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
				{
					if (func_20(&(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/]), 22, Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/].f_1, Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/].f_2, Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/].f_5, 1, 1, 1))
					{
						...
						ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar0 /*18*/]), round(200f * Global_262145.f_151));
	...
	if (iParam4 && !iParam7)
	{
		if (func_431(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_27(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_23(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_27(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
				...
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_23(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_27(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
				...
				if (!network_does_network_id_exist(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar1 /*18*/]))
				{
					if (func_35(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar1 /*18*/].f_1))
					{
						if (func_38(&(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar1 /*18*/]), Local_96.f_2.f_68[uParam0 /*104*/].f_78[0 /*17*/], 22, Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar1 /*18*/].f_1, iVar1 - 1, 1, 1, 1))
						{
							...
							ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iVar1 /*18*/]), round(200f * Global_262145.f_151));
	...
	if (!network_does_network_id_exist(Local_96.f_2.f_68[uParam0 /*104*/].f_78[0 /*17*/]))
	{
		if (func_35(Local_96.f_2.f_68[uParam0 /*104*/].f_78[0 /*17*/].f_1))
		{
			...
			if (iVar4 == 1)
			{
				...
				{
					ENTITY::SET_ENTITY_HEALTH(net_to_veh(Local_96.f_2.f_68[uParam0 /*104*/].f_78[0 /*17*/]), Local_96.f_2.f_68[uParam0 /*104*/].f_78[0 /*17*/].f_16);
				...
				if (network_does_network_id_exist(Local_96.f_2.f_1[iVar0 /*66*/].f_1))
				{
					...
					if (can_register_mission_objects(1))
					{
						...
						if (func_39(Local_96.f_2.f_1[iVar0 /*66*/].f_1))
						{
							...
							if (func_49(&(Local_96.f_181[iVar0 /*2*/]), Local_96.f_181[iVar0 /*2*/].f_1, ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_2.f_1[iVar0 /*66*/].f_1), 1) - Vector(5f, 0f, 0f), 1, 1, 1, 0))
							{
		...
		if (network_does_network_id_exist(Local_96.f_2.f_1[iParam0 /*66*/].f_1))
		{
			...
			if (!network_does_network_id_exist(Local_96.f_2.f_1[iParam0 /*66*/].f_2))
			{
				...
				if (can_register_mission_entities(0, 0, 1, 0))
				{
					...
					if (func_49(&(Local_96.f_2.f_1[iParam0 /*66*/].f_2), Local_96.f_2.f_1[iParam0 /*66*/].f_4, ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_2.f_1[iParam0 /*66*/].f_1), 1) + Vector(1f, 0f, 0f), 1, 1, 0, 1))
					{
	...
	switch (Local_286[participant_id_to_int() /*4*/].f_3)
	{
		...
		case 1:
			...
			while (iVar1 < Local_96.f_2)
			{
				...
				func_158(iVar1);
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_96.f_2.f_68[iVar1 /*104*/].f_1, 200f, 200f, 200f, false, true, 0))
				{
					func_157();
					func_103(iVar1);
					fVar2 = 200f / 4f * 3f;
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_96.f_2.f_68[iVar1 /*104*/].f_1, fVar2, fVar2, fVar2, false, true, 0))
					{
						func_82(iVar1, fVar2);
					}
				}
...
void func_104(auto uParam0, int iParam1)
{
	...
	if (network_does_network_id_exist(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iParam1 /*18*/]))
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(net_to_ped(Local_96.f_2.f_68[uParam0 /*104*/].f_5[iParam1 /*18*/]), 0))
			{
...
void func_165(int iParam0, Vector3 vParam1)
{
	...
	if (network_does_network_id_exist(Local_96.f_2.f_1[iParam0 /*66*/].f_1))
	{
		if (network_has_control_of_network_id(Local_96.f_2.f_1[iParam0 /*66*/].f_1) || (!_0xA1607996431332DF(Local_96.f_2.f_1[iParam0 /*66*/].f_1) && network_is_host_of_this_script()))
		{
					...
					if (network_has_control_of_network_id(Local_96.f_181[iParam0 /*2*/]) || (!_0xA1607996431332DF(Local_96.f_181[iParam0 /*2*/]) && network_is_host_of_this_script()))
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_96.f_2.f_1[iParam0 /*66*/].f_65, 15) && !GAMEPLAY::IS_BIT_SET(Local_286[participant_id_to_int() /*4*/].f_1, 15 + iParam0))
						{
							if (func_39(Local_96.f_181[iParam0 /*2*/]))
							{
								...
								vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_181[iParam0 /*2*/]), 1)};
								if (vVar0.z < 0f)
								{
			...
			vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_2.f_1[iParam0 /*66*/].f_1), 1)};
			if (vVar0.z < 0f)
			{
				if (func_39(Local_96.f_2.f_1[iParam0 /*66*/].f_1))
				{
...
void func_180(int iParam0)
{
	...
	if (network_does_network_id_exist(Local_96.f_2.f_1[iParam0 /*66*/].f_1))
	{
		vVar2 = {ENTITY::GET_ENTITY_COORDS(net_to_obj(Local_96.f_2.f_1[iParam0 /*66*/].f_1), 1)};
	}
	else
	{
...
int func_192(int iParam0, int iParam1, auto uParam2)
{
	...
	if (iVar28)
	{
		...
		func_221(GAMEPLAY::GET_HASH_KEY(&Var1));
	...
	else if (((((iParam0 != -1 && iParam0 != 10) && iParam1 != -1) && iParam1 != -99) && func_220(func_300(), iParam0, iParam1)) && !is_string_null_or_empty(&(Var14.f_8)))
	{
		...
		func_221(GAMEPLAY::GET_HASH_KEY(&(Var14.f_8)));
		MemCopy(uParam2, {Var14.f_8}, 8);
		func_193(GAMEPLAY::GET_HASH_KEY(&(Var14.f_8)));
		iVar0 = 2;
	}
	else
	{
...
bool func_301(int iParam0, int iParam1)
{
	...
	if (iParam0 == 10)
	{
		...
		{
			if (!func_302(GAMEPLAY::GET_HASH_KEY(&sVar0)))
			{
				return true;
			}
		}
	...
	else if (iParam0 != -1)
	{
		if ((iParam1 != -1 && iParam1 != -99) && func_220(func_300(), iParam0, iParam1))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Var13.f_6, true) && !func_302(GAMEPLAY::GET_HASH_KEY(&(Var13.f_8))))
			{
				return true;
			}
		}
...
void func_368(int iParam0, int iParam1)
{
	...
	if (iParam1 > 0)
	{
		if (func_369(ENTITY::GET_ENTITY_COORDS(iParam0, 0)))
		{
		}
		func_108(1);
