#region Local Var
	...
	auto uLocal_18 = 0;
	auto uLocal_19 = 0;
	int[] iLocal_20 = new int[45];
	int[] iLocal_66 = new int[19];
	int[] iLocal_86 = new int[76];
	int[] iLocal_163 = new int[102];
	int[] iLocal_266 = new int[9];
	int iLocal_276 = 0;
	int iLocal_277 = 0;
	int[] iLocal_278 = new int[1];
	int iLocal_280 = 0;
	int[] iLocal_281 = new int[1];
	int iLocal_283 = 0;
#endregion
...
void func_3(int iParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4)
{
	int iVar0;
...
void func_7(int iParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4)
{
	int iVar0;
...
void func_11(int iParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	set_pickup_regeneration_time(iLocal_266[iParam0], 600000);
}
...
void func_14()
{
	switch (Global_25360)
	{
		...
		case 1:
			...
			{
				case 0:
					if (does_pickup_exist(iLocal_20[Global_25362]) && does_pickup_object_exist(iLocal_20[Global_25362]))
					{
						Global_25363 = 0;
					}
					else
				...
				case 1:
					if (does_pickup_exist(iLocal_86[Global_25362]) && does_pickup_object_exist(iLocal_86[Global_25362]))
					{
						Global_25363 = 0;
					}
					else
				...
				case 2:
					if (does_pickup_exist(iLocal_163[Global_25362]) && does_pickup_object_exist(iLocal_163[Global_25362]))
					{
						Global_25363 = 0;
					}
					else
...
void func_16()
{
	...
	while (iVar0 < 1)
	{
		if (does_pickup_exist(iLocal_281[iVar0]))
		{
			remove_pickup(iLocal_281[iVar0]);
		}
		iVar0++;
	}
	iLocal_283 = 0;
...
void func_17()
{
	...
	while (iVar0 < 1)
	{
		if (does_pickup_exist(iLocal_278[iVar0]))
		{
			remove_pickup(iLocal_278[iVar0]);
		}
		iVar0++;
	}
	iLocal_280 = 0;
...
void func_18()
{
	...
	while (iVar0 < 9)
	{
		if (does_pickup_exist(iLocal_266[iVar0]))
		{
			remove_pickup(iLocal_266[iVar0]);
		}
		iVar0++;
	}
	iLocal_276 = 0;
...
void func_19()
{
	...
	while (iVar0 < 102)
	{
		if (does_pickup_exist(iLocal_163[iVar0]))
		{
			remove_pickup(iLocal_163[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()
{
	...
	while (iVar0 < 76)
	{
		if (does_pickup_exist(iLocal_86[iVar0]))
		{
			remove_pickup(iLocal_86[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	while (iVar0 < 19)
	{
		if (does_pickup_exist(iLocal_66[iVar0]))
		{
			remove_pickup(iLocal_66[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	if (iParam6)
	{
		add_pickup_to_interior_room_by_name(iLocal_163[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, Vector3 vParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	if (iParam5)
	{
		add_pickup_to_interior_room_by_name(iLocal_86[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
...
void func_37(int iParam0, Vector3 vParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
