...
bool func_165(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_111(player_ped_id()) && func_111(*iParam0.f_28[0])) && !func_130()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_169(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_180(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_181(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_180(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_187(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
{
	return func_192(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
