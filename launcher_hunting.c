...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_253(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_241(&Var0, 1);
	}
	if (!func_238(&iVar64, &Var0, vVar61, 1f))
	{
		func_237();
	...
	clear_area(vVar61, 3f, 1, 0, 0, false);
	while (true)
	{
		wait(0);
		if (!func_178(&Var0, 1))
		...
		func_177(Var0);
		func_170(&iLocal_101, &(Var0.f_9), vVar61);
		if (Var0 == 25)
		{
			func_165(&Var0, vVar61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (Var0 == 25)
		{
			...
			{
				set_ped_max_move_blend_ratio(PLAYER::PLAYER_PED_ID(), 3f);
			}
		}
		if (func_150(&Var0, 0) && absf(vVar61.z - vVar67.z) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_241(&Var0, 1);
...
bool func_165(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && !func_130()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_169(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_168(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
		func_166(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_166(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_167(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_168(auto uParam0, auto uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
auto func_169(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_170(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
...
bool func_178(int iParam0, int iParam1)
{
	...
	if (func_182(iParam0.f_48) && iParam1)
	{
...
void func_179(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_181(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_180(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_181(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_180(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_186(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_187(PLAYER::PLAYER_PED_ID(), *uParam0.f_35[iVar0]))
							{
...
bool func_188(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
{
	return func_192(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_192(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_193(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_193(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_194(iParam4, iParam7)};
...
bool func_196(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_198(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
	...
	{
		vVar3 = {func_198(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_197(vVar3, vVar0);
...
float func_197(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
bool func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0))
	{
		...
		if (!iParam2)
		{
			...
			if (func_203(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_203(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_205(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_198(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_217(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_224(&iVar0) || !has_anim_dict_loaded("rcmhunting2"))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				iLocal_100 = create_weapon_object(joaat("weapon_sniperrifle"), false, vLocal_97, 0, 1f, false, 0, 1);
				give_weapon_component_to_weapon_object(iLocal_100, joaat("component_at_scope_large"));
				give_weapon_component_to_weapon_object(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (iVar7)
			{
				iLocal_91 = 3;
...
void func_218(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	func_219(iParam0, iLocal_93, vParam1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_219(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_220(iParam0);
...
bool func_221(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_222(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_222(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_223(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_225(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_224(&iVar0) || !func_226(uParam0.f_48)) || !has_anim_dict_loaded("special_ped@cletus@base"))
			{
				return false;
			}
			iLocal_91 = 2;
...
void func_227(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
int func_232(int iParam0, char* sParam1)
{
...
bool func_238(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_239(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_239(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_239(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_240(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_240(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_242(auto uParam0, int iParam1, int iParam2, int iParam3)
{
