...
void main()
{
	...
	while (true)
	{
		...
		{
			vVar67 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 0)};
		}
		if (Var0 == 25)
		{
		...
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_181(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					...
					else if ((func_181(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
...
bool func_196(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_198(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
...
bool func_205(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_198(vParam1 - get_entity_coords(iParam0, 1))};
