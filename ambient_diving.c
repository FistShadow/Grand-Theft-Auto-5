...
int func_18(auto uParam0, int iParam1)
{
	...
	if (*uParam0.f_11)
	{
		...
		if (!func_25(44))
		{
			...
			{
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_23(iVar8), vVar5, 0) > 200f)
				{
...
void func_21(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
int func_24(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_26(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, auto uParam5, char* sParam6, char* sParam7)
{
	int iVar0;
...
int func_28(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_108, func_33(func_34(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
bool func_36(auto uParam0, auto uParam1, Vector3 vParam2)
{
	int iVar0;
...
void func_39(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_51(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
		...
		case 1:
			...
			if (!func_62())
			{
				if (func_50(iLocal_409))
				{
					...
					if (is_this_model_a_boat(ENTITY::GET_ENTITY_MODEL(iLocal_409)))
					{
...
int func_57(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_58(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_58(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
bool func_62()
{
	if (func_50(PLAYER::PLAYER_PED_ID()))
	{
		if (func_50(iLocal_409))
		{
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_409, 0))
			{
				return true;
			}
		}
		...
		{
			iLocal_409 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
...
void func_64()
{
	...
	if (func_24(&Local_42, &Local_55, vVar0, &iLocal_388))
	{
		...
		fVar6 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar3, vVar0, 0);
		if (fVar6 > 200f)
		{
			func_66();
			if (!iLocal_406)
		...
		else
		{
			...
			if (func_25(42))
			{
				if (!func_25(43))
				{
					if (is_entity_in_water(PLAYER::PLAYER_PED_ID()) && !is_ped_swimming_under_water(PLAYER::PLAYER_PED_ID()))
					{
...
void func_70(auto uParam0, int iParam1, int iParam2, char* sParam3)
{
	*uParam0 = iParam1;
	*uParam0.f_7 = iParam2;
	*uParam0.f_8 = sParam3;
