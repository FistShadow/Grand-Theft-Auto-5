...
bool func_13(int iParam0, var uParam1, float fParam2, int iParam3)
{
	int iVar0;
	float fVar1;
...
var func_15(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
		...
		case 1:
			if (func_388())
			{
				...
				if (iLocal_116)
				{
					...
					{
						func_359();
						set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 8);
					}
				}
			...
			{
				func_333();
				set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 7);
			}
...
void func_67(int iParam0)
{
	if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 6))
	{
		...
		set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 6);
	}
}
...
void func_71()
{
	...
	if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 5))
	{
		if (is_bit_set(Local_129.f_2, 3))
		{
			...
			set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 5);
		}
		else if (is_bit_set(Local_129.f_2, false))
		{
			if (func_378(player_id(), func_16(), 1))
...
void func_72(int iParam0, int iParam1, var uParam2)
{
	...
	if (iVar1 > 0)
	{
		...
		func_137();
		func_89(0, player_ped_id(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
	}
	if (iVar0 > 0)
	{
...
void func_76(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_77(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_84(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
void func_91(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_93(player_ped_id()))
	{
		func_92(1);
	}
...
Vector3 func_94(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_95(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_99(vector3 vParam0, var uParam1, var uParam2)
{
	Vector3 fVar0;
	float fVar1;
	float fVar2;
...
var func_100(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
var func_132(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
var func_192(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_221(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
int func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
...
void func_234(char* sParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_242(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, var uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, Vector3 fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_247(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_251(iParam3))
	{
...
int func_362(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, var uParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	struct<72> Var0;
...
int func_372(int iParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7)
{
	struct<72> Var0;
...
bool func_395(int iParam0, int iParam1, var uParam2, int iParam3, float fParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_398(int iParam0, var uParam1, int iParam2, int iParam3)
{
	if (iParam2 == -1)
	{
		return true;
		...
		case 1:
			if (func_388())
			{
				if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 3))
				{
					...
					{
						set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 3);
					}
				}
			}
			else if (func_378(player_id(), func_16(), 0))
...
bool func_401(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_413()
{
	...
	{
		if (func_416(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
			iVar0 = func_415(player_ped_id());
...
bool func_419(char* sParam0, char* sParam1, char* sParam2, int iParam3, var uParam4)
{
...
bool func_431(char* sParam0, char* sParam1, int iParam2, var uParam3)
{
	if (is_string_null_or_empty(sParam0))
	{
		return false;
			...
			if (func_388())
			{
				...
				if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
				{
					if (!func_21(&(Local_129.f_16)) && !func_21(&(Local_129.f_18)))
					{
						...
						{
							func_454(1);
							set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 2);
						}
					}
					...
					if (iLocal_116)
					{
						if (vLocal_151[network_get_participant_index(Local_129.f_5) /*3*/].f_1 == 1 && !is_bit_set(vLocal_151[network_get_participant_index(Local_129.f_5) /*3*/].f_2, 2))
						{
							if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 10))
							{
								...
								set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 10);
							}
						}
	...
	if (is_bit_set(vLocal_151[func_16() /*3*/].f_2, 4))
	{
		if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 9))
		{
			if (func_16() != func_88())
			{
				...
				set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 9);
			}
		}
	}
...
void func_454(int iParam0)
{
	if (!is_thread_active(Global_2412879.f_876) || Global_2412879.f_876 == get_id_of_this_thread())
	{
		if (iParam0)
		{
			...
			set_bit(&(Global_2418472[player_id() /*313*/].f_69.f_2), 25);
		}
		else
		{
...
void func_455()
{
	...
	{
		vLocal_118 = {get_entity_coords(player_ped_id(), 1)};
	...
	{
		if (vdist(get_entity_coords(player_ped_id(), 1), vLocal_118) > IntToFloat(Global_262145.f_10430))
		{
			func_8(&uLocal_122);
			if (is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
			{
		...
		else if (IntToFloat(func_442(&uLocal_122, 0, 0)) > Global_262145.f_10431)
		{
			...
			if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
			{
				set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 4);
			}
		}
		iLocal_121++;
	}
...
void func_456(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if ((!is_thread_active(Global_2412879.f_853) || Global_2412879.f_853 == get_id_of_this_thread()) || iParam4)
	{
		if (iParam0)
		{
			...
			set_bit(&(Global_2418472[player_id() /*313*/].f_69.f_2), 21);
			Global_2412879.f_854 = get_network_time();
		}
		else
		{
...
bool func_459(int iParam0, int iParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_465()
{
	...
	if (func_388())
	{
		if (func_480())
		{
			if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, 11))
			{
				set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 11);
			}
		}
	}
	switch (func_392(participant_id_to_int()))
	{
		case 1:
			...
			else if (func_459(player_id(), 500, &uVar0, 1123024896, 0))
			{
				if (!is_bit_set(vLocal_151[participant_id_to_int() /*3*/].f_2, false))
				{
					set_bit(&(vLocal_151[participant_id_to_int() /*3*/].f_2), false);
					if (func_388())
					{
						func_469(1);
						func_468(2);
...
{
	set_bit(&Global_1572926, iParam0);
}
...
void func_490(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	Vector3 fVar0;
	float fVar1;
...
void func_575(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_570();
