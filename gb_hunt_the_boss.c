...
bool func_1()
{
	...
	switch (Local_129.f_1)
	{
		case 0:
			...
			{
				GAMEPLAY::SET_BIT(&(Local_129.f_2), 4);
				func_18(2);
			}
			...
			if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, true))
			{
				func_18(2);
			}
			if (func_12(Local_129.f_5) || func_10(Local_129.f_5, 1, 0))
			{
				GAMEPLAY::SET_BIT(&(Local_129.f_2), 2);
				func_18(2);
			}
			break;
			...
			else
			{
				if (!func_21(&(Local_129.f_16)))
				{
					if (!func_13(Global_262145.f_10433, &uVar0, 1123024896, 0))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_129.f_2), 6);
					}
				}
				...
				else
				{
					...
					GAMEPLAY::CLEAR_BIT(&(Local_129.f_2), 6);
				}
				...
				if (func_19(&(Local_129.f_12), Global_262145.f_10429, 0) || iVar1)
				{
					...
					if (!iVar1)
					{
						GAMEPLAY::SET_BIT(&(Local_129.f_2), false);
					}
					else
					{
						func_2();
...
void func_2()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_129.f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 3))
		{
			Var0 = 0;
			Var0.f_1 = player_id();
			Var0.f_2 = 186;
			Var0.f_10 = func_6();
			func_3(Var0, func_4());
			GAMEPLAY::SET_BIT(&(Local_129.f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, false))
		{
			Var14 = 0;
			Var14.f_1 = player_id();
			Var14.f_2 = 188;
		...
		else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 2) || GAMEPLAY::IS_BIT_SET(Local_129.f_2, true))
		{
			Var28 = 0;
			Var28.f_1 = player_id();
			Var28.f_2 = 187;
...
auto func_4()
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_5(iVar2, 0, 0))
		{
			if (!GAMEPLAY::IS_BIT_SET(vLocal_151[iVar1 /*3*/].f_2, false))
			{
...
bool func_7()
{
	if ((((GAMEPLAY::IS_BIT_SET(Local_129.f_2, false) || GAMEPLAY::IS_BIT_SET(Local_129.f_2, true)) || GAMEPLAY::IS_BIT_SET(Local_129.f_2, 2)) || GAMEPLAY::IS_BIT_SET(Local_129.f_2, 3)) || GAMEPLAY::IS_BIT_SET(Local_129.f_2, 4))
	{
		return true;
	}
	return false;
...
void func_22()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_129.f_2, true))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_129.f_2), true);
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_129.f_2, true) && !GAMEPLAY::IS_BIT_SET(Local_129.f_2, 2))
	{
		iVar0 = network_get_participant_index(func_16());
		if (iVar0 >= 0 && iVar0 < 32)
		{
			if (GAMEPLAY::IS_BIT_SET(vLocal_151[iVar0 /*3*/].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(Local_129.f_2), 2);
				if (Local_129.f_1 == 0)
				{
...
Vector3 func_24(int iParam0)
{
	...
	iVar2 = _network_GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, iVar1);
	...
	switch (vLocal_151[participant_id_to_int() /*3*/].f_1)
	{
		...
		case 1:
			if (func_388())
			{
				...
				if (iLocal_116)
				{
					if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 8))
					{
						func_359();
						GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 8);
					}
				}
				...
				if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 6))
				{
					func_380(4);
				}
			}
			else if (iLocal_116)
			{
				...
				{
					func_361(0);
					if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, false))
					{
						func_380(8);
					}
					else
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 7))
			{
				func_333();
				GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 7);
			}
		...
		case 2:
			...
			if (func_388())
			{
				...
				if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 11))
				{
					func_549();
					return;
				}
			...
			func_71();
			func_218();
			if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, false))
			{
				if (func_388())
				{
					func_361(10);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, true))
			{
				if (func_356(participant_id_to_int()))
				{
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 2))
			{
				if (func_388())
				{
					func_361(12);
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 3))
			{
				if (func_388())
				{
					if (func_66())
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 4))
			{
				if (func_388())
				{
					func_361(16);
...
void func_38()
{
	...
	{
		if ((((((((!is_radar_hidden() && !GAMEPLAY::IS_BIT_SET(Global_2460486.f_743, 2)) && func_5(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out()) && !func_220(player_id(), 22)) && func_48(player_id()) != 0) && !func_41(func_42()))
		{
...
int func_48(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_63(iParam0) && !func_62(iParam0)) && !GAMEPLAY::IS_BIT_SET(Global_1610316[iParam0 /*174*/].f_1, 8));
...
{
	if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 6))
	{
		if (iParam0 != func_11())
		{
			func_68(0, iParam0);
		...
		GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 6);
	}
}
...
void func_71()
{
	...
	Var0.f_4 = 1;
	Var0.f_9 = -1;
	if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 5))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, 3))
		{
			if (player_id() == func_6())
			...
			GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 5);
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_129.f_2, false))
		{
			if (func_378(player_id(), func_16(), 1))
...
int func_156(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_126(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_160(1);
...
int func_161(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_166(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_126(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_160(1);
			}
...
int func_200(int iParam0)
{
	...
	if (func_207(iParam0))
	{
		...
		if (iVar1 < func_201(iParam0))
		{
			...
			{
				iVar0 += func_205(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
...
void func_218()
{
	if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 7))
	{
		...
		GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 7);
	}
}
...
bool func_277()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4426, false) && func_64())
	{
		return true;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_2460486.f_4426, true) && func_64())
	{
		return true;
	}
	return false;
...
void func_337()
{
	...
	vVar0 = {ENTITY::GET_ENTITY_COORDS(get_player_ped(func_16()), 0)};
	vVar3 = {ENTITY::GET_ENTITY_COORDS(get_player_ped(player_id()), 0)};
...
bool func_356(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(vLocal_151[iParam0 /*3*/].f_2, false))
	{
		return false;
	}
	return true;
...
void func_380(int iParam0)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(iLocal_108, iParam0))
			{
				if (func_387(0))
				{
					func_385("GB_HTB_HB0", "GB_HTB_BLP", func_386(func_16()), -1);
					func_39(1);
					GAMEPLAY::SET_BIT(&iLocal_108, iParam0);
				}
			}
			break;
...
void func_399()
{
	switch (vLocal_151[participant_id_to_int() /*3*/].f_1)
	{
		case 1:
			if (func_388())
			{
				if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 3))
				{
					if (func_400(82, "GB_INTTXT_HBB", 2, 0, 0, 0, 0, 1, 0, 1))
					{
						GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 3);
					}
				}
			}
			else if (func_378(player_id(), func_16(), 0))
...
void func_443()
{
	...
	switch (vLocal_151[participant_id_to_int() /*3*/].f_1)
	{
		...
		case 1:
			...
			{
				func_455();
				if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
				{
					if (!func_21(&(Local_129.f_16)) && !func_21(&(Local_129.f_18)))
					{
						if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 2))
						{
							func_454(1);
							GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 2);
						}
					}
					else if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 2))
					{
						func_454(0);
						GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 2);
					}
				}
			}
			else
			{
				...
				if (!func_378(player_id(), func_16(), 0))
				{
					if (iLocal_116)
					{
						if (vLocal_151[network_get_participant_index(Local_129.f_5) /*3*/].f_1 == 1 && !GAMEPLAY::IS_BIT_SET(vLocal_151[network_get_participant_index(Local_129.f_5) /*3*/].f_2, 2))
						{
							if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 10))
							{
								...
								GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 10);
							}
						}
						else if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 10))
						{
							...
							GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 10);
						}
					}
				}
			}
...
void func_446(int iParam0, auto uParam1, int iParam2)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_448())
	{
		return;
	}
	iVar0 = iParam0;
...
void func_453()
{
	if (GAMEPLAY::IS_BIT_SET(vLocal_151[func_16() /*3*/].f_2, 4))
	{
		if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 9))
		{
			if (func_16() != func_88())
			{
				play_sound_frontend(-1, "Boss_Blipped", "GTAO_Magnate_Hunt_Boss_SoundSet", 0);
				GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 9);
			}
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 9))
	{
		GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 9);
	}
}
...
void func_454(int iParam0)
{
	if (!is_thread_active(Global_2412879.f_876) || Global_2412879.f_876 == get_id_of_this_thread())
	{
		if (iParam0)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_69.f_2), 25);
		}
		else
		{
			Global_2412879.f_876 = -1;
			GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_69.f_2), 25);
		}
	}
}
...
void func_455()
{
	...
	{
		vLocal_118 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)};
	...
	else if (func_21(&uLocal_124))
	{
		...
		{
			func_8(&uLocal_124);
			GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 4);
	...
	{
		if (vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_118) > IntToFloat(Global_262145.f_10430))
		{
			func_8(&uLocal_122);
			if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
			{
		...
		else if (IntToFloat(func_442(&uLocal_122, 0, 0)) > Global_262145.f_10431)
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 4))
			{
				GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 4);
			}
		}
		iLocal_121++;
	}
...
void func_456(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if ((!is_thread_active(Global_2412879.f_853) || Global_2412879.f_853 == get_id_of_this_thread()) || iParam4)
	{
		if (iParam0)
		{
			...
			GAMEPLAY::SET_BIT(&(Global_2418472[player_id() /*313*/].f_69.f_2), 21);
			Global_2412879.f_854 = NETWORK::GET_NETWORK_TIME();
		}
		else
		{
			Global_2412879.f_853 = -1;
			GAMEPLAY::CLEAR_BIT(&(Global_2418472[player_id() /*313*/].f_69.f_2), 21);
		}
...
void func_462(int iParam0)
{
	...
	if (iVar2 == func_16())
	{
		if (ENTITY::DOES_ENTITY_EXIST(Var4.f_1))
		{
			if (is_entity_a_ped(Var4.f_1))
			{
				...
				if (is_ped_a_player(iVar1))
				{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_151[network_get_participant_index(iVar3) /*3*/].f_2, false))
						{
							if (iVar3 != func_11())
							{
								if (func_5(iVar3, 0, 0))
		...
		else
		{
			...
			{
				Local_129.f_6 = iVar3;
				GAMEPLAY::SET_BIT(&(Local_129.f_2), 3);
				func_18(2);
			}
		}
	}
...
void func_465()
{
	...
	if (func_388())
	{
		if (func_480())
		{
			if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, 11))
			{
				GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), 11);
			}
		}
	}
	switch (func_392(participant_id_to_int()))
	{
		case 1:
			...
			if (iLocal_117)
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, false))
				{
					GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), false);
					if (func_388())
					{
						func_469(0);
						func_468(2);
			...
			else if (func_459(player_id(), 500, &uVar0, 1123024896, 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, false))
				{
					GAMEPLAY::SET_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), false);
					if (func_388())
					{
						func_469(1);
						func_468(2);
			...
			else if (GAMEPLAY::IS_BIT_SET(vLocal_151[participant_id_to_int() /*3*/].f_2, false))
			{
				GAMEPLAY::CLEAR_BIT(&(vLocal_151[participant_id_to_int() /*3*/].f_2), false);
				if (func_388())
				{
...
{
	GAMEPLAY::CLEAR_BIT(&Global_1572926, iParam0);
}

void func_468(int iParam0)
{
	GAMEPLAY::SET_BIT(&Global_1572926, iParam0);
}
...
int func_474(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_449() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_28(func_472(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_490(int iParam0, Vector3 vParam1, auto uParam2, float fParam3, float fParam4, int iParam5)
{
	...
	if (((func_63(player_id()) && !func_62(player_id())) && !GAMEPLAY::IS_BIT_SET(Global_1610316[player_id() /*174*/].f_1, 8)) && (func_52(player_id()) || func_51(player_id())))
	{
		return;
	}
...
void func_550(int iParam0)
{
	...
	if (Global_1610316[player_id() /*174*/].f_10.f_28 != -1)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_1573883.f_1, 14) && !func_63(player_id()))
		{
			func_505(0);
		}
	}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1572926, iParam0);
}
