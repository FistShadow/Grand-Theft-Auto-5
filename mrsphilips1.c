#region Local Var
	...
	auto uLocal_77 = 0;
	auto uLocal_78 = 0;
	struct<61> Local_79 = 0;
	int iLocal_140 = 0;
	int iLocal_141 = 0;
	int iLocal_142 = 0;
	int iLocal_143 = 0;
	struct<61> Local_144 = 0;
#endregion
			...
			switch (iLocal_142)
			{
				...
				case 2:
					if (is_cutscene_playing())
					{
						...
						{
							func_214(player_ped_id(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
...
void func_201(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_205(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_209(player_id())) && !func_207(player_id(), 0)) && !func_206())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_209(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
int func_211(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
int func_214(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_215(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_216(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
bool func_221(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		{
			if (!func_228(get_vehicle_ped_is_in(player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_227(player_ped_id(), -828834893))
				{
...
bool func_228(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_230(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_232(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_239(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_238(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_237(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_236(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_235(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_234(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_233(iVar2), 8);
					break;
			}
			break;
...
bool func_241(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_244(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_243(0)) || func_242(1))
			{
			}
			else
			{
...
void func_248(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_263(int iParam0)
{
	...
	if (!func_282())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_264(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_265(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_271())
	{
		...
		{
			iVar33 = func_266(get_this_script_name());
			if (iVar33 > -1)
			{
