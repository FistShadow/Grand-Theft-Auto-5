			...
			switch (iLocal_142)
			{
				...
				case 2:
					if (is_cutscene_playing())
					{
						...
						{
							func_214(PLAYER::PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
...
void func_205(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_209(player_id())) && !func_207(player_id(), 0)) && !func_206())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_209(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
bool func_221(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_228(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_227(PLAYER::PLAYER_PED_ID(), -828834893))
				{
