...
void func_53(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_49(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		...
		if (iLocal_38 == 0)
		{
			if (!is_bit_set(iLocal_105, true) && is_bit_set(iLocal_105, false))
			{
				if (!func_71(player_ped_id(), vLocal_106, 5f))
				{
					...
					{
						if ((func_233(player_ped_id()) && !is_bit_set(uLocal_101[0], 17)) && !is_bit_set(uLocal_101[1], 18))
						{
...
bool func_167()
{
	...
	while (iVar6 <= 4)
	{
		if (func_233(uVar0[iVar6]) && uVar0[iVar6] != player_ped_id())
		{
...
bool func_195()
{
	...
	{
		if ((get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), 0), 0) == player_ped_id() || get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), 0), 1) == player_ped_id()) || get_ped_in_vehicle_seat(get_vehicle_ped_is_in(player_ped_id(), 0), 2) == player_ped_id())
		{
			return true;
		}
	}
...
bool func_205(var uParam0)
{
	...
	if (func_233(player_ped_id()) && is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		iVar0 = get_players_last_vehicle();
		if (func_80(iVar0))
		{
...
var func_215(char* sParam0, int iParam1, char* sParam2)
{
...
int func_230(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	var uVar1;
