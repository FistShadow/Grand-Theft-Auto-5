...
void main()
{
	...
	if (has_force_cleanup_occurred(3))
	{
		...
		func_464();
		if (does_entity_exist(iLocal_1464))
		{
...
bool func_137(auto uParam0, auto uParam1)
{
	...
	switch (iLocal_1041)
	{
		...
		case 7:
			...
			if (iLocal_1460 >= 2)
			{
				if (does_entity_exist(iLocal_1574))
				{
					if (func_255(iLocal_1574, player_ped_id(), 1) > 500f)
					{
		...
		case 10:
			...
			{
				if (iLocal_1515 && !is_ped_injured(*uParam1))
				{
					func_232();
		...
		case 11:
			...
			{
				if (!is_ped_injured(*uParam1) && iLocal_1460 == 2)
				{
...
void func_147(auto uParam0, int iParam1)
{
	...
	*iParam1 = 0;
	...
	if (does_entity_exist(iLocal_1573))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1573);
	}
	if (does_entity_exist(iLocal_1576))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1576);
	}
	if (does_entity_exist(iLocal_1575))
	{
...
void func_164(int iParam0, auto uParam1)
{
	...
	while (iVar0 <= 1)
	{
		if (does_entity_exist(Local_2203[iVar0 /*9*/]))
		{
...
void func_165()
{
	...
	while (iVar0 < 4)
	{
		if (does_entity_exist(iLocal_1577[iVar0]))
		{
...
bool func_184(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_187(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(player_ped_id(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (get_game_timer() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), 1) || func_185(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
bool func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_199(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_255(player_ped_id(), iParam0, 1) < 40f)
						{
...
int func_205(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_89(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_89(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
	else if (is_entity_an_object(iParam0))
	{
...
void func_206(auto uParam0)
{
	switch (iLocal_1461)
	{
		...
		case 1:
			if (!iLocal_1515)
			{
				if ((((func_197(*uParam0, 0, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || has_bullet_impacted_in_area(get_entity_coords(*uParam0, 1), 15f, 0, 1)) || iLocal_1517) || func_237(*uParam0, 1) < 5f) || (is_ped_in_flying_vehicle(player_ped_id()) && func_237(*uParam0, 1) <= 35f))
				{
	...
	switch (iLocal_1461)
	{
		...
		case 1:
			...
			else
			{
				...
				if (!iLocal_1521)
				{
					if (is_ped_in_vehicle(player_ped_id(), iLocal_1573, 0))
					{
						if (!is_ped_injured(*uParam1.f_9))
						{
							if (get_script_task_status(*uParam1.f_9, 1805844857) != 1)
...
bool func_215(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			task_look_at_entity(Local_1044, player_ped_id(), 5000, 0, 2);
			*iParam0++;
			break;
...
void func_218(auto uParam0, auto uParam1)
{
	...
	switch (iLocal_1461)
	{
		...
		case 2:
			...
			{
				iVar0 = func_223(0, get_entity_coords(player_ped_id(), 1), 20f);
				if (iVar0 != 0)
				{
...
auto func_223(int iParam0, Vector3 vParam1, float fParam2)
{
	...
	while (iVar0 <= 1)
	{
		if (!is_ped_injured(Local_2203[iVar0 /*9*/]))
		{
...
void func_229()
{
	if (does_entity_exist(Local_1044))
	{
		if (!is_ped_injured(Local_1044))
		{
		...
		while (iVar0 <= 1)
		{
			if (!is_ped_injured(Local_2203[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					...
					{
						task_smart_flee_ped(Local_2203[iVar0 /*9*/], player_ped_id(), 200f, -1, 0, 0);
...
void func_247()
{
	...
	Local_2203[0 /*9*/] = create_ped(5, joaat("a_f_y_fitness_02"), Local_2203[0 /*9*/].f_1, 169.9513f, 1, true);
	func_226(Local_2203[0 /*9*/], 1);
	Local_2203[1 /*9*/] = create_ped(5, joaat("a_f_y_beach_01"), Local_2203[1 /*9*/].f_1, 257.4617f, 1, true);
	func_226(Local_2203[1 /*9*/], 1);
	set_ped_combat_attributes(Local_2203[0 /*9*/], 17, true);
	set_ped_combat_attributes(Local_2203[0 /*9*/], 1, false);
	set_blocking_of_non_temporary_events(Local_2203[0 /*9*/], true);
	set_ped_combat_attributes(Local_2203[1 /*9*/], 17, true);
	set_ped_combat_attributes(Local_2203[1 /*9*/], 1, false);
...
void func_248(auto uParam0, int iParam1)
{
	...
	func_32(iParam1.f_16, 1, player_ped_id(), "FRANKLIN", 0, 1);
	if (*uParam0.f_274 == 1)
	{
	...
	if (*uParam0.f_15 != 0)
	{
		...
		if (*uParam0.f_274 == 1)
		{
			...
			iLocal_1028 = create_ped_inside_vehicle(*iParam1.f_8, 4, *uParam0.f_16, -1, 1, true);
...
void func_256()
{
	...
	if (func_448(&iLocal_1601))
	{
		if (func_39(&iLocal_1601) > 30f)
		{
			...
			if (iLocal_1539 == 1)
			{
				if (vdist(vVar0, vLocal_1616[0 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
			...
			{
				if (vdist(vVar0, vLocal_1616[1 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
						set_player_wanted_level(player_id(), 2, 0);
			...
			{
				if (vdist(vVar0, vLocal_1616[2 /*3*/]) < 100f || is_ped_in_flying_vehicle(player_ped_id()))
				{
					if (get_player_wanted_level(player_id()) == 0)
					{
						set_player_wanted_level(player_id(), 2, 0);
...
void func_259()
{
	if (!does_entity_exist(iLocal_1583))
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), 0))
			{
				iLocal_1583 = get_vehicle_ped_is_in(player_ped_id(), 0);
				if (does_entity_exist(iLocal_1583) && !is_entity_dead(iLocal_1583, 0))
				{
	...
	*uParam0.f_1 = func_314();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_292())
		{
			func_285(player_ped_id(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
bool func_303(auto uParam0)
{
	if (!is_entity_dead(player_ped_id(), 0) && !is_ped_injured(player_ped_id()))
	{
		if (func_313())
		{
			*uParam0 = func_309(get_entity_coords(player_ped_id(), 0), 5, -1, 0, 1, -1);
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_283(iParam0, 0, 0)) || func_283(iParam0, 1, 0)) || func_283(iParam0, 2, 0)) || func_265(iParam0) != 145) || func_384(iParam0)) || func_383(iParam0)) || func_382(iParam0)) || func_381(iParam0)) || !func_380(get_entity_model(iParam0)))
	{
		if (func_383(iParam0))
		{
		}
...
void func_397(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_88942[iVar0]) == func_267(iParam0, iParam1))
				{
...
void func_398(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(uParam1.f_77, func_270(iVar1 + 1));
			}
		}
...
bool func_399(int iParam0, auto uParam1, auto uParam2)
{
	...
	if (func_402(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_401(*iParam0, *uParam1[38] - 1))
	{
			...
			if (iLocal_1534)
			{
				if (does_entity_exist(iLocal_1464))
				{
					...
					if (!is_entity_dead(player_ped_id(), 0))
					{
						...
						set_entity_coords(player_ped_id(), vLocal_1471, 1, false, 0, 1);
						set_entity_heading(player_ped_id(), fLocal_1474);
					...
					task_synchronized_scene(player_ped_id(), iLocal_1504, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
		...
		case 2:
			...
			if (iLocal_1496)
			{
				if (is_screen_faded_out())
				{
					...
					{
						_0x2208438012482A1A(player_ped_id(), 0, 0);
						set_entity_coords(player_ped_id(), -700.2628f, -917.5313f, 18.2147f, 1, false, 0, 1);
...
void func_432(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((!is_ped_injured(player_ped_id()) && !func_436(player_id())) && !func_434(player_id(), 0)) && !func_433())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_436(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
