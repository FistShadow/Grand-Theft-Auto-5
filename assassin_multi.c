...
int func_305(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_307() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_286(func_306(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	return shift_right(iParam0, 26) & 31 * func_320(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_398(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_270(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_270(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_405(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_404())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_270(iVar2 + 1)))
				{
...
void func_426(auto uParam0)
{
	...
	switch (iLocal_1463)
	{
		case 0:
			...
			if ((has_anim_dict_loaded("oddjobs@assassinate@multi@call") && STREAMING::HAS_MODEL_LOADED(-1559354806)) && func_350())
			{
				iLocal_1534 = true;
			}
			if (iLocal_1534)
