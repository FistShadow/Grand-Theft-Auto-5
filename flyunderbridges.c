			...
			if (is_player_playing(player_id()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_39[iLocal_31 /*3*/]) < fLocal_250)
							{
								if (is_ped_in_any_heli(PLAYER::PLAYER_PED_ID()) || is_ped_in_any_plane(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (is_vehicle_driveable(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
									{
										if (func_14())
										{
											if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0))
											{
												iLocal_33 = true;
												iLocal_27 = 1;
											}
											if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
											{
												iLocal_34 = true;
												iLocal_27 = 1;
											}
					...
					case 1:
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							...
							else if (!is_entity_in_air(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
							{
								func_13();
							}
							if (iLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
										{
											func_13();
											func_1();
									...
									else if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
									{
										iLocal_36 = 1;
									}
									else if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && !is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		iVar0 = GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		iVar0 = GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_97, iLocal_31 - 32);
	}
	else
	{
		iVar0 = GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_98, iLocal_31 - 64);
	}
	if (iVar0)
	{
	}
...
bool func_14()
{
	if (iLocal_38)
	{
		...
		{
			if (get_entity_upright_value(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) > -0.6f && get_entity_upright_value(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) < 0.6f)
			{
				return true;
			}
		}
...
void func_15()
{
	if (GAMEPLAY::GET_GAME_TIMER() - iLocal_268 > 500)
	{
		if (iLocal_31 == 29)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_96, iLocal_31))
			{
				iLocal_267 = true;
			}
		}
...
void func_25()
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_97, iLocal_31 - 32))
		{
			iLocal_267 = true;
		}
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_98, iLocal_31 - 64))
	{
		iLocal_267 = true;
	}
	if (iLocal_267)
...
int func_48()
{
	...
	while (iVar1 < 32)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_96, iVar1))
		{
			if (func_49(iVar1))
			{
				iVar0++;
		...
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_97, iVar1))
		{
			if (func_49(iVar1 + 32))
			{
				iVar0++;
		...
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_8739.f_98, iVar1))
		{
			if (func_49(iVar1 + 64))
			{
				iVar0++;
