...
bool func_24(int iParam0)
{
	...
	{
		iVar0 = 60 * TIME::GET_CLOCK_HOURS() + get_clock_minutes() - iLocal_303 + 60 * iLocal_302;
	}
	if (iVar0 >= 60 * iParam0)
	{
		return true;
	...
	if (iLocal_466 == 0)
	{
		if (iLocal_336)
		{
			if (iLocal_337)
			{
				...
				{
					open_sequence_task(&iVar0);
					AI::TASK_PLAY_ANIM(false, sLocal_296, "react_intro", 8f, -8f, 4900, 8, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_296, "react_loop", 8f, -4f, 12400, 8, 0, 0, 0, 0);
					close_sequence_task(iVar0);
					AI::CLEAR_PED_TASKS(iLocal_289);
					task_perform_sequence(iLocal_289, iVar0);
					iLocal_466 += 4;
...
bool func_232(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_242())
		{
			*uParam0 = func_238(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_238(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_241(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_239(iVar0, 0), 1);
...
auto func_243()
{
	...
	func_251(&uVar0, TIME::GET_CLOCK_HOURS());
		...
		case 0:
			...
			if (func_26(iLocal_290))
			{
				...
				if (is_ped_in_any_vehicle(iLocal_290, 0))
				{
					...
					task_smart_flee_coord(false, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
					close_sequence_task(iVar0);
				...
				{
					task_smart_flee_coord(iLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
				}
				iLocal_413 = 0;
				iLocal_414 = false;
				iLocal_415 = 0;
		...
		case 1:
			...
			if (func_26(iLocal_290))
			{
				...
				else
				{
					...
					else if ((((is_ped_on_foot(iLocal_290) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !is_ped_getting_up(iLocal_290)) && !is_entity_on_fire(iLocal_290)) && !is_entity_in_air(iLocal_290))
					{
...
void func_270()
{
	if (!iLocal_604)
	{
		...
		{
			func_273(1);
			if (((func_272(vLocal_584[0 /*3*/], vLocal_584[2 /*3*/], 1f) && !is_ped_in_melee_combat(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !is_ped_getting_up(iLocal_290))
			{
		...
		if (!iLocal_604)
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() > uLocal_606[0] && func_189(PLAYER::PLAYER_PED_ID(), iLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !is_ped_getting_up(iLocal_290))
				{
					func_271(0, 0);
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > uLocal_606[1])
				{
					if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), get_offset_from_entity_in_world_coords(iLocal_290, 0f, 1f, -2f), get_offset_from_entity_in_world_coords(iLocal_290, 0f, 7f, 5f), 5f, 0, true, 0) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !is_ped_getting_up(iLocal_290))
					{
						func_271(0, 1);
					}
					else
...
bool func_284(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_286(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_327()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_277, 0) || !is_vehicle_driveable(Local_277, 0))
		{
			return true;
		}
...
bool func_329(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, float fParam6)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = {func_286(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
		...
		case 0:
			if (!func_337())
			{
				...
				if (func_333(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					open_sequence_task(&iVar0);
					task_vehicle_mission_coors_target(false, Local_277, ENTITY::GET_ENTITY_COORDS(iLocal_273, 1), 4, 35f, 2883621, 10f, 12f, 1);
					...
					switch (iLocal_316)
					{
						...
						case 4:
							...
							else if (!func_23() && GAMEPLAY::GET_GAME_TIMER() > iLocal_543)
							{
								if (!func_186())
								{
									if (iLocal_312 && !GAMEPLAY::ARE_STRINGS_EQUAL(Local_487[iLocal_520 /*8*/].f_6, "NULL"))
									{
...
void func_340()
{
	...
	Var27[0 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
	if (Var27[0 /*4*/][0] < 2)
	{
	...
	{
		Var27[0 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, true);
	}
	if (Var27[0 /*4*/][0] > 1)
	{
	...
	{
		Var27[0 /*4*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, true);
	}
	...
	Var27[1 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
	...
	{
		Var27[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, true);
	}
	if (Var27[1 /*4*/][0] > 1)
	{
		Var27[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
...
bool func_349(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_286(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
					...
					switch (iLocal_304)
					{
						case 0:
							if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, true, 0))
							{
								...
								open_sequence_task(&iVar0);
								AI::TASK_PLAY_ANIM(false, sLocal_296, "breakout", 8f, -4f, -1, 0, 0, 0, 0, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_396(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_393(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
	...
	if (func_452(uParam0))
	{
		...
		if (func_451(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_441(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(get_this_script_name(), "startup_positioning"))
				{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				...
				{
					if ((!iParam4 || func_231(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
