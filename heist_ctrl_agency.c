...
int func_270(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
bool func_289(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_325(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, vector3 vParam11, vector3 vParam12)
{
	*uParam0.f_1 = iParam1;
