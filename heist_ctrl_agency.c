...
void main()
{
	...
	while (!func_313(2))
	{
		if (!Global_69758)
		{
			...
			if (func_310(3, 0))
			{
				if (!func_309(66))
				{
					if (!is_bit_set(iLocal_41, 8))
					{
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 8);
					}
				}
				else if (!is_bit_set(iLocal_41, 9))
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 9);
				}
			}
			func_310(3, 0);
			...
			else if (is_bit_set(Local_95.f_449, false))
			{
				func_144(&Local_95);
			}
			if (func_142(0) || is_bit_set(Local_95.f_449, 2))
			{
				func_68(&Local_95);
				func_6(&Local_95);
				func_5(&Local_95);
		...
		if (_get_number_of_instances_of_streamed_script(joaat("agency_heist3a")) > 0 || _get_number_of_instances_of_streamed_script(joaat("agency_heist3b")) > 0)
		{
			func_4();
		}
		if (func_313(12))
		{
			if (!func_3(0))
			{
				if (!is_bit_set(Global_101154.f_1.f_120[3], 8))
				{
					func_2(3, 8, 1);
				}
			}
			else if (is_bit_set(Global_101154.f_1.f_120[3], 8))
			{
				func_2(3, 8, 0);
			}
		}
...
void func_18(int iParam0, auto uParam1)
{
...
void func_24(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
void func_26(auto uParam0, struct<2> Param1, struct<2> Param2, int iParam3)
{
	if (*uParam0.f_483 == 3)
	{
		return;
...
void func_27(auto uParam0, auto uParam1, float fParam2)
{
	Vector3 vVar0;
...
void func_28(auto uParam0, Vector3 vParam1, float fParam2)
{
...
Vector3 func_29(auto uParam0, auto uParam1)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_30(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	int iVar1;
...
void func_33(auto uParam0)
{
	...
	_push_scaleform_movie_function_parameter_int(*uParam0.f_415);
	_push_scaleform_movie_function_parameter_bool(func_310(*uParam0, *uParam0.f_1.f_29));
	_pop_scaleform_movie_function_void();
	iVar0 = func_66(func_32(*uParam0));
	if (iVar0 != 0)
	{
...
void func_148()
{
	...
	if (func_313(7))
	{
		if (!is_bit_set(iLocal_41, 7))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 7);
		}
	...
	if (func_313(8))
	{
			...
			if ((has_this_cutscene_loaded("AH_2_EXT_P4") && SCRIPT::HAS_SCRIPT_LOADED("lesterHandler")) && has_model_loaded(1385417869))
			{
				if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					else
					{
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 12);
					}
				}
				if (func_3(0))
				{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 10);
				func_272(0);
				func_116(1);
				func_264(1, 1, 1, 0);
				func_73(1);
		...
		else if (is_cutscene_playing())
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity("MICHAEL", joaat("player_zero"))))
				{
					set_entity_visible(get_entity_index_of_registered_entity("MICHAEL", joaat("player_zero")), true, 0);
				}
			...
			if (can_set_exit_state_for_registered_entity("MICHAEL", false))
			{
				if (func_93() != 0)
				{
					...
					func_247(&iLocal_49, 0);
					func_186(&iLocal_49, 1, 0, 0);
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					set_blocking_of_non_temporary_events(PLAYER::PLAYER_PED_ID(), false);
		...
		else
		{
			...
			if (iLocal_94 != -1)
			{
				if (_0x0EAEB0DB4B132399(iLocal_94))
				{
					remove_navmesh_blocking_object(iLocal_94);
				}
			}
			clear_ped_non_creation_area();
			set_ped_paths_in_area(Local_95.f_1.f_394 - Local_95.f_1.f_397, Local_95.f_1.f_394 + Local_95.f_1.f_397, true, 0);
...
bool func_157(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<98> Var1;
	auto uVar99;
...
int func_158(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	*uParam2.f_3 = 1000;
	*uParam2.f_1 = 0;
	*uParam2.f_84 = 255;
...
void func_159(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
bool func_160(int iParam0, auto uParam1, int iParam2)
{
...
int func_169(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_170(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_182(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_170(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
bool func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((!PED::IS_PED_INJURED(*iParam0[*iParam0.f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && *iParam0[*iParam0.f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		*iParam0.f_7 = 4;
		...
		func_216();
		func_210(iVar2);
		func_193(func_208(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 145, 0));
		...
		if (is_player_playing(player_id()))
		{
			set_auto_give_parachute_when_enter_plane(player_id(), func_313(67));
		}
		if (is_player_playing(player_id()))
		{
			_0xD2B315B6689D537D(player_id(), func_313(68));
		}
...
void func_187()
{
	...
	{
		func_94();
		_0xBF59707B3E5ED531(func_188(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
bool func_199(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_200(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_201(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_202(iParam0) && _get_number_of_instances_of_streamed_script(Global_82399[26 /*34*/].f_6) == 0)
			{
				Global_101154.f_5951[iParam0] = 1;
				_set_door_acceleration_limit(*uParam1.f_5, Global_101154.f_5951[iParam0], 1, 1);
			}
...
int func_208(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
void func_215(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_216()
{
	...
	if ((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !func_95(func_93())) || !func_222())
	{
		return;
	}
	Var0 = 12;
	...
	Var0.f_39 = 9;
	Var0.f_49 = 9;
	func_218(PLAYER::PLAYER_PED_ID(), &Var0, 1);
...
auto func_217(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_218(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_213(iParam1)];
...
void func_220(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_221(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_242(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_228(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_243(Var9.f_1)) && iVar70 < 50)
			{
...
int func_245(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_247(int iParam0, int iParam1)
{
	...
	else
	{
		...
		if (func_230(func_93()) != iParam1 || iVar0)
		{
			iVar1 = false;
			if ((iVar0 || *iParam0.f_24[iParam1] != 0) || ((func_251(iParam1) && func_248(iParam1)) && !*iParam0.f_18[iParam1]))
			{
				if (!*iParam0.f_23)
				{
			...
			else if (!((is_bit_set(Global_101154.f_7775.f_2[27 /*3*/], true) && !Global_3) && !func_3(0)))
			{
				if (*iParam0.f_23)
				{
					iVar1 = true;
...
auto func_263(int iParam0)
{
	auto uVar0;
	
	uVar0 = func_66(func_262(iParam0));
...
void func_264(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_268(player_id())) && !func_266(player_id(), 0)) && !func_265())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_268(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_270(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
	...
	if (func_313(6))
	{
		if (!func_3(0))
		{
			if (!is_bit_set(iLocal_41, 6))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 6);
			}
			else if (_0xB56BBBCC2955D9CB())
			{
				set_cutscene_ped_prop_variation("LESTER", true, 0, 0, false);
			...
			if (func_309(67))
			{
				if (!func_231(0))
				{
					if (func_293(&iLocal_42, 0, 0, 0, 0) == 1)
					{
						...
						iLocal_93 = add_scenario_blocking_area(Local_95.f_1.f_394 - Local_95.f_1.f_397, Local_95.f_1.f_394 + Local_95.f_1.f_397, 0, 1, 1, 1);
						...
						set_ped_paths_in_area(Local_95.f_1.f_394 - Local_95.f_1.f_397, Local_95.f_1.f_394 + Local_95.f_1.f_397, false, 0);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 2);
					}
				}
			}
			if (is_bit_set(iLocal_41, 2))
			{
				if (func_291("AH_2_EXT_ALT") && has_model_loaded(1385417869))
				{
					if (!is_cutscene_playing())
					{
						if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_9[0]) && !is_entity_dead(Global_88108.f_9[0], 0))
						{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_28[0]) && !is_entity_dead(Global_88108.f_28[0], 0))
						{
							iLocal_47 = Global_88108.f_28[0];
							set_entity_as_mission_entity(Global_88108.f_28[0], false, 1);
							register_entity_for_cutscene(iLocal_47, "WALKINGSTICK_LESTER", 1, joaat("prop_cs_walking_stick"), 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_9[1]) && !is_entity_dead(Global_88108.f_9[1], 0))
						{
							iLocal_49[0] = Global_88108.f_9[1];
					...
					{
						func_112();
						if (ENTITY::DOES_ENTITY_EXIST(Global_88108[0]) && !is_entity_dead(Global_88108[0], 0))
						{
							set_entity_as_mission_entity(Global_88108[0], false, 1);
							func_275(Global_88108[0], 0, 1);
							delete_vehicle(&(Global_88108[0]));
						}
						if (ENTITY::DOES_ENTITY_EXIST(get_players_last_vehicle()))
						{
							Global_88108[0] = get_players_last_vehicle();
							set_entity_as_mission_entity(Global_88108[0], false, 1);
							func_275(Global_88108[0], 0, func_93());
							delete_vehicle(&(Global_88108[0]));
						}
						if (get_ped_prop_index(PLAYER::PLAYER_PED_ID(), false) == 7)
						{
						...
						if (!is_bit_set(iLocal_41, 13))
						{
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 13);
						}
						if (was_cutscene_skipped())
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 14);
						}
						if (is_bit_set(iLocal_41, 14))
						{
							if (is_screen_faded_out())
							{
								if (!is_bit_set(iLocal_41, true))
								{
									func_274();
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, true);
								}
								if (!is_bit_set(iLocal_41, 3))
								{
									func_2(3, 3, 1);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 3);
								}
							}
						}
						if (is_bit_set(iLocal_41, 12))
						...
						if (!is_bit_set(iLocal_41, 4))
						{
							...
							{
								if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_cutscene_entity("FRANKLIN", 0)))
								{
									if (!is_entity_dead(get_entity_index_of_cutscene_entity("FRANKLIN", 0), 0))
									{
										set_entity_visible(get_entity_index_of_cutscene_entity("FRANKLIN", 0), false, 0);
									}
								}
								if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_cutscene_entity("LESTER", 0)))
								{
									if (!is_entity_dead(get_entity_index_of_cutscene_entity("LESTER", 0), 0))
									{
										set_entity_visible(get_entity_index_of_cutscene_entity("LESTER", 0), false, 0);
									}
								}
								if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_cutscene_entity("WALKINGSTICK_LESTER", 0)))
								{
									if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_cutscene_entity("WALKINGSTICK_LESTER", 0)))
									{
										set_entity_visible(get_entity_index_of_cutscene_entity("WALKINGSTICK_LESTER", 0), false, 0);
									}
								}
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 4);
							}
						}
						if (!is_bit_set(iLocal_41, 5))
						{
							if (GAMEPLAY::GET_GAME_TIMER() - iLocal_44 > 73900)
							{
								...
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_41, 5);
							}
						}
						if (can_set_exit_state_for_registered_entity("MICHAEL", joaat("player_zero")))
						{
							...
							{
								func_247(&iLocal_49, 0);
								func_186(&iLocal_49, 0, 0, 0);
								set_model_as_no_longer_needed(joaat("player_zero"));
								func_290(&(Local_95.f_484), 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
							}
							if (!is_bit_set(iLocal_41, true))
							{
								func_274();
...
void func_277(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_278(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_279(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_288(iParam0, 0, 0)) || func_288(iParam0, 1, 0)) || func_288(iParam0, 2, 0)) || func_287(iParam0) != 145) || func_286(iParam0)) || func_285(iParam0)) || func_284(iParam0)) || func_283(iParam0)) || !func_282(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_285(iParam0))
		{
		}
...
bool func_288(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_289(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_289(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_290(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_294(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_297(auto uParam0, float fParam1, float fParam2)
{
	float fVar0;
...
void func_300(auto uParam0)
{
	...
	while (iVar0 < *uParam0.f_1.f_33)
	{
		if (func_310(*uParam0, *uParam0.f_1.f_75[iVar0]))
		{
			...
			vVar4 = {func_301(uParam0, uParam0.f_1.f_34[iVar0 /*2*/])};
...
Vector3 func_301(auto uParam0, auto uParam1)
{
	float fVar0;
	float fVar1;
	float fVar2;
		...
		while (iVar0 < *uParam0.f_1.f_33)
		{
			if (func_310(*uParam0, *uParam0.f_1.f_75[iVar0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_428[iVar0]))
				{
					...
					vVar6 = {func_301(uParam0, uParam0.f_1.f_34[iVar0 /*2*/])};
...
{
	return is_bit_set(Global_101154.f_1.f_120[iParam0], iParam1);
}
...
void func_318(auto uParam0, int iParam1, int iParam2, char* sParam3)
{
	char[32] cVar0;
...
void func_319(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (*uParam0.f_117 < 22)
	{
...
void func_320(auto uParam0, int iParam1, char* sParam2)
{
	char[8] cVar0;
...
void func_321(auto uParam0, int iParam1, char* sParam2, char* sParam3)
{
	char[8] cVar0;
	char[8] cVar2;
...
void func_322(auto uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8)
{
	char[16] cVar0;
	char[16] cVar4;
	char[16] cVar8;
...
void func_323(auto uParam0, float fParam1, float fParam2, float fParam3)
{
	*uParam0.f_9 = fParam1;
...
void func_325(auto uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, auto uParam10, Vector3 vParam11, Vector3 vParam12)
{
	*uParam0.f_1 = iParam1;
