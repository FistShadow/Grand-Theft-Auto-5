#region Local Var
	...
	int iLocal_923 = 0;
	int iLocal_924 = 0;
	Vector3[] vLocal_925 = new Vector3[1];
	int iLocal_929 = 0;
	int iLocal_930 = 0;
	int iLocal_931 = 0;
	int iLocal_932 = 0;
	...
	int iLocal_976 = 0;
	int iLocal_977 = 0;
	Vector3 vLocal_978 = 0;
	Vector3 vLocal_981 = 0;
	Vector3 vLocal_984 = 0;
	Vector3 vLocal_987 = 0;
	Vector3 vLocal_990 = 0;
	Vector3 vLocal_993 = 0;
	Vector3 vLocal_996 = 0;
	Vector3 vLocal_999 = 0;
	Vector3 vLocal_1002 = 0;
	Vector3 vLocal_1005 = 0;
	char* sLocal_1008 = 0;
	char[24] cLocal_1009 = 0;
	char[24] cLocal_1015 = 0;
	struct<6> Local_1021 = 0;
	int iLocal_1027 = 0;
	auto uLocal_1028 = 0;
	auto uLocal_1029 = 0;
	int iLocal_1030 = 0;
	...
	auto uLocal_1105 = 0;
	auto uLocal_1106 = 0;
	auto uLocal_1107 = 1097859072;
	auto uLocal_1108 = 1500;
	auto uLocal_1109 = 45;
	auto uLocal_1110 = 1103626240;
	auto uLocal_1111 = 5;
	int iLocal_1112 = 0;
	auto uLocal_1113 = 0;
	auto uLocal_1114 = 0;
...
void func_8()
{
	...
	else
	{
		...
		if (Local_409.f_410 > 5 && !is_bit_set(iLocal_959, false))
		{
			Local_409.f_17 = {189.7825f, -3325.684f, 4.6697f};
			set_bit(&iLocal_959, false);
		}
		...
		switch (Local_409.f_410)
		{
			case 0:
				...
				func_279(&Local_409, vLocal_978, vLocal_981, "TaxiWalter", iLocal_929, 202f, 35f);
				func_277(&Local_409);
			...
			case 1:
				...
				{
					func_273();
					func_272(&(vLocal_925[0 /*3*/]), "TAXI_SC_BN_12", 200);
					func_271(&Local_409, &vLocal_925);
					func_251();
					func_250(&Local_409);
			...
			case 3:
				if (func_245(&Local_409, 1))
				{
					if (!is_entity_dead(Local_409.f_3, 0))
					{
						...
						set_ped_component_variation(Local_409.f_3, false, false, 2, 0);
					}
					...
					set_ped_can_be_targetted(Local_409.f_3, false);
			...
			case 7:
				if (is_bit_set(iLocal_959, false))
				{
					func_209();
			...
			case 9:
				...
				{
					set_all_vehicle_generators_active_in_area(vLocal_984, vLocal_987, false, 1);
					set_ped_non_creation_area(vLocal_984, vLocal_987);
					iLocal_947 = add_scenario_blocking_area(vLocal_984, vLocal_987, 0, 1, 1, 1);
					clear_area_of_peds(195.16f, -3282.54f, 4.79f, 25f, 0);
					func_191(&Local_409);
					func_189(&uLocal_1064);
					func_188(&Local_1034, 3, 0);
					func_213(&Local_409, 97, 1, 0, 0);
					give_weapon_to_ped(Local_409.f_2, joaat("weapon_combatpistol"), 200, true, true);
					iLocal_966 = 1;
				}
			...
			case 27:
				if ((!func_104() && !is_entity_dead(Local_409.f_3, 0)) && func_102(&Local_409, 19) > 2f)
				{
					...
					if (create_incident(5, vLocal_1005, 1, 0f, &uLocal_948))
					{
						_0xD261BA3E7E998072(uLocal_948, 200f);
						iLocal_973 = true;
					}
					if (create_incident(7, vLocal_1005, 3, 0f, &uLocal_949))
					{
						iLocal_973 = true;
					}
				}
				...
				if (func_74(&Local_409, &iLocal_1112))
				{
					if (does_entity_exist(Local_409.f_3))
					{
						if (!is_entity_dead(Local_409.f_3, 0))
						{
							...
							task_follow_nav_mesh_to_coord(false, 261.0916f, -3089.062f, 4.79249f, 2f, -1, 0.25f, 0, 1193033728);
							task_follow_nav_mesh_to_coord(false, 304.6327f, -2965.922f, 5.00012f, 2f, -1, 0.25f, 0, 1193033728);
							task_follow_nav_mesh_to_coord(false, 309.8907f, -2870.473f, 5.15704f, 2f, -1, 0.25f, 0, 1193033728);
							task_wander_standard(false, 1193033728, 0);
							close_sequence_task(iLocal_934);
							task_perform_sequence(Local_409.f_3, iLocal_934);
							set_ped_keep_task(Local_409.f_3, true);
						}
					}
			...
			case 30:
				...
				{
					iLocal_946 = get_random_vehicle_in_sphere(vLocal_1005, 40f, joaat("ambulance"), 0);
					if (is_vehicle_driveable(iLocal_946, 0))
					{
						iLocal_974 = 1;
					}
					iLocal_946 = get_random_vehicle_in_sphere(vLocal_1005, 40f, joaat("police"), 0);
					if (is_vehicle_driveable(iLocal_946, 0))
					{
						iLocal_974 = 1;
					}
					iLocal_944 = get_random_ped_at_coord(vLocal_1005, 10f, 10f, 5f, -1);
...
auto func_9(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_10(int iParam0, auto uParam1, int iParam2)
{
	if (iParam0)
	{
		func_50(uParam1);
...
void func_11(auto uParam0, int iParam1)
{
	...
	playstats_oddjob_done(round(func_12(&iLocal_90) * 1000f), 12, 0);
}
...
void func_36(Vector3 vParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_38(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_39(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_74(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!func_104() && func_102(iParam0, 0) > 1f)
			{
				if (func_32())
				{
					set_player_control(player_id(), true, 0);
				...
				func_98(iParam1, "TAXI_FARE_TITLE", *iParam0.f_50, *iParam0.f_56, *iParam0.f_50 + *iParam0.f_56 + *iParam0.f_105, *iParam0.f_105, func_99(iParam0), "TAXI_FARE_MID", 4000, 1);
				*iParam1.f_1 = 4000;
...
void func_80(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_82() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_82() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_81(iParam0));
...
int func_84(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_82() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_91(auto uParam0, int iParam1)
{
	...
	if (func_93(uParam0.f_2) * 1000f > to_float(*uParam0.f_1))
	{
		if (!func_15(uParam0.f_5))
		{
			func_95(uParam0.f_5);
...
void func_94(auto uParam0, Vector3 fParam1)
{
...
void func_98(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7, int iParam8, int iParam9)
{
...
void func_107(int iParam0)
{
	...
	if (*iParam0.f_56 < *iParam0.f_58)
	{
		if (*iParam0.f_411 == 0)
		{
			func_213(iParam0, 105, 1, 0, 0);
		}
		else
		{
			func_213(iParam0, 103, 1, 0, 0);
		}
		func_108(1);
	}
	else if (*iParam0.f_56 >= *iParam0.f_59)
	{
		func_213(iParam0, 101, 1, 0, 0);
	}
	else
	{
		func_213(iParam0, 102, 1, 0, 0);
	}
	func_281(iParam0, 16, 4f, 0);
}
...
int func_115()
{
	...
	switch (iLocal_933)
	{
		case 0:
			...
			func_148();
			clear_bit(&iLocal_959, true);
			if (!is_synchronized_scene_running(iLocal_964))
			{
				if ((!is_ped_injured(Local_839.f_3[0]) && !is_ped_injured(Local_839.f_3[1])) && !is_ped_injured(Local_839.f_3[2]))
				{
					iLocal_964 = create_synchronized_scene(vLocal_996, vLocal_999, 2);
					set_synchronized_scene_looped(iLocal_964, true);
					task_synchronized_scene(Local_839.f_3[0], iLocal_964, "oddjobs@taxi@argument", "idle_a_biker_a", 1000f, -1000f, 0, 0, 1000f, 0);
					task_synchronized_scene(Local_839.f_3[1], iLocal_964, "oddjobs@taxi@argument", "idle_a_biker_b", 1000f, -1000f, 0, 0, 1000f, 0);
					task_synchronized_scene(Local_839.f_3[2], iLocal_964, "oddjobs@taxi@argument", "idle_a_biker_c", 1000f, -1000f, 0, 0, 1000f, 0);
				}
			}
		...
		case 1:
			if (!func_104() && !is_bit_set(iLocal_959, 10))
			{
				func_213(&Local_409, 91, 1, 0, 0);
				set_bit(&iLocal_959, 10);
			...
			if (get_game_timer() - iLocal_951 > 4000)
			{
				if (!is_player_control_on(get_player_index()))
				{
					...
					iLocal_967 = 1;
					if ((!is_ped_injured(Local_839.f_3[3]) && !is_ped_injured(iLocal_941[0])) && !is_ped_injured(iLocal_941[1]))
					{
						iLocal_961 = create_synchronized_scene(vLocal_990, vLocal_993, 2);
						task_synchronized_scene(Local_839.f_3[3], iLocal_961, "oddjobs@taxi@argument", "bridge_biker_d", 1000f, -1000f, 0, 0, 1000f, 0);
						task_synchronized_scene(iLocal_941[0], iLocal_961, "oddjobs@taxi@argument", "bridge_hooker_a", 1000f, -1000f, 0, 0, 1000f, 0);
						task_synchronized_scene(iLocal_941[1], iLocal_961, "oddjobs@taxi@argument", "bridge_hooker_b", 1000f, -1000f, 0, 0, 1000f, 0);
					}
					set_player_control(get_player_index(), true, 0);
				}
			}
			if (func_145("TAXI_VIEW") && (is_control_pressed(0, 80) || !is_ped_in_any_vehicle(player_ped_id(), 0)))
			{
				clear_help(1);
			}
			if (!is_ped_injured(Local_409.f_3) && (!func_104() || func_12(&iLocal_1027) > 9f))
			{
				if ((is_entity_at_coord(Local_409.f_3, vLocal_1002, 1.5f, 1.5f, 2f, false, true, 0) && get_script_task_status(Local_409.f_3, 242628503) == 7) && (is_synchronized_scene_running(iLocal_964) && get_synchronized_scene_phase(iLocal_964) > 0.995f))
				{
					if ((!is_ped_injured(Local_839.f_3[0]) && !is_ped_injured(Local_839.f_3[1])) && !is_ped_injured(Local_839.f_3[2]))
					{
						iLocal_965 = create_synchronized_scene(vLocal_996, vLocal_999, 2);
						task_synchronized_scene(Local_839.f_3[0], iLocal_965, "oddjobs@taxi@argument", "stand_off_biker_a", 1000f, -4f, 0, 0, 1000f, 0);
						task_synchronized_scene(Local_839.f_3[1], iLocal_965, "oddjobs@taxi@argument", "stand_off_biker_b", 1000f, -4f, 0, 0, 1000f, 0);
		...
		case 2:
			if (get_game_timer() - iLocal_951 > 2500 && !is_bit_set(iLocal_959, true))
			{
				func_213(&Local_409, 89, 1, 1, 0);
				set_bit(&iLocal_959, true);
			}
			if (((get_synchronized_scene_phase(iLocal_965) >= 0.838f && !is_ped_injured(Local_409.f_3)) && !is_ped_injured(Local_839.f_3[1])) && !is_bit_set(iLocal_959, 6))
			{
				...
				set_bit(&iLocal_959, 6);
			}
			if ((get_synchronized_scene_phase(iLocal_965) >= 0.853f && !is_ped_injured(Local_839.f_3[2])) && !is_bit_set(iLocal_959, 7))
			{
				give_weapon_to_ped(Local_839.f_3[2], joaat("weapon_pistol"), -1, true, true);
				set_bit(&iLocal_959, 7);
			}
			if (!is_bit_set(iLocal_959, 3))
			{
				if ((is_synchronized_scene_running(iLocal_961) && get_synchronized_scene_phase(iLocal_961) == 1f) || !is_synchronized_scene_running(iLocal_961))
				{
					if ((!is_ped_injured(Local_839.f_3[3]) && !is_ped_injured(iLocal_941[0])) && !is_ped_injured(iLocal_941[1]))
					{
						iLocal_962 = create_synchronized_scene(vLocal_990, vLocal_993, 2);
						task_synchronized_scene(Local_839.f_3[3], iLocal_962, "oddjobs@taxi@argument", "hooker_loop_b_biker_d", 1000f, -1000f, 0, 0, 1000f, 0);
						...
						set_bit(&iLocal_959, 3);
					}
				}
			}
			if (is_bit_set(iLocal_959, true))
			{
				Local_1021 = {func_144()};
				if (are_strings_equal(&cLocal_1009, &Local_1021) || are_strings_equal(&cLocal_1015, &Local_1021))
				{
					if ((!is_ped_injured(Local_839.f_3[3]) && !is_ped_injured(iLocal_941[0])) && !is_ped_injured(iLocal_941[1]))
					{
						if (is_synchronized_scene_running(iLocal_962))
						{
							iLocal_963 = create_synchronized_scene(vLocal_990, vLocal_993, 2);
							task_synchronized_scene(Local_839.f_3[3], iLocal_963, "oddjobs@taxi@argument", "hooker_outro_biker_d", 1000f, -1000f, 0, 0, 1000f, 0);
							task_synchronized_scene(iLocal_941[0], iLocal_963, "oddjobs@taxi@argument", "hooker_outro_hooker_a", 1000f, -1000f, 0, 0, 1000f, 0);
							task_synchronized_scene(iLocal_941[1], iLocal_963, "oddjobs@taxi@argument", "hooker_outro_hooker_b", 1000f, -1000f, 0, 0, 1000f, 0);
							_0x394B9CD12435C981(iLocal_963, true);
		...
		case 3:
			...
			{
				case 0:
					if ((get_game_timer() - iLocal_952 > 850 && !is_ped_injured(Local_839.f_3[3])) && !is_bit_set(iLocal_959, 8))
					{
						give_weapon_to_ped(Local_839.f_3[3], joaat("weapon_pistol"), -1, true, true);
						set_bit(&iLocal_959, 8);
					}
					...
					{
						set_ped_reset_flag(Local_839.f_3[0], 156, true);
						set_ped_reset_flag(Local_839.f_3[1], 156, true);
						set_ped_reset_flag(Local_839.f_3[2], 156, true);
						set_ped_reset_flag(Local_409.f_3, 156, true);
						if (((is_synchronized_scene_running(iLocal_965) && get_synchronized_scene_phase(iLocal_965) == 1f) || !is_synchronized_scene_running(iLocal_965)) || get_game_timer() - iLocal_953 > 27000)
						{
				...
				case 1:
					...
					{
						set_ped_reset_flag(Local_839.f_3[3], 156, true);
					}
					if (!is_bit_set(iLocal_959, 4))
					{
						if (!is_synchronized_scene_running(iLocal_963) || get_synchronized_scene_phase(iLocal_963) == 1f)
						{
							if (((!is_ped_injured(Local_839.f_3[3]) && !is_ped_injured(iLocal_941[0])) && !is_ped_injured(iLocal_941[1])) && !is_ped_injured(Local_409.f_3))
							{
								task_follow_nav_mesh_to_coord(iLocal_941[0], 299.3585f, -3204.905f, 4.7214f, 3f, 20000, 0.25f, 0, 1193033728);
								task_follow_nav_mesh_to_coord(iLocal_941[1], 299.3585f, -3204.905f, 4.7214f, 3f, 20000, 0.25f, 0, 1193033728);
					...
					else if ((iLocal_951 > 0 && get_game_timer() - iLocal_951 > 1500) && !is_bit_set(iLocal_959, 9))
					{
						func_143();
						...
						iLocal_951 = get_game_timer();
						iLocal_955 = 2;
						set_bit(&iLocal_959, 9);
					}
					else if (iLocal_951 > 0 && get_game_timer() - iLocal_951 > 1200)
					{
						if (func_140() && is_cam_active(Local_409))
						{
							if (!iLocal_977)
							{
				...
				case 2:
					if (get_game_timer() - iLocal_951 > 4000 && is_bit_set(iLocal_959, 9))
					{
						func_130(&(Local_409.f_244), Local_409.f_144, "txm12_deal1", "txm12_deal1_9", 9, 0, 0);
						iLocal_951 = get_game_timer();
						clear_bit(&iLocal_959, 9);
					}
					if ((((!is_ped_injured(Local_409.f_3) && !is_ped_injured(Local_839.f_3[0])) && !is_ped_injured(Local_839.f_3[2])) && !is_bit_set(iLocal_959, 9)) && get_game_timer() - iLocal_951 > 2000)
					{
				...
				case 8:
					if ((!is_ped_injured(Local_839.f_3[0]) && !is_ped_injured(Local_839.f_3[1])) && !is_ped_injured(Local_839.f_3[2]))
					{
						clear_relationship_between_groups(1, iLocal_923, Local_409.f_413);
...
void func_116(auto uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			set_ped_accuracy(*uParam0[iVar0], true);
		}
		iVar0++;
	}
}
...
int func_119(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	int iVar1;
...
bool func_120(auto uParam0, int iParam1, int iParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
int func_122(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_123(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_123(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_123(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_124()
{
	...
	{
		start_playback_recorded_vehicle_with_flags(Local_881.f_27[0], iLocal_954, func_125(0), 6, 1000, 786603);
		set_playback_speed(Local_881.f_27[0], 1f);
	}
	if (is_vehicle_driveable(Local_881.f_27[1], 0))
	{
		start_playback_recorded_vehicle_with_flags(Local_881.f_27[1], iLocal_954, func_125(1), 6, 1000, 786603);
...
void func_127()
{
	...
	Local_881.f_27[0] = create_vehicle(Local_881.f_32[0], func_129(1), func_128(1), 1, true);
	Local_881.f_27[1] = create_vehicle(Local_881.f_32[1], func_129(2), func_128(2), 1, true);
	Local_881.f_3[0] = PED::CREATE_PED_inside_vehicle(Local_881.f_27[0], 26, Local_881.f_19[0], -1, 1, true);
	Local_881.f_3[1] = PED::CREATE_PED_inside_vehicle(Local_881.f_27[0], 26, Local_881.f_19[0], false, 1, true);
	Local_881.f_3[2] = PED::CREATE_PED_inside_vehicle(Local_881.f_27[1], 26, Local_881.f_19[0], -1, 1, true);
	Local_881.f_3[3] = PED::CREATE_PED_inside_vehicle(Local_881.f_27[1], 26, Local_881.f_19[0], false, 1, true);
	...
	give_weapon_to_ped(Local_881.f_3[0], joaat("weapon_smg"), 100, false, true);
	give_weapon_to_ped(Local_881.f_3[1], joaat("weapon_pistol"), 100, false, true);
	give_weapon_to_ped(Local_881.f_3[2], joaat("weapon_smg"), 100, false, true);
	give_weapon_to_ped(Local_881.f_3[3], joaat("weapon_pistol"), 100, true, true);
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		...
		set_blocking_of_non_temporary_events(Local_881.f_3[iVar0], true);
...
int func_130(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_131(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_139(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_141(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_148()
{
	if (does_entity_exist(Local_409.f_3))
	{
		if (!is_ped_injured(Local_409.f_3))
		{
			...
			clear_sequence_task(&iLocal_934);
			open_sequence_task(&iLocal_934);
			task_leave_any_vehicle(false, false, 262144);
			task_follow_nav_mesh_to_coord(false, vLocal_1002, 1f, 30000, 0.25f, 0, 1193033728);
			task_achieve_heading(false, -30.3f, 0);
...
auto func_149(int iParam0, int iParam1)
{
	return func_155(get_player_ped(get_player_index()), iParam0, iParam1);
}
...
bool func_152(auto uParam0, int iParam1, float fParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
auto func_155(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_157(int iParam0, float fParam1, float fParam2, float fParam3)
{
	if ((((is_screen_faded_in() && !is_screen_fading_in()) && !is_screen_fading_out()) && !is_screen_faded_out()) && !*iParam0.f_142)
	{
		if (func_174(iParam0))
		{
			func_173(iParam0, iParam0.f_43);
			func_168(iParam0);
			func_167(iParam0);
			func_164(iParam0);
			func_163(iParam0, fParam2, fParam3);
			func_160(iParam0);
			return func_158(iParam0, fParam1);
		}
	}
	return 0;
}
...
void func_160(int iParam0)
{
	...
	if ((func_162(iParam0) && func_21(*iParam0.f_81, 67108864)) && get_player_wanted_level(player_id()) == 0)
	{
		if (get_game_timer() - iLocal_97 >= 10000)
		{
			fVar0 = func_161(*iParam0.f_17, 1);
			if (fVar0 > fLocal_95)
			{
				iLocal_96++;
			}
...
float func_161(Vector3 vParam0, int iParam1)
{
	return func_192(get_player_ped(get_player_index()), vParam0, iParam3);
}
...
bool func_162(int iParam0)
{
	if (is_vehicle_driveable(*iParam0.f_4, 0))
	{
		...
		{
			if (is_ped_in_vehicle(*iParam0.f_3, *iParam0.f_4, 1))
			{
				return true;
			}
		}
...
void func_163(int iParam0, float fParam1, float fParam2)
{
	if (func_162(iParam0) && func_21(*iParam0.f_44, 4))
	{
		if ((is_vehicle_stopped(*iParam0.f_4) || get_entity_speed(*iParam0.f_4) < 3f) && func_147(iParam0))
		{
			if (!func_288(iParam0, 2))
			{
				func_287(iParam0, 2);
			}
			else if (func_162(iParam0))
			{
				if (func_102(iParam0, 2) > fParam1 && !func_288(iParam0, 14))
				{
					if (func_34())
					{
						func_213(iParam0, 48, 1, 0, 0);
					}
					else
					{
						func_213(iParam0, 48, 1, 0, 0);
					}
					func_281(iParam0, 2, 0, 0);
					if (func_288(iParam0, 10))
					{
						func_281(iParam0, 10, 0, 0);
					}
				}
				if (!func_288(iParam0, 3))
				{
					func_281(iParam0, 3, 0, 0);
				}
				else if (func_102(iParam0, 3) >= fParam2)
				{
					func_101(iParam0, 3, 0);
					func_313(iParam0, "Car not moving", 20);
				}
			}
		}
		else
...
void func_165(int iParam0)
{
	...
	switch (*iParam0.f_418.f_4)
	{
		...
		case 1:
			...
			{
				if (func_102(iParam0, 20) > 3f)
				{
					func_213(iParam0, 87, 1, 0, 0);
					*iParam0.f_418.f_8 = 0;
					*iParam0.f_418.f_4++;
				}
			}
			else if (*iParam0.f_418 == *iParam0.f_418.f_1)
			{
				...
				{
					if (func_102(iParam0, 20) > 5f)
					{
						*iParam0.f_418.f_5 = 1;
						func_213(iParam0, 84, 1, 0, 0);
						*iParam0.f_418.f_4++;
					}
				}
			}
			else if (*iParam0.f_418 == *iParam0.f_418.f_2)
			{
				if (!func_21(*iParam0.f_82, 67108864))
				{
					if (func_102(iParam0, 20) > 5f)
					{
						*iParam0.f_418.f_6 = 1;
						*iParam0.f_418.f_8 = 0;
						func_213(iParam0, 85, 1, 0, 0);
						func_101(iParam0, 22, 0);
						*iParam0.f_418.f_4++;
					}
				}
			}
			...
			{
				if (func_102(iParam0, 20) > 8f)
				{
					func_213(iParam0, 86, 1, 0, 0);
					*iParam0.f_418.f_4++;
				}
			}
			break;
		...
		case 2:
			...
			{
				if (!func_288(iParam0, 22))
				{
					func_287(iParam0, 22);
				}
			}
			if (func_288(iParam0, 22) && func_102(iParam0, 22) > 15f)
			{
...
{
	if (is_player_pressing_horn(get_player_index()) && !func_21(*iParam0.f_44, 2))
	{
		func_156(iParam0.f_44, 2);
	}
	else if (!is_player_pressing_horn(get_player_index()) && func_21(*iParam0.f_44, 2))
	{
		func_113(iParam0.f_44, 2);
		*iParam0.f_47++;
		func_48(9, 0);
	}
	if (*iParam0.f_47 > 30)
	{
		func_213(iParam0, 47, 1, 0, 0);
		*iParam0.f_47 = 0;
		*iParam0.f_76 += ceil(5f);
	}
}
	...
	if (!func_21(*iParam0.f_44, 1))
	{
		switch (*iParam0.f_412)
		{
			case 0:
				...
				{
					if (func_102(iParam0, 9) > 1f)
					{
						func_172(iParam0, get_player_wanted_level(get_player_index()));
						if (*iParam0.f_410 != 22)
						{
							func_213(iParam0, 50, 1, 1, 0);
						}
						func_281(iParam0, 9, 0, 0);
			...
			case 1:
				if (!func_104() && func_102(iParam0, 9) > 4f)
				{
					func_213(iParam0, 52, 1, 0, 0);
					*iParam0.f_412 = 2;
				}
				break;
			...
			case 3:
				if (is_player_wanted_level_greater(get_player_index(), func_170(iParam0)))
				{
					func_172(iParam0, get_player_wanted_level(get_player_index()));
					func_48(6, 0);
				}
				if (!func_169(iParam0))
				{
					if (!is_scripted_conversation_ongoing())
					{
						if (func_102(iParam0, 16) > 10f)
						{
							if (*iParam0.f_410 != 22)
							{
								func_213(iParam0, 51, 1, 0, 0);
							}
						}
					}
				}
			...
			case 4:
				if (!func_104())
				{
					if (*iParam0.f_410 != 22)
					{
						func_213(iParam0, 53, 1, 0, 1);
					}
					func_48(7, func_170(iParam0));
					func_172(iParam0, 0);
					*iParam0.f_412 = 5;
				}
				break;
			...
			case 5:
				if (!func_104())
				{
					func_101(iParam0, 9, 0);
					func_281(iParam0, 11, 0, 0);
					*iParam0.f_412 = 0;
				}
				break;
			}
...
auto func_171(char* sParam0, int iParam1, char* sParam2)
{
...
void func_180(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_181(auto uParam0, int iParam1, int iParam2)
{
...
void func_188(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		*uParam0 = 0;
...
void func_194()
{
	...
	remove_vehicle_recording(iLocal_954, func_125(0));
	remove_vehicle_recording(iLocal_954, func_125(1));
...
void func_195()
{
	iLocal_935[0] = create_object(iLocal_930, 204.8445f, -3333.998f, 4.795367f, 1, true, false);
	set_entity_coords(iLocal_935[0], 204.8445f, -3333.998f, 4.795367f, 1, false, 0, 1);
	set_entity_rotation(iLocal_935[0], -0.036243f, -0.00124f, 91.56063f, 2, 1);
	iLocal_935[1] = create_object(iLocal_930, 212.67f, -3328.77f, 4.79f, 1, true, false);
	set_entity_coords(iLocal_935[1], 212.67f, -3328.77f, 4.79f, 1, false, 0, 1);
	set_entity_rotation(iLocal_935[1], -0.04f, -0.01f, 86.36f, 2, 1);
	iLocal_935[2] = create_object(iLocal_930, 204.8248f, -3328.631f, 4.7915f, 1, true, false);
	set_entity_coords(iLocal_935[2], 204.8248f, -3328.631f, 4.7915f, 1, false, 0, 1);
	set_entity_rotation(iLocal_935[2], -0.0027f, -0.0374f, 0.1414f, 2, 1);
	iLocal_940 = create_object(iLocal_931, 214.2505f, -3314.673f, 4.7883f, 1, true, false);
	set_entity_coords(iLocal_940, 214.2505f, -3314.673f, 4.7883f, 1, false, 0, 1);
	set_entity_rotation(iLocal_940, 0f, 0f, -17.399f, 2, 1);
	if (has_model_loaded(iLocal_932))
	{
		iLocal_939 = create_object(iLocal_932, 220.7266f, -3320.001f, 5.2749f, 1, true, false);
		set_entity_coords(iLocal_939, 220.7266f, -3320.001f, 5.2749f, 1, false, 0, 1);
		set_entity_rotation(iLocal_939, 0f, 0f, 0f, 2, 1);
	}
}

void func_196()
{
	if ((!is_ped_injured(iLocal_941[0]) && !is_ped_injured(iLocal_941[0])) && !is_ped_injured(Local_839.f_3[3]))
	{
		iLocal_960 = create_synchronized_scene(vLocal_990, vLocal_993, 2);
		set_synchronized_scene_looped(iLocal_960, true);
		task_synchronized_scene(Local_839.f_3[3], iLocal_960, sLocal_1008, "hooker_loop_a_biker_d", 1000f, -1000f, 64, 0, 1000f, 0);
		task_synchronized_scene(iLocal_941[0], iLocal_960, sLocal_1008, "hooker_loop_a_hooker_a", 1000f, -1000f, 64, 0, 1000f, 0);
		task_synchronized_scene(iLocal_941[1], iLocal_960, sLocal_1008, "hooker_loop_a_hooker_b", 1000f, -1000f, 64, 0, 1000f, 0);
	}
	if ((!is_ped_injured(Local_839.f_3[0]) && !is_ped_injured(Local_839.f_3[1])) && !is_ped_injured(Local_839.f_3[2]))
	{
		give_weapon_to_ped(Local_839.f_3[0], joaat("weapon_pistol"), -1, true, true);
		iLocal_964 = create_synchronized_scene(vLocal_996, vLocal_999, 2);
		set_synchronized_scene_looped(iLocal_964, true);
		task_synchronized_scene(Local_839.f_3[0], iLocal_964, "oddjobs@taxi@argument", "idle_a_biker_a", 1000f, -1000f, 0, 0, 1000f, 0);
		task_synchronized_scene(Local_839.f_3[1], iLocal_964, "oddjobs@taxi@argument", "idle_a_biker_b", 1000f, -1000f, 0, 0, 1000f, 0);
...
void func_197()
{
	...
	while (iVar0 <= 3)
	{
		...
		set_blocking_of_non_temporary_events(Local_839.f_3[iVar0], false);
		set_ped_accuracy(Local_839.f_3[iVar0], true);
		iVar0++;
	}
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_839.f_3[0], iLocal_923);
	...
	while (iVar0 <= 1)
	{
		...
		set_ped_seeing_range(iLocal_941[iVar0], 100f);
		set_ped_hearing_range(iLocal_941[iVar0], 100f);
		set_ped_id_range(iLocal_941[iVar0], 100f);
		set_blocking_of_non_temporary_events(iLocal_941[iVar0], true);
		iVar0++;
	}
	func_7(&(Local_409.f_244), 7, iLocal_941[1], "TaxiGangGirl2", 0, 1);
	func_7(&(Local_409.f_244), 8, iLocal_941[0], "TaxiGangGirl1", 0, 1);
	set_ambient_voice_name(iLocal_941[1], "TaxiGangGirl2");
	set_ambient_voice_name(iLocal_941[0], "TaxiGangGirl1");
}

void func_198()
{
	Local_839.f_3[0] = PED::CREATE_PED(26, Local_839.f_19[0], func_201(1), func_200(1), 1, true);
	Local_839.f_3[1] = PED::CREATE_PED(26, Local_839.f_19[0], func_199(2), 0f, 1, true);
	Local_839.f_3[2] = PED::CREATE_PED(26, Local_839.f_19[0], func_201(3), func_200(3), 1, true);
	Local_839.f_3[3] = PED::CREATE_PED(26, Local_839.f_19[0], func_201(4), func_200(4), 1, true);
	PED::SET_PED_CONFIG_FLAG(Local_839.f_3[1], 20, true);
	iLocal_941[0] = PED::CREATE_PED(26, Local_839.f_19[1], func_201(5), func_200(5), 1, true);
	...
	if (!is_entity_dead(Local_839.f_3[3], 0))
	{
		...
		set_ped_component_variation(Local_839.f_3[3], 4, false, 2, 0);
		set_ped_component_variation(Local_839.f_3[3], 10, true, false, 0);
	}
}
...
void func_203()
{
	Local_839.f_27[0] = create_vehicle(Local_839.f_32[0], func_205(1), func_204(1), 1, true);
	Local_839.f_27[1] = create_vehicle(Local_839.f_32[1], func_205(2), func_204(2), 1, true);
	Local_839.f_27[2] = create_vehicle(Local_839.f_32[3], func_205(3), func_204(3), 1, true);
	Local_839.f_27[3] = create_vehicle(Local_839.f_32[3], func_205(4), func_204(4), 1, true);
	iLocal_945 = create_vehicle(Local_839.f_32[2], func_205(5), func_204(5), 1, true);
...
bool func_206()
{
	...
	if (!has_vehicle_recording_been_loaded(iLocal_954, func_125(0)))
	{
		func_207("TAXI_ASSETS_STREAMING - Vehicle Recording Loading TXM12_S01_A...", &iLocal_950, 1000);
		return false;
	}
	if (!has_vehicle_recording_been_loaded(iLocal_954, func_125(1)))
	{
...
void func_208()
{
	...
	request_vehicle_recording(iLocal_954, func_125(0));
	request_vehicle_recording(iLocal_954, func_125(1));
...
bool func_217(int iParam0)
{
	if (is_vehicle_driveable(*iParam0.f_4, 0))
	{
		if (!is_ped_injured(*iParam0.f_3))
		{
			if ((is_ped_getting_into_a_vehicle(*iParam0.f_3) && get_game_timer() - iLocal_89 > 500) || is_ped_in_vehicle(*iParam0.f_3, *iParam0.f_4, 1))
			{
				return true;
			}
		}
...
bool func_218(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(*iParam0.f_4, 0))
	{
		if (!is_ped_in_vehicle(*iParam0.f_2, *iParam0.f_4, 0))
		{
			...
			if (get_script_task_status(*iParam0.f_3, 2106541073) == 1 || get_script_task_status(*iParam0.f_3, 2106541073) == 0)
			{
				...
				*iParam0.f_48 = 0;
				iLocal_87 = 0;
				task_turn_ped_to_face_entity(*iParam0.f_3, player_ped_id(), false);
			}
		}
		else if (is_player_wanted_level_greater(get_player_index(), 0))
		{
			...
			if (*iParam0.f_48 > 1)
			{
				...
				task_follow_nav_mesh_to_coord(false, *iParam0.f_11, *iParam0.f_6, 20000, 0.25f, 0, 1193033728);
				task_turn_ped_to_face_entity(false, *iParam0.f_4, false);
		...
		{
			if (func_288(iParam0, 14))
			{
				func_185(iParam0);
				func_176(iParam0, 0);
			}
			if (func_288(iParam0, 9))
			{
				func_101(iParam0, 9, 0);
				clear_prints();
			...
			if (!is_entity_dead(*iParam0.f_3, 0))
			{
				...
				{
					func_313(iParam0, "Left Passenger", 8);
				}
				switch (*iParam0.f_48)
				{
					case 0:
						if (get_script_task_status(*iParam0.f_3, 242628503) != 1 || ((func_155(player_ped_id(), *iParam0.f_3, 1) < 20f && func_9(*iParam0.f_3, *iParam0.f_11, 1) <= 28f) && func_9(*iParam0.f_4, *iParam0.f_11, 1) <= 28f))
						{
					...
					case 1:
						if (func_238(iParam0, 0, 28f, fVar4, 4f))
						{
							*iParam0.f_138 = 1;
							if (iLocal_94)
							{
					...
					case 2:
						if (iLocal_94)
						{
							if (func_155(*iParam0.f_4, *iParam0.f_3, 1) < 3f)
							{
						...
						func_232(iParam0);
						if (func_242(iParam0, *iParam0.f_3) < fVar4 || func_32())
						{
							if (is_ped_in_vehicle(*iParam0.f_2, *iParam0.f_4, 0))
							{
								if (func_220(iParam0))
								{
									...
									func_101(iParam0, 5, 0);
									clear_gps_flags();
									stat_get_float(*iParam0.f_428, iParam0.f_42, -1);
									set_ped_can_play_ambient_base_anims(*iParam0.f_3, 0);
									return true;
								}
							}
						}
...
bool func_220(int iParam0)
{
	...
	{
		case 0:
			if (func_152(iParam0, 0, 1084227584) && func_159(1, 1, 1))
			{
				if (func_235(iParam0, 1))
				{
		...
		case 2:
			...
			iVar12 = func_228(iParam0.f_409, get_offset_from_entity_in_world_coords(*iParam0.f_4, 0f, 2.2f, 0.275f), get_offset_from_entity_in_world_coords(*iParam0.f_4, vVar0), 1);
			if (iVar12 == 1)
			{
				vVar0.z += 1.5f;
				if (*iParam0.f_7 == 2)
			...
			if (iVar12 != -1)
			{
				...
				vVar13 = {get_offset_from_entity_in_world_coords(*iParam0.f_4, vVar6)};
				set_entity_coords(*iParam0.f_3, vVar13, 1, false, 0, 1);
				set_entity_heading(*iParam0.f_3, func_225(iParam0));
				func_224(iParam0, 1f, 1f, 1f, 0f, 0f, 0f, 1112014848);
				set_cam_coord(*iParam0, get_offset_from_entity_in_world_coords(*iParam0.f_4, vVar0));
				point_cam_at_entity(*iParam0, *iParam0.f_4, vVar3, 1);
				set_cam_active(*iParam0, true);
				render_script_cams(true, false, 3000, 1, 0, 0);
				_0x2208438012482A1A(*iParam0.f_3, 0, 0);
		...
		case 5:
			func_207("TAXI_PED_ENTER_CUT_WAIT", iParam0.f_78, 1000);
			if (timera() > 3500)
			{
				iLocal_86 = 9;
			}
		...
		case 7:
			if (!is_entity_dead(*iParam0.f_3, 0) && !is_entity_dead(*iParam0.f_4, 0))
			{
				if (!is_ped_in_any_vehicle(*iParam0.f_3, 0))
				{
					...
					set_vehicle_door_shut(*iParam0.f_4, func_223(*iParam0.f_7), 1);
				}
				render_script_cams(false, false, 3000, 1, 0, 0);
				destroy_cam(*iParam0, 0);
				destroy_cam(*iParam0.f_1, 0);
...
void func_224(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*iParam0))
	{
		*iParam0 = create_camera_with_params(26379945, vParam1, vParam4, fParam7, 0, 2);
	}
}

float func_225(auto uParam0)
{
	float fVar0;
	Vector3 vVar1;
...
float func_226(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
...
int func_228(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3)
{
	auto uVar0;
	auto uVar3;
	int iVar6;
...
bool func_233(auto uParam0)
{
	if ((get_entity_speed(*uParam0.f_4) > 3f && func_102(uParam0, 5) > 15f) || is_entity_upsidedown(*uParam0.f_4))
	{
		return true;
	}
	return false;
...
bool func_235(auto uParam0, int iParam1)
{
	int[] iVar0 = new int[3];
	int iVar4;
...
int func_236(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_239(auto uParam0, float fParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_155(*uParam0.f_4, *uParam0.f_3, 0) <= fParam1 && !*uParam0.f_142) && absf(vVar0.z - vVar3.z) < 5f)
			{
				if (*uParam0.f_409 == 0)
				{
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_241(iParam3), 0);
}
...
bool func_245(auto uParam0, int iParam1)
{
	...
	if (!func_248(uParam0, iParam1))
	{
		...
		if ((is_ped_injured(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_149(*uParam0.f_3, 1) > 400f)
		{
...
{
	Local_343 = 0;
	func_268(43608/*func_270*/, 43583/*func_269*/, 1);
	func_268(43344/*func_266*/, 43321/*func_265*/, 1);
	func_268(43259/*func_264*/, 43234/*func_263*/, 1);
	func_268(43162/*func_262*/, 43138/*func_261*/, 1);
	func_268(43028/*func_260*/, 43007/*func_259*/, 1);
	func_268(42954/*func_257*/, 42929/*func_256*/, 1);
	func_268(42787/*func_253*/, 42764/*func_252*/, 1);
}

bool func_252(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Taxi Not Driveable", 1);
	return true;
}
...
bool func_256(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Didn't lose police in time.", 9);
	return true;
}
...
bool func_259(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_254(uParam0, 11);
	return true;
...
bool func_260(int iParam0)
{
	if (does_entity_exist(*iParam0.f_4))
	{
		...
		{
			if (!func_288(iParam0, 25))
			{
				func_281(iParam0, 25, 0, 0);
			}
			else if (func_102(iParam0, 25) > 2f)
			{
				return true;
			}
		}
		else if (func_288(iParam0, 25))
		{
			func_101(iParam0, 25, 0);
		}
	}
	return false;
}

bool func_261(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Taxi Is Flipped", 0);
	return true;
}
...
bool func_263(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Stayed stopped for too long.", 9);
	return true;
}
...
bool func_265(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Taxi Not Driveable", 0);
	return true;
}
...
bool func_269(int iParam0, auto uParam1)
{
	uParam1 = uParam1;
	func_313(iParam0, "Passenger injured.", 15);
	return true;
}

bool func_270(auto uParam0)
{
	if (does_entity_exist(*uParam0.f_3))
	{
...
void func_271(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_272(auto uParam0, char* sParam1, int iParam2)
{
	*uParam0 = 0;
	*uParam0.f_1 = iParam2;
	*uParam0.f_2 = sParam1;
...
bool func_274()
{
	...
	if (!has_scaleform_movie_loaded(iLocal_1112))
	{
		return false;
	}
...
{
	return func_122(iParam0, !iParam1, iParam2);
}

bool func_279(auto uParam0, Vector3 vParam1, Vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!does_entity_exist(*uParam0.f_3))
	{
...
void func_280(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_51[0] = _0x2CE544C68FB812A0(vParam1, 20f, 5f, 0);
}

void func_281(int iParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
...
void func_289(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_411 == 0)
	{
		if (get_player_wanted_level(player_id()) == 0)
...
bool func_293(auto uParam0)
{
	...
	if ((((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_15(&(Local_190[0 /*10*/].f_3))) && !func_15(&(Local_190[1 /*10*/].f_3))) && !func_15(&(Local_190[5 /*10*/].f_3))) && !func_15(&(Local_190[9 /*10*/].f_3))) && !func_15(&(Local_190[7 /*10*/].f_3))) && !func_15(&(Local_190[8 /*10*/].f_3)))
	{
		...
		if (absf(vVar0.x) > 2.5f && !func_15(&(Local_190[0 /*10*/].f_3)))
		{
			...
			else if (func_93(&(Local_190[11 /*10*/].f_3)) < 1.5f && absf(fLocal_342) - absf(vVar0.x) < 0f)
			{
...
bool func_294(auto uParam0)
{
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_15(&(Local_190[0 /*10*/].f_3))) && !func_15(&(Local_190[8 /*10*/].f_3))) && !func_15(&(Local_190[5 /*10*/].f_3))) && !func_15(&(Local_190[9 /*10*/].f_3))) && !func_15(&(Local_190[7 /*10*/].f_3)))
	{
		...
		else if ((func_93(&(Local_190[14 /*10*/].f_3)) < 1.5f && func_155(*uParam0.f_5, *uParam0.f_4, 1) > 4.5f) && !has_entity_been_damaged_by_any_vehicle(*uParam0.f_5))
		{
...
void func_309(int iParam0, auto uParam1)
{
...
void func_310(auto uParam0, auto uParam1)
{
	*uParam0.f_76 += Local_190[uParam1 /*10*/];
}

void func_311(auto uParam0, int iParam1)
{
...
void func_313(int iParam0, char* sParam1, int iParam2)
{
	...
	func_418(2);
	Var0 = {func_144()};
	if ((!is_string_null_or_empty(&Var0) && func_104()) && !are_strings_equal(&Var0, "NULL"))
	{
	}
	else
	{
		...
		*iParam0.f_415 = iParam2;
		...
		if (iParam2 == 8 || iParam2 == 18)
		{
			...
			{
				func_240(*iParam0.f_3, "TAXI_FAIL", *iParam0.f_145, 4);
			}
		...
		else if (iParam2 == 14)
		{
			...
			{
				func_240(*iParam0.f_3, "CALL_COPS_COMMIT", *iParam0.f_145, 4);
			}
			set_player_wanted_level(player_id(), true, 0);
		...
		else if (iParam2 == 11)
		{
			...
			{
				func_240(*iParam0.f_3, "GENERIC_INSULT_MED", *iParam0.f_145, 4);
			}
			func_316(iParam0, 0, 0);
			func_319(iParam0, &Var0);
		...
		else if (iParam2 == 19)
		{
			...
			func_315(&Var0);
			func_314(iParam0.f_244, "OJTXAUD", &Var0, 7, 0, 0, 0);
		...
		func_281(iParam0, 3, 0f, 1);
	}
}

int func_314(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_316(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_319(auto uParam0, char* sParam1)
{
	if (func_320(uParam0))
	{
...
bool func_320(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_155(player_ped_id(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
...
void func_322()
{
		...
		switch (Local_1034.f_27)
		{
			case 0:
				if (Local_409.f_410 == 9)
				{
					...
					{
						if (func_351("TX_OBJ_GYB_DO") || does_blip_exist(Local_409.f_9))
						{
							Local_1034.f_27++;
						}
			...
			case 3:
				if (func_102(&Local_409, 18) > get_random_float_in_range(2f, 7f))
				{
	...
	func_323(&Local_409, &uLocal_1064, &Local_1034, iLocal_1033);
}

bool func_323(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	...
	if (!*uParam0.f_109)
	{
		switch (*uParam2)
		{
			...
			case 2:
				...
				{
					func_151(uParam2.f_26, round(pow(2f, to_float(*uParam2.f_27))));
					*uParam2.f_27++;
					func_326(uParam1);
...
int func_324(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_139(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
struct<6> func_328(auto uParam0)
{
	int iVar0;
	struct<6> Var1;
...
void func_331(auto uParam0, auto uParam1)
{
	struct<6> Var0;
	struct<6> Var6;
	int iVar12;
	...
	else if (func_288(uParam0, 14))
	{
		...
		switch (func_350(uParam0))
		{
			case 55:
				...
				Var6 = {Var0};
				func_348(uParam0.f_93, 3, &Var6, 0, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
		...
		switch (func_350(uParam0))
		{
			...
			case 4:
				...
				if (!func_21(*uParam0.f_44, 128))
				{
					...
					{
						func_348(uParam0.f_99, 4, &Var6, 0, 1, 0);
						func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					}
					else
					{
			...
			case 72:
				...
				else if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_348(uParam0.f_95, 5, &Var6, 1, 0, 1);
					func_314(uParam0.f_244, *uParam0.f_144, &Var6, 8, 0, 0, 0);
				}
				else
				{
					...
					if (*uParam0.f_411 == 0)
					{
						func_348(uParam0.f_95, 8, &Var6, 1, 1, 0);
					}
					else
					{
						func_348(uParam0.f_95, 5, &Var6, 1, 1, 0);
					}
					func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
				func_347(2, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
				break;
			...
			case 79:
				...
				{
					func_341(uParam0, 4096, Var0, "_sideW1", iVar24, 8);
				}
				else if (!func_21(*uParam0.f_81, 8192))
				{
					func_341(uParam0, 8192, Var0, "_sideW2", iVar24, 8);
				}
			...
			case 80:
				...
				{
					func_341(uParam0, 16384, Var0, "_opLne1", iVar24, 8);
				}
				else if (!func_21(*uParam0.f_81, 32768))
				{
					func_341(uParam0, 32768, Var0, "_opLne2", iVar24, 8);
				}
			...
			case 83:
				...
				if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_348(uParam0.f_93, 6, &Var6, 0, 1, 0);
					func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_347(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
					func_281(uParam0, 16, 0, 0);
					func_244(uParam0, 0, 0);
			...
			case 92:
				...
				Var6 = {Var0};
				func_348(uParam0.f_96, 2, &Var6, 0, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_347(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
			...
			case 93:
				...
				Var6 = {Var0};
				func_348(uParam0.f_97, 2, &Var6, 0, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_347(12, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
					...
					if (!*uParam0.f_109 && !func_104())
					{
						switch (*uParam0.f_414)
						{
							...
							case 8:
								StringConCat(&Var0, "_good1", 24);
								Var6 = {Var0};
								func_348(uParam0.f_93, 6, &Var6, 1, 1, 0);
								func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
								func_347(23, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
								func_281(uParam0, 16, 0, 0);
								func_244(uParam0, 0, 0);
								break;
			...
			case 78:
				...
				Var6 = {Var0};
				func_348(uParam0.f_87, 6, &Var6, 1, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 48:
				...
				Var6 = {Var0};
				func_348(uParam0.f_86, 4, &Var6, 0, 1, 0);
				if (*uParam0.f_411 != 9)
				{
					func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 67:
				...
				Var6 = {Var0};
				func_348(uParam0.f_88, 4, &Var6, 0, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_347(16, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var6, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
				break;
			...
			case 51:
				...
				else
				{
					StringConCat(&Var0, "_copBa1", 24);
					Var6 = {Var0};
					func_348(uParam0.f_85, 6, &Var6, 1, 1, 0);
					func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_281(uParam0, 16, 0, 0);
					func_244(uParam0, 0, 0);
				}
			...
			case 58:
				if (*uParam0.f_411 == 6)
				{
					...
					Var6 = {Var0};
					func_348(uParam0.f_93, 6, &Var6, 1, 1, 1);
					func_215(&Var0);
					func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 115:
				...
				Var6 = {Var0};
				func_348(uParam0.f_91, 5, &Var6, 1, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
				break;
			...
			case 116:
				...
				Var6 = {Var0};
				func_348(uParam0.f_92, 5, &Var6, 1, 1, 0);
				func_130(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_281(uParam0, 16, 0, 0);
				func_244(uParam0, 0, 0);
				break;
...
void func_332(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
...
void func_333(auto uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
	...
	func_130(uParam0.f_244, *uParam0.f_144, &Param1, &Var0, iParam7, 0, 0);
	func_281(uParam0, 16, 0, 0);
}

void func_334(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_156(uParam0.f_82, iParam1);
	func_281(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
void func_336(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_337(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_338(char[24] cParam0, auto uParam1)
{
	int iVar0;
...
void func_341(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_156(uParam0.f_81, iParam1);
	func_281(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
int func_342(Vector3 vParam0, int iParam1)
{
	int iVar0;
...
void func_343(auto uParam0, char[24] cParam1, char* sParam2)
{
	func_281(uParam0, 16, 0, 0);
	func_281(uParam0, 17, 0f, 1);
	...
	if (!is_ped_injured(*uParam0.f_3))
	{
		interrupt_conversation(*uParam0.f_3, &cParam1, func_344(uParam0));
	}
}

char* func_344(auto uParam0)
{
	char* sVar0;
...
char* func_345(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 72:
...
int func_346(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	func_281(uParam0, 16, 0, 0);
	if (iParam3)
	{
...
void func_347(int iParam0, auto uParam1, auto uParam2, auto uParam3, char[24] cParam4, int iParam5)
{
	if (iParam0 == 0)
	{
...
void func_348(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
int func_353(auto uParam0, auto uParam1)
{
...
void func_356(auto uParam0, auto uParam1, int iParam2)
{
	if (!func_21(*uParam0.f_55, 1))
	{
		...
		{
			case 0:
				if (!is_string_null_or_empty(uParam0.f_124) && func_104())
				{
					*uParam1++;
				}
				break;
...
bool func_358(int iParam0, auto uParam1)
{
	...
	{
		if (func_385(*iParam0.f_3, *iParam0.f_4, uParam1, &uVar0, 0, 1, 0, 1, 1))
		{
			func_281(iParam0, 27, 0, 0);
			func_281(iParam0, 10, 0, 0);
			func_383(iParam0, &uVar0, uParam1);
		}
		func_380(iParam0);
	}
	...
	if ((((!is_player_control_on(player_id()) && (does_cam_exist(*iParam0) && !is_cam_active(*iParam0))) && (does_cam_exist(*iParam0.f_1) && !is_cam_active(*iParam0.f_1))) && !is_message_being_displayed()) && !func_104())
	{
...
void func_359(auto uParam0)
{
	if (!func_379(*uParam0.f_429))
	{
		*uParam0.f_429 = func_378();
		func_369(uParam0.f_429, 0, 0, get_random_int_in_range(4, 7), 0, 0, 0);
	}
...
auto func_367(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_368(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_369(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_370(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_375(auto uParam0, int iParam1)
{
...
auto func_378()
{
	...
	func_376(&uVar0, get_clock_seconds());
	func_375(&uVar0, get_clock_minutes());
	func_374(&uVar0, get_clock_hours());
	func_372(&uVar0, get_clock_day_of_month());
	func_373(&uVar0, get_clock_month());
...
void func_383(auto uParam0, auto uParam1, auto uParam2)
{
	switch (*uParam1)
	{
		case 1:
...
bool func_384(auto uParam0, int iParam1, int iParam2)
{
...
bool func_385(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!is_entity_dead(iVar0, 0) && !is_entity_dead(iParam0, 0))
	{
		...
		if (!func_21(*uParam2, 4))
		{
			if (func_389(iVar0, iParam0, uParam2, iParam5))
			{
				*uParam3 = 4;
				return true;
			}
		...
		if (iParam4)
		{
			if (func_386(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_386(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_386(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (func_387(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
...
bool func_389(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
		...
		if (is_vehicle_driveable(iParam0, 0))
		{
			if (get_ped_in_vehicle_seat(iParam0, -1) != 0)
			{
				if (get_current_ped_weapon(player_ped_id(), &iVar0, 1))
				{
					...
					{
						if (func_155(player_ped_id(), iParam0, 1) < 40f)
						{
...
void func_392()
{
	...
	Var7 = {func_144()};
	if ((((iLocal_933 < 4 && func_149(Local_409.f_3, 1) < 50f) && Local_409.f_410 == 22) && is_ped_in_any_vehicle(player_ped_id(), 0)) && !iLocal_976)
	{
	...
	if ((((iLocal_933 < 4 && func_149(Local_409.f_3, 1) < 50f) && Local_409.f_410 == 22) && is_ped_in_any_vehicle(player_ped_id(), 0)) && !iLocal_976)
	{
		if (iLocal_967)
		{
			...
			if (is_control_just_pressed(0, 80) && get_game_timer() - iLocal_1124 > 500)
			{
				if (does_cam_exist(Local_409))
				{
					set_cam_active(Local_409, false);
					render_script_cams(false, false, 3000, 1, 0, 0);
				}
			}
		}
	...
	else if (iLocal_967)
	{
		...
		if (iLocal_976)
		{
			...
			else if (func_93(&iLocal_1030) > 0.3f)
			{
				if (does_cam_exist(Local_409))
				{
					if (is_cam_active(Local_409))
...
void func_393(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	if (!does_cam_exist(Local_409))
	{
...
void func_395()
{
	...
	if (iLocal_968)
	{
		if (func_9(player_ped_id(), Local_409.f_17, 1) > 50f || func_119(&(Local_839.f_3), &(Local_839.f_11), &(Local_881.f_3), &(Local_881.f_11)))
		{
			func_416();
		}
	}
...
bool func_397(auto uParam0, int iParam1)
{
	if (iParam1)
	{
		return true;
...
void func_400()
{
	...
	add_relationship_group("TAXI_Pursuers", &iLocal_923);
	func_415(1);
...
void func_403(auto uParam0, int iParam1, int iParam2)
{
...
void func_407(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
void func_408(auto uParam0)
{
	...
	switch (*uParam0.f_411)
	{
		...
		case 9:
			func_412(uParam0, get_random_int_in_range(false, 17));
			iVar0 = func_410(*uParam0.f_418.f_2 + get_random_int_in_range(true, 17), 0, 16);
...
void func_416()
{
	...
	set_all_vehicle_generators_active_in_area(vLocal_984, vLocal_987, true, 1);
	clear_ped_non_creation_area();
	remove_scenario_blocking_area(iLocal_947, 0);
	set_vehicle_as_no_longer_needed(&iLocal_945);
	func_417();
	func_194();
	if (does_cam_exist(Local_409))
	{
