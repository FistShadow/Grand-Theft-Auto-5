...
void func_77(struct<2> Param0, Vector3 fParam1, struct<2> Param2, var uParam3, float fParam4, float fParam5, int iParam6)
{
	if (!iLocal_318)
	{
		if (Param3 <= Param0)
...
int func_81(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_19(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
int func_124(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
void func_132(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	*uParam0.f_4 = iParam5;
	*uParam0 = sParam1;
	*uParam0.f_1 = {Param2};
...
bool func_159(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, float fParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	int iVar2;
