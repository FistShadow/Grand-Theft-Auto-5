...
void func_3()
{
	...
	{
		if (!is_bit_set(Local_818.f_2, 2))
		{
			Local_818.f_1 = get_network_time();
			set_bit(&(Local_818.f_2), 2);
		}
	}
	switch (Local_818.f_8)
	{
		...
		case 1:
			if (func_1(&(Local_818.f_667), Global_262145.f_9065, 0) || is_bit_set(Local_818.f_2, 2))
			{
				func_23(2);
			}
			func_24();
		...
		case 2:
			Local_818.f_9 = get_network_time();
			func_23(3);
			break;
		
		case 3:
			if ((func_22() || func_1(&(Local_818.f_661), Global_262145.f_9064, 0)) || is_bit_set(Local_818.f_2, 2))
			{
				if (!is_bit_set(Local_818.f_2, true) && func_21())
				{
					func_20(&(Local_818.f_661), 0, 0);
					set_bit(&(Local_818.f_2), true);
				}
				else
				{
					func_23(4);
...
bool func_4()
{
	...
	while (iVar0 < 10)
	{
		if (network_does_entity_exist_with_network_id(Local_818.f_729[iVar0 /*2*/].f_1) && !is_entity_dead(net_to_ent(Local_818.f_729[iVar0 /*2*/].f_1), 0))
		{
			return false;
		}
		iVar0++;
...
bool func_5()
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (!func_6(iVar1))
			{
				if ((!is_bit_set(Local_3612[iVar0 /*5*/].f_2, false) || Local_3612[iVar0 /*5*/].f_3 != 6) || (is_bit_set(Local_818.f_2, false) && !is_bit_set(Local_3612[iVar0 /*5*/].f_2, true)))
				{
					return false;
				}
			}
...
void func_15(int iParam0)
{
	...
	if (Global_2460486.f_4574.f_38[iVar0] >= 0)
	{
		...
		if (!is_bit_set(Local_818.f_3[func_17(iVar4)], func_16(iVar4)))
		{
			if (is_bit_set(Global_2460486.f_4574[func_17(iVar4)], func_16(iVar4)))
			{
				if (func_1(&uLocal_386, 750, 0))
				{
					if (iVar1 != 0)
					{
						if (iVar1 < iVar2 || iVar2 == 0)
						{
							...
							set_bit(&(Local_818.f_3[func_17(iVar4)]), func_16(iVar4));
							Local_818.f_708--;
						}
					}
				}
...
void func_19(int iParam0)
{
	...
	if (is_bit_set(Local_818.f_673, iParam0))
	{
		iVar0 = 0;
		while (iVar0 < 32)
		{
		...
		clear_bit(&(Local_818.f_673), iParam0);
	}
}
		...
		if (func_31(Var0))
		{
			if (!network_does_network_id_exist(Var0.f_1))
			{
				if (func_30(iLocal_99, &vVar2, &fVar5))
				{
					...
					if (is_bit_set(Local_3612[Local_818.f_713[iLocal_99] /*5*/].f_1, iLocal_99))
					{
...
bool func_26(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
bool func_30(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		case 0:
...
{
	if ((!is_bit_set(Global_1573883.f_1, 2) && !func_7(player_id())) && !func_6(player_id()))
	{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_57(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_56(1);
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_66(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_57(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_56(1);
			}
...
bool func_92(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		case 0:
	...
	if (func_32())
	{
		...
		while (iVar0 < 10)
		{
			if (Local_818.f_713[iVar0] == participant_id_to_int())
			{
				if (func_96(iVar0))
				{
					if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_1, iVar0))
					{
						set_bit(&(Local_3612[participant_id_to_int() /*5*/].f_1), iVar0);
					}
				}
				else if (is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_1, iVar0))
				{
					clear_bit(&(Local_3612[participant_id_to_int() /*5*/].f_1), iVar0);
				}
			}
			else if (is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_1, iVar0))
			{
	...
	if (iParam4 && !iParam7)
	{
		if (func_13(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_29(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_99(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (get_distance_between_coords(func_29(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
...
bool func_100(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_13(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_99(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (get_distance_between_coords(func_29(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
		...
		if (func_374())
		{
			...
			switch (Local_3612[participant_id_to_int() /*5*/].f_3)
			{
				...
				case 4:
					...
					func_142();
					func_238();
					if (func_130(&uLocal_784, !is_bit_set(Local_818.f_2, 2)) || is_bit_set(Local_818.f_2, 2))
					{
						if (func_32())
						{
							func_372(5);
...
void func_107()
{
	if (Local_818.f_8 == 5)
	{
		if (func_36(&(Local_818.f_669)))
		{
			...
			{
				if (!is_entity_dead(net_to_veh(Local_818.f_729[iLocal_383 /*2*/].f_1), 0))
				{
					if (!is_bit_set(iLocal_802, iLocal_383))
					{
						set_bit(&iLocal_802, iLocal_383);
						iLocal_803[iLocal_383] = get_sound_id();
					...
					{
						if (is_ped_in_vehicle(player_ped_id(), net_to_veh(Local_818.f_729[iLocal_383 /*2*/].f_1), 0))
						{
							func_368(3);
							iLocal_814 = 1;
						}
				...
				else if (is_bit_set(iLocal_802, iLocal_383) && !has_sound_finished(iLocal_803[iLocal_383]))
				{
...
void func_112()
{
	...
	if (((func_13(player_id(), 1, 1) && !func_6(player_id())) && !func_399(player_id())) && func_374())
	{
		if (Local_3612[participant_id_to_int() /*5*/].f_3 == 1)
		{
			...
			if (func_32() && !is_ped_in_flying_vehicle(player_ped_id()))
			{
...
void func_132()
{
	...
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_13(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out())
		{
...
void func_144()
{
	...
	if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_2, false) && (func_154() || is_bit_set(Local_818.f_2, 2)))
	{
		if (func_48(func_153()))
		{
			func_152();
		...
		if (!is_bit_set(Local_818.f_2, 2))
		{
			if (func_265(0))
			{
				if (func_264(0))
				{
					if (!is_bit_set(Local_818.f_2, false))
					{
						sVar0 = "CPC_END";
					}
					else
				...
				else
				{
					...
					if (network_is_participant_active(iVar1))
					{
						...
						{
							if (is_bit_set(Local_818.f_2, false) && Local_3612[participant_id_to_int() /*5*/].f_4 >= Global_262145.f_9225)
							{
								sVar0 = "CPC_LOSEBONUS";
							}
							else
		...
		set_bit(&(Local_3612[participant_id_to_int() /*5*/].f_2), false);
		func_145(132);
	}
}
...
void func_155()
{
	...
	if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_2, true))
	{
		if (func_6(player_id()))
		{
			set_bit(&(Local_3612[participant_id_to_int() /*5*/].f_2), true);
			return;
		}
		...
		func_203();
		func_156(0, player_ped_id(), "", -1636175450, -1253457806, iVar1, 1, -1, 0, 0);
...
void func_158(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_160(player_ped_id()))
	{
		func_159(1);
	}
...
Vector3 func_161(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_162(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_166(vector3 vParam0, var uParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
var func_167(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
void func_205(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_206(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_213(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
{
	return func_268(player_ped_id(), Local_818.f_10[uParam0 /*5*/], 1) < 500f;
}
...
{
	return func_268(player_ped_id(), Local_818.f_10[uParam0 /*5*/], 1) < 750f;
}
...
void func_271(struct<4> Param0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (Param0.f_3 == participant_id_to_int() && !is_bit_set(uLocal_371[func_17(iParam5)], func_16(iParam5)))
	{
		...
		func_203();
		func_156(0, player_ped_id(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
		iLocal_381 += iVar0;
		Global_2445403 = iVar0;
		Local_3600.f_7 += iVar1;
		set_bit(&(uLocal_371[func_17(iParam5)]), func_16(iParam5));
...
void func_272()
{
	if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_2, 2))
	{
		set_bit(&(Local_3612[participant_id_to_int() /*5*/].f_2), 2);
		func_273(1);
	}
}
...
void func_273(int iParam0)
{
	...
	if (iParam0)
	{
		...
		{
			uVar0 = func_191(2458, -1, 0);
			clear_bit(&uVar0, func_396(func_252(player_id())));
			func_275();
		}
		if (func_274())
		{
...
void func_290(vector3 vParam0, var uParam1, var uParam2, int iParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
	
	if (!is_bit_set(Local_818.f_3[func_17(iParam5)], func_16(iParam5)))
	{
		if (!is_bit_set(uLocal_366[func_17(iParam5)], func_16(iParam5)))
		{
			...
			if (is_entity_at_coord(player_ped_id(), vParam0 + Vector(fVar2, 0f, 0f), fVar1, fVar1, fVar0, false, true, 0))
			{
				if (func_291())
				{
					iLocal_365 = get_time_difference(get_network_time(), Local_818.f_9);
					if (network_get_host_of_this_script() != func_259() && network_is_participant_active(network_get_host_of_this_script()))
					{
					...
					set_bit(&(uLocal_366[func_17(iParam5)]), func_16(iParam5));
				}
			}
		}
...
void func_295(int iParam0, vector3 vParam1, var uParam2, var uParam3, int iParam4)
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
	...
	if (!is_bit_set(uLocal_366[func_17(iParam6)], func_16(iParam6)) && !is_bit_set(Local_818.f_3[func_17(iParam6)], func_16(iParam6)))
	{
		...
		{
			if (!is_bit_set(iLocal_376[func_17(iParam6)], func_16(iParam6)))
			{
				iVar7 = 52;
				if (func_32())
				{
				...
				set_bit(&(iLocal_376[func_17(iParam6)]), func_16(iParam6));
			}
			else
			{
		...
		else if (is_bit_set(iLocal_376[func_17(iParam6)], func_16(iParam6)))
		{
			if (func_297(iParam0.f_1, iParam0.f_2))
			{
				delete_checkpoint(*iParam0.f_1);
				clear_bit(&(iLocal_376[func_17(iParam6)]), func_16(iParam6));
			}
		}
	}
	else if (is_bit_set(iLocal_376[func_17(iParam6)], func_16(iParam6)))
...
void func_296(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (*uParam0 != 0)
	{
		*uParam1 -= 25;
		...
		else
		{
			...
			*uParam0 = 0;
			clear_bit(&(iLocal_376[func_17(iParam3)]), func_16(iParam3));
		}
	}
}
...
bool func_310()
{
	if (func_262(player_id()))
	{
		...
		{
			set_bit(&iLocal_100, 2);
			return true;
		}
	}
	else if (is_bit_set(iLocal_100, 2))
	{
		clear_bit(&iLocal_100, 2);
		return true;
	}
	return false;
}
...
void func_312(vector3 vParam0, var uParam1, int iParam2, var uParam3)
{
	func_313(vParam0, 0f, 0f, 0f, uParam3, 0, iParam4, uParam5);
}

void func_313(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3, var uParam4, var uParam5)
{
	struct<12> Var0;
...
void func_314(struct<12> Param0, var uParam1)
{
...
bool func_316(vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10)
{
	int iVar0;
...
void func_327()
{
	...
	if (!is_bit_set(iLocal_100, 5) && !is_radar_hidden())
	{
		if (Local_818.f_707)
		{
			sVar0 = "CPC_TITLEA";
...
void func_337(float fParam0)
{
	...
	if (get_hash_key(get_this_script_name()) == func_338())
	{
		return;
	}
...
void func_345()
{
	...
	if (func_13(player_id(), 1, 1))
	{
		if ((!func_248() && !func_358(player_id(), 0, 0)) && !func_357(player_id()))
		{
			...
			iVar11 = is_ped_in_any_vehicle(player_ped_id(), 0);
			iVar12 = func_355();
			iVar4 = false;
			while (iVar4 < 10)
			{
				iVar13 = Local_818.f_729[iVar4 /*2*/].f_1;
				if (network_does_entity_exist_with_network_id(iVar13) && is_vehicle_driveable(net_to_veh(iVar13), 0))
				{
					if (!iVar12)
					{
						if (iVar11 && get_vehicle_ped_is_in(player_ped_id(), 0) == net_to_veh(iVar13))
						{
							func_273(1);
						}
					}
					...
					{
						vVar14 = {get_entity_coords(net_to_veh(iVar13), 1)};
			...
			if ((is_ped_in_flying_vehicle(player_ped_id()) || (is_entity_in_air(player_ped_id()) && !is_ped_ragdoll(player_ped_id()))) || Local_3612[participant_id_to_int() /*5*/].f_4 > 0)
			{
...
void func_366(int iParam0)
{
	...
	if (func_32())
	{
		if (func_13(player_id(), 1, 1))
		{
			...
			while (iVar0 < 10)
			{
				if (((!iParam0 && network_does_entity_exist_with_network_id(Local_818.f_729[iVar0 /*2*/].f_1)) && is_vehicle_driveable(net_to_veh(Local_818.f_729[iVar0 /*2*/].f_1), 0)) && is_vehicle_seat_free(net_to_veh(Local_818.f_729[iVar0 /*2*/].f_1), -1))
				{
					...
					else
					{
						...
						if (vdist(vVar1, get_entity_coords(net_to_veh(Local_818.f_729[iVar0 /*2*/].f_1), 1)) <= 150f)
						{
	...
	if (!is_radar_hidden())
	{
		switch (iParam0)
		{
			...
			case 5:
				if (!is_bit_set(iLocal_781, iParam0))
				{
					if (((!is_pause_menu_active() && !func_370(62)) && !is_help_message_being_displayed()) && is_bit_set(iLocal_781, 4))
					{
						if (Local_818.f_707)
						{
							sVar1 = "CPC_HELPA2";
			...
			case 6:
				if (!is_bit_set(iLocal_781, iParam0))
				{
					if (((!is_pause_menu_active() && !func_370(62)) && !is_help_message_being_displayed()) && is_bit_set(iLocal_781, 5))
					{
						if (Local_818.f_707)
						{
							sVar2 = "CPC_WARNA";
...
int func_385(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_322(iParam0) && !func_7(iParam0)) && !is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 8));
...
void func_402(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	if (func_501() || iParam2 == 24)
	{
		...
		{
			func_462(1);
			if ((!func_461() && !func_460()) || is_bit_set(Global_2460486.f_4426, true))
			{
				if (func_459())
				{
					func_458();
...
int func_407(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
...
void func_415(char* sParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_423(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, var uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_427(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_431(iParam3))
	{
...
bool func_459()
{
	if (is_bit_set(Global_2460486.f_4426, false) && func_141())
	{
		return true;
	}
	if (is_bit_set(Global_2460486.f_4426, true) && func_141())
	{
		return true;
	}
	return false;
...
bool func_463(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
...
void func_513()
{
	...
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_13(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_help_message_being_displayed())
		{
			if (func_535())
			{
	...
	if (func_322(player_id()))
	{
		...
		{
			if ((func_293(player_id(), 21) && is_bit_set(Global_1573883.f_1, 20)) && !is_bit_set(Global_1573883.f_1, 19))
			{
	...
	func_514();
	if (func_329(func_252(player_id())) && !is_bit_set(Global_1573883.f_1, 21))
	{
		set_bit(&(Global_1573883.f_1), 21);
	}
	if ((func_283() && !func_294()) || func_293(player_id(), 21))
...
void func_519(int iParam0)
{
	if ((is_bit_set(Global_1573883.f_1, 11) || (is_bit_set(Global_1573883.f_1, 10) && iParam0)) || (is_bit_set(Global_1573883.f_1, 22) && iParam0))
	{
		...
		if (is_bit_set(Global_1573883.f_1, 14) && !func_140(player_id(), 0))
		{
...
void func_550()
{
	...
	while (iVar5 < 10)
	{
		if (is_bit_set(iLocal_802, iVar5) && !has_sound_finished(iLocal_803[iVar5]))
		{
	...
	else if (is_bit_set(Local_818.f_2, 2))
	{
		Local_3600.f_5 = 6;
	}
...
void func_551(struct<12> Param0, var uParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	struct<13> Var1;
	struct<14> Var14;
...
void func_587(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_585();
