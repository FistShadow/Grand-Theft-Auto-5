...
void func_3()
{
	if (func_33(2, 0, 0, 0, 0))
	{
		if (!is_bit_set(Local_818.f_2, 2))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_818.f_2), 2);
		}
	}
		...
		case 3:
			if ((func_22() || func_1(&(Local_818.f_661), Global_262145.f_9064, 0)) || is_bit_set(Local_818.f_2, 2))
			{
				if (!is_bit_set(Local_818.f_2, true) && func_21())
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_818.f_2), true);
				}
				else
				{
					func_23(4);
...
bool func_4()
{
	...
	while (iVar0 < 10)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_818.f_729[iVar0 /*2*/].f_1) && !is_entity_dead(net_to_ent(Local_818.f_729[iVar0 /*2*/].f_1), 0))
		{
			return false;
		}
		iVar0++;
...
void func_8()
{
	...
	while (iVar2 < _network_get_num_participants_host())
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar2);
		}
		else
		{
			func_19(iVar2);
	...
	while (iVar2 < _network_get_num_participants_host())
	{
		if (is_bit_set(iVar3, iVar2))
		{
			...
			func_15(iVar2);
			func_9(iVar2);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_818.f_673), iVar2);
		}
		iVar2++;
	}
				...
				if (func_1(&uLocal_386, 750, 0))
				{
					if (iVar1 != 0)
					{
						if (iVar1 < iVar2 || iVar2 == 0)
						{
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_818.f_3[func_17(iVar4)]), func_16(iVar4));
							Local_818.f_708--;
						}
					}
				}
...
bool func_22()
{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_818.f_2), false);
		return true;
	}
	return false;
}
		...
		while (iVar0 < 10)
		{
			if (Local_818.f_713[iVar0] == participant_id_to_int())
			{
				if (func_96(iVar0))
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_3612[participant_id_to_int() /*5*/].f_1), iVar0);
					}
				}
			...
			switch (Local_3612[participant_id_to_int() /*5*/].f_3)
			{
				...
				case 2:
					if (Local_818.f_8 > 2)
					{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_100, 5);
						}
						if (Local_818.f_710)
						{
							func_326();
		...
		if (func_36(&(Local_818.f_669)))
		{
			if (network_does_network_id_exist(Local_818.f_729[iLocal_383 /*2*/].f_1))
			{
				if (!is_entity_dead(net_to_veh(Local_818.f_729[iLocal_383 /*2*/].f_1), 0))
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_802, iLocal_383);
...
void func_125()
{
	if (!is_bit_set(iLocal_100, 3))
	{
		...
		func_129();
		func_127();
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_100, 3);
		func_126();
	}
}
...
void func_144()
{
	...
	if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_2, false) && (func_154() || is_bit_set(Local_818.f_2, 2)))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_3612[participant_id_to_int() /*5*/].f_2), false);
		func_145(132);
	}
}
...
void func_155()
{
	...
	if (!is_bit_set(Local_3612[participant_id_to_int() /*5*/].f_2, true))
	{
		if (func_6(player_id()))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_3612[participant_id_to_int() /*5*/].f_2), true);
			return;
		}
...
void func_260()
{
	if (func_264(0))
	{
		if (!is_bit_set(iLocal_100, 4))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_100, 4);
		}
	}
...
void func_261()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1641), 26);
}
...
void func_271(struct<4> Param0, auto uParam1, int iParam2)
{
	...
	if (Param0.f_3 == participant_id_to_int() && !is_bit_set(uLocal_371[func_17(iParam5)], func_16(iParam5)))
	{
		...
		Global_2445403 = iVar0;
		Local_3600.f_7 += iVar1;
		GAMEPLAY::GAMEPLAY::SET_BIT(&(uLocal_371[func_17(iParam5)]), func_16(iParam5));
...
void func_272()
{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_3612[participant_id_to_int() /*5*/].f_2), 2);
		func_273(1);
	}
}
...
void func_290(Vector3 vParam0, auto uParam1, auto uParam2, int iParam3)
{
	...
	if (!is_bit_set(Local_818.f_3[func_17(iParam5)], func_16(iParam5)))
	{
		if (!is_bit_set(uLocal_366[func_17(iParam5)], func_16(iParam5)))
		{
			...
			if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vParam0 + Vector(fVar2, 0f, 0f), fVar1, fVar1, fVar0, false, true, 0))
			{
				if (func_291())
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(uLocal_366[func_17(iParam5)]), func_16(iParam5));
				}
			}
		}
	...
	if (!is_bit_set(uLocal_366[func_17(iParam6)], func_16(iParam6)) && !is_bit_set(Local_818.f_3[func_17(iParam6)], func_16(iParam6)))
	{
		...
		if (uLocal_232[iParam6])
		{
			if (!is_bit_set(iLocal_376[func_17(iParam6)], func_16(iParam6)))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(iLocal_376[func_17(iParam6)]), func_16(iParam6));
			}
			else
			{
...
bool func_310()
{
	if (func_262(player_id()))
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_100, 2);
			return true;
		}
	}
...
void func_345()
{
	...
	if (func_13(player_id(), 1, 1))
	{
		if ((!func_248() && !func_358(player_id(), 0, 0)) && !func_357(player_id()))
		{
				...
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(iVar13) && is_vehicle_driveable(net_to_veh(iVar13), 0))
				{
					...
					if (func_30(iVar4, &vVar0, &uVar3))
					{
						...
						if (vdist(vVar14, vVar0) <= 10f)
						{
							if (func_354(vVar14))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&uVar7, iVar4);
							}
			...
			if ((is_ped_in_flying_vehicle(PLAYER::PLAYER_PED_ID()) || (is_entity_in_air(PLAYER::PLAYER_PED_ID()) && !is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))) || Local_3612[participant_id_to_int() /*5*/].f_4 > 0)
			{
			...
			case 0:
				if (!is_bit_set(iLocal_781, iParam0))
				{
					if (!is_pause_menu_active())
					{
						...
						func_133(1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_781, iParam0);
					}
				}
				break;
...
void func_552(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(iParam0, iVar0);
		}
		iVar0++;
	}
}
