...
bool func_33()
{
	...
	if (!func_49())
	{
		...
		while (iVar0 < 3)
		{
			if (!is_ped_injured(iLocal_85[iVar0]))
			{
				if (vdist2(get_entity_coords(player_ped_id(), 0), get_entity_coords(iLocal_85[iVar0], 0)) < 400f)
				{
					if (!iLocal_62)
					{
						if (iLocal_83 == 2)
						...
						if (((has_entity_been_damaged_by_entity(iLocal_85[iVar0], player_ped_id(), 1) || is_ped_shooting(player_ped_id())) || is_player_targetting_entity(player_id(), iLocal_85[iVar0])) || is_player_free_aiming_at_entity(player_id(), iLocal_85[iVar0]))
						{
							iLocal_62 = 1;
							iLocal_65 = 1;
							iLocal_64 = 1;
...
bool func_50()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(iLocal_85[iVar0]))
		{
			if (vdist2(get_entity_coords(player_ped_id(), 0), get_entity_coords(iLocal_85[iVar0], 0)) < 62500f)
			{
				return true;
			}
			else
...
void func_51()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(iLocal_85[iVar0]))
		{
			...
			if (iLocal_64 || iLocal_65)
			{
				if (is_ped_in_any_vehicle(iLocal_85[iVar0], 0))
				{
					if (is_ped_in_any_vehicle(player_ped_id(), 0) && !iLocal_67[iVar0])
					{
						...
						{
							task_vehicle_mission(iLocal_85[iVar0], iLocal_89[iVar0], get_vehicle_ped_is_in(player_ped_id(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						}
						if (!iLocal_65)
						{
						...
						if (!is_ped_injured(iLocal_85[iVar0]))
						{
							if (is_ped_in_any_vehicle(iLocal_85[iVar0], 0))
							{
								task_drive_by(iLocal_85[iVar0], player_ped_id(), false, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
					...
					{
						if (!is_ped_injured(iLocal_85[iVar0]) && !is_entity_dead(iLocal_89[iVar0], 0))
						{
							task_vehicle_mission_ped_target(iLocal_85[iVar0], iLocal_89[iVar0], player_ped_id(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							if (!iLocal_65)
							{
								wait(get_random_int_in_range(400, 800));
							}
				...
				{
					task_combat_ped(iLocal_85[iVar0], player_ped_id(), 0, 16);
					set_ped_keep_task(iLocal_85[iVar0], true);
				}
			}
			else if (is_ped_in_any_vehicle(iLocal_85[iVar0], 0))
			{
				if (is_ped_in_any_vehicle(player_ped_id(), 0) && !iLocal_75[iVar0])
				{
					if (get_script_task_status(iLocal_85[iVar0], 579380604) != 1 && get_script_task_status(iLocal_85[iVar0], 579380604) != 0)
					{
						...
						{
							task_vehicle_mission(iLocal_85[iVar0], iLocal_89[iVar0], get_vehicle_ped_is_in(player_ped_id(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							task_look_at_entity(iLocal_85[iVar0], player_ped_id(), -1, 2096, 4);
						}
						iLocal_79[iVar0] = 0;
						iLocal_75[iVar0] = 1;
					}
				...
				{
					if ((!is_ped_injured(iLocal_85[iVar0]) && !is_ped_injured(player_ped_id())) && !is_entity_dead(iLocal_89[iVar0], 0))
					{
						clear_ped_tasks(iLocal_85[iVar0]);
						task_vehicle_mission_ped_target(iLocal_85[iVar0], iLocal_89[iVar0], player_ped_id(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						task_look_at_entity(iLocal_85[iVar0], player_ped_id(), -1, 2096, 4);
			...
			{
				task_follow_to_offset_of_entity(iLocal_85[iVar0], player_ped_id(), 1f, 0f, 0f, 2f, -1, 0.1f, 1);
			}
			if (!is_ped_injured(iLocal_85[iVar0]))
			{
			...
			if (is_ped_in_any_vehicle(player_ped_id(), 0) && is_ped_in_any_vehicle(iLocal_85[iVar0], 0))
			{
				if (get_entity_speed(player_ped_id()) > 13f)
				{
					if (is_entity_touching_entity(get_vehicle_ped_is_in(player_ped_id(), 0), get_vehicle_ped_is_in(iLocal_85[iVar0], 0)))
					{
			...
			if (func_127())
			{
				task_smart_flee_ped(iLocal_85[iVar0], player_ped_id(), 1000f, -1, 0, 0);
			}
		}
		else if (does_entity_exist(iLocal_85[iVar0]))
		{
			iLocal_65 = 1;
			iLocal_64 = 1;
		}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_55(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_55(network_is_game_in_progress(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
bool func_66()
{
	...
	if ((has_model_loaded(iVar8) && has_model_loaded(iVar6)) && has_model_loaded(iVar7))
	{
		...
		else
		{
			...
			{
				get_nth_closest_vehicle_node_favour_direction(get_offset_from_entity_in_world_coords(player_ped_id(), 0f, -25f, 0f), get_entity_coords(player_ped_id(), 0), 1, &vVar0, &fVar3, 1, 1077936128, 0);
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_119()) || Global_100201) || Global_25122) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_115()) || func_114()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_119()) || Global_100201) || Global_25122) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_119()) || Global_100201) || Global_25122) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_114()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (does_entity_exist(player_ped_id()))
						{
							if ((((((((((((((is_ped_in_combat(player_ped_id(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_119()) || Global_25122) || func_118()) || func_43(8, -1)) || func_116()) || func_115()) || func_114()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || func_119()) || func_116()) || Global_100201) || Global_25122) || func_118()) || Global_36839) || func_43(8, -1)) || func_115()) || func_113()) || func_114()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(player_ped_id())) || is_ped_in_any_vehicle(player_ped_id(), 1)) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_ped_swimming(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_119()) || Global_100201) || Global_25122) || func_118()) || func_43(8, -1)) || func_115()) || func_113()) || func_117()) || func_116()) || func_114())
						{
							return false;
						}
						break;
...
bool func_127()
{
	if (!is_ped_injured(player_ped_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			...
			{
				if (((((is_ped_in_model(player_ped_id(), joaat("rhino")) || is_ped_in_model(player_ped_id(), joaat("ambulance"))) || is_ped_in_model(player_ped_id(), 1938952078)) || is_ped_in_any_police_vehicle(player_ped_id())) || is_ped_in_flying_vehicle(player_ped_id())) || Global_100201 == 1)
				{
					return true;
				}
			}
...
void func_128()
{
	...
	if (iLocal_61)
	{
		...
		while (iVar0 < 3)
		{
			if (!is_ped_injured(iLocal_85[iVar0]) && !is_ped_injured(player_ped_id()))
			{
				task_smart_flee_ped(iLocal_85[iVar0], player_ped_id(), 1000f, -1, 0, 0);
				set_ped_keep_task(iLocal_85[iVar0], true);
			}
