...
var func_206(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
var func_208(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_237(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_264(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
bool func_279(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_325(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_326(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_368(var uParam0, vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
