#region Local Var
	...
	int iLocal_532 = 0;
	int iLocal_533 = 0;
	struct<7>[] Local_534 = new struct<7>[5];
	Vector3[] vLocal_570 = new Vector3[5];
	struct<4>[] Local_586 = new struct<4>[5];
	struct<61> Local_607 = 0;
#endregion
...
void main()
{
	...
	if (func_403())
	{
		...
		func_402(vLocal_106, fLocal_109, 1, 0);
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			{
				set_entity_proofs(iLocal_507, false, false, false, false, false, false, 0, false);
			}
			if (func_389(iLocal_508))
			{
				set_entity_proofs(iLocal_508, false, false, false, false, false, false, 0, false);
			}
			...
			{
				task_look_at_entity(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
			_set_unk_map_flag(2);
		...
		case 1:
			...
			func_207();
			func_205();
			if (get_player_wanted_level(get_player_index()) <= 0 && !func_204())
			{
				iVar0 = 1;
				...
				{
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_507, 0))
					{
						func_201(777);
					}
				}
...
int func_69(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_68(iParam1)];
...
void func_205()
{
	if (iLocal_533 == 0)
	{
		if (func_206(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
...
auto func_206(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_207()
{
	if (iLocal_528 == 0)
	{
		if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, true, 0))
		{
			while (func_204())
			{
				func_222();
			...
			func_221(&uLocal_278, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (iLocal_102 != 0)
		{
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_531 > 6000)
			{
				...
				else if (iLocal_102 == 1)
				{
					if (func_389(Local_443.f_28[0]))
					{
						if (func_208(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) < 75f)
						{
...
auto func_208(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_209(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
		...
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_389(Local_443.f_28[0]))
				{
					...
					{
						if (is_position_occupied(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508, 0))
						{
							func_437("Back gate blocked");
							vLocal_110 = {-1130.35f, 307.92f, 65.19f};
							open_sequence_task(&iLocal_506);
							task_follow_nav_mesh_to_coord(false, vLocal_110, 2f, 20000, 1f, 1, 1193033728);
							task_follow_nav_mesh_to_coord(false, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							close_sequence_task(iLocal_506);
							set_ped_keep_task(Local_443.f_28[0], true);
							task_perform_sequence(Local_443.f_28[0], iLocal_506);
						}
						else
						{
							...
							if (func_202(iLocal_508))
							{
								task_vehicle_mission_ped_target(false, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_202(iLocal_508))
						{
							task_enter_vehicle(false, iLocal_508, 20000, -1, 2f, 1, 0);
							task_vehicle_mission_ped_target(false, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					set_ped_flee_attributes(Local_443.f_28[0], 2, true);
					clear_sequence_task(&iLocal_506);
				}
		...
		case 1:
			if (func_389(Local_443.f_28[0]))
			{
				if (!iLocal_525)
				{
					...
					{
						if (func_208(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							func_221(&uLocal_278, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_221(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
							if (func_204())
				...
				if (func_202(iLocal_508))
				{
					if (is_ped_in_vehicle(Local_443.f_28[0], iLocal_508, 1))
					{
						if (get_vehicle_engine_health(iLocal_508) < 20f)
						{
							clear_ped_tasks(Local_443.f_28[0]);
							task_leave_any_vehicle(Local_443.f_28[0], 0, 4416);
							task_smart_flee_ped(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_227(&iLocal_508);
						}
					}
					if (func_389(PLAYER::PLAYER_PED_ID()))
					{
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_508, 1))
						{
							clear_ped_tasks(Local_443.f_28[0]);
							task_smart_flee_ped(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_227(&iLocal_508);
				...
				if (func_208(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) > 350f)
				{
				...
				if (func_389(PLAYER::PLAYER_PED_ID()) && func_389(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						if (func_208(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) < 10f)
						{
							if (!func_204() && GAMEPLAY::GET_GAME_TIMER() - iLocal_532 > 8000)
							{
			...
			{
				if (has_entity_been_damaged_by_entity(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 1))
				{
...
void func_228(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_230()
{
	switch (Local_89.f_11)
	{
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, true, 2))
				{
					...
					while ((!has_vehicle_recording_been_loaded(Local_89.f_9, Local_89.f_10) || !STREAMING::HAS_MODEL_LOADED(iLocal_85)) || !STREAMING::HAS_MODEL_LOADED(iLocal_84))
					{
						wait(0);
					}
		...
		case 1:
			...
			{
				Local_89.f_7 = create_vehicle(iLocal_85, Local_89, 0, 1, true);
				set_vehicle_on_ground_properly(Local_89.f_7);
				...
				give_weapon_to_ped(Local_89.f_8, joaat("weapon_pistol"), -1, false, true);
				set_blocking_of_non_temporary_events(Local_89.f_8, true);
		...
		case 4:
			if (func_202(Local_89.f_7))
			{
				if (func_389(Local_89.f_8))
				{
					set_blocking_of_non_temporary_events(Local_89.f_8, false);
	...
	switch (iLocal_101)
	{
		case 0:
			...
			while (iVar0 <= Local_443.f_28 - 1)
			{
				if (func_389(Local_443.f_28[iVar0]))
				{
					if (func_208(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 10f)
					{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_511 > 20000)
			{
				...
				if (func_389(Local_443.f_28[1]))
				{
					...
					set_blocking_of_non_temporary_events(Local_443.f_28[1], false);
					task_arrest_ped(Local_443.f_28[1], PLAYER::PLAYER_PED_ID());
				}
				iLocal_101 = 4;
				iLocal_511 = GAMEPLAY::GET_GAME_TIMER();
			}
			...
			while (iVar0 <= Local_443.f_28 - 1)
			{
				if (func_389(Local_443.f_28[iVar0]))
				{
					if (func_208(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				while (iVar0 <= Local_443.f_28 - 1)
				{
					if (func_389(Local_443.f_28[iVar0]))
					{
						...
						set_blocking_of_non_temporary_events(Local_443.f_28[iVar0], false);
						open_sequence_task(&iLocal_506);
						task_shoot_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, -687903391);
						close_sequence_task(iLocal_506);
						task_perform_sequence(Local_443.f_28[iVar0], iLocal_506);
						clear_sequence_task(&iLocal_506);
					}
					iVar0++;
				}
				func_221(&uLocal_113, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= Local_443.f_28 - 1)
				{
					...
					{
						if (func_208(Local_443.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) > 20f)
						{
							set_ped_accuracy(Local_443.f_28[iVar1], 75);
						}
						else
						{
							set_ped_accuracy(Local_443.f_28[iVar1], true);
						}
					}
					iVar1++;
				}
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_530 > 15000)
				{
					...
					while (iVar1 <= Local_443.f_28 - 1)
					{
						if (func_389(Local_443.f_28[iVar1]))
						{
							if (func_208(Local_443.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) >= 50f)
							{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= Local_443.f_28 - 1)
		{
			if (func_389(Local_443.f_28[iVar0]))
			{
				...
				if (iLocal_101 != 4)
				{
					if (func_208(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) < 2.3f)
					{
...
int func_233(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	...
	if (func_389(PLAYER::PLAYER_PED_ID()) && func_389(iParam0))
	{
		...
		if (func_247(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
...
bool func_234(int iParam0, float fParam1)
{
	...
	if (func_389(PLAYER::PLAYER_PED_ID()) && func_389(iParam0))
	{
		if (func_245(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
int func_236(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_237(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_237(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_238(iParam4, iParam7)};
...
bool func_240(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_242(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_242(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_241(vVar3, vVar0);
...
float func_241(Vector3 vParam0, Vector3 vParam1)
{
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}

Vector3 func_242(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_246(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_389(PLAYER::PLAYER_PED_ID()) && func_389(iParam0))
	{
		...
		if (!iParam2)
		{
			...
			if (func_248(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_248(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_249(int iParam0, float fParam1)
{
	...
	{
		if (func_250(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_250(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_242(vParam1 - get_entity_coords(iParam0, 1))};
...
void func_252()
{
	...
	else
	{
		switch (iLocal_103)
		{
			...
			case 1:
				if (!func_204() && !is_message_being_displayed())
				{
					if (iLocal_104)
					{
						func_221(&uLocal_113, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_255()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		if (func_389(Local_443.f_28[1]))
		{
			...
			_0x2A56C06EBEF2B0D9("Cop_standing_idle", Local_443.f_28[1], false);
		}
		if (func_389(Local_443.f_28[2]))
		{
			func_437("Trying to set Cop 2 component variation (intro loop)");
			_0x2A56C06EBEF2B0D9("Cop_with_notepad", Local_443.f_28[2], false);
		}
	}
	switch (iLocal_88)
	{
		...
		case 1:
			switch (iLocal_527)
			{
				case 0:
					if (func_283(1, 1093140480, 0))
					{
						...
						if (func_202(iVar0))
						{
							if (is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(iVar0)))
							{
								func_273(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								func_273(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, func_272(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
						...
						if (func_202(iLocal_507))
						{
							set_entity_coords(iLocal_507, -1107.5f, 280.33f, 64.01f, 1, false, 0, 1);
							set_entity_heading(iLocal_507, 97.97f);
							set_vehicle_on_ground_properly(iLocal_507);
						}
						iLocal_527++;
					}
					break;
				...
				case 2:
					if (((has_anim_dict_loaded("rcmjosh4") && has_anim_dict_loaded("combat@gestures@pistol@halt")) && has_anim_dict_loaded("combat@gestures@pistol@glances")) && STREAMING::HAS_MODEL_LOADED(iLocal_509))
					{
						iLocal_527++;
					}
					break;
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_262(player_id())) && !func_260(player_id(), 0)) && !func_259())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_262(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_264(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_266()
{
	if (can_set_exit_state_for_registered_entity("Josh", false))
	{
		if (func_389(Local_443.f_28[0]))
		{
			func_437("Playing Josh's leadout");
			open_sequence_task(&iLocal_506);
			task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2, 2);
			task_play_anim(false, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			close_sequence_task(iLocal_506);
			task_perform_sequence(Local_443.f_28[0], iLocal_506);
			clear_sequence_task(&iLocal_506);
			force_ped_motion_state(Local_443.f_28[0], 247561816, false, 1, 0);
		}
	}
	if (can_set_exit_state_for_registered_entity("Security_guard_pistol", false))
	{
		if (func_389(iLocal_504) && func_389(Local_443.f_28[1]))
		{
			give_weapon_object_to_ped(iLocal_504, Local_443.f_28[1]);
			func_437("*** Gave idle cop gun");
		}
	}
	if (can_set_exit_state_for_registered_entity("FBI_Agent_1_Gun", false))
	{
		if (func_389(iLocal_505) && func_389(Local_443.f_28[2]))
		{
			give_weapon_object_to_ped(iLocal_505, Local_443.f_28[2]);
			func_437("*** Gave notepad cop gun");
		}
	}
	if (can_set_exit_state_for_registered_entity("Cop_standing_idle", false))
	{
		if (func_389(Local_443.f_28[1]))
		{
			force_ped_motion_state(Local_443.f_28[1], 1063765679, false, 1, 0);
			open_sequence_task(&iLocal_506);
			task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			task_aim_gun_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1);
			task_play_anim(false, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			close_sequence_task(iLocal_506);
			task_perform_sequence(Local_443.f_28[1], iLocal_506);
			clear_sequence_task(&iLocal_506);
			func_437("*** Idle cop anim");
		}
	}
	if (can_set_exit_state_for_registered_entity("Cop_with_notepad", false))
	{
		if (func_389(Local_443.f_28[2]))
		{
			force_ped_motion_state(Local_443.f_28[2], 1063765679, false, 1, 0);
			open_sequence_task(&iLocal_506);
			task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			task_go_to_coord_while_aiming_at_entity(0, -1103.72f, 289.46f, 63.23f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			task_go_to_coord_while_aiming_at_entity(0, -1106.08f, 288.55f, 63.31f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			task_aim_gun_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1);
			close_sequence_task(iLocal_506);
			task_perform_sequence(Local_443.f_28[2], iLocal_506);
			clear_sequence_task(&iLocal_506);
...
void func_268(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_273(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_274(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_274(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_276(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_277(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_277(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_278(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_242(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_279(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_282()
{
	...
	if (func_389(Local_443.f_28[0]))
	{
		register_entity_for_cutscene(Local_443.f_28[0], "Josh", 0, false, 0);
		func_437("*** Registered Josh");
	}
	if (func_389(Local_443.f_28[1]))
	{
		iLocal_504 = create_weapon_object(joaat("weapon_pistol"), -1, get_entity_coords(Local_443.f_28[1], 1), 1, 1f, false, 0, 1);
		register_entity_for_cutscene(Local_443.f_28[1], "Cop_standing_idle", 0, false, 0);
		func_437("*** Registered Cop standing");
	}
	if (func_389(Local_443.f_28[2]))
	{
		iLocal_505 = create_weapon_object(joaat("weapon_pistol"), -1, get_entity_coords(Local_443.f_28[2], 1), 1, 1f, false, 0, 1);
		register_entity_for_cutscene(Local_443.f_28[2], "Cop_with_notepad", 0, false, 0);
		func_437("*** Registered Cop with notepad");
	}
	if (func_389(iLocal_504))
	{
		register_entity_for_cutscene(iLocal_504, "Security_guard_pistol", 0, false, 0);
		func_437("*** Registered idle cop gun");
	}
	if (func_389(iLocal_505))
	{
		register_entity_for_cutscene(iLocal_505, "FBI_Agent_1_Gun", 0, false, 0);
...
bool func_283(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_287(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_289(int iParam0)
{
	...
	request_anim_dict("combat@gestures@pistol@glances");
	STREAMING::REQUEST_MODEL(iLocal_509);
	while ((!has_anim_dict_loaded("combat@gestures@pistol@halt") || !has_anim_dict_loaded("combat@gestures@pistol@glances")) || !STREAMING::HAS_MODEL_LOADED(iLocal_509))
	{
		wait(0);
	}
	...
	if (func_389(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			set_entity_coords(Local_443.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, false, 0, 1);
			set_entity_heading(Local_443.f_28[0], 193.1737f);
			task_play_anim(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
		set_entity_only_damaged_by_player(Local_443.f_28[0], true);
		set_ped_can_be_targetted(Local_443.f_28[0], true);
	}
	if (iParam0 == 1)
	{
		if (func_389(Local_443.f_28[2]))
		{
			give_weapon_to_ped(Local_443.f_28[2], joaat("weapon_pistol"), -1, true, true);
			set_entity_coords(Local_443.f_28[2], -1106.08f, 288.55f, 63.31f, 1, false, 0, 1);
			open_sequence_task(&iLocal_506);
			task_aim_gun_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1);
			close_sequence_task(iLocal_506);
			task_perform_sequence(Local_443.f_28[2], iLocal_506);
			clear_sequence_task(&iLocal_506);
			set_blocking_of_non_temporary_events(Local_443.f_28[2], true);
		}
	}
	if (iParam0 == 1)
	{
		if (func_389(Local_443.f_28[1]))
		{
			give_weapon_to_ped(Local_443.f_28[1], joaat("weapon_pistol"), -1, true, true);
			set_entity_coords(Local_443.f_28[1], -1102.41f, 289.73f, 63.18f, 1, false, 0, 1);
			open_sequence_task(&iLocal_506);
			task_aim_gun_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 1);
			close_sequence_task(iLocal_506);
			task_perform_sequence(Local_443.f_28[1], iLocal_506);
			clear_sequence_task(&iLocal_506);
			set_blocking_of_non_temporary_events(Local_443.f_28[1], true);
		}
	}
	if (func_389(Local_443.f_28[1]))
	{
...
void func_291()
{
	...
	{
		case 0:
			if (!func_5(0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_389(PLAYER::PLAYER_PED_ID()) && func_257(Local_443.f_28[0]))
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_292())
						{
							if (!func_286(PLAYER::PLAYER_PED_ID(), -875674219))
							{
								task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_519)
				{
					...
					{
						if (is_entity_playing_anim(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_204())
						{
							...
							remove_cutscene();
							_request_cutscene_2("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_519 = 1;
						}
					}
				}
				...
				{
					if ((func_389(PLAYER::PLAYER_PED_ID()) && func_257(Local_443.f_28[0])) && !func_292())
					{
						if (!func_286(PLAYER::PLAYER_PED_ID(), -875674219))
						{
							task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 0);
					...
					if (func_257(Local_443.f_28[0]))
					{
						if (is_entity_playing_anim(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_208(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) <= 2f)
							{
								if (func_204())
								{
									func_222();
...
void func_294()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_287(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_315()
{
	...
	if (!func_321())
	{
		func_320(PLAYER::PLAYER_PED_ID(), vLocal_106, fLocal_109, 1, 1);
...
int func_320(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_322(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_367(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_358(iParam12, 0);
			while (!func_323(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_323(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_324(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_329(*iParam1, 0, &uVar0))
		{
...
bool func_325(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_326(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_328(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_329(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_331(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_331(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_335(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_348(iParam0) != 145) || func_347(iParam0)) || func_346(iParam0)) || func_330(iParam0)) || func_345(iParam0)) || !func_337(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_346(iParam0))
		{
		}
...
bool func_352(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_355(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_354(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_354(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_353(*iParam0))
	{
...
void func_358(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_359(iParam0, iParam1))
				{
...
void func_360(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_362(auto uParam0, auto uParam1)
{
...
auto func_364(auto uParam0)
{
	return *uParam0;
}

int func_365(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_366(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_367(Vector3 vParam0, Vector3 fParam1)
{
	return func_368(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_368(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_378(uParam0))
	{
		...
		if (func_377(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_370(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_370(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_372(iParam0, uVar1[iVar6], 1) && func_371(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_366(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
...
bool func_371(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_373(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_335(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_335(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_335(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_376(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_375())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_335(iVar2 + 1)))
				{
...
bool func_382(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_388()
{
	...
	request_additional_text("JOSH4", false);
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[2]))
			{
				...
				{
					set_ped_component_variation(*uParam0.f_28[2], false, 1, true, 0);
					set_ped_component_variation(*uParam0.f_28[2], 3, 0, true, 0);
					set_ped_component_variation(*uParam0.f_28[2], 10, 0, true, 0);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[1]))
			{
				...
				if (func_202(*uParam0.f_35[1]))
				{
					...
					set_vehicle_on_ground_properly(*uParam0.f_35[1]);
				}
				else
				{
					iVar7 = false;
...
void func_392(int iParam0, int iParam1)
{
	...
	func_393(iParam0, iLocal_81, vVar0, fVar3);
...
void func_393(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_225(iParam0);
...
void func_394(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	func_226(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

bool func_395(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_396(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_396(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_401(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
void func_405(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_412(uParam0, iParam1);
	func_410(uParam0, iParam2);
	func_406(uParam0, iParam3);
}

void func_406(auto uParam0, int iParam1)
{
	func_407(uParam0.f_41, iParam1);
}
...
void func_415(int iParam0)
{
	...
	if (!func_432())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_416(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_417(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_423())
	{
		...
		{
			iVar33 = func_418(get_this_script_name());
			if (iVar33 > -1)
			{
