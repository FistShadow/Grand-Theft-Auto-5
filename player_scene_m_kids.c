#region Local Var
	...
	Vector3[] fLocal_262 = new Vector3[2];
	struct<16>[] Local_265 = new struct<16>[2];
	struct<16>[] Local_298 = new struct<16>[2];
	Vector3 vLocal_331 = 0;
	float fLocal_334 = 0;
	Vector3[] vLocal_335 = new Vector3[2];
	Vector3[] fLocal_342 = new Vector3[2];
	char* sLocal_345 = 0;
	auto uLocal_346 = 0;
	auto uLocal_347 = 0;
	auto uLocal_348 = 0;
	...
	auto uLocal_391 = 0;
	auto uLocal_392 = 0;
	struct<16>[] Local_393 = new struct<16>[2];
	struct<16>[] Local_426 = new struct<16>[2];
	struct<4> Local_459 = 0;
	float fLocal_463 = 0;
	int iLocal_464 = 0;
	int iLocal_465 = 0;
	struct<4> Local_466 = 0;
	int[] iLocal_470 = new int[2];
	auto uLocal_473 = 0;
	float fLocal_474 = 0;
	float fLocal_475 = 0;
	int iLocal_476 = 0;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		switch (iLocal_239[iParam1])
		{
			case 0:
				...
				{
					if (is_entity_playing_anim(iParam0, &sLocal_345, &(Local_426[iParam1 /*16*/]), 2))
					{
			...
			case 5:
				if (is_entity_playing_anim(iParam0, &sLocal_345, &(Local_426[iParam1 /*16*/]), 2))
				{
					if (func_6(iLocal_242[iParam1], iLocal_245[iParam1], &sVar4, &sVar20, &iVar36, &iVar37))
					{
					...
					if (is_synchronized_scene_running(Global_88941))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_249[iParam1], 0))
						{
							...
							{
								if (get_synchronized_scene_phase(Global_88941) > 0.817f)
								{
									stop_synchronized_entity_anim(iLocal_249[iParam1], -8f, 1);
									vVar38 = {-824.5328f, 175.0702f, 69.8919f};
									fVar41 = 156.6901f;
									vVar38.x = -824.333f;
									fVar41 = 140.49f;
									set_entity_coords(iLocal_249[iParam1], vVar38, 1, false, 0, 1);
									set_entity_heading(iLocal_249[iParam1], fVar41);
									set_vehicle_on_ground_properly(iLocal_249[iParam1]);
								}
							}
						}
						if (get_synchronized_scene_phase(Global_88941) > fLocal_477)
						{
			...
			case 10:
				...
				if (func_6(iLocal_242[iParam1], iLocal_245[iParam1], &sVar42, &sVar58, &iVar74, &iVar75) && func_4(iLocal_242[iParam1], iLocal_245[iParam1], &vVar76, &fVar79))
				{
					if (!is_synchronized_scene_running(iLocal_476))
					{
						iLocal_476 = create_synchronized_scene(vVar0 + vVar76, 0f, 0f, fVar3 + fVar79, 2);
						set_synchronized_scene_looped(iLocal_476, true);
						_0x394B9CD12435C981(iLocal_476, false);
					}
					task_synchronized_scene(iParam0, iLocal_476, &sVar42, &sVar58, 1000f, -8f, 0, 0, 1000f, 0);
					_0x394B9CD12435C981(iLocal_476, true);
					iLocal_239[iParam1] = 1;
				}
				break;
...
int func_4(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
bool func_7(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, auto uParam5)
{
	if (iParam0 != 141)
	{
	}
...
int func_8(int iParam0, char* sParam1, char* sParam2, auto uParam3)
{
...
bool func_9()
{
	...
	if (!func_28())
	{
		if (is_synchronized_scene_running(Global_88941))
		{
			if (is_string_null_or_empty(&Local_459))
			{
			}
			else if (!iLocal_464)
			{
...
int func_11(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_29()
{
	...
	if (!is_string_null_or_empty(&Local_459) && !iLocal_464)
	{
		if (func_11(&uLocal_67, "PRSAUD", &Local_459, 3, 0, 0, 0, 0))
		{
			iLocal_464 = 1;
		...
		if (is_synchronized_scene_running(Global_88941))
		{
			...
			while (iVar0 < iLocal_233)
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_249[iVar0], 0))
				{
					...
					{
						stop_playback_recorded_vehicle(iLocal_249[iVar0]);
					}
					play_synchronized_entity_anim(iLocal_249[iVar0], Global_88941, &(Local_298[iVar0 /*16*/]), &sLocal_345, 8f, 8f, 0, 1000f);
				}
				iVar0++;
			}
			if (!is_string_null_or_empty(&Local_459) && iLocal_464)
	...
	if (is_synchronized_scene_running(Global_88940))
	{
		...
		while (iVar0 < iLocal_233)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_249[iVar0], 0))
			{
				...
				{
					play_synchronized_entity_anim(iLocal_249[iVar0], Global_88940, &(Local_265[iVar0 /*16*/]), &sLocal_345, 8f, 8f, 0, 1000f);
				}
				else
				{
					if (!is_playback_going_on_for_vehicle(iLocal_249[iVar0]))
					{
						start_playback_recorded_vehicle(iLocal_249[iVar0], iLocal_470[iVar0], &Local_466, 1);
					}
					skip_time_in_playback_recorded_vehicle(iLocal_249[iVar0], fLocal_474 - get_time_position_in_recording(iLocal_249[iVar0]));
					set_playback_speed(iLocal_249[iVar0], fLocal_475);
				}
			}
			iVar0++;
		}
...
int func_34(auto uParam0, auto uParam1)
{
...
void func_40()
{
	...
	while (!iVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_233)
		{
			...
			if (!is_string_null_or_empty(&Local_466) && iLocal_470[iVar0] > 0)
			{
				request_vehicle_recording(iLocal_470[iVar0], &Local_466);
				if (!has_vehicle_recording_been_loaded(iLocal_470[iVar0], &Local_466))
				{
					request_vehicle_recording(iLocal_470[iVar0], &Local_466);
					iVar2 = false;
				}
		...
		if (!is_string_null_or_empty(&sLocal_345))
		{
			request_anim_dict(&sLocal_345);
			if (!has_anim_dict_loaded(&sLocal_345))
			{
				iVar2 = false;
				request_anim_dict(&sLocal_345);
			}
		...
		iVar35 = 0;
		iVar36 = 0;
		if (func_6(iLocal_242[0], iLocal_245[0], &Var3, &Var19, &iVar35, &iVar36))
		{
	...
	while (iVar0 < iLocal_249)
	{
		if (iLocal_252[iVar0] != 0)
		{
			iLocal_249[iVar0] = create_vehicle(iLocal_252[iVar0], vLocal_331 + vLocal_255[iVar0 /*3*/], fLocal_334 + fLocal_262[iVar0], 0, false);
			set_vehicle_on_ground_properly(iLocal_249[iVar0]);
			if (!is_string_null_or_empty(&(Local_265[iVar0 /*16*/])))
			{
				play_entity_anim(iLocal_249[iVar0], &(Local_265[iVar0 /*16*/]), &sLocal_345, 8f, true, 0, 0, 0f, 0);
			}
			else
			{
				start_playback_recorded_vehicle(iLocal_249[iVar0], iLocal_470[iVar0], &Local_466, 1);
	...
	add_relationship_group("KIDSS", &iLocal_248);
	iVar0 = 0;
	while (iVar0 < iLocal_233)
	{
		if (iLocal_236[iVar0] != 145)
		{
			if (func_164(&(iLocal_233[iVar0]), iLocal_236[iVar0], vLocal_331 + vLocal_335[iVar0 /*3*/], fLocal_334 + fLocal_342[iVar0], 1))
			{
				...
				{
					set_ped_into_vehicle(iLocal_233[iVar0], iLocal_249[iVar0], -1);
					iLocal_239[iVar0] = 20;
				}
			}
		}
...
bool func_41(auto uParam0, int iParam1, int iParam2)
{
	switch (iParam2)
	{
		case 77:
		...
		case 218:
			set_ped_component_variation(*uParam0, false, false, true, 0);
			set_ped_component_variation(*uParam0, true, 2, false, 0);
			set_ped_component_variation(*uParam0, 5, false, false, 0);
			set_ped_component_variation(*uParam0, 2, 4, false, 0);
			set_ped_component_variation(*uParam0, 3, 2, 2, 0);
			set_ped_component_variation(*uParam0, 4, 5, false, 0);
			set_ped_component_variation(*uParam0, 6, true, false, 0);
			set_ped_component_variation(*uParam0, 10, true, false, 0);
			return true;
			break;
		
		case 219:
			set_ped_default_component_variation(*uParam0);
			set_ped_component_variation(*uParam0, 5, 2, false, 0);
			return true;
			break;
		...
		case 225:
			...
			set_ped_component_variation(*uParam0, true, 2, false, 0);
			set_ped_component_variation(*uParam0, 5, false, false, 0);
			set_ped_component_variation(*uParam0, 2, 2, false, 0);
			set_ped_component_variation(*uParam0, 3, 2, true, 0);
			set_ped_component_variation(*uParam0, 4, 4, false, 0);
			set_ped_component_variation(*uParam0, 6, false, false, 0);
			return true;
			break;
...
bool func_42(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		case 4:
			set_ped_component_variation(iParam0, false, false, true, 0);
			set_ped_component_variation(iParam0, 3, true, false, 0);
			set_ped_component_variation(iParam0, 4, true, true, 0);
		...
		case 9:
			if (iParam2 == 108)
			{
				iVar0 = 12;
				iVar1 = 32;
				if (GAMEPLAY::IS_BIT_SET(Global_101154.f_1826.f_539.f_3044[0 /*166*/][iVar0 /*11*/][iVar1 / 32], iVar1 % 32))
				{
...
bool func_43(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_43(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_43(iParam0, 14, uVar21[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar31 <= 8)
		{
			if (!func_43(iParam0, 14, uVar32[iVar31]))
			{
				return false;
			}
			iVar31++;
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_44(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_44(iParam1)))
	{
		return true;
	}
	return false;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_44(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar0 = func_49(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					iVar1 = func_49(iParam0, iParam2, 1, 4);
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_49(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_44(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_61(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_61(vVar16.z)] = func_57(iParam1, vVar16.x, func_61(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_61(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_65(int iParam0)
{
	...
	func_66(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_66(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_76(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_69(func_72(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_67(iParam1, *uParam0.f_2, &uVar1))
			{
...
int func_67(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_74(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_75(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
...
int func_75(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_77(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_66(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_44(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_66(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							if (Global_69310 == 1)
							{
								...
								while (iVar2 < 15)
								{
									iVar3 = func_141(iParam0, iVar10, 14, uVar27[iVar1], iVar2, 0);
									if (iVar3 != -99)
									{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_44(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_44(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_44(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_154(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_44(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_44(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_44(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_133(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_43(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_138(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_43(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
bool func_142(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
...
void func_155(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_75(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		...
		func_156(uVar2, iVar3, iVar0, 1);
	}
}

void func_156(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_158(int iParam0, int iParam1)
{
	...
	if (func_162(iParam1, &iVar0, &iVar1, &iVar2, &iVar3, &iVar4, &iVar5, &iVar6, &iVar7, &iVar8, &iVar9, &iVar10, &iVar11, &uVar12))
	{
		...
		func_160(iParam0, iVar1);
		func_160(iParam0, iVar2);
		func_160(iParam0, iVar3);
		func_160(iParam0, iVar4);
		func_160(iParam0, iVar5);
		func_160(iParam0, iVar6);
		func_160(iParam0, iVar7);
		func_160(iParam0, iVar8);
		func_160(iParam0, iVar9);
		func_160(iParam0, iVar10);
		func_160(iParam0, iVar11);
...
bool func_161(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 0:
...
bool func_162(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	switch (iParam0)
	{
		case 34:
...
bool func_164(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_165(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_167(int iParam0)
{
	if (!func_20(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(func_166(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_168(int iParam0)
{
	if (!func_20(iParam0))
	{
		STREAMING::REQUEST_MODEL(func_166(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_169()
{
	...
	func_174(iLocal_66, &vLocal_331, &fLocal_334, &sVar0);
	func_172(iLocal_66, &sLocal_345, &sLocal_361, &sLocal_377, &uVar8, &uVar9);
	func_171(iLocal_66, &Local_466, &uVar10, &uLocal_473, &fLocal_474, &uVar11, &fLocal_475, &uVar12);
	switch (iLocal_66)
	{
		case 86:
			vLocal_335[0 /*3*/] = {get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f};
			fLocal_342[0] = get_random_float_in_range(-180f, 180f);
			iLocal_236[0] = 14;
			iLocal_242[0] = 0;
			iLocal_245[0] = 19;
		...
		case 168:
			vLocal_335[0 /*3*/] = {get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f};
			fLocal_342[0] = get_random_float_in_range(-180f, 180f);
			vLocal_335[1 /*3*/] = {get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f};
			fLocal_342[1] = get_random_float_in_range(-180f, 180f);
			iLocal_236[0] = 14;
			iLocal_236[1] = 15;
			iLocal_242[0] = 0;
			iLocal_242[1] = 1;
		...
		case 173:
			...
			vLocal_255[0 /*3*/] = {get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), 0f};
			fLocal_262[0] = get_random_float_in_range(-180f, 180f);
		...
		default:
			vLocal_335[0 /*3*/] = {get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f};
			vLocal_335[1 /*3*/] = {get_random_float_in_range(-10f, 10f), get_random_float_in_range(-10f, 10f), 0f};
			fLocal_342[0] = get_random_float_in_range(-180f, 180f);
			fLocal_342[1] = get_random_float_in_range(-180f, 180f);
			iLocal_236[0] = 145;
			iLocal_236[1] = 145;
...
bool func_171(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	switch (iParam0)
	{
		case 231:
...
bool func_172(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
bool func_174(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_177(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
	...
	switch (iParam0)
	{
		...
		case 11:
			if (func_178(iParam0, &vVar0, uParam1))
			{
...
int func_178(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_180()
{
	...
	while (iVar0 < iLocal_236)
	{
		...
		if (!is_string_null_or_empty(&Local_466) && iLocal_470[iVar0] > 0)
		{
			remove_vehicle_recording(iLocal_470[iVar0], &Local_466);
		}
		iVar0++;
	}
	remove_relationship_group(iLocal_248);
...
void func_181(int iParam0)
{
	if (!func_20(iParam0))
	{
		set_model_as_no_longer_needed(func_166(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
