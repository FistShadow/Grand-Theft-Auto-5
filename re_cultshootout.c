...
void main()
{
	...
	{
		wait(false);
		if ((is_world_point_within_brain_activation_range() || iLocal_100) || (func_105() && is_entity_at_coord(player_ped_id(), vLocal_48, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_105())
			{
				if (func_104())
	...
	switch (iLocal_47)
	{
		case 0:
			if (does_pickup_exist(iLocal_113))
			{
				...
				{
					if (is_entity_in_angled_area(player_ped_id(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0))
					{
						func_66();
						if (!iLocal_101)
						{
		...
		case 1:
			...
			else if (!is_entity_at_coord(player_ped_id(), vLocal_48, 100f, 100f, 100f, false, true, 0))
			{
				func_25();
			}
			break;
...
void func_44()
{
	...
	{
		if (func_48(Global_101154.f_1826.f_539.f_3549) != get_entity_model(player_ped_id()))
		{
		...
		else
		{
			...
			switch (iLocal_127)
			{
				case 0:
					...
					{
						if ((is_entity_at_entity(iLocal_103[iLocal_125], player_ped_id(), 15f, 15f, 40f, 0, 1, 0) && can_ped_hear_player(player_id(), iLocal_103[iLocal_125])) || _0x6CD5A433374D4CFB(iLocal_103[iLocal_125], player_ped_id()))
						{
							if (is_entity_in_angled_area(player_ped_id(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || is_entity_at_coord(player_ped_id(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_55())
								{
				...
				case 1:
					...
					if (iLocal_90[iLocal_125])
					{
						if ((get_game_timer() - iLocal_130 > 18000 || iLocal_129 - iLocal_128 > 5000) || is_ped_in_combat(iLocal_103[iLocal_125], false))
						{
							if (is_entity_in_angled_area(player_ped_id(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || is_entity_at_entity(iLocal_103[iLocal_125], player_ped_id(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_87();
								wait(false);
								if (func_86())
...
bool func_89()
{
	...
	while (iVar0 < iLocal_103)
	{
		...
		{
			if (_0x6CD5A433374D4CFB(iLocal_103[iVar0], player_ped_id()))
			{
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_128()) || Global_100201) || Global_25122) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_124()) || func_123()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_128()) || Global_100201) || Global_25122) || func_127()) || func_82(8, -1)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_128()) || Global_100201) || Global_25122) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_123()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (does_entity_exist(player_ped_id()))
						{
							if ((((((((((((((is_ped_in_combat(player_ped_id(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_128()) || Global_25122) || func_127()) || func_82(8, -1)) || func_125()) || func_124()) || func_123()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(player_ped_id())) || is_ped_in_any_vehicle(player_ped_id(), 1)) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_ped_swimming(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_128()) || Global_100201) || Global_25122) || func_127()) || func_82(8, -1)) || func_124()) || func_122()) || func_126()) || func_125()) || func_123())
						{
							return false;
						}
						break;
