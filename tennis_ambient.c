...
void main()
{
	...
	while (true)
	{
		...
		{
			if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Var0.f_189.f_55) < 5625f || vLocal_702.y)
			{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Var0.f_189.f_55) > fVar1712 * fVar1712)
			{
				func_302(&Var0);
			}
		}
	...
	switch (func_301(uParam1))
	{
		...
		case 14:
			...
			else
			{
				...
				if (func_174(uParam1))
				{
					if (is_bit_set(*uParam1.f_7[iParam3 /*8*/] + *uParam1.f_7[iParam4 /*8*/], false))
					{
						func_267(uParam1, 18);
					}
...
int func_25(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	...
	else if (((!PED::IS_PED_INJURED(iVar2) && ((uParam5 || iParam4 == 4) || iParam4 == 1)) && !func_103(uParam0[iParam2 /*94*/], 8192)) && get_script_task_status(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
...
{
	if (!((!PED::IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0))) && are_strings_equal(_0x717E4D1F2048376D(func_263(uParam0)), "running")))
	{
...
bool func_105(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	{
		iVar0 = is_control_pressed(0, 223);
		iVar2 = is_control_pressed(0, 224);
		iVar3 = is_control_pressed(0, 225);
		iVar1 = is_control_pressed(0, 222);
...
void func_114(auto uParam0, int iParam1)
{
	...
	{
		vVar0 = {func_115(iParam1, func_281(uParam0), get_entity_coords(*uParam0, 1))};
	}
	*uParam0.f_27 = {vVar0};
	*uParam0.f_30 = {vVar0};
	*uParam0.f_25 = 0f;
	...
	if (!func_103(uParam1, 1024))
	{
		...
		if ((1 && !func_226(uParam0[iParam3 /*94*/].f_4, 256)) && GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]))
		{
			...
			if (iParam9)
			{
				...
				if (is_bit_set(*uParam2[0 /*8*/] + *uParam2[1 /*8*/] + 1, false) || iVar4)
				{
					iParam5 = 1;
					iParam4 = 1 - iParam4;
				}
...
void func_199(int iParam0)
{
	if (func_210(iParam0))
	{
		if (!func_209(iParam0))
		{
			*iParam0.f_2 = func_200(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
...
void func_204(int iParam0)
{
	if (func_210(iParam0))
	{
		if (func_209(iParam0))
		{
			*iParam0.f_1 = func_200(is_bit_set(*iParam0, 4)) - *iParam0.f_2;
			*iParam0.f_2 = 0f;
			clear_bit(iParam0, 2);
		}
	}
...
{
	*iParam0.f_1 = func_200(is_bit_set(*iParam0, 4)) - fParam1;
...
{
	if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && get_script_task_status(func_263(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return false;
	}
	...
	if (!PED::IS_PED_INJURED(*uParam0.f_32) && *uParam0.f_36 == 75)
	{
		...
		else
		{
			...
			if (!iParam6 && iParam7)
			{
				...
				task_play_anim(false, func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar10, 0, 0, 0, 0, 0);
			}
			if (!iParam8)
			{
...
void func_234(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (((*uParam0.f_31 != 3 && !iParam4) && !PED::IS_PED_INJURED(func_263(uParam0))) && !is_ped_ragdoll(func_263(uParam0)))
	{
	...
	switch (func_145(uParam0.f_4))
	{
		...
		case 5:
			if (func_74(uParam0) == 75)
			{
				...
				else if ((is_entity_at_coord(*uParam0.f_32, func_69(uParam0.f_4), vVar6, false, true, 0) || get_script_task_status(func_263(uParam0), 2106541073) == 7) && !func_226(uParam0.f_4, 256))
				{
					func_233(uParam0.f_4, 0);
					func_215(uParam0.f_4, 4);
				}
...
void func_271(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	...
	iVar1 = 1 - iVar0;
	if (!PED::IS_PED_INJURED(func_263(uParam0[iVar0 /*94*/])) && get_script_task_status(func_263(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = get_sequence_progress(func_263(uParam0[iVar0 /*94*/]));
	}
	if (!PED::IS_PED_INJURED(func_263(uParam0[iVar1 /*94*/])) && get_script_task_status(func_263(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
...
void func_288(auto uParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5)
{
	...
	if (!func_227(uParam0, 1))
	{
		...
		{
			*(uParam0[uParam3 /*94*/].f_37) = {get_entity_coords(func_263(uParam0[uParam3 /*94*/]), 1)};
		...
		{
			*(uParam0[uParam4 /*94*/].f_37) = {get_entity_coords(func_263(uParam0[uParam4 /*94*/]), 1)};
...
void func_307(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6, int iParam7)
{
	...
	*uParam0.f_1657 = iParam2;
	...
	func_308(uParam1, func_49(*uParam5.f_1, *uParam5.f_3, get_random_int_in_range(500, 3000)));
	func_267(uParam1, 4);
