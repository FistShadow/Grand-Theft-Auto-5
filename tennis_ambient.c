#region Local Var
	...
	auto uLocal_214 = 0;
	auto uLocal_215 = 0;
	Vector3 vLocal_216 = 0;
	Vector3 vLocal_219 = 0;
	Vector3 vLocal_222 = 0;
	Vector3 vLocal_225 = 0;
	Vector3 vLocal_228 = 0;
...
void main()
{
	...
	vLocal_216 = {0.034f, 0.002f, -0.007f};
	vLocal_219 = {70.56f, 72.36f, 67.68f};
	vLocal_222 = {2f, -0.04f, 0.6f};
	vLocal_225 = {3.2f, -0.04f, 0.6f};
	vLocal_228 = {3.2f, -0.04f, -0.6f};
	vLocal_231 = {2f, -0.04f, -0.6f};
	vLocal_234 = {-3.2f, -0.04f, 0.6f};
	vLocal_237 = {-2f, -0.04f, 0.6f};
	vLocal_240 = {-2f, -0.04f, -0.6f};
	vLocal_243 = {-3.2f, -0.04f, -0.6f};
	if (((func_334(10) && _get_number_of_instances_of_streamed_script(joaat("tennis")) == 0) || Global_88539) && !vLocal_702.y)
	{
	...
	Var1680.f_28 = 1;
	fVar1712 = func_323(vLocal_702.y, vLocal_702.z, 150f);
	iVar1713 = 0;
	iVar1714 = 0;
	iVar1715 = 1 - iVar1714;
	func_307(&Var0, &Var1680, 1, iVar1714, iVar1715, &vLocal_702, joaat("a_f_y_tennis_01"), joaat("a_m_m_tennis_01"));
	while (true)
	{
		func_306(&Var0);
		if (Global_88539)
		...
		if (network_is_in_session() && !vLocal_702.y)
		{
			func_302(&Var0);
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0.f_189.f_55) < 5625f || vLocal_702.y)
			{
				func_2(&Var0, &Var1680, &iVar1713, iVar1714, iVar1715, &uVar1716, vLocal_702.y);
			}
		}
		func_1(&(Var0.f_281));
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0.f_189.f_55) > fVar1712 * fVar1712)
			{
				func_302(&Var0);
			}
		}
		if ((func_334(10) && _get_number_of_instances_of_streamed_script(joaat("tennis")) == 0) && !vLocal_702.y)
		{
			func_302(&Var0);
		}
		wait(false);
...
void func_2(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	int iVar2;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	vVar3 = {0f, 0f, 0f};
	iVar17 = (*uParam0.f_1657 == 1 && func_301(uParam1) == 20);
	func_288(uParam0, func_301(uParam1), *iParam2, iParam3, iParam4, iVar17);
	...
	{
		iVar19 = (func_301(uParam1) != 8 && func_301(uParam1) < 16);
		vVar14 = {func_281(uParam0.f_247)};
		iVar20 = func_277(uParam0.f_189, &vVar14, uParam0.f_247.f_10, uParam0.f_1658, uParam0.f_247.f_4, uParam0.f_247.f_22, uParam0.f_247.f_5, &iVar18, iVar19, -1f, func_286(uParam0.f_247, 32), 0, 0);
		if (iVar20 == 1)
		{
		...
		set_entity_coords(*uParam0.f_247, func_281(uParam0.f_247), 1, false, 0, 0);
	...
	switch (func_301(uParam1))
	{
		case 0:
			...
			{
				clear_prints();
				set_entity_coords(*(uParam0[iParam3 /*94*/]).f_32, func_268(uParam0.f_189, func_270(uParam1), *uParam0.f_1661, *uParam0.f_1658, iParam3 == func_269(uParam1), iParam3), 1, true, 0, 1);
				...
				_new_load_scene_start_safe(*uParam0.f_189.f_29, 50f, 0);
				func_267(uParam1, 1);
			}
			break;
		...
		case 4:
			if (func_266(uParam0))
			{
				if (*uParam0.f_1657 == 1)
				{
					...
					func_264(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, *uParam0.f_1669, vVar23, get_heading_from_vector_2d(*uParam0.f_1658, *uParam0.f_1658.f_1), 0, false));
					...
					func_264(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, *uParam0.f_1668, vVar3, get_heading_from_vector_2d(-*uParam0.f_1658, -*uParam0.f_1658.f_1), 0, false));
					...
					*(uParam0[iParam3 /*94*/]).f_33 = create_object(joaat("prop_tennis_rack_01b"), *(uParam0.f_189.f_3[3 /*3*/]), 0, false, false);
					set_entity_visible(*(uParam0[iParam3 /*94*/]).f_33, false, 0);
					*(uParam0[iParam4 /*94*/]).f_33 = create_object(joaat("prop_tennis_rack_01b"), *(uParam0.f_189.f_3[2 /*3*/]), 0, false, false);
					func_260(uParam0, iParam3, iParam4, 0, 0);
					set_entity_visible(*(uParam0[iParam4 /*94*/]).f_33, false, 0);
					set_entity_visible(*(uParam0[iParam3 /*94*/]).f_33, true, 0);
					_0xB2D0BDE54F0E8E5A(*(uParam0[iParam3 /*94*/]).f_33, true);
					set_entity_visible(*(uParam0[iParam4 /*94*/]).f_33, true, 0);
					...
					{
						func_257(uParam0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), false, false, false, 0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), 2, false, false, 0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), 3, false, false, 0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), 4, false, false, 0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), 5, false, false, 0);
						set_ped_component_variation(func_263(uParam0[iParam4 /*94*/]), 7, false, false, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			iVar26 = (GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]) && GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam4 /*94*/]));
			if ((((*uParam0.f_1657 != 1 && !func_255(*iParam2, 4194304)) && iVar26) || ((*uParam0.f_1657 == 1 && func_251(uParam0) > func_250(uParam0, iParam3, iParam4)) && !iParam6)) || (*uParam0.f_1657 == 1 && iParam6))
			{
				...
				iVar27 = (*uParam0.f_1657 == 1 || func_227(uParam0, 1));
				if (!func_226(uParam0[func_269(uParam1) /*94*/].f_4, 256))
				{
					func_225(uParam0[func_269(uParam1) /*94*/], uParam0, func_270(uParam1), func_269(uParam1), *uParam0.f_1657 != 1, func_255(*iParam2, 1), (*uParam0.f_1657 != 1 && !func_227(uParam0, 1)), iVar27, 0, 0);
				}
				if (!func_226(uParam0[1 - func_269(uParam1) /*94*/].f_4, 256))
				{
					func_216(uParam0[1 - func_269(uParam1) /*94*/], uParam0, func_270(uParam1), 1 - func_269(uParam1), *uParam0.f_1657 != 1, iVar27, 0, !func_226(uParam0[1 - func_269(uParam1) /*94*/].f_4, 16), 0);
				}
				func_229(uParam0, 8);
				func_267(uParam1, 20);
		...
		case 9:
			...
			else
			{
				...
				if (func_180(uParam0, uParam1, uParam0[func_269(uParam1) /*94*/], iParam6))
				{
					iVar28 = true;
				}
			}
		...
		case 14:
			...
			else
			{
				...
				{
					if (((((func_29(uParam1) == 0 && *(uParam1.f_7[iVar38 /*8*/].f_1)[uVar37] >= 5) && *(uParam1.f_7[iVar38 /*8*/].f_1)[uVar37] + 1 - *(uParam1.f_7[iVar39 /*8*/].f_1)[uVar37] >= 2) || func_29(uParam1) == 1) || (func_29(uParam1) == 2 && *(uParam1.f_7[iVar38 /*8*/].f_1)[uVar37] >= 1)) || (func_29(uParam1) == 3 && *(uParam1.f_7[iVar38 /*8*/].f_1)[uVar37] >= 2))
					{
				...
				if (func_174(uParam1))
				{
					if (GAMEPLAY::IS_BIT_SET(*uParam1.f_7[iParam3 /*8*/] + *uParam1.f_7[iParam4 /*8*/], false))
					{
						func_267(uParam1, 18);
					}
		...
		case 20:
			...
			else if (((GAMEPLAY::GET_GAME_TIMER() > func_21(uParam0) && func_227(uParam0, 4)) && ENTITY::DOES_ENTITY_EXIST(*uParam0.f_247)) && !is_entity_attached(*uParam0.f_247))
			{
				func_265(uParam0, 1);
				func_192(uParam0[func_269(uParam1) /*94*/], uParam0.f_247);
...
void func_5(auto uParam0, int iParam1, auto uParam2, int iParam3, auto uParam4)
{
	int iVar0;
	char* sVar1;
	struct<8> Var2;
	...
	sVar1 = func_193(iVar0, "mini@tennis", "mini@tennis@female");
	Var2 = {*uParam2.f_4};
...
void func_12(auto uParam0, float fParam1)
{
...
void func_17(auto uParam0, auto uParam1)
{
	*uParam0[0 /*8*/] = 0;
	*uParam0[1 /*8*/] = 0;
	func_178(uParam1, 2);
...
void func_18(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
...
void func_20(int iParam0, auto uParam1, auto uParam2, int iParam3)
{
	if ((((iParam0 > 6 && iParam0 < 22) && !func_255(uParam2, 4194304)) && iParam0 != 16) || iParam3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_263(uParam1)))
		{
			...
			{
				set_ped_reset_flag(func_263(uParam1), 69, true);
			}
			set_ped_reset_flag(func_263(uParam1), 102, true);
		}
	}
}
...
int func_25(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if ((!PED::IS_PED_INJURED(iVar1) && (uParam5 || iParam4 == 1)) && !func_103(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam3)
		{
	...
	{
		if (!PED::IS_PED_INJURED(iVar1) && _0x921CE12C489C4C41(iVar1))
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(iVar1), "Intro") && _0x30ED88D5E0C56A37(iVar1))
			{
				_0xD01015C7316AE176(iVar1, "running");
			}
		}
	}
	iVar3 = (((iParam2 != iParam3 && iParam6 >= func_26(uParam0[iParam2 /*94*/]) - 1) && iVar0) && 1);
	...
	else if (((!PED::IS_PED_INJURED(iVar2) && ((uParam5 || iParam4 == 4) || iParam4 == 1)) && !func_103(uParam0[iParam2 /*94*/], 8192)) && AI::GET_SCRIPT_TASK_STATUS(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
	...
	{
		if (!PED::IS_PED_INJURED(iVar2) && _0x921CE12C489C4C41(iVar2))
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(iVar2), "Intro") && _0x30ED88D5E0C56A37(iVar2))
			{
...
auto func_26(auto uParam0)
{
	return *uParam0.f_55;
}

void func_27(auto uParam0, char* sParam1, float fParam2)
{
	if (!((!PED::IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0))) && GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "running")))
	{
		_0x2D537BA194896636(func_263(uParam0), sParam1, fParam2, 0, "mini@tennis", 4);
	}
}
...
auto func_29(auto uParam0)
{
	return *uParam0.f_24;
}

void func_30(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	if (iParam0 == iParam1)
	{
...
void func_31(auto uParam0, auto uParam1)
{
...
void func_41()
{
	...
	{
		if (func_45(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_47(auto uParam0, auto uParam1, auto uParam2, int iParam3, auto uParam4, int iParam5)
{
	if (*(uParam0[uParam2 /*8*/].f_1)[uParam1] == -1)
	{
		*(uParam0[uParam2 /*8*/].f_1)[uParam1] = 1;
	}
	else
	{
		*(uParam0[uParam2 /*8*/].f_1)[uParam1]++;
	}
	if ((((*(uParam0[uParam2 /*8*/].f_1)[uParam1] > 5 && *(uParam0[uParam2 /*8*/].f_1)[uParam1] - *(uParam0[iParam3 /*8*/].f_1)[uParam1] >= 2) && *uParam0[uParam2 /*8*/] >= 3) && !iParam5) || iParam5)
	{
		*(uParam0[uParam2 /*8*/]).f_7++;
	}
	func_178(uParam4, 2);
}

auto func_48(auto uParam0)
{
	return *uParam0.f_30;
}
...
void func_52(auto uParam0, auto uParam1)
{
	...
	if (!func_103(uParam0, 2048) && func_54(*uParam0.f_37, uParam1))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 713668775) != 1 && AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 242628503) != 1)
		{
			...
			task_follow_nav_mesh_to_coord(func_263(uParam0), *uParam1.f_29 + vVar0, 2f, 20000, 0.25f, 0, 1193033728);
...
int func_54(Vector3 vParam0, auto uParam1)
{
	float fVar0;
	float fVar1;
	Vector3 vVar2;
...
void func_56(auto uParam0, auto uParam1, Vector3 vParam2)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	{
		iVar0 = func_49(get_random_float_in_range(0f, 1065353216) < 0.5f, 0, 3);
...
int func_58(Vector3 vParam0, auto uParam1, auto uParam2, auto uParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_75(vParam0, vVar0, vVar3, *uParam3.f_1);
	vVar7 = {*uParam4 * Vector(0.018f, 0.018f, 0.018f)};
	fVar10 = *uParam3.f_1 * 1.038f;
	vVar0 = {vVar0 - vVar7};
	vVar3 = {vVar3 + vVar7};
	return (!iVar6 && func_75(vParam0, vVar0, vVar3, fVar10));
}
...
{
	uLocal_249[uParam0] = iParam1;
}

auto func_61(auto uParam0)
{
	return uLocal_249[uParam0];
}
...
int func_64(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
...
Vector3 func_69(auto uParam0)
{
	return *uParam0;
}

void func_70(auto uParam0, Vector3 vParam1, Vector3 vParam2)
{
...
int func_75(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	vParam3.z += 30f;
	vParam6.z -= 5f;
	return is_point_in_angled_area(vParam0, vParam3, vParam6, fParam9, 0, true);
}
...
void func_78(auto uParam0, float fParam1)
{
...
void func_80(auto uParam0, Vector3 vParam1)
{
	*uParam0 = {vParam1};
}

Vector3 func_81(auto uParam0, auto uParam1, Vector3 vParam2, auto uParam3, float fParam4)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
...
float func_82(auto uParam0, Vector3 vParam1, float fParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	...
	*fParam5 = vmag(vVar0);
	if (*fParam5 > 5f)
	{
		vVar0 = {vVar0 * Vector(5f / *fParam5, 5f / *fParam5, 5f / *fParam5)};
	}
...
Vector3 func_84(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
...
Vector3 func_85(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
	float fVar3;
	Vector3 vVar4;
...
Vector3 func_86(Vector3 vParam0, auto uParam1, Vector3 vParam2, Vector3 vParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, float fParam10)
{
	Vector3 vVar0;
	int iVar3;
	int iVar4;
	...
	{
		vVar0 = {vParam4};
		func_277(uParam3, &vParam4, &vParam7, &uParam10, &uParam13, &uParam14, &uParam15, &iVar3, 0, -1082130432, 0, 0, 0);
...
Vector3 func_88(auto uParam0, Vector3 vParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10)
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < 180)
	{
		func_277(uParam0, &vParam1, &uParam4, &uParam7, &uParam10, &uParam11, &uParam12, &iVar0, 0, 0.03333334f, 0, 0.1f, 0);
		if (iVar0 > 0)
		{
			return vParam1;
		}
...
auto func_91(auto uParam0)
{
	return *uParam0.f_4;
}

void func_92(auto uParam0, int iParam1)
{
...
int func_95(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
bool func_96(auto uParam0, int iParam1, auto uParam2)
{
	int iVar0;
...
int func_103(auto uParam0, int iParam1)
{
...
bool func_105(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar6 = (ENTITY::DOES_ENTITY_EXIST(*uParam1.f_247) && !is_entity_attached(*uParam1.f_247));
	...
	if (func_226(uParam0.f_4, 32))
	{
		...
		{
			func_164(uParam1, uParam0, uParam2, iParam3, iParam5, iParam6, func_281(uParam1.f_247), iParam7);
	...
	{
		iVar0 = CONTROLS::IS_CONTROL_PRESSED(0, 223);
		iVar2 = CONTROLS::IS_CONTROL_PRESSED(0, 224);
		iVar3 = CONTROLS::IS_CONTROL_PRESSED(0, 225);
		iVar1 = CONTROLS::IS_CONTROL_PRESSED(0, 222);
		if (((is_control_just_pressed(0, 223) || is_control_just_pressed(0, 224)) || is_control_just_pressed(0, 225)) || is_control_just_pressed(0, 222))
		{
			...
			if (func_160(uParam1, uParam0, iVar6))
			{
				func_57(uParam0, 8);
			}
			vVar17 = {vVar14};
	...
	else if (GAMEPLAY::GET_GAME_TIMER() > func_162(uParam0))
	{
		...
		{
			func_159(uParam0, uParam1, &iVar0, &iVar1);
		}
	}
	...
	{
		if (func_151(uParam0, vVar11, iVar6))
		{
			...
			else if (iVar4 == 75 && func_143(uParam0, uParam1[iParam3 /*94*/], uParam1.f_247, *uParam1.f_189.f_29, &fVar5))
			{
				...
				if (iVar4 == 75 || fVar5 <= 0f)
				{
					...
					func_136(uParam1, uParam0, uParam2, iParam3, iParam5, iParam6, vVar11, iParam7);
					func_275(uParam0, 512);
				}
				if (fVar5 < 5f)
				{
	...
	if (func_132(uParam0, uParam1.f_247, *uParam1.f_189.f_29, iVar6))
	{
		iVar42 = 1 - iParam4;
		vVar11 = {func_281(uParam1.f_247)};
		...
		func_106(uParam0, uParam1, iParam4, iVar40, iVar41, iVar38, iVar39);
		return true;
	}
	return false;
}

void func_106(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if ((func_51(uParam0) != 2 && func_51(uParam0) != 5) && !iParam3)
	{
		func_126(uParam1.f_247, func_125(*uParam0.f_4.f_20));
	}
	vVar3 = {func_119(uParam0, uParam1, iVar0, iParam2, func_281(uParam1.f_247), iParam3, iParam4, iParam5, iParam6)};
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1.f_247) && is_entity_attached(*uParam1.f_247))
	{
		detach_entity(*uParam1.f_247, 1, true);
	}
	...
	func_157(uParam0);
	func_107(uParam0, uParam1.f_247, iParam3, iParam4, iParam5, iParam6);
	iVar2 = 1 - iParam2;
...
void func_107(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	
	if (func_44(func_263(uParam0)) == 17 && get_random_float_in_range(0f, 1065353216) < 0.5f)
	{
...
void func_108(auto uParam0, char* sParam1, char* sParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, int iParam10)
{
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_110(iParam3), 0);
}
...
struct<8> func_111(auto uParam0)
{
	return *uParam0.f_86;
}

void func_112(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
...
void func_113(int iParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if ((is_entity_visible(iParam0) && !iParam1) || (!is_entity_visible(iParam0) && iParam1))
		{
			set_entity_visible(iParam0, iParam1, 0);
			_0xB2D0BDE54F0E8E5A(iParam0, iParam1);
		}
	}
}
...
Vector3 func_115(int iParam0, Vector3 vParam1, Vector3 vParam2)
{
	if (iParam0)
	{
		return vParam1;
...
Vector3 func_119(auto uParam0, auto uParam1, int iParam2, int iParam3, Vector3 vParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_120(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
	auto uVar0;
	auto uVar1;
	int iVar2;
	...
	uVar0 = func_49(*uParam0.f_1 == 0, 3, 1);
	uVar1 = func_49(*uParam0.f_1 == 0, 2, 0);
	iVar2 = 1 - iParam4;
	...
	else if (*uParam0.f_4.f_20 == 1)
	{
		...
		vVar16 = {*(uParam1.f_189.f_3[uVar1 /*3*/]) - *(uParam1.f_189.f_3[uVar0 /*3*/]) * Vector(0.5f, 0.5f, 0.5f)};
		if (vdist2(*uParam3, *(uParam1.f_189.f_3[uVar0 /*3*/])) > vdist2(*uParam3, *(uParam1.f_189.f_3[uVar1 /*3*/])))
		{
			vVar10 = {*(uParam1.f_189.f_3[uVar0 /*3*/])};
			vVar13 = {vVar10 + vVar16};
		}
		else
		{
			vVar10 = {*(uParam1.f_189.f_3[uVar0 /*3*/]) + vVar16};
			vVar13 = {*(uParam1.f_189.f_3[uVar1 /*3*/])};
		}
	...
	else if (*uParam0.f_4.f_20 == 2)
	{
		...
		fVar33 = get_random_float_in_range(0f, 1065353216);
...
Vector3 func_121(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2)
{
	return Vector(1f - fParam6, 1f - fParam6, 1f - fParam6) * vParam0 + Vector(fParam6, fParam6, fParam6) * vParam3;
}

Vector3 func_122(auto uParam0, auto uParam1, Vector3 vParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	vVar3 = {0f, 0f, 0f};
	vVar6 = {0f, 0f, 0f};
	uVar9 = func_49(*uParam0.f_1 == 0, 3, 1);
	uVar10 = func_49(*uParam0.f_1 == 0, 2, 0);
	...
	{
		fVar14 = func_123(0.4f, 1f, get_random_float_in_range(0f, 1065353216));
	...
	vVar15 = {_0x21C235BC64831E5A(*uParam0.f_37, *(uParam1.f_3[uVar9 /*3*/]), *(uParam1.f_3[uVar10 /*3*/]), 1)};
	if (absi(iParam5) > 15)
	{
		if (iParam5 > 0)
		{
			fVar18 = to_float(iParam5) / to_float(128);
			vVar19 = {func_121(vVar15, *(uParam1.f_3[uVar10 /*3*/]) + vVar6, fVar18)};
		}
		else
		{
			fVar18 = to_float(iParam5) / to_float(-128);
			vVar19 = {func_121(vVar15, *(uParam1.f_3[uVar9 /*3*/]) + vVar3, fVar18)};
		}
...
float func_123(float fParam0, float fParam1, Vector3 fParam2)
{
...
int func_125(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			if (get_random_float_in_range(0f, 1065353216) < 0.3f)
			{
				if (get_random_float_in_range(0f, 1065353216) < 0.5f)
				{
					return 1;
				}
				else
		...
		case 2:
			if (get_random_float_in_range(0f, 1065353216) < 0.2f)
			{
				if (get_random_float_in_range(0f, 1065353216) < 0.6f)
				{
					return 1;
				}
				else
...
void func_127(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_128(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	Vector3 vVar0;
	float fVar3;
...
bool func_129(auto uParam0, auto uParam1, auto uParam2, float fParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = (*uParam0.f_31 != 4 || *uParam0.f_4.f_20 > 0);
	iVar2 = iParam4 < 1;
	if (!iVar1)
	{
		return false;
...
auto func_131(auto uParam0, auto uParam1, Vector3 vParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
	auto uVar6;
...
bool func_132(auto uParam0, auto uParam1, Vector3 vParam2, int iParam3)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	if (!PED::IS_PED_INJURED(func_263(uParam0)) && _0xE95B0C7D5BA3B96B(func_263(uParam0)))
	{
		return false;
	}
	...
	set_entity_coords(*uParam1, vVar0, 1, false, 0, 1);
	return true;
}

int func_133(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	Vector3 vVar0;
	auto uVar3;
	auto uVar6;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		get_entity_matrix(iParam0, &uVar6, &uVar3, &vVar9, &vVar0);
...
auto func_135(auto uParam0)
{
	return *uParam0.f_56;
}

void func_136(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, Vector3 vParam6, int iParam7)
{
	float fVar0;
	int iVar1;
	char* sVar2;
	...
	if (!func_103(uParam1, 1024))
	{
		...
		sVar2 = "mini@tennis";
		uVar3 = func_193(fVar0 > 0f, "react_ball_out", "react_ball_out_lt");
		iVar4 = false;
		...
		if ((1 && !func_226(uParam0[iParam3 /*94*/].f_4, 256)) && GAMEPLAY::GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]))
		{
			...
			if (iParam9)
			{
				iVar4 = *uParam2[0 /*8*/] + *uParam2[1 /*8*/] + 1 % 6 == false;
				if (GAMEPLAY::IS_BIT_SET(*uParam2[0 /*8*/] + *uParam2[1 /*8*/] + 1, false) || iVar4)
				{
					iParam5 = 1;
					iParam4 = 1 - iParam4;
				}
...
int func_138(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (iVar0 == 72)
	{
		iVar19 = func_142(uParam0, &vVar20, &vVar23, &vLocal_234, &vLocal_240, &vLocal_243, 0, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
	...
	{
		iVar19 = func_142(uParam0, &vVar20, &vVar23, &vLocal_222, &vLocal_228, &vLocal_231, 1, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
			func_141(uParam0, 0.5f);
			func_140(uParam0, 1f);
...
void func_141(auto uParam0, float fParam1)
{
	*uParam0.f_70 = fParam1;
}

int func_142(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, int iParam6, float fParam7, float fParam8, auto uParam9)
{
	float fVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	*fParam8 = _0x7F8F6405F4777AF6(vVar9, func_115(iParam6, *uParam5, *uParam4), func_115(iParam6, *uParam4, *uParam5), 0);
...
bool func_143(auto uParam0, auto uParam1, auto uParam2, Vector3 vParam3, auto uParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
void func_144(auto uParam0, auto uParam1, auto uParam2)
{
	Vector3 fVar0;
	Vector3 fVar1;
	float fVar2;
	...
	else
	{
		...
		fVar4 = get_random_float_in_range(0f, 1065353216);
		if (fVar4 < fVar3)
		{
			func_228(uParam0, 2);
		}
...
void func_146(auto uParam0, auto uParam1)
{
...
void func_148(auto uParam0)
{
	...
	switch (func_145(uParam0))
	{
		...
		default:
			fVar0 = get_random_float_in_range(0f, 1065353216);
...
int func_149(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
				...
				if (*(uParam3[iVar32 /*12*/]).f_1 >= 0f)
				{
					...
					if (iVar3 < *uParam4 - 2 && iVar3 >= 0)
					{
						if (iVar24 == 0 && (iVar32 == 72 || iVar32 == 73))
						{
							...
							if (iVar32 == 72)
							{
								iVar37 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_234, &vLocal_240, &vLocal_243, 0, &fVar38, &fVar39, &vVar28);
							}
							else
							{
								iVar37 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_222, &vLocal_228, &vLocal_231, 1, &fVar38, &fVar39, &vVar28);
							}
							if (iVar37 != 0)
							{
...
bool func_151(auto uParam0, Vector3 vParam1, int iParam2)
{
	if (!iParam4)
	{
		return false;
...
{
	*uParam0.f_64 += get_frame_time();
}

void func_155(auto uParam0)
{
	*uParam0.f_60 += get_frame_time();
}

void func_156(auto uParam0)
{
	*uParam0.f_61 += get_frame_time();
}
...
auto func_158(auto uParam0)
{
	return *uParam0.f_61;
}

void func_159(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 fVar0;
	float fVar1;
...
bool func_160(auto uParam0, auto uParam1, int iParam2)
{
...
bool func_164(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4, int iParam5, Vector3 vParam6, int iParam7)
{
	...
	func_136(uParam0, uParam1, uParam2, iParam3, iParam4, iParam5, vParam6, iParam9);
...
{
	*uParam0.f_68 += get_frame_time();
}

void func_168(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	
	iVar0 = false;
	*uParam1.f_247.f_33 -= get_frame_time();
...
void func_169(auto uParam0, Vector3 vParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
void func_171(auto uParam0, float fParam1)
{
	*uParam0.f_69 = fParam1;
}

void func_172(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
...
void func_173(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
...
auto func_175(auto uParam0)
{
	return *uParam0.f_1;
}

void func_176(auto uParam0, auto uParam1, int iParam2)
{
...
void func_179(auto uParam0, auto uParam1)
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_180(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	int iVar0;
	struct<2> Var1;
	float fVar3;
	...
	if (func_103(uParam2, 4))
	{
		...
		else if (*uParam2.f_4.f_20 == 0)
		{
			...
			iVar0 = func_49(get_random_float_in_range(0f, 1065353216) < 0.2f, 6, iVar12);
		}
		else if (*uParam2.f_4.f_20 == 1)
		{
			iVar12 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 4);
			iVar0 = func_49(get_random_float_in_range(0f, 1065353216) < 0.1f, 6, iVar12);
		}
		else if (*uParam2.f_4.f_20 == 2)
		{
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
		}
		vVar6 = {func_121(vVar9, vVar6, get_random_float_in_range(0f, 1065353216))};
		...
		*uParam2 = fVar5;
		...
		detach_entity(*uParam0.f_247, 0, true);
...
void func_181(auto uParam0, auto uParam1, auto uParam2)
{
	Vector3 fVar0;
	Vector3 vVar1;
	
	fVar0 = *uParam1;
	vVar1 = {func_182(to_float(*uParam2), to_float(*uParam2.f_1), fVar0, uParam1.f_40, uParam1.f_43)};
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_247))
	{
		if (*uParam0.f_1657 != 1 && !func_273(uParam0.f_247))
		{
...
Vector3 func_182(Vector3 fParam0, Vector3 fParam1, Vector3 fParam2, auto uParam3, auto uParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_183(auto uParam0, Vector3 fParam1, Vector3 vParam2)
{
	Vector3 fVar0;
	Vector3 fVar1;
...
float func_188(struct<2> Param0, auto uParam1, struct<2> Param2, Vector3 fParam3)
{
...
char* func_193(int iParam0, char* sParam1, char* sParam2)
{
	if (iParam0)
	{
		return sParam1;
...
bool func_197(auto uParam0, auto uParam1, int iParam2, auto uParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		func_156(uParam0);
		if ((is_control_just_pressed(0, 223) && !iParam4) || (func_158(uParam0) > 30f && *uParam1.f_1657 == 4))
		{
		...
		if (func_103(uParam0, 4))
		{
			...
			detach_entity(*uParam1.f_247, 0, true);
		...
		if (func_158(uParam0) > 30f || (is_control_just_pressed(0, 223) && !iParam4))
		{
			func_157(uParam0);
		}
	}
...
int func_201(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	float fVar0;
	Vector3 vVar1;
	Vector3 vVar4;
...
bool func_212(auto uParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return false;
	}
	else if ((!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && ((uParam4 || iParam3 == 4) || iParam3 == 1)) && !func_103(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_27(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
	...
	{
		if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && _0x921CE12C489C4C41(func_263(uParam0[iParam1 /*94*/])))
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0[iParam1 /*94*/])), "Intro") && _0x30ED88D5E0C56A37(func_263(uParam0[iParam1 /*94*/])))
			{
...
void func_215(auto uParam0, int iParam1)
{
	func_253(uParam0.f_25, iParam1);
}

void func_216(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	Vector3 fVar0;
	Vector3 vVar1;
	Vector3 fVar4;
	...
	if (!PED::IS_PED_INJURED(*uParam0.f_32) && *uParam0.f_36 == 75)
	{
		...
		if ((*uParam1.f_1657 != 1 && !iParam5) && !func_222(player_id(), 0))
		{
			func_221(uParam1, iParam3, 1);
			set_entity_coords(*uParam0.f_32, vVar1, 1, false, 0, 1);
		...
		else
		{
			...
			fVar4 = get_heading_from_vector_2d(*uParam0.f_40, *uParam0.f_40.f_1) + func_323(iParam6, 180f, 0f);
			vVar5 = {*uParam1.f_189.f_29 - ENTITY::GET_ENTITY_COORDS(*(uParam1[iParam3 /*94*/]).f_32, 1)};
			iVar8 = func_68(vVar5, *uParam0.f_40) < 0f;
			iVar9 = func_68(vVar5, *uParam0.f_43) < 0f;
			iVar10 = false;
			func_220(uParam0, 0);
			...
			if (!iParam6 && iParam7)
			{
				...
				AI::TASK_PLAY_ANIM(false, func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar10, 0, 0, 0, 0, 0);
			}
			if (!iParam8)
			{
			...
			if ((iParam6 && !iVar8) || (!iParam6 && iVar8))
			{
				...
				if (!iVar9 && (!iParam6 && iVar8))
				{
					vVar11 = {*uParam1.f_189.f_29 + *uParam0.f_43 * Vector(-7.2f, -7.2f, -7.2f)};
				}
				if (func_218(uParam1, uParam0))
				{
					task_go_straight_to_coord(false, vVar11, 1f, 20000, 1193033728, 0.5f);
				}
				else
				{
					task_follow_nav_mesh_to_coord(false, vVar11, 1f, 20000, 0.25f, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
...
bool func_217(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3, float fParam4)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_218(auto uParam0, auto uParam1)
{
...
auto func_224(auto uParam0)
{
	return *uParam0.f_23;
}

void func_225(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	Vector3 fVar0;
	Vector3 vVar1;
	Vector3 fVar4;
	...
	if (!PED::IS_PED_INJURED(*uParam0.f_32) && *uParam0.f_36 == 75)
	{
		...
		if ((*uParam1.f_1657 != 1 && !iParam7) && !func_222(player_id(), 0))
		{
			if (!((!PED::IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0))) && GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "running")))
			{
				func_221(uParam1, iParam3, 1);
			}
			set_entity_coords(*uParam0.f_32, vVar1, 1, true, 0, 1);
			fVar0 = get_heading_from_vector_2d(-*uParam1.f_1658, -*uParam1.f_1658.f_1);
			if (*uParam0.f_1 == 0)
			{
				fVar0 += 180f;
		...
		else
		{
			set_entity_heading(*uParam0.f_32, get_entity_heading(*uParam0.f_32));
			func_57(uParam0, 16384);
			fVar4 = get_heading_from_vector_2d(*uParam0.f_40, *uParam0.f_40.f_1) + func_323(iParam8, 180f, 0f);
			vVar5 = {*uParam1.f_189.f_29 - ENTITY::GET_ENTITY_COORDS(*(uParam1[iParam3 /*94*/]).f_32, 1)};
			iVar8 = func_68(vVar5, *uParam0.f_40) < 0f;
			iVar9 = func_68(vVar5, *uParam0.f_43) < 0f;
			func_220(uParam0, 0);
			...
			if ((iParam8 && !iVar8) || (!iParam8 && iVar8))
			{
				...
				if (!iVar9 && (!iParam8 && iVar8))
				{
					vVar10 = {*uParam1.f_189.f_29 + *uParam0.f_43 * Vector(-7.2f, -7.2f, -7.2f)};
				}
				if (func_218(uParam1, uParam0))
				{
					task_go_straight_to_coord(false, vVar10, 1f, 20000, 1193033728, 0.5f);
				}
				else
				{
					task_follow_nav_mesh_to_coord(false, vVar10, 1f, 20000, 0.25f, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
			task_follow_nav_mesh_to_coord(false, vVar1, 1f, 20000, 0.25f, 0, fVar4);
	...
	if (!iParam7 && *uParam1.f_1657 != 1)
	{
		...
		{
			iVar13 = (*uParam1.f_1657 != 1 && !iParam7);
			sVar14 = func_193(iVar13, "TennisServeSet", "TennisServeSetWithIntro");
...
void func_230(int iParam0, int iParam1)
{
	if (iParam0 != 1)
	{
		if (iParam1)
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !is_player_control_on(get_player_index()))
			{
				set_player_control(get_player_index(), true, 0);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_player_control_on(get_player_index()))
		{
...
void func_234(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (((*uParam0.f_31 != 3 && !iParam4) && !PED::IS_PED_INJURED(func_263(uParam0))) && !PED::IS_PED_RAGDOLL(func_263(uParam0)))
	{
		...
		{
			uVar6 = func_68(*uParam0.f_43, func_281(uParam1.f_247) - *uParam0.f_37);
			_0x54F157E0336A3822(func_263(uParam0), "ForcedStopDirection", uVar6);
		}
	}
	else if (*uParam0.f_31 != 3)
	{
		...
		if (!PED::IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0)))
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "Intro") && _0x30ED88D5E0C56A37(func_263(uParam0)))
			{
			...
			{
				fVar16 = get_random_float_in_range(0f, 1065353216);
				StringCopy(uParam1.f_1670, func_193(fVar16 < 0.33f, "Idle3", func_193(fVar16 < 0.66f, "Idle4", "Idle1")), 8);
			}
			_0xB0A6CFD2C69C1088(func_263(uParam0), uParam1.f_1670, 1);
			_0xD5BB4025AE449A4E(func_263(uParam0), "Speed", *uParam0.f_62);
		}
	}
	if (((func_74(uParam0) == 75 && ENTITY::DOES_ENTITY_EXIST(*uParam1.f_247)) && has_entity_collided_with_anything(*uParam1.f_247)) && vdist2(*uParam0.f_37, func_281(uParam1.f_247)) < 0.88f * 0.88f)
	{
		func_57(uParam0, 256);
...
void func_235(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_236(auto uParam0, int iParam1, int iParam2)
{
	if ((get_rain_level() <= 0f && get_snow_level() <= 0f) && func_74(uParam0) == 75)
	{
		if (absf(to_float(iParam1)) >= absf(to_float(iParam2)))
		{
			if (iParam1 > 15)
			{
				if (*uParam0.f_35 != 3 && get_random_float_in_range(0f, 1065353216) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (get_random_float_in_range(0f, 1065353216) < 0.1f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				*uParam0.f_35 = 3;
			...
			{
				if (*uParam0.f_35 != 2 && get_random_float_in_range(0f, 1065353216) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (get_random_float_in_range(0f, 1065353216) < 0.1f)
			...
			{
				if (*uParam0.f_35 != 4 && get_random_float_in_range(0f, 1065353216) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				*uParam0.f_35 = 4;
		...
		else if (absf(to_float(iParam1)) < absf(to_float(iParam2)))
		{
			if (iParam2 > 15)
			{
				if (*uParam0.f_35 != 1 && get_random_float_in_range(0f, 1065353216) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (get_random_float_in_range(0f, 1065353216) < 0.1f)
			...
			{
				if (*uParam0.f_35 != 0 && get_random_float_in_range(0f, 1065353216) < 0.08f)
				{
					play_sound_from_entity(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (get_random_float_in_range(0f, 1065353216) < 0.1f)
...
void func_237(auto uParam0, int iParam1, int iParam2, auto uParam3, auto uParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	switch (func_145(uParam0.f_4))
	{
		...
		case 5:
			if (func_74(uParam0) == 75)
			{
				...
				{
					task_go_straight_to_coord(func_263(uParam0), vVar3, 2f, -1, 1193033728, 0.5f);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(*uParam0.f_32, func_69(uParam0.f_4), vVar6, false, true, 0) || AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7) && !func_226(uParam0.f_4, 256))
				{
					func_233(uParam0.f_4, 0);
					func_215(uParam0.f_4, 4);
				}
		...
		case 1:
			if (func_74(uParam0) == 75)
			{
				...
				if (((!PED::IS_PED_INJURED(func_263(uParam0)) && !vdist2(*uParam0.f_37, vVar3) <= 0f * 0f) && !func_226(uParam0.f_4, 4)) && !func_103(uParam0, 1024))
				{
					task_go_straight_to_coord(*uParam0.f_32, func_69(uParam0.f_4), 2f, -1, 1193033728, 0.5f);
					vVar3 = {func_69(uParam0.f_4)};
					func_240(uParam0.f_4, vVar3);
					func_79(uParam0.f_4, 4);
				...
				else if (vdist2(*uParam0.f_37, vVar3) <= 0f * 0f || AI::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7)
				{
...
{
	*uParam0.f_24 -= get_frame_time();
}

auto func_239(auto uParam0)
{
	return *uParam0.f_24;
}

void func_240(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_3 = {vParam1};
}

bool func_241(auto uParam0, auto uParam1, auto uParam2)
{
	if (func_103(uParam0, 1024))
	{
		return false;
...
void func_243(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_246(auto uParam0, auto uParam1)
{
	float fVar0;
...
{
	*uParam0.f_63 += get_frame_time();
}

void func_248(auto uParam0, float fParam1)
{
	*uParam0.f_72 = fParam1;
}

auto func_249(auto uParam0)
{
	return *uParam0.f_72;
}

int func_250(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
auto func_251(auto uParam0)
{
	return *uParam0.f_1672;
}

auto func_252(auto uParam0)
{
	return *uParam0.f_77;
}
...
void func_254(auto uParam0, auto uParam1)
{
	*uParam0 -= (*uParam0 && uParam1);
}
...
void func_258(auto uParam0, int iParam1)
{
...
void func_260(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_263(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!iParam4)
			{
				attach_entity_to_entity(*(uParam0[iParam1 /*94*/]).f_33, func_263(uParam0[iParam1 /*94*/]), get_ped_bone_index(func_263(uParam0[iParam1 /*94*/]), 28422), vLocal_216, vLocal_219, 0, 0, 0, 0, 2, 1);
			}
			attach_entity_to_entity(*(uParam0[iParam2 /*94*/]).f_33, func_263(uParam0[iParam2 /*94*/]), get_ped_bone_index(func_263(uParam0[iParam2 /*94*/]), 28422), vLocal_216, vLocal_219, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_265(auto uParam0, int iParam1)
{
	...
	*uParam0.f_247 = create_object(joaat("prop_tennis_ball"), vVar0, 0, false, false);
...
{
	if (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\Tennis", false))
	{
		if (*uParam0.f_1657 != 1)
		{
		}
	...
	if (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\TENNIS_VER2_A", false))
	{
		if (*uParam0.f_1657 != 1)
		{
		}
...
Vector3 func_268(auto uParam0, int iParam1, Vector3 vParam2, Vector3 vParam3, int iParam4, int iParam5)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_271(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	int iVar1;
...
int func_273(auto uParam0)
{
	return does_particle_fx_looped_exist(*uParam0.f_23);
}

void func_274(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_7 = {vParam1};
}
...
int func_277(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7, int iParam8, float fParam9, int iParam10, float fParam11, int iParam12)
{
	Vector3 vVar0;
	float fVar3;
	int iVar4;
	...
	vVar0 = {0f, 0f, 1f};
	fVar3 = func_323(fParam9 == -1f, get_frame_time(), fParam9);
	iVar4 = 0;
	...
	*uParam4 += fVar3;
	...
	unk_0x0A25F80D5BADC013(*uParam0.f_29 + Vector(1f, 0f, 0f), *uParam0.f_29 + Vector(1f, 0f, 0f) + vVar6, 0, 0, 255, 255);
...
Vector3 func_278(Vector3 vParam0, float fParam1)
{
	...
	vVar0 = {0f, 0f, -9.8f};
	fVar3 = vmag(vParam0);
	vVar4 = {-vParam0 * Vector(fVar3 * 0.065f, fVar3 * 0.065f, fVar3 * 0.065f)};
	vVar4 = {vVar4 + vVar0};
...
int func_280(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, float fParam6)
{
	float fVar0;
	Vector3 vVar1;
	Vector3 vVar4;
...
Vector3 func_281(auto uParam0)
{
	return *uParam0.f_7;
}

bool func_282(auto uParam0, int iParam1, auto uParam2, int iParam3)
{
	if (iParam3 < 8)
	{
		return false;
...
int func_283(auto uParam0, auto uParam1, auto uParam2, auto uParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
auto func_284(auto uParam0)
{
	return *uParam0.f_1;
}

void func_285(auto uParam0, int iParam1)
{
	func_253(uParam0.f_24, iParam1);
}

int func_286(auto uParam0, int iParam1)
{
...
void func_288(auto uParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5)
{
	int iVar0;
	...
	if (!func_227(uParam0, 1))
	{
		iVar0 = !PED::IS_PED_INJURED(func_263(uParam0[uParam3 /*94*/]));
		if (((iVar0 && !iParam5) && !func_226(uParam0[uParam3 /*94*/].f_4, 256)) || ((iVar0 && func_103(uParam0[uParam3 /*94*/], 8192)) && *uParam0.f_1657 == 1))
		{
			*(uParam0[uParam3 /*94*/].f_37) = {ENTITY::GET_ENTITY_COORDS(func_263(uParam0[uParam3 /*94*/]), 1)};
			func_20(iParam1, uParam0[uParam3 /*94*/], uParam2, func_103(uParam0[uParam3 /*94*/], 8192));
		}
		iVar0 = (!PED::IS_PED_INJURED(func_263(uParam0[uParam4 /*94*/])) && ENTITY::DOES_ENTITY_EXIST(func_263(uParam0[uParam4 /*94*/])));
		if (((iVar0 && !iParam5) && !func_226(uParam0[uParam4 /*94*/].f_4, 256)) || ((iVar0 && func_103(uParam0[uParam4 /*94*/], 8192)) && *uParam0.f_1657 == 1))
		{
			*(uParam0[uParam4 /*94*/].f_37) = {ENTITY::GET_ENTITY_COORDS(func_263(uParam0[uParam4 /*94*/]), 1)};
			func_20(iParam1, uParam0[uParam4 /*94*/], uParam2, func_103(uParam0[uParam4 /*94*/], 8192));
		}
	}
}
...
void func_289(auto uParam0, Vector3 vParam1)
{
	...
	if (func_286(uParam0, 1))
	{
		if (!func_273(uParam0))
		{
			*uParam0.f_23 = start_particle_fx_looped_at_coord("scr_tennis_ball_trail", vParam1, 0f, 0f, 0f, 1f, 0, 0, 0, 1);
			get_hud_colour(12, &iVar0, &iVar1, &iVar2, &uVar3);
			set_particle_fx_looped_colour(*uParam0.f_23, to_float(iVar0) / 255f, to_float(iVar1) / 255f, to_float(iVar2) / 255f, 0);
			uVar3 = uVar3;
		}
...
{
	*uParam0.f_6 += get_frame_time();
}

bool func_299(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_shooting(PLAYER::PLAYER_PED_ID()))
	{
		if (!PED::IS_PED_INJURED(iVar0))
		{
			task_seek_cover_from_ped(iVar0, PLAYER::PLAYER_PED_ID(), -1, 0);
		}
		if (!PED::IS_PED_INJURED(func_263(uParam0[1 - iParam1 /*94*/])))
		{
			task_seek_cover_from_ped(func_263(uParam0[1 - iParam1 /*94*/]), PLAYER::PLAYER_PED_ID(), -1, 0);
		}
		return true;
	}
	if (PED::IS_PED_INJURED(iVar0))
...
void func_302(auto uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*(uParam0[0 /*94*/]).f_33))
	{
		detach_entity(*(uParam0[0 /*94*/]).f_33, 1, true);
		set_object_as_no_longer_needed(uParam0[0 /*94*/].f_33);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_247))
	{
		detach_entity(*uParam0.f_247, 1, true);
		set_object_as_no_longer_needed(uParam0.f_247);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*(uParam0[1 /*94*/]).f_33))
	{
		detach_entity(*(uParam0[1 /*94*/]).f_33, 1, true);
...
void func_306(auto uParam0)
{
	*uParam0.f_1672 += round(get_frame_time() * 1000f);
}

void func_307(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, auto uParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	Vector3 vVar3;
	int iVar6;
...
void func_308(auto uParam0, auto uParam1)
{
	*uParam0.f_27 = uParam1;
}

void func_309(auto uParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3, Vector3 vParam4)
{
...
void func_314(auto uParam0, int iParam1, int iParam2, Vector3 vParam3, Vector3 vParam4)
{
	*uParam0.f_36 = 75;
	*uParam0.f_1 = iParam1;
...
void func_317(auto uParam0, auto uParam1, int iParam2)
{
	float fVar0;
	float fVar1;
	...
	if (*uParam1.f_1656 == 16 && *uParam1.f_1657 != 1)
	{
		...
		*uParam1.f_1664 = {func_185(*uParam1.f_1661, *uParam1.f_1658)};
		func_321(uParam0, vmag(*uParam1.f_1661));
...
void func_318(auto uParam0, auto uParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_319(auto uParam0, float fParam1)
{
	*uParam0.f_2 = fParam1;
}
...
void func_321(auto uParam0, float fParam1)
{
	*uParam0.f_1 = fParam1;
}

auto func_322(auto uParam0)
{
	float fVar0;
	float fVar1;
	Vector3 vVar2;
...
float func_323(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_327(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_329(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_329(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
