...
void func_3()
{
	...
	if (func_42(2, 0, 0, 0, 0))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_640.f_2), false);
	...
	switch (Local_640.f_37)
	{
		...
		case 3:
			if (func_1(&(Local_640.f_39), func_28(0), 0) || GAMEPLAY::IS_BIT_SET(Local_640.f_2, false))
			{
				...
				{
					Local_640.f_1 = NETWORK::GET_NETWORK_TIME();
					GAMEPLAY::SET_BIT(&(Local_640.f_2), true);
...
bool func_4()
{
	...
	while (iVar0 < 10)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_640.f_67[iVar0 /*2*/].f_1) && !ENTITY::IS_ENTITY_DEAD(net_to_ent(Local_640.f_67[iVar0 /*2*/].f_1), 0))
		{
			return false;
		}
		iVar0++;
...
void func_13()
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		...
		{
			func_23(iVar0);
			GAMEPLAY::SET_BIT(&(Local_640.f_47), iVar0);
			iVar1++;
			if (func_17(iVar0, 0))
			{
...
void func_23(int iParam0)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_640.f_48, iParam0))
	{
		...
		{
			Local_640.f_49++;
			GAMEPLAY::SET_BIT(&(Local_640.f_48), iParam0);
		}
	}
	iVar3 = -1;
	iVar4 = -2;
		...
		while (iVar0 < 10)
		{
			if (Local_640.f_55[iVar0] == participant_id_to_int())
			{
				if (func_98(iVar0))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_2760[participant_id_to_int() /*12*/].f_2), iVar0);
					}
				}
	...
	if (iParam4 && !iParam7)
	{
		if (func_12(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_36(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_101(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_36(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
				...
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_101(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_36(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
void func_109()
{
	if (Local_640.f_37 == 5)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(net_to_veh(Local_640.f_67[iLocal_350 /*2*/].f_1), 0))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_626, iLocal_350))
				{
					GAMEPLAY::SET_BIT(&iLocal_626, iLocal_350);
		...
		switch (iParam0)
		{
			...
			case 4:
				...
				else
				{
					...
					if (is_this_model_a_bike(iVar1) && VEHICLE::IS_THIS_MODEL_A_BICYCLE(iVar1))
					{
						return "AMCH_PREPBIKE";
					}
				}
...
void func_139()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_2760[participant_id_to_int() /*12*/].f_1, false))
	{
		if (func_7(player_id()))
		{
			GAMEPLAY::SET_BIT(&(Local_2760[participant_id_to_int() /*12*/].f_1), false);
			return;
		}
...
void func_233()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_2760[participant_id_to_int() /*12*/].f_1, true) && (func_245() || GAMEPLAY::IS_BIT_SET(Local_640.f_2, false)))
	{
		...
		if (func_12(player_id(), 1, 1))
		{
			...
			GAMEPLAY::SET_BIT(&(Local_2760[participant_id_to_int() /*12*/].f_1), true);
			func_234(133);
		}
	}
}
...
float func_261(int iParam0, auto uParam1)
{
	...
	{
		func_420(3);
		GAMEPLAY::SET_BIT(&iLocal_331, 10);
	...
	if (iVar2 == iLocal_332)
	{
		if (func_21(iVar2, 0))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_331, true))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_331, true);
			}
...
void func_291()
{
	...
	{
		GAMEPLAY::SET_BIT(&(Local_2760[participant_id_to_int() /*12*/].f_1), 2);
		func_292(1);
	}
}
				...
				if ((!func_319(&iVar2, 0) || ENTITY::GET_ENTITY_MODEL(iVar2) != joaat("dodo")) && is_entity_in_air(iVar2))
				{
					...
					if (func_311())
					{
						...
						if (iVar3 >= 0)
						{
							...
							{
								iLocal_334++;
								GAMEPLAY::SET_BIT(&(Local_2760[participant_id_to_int() /*12*/].f_8[func_309(iVar3)]), func_308(iVar3));
							}
						}
					}
					iVar0 = iLocal_334;
...
void func_312(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iLocal_97)
	{
		case 0:
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_107[iLocal_96 /*3*/]) < fLocal_303)
				{
...
void func_314(auto uParam0, auto uParam1)
{
	...
	vLocal_104 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)};
	fVar1 = 1E+07f;
	iVar0 = 0;
	while (iVar0 < 65)
	{
...
void func_359(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_360())
	{
		return;
	}
		...
		if (func_12(player_id(), 1, 1))
		{
			...
			while (iVar4 < 10)
			{
				...
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(iVar14) && is_vehicle_driveable(net_to_veh(iVar14), 0))
				{
					...
					{
						vVar15 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(iVar14), 1)};
			...
			if (func_5(Local_640.f_3))
			{
				if ((is_ped_in_flying_vehicle(PLAYER::PLAYER_PED_ID()) || (is_entity_in_air(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))) || func_17(-1, 0))
				{
		...
		while (iVar5 < 10)
		{
			if (((!iParam0 && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_640.f_67[iVar5 /*2*/].f_1)) && is_vehicle_driveable(net_to_veh(Local_640.f_67[iVar5 /*2*/].f_1), 0)) && is_vehicle_seat_free(net_to_veh(Local_640.f_67[iVar5 /*2*/].f_1), -1))
			{
				...
				else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (vdist(vVar6, ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_640.f_67[iVar5 /*2*/].f_1), 1)) <= 150f)
					{
			...
			case 0:
				if (!GAMEPLAY::IS_BIT_SET(iLocal_624, iParam0))
				{
					if (!is_pause_menu_active() && !is_help_message_being_displayed())
					{
						...
						func_249(1);
						GAMEPLAY::SET_BIT(&iLocal_624, iParam0);
					}
				}
				break;
