...
void main()
{
	...
	while (true)
	{
		if (is_entity_dead(iLocal_311, 0))
		{
			func_83(0);
		}
		func_82();
		vLocal_312 = {get_entity_coords(iLocal_311, 1)};
		switch (iLocal_310)
		{
			case 0:
				func_80();
...
void func_4()
{
	...
	if (iLocal_51 == 1)
	{
		...
		{
			if (is_entity_in_angled_area(player_ped_id(), 1766.972f, 2409.596f, 43.55469f, 1826.647f, 2471.633f, 56.30863f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
	...
	else if (iLocal_51 == 2)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1662.31f, 2391.06f, 43.51377f, 1761.362f, 2405.143f, 56.65472f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 3)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1537.369f, 2465.132f, 43.5756f, 1655.663f, 2391.822f, 56.54404f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 4)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1529.153f, 2584.264f, 43.6168f, 1535.014f, 2469.253f, 56.5985f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 5)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1565.045f, 2681.205f, 43.50552f, 1529.915f, 2586.427f, 56.52686f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 6)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1645.169f, 2760.33f, 43.6705f, 1567.113f, 2682.905f, 56.39177f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 7)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1772.306f, 2766.364f, 43.59126f, 1650.228f, 2761.691f, 56.53028f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 8)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1831.435f, 2623.257f, 43.46658f, 1851.659f, 2696.404f, 56.68093f, 12f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 10)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1829.468f, 2480.96f, 43.52237f, 1836.998f, 2566.856f, 60.35412f, 20.5f, 0, true, 0))
			{
				if (!iLocal_103)
				{
					set_ambient_zone_state("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
...
void func_5()
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			...
			iLocal_126 = create_ped_inside_vehicle(iLocal_124, 6, joaat("s_m_y_cop_01"), -1, 1, true);
			func_26(&iLocal_126);
			iLocal_50++;
			break;
		...
		case 2:
			...
			if ((func_16(iLocal_126, iLocal_124, &Local_128, &uLocal_135, 0, 1, 0, 1, 1) || func_16(iLocal_127, iLocal_125, &Local_128, &uLocal_135, 0, 1, 0, 1, 1)) || (func_15(vVar0, 4, 20, 0) && !is_ped_in_flying_vehicle(player_ped_id())))
			{
				...
				{
					task_combat_ped(iLocal_126, player_ped_id(), 0, 16);
				}
		...
		case 3:
			if (func_14(&iLocal_136))
			{
				if (func_8(&iLocal_136) > 15f)
				{
					...
					iLocal_127 = create_ped_inside_vehicle(iLocal_125, 6, joaat("s_m_y_cop_01"), -1, 1, true);
					func_26(&iLocal_127);
					task_combat_ped(iLocal_127, player_ped_id(), 0, 16);
					iLocal_50++;
				}
...
bool func_7(vector3 vParam0, vector3 vParam1, float fParam2)
{
	...
	{
		if (((does_entity_exist(iLocal_124) && does_entity_exist(iLocal_126)) && does_entity_exist(iLocal_125)) && does_entity_exist(iLocal_127))
		{
			if (is_entity_occluded(iLocal_124) || !is_entity_on_screen(iLocal_124))
			{
				if (is_entity_occluded(iLocal_126) || !is_entity_on_screen(iLocal_126))
				{
					if (is_entity_occluded(iLocal_125) || !is_entity_on_screen(iLocal_125))
					{
						if (is_entity_occluded(iLocal_127) || !is_entity_on_screen(iLocal_127))
						{
							return true;
						}
					}
...
bool func_16(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
...
var func_19(int iParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_22(int iParam0, int iParam1, var uParam2, int iParam3)
{
	vector3 vVar0;
	int iVar3;
...
void func_27()
{
	...
	if (iLocal_574)
	{
		if (!is_entity_dead(iLocal_569, 0))
		{
			...
			if (iLocal_572)
			{
				vVar3 = {get_entity_coords(iLocal_569, 1)};
...
void func_30()
{
	...
	while (iVar0 < 3)
	{
		if (((does_entity_exist(iLocal_408[iVar0]) && !is_entity_dead(iLocal_408[iVar0], 0)) && does_entity_exist(iLocal_404[iVar0])) && !is_entity_dead(iLocal_404[iVar0], 0))
		{
			...
			if (iLocal_412[iVar0])
			{
				if (!func_28())
				{
					if (!is_entity_dead(iLocal_404[iVar0], 0))
					{
						iLocal_412[iVar0] = 0;
	...
	if (does_entity_exist(iLocal_404[0]))
	{
		set_entity_heading(iLocal_404[0], 53f + fLocal_416);
	}
	if (does_entity_exist(iLocal_404[1]))
	{
		set_entity_heading(iLocal_404[1], 13f + fLocal_416);
	}
	if (does_entity_exist(iLocal_404[2]))
	{
...
void func_34()
{
	...
	if (!is_entity_dead(player_ped_id(), 0))
	{
		if (is_entity_in_angled_area(player_ped_id(), 1840.23f, 2471.49f, 41.94113f, 1840.553f, 2751.983f, 54.68177f, 84.25f, 0, true, 0))
		{
			func_57(&Local_128, 2);
		}
		else
		...
		if (!is_entity_dead(player_ped_id(), 0))
		{
			...
			if (is_ped_in_flying_vehicle(player_ped_id()))
			{
				if (func_15(vVar0, 4, 150, 0))
				{
					...
					if (!iLocal_118)
					{
						if (does_entity_exist(iLocal_126) && !is_entity_dead(iLocal_126, 0))
						{
...
void func_62()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			Local_629.f_27[iVar0] = create_ped(6, joaat("s_m_m_prisguard_01"), Local_629[iVar0 /*3*/], Local_629.f_10[iVar0], 1, true);
			wait(false);
		}
		iVar0++;
	}
	...
	Local_629.f_31[0] = create_ped(6, joaat("s_m_m_prisguard_01"), vVar1, Local_629.f_10[1], 1, true);
	Local_629.f_31[1] = create_ped(6, joaat("s_m_m_prisguard_01"), vVar4, Local_629.f_10[1], 1, true);
	Local_629.f_31[2] = create_ped(6, joaat("s_m_m_prisguard_01"), vVar7, Local_629.f_10[2], 1, true);
	Local_629.f_31[3] = create_ped(6, joaat("s_m_m_prisguard_01"), vVar10, Local_629.f_10[2], 1, true);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (does_entity_exist(Local_629.f_31[iVar0]))
...
void func_63()
{
	if (iLocal_574)
	{
		...
		iLocal_570 = create_ped(6, joaat("s_m_m_prisguard_01"), 10f, 10f, -20f, 0f, 1, true);
...
void func_66()
{
	...
	while (iVar0 < 10)
	{
		if (does_entity_exist(Local_318.f_64[iVar0]) && !is_entity_dead(Local_318.f_64[iVar0], 0))
		{
			...
			set_ped_config_flag(Local_318.f_64[iVar0], 132, true);
			...
			set_ped_combat_attributes(Local_318.f_64[iVar0], 13, true);
			set_ped_combat_attributes(Local_318.f_64[iVar0], 0, false);
			...
			set_ped_combat_attributes(Local_318.f_64[iVar0], 23, false);
...
void func_67()
{
	...
	if (!is_sphere_visible(1823.845f, 2621.267f, 57f, 0.5f))
	{
		...
		if (does_entity_exist(iLocal_404[0]) && !is_entity_dead(iLocal_404[0], 0))
		{
			iLocal_408[0] = create_ped_inside_vehicle(iLocal_404[0], 6, joaat("s_m_m_prisguard_01"), -1, 1, true);
			set_entity_can_be_damaged(iLocal_408[0], 0);
			set_ped_relationship_group_hash(iLocal_408[0], iLocal_316);
	...
	if (!is_sphere_visible(1761.418f, 2410.378f, 61f, 0.5f))
	{
		...
		if (does_entity_exist(iLocal_404[1]) && !is_entity_dead(iLocal_404[1], 0))
		{
			iLocal_408[1] = create_ped_inside_vehicle(iLocal_404[1], 6, joaat("s_m_m_prisguard_01"), -1, 1, true);
			set_entity_can_be_damaged(iLocal_408[1], 0);
			set_ped_relationship_group_hash(iLocal_408[1], iLocal_316);
	...
	if (!is_sphere_visible(1534.635f, 2585.162f, 61f, 0.5f))
	{
		...
		if (does_entity_exist(iLocal_404[2]) && !is_entity_dead(iLocal_404[2], 0))
		{
			iLocal_408[2] = create_ped_inside_vehicle(iLocal_404[2], 6, joaat("s_m_m_prisguard_01"), -1, 1, true);
			set_entity_can_be_damaged(iLocal_408[2], 0);
			set_ped_relationship_group_hash(iLocal_408[2], iLocal_316);
	...
	while (iVar0 < 3)
	{
		if ((does_entity_exist(iLocal_408[iVar0]) && !is_entity_dead(iLocal_408[iVar0], 0)) && !is_entity_dead(iLocal_404[iVar0], 0))
		{
			if (func_28())
			{
				iLocal_412[iVar0] = 1;
...
void func_68()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			Local_318.f_64[iVar0] = create_ped(6, joaat("s_m_m_prisguard_01"), Local_318[iVar0 /*3*/], Local_318.f_31[iVar0], 1, true);
			set_model_as_no_longer_needed(joaat("s_m_m_prisguard_01"));
			wait(false);
		}
		iVar0++;
...
void func_80()
{
	...
	set_relationship_between_groups(2, iLocal_316, iLocal_317);
	set_relationship_between_groups(2, iLocal_317, iLocal_316);
	set_relationship_between_groups(1, iLocal_316, -1533126372);
	set_relationship_between_groups(1, -1533126372, iLocal_316);
	set_relationship_between_groups(3, 1862763509, iLocal_317);
	set_relationship_between_groups(3, iLocal_317, 1862763509);
}
...
void func_82()
{
	if (!is_entity_dead(player_ped_id(), 0))
	{
		if ((is_entity_in_angled_area(player_ped_id(), 1879.956f, 2705.097f, 52.07341f, 1869.859f, 2726.776f, 59.82338f, 24.75f, 0, true, 0) || is_entity_in_angled_area(player_ped_id(), 1833.113f, 2520.888f, 52.26086f, 1833.115f, 2554.431f, 61.25998f, 15f, 0, true, 0)) || is_entity_in_angled_area(player_ped_id(), 1832.742f, 2568.421f, 48.87375f, 1833.015f, 2596.529f, 57.12439f, 27.75f, 0, true, 0))
		{
			if (get_player_wanted_level(player_id()) == 0)
			{
	...
	if (!iLocal_104)
	{
		if (!is_ped_injured(player_ped_id()))
		{
			if (is_entity_in_angled_area(player_ped_id(), 1917.889f, 2618.476f, -45.677f, 1822.889f, 2618.476f, 45.677f, 195f, 0, false, 0))
			{
...
void func_86()
{
	...
	if (does_entity_exist(iLocal_619))
	{
...
void func_88()
{
	...
	while (iVar0 < 3)
	{
		if (does_entity_exist(iLocal_404[iVar0]))
		{
			delete_vehicle(&(iLocal_404[iVar0]));
		}
		if (does_entity_exist(iLocal_408[iVar0]))
		{
			delete_ped(&(iLocal_408[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_89()
{
	...
	if (does_entity_exist(iLocal_569))
	{
		if (is_entity_occluded(iLocal_569))
		{
			delete_vehicle(&iLocal_569);
			delete_ped(&iLocal_570);
		}
		else
		{
