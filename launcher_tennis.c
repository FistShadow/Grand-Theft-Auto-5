...
void main()
{
	...
	iLocal_86 = get_player_ped(player_id());
	iLocal_96 = 0;
	...
	if (_get_number_of_instances_of_streamed_script(_get_this_script_hash()) > 1 && !func_179(uLocal_95, 4194304))
	{
		if (iLocal_106 != 263)
		{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_86) && !is_entity_dead(iLocal_86, 0))
		{
			vLocal_88 = {get_entity_coords(iLocal_86, 1)};
			fLocal_94 = vdist2(vLocal_88, Local_136.f_1[0 /*3*/]);
			fLocal_94 = fLocal_94;
			vLocal_112 = {vLocal_88};
			vLocal_115 = {Local_136.f_1[0 /*3*/]};
			vLocal_112.z = 0f;
			vLocal_115.z = 0f;
			...
			switch (iLocal_96)
			{
				case 0:
					...
					else
					{
						...
						if (vLocal_88.z - Local_136.f_1[0 /*3*/].f_2 > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					{
						cLocal_70 = {cLocal_54};
						iVar2 = !func_179(uLocal_95, 64);
						func_185(&uLocal_95, 128);
						if (!func_164(3) && !Global_91312)
						{
							if (func_179(uLocal_95, 2097152))
							{
								if ((!func_179(uLocal_95, 1) || !ENTITY::DOES_ENTITY_EXIST(func_163())) && !Global_91312)
								{
									func_172(10);
									break;
								}
						...
						if (iVar2)
						{
							if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_118, vLocal_121, fLocal_124, 1, false, iLocal_104) || (fLocal_126 > 0f && get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), func_138(vLocal_118, vLocal_121, 0.5f), 0) > fLocal_126))
							{
								iVar2 = false;
							}
				...
				case 6:
					...
					if (func_179(uLocal_95, 2097152))
					{
						if (!func_164(3) && !is_thread_active(iLocal_53))
						{
							func_172(10);
						}
					}
					if (!is_thread_active(iLocal_53))
					{
						playstats_oddjob_done(round(func_11(&iLocal_108) * 1000f), iLocal_100, 0);
						func_10(&iLocal_108);
						...
						if (iLocal_100 != -1)
						{
							if (func_179(Global_99807, 0))
							{
								playstats_mission_checkpoint(func_19(iLocal_100), 0, Global_91315, 0);
...
void func_38()
{
	...
	if (iLocal_128 == 2)
	{
		...
		else if (_get_number_of_instances_of_streamed_script(joaat("tennis_family")) == 0)
		{
			iLocal_130 = 0;
			iLocal_131 = 0;
		}
	...
	if (!_0x66680A92700F43DF(PLAYER::PLAYER_PED_ID()))
	{
	}
}
...
void func_44(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	struct<14> Var1;
	int iVar15;
	...
	while (iVar15 <= 8)
	{
		...
		if (uVar19[iVar15] != iVar18)
		{
			...
			{
				_is_ped_prop_valid(iParam0, iVar17, Var1.f_3, Var1.f_4);
			}
		}
		iVar15++;
	}
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_51(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_56(int iParam0)
{
	...
	func_57(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_57(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_46(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_60(func_63(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_60(func_59(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
			if (func_58(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_60(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_58(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_60(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_61(iParam1)];
...
int func_64(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_65(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_66(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_60(uVar2, iVar0, 0);
		return GAMEPLAY::IS_BIT_SET(iVar3, iVar1);
	}
	return false;
}

int func_66(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_67(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_57(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_51(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_57(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_122(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_122(vVar16.z)] = func_49(iParam1, vVar16.x, func_122(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_122(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
int func_145()
{
	if (func_166(6) || func_166(7))
	{
		...
		{
			switch (func_146(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)))
			{
				case 1:
					return func_165(96);
					break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_159()) || Global_100201) || Global_25122) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_155()) || func_143()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_159()) || Global_25122) || func_158()) || func_141(8, -1)) || func_155()) || func_157()) || func_156()) || func_143()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_159()) || Global_100201) || Global_25122) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_143()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_159() || get_player_wanted_level(player_id()) > 0) || func_141(8, -1)) || func_143()) || func_154()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_159()) || Global_25122) || func_158()) || func_141(8, -1)) || func_156()) || func_155()) || func_143()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_159()) || func_156()) || Global_100201) || Global_25122) || func_158()) || Global_36839) || func_141(8, -1)) || func_155()) || func_154()) || func_143()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
...
void func_161()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_131(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_130(PLAYER::PLAYER_PED_ID());
...
void func_168()
{
	...
	if (iLocal_129 && _get_number_of_instances_of_streamed_script(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_128 == 1)
		{
...
int func_179(auto uParam0, int iParam1)
{
...
void func_186(auto uParam0, auto uParam1)
{
	*uParam0 -= (*uParam0 && uParam1);
}
...
void func_188()
{
	...
	if (is_thread_active(iLocal_53))
	{
		force_cleanup_for_thread_with_this_id(iLocal_53, 3);
	}
