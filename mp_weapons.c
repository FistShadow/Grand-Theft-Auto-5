...
void func_1(auto uParam0, auto uParam1, auto uParam2)
{
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_285, false))
	{
		GAMEPLAY::CLEAR_BIT(uParam0.f_285, false);
		play_sound_frontend(-1, "NAV_LEFT_RIGHT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
		*uParam1.f_3++;
		if (*uParam1.f_3 > 2)
		{
	...
	if (*uParam0 == 0)
	{
		...
		while (iVar0 <= 8)
		{
			...
			if (*uParam0.f_85[iVar0] != 0)
			{
				if (iVar3)
				{
					if (((func_86(*uParam0.f_85[iVar0], *uParam0.f_276, 0) || (*uParam0.f_85[iVar0] == joaat("weapon_pistol") && has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_pistol"), 0))) || func_45(*uParam0.f_85[iVar0])) || func_29(*uParam0.f_85[iVar0], *uParam0.f_276))
					{
						iVar6++;
					}
					else
...
void func_59(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		if (iParam2)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, func_30(iVar1));
		}
		else
		{
...
void func_72(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 > -1)
	{
		if (iParam2)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2467971.f_991[func_73(iParam0, iParam1)]), func_30(iVar0));
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2467971.f_991[func_73(iParam0, iParam1)]), func_30(iVar0));
		}
	}
}
