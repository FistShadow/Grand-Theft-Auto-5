	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				...
				{
					if ((!iParam4 || func_128(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
...
bool func_188(int iParam0)
{
	if (!func_189())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_176) && is_vehicle_driveable(iLocal_176, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_176, vLocal_154, 2f, 2f, 2f, false, true, 0))
		{
...
void func_338()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (is_vehicle_driveable(iVar0, 0))
		{
			func_339(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), get_entity_heading(iVar0), 24, 0);
		}
	}
}
