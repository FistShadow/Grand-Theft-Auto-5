...
void main()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("ALARM_BELL_02", false))
				{
					if (func_795() == 1)
					{
						if (func_794())
...
void func_25(int iParam0, int iParam1)
{
	if (!func_24(Local_96.f_2[iParam1 /*10*/].f_1))
	{
		if (is_ped_sitting_in_any_vehicle(net_to_ped(Local_96.f_2[iParam1 /*10*/].f_1)))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_204), iParam1);
				...
				if (!func_34(iVar5, 0))
				{
					...
					if (func_341())
					{
						...
						if (!GAMEPLAY::IS_BIT_SET(Local_96.f_217, iLocal_721))
						{
							...
							{
								GAMEPLAY::SET_BIT(&(Local_96.f_217), iLocal_721);
							}
						}
	...
	while (iVar0 < 10)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar0 /*10*/].f_1))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_96.f_209, iVar0))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_96.f_209), iVar0);
				}
			}
		}
		iVar0++;
...
void func_32(int iParam0)
{
	...
	while (iVar0 < 10)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_205, iVar0))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_205), iVar0);
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_206, iVar0))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_206), iVar0);
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_208, iVar0))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_208), iVar0);
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_207, iVar0))
		{
			...
			{
				GAMEPLAY::SET_BIT(&(Local_96.f_207), iVar0);
			}
		}
		if (!GAMEPLAY::IS_BIT_SET(Local_96.f_209, iVar0))
		{
		...
		while (iVar0 < 10)
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar0 /*10*/].f_2))
			{
				if (func_13(Local_96.f_2[iVar0 /*10*/].f_2))
				{
					...
					GAMEPLAY::SET_BIT(&(Local_96.f_210), iParam0);
				}
			}
			else
			{
			...
			if (func_60(iVar0))
			{
				...
				else if (func_46(&(Local_96.f_2[iParam0 /*10*/].f_1), 22, iVar0, Local_96.f_2[iParam0 /*10*/].f_5, Local_96.f_2[iParam0 /*10*/].f_8, 1, 1, 1))
				{
					...
					if (iParam0 % 2 == 0)
					{
						...
						ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_96.f_2[iParam0 /*10*/].f_1), iVar6);
					...
					GAMEPLAY::SET_BIT(&(Local_96.f_203), iParam0);
				}
			}
		}
	}
			...
			else
			{
				...
				if (iVar1)
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_212, iVar0))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_96.f_212), iVar0);
					}
				}
			}
		}
			...
			if (func_60(iVar0))
			{
				if (!func_59(Local_96.f_262, 0f, 0f, 0f, 0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_96.f_211, false))
					{
						...
						GAMEPLAY::SET_BIT(&(Local_96.f_211), false);
					}
					if (func_144(&(Local_96.f_2[0 /*10*/].f_2), iVar0, vVar2, fVar5, 1, 1, 1, 0, 1, 1))
					{
						...
						ENTITY::SET_ENTITY_HEALTH(net_to_veh(Local_96.f_2[0 /*10*/].f_2), Global_262145.f_12463);
						...
						if (!func_59(Local_96.f_179[iVar0 /*5*/], 0f, 0f, 0f, 0))
						{
							if (func_48(Local_96.f_179[iVar0 /*5*/], 1086324736, 1065353216, 1065353216, 1084227584, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
							{
								if (!GAMEPLAY::IS_BIT_SET(Local_96.f_211, iVar0))
								{
									...
									GAMEPLAY::SET_BIT(&(Local_96.f_211), iVar0);
								}
...
void func_150()
{
	...
	if (Local_96.f_223 == 0)
	{
		...
		vVar3 = {func_151()};
		fVar6 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, vVar3, 0);
		if (fVar6 > 2500f)
		{
...
auto func_153()
{
	...
	Local_96.f_195 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
	return Local_96.f_195;
}
...
void func_156()
{
	...
	if (func_792())
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_720, false))
		{
			...
			GAMEPLAY::SET_BIT(&iLocal_720, false);
		}
		if (!GAMEPLAY::IS_BIT_SET(iLocal_720, true))
		{
			...
			{
				GAMEPLAY::SET_BIT(&iLocal_720, true);
			}
		}
		if (!func_341())
		{
		...
		if (func_341())
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 16))
			{
				if (Local_96.f_215 == -1)
				{
					if (func_157("DCONTRA_OBJ4"))
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_720, 16);
						}
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 17))
			{
				if (Local_96.f_215 != -1)
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_720, 17);
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 18))
			{
				if (GAMEPLAY::IS_BIT_SET(Local_96.f_1, 4))
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_720, 18);
					}
				}
			}
		}
		...
		if (GAMEPLAY::IS_BIT_SET(iLocal_720, 9))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 10))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 15))
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_720, 15);
					}
				}
				if (GAMEPLAY::IS_BIT_SET(iLocal_720, 15))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_720, 13))
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_720, 13);
						}
					}
					if (GAMEPLAY::IS_BIT_SET(iLocal_720, 13))
					{
						GAMEPLAY::SET_BIT(&iLocal_720, 10);
					}
				}
			}
		}
...
void func_162()
{
		...
		if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 16))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (get_max_wanted_level() == 0)
				{
					...
					GAMEPLAY::SET_BIT(&iLocal_719, 16);
				}
			}
		}
		return;
	...
	if (func_341())
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[0 /*10*/].f_2))
		{
			vVar0 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_2[0 /*10*/].f_2), 0)};
		}
	}
	else
	{
	...
	fVar3 = vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar0);
	if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 17))
	{
		if (fVar3 < 250000f)
		{
			set_max_wanted_level(false);
			GAMEPLAY::SET_BIT(&iLocal_719, 17);
		}
	}
...
void func_187(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_188())
	{
		return;
	}
		...
		if (func_13(Local_96.f_2[0 /*10*/].f_2))
		{
			if (func_207(Local_96.f_2[0 /*10*/].f_2))
			{
				if (network_has_control_of_network_id(Local_96.f_2[0 /*10*/].f_2))
				{
					...
					GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 15);
				}
			}
		}
	}
												...
												if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
												{
													if (is_entity_a_ped(Var0.f_1))
													{
														if (get_ped_index_from_entity_index(Var0.f_1) == PLAYER::PLAYER_PED_ID())
														{
															...
															{
																GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_5), iVar29);
															}
														}
									...
									if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
									{
										if (is_entity_a_ped(Var0.f_1))
										{
											...
											if (is_ped_a_player(iVar10))
											{
												...
												if (network_is_player_a_participant(iVar13))
												{
													if (Var0.f_3)
													{
														if (iVar13 == player_id())
														{
															GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_6), iVar29);
															if (!func_341())
															{
																Var15.f_2 = 206;
												...
												else if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_7, iVar29))
												{
													if (Var0.f_3)
													{
														GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_7), iVar29);
													}
												}
											}
											else if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_8, iVar29))
											{
												if (Var0.f_3)
												{
													GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_8), iVar29);
												}
											}
										}
										else if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_8, iVar29))
		...
		if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 15))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Var0))
			{
				if (is_entity_a_ped(Var0))
				{
					...
					{
						GAMEPLAY::SET_BIT(&iLocal_719, 15);
					}
				}
...
void func_351()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 10))
	{
		...
		GAMEPLAY::SET_BIT(&iLocal_719, 10);
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 11))
	{
		GAMEPLAY::SET_BIT(&iLocal_719, 11);
		func_707();
	}
		...
		if (GAMEPLAY::IS_BIT_SET(iLocal_719, 3))
		{
			...
			if (participant_id_to_int() == Local_96.f_218)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 16) && !GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, 13))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 13);
						if (!func_377(38))
						{
							func_376(38);
						}
			...
			if (func_353(&uLocal_731, 1) && (GAMEPLAY::IS_BIT_SET(Local_96.f_1, 16) || GAMEPLAY::IS_BIT_SET(Local_96.f_1, 5)))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 4);
				}
			}
		}
	}
...
int func_416(int iParam0, int iParam1, auto uParam2)
{
	...
	{
		iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 4);
	}
	iVar1 = false;
...
int func_418(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
		case 1:
			return GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
...
bool func_432()
{
	...
	if (!func_34(player_id(), 0))
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, 12))
		{
			GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 12);
		}
	}
	else
	{
...
int func_557(int iParam0)
{
	...
	if (func_561(iParam0))
	{
		...
		if (iVar1 < func_558(iParam0))
		{
			...
			{
				iVar0 += func_559(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
			...
			if (iVar1 == Local_96.f_218)
			{
				if (func_341())
				{
					if (func_628())
					{
						...
						GAMEPLAY::SET_BIT(&iLocal_719, true);
					}
				}
				else if (func_628())
				{
...
char* func_706()
{
	...
	iVar0 = !func_621(1);
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
	if (!func_341())
	{
		if (iVar0)
		{
...
void func_709()
{
	...
	if (!func_341())
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Local_366[iVar0 /*11*/].f_1), 14);
		}
		return;
	}
	if (!func_733())
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_366[iVar0 /*11*/].f_1, 14))
	{
		if (!func_719(iVar1, participant_id_to_int()))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 13))
			{
				...
				{
					GAMEPLAY::SET_BIT(&iLocal_719, 13);
				}
			}
			else
			{
...
void func_711()
{
	...
	if (func_713(player_id()))
	{
		...
		GAMEPLAY::SET_BIT(&(Global_1728515.f_106), iVar0);
	}
}
...
bool func_720(int iParam0, int iParam1, int iParam2, Vector3 vParam3, int iParam4, int iParam5)
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_1728515.f_15), iParam0);
	}
	if (GAMEPLAY::IS_BIT_SET(Global_1728515.f_13, iParam0))
	{
		return false;
	}
	GAMEPLAY::SET_BIT(&(Global_1728515.f_13), iParam0);
	GAMEPLAY::CLEAR_BIT(&(Global_1728515.f_107), iParam0);
	func_721(iParam0);
	if (iParam2)
	{
		GAMEPLAY::SET_BIT(&(Global_1728515.f_14), iParam0);
	...
	{
		GAMEPLAY::SET_BIT(&(Global_1728515.f_106), iParam0);
	}
	return true;
}
...
int func_725(int iParam0)
{
	...
	return INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_51(player_id()), vVar1, 1) <= IntToFloat(iVar0);
}
...
bool func_733()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_734(Local_96.f_197 + 1), 1) > 100f)
	{
		return false;
	}
	return true;
...
void func_737()
{
	...
	if (fVar3 < 62500f)
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 14))
		{
			...
			func_738();
			GAMEPLAY::SET_BIT(&iLocal_719, 14);
		}
	}
...
void func_740()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 8))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, 9))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[0 /*10*/].f_2))
			{
				if (!func_13(Local_96.f_2[0 /*10*/].f_2))
				{
					GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 9);
				}
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 6))
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, 7))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[0 /*10*/].f_2))
			{
				vVar1 = {ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_96.f_2[0 /*10*/].f_2), 0)};
				if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar1) < 90000f)
				{
					GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 7);
				}
			}
		}
	}
		...
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[0 /*10*/].f_2))
		{
			if (func_13(Local_96.f_2[0 /*10*/].f_2))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, 8))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 8);
					}
				}
					...
					if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						if (get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0) == iVar0)
						{
							if (get_ped_in_vehicle_seat(iVar0, -1) == PLAYER::PLAYER_PED_ID())
							{
								...
								{
									GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 3);
								}
							}
				...
				if (iVar0 == player_id())
				{
					if (!PED::IS_PED_INJURED(get_player_ped(iVar0)))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(get_player_ped(iVar0), vVar1, 6f, 6f, 2f, false, true, 0))
						{
							...
							GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 2);
						}
					}
				}
			}
...
bool func_754(int iParam0)
{
	...
	vVar0 = {ENTITY::GET_ENTITY_COORDS(iParam0, 0)};
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 0) < 50f)
	{
		return true;
	}
		...
		if (GAMEPLAY::IS_BIT_SET(iLocal_719, 2))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 4))
			{
				if (func_699(0, 1, 1, 1))
				{
					...
					func_358(1);
					GAMEPLAY::SET_BIT(&iLocal_719, 4);
					GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 10);
				}
			}
		}
	}
...
void func_758()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_719, 12))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 1) <= 200f)
			{
				iLocal_727 = AUDIO::GET_SOUND_ID();
				AUDIO::PLAY_SOUND_FROM_COORD(iLocal_727, "Bell_02", vVar0, "ALARMS_SOUNDSET", 0, 0, 0);
				GAMEPLAY::SET_BIT(&iLocal_719, 12);
			}
		}
	}
}
...
void func_760()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_96.f_1, 13))
	{
		...
		{
			vVar0 = {func_40()};
			if (vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar0) < 22500f)
			{
				GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), 11);
			}
		}
		if (func_432())
		{
...
void func_761()
{
	if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_1, true))
	{
		if (!func_792())
		{
			...
			{
				func_185(1);
				GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_1), true);
			}
		}
	}
}
						...
						if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (func_793() == Local_96.f_218)
								{
									...
									{
										GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_2), iVar3);
									}
								}
							}
						}
			...
			if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_3, iVar3))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_208, iVar3))
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_2))
					{
						if (func_768(iVar3))
						{
							GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_3), iVar3);
						}
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(Local_366[participant_id_to_int() /*11*/].f_4, iVar3))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_96.f_207, iVar3))
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_1))
					{
						if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
						{
							if (is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), 1), 10f, 1))
							{
								GAMEPLAY::SET_BIT(&(Local_366[participant_id_to_int() /*11*/].f_4), iVar3);
							}
						}
					}
				}
		...
		switch (Local_96.f_2[iVar3 /*10*/].f_9)
		{
						...
						if (func_13(Local_96.f_2[iVar3 /*10*/].f_2))
						{
							if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
							{
								if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), net_to_veh(Local_96.f_2[iVar3 /*10*/].f_2)))
								{
									...
									if (func_27(&iVar5))
									{
										if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -258271821) != 0)
										{
						...
						if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_1))
						{
							if (func_13(Local_96.f_2[iVar3 /*10*/].f_2))
							{
								if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
								{
									if (is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), net_to_veh(Local_96.f_2[iVar3 /*10*/].f_2)))
									{
										if ((AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -258271821) != 0) || GAMEPLAY::IS_BIT_SET(Local_96.f_204, iVar3))
										{
			...
			case 3:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_1))
				{
					if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
					{
						iVar4 = AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -828834893);
						if (iVar4 != 1 && iVar4 != 0)
						{
			...
			case 7:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_1))
				{
					if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
					{
						iVar4 = AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), -1442466670);
						if (iVar4 != 1 && iVar4 != 0)
						{
							if (func_207(Local_96.f_2[iVar3 /*10*/].f_1))
							{
			...
			case 6:
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iVar3 /*10*/].f_1))
				{
					if (!func_24(Local_96.f_2[iVar3 /*10*/].f_1))
					{
						iVar4 = AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), 1120685857);
						if (iVar4 != 1 && iVar4 != 0)
						{
							set_blocking_of_non_temporary_events(net_to_ped(Local_96.f_2[iVar3 /*10*/].f_1), false);
							vVar0 = {func_151()};
	...
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_2[iLocal_1003 /*10*/].f_1))
	{
		if (!func_24(Local_96.f_2[iLocal_1003 /*10*/].f_1))
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_1002, iLocal_1003))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_1002, iLocal_1003);
			}
		}
	}
	iLocal_1003++;
...
auto func_790()
{
	...
	if (Local_96.f_196 == -1)
	{
		iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 10);
		if (iVar4 > 7)
		{
			Local_96.f_196 = 99;
		}
