...
void main()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			if (func_200(player_id()) != 1 && !GAMEPLAY::IS_BIT_SET(Global_2460486.f_791.f_7, false))
			{
				func_201();
			}
		}
	...
	while (true)
	{
		...
		switch (func_188(participant_id_to_int()))
		{
			...
			case 1:
				...
				{
					if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_56.f_3, 500f, 500f, 500f, false, true, 0) && func_200(player_id()) != 1) && !GAMEPLAY::IS_BIT_SET(Global_2460486.f_791.f_7, false))
					{
...
void func_5()
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			if (Local_56.f_6 == -1)
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_67[iVar0 /*3*/].f_1, false))
				{
					Local_56.f_6 = iVar0;
				}
			}
	...
	if (!network_does_network_id_exist(Local_56.f_2))
	{
		if (func_187())
		{
			if (can_register_mission_objects(1))
			{
				fVar5 = 250f;
				vVar6 = {Local_56.f_3};
				if (GAMEPLAY::IS_BIT_SET(Local_56.f_1, 8))
				{
				...
				if (iVar4 == 0)
				{
					if (GAMEPLAY::IS_BIT_SET(Local_56.f_1, 8) || func_147(vVar6, fVar5, &vVar0, &fVar3, Var13))
					{
						if (Local_56.f_7 >= 32 || func_200(player_id()) == 1)
						{
				...
				else if (GAMEPLAY::IS_BIT_SET(Local_56.f_1, 8) || func_7(vVar6, vVar9, fVar5, &vVar0, &fVar3, Var13))
				{
					if (Local_56.f_7 >= 32 || func_200(player_id()) == 1)
					{
						Local_56.f_2 = obj_to_net(create_portable_pickup(joaat("pickup_portable_package"), vVar0, 1, joaat("prop_drug_package_02")));
...
bool func_7(Vector3 vParam0, Vector3 vParam1, float fParam2, auto uParam3, Vector3 fParam4, struct<8> Param5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16, auto uParam17, auto uParam18, auto uParam19, auto uParam20, auto uParam21, auto uParam22)
{
	struct<11> Var0;
	struct<25> Var18;
...
bool func_8(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	float fVar4;
	...
	if (iVar25)
	{
		if (Global_2404956.f_1482 == 1)
		{
			if (is_thread_active(Global_2404956.f_1491))
			{
				...
				{
					if (get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_1488) < func_146(0))
					{
						return false;
					}
				}
				else if (get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_1488) < func_146(0))
				{
					return false;
				}
			}
	...
	if (Global_2404956.f_1482)
	{
		...
		{
			if (func_118() || get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_1489) > 10000)
			{
				Global_2404956.f_1489 = NETWORK::GET_NETWORK_TIME();
				Global_2404956.f_1483 = 4;
			}
...
void func_11(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, auto uParam5, auto uParam6)
{
	Vector3 vVar0;
	auto uVar3;
	struct<56> Var4;
...
bool func_13(Vector3 vParam0, auto uParam1, int iParam2, int iParam3, int iParam4)
{
...
bool func_14(Vector3 vParam0, auto uParam1, int iParam2, int iParam3)
{
	float fVar0;
	auto uVar1;
	auto uVar8;
...
void func_18(auto uParam0, Vector3 vParam1)
{
	float fVar0;
	float fVar1;
	Vector3 vVar2;
...
bool func_23(Vector3 vParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_24(auto uParam0, Vector3 vParam1, float fParam2, float fParam3, int iParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_28(auto uParam0, auto uParam1, float fParam2, int iParam3, int iParam4)
{
	if (iParam4)
	{
		switch (*uParam1.f_10)
...
void func_29(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, float fParam4, int iParam5)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
void func_32(auto uParam0, struct<2> Param1, auto uParam2, struct<2> Param3, auto uParam4, float fParam5, int iParam6)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
...
bool func_34(Vector3 vParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
int func_35(Vector3 vParam0, auto uParam1, float fParam2, int iParam3, int iParam4)
{
	switch (*uParam3.f_10)
	{
		case 0:
...
bool func_37(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
...
bool func_45(Vector3 vParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_47(auto uParam0, auto uParam1)
{
	auto uVar0;
...
bool func_50(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	if (Global_2404956.f_1509.f_1 > 0 || Global_2404956.f_1509 > 0)
	{
		...
		if (Global_2404956.f_1509.f_1 == iVar4)
		{
			...
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, Global_2404956.f_1509.f_1);
...
bool func_51(auto uParam0, int iParam1)
{
	int iVar0;
	Vector3 vVar1;
	auto uVar4;
...
int func_52(Vector3 vParam0, auto uParam1)
{
	return is_point_in_angled_area(vParam0, *uParam3, *uParam3.f_3, *uParam3.f_6, 0, true);
}

int func_53(struct<2> Param0, auto uParam1)
{
...
void func_55(Vector3 vParam0, Vector3 fParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_73(Vector3 vParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_75(Vector3 vParam0, auto uParam1, auto uParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
...
bool func_85(Vector3 vParam0, auto uParam1, auto uParam2, float fParam3)
{
	float fVar0;
	int iVar1;
	Vector3 vVar2;
...
bool func_86(auto uParam0, auto uParam1, int iParam2, float fParam3)
{
	int iVar0;
	Vector3 vVar1;
	...
	if (iParam4 && !iParam7)
	{
		if (func_44(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_58(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
					if (CAM::IS_SPHERE_VISIBLE(vParam0, fParam3))
					{
						return true;
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_59(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							if ((iParam5 || (iParam5 == 0 && get_player_team(iVar1) != get_player_team(player_id()))) || get_player_team(iVar1) == -1)
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_58(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
									if (CAM::IS_SPHERE_VISIBLE_to_player(iVar1, vParam0, fParam3))
									{
										return true;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_44(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_59(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_58(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
void func_107(Vector3 vParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	struct<4> Var2;
...
void func_108(auto uParam0, auto uParam1, int iParam2)
{
...
void func_109(auto uParam0, auto uParam1, int iParam2)
{
...
int func_111(Vector3 vParam0, auto uParam1)
{
	switch (*uParam3.f_7)
	{
		case 0:
...
void func_112(Vector3 vParam0, Vector3 vParam1, auto uParam2, auto uParam3, auto uParam4)
{
	float fVar0;
...
void func_124(auto uParam0, auto uParam1, auto uParam2)
{
...
void func_125(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	float fVar4;
...
void func_126(auto uParam0, auto uParam1, auto uParam2, Vector3 vParam3)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && player_id() != iVar1) || iParam9 == 0)
		{
			if (func_44(iVar1, iParam5, iParam6))
			{
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam8 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_59(iVar1)))
					{
...
bool func_139(Vector3 vParam0, auto uParam1)
{
	if (*uParam3.f_18)
	{
		switch (*uParam3.f_26)
...
int func_142(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	float fVar4;
...
bool func_147(Vector3 vParam0, float fParam1, auto uParam2, auto uParam3, struct<13> Param4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16)
{
	struct<11> Var0;
	struct<18> Var18;
	Vector3 vVar44;
...
bool func_155(int iParam0, auto uParam1)
{
	if (Global_1315901)
	{
		return false;
...
void func_157(auto uParam0, int iParam1, auto uParam2)
{
	int iVar0;
...
int func_158(auto uParam0, auto uParam1)
{
	int iVar0;
	auto uVar1;
...
bool func_173()
{
	...
	if (network_does_network_id_exist(Local_56.f_2))
	{
		if (is_entity_attached_to_entity(net_to_obj(Local_56.f_2), PLAYER::PLAYER_PED_ID()) && func_183(Local_56.f_2))
		{
...
void func_174(struct<2> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, int iParam13)
{
	Param0 = 0;
...
bool func_198(int iParam0, auto uParam1)
{
...
void func_203()
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_2460486.f_791.f_7), false);
}

void func_204()
{
	if (GAMEPLAY::IS_BIT_SET(iLocal_164, 4))
	{
		...
		func_205(1);
		GAMEPLAY::CLEAR_BIT(&iLocal_164, 5);
		GAMEPLAY::CLEAR_BIT(&iLocal_164, 7);
		GAMEPLAY::CLEAR_BIT(&iLocal_164, 4);
	}
}
...
bool func_207(struct<20> Param0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		Local_56.f_3 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)};
		if (!func_3(Global_2460486.f_791.f_1))
		{
...
void func_211(int iParam0, struct<17> Param1, auto uParam2, auto uParam3, auto uParam4)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_202();
