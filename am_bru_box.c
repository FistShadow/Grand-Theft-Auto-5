	...
	while (true)
	{
		...
		switch (func_188(participant_id_to_int()))
		{
			...
			case 1:
				...
				{
					if ((!is_entity_at_coord(PLAYER::PLAYER_PED_ID(), Local_56.f_3, 500f, 500f, 500f, false, true, 0) && func_200(player_id()) != 1) && !GAMEPLAY::IS_BIT_SET(Global_2460486.f_791.f_7, false))
					{
