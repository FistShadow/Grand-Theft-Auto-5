					...
					if (iLocal_407 > 0)
					{
						...
						while (iVar0 <= iLocal_407 - 1)
						{
							if (func_21(Local_132[iVar0 /*19*/]))
							{
								...
								ENTITY::SET_ENTITY_HEALTH(Local_132[iVar0 /*19*/], false);
							}
							iVar0++;
						}
					}
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_21(Local_322))
				{
					...
					{
						if (func_103(Local_322, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_172(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_169(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
			...
			case 1:
				...
				else
				{
					...
					else
					{
						if (!iLocal_355)
						{
							if (!PED::IS_PED_RAGDOLL(Local_112.f_9) && !is_ped_in_any_vehicle(Local_112.f_9, 0))
							{
...
void func_310(int iParam0, Vector3 vParam1, int iParam2, float fParam3)
{
	...
	fVar2 = 625f;
	fVar3 = 16000f;
	fVar4 = vdist2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1);
...
bool func_315(int iParam0, Vector3 vParam1, float fParam2, float fParam3)
{
	if (func_103(iParam0, vParam1, fParam4))
	{
		...
		{
			if (is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(iParam0, 1), fParam5, 1))
			{
				return true;
			}
		}
...
bool func_316(int iParam0, Vector3 vParam1)
{
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (func_103(iParam0, vParam1, 3.5f) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), iParam0))
			{
				return true;
			}
		}
			...
			switch (Local_112.f_10)
			{
				...
				case 23:
					if (func_347(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_346())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_112.f_9) && !is_ped_being_stunned(Local_112.f_9, 0)) && !is_ped_being_jacked(Local_112.f_9)) && !func_62(Local_112.f_9, -828834893))
						{
							task_look_at_entity(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_343(Local_112.f_19, 10) && func_103(Local_112.f_9, vLocal_619, 50f)) || !func_111(iLocal_415, 2000))
							{
								...
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !is_player_targetting_entity(player_id(), Local_112.f_9)) && !func_346()) || is_entity_in_water(Local_112.f_9))
								{
									task_turn_ped_to_face_entity(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
				...
				case 24:
					if (func_347(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_346())
					{
						if (!func_62(Local_112.f_9, -1519143300))
						{
							...
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || is_player_targetting_entity(player_id(), Local_112.f_9)) || func_346())
								{
									Local_112.f_10 = 23;
								}
							}
				...
				case 26:
					...
					else if ((!PED::IS_PED_RAGDOLL(Local_112.f_9) && !is_ped_getting_up(Local_112.f_9)) && is_ped_on_foot(Local_112.f_9))
					{
...
bool func_346()
{
	...
	if (is_ped_getting_up(Local_112.f_9) || PED::IS_PED_RAGDOLL(Local_112.f_9))
	{
		iLocal_415 = GAMEPLAY::GET_GAME_TIMER();
		return true;
	}
...
bool func_347(int iParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5, int iParam6)
{
	...
	if (func_21(iParam0))
	{
		...
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam0, PLAYER::PLAYER_PED_ID()) || has_ped_received_event(iParam0, 56))
		{
			if (PED::IS_PED_RAGDOLL(iParam0))
			{
				return true;
...
bool func_359(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_178(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
				...
				case 2:
					...
					else if (!func_62(Local_132[iVar0 /*19*/], 780511057))
					{
						...
						if (func_103(Local_132[iVar0 /*19*/], vLocal_619, 5f))
						{
							...
							{
								set_ped_sphere_defensive_area(Local_132[iVar0 /*19*/], ENTITY::GET_ENTITY_COORDS(Local_132[iVar0 /*19*/], 1), 5f, 0, 0);
	...
	if (func_21(iParam0))
	{
		if (func_348(1, 0, 1))
		{
			...
			if (func_103(iParam0, vLocal_619, fParam2))
			{
				...
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iParam0) || has_ped_received_event(iParam0, 56))
				{
					return true;
				}
			}
						...
						else
						{
							...
							if (func_103(Local_112.f_9, vLocal_619, 25f) && func_393(Local_112.f_9, vLocal_619, 10f))
							{
								if (get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()) || is_ped_in_cover(PLAYER::PLAYER_PED_ID(), 0))
								{
									...
									else if (!is_ped_performing_stealth_kill(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_112.f_9))
									{
										iLocal_101 = 1;
										iLocal_366 = 0;
										if (Local_112.f_10 != 3 && Local_112.f_10 != 4)
...
bool func_404(int iParam0)
{
	if (func_21(Local_322))
	{
		...
		if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(Local_322, 1), 15f))
		{
			return true;
		}
...
bool func_408(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_178(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_453(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_455(iParam0, uVar1[iVar6], 1) && func_454(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_163(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
...
void func_472()
{
	...
	if (func_21(Local_112.f_9))
	{
		...
		open_sequence_task(&iLocal_418);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "idle_c", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
	...
	while (iVar0 <= 2)
	{
		if (func_21(Local_132[iVar0 /*19*/]))
		{
			...
			switch (iVar0)
			{
				case 0:
					open_sequence_task(&iLocal_418);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
				...
				case 1:
					open_sequence_task(&iLocal_418);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					set_sequence_to_repeat(iLocal_418, 1);
					close_sequence_task(iLocal_418);
				...
				case 2:
					open_sequence_task(&iLocal_418);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "idle_c", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					set_sequence_to_repeat(iLocal_418, 1);
					close_sequence_task(iLocal_418);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_494()) || Global_100201) || Global_25122) || func_500()) || func_86(8, -1)) || func_499()) || func_498()) || func_492()) || func_493()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_494()) || Global_100201) || Global_25122) || func_500()) || func_86(8, -1)) || func_492()) || func_499()) || func_498()) || func_493()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_494()) || Global_100201) || Global_25122) || func_500()) || func_86(8, -1)) || func_499()) || func_498()) || func_493()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_494()) || Global_25122) || func_500()) || func_86(8, -1)) || func_498()) || func_492()) || func_493()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_494()) || func_498()) || Global_100201) || Global_25122) || func_500()) || Global_36839) || func_86(8, -1)) || func_492()) || func_497()) || func_493()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_494()) || Global_100201) || Global_25122) || func_500()) || func_86(8, -1)) || func_492()) || func_497()) || func_499()) || func_498()) || func_493())
						{
							return false;
						}
						break;
