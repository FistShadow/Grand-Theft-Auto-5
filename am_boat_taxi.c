	...
	while (true)
	{
		...
		switch (func_121(participant_id_to_int()))
		{
			...
			case 1:
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_88.f_2), 1), 200f, 200f, 200f, false, true, 0))
					{
		...
		if (network_is_host_of_this_script())
		{
			switch (func_120())
			{
				case 0:
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_88, 12))
						{
							Local_88.f_4 = player_id();
							Local_88.f_5 = func_56();
							Local_88.f_10 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) + Vector(0f, 5f, 0f)};
							Local_88.f_7 = {func_54(Local_88.f_5)};
							GAMEPLAY::SET_BIT(&Local_88, 12);
						}
						if (func_32())
						{
							func_119();
	...
	if (!func_4(Local_88.f_3) && func_61(Local_88.f_2))
	{
		...
		switch (Local_88.f_20)
		{
			case 2:
				...
				else if (!GAMEPLAY::IS_BIT_SET(Local_88, 7) && is_entity_at_entity(net_to_ped(Local_88.f_3), PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
				{
					Local_88.f_20 = 3;
				}
				break;
			...
			case 4:
				GAMEPLAY::SET_BIT(&iLocal_207, 8);
				if (get_vehicle_number_of_passengers(net_to_veh(Local_88.f_2)) <= 0)
				{
					Local_88.f_20 = 3;
					GAMEPLAY::CLEAR_BIT(&iLocal_207, 8);
				}
				else if (!GAMEPLAY::IS_BIT_SET(Local_88, 7) && ENTITY::IS_ENTITY_AT_COORD(net_to_ped(Local_88.f_3), Local_88.f_7, 10f, 10f, 10f, false, true, 0))
				{
					Local_88.f_20 = 5;
				}
				break;
			...
			case 5:
				if ((get_vehicle_number_of_passengers(net_to_veh(Local_88.f_2)) <= 0 && !is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2))) && func_25(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 1) >= 10f)
				{
					Local_88.f_20 = 6;
				}
				break;
			...
			case 6:
				if ((get_vehicle_number_of_passengers(net_to_veh(Local_88.f_2)) <= 0 && !is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2))) && func_25(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 1) >= 10f)
				{
					if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), 242628503) == 1)
					{
						Local_88.f_20 = 7;
					}
				}
			...
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), 242628503) == 1 && func_25(PLAYER::PLAYER_PED_ID(), net_to_ped(Local_88.f_3), 1) >= 10f)
				{
					Local_88.f_20 = 7;
				}
				break;
...
void func_26()
{
	...
	{
		case 0:
			if (GAMEPLAY::IS_BIT_SET(Local_88, 8) || get_vehicle_number_of_passengers(net_to_veh(Local_88.f_2)) > 0)
			{
				Local_88.f_21 = 1;
			}
			break;
		...
		case 2:
			...
			else if (GAMEPLAY::IS_BIT_SET(Local_88, 10))
			{
				Local_88.f_21 = 4;
			}
			break;
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_61(Local_88.f_2))
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_88, 8))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(net_to_veh(Local_88.f_2), Local_88.f_10, 10f * 1.5f, 10f * 1.5f, 10f * 1.5f, false, true, 0))
						{
							GAMEPLAY::SET_BIT(&Local_88, 8);
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_88, 7) || GAMEPLAY::IS_BIT_SET(Local_88, 11))
					{
						if (!GAMEPLAY::IS_BIT_SET(Local_88, 10))
						{
							if (ENTITY::IS_ENTITY_AT_COORD(net_to_veh(Local_88.f_2), Local_88.f_7, 10f * 1.5f, 10f * 1.5f, 10f * 1.5f, false, true, 0))
							{
								GAMEPLAY::SET_BIT(&Local_88, 10);
							}
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_88, 9))
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_110[iVar0 /*3*/].f_1, 6))
						{
							GAMEPLAY::SET_BIT(&Local_88, 9);
							GAMEPLAY::CLEAR_BIT(&(vLocal_110[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_88.f_20 != 3)
					{
						if (GAMEPLAY::IS_BIT_SET(vLocal_110[iVar0 /*3*/].f_1, 5))
						{
							Local_88.f_20 = 3;
							GAMEPLAY::CLEAR_BIT(&(vLocal_110[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
...
bool func_30()
{
	...
	while (iVar0 < 21)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_31(iVar0), 50f, 50f, 50f, false, true, 0))
		{
			return true;
		}
		iVar0++;
	...
	if ((!network_does_network_id_exist(Local_88.f_3) && func_53(joaat("s_m_y_blackops_01"))) && network_does_network_id_exist(Local_88.f_2))
	{
		if (func_61(Local_88.f_2))
		{
			if (func_34(&(Local_88.f_3), Local_88.f_2, 22, joaat("s_m_y_blackops_01"), -1, 1, 1, 1))
			{
				...
				{
					PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(net_to_ped(Local_88.f_3), Global_1574231);
				}
				else
				{
					PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(net_to_ped(Local_88.f_3), Global_1573914[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
				set_ped_keep_task(net_to_ped(Local_88.f_3), true);
				set_blocking_of_non_temporary_events(net_to_ped(Local_88.f_3), true);
				ENTITY::SET_ENTITY_HEALTH(net_to_ped(Local_88.f_3), round(200f * Global_262145.f_151));
				set_ped_can_be_dragged_out(net_to_ped(Local_88.f_3), 0);
				PED::SET_PED_CONFIG_FLAG(net_to_ped(Local_88.f_3), 255, true);
			}
		}
	}
	if (!network_does_network_id_exist(Local_88.f_3))
...
bool func_35()
{
	...
	if (!network_does_network_id_exist(Local_88.f_2))
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 10))
			{
				...
				if (test_probe_against_water(vLocal_903 + Vector(2f, 0f, 0f), vLocal_903 - Vector(10f, 0f, 0f), &vLocal_903))
				{
					if (func_37(vLocal_903, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
					{
						...
						{
							GAMEPLAY::SET_BIT(&iLocal_207, 10);
						}
					}
				}
			}
			else if (_get_raycast_result(iLocal_901, &iLocal_902, &uVar0, &uVar0, &uVar3) == 2)
			{
				...
				{
					iLocal_902 = 0;
					GAMEPLAY::CLEAR_BIT(&iLocal_207, 10);
				}
			}
	...
	if (iParam4 && !iParam7)
	{
		if (func_3(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_42(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_39(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_42(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_3(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_39(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_42(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
Vector3 func_54(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar5 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_88.f_10, func_31(iVar0), 1);
				if (fVar5 < fVar6)
				{
					iVar1 = iVar0;
					fVar6 = fVar5;
	...
	if (func_3(player_id(), 1, 1))
	{
		...
		switch (vLocal_110[participant_id_to_int() /*3*/].f_2)
		{
			...
			case 1:
				...
				{
					func_118();
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 0))
					{
						func_85();
						vLocal_110[participant_id_to_int() /*3*/].f_2 = 3;
						AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						GAMEPLAY::CLEAR_BIT(&(vLocal_110[participant_id_to_int() /*3*/].f_1), false);
					}
				}
				break;
			...
			case 2:
				if (func_61(Local_88.f_2))
				{
					...
					{
						vLocal_110[participant_id_to_int() /*3*/].f_2 = 3;
						GAMEPLAY::CLEAR_BIT(&(vLocal_110[participant_id_to_int() /*3*/].f_1), 5);
						GAMEPLAY::SET_BIT(&(vLocal_110[participant_id_to_int() /*3*/].f_1), 6);
						if (Local_88.f_21 >= 4)
						{
			...
			case 4:
				if (func_61(Local_88.f_2))
				{
					if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 3))
					{
						if (get_entity_speed(net_to_veh(Local_88.f_2)) < 3f)
						{
							task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
							GAMEPLAY::SET_BIT(&iLocal_207, 3);
						}
					}
					if ((!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 0) && !is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2))) && func_25(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 1) >= 10f)
					{
						vLocal_110[participant_id_to_int() /*3*/].f_2 = 5;
					}
				}
		...
		if (func_79(1, 1))
		{
			if (((vLocal_110[participant_id_to_int() /*3*/].f_2 == 1 || vLocal_110[participant_id_to_int() /*3*/].f_2 == 2) || vLocal_110[participant_id_to_int() /*3*/].f_2 == 3) || vLocal_110[participant_id_to_int() /*3*/].f_2 == 4)
			{
				...
				if (vLocal_110[participant_id_to_int() /*3*/].f_2 == 1)
				{
					if (func_61(Local_88.f_2))
					{
						if ((is_entity_at_entity(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 10f, 10f, 3f, 0, 1, 0) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && !func_75(net_to_veh(Local_88.f_2), 0))
						{
	...
	if (!func_4(Local_88.f_3) && func_61(Local_88.f_2))
	{
		if (network_has_control_of_network_id(Local_88.f_3) || (!_0xA1607996431332DF(Local_88.f_3) && network_is_host_of_this_script()))
		{
			...
			switch (Local_88.f_20)
			{
				...
				case 2:
					if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), -1273030092) != 0)
					{
						task_boat_mission(net_to_ped(Local_88.f_3), net_to_veh(Local_88.f_2), 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 4, 12f, 786469, 10f, 1071);
					}
					break;
				
				case 4:
					func_93(ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_88.f_2), 0), Local_88.f_7);
					...
					{
						if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), 242628503) != 0)
						{
				...
				case 5:
					if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_88.f_3), -1273030092) != 0)
					{
						task_vehicle_mission_coors_target(net_to_ped(Local_88.f_3), net_to_veh(Local_88.f_2), ENTITY::GET_ENTITY_COORDS(net_to_veh(Local_88.f_2), 1), 5, 5f, 1076625579, 2f, 1f, 1);
					}
					break;
				...
				case 1:
					if (!GAMEPLAY::IS_BIT_SET(vLocal_110[participant_id_to_int() /*3*/].f_1, 7))
					{
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), 0) || is_ped_on_specific_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2)))
						{
						...
						GAMEPLAY::SET_BIT(&(vLocal_110[participant_id_to_int() /*3*/].f_1), 7);
					}
					break;
...
void func_95()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 4))
	{
		if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), net_to_ped(Local_88.f_3), 15f, 15f, 15f, 0, 1, 0))
		{
			...
			if (func_99(&uLocal_907, "FMAMBAU", "FMA_BPDA", 12, 0, 0, 1))
			{
				...
				GAMEPLAY::SET_BIT(&iLocal_207, 4);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 6))
	{
		if (Local_88.f_20 == 4)
		{
			func_115(&uLocal_907, 8, net_to_ped(Local_88.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				task_look_at_entity(net_to_ped(Local_88.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_207, 6);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 5))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_88.f_7, 10f * 2f, 10f * 2f, 10f * 2f, false, true, 0))
		{
			func_115(&uLocal_907, 8, net_to_ped(Local_88.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_99(&uLocal_907, "FMAMBAU", "FMA_BPDA6", 12, 0, 0, 1))
			{
				task_look_at_entity(net_to_ped(Local_88.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_207, 5);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 7))
	{
		if (Local_88.f_20 == 5)
		{
			func_115(&uLocal_907, 8, net_to_ped(Local_88.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				task_look_at_entity(net_to_ped(Local_88.f_3), PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				GAMEPLAY::SET_BIT(&iLocal_207, 7);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(iLocal_207, 8))
	{
		func_115(&uLocal_907, 8, net_to_ped(Local_88.f_3), "FM_DRIVER_BOAT", 0, 1);
...
void func_116()
{
	...
	if (func_3(player_id(), 1, 1))
	{
		if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2)) && !func_117(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_88.f_2), -1))
		{
