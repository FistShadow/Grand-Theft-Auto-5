...
void main()
{
	...
	{
		_0xCD9CC7E200A52A6F(Local_81.f_59);
...
void func_1()
{
	...
	switch (iLocal_143)
	{
		case 0:
			...
			{
				freeze_entity_position(iLocal_156, false);
			}
			if (iLocal_144 == 1)
			{
				...
				if (func_17(iLocal_158))
				{
					...
					{
						if (func_14(iLocal_158, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
					...
					else if (func_17(iLocal_158))
					{
						if (!func_2(iLocal_158, 1805844857))
						{
							if (!is_ped_fleeing(iLocal_158))
							{
								...
								{
									set_ped_flee_attributes(iLocal_158, 2, false);
									set_ped_flee_attributes(iLocal_158, 64, false);
									set_ped_flee_attributes(iLocal_158, 128, false);
									set_ped_flee_attributes(iLocal_158, 8, false);
									set_ped_flee_attributes(iLocal_158, 1, false);
									set_ped_flee_attributes(iLocal_158, 32, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_158, 5, false);
									PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_158, 17, true);
									task_smart_flee_ped(iLocal_158, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									set_ped_keep_task(iLocal_158, true);
								}
							}
						}
					}
		...
		if (is_entity_playing_anim(iLocal_158, "special_ped@maude@base", "base", 3))
		{
			if (!is_ped_ragdoll(iLocal_158) || is_ped_getting_up(iLocal_158))
			{
				...
				if (has_anim_dict_loaded("special_ped@maude@exit_flee"))
				{
					...
					set_synchronized_scene_looped(iLocal_150, false);
					_0x394B9CD12435C981(iLocal_150, false);
					if (func_2(iLocal_158, 1785177548))
					{
						stop_synchronized_entity_anim(iLocal_158, -1000f, 1);
					}
					task_synchronized_scene(iLocal_158, iLocal_150, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1000f, 0);
					...
					if (func_11(iLocal_154))
					{
						...
						iVar0 += 512;
						iVar0 += 4096;
						play_synchronized_entity_anim(iLocal_154, iLocal_150, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1000f);
					}
					return true;
				}
			}
...
int func_14(int iParam0, Vector3 vParam1, float fParam2)
{
	...
	switch (iLocal_143)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_156))
			{
				...
				{
					iLocal_156 = get_closest_object_of_type(2727.4f, 4145.56f, 43.68f, 10f, -380698483, 1, 0, 1);
					if (func_11(iLocal_156))
					{
						set_entity_coords(iLocal_156, 2727.4f, 4145.56f, 43.68f, 1, false, 0, 1);
						set_entity_heading(iLocal_156, -92.17f);
			...
			if (func_17(iLocal_158))
			{
				if (!is_ped_headtracking_ped(iLocal_158, PLAYER::PLAYER_PED_ID()))
				{
					task_look_at_entity(iLocal_158, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				}
				set_ped_keep_task(iLocal_158, true);
			}
			request_additional_text("MAUDE1", false);
		...
		case 1:
			...
			if (func_17(iLocal_158))
			{
				...
				if (!func_236(0))
				{
					if (vdist2(vVar0, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0)) > 14400f)
					{
					...
					{
						func_232(vVar0, vVar3, 18000, 1101004800);
					}
				}
				else
				{
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_100(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_100(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_100(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_59(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_173(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_100(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_100(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_100(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_91(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_100(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_100(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_100(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_65(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_70(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_100(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_100(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_92(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_96(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_95(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_93(uVar2, iVar3, iVar0, 1);
	}
}

void func_93(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_94(iParam2)];
	if (iVar0 != 0)
	{
...
int func_95(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_94(iParam1)];
...
int func_96(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_97(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_99(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_173(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!_is_dlc_data_empty(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						*iParam0[vVar16.z] = func_87(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_106(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_106(vVar16.z)] = func_87(iParam1, vVar16.x, func_106(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_106(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
	...
	*uParam0.f_12 = func_117(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_95(func_114(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_112(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_95(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_112(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
void func_118(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_100(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
bool func_173(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_100(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_100(iParam1)))
	{
		return true;
	}
	return false;
...
void func_184(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_185(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}

void func_185(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_190()
{
	...
	{
		func_179();
		_0xBF59707B3E5ED531(func_191(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_206(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		...
		func_209(iParam0, iParam3, iParam4, 0);
...
int func_222()
{
	return func_223(get_this_script_name(), 0);
}
...
void func_229(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
auto func_231(char* sParam0, int iParam1, char* sParam2)
{
...
bool func_232(Vector3 vParam0, Vector3 vParam1, int iParam2, float fParam3)
{
	if (iLocal_153 < iLocal_151)
	{
		if (!func_20())
		{
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_152 > iParam6 + get_random_int_in_range(false, 2000))
				{
...
void func_233(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
bool func_236(int iParam0)
{
	if (func_17(iLocal_158))
	{
		...
		{
			if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iLocal_158))
			{
				return true;
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_154))
			{
				if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iLocal_154))
				{
					return true;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_156))
			{
				if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iLocal_156))
				{
					return true;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_155))
			{
				if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), iLocal_155))
				{
					return true;
				}
			}
		...
		{
			if (is_entity_at_entity(iLocal_158, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
			{
				return true;
			}
		}
...
bool func_237(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_11(PLAYER::PLAYER_PED_ID()) && func_11(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_243(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_238(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_238(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_239(int iParam0, float fParam1)
{
	...
	{
		if (func_240(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_240(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_243(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
bool func_244(int iParam0, float fParam1)
{
	...
	if (func_11(PLAYER::PLAYER_PED_ID()) && func_11(iParam0))
	{
		if (func_253(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
int func_246(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_247(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_247(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_248(iParam4, iParam7)};
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_11(iLocal_158))
			{
				...
				{
					_0x2A56C06EBEF2B0D9(sLocal_160, iLocal_158, false);
				}
			}
			func_341();
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_338())
				{
					if (func_334(1, 1093140480, 0))
					{
						...
						func_330();
						register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), sLocal_159, 0, false, 0);
						if (func_11(iLocal_158))
						{
							register_entity_for_cutscene(iLocal_158, sLocal_160, 0, false, 0);
						}
						if (func_11(iLocal_154))
						{
							register_entity_for_cutscene(iLocal_154, sLocal_161, 0, false, 0);
						}
						if (func_11(iLocal_155))
						{
							register_entity_for_cutscene(iLocal_155, sLocal_162, 0, false, 0);
						}
		...
		case 1:
			if (func_11(iLocal_154))
			{
				if (func_17(iLocal_158))
				{
					if (can_set_exit_state_for_registered_entity(sLocal_160, false) && can_set_exit_state_for_registered_entity(sLocal_161, false))
					{
						if (has_anim_dict_loaded("special_ped@maude@base"))
						{
							...
							set_synchronized_scene_looped(iLocal_147, true);
							_0x394B9CD12435C981(iLocal_147, false);
							task_synchronized_scene(iLocal_158, iLocal_147, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1000f, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
							iVar0 = 4096;
							play_synchronized_entity_anim(iLocal_154, iLocal_147, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1000f);
							set_ped_keep_task(iLocal_158, true);
						}
					}
				}
			}
			if (can_set_exit_state_for_registered_entity(sLocal_159, false))
			{
				_0x81CBAE94390F9F89();
...
void func_256()
{
	...
	if (!func_11(iVar0))
	{
		iVar0 = get_random_vehicle_in_sphere(vLocal_329, 10f, false, 16390);
		if (!func_11(iVar0))
		{
			return;
		}
...
bool func_267()
{
	...
	request_additional_text("MAUDE1", false);
	if (has_anim_dict_loaded("special_ped@maude@base") && has_additional_text_loaded(false))
	{
		return true;
	}
	return false;
...
void func_268(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (iParam1)
			{
				iLocal_80 = add_scenario_blocking_area(vVar0, vVar3, 0, 1, 1, 1);
...
void func_269()
{
	...
	if (func_322(vVar6, 0))
	{
		func_316(vVar0, vVar3, fVar9, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_270(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		vLocal_329 = {2719.87f, 4143.46f, 43.46f};
	}
	else
	{
		func_316(vVar0, vVar3, fVar9, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_270(2710.665f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		vLocal_329 = {2710.665f, 4149.075f, 42.7026f};
	}
}

void func_270(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_315(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_312(get_entity_coords(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_271(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_271(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		if (func_307(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_303(iParam5, &Var0, vParam1, fParam4, func_306(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_287(iParam0, 0, 0)) || func_287(iParam0, 1, 0)) || func_287(iParam0, 2, 0)) || func_306(iParam0) != 145) || func_286(iParam0)) || func_285(iParam0)) || func_284(iParam0)) || func_283(iParam0)) || !func_275(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_285(iParam0))
		{
		}
...
bool func_287(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_288(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_288(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
auto func_294(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_295(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
int func_300(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_302(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_303(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_300(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
int func_307(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_309(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_310(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_312(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_313(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_316(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_317(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}
...
int func_322(Vector3 vParam0, int iParam1)
{
	return func_323(Global_93091.f_2311.f_12.f_66, vParam0, iParam3);
}

bool func_323(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_325(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_327(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_330()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_157))
	{
		...
		if (func_14(PLAYER::PLAYER_PED_ID(), vVar0, 150f))
		{
			...
			{
				iLocal_157 = get_closest_object_of_type(vVar0, 10f, iVar3, 1, 0, 1);
			}
		}
	}
}

void func_331(int iParam0, auto uParam1)
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_333(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_334(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_337(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_337(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_338()
{
	...
	if (iLocal_148 == 0)
	{
		...
		{
			if (!func_339(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 7f, 1))
			{
				...
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					task_follow_to_offset_of_entity(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 0f, 1.2f, 0f, 1f, -1, 0.1f, 1);
				}
			...
			else
			{
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], false);
				}
				iLocal_149 = -1;
			}
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4000, 0, 2);
		}
		iLocal_148++;
	}
	else if (iLocal_148 == 1)
	{
		if ((iLocal_149 == -1 || GAMEPLAY::GET_GAME_TIMER() - iLocal_149 > 3000) || (func_11(Local_81.f_28[0]) && func_339(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4.5f, 1)))
		{
			return true;
		}
	}
...
int func_339(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
void func_342()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_337(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_348()
{
	...
	else
	{
		...
		func_331(&iLocal_154, &(Local_81.f_41[0]));
		func_331(&iLocal_155, &(Local_81.f_41[1]));
		if (!ENTITY::DOES_ENTITY_EXIST(func_349()))
		{
...
bool func_350(auto uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 1:
			if (!func_355(&iVar0) || !has_anim_dict_loaded("special_ped@maude@base"))
			{
				return false;
			}
			iLocal_79 = 2;
		...
		case 3:
			if (func_17(*uParam0.f_28[0]) && func_11(*uParam0.f_41[0]))
			{
				*uParam0.f_59 = create_synchronized_scene(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				...
				_0x394B9CD12435C981(*uParam0.f_59, false);
				...
				iVar6 += 512;
				iVar6 += 4096;
				play_synchronized_entity_anim(*uParam0.f_41[0], *uParam0.f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1000f);
			}
			iVar4 = 0;
			while (iVar4 <= iVar0 - 1)
			{
...
bool func_351(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_352(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_352(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_354(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_4(iParam0);
...
void func_361(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_403())
	{
...
void func_362(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_384(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_307(vParam1, 0f, 0f, 0f, 0))
		...
		func_380(vParam1, 5f, 0);
		if (func_176(iParam12))
		{
			func_379(iParam12, 0);
			while (!func_363(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_363(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_364(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_176(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_368(*iParam1, 0, &uVar0))
		{
...
bool func_365(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_366(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_368(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_369(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_369(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
...
bool func_374(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_377(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_376(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_376(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_375(*iParam0))
	{
...
bool func_378(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_379(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_301(iParam0, iParam1))
				{
...
auto func_383(auto uParam0)
{
	return *uParam0;
}

int func_384(Vector3 vParam0, Vector3 fParam1)
{
	return func_385(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_385(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_395(uParam0))
	{
		...
		if (func_394(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_387(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_387(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_389(iParam0, uVar1[iVar6], 1) && func_388(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_307(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_388(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_390(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_309(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_309(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_309(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_393(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_392())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam1.f_77, func_309(iVar2 + 1)))
				{
...
bool func_399(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_407(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_420(int iParam0)
{
	...
	if (!func_437())
	{
		...
		{
			func_184(iVar0, 1, 0);
			func_421(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_422(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_428())
	{
		...
		{
			iVar33 = func_423(get_this_script_name());
			if (iVar33 > -1)
			{
