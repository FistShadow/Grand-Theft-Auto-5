#region Local Var
	...
	auto uLocal_678 = 0;
	auto uLocal_679 = 0;
	auto uLocal_680 = 1000;
	auto uLocal_681 = 1000;
	auto uLocal_682 = 0;
	int iLocal_683 = 0;
	int iLocal_684 = 0;
	int iLocal_685 = 0;
	...
	switch (iLocal_684)
	{
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				clear_area(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 30f, 1, 0, 0, false);
				func_357();
			}
			break;
	}
...
void func_13(auto uParam0, Vector3 vParam1, auto uParam2)
{
	*uParam0 = {vParam1};
	*uParam0.f_6 = uParam4;
}
...
int func_22(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_26()
{
	...
	{
		if (func_30(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_52(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<15> Var0;
	int iVar15;
...
bool func_66(auto uParam0, char* sParam1, auto uParam2)
{
	switch (*uParam0)
	{
		case 0:
...
int func_81(auto uParam0, int iParam1, auto uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
...
void func_89(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
auto func_100(char* sParam0, int iParam1, char* sParam2)
{
...
void func_102()
{
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_116(iLocal_683, iLocal_28))
			{
				if (get_player_wanted_level(player_id()) == 0)
				{
					...
					{
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_874, 0))
						{
		...
		case 3:
			...
			{
				if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_868, 0))
				{
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), Local_868, -1);
				}
				else
				{
...
int func_129()
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, iLocal_81 - 1);
...
bool func_142()
{
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (is_vehicle_model(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), joaat("trash")))
		{
			set_entity_as_mission_entity(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), true, 0);
			iLocal_874 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
			if (func_36(iLocal_874))
			{
				return true;
			}
...
bool func_143(int iParam0, Vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_88108.f_9[1], 1))
				{
		...
		if (is_entity_playing_anim(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (get_entity_anim_current_time(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_134[iLocal_661 /*25*/].f_17) && is_entity_attached(Local_134[iLocal_661 /*25*/].f_17))
				{
					...
					ENTITY::APPLY_FORCE_TO_ENTITY_center_of_mass(Local_134[iLocal_661 /*25*/].f_17, 1, get_entity_forward_vector(*iParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (*iParam0.f_5)
	...
	switch (*iParam0.f_6)
	{
		...
		case 21:
			...
			if (GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_1 > *iParam0.f_3)
			{
				...
				{
					task_put_ped_directly_into_melee(*iParam0, PLAYER::PLAYER_PED_ID(), 8f, -1f, 10f, 0);
				}
				else
				{
		...
		case 18:
			if (!func_178(*iParam0, -2017877118))
			{
				...
				{
					task_turn_ped_to_face_coord(false, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 0);
				}
		...
		case 2:
			if (!is_ped_sitting_in_any_vehicle(*iParam0) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_1 > 3000)
			{
				func_162(iParam0);
			}
			break;
		...
		case 20:
			...
			{
				if (!is_entity_in_angled_area(*iParam0, get_offset_from_entity_in_world_coords(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
				{
					func_157(iParam0);
				}
				else
...
{
	if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), get_offset_from_entity_in_world_coords(iLocal_109, 0f, 10f, -2f), get_offset_from_entity_in_world_coords(iLocal_109, 0f, 3f, 2f), 5f, 0, true, 0) && is_ped_stopped(*iParam0))
	{
		return true;
	}
	return false;
...
void func_158(auto uParam0)
{
	if (!func_178(*uParam0, -71340211))
	{
		...
		{
			task_follow_nav_mesh_to_coord(*uParam0, Local_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, 0, func_159(Local_134[iLocal_661 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 1));
		}
		if (func_36(iLocal_109))
		{
...
float func_159(struct<2> Param0, auto uParam1, struct<2> Param2, Vector3 fParam3, int iParam4)
{
	float fVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
bool func_160()
{
	if (func_36(iLocal_109) && func_323(PLAYER::PLAYER_PED_ID()))
	{
...
{
	if (func_36(iLocal_109) && (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_109, 0) && !is_ped_in_vehicle(*iParam0, iLocal_109, 0)))
	{
...
int func_168(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_169(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
			set_blip_as_friendly(iVar0, iParam1);
		}
	...
	{
		set_blip_scale(iVar0, func_169(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
bool func_172(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
void func_179(auto uParam0)
{
	...
	{
		case 1:
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_109, 1))
			{
				func_170(uParam0, 0);
				return;
			}
		...
		case 2:
			...
			else if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_109, 1))
			{
				func_170(uParam0, 0);
				return;
			}
	...
	switch (*uParam0.f_9)
	{
		case 1:
			if (!func_178(*uParam0, -2015108952))
			{
				...
				AI::TASK_PLAY_ANIM(false, "missfbi4prepp1", "_bag_pickup_garbage_man", 8f, -16f, -1, 528384, 0, 0, 0, 0);
				close_sequence_task(iVar0);
		...
		case 3:
			if (func_36(iLocal_109))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, get_offset_from_entity_in_world_coords(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						if (!func_178(*uParam0, 713668775))
						{
							...
							AI::TASK_PLAY_ANIM(false, "missfbi4prepp1", "_bag_throw_garbage_man", 8f, -8f, -1, 0, 0, 0, 0, 0);
							close_sequence_task(iVar1);
						...
						if (get_entity_anim_current_time(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_134[iLocal_661 /*25*/].f_17))
							{
								if (is_entity_attached(Local_134[iLocal_661 /*25*/].f_17))
								{
									...
									ENTITY::APPLY_FORCE_TO_ENTITY_center_of_mass(Local_134[iLocal_661 /*25*/].f_17, 1, get_entity_forward_vector(*uParam0), 0, 1, 1, 0);
								}
...
void func_182(auto uParam0)
{
	...
	if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			task_put_ped_directly_into_melee(*uParam0, PLAYER::PLAYER_PED_ID(), 8f, -1f, 10f, 0);
		}
		else
		{
			open_sequence_task(&iVar0);
	...
	if (Local_82.f_26)
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (is_entity_a_vehicle(Local_82.f_18))
			{
				...
				{
					if (get_vehicle_index_from_entity_index(Local_82.f_18) == get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 1))
					{
						return true;
					}
				}
		...
		else if (is_entity_a_ped(Local_82.f_18))
		{
			if (func_10(Local_82.f_18))
			{
				if (get_ped_index_from_entity_index(Local_82.f_18) == PLAYER::PLAYER_PED_ID())
				{
					return true;
				}
			}
...
void func_190(auto uParam0, int iParam1)
{
	...
	{
		if (is_entity_in_angled_area(*uParam0, get_offset_from_entity_in_world_coords(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), get_offset_from_entity_in_world_coords(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
			func_191(uParam0);
		}
		else if (!func_178(*uParam0, 1227113341) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), get_offset_from_entity_in_world_coords(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
			AI::CLEAR_PED_TASKS(*uParam0);
			task_go_to_entity(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 2f, 0);
		}
	}
...
void func_192(auto uParam0)
{
	if (*uParam0.f_5 != 1)
	{
		if (func_36(iLocal_109) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_178(*uParam0, 2104565373) && is_ped_in_vehicle(*uParam0, iLocal_109, 0))
			{
				if (func_151(PLAYER::PLAYER_PED_ID(), iLocal_109, 10f, 1))
				{
					...
					{
						task_drive_by(*uParam0, PLAYER::PLAYER_PED_ID(), false, 0f, 0f, 0f, 10f, 100, 1, -957453492);
						*uParam0.f_1 = GAMEPLAY::GET_GAME_TIMER();
						*uParam0.f_6 = 9;
					}
				}
...
bool func_194(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	...
	if (*iParam0.f_5 != 1 || iParam2)
	{
		...
		if (*iParam0.f_10 == 0 && *iParam0.f_7 == 4)
		{
			if (func_155(iParam0))
			{
				if (is_ped_in_vehicle(*iParam0, iLocal_109, 0))
				{
					task_drive_by(*iParam0, PLAYER::PLAYER_PED_ID(), false, 0f, 0f, 0f, 10f, 100, 1, -957453492);
				...
				if (func_36(iLocal_109))
				{
					if (is_ped_in_vehicle(*iParam0, iLocal_109, 0))
					{
						if (get_entity_speed(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								task_vehicle_mission_ped_target(*iParam0, iLocal_109, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
								*iParam0.f_6 = 7;
							...
							else
							{
								task_cower(*iParam0, -1);
								*iParam0.f_6 = 12;
								task_vehicle_mission_ped_target(Local_111[func_165(iParam1) /*11*/], iLocal_109, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
...
{
	if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), get_offset_from_entity_in_world_coords(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) && get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()))
	{
		return true;
	}
	return false;
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Vector3 vParam5, int iParam6, int iParam7, float fParam8)
{
	if (func_36(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_214(*iParam0)) && !func_213(*iParam0))
				{
					func_7(iParam4);
...
void func_210(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_213(int iParam0)
{
	...
	if ((func_323(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && func_36(iParam0))
	{
	...
	switch (iLocal_684)
	{
		...
		case 3:
			if (func_36(iLocal_874))
			{
				if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_874, 0))
				{
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_874, -1);
				}
				else
				{
...
bool func_223(int iParam0)
{
	...
	if (!func_224())
	{
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && get_player_wanted_level(player_id()) == 0)
		{
			iVar0 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
			if (func_36(iVar0))
			{
...
bool func_225(int iParam0)
{
	if (!func_224())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_868) && is_vehicle_driveable(Local_868, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_868, vLocal_827, 2f, 2f, 2f, false, true, 0))
		{
			if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_868, 0)) && get_player_wanted_level(player_id()) == 0)
			{
...
void func_226(int iParam0)
{
	if (iLocal_683 > 1)
	{
		if (iLocal_685 > 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, false) && iLocal_686 == 1)
			{
				if (!is_message_being_displayed())
				{
					if (func_230(&uLocal_879, sLocal_878, Local_688[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						GAMEPLAY::SET_BIT(&(Local_688[iParam0 /*8*/].f_7), false);
					}
				}
			}
		}
		...
		{
			if ((GAMEPLAY::IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, false) && !GAMEPLAY::IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, true)) && iLocal_686 == 1)
			{
				if (!is_message_being_displayed())
				{
					if (func_230(&uLocal_879, sLocal_878, Local_688[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						GAMEPLAY::SET_BIT(&(Local_688[iParam0 /*8*/].f_7), true);
					}
				}
			}
...
void func_236(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_237(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_237(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	func_238(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}

void func_238(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
...
void func_239(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
...
void func_247(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_250(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_253(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_251(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
void func_269()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (is_vehicle_driveable(iVar0, 0))
		{
			func_270(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), get_entity_heading(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_286(iParam0, 0, 0)) || func_286(iParam0, 1, 0)) || func_286(iParam0, 2, 0)) || func_309(iParam0) != 145) || func_285(iParam0)) || func_284(iParam0)) || func_283(iParam0)) || func_282(iParam0)) || !func_274(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_284(iParam0))
		{
		}
...
bool func_287(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_310(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_311(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_312(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
void func_328(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_330(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
...
int func_337(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_332() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_330(func_331(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_344(auto uParam0, Vector3 vParam1, int iParam2, float fParam3, float fParam4, float fParam5, int iParam6, Vector3 vParam7, Vector3 vParam8)
{
	*uParam0.f_3 = {vParam1};
	*uParam0.f_6 = fParam5;
	*uParam0.f_7 = fParam6;
...
void func_348(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_349(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_351(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
