#region Local Var
	...
	int iLocal_345 = 0;
	int iLocal_346 = 0;
	Vector3 vLocal_347 = 0;
	int iLocal_350 = 0;
	int iLocal_351 = 0;
	int iLocal_352 = 0;
	int iLocal_353 = 0;
	struct<61> Local_354 = 0;
#endregion
...
void main()
{
	...
	if (func_415(Local_100.f_28[0]))
	{
		...
		set_entity_as_mission_entity(iLocal_169, true, 1);
	}
	func_414();
	if (func_413())
	{
...
void func_9()
{
	switch (iLocal_168)
	{
		...
		case 1:
			...
			else if (func_225(PLAYER::PLAYER_PED_ID(), iLocal_169) > 250f)
			{
				if (get_player_wanted_level(get_player_index()) == 0)
				{
					iLocal_168 = 2;
			...
			else
			{
				...
				{
					task_smart_flee_ped(iLocal_169, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
				}
				if (iLocal_338 == 0)
				{
					if (((!func_222() && func_221(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !is_ped_ragdoll(iLocal_169)) && func_209(&uLocal_173, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_338 = 1;
					}
				}
				else if (((((iLocal_346 < 15 && !func_222()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_343 > 10000) && func_221(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !is_ped_ragdoll(iLocal_169)) && func_209(&uLocal_173, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 3), -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 3), -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 4), -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 4), -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 3), 97230661, 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_61(iParam0, iParam2, 14, 4), 97230661, 1);
				}
			}
			break;
	}
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_93(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
		...
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_93(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_220(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_229(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_230(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, iParam5, iParam6);
}
...
void func_230(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	*uParam0.f_6 = 2;
	func_231(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}

void func_231(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_249(iParam1) && is_entity_visible(iParam1))
	{
		...
		if (!is_gameplay_hint_active())
		{
			...
			{
				func_240(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_240(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_243(vParam2, 0f, 0f, 0f, 0))
	{
		if (is_entity_a_ped(iParam1))
		{
...
int func_243(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_244(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_247(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_245(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
	...
	if (!func_237(iParam1, iParam2, iParam3))
	{
		*uParam0.f_5 = 0;
		*uParam0.f_7 = 0;
	}
...
void func_251()
{
	if (!does_blip_exist(iLocal_170) && func_415(iLocal_169))
	{
		iLocal_170 = func_252(iLocal_169, 1, 0, 5);
	}
	if (does_blip_exist(iLocal_170) && get_blip_colour(iLocal_170) != 1)
	{
		set_blip_as_friendly(iLocal_170, 0);
		set_blip_colour(iLocal_170, 1);
	}
}
...
void func_253()
{
	switch (iLocal_168)
	{
		...
		case 1:
			...
			{
				if (((iLocal_340 == 0 && !func_222()) && func_221(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_209(&uLocal_173, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_340 = 1;
					func_251();
				}
				if (func_225(PLAYER::PLAYER_PED_ID(), iLocal_169) > 250f)
				{
					iLocal_168 = 2;
				}
			}
...
void func_255()
{
	...
	{
		case 0:
			iLocal_353 = add_scenario_blocking_area(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
			func_283();
			if (func_415(iLocal_169))
			{
				func_281();
				if (func_3(iLocal_162))
				{
					...
					open_sequence_task(&iLocal_344);
					if (!is_ped_in_vehicle(iLocal_169, iLocal_162, 0))
					{
						task_follow_nav_mesh_to_coord(false, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 40000f);
						task_follow_nav_mesh_to_coord(false, -1567.85f, 5178.12f, 14.78f, 1f, 20000, 0.25f, 1, 40000f);
						task_follow_nav_mesh_to_coord(false, -1571.85f, 5181.21f, 16.88f, 1f, 20000, 0.25f, 1, 40000f);
						task_follow_nav_mesh_to_coord(false, -1579.01f, 5174.08f, 18.57f, 1f, 20000, 0.25f, 1, 40000f);
						task_enter_vehicle(false, iLocal_162, 20000, -1, 1f, 1, 0);
					}
					task_vehicle_drive_to_coord_longrange(false, iLocal_162, vLocal_347, 20f, 786469, 10f);
					task_vehicle_park(false, iLocal_162, vLocal_347, 49.567f, 3, 10f, 0);
					task_leave_vehicle(false, iLocal_162, 256);
					task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					close_sequence_task(iLocal_344);
					task_perform_sequence(iLocal_169, iLocal_344);
				}
				else
				{
					task_wander_standard(iLocal_169, 40000f, 0);
				}
			}
		...
		case 1:
			...
			else if (is_entity_at_coord(iLocal_169, vLocal_347, 5f, 5f, 5f, false, true, 0))
			{
				func_227(3);
			}
			else
			{
				...
				if (iLocal_339 == 0)
				{
					if (((func_415(iLocal_162) && is_ped_in_vehicle(iLocal_169, iLocal_162, 1)) && func_221(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_209(&uLocal_173, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_339 = 1;
					}
					if (((((iLocal_345 < 7 && !func_222()) && GAMEPLAY::GET_GAME_TIMER() - iLocal_342 > 10000) && func_221(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !is_ped_ragdoll(iLocal_169)) && func_209(&uLocal_173, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_342 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_345++;
					}
...
void func_256(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	if (does_blip_exist(*iParam0))
	{
		if (GAMEPLAY::GET_GAME_TIMER() - *iParam3 > 500)
		{
			if (get_blip_colour(*iParam0) == 1)
			{
				...
				{
					if (!is_message_being_displayed() || func_257(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if (GAMEPLAY::GET_GAME_TIMER() - iParam4 < 7500 && iParam5)
				{
					if (!is_message_being_displayed() || func_257(sParam2, 0, 0))
					{
...
auto func_257(char* sParam0, int iParam1, char* sParam2)
{
...
bool func_260()
{
	...
	if (func_415(iLocal_162))
	{
		...
		if (func_415(iLocal_162))
		{
			if (is_ped_in_vehicle(iLocal_169, iLocal_162, 0) && has_entity_been_damaged_by_entity(iLocal_162, PLAYER::PLAYER_PED_ID(), 1))
			{
				return true;
			}
...
int func_261(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	
	if (func_415(PLAYER::PLAYER_PED_ID()) && func_415(iParam0))
	{
		if (has_entity_been_damaged_by_entity(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		if (func_275(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
		if (!is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_274(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
...
bool func_262(int iParam0, float fParam1)
{
	...
	if (func_415(PLAYER::PLAYER_PED_ID()) && func_415(iParam0))
	{
		if (func_273(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_264(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_264(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_265(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_265(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_266(iParam4, iParam7)};
...
bool func_268(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_270(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_270(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
int func_274(int iParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_275(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_415(PLAYER::PLAYER_PED_ID()) && func_415(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_279(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_276(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_276(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_277(int iParam0, float fParam1)
{
	...
	{
		if (func_278(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_278(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_270(vParam1 - get_entity_coords(iParam0, 1))};
...
bool func_279(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
void func_280(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (does_blip_exist(*iParam0))
	{
		if (iParam5)
...
void func_281()
{
	if (func_415(iLocal_169))
	{
		...
		set_ped_flee_attributes(iLocal_169, 128, true);
		set_ped_flee_attributes(iLocal_169, 4, true);
		set_ped_flee_attributes(iLocal_169, 1024, true);
		...
		set_ped_can_be_targetted(iLocal_169, true);
		set_ped_path_can_drop_from_height(iLocal_169, 0);
		set_ped_path_can_use_climbovers(iLocal_169, 0);
	}
}

void func_282(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_283()
{
	if (!func_415(iLocal_162))
	{
		iLocal_162 = create_vehicle(iLocal_161, vLocal_163, fLocal_166, 1, 1);
	...
	if (func_415(iLocal_162))
	{
		...
		set_vehicle_model_is_suppressed(iLocal_161, true);
			...
			switch (iLocal_351)
			{
				case 0:
					if (func_335(1, 1093140480, 0))
					{
						if (func_415(iLocal_169))
						{
							register_entity_for_cutscene(iLocal_169, "ABIGAIL", 0, false, 0);
						}
						func_334();
						start_cutscene(0);
				...
				case 2:
					if (is_cutscene_playing())
					{
						if (can_set_exit_state_for_registered_entity("ABIGAIL", func_450(16)) && func_415(iLocal_169))
						{
							task_follow_nav_mesh_to_coord(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 40000f);
						}
...
bool func_286(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_289(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_291() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_291() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_290(iParam0));
...
int func_293(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_291() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_298(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_302(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
auto func_303(auto uParam0)
{
	return *uParam0.f_72;
}

int func_304(auto uParam0, int iParam1)
{
...
void func_313(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_317(player_id())) && !func_315(player_id(), 0)) && !func_314())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_317(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_319(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
int func_321(int iParam0, Vector3 vParam1, float fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_326(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_327(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_327(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, float fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_331(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (((((((((((((((func_332(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_332(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_332(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_332(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_332(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_332(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_332(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_332(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_332(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_332(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_332(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_332(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_332(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_332(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_332(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_332(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_332(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_335(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_339(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_223(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_339(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_341()
{
	request_additional_text("ABGAIL2", false);
	STREAMING::REQUEST_MODEL(iLocal_161);
	if ((!func_222() && has_additional_text_loaded(false)) && STREAMING::HAS_MODEL_LOADED(iLocal_161))
	{
		...
		if (func_415(Local_100.f_35[0]))
		{
			...
			set_entity_as_mission_entity(iLocal_162, true, 1);
			set_model_as_no_longer_needed(iLocal_161);
		}
		iLocal_167 = 1;
	}
...
void func_343()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_339(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_347(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				case 8:
					cVar0 = {func_355(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_354(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_353(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_352(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_351(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_350(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_356(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_358(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_360(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_239(0)) || func_359(1))
			{
			}
			else
			{
...
void func_363(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			func_369(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, vLocal_163, fLocal_166);
			func_227(2);
			break;
		
		case 2:
			func_369(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, vLocal_163, fLocal_166);
			func_227(2);
			break;
	...
	if (!func_368())
	{
		func_366(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_365(0, -1, 1);
	func_364(1, 1, 1);
}
...
void func_366(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_369(Vector3 vParam0, float fParam1, Vector3 vParam2, float fParam3, Vector3 vParam4, float fParam5, Vector3 vParam6, float fParam7)
{
	int iVar0;
	
	if (func_328(vParam0))
	{
		while (!func_374(&iVar0, 0, vParam4, fParam7, 1, 0))
		{
			wait(0);
		}
		set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), iVar0, -1);
		func_373(&iVar0);
	}
	else if (!func_413())
	{
		func_321(PLAYER::PLAYER_PED_ID(), vParam0, fParam3, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_161);
	...
	while (!func_370(&iLocal_169, 16, vParam8, fParam11, "RC ABIGAIL 2", 1))
	{
		wait(0);
	}
	iLocal_162 = create_vehicle(iLocal_161, vParam12, fParam15, 1, 1);
	set_vehicle_model_is_suppressed(iLocal_161, true);
	set_model_as_no_longer_needed(iLocal_161);
	func_283();
	if (func_328(vParam8))
...
bool func_370(int iParam0, int iParam1, Vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_371(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_371(int iParam0, int iParam1, Vector3 vParam2, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_372(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_374(int iParam0, int iParam1, Vector3 vParam2, float fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_375(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_158(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_380(*iParam1, 0, &uVar0))
		{
...
bool func_376(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_377(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_379(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_380(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_382(iVar0, iParam1, uParam2))
	{
		return false;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_381(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_382(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_386(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_329(iParam0, 0, 0)) || func_329(iParam0, 1, 0)) || func_329(iParam0, 2, 0)) || func_399(iParam0) != 145) || func_398(iParam0)) || func_397(iParam0)) || func_381(iParam0)) || func_396(iParam0)) || !func_388(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_397(iParam0))
		{
		}
...
bool func_403(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_406(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && get_vehicle_mod(*uParam0, 24) != func_405(*uParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*uParam0, 24, func_405(*uParam0, *uParam1[38] - 1), false);
	}
	if (func_404(*uParam0))
	{
...
bool func_407(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_408(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_416(int iParam0)
{
	func_7(&uLocal_88, 0, 0);
	set_wanted_level_multiplier(1f);
	set_vehicle_model_is_suppressed(iLocal_161, false);
	set_model_as_no_longer_needed(iLocal_161);
	func_6(&iLocal_170);
	...
	remove_scenario_blocking_area(iLocal_353, 0);
	if (iParam0 == 1)
	{
...
void func_417(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_425(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_426(auto uParam0, int iParam1)
{
	if (*(uParam0[iParam1 /*10*/]).f_7 == 1)
	{
...
void func_427(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_428(int iParam0)
{
	...
	if (!func_445())
	{
		...
		{
			func_166(iVar0, 1, 0);
			func_429(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_430(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_436())
	{
		...
		{
			iVar33 = func_431(get_this_script_name());
			if (iVar33 > -1)
			{
