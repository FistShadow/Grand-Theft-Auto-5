#region Local Var
	...
	char* sLocal_51 = 0;
	Vector3 vLocal_52 = 0;
	struct<2>[] Local_55 = new struct<2>[4];
	struct<10>[] Local_64 = new struct<10>[8];
	struct<5>[] Local_145 = new struct<5>[4];
	Vector3 vLocal_166 = 0;
	struct<2>[] Local_169 = new struct<2>[9];
	struct<6> Local_188 = 0;
	auto uLocal_194 = 0;
	auto uLocal_195 = 1092616192;
	auto uLocal_196 = 1101004800;
	auto uLocal_197 = 0;
	auto uLocal_198 = 0;
	auto uLocal_199 = 0;
	auto uLocal_200 = 0;
	...
	int iLocal_409 = 0;
	int iLocal_410 = 0;
	Vector3 vLocal_411 = 0;
	Vector3 fLocal_414 = 0;
	int iLocal_415 = 0;
	Vector3 vLocal_416 = 0;
	Vector3 fLocal_419 = 0;
	int iLocal_420 = 0;
	Vector3 vLocal_421 = 0;
	Vector3 fLocal_424 = 0;
	int iLocal_425 = 0;
	Vector3 vLocal_426 = 0;
	Vector3 fLocal_429 = 0;
	Vector3 vLocal_430 = 0;
	Vector3 vLocal_433 = 0;
	Vector3 vLocal_436 = 0;
	int iLocal_439 = 0;
	Vector3 vLocal_440 = 0;
	float fLocal_443 = 0;
	int iLocal_444 = 0;
	int iLocal_445 = 0;
	int iLocal_446 = 0;
...
void func_8()
{
	switch (iLocal_2099)
	{
		case 0:
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Local_55[0 /*2*/], false, false, false, true, false, false, 0, false);
			}
			set_vehicle_can_be_visibly_damaged(Local_55[0 /*2*/], false);
			set_vehicle_can_be_visibly_damaged(Local_55[1 /*2*/], false);
		...
		case 1:
			if (func_100(PLAYER::PLAYER_PED_ID()) && func_100(Local_55[0 /*2*/]))
			{
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 400f && !is_entity_on_screen(Local_55[0 /*2*/]))
				{
					func_86(9);
				}
			}
			...
			if (!iLocal_453 && func_85(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) < 200f)
			{
			...
			{
				if (func_85(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) > 220f)
				{
				...
				else if (func_85(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) < 200f)
				{
					if (iLocal_454 && STREAMING::HAS_MODEL_LOADED(joaat("bison")))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(Local_55[3 /*2*/]))
						{
							Local_55[3 /*2*/] = create_vehicle(joaat("bison"), -317.0741f, -2594.14f, 5.0004f, 316.2352f, 1, 1);
			...
			if (is_entity_attached_to_entity(Local_55[1 /*2*/], get_players_last_vehicle()) || ((is_entity_in_angled_area(Local_55[2 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0) && is_entity_in_angled_area(Local_64[3 /*10*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)) && is_entity_in_angled_area(Local_55[0 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)))
			{
				...
				if (does_blip_exist(iLocal_378))
				{
					remove_blip(&iLocal_378);
				}
				if (iLocal_390)
				{
					clear_prints();
				...
				if (func_41(&Local_188, vLocal_52, 0.1f, 0.1f, 2f, 1, Local_64[3 /*10*/], 0, 0, get_players_last_vehicle(), "dkp1_tk2", "DKP1_ABFLD", "", "", "", "DKP1_TRUCK", "DKP1_TRUCKBK", 0, 1, 1, -1) || (does_blip_exist(Local_188.f_5) && is_entity_in_angled_area(get_players_last_vehicle(), -340.1324f, -2630.243f, 5.001461f, -346.5508f, -2636.808f, 12.68896f, 14.9375f, 0, true, 0)))
				{
					remove_scenario_blocking_areas();
					func_40(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 7f, -1, 1056964608, 0, 1, 0);
					set_vehicle_is_considered_by_player(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0);
					set_vehicle_is_considered_by_player(Local_55[0 /*2*/], 0);
		...
		case 2:
			if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					set_ped_keep_task(Local_64[3 /*10*/], true);
					task_look_at_entity(Local_64[3 /*10*/], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					clear_sequence_task(&iLocal_379);
					open_sequence_task(&iLocal_379);
					task_leave_any_vehicle(false, 0, 0);
					task_go_to_entity(false, PLAYER::PLAYER_PED_ID(), -1, 3f, 1f, 2f, 0);
					task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), -1);
					close_sequence_task(iLocal_379);
					task_perform_sequence(Local_64[3 /*10*/], iLocal_379);
					clear_sequence_task(&iLocal_379);
					iLocal_2099++;
				}
			}
		...
		case 3:
			if (!func_11())
			{
				if (func_100(Local_55[3 /*2*/]))
				{
					...
					clear_sequence_task(&iLocal_379);
					open_sequence_task(&iLocal_379);
					task_enter_vehicle(false, Local_55[3 /*2*/], -1, -1, 2f, 1, 0);
					task_vehicle_mission_coors_target(false, Local_55[3 /*2*/], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, 1);
					task_vehicle_mission_ped_target(false, Local_55[3 /*2*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, 1);
					close_sequence_task(iLocal_379);
					task_perform_sequence(Local_64[3 /*10*/], iLocal_379);
					clear_sequence_task(&iLocal_379);
				}
...
void func_28(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_34(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_34(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_34(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
	...
	*iParam0.f_15 = 0;
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(*iParam0.f_17[iVar0]))
		{
			...
			if (iParam1)
			{
				if (is_ped_group_member(*iParam0.f_17[iVar0], func_37()) && *iParam0.f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
bool func_40(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_41(int iParam0, Vector3 vParam1, Vector3 vParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18)
{
	return func_42(iParam0, vParam1, vParam4, func_80(), func_80(), iParam7, 5, iParam8, iParam9, iParam10, iParam11, sParam12, sParam13, sParam14, sParam15, sParam16, sParam17, iParam19, iParam20, sParam18, 0, 0, iParam21, iParam22, 0, 0, 0, 1, 1065353216);
}

bool func_42(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3, Vector3 vParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, char* sParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, int iParam25, int iParam26, int iParam27, float fParam28)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (is_screen_faded_in())
		{
			...
			if (iVar1)
			{
				...
				if (iParam26 && is_player_wanted_level_greater(player_id(), 0))
				{
					...
					if ((!func_56(iParam0, 1) && !func_55(iParam0)) && !GAMEPLAY::IS_BIT_SET(*iParam0.f_13, false))
					{
						if (iParam30)
						{
					...
					if (iVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(*iParam0.f_17[iVar2]))
							{
								...
								else if (!is_ped_group_member(*iParam0.f_17[iVar2], func_37()) || !func_47(*iParam0.f_17[iVar2], 1))
								{
									iVar1 = false;
								}
							}
...
bool func_44(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 12))
	{
		...
		{
			if (func_45(1, 0, 1) || GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 7))
			{
				return true;
			}
		}
	}
	else if (func_45(1, 0, 1) || GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 7))
	{
		return true;
	}
	return false;
...
bool func_47(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (is_ped_group_member(iParam0, func_37()))
		{
			set_group_separation_range(func_37(), 50f);
			return true;
		}
...
bool func_61(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, char* sParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, auto uParam13, auto uParam14, auto uParam15, int iParam16, int iParam17)
{
	...
	*uParam0.f_16 = uParam1;
						...
						if (func_59(*uParam0.f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
								{
									...
									if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_17[iVar0], -1794415470) == 7 && !func_76(*uParam0.f_17[iVar0], *uParam0.f_21))
									{
	...
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 26))
	{
		if ((!func_73(uParam0) && is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
			if ((!PED::IS_PED_INJURED(*uParam0.f_17[0]) || !PED::IS_PED_INJURED(*uParam0.f_17[1])) || !PED::IS_PED_INJURED(*uParam0.f_17[2]))
			{
				...
				{
					if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && !func_56(uParam0, 2))
					{
						iVar13 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
				...
				if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
				{
					...
					if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (is_vehicle_driveable(iVar13, 0))
						{
							if (is_ped_group_member(*uParam0.f_17[iVar0], func_37()))
							{
								if (!func_73(uParam0) && is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
								{
					...
					if (is_ped_group_member(*uParam0.f_17[iVar0], func_37()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar32))
						{
							...
							{
								if (func_70(iVar0, uParam0) || !GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 27))
								{
									set_ped_group_member_passenger_index(*uParam0.f_17[iVar0], iVar0);
					...
					if ((!is_ped_group_member(*uParam0.f_17[iVar0], func_37()) && !func_68(*uParam0.f_17[iVar0], iParam10)) && !func_67(*uParam0.f_17[iVar0], iParam10))
					{
					...
					{
						if (((func_47(*uParam0.f_17[iVar0], 1) || func_68(*uParam0.f_17[iVar0], iParam10)) || iParam12) || (is_vehicle_driveable(iParam10, 0) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
						{
							if (does_blip_exist(*uParam0.f_1[iVar0]))
							{
						...
						if (!is_ped_sitting_in_vehicle(*uParam0.f_17[iVar0], iParam10))
						{
							if ((is_entity_at_entity(*uParam0.f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 11)) && !((iParam17 && is_player_wanted_level_greater(player_id(), 0)) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!is_ped_jumping_out_of_vehicle(*uParam0.f_17[iVar0]) && !is_ped_jumping_out_of_vehicle(PLAYER::PLAYER_PED_ID())) && !func_66(*uParam0.f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(*uParam0.f_17[iVar0])) && !is_ped_getting_up(*uParam0.f_17[iVar0])) && !is_entity_on_fire(iParam10))
										{
											set_blocking_of_non_temporary_events(*uParam0.f_17[iVar0], true);
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
						{
							if (func_71(*uParam0.f_17[iVar0]) || is_entity_at_entity(*uParam0.f_17[iVar0], PLAYER::PLAYER_PED_ID(), *uParam0.f_8, *uParam0.f_8, *uParam0.f_8, 0, 1, 0))
							{
								iVar1--;
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!is_entity_at_entity(*uParam0.f_17[iVar0], PLAYER::PLAYER_PED_ID(), *uParam0.f_8 * 0.85f, *uParam0.f_8 * 0.85f, *uParam0.f_8, 0, 1, 0) && !func_71(*uParam0.f_17[iVar0]))
						{
						}
					}
					iVar0++;
...
bool func_67(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!is_ped_group_member(iParam0, func_37()))
		{
...
void func_86(int iParam0)
{
	...
	else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1298.369f, -3062.1f, -71.22691f, 790.9125f, -3068.998f, 63.91419f, 250f, 0, false, 0))
	{
...
void func_87(Vector3 vParam0, float fParam1)
{
...
void func_94(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_96(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_96(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_101(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_170(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_163(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_102(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_103(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_103(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_150();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_128())
		{
			func_121(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_105(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_106(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_113(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_115(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_116(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_118(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_119(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_120(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_120(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_121(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_126(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_127(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_130(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_134(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_131(Var9.f_1)) && iVar70 < 50)
			{
...
int func_133(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_137(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
bool func_139(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_149())
		{
			*uParam0 = func_145(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_143() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_122(func_142(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_145(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_147(iVar0))
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_146(iVar0, 0), 1);
...
auto func_150()
{
	...
	func_158(&uVar0, TIME::GET_CLOCK_HOURS());
	func_153(&uVar0, get_clock_day_of_month());
	func_152(&uVar0, get_clock_month());
...
{
	return shift_right(iParam0, 26) & 31 * func_156(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_160(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_173()
{
	...
	switch (iLocal_2099)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("packer")) && STREAMING::HAS_MODEL_LOADED(joaat("armytrailer")))
			{
				...
				func_200(6, 0);
				Local_55[2 /*2*/] = create_vehicle(joaat("packer"), 298.2343f, -2942.77f, 5.0003f, 0f, 1, 1);
				set_vehicle_is_considered_by_player(Local_55[2 /*2*/], 0);
				set_vehicle_has_strong_axles(Local_55[2 /*2*/], true);
				set_vehicle_colour_combination(Local_55[2 /*2*/], 0);
				set_vehicle_tyres_can_burst(Local_55[2 /*2*/], false);
				Local_55[1 /*2*/] = create_vehicle(joaat("armytrailer"), 298.27f, -2951.27f, 7.86f, 0f, 1, 1);
				attach_vehicle_to_trailer(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
				_0x95CF53B3D687F9FA(Local_55[1 /*2*/]);
				set_vehicle_tyres_can_burst(Local_55[1 /*2*/], false);
				set_vehicle_has_strong_axles(Local_55[1 /*2*/], true);
				iLocal_383 = 0;
		...
		case 1:
			if (func_199())
			{
				func_198(&uLocal_460, sLocal_49);
				func_198(&uLocal_460, sLocal_50);
				iLocal_396 = -1;
				iLocal_397 = 0;
				iLocal_2099++;
			}
		...
		case 2:
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				switch (iLocal_397)
				{
					case 0:
			...
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || is_ped_fleeing(Local_64[6 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[6 /*10*/], 1) > 100f)
				{
			...
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || is_ped_fleeing(Local_64[7 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[7 /*10*/], 1) > 100f)
				{
			...
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || is_ped_fleeing(Local_64[4 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[4 /*10*/], 1) > 100f)
				{
			...
			{
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || is_ped_fleeing(Local_64[5 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[5 /*10*/], 1) > 100f)
				{
					AI::CLEAR_PED_TASKS(Local_64[5 /*10*/]);
					func_9(&(Local_64[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_203(&Local_188, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_55[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((does_blip_exist(Local_188.f_5) && is_entity_in_angled_area(Local_55[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, true, 0)) && func_195(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/])))
			{
		...
		case 3:
			if (func_75(Local_55[0 /*2*/]) || GAMEPLAY::GET_GAME_TIMER() - iLocal_452 > 3500)
			{
				iLocal_444 = create_camera_with_params(26379945, 341.6419f, -2965.525f, 4.037704f, 17.06695f, 0.473599f, 112.4448f, 34f, 0, 2);
				set_cam_active(iLocal_444, true);
				shake_cam(iLocal_444, "HAND_SHAKE", 0.4f);
				set_cam_params(iLocal_444, 341.6419f, -2965.525f, 4.037704f, -4.346406f, 0.473595f, 112.4448f, 34f, 6000, 1, 1, 2);
				func_188(0, 340.6675f, -2964.01f, 1.4937f, 1, 0, 1, 3000, 0, 1);
				func_81(&uLocal_460, joaat("prop_tarp_strap"));
				set_entity_coords(Local_55[0 /*2*/], vLocal_411, 1, false, 0, 1);
		...
		case 5:
			if (has_cutscene_loaded() && STREAMING::HAS_MODEL_LOADED(joaat("prop_tarp_strap")))
			{
				register_entity_for_cutscene(Local_55[2 /*2*/], "DockHeist_truck", 0, false, 0);
				...
				register_entity_for_cutscene(false, "sub_cover", 2, joaat("prop_sub_cover_01"), 0);
				register_entity_for_cutscene(false, "Floyd", 2, joaat("ig_floyd"), 0);
				_0x2A56C06EBEF2B0D9("Trevor", PLAYER::PLAYER_PED_ID(), false);
		...
		case 6:
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity("Floyd", false)))
				{
					Local_64[3 /*10*/] = get_ped_index_from_entity_index(get_entity_index_of_registered_entity("Floyd", false));
			...
			if (can_set_exit_state_for_registered_entity("Floyd", false))
			{
				iLocal_447 = 1;
			}
			if (can_set_exit_state_for_registered_entity("DockHeist_truck", false))
			{
				set_all_vehicles_spawn(Local_55[2 /*2*/], 1, 0, 0);
				set_vehicle_doors_shut(Local_55[2 /*2*/], 1);
				iLocal_448 = 1;
			}
			if (can_set_exit_state_for_registered_entity("DockHeist_trailer", false))
			{
				set_all_vehicles_spawn(Local_55[1 /*2*/], 1, 0, 0);
				iLocal_451 = 1;
			}
			if (can_set_exit_state_for_registered_entity("submarine", false))
			{
				iLocal_449 = 1;
			}
			if (can_set_exit_state_for_registered_entity("sub_cover", false))
			{
				iLocal_450 = 1;
			}
			else if (!ENTITY::DOES_ENTITY_EXIST(Local_169[4 /*2*/]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity("sub_cover", joaat("prop_sub_cover_01"))))
				{
			...
			if (((((iLocal_446 && iLocal_447) && iLocal_448) && iLocal_449) && iLocal_450) && iLocal_451)
			{
				...
				{
					set_ped_into_vehicle(Local_64[3 /*10*/], Local_55[2 /*2*/], false);
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[2 /*2*/], -1);
					_0x16B5E274BDE402F8(Local_55[0 /*2*/], Local_55[1 /*2*/], 0f, -4f, -0.7f, 0f, 0f, 0f, 0f, 0f, 0f, -1f);
					set_vehicle_is_considered_by_player(Local_55[0 /*2*/], 0);
					set_vehicle_doors_shut(Local_55[0 /*2*/], 1);
					set_vehicle_doors_locked(Local_55[0 /*2*/], 10);
					set_vehicle_engine_on(Local_55[0 /*2*/], false, 1, 0);
					...
					Local_169[5 /*2*/] = create_object(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, 1, true, false);
	...
	if (does_blip_exist(Local_188.f_5))
	{
		set_blip_route(Local_188.f_5, false);
	}
	if (func_100(PLAYER::PLAYER_PED_ID()) && func_100(Local_55[0 /*2*/]))
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, 1) > 2500f)
		{
			func_86(9);
		}
	}
...
bool func_178()
{
	...
	switch (iLocal_410)
	{
		case 0:
			...
			set_entity_coords(Local_55[0 /*2*/], vLocal_411, 1, false, 0, 1);
			set_entity_heading(Local_55[0 /*2*/], fLocal_414);
			freeze_entity_position(Local_55[0 /*2*/], true);
			iLocal_380 = start_particle_fx_looped_on_entity("scr_pls_sub_water_drips", Local_55[0 /*2*/], 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
			set_particle_fx_looped_evolution(iLocal_380, "flow", 1f, 0);
		...
		case 1:
			...
			if (vLocal_430.z <= 1f)
			{
				freeze_entity_position(Local_55[0 /*2*/], false);
				set_cam_params(iLocal_444, 310.0923f, -2949.529f, 10.9528f, -20.2654f, 2.7992f, -141.6393f, 25.6f, false, 1, 1, 2);
				set_cam_params(iLocal_444, 308.3542f, -2950.972f, 10.8434f, 0.0544f, 2.7992f, -137.3849f, 25.6f, 12500, 1, 1, 2);
		...
		case 2:
			...
			{
				set_cam_params(iLocal_444, 356.9992f, -2984.961f, 117.2741f, -68.2497f, -0.1106f, 66.9743f, 20f, false, 1, 1, 2);
				set_cam_params(iLocal_444, 361.4758f, -2966.824f, 117.2872f, -66.6976f, -0.1106f, 84.372f, 20f, 10000, 1, 1, 2);
				fLocal_443 = get_cam_near_clip(iLocal_444);
				set_cam_near_clip(iLocal_444, 1.8f);
				iLocal_410++;
			}
			else
			{
		...
		case 3:
			if (fLocal_424 >= 40f)
			{
				set_cam_params(iLocal_444, 289.8129f, -2944.046f, 5.5715f, 17.075f, 0.1698f, -109.4507f, 38.3f, false, 1, 1, 2);
				set_cam_params(iLocal_444, 290.8941f, -2941.987f, 5.5781f, 22.5176f, 0.1698f, -128.6537f, 38.3f, 7000, 1, 1, 2);
				set_cam_near_clip(iLocal_444, fLocal_443);
				fLocal_424 = 80f;
				detach_entity(Local_169[7 /*2*/], 1, true);
				...
				iLocal_2105 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_410++;
			}
			else
			{
		...
		case 4:
			if (fLocal_424 >= 108f)
			{
				...
				set_cam_params(iLocal_444, 300.0253f, -2973.253f, 5.7369f, 10.5662f, 0.1117f, 4.0913f, 22.7929f, false, 1, 1, 2);
				set_cam_params(iLocal_444, 300.0292f, -2973.294f, 6.1746f, 5.2629f, 0.1117f, 4.0913f, 22.7929f, 8000, 1, 1, 2);
				set_cam_shake_amplitude(iLocal_444, 0.25f);
				detach_entity(Local_169[7 /*2*/], 1, true);
				attach_entity_to_entity(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, vLocal_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1);
				set_entity_coords_no_offset(Local_169[8 /*2*/], get_offset_from_entity_in_world_coords(Local_169[7 /*2*/], vLocal_426), 0, 0, 1);
				if (does_particle_fx_looped_exist(iLocal_380))
				{
					stop_particle_fx_looped(iLocal_380, 0);
				}
				iLocal_410++;
			}
			else
			{
				fVar0 = 1f - func_182(to_float(GAMEPLAY::GET_GAME_TIMER() - iLocal_2105 + 1500) / 3000f, 0f, 1f);
				set_particle_fx_looped_evolution(iLocal_380, "flow", fVar0, 0);
				func_183(1, 5.5f);
			}
			break;
		...
		case 5:
			...
			if (vLocal_430.z <= 11f)
			{
				detach_entity(Local_55[0 /*2*/], 1, true);
				iLocal_410++;
			}
			else
			{
		...
		case 6:
			...
			{
				iLocal_2105 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_410++;
			}
			break;
		
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2105)
			{
				freeze_entity_position(Local_169[8 /*2*/], true);
				iLocal_410++;
			}
			else
			{
	...
	else if (is_screen_faded_out())
	{
		...
		remove_particle_fx_in_range(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 30f);
		iLocal_2103 = 2;
		iLocal_2102 = 1;
	}
	return false;
...
bool func_185(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, int iParam4)
{
	if (func_186(vParam1) || func_186(vParam4))
	{
		return false;
	}
	if (*uParam0.f_863)
	{
		if ((func_88(*uParam0.f_863.f_4, vParam1, 0) && func_88(*uParam0.f_863.f_7, vParam4, 0)) && *uParam0.f_863.f_10 == fParam7)
		{
			*uParam0.f_863.f_2 = 0;
...
void func_188(int iParam0, Vector3 vParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	display_radar(false);
	display_hud(false);
...
void func_198(auto uParam0, char* sParam1)
{
	int iVar0;
...
bool func_199()
{
	...
	{
		Local_169[6 /*2*/] = create_object(iLocal_415, vLocal_416, 1, true, false);
		set_entity_coords(Local_169[6 /*2*/], vLocal_416, 1, false, 0, 1);
		set_entity_heading(Local_169[6 /*2*/], fLocal_419);
		freeze_entity_position(Local_169[6 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[7 /*2*/]))
	{
		Local_169[7 /*2*/] = create_object(iLocal_420, get_offset_from_entity_in_world_coords(Local_169[6 /*2*/], vLocal_421), 1, true, false);
	}
	...
	{
		Local_169[8 /*2*/] = create_object(iLocal_425, get_offset_from_entity_in_world_coords(Local_169[7 /*2*/], vLocal_426), 1, true, false);
		_0x3910051CCECDB00C(Local_169[8 /*2*/], false);
		attach_entity_to_entity(Local_169[8 /*2*/], Local_169[7 /*2*/], -1, vLocal_426, 0f, 0f, fLocal_429, 0, 0, 0, 0, 2, 1);
		detach_entity(Local_169[8 /*2*/], 1, false);
		freeze_entity_position(Local_169[8 /*2*/], true);
	}
	if (!iLocal_384)
	{
		...
		{
			iLocal_439 = add_rope(get_offset_from_entity_in_world_coords(Local_169[7 /*2*/], vLocal_433), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, 0, 0, 1, 1f, 0, 0);
			_0x36CCB9BE67B970FD(iLocal_439, 1);
			_0xDC57A637A20006ED(iLocal_439, 2);
			rope_draw_shadow_enabled(&iLocal_439, 0);
			attach_entities_to_rope(iLocal_439, Local_169[7 /*2*/], Local_169[8 /*2*/], get_offset_from_entity_in_world_coords(Local_169[7 /*2*/], vLocal_433), get_offset_from_entity_in_world_coords(Local_169[8 /*2*/], vLocal_436), 70f, 0, 0, 0, 0);
			iLocal_384 = 1;
			return true;
		}
...
void func_201(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_203(int iParam0, Vector3 vParam1, Vector3 vParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	return func_42(iParam0, vParam1, vParam4, func_80(), func_80(), iParam7, 5, 0, 0, 0, iParam8, sParam9, func_204(), func_204(), func_204(), func_204(), sParam10, 0, iParam12, sParam11, 0, iParam13, iParam14, iParam15, 0, 0, 0, 1, 1065353216);
}
...
void func_205(auto uParam0, char* sParam1)
{
	int iVar0;
...
void func_206()
{
	...
	switch (iLocal_2099)
	{
		case 0:
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]) && !does_blip_exist(iLocal_378))
			{
				iLocal_378 = func_252(Local_169[2 /*2*/]);
			}
			set_blip_name_from_text_file(iLocal_378, "SUBBTN_LABEL");
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			if (func_100(Local_64[4 /*10*/]))
			{
				set_blocking_of_non_temporary_events(Local_64[4 /*10*/], true);
				set_ped_path_can_use_climbovers(Local_64[4 /*10*/], 0);
			}
			func_251(&uLocal_460, sLocal_51);
			...
			if (iLocal_2108[0] == -1)
			{
				iLocal_2108[0] = AUDIO::GET_SOUND_ID();
			}
			if (iLocal_2108[1] == -1)
			{
				iLocal_2108[1] = AUDIO::GET_SOUND_ID();
			}
			iLocal_2099++;
			break;
		...
		case 1:
			if (iLocal_383)
			{
				...
				func_245();
				if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, true, 0) && !is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) && !func_191(0))
				{
					if (is_control_just_pressed(2, 51))
					{
						iLocal_444 = create_camera_with_params(26379945, 1249.929f, -3010.267f, 9.590105f, 5.351202f, -1.57369f, 8.12499f, 21.33357f, 1, 2);
						set_cam_params(iLocal_444, 1249.929f, -3010.267f, 9.590105f, 4.448765f, -1.5737f, 12.68005f, 21.33357f, 3500, 0, 1, 2);
						shake_cam(iLocal_444, "hand_shake", 0.3f);
						func_188(0, 1249.787f, -3008.016f, 8.52751f, 1, 0, 1, 3000, 0, 1);
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
						AI::CLEAR_PED_TASKS_immediately(PLAYER::PLAYER_PED_ID());
						iLocal_381 = create_synchronized_scene(1250.01f, -3007.9f, 9.32f, 0f, 0f, 90f, 2);
						if (get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()))
						{
							task_synchronized_scene(PLAYER::PLAYER_PED_ID(), iLocal_381, sLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							task_synchronized_scene(PLAYER::PLAYER_PED_ID(), iLocal_381, sLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
						clear_help(1);
						iVar0 = get_closest_vehicle(1249.787f, -3008.016f, 8.52751f, 5f, false, 4);
						if (func_100(iVar0))
						{
		...
		case 2:
			if (!is_synchronized_scene_running(iLocal_381) || get_synchronized_scene_phase(iLocal_381) == 1f)
			{
				_0x81CBAE94390F9F89();
				AUDIO::PLAY_SOUND_FROM_COORD(-1, "SUB_RELEASE", 1260.896f, -3006.556f, 23.4213f, "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0, 0);
				set_cam_params(iLocal_444, 1249f, -3010.3f, 10.7f, 37.7f, 0f, -61.5f, 43.4f, false, 1, 1, 2);
				set_cam_params(iLocal_444, 1249f, -3010.3f, 10.7f, -20.1f, 0f, -48.2f, 43.4f, 1700, 2, 2, 2);
				set_cam_shake_amplitude(iLocal_444, 0.1f);
			...
			else if (is_synchronized_scene_running(iLocal_381) && get_synchronized_scene_phase(iLocal_381) >= 0.7f)
			{
				if (AI::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 713668775) != 1)
				{
					task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), 1252.594f, -3008.883f, 8.3191f, 1f, -1, 0.25f, 0, 40000f);
				}
			}
			break;
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_452 > 1500)
			{
				if (iLocal_445)
				{
					set_cam_params(iLocal_444, 1261.7f, -3013.3f, 21.7f, -62.7f, 0f, 29.5f, 40.4f, false, 3, 3, 2);
					set_cam_params(iLocal_444, 1259.9f, -3014.1f, 21.7f, -67.7f, 0f, 16.5f, 40.4f, 4000, 3, 3, 2);
					iLocal_445 = 0;
				}
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_452 > 5000 || is_control_just_pressed(2, 201))
				{
					if (does_blip_exist(iLocal_378))
					{
						remove_blip(&iLocal_378);
		...
		case 4:
			if (!func_243())
			{
				if (func_19() == 2)
				{
					...
					{
						func_201(&uLocal_213, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		case 5:
			...
			if (get_entity_submerged_level(Local_55[0 /*2*/]) > 0f || vVar1.z < -0.5f)
			{
				...
				if (iLocal_2108[0] != -1)
				{
					stop_sound(iLocal_2108[0]);
				}
				if (iLocal_2108[1] != -1)
				{
					stop_sound(iLocal_2108[1]);
				}
			}
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				...
				if (get_player_wanted_level(player_id()) > 0)
				{
					...
					give_weapon_to_ped(Local_64[6 /*10*/], joaat("weapon_pistol"), -1, false, true);
					PED::SET_PED_CONFIG_FLAG(Local_64[6 /*10*/], 330, true);
					set_ped_as_cop(Local_64[6 /*10*/], 1);
					clear_sequence_task(&iLocal_379);
					open_sequence_task(&iLocal_379);
					task_follow_nav_mesh_to_coord(false, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
					close_sequence_task(iLocal_379);
					task_perform_sequence(Local_64[6 /*10*/], iLocal_379);
					clear_sequence_task(&iLocal_379);
					...
					give_weapon_to_ped(Local_64[7 /*10*/], joaat("weapon_pistol"), -1, false, true);
					set_ped_as_cop(Local_64[7 /*10*/], 1);
					clear_sequence_task(&iLocal_379);
					open_sequence_task(&iLocal_379);
					task_follow_nav_mesh_to_coord(false, 1252.056f, -3006.94f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					task_combat_ped(false, PLAYER::PLAYER_PED_ID(), 0, 16);
					close_sequence_task(iLocal_379);
					task_perform_sequence(Local_64[7 /*10*/], iLocal_379);
					clear_sequence_task(&iLocal_379);
					func_82(&uLocal_460, joaat("s_m_m_security_01"));
				}
				else
				{
					Local_64[5 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1228.929f, -3015.008f, 8.31909f, 0, 1, true);
					set_blocking_of_non_temporary_events(Local_64[5 /*10*/], true);
					clear_sequence_task(&iLocal_379);
					open_sequence_task(&iLocal_379);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
					task_follow_nav_mesh_to_coord(false, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
					AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
					task_smart_flee_coord(false, 1252.876f, -3014.035f, 8.31909f, 300f, -1, 0, 0);
					close_sequence_task(iLocal_379);
					task_perform_sequence(Local_64[5 /*10*/], iLocal_379);
					clear_sequence_task(&iLocal_379);
					func_82(&uLocal_460, joaat("s_m_m_security_01"));
				}
				if (func_100(Local_64[4 /*10*/]))
				{
					AI::CLEAR_PED_TASKS(Local_64[4 /*10*/]);
					set_entity_coords(Local_64[4 /*10*/], 1229.557f, -3002.882f, 8.31909f, 1, false, 0, 1);
				}
				else
				{
				...
				open_sequence_task(&iLocal_379);
				task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
				task_follow_nav_mesh_to_coord(false, 1252.994f, -3004.134f, 9.319f, 2f, 20000, 0.25f, 0, 40000f);
				AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_f", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_h", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(false, sLocal_49, "react_big_variations_f", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				task_smart_flee_coord(false, 1252.994f, -3004.134f, 9.319f, 300f, -1, 0, 0);
				close_sequence_task(iLocal_379);
				task_perform_sequence(Local_64[4 /*10*/], iLocal_379);
				clear_sequence_task(&iLocal_379);
				...
				func_82(&uLocal_460, joaat("prop_sub_release"));
				func_198(&uLocal_460, sLocal_51);
				remove_waypoint_recording("docksprep1");
				_0x293220DA1B46CEBC(15f, 10f, 4);
				func_174(1);
				iLocal_2099 = 0;
			}
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) < 5f && !iLocal_388)
			{
	...
	if ((!iLocal_398 && func_100(Local_55[0 /*2*/])) && is_entity_in_water(Local_55[0 /*2*/]))
	{
		play_sound_from_entity(-1, "SUB_SPLASH", Local_55[0 /*2*/], "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0);
		iLocal_398 = 1;
	}
	if (((!iLocal_383 && ENTITY::DOES_ENTITY_EXIST(Local_169[0 /*2*/])) && ENTITY::DOES_ENTITY_EXIST(Local_169[1 /*2*/])) && func_100(Local_55[0 /*2*/]))
	{
		if (does_entity_have_physics(Local_169[0 /*2*/]) && does_entity_have_physics(Local_169[1 /*2*/]))
		{
			set_cg_at_boundcenter(Local_55[0 /*2*/]);
			Local_145[0 /*5*/] = add_rope(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2104, 1, fLocal_2104, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			attach_entities_to_rope(Local_145[0 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], get_offset_from_entity_in_world_coords(Local_169[0 /*2*/], 0f, 0f, 0f), get_offset_from_entity_in_world_coords(Local_55[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_2104, 0, 0, 0, 0);
			Local_145[1 /*5*/] = add_rope(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2104, 1, fLocal_2104, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			attach_entities_to_rope(Local_145[1 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], get_offset_from_entity_in_world_coords(Local_169[0 /*2*/], 0f, 0f, 0f), get_offset_from_entity_in_world_coords(Local_55[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_2104, 0, 0, 0, 0);
			Local_145[2 /*5*/] = add_rope(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2104, 1, fLocal_2104, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			attach_entities_to_rope(Local_145[2 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], get_offset_from_entity_in_world_coords(Local_169[1 /*2*/], 0f, 0f, 0f), get_offset_from_entity_in_world_coords(Local_55[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_2104, 0, 0, 0, 0);
			Local_145[3 /*5*/] = add_rope(1260.752f, -3004.994f, 22.68315f, 0f, 0f, 0f, fLocal_2104, 1, fLocal_2104, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			attach_entities_to_rope(Local_145[3 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], get_offset_from_entity_in_world_coords(Local_169[1 /*2*/], 0f, 0f, 0f), get_offset_from_entity_in_world_coords(Local_55[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_2104, 0, 0, 0, 0);
			iLocal_383 = 1;
			iLocal_385 = 0;
			activate_physics(Local_55[0 /*2*/]);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]) && ((func_100(Local_64[4 /*10*/]) && is_ped_fleeing(Local_64[4 /*10*/])) || !func_100(Local_64[4 /*10*/])))
	{
		if (func_100(Local_64[4 /*10*/]) && is_entity_playing_anim(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", 3))
		{
			stop_anim_task(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", -8f);
		}
		if (is_entity_attached_to_any_ped(Local_169[3 /*2*/]))
		{
			detach_entity(Local_169[3 /*2*/], 1, true);
		}
	}
	if (func_19() == 2)
	{
...
void func_207(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		if (is_vehicle_driveable(Global_93091.f_4, 0))
		{
			if (func_235(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_232(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_208(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_208(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		func_225(iParam5, &Var0, vParam1, fParam4, func_110(iParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_119(iParam0, 0, 0)) || func_119(iParam0, 1, 0)) || func_119(iParam0, 2, 0)) || func_110(iParam0) != 145) || func_223(iParam0)) || func_222(iParam0)) || func_221(iParam0)) || func_220(iParam0)) || !func_212(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_222(iParam0))
		{
		}
...
void func_225(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_224(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
...
void func_229(auto uParam0, auto uParam1)
{
...
bool func_232(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_233(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_236(auto uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8)
{
	auto uVar0;
	auto uVar11;
...
bool func_237(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_238(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
...
void func_245()
{
	...
	if (iVar1)
	{
		if (((((!_0x84DE3B5FB3E666F0(&(Local_145[0 /*5*/])) && !_0x84DE3B5FB3E666F0(&(Local_145[1 /*5*/]))) && (!Local_145[0 /*5*/].f_4 || !Local_145[1 /*5*/].f_4)) || ((!_0x84DE3B5FB3E666F0(&(Local_145[2 /*5*/])) && !_0x84DE3B5FB3E666F0(&(Local_145[3 /*5*/]))) && (!Local_145[2 /*5*/].f_4 || !Local_145[3 /*5*/].f_4))) || iVar0 == 3) && iVar0 < 4)
		{
			if (iLocal_2111 > 0)
			{
				if (iLocal_2108[iLocal_2111 - 1] != -1)
				{
					stop_sound(iLocal_2108[iLocal_2111 - 1]);
				}
			}
			if (iLocal_2108[iLocal_2111] != -1)
			{
				AUDIO::PLAY_SOUND_FROM_COORD(iLocal_2108[iLocal_2111], "DOCKS_HEIST_PREP_1_SUB_SWING", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				iLocal_2111++;
			}
		}
		else if (iVar0 <= 2)
...
bool func_249(auto uParam0, char* sParam1)
{
	int iVar0;
	int iVar1;
...
bool func_250(auto uParam0, char* sParam1)
{
	int iVar0;
	int iVar1;
...
bool func_251(auto uParam0, char* sParam1)
{
	int iVar0;
	int iVar1;
...
void func_253()
{
	...
	if (func_100(Local_55[0 /*2*/]) && func_100(PLAYER::PLAYER_PED_ID()))
	{
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 750f)
		{
			func_86(10);
		}
		else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 700f)
		{
	...
	if ((((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.402f, -2880.396f, 8.25003f, 1240.384f, -2924.513f, 40.81909f, 28.875f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.222f, -3035.469f, 16.02625f, 1240.409f, -2924.159f, 8.06909f, 28.875f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.464f, -3035.127f, 13.00698f, 1240.617f, -3057.122f, 16.97133f, 27.6875f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.537f, -2967.822f, 32.94558f, 1240.792f, -2943.657f, 10.00659f, 12.1875f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1261.525f, -3006.275f, 29.21641f, 1237.788f, -3006.826f, 12.87723f, 8.1875f, 0, true, 0))
	{
		set_radar_as_interior_this_frame(GAMEPLAY::GET_HASH_KEY("V_FakeBoatPO1SH2A"), 1240f, -2970f, 0, 0);
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
		{
		...
		if ((!is_entity_in_air(iVar0) && !is_entity_in_water(iVar0)) && (!ENTITY::DOES_ENTITY_EXIST(Local_55[0 /*2*/]) || !ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, Local_55[0 /*2*/])))
		{
			if (!iLocal_391)
			{
				func_254(593);
	...
	switch (iLocal_399)
	{
		case 0:
			if (func_100(Local_64[4 /*10*/]))
			{
				if (iLocal_404)
				{
					AI::TASK_PLAY_ANIM(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
		...
		case 1:
			if (!iLocal_404)
			{
				if (GAMEPLAY::GET_GAME_TIMER() - iLocal_403 > 2000 || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 10f)
				{
					iLocal_404 = 1;
					iLocal_399 = 0;
				}
			}
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0))
			{
				if (func_100(Local_64[4 /*10*/]))
				{
					if (_0x6CD5A433374D4CFB(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID()))
					{
						AI::CLEAR_PED_TASKS(Local_64[4 /*10*/]);
					...
					else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && get_player_current_stealth_noise(player_id()) > 8.5f)
					{
						stop_current_playing_ambient_speech(Local_64[4 /*10*/]);
						if (!func_258(Local_64[4 /*10*/], 1464580341, 1))
						{
							task_turn_ped_to_face_coord(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
							AI::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
						}
					}
					else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!func_258(Local_64[4 /*10*/], 1464580341, 1))
						{
							task_turn_ped_to_face_coord(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
					...
					else if (((set_weapon_smokegrenade_assigned(PLAYER::PLAYER_PED_ID()) && (TIME::GET_CLOCK_HOURS() >= 19 || TIME::GET_CLOCK_HOURS() < 6)) && func_10(PLAYER::PLAYER_PED_ID(), Local_64[4 /*10*/], 1) < 25f) && (is_player_targetting_entity(player_id(), Local_64[4 /*10*/]) || is_player_free_aiming_at_entity(player_id(), Local_64[4 /*10*/])))
					{
						if (!func_258(Local_64[4 /*10*/], 1464580341, 1))
						{
							task_turn_ped_to_face_coord(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
			...
			if (func_100(Local_64[4 /*10*/]))
			{
				if (!is_waypoint_playback_going_on_for_ped(Local_64[4 /*10*/]))
				{
					if (iLocal_404)
					{
						...
						{
							if (!is_entity_playing_anim(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", 3))
							{
								AI::TASK_PLAY_ANIM(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
							}
				...
				else
				{
					...
					if (!is_ambient_speech_playing(Local_64[4 /*10*/]) && GAMEPLAY::GET_GAME_TIMER() - iLocal_408 > 4000)
					{
				...
				if (((has_ped_received_event(Local_64[4 /*10*/], 122) || has_ped_received_event(Local_64[4 /*10*/], 123)) || has_ped_received_event(Local_64[4 /*10*/], 124)) || has_ped_received_event(Local_64[4 /*10*/], 116))
				{
					...
					task_hands_up(Local_64[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
				}
		...
		case 2:
			if (func_100(Local_64[4 /*10*/]))
			{
				if (!is_ped_headtracking_ped(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID()))
				{
					task_look_at_entity(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), -1, 3104, 2);
				}
			}
			switch (iLocal_400)
			{
			...
			if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || !func_100(Local_64[4 /*10*/]))
			{
				iLocal_399 = 0;
			}
			...
			if (func_100(Local_64[4 /*10*/]))
			{
				...
				else if (is_player_free_aiming_at_entity(player_id(), Local_64[4 /*10*/]) || is_player_targetting_entity(player_id(), Local_64[4 /*10*/]))
				{
					if (get_weapontype_group(iLocal_406) != -728555052 && iLocal_406 != joaat("weapon_unarmed"))
					{
						...
						iLocal_401 = 1;
						AI::CLEAR_PED_TASKS_immediately(Local_64[4 /*10*/]);
						task_hands_up(Local_64[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
				}
				else if (has_ped_received_event(Local_64[4 /*10*/], 23))
				{
		...
		case 3:
			switch (iLocal_401)
			{
				...
				case 4:
					if (func_100(Local_64[4 /*10*/]))
					{
						if (!PED::IS_PED_RAGDOLL(Local_64[4 /*10*/]) && !is_ped_getting_up(Local_64[4 /*10*/]))
						{
							if (func_12(&uLocal_213, "SOL1AUD", "SOL1_COPSIN2", 7, 0, 0, 0))
							{
								AI::CLEAR_PED_TASKS(Local_64[4 /*10*/]);
								open_sequence_task(&iLocal_379);
								AI::TASK_PLAY_ANIM(false, sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
								if (iLocal_405)
								{
									task_follow_nav_mesh_to_coord(false, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
									AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
								else
								{
									task_follow_nav_mesh_to_coord(false, 1228.775f, -2923.852f, 8.31909f, 1f, 20000, 0.25f, 0, 40000f);
									task_wander_in_area(false, 1183.287f, -2947.87f, 4.8986f, 100f, 3f, 6f);
								}
								close_sequence_task(iLocal_379);
								task_perform_sequence(Local_64[4 /*10*/], iLocal_379);
								clear_sequence_task(&iLocal_379);
				...
				case 5:
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_402 > 8000)
					{
						...
						if (func_100(Local_64[4 /*10*/]))
						{
							...
							{
								task_wander_in_area(Local_64[4 /*10*/], 1183.287f, -2947.87f, 4.8986f, 100f, 3f, 6f);
							}
						}
					}
					if (!iLocal_405)
						...
						if (func_100(Local_64[4 /*10*/]))
						{
							if ((has_ped_received_event(Local_64[4 /*10*/], 122) || has_ped_received_event(Local_64[4 /*10*/], 123)) || has_ped_received_event(Local_64[4 /*10*/], 124))
							{
								...
								if (func_12(&uLocal_213, "SOL1AUD", "SOL1_ARM2", 7, 0, 0, 0))
								{
									AI::CLEAR_PED_TASKS(Local_64[4 /*10*/]);
									open_sequence_task(&iLocal_379);
									task_hands_up(false, 3000, PLAYER::PLAYER_PED_ID(), -1, 0);
									task_follow_nav_mesh_to_coord(false, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, 0, 40000f);
									AI::TASK_SMART_FLEE_PED(false, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									close_sequence_task(iLocal_379);
									task_perform_sequence(Local_64[4 /*10*/], iLocal_379);
							...
							else if ((is_player_free_aiming_at_entity(player_id(), Local_64[4 /*10*/]) || is_player_targetting_entity(player_id(), Local_64[4 /*10*/])) && is_ped_facing_ped(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), 160f))
							{
								if (get_weapontype_group(iLocal_406) != -728555052 && iLocal_406 != joaat("weapon_unarmed"))
								{
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_53(iParam3), 0);
}
...
void func_259()
{
	switch (iLocal_459)
	{
		case 0:
			switch (iLocal_458)
			{
				case 0:
					if (func_100(Local_55[0 /*2*/]))
					{
						if ((!is_message_being_displayed() && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && get_player_wanted_level(player_id()) == 0)
						{
							func_264();
							iLocal_456 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_458 = 1;
				...
				case 1:
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_456 > 6000 && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
					{
						func_201(&uLocal_213, 1, 0, "FLOYD", 0, 1);
		...
		case 2:
			...
			{
				case 0:
					if ((!is_message_being_displayed() && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, 1) < 110f)
					{
						func_264();
						iLocal_458 = 1;
					}
		...
		case 3:
			if (func_100(Local_55[2 /*2*/]) && func_100(Local_64[3 /*10*/]))
			{
				...
				{
					case 0:
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[2 /*2*/], 0) && is_ped_in_vehicle(Local_64[3 /*10*/], Local_55[2 /*2*/], 0))
						{
							if (func_11())
							{
								func_264();
		...
		case 4:
			if (func_100(Local_55[2 /*2*/]) && func_100(Local_64[3 /*10*/]))
			{
				...
				{
					case 0:
						if (((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_vehicle(Local_64[3 /*10*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)) && is_entity_attached_to_entity(Local_55[1 /*2*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && !is_message_being_displayed())
						{
							func_264();
							iLocal_456 = GAMEPLAY::GET_GAME_TIMER();
							iLocal_458 = 1;
					...
					case 2:
						if (func_11())
						{
							if ((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_vehicle(Local_64[3 /*10*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)) && is_entity_attached_to_entity(Local_55[1 /*2*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
							{
								if (func_31())
								{
									func_263(0);
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 60f)
				{
					func_262();
					iLocal_458 = 3;
				}
		...
		case 5:
			...
			{
				case 0:
					if ((((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_vehicle(Local_64[3 /*10*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)) && is_entity_attached_to_entity(Local_55[1 /*2*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && !is_message_being_displayed()) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -273.635f, -2558.818f, 4.751376f, -405.7218f, -2695.898f, 14.37495f, 51f, 0, true, 0))
					{
						func_264();
						iLocal_458 = 1;
					}
		...
		case 6:
			...
			{
				case 0:
					if ((((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_vehicle(Local_64[3 /*10*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0)) && is_entity_attached_to_entity(Local_55[1 /*2*/], get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0))) && !is_message_being_displayed()) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 40f)
					{
						func_264();
						iLocal_458 = 1;
					}
...
bool func_268(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_269()
{
	...
	if (iLocal_2102 == 1)
	{
		...
		else if (iLocal_2097 == 3)
		{
			...
			if (!func_285())
			{
				func_284(iLocal_2103, &vVar0, &fVar3);
				...
				func_283(&uLocal_460, vVar0, 50f, 0);
			}
...
void func_270()
{
	if (!func_100(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = create_vehicle(joaat("submersible"), -337.7228f, -2623.835f, 8.6595f, 135.24f, 1, 1);
		set_vehicle_is_considered_by_player(Local_55[0 /*2*/], 0);
		set_vehicle_engine_on(Local_55[0 /*2*/], false, 1, 0);
		set_vehicle_lights(Local_55[0 /*2*/], 1);
	...
	if (!func_100(Local_55[2 /*2*/]))
	{
		Local_55[2 /*2*/] = create_vehicle(joaat("packer"), -337.7228f, -2627.038f, 5.001f, 134.9894f, 1, 1);
		set_vehicle_is_considered_by_player(Local_55[2 /*2*/], 0);
		set_vehicle_colour_combination(Local_55[2 /*2*/], 0);
		set_vehicle_tyres_can_burst(Local_55[2 /*2*/], false);
		set_vehicle_has_strong_axles(Local_55[2 /*2*/], true);
	...
	if (!func_100(Local_55[1 /*2*/]))
	{
		Local_55[1 /*2*/] = create_vehicle(joaat("armytrailer"), -331.728f, -2621.006f, 7.8828f, 135.24f, 1, 1);
		set_vehicle_has_strong_axles(Local_55[1 /*2*/], true);
	}
	attach_vehicle_to_trailer(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
	_0x95CF53B3D687F9FA(Local_55[1 /*2*/]);
	...
	{
		Local_169[4 /*2*/] = create_object(joaat("prop_sub_cover_01"), 297.5948f, -2950.354f, 5.0008f, 1, true, false);
		attach_entity_to_entity(Local_169[4 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
...
void func_274()
{
	if (!func_100(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = create_vehicle(joaat("submersible"), 320.4211f, -2975.993f, -11.1896f, 2.5159f, 1, 1);
		set_vehicle_can_be_visibly_damaged(Local_55[0 /*2*/], false);
		set_vehicle_engine_on(Local_55[0 /*2*/], false, 1, 0);
		set_vehicle_lights(Local_55[0 /*2*/], 1);
		set_vehicle_radio_enabled(Local_55[0 /*2*/], 1);
	...
	if (!func_100(Local_55[2 /*2*/]))
	{
		Local_55[2 /*2*/] = create_vehicle(joaat("packer"), 297.5948f, -2950.354f, 5.0008f, 359.1976f, 1, 1);
		set_vehicle_colour_combination(Local_55[2 /*2*/], 0);
		set_vehicle_tyres_can_burst(Local_55[2 /*2*/], false);
		set_vehicle_has_strong_axles(Local_55[2 /*2*/], true);
	}
	if (!func_100(Local_55[1 /*2*/]))
	{
		Local_55[1 /*2*/] = create_vehicle(joaat("armytrailer"), 297.2917f, -2970.246f, 4.8884f, 359.0483f, 1, 1);
		set_vehicle_can_be_visibly_damaged(Local_55[1 /*2*/], false);
		set_vehicle_has_strong_axles(Local_55[1 /*2*/], true);
	}
	attach_vehicle_to_trailer(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
...
bool func_276(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_278()
{
	...
	{
		Local_55[0 /*2*/] = create_vehicle(joaat("submersible"), 1272.398f, -2982.072f, -3.2414f, 201.5542f, 1, 1);
		set_vehicle_radio_enabled(Local_55[0 /*2*/], 1);
	}
	if (func_285())
	{
	...
	{
		freeze_entity_position(PLAYER::PLAYER_PED_ID(), false);
		set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], -1);
	}
	clear_area(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 1, 0, 0, false);
	iLocal_459 = 0;
	iLocal_458 = 0;
...
void func_279()
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = create_vehicle(joaat("submersible"), 1260.802f, -3006.417f, 18.3289f, 178.9076f, 1, 1);
		func_280(Local_55[0 /*2*/], 0);
		freeze_entity_position(Local_55[0 /*2*/], true);
		set_entity_load_collision_flag(Local_55[0 /*2*/], true);
		_0x3910051CCECDB00C(Local_55[0 /*2*/], false);
		set_vehicle_radio_enabled(Local_55[0 /*2*/], 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_64[4 /*10*/]))
	{
		...
		AI::TASK_PLAY_ANIM(Local_64[4 /*10*/], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
		set_ped_flee_attributes(Local_64[4 /*10*/], 512, false);
	...
	{
		Local_169[0 /*2*/] = create_object(joaat("prop_ld_test_01"), 1260.692f, -3008.286f, 23.73365f, 1, true, false);
		freeze_entity_position(Local_169[0 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[1 /*2*/]))
	{
		Local_169[1 /*2*/] = create_object(joaat("prop_ld_test_01"), 1260.752f, -3004.994f, 22.68315f, 1, true, false);
		freeze_entity_position(Local_169[1 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		Local_169[2 /*2*/] = create_object(joaat("prop_sub_release"), 1249.105f, -3007.968f, 9.68718f, 1, true, false);
		set_entity_rotation(Local_169[2 /*2*/], 0f, 0f, 90f, 2, 1);
		freeze_entity_position(Local_169[2 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		Local_169[3 /*2*/] = create_object(joaat("p_amb_phone_01"), 1229.322f, -3002.879f, 8.31861f, 1, true, false);
	}
	iLocal_383 = 0;
	request_waypoint_recording("docksprep1");
...
bool func_283(auto uParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (func_186(vParam1) || fParam4 <= 0f)
	{
		return false;
	}
	if (*uParam0.f_863)
	{
		if (func_88(*uParam0.f_863.f_4, vParam1, 0) && *uParam0.f_863.f_10 == fParam4)
		{
			*uParam0.f_863.f_2 = 0;
			if (!*uParam0.f_863.f_1)
			{
...
void func_284(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 0:
...
void func_287()
{
	...
	while (iLocal_382 <= 8 - 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_64[iLocal_382 /*10*/]) && !PED::IS_PED_INJURED(Local_64[iLocal_382 /*10*/]))
		{
			...
			{
				set_ped_coords_no_gang(Local_64[iLocal_382 /*10*/], ENTITY::GET_ENTITY_COORDS(get_vehicle_ped_is_in(Local_64[iLocal_382 /*10*/], 0), 1) + Vector(0f, -2f, 0f));
			}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		clear_area(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 300f, 1, 0, 0, false);
	}
...
void func_296()
{
	switch (iLocal_2097)
	{
		...
		case 0:
			if (GAMEPLAY::GET_GAME_TIMER() - iLocal_2101 > 2500)
			{
				iLocal_2101 = GAMEPLAY::GET_GAME_TIMER();
			}
			break;
	}
}

void func_297(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_300()
{
	...
	if (func_273() || func_7(0))
	{
		...
		if (func_273())
		{
			func_284(iLocal_2103, &vVar0, &uVar3);
			func_303(vVar0, uVar3, 1, 0);
		}
		settimera(0);
		iLocal_2102 = 1;
	}
	...
	remove_relationship_group(iLocal_394);
	remove_relationship_group(iLocal_395);
	add_relationship_group("REL_BUDDY", &iLocal_394);
	add_relationship_group("rel_dock", &iLocal_395);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_28[1]))
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_28[2]))
		{
			set_entity_as_mission_entity(Global_88108.f_28[2], true, 1);
			Local_169[2 /*2*/] = Global_88108.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88108.f_28[3]))
		{
			set_entity_as_mission_entity(Global_88108.f_28[3], true, 1);
			Local_169[3 /*2*/] = Global_88108.f_28[3];
		}
	}
	if (Global_88108.f_357)
	{
		if (does_rope_exist(&(Global_88108.f_37[0])))
		{
			_0xB1B6216CA2E7B55E(Global_88108.f_37[0], 1, 1);
			Local_145[0 /*5*/] = Global_88108.f_37[0];
			Global_88108.f_37[0] = 0;
		}
		if (does_rope_exist(&(Global_88108.f_37[1])))
		{
			_0xB1B6216CA2E7B55E(Global_88108.f_37[1], 1, 1);
			Local_145[1 /*5*/] = Global_88108.f_37[1];
			Global_88108.f_37[1] = 0;
		}
		if (does_rope_exist(&(Global_88108.f_37[2])))
		{
			_0xB1B6216CA2E7B55E(Global_88108.f_37[2], 1, 1);
			Local_145[2 /*5*/] = Global_88108.f_37[2];
			Global_88108.f_37[2] = 0;
		}
		if (does_rope_exist(&(Global_88108.f_37[3])))
		{
			_0xB1B6216CA2E7B55E(Global_88108.f_37[3], 1, 1);
	...
	request_additional_text("DOCKP1", false);
...
void func_303(Vector3 vParam0, auto uParam1, int iParam2, int iParam3)
{
	if (func_273())
	{
...
void func_305()
{
	...
	if (func_100(PLAYER::PLAYER_PED_ID()))
	{
		if (func_100(Local_55[0 /*2*/]))
		{
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				set_ped_coords_no_gang(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1) + Vector(2f, 0f, 0f));
			}
		}
	}
	func_187();
