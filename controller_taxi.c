		...
		switch (iVar1)
		{
			...
			case 1:
				...
				if (!func_69() && !Global_88539)
				{
					if (iVar1 != 2)
					{
						if ((!is_minigame_in_progress() && !iVar0) && !func_68(5))
						{
							func_65();
							if (func_64())
							{
								...
								switch (iLocal_106)
								{
									...
									case 2:
										...
										if (func_53(&iLocal_118) > 15f)
										{
											...
											fLocal_111 = get_random_float_in_range(10f, 40f) + func_53(&iLocal_118);
											iLocal_106 = 3;
										}
										else if (iLocal_112)
										{
								...
								if (((is_control_pressed(0, 86) && !is_entity_upsidedown(PLAYER::PLAYER_PED_ID())) && !Global_25271) && GAMEPLAY::GET_GAME_TIMER() - iLocal_109 > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
			...
			case 4:
				...
				{
					set_horn_enabled(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 1);
				}
...
void func_12()
{
	...
	{
		func_14(13, floor(Global_101154.f_8884.f_3853));
	}
...
void func_33(int iParam0, char* sParam1, auto uParam2, int iParam3)
{
	struct<6> Var0;
	struct<6> Var6;
	...
	if (iParam3)
	{
		...
		func_73(uParam2);
		func_34(uParam2, "OJTXAUD", &Var0, &Var6, 8, 0, 0);
	}
}

int func_34(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_47(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_50(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_51(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
float func_53(int iParam0)
{
	if (func_57(iParam0))
	{
		...
		{
			return func_54(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
void func_60(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
{
	*iParam0.f_1 = func_54(is_bit_set(*iParam0, 4)) - fParam1;
...
void func_75(auto uParam0, auto uParam1)
{
...
void func_83()
{
	...
	if (get_length_of_literal_string(&cLocal_99) != 0)
	{
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_99);
	}
	if (does_blip_exist(iLocal_105))
