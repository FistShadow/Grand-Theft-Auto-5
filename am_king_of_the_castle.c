...
void main()
{
	...
	iLocal_392 = -1;
	iLocal_3350 = -1;
	if (network_is_game_in_progress() && func_658(player_id(), 0, 1))
	{
		func_643(Local_3356);
	}
	else
	...
	while (true)
	{
		...
		iLocal_3350 = -1;
		if (is_bit_set(iLocal_3342, player_id()))
		{
			if (is_bit_set(iLocal_3343, participant_id_to_int()))
			{
...
void func_1()
{
	...
	{
		case 0:
			if (is_bit_set(Local_96.f_213, false))
			{
		...
		case 1:
			if (is_bit_set(Local_96.f_213, 2))
			{
		...
		case 2:
			if (is_bit_set(Local_96.f_213, true))
			{
				func_10(3);
			}
			break;
...
void func_2(int iParam0)
{
	...
	if (iVar0 > -1)
	{
		if (is_bit_set(iLocal_3343, iVar0))
		{
			if (is_bit_set(iLocal_3342, iVar1))
			{
				if (!is_bit_set(iLocal_3344, iVar1))
				{
	...
	switch (func_572())
	{
				...
				if (iLocal_3350 == participant_id_to_int())
				{
					if (!func_197(1, 0))
					{
						if (func_196(participant_id_to_int(), iVar0))
						{
							...
							{
								if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 2))
								{
									set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 2);
									func_184(1);
								}
							}
							if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 5))
							{
								set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 5);
							}
							if (func_8(iVar0) == participant_id_to_int())
							{
								if (!is_bit_set(iLocal_555, 20))
								{
									set_bit(&iLocal_555, 20);
								}
							}
						}
						if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 4))
						{
							if (func_8(iVar0) == participant_id_to_int())
							{
								set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 4);
							}
						}
					}
					else
					{
						if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 2))
						{
							clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 2);
						}
						if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 5))
						{
							clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 5);
						}
						if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 4))
						{
							clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 4);
						}
						if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 6))
						{
							clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 6);
						}
						if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 7))
						{
							clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 7);
						}
					}
				}
				if (func_15(iVar0) == 0)
						...
						if (!is_help_message_being_displayed())
						{
							if (!func_183())
							{
								if (iLocal_3350 == participant_id_to_int())
								{
									if (!func_240(0, 0))
									{
										if (is_bit_set(iLocal_3342, Local_560[participant_id_to_int() /*18*/].f_1))
										{
											if (!is_bit_set(iLocal_3344, Local_560[participant_id_to_int() /*18*/].f_1))
											{
												func_182("KOTC_1STHELP", 30000);
												func_181(0);
												play_sound_frontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0);
												set_bit(&iLocal_555, 8);
											}
										}
									}
								}
				...
				if (iLocal_3350 == participant_id_to_int())
				{
					if (func_179(iVar0) <= 500f)
					{
						if (!is_bit_set(iLocal_555, 9))
						{
							...
							set_bit(&iLocal_555, 9);
						}
					}
					else if (is_bit_set(iLocal_555, 9))
					{
						set_wanted_level_multiplier(1f);
						clear_bit(&iLocal_555, 9);
					}
				}
				if (iLocal_3350 != -1)
				{
					if (is_bit_set(iLocal_555, 14) && func_8(iVar0) != iLocal_3350)
					{
						if (!is_bit_set(iLocal_555, 21))
						{
							func_178(80);
							set_bit(&iLocal_555, 21);
						}
					}
					else if (is_bit_set(iLocal_555, 21))
					{
						clear_bit(&iLocal_555, 21);
					}
				}
				if (func_15(iVar0) != 0)
				{
					if (!is_bit_set(iLocal_555, 26))
					{
						...
						set_bit(&iLocal_555, 26);
					}
					if (!is_bit_set(iLocal_555, true))
					{
						if (iLocal_3350 != -1)
						{
							if (!func_240(0, 0))
							{
								if (is_bit_set(iLocal_3342, Local_560[iLocal_3350 /*18*/].f_1))
								{
									if (!is_bit_set(iLocal_3344, Local_560[iLocal_3350 /*18*/].f_1))
									{
										if (func_8(iVar0) != -1)
										{
											...
											else
											{
												...
												set_bit(&iLocal_555, 14);
												set_bit(&iLocal_555, 15);
											}
										}
										else
										{
					...
					else if (iLocal_3350 != -1)
					{
						...
						else
						{
							if (is_bit_set(iLocal_555, 14))
							{
								clear_bit(&iLocal_555, 14);
							}
							if (is_bit_set(iLocal_555, 15))
							{
								clear_bit(&iLocal_555, 15);
							}
						}
					}
					else
					...
					if (func_8(iVar0) != -1)
					{
						if (iLocal_3350 != -1)
						{
							...
							else
							{
								...
								if (((func_145(iLocal_3350) || is_bit_set(Local_394[iLocal_3350 /*5*/].f_4, 12)) && is_bit_set(iLocal_3343, func_8(iVar0))) && !func_240(1, 0))
								{
									if (func_154(player_id(), func_7(iVar0)))
									{
		...
		case 2:
			...
			while (iVar0 < 1)
			{
				...
				else if (!is_bit_set(iLocal_3343, Local_96.f_6[iVar0 /*204*/].f_74[0 /*4*/]))
				{
					iVar8 = true;
				}
			...
			if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, true) && func_61())
			{
			...
			if (func_21(&uLocal_1234, iVar10) && is_bit_set(iLocal_555, 4))
			{
				if (!func_183() || is_pause_menu_active())
				{
					set_bit(&iLocal_555, 17);
					if (is_bit_set(iLocal_555, 5))
					{
						set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), true);
						func_419(3);
					}
				}
			}
...
void func_22()
{
	...
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_658(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out())
		{
...
void func_63(int iParam0, int iParam1)
{
	...
	if (is_bit_set(iLocal_556, iVar0))
	{
...
void func_75(vector3 vParam0, var uParam1, var uParam2)
{
...
void func_86(int iParam0)
{
	...
	if (!is_bit_set(Local_394[iLocal_3350 /*5*/].f_4, 12))
	{
		if (!func_145(iLocal_3350))
		{
...
void func_123(char* sParam0, int iParam1, char* sParam2, int iParam3, var uParam4, int iParam5)
{
...
bool func_124(char* sParam0, char* sParam1, char* sParam2, int iParam3, var uParam4)
{
	if (is_string_null_or_empty(sParam0))
	{
		return false;
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_134(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_133(1);
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_140(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_134(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_133(1);
			}
...
{
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 2))
	{
		return true;
	}
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 3))
	{
		return true;
	}
...
int func_152(int iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, char* sParam5, var uParam6)
{
	struct<72> Var0;
...
void func_184(int iParam0)
{
	...
	if (iParam0)
	{
		...
		{
			uVar0 = func_162(2458, -1, 0);
			clear_bit(&uVar0, func_175(func_195(player_id())));
			func_186();
		}
		if (func_185())
		{
...
void func_204(int iParam0)
{
	...
	if (iParam0)
	{
		...
		{
			uVar1 = func_162(2458, -1, 0);
			clear_bit(&uVar1, func_175(func_195(player_id())));
			func_186();
		}
		if (func_185())
		{
...
int func_245(int iParam0, int iParam1, int iParam2)
{
	...
	else if (network_is_game_in_progress())
	{
		if (func_169() == 0)
		{
			return is_bit_set(func_162(func_246(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_264(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_273(iParam0) && !func_173(iParam0)) && !is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 8));
...
void func_278(int iParam0, vector3 vParam1, var uParam2, float fParam3, float fParam4, var uParam5)
{
	float fVar0;
	int iVar1;
	...
	if (fVar0 < fParam5 && !func_173(player_id()))
	{
		...
		if ((!*uParam4 || is_bit_set(Global_1573883.f_1, 3)) && func_658(player_id(), 1, 1))
		{
			*uParam4 = 1;
			...
			set_bit(&(Global_1610316[player_id() /*174*/].f_1), 3);
			clear_bit(&(Global_1573883.f_1), 3);
		}
	}
	else if ((iParam0 == 146 && fVar0 < fParam6) && !func_173(player_id()))
	{
		if (!is_bit_set(Global_1573883.f_1, 3) && func_658(player_id(), 1, 1))
		{
			func_286();
			set_wanted_level_multiplier(Global_262145.f_9351);
			clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 3);
			set_bit(&(Global_1573883.f_1), 3);
		}
	}
	else if ((*uParam4 || is_bit_set(Global_1573883.f_1, 3)) && func_658(player_id(), 1, 1))
	{
		*uParam4 = 0;
		func_286();
		set_wanted_level_multiplier(1f);
...
void func_293(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	if (func_393() || iParam2 == 24)
	{
		...
		{
			func_354(1);
			if ((!func_353() && !func_352()) || is_bit_set(Global_2460486.f_4426, true))
			{
				if (func_351())
				{
					func_349();
				...
				else
				{
					...
					if (*uParam3.f_27 == 0)
					{
						...
						{
							iVar35 = int_to_playerindex(iVar52);
							if (func_658(iVar35, 0, 1) && !is_bit_set(iVar49, iVar35))
							{
								iVar35 = int_to_playerindex(iVar52);
							}
							else
...
int func_298(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
	return network_is_handle_valid(&uParam0, 13);
}

var func_299(var uParam0, var uParam1)
{
...
void func_306(char* sParam0, int iParam1, var uParam2, int iParam3, char* sParam4, var uParam5, var uParam6, var uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_314(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, var uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
bool func_318(var uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_322(iParam3))
	{
...
bool func_351()
{
	if (is_bit_set(Global_2460486.f_4426, false) && func_183())
	{
		return true;
	}
	if (is_bit_set(Global_2460486.f_4426, true) && func_183())
	{
		return true;
	}
	return false;
...
bool func_355(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
...
{
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 5))
	{
		return true;
	}
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 4))
	{
		return true;
	}
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 6))
	{
		return true;
	}
	if (is_bit_set(Local_394[iParam0 /*5*/].f_4, 7))
	{
		return true;
	}
	return false;
...
void func_400()
{
	if (func_240(1, 1))
	{
		if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 8))
		{
			set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 8);
		}
	}
	else if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 8))
	{
		clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 8);
	}
	if (func_240(0, 1))
	{
		if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 9))
		{
			set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 9);
		}
	}
	else if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 9))
	{
		clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 9);
	}
	if (func_240(1, 0))
	{
		if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 10))
		{
			set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 10);
		}
	}
	else if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 10))
	{
		clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 10);
	}
	if (func_240(0, 0))
	{
		if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 11))
		{
			set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 11);
		}
	}
	else if (is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 11))
	{
		clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 11);
	}
}
...
{
	if (!is_bit_set(iLocal_556, func_427(iParam0)))
	{
		...
		set_bit(&iLocal_556, func_427(iParam0));
	}
}
...
void func_404(int iParam0)
{
	if (!does_blip_exist(func_69(iParam0)))
	{
		...
		if (!is_bit_set(iLocal_555, 13))
		{
			...
			set_bit(&iLocal_555, 13);
		}
		if (!is_bit_set(iLocal_555, 12))
		{
			flash_minimap_display();
			set_bit(&iLocal_555, 12);
		}
...
void func_409(int iParam0, int iParam1)
{
	...
	if (iParam1)
	{
		set_bit(&(Local_394[participant_id_to_int() /*5*/].f_3), iParam0);
	}
	else
	{
		clear_bit(&(Local_394[participant_id_to_int() /*5*/].f_3), iParam0);
	}
}
...
void func_430()
{
	...
	iVar0 = -1;
	iVar1 = -1;
	if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, false))
	{
		iVar2 = 0;
		while (iVar2 < 1)
		{
			if (func_427(iVar2) > -1)
			{
				...
				while (iVar3 < 3)
				{
					...
					set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), false);
					iVar3++;
				}
			}
			iVar2++;
	...
	while (iVar2 < 1)
	{
			...
			if (!func_111(iVar2))
			{
				if (network_is_host_of_this_script())
				{
					if (iVar0 > -1)
					{
						...
						if (!is_bit_set(iLocal_3342, iVar0))
						{
							set_bit(&iLocal_555, false);
						}
						if (is_bit_set(iLocal_3344, iVar0))
						{
							set_bit(&iLocal_555, false);
						}
		...
		if (is_bit_set(iLocal_555, false))
		{
			if (func_436(iVar2) > -1 && func_435(iVar2) > -1)
			{
				if (network_is_host_of_this_script())
				{
					...
					if (!is_bit_set(Local_96.f_6[iVar2 /*204*/].f_203, func_436(iVar2)))
					{
						set_bit(&(Local_96.f_6[iVar2 /*204*/].f_203), func_436(iVar2));
					}
				}
			}
		}
...
void func_432(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13)
{
	Param0 = 0;
...
void func_453()
{
	...
	while (iVar1 < 32)
	{
		...
		clear_bit(&iLocal_3342, iVar1);
		clear_bit(&iLocal_3344, iVar1);
		iVar1++;
	}
	iVar0 = false;
	while (iVar0 < 32)
	{
		...
		clear_bit(&iLocal_3343, iVar0);
		if (network_is_host_of_this_script())
		{
			iVar25 = 0;
			while (iVar25 < 1)
			{
				clear_bit(&(Local_96.f_6[iVar25 /*204*/].f_73), iVar0);
				iVar25++;
			}
		}
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(iVar0))
		{
			...
			if (func_658(iVar2, 0, 1))
			{
				...
				set_bit(&iLocal_3342, iVar1);
				if ((is_entity_dead(vLocal_1137[iVar1 /*3*/].f_2, 0) || is_ped_injured(vLocal_1137[iVar1 /*3*/].f_2)) || !is_player_playing(vLocal_1137[iVar1 /*3*/]))
				{
					set_bit(&iLocal_3344, iVar1);
				}
				if (network_is_host_of_this_script())
				{
					if (!is_bit_set(Local_394[iVar0 /*5*/].f_4, false))
					{
						iVar30 = false;
					}
					if (!is_bit_set(Local_394[iVar0 /*5*/].f_4, true))
					{
						iVar31 = false;
					}
				}
				...
				if (is_bit_set(iLocal_3342, iVar1))
				{
					...
					if (!is_bit_set(iLocal_3344, iVar1))
					{
						if (iVar0 == participant_id_to_int())
						{
							...
							vVar34 = {get_entity_coords(vLocal_1137[iVar1 /*3*/].f_2, 1)};
						...
						if (func_196(iVar0, iVar25))
						{
							...
							if (network_is_host_of_this_script())
							{
								set_bit(&(Local_96.f_6[iVar25 /*204*/].f_73), iVar0);
							}
						}
					}
					if (iVar0 == participant_id_to_int())
					{
						if (!is_bit_set(iLocal_3344, iVar1))
						{
							...
							{
								if (!is_bit_set(Local_394[iVar0 /*5*/].f_4, 12))
								{
									set_bit(&(Local_394[iVar0 /*5*/].f_4), 12);
								}
							}
							else if (func_179(iVar25) >= IntToFloat(Global_262145.f_9448))
							{
								if (is_bit_set(Local_394[iVar0 /*5*/].f_4, 12))
								{
									clear_bit(&(Local_394[iVar0 /*5*/].f_4), 12);
								}
							}
							if (!func_197(1, 0))
							{
								if (func_179(iVar25) <= IntToFloat(Global_262145.f_9447))
								{
									if (!is_bit_set(Local_394[iVar0 /*5*/].f_4, 3))
									{
										set_bit(&(Local_394[iVar0 /*5*/].f_4), 3);
									}
								}
								else if (func_179(iVar25) >= IntToFloat(Global_262145.f_9448))
								{
									if (is_bit_set(Local_394[iVar0 /*5*/].f_4, 3))
									{
										clear_bit(&(Local_394[iVar0 /*5*/].f_4), 3);
									}
								}
							}
							else if (is_bit_set(Local_394[iVar0 /*5*/].f_4, 3))
							{
								clear_bit(&(Local_394[iVar0 /*5*/].f_4), 3);
							}
						}
					...
					else
					{
						...
						if (iVar0 != participant_id_to_int())
						{
							if (func_145(participant_id_to_int()))
							{
								...
								iVar44 = 100;
								draw_marker(2, get_entity_coords(vLocal_1137[iVar1 /*3*/].f_2, 1) + Vector(1.5f, 0f, 0f), 0f, 0f, 0f, 180f, 0f, 0f, 0.5f, 0.5f, 0.5f, iVar41, iVar42, iVar43, iVar44, 1, 1, 2, 0, 0, 0, 0);
							}
						}
					}
				}
	...
	if (network_is_host_of_this_script())
	{
		if (iVar30)
		{
			set_bit(&(Local_96.f_213), false);
		}
		else
		{
			clear_bit(&(Local_96.f_213), false);
		}
		if (iVar31)
		{
			set_bit(&(Local_96.f_213), true);
		}
		else
		{
			clear_bit(&(Local_96.f_213), true);
		}
	}
...
void func_454(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
...
int func_456(int iParam0)
{
	...
	return is_bit_set(Global_1338622.f_241.f_136[func_458(10) /*33*/][iParam0], func_457(10));
}
...
void func_460(int iParam0)
{
	...
	if (iParam0 > -1)
	{
		if (is_bit_set(iLocal_3342, iParam0))
		{
			if (!is_bit_set(iLocal_3344, iParam0))
			{
...
void func_465(int iParam0)
{
	...
	iVar0 = 6;
	if (is_bit_set(iLocal_3349, iParam0))
	{
		if (iParam0 > -1)
		{
			if (is_bit_set(iLocal_3342, iParam0))
...
void func_467(int iParam0, int iParam1, int iParam2, var uParam3)
{
												...
												if (iVar6 == func_8(iVar9))
												{
													if (!func_197(1, 0))
													{
														if (iVar7 == participant_id_to_int())
														{
															if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 7))
															{
																set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 7);
															}
														}
													}
													if (Var11.f_3)
												...
												else if (iVar7 == func_8(iVar9))
												{
													if (iVar6 == participant_id_to_int())
													{
														if (!func_197(1, 0))
														{
															if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 6))
															{
																set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 6);
															}
															if (!is_bit_set(Local_394[participant_id_to_int() /*5*/].f_4, 2))
															{
																set_bit(&(Local_394[participant_id_to_int() /*5*/].f_4), 2);
													...
													else if (Var11.f_3)
													{
														if (network_is_host_of_this_script())
														{
															...
															while (iVar10 < 32)
															{
																if (is_bit_set(iLocal_3343, iVar10))
																{
																	if (is_bit_set(iLocal_3342, Local_560[iVar10 /*18*/].f_1))
																	{
																		if (!is_bit_set(Local_394[iVar10 /*5*/].f_4, 9) && !is_bit_set(Local_394[iVar10 /*5*/].f_4, 10))
																		{
																			if (func_145(iVar10))
																			{
...
void func_489(int iParam0, int iParam1, char* sParam2)
{
	...
	if (iParam0 == func_491(player_ped_id()))
	{
		func_490(1);
	}
...
Vector3 func_492(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_493(player_ped_id()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
var func_498(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
...
var func_522(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
			...
			if (!func_199(player_id()))
			{
				if (!func_92(player_id()))
				{
					if (func_399(participant_id_to_int()))
					{
						...
						{
							func_552();
							func_487(0, player_ped_id(), "", -1636175450, -1253457806, iVar1, 1, -1, 0, 0);
							Local_380.f_7 += iVar1;
						}
						if (iVar0 > 0)
						{
...
void func_533(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_534(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_541(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)
{
	int iVar0;
...
{
	if ((!is_bit_set(Global_1573883.f_1, 2) && !func_173(player_id())) && !func_199(player_id()))
	{
		if (is_string_null_or_empty(sParam0))
		{
			sParam0 = "FMEVEN_NUM1";
...
void func_573()
{
	...
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_658(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_help_message_being_displayed())
		{
			if (func_590())
			{
	...
	if (func_273(player_id()))
	{
		...
		{
			if ((func_93(player_id(), 21) && is_bit_set(Global_1573883.f_1, 20)) && !is_bit_set(Global_1573883.f_1, 19))
			{
	...
	func_574();
	if (func_156(func_195(player_id())) && !is_bit_set(Global_1573883.f_1, 21))
	{
		set_bit(&(Global_1573883.f_1), 21);
	}
	if ((func_95() && !func_94()) || func_93(player_id(), 21))
...
void func_578(int iParam0)
{
	if ((is_bit_set(Global_1573883.f_1, 11) || (is_bit_set(Global_1573883.f_1, 10) && iParam0)) || (is_bit_set(Global_1573883.f_1, 22) && iParam0))
	{
		...
		if (is_bit_set(Global_1573883.f_1, 14) && !func_28(player_id(), 0))
		{
...
void func_614()
{
	...
	func_149();
	func_642(141);
	func_624(141, 0, is_bit_set(iLocal_555, 5));
	func_239();
	func_184(0);
	if (is_bit_set(iLocal_555, 16))
	{
...
void func_616(struct<12> Param0, var uParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	char* sVar0;
	struct<13> Var1;
	struct<14> Var14;
...
void func_656(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_615();
