...
bool func_148()
{
	...
	if (is_player_playing(player_id()))
	{
		...
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_89, 1) < IntToFloat(iVar0) && get_interior_from_entity(PLAYER::PLAYER_PED_ID()) == 0)
		{
			return true;
		}
	}
