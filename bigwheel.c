#region Local Var
	...
	char* sLocal_160 = 0;
	int iLocal_161 = 0;
	struct<7>[] Local_162 = new struct<7>[16];
	int iLocal_275 = 0;
	float fLocal_276 = 0;
	float fLocal_277 = 0;
	...
	while (true)
	{
		...
		if (iLocal_365 == 1)
		{
			...
			else
			{
				...
				set_cam_rot(Local_294, get_entity_rotation(PLAYER::PLAYER_PED_ID(), 2) + Local_294.f_14, 2);
			}
		}
		wait(0);
	}
...
void func_1(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7)
{
	int[] iVar0 = new int[4];
	float fVar5;
	float fVar6;
...
float func_2(float fParam0, Vector3 fParam1, Vector3 fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_4(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
...
void func_6(Vector3 vParam0, Vector3 vParam1, auto uParam2, auto uParam3, int iParam4)
{
	Vector3 vVar0;
...
void func_7(Vector3 vParam0, auto uParam1, auto uParam2, int iParam3)
{
	Vector3 fVar0;
...
void func_9(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 vVar0;
	Vector3 fVar3;
...
void func_15(int iParam0)
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_292)
		{
			...
			func_18(&Local_294, vVar0, get_entity_rotation(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_294.f_20, Local_294.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
			attach_cam_to_ped_bone(Local_294, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, 1);
		}
		else
		{
...
bool func_16(auto uParam0, int iParam1, int iParam2)
{
	if (!*uParam0.f_1 == 1)
	{
		return false;
...
void func_18(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, auto uParam4, auto uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, int iParam11)
{
	*uParam0.f_1 = {vParam1};
	*uParam0.f_4 = {vParam4};
	*uParam0.f_7 = fParam7;
...
void func_19(auto uParam0, Vector3 fParam1)
{
	char* sVar0;
	...
	*uParam0.f_1 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, fParam1, 2);
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		set_ped_keep_task(PLAYER::PLAYER_PED_ID(), true);
		PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 118, false);
		PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 208, true);
		set_blocking_of_non_temporary_events(PLAYER::PLAYER_PED_ID(), true);
		set_entity_lod_dist(PLAYER::PLAYER_PED_ID(), 1000);
		sVar0 = func_21(iLocal_286);
		if (!is_string_null_or_empty(sVar0))
		{
			task_synchronized_scene(PLAYER::PLAYER_PED_ID(), *uParam0.f_1, sLocal_160, sVar0, 1000f, -8f, 0, 0, 1000f, 0);
	...
	PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 118, false);
	PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 208, true);
	attach_entity_to_entity(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 0, func_20(fParam1), 0f, 0f, fParam1, 0, 0, 0, 0, 2, 1);
	task_play_anim(PLAYER::PLAYER_PED_ID(), sLocal_160, func_21(iLocal_286), 1000f, -8f, -1, 1, 0, 0, 0, 0);
	_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
}

Vector3 func_20(Vector3 fParam0)
{
	Vector3 vVar0;
...
void func_24()
{
	...
	fLocal_276 += fLocal_277 * timestep();
	if (fLocal_276 >= 360f)
	{
		fLocal_276 -= 360f;
		iLocal_275++;
...
void func_31()
{
	...
	if (!does_cam_exist(iLocal_293))
	{
		iLocal_293 = create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
		set_cam_params(iLocal_293, -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, false, 1, 1, 2);
		set_cam_active(iLocal_293, true);
		set_cam_params(iLocal_293, -1659.11f, -1120.752f, 12.9489f, -5.5053f, 0f, 56.0716f, 50.1098f, 7000, 1, 1, 2);
		render_script_cams(true, false, 3000, 1, 0, 0);
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 44.1132f);
	}
	func_43(64, 1, 0, 1, 0);
	...
	play_sound_from_entity(iLocal_287, "GENERATOR", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_289 = get_sound_id();
	play_sound_from_entity(iLocal_289, "SLOW_SQUEAK", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
...
void func_34(auto uParam0, int iParam1, int iParam2)
{
	...
	func_38(uParam0);
	*uParam0.f_2 = iParam1;
	*uParam0.f_3 = create_object(iLocal_159, 0f, 1f, 2f, 1, true, false);
	func_25(uParam0);
	if (iParam2 == 1)
	{
...
void func_41(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3, int iParam4)
{
	func_42(uParam0);
...
void func_52(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_53(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_53(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_54(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_55(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_55(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_62(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
bool func_63(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_67(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
bool func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_80(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_80(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_80(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_111(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_80(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_80(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_80(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_76(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_83(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						*iParam0[func_99(vVar16.z)] = func_93(iParam1, vVar16.x, func_99(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_80(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	while (iVar4 <= iVar2 - 1)
	{
		...
		else
		{
			...
			while (iVar5 <= iVar6 - 1)
			{
				...
				{
					iVar3 += func_107(iParam0, iParam3);
					return iVar3;
				}
				else
				{
...
void func_112(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	{
		iVar3 = func_116(uVar2, iVar0, 0);
		GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_113(uVar2, iVar3, iVar0, 1);
	}
}

void func_113(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_114(iParam2)];
	if (iVar0 != 0)
	{
...
int func_116(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_114(iParam1)];
...
int func_117(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_118(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_122(int iParam0)
{
	...
	func_123(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_123(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_128(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_116(func_126(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_116(func_125(iParam1, *uParam0.f_2), Global_69309, 0);
			if (GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
			if (func_124(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_116(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_124(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_127(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_123(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
		...
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_123(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_184(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_80(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_80(iParam1)))
	{
		return true;
	}
	return false;
...
bool func_196(auto uParam0, int iParam1)
{
...
bool func_198(auto uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)
{
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_113, iParam1) || GAMEPLAY::IS_BIT_SET(*uParam0.f_114, iParam1))
	{
		return true;
...
void func_206(int iParam0)
{
	if (iParam0)
	{
		clear_help(1);
		func_23(500, 1);
		GAMEPLAY::CLEAR_BIT(&Global_69737, 6);
	}
	func_249();
	func_247(1, 1, 1, 1);
	func_201(0);
...
void func_208()
{
	...
	{
		func_211(13, floor(Global_101154.f_8884.f_3853));
	}
...
bool func_214(auto uParam0, int iParam1)
{
...
int func_216(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_217(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_220(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_222() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_222() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_221(iParam0));
...
int func_224(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_222() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_229(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_233(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_235(auto uParam0, int iParam1)
{
	return func_236(uParam0, iParam1) != -1;
}

int func_236(auto uParam0, int iParam1)
{
	int iVar0;
