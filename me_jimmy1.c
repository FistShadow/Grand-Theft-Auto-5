#region Local Var
	...
	Vector3 vLocal_293 = 0;
	Vector3 vLocal_296 = 0;
	int iLocal_299 = 0;
	int iLocal_300 = 0;
	char*[] sLocal_301 = new char*[8];
	int iLocal_310 = 0;
	int iLocal_311 = 0;
	int iLocal_312 = 0;
	int iLocal_313 = 0;
	...
	int iLocal_323 = 0;
	int iLocal_324 = 0;
	char*[] sLocal_325 = new char*[6];
	int iLocal_332 = 0;
	int iLocal_333 = 0;
	char*[] sLocal_334 = new char*[3];
	char*[] sLocal_338 = new char*[3];
	int iLocal_342 = 0;
	int iLocal_343 = 0;
	int iLocal_344 = 0;
	char*[] sLocal_345 = new char*[3];
	int iLocal_349 = 0;
	int iLocal_350 = 0;
	char*[] sLocal_351 = new char*[4];
	int iLocal_356 = 0;
	int iLocal_357 = 0;
	int iLocal_358 = 0;
	char*[] sLocal_359 = new char*[12];
	int iLocal_372 = 0;
	int iLocal_373 = 0;
	int iLocal_374 = 0;
	int iLocal_375 = 0;
	int iLocal_376 = 0;
	Vector3 vLocal_377 = 0;
	Vector3 vLocal_380 = 0;
	Vector3 vLocal_383 = 0;
	float fLocal_386 = 0;
	float fLocal_387 = 0;
	int iLocal_388 = 0;
	int iLocal_389 = 0;
	...
	int iLocal_392 = 0;
	int iLocal_393 = 0;
	int[] iLocal_394 = new int[3];
	int[] iLocal_398 = new int[3];
	int iLocal_402 = 0;
	int iLocal_403 = 0;
	int iLocal_404 = 0;
	Vector3 vLocal_405 = 0;
	Vector3 fLocal_408 = 0;
	Vector3 vLocal_409 = 0;
	Vector3 vLocal_412 = 0;
	Vector3 vLocal_415 = 0;
	Vector3 vLocal_418 = 0;
	Vector3 vLocal_421 = 0;
	Vector3 vLocal_424 = 0;
	Vector3 vLocal_427 = 0;
	Vector3 vLocal_430 = 0;
	Vector3 fLocal_433 = 0;
	Vector3 fLocal_434 = 0;
	int iLocal_435 = 0;
	int iLocal_436 = 0;
	int iLocal_437 = 0;
	int iLocal_438 = 0;
	...
	int iLocal_440 = 0;
	int iLocal_441 = 0;
	Vector3 vLocal_442 = 0;
	Vector3 vLocal_445 = 0;
	Vector3 fLocal_448 = 0;
	Vector3 vLocal_449 = 0;
	Vector3 fLocal_452 = 0;
	auto uLocal_453 = 0;
	auto uLocal_454 = 0;
	float fLocal_455 = 0;
	auto uLocal_456 = 0;
...
void main()
{
	...
	iLocal_99 = 49;
	iLocal_100 = 64;
	iLocal_105 = _0x4A9923385BDB9DAD();
	iLocal_106 = _get_blip_info_id_iterator();
...
void func_3()
{
	...
	else if (func_36(iLocal_392) && func_36(PLAYER::PLAYER_PED_ID()))
	{
		if (is_explosion_in_sphere(-1, get_entity_coords(iLocal_392, 1), 2f) && !is_explosion_in_sphere(13, get_entity_coords(iLocal_392, 1), 2f))
		{
			...
			set_entity_health(iLocal_392, 99);
			set_entity_collision(iLocal_392, true, 0);
			func_2(2);
		}
		else if (has_entity_been_damaged_by_entity(iLocal_392, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (has_ped_been_damaged_by_weapon(iLocal_392, false, 2) || has_entity_been_damaged_by_any_vehicle(iLocal_392))
			{
				remove_ped_from_group(iLocal_392);
				open_sequence_task(&iVar0);
				if (is_ped_in_any_vehicle(iLocal_392, 0))
				{
					task_leave_any_vehicle(false, 0, 4416);
				}
				task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				close_sequence_task(iVar0);
				task_perform_sequence(iLocal_392, iVar0);
		...
		else
		{
			...
			if (((is_player_free_aiming(player_id()) && func_34(PLAYER::PLAYER_PED_ID(), iLocal_392, 50f, 1)) && func_33(iLocal_392, 1126825984)) && func_24(PLAYER::PLAYER_PED_ID(), iLocal_392, 90f, 1, 250, 7))
			{
				...
				{
					task_hands_up(iLocal_392, -1, false, -1, 0);
				}
			}
...
int func_4(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_20(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_24(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
...
bool func_25(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_28(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
void func_40(int iParam0, int iParam1)
{
	...
	else
	{
		...
		else if (func_36(iLocal_392) && is_entity_at_coord(iLocal_392, vLocal_380, 50f, 50f, 50f, false, true, 0))
		{
			func_44(iLocal_392);
		}
		else
	...
	{
		_0x18EB48CFC41F2EA0(iLocal_403, 0f);
	}
	if (iParam0)
	{
		func_42(&iLocal_403);
...
void func_54(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_56(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_56(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_62()
{
	...
	{
		set_ped_reset_flag(iLocal_392, 60, true);
		...
		switch (iLocal_389)
		{
			case 0:
				...
				task_look_at_entity(PLAYER::PLAYER_PED_ID(), iLocal_392, -1, 2050, 4);
				if (func_43(iVar0))
				{
				...
				{
					task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), iLocal_392, false);
					open_sequence_task(&iVar1);
					task_follow_nav_mesh_to_coord(false, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 2f, 20000, 0.25f, 0, 1193033728);
					task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 10000);
					task_follow_nav_mesh_to_coord(false, vLocal_296, 1f, 20000, 0.25f, 0, 1193033728);
					close_sequence_task(iVar1);
					task_perform_sequence(iLocal_392, iVar1);
				...
				iLocal_457 = -1;
				iLocal_300 = false;
				if ((((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) && !is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID())) || (is_ped_in_any_vehicle(iLocal_392, 1) && !is_ped_sitting_in_any_vehicle(iLocal_392))) || is_ped_ragdoll(PLAYER::PLAYER_PED_ID())) || is_ped_ragdoll(iLocal_392))
				{
					func_80(500, 1);
					wait(1000);
					set_entity_coords_no_offset(PLAYER::PLAYER_PED_ID(), -1374.11f, 363.81f, 64.25f, 0, 0, 1);
					set_entity_heading(PLAYER::PLAYER_PED_ID(), 117.46f);
					if (func_36(iLocal_392))
					{
					...
					task_perform_sequence(iLocal_392, iVar2);
			...
			case 1:
				...
				if (!func_21())
				{
					if (((func_43(iLocal_403) && func_36(iLocal_392)) && is_ped_in_vehicle(iLocal_392, iLocal_403, 0)) && is_vehicle_seat_free(iLocal_403, false))
					{
			...
			case 3:
				...
				if (((!func_21() && func_76(iLocal_392, vLocal_296, 4f)) || iLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (iLocal_300)
					{
						if (func_21())
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_72(player_id())) && !func_69(player_id(), 0)) && !func_68())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_72(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_74(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
int func_76(int iParam0, Vector3 vParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_81(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_82(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_83(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
bool func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_94(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_94(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_94(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_125(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_94(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_94(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_94(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_85(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_197(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_90(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_197(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
bool func_97(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_94(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_113(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_113(vVar16.z)] = func_107(iParam1, vVar16.x, func_113(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_113(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_94(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_116(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
	...
	while (iVar4 <= iVar2 - 1)
	{
		...
		else
		{
			...
			while (iVar5 <= iVar6 - 1)
			{
				...
				{
					iVar3 += func_121(iParam0, iParam3);
					return iVar3;
				}
				else
				{
...
void func_135(int iParam0)
{
	...
	func_136(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_136(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_141(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_129(func_139(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_137(iParam1, *uParam0.f_2, &uVar1))
			{
...
int func_137(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_140(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_142(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_136(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_94(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_136(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_197(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_94(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_94(iParam1)))
	{
		return true;
	}
	return false;
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				{
					func_204(vLocal_442, vLocal_445, fLocal_448, vLocal_449, fLocal_452, func_212(), 1, 1, 1, 0, 0);
					task_turn_ped_to_face_entity(PLAYER::PLAYER_PED_ID(), iLocal_392, false);
					open_sequence_task(&iVar1);
					task_follow_nav_mesh_to_coord(false, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 2f, 20000, 0.25f, 0, 1193033728);
					task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), 10000);
					task_follow_nav_mesh_to_coord(false, vLocal_293, 1f, 20000, 0.25f, 0, 1193033728);
					close_sequence_task(iVar1);
					task_perform_sequence(iLocal_392, iVar1);
					clear_sequence_task(&iVar1);
				}
			...
			case 3:
				...
				if (((!func_21() && (func_76(iLocal_392, vLocal_287, 2f) || func_76(iLocal_392, vLocal_290, 2f))) || iLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (iLocal_300)
					{
						if (func_21())
						...
						{
							clear_ped_tasks(iLocal_392);
							set_entity_coords(iLocal_392, vLocal_293, 1, false, 0, 1);
...
void func_204(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_205(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_205(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_209(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_207(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_208(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_208(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_209(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		if (((((((((((((((func_210(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_210(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_210(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_210(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_210(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_210(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_210(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_210(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_210(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_210(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_210(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_210(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_210(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_210(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_210(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_210(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_210(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
{
	func_233();
	func_228(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &sLocal_466);
	switch (iLocal_389)
	{
		case 0:
			func_61(&iLocal_391);
			...
			func_226(&uLocal_459);
			if (func_36(iLocal_392) && !is_ped_group_member(iLocal_392, func_225()))
			{
				set_ped_as_group_member(iLocal_392, func_225());
				set_ped_group_member_passenger_index(iLocal_392, false);
		...
		case 1:
			if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
			{
				...
				if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) > 15f)
				{
					func_22();
					iLocal_389 = 0;
					iLocal_388 = 4;
	...
	if (func_36(iLocal_392))
	{
		set_ped_reset_flag(iLocal_392, 124, true);
	}
}
	...
	if (func_36(iLocal_392) && func_43(iLocal_403))
	{
		switch (iLocal_274)
		{
			...
			case 2:
				...
				set_synchronized_scene_phase(iLocal_273, 0f);
				set_synchronized_scene_looped(iLocal_273, false);
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_322 = 0;
				iLocal_323 = -1;
				iLocal_274 = 12;
				break;
			...
			case 3:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (iLocal_277 || !is_vehicle_window_intact(iLocal_403, 7))
					{
						iLocal_274 = 14;
			...
			case 4:
				...
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 5;
				break;
			...
			case 5:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.9f)
					{
						iLocal_273 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
						set_synchronized_scene_looped(iLocal_273, true);
						_0x394B9CD12435C981(iLocal_273, false);
						attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
						task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 6;
					}
				}
				break;
			...
			case 7:
				...
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1000f, 0);
			...
			case 8:
				...
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 9;
				break;
			...
			case 9:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.9f)
					{
						...
						_0x394B9CD12435C981(iLocal_273, false);
						attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
						task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 10;
					}
				}
				break;
			...
			case 11:
				...
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1000f, 0);
				if (iLocal_277 || !is_vehicle_window_intact(iLocal_403, 7))
				{
					iLocal_274 = 13;
				}
			...
			case 12:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.9f)
					{
						...
						_0x394B9CD12435C981(iLocal_273, false);
						attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
						task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 3;
					}
				}
				break;
			...
			case 13:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.7f)
					{
						iLocal_274 = 14;
					}
				}
			...
			case 14:
				...
				_0x394B9CD12435C981(iLocal_273, true);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 15;
				break;
			...
			case 15:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.95f)
					{
						iLocal_273 = create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
						set_synchronized_scene_phase(iLocal_273, 0f);
						set_synchronized_scene_looped(iLocal_273, false);
						...
						task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 16;
					}
				}
				else
			...
			case 16:
				if (is_synchronized_scene_running(iLocal_273))
				{
					if (get_synchronized_scene_phase(iLocal_273) >= 0.85f)
					{
			...
			case 17:
				...
				{
					if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_403, 0))
					{
...
int func_216()
{
	...
	{
		vVar0 = {get_offset_from_entity_given_world_coords(iLocal_403, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1))};
		if (vVar0.y < -1f)
		{
			return 1;
		}
...
auto func_217(int iParam0, int iParam1)
{
	return func_218(iParam0, iParam1, 1);
}

auto func_218(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_219()
{
	...
	if (func_36(iLocal_392))
	{
		if (is_ped_in_any_vehicle(iLocal_392, 0))
		{
			iVar0 = get_vehicle_ped_is_in(iLocal_392, 0);
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!is_vehicle_driveable(iVar0, 0) && is_entity_in_water(iVar0))
				{
...
void func_220()
{
	if ((iLocal_349 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_343) && (func_223() || func_222()))
	{
...
bool func_222()
{
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) || is_ped_in_any_vehicle(iLocal_392, 0))
	{
		return false;
	}
	return true;
...
bool func_223()
{
	...
	{
		iVar0 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
		if (func_43(iVar0) && is_ped_in_vehicle(iLocal_392, iVar0, 0))
		{
			return true;
		}
	}
...
void func_224()
{
	...
	if ((iLocal_332 < 6 && GAMEPLAY::GET_GAME_TIMER() > iLocal_324) && func_223())
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && !is_ped_stopped(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_43(iVar0))
			{
				if (has_entity_collided_with_anything(iVar0))
				{
					...
					if (func_221())
					{
						iVar1 = func_4(&uLocal_107, "MEJ1AUD", "MEJ1_CRASH", sLocal_325[iLocal_332], 7, 0, 0);
					}
					else
					{
						iVar1 = func_4(&uLocal_107, "MEJ1AUD", "MEJ1_CRASH", sLocal_325[iLocal_332], 7, 1, 0);
					}
					if (iVar1)
					{
						iLocal_332++;
...
void func_228(auto uParam0, auto uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
...
int func_229(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_20(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_234()
{
	...
	switch (iLocal_389)
	{
		...
		case 1:
			...
			if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
			{
				if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) < 5f)
				{
...
void func_235()
{
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_386)
		{
...
void func_237()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_314() == 1)
			{
				iLocal_391 = func_313(vLocal_383, 5, 1);
				set_all_vehicle_generators_active_in_area(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), false, 1);
				clear_area_of_vehicles(vLocal_383, 10f, 0, 0, 0, 0, false);
			}
			else
			{
				iLocal_391 = func_313(vLocal_380, 5, 1);
			}
			...
			if (func_36(iLocal_392) && !is_ped_group_member(iLocal_392, func_225()))
			{
				...
				set_ped_never_leaves_group(iLocal_392, 1);
				set_ped_dies_instantly_in_water(iLocal_392, 0);
				set_entity_proofs(iLocal_392, true, false, false, false, true, false, 0, false);
				set_ped_can_ragdoll(iLocal_392, 1);
			}
...
void func_240()
{
	...
	{
		if ((!func_21() && func_221()) && is_ped_shooting(PLAYER::PLAYER_PED_ID()))
		{
...
void func_241()
{
	...
	{
		if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 30f)
		{
			if (!func_21() && func_221())
			{
...
void func_242()
{
	...
	if ((iLocal_342 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_333) && (func_223() || func_222()))
	{
		if (has_player_damaged_at_least_one_ped(player_id()))
		{
			if (iLocal_376)
			{
				...
				if (func_221())
				{
					iVar0 = func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NOKILL", sLocal_338[iLocal_342], 7, 0, 0);
				}
				else
				{
					iVar0 = func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NOKILL", sLocal_338[iLocal_342], 7, 1, 0);
				}
				if (iVar0)
				{
					iLocal_342++;
...
void func_243()
{
	...
	{
		if (((!func_21() && func_221()) && func_223()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_319)
		{
...
void func_244()
{
	if (((((iLocal_375 && ENTITY::DOES_ENTITY_EXIST(iLocal_394[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[1])) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[2])) && func_36(iLocal_392)) && !is_message_being_displayed())
	{
...
void func_245(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_310(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_303(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
{
	func_247(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_247(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_249(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_250(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_252(auto uParam0, int iParam1, int iParam2)
{
...
void func_257(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_259(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_260(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_262(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_263(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_264(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_128(iParam1)];
...
void func_265(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_266(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_269(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_273(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_270(Var9.f_1)) && iVar70 < 50)
			{
...
int func_272(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_276(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_277(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
int func_278(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_279(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_289())
		{
			*uParam0 = func_285(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_281(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_283() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_129(func_282(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_285(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_288(iVar0))
		{
			...
			{
				fVar1 = get_distance_between_coords(vParam0, func_286(iVar0, 0), 1);
...
auto func_290()
{
	...
	func_300(&uVar0, get_clock_seconds());
	func_299(&uVar0, get_clock_minutes());
	func_298(&uVar0, get_clock_hours());
	func_293(&uVar0, get_clock_day_of_month());
	func_292(&uVar0, get_clock_month());
	func_291(&uVar0, get_clock_year());
	return uVar0;
}
...
auto func_295(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_296(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_304(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
int func_310(char* sParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_313(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_317()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			{
				set_entity_visible(iLocal_403, true, 0);
				set_vehicle_has_strong_axles(iLocal_403, true);
				iVar0 = 0;
				iVar0 = 0;
				while (iVar0 < 3)
				{
					set_entity_visible(iLocal_394[iVar0], true, 0);
					iVar0++;
				}
				set_entity_visible(iLocal_392, true, 0);
				set_ped_dies_instantly_in_water(iLocal_392, 1);
				set_vehicle_forward_speed(iLocal_403, 12f);
				task_vehicle_drive_wander(iLocal_394[0], iLocal_403, 12f, 786468);
		...
		case 1:
			...
			if (func_43(iLocal_403) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[0]))
			{
				...
				{
					set_vehicle_can_be_visibly_damaged(iLocal_403, true);
					iLocal_322 = 0;
				}
				func_331(&uLocal_40, iLocal_403, 0, 0, 1, 1, 1);
				if ((((((((((get_entity_health(iLocal_403) < 850 || func_330()) || func_328()) || func_327(iLocal_403, &uLocal_454, &uLocal_456, &uLocal_453, &fLocal_455, 6, 1082130432)) || get_vehicle_engine_health(iLocal_403) < 50f) || get_vehicle_petrol_tank_health(iLocal_403) < 50f) || (func_36(iLocal_394[0]) && !is_ped_in_vehicle(iLocal_394[0], iLocal_403, 0))) || is_vehicle_stuck_timer_up(iLocal_403, 2, 5000)) || is_vehicle_stuck_timer_up(iLocal_403, 3, 5000)) || is_vehicle_stuck_timer_up(iLocal_403, 0, 5000)) || is_vehicle_stuck_timer_up(iLocal_403, 1, 5000))
				{
					if (is_mobile_phone_call_ongoing())
					{
						func_199();
					...
					{
						task_vehicle_temp_action(iLocal_394[0], iLocal_403, 20, 1000);
					}
					_task_bring_vehicle_to_halt(iLocal_403, 20f, 1, 0);
			...
			if (func_43(iLocal_403))
			{
				if (is_vehicle_stopped(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						...
						{
							open_sequence_task(&iVar3);
							task_pause(false, iVar2 * 1000);
							if (is_ped_in_vehicle(iLocal_394[iVar2], iLocal_403, 0))
							{
								task_leave_any_vehicle(false, 0, 257);
							}
							task_smart_flee_ped(false, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							close_sequence_task(iVar3);
							task_perform_sequence(iLocal_394[iVar2], iVar3);
							clear_sequence_task(&iVar3);
							if (iVar2 == 0 && !func_328())
							{
								func_22();
							...
							else if (((iVar2 == 1 && !func_36(iLocal_394[0])) || ((iVar2 == 2 && !func_36(iLocal_394[0])) && !func_36(iLocal_394[1]))) && !func_328())
							{
								func_326(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_22();
							...
							{
								func_323(iLocal_394[iVar2], 1);
							}
						}
						iVar2++;
					}
					func_61(&iLocal_391);
					set_entity_only_damaged_by_player(iLocal_403, false);
					...
					{
						if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) > 5f + 1f)
						{
							iLocal_391 = func_236(iLocal_392, 1, 1, 5);
					...
					else if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_403, 0))
					{
						iLocal_277 = 1;
						if (is_audio_scene_active("M_E_JIMMY_STOP_KIDNAPPERS"))
						{
		...
		case 3:
			...
			{
				if (iLocal_438 && func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_387)
				{
				...
				else if (func_218(PLAYER::PLAYER_PED_ID(), iLocal_403, 1) < 5f - 1f)
				{
					iLocal_277 = 1;
					func_319();
				}
	...
	if (func_36(iLocal_392))
	{
		set_ped_reset_flag(iLocal_392, 249, true);
		set_ped_reset_flag(iLocal_392, 248, true);
		set_ped_reset_flag(iLocal_392, 124, true);
	}
	func_214();
	func_235();
...
void func_321(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_325(iParam3), 0);
}
...
void func_326(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_327(int iParam0, auto uParam1, auto uParam2, auto uParam3, float fParam4, int iParam5, float fParam6)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = {func_30(get_entity_coords(iVar0, 1) - get_entity_coords(iParam0, 1))};
...
bool func_328()
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && func_43(iLocal_403))
	{
		iVar0 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
		if (func_43(iVar0))
		{
			...
			{
				if (is_vehicle_siren_on(iVar0) && func_34(iVar0, iLocal_403, 15f, 1))
				{
					return true;
				}
			}
...
bool func_330()
{
	...
	{
		iVar0 = 0;
		if (is_vehicle_tyre_burst(iLocal_403, false, 0))
		{
			iVar0++;
		}
		if (is_vehicle_tyre_burst(iLocal_403, true, 0))
		{
			iVar0++;
		}
...
void func_331(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_332(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_332(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	*uParam0.f_6 = 0;
	func_333(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_333(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_349(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
		...
		if (!is_gameplay_hint_active())
		{
			if (func_344(uParam0, iParam7, iParam9, 0))
			{
				func_341(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_341(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_344(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		case 0:
			*uParam0.f_7 = 0;
			if (*uParam0.f_6 == 0)
			{
				...
				else if (func_347(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
			...
			{
				if (func_347(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
		...
		case 2:
			...
			{
				if (!func_347(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
			else if (*uParam0.f_6 == 2)
			{
				...
				else if (!func_348(iParam1, iParam2, iParam3))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_345(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
	...
	if (!func_338(iParam1, iParam2, iParam3))
	{
		*uParam0.f_5 = 0;
		*uParam0.f_7 = 0;
	}
...
void func_352()
{
	if (iLocal_312 > 0 && GAMEPLAY::GET_GAME_TIMER() > iLocal_312)
	{
		if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
		{
			if ((func_217(PLAYER::PLAYER_PED_ID(), iLocal_392) < 50f && !func_21()) && !func_353("MEJ1_02", 0, 0))
			{
				if (iLocal_315)
				{
...
auto func_353(char* sParam0, int iParam1, char* sParam2)
{
...
void func_354()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_394[0])) && func_43(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			if (!iLocal_313)
			{
				iLocal_313 = is_entity_touching_entity(iLocal_403, PLAYER::PLAYER_PED_ID());
			}
			if (has_entity_been_damaged_by_entity(iLocal_403, PLAYER::PLAYER_PED_ID(), 1) || iLocal_313)
			{
				func_199();
				func_22();
				if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					task_vehicle_mission_ped_target(iLocal_394[0], iLocal_403, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_274 = 2;
					fLocal_386 = 200f;
					fLocal_387 = 500f;
			...
			else if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f && !is_entity_occluded(iLocal_403))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_320)
				{
					...
					if (is_message_being_displayed())
					{
						iVar0 = func_39(&uLocal_107, "MEJ1AUD", "MEJ1_SEES", 7, 1, 0, 0);
					}
					else
					{
						iVar0 = func_39(&uLocal_107, "MEJ1AUD", "MEJ1_SEES", 7, 0, 0, 0);
					}
					if (iLocal_317)
					{
						_0x293220DA1B46CEBC(3f, 0f, 3);
		...
		else if (((iLocal_310 < 8 && func_217(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f) && !func_21()) && !func_353("MEJ1_02", 0, 0))
		{
...
int func_355(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_356()
{
	...
	if (has_anim_dict_loaded("missfam3"))
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_321)
		{
			...
			if (func_359(PLAYER::PLAYER_PED_ID(), vVar0, 20f))
			{
				iVar3 = get_random_int_in_range(true, iLocal_394);
		...
		if (!is_entity_dead(iParam0, 0))
		{
			if (is_ped_sitting_in_any_vehicle(iParam0))
			{
				...
				if (func_43(iVar5))
				{
					...
					clear_sequence_task(&iVar3);
					open_sequence_task(&iVar3);
					task_play_anim(false, "missfam3", sVar0, 4f, -8f, -1, 16 | iParam2, 0, 0, 0, 0);
					task_play_anim(false, "missfam3", sVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0, 0, 0, 0);
					task_play_anim(false, "missfam3", sVar2, 8f, -4f, -1, 16 | iParam2, 0, 0, 0, 0);
					close_sequence_task(iVar3);
...
int func_359(int iParam0, Vector3 vParam1, float fParam2)
{
	return vdist2(get_entity_coords(iParam0, 1), vParam1) <= fParam4 * fParam4;
}

void func_360(auto uParam0, auto uParam1, auto uParam2, float fParam3)
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_363()
{
	...
	switch (iLocal_389)
	{
		case 0:
			func_61(&iLocal_391);
			iLocal_391 = func_313(vLocal_377, 5, 0);
			set_blip_colour(iLocal_391, 3);
			set_blip_name_from_text_file(iLocal_391, "MEJ1_JIM");
			set_blip_route(iLocal_391, true);
		...
		case 1:
			if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vLocal_377, 1) < 1400f)
			{
				iLocal_389 = 2;
			}
			break;
		...
		case 2:
			...
			{
				if (func_359(PLAYER::PLAYER_PED_ID(), vLocal_377, 150f) || func_355(&uLocal_107, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_389 = 3;
				}
			}
...
bool func_364()
{
	...
	{
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_409, vLocal_412, fLocal_433, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_415, vLocal_418, fLocal_434, 0, true, 0))
		{
			set_entity_coords(iLocal_403, vLocal_405, 1, false, 0, 1);
			set_entity_heading(iLocal_403, fLocal_408);
			return true;
		}
		else if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_421, vLocal_424, fLocal_433, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_427, vLocal_430, fLocal_434, 0, true, 0))
		{
			set_entity_coords(iLocal_403, vLocal_405, 1, false, 0, 1);
			set_entity_heading(iLocal_403, fLocal_408);
			return true;
...
void func_365()
{
	...
	if (func_43(iLocal_403))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_36(iLocal_394[iVar0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_402))
				{
					...
					set_ped_component_variation(iLocal_394[iVar0], 4, iVar0, iVar0, 0);
					set_blocking_of_non_temporary_events(iLocal_394[iVar0], true);
					set_entity_visible(iLocal_394[iVar0], false, 0);
		...
		if (!func_36(iLocal_392))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_46(14)) && has_anim_dict_loaded(sLocal_272))
			{
				...
				set_entity_proofs(iLocal_392, true, false, false, true, true, false, 0, false);
				set_ped_can_ragdoll(iLocal_392, 0);
				set_ped_reset_flag(iLocal_392, 249, true);
				set_ped_reset_flag(iLocal_392, 248, true);
				set_ped_reset_flag(iLocal_392, 124, true);
				set_blocking_of_non_temporary_events(iLocal_392, true);
				...
				_0x394B9CD12435C981(iLocal_273, false);
				attach_synchronized_scene_to_entity(iLocal_273, iLocal_403, get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 0;
			}
		}
	}
	...
	{
		iLocal_403 = create_vehicle(iLocal_404, vLocal_405, fLocal_408, 1, true);
		set_vehicle_colours(iLocal_403, 22, 22);
		set_vehicle_extra_colours(iLocal_403, false, 8);
		set_entity_visible(iLocal_403, false, 0);
		set_entity_only_damaged_by_player(iLocal_403, true);
		set_vehicle_model_is_suppressed(iLocal_404, true);
		set_model_as_no_longer_needed(iLocal_404);
		set_entity_load_collision_flag(iLocal_403, true);
		set_vehicle_can_be_visibly_damaged(iLocal_403, false);
		iLocal_322 = 0;
		iLocal_323 = -1;
		_0x153973AB99FE8980(iLocal_403, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0f);
	}
}

bool func_366(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	...
	if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		...
		*iParam0 = PED::CREATE_PED(26, iVar0, vParam1, fParam4, 0, false);
		...
		set_ped_component_variation(*iParam0, true, 3, false, 0);
		if (iParam5)
		{
...
void func_370(int iParam0, Vector3 vParam1, float fParam2)
{
	if (does_blip_exist(*iParam0))
	{
...
void func_371()
{
	...
	request_additional_text("MEJ1", false);
	if (has_additional_text_loaded(false))
	{
		if (func_36(PLAYER::PLAYER_PED_ID()))
		{
			func_326(&uLocal_107, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		func_326(&uLocal_107, 4, 0, "JIMMY", 0, 1);
		if (func_36(PLAYER::PLAYER_PED_ID()))
		{
			iLocal_393 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
		}
		func_450(1);
		_set_unk_map_flag(2);
		...
		if (func_60(0) && func_36(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_403(&iVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_367())
		{
			iVar5 = func_402();
			...
			switch (iVar5)
			{
				...
				case 3:
					func_372(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_372(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_378(int iParam0)
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		if (iParam0)
		{
			if ((func_43(iLocal_403) && is_vehicle_seat_free(iLocal_403, -1)) && is_vehicle_seat_free(iLocal_403, false))
			{
				set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_403, -1);
				set_ped_into_vehicle(iLocal_392, iLocal_403, false);
				set_vehicle_engine_on(iLocal_403, true, 1, 0);
			}
		}
		else
		{
			vVar2 = {func_380()};
			func_379(&vVar2, &fVar5);
			func_403(&iVar1, vVar2, fVar5, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			if ((func_43(iVar1) && is_vehicle_seat_free(iVar1, false)) && func_36(iLocal_392))
			{
				set_ped_into_vehicle(iLocal_392, iVar1, false);
...
void func_379(auto uParam0, auto uParam1)
{
	Vector3[] vVar0 = new Vector3[5];
	float[] fVar16 = new float[5];
	int iVar22;
	int iVar23;
...
void func_384(int iParam0, int iParam1)
{
	...
	func_82(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
void func_388(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_401() && func_389(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = {0f, 0f, 0f};
		fVar3 = 0f;
		func_403(iParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
bool func_393(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_403(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		func_428(vParam1, 5f, 0);
		if (func_13(iParam12))
		{
			func_427(iParam12, 0);
			while (!func_404(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_404(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_405(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_13(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_409(*iParam1, 0, &uVar0))
		{
...
bool func_406(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_407(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_409(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_411(iVar0, iParam1, uParam2))
	{
		return false;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_410(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_411(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_207(iParam0, 0, 0)) || func_207(iParam0, 1, 0)) || func_207(iParam0, 2, 0)) || func_254(iParam0) != 145) || func_418(iParam0)) || func_417(iParam0)) || func_410(iParam0)) || func_416(iParam0)) || !func_415(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_417(iParam0))
		{
		}
...
bool func_426(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_427(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_256(iParam0, iParam1))
				{
...
void func_428(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
bool func_440(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_441(iParam0, uVar1[iVar6], 1) && func_393(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_278(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
...
void func_442(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_259(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_445(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_444())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
...
void func_451(int iParam0)
{
	...
	set_widescreen_borders(false, 0);
	set_all_vehicle_generators_active_in_area(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), true, 1);
	func_450(0);
