...
void func_3()
{
	...
	{
		if (is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(iLocal_392, 1), 2f) && !is_explosion_in_sphere(13, ENTITY::GET_ENTITY_COORDS(iLocal_392, 1), 2f))
		{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				iLocal_457 = -1;
				iLocal_300 = false;
				if ((((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) && !is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID())) || (is_ped_in_any_vehicle(iLocal_392, 1) && !is_ped_sitting_in_any_vehicle(iLocal_392))) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(iLocal_392))
				{
					func_80(500, 1);
					wait(1000);
...
int func_216()
{
	...
	{
		vVar0 = {get_offset_from_entity_given_world_coords(iLocal_403, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))};
		if (vVar0.y < -1f)
		{
			return 1;
		}
...
bool func_279(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_289())
		{
			*uParam0 = func_285(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_285(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_288(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_286(iVar0, 0), 1);
...
auto func_290()
{
	...
	func_298(&uVar0, TIME::GET_CLOCK_HOURS());
...
void func_354()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_394[0])) && func_43(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			else if (func_217(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403))
			{
...
void func_356()
{
	...
	if (has_anim_dict_loaded("missfam3"))
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_321)
		{
			...
			{
				iVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, iLocal_394);
		...
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (is_ped_sitting_in_any_vehicle(iParam0))
			{
				...
				if (func_43(iVar5))
				{
					...
					clear_sequence_task(&iVar3);
					open_sequence_task(&iVar3);
					AI::TASK_PLAY_ANIM(false, "missfam3", sVar0, 4f, -8f, -1, 16 | iParam2, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "missfam3", sVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "missfam3", sVar2, 8f, -4f, -1, 16 | iParam2, 0, 0, 0, 0);
					close_sequence_task(iVar3);
...
void func_363()
{
	...
	switch (iLocal_389)
	{
		...
		case 1:
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_377, 1) < 1400f)
			{
				iLocal_389 = 2;
			}
			break;
	...
	if (has_additional_text_loaded(false))
	{
		...
		if (func_367())
		{
			...
			switch (iVar5)
			{
				...
				case 3:
					func_372(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
bool func_440(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_441(iParam0, uVar1[iVar6], 1) && func_393(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_278(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						delete_vehicle(&iParam0);
						return true;
					}
