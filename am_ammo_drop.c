...
bool func_2()
{
	if (is_bit_set(iLocal_175, 8))
	{
		if (!func_6(player_id(), 1, 1))
		{
			if (!is_bit_set(Local_56.f_1, 9))
			{
				set_bit(&(Local_56.f_1), 9);
			}
			return false;
		}
		else if (is_bit_set(Local_56.f_1, 9))
		{
			return true;
		}
	}
	...
	{
		if (!network_does_entity_exist_with_network_id(Local_56.f_4))
		{
		...
		if (is_bit_set(iLocal_175, 8))
		{
			if (!is_entity_at_coord(player_ped_id(), Local_56.f_6, 250f, 250f, 250f, false, true, 0))
			{
				return true;
			}
		}
...
bool func_11()
{
	request_model(Local_56.f_18.f_1);
	if (has_model_loaded(Local_56.f_18.f_1))
	{
...
bool func_12(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (!can_register_mission_objects(1))
	{
		return false;
...
bool func_13()
{
	...
	request_model(joaat("prop_box_ammo02a"));
	request_model(joaat("p_cargo_chute_s"));
	if (has_model_loaded(joaat("prop_box_ammo02a")) && has_model_loaded(joaat("p_cargo_chute_s")))
	{
	...
	if ((!network_does_network_id_exist(Local_56.f_3) && func_64(joaat("s_m_m_pilot_02"))) && network_does_network_id_exist(Local_56.f_2))
	{
		if (func_4(Local_56.f_2))
		{
			if (func_43(&(Local_56.f_3), Local_56.f_2, 22, joaat("s_m_m_pilot_02"), -1, 1, 1, 1))
			{
				...
				set_ped_relationship_group_hash(net_to_ped(Local_56.f_3), Global_1574231);
...
bool func_43(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_45(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_6(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_48(iVar1)))
					{
...
void func_68()
{
	...
	if (network_does_network_id_exist(Local_56.f_4))
	{
		if (func_6(player_id(), 1, 1))
		{
			...
			if ((func_70(iVar1) && func_69(iVar1)) && get_ammo_in_ped_weapon(player_ped_id(), iVar1) < iVar0)
			{
			}
			else if (network_is_host_of_this_script())
			{
				if (!is_bit_set(iLocal_175, 12))
				{
					if (!is_help_message_being_displayed())
					{
						func_39("AMD_HELP3", -1);
						set_bit(&iLocal_175, 12);
					}
				}
				else if (!is_bit_set(iLocal_175, 13))
				{
					if (!is_help_message_being_displayed())
					{
						if (network_does_entity_exist_with_network_id(Local_56.f_4))
						{
							if (is_entity_at_entity(player_ped_id(), net_to_obj(Local_56.f_4), 10f, 10f, 10f, 0, 1, 0))
							{
								if (func_62(&uLocal_180, 20000, 0))
								{
									func_39("AMD_HELP3", -1);
									set_bit(&iLocal_175, 13);
								}
							}
						}
					}
...
void func_72()
{
	...
	if (network_does_entity_exist_with_network_id(Local_56.f_4))
	{
		...
		{
			if (network_does_entity_exist_with_network_id(Local_56.f_5))
			{
				if (network_has_control_of_network_id(Local_56.f_5) || (!_0xA1607996431332DF(Local_56.f_5) && network_is_host_of_this_script()))
				{
					if (func_76(Local_56.f_4) && func_76(Local_56.f_5))
					{
						...
						if (!is_bit_set(iLocal_175, 7))
						{
							if (is_bit_set(iLocal_175, 6))
							{
								if (is_entity_playing_anim(net_to_obj(Local_56.f_5), "P_cargo_chute_S", "P_cargo_chute_S_crumple", 3))
								{
									set_bit(&iLocal_175, 7);
								}
							}
						}
						if (!is_bit_set(iLocal_175, 6))
			...
			if (!is_bit_set(iLocal_175, 14))
			{
				if (network_does_entity_exist_with_network_id(Local_56.f_18))
				{
					if (network_has_control_of_network_id(Local_56.f_18) || (!_0xA1607996431332DF(Local_56.f_18) && network_is_host_of_this_script()))
					{
						if (func_76(Local_56.f_18))
						{
							...
							if (has_object_been_broken(net_to_obj(Local_56.f_18)))
							{
								...
								set_bit(&iLocal_175, 14);
							}
						}
						if (!is_bit_set(Local_56.f_1, 8) && is_bit_set(iLocal_175, 8))
						{
							if (func_76(Local_56.f_18))
							{
			...
			if (network_does_entity_exist_with_network_id(Local_56.f_4))
			{
				if (network_does_entity_exist_with_network_id(Local_56.f_18) && is_entity_attached(net_to_obj(Local_56.f_4)))
				{
...
bool func_88()
{
	request_model(joaat("prop_box_ammo02a"));
	request_model(joaat("p_cargo_chute_s"));
	if ((has_model_loaded(joaat("prop_box_ammo02a")) && has_model_loaded(joaat("p_cargo_chute_s"))) && func_89())
	{
		return true;
	}
	return false;
...
bool func_108(struct<20> Param0)
{
	...
	if (network_is_host_of_this_script())
	{
		...
		Local_56.f_6 = {get_offset_from_entity_in_world_coords(player_ped_id(), 0f, 5f * 1.5f, 0f)};
		Local_56.f_13 = 1;
		Local_56.f_14 = 1;
		Local_56.f_15 = 3;
...
void func_112(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_103();
