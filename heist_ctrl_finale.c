...
void func_63(auto uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_87640[iParam1 /*19*/].f_7[iParam2 /*2*/]), ""))
		{
			...
			while (iVar0 < 10)
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_87640[iParam1 /*19*/].f_7[iParam2 /*2*/]), &(Global_87640[iVar0 /*19*/].f_7[iParam2 /*2*/])))
				{
			...
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_456 > 200)
			{
				if ((*uParam0.f_464 == 2 || *uParam0.f_464 == 3) || *uParam0.f_464 == 4)
				{
					if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_457 > 25000)
					{
						...
						*uParam0.f_457 = GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 8000);
					}
				}
				if (*uParam0.f_464 == 2)
				{
					if ((((*uParam0.f_458[1] < -85 || *uParam0.f_458[0] < -85) || CONTROLS::IS_CONTROL_PRESSED(2, 188)) || CONTROLS::IS_CONTROL_PRESSED(2, 189)) || (_is_input_disabled(2) && is_disabled_control_just_pressed(2, 241)))
					{
						_push_scaleform_movie_function(*uParam0.f_413, "SET_INPUT_EVENT");
						_push_scaleform_movie_function_parameter_int(8);
						_pop_scaleform_movie_function_void();
					...
					else if ((((*uParam0.f_458[1] > 85 || *uParam0.f_458[0] > 85) || CONTROLS::IS_CONTROL_PRESSED(2, 187)) || CONTROLS::IS_CONTROL_PRESSED(2, 190)) || (_is_input_disabled(2) && is_disabled_control_just_pressed(0, 242)))
					{
						_push_scaleform_movie_function(*uParam0.f_413, "SET_INPUT_EVENT");
						_push_scaleform_movie_function_parameter_int(9);
						_pop_scaleform_movie_function_void();
				...
				if (*uParam0.f_464 == 3)
				{
					if ((*uParam0.f_458[1] < -85 || CONTROLS::IS_CONTROL_PRESSED(2, 188)) || (_is_input_disabled(2) && is_disabled_control_just_pressed(0, 40)))
					{
						_push_scaleform_movie_function(*uParam0.f_413, "SET_INPUT_EVENT");
						_push_scaleform_movie_function_parameter_int(8);
						_pop_scaleform_movie_function_void();
					...
					else if ((*uParam0.f_458[1] > 85 || CONTROLS::IS_CONTROL_PRESSED(2, 187)) || (_is_input_disabled(2) && is_disabled_control_just_pressed(0, 41)))
					{
						_push_scaleform_movie_function(*uParam0.f_413, "SET_INPUT_EVENT");
						_push_scaleform_movie_function_parameter_int(9);
						_pop_scaleform_movie_function_void();
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_140()) || Global_100201) || Global_25122) || func_139()) || func_99(8, -1)) || func_138()) || func_137()) || func_136()) || func_135()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_140()) || Global_100201) || Global_25122) || func_139()) || func_99(8, -1)) || func_136()) || func_138()) || func_137()) || func_135()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_140()) || Global_100201) || Global_25122) || func_139()) || func_99(8, -1)) || func_138()) || func_137()) || func_135()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
			...
			if (GAMEPLAY::IS_BIT_SET(iLocal_43, 3))
			{
				if (has_this_cutscene_loaded("BS_2A_2B_INT"))
				{
					...
					else
					{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(get_entity_index_of_registered_entity("MICHAEL", false), 0))
							{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(get_entity_index_of_registered_entity("FRANKLIN", false), 0))
							{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(get_entity_index_of_registered_entity("TREVOR", false), 0))
							{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(get_entity_index_of_registered_entity("LESTER", false), 0))
							{
						...
						if (can_set_exit_state_for_camera(0))
						{
							...
							ENTITY::ENTITY::REMOVE_MODEL_HIDE(95.19f, -1293.499f, 28.2672f, 1.5f, joaat("v_club_officechair"), false);
							func_107(24, 0);
						}
					}
				}
...
bool func_209(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((!PED::IS_PED_INJURED(*iParam0[*iParam0.f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && *iParam0[*iParam0.f_7] != PLAYER::PLAYER_PED_ID())
	{
		if (!iParam2)
		{
			if ((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && !is_entity_on_fire(PLAYER::PLAYER_PED_ID())) && !is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID()))
			{
				AI::CLEAR_PED_TASKS_immediately(PLAYER::PLAYER_PED_ID());
			}
			else
			...
			if ((PED::IS_PED_RAGDOLL(*iParam0[*iParam0.f_7]) && !is_entity_on_fire(*iParam0[*iParam0.f_7])) && !is_ped_getting_into_a_vehicle(*iParam0[*iParam0.f_7]))
			{
		...
		*iParam0.f_7 = 4;
		...
		{
			ENTITY::SET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID(), round(25f / 100f * to_float(get_ped_max_health(PLAYER::PLAYER_PED_ID())) - 100f + 100f));
		}
		if (iParam1)
		{
		...
		func_238();
		func_233(iVar2);
		func_216(func_231(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 145, 0));
...
void func_216(int iParam0)
{
	...
	{
		case 0:
			GAMEPLAY::SET_BIT(&(Global_31499[38 / 32]), 38 % 32);
			func_217(38, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[41 / 32]), 41 % 32);
			func_217(41, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[43 / 32]), 43 % 32);
			func_217(43, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[42 / 32]), 42 % 32);
			func_217(42, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[44 / 32]), 44 % 32);
			func_217(44, 0);
			break;
		
		case 1:
			GAMEPLAY::SET_BIT(&(Global_31499[51 / 32]), 51 % 32);
			func_217(51, 0);
			break;
		...
		case 3:
			GAMEPLAY::SET_BIT(&(Global_31499[53 / 32]), 53 % 32);
			func_217(53, 0);
			break;
		
		case 4:
			GAMEPLAY::SET_BIT(&(Global_31499[81 / 32]), 81 % 32);
			func_217(81, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[82 / 32]), 82 % 32);
			func_217(82, 0);
			break;
		
		case 5:
			GAMEPLAY::SET_BIT(&(Global_31499[47 / 32]), 47 % 32);
			func_217(47, 0);
			GAMEPLAY::SET_BIT(&(Global_31499[50 / 32]), 50 % 32);
			func_217(50, 0);
			break;
...
void func_251(int iParam0)
{
	...
	if (func_95(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iParam0, round(Global_101154.f_1826.f_539.f_290[iVar0] / 100f * to_float(get_ped_max_health(iParam0)) - 100f + 100f));
	}
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			...
			else
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(Global_91046[uVar2], 0))
				{
					if (is_vehicle_seat_free(Global_91046[uVar2], -1))
					{
						vVar3 = {ENTITY::GET_ENTITY_COORDS(iParam0, 1)};
						vVar6 = {ENTITY::GET_ENTITY_COORDS(Global_91046[uVar2], 1)};
	...
	*uParam2.f_97 = 0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(Global_91046[iVar0], 0))
			{
				if (!func_283(Global_91046[iVar0], iVar0, 0) || is_ped_in_vehicle(iParam0, Global_91046[iVar0], 0))
				{
					...
					vVar5 = {ENTITY::GET_ENTITY_COORDS(Global_91046[iVar0], 1)};
...
void func_343(auto uParam0)
{
	...
	while (iVar0 < *uParam0.f_1.f_33)
	{
		if (func_33(*uParam0, *uParam0.f_1.f_75[iVar0]))
		{
			...
			fVar2 = to_float(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) - 32767) / 4000f;
			fVar3 = to_float(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) - 32767) / 4000f;
		...
		while (iVar0 < *uParam0.f_1.f_33)
		{
			if (func_33(*uParam0, *uParam0.f_1.f_75[iVar0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_428[iVar0]))
				{
					...
					fVar4 = to_float(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) - 32767) / 4000f;
					fVar5 = to_float(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) - 32767) / 4000f;
