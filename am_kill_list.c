#region Local Var
	...
	struct<12> Local_713 = 0;
	int[] iLocal_725 = new int[4];
	struct<18>[] Local_730 = new struct<18>[32];
	int iLocal_1307 = 0;
	int iLocal_1308 = 0;
	int[] iLocal_1309 = new int[5];
	int iLocal_1315 = 0;
	int iLocal_1316 = 0;
	int iLocal_1317 = 0;
	float fLocal_1318 = 0;
	int[] iLocal_1319 = new int[4];
	struct<8>[] Local_1324 = new struct<8>[24];
	int iLocal_1517 = 0;
	int iLocal_1518 = 0;
	int iLocal_1519 = 0;
	int[] iLocal_1520 = new int[4];
	int[] iLocal_1525 = new int[4];
	auto uLocal_1530 = 0;
	auto uLocal_1531 = 0;
	int iLocal_1532 = 0;
	struct<47>[] Local_1533 = new struct<47>[32];
	struct<104> Local_3038 = 0;
	auto uLocal_3142 = 0;
	auto uLocal_3143 = 0;
	auto uLocal_3144 = 0;
	auto uLocal_3145 = 0;
	...
	int iLocal_3572 = 0;
	int iLocal_3573 = 0;
	int[] iLocal_3574 = new int[4];
	int iLocal_3579 = 0;
	auto uLocal_3580 = 0;
	auto uLocal_3581 = 0;
	int iLocal_3582 = 0;
	int iLocal_3583 = 0;
	struct<2>[] Local_3584 = new struct<2>[10];
	auto uLocal_3605 = 0;
	auto uLocal_3606 = 0;
	auto uLocal_3607 = 0;
	auto uLocal_3608 = 0;
	...
	auto uLocal_3613 = 0;
	auto uLocal_3614 = 0;
	struct<2>[] Local_3615 = new struct<2>[5];
	auto uLocal_3626 = 0;
	auto uLocal_3627 = 0;
	auto uLocal_3628 = 0;
	auto uLocal_3629 = 0;
	int iLocal_3630 = 0;
	Vector3 vLocal_3631 = 0;
	int iLocal_3634 = 0;
	int iLocal_3635 = 0;
	int iLocal_3636 = 0;
	int iLocal_3637 = 0;
	int iLocal_3638 = 0;
	int[] iLocal_3639 = new int[24];
	int iLocal_3664 = 0;
	int[] iLocal_3665 = new int[5];
	int iLocal_3671 = 0;
	var[] uLocal_3672 = new var[4];
	var[] uLocal_3677 = new var[4];
	struct<20> Local_3682 = 0;
#endregion
...
void main()
{
	...
	iLocal_3573 = -1;
	iLocal_3636 = -1;
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_754(player_id(), 0, 1))
	{
		func_743(Local_3682);
	}
	else
	...
	while (true)
	{
		...
		func_673();
		switch (func_672(participant_id_to_int()))
		{
			case 0:
				if ((func_671() == 1 && Local_96.f_1 != -1) && Local_96.f_2 != -1)
				{
					...
					Local_730[participant_id_to_int() /*18*/] = 1;
				}
				else if (func_671() == 4)
				{
					Local_730[participant_id_to_int() /*18*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_730[participant_id_to_int() /*18*/] = 4;
				}
				break;
...
bool func_2()
{
	...
	if ((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2))
	{
		if (!is_bit_set(Local_96.f_3, 11))
		{
			return false;
		}
	}
	else if (is_bit_set(Local_96.f_3, 6))
	{
		if (!is_bit_set(Local_96.f_3, 11))
		{
			return false;
		...
		if (Local_96.f_241 < 3)
		{
			...
			if (Local_96.f_241 >= 1)
			{
				...
				while (iVar1 < _network_get_num_participants_host())
				{
					...
					{
						if (!func_14(network_get_player_index(int_to_participantindex(iVar1)), 0))
						{
			...
			if (iVar0 == 1)
			{
				if ((!((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2)) && !is_bit_set(Local_96.f_3, 6)) && !is_bit_set(Local_96.f_3, 14))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 15);
				}
				func_5();
			}
			else if (Local_96.f_241 < 3)
			{
				if (func_3())
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 16);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 15);
					func_5();
				}
			}
...
bool func_3()
{
	...
	while (iVar0 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
		{
			if (!func_4(net_to_veh(Local_96.f_7[iVar0]), 1, 0, 0, 0, 0))
			{
				return false;
			}
		}
...
bool func_4(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_19()
{
	...
	while (iVar0 < 24)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar0]))
		{
...
bool func_21()
{
	...
	while (iVar0 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
		{
			if (!is_entity_dead(net_to_veh(Local_96.f_7[iVar0]), 0))
			{
				return false;
			}
		}
...
void func_22()
{
	...
	while (iVar1 < 24)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar1]))
		{
			if (!func_30(Local_96.f_48[iVar1]))
			{
				...
				{
					case 0:
						if (!is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar1]), 0))
						{
							Local_96.f_85[iVar1] = 1;
						}
						else if (is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar1]), 0) && func_29(iVar1))
						{
							Local_96.f_85[iVar1] = 1;
						}
						break;
					...
					case 1:
						if (Local_96.f_241 == 1)
						{
							if (!func_21())
							{
								if (is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar1]), 0))
								{
									iVar4 = get_vehicle_ped_is_in(net_to_ped(Local_96.f_48[iVar1]), 0);
									if (func_28(iVar4, 250f))
									{
										Local_96.f_85[iVar1] = 2;
									}
									else if (is_this_model_a_plane(ENTITY::GET_ENTITY_MODEL(iVar4)))
									{
										if (iVar1 % 4 == 0)
										{
											iVar0 = iVar1 / 4;
					...
					case 2:
						if (Local_96.f_241 == 1)
						{
							...
							else if (is_bit_set(Local_96.f_464, iVar1))
							{
								Local_96.f_85[iVar1] = 1;
								clear_bit(&(Local_96.f_464), iVar1);
							}
						}
						else
						{
					...
					case 3:
						if (is_ped_fleeing(net_to_ped(Local_96.f_48[iVar1])))
						{
		...
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			if (Local_730[iVar0 /*18*/].f_1 != 0)
			{
				if (Local_730[iVar0 /*18*/].f_17 == 1)
				{
					...
					if (!PED::IS_PED_INJURED(iVar2))
					{
						if (func_24(iParam0, iVar2, 1) < fParam1)
						{
							return true;
						}
					}
...
bool func_29(int iParam0)
{
	...
	if (!is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iParam0]), 0))
	{
		return false;
	}
	iVar0 = get_vehicle_ped_is_in(net_to_ped(Local_96.f_48[iParam0]), 0);
...
void func_31()
{
	...
	switch (Local_96.f_241)
	{
		case 0:
			...
			else if (is_bit_set(Local_96.f_3, 4) && func_106() > 1)
			{
				func_105();
				func_109();
				Local_96.f_241 = 1;
			...
			if (!func_664())
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[0]))
				{
					if (!func_103(Local_96.f_7[0]))
					{
						Var2.f_2 = 141;
						func_101(Var2, func_102(net_to_veh(Local_96.f_7[0]), 1, 0));
						Local_96.f_241 = 2;
					}
				}
			}
			if (Local_96.f_241 == 0)
			{
				...
				else if (func_17(&(Local_96.f_330), func_99(), 0))
				{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 12);
					func_5();
				}
				if (is_bit_set(Local_96.f_3, 14))
				{
					func_5();
				}
			}
...
void func_32()
{
	...
	if (!is_bit_set(Local_96.f_3, 6))
	{
		if (!func_20(&(Local_96.f_332)))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 7);
		}
		else if (func_17(&(Local_96.f_332), func_33(), 0))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 6);
		}
	}
}
...
void func_34()
{
	...
	if (Local_96.f_278 > 0)
	{
		if (Local_96.f_279 >= Local_96.f_278)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), false);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), true);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 2);
				return;
			}
		}
	}
	...
	if (iVar2)
	{
		if (Local_96.f_278 > 0)
		{
			if (Local_96.f_279 >= Local_96.f_278)
			{
				...
				{
					iVar5 += Local_96.f_256[0];
				}
				if (Local_96.f_256[1] >= 0)
				{
					iVar5 += Local_96.f_256[1];
				}
				if (Local_96.f_256[2] >= 0)
				{
					iVar5 += Local_96.f_256[2];
				}
				if (Local_96.f_256[3] >= 0)
				{
					iVar5 += Local_96.f_256[3];
				}
				if (iVar5 >= Local_96.f_255)
				{
					...
					while (iVar4 < 24)
					{
						if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar4]))
						{
	...
	if (!is_bit_set(Local_96.f_3, false) || !is_bit_set(Local_96.f_3, true))
	{
		...
		{
			if (network_does_network_id_exist(Local_96.f_73[iVar0]))
			{
				if (func_96(iVar0))
				{
					if (!is_bit_set(Local_96.f_245, iVar0))
					{
						if ((Local_96.f_27 != joaat("hydra") && !func_4(net_to_veh(Local_96.f_73[iVar0]), 1, 0, 0, 0, 0)) || Local_96.f_27 == joaat("hydra"))
						{
							clear_bit(&(Local_96.f_3), false);
							if (func_20(&(Local_3615[iVar0 /*2*/])))
							{
								func_100(&(Local_3615[iVar0 /*2*/]));
							}
						}
						else if (func_4(net_to_veh(Local_96.f_73[iVar0]), 1, 0, 0, 0, 0) && ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iVar0])) == joaat("savage"))
						{
							if (is_bit_set(Local_96.f_3, false))
							{
								clear_bit(&(Local_96.f_3), false);
							}
							if (!is_bit_set(Local_96.f_3, 18))
							{
								func_95(func_98(1), iVar0);
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 18);
							}
						}
						else if (func_94(iVar0) || !func_664())
						{
							...
							if (!is_bit_set(Local_96.f_303, iVar0))
							{
								func_93(func_98(1), iVar0);
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_303), iVar0);
							}
						}
						else
						{
							func_23(&(Local_96.f_73[iVar0]));
							if (!is_bit_set(Local_96.f_253, iVar0))
							{
								Local_96.f_251--;
								if (func_92() > 1)
								{
								...
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_253), iVar0);
							}
							func_100(&(Local_3615[iVar0 /*2*/]));
						}
					}
				...
				else
				{
					...
					if (!is_bit_set(Local_96.f_271, iVar0))
					{
						if (!func_20(&(Local_96.f_336[iVar0 /*2*/])))
						{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_271), iVar0);
						}
						else if (func_17(&(Local_96.f_336[iVar0 /*2*/]), 3000, 0))
						{
							if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iVar0])) == joaat("savage"))
							{
								if (!is_bit_set(Local_96.f_3, 18))
								{
									func_95(func_98(1), iVar0);
			...
			{
				if (network_does_network_id_exist(Local_96.f_48[iVar0 * 4 + iVar1]))
				{
					iVar6 = iVar0 * 4 + iVar1;
					if (!func_30(Local_96.f_48[iVar0 * 4 + iVar1]))
					{
						if (is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar0 * 4 + iVar1]), 0))
						{
							...
							else if (func_87(iVar6))
							{
								...
								if (does_ped_have_ai_blip(net_to_ped(Local_96.f_48[iVar0 * 4 + iVar1])))
								{
									func_86(&(Local_1324[iVar0 * 4 + iVar1 /*8*/]));
								}
								func_23(&(Local_96.f_48[iVar0 * 4 + iVar1]));
								if (is_bit_set(Local_96.f_272[func_85(iVar6)], func_84(iVar6)))
								{
								...
								if (is_bit_set(Local_96.f_275[func_85(iVar6)], func_84(iVar6)))
								{
									clear_bit(&(Local_96.f_275[func_85(iVar6)]), func_84(iVar6));
								}
							}
							else
							{
								if (!is_bit_set(Local_96.f_272[func_85(iVar6)], func_84(iVar6)))
								{
									...
									{
										GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_272[func_85(iVar6)]), func_84(iVar6));
										func_100(&(Local_96.f_364[iVar6 /*2*/]));
									}
								}
								if (!is_bit_set(Local_96.f_275[func_85(iVar6)], func_84(iVar6)))
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_275[func_85(iVar6)]), func_84(iVar6));
								}
							}
						}
					}
					else if (is_bit_set(Local_96.f_272[func_85(iVar6)], func_84(iVar6)) || Local_96.f_27 == joaat("hydra"))
					{
						if (!func_17(&(Local_96.f_414[iVar0 * 4 + iVar1 /*2*/]), 5000, 0))
						{
						}
	...
	if (!is_bit_set(Local_96.f_3, 2))
	{
		...
		{
			if (network_does_network_id_exist(Local_96.f_48[20 + iVar1]))
			{
				iVar7 = 20 + iVar1;
				if (!is_entity_dead(net_to_ped(Local_96.f_48[20 + iVar1]), 0))
				{
					clear_bit(&(Local_96.f_3), 2);
				}
				else if (is_bit_set(Local_96.f_272[func_85(iVar7)], func_84(iVar7)))
				{
					...
					if (is_bit_set(Local_96.f_275[func_85(iVar7)], func_84(iVar7)))
					{
						clear_bit(&(Local_96.f_275[func_85(iVar7)]), func_84(iVar7));
					}
				}
				else
				{
					if (!is_bit_set(Local_96.f_272[func_85(iVar7)], func_84(iVar7)))
					{
						if (!func_20(&(Local_96.f_364[iVar7 /*2*/])))
						{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_272[func_85(iVar7)]), func_84(iVar7));
							func_100(&(Local_96.f_364[iVar7 /*2*/]));
						}
					}
					if (!is_bit_set(Local_96.f_275[func_85(iVar7)], func_84(iVar7)))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_275[func_85(iVar7)]), func_84(iVar7));
					}
				}
			}
...
void func_39()
{
	...
	if (Local_96.f_29 == -1)
	{
		...
		Local_96.f_29 = get_random_int_in_range(0, iVar0);
		if (func_664())
		{
			if (Local_96.f_27 == joaat("hydra"))
			{
...
int func_40()
{
	...
	switch (Local_96.f_27)
	{
		...
		case joaat("buzzard"):
			...
			while (iVar1 < Local_96.f_278)
			{
				iVar0 += Local_96.f_291[iVar1] * iVar4 + Local_96.f_305[iVar1];
				iVar1++;
			}
			break;
	}
...
bool func_50(int iParam0)
{
	...
	if (!network_does_network_id_exist(Local_96.f_48[20 + iParam0]))
	{
		if (func_66(Local_96.f_239) && can_register_mission_entities(0, 1, 0, 0))
		{
			if (func_64(&iVar3))
			{
				if (func_54(Local_96.f_117[iVar3 /*3*/], 1086324736, 1065353216, 1065353216, 1084227584, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
				{
					...
					{
						PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(net_to_ped(Local_96.f_48[20 + iParam0]), iLocal_1518);
						set_entity_is_target_priority(net_to_ped(Local_96.f_48[20 + iParam0]), 1, 0f);
						set_ped_random_component_variation(net_to_ped(Local_96.f_48[20 + iParam0]), 0);
						if (iVar3 == 8 || iVar3 == 9)
						{
							give_weapon_to_ped(net_to_ped(Local_96.f_48[20 + iParam0]), joaat("weapon_rpg"), 25000, true, true);
						}
						else
						{
							give_delayed_weapon_to_ped(net_to_ped(Local_96.f_48[20 + iParam0]), joaat("weapon_advancedrifle"), 25000, 1);
						}
						fVar6 = 30f * func_52();
						set_ped_accuracy(net_to_ped(Local_96.f_48[20 + iParam0]), round(fVar6));
						PED::SET_PED_COMBAT_ABILITY(net_to_ped(Local_96.f_48[20 + iParam0]), 1);
						set_ped_combat_movement(net_to_ped(Local_96.f_48[20 + iParam0]), 2);
						PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[20 + iParam0]), 0, true);
						set_ped_target_loss_response(net_to_ped(Local_96.f_48[20 + iParam0]), 1);
						_0x52D59AB61DDC05DD(net_to_ped(Local_96.f_48[20 + iParam0]), 1);
						PED::SET_PED_CONFIG_FLAG(net_to_ped(Local_96.f_48[20 + iParam0]), 42, true);
						set_entity_health(net_to_ped(Local_96.f_48[20 + iParam0]), round(200f * Global_262145.f_151));
						set_ped_as_enemy(net_to_ped(Local_96.f_48[20 + iParam0]), 1);
						set_ped_keep_task(net_to_ped(Local_96.f_48[20 + iParam0]), true);
						set_ped_dies_when_injured(net_to_ped(Local_96.f_48[20 + iParam0]), true);
						PED::SET_PED_CONFIG_FLAG(net_to_ped(Local_96.f_48[20 + iParam0]), 151, false);
						iVar4 = get_entity_health(net_to_ped(Local_96.f_48[20 + iParam0]));
						fVar5 = func_51();
						iVar4 = round(fVar5 * to_float(iVar4));
						set_entity_health(net_to_ped(Local_96.f_48[20 + iParam0]), iVar4);
						iVar7 = 20 + iParam0;
						if (is_bit_set(Local_96.f_272[func_85(iVar7)], func_84(iVar7)))
						{
							clear_bit(&(Local_96.f_272[func_85(iVar7)]), func_84(iVar7));
						}
						Local_96.f_247++;
						Local_96.f_317++;
						Local_96.f_250++;
						...
						set_entity_only_damaged_by_relationship_group(net_to_ped(Local_96.f_48[iVar7]), 1, iLocal_1517);
					}
				}
			}
		}
...
bool func_53(auto uParam0, int iParam1, int iParam2, Vector3 vParam3, float fParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
bool func_54(Vector3 vParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, float fParam14, int iParam15, int iParam16)
{
	Global_2404956 = 0;
	if (fParam3 > 0f)
	{
	...
	if (fParam14 > 0f)
	{
		if (func_58(vParam0, fParam14, 1, 1, iParam15, iParam17, 0, iParam15))
		{
			return false;
		}
	}
	...
	if (iParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_55(vParam0, fParam6, iParam7, iParam9, fParam10, iParam11, iParam12, fParam16, iParam17))
			{
				return false;
			}
		}
...
bool func_55(Vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, int iParam5, int iParam6, float fParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if (func_754(iVar1, 1, 1))
		{
			if (!func_14(iVar1, 0) && _0x9DE986FC9A87C474(player_id(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_56(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
...
bool func_58(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_754(iVar1, iParam4, iParam5))
			{
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_56(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							if (((get_player_team(player_id()) == -1 && uParam9) && iParam6) && func_59(iVar1))
							{
							}
...
int func_65(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_69(int iParam0)
{
	...
	if (func_66(Local_96.f_240) && func_66(Local_96.f_239))
	{
		if (func_70(iParam0))
		{
			if (is_bit_set(Local_96.f_245, iParam0))
			{
				Local_96.f_249++;
				Local_96.f_251++;
				Local_96.f_252++;
				clear_bit(&(Local_96.f_245), iParam0);
				if (!is_bit_set(Local_96.f_3, 19))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 19);
				}
			}
			return true;
		}
...
bool func_71(int iParam0)
{
	...
	if (func_103(Local_96.f_73[iParam0]) && is_bit_set(Local_96.f_245, iParam0))
	{
		if (func_75(Local_96.f_73[iParam0]))
		{
			if (Local_96.f_116 <= 0)
			{
				if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iParam0])) == joaat("insurgent"))
				{
					Local_96.f_116 = 2;
				}
				else
				{
					Local_96.f_116 = get_vehicle_max_number_of_passengers(net_to_veh(Local_96.f_73[iParam0])) + 1;
					if (Local_96.f_116 > 4)
					{
						Local_96.f_116 = 4;
					}
			...
			{
				if (!network_does_network_id_exist(Local_96.f_48[iParam0 * 4 + iVar6]))
				{
					if (func_66(Local_96.f_239))
					{
						...
						{
							PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), iLocal_1518);
							set_entity_is_target_priority(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1, 0f);
							set_ped_random_component_variation(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 0);
							give_delayed_weapon_to_ped(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), joaat("weapon_appistol"), 25000, 0);
							if (func_73())
							{
								give_delayed_weapon_to_ped(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), joaat("weapon_advancedrifle"), 25000, 1);
							}
							else
							{
								give_delayed_weapon_to_ped(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), joaat("weapon_advancedrifle"), 25000, 1);
							...
							fVar5 = 10f;
							fVar5 *= func_52();
							set_ped_accuracy(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), round(fVar5));
							PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 2, true);
							PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 3, false);
							PED::SET_PED_COMBAT_ABILITY(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_ped_combat_movement(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 2);
							PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 0, true);
							set_ped_target_loss_response(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							_0x52D59AB61DDC05DD(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_entity_health(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), round(200f * Global_262145.f_151));
							set_ped_as_enemy(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_ped_keep_task(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), true);
							PED::SET_PED_CONFIG_FLAG(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 42, true);
							PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 52, true);
							PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 53, true);
							set_ped_dies_in_water(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_ped_dies_instantly_in_water(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_ped_dies_in_sinking_vehicle(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							PED::SET_PED_CONFIG_FLAG(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 151, false);
							if (is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iParam0]))))
							{
								if (iVar6 == 0)
								{
									set_ped_seeing_range(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 299f);
									fVar5 = 3f;
									fVar5 *= func_72();
									set_ped_accuracy(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), round(fVar5));
									set_ped_shoot_rate(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 50);
									PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 52, true);
									PED::SET_PED_COMBAT_ATTRIBUTES(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 53, true);
									set_ped_firing_pattern(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), -1857128337);
								}
								fVar0 = Global_262145.f_9305;
								fVar1 = Global_262145.f_9306;
								fVar2 = Global_262145.f_9307;
								fVar3 = Global_262145.f_9308;
								PED::SET_COMBAT_FLOAT(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 23, fVar0);
								PED::SET_COMBAT_FLOAT(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 24, fVar1);
								PED::SET_COMBAT_FLOAT(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 25, fVar2);
								PED::SET_COMBAT_FLOAT(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 26, fVar3);
							}
							else if (is_this_model_a_plane(ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iParam0]))))
							{
								set_ped_seeing_range(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 299f);
								fVar5 = 3f;
								fVar5 *= func_72();
							...
							set_ped_dies_when_injured(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), true);
							set_ped_keep_task(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), true);
							set_ped_can_be_knocked_off_vehicle(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1);
							set_entity_only_damaged_by_relationship_group(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), 1, iLocal_1517);
							Local_96.f_250++;
			...
			while (iVar6 < Local_96.f_116)
			{
				...
				else if (!is_ped_sitting_in_vehicle(net_to_ped(Local_96.f_48[iParam0 * 4 + iVar6]), net_to_veh(Local_96.f_73[iParam0])))
				{
					return false;
				}
				iVar6++;
...
bool func_74(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!can_register_mission_peds(1))
	{
		return false;
...
bool func_76(int iParam0)
{
	...
	if (!network_does_network_id_exist(Local_96.f_73[iParam0]))
	{
		iVar2 = 0;
		while (iVar2 < Local_96.f_116)
		{
			iVar3 = iParam0 * 4 + iVar2;
			if (network_does_network_id_exist(Local_96.f_48[iVar3]))
			{
				return false;
			}
			iVar2++;
		}
		if (func_66(Local_96.f_240) && !is_bit_set(Local_96.f_245, iParam0))
		{
			fVar10 = 300f;
			if (is_this_model_a_heli(Local_96.f_240) || is_this_model_a_plane(Local_96.f_240))
			{
				fVar9 = 300f;
			}
			else
			...
			if (is_this_model_a_plane(Local_96.f_240))
			{
				fVar10 = 800f;
			}
			iVar11 = 0;
			while (iVar11 < Local_96.f_242)
			{
				if (func_81(iVar11))
				{
					func_80(Local_96.f_240, iVar11, &vVar12, &uVar15);
					if (!func_65(vVar12, 0f, 0f, 0f, 0))
					{
						if (func_54(vVar12, 1086324736, 1065353216, 1065353216, 1084227584, 1, 1, 1, fVar10, 0, -1, 1, fVar9, 0, 0, 0, 0))
						{
							vVar4 = {vVar12};
							fVar7 = uVar15;
							iVar8 = 1;
			...
			if (iVar8 == 1)
			{
				...
				if (func_79(iParam0))
				{
					if (func_78(&(Local_96.f_73[iParam0]), Local_96.f_240, vVar4, fVar7, 1, 1, 1, 0, iVar16, 1))
					{
						set_vehicle_doors_locked(net_to_veh(Local_96.f_73[iParam0]), 2);
						_0x2311DD7159F00582(net_to_veh(Local_96.f_73[iParam0]), 1);
						set_vehicle_automatically_attaches(net_to_veh(Local_96.f_73[iParam0]), false, 0);
						set_vehicle_doors_locked(net_to_veh(Local_96.f_73[iParam0]), 2);
						set_vehicle_engine_on(net_to_veh(Local_96.f_73[iParam0]), true, 1, 0);
						_0x0AD9E8F87FF7C16F(net_to_veh(Local_96.f_73[iParam0]), 0);
						if (is_this_model_a_heli(Local_96.f_240))
						{
							set_heli_blades_full_speed(net_to_veh(Local_96.f_73[iParam0]));
							set_entity_dynamic(net_to_veh(Local_96.f_73[iParam0]), 1);
							activate_physics(net_to_veh(Local_96.f_73[iParam0]));
							_0x3910051CCECDB00C(net_to_veh(Local_96.f_73[iParam0]), false);
						}
						else if (is_this_model_a_plane(Local_96.f_240))
						{
							_set_vehicle_landing_gear(net_to_veh(Local_96.f_73[iParam0]), 3);
							_0x3910051CCECDB00C(net_to_veh(Local_96.f_73[iParam0]), false);
							set_entity_dynamic(net_to_veh(Local_96.f_73[iParam0]), 1);
							activate_physics(net_to_veh(Local_96.f_73[iParam0]));
							set_vehicle_forward_speed(net_to_veh(Local_96.f_73[iParam0]), 30f);
							_0xE16142B94664DEFD(net_to_veh(Local_96.f_73[iParam0]), 1);
							_0xC361AA040D6637A8(net_to_veh(Local_96.f_73[iParam0]), 1);
							fVar1 = 500f;
							set_entity_health(net_to_veh(Local_96.f_73[iParam0]), round(fVar1));
						}
						else
						{
							set_entity_load_collision_flag(net_to_veh(Local_96.f_73[iParam0]), true);
						}
						if (func_92() == 5)
						{
							fVar1 = to_float(func_77());
							set_entity_health(net_to_veh(Local_96.f_73[iParam0]), round(fVar1));
							set_entity_max_health(net_to_veh(Local_96.f_73[iParam0]), round(fVar1));
							set_vehicle_petrol_tank_health(net_to_veh(Local_96.f_73[iParam0]), fVar1);
							set_vehicle_body_health(net_to_veh(Local_96.f_73[iParam0]), fVar1);
							set_vehicle_engine_health(net_to_veh(Local_96.f_73[iParam0]), fVar1);
							set_vehicle_explodes_on_high_explosion_damage(net_to_veh(Local_96.f_73[iParam0]), 0);
							if (fVar1 > 2000f)
							{
								fVar1 = 2000f;
							}
							unk_0x4056EA1105F5ABD7(net_to_veh(Local_96.f_73[iParam0]), fVar1);
							unk_0xFE205F38AAA58E5B(net_to_veh(Local_96.f_73[iParam0]), fVar1);
						}
						if (func_20(&(Local_96.f_336[iParam0 /*2*/])))
						{
							func_100(&(Local_96.f_336[iParam0 /*2*/]));
						}
						clear_bit(&(Local_96.f_253), iParam0);
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_245), iParam0);
						set_entity_only_damaged_by_relationship_group(net_to_veh(Local_96.f_73[iParam0]), 1, iLocal_1517);
						if (is_bit_set(Local_96.f_271, iParam0))
						{
							clear_bit(&(Local_96.f_271), iParam0);
						}
						if (is_bit_set(Local_96.f_303, iParam0))
						{
							clear_bit(&(Local_96.f_303), iParam0);
						}
...
bool func_78(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
bool func_79(int iParam0)
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			if (is_bit_set(Local_730[iVar0 /*18*/].f_6, iParam0))
			{
				iVar1 = network_get_player_index(int_to_participantindex(iVar0));
				return false;
			}
...
void func_80(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = (is_this_model_a_plane(iParam0) || is_this_model_a_heli(iParam0));
	switch (Local_96.f_27)
	{
		case joaat("rhino"):
...
bool func_87(int iParam0)
{
	...
	if (is_bit_set(Local_96.f_272[func_85(iParam0)], func_84(iParam0)))
	{
		return true;
	}
	return false;
...
bool func_89(auto uParam0)
{
	int iVar0;
	
	if (!is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[uParam0]), 0))
	{
		return true;
	}
	iVar0 = get_vehicle_ped_is_in(net_to_ped(Local_96.f_48[uParam0]), 0);
...
bool func_90(int iParam0)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iParam0]));
...
bool func_94(int iParam0)
{
	...
	while (iVar1 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar1)))
		{
			...
			if (!is_entity_dead(net_to_veh(Local_96.f_73[iParam0]), 0))
			{
				if (_0x4CACA84440FA26F6(iVar2, net_to_veh(Local_96.f_73[iParam0]), &uVar0))
				{
					return true;
				}
			}
			else if (unk_0x83660B734994124D(iVar2, net_to_veh(Local_96.f_73[iParam0]), &uVar0))
			{
				return true;
			}
		}
...
int func_96(int iParam0)
{
	...
	{
		return !is_entity_dead(net_to_veh(Local_96.f_73[iParam0]), 0);
	}
	return !is_entity_dead(net_to_veh(Local_96.f_73[iParam0]), 0);
}
...
void func_101(struct<2> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, int iParam13)
{
	Param0 = 0;
...
auto func_102(int iParam0, int iParam1, int iParam2)
{
	auto uVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < 32)
	{
		...
		{
			if (!is_ped_in_vehicle(get_player_ped(iVar2), iParam0, 0))
			{
				if (get_player_team(iVar2) == get_player_team(player_id()) || !iParam2)
				{
...
int func_103(int iParam0)
{
	if (network_does_network_id_exist(iParam0))
	{
		return !func_104(net_to_veh(iParam0));
	}
	return false;
}
...
void func_105()
{
	...
	while (iVar1 < iVar0)
	{
		if (func_4(net_to_veh(Local_96.f_7[iVar1]), 1, 0, 0, 0, 0))
		{
			func_23(&(Local_96.f_7[iVar1]));
		}
		iVar1++;
	}
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 20);
}
...
void func_114(int iParam0, auto uParam1, auto uParam2)
{
...
bool func_116()
{
	...
	while (iVar1 < iVar0)
	{
		...
		if (!is_bit_set(Local_96.f_13, iVar1))
		{
			func_100(&(Local_96.f_5));
			return false;
		}
		else if (func_4(net_to_veh(Local_96.f_7[iVar1]), 1, 0, 0, 0, 0))
		{
			func_100(&(Local_96.f_5));
			return false;
		}
...
bool func_117(int iParam0)
{
	...
	{
		if (get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iParam0]), -1) != 0)
		{
			return true;
		}
	}
...
void func_119()
{
	...
	if (!func_664())
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[0]))
		{
			if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[0])) == joaat("valkyrie"))
			{
				iVar0 = Local_96.f_15 != false;
			}
			else
			{
				iVar0 = Local_96.f_14 != false;
			}
		}
	}
	else
	{
		iVar0 = is_bit_set(Local_96.f_3, 9);
	}
	if (iVar0)
	{
		if (Local_96.f_413 == -1)
		...
		else if (!is_bit_set(Local_96.f_3, 4))
		{
			if (Local_96.f_413 - func_120(&(Local_96.f_326), 0, 0) < 0)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 4);
			}
		}
	}
	else if (func_20(&(Local_96.f_326)))
	{
		...
		Local_96.f_413 -= func_120(&(Local_96.f_326), 0, 0);
	}
}

int func_120(auto uParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !iParam1)
	{
		if (!iParam2)
...
void func_122()
{
	...
	{
		iLocal_1315 = false;
		while (iLocal_1315 < _network_get_num_participants_host())
		{
			if (network_is_participant_active(int_to_participantindex(iLocal_1315)))
			{
				iVar7 = network_get_player_index(int_to_participantindex(iLocal_1315));
				if (!func_14(iVar7, 0))
				{
					...
					if (!is_bit_set(Local_96.f_3, 14))
					{
						if (!is_bit_set(Local_730[iLocal_1315 /*18*/].f_2, 9))
						{
							iVar6++;
						}
					}
					...
					if (!iVar5)
					{
						if (!is_bit_set(Local_730[iLocal_1315 /*18*/].f_2, 8))
						{
							iVar5 = true;
						}
					}
					...
					if (func_754(iVar7, 1, 1))
					{
						...
						while (iVar0 < 4)
						{
							if (Local_96.f_17[iVar0] == func_25())
							{
								if (is_bit_set(Local_730[iLocal_1315 /*18*/].f_2, 0 + iVar0))
								{
	...
	while (iVar0 < 4)
	{
		if (!is_bit_set(Local_96.f_13, iVar0))
		{
			if (iLocal_1520[iVar0] == func_124() && func_117(iVar0))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_13), iVar0);
			}
			if (!is_bit_set(Local_96.f_14, iVar0))
			{
				if (iLocal_1520[iVar0] >= 1 && func_117(iVar0))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_14), iVar0);
				}
			}
			...
			if (!is_bit_set(Local_96.f_15, iVar0) && func_117(iVar0))
			{
				if (iLocal_1520[iVar0] >= 2)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_15), iVar0);
				}
			}
			else if (iLocal_1520[iVar0] <= 1 || !func_117(iVar0))
			{
				if (is_bit_set(Local_96.f_15, iVar0))
				{
					clear_bit(&(Local_96.f_15), iVar0);
				}
			}
		}
		else if (iLocal_1520[iVar0] < func_124() || !func_117(iVar0))
		{
			clear_bit(&(Local_96.f_13), iVar0);
		}
		if (Local_96.f_266[iVar0] != iLocal_1520[iVar0])
		{
			...
			if (Local_96.f_241 == 1)
			{
				...
				{
					if (!is_bit_set(Local_96.f_616, iVar0))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_616), iVar0);
					}
				}
			}
		}
		if (Local_96.f_241 == 0)
		{
			if (func_664())
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
				{
					iVar3 = ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iVar0]));
	...
	if (!is_bit_set(Local_96.f_3, 11))
	{
		if (!iVar5)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 11);
		}
	}
	iVar0 = false;
	iVar9 = 0;
	if (Local_96.f_241 == 0)
	{
		if (func_664())
		{
			...
			if (!is_bit_set(Local_96.f_3, 9))
			{
				if (iVar9 >= 2)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 9);
				}
			}
			else if (iVar9 < 2)
			{
				clear_bit(&(Local_96.f_3), 9);
			}
		}
	}
	if (Local_96.f_241 == 0)
			...
			if (!is_bit_set(Local_96.f_3, 14))
			{
				if (func_664())
				{
					if (Local_96.f_27 == joaat("valkyrie"))
					{
						if (iVar6 < 4)
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 14);
						}
					}
					else if (iVar6 < 2)
					{
...
void func_125(int iParam0, int iParam1)
{
	...
	if (!is_bit_set(Local_96.f_16, iParam0))
	{
		if (is_bit_set(Local_730[iParam0 /*18*/].f_2, 12))
		{
			func_126(iParam1, 1);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_16), iParam0);
		}
		else if (Local_96.f_241 >= 1)
		{
			...
			else if (Local_730[iParam0 /*18*/].f_17 >= 2)
			{
				...
				while (iVar1 < 4)
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar1]))
					{
						if (func_103(Local_96.f_7[iVar1]))
						{
							if (is_ped_in_vehicle(get_player_ped(iParam1), net_to_veh(Local_96.f_7[iVar1]), 0))
							{
								iVar0 = true;
							}
						}
	...
	else if (Local_96.f_241 < 1)
	{
		...
		{
			func_126(iParam1, 0);
			clear_bit(&(Local_96.f_16), iParam0);
		}
	}
}
...
void func_126(int iParam0, int iParam1)
{
	...
	while (iVar0 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
		{
			set_vehicle_doors_locked_for_player(net_to_veh(Local_96.f_7[iVar0]), iParam0, iParam1);
		}
		iVar0++;
	}
}
...
{
	if (!is_bit_set(Local_96.f_272[func_85(iParam1)], func_84(iParam1)))
	{
		if (is_bit_set(Local_730[iParam0 /*18*/].f_3[func_85(iParam1)], func_84(iParam1)))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_272[func_85(iParam1)]), func_84(iParam1));
			if (Local_730[iParam0 /*18*/].f_17 < 2)
			{
			}
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iParam1]))
			{
				if (!func_30(Local_96.f_48[iParam1]))
				{
					if (!func_88(iParam1))
					{
						clear_bit(&(Local_96.f_272[func_85(iParam1)]), func_84(iParam1));
					}
					else if (!is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iParam1]), 0))
					{
						if (iParam1 >= 20)
						{
							clear_bit(&(Local_96.f_272[func_85(iParam1)]), func_84(iParam1));
...
{
	if (!is_bit_set(Local_96.f_271, iParam1))
	{
		if (is_bit_set(Local_730[iParam0 /*18*/].f_6, iParam1))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_271), iParam1);
			if (Local_730[iParam0 /*18*/].f_17 < 2)
			{
			}
			if (is_bit_set(Local_96.f_303, iParam1))
			{
				if (!is_bit_set(Local_96.f_253, iParam1))
				{
					Local_96.f_251--;
					if (func_92() > 1)
					{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_253), iParam1);
				}
				...
				clear_bit(&(Local_96.f_303), iParam1);
			}
		}
	}
}
...
void func_129(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_bit_set(Local_730[iParam0 /*18*/].f_1, iParam1))
	{
		iLocal_1520[iParam1]++;
		...
		iLocal_725[iParam1] += Local_730[iParam0 /*18*/].f_8;
		if (Local_96.f_241 >= 1)
		{
			if (Local_96.f_22[iParam1] == func_25())
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iParam1]))
				{
					if (func_103(Local_96.f_7[iParam1]))
					{
						iVar1 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iParam1]), -1);
						if (iVar1 != 0)
						{
							if (is_ped_a_player(iVar1))
							{
								iVar0 = _network_get_ped_player(iVar1);
								if (iVar0 == iParam2)
								{
		...
		if (!is_bit_set(Local_96.f_319, iParam1))
		{
			if (Local_730[iParam0 /*18*/].f_10 > -1)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_319), iParam1);
	...
	if (Local_96.f_22[iParam1] != func_25())
	{
		if (!network_is_player_active(Local_96.f_22[iParam1]))
		{
		...
		{
			iVar1 = get_player_ped(Local_96.f_22[iParam1]);
			if (!PED::IS_PED_INJURED(iVar1))
			{
				if (func_103(Local_96.f_7[iParam1]))
				{
					if (!is_ped_in_vehicle(iVar1, net_to_veh(Local_96.f_7[iParam1]), 0))
					{
						iVar0 = func_130(iParam1, 1);
						if (iVar0 != func_25())
						{
		...
		while (iVar3 < _network_get_num_participants_host())
		{
			if (network_is_participant_active(int_to_participantindex(iVar3)))
			{
				if (iVar0 == func_25())
				{
					if (Local_730[iVar3 /*18*/].f_17 == 1)
					{
						if (is_bit_set(Local_730[iVar3 /*18*/].f_1, iParam0))
						{
							if (!iParam1)
							{
							...
							else
							{
								...
								if (func_103(Local_96.f_7[iParam0]))
								{
									...
									if (!PED::IS_PED_INJURED(iVar2))
									{
										if (is_ped_in_vehicle(iVar2, net_to_veh(Local_96.f_7[iParam0]), 0))
										{
											iVar0 = iVar1;
										}
									}
...
auto func_132(int iParam0, int iParam1)
{
	auto uVar0;
	int iVar1;
	int iVar2;
...
bool func_134()
{
	...
	if (func_66(Local_96.f_27))
	{
		if (func_135())
		{
			set_model_as_no_longer_needed(Local_96.f_27);
			return true;
		}
	}
	return false;
...
bool func_135()
{
	...
	{
		if (!network_does_network_id_exist(Local_96.f_7[iVar0]))
		{
			if (func_66(Local_96.f_27))
			{
				if (!is_bit_set(Local_96.f_244, iVar0))
				{
					clear_area(Local_96.f_30[iVar0 /*3*/], 5f, 1, 0, 0, true);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_244), iVar0);
				}
				if (func_78(&(Local_96.f_7[iVar0]), Local_96.f_27, Local_96.f_30[iVar0 /*3*/], Local_96.f_43[iVar0], 1, 1, 1, 1, 0, 1))
				{
					network_fade_in_entity(net_to_ent(Local_96.f_7[iVar0]), 1, 1);
					set_vehicle_doors_locked(net_to_veh(Local_96.f_7[iVar0]), 1);
					_0xDBC631F109350B8C(net_to_veh(Local_96.f_7[iVar0]), 1);
					set_vehicle_can_be_used_by_fleeing_peds(net_to_veh(Local_96.f_7[iVar0]), 0);
					set_vehicle_automatically_attaches(net_to_veh(Local_96.f_7[iVar0]), false, 0);
					freeze_entity_position(net_to_veh(Local_96.f_7[iVar0]), false);
					set_entity_dynamic(net_to_veh(Local_96.f_7[iVar0]), 1);
					activate_physics(net_to_veh(Local_96.f_7[iVar0]));
					set_vehicle_engine_on(net_to_veh(Local_96.f_7[iVar0]), true, 1, 0);
					_0x3910051CCECDB00C(net_to_veh(Local_96.f_7[iVar0]), true);
					_0x0AD9E8F87FF7C16F(net_to_veh(Local_96.f_7[iVar0]), 0);
					if (is_this_model_a_heli(Local_96.f_27) || is_this_model_a_plane(Local_96.f_27))
					{
						set_vehicle_explodes_on_high_explosion_damage(net_to_veh(Local_96.f_7[iVar0]), 0);
						if (is_this_model_a_heli(Local_96.f_27))
						{
							fVar1 = to_float(func_138());
						}
						else if (is_this_model_a_plane(Local_96.f_27))
						{
							fVar1 = to_float(func_137());
						}
						else
						{
							fVar1 = to_float(func_136());
						}
						set_entity_health(net_to_veh(Local_96.f_7[iVar0]), round(fVar1));
						set_entity_max_health(net_to_veh(Local_96.f_7[iVar0]), round(fVar1));
						set_vehicle_petrol_tank_health(net_to_veh(Local_96.f_7[iVar0]), fVar1);
						set_vehicle_body_health(net_to_veh(Local_96.f_7[iVar0]), fVar1);
						set_vehicle_engine_health(net_to_veh(Local_96.f_7[iVar0]), fVar1);
						if (is_this_model_a_plane(Local_96.f_27))
						{
							_0xE16142B94664DEFD(net_to_veh(Local_96.f_7[iVar0]), 1);
						}
						if (is_this_model_a_heli(Local_96.f_27))
						{
							if (fVar1 > 2000f)
							...
							unk_0x4056EA1105F5ABD7(net_to_veh(Local_96.f_7[iVar0]), fVar1);
							unk_0xFE205F38AAA58E5B(net_to_veh(Local_96.f_7[iVar0]), fVar1);
						}
					}
					else
					{
					...
					set_vehicle_strong(net_to_veh(Local_96.f_7[iVar0]), true);
					if (Local_96.f_27 == joaat("savage"))
					{
					}
					if (decor_is_registered_as_type("Not_Allow_As_Saved_Veh", 3))
					{
						decor_set_int(net_to_veh(Local_96.f_7[iVar0]), "Not_Allow_As_Saved_Veh", true);
					}
					if (decor_is_registered_as_type("MPBitset", 3))
					{
						if (decor_exist_on(net_to_veh(Local_96.f_7[iVar0]), "MPBitset"))
						{
							iVar2 = decor_get_int(net_to_veh(Local_96.f_7[iVar0]), "MPBitset");
						}
						GAMEPLAY::GAMEPLAY::SET_BIT(&iVar2, 10);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iVar2, 15);
						decor_set_int(net_to_veh(Local_96.f_7[iVar0]), "MPBitset", iVar2);
					}
					set_entity_can_be_damaged_by_relationship_group(net_to_veh(Local_96.f_7[iVar0]), 0, iLocal_1517);
					iVar3 = 0;
					while (iVar3 < 32)
					{
						set_entity_can_be_damaged_by_relationship_group(net_to_veh(Local_96.f_7[iVar0]), 0, Global_1574198[iVar3]);
						iVar3++;
					}
					unk_0x1DDA078D12879EEE(net_to_veh(Local_96.f_7[iVar0]), 0, 0);
					set_vehicle_can_be_targetted(net_to_veh(Local_96.f_7[iVar0]), 0);
					set_entity_invincible(net_to_veh(Local_96.f_7[iVar0]), true);
					set_vehicle_can_be_visibly_damaged(net_to_veh(Local_96.f_7[iVar0]), false);
				}
			}
		}
		iVar0++;
...
int func_139()
{
	...
	if (!is_bit_set(Local_96.f_3, 10))
	{
		if (func_153(&iVar0))
		{
			if (iVar0 < func_152())
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 10);
			}
			else
			{
				...
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 8);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 10);
				}
				else
				{
		...
		if (!is_bit_set(Local_96.f_3, 13))
		{
			if (func_148())
			{
				if (!func_146(129, Local_96.f_1, Local_96.f_2, 0))
				{
					if (func_140())
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_3), 13);
					}
					else
					{
						Local_96.f_29 = -1;
	...
	return is_bit_set(Local_96.f_3, 13);
}
...
bool func_141(Vector3 vParam0, float fParam1)
{
	int[] iVar0 = new int[32];
	int iVar33;
	int iVar34;
	int iVar35;
	Vector3 vVar36;
	...
	{
		if (is_bit_set(Global_2359718[iVar34 /*26*/].f_12, 11))
		{
...
bool func_153(auto uParam0)
{
	...
	else if (func_17(&(Local_96.f_334), 3000, 0))
	{
		...
		while (iVar0 < _network_get_num_participants_host())
		{
			if (network_is_participant_active(int_to_participantindex(iVar0)))
			{
				if (!func_14(network_get_player_index(int_to_participantindex(iVar0)), 0))
				{
					if (!is_bit_set(Local_730[iVar0 /*18*/].f_2, 7))
					{
						*uParam0++;
					}
				}
...
void func_156()
{
	...
	if (iLocal_3637 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iLocal_3637]))
		{
			if (network_has_control_of_network_id(Local_96.f_7[iLocal_3637]))
			{
				vVar0 = {get_entity_coords(net_to_veh(Local_96.f_7[iLocal_3637]), 0)};
				if (vVar0.z < -25f)
				{
...
void func_157()
{
	...
	if (Local_730[participant_id_to_int() /*18*/].f_17 == 1)
	{
		if (!is_bit_set(iLocal_1308, 13))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 13);
			use_player_colour_instead_of_team_colour(1);
		}
	}
	else if (is_bit_set(iLocal_1308, 13))
	{
...
void func_158()
{
	...
	if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
	{
		Local_730[participant_id_to_int() /*18*/].f_1 = 0;
	}
	if (iVar0 != func_25())
	{
...
void func_159(int iParam0)
{
	...
	while (iVar0 < 24)
	{
		...
		if (does_blip_exist(Local_1324[iVar0 /*8*/]))
		{
			set_blip_name_from_text_file(Local_1324[iVar0 /*8*/], "UW_BLIP2");
			if (iParam0)
			{
			}
			else
			{
				set_blip_as_short_range(Local_1324[iVar0 /*8*/], true);
			}
		}
		if (does_blip_exist(Local_1324[iVar0 /*8*/].f_1))
		{
			set_blip_name_from_text_file(Local_1324[iVar0 /*8*/].f_1, "UW_BLIP2");
			if (iParam0)
			{
			}
			else
			{
				set_blip_as_short_range(Local_1324[iVar0 /*8*/].f_1, true);
			}
		}
		if (Local_96.f_27 != joaat("hydra"))
		{
			if (is_bit_set(Local_96.f_272[func_85(iVar0)], func_84(iVar0)) || is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar0)], func_84(iVar0)))
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar0]))
				{
		...
		{
			iVar1 = iVar0 / 4;
			if (is_bit_set(Local_96.f_271, iVar1) || is_bit_set(Local_730[participant_id_to_int() /*18*/].f_6, iVar1))
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar0]))
				{
					func_86(&(Local_1324[iVar0 /*8*/]));
...
void func_160(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7)
{
	if (network_does_network_id_exist(iParam0))
	{
		if (func_162())
		...
		if (iParam3)
		{
			func_161(net_to_ped(iParam0), iParam1, 1, Global_2428492, iParam4, iParam5, fParam2, sParam6, iParam7);
		}
		else
		{
			func_161(net_to_ped(iParam0), iParam1, -1, Global_2428492, iParam4, iParam5, fParam2, sParam6, iParam7);
...
bool func_161(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_163()
{
	...
	int iVar2;
	int iVar3;
	char*[] sVar4 = new char*[4];
	int iVar9;
	int[] iVar10 = new int[4];
	...
	if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
	{
		return;
	}
	if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 10))
	{
		return;
	}
	if (Local_730[participant_id_to_int() /*18*/].f_10 >= 0)
	{
		return;
	}
	if (func_664())
	...
	if (func_664())
	{
		...
		while (iVar1 < 4)
		{
			iVar21 = int_to_playerindex(Local_96.f_594[iVar1 /*4*/].f_2);
			if (iVar21 != func_25())
			{
				if (network_is_player_active(iVar21))
				{
					...
					if (Local_730[participant_id_to_int() /*18*/].f_9 == uVar15[iVar1])
					{
						iVar20 = uVar15[iVar1];
						iVar20++;
					}
	...
	else if (iVar2 >= 0)
	{
		...
		if (Local_96.f_27 == joaat("rhino") || Local_96.f_27 == joaat("hydra"))
		{
			func_178(get_player_name(player_id()), iVar0, iVar0, Local_96.f_255, iVar2, iVar3, 0, func_182());
		}
		else
		{
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7)
{
	struct<16> Var0;
	char* sVar16;
...
void func_178(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, char* sParam7)
{
	char* sVar0;
...
struct<16> func_180(auto uParam0)
{
	char[64] cVar0;
	
	StringConCat(&cVar0, _get_label_text("HUD_TEAM"), 64);
	StringConCat(&cVar0, " ", 64);
	StringIntConCat(&cVar0, uParam0, 64);
	return cVar0;
}
...
void func_185(int iParam0)
{
	...
	{
		if (is_bit_set(Global_2460486.f_4563, false))
		{
	...
	else if (iParam0 < 30000)
	{
		if (is_bit_set(Global_2460486.f_4563, false))
		{
			if (is_bit_set(Global_2460486.f_4563, 4))
			{
				if (!is_bit_set(Global_2460486.f_4563, 2))
				{
					if (_0x109697E2FFBAC8A1())
					{
						if ((!are_strings_equal(get_radio_station_name(get_player_radio_station_index()), "OFF") && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && !is_string_null_or_empty(&(Global_2460486.f_4565)))
						{
							...
							set_audio_flag("AllowScoreAndRadio", 0);
							set_user_radio_control_enabled(1);
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), 2);
						}
					}
				}
				else if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_bit_set(Global_2460486.f_4563, 5))
				{
					set_radio_to_station_name("OFF");
				}
			}
			else if (!is_bit_set(Global_2460486.f_4563, true))
			{
				if (iParam0 < 10000)
				{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), true);
			}
			else if (!is_bit_set(Global_2460486.f_4563, 4))
			{
				if (iParam0 < 27500)
				{
					if (get_player_radio_station_genre() != 0)
					{
						...
						set_user_radio_control_enabled(1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), 4);
					}
				}
			}
			if (iParam0 < 10000)
			{
				if (!is_bit_set(Global_2460486.f_4563, 3))
				{
					Global_2460486.f_4573 = get_sound_id();
					play_sound_frontend(Global_2460486.f_4573, "10S", "MP_MISSION_COUNTDOWN_SOUNDSET", 0);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), 3);
				}
			}
		}
		else if (iParam0 > 10000)
		{
			if (!is_bit_set(Global_2460486.f_4563, false))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), false);
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) || is_bit_set(Global_2460486.f_4563, 2))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), 2);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4563), 5);
				}
				else
				{
					clear_bit(&(Global_2460486.f_4563), 5);
					clear_bit(&(Global_2460486.f_4563), 2);
				}
			}
		}
	}
...
void func_186()
{
	...
	while (iVar0 < 4)
	{
		if (does_blip_exist(iLocal_1319[iVar0]))
		{
			remove_blip(&(iLocal_1319[iVar0]));
		}
		iVar0++;
	}
}
	...
	while (iVar0 < 4)
	{
		if (!does_blip_exist(iLocal_1319[iVar0]))
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
			{
				if (!is_bit_set(Local_96.f_13, iVar0))
				{
					if (!is_bit_set(Local_730[iParam0 /*18*/].f_1, iVar0))
					{
						iLocal_1319[iVar0] = add_blip_for_entity(net_to_veh(Local_96.f_7[iVar0]));
						set_blip_sprite(iLocal_1319[iVar0], 429);
						func_188(&(iLocal_1319[iVar0]), 29);
						if (func_664())
						{
							set_blip_name_from_text_file(iLocal_1319[iVar0], "UW_BLIPC");
						}
						else
						{
							set_blip_name_from_text_file(iLocal_1319[iVar0], "UW_BLIP");
						}
						set_blip_priority(iLocal_1319[iVar0], 9);
					}
					else if (does_blip_exist(iLocal_1319[iVar0]))
					{
						remove_blip(&(iLocal_1319[iVar0]));
					}
				}
...
void func_188(auto uParam0, int iParam1)
{
	...
	{
		set_blip_colour(*uParam0, func_189(iParam1));
	}
}
...
void func_193(int iParam0)
{
	...
	{
		if (!is_bit_set(Global_2460486.f_4563, true))
		{
...
int func_194()
{
	...
	if (iVar0)
	{
		if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 9))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				iVar1 = set_exclusive_phone_relationships(PLAYER::PLAYER_PED_ID());
				if (!is_vehicle_driveable(iVar1, 0))
				{
					func_199(0, -1);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 9);
				}
			}
		}
	}
	else if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 9))
	{
		clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 9);
	}
	if (Global_1715399)
	{
		iVar0 = true;
...
bool func_201()
{
	...
	if (func_197(player_id(), 0) || func_197(player_id(), 3))
	{
		return false;
	}
	if ((func_197(player_id(), 12) || func_197(player_id(), 14)) || func_197(player_id(), 13))
	{
		return false;
	}
	if (func_207(player_id(), 0, 0))
	{
		return false;
	}
	...
	if (func_202(player_id()) && Global_1587316.f_168)
	{
		return false;
	}
	return true;
...
int func_217(int iParam0)
{
	...
	iVar0 = 2;
	iVar1 = ((func_234(iParam0) && !func_196(iParam0)) && !is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 8));
	iVar2 = func_233(iParam0);
	uVar3 = func_232();
	uVar4 = func_223();
	if ((iVar1 && (func_222(iParam0) || func_221(iParam0))) || uVar4)
	{
		iVar0 = 0;
	}
	else if (uVar3 || ((!iVar2 && !func_220(iParam0)) && !func_218(iParam0)))
	{
		iVar0 = 2;
	}
	else
...
bool func_223()
{
	if ((func_219(player_id(), 21) || func_219(player_id(), 22)) || func_229())
	{
		return true;
	}
	if (func_225())
...
bool func_225()
{
	if (func_228(player_id(), 0))
	{
		if ((func_232() && !func_227()) || func_197(player_id(), 21))
		{
			if (!func_219(player_id(), 27))
			{
				return true;
			}
		}
...
int func_230(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_231(iParam1)];
...
bool func_241()
{
	...
	iVar0 = Global_1347750[func_231(-1)];
	if (is_bit_set(iVar0, 7))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1638), 23);
		return true;
	}
	return false;
}
...
void func_258(int iParam0)
{
	...
	if (iVar9)
	{
		...
		func_263(&Local_1533, &iLocal_1532, 23, &Local_3038, &uLocal_3147, -1, 0);
		if (Local_730[participant_id_to_int() /*18*/].f_17 == 1)
		{
			if (Local_1533[0 /*47*/].f_1 != player_id())
			{
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (Local_96.f_465[iVar0 /*4*/].f_1 > -1)
			{
				StringIntConCat(&cVar5, Local_96.f_465[iVar0 /*4*/] + 1, 16);
				Local_1533[iVar0 /*47*/].f_37 = {cVar5};
				Local_1533[iVar0 /*47*/].f_1 = int_to_playerindex(Local_96.f_465[iVar0 /*4*/].f_2);
		...
		if (Local_730[participant_id_to_int() /*18*/].f_17 == 1)
		{
			...
			{
				if (Local_96.f_594[0 /*4*/] != Local_730[participant_id_to_int() /*18*/].f_9)
				{
		...
		func_263(&Local_1533, &iLocal_1532, 23, &Local_3038, &uLocal_3147, -1, 1);
		if (iParam0)
		{
			if (!func_376())
			{
...
void func_262()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1641), 19);
}

void func_263(int iParam0, int iParam1, int iParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	*uParam3.f_36 = 0;
	...
	{
		if (func_334(iParam1, iParam2, uParam3, Global_1573685, 0, func_378()))
		{
			func_333(1);
			if ((!func_331() && !func_329()) || is_bit_set(Global_2460486.f_4426, true))
			{
				if (func_328())
				{
					func_325();
				...
				else
				{
					...
					if (*uParam3.f_27 == 0)
					{
						...
						if (iParam2 == 24)
						{
							...
							while (iVar52 < 32)
							{
								if (func_754(int_to_playerindex(iVar52), 0, 1))
								{
									iVar35 = int_to_playerindex(iVar52);
									if (!func_14(iVar35, 0))
									{
										if ((_0x9DE986FC9A87C474(iVar35, player_id()) || Global_2418472[iVar35 /*313*/].f_232 != -1) || func_322(iVar35))
										{
											iVar44 = iVar35;
											if (func_321(iVar35))
											{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_313(iVar35) && func_309(iVar35, iParam2)) && func_754(iVar35, 0, 1))
							{
								...
								*(uParam3.f_38[iVar44 /*2*/]).f_1 = iVar53;
								if (func_285(iParam5))
								{
									func_284(iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, iParam0[iVar52 /*47*/].f_37, iParam0[iVar52 /*47*/].f_41, *(iParam0[iVar52 /*47*/]).f_45, iVar48, iParam6);
								}
								else
								{
									func_284(iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, iParam0[iVar52 /*47*/].f_37, iParam0[iVar52 /*47*/].f_41, *(iParam0[iVar52 /*47*/]).f_45, iVar48, iParam6);
								}
						...
						{
							iVar35 = int_to_playerindex(iVar52);
							if (func_754(iVar35, 0, 1) && !is_bit_set(iVar49, iVar35))
							{
								iVar35 = int_to_playerindex(iVar52);
							}
							else
							...
							if (func_313(iVar35))
							{
								if (func_754(int_to_playerindex(iVar52), 0, 1))
								{
									...
									*(uParam3.f_38[iVar44 /*2*/]).f_1 = iVar53;
									func_276(get_player_name(iVar35), iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
			...
			switch (iVar1)
			{
				case 0:
					if (network_can_communicate_with_gamer(&Var2))
					{
						...
						{
							iVar16 = 1;
							func_267(uParam0, uVar0, 2);
						}
					}
					else if (network_is_gamer_muted_by_me(&Var2))
					{
						iVar16 = 1;
						func_267(uParam0, uVar0, 1);
					}
					break;
...
void func_267(auto uParam0, auto uParam1, int iParam2)
{
	*uParam0.f_38[uParam1 /*2*/] = iParam2;
}

int func_268(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12)
{
	return network_is_handle_valid(&uParam0, 13);
}

auto func_269(auto uParam0, auto uParam1)
{
		...
		if (iVar2 != func_25())
		{
			if (func_754(iVar2, 0, 1))
			{
				if (*(uParam0.f_38[iVar0 /*2*/]).f_1 != -1)
				{
					...
					func_274(iParam1, *(uParam0.f_38[iVar0 /*2*/]).f_1, iVar1, Global_1587523[iVar0 /*444*/].f_195.f_6);
				}
			}
		}
		iVar0++;
...
void func_274(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_276(char* sParam0, int iParam1, auto uParam2, int iParam3, char* sParam4, auto uParam5, auto uParam6, auto uParam7, char* sParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	char* sVar1;
...
void func_284(int iParam0, auto uParam1, int iParam2, char* sParam3, auto uParam4, auto uParam5, auto uParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, int iParam19)
{
	int iVar0;
	char* sVar1;
...
int func_287(int iParam0, int iParam1)
{
	...
	iVar0 = 116;
	if ((!iParam1 && func_234(iParam0)) && !func_233(iParam0))
	{
		iVar0 = func_291();
	}
...
char* func_292(int iParam0, int iParam1, int iParam2, int iParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_293(auto uParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_297(iParam3))
	{
...
void func_305(auto uParam0, char* sParam1)
{
...
bool func_314()
{
	...
	if (func_233(player_id()))
	{
		switch (func_315(player_id()))
		{
			case 148:
			case 151:
			case 152:
...
void func_318(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar0 < 32)
	{
		if (func_754(int_to_playerindex(iVar0), 0, 1))
		{
			...
			if (!func_14(iVar1, 0))
			{
				if ((_0x9DE986FC9A87C474(iVar1, player_id()) || Global_2418472[iVar1 /*313*/].f_232 != -1) || func_322(iVar1))
				{
...
bool func_328()
{
	if (is_bit_set(Global_2460486.f_4426, false) && func_327())
	{
		return true;
	}
	if (is_bit_set(Global_2460486.f_4426, true) && func_327())
	{
		return true;
	}
	return false;
...
bool func_334(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	char* sVar4;
	int iVar5;
	...
	if (!func_20(uParam2.f_19))
	{
		if (func_369() == 1)
		{
			func_356(iVar6, iParam0, 0);
			func_18(uParam2.f_19, 0, 0);
			func_357(iParam0, uParam2, 0);
		}
	}
	if (func_20(uParam2.f_19) || iParam5)
	{
		if (is_help_message_being_displayed())
		{
			hide_help_text_this_frame();
		...
		hide_hud_component_this_frame(10);
		if (func_17(uParam2.f_19, 10000, 0) || (func_369() == 0 && !iParam5))
		{
			func_357(iParam0, uParam2, 1);
			return false;
		}
		else
		{
			...
			else
			{
				...
				_0x55598D21339CB998(fVar7);
				if (func_356(iVar6, iParam0, 0))
				{
					func_323(iParam0);
					sVar4 = func_353(iParam1, &(Global_1617379.f_70372), iParam4);
					if (iParam4)
					{
						func_350(iParam0, sVar4, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 23)
					{
						func_345(iParam0, func_347(uParam2), func_346(uParam2), -1);
					}
					else if (iParam1 == 24)
					{
						func_342(iParam0, func_344(), func_343(), -1);
					}
					else if (iVar5)
					{
						*uParam2.f_34 = Global_1573686;
						func_350(iParam0, sVar4, "", 0, -1, Global_1573686, 1);
					}
					else
					{
						Var0 = {func_340(iParam1)};
						iVar8 = func_335(iParam1);
						func_350(iParam0, sVar4, &Var0, 1, iVar8, -1, 1);
					}
...
struct<4> func_340(int iParam0)
{
	...
	StringCopy(&cVar0, "", 16);
	if (func_341(player_id()) || func_336(player_id()))
	{
		return cVar0;
	}
	switch (iParam0)
...
void func_345(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	if (has_scaleform_movie_loaded(*iParam0))
	{
		_push_scaleform_movie_function(*iParam0, "SET_TITLE");
		...
		else if (func_184(player_id()) == 133)
		{
...
char* func_346(auto uParam0)
{
	int iVar0;
	
	iVar0 = func_184(player_id());
	if (func_376())
	{
		if (*uParam0.f_103 != -1)
		{
...
void func_350(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
char* func_353(int iParam0, char* sParam1, int iParam2)
{
	auto uVar0;
...
void func_357(int iParam0, auto uParam1, int iParam2)
{
...
bool func_358()
{
	...
	else if (!func_239(player_id(), 1) && Global_1311716[0 /*4*/] > 0)
	{
		return false;
	}
...
{
	if ((iParam0 == 24 && func_234(player_id())) && !func_233(player_id()))
	{
		return true;
	}
	if (iParam0 == 23)
	{
		if (func_228(player_id(), 0) && func_233(player_id()))
		{
			return true;
		}
		if (func_217(player_id()) == 3)
...
struct<4> func_377()
{
	...
	{
		case joaat("rhino"):
			StringCopy(&cVar0, "UW_TMRHN", 16);
			break;
		
		case joaat("hydra"):
			StringCopy(&cVar0, "UW_TMHYD", 16);
			break;
		
		case joaat("savage"):
			StringCopy(&cVar0, "UW_TMSAV", 16);
			break;
		
		case joaat("valkyrie"):
			StringCopy(&cVar0, "UW_TMVALK", 16);
			break;
		
		case joaat("buzzard"):
			StringCopy(&cVar0, "UW_TMBUZ", 16);
			break;
	}
	return cVar0;
}
...
void func_380()
{
	...
	switch (Local_730[participant_id_to_int() /*18*/].f_17)
	{
		case 0:
			if (Local_730[participant_id_to_int() /*18*/].f_1 == 0)
			{
			...
			if (Local_96.f_241 == 0)
			{
				...
				if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
				{
					if (!is_bit_set(iLocal_1308, true))
					{
						func_626(129);
						func_604(1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, true);
						network_set_friendly_fire_option(0);
					}
					if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 6))
					{
						if (Local_96.f_28 > 1 || (Local_96.f_28 == 1 && func_106() > 1))
						{
							...
							{
								Local_730[participant_id_to_int() /*18*/].f_1 = 0;
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 6);
							}
						}
					}
				}
				else if (is_bit_set(iLocal_1308, true))
				{
					clear_bit(&iLocal_1308, true);
					func_603();
					func_602();
					func_604(0);
				}
			...
			if (Local_96.f_241 == 1)
			{
				...
				if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
				{
					if (!func_599())
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 19);
					}
					...
					iLocal_1317 = get_max_wanted_level();
					...
					iLocal_1519 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
					PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), iLocal_1517);
					set_audio_flag("DisableFlightMusic", 1);
					...
					func_564(0);
					Local_730[participant_id_to_int() /*18*/].f_9 = iLocal_3573;
					if (!func_664())
					{
					...
					else
					{
						...
						func_562(62, &cVar0, "UW_DESCCT", "UW_TITLE", 15000, -1, -1082130432, "", func_291(), func_291());
					}
					Local_713.f_9 = _get_posix_time();
					func_564(0);
					func_560(0);
					func_18(&uLocal_3611, 0, 0);
					Local_730[participant_id_to_int() /*18*/].f_17 = 1;
				}
				else
				{
					func_186();
					...
					Local_730[participant_id_to_int() /*18*/].f_17 = 2;
					func_564(0);
					if (Local_730[participant_id_to_int() /*18*/].f_1 == 0)
					{
					}
			...
			else if (Local_96.f_241 == 3)
			{
				...
				func_186();
				Local_730[participant_id_to_int() /*18*/].f_17 = 3;
			}
			else if (Local_96.f_241 > 3)
			{
				if (func_257("UW_ABTSC") || func_257("UW_ABTS"))
				...
				func_564(0);
				Local_730[participant_id_to_int() /*18*/].f_17 = 4;
			}
			else
			{
				if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
		...
		case 1:
			...
			if (!is_bit_set(iLocal_1307, 26))
			{
				if (!func_475(54))
				{
					if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
					{
						if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 10))
						{
							if (Local_730[participant_id_to_int() /*18*/].f_10 == -1)
							{
								if (!func_664())
								{
									if (!func_257("UW_ATTK"))
			...
			if (!func_754(player_id(), 1, 1))
			{
				Local_730[participant_id_to_int() /*18*/].f_17 = 2;
				func_7();
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 21);
			}
			else if (func_176())
			{
				Local_730[participant_id_to_int() /*18*/].f_17 = 2;
			...
			if (Local_730[participant_id_to_int() /*18*/].f_17 == 1)
			{
				if (!func_473())
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 23);
					func_7();
					if (iLocal_3573 > -1)
					{
						if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iLocal_3573]))
						{
		...
		case 2:
			...
			if (func_555())
			{
				if (func_184(player_id()) == 129)
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !is_radar_hidden())
					{
						PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 398, false);
						if (is_bit_set(iLocal_1307, 22))
						{
							func_411();
							clear_bit(&iLocal_1307, 22);
						}
						func_602();
						func_408();
						func_407(0);
			...
			else if (!is_bit_set(iLocal_1308, 8))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 8);
			}
			if (!func_194())
			{
				func_403();
			...
			func_396();
			func_497();
			if (!is_bit_set(iLocal_1308, 7))
			{
				iVar6 = 0;
				while (iVar6 < 24)
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar6]))
					{
						if (!func_30(Local_96.f_48[iVar6]))
						{
							set_ped_can_be_targetted_by_player(net_to_ped(Local_96.f_48[iVar6]), player_id(), 0);
						}
					}
					iVar6++;
				}
				...
				while (iVar6 < 4)
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_80[iVar6]))
					{
						if (!func_30(Local_96.f_80[iVar6]))
						{
							set_ped_can_be_targetted_by_player(net_to_ped(Local_96.f_80[iVar6]), player_id(), 0);
						}
					}
					iVar6++;
				}
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 7);
			}
			else if (Local_96.f_247 != iLocal_3571)
			{
				iLocal_3571 = Local_96.f_247;
				clear_bit(&iLocal_1308, 7);
			}
			if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
			{
				clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 11);
			}
			if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 10))
			{
				clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 10);
			}
			if (get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID()) == iLocal_1517)
			{
				PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), iLocal_1519);
			}
			break;
		
		case 3:
			if (!is_bit_set(iLocal_1307, 31))
			{
				if (is_bit_set(Local_96.f_3, 12))
				{
					func_186();
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 31);
				}
			}
			func_474();
			func_391();
			if (!func_194())
			{
				if (!is_bit_set(Local_96.f_3, 14) && !is_bit_set(Local_96.f_3, 12))
				{
					func_258(1);
				}
				func_483();
...
void func_381()
{
	...
	if (iLocal_3634 != Local_96.f_616)
	{
		...
		while (iVar0 < 4)
		{
			if (is_bit_set(Local_96.f_616, iVar0))
			{
				if (!is_bit_set(iLocal_3634, iVar0))
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
					{
						if (network_has_control_of_network_id(Local_96.f_7[iVar0]))
						{
							set_vehicle_doors_locked(net_to_veh(Local_96.f_7[iVar0]), 2);
							func_23(&(Local_96.f_7[iVar0]));
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_3634, iVar0);
						}
					}
					else
					{
	...
	if (is_bit_set(Local_96.f_3, 14))
	{
		if (!is_bit_set(iLocal_1308, 5))
		{
			if (func_385(0, 1, 1, 1))
			{
				...
				func_383(1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 5);
			}
		}
	}
}
...
void func_391()
{
	...
	while (iVar2 < 4)
	{
		if (!is_bit_set(iLocal_1307, 27 + iVar2))
		{
			if (network_does_network_id_exist(Local_96.f_7[iVar2]))
			{
				if (!is_entity_dead(net_to_veh(Local_96.f_7[iVar2]), 0))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 27 + iVar2);
					iLocal_3574[iVar2] = get_sound_id();
					play_sound_from_entity(iLocal_3574[iVar2], "Explosion_Countdown", net_to_veh(Local_96.f_7[iVar2]), "GTAO_FM_Events_Soundset", 0, 0);
					set_variable_on_sound(iLocal_3574[iVar2], "Time", 30f);
				}
			}
		}
		iVar2++;
	...
	if (!func_664())
	{
		if (network_does_network_id_exist(Local_96.f_7[0]))
		{
			if (!is_bit_set(Local_96.f_319, false))
			{
				if (!is_entity_dead(net_to_veh(Local_96.f_7[0]), 0))
				{
					if (func_395() - func_120(&(Local_96.f_324), 0, 0) >= 0)
					{
						if (Local_730[participant_id_to_int() /*18*/].f_1 != 0 || is_bit_set(Local_96.f_3, 14))
						{
							if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[0]), 50f, 50f, 50f, 0, 1, 0))
							{
								if (!func_194())
								{
									func_394();
					...
					else
					{
						...
						if (network_has_control_of_network_id(Local_96.f_7[0]))
						{
							set_entity_invincible(net_to_veh(Local_96.f_7[0]), false);
							set_vehicle_can_be_visibly_damaged(net_to_veh(Local_96.f_7[0]), true);
							if (!is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[0]))))
							{
								network_explode_vehicle(net_to_veh(Local_96.f_7[0]), 1, 0, -1);
								func_23(&(Local_96.f_7[0]));
							}
							else
							{
								unk_0x2A5E0621DD815A9A(net_to_veh(Local_96.f_7[0]), 1, 0, 0);
								func_23(&(Local_96.f_7[0]));
							}
						}
					}
		...
		if (!func_194())
		{
			if (!is_bit_set(iLocal_1307, 12))
			{
				if (func_103(Local_96.f_7[0]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[0])))
						{
							if (!func_664())
							{
								if (!func_257("UW_EXPL"))
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 12);
						}
					}
				}
			}
	...
	else
	{
		...
		while (iVar0 < 4)
		{
			if (network_does_network_id_exist(Local_96.f_7[iVar0]))
			{
				if (!is_bit_set(Local_96.f_319, iVar0))
				{
					if (!is_entity_dead(net_to_veh(Local_96.f_7[iVar0]), 0))
					{
						if (func_395() - func_120(&(Local_96.f_324), 0, 0) >= 0)
						{
							if (Local_730[participant_id_to_int() /*18*/].f_1 != 0 || is_bit_set(Local_96.f_3, 14))
							{
								if (is_entity_at_entity(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iVar0]), 50f, 50f, 50f, 0, 1, 0))
								{
									if (!func_194())
									{
										if (!iVar1)
						...
						else
						{
							...
							if (func_392(Local_96.f_7[iVar0]))
							{
								if (network_has_control_of_network_id(Local_96.f_7[iVar0]))
								{
									set_entity_invincible(net_to_veh(Local_96.f_7[iVar0]), false);
									set_vehicle_can_be_visibly_damaged(net_to_veh(Local_96.f_7[iVar0]), true);
									if (!is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iVar0]))))
									{
										network_explode_vehicle(net_to_veh(Local_96.f_7[iVar0]), 1, 0, -1);
										func_23(&(Local_96.f_7[iVar0]));
									}
									else
									{
										unk_0x2A5E0621DD815A9A(net_to_veh(Local_96.f_7[iVar0]), 1, 0, 0);
										func_23(&(Local_96.f_7[iVar0]));
									}
								}
							}
				...
				if (!is_bit_set(iLocal_1307, 12))
				{
					if (func_103(Local_96.f_7[iVar0]))
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iVar0])))
							{
								if (!func_194())
								{
									if (!func_664())
	...
	if (!is_bit_set(iLocal_1308, 4))
	{
		if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_603();
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 4);
				}
			}
		}
	}
...
void func_397()
{
	...
	iVar0 = int_to_participantindex(iLocal_1316);
	if (network_is_participant_active(iVar0))
	{
		iVar1 = network_get_player_index(iVar0);
		if (network_is_player_active(iVar1))
		{
			if (iLocal_1316 != participant_id_to_int())
			{
				if (!is_bit_set(iLocal_3635, iLocal_1316))
				{
					if (!func_194())
					{
						if (Local_730[iLocal_1316 /*18*/].f_17 == 1)
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_3635, iLocal_1316);
							func_398(iVar1, 55, 1);
						}
					}
				}
				...
				{
					func_398(iVar1, 55, 0);
					clear_bit(&iLocal_3635, iLocal_1316);
				}
	...
	iLocal_1316++;
	if (iLocal_1316 >= _network_get_num_participants_host())
	{
		iLocal_1316 = false;
	}
}
...
void func_402()
{
	...
	while (iVar0 < 24)
	{
		if (does_blip_exist(Local_1324[iVar0 /*8*/]))
		{
			remove_blip(&(Local_1324[iVar0 /*8*/]));
		}
		if (does_blip_exist(Local_1324[iVar0 /*8*/].f_1))
		{
			remove_blip(&(Local_1324[iVar0 /*8*/].f_1));
		}
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar0]))
		{
			if (!func_30(Local_96.f_48[iVar0]))
			{
				if (does_ped_have_ai_blip(net_to_ped(Local_96.f_48[iVar0])))
				{
					func_86(&(Local_1324[iVar0 /*8*/]));
				}
			}
...
void func_403()
{
	if (!is_bit_set(iLocal_1307, 11))
	{
		if (!is_bit_set(Local_96.f_3, 6))
		{
			if (!is_bit_set(iLocal_1307, 13))
			{
				if (func_184(player_id()) != 129)
				{
					if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
					{
						...
						{
							if (is_bit_set(iLocal_1308, 11))
							{
								if (!is_bit_set(iLocal_1308, 12))
								{
									if (func_385(0, 1, 1, 1))
									{
										if (func_664())
										...
										func_383(1);
										GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 12);
									}
								}
							}
							else if (!(Local_96.f_27 == joaat("rhino") || Local_96.f_27 == joaat("hydra")))
							{
								if (func_385(0, 1, 1, 1))
								{
									...
									func_383(1);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 11);
								}
							}
						}
					}
...
void func_404()
{
	...
	fVar0 = to_float(iLocal_3630);
	fVar0 /= 60000f;
	iLocal_3630 = floor(fVar0);
	if (iLocal_3630 >= 1)
	{
	}
	else
...
void func_408()
{
	...
	clear_bit(&(Global_1573883.f_1), 8);
	func_409();
}
...
void func_412()
{
	...
	iVar0 = is_bit_set(Local_96.f_3, 6);
	iVar1 = is_bit_set(iLocal_1307, 21);
	iVar2 = is_bit_set(iLocal_1307, 23);
	iVar3 = Local_730[participant_id_to_int() /*18*/].f_10 != -1;
	if (iVar3)
	{
		iVar1 = false;
		iVar2 = false;
	...
	if (func_555())
	{
		if (!is_bit_set(iLocal_1308, 17))
		{
			if (func_754(player_id(), 1, 1))
			{
				if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) || iVar2)
				{
					if (!func_194())
					{
						if (!func_664())
						{
							...
							else if (iVar1)
							{
								...
								else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[0]) && func_103(Local_96.f_7[0]))
								{
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 11);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 16);
							...
							else if (iVar3 || is_bit_set(Local_96.f_3, 16))
							{
					...
					if (iVar4 > 0)
					{
						...
						{
							_0xFB6DB092FBAE29E6(iVar4, "AM_KILL_LIST", &uVar6);
						}
					}
					iVar10 = func_459(1);
					Local_713.f_7 += iVar10;
					func_458();
					func_413(0, PLAYER::PLAYER_PED_ID(), "", -1636175450, 153786435, iVar10, 1, -1, 0, 0);
					Local_713.f_5 = 2;
					PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 398, false);
					if (!is_bit_set(iLocal_1308, 16))
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 8);
					}
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 17);
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 18);
				}
			}
		}
	}
...
int func_413(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9)
{
	return func_414(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6, iParam7, sParam8, iParam9);
}

int func_414(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9)
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_424(iParam0, sParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam9);
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1))
		{
			if (is_entity_a_ped(iParam1))
			{
				...
				func_420(get_ped_bone_coords(iVar1, 31086, 0f, 0f, 0f), iVar0, 0, sParam8);
			}
		}
	}
	else
...
void func_415(int iParam0, int iParam1, char* sParam2)
{
	...
	vVar0 = {func_418(iParam0, 1)};
	if (iParam0 == func_417(PLAYER::PLAYER_PED_ID()))
	{
		func_416(1);
	}
	func_420(vVar0, iParam1, 0, sParam2);
}
...
Vector3 func_418(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_419(PLAYER::PLAYER_PED_ID()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
void func_420(Vector3 vParam0, int iParam1, int iParam2, char* sParam3)
{
	int iVar0;
	int iVar1;
...
float func_423(Vector3 vParam0, auto uParam1, auto uParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
auto func_424(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	auto uVar0;
	
	uVar0 = func_425(iParam0, 0, sParam1, iParam4, iParam5, 0, iParam6, 1, iParam2, iParam3, iParam7);
	return uVar0;
}

int func_425(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (func_457(player_id()) || func_456(player_id()))
	{
	...
	if (func_455())
	{
		...
		if (iParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_435(func_444(player_id()) + iVar1, iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (iParam7)
		{
			if (iParam6 == -1)
			{
				func_426(func_428(player_id()) + iVar1);
			}
			else
			{
				func_426(func_428(player_id()) + iParam6);
			}
		}
		if (iParam7)
		{
...
void func_435(int iParam0, int iParam1, int iParam2)
{
	if (func_455())
	{
		...
		if (func_443(player_id()))
		{
			...
			Global_1587523[player_id() /*444*/].f_195.f_6 = func_441(iParam0, 1);
		}
...
bool func_438(int iParam0, auto uParam1)
{
	if (Global_1315901)
	{
		return false;
...
void func_447(int iParam0)
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		...
		if (network_is_participant_active(iVar4))
		{
			...
			{
				if (get_player_team(iVar5) == iVar1 || func_449(get_player_team(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != player_id())
					{
	...
	if (iVar3)
	{
		iVar6 = round(func_448(*iParam0, 100) * 10f * Global_262145.f_4211);
	}
	if (iVar2 > 4)
	{
		iVar2 = 4;
	...
	if (iVar2 >= 2)
	{
		iVar7 = round(func_448(*iParam0, 100) * 20f * Global_262145.f_4204);
	}
	*iParam0 += iVar6;
	*iParam0 += iVar7;
}
...
void func_450(int iParam0, int iParam1)
{
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_754(iVar4, 1, 1))
			{
				if (iVar4 != player_id())
				{
					if (func_451(player_id(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_63(player_id(), iVar4))
						{
	...
	if (iVar2)
	{
		iVar5 = round(func_448(*iParam1, 100) * 10f * Global_262145.f_4211);
	}
	if (iVar1 > 4)
	{
		iVar1 = 4;
	...
	if (iVar1 >= 1)
	{
		iVar6 = round(func_448(*iParam1, 100) * 20f * Global_262145.f_4204);
	}
	*iParam1 += iVar5;
	*iParam1 += iVar6;
}
...
auto func_452(int iParam0)
{
	...
	iVar0 = round(func_448(*iParam0, 100) * 25f);
	*iParam0 += iVar0;
	return *iParam0;
}
...
int func_453(int iParam0)
{
	if (iParam0 < 0)
	{
		if (absi(iParam0) > func_444(player_id()))
		{
			iParam0 = -func_444(player_id());
		}
	}
	if (func_454(8000, 0, 0) > 0)
	{
		if (func_454(8000, 0, 0) < iParam0 + func_444(player_id()))
		{
			iParam0 = func_454(8000, 0, 0) - func_444(player_id());
		}
	}
	return iParam0;
}

auto func_454(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
void func_460(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_461(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_468(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8)
{
	int iVar0;
...
void func_474()
{
				...
				if (!func_20(&uLocal_3609) || (func_20(&uLocal_3609) && func_17(&uLocal_3609, 5000, 0)))
				{
					if (Local_96.f_27 == joaat("savage") || Local_96.f_27 == joaat("buzzard"))
					{
						...
						if (iVar1 > -1)
						{
							if (func_103(Local_96.f_7[iVar1]))
							{
								iVar0 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iVar1]), -1);
								if (iVar0 == 0)
								{
									Local_730[participant_id_to_int() /*18*/].f_10 = iVar1;
								}
					...
					else if (Local_96.f_27 == joaat("valkyrie"))
					{
						...
						if (iVar1 > -1)
						{
							if (func_103(Local_96.f_7[iVar1]))
							{
								...
								if (Local_730[participant_id_to_int() /*18*/].f_10 == -1)
								{
									iVar4 = _get_vehicle_model_max_number_of_passengers(joaat("valkyrie"));
									iVar2 = false;
									while (iVar2 < iVar4)
									{
										iVar0 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iVar1]), iVar2);
										if (iVar0 != 0)
										{
	...
	while (iVar2 < 4)
	{
		if (is_bit_set(Local_96.f_319, iVar2))
		{
			if (network_does_network_id_exist(Local_96.f_7[iVar2]))
			{
				if (!is_entity_dead(net_to_veh(Local_96.f_7[iVar2]), 0))
				{
					if (func_395() - func_120(&(Local_96.f_349[iVar2 /*2*/]), 0, 0) >= 0)
					{
						if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
						{
							if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iVar2]), 0))
							{
								if (!func_194())
								{
									func_394();
					...
					else
					{
						...
						if (network_has_control_of_network_id(Local_96.f_7[iVar2]))
						{
							set_entity_invincible(net_to_veh(Local_96.f_7[iVar2]), false);
							set_vehicle_can_be_visibly_damaged(net_to_veh(Local_96.f_7[iVar2]), true);
							if (!is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iVar2]))))
							{
								network_explode_vehicle(net_to_veh(Local_96.f_7[iVar2]), 1, 0, -1);
								func_23(&(Local_96.f_7[iVar2]));
							}
							else
							{
								unk_0x2A5E0621DD815A9A(net_to_veh(Local_96.f_7[iVar2]), 1, 0, 0);
								func_23(&(Local_96.f_7[iVar2]));
							}
						}
					}
			...
			if (Local_730[participant_id_to_int() /*18*/].f_10 == iVar2)
			{
				if (!is_bit_set(iLocal_1308, 6))
				{
					if (func_385(0, 1, 1, 1))
					{
						if (func_664())
						{
							if (!is_bit_set(iLocal_1308, 19))
							{
						...
						func_383(1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 6);
					}
					else if (is_bit_set(iLocal_1308, 19))
					{
						if (is_help_message_being_displayed())
						{
							clear_help(1);
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					uVar5 = Local_730[participant_id_to_int() /*18*/].f_10;
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[uVar5]))
					{
						if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[uVar5])))
						{
							if (!func_664())
							{
								if (!func_257("UW_EXPL"))
			...
			if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
			{
				if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 10))
				{
					if (!func_20(&uLocal_3605) || (func_20(&uLocal_3605) && func_17(&uLocal_3605, 5000, 0)))
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (func_65(vLocal_3631, 0f, 0f, 0f, 0))
							{
								vLocal_3631 = {Local_96.f_30[0 /*3*/]};
							}
							fVar0 = func_478(PLAYER::PLAYER_PED_ID(), vLocal_3631, 1);
							if (fVar0 > 750f)
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 10);
							}
						}
				...
				else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						iVar2 = get_sound_id();
						play_sound_from_entity(iVar2, "Explosion_Countdown", net_to_veh(Local_96.f_7[func_477()]), "GTAO_FM_Events_Soundset", 0, 0);
					...
					if (func_20(&uLocal_3607))
					{
						...
						else
						{
							...
							func_165(0, "UW_DEST", 0, 1, -1, 0, 2, 0, 6, 0, 0, 0, 6, 0, 0, 0);
							func_7();
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 11);
						}
					}
					if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
					{
						fVar0 = func_478(PLAYER::PLAYER_PED_ID(), Local_96.f_30[0 /*3*/], 1);
						if (fVar0 < 750f)
						{
							clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 10);
	...
	if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iVar1 > -1)
			{
				if (func_103(Local_96.f_7[iVar1]))
				{
					if (network_has_control_of_network_id(Local_96.f_7[iVar1]))
					{
						set_entity_invincible(net_to_veh(Local_96.f_7[iVar1]), false);
						set_vehicle_can_be_visibly_damaged(net_to_veh(Local_96.f_7[iVar1]), true);
						network_explode_vehicle(net_to_veh(Local_96.f_7[iVar1]), 1, 0, -1);
						func_23(&(Local_96.f_7[iVar1]));
					}
				}
			}
		...
		if (iVar0 == -1)
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar1]))
			{
				if (func_103(Local_96.f_7[iVar1]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iVar1])))
						{
							iVar0 = iVar1;
						}
					}
...
float func_478(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
		...
		if (Local_730[participant_id_to_int() /*18*/].f_17 == 1)
		{
			...
			if (func_482(iVar1))
			{
				if (iVar1 > -1)
				{
					...
					{
						fLocal_1318 = network_get_talker_proximity();
						network_set_talker_proximity(-1f);
						func_481(1, iVar1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 24);
						func_480(1);
					}
				}
			}
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 24);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 25);
			}
		}
	}
	if (!is_bit_set(iLocal_1307, 25))
	{
		if (is_bit_set(iLocal_1307, 24))
		{
			if (Local_730[participant_id_to_int() /*18*/].f_17 > 1)
			{
				network_set_talker_proximity(fLocal_1318);
				func_601(&iVar1, &uVar0);
				if (iVar1 > -1)
				{
					func_481(0, iVar1);
...
void func_480(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), 15);
	}
	else
	{
		clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 4);
	}
}
...
void func_481(int iParam0, int iParam1)
{
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		...
		{
			iVar1 = network_get_player_index(int_to_participantindex(iVar0));
			if (func_754(iVar1, 0, 1) && iVar1 != player_id())
			{
				if (is_bit_set(Local_730[iVar0 /*18*/].f_1, iParam1) || !iParam0)
				{
					_0x3039AE5AD2C9C0C4(iVar1, 1);
				}
				else if (iParam0)
				{
					_0x3039AE5AD2C9C0C4(iVar1, 0);
				}
			}
		}
		iVar0++;
	...
	while (iVar1 < _network_get_num_participants_host())
	{
		if (!iVar0)
		{
			if (network_is_participant_active(int_to_participantindex(iVar1)))
			{
				...
				{
					if (is_bit_set(Local_730[iVar1 /*18*/].f_1, iParam0))
					{
						iVar0 = true;
					}
				}
...
void func_483()
{
	...
	if (!is_bit_set(iLocal_1307, 15))
	{
		if (Local_730[participant_id_to_int() /*18*/].f_17 == 2)
		{
			if (Local_730[participant_id_to_int() /*18*/].f_1 == 0)
			{
					...
					if (func_385(0, 0, 1, 1))
					{
						if (!func_664())
						{
							if (Local_96.f_27 == joaat("rhino") || Local_96.f_27 == joaat("hydra"))
							{
								if (!func_664())
								{
									func_494("UW_START1P", get_player_name(Local_96.f_22[0]), 1, 30000);
								}
								else
								{
									func_494("UW_START1PC", get_player_name(Local_96.f_22[0]), 1, 30000);
								}
								func_383(1);
							}
							else if (is_bit_set(Local_96.f_15, false))
							{
						...
						else if (!is_bit_set(Global_1587523[player_id() /*444*/].f_250.f_7, 14))
						{
							if (!func_664())
							{
								func_384("UW_STARTM", 30000);
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 15);
					}
				}
			}
		}
		...
		if (Local_96.f_241 == 1)
		{
			if (Local_96.f_27 != joaat("hydra") && Local_96.f_27 != joaat("rhino"))
			{
				if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
				{
					if (iLocal_3573 >= 0)
					{
						if (!is_bit_set(iLocal_1308, 10))
						{
							if (!is_bit_set(iLocal_1308, 9))
							{
								if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iLocal_3573]))
								{
									if (func_103(Local_96.f_7[iLocal_3573]))
									{
										GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 9);
									}
								}
							}
							else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iLocal_3573]))
							{
								if (!func_103(Local_96.f_7[iLocal_3573]))
								{
									func_493("UW_TEAMV", 1);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 10);
								}
							}
						}
					}
	...
	if (!func_664())
	{
		...
		while (iVar1 < 4)
		{
			if (!is_bit_set(Local_96.f_3, 6))
			{
				if (!is_bit_set(iLocal_1307, 16 + iVar1))
				{
					if (Local_730[participant_id_to_int() /*18*/].f_17 >= 2)
					{
						if (Local_730[participant_id_to_int() /*18*/].f_1 == 0)
						{
							if ((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2))
							{
								if (network_does_network_id_exist(Local_96.f_7[0]))
								{
									if (func_103(Local_96.f_7[0]))
									{
										if (get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[0]), -1) != 0)
										{
											...
											GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 16 + iVar1);
										}
									}
								}
							}
...
int func_484(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	struct<16> Var1;
	int iVar17;
	...
	if (_0x9DE986FC9A87C474(player_id(), iParam1) || iParam4)
	{
		...
		add_text_component_substring_player_name(func_490(&Var1));
		if (!iParam5)
		{
...
void func_485(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_488() || !network_is_activity_session()) || !func_14(player_id(), 0))
	{
		return;
	}
...
int func_492(int iParam0, int iParam1)
{
	...
	iVar0 = func_25();
	iVar2 = iParam0 - 1;
	if (network_does_network_id_exist(Local_96.f_7[iParam1]))
	{
		if (func_103(Local_96.f_7[iParam1]))
		{
			iVar1 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iParam1]), iVar2);
			if (iVar1 != 0)
			{
				if (is_ped_a_player(iVar1))
				{
	...
	if (!is_bit_set(iLocal_1307, 9))
	{
		if (Local_96.f_241 == 1)
		{
			if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
			{
				...
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 9);
				}
			}
		}
	}
	if (!is_bit_set(iLocal_1307, 10))
	{
		if (is_bit_set(iLocal_1307, 9))
		{
			if (Local_730[participant_id_to_int() /*18*/].f_17 > 1)
			{
				if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
				{
					if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 10);
						}
					}
...
void func_496()
{
	if (is_bit_set(Global_2460486.f_4563, true))
	{
		clear_bit(&(Global_2460486.f_4563), true);
	}
...
void func_497()
{
	...
	if (Local_730[participant_id_to_int() /*18*/].f_1 != 0)
	{
		if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 8))
		{
			if (!is_bit_set(iLocal_1307, 26))
			{
				if ((((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2)) || (func_664() && is_bit_set(Local_96.f_3, 6))) || (func_664() && is_bit_set(Local_96.f_3, 15)))
				{
					...
					if (func_17(&uLocal_3626, 1000, 0))
					{
						...
						if (func_545())
						{
							...
							if (iVar25 > 0)
							{
								Local_713.f_6 += iVar25;
								if ((!Global_262145.f_9452 && !is_bit_set(Local_96.f_3, 8)) || (!Global_262145.f_9453 && is_bit_set(Local_96.f_3, 8)))
								{
									if (Local_713.f_6 > 0)
									{
										func_470(19, Local_713.f_6);
								...
								{
									_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar28);
								}
							}
							iVar23 = func_459(1);
							func_458();
							Local_713.f_7 += iVar23;
							func_413(0, PLAYER::PLAYER_PED_ID(), "", -1636175450, 153786435, iVar23, 1, -1, 0, 0);
							Local_713.f_5 = 2;
						...
						else if (!func_664())
						{
							...
							if (iVar25 > 0)
							{
								...
								{
									_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar33);
								}
							}
							iVar23 = func_459(1);
							iVar23 += func_533();
						...
						else if (func_532())
						{
							if (!func_531(1))
							{
								...
								if (iVar25 > 0)
								{
									...
									{
										_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar38);
									}
								}
								if (Local_96.f_27 == joaat("rhino") || Local_96.f_27 == joaat("hydra"))
								{
								...
								Local_713.f_7 += iVar23;
								func_458();
								func_413(0, PLAYER::PLAYER_PED_ID(), "", -875716015, 459130717, iVar23, 1, -1, 0, 0);
							}
							else
							{
								iVar25 = func_471(1);
								...
								while (iVar22 <= 3)
								{
									if (Local_96.f_465[iVar22 /*4*/].f_1 == Local_96.f_465[0 /*4*/].f_1)
									{
										...
										if (Local_96.f_27 == joaat("hydra") || Local_96.f_27 == joaat("rhino"))
										{
											...
											{
												if (Local_96.f_465[iVar22 /*4*/].f_2 != player_id())
												{
													if (network_is_player_active(int_to_playerindex(Local_96.f_465[iVar22 /*4*/].f_2)))
													{
														iVar9[iVar12] = int_to_playerindex(Local_96.f_465[iVar22 /*4*/].f_2);
														iVar12++;
													}
												}
											}
								...
								if (Local_96.f_27 == joaat("hydra") || Local_96.f_27 == joaat("rhino"))
								{
									...
									{
										func_530(67, "UW_DRAWP", get_player_name(iVar9[0]), 1, 15000, "UW_BIGO", 2);
									}
								}
								else if (iVar20 > 2)
								{
								...
								iVar26 = round(to_float(func_558(0)) / to_float(iVar20));
								iVar24 = round(to_float(func_533()) / to_float(iVar20));
								func_534(&iVar26, 1);
								iVar25 += iVar26;
								iVar23 += iVar24;
								Local_713.f_6 += iVar25;
								...
								if (iVar25 > 0)
								{
									...
									{
										_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar43);
									}
								}
								Local_713.f_7 += iVar23;
								func_458();
						...
						else
						{
							...
							if (iVar25 > 0)
							{
								...
								{
									_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar48);
								}
							}
							Local_713.f_7 += iVar23;
							func_458();
							...
							if (!func_531(0))
							{
								...
								if (Local_96.f_27 == joaat("hydra") || Local_96.f_27 == joaat("rhino"))
								{
									iVar8 = int_to_playerindex(Local_96.f_465[0 /*4*/].f_2);
									if (func_286(iVar8, 1))
									{
									...
									if (iVar8 != func_25())
									{
										if (!iVar52)
										{
											if (!func_664())
											{
												func_530(64, "UW_FWONP", get_player_name(iVar8), 6, 15000, "UW_BIGF", 2);
											}
											else
											{
												func_530(64, "UW_FWONPC", get_player_name(iVar8), 6, 15000, "UW_BIGF", 2);
											}
										}
										else if (!func_664())
										{
							...
							else
							{
								...
								if (Local_96.f_27 == joaat("hydra") || Local_96.f_27 == joaat("rhino"))
								{
									if (iVar20 == 2)
									{
										if (iVar9[0] != func_25() && network_is_player_active(iVar9[0]))
										{
											if (iVar9[1] != func_25() && network_is_player_active(iVar9[1]))
											{
												func_502(67, func_25(), func_25(), -1, "UW_DRAW2P", "UW_BIGF", func_291(), 15000, func_291(), get_player_name(iVar9[0]), get_player_name(iVar9[1]), 0);
											}
											else
											{
												iVar21 = true;
						...
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 13);
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 26);
					}
				}
				else if (is_bit_set(Local_96.f_3, 6) || (!func_664() && is_bit_set(Local_96.f_3, 15)))
				{
					if (Local_730[participant_id_to_int() /*18*/].f_10 != -1)
					{
						func_563(65, "UW_BIGO", "UW_ABAND", 1, 15000, 2);
					...
					if (iVar25 > 0)
					{
						...
						{
							_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar57);
						}
					}
					iVar23 = func_459(1);
					Local_713.f_7 += iVar23;
				...
				else if (is_bit_set(Local_96.f_3, 14))
				{
					func_582(0);
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 8);
					if (Local_730[participant_id_to_int() /*18*/].f_17 < 3)
					{
						Local_730[participant_id_to_int() /*18*/].f_17 = 3;
					}
				}
				else if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 11))
				{
					...
					if (iVar25 > 0)
					{
						...
						{
							_0xFB6DB092FBAE29E6(iVar25, "AM_KILL_LIST", &uVar62);
						}
					}
					iVar23 = func_459(1);
					Local_713.f_7 += iVar23;
				...
				else if (is_bit_set(Local_96.f_3, 12))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 8);
				}
			}
			if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 8))
			{
				if (is_bit_set(iLocal_1307, 26))
				{
					...
					if (!func_257("UW_EXPL") && !func_257("UW_EXPLC"))
					{
						if (Local_730[participant_id_to_int() /*18*/].f_9 > -1)
						{
							if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[Local_730[participant_id_to_int() /*18*/].f_9]))
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									if (func_103(Local_96.f_7[Local_730[participant_id_to_int() /*18*/].f_9]))
									{
										if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[Local_730[participant_id_to_int() /*18*/].f_9])))
										{
										}
									}
								}
	...
	else if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 8))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 8);
	}
}

bool func_498(auto uParam0, int iParam1)
{
	int iVar0;
	
	if ((*uParam0 > 0 && !func_327()) && !(func_228(player_id(), 0) && (func_220(player_id()) || func_218(player_id()))))
	{
		func_501();
	}
	switch (*uParam0)
	{
		case 0:
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 25);
				if (iParam1)
				{
...
void func_499()
{
	...
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_754(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out())
		{
...
int func_502(int iParam0, auto uParam1, auto uParam2, int iParam3, char* sParam4, char* sParam5, auto uParam6, int iParam7, auto uParam8, char* sParam9, char* sParam10, char* sParam11)
{
	struct<72> Var0;
...
void func_506(auto uParam0, int iParam1)
{
	if (func_332(*uParam0.f_1))
	{
		*uParam0.f_67 = 1;
...
int func_507(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_360(player_id()) || (func_520() && func_519()))
	{
		iVar0 = func_518();
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (is_ped_a_player(iVar0))
			{
				...
				{
					if (func_754(_network_get_ped_player(iVar0), 0, 1))
					{
						if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
						{
							...
							{
								return func_514(iParam0, _network_get_ped_player(iVar0), iParam1, iParam2, iParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && network_is_activity_session()) && iParam1 < 4)
	{
		...
		{
			return func_514(iParam0, player_id(), iParam1, iParam2, iParam3);
		}
	}
	return func_514(iParam0, player_id(), iParam1, iParam2, iParam3);
}
...
{
	return func_509(player_id(), iParam0, iParam1, iParam2);
}
...
int func_509(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_449(iVar0, iParam2, 0) && !is_bit_set(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_513(1);
...
int func_514(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_516(iParam1, iParam0, iVar0, 0) && !is_bit_set(Global_1617379.f_15, 18)) || ((func_449(get_player_team(iParam1), get_player_team(iParam0), 0) && is_bit_set(Global_1617379.f_15, 23)) && !is_bit_set(Global_1617379.f_15, 18)))
			{
				return func_513(1);
			}
			...
			{
				return func_509(iParam1, 1, iVar0, iParam4);
			}
		}
...
int func_517(int iParam0, int iParam1, int iParam2)
{
	...
	{
		iVar0 = func_509(iParam1, !iParam2, iParam0, 0);
	}
	return iVar0;
}
...
void func_521(auto uParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4)
{
...
int func_522(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	auto uVar0;
	auto uVar1;
	auto uVar2;
	...
	uVar1 = func_25();
	uVar2 = func_25();
	return func_523(iParam0, sParam1, sParam2, sParam3, uParam4, uVar0, uVar1, uVar2, sParam5, iParam6, iParam7, iParam8, iParam9, iParam10);
}

int func_523(auto uParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, char* sParam8, int iParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	struct<72> Var0;
...
char* func_524(int iParam0)
{
	...
	if (iParam0 == player_id())
	{
		sVar0 = func_527(&(Global_1610316[iParam0 /*174*/].f_10.f_74));
		return sVar0;
	}
	if (((func_219(iParam0, 28) || func_219(player_id(), 28)) || func_526(iParam0)) && !func_525(iParam0))
	{
	...
	if (iVar1 != func_25())
	{
		sVar0 = func_527(&(Global_1610316[iVar1 /*174*/].f_10.f_74));
...
void func_528(int iParam0)
{
	if (iParam0)
	{
		if (func_529(1))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573907, true);
		}
	}
	else if (func_529(2))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573907, 2);
	}
}
...
bool func_529(int iParam0)
{
	...
	if (iParam0 == 0)
	{
		if ((is_bit_set(iVar0, false) && is_bit_set(iVar0, true)) && is_bit_set(iVar0, 2))
		{
			return false;
		}
	}
...
int func_533()
{
	if (!func_664())
	{
		return round(to_float(Global_262145.f_9202) * Global_262145.f_9391);
	}
	if ((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2))
	{
		return round(to_float(Global_262145.f_9263) * Global_262145.f_9393);
	}
	if (is_bit_set(Local_96.f_3, 6))
	{
		return round(to_float(Global_262145.f_9263) * Global_262145.f_9393);
...
void func_534(int iParam0, int iParam1)
{
	...
	if (*iParam0 > 0)
	{
		if (!func_544())
		{
			if (func_543(0))
			{
				if (network_is_player_active(func_542()))
				{
					if (func_541() == 100)
					{
						iVar0 = *iParam0;
...
void func_535(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_754(iParam0, 0, 1))
	{
		...
		Var0.f_2 = iParam1;
		Var0.f_3 = iParam2;
		trigger_script_event(1, &Var0, 5, func_536(iParam0));
	}
}

auto func_536(int iParam0)
{
	auto uVar0;
...
int func_538(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	struct<16> Var1;
	...
	if (_0x9DE986FC9A87C474(player_id(), iParam1) || iParam5)
	{
		...
		_set_notification_text_entry(sParam0);
		_0x39BBF623FC803EAC(func_507(iParam1, -2, 1, 0));
		add_text_component_substring_player_name(func_490(&Var1));
		if (!iParam3 == 0)
		{
...
{
	return func_286(player_id(), iParam0);
}
...
bool func_545()
{
	...
	if (!is_bit_set(Local_96.f_3, 6) && !is_bit_set(Local_96.f_3, 15))
	{
		return false;
	}
	iVar0 = 0;
...
void func_546()
{
	...
	while (iVar0 < 5)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_73[iVar0]))
		{
...
bool func_547(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)
{
...
int func_548()
{
	return is_bit_set(Global_1573883.f_1, false);
}
...
void func_552(char* sParam0, char* sParam1, int iParam2)
{
	if ((!is_bit_set(Global_1573883.f_1, 2) && !func_196(player_id())) && !func_195(player_id()))
	{
		if (is_string_null_or_empty(sParam0))
		{
			sParam0 = "FMEVEN_NUM1";
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 2);
	}
}
...
int func_555()
{
	return is_bit_set(Global_2460486.f_1641, 11);
}
...
bool func_556()
{
	if (iLocal_3573 > -1)
	{
		if (func_103(Local_96.f_7[iLocal_3573]))
		{
			if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iLocal_3573])))
			{
				return true;
			}
		}
...
int func_557(char* sParam0, char* sParam1, int iParam2)
{
...
int func_558(int iParam0)
{
	if (!func_664())
	{
		return round(to_float(Global_262145.f_9201) * Global_262145.f_9390);
	}
	if (iParam0)
	{
		return round(to_float(Global_262145.f_9262) * Global_262145.f_9392);
	}
	if ((is_bit_set(Local_96.f_3, false) && is_bit_set(Local_96.f_3, true)) && is_bit_set(Local_96.f_3, 2))
	{
		return round(to_float(Global_262145.f_9262) * Global_262145.f_9392);
...
void func_560(int iParam0)
{
	if (func_232())
	{
		...
		if ((!network_is_activity_session() && !func_561()) && !func_238(player_id()))
		{
			Global_978142 = 0;
		}
...
void func_564(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), 4);
	}
	else
	{
		clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 4);
...
void func_565(int iParam0)
{
	...
	if (get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 5) != 0)
	{
		set_ped_reset_flag(PLAYER::PLAYER_PED_ID(), 177, true);
		set_player_parachute_tint_index(player_id(), func_249(578, -1, 0));
		if (func_581())
		{
		...
		set_player_parachute_pack_tint_index(player_id(), func_576(get_player_ped(player_id()), iVar0));
		if (func_543(0))
		{
			set_player_parachute_tint_index(player_id(), func_249(578, -1, 0));
		}
		...
		{
			set_player_parachute_tint_index(player_id(), func_575(Global_2467475));
		}
		func_574(player_id(), iVar0);
		set_player_parachute_variation_override(player_id(), 5, func_570(PLAYER::PLAYER_PED_ID(), iVar0), func_569(PLAYER::PLAYER_PED_ID(), iVar0), 0);
		func_568(func_249(2032, -1, 0), 1);
		Global_2460486.f_273 = 1;
		func_566(player_id(), -1, -1);
		if (iParam0)
		{
		}
	}
...
void func_566(int iParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		set_player_parachute_variation_override(iParam0, 5, func_570(get_player_ped(iParam0), iParam2), func_569(get_player_ped(iParam0), iParam2), 0);
		func_574(iParam0, iParam2);
		set_player_parachute_pack_tint_index(iParam0, func_576(get_player_ped(iParam0), iParam2));
		set_ped_component_variation(get_player_ped(iParam0), 5, func_570(get_player_ped(iParam0), iParam2), func_569(get_player_ped(iParam0), iParam2), func_576(get_player_ped(iParam0), iParam2));
		if (iParam1 == -1)
		{
			iParam1 = func_249(578, -1, 0);
		}
		if (func_543(1) && func_567(player_id()))
		{
			set_player_parachute_tint_index(player_id(), func_575(Global_2467475));
		}
		else
		...
		if (func_581())
		{
			set_player_parachute_model_override(iParam0, 1931904776);
		}
		else if (func_580())
		{
			set_player_parachute_model_override(iParam0, -2124524821);
		}
		set_ped_reset_flag(get_player_ped(iParam0), 177, true);
	}
}
...
void func_568(int iParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		set_player_parachute_variation_override(player_id(), 5, func_570(PLAYER::PLAYER_PED_ID(), iParam0), func_569(PLAYER::PLAYER_PED_ID(), iParam0), 0);
		func_574(player_id(), iParam0);
		set_player_parachute_pack_tint_index(player_id(), func_576(PLAYER::PLAYER_PED_ID(), iParam0));
		if ((iParam1 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && get_ped_drawable_variation(PLAYER::PLAYER_PED_ID(), 5) != 0)
		{
			func_566(player_id(), -1, -1);
		}
	}
...
int func_570(int iParam0, int iParam1)
{
	...
	if (iVar0 > 15)
	{
		...
		else if (_0x341DE7ED1D2A1BFD(iVar5, 1536649085, 0))
		{
			iVar6 = func_573(iVar5, 0);
			if (iVar2 == joaat("mp_m_freemode_01"))
			{
				switch (iVar6)
				{
...
void func_582(int iParam0)
{
	if (iParam0)
	{
		if (!is_bit_set(Global_2460486.f_1641, 11))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1641), 11);
		}
	}
	else if (is_bit_set(Global_2460486.f_1641, 11))
	{
		clear_bit(&(Global_2460486.f_1641), 11);
	}
}
...
void func_583(int iParam0)
{
	if (iParam0)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_1641), 9);
		}
	}
...
void func_585(int iParam0)
{
	...
	if (iParam0)
	{
		...
		if (func_248(0))
		{
			...
			clear_bit(&uVar0, false);
			func_587();
		}
		if (func_248(func_200(func_184(player_id()))))
		{
			uVar0 = func_249(2458, -1, 0);
			clear_bit(&uVar0, func_200(func_184(player_id())));
			func_587();
		}
		if (func_586())
		{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), 7);
		}
	}
	else
	{
		clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 7);
	}
}
...
void func_588(int iParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	...
	Global_2460486.f_4573 = -1;
	iVar0 = (func_228(player_id(), 0) && func_220(player_id()));
	if (iParam6)
	{
		func_597(21, 1);
	}
	else
	{
		...
		if (func_196(player_id()))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 5);
		}
		if ((func_232() && !func_227()) || func_197(player_id(), 21))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 4);
		}
		clear_bit(&(Global_1573883.f_1), 17);
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 20);
		if (func_595(iParam0))
		{
			func_594();
		}
	...
	if (!iVar0)
	{
		...
		if (func_592(iParam0))
		{
			...
			set_player_wanted_level(player_id(), 0, 0);
			set_player_wanted_level_now(player_id(), 0);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 8);
		}
		if (iParam3)
		{
			func_407(1);
			if (func_529(0))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 9);
			}
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 14);
		}
		if (iParam4)
		{
			func_405(1);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 12);
		}
		if (iParam5)
		{
			func_591();
		...
		if (!iParam6)
		{
			if (func_589(iParam0))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 21);
			}
		}
	}
	Global_2459366 = 1;
...
void func_591()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4564), false);
}
...
void func_594()
{
	...
	clear_bit(&(Global_2460486.f_4420), true);
}
...
void func_596(int iParam0, int iParam1)
{
	...
	if (iParam0 != -1 || iParam1 != -1)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), 2);
		}
		else
		{
			clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 2);
		}
	}
}
...
bool func_599()
{
	...
	iVar1 = _get_vehicle_model_max_number_of_passengers(joaat("valkyrie"));
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar4 = get_ped_in_vehicle_seat(iVar0, iVar2);
		if (iVar4 != 0)
		{
...
void func_600(int iParam0)
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			set_entity_invincible(iVar0, iParam0);
			set_vehicle_can_be_visibly_damaged(iVar0, !iParam0);
		}
	}
}

void func_601(int iParam0, auto uParam1)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_1, iVar0))
		{
			*iParam0 = iVar0;
...
void func_604(int iParam0)
{
	...
	if (iParam0)
	{
		Global_2445386 = func_184(player_id());
		if (Global_2445386 == -1)
		{
		...
		if (func_248(0))
		{
			uVar1 = func_249(2458, -1, 0);
			clear_bit(&uVar1, false);
			func_587();
		}
		if (func_248(func_200(func_184(player_id()))))
		{
			uVar1 = func_249(2458, -1, 0);
			clear_bit(&uVar1, func_200(func_184(player_id())));
			func_587();
		}
		if (func_586())
		{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), false);
	}
	else
	{
		...
		clear_bit(&(Global_1610316[player_id() /*174*/].f_1), false);
	}
}
...
int func_607(int iParam0)
{
	...
	if (func_621())
	{
		if (network_is_activity_session() || (func_620() || func_618()))
		{
			Global_2443089 = 1;
		}
	}
...
void func_610(auto uParam0, int iParam1)
{
	func_611(uParam0, iParam1);
}

void func_611(auto uParam0, auto uParam1)
{
...
bool func_612()
{
	if (((Global_1573854 || Global_1573825) || func_14(player_id(), 0)) || func_520())
	{
		return true;
	}
	return false;
...
int func_617(auto uParam0, int iParam1)
{
...
int func_621()
{
	return is_bit_set(Global_1312423, false);
}
...
void func_628(int iParam0)
{
	...
	{
		case 1:
			if (!is_bit_set(iLocal_1307, false))
			{
				if ((((func_630(60000) && !is_help_message_being_displayed()) && !func_368()) && !is_pause_menu_active()) && func_385(0, 1, 1, 1))
				{
					if (!func_664())
					{
					...
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, false);
				}
			}
			break;
	}
...
void func_631()
{
	...
	if (is_bit_set(iLocal_1308, 15))
	{
		if (!is_bit_set(Global_1573883.f_1, 15))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 15);
		}
	}
	else if (is_bit_set(Global_1573883.f_1, 15))
	{
		clear_bit(&(Global_1573883.f_1), 15);
	}
}
...
void func_632(int iParam0)
{
	...
	if (network_does_network_id_exist(Local_96.f_7[iParam0]))
	{
		if (!is_vehicle_driveable(net_to_veh(Local_96.f_7[iParam0]), 0))
		{
			if (Local_96.f_241 == 0)
			{
			}
		}
		if (!is_entity_dead(net_to_veh(Local_96.f_7[iParam0]), 0))
		{
			if (!func_194())
			{
				if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_1, iParam0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (!is_bit_set(iLocal_1308, 15))
						{
							if (get_vehicle_ped_is_using(PLAYER::PLAYER_PED_ID()) == net_to_veh(Local_96.f_7[iParam0]))
							{
								GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 15);
							}
						}
						if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iParam0]), 0))
						{
							...
							iVar0 = func_635(PLAYER::PLAYER_PED_ID(), 0);
							if (func_557("UW_HELP1", func_559(), func_558(1)) || func_557("UW_HELP1C", func_559(), func_558(1)))
							{
								clear_help(1);
							}
							...
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 0 + iVar0 + 1);
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_1), iParam0);
							Local_730[participant_id_to_int() /*18*/].f_9 = iParam0;
						...
						{
							if (!is_bit_set(iLocal_1307, true))
							{
								if (get_player_wanted_level(player_id()) == 0)
								{
									if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(net_to_veh(Local_96.f_7[iParam0]), 1)) < 2500f)
									{
										if (func_385(0, 1, 1, 1))
										{
											if (!func_664())
											...
											func_383(1);
											GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, true);
										}
									}
								}
							}
							if (!func_232())
							{
								if (is_bit_set(iLocal_1308, 2))
								{
									clear_bit(&iLocal_1308, 2);
								}
								if (get_player_wanted_level(player_id()) > 0)
								{
									if (!is_bit_set(iLocal_1307, 4))
									{
										if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 12))
										{
											GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 12);
										}
										if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
										{
											if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(net_to_veh(Local_96.f_7[iParam0]), 1)) < 2500f)
											{
												if (func_385(0, 1, 1, 1))
												{
													...
													func_383(1);
													GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 4);
												}
											}
										}
									}
									else if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(net_to_veh(Local_96.f_7[iParam0]), 1)) > 10000f)
									{
										clear_bit(&iLocal_1307, 4);
									}
								}
								else
								{
									...
									if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 12))
									{
										clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 12);
									}
								}
							}
							else
								...
								if (!is_bit_set(iLocal_1308, 2))
								{
									if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(net_to_veh(Local_96.f_7[iParam0]), 1)) < 2500f)
									{
										if (func_385(0, 1, 1, 1))
										{
											...
											func_383(1);
											GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 2);
										}
									}
								}
							}
				...
				{
					if (Local_730[participant_id_to_int() /*18*/].f_17 == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iParam0]), 0))
							{
								...
								{
									if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 0 + iVar2))
									{
										func_7();
										clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 0 + iVar2);
									}
									iVar2++;
								}
								if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_1, iParam0))
								{
									clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_1), iParam0);
								}
								if (Local_730[participant_id_to_int() /*18*/].f_9 != -1)
								{
									Local_730[participant_id_to_int() /*18*/].f_9 = -1;
								}
							...
							{
								if (Local_96.f_241 == 0 && !is_bit_set(Local_96.f_3, 4))
								{
									iVar0 = func_635(PLAYER::PLAYER_PED_ID(), 0);
									if (Local_96.f_463 != -1)
									{
									...
									{
										clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_1), iParam0);
										clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_2), 0 + iLocal_3636 + 1);
									}
								}
								iVar1 = false;
								if (func_250())
								...
								func_633(iVar1);
								if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iParam0])) == joaat("rhino"))
								{
									unk_0x32CAEDF24A583345(net_to_veh(Local_96.f_7[iParam0]));
								}
								...
								{
									if (is_bit_set(Local_96.f_3, 9) || !func_664())
									{
										if (func_598("UW_MINV"))
										{
										}
										if (!is_bit_set(iLocal_1307, 5))
										{
											if (Local_96.f_28 > 1 || (Local_96.f_28 == 1 && func_106() > 1))
											{
												if (func_20(&(Local_96.f_326)))
												{
													if (!is_help_message_being_displayed())
													{
														...
														func_383(1);
														GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 5);
													}
												}
											}
										}
									...
									else if (func_664())
									{
										if (!is_bit_set(Local_96.f_3, 9))
										{
											if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iParam0])) != joaat("valkyrie"))
											{
												if (!is_bit_set(iLocal_1307, 14))
												{
													if (!is_help_message_being_displayed())
													{
														func_384("UW_MINV", 30000);
														func_383(1);
														GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 14);
													}
												}
											}
										}
					...
					if (Local_96.f_241 == 0)
					{
						if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_7[iParam0])) == joaat("valkyrie"))
						{
							if (!func_598("UW_VALK") && !func_598("UW_VALKC"))
							{
								...
								if (is_bit_set(iLocal_1307, 8))
								{
									clear_bit(&iLocal_1307, 8);
								}
							}
							if (!is_bit_set(iLocal_1307, 8))
							{
								...
								{
									iVar6 = 0;
									iVar4 = get_vehicle_max_number_of_passengers(net_to_veh(Local_96.f_7[iParam0])) + 1;
									iVar5 = 0;
									while (iVar5 < iVar4)
									{
										if (!is_vehicle_seat_free(net_to_veh(Local_96.f_7[iParam0]), iVar5 - 1))
										{
											iVar6++;
										}
										iVar5++;
									...
									if (iVar6 == 1)
									{
										...
										func_383(1);
										GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 8);
									}
									if (!is_bit_set(iLocal_1307, 8))
									{
										if (func_664())
											...
											while (iVar7 < 4)
											{
												if (!iVar8)
												{
													if (iVar7 != iParam0)
													{
														iVar5 = 0;
														iVar6 = 0;
														if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar7]))
														{
															if (func_103(Local_96.f_7[iVar7]))
															{
																...
																while (iVar5 < iVar4)
																{
																	if (!is_vehicle_seat_free(net_to_veh(Local_96.f_7[iVar7]), iVar5 - 1))
																	{
																		iVar6++;
																	}
																	iVar5++;
					...
					if (Local_96.f_241 == 1)
					{
						if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_1, iParam0))
						{
							if (!is_bit_set(iLocal_1307, 6))
							{
								if (func_103(Local_96.f_7[iParam0]))
								{
									if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
									{
										if (is_ped_sitting_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iParam0])))
										{
											if (!is_bit_set(iLocal_1307, 7))
											{
												if ((is_control_just_pressed(0, 75) || is_control_pressed(0, 75)) || is_disabled_control_pressed(0, 75))
												{
													GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 7);
												}
											}
											if (is_bit_set(iLocal_1307, 7))
											{
												if (!is_help_message_being_displayed())
												{
													...
													func_383(1);
													GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 6);
												}
											}
										}
									}
			...
			else
			{
				...
				while (iVar10 < 4)
				{
					if (network_does_network_id_exist(Local_96.f_7[iVar10]))
					{
						if (is_vehicle_driveable(net_to_veh(Local_96.f_7[iVar10]), 0))
						{
							if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), net_to_veh(Local_96.f_7[iVar10]), 0))
							{
								iVar11 = true;
							}
						}
							...
							if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(net_to_veh(Local_96.f_7[iParam0]), 1)) < 2500f)
							{
								if (func_385(0, 1, 1, 1))
								{
									if (!func_240(129, 0, 0))
									{
										...
										func_383(1);
										GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 14);
									}
									else
									{
										if (!func_664())
			...
			if (func_754(player_id(), 1, 1) && Local_730[participant_id_to_int() /*18*/].f_1 != 0)
			{
				if (!is_bit_set(Global_2460486.f_4430, true))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2460486.f_4430), true);
				}
			}
...
int func_636(char* sParam0, char* sParam1)
{
	_0x0A24DA3A41B718F5(sParam0);
	_add_text_component_item_string(sParam1);
	return _0x10BDDBFC529428DD(0);
...
void func_637()
{
	...
	while (iVar0 < 4)
	{
		if (network_does_network_id_exist(Local_96.f_7[iVar0]) && network_has_control_of_network_id(Local_96.f_7[iVar0]))
		{
			iVar1 = net_to_veh(Local_96.f_7[iVar0]);
...
void func_638(Vector3 vParam0)
{
	Global_2391046 = {vParam0};
	Global_2391049 = 1;
}
...
void func_641(int iParam0)
{
	...
	{
		iVar6 = vVar0.z;
		if (!network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_73[iVar6]))
		{
			return;
		}
		if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_6, iVar6))
		{
			if (!is_bit_set(Local_96.f_271, iVar6))
			{
				if (func_94(iVar6))
				{
					if (!is_entity_dead(net_to_veh(Local_96.f_73[iVar6]), 0))
					{
						if (_0x4CACA84440FA26F6(player_id(), net_to_veh(Local_96.f_73[iVar6]), &uVar5))
						{
							iVar8 = true;
						}
					}
					else if (unk_0x83660B734994124D(player_id(), net_to_veh(Local_96.f_73[iVar6]), &uVar5))
					{
						iVar8 = true;
					}
				}
				else if (!func_664())
				{
					if (Local_96.f_465[0 /*4*/].f_1 > 0)
					{
						iVar9 = int_to_playerindex(Local_96.f_465[0 /*4*/].f_2);
						if (iVar9 != func_25())
						{
							if (iVar9 == player_id())
							{
					...
					else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[0]))
					{
						if (func_103(Local_96.f_7[0]))
						{
							iVar11 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[0]), -1);
							if (iVar11 != 0)
							{
								if (is_ped_a_player(iVar11))
								{
									iVar10 = _network_get_ped_player(iVar11);
									if (iVar10 == player_id())
									{
										iVar8 = true;
									}
		...
		if (iVar8)
		{
			...
			{
				iVar4 = func_646();
				iVar12 = ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iVar6]));
				iVar7 = iVar6 * 4;
				if (func_645(iVar12))
				{
					...
					{
						if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar14]) && !is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar14)], func_84(iVar14)))
						{
							iVar13++;
							GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar14)]), func_84(iVar14));
						}
						iVar14++;
					}
					Local_730[participant_id_to_int() /*18*/].f_8 += iVar13;
					iVar4 *= iVar13;
				}
				else
				{
					Local_730[participant_id_to_int() /*18*/].f_8++;
				}
				if (Local_713.f_11 == 0)
				{
					Local_713.f_11 = _get_posix_time();
				}
				if (Local_730[participant_id_to_int() /*18*/].f_8 <= func_644())
				{
					Local_713.f_7 += iVar4;
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_6), iVar6);
		}
	}
}
...
auto func_643(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	return func_424(iParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7);
}
			...
			if (!is_bit_set(Local_96.f_271, iVar6))
			{
				...
				if (iVar8)
				{
					if (Local_730[participant_id_to_int() /*18*/].f_17 < 2)
					{
						...
						{
							if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar12]) && !is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar12)], func_84(iVar12)))
							{
								iVar13++;
								GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar12)]), func_84(iVar12));
							}
							iVar12++;
						}
						Local_730[participant_id_to_int() /*18*/].f_8 += iVar13;
...
bool func_649(int iParam0)
{
	...
	if (Local_730[participant_id_to_int() /*18*/].f_11[iParam0] == 0)
	{
		return false;
	}
	iVar0 = false;
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			{
				if (Local_730[iVar0 /*18*/].f_11[iParam0] > Local_730[participant_id_to_int() /*18*/].f_11[iParam0])
				{
					return false;
				}
			}
...
void func_650(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &vVar0, 3))
	{
		if (network_get_host_of_script("am_kill_list", -1, 0) != func_25())
		{
		}
		if (network_is_host_of_this_script())
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_96.f_464), vVar0.z);
		}
	}
}
...
void func_651(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &vVar0, 3))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&uLocal_3580, vVar0.z);
	}
}
...
void func_652(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &vVar0, 3))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&uLocal_3581, vVar0.z);
	}
}
...
void func_653(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &vVar0, 3))
	{
		if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(vVar0.z)], func_84(vVar0.z)))
		{
			clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(vVar0.z)]), func_84(vVar0.z));
		}
	}
}
...
void func_654(int iParam0)
{
	...
	{
		iVar3 = vVar0.z;
		if (is_bit_set(Local_730[participant_id_to_int() /*18*/].f_6, iVar3))
		{
			clear_bit(&(Local_730[participant_id_to_int() /*18*/].f_6), iVar3);
		}
	}
}
...
void func_655(int iParam0)
{
	...
	if (get_event_data(1, iParam0, &Var0, 10))
	{
		...
		while (iVar10 < 5)
		{
			if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_6, iVar10))
			{
				if (!is_bit_set(Local_96.f_271, iVar10))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Var0))
					{
						if (is_entity_a_vehicle(Var0))
						{
							if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_73[iVar10]))
							{
								if (ENTITY::DOES_ENTITY_EXIST(net_to_veh(Local_96.f_73[iVar10])))
								{
									if (get_vehicle_index_from_entity_index(Var0) == net_to_veh(Local_96.f_73[iVar10]))
									{
										if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
										{
											if (is_entity_a_ped(Var0.f_1))
											{
												if (get_ped_index_from_entity_index(Var0.f_1) == PLAYER::PLAYER_PED_ID())
												{
													if (Var0.f_3)
													{
														iVar13 = ENTITY::GET_ENTITY_MODEL(Var0);
														if (Local_96.f_27 == joaat("hydra"))
														{
															if (Local_730[participant_id_to_int() /*18*/].f_17 < 2)
															{
																...
																if (func_645(iVar13))
																{
																	...
																	Local_730[participant_id_to_int() /*18*/].f_8 += iVar11;
																	iVar16 *= iVar11;
																}
																else
																{
																...
																if (Local_730[participant_id_to_int() /*18*/].f_8 <= func_644())
																{
																	Local_713.f_7 += iVar16;
																	func_643(0, "", -875716015, 153786435, iVar16, 1, -1, 0);
																	func_642();
																}
															}
															GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_6), iVar10);
														}
														else if (iVar13 == joaat("buzzard"))
														{
															...
															while (iVar18 <= 3)
															{
																iVar15 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_73[iVar10]), iVar18);
																if (iVar15 != 0)
																{
																	iVar17 = func_656(iVar15);
																	if (iVar17 > -1)
																	{
																		if (!is_bit_set(Local_96.f_272[func_85(iVar17)], func_84(iVar17)))
																		{
																			if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar17)], func_84(iVar17)))
																			{
																				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar17)]), func_84(iVar17));
																				iVar16 = func_646();
																				Local_730[participant_id_to_int() /*18*/].f_8++;
																				if (Local_730[participant_id_to_int() /*18*/].f_8 <= func_644())
																				{
																				...
																				if (does_ped_have_ai_blip(net_to_ped(Local_96.f_48[iVar17])))
																				{
		...
		if (Local_96.f_27 != joaat("hydra"))
		{
			...
			while (iVar10 <= 19)
			{
				if (!is_bit_set(Local_96.f_272[func_85(iVar10)], func_84(iVar10)))
				{
					if (!is_bit_set(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar10)], func_84(iVar10)))
					{
						if (ENTITY::DOES_ENTITY_EXIST(Var0))
						{
							if (is_entity_a_ped(Var0))
							{
								if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar10]))
								{
									if (ENTITY::DOES_ENTITY_EXIST(net_to_veh(Local_96.f_48[iVar10])))
									{
										if (get_ped_index_from_entity_index(Var0) == net_to_ped(Local_96.f_48[iVar10]))
										{
											if (Var0.f_3)
											{
												if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
												{
													if (is_entity_a_ped(Var0.f_1))
													{
														iVar14 = get_ped_index_from_entity_index(Var0.f_1);
														if (is_ped_a_player(iVar14))
														{
															if (iVar14 == PLAYER::PLAYER_PED_ID())
															{
																if (Var0.f_3)
																{
																	iVar16 = func_646();
																	...
																	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar10)]), func_84(iVar10));
																}
															}
														}
													}
														...
														if (Var0.f_3)
														{
															if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
															{
																if (is_entity_a_ped(Var0.f_1))
																{
																		...
																		if (iVar14 == PLAYER::PLAYER_PED_ID())
																		{
																			if (Var0.f_3)
																			{
																				if (Local_730[participant_id_to_int() /*18*/].f_17 < 2)
																				{
																					...
																					iVar19 = iVar10 * 4;
																					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar19)]), func_84(iVar19));
																					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar19 + 1)]), func_84(iVar19 + 1));
																					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar19 + 2)]), func_84(iVar19 + 2));
																					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_3[func_85(iVar19 + 3)]), func_84(iVar19 + 3));
																					GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_6), iVar10);
																				}
																			}
																		}
																	...
																	else if (unk_0x83660B734994124D(iVar20, Var0, &uVar21))
																	{
																		if (iVar20 == player_id())
																		{
																			if (Local_730[participant_id_to_int() /*18*/].f_17 < 2)
															...
															if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1))
															{
																if (is_entity_a_ped(Var0.f_1))
																{
																	...
																	if (is_ped_a_player(iVar14))
																	{
																		if (iVar14 == PLAYER::PLAYER_PED_ID())
																		{
																			iVar12 = _get_posix_time();
																			Local_730[participant_id_to_int() /*18*/].f_11[iVar10] = iVar12;
																		}
																	}
																}
															}
			...
			while (iVar10 <= 23)
			{
				...
				else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar10]))
				{
				}
				iVar10++;
			}
...
int func_656(int iParam0)
{
	...
	while (iVar1 < 24)
	{
		if (iVar0 == -1)
		{
			if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar1]))
			{
				if (net_to_ped(Local_96.f_48[iVar1]) == iParam0)
				{
					iVar0 = iVar1;
				}
			}
...
void func_657()
{
	...
	if (Local_96.f_27 != joaat("hydra"))
	{
		...
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iLocal_3638]))
		{
			if (!func_30(Local_96.f_48[iLocal_3638]))
			{
				iVar0 = unk_0x815F18AD865F057F(net_to_ped(Local_96.f_48[iLocal_3638]));
				if (iLocal_3639[iLocal_3638] != iVar0)
				{
					iLocal_3639[iLocal_3638] = iVar0;
					activate_damage_tracker_on_network_id(Local_96.f_48[iLocal_3638], 1);
				}
			}
		}
		iLocal_3638++;
	...
	if (Local_96.f_27 != joaat("hydra") && Local_96.f_27 != joaat("rhino"))
	{
		if (!iLocal_3671)
		{
			if (func_92() == 5)
			{
				...
				while (iVar1 < 5)
				{
					if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_73[iVar1]))
					{
						if (func_103(Local_96.f_73[iVar1]))
						{
							if (ENTITY::GET_ENTITY_MODEL(net_to_veh(Local_96.f_73[iVar1])) == joaat("savage"))
							{
								activate_damage_tracker_on_network_id(Local_96.f_73[iVar1], 1);
								iLocal_3671 = true;
							}
						}
					}
	...
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_73[iLocal_3664]))
	{
		if (func_103(Local_96.f_73[iLocal_3664]))
		{
			iVar0 = unk_0x815F18AD865F057F(net_to_ped(Local_96.f_73[iLocal_3664]));
			if (iLocal_3665[iLocal_3664] != iVar0)
			{
				iLocal_3665[iLocal_3664] = iVar0;
				if (!iLocal_3671)
				{
					activate_damage_tracker_on_network_id(Local_96.f_73[iLocal_3664], 1);
				}
			}
		}
	}
...
void func_658()
{
	...
	while (iVar0 < 24)
	{
		if (is_bit_set(iLocal_3582, iVar0))
		{
			if (Local_96.f_85[iVar0] != 2)
			{
				clear_bit(&iLocal_3582, iVar0);
			}
		}
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_48[iVar0]))
		{
			...
			if (!func_30(Local_96.f_48[iVar0]))
			{
				...
				{
					case 1:
						if (network_has_control_of_network_id(Local_96.f_48[iVar0]))
						{
							if (is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar0]), 0))
							{
								iVar2 = get_vehicle_ped_is_in(net_to_ped(Local_96.f_48[iVar0]), 0);
								iVar1 = ENTITY::GET_ENTITY_MODEL(iVar2);
								if (is_this_model_a_heli(iVar1))
								{
									if (get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 1 && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 0)
									{
										if (get_ped_in_vehicle_seat(iVar2, -1) == net_to_ped(Local_96.f_48[iVar0]))
										{
											iVar9 = func_26();
											if (iVar9 != func_25())
											{
												iVar10 = get_player_ped(iVar9);
												if (!PED::IS_PED_INJURED(iVar10))
												{
													if (func_24(iVar2, iVar10, 1) > 250f)
													{
														vVar3 = {get_entity_coords(iVar10, 1)};
														task_heli_mission(net_to_ped(Local_96.f_48[iVar0]), iVar2, false, iVar10, vVar3, 4, 50f, 5f, -1f, 0, 100, -1f, 4096);
													}
												}
											}
										}
								...
								else if (is_this_model_a_plane(iVar1))
								{
									...
									if ((get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 1 && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 0) || ((iVar15 && iVar14 < 5) && iLocal_1309[iVar14] != Local_96.f_110[iVar14]))
									{
										if (get_ped_in_vehicle_seat(iVar2, -1) == net_to_ped(Local_96.f_48[iVar0]))
										{
											...
											if (iVar13 > -1)
											{
												...
												if (iVar9 != func_25())
												{
													...
													{
														vVar3 = {get_entity_coords(iVar10, 1)};
														task_plane_mission(net_to_ped(Local_96.f_48[iVar0]), iVar2, false, iVar10, vVar3, 4, 50f, 5f, -1f, 100, 50);
								...
								else if (((get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 1 && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1273030092) != 0) && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), 1306903184) != 0) && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), 1306903184) != 1)
								{
									if (get_ped_in_vehicle_seat(iVar2, -1) == net_to_ped(Local_96.f_48[iVar0]))
									{
										iVar9 = func_26();
										if (iVar9 != func_25())
										{
											...
											if (!PED::IS_PED_INJURED(iVar10))
											{
												...
												if (fVar11 > 500f)
												{
													task_go_to_coord_any_means_extra_params_with_cruise_speed(net_to_ped(Local_96.f_48[iVar0]), get_entity_coords(iVar10, 1), 2f, iVar2, 1, 786469, -1f, 0f, 20f, 0, 30f, 4f);
												}
												else if (fVar11 > 250f)
												{
													task_vehicle_mission_ped_target(net_to_ped(Local_96.f_48[iVar0]), iVar2, iVar10, 4, 30f, 786469, 5f, 5f, 1);
												}
											}
										}
									}
					...
					case 2:
						if (network_has_control_of_network_id(Local_96.f_48[iVar0]))
						{
							if (!func_21())
							{
								if (get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1442466670) != 1 && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -1442466670) != 0)
								{
									if (is_ped_in_any_vehicle(net_to_ped(Local_96.f_48[iVar0]), 0))
									{
										if (!is_bit_set(iLocal_3582, iVar0))
										{
											iVar12 = func_661(net_to_ped(Local_96.f_48[iVar0]), 1133084672);
											if (iVar12 > -1)
											{
												task_combat_hated_targets_around_ped(net_to_ped(Local_96.f_48[iVar0]), 299f, 0);
											}
											else if (!is_bit_set(iLocal_3582, iVar0))
											{
												func_660(iVar0, func_98(1));
												GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_3582, iVar0);
											}
										}
									}
									else
					...
					case 3:
						if (get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -251125078) != 1 && get_script_task_status(net_to_ped(Local_96.f_48[iVar0]), -251125078) != 0)
						{
							vVar6 = {func_659()};
							clear_ped_tasks(net_to_ped(Local_96.f_48[iVar0]));
							set_blocking_of_non_temporary_events(net_to_ped(Local_96.f_48[iVar0]), true);
							task_smart_flee_coord(net_to_ped(Local_96.f_48[iVar0]), vVar6, 10000f, 999999, 0, 0);
						}
						break;
					}
				}
...
Vector3 func_659()
{
	...
	while (iVar0 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
		{
			return get_entity_coords(net_to_veh(Local_96.f_7[iVar0]), 0);
		}
		iVar0++;
	}
...
int func_661(int iParam0, float fParam1)
{
	...
	while (iVar3 < 4)
	{
		if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar3]))
		{
			if (func_103(Local_96.f_7[iVar3]))
			{
				iVar7 = get_ped_in_vehicle_seat(net_to_veh(Local_96.f_7[iVar3]), -1);
				if (!PED::IS_PED_INJURED(iVar7))
				{
					if (is_ped_a_player(iVar7))
					{
						vVar4 = {get_entity_coords(net_to_veh(Local_96.f_7[iVar3]), 1)};
						fVar2 = func_478(iParam0, vVar4, 1);
						if (fVar2 < fVar1)
						{
							if (fVar2 < fParam1)
							{
...
void func_662(int iParam0)
{
	...
	{
		if (network_has_control_of_network_id(Local_96.f_48[iParam0]))
		{
			if (is_ped_sitting_in_any_vehicle(net_to_ped(Local_96.f_48[iParam0])))
			{
				iVar0 = get_vehicle_ped_is_in(net_to_ped(Local_96.f_48[iParam0]), 0);
				if (is_this_model_a_plane(ENTITY::GET_ENTITY_MODEL(iVar0)) || is_this_model_a_heli(ENTITY::GET_ENTITY_MODEL(iVar0)))
				{
					if (!is_vehicle_driveable(iVar0, 0))
					{
						set_entity_health(net_to_ped(Local_96.f_48[iParam0]), 5);
					}
				}
			}
		}
...
void func_663(Vector3 vParam0)
{
	Global_1573883.f_6 = {vParam0};
}

int func_664()
{
	return is_bit_set(Local_96.f_3, 8);
}
...
struct<12> func_668(auto uParam0)
{
	struct<12> Var0;
	int iVar12;
		...
		while (iVar0 < 4)
		{
			if (!does_blip_exist(iLocal_1319[iVar0]))
			{
				if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
				{
					if (func_103(Local_96.f_7[iVar0]))
					{
						vVar1 = {get_entity_coords(net_to_veh(Local_96.f_7[iVar0]), 0)};
						if (!func_670(iVar0, vVar1))
						{
							if (!is_bit_set(Local_96.f_13, iVar0))
							{
								iLocal_1319[iVar0] = add_blip_for_entity(net_to_veh(Local_96.f_7[iVar0]));
								set_blip_sprite(iLocal_1319[iVar0], 429);
								func_188(&(iLocal_1319[iVar0]), 29);
								if (!is_bit_set(iLocal_1307, 20))
								{
									set_blip_flashes(iLocal_1319[iVar0], 1);
									set_blip_flash_timer(iLocal_1319[iVar0], 7000);
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1307, 20);
								}
								set_blip_priority(iLocal_1319[iVar0], 9);
								if (func_664())
								{
								...
								if (!is_bit_set(iLocal_1308, 3))
								{
									flash_minimap_display();
									GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1308, 3);
								}
							}
						}
					}
			...
			else if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_96.f_7[iVar0]))
			{
				if (!func_103(Local_96.f_7[iVar0]))
				{
					remove_blip(&(iLocal_1319[iVar0]));
				}
				else if (is_bit_set(Local_96.f_13, iVar0))
				{
					remove_blip(&(iLocal_1319[iVar0]));
				}
			}
...
bool func_670(int iParam0, Vector3 vParam1)
{
	int iVar0;
	Vector3 vVar1;
...
void func_673()
{
	if (is_bit_set(Global_1573883.f_1, 6))
	{
		func_408();
		clear_bit(&(Global_1573883.f_1), 6);
	}
	if (!is_bit_set(Global_1573883.f_1, 7))
	{
		if (is_bit_set(Global_1573883.f_1, 4) || is_bit_set(Global_1573883.f_1, 16))
		{
			if (((!is_radar_hidden() && !is_help_message_being_displayed()) && !func_327()) && func_754(player_id(), 1, 1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 7);
				func_384("FME_PASINT", 30000);
				func_383(1);
			}
		}
		else if (is_bit_set(Global_1573883.f_1, 17))
		{
			if (func_232() && !func_227())
			{
				clear_bit(&(Global_1573883.f_1), 17);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 16);
			}
		}
	}
	if (!is_bit_set(Global_1573883.f_1, 23))
	{
		if (((((!is_radar_hidden() && !is_bit_set(Global_2460486.f_743, 2)) && func_754(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_help_message_being_displayed())
		{
			if (func_696())
			{
				func_384("AMEV_GA_RP", -1);
				func_383(1);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 23);
			}
		}
	}
	...
	if (is_bit_set(Global_1573883.f_1, 9))
	{
		if ((((!is_radar_hidden() && !is_help_message_being_displayed()) && !func_327()) && func_754(player_id(), 1, 1)) && !func_197(player_id(), 21))
		{
			clear_bit(&(Global_1573883.f_1), 9);
			func_695(0);
	...
	if (func_234(player_id()))
	{
		if (!is_bit_set(Global_1573883.f_1, 18))
		{
			if ((func_197(player_id(), 21) && is_bit_set(Global_1573883.f_1, 20)) && !is_bit_set(Global_1573883.f_1, 19))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 18);
			}
		}
		else if (is_bit_set(Global_1573883.f_1, 18))
		{
			if (((((!is_radar_hidden() && !is_help_message_being_displayed()) && !func_327()) && func_754(player_id(), 1, 1)) && is_screen_faded_in()) && !Global_2460486.f_4654)
			{
				clear_bit(&(Global_1573883.f_1), 18);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 19);
				func_384("AMTT_RPAS", -1);
				func_383(1);
			}
		}
	}
	if (((((func_234(player_id()) && !func_196(player_id())) && func_184(player_id()) != 146) && !func_195(player_id())) && !func_694(player_id())) && !func_684())
	{
		if (func_592(func_184(player_id())))
		{
			unk_0xFAC75988A7D078D3(player_id());
		}
		if (!is_bit_set(Global_1573883.f_1, 22))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 22);
		}
		if (func_222(player_id()) || func_590())
		{
			if (!is_bit_set(Global_1573883.f_1, 10))
			{
				if (func_682(func_184(player_id())))
				{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 10);
			}
		}
		if (func_221(player_id()))
		{
			if (!is_bit_set(Global_1573883.f_1, 11))
			{
				if (!Global_91330.f_8)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 12);
				...
				if (!func_681())
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 13);
					func_591();
				}
				if (!Global_2391042)
				{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 11);
			}
		}
		else
		{
	...
	func_674();
	if (func_589(func_184(player_id())) && !is_bit_set(Global_1573883.f_1, 21))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 21);
	}
	if ((func_232() && !func_227()) || func_197(player_id(), 21))
	{
		if (!is_bit_set(Global_1610316[player_id() /*174*/].f_1, 10))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1610316[player_id() /*174*/].f_1), 10);
		}
	}
	else if (is_bit_set(Global_1610316[player_id() /*174*/].f_1, 10))
	{
		clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 10);
	}
}
...
void func_674()
{
	...
	if (func_327())
	{
		...
		while (iVar2 < 82)
		{
			if (func_475(iVar2))
			{
				...
				if (is_bit_set(Global_1573883.f_1, 26))
				{
					clear_bit(&(Global_1573883.f_1), 26);
				}
	...
	else if (!is_bit_set(Global_1573883.f_1, 26))
	{
		func_100(&(Global_1573883.f_21));
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 26);
	}
}
...
{
	if ((is_bit_set(Global_1573883.f_1, 11) || (is_bit_set(Global_1573883.f_1, 10) && iParam0)) || (is_bit_set(Global_1573883.f_1, 22) && iParam0))
	{
		if (is_bit_set(Global_1573883.f_1, 12))
		{
			clear_bit(&(Global_1573883.f_1), 12);
			func_405(0);
		}
		if (is_bit_set(Global_1573883.f_1, 13))
		{
			clear_bit(&(Global_1573883.f_1), 13);
			func_680();
		}
		if (is_bit_set(Global_1573883.f_1, 14) && !func_228(player_id(), 0))
		{
			clear_bit(&(Global_1573883.f_1), 14);
			func_407(0);
		}
		clear_bit(&(Global_1573883.f_1), 11);
		clear_bit(&(Global_1573883.f_1), 10);
		clear_bit(&(Global_1573883.f_1), 22);
	}
}

void func_680()
{
	clear_bit(&(Global_2460486.f_4564), false);
}

int func_681()
{
	return is_bit_set(Global_2460486.f_4564, false);
}
...
bool func_684()
{
	if (((((((((func_693() || func_692()) || func_691()) || func_176()) || (func_690() && !network_is_activity_session())) || (func_687() && !func_686())) || Global_2394645) || Global_2394645.f_1 != 0) || Global_2394718 != 0) || (func_685() == 2 && !network_is_activity_session()))
	{
		return true;
	}
	return false;
...
int func_694(int iParam0)
{
	...
	else if (is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 10))
	{
		return true;
	}
	return is_bit_set(Global_1610316[iParam0 /*174*/].f_1, 9);
}
...
void func_695(int iParam0)
{
	...
	else if (iParam0 == 2)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 7);
		}
	...
	else if (iParam0 == 3)
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, 9);
		}
	...
	else if (func_17(&(Global_1573883.f_15), 1000, 0))
	{
		if (network_is_participant_active(int_to_participantindex(Global_1573883.f_17)))
		{
			...
			if (network_is_player_active(iVar0))
			{
				...
				{
					if (vdist(func_57(player_id()), func_57(iVar0)) < 80f)
					{
						return true;
					}
				}
...
bool func_702()
{
	...
	if (func_400() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_400()) == 0)
		{
			return true;
		}
	}
...
bool func_708(int iParam0, auto uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_710()
{
	...
	{
		set_vehicle_model_is_suppressed(Local_96.f_27, false);
	}
	clear_bit(&(Global_2460486.f_4430), true);
	func_597(19, 0);
	func_583(0);
	...
	{
		func_715(129, 0, is_bit_set(Local_730[participant_id_to_int() /*18*/].f_2, 8));
	}
	func_714(129);
	PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 184, false);
	PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 151, true);
	...
	if (iLocal_1317 > 0)
	{
		set_max_wanted_level(iLocal_1317);
	}
	if (player_id() != -1)
	{
		if (Global_1587523[player_id() /*444*/] == 129)
		{
			Global_1587523[player_id() /*444*/] = -1;
		}
	}
	if (get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID()) == iLocal_1517)
	{
	...
	stop_sound(iLocal_3579);
	Local_713 = Local_96.f_611;
	Local_713.f_1 = Local_96.f_612;
	Local_713.f_4 = Local_96.f_613;
	Local_713.f_3 = Local_96.f_615;
	if (Local_713.f_9 > 0)
	{
		Local_713.f_10 = _get_posix_time() - Local_713.f_9;
	}
	if ((!Global_262145.f_9452 && !is_bit_set(Local_96.f_3, 8)) || (!Global_262145.f_9453 && is_bit_set(Local_96.f_3, 8)))
	{
		if (Local_713.f_6 > 0)
	...
	{
		func_712(Local_713, Local_96.f_279, Local_730[participant_id_to_int() /*18*/].f_8, iVar0, -1, -1, -1);
	}
	if (func_374(player_id()))
	{
		func_564(0);
...
void func_712(struct<12> Param0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	char* sVar0;
	struct<13> Var1;
	struct<14> Var14;
...
void func_713()
{
	remove_relationship_group(iLocal_1518);
	remove_relationship_group(iLocal_1517);
}
...
void func_715(int iParam0, int iParam1, int iParam2)
{
	...
	if (player_id() != -1)
	{
		if (is_bit_set(Global_1610316[player_id() /*174*/].f_1, 13))
		{
			clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 13);
		}
		if (is_bit_set(Global_1610316[player_id() /*174*/].f_1, 14))
		{
			clear_bit(&(Global_1610316[player_id() /*174*/].f_1), 14);
		}
	}
	if (is_bit_set(Global_1573883.f_1, 21))
	{
		clear_bit(&(Global_1573883.f_1), 21);
	}
	func_739();
	set_audio_flag("DisableFlightMusic", 0);
	set_audio_flag("WantedMusicDisabled", 0);
	if (iParam1)
	{
		uVar0 = func_738(func_184(player_id()));
		func_597(21, 0);
	}
	else
	{
		if ((iParam2 && player_id() != -1) && func_737(player_id()) >= 12)
		{
			func_736(2524, -1);
			iVar1 = func_249(2524, -1, 0);
			if (iVar1 == 2)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, false);
			}
			else if (iVar1 == 4)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, true);
			}
			else if (iVar1 == 6)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, 2);
			}
			else if (iVar1 == 8)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, 3);
			}
			else if (iVar1 == 10)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, 4);
			}
			else if (iVar1 == 12)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&Global_1573908, 5);
			}
		}
		func_602();
		func_735();
		func_734();
		if ((!func_220(player_id()) && !func_218(player_id())) && !func_733())
		{
			func_722();
		}
		func_721();
		if (!is_bit_set(Global_1727391.f_3, false) && !is_bit_set(Global_1727391.f_3, true))
		{
			func_408();
		}
		func_720();
		clear_bit(&(Global_2460486.f_1645), 2);
		func_496();
		func_719();
	}
	if (_0x84698AB38D0C6636(1344549371))
	...
	if (!iParam1 || uVar0)
	{
		if ((player_id() != -1 && !func_197(player_id(), 21)) && !func_228(player_id(), 0))
		{
			func_407(0);
			func_405(0);
			func_718();
...
bool func_716()
{
	if (((!func_351(player_id()) && !func_336(player_id())) && func_184(player_id()) != 146) && !func_717())
	{
		return false;
	}
	return true;
...
bool func_717()
{
	if ((Global_1617379 == 0 && network_is_activity_session()) && ((((((Global_1617379.f_5 != 0 || Global_1617379.f_88495 > 0) || is_bit_set(Global_1617379.f_4, 15)) || is_bit_set(Global_1617379.f_4, 18)) || is_bit_set(Global_1617379.f_4, 19)) || is_bit_set(Global_1617379.f_4, 28)) || is_bit_set(Global_1617379.f_4, 27)))
	{
		return true;
	}
	return false;
...
void func_718()
{
	...
	{
		if (is_bit_set(Global_2359718[iVar0 /*26*/].f_12, 11))
		{
			if (is_bit_set(Global_2359718[iVar0 /*26*/].f_13, 26))
			{
				clear_bit(&(Global_2359718[iVar0 /*26*/].f_13), 26);
			}
		}
		iVar0++;
	}
...
void func_726(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	if (iParam0)
	{
...
void func_739()
{
	if (is_bit_set(Global_2460486.f_1642, 3) || is_bit_set(Global_2460486.f_1642, 4))
	{
	...
	if (is_bit_set(Global_2460486.f_1642, 5))
	{
		clear_bit(&(Global_2460486.f_1642), 5);
	}
	if (is_bit_set(Global_2460486.f_1642, 3))
	{
		clear_bit(&(Global_2460486.f_1642), 3);
	}
	if (is_bit_set(Global_2460486.f_1642, 4))
	{
		clear_bit(&(Global_2460486.f_1642), 4);
	}
	func_742(0);
	func_741(0);
	func_740(0);
...
void func_743(struct<20> Param0)
{
	...
	func_752(func_753(Param0), Param0);
	reserve_network_mission_peds(24);
	reserve_network_mission_vehicles(9);
	func_751(0, -1, 0);
	func_749(129);
	network_register_host_broadcast_variables(&Local_96, 617);
	network_register_player_broadcast_variables(&Local_730, 577);
	func_748(1);
	if (!func_747())
	{
		func_710();
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (network_is_host_of_this_script())
		{
			...
			_0x6DEE77AFF8C21BD1(&(Local_96.f_611), &(Local_96.f_612));
		}
		iVar0 = 0;
		iVar0 = 0;
		while (iVar0 < 4)
		...
		Local_713.f_2 = _0xCF61D4B4702EE9EB();
		Local_713.f_8 = _get_posix_time();
		func_597(19, 1);
		func_744();
		if (func_194())
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_730[participant_id_to_int() /*18*/].f_2), 7);
		}
		Local_730[participant_id_to_int() /*18*/].f_9 = -1;
		Global_2460486.f_4650 = -1;
		Local_730[participant_id_to_int() /*18*/] = 0;
	}
	else
	{
		func_710();
...
void func_744()
{
	...
	add_relationship_group("relUWPlayer", &iLocal_1517);
	add_relationship_group("relUWAi", &iLocal_1518);
	iVar0 = 0;
	while (iVar0 < 32)
	{
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_1574198[iVar0], iLocal_1517);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1517, Global_1574198[iVar0]);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_1574198[iVar0], iLocal_1518);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1518, Global_1574198[iVar0]);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1517, -1533126372);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_1517);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1517, Global_1574240[5]);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_1574240[5], iLocal_1517);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1517, Global_1574231);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, Global_1574231, iLocal_1517);
		iVar0++;
	}
...
void func_748(int iParam0)
{
	...
	if (!is_thread_active(Global_2412879.f_725) || Global_2412879.f_725 == get_id_of_this_thread())
	{
		if (iParam0)
		{
			Global_2412879.f_725 = get_id_of_this_thread();
		}
		else
		{
...
void func_749(int iParam0)
{
	...
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1573883.f_1), 17);
	}
}
...
void func_752(int iParam0, struct<17> Param1, auto uParam2, auto uParam3, auto uParam4)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_711();
