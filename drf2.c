		...
		switch (iLocal_60)
		{
						...
						if (_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_121(&iVar9) > func_61(func_239()))
							{
								if (func_239() == 4)
								{
									...
									set_ped_money(iLocal_400, 2000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5, 301));
			...
			case 15:
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_400) || func_59(iLocal_400, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					...
					{
						clear_area_of_projectiles(ENTITY::GET_ENTITY_COORDS(iLocal_400, 1), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
...
void func_47()
{
	...
	fVar6 = vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			...
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 7);
		...
		else if (func_121(&iLocal_269) > 12f)
		{
			...
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 7 - iLocal_429);
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			...
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 8);
		...
		else if (func_121(&iLocal_272) > 10.3f)
		{
			...
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 8 - iLocal_431);
				iVar5 = false;
				while (iVar5 >= 0)
				{
...
void func_76()
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_401, 0)) && is_vehicle_driveable(iLocal_401, 0))
	{
