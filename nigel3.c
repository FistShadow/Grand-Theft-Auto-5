...
{
	iLocal_532 = 0;
	if (!is_bit_set(Global_101154.f_17264.f_382, 5))
	{
...
void func_242()
{
	...
	switch (iLocal_158)
	{
		case 0:
			...
			if ((has_anim_dict_loaded(sLocal_283) && has_model_loaded(iLocal_292)) && func_228(Local_165))
			{
...
void func_247(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_249() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_249() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_251(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_249() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_302()
{
	...
	{
		if (has_model_loaded(Local_557.f_7) && func_228(Local_557))
		{
...
int func_342(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_8() == 0)
		{
			return is_bit_set(func_69(func_343(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_527()
{
	...
	func_535(64, 2, 0);
	clear_bit(&(Global_101154.f_17264.f_382), 5);
	if (func_228(PLAYER::PLAYER_PED_ID()))
	{
