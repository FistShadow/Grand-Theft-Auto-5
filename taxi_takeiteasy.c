...
int func_107(int iParam0)
{
	...
	set_blip_scale(iVar0, func_108(network_is_game_in_progress(), 0.7f, 0.7f));
	return iVar0;
}
...
bool func_126(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0.f_5)
	{
		...
		case 2:
			...
			{
				if (!func_129(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(player_ped_id(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (get_game_timer() - *uParam0.f_4 > 500)
			{
				...
				{
					if (is_ped_in_any_vehicle(player_ped_id(), 1) || func_127(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
...
int func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_108(network_is_game_in_progress(), 1f, 1f));
		if (!iParam2)
		{
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!is_entity_dead(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (get_script_task_status(*uParam0.f_3, 242628503) != 1 || ((func_151(player_ped_id(), *uParam0.f_3, 1) < 20f && func_210(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_210(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
...
{
	if (func_236() && get_game_timer() >= iParam0 + 1000)
	{
...
bool func_253(auto uParam0, int iParam1)
{
	...
	if (!func_256(uParam0, iParam1))
	{
		...
		if ((is_ped_injured(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_150(*uParam0.f_3, 1) > 400f)
		{
...
bool func_323(auto uParam0)
{
	if (!is_entity_dead(*uParam0.f_3, 0))
	{
		if (func_151(player_ped_id(), *uParam0.f_3, 1) < 40f && !is_entity_occluded(*uParam0.f_3))
		{
			return true;
		}
	}
