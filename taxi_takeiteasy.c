#region Local Var
	...
	auto uLocal_846 = 0;
	int iLocal_847 = 0;
	Vector3[] vLocal_848 = new Vector3[1];
	int iLocal_852 = 0;
	int iLocal_853 = 0;
	...
	auto uLocal_957 = 0;
	auto uLocal_958 = 0;
	auto uLocal_959 = 1097859072;
	auto uLocal_960 = 1500;
	auto uLocal_961 = 45;
	auto uLocal_962 = 1103626240;
	auto uLocal_963 = 5;
	int iLocal_964 = 0;
	auto uLocal_965 = 0;
	auto uLocal_966 = 0;
...
void func_8()
{
	...
	else
	{
		...
		{
			case 0:
				func_292(&(vLocal_848[0 /*3*/]), "TAXI_SC_BN_01", 100);
				func_291(&Local_410, &vLocal_848);
				func_288();
				func_287(&Local_410, 16, 4f, 0);
				func_285(&Local_410, vLocal_857, vLocal_860, "TaxiOtis", iLocal_852, 135.3f, 40f);
				func_283(&Local_410);
			...
			case 3:
				if (func_253(&Local_410, 1))
				{
					...
					{
						set_ped_component_variation(Local_410.f_3, 3, true, false, 0);
						set_ped_component_variation(Local_410.f_3, 4, true, false, 0);
						set_ped_component_variation(Local_410.f_3, false, true, false, 0);
						set_ped_flee_attributes(Local_410.f_3, 1024, true);
						set_ped_flee_attributes(Local_410.f_3, 131072, true);
					}
			...
			case 9:
				...
				switch (iLocal_847)
				{
					case 0:
						...
						if ((((func_175(&Local_410) >= 2 && get_player_wanted_level(player_id()) < 1) && !is_entity_upsidedown(Local_410.f_4)) && !(get_entity_roll(Local_410.f_4) <= -145f || get_entity_roll(Local_410.f_4) >= 145f)) && !iLocal_879)
						{
							if (func_174())
							{
								func_172();
			...
			case 29:
				...
				if (!PED::IS_PED_INJURED(Local_410.f_3))
				{
					...
					{
						set_ped_reset_flag(Local_410.f_3, 60, true);
					}
				}
				break;
...
float func_9(int iParam0, Vector3 vParam1, int iParam2)
{
...
void func_38(Vector3 vParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_40(Vector3 vParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_41(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_105(auto uParam0, auto uParam1, int iParam2, auto uParam3, int iParam4)
{
	int iVar0;
	...
	switch (*uParam0)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(*iParam2, 0))
			{
				func_112(&uLocal_45, *iParam2, 0, 0, 1, 1, 1);
...
void func_106(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
...
int func_107(int iParam0)
{
	...
	set_blip_scale(iVar0, func_108(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return iVar0;
}
...
void func_112(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_113(uParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_113(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5, int iParam6)
{
	func_114(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, iParam4, uParam5, iParam6);
}

void func_114(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	*uParam0.f_6 = 2;
	func_115(uParam0, iParam1, vParam2, sParam5, iParam6, iParam7, uParam8, iParam9);
}
...
void func_115(auto uParam0, int iParam1, Vector3 vParam2, char* sParam3, int iParam4, int iParam5, auto uParam6, int iParam7)
{
	...
	if (func_131(iParam1) && is_entity_visible(iParam1))
	{
		iVar1 = 0;
		...
		if (!is_gameplay_hint_active())
		{
			if (func_126(uParam0, iParam7, iParam9, 0))
			{
...
void func_123(auto uParam0, int iParam1, Vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_126(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	if (*uParam0.f_1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() >= *uParam0.f_8 + *uParam0.f_9)
	...
	switch (*uParam0.f_5)
	{
		case 0:
			*uParam0.f_7 = 0;
			if (*uParam0.f_6 == 0)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					if (func_130(iParam1, iParam2, iParam3))
					{
				...
				else if (func_129(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
			...
			{
				if (func_129(iParam1, iParam2, iParam3))
				{
					*uParam0.f_4 = GAMEPLAY::GET_GAME_TIMER();
					*uParam0.f_5 = 1;
					*uParam0.f_7 = 1;
		...
		case 2:
			...
			{
				if (!func_129(iParam1, iParam2, iParam3) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam0.f_5 = 0;
				}
			}
			else if (*uParam0.f_6 == 2)
			{
				...
				else if (!func_130(iParam1, iParam2, iParam3))
				{
					*uParam0.f_5 = 0;
				}
			}
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() - *uParam0.f_4 > 500)
			{
				if (*uParam0.f_6 == 0)
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
					{
						if (func_128(iParam1, iParam2, iParam3))
						{
							*uParam0.f_5 = 0;
						}
					}
					else if (func_127(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				...
				{
					if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1) || func_127(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
				else if (*uParam0.f_6 == 2)
				{
					...
					else if (func_128(iParam1, iParam2, iParam3))
					{
						*uParam0.f_5 = 0;
					}
				}
	...
	if (!func_121(iParam1, iParam2, iParam3))
	{
		*uParam0.f_5 = 0;
		*uParam0.f_7 = 0;
	}
...
int func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (is_entity_a_vehicle(iParam0))
	{
		set_blip_scale(iVar0, func_108(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
...
void func_135(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_138(auto uParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
...
void func_140(auto uParam0, Vector3 vParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_143(auto uParam0, int iParam1, float fParam2)
{
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
auto func_150(int iParam0, int iParam1)
{
	return func_151(get_player_ped(get_player_index()), iParam0, iParam1);
}

auto func_151(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_153(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1)
	{
		func_401(uParam0);
...
void func_156(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_157(auto uParam0, int iParam1, int iParam2)
{
...
void func_165(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_166()
{
	if (is_vehicle_driveable(Local_410.f_4, 0))
	{
		...
		if (get_entity_speed(Local_410.f_4) >= 5f && func_159(&Local_410, 21))
		{
			...
			case 0:
				if (!func_174())
				{
					if (func_176(&(Local_410.f_244), "txm1aud", "txm1_Puke1", 8, 0, 0, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							switch (func_171(*uParam0, 0))
							{
								case 0:
									remove_vehicle_window(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), true);
									break;
								
								case 2:
									remove_vehicle_window(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 3);
									break;
			...
			case 1:
				if (is_entity_playing_anim(*uParam0, sLocal_884, sLocal_883, 3))
				{
					...
					if (fVar0 > 0.243f && fVar0 < 0.28f)
					{
						if (!iLocal_876)
						{
							start_particle_fx_non_looped_on_ped_bone("scr_puke_in_car", *uParam0, vLocal_863, vLocal_866, 31086, 1f, 0, 0, 0);
							iLocal_876 = 1;
						}
					}
...
int func_176(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_184(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_187(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
		*uParam0 = 0;
...
int func_190(auto uParam0, float fParam1, float fParam2)
{
	if ((((is_screen_faded_in() && !is_screen_fading_in()) && !is_screen_fading_out()) && !is_screen_faded_out()) && !*uParam0.f_142)
	{
		if (func_207(uParam0))
		{
			...
			func_193(uParam0);
			func_191(uParam0);
			if (round(func_397(uParam0, 7)) % 5 == 0 && !iLocal_93)
			{
				iLocal_93 = 1;
			}
			if (round(func_397(uParam0, 7)) % 5 == 2 && iLocal_93)
			{
				iLocal_93 = 0;
			}
			return func_208(uParam0, fParam1);
		}
	}
	return 0;
}
...
void func_191(auto uParam0)
{
	...
	if ((func_146(uParam0) && func_23(*uParam0.f_81, 67108864)) && get_player_wanted_level(player_id()) == 0)
	{
...
float func_192(Vector3 vParam0, int iParam1)
{
...
void func_194(auto uParam0, float fParam1, float fParam2)
{
...
auto func_200(auto uParam0)
{
	return *uParam0.f_106;
}

auto func_201(char* sParam0, int iParam1, char* sParam2)
{
...
auto func_205(auto uParam0)
{
	return *uParam0.f_120;
}

void func_206(auto uParam0, auto uParam1)
{
...
int func_208(auto uParam0, float fParam1)
{
	if (func_61(uParam0) == 2)
	{
		...
		if (((func_210(*uParam0.f_4, *uParam0.f_17, 1) <= fParam1 + 1f && get_player_wanted_level(get_player_index()) < 1) && func_209(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
		{
			return func_143(uParam0, 1, fParam1);
		}
	}
	else if (((ENTITY::IS_ENTITY_AT_COORD(*uParam0.f_4, *uParam0.f_17, fParam1 + 1f, fParam1 + 1f, 2f, !*uParam0.f_140, true, 0) && get_player_wanted_level(get_player_index()) < 1) && func_209(1, 1, 1)) && is_vehicle_on_all_wheels(*uParam0.f_4))
	{
		return func_143(uParam0, 1, fParam1);
	}
	return 0;
...
auto func_210(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_211(auto uParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(*uParam0.f_3))
	{
...
int func_215(auto uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_4) && is_vehicle_driveable(*uParam0.f_4, 0))
	{
...
void func_218(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
bool func_222(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(*uParam0.f_4, 0))
	{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
			{
				...
				{
					case 0:
						if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 || ((func_151(PLAYER::PLAYER_PED_ID(), *uParam0.f_3, 1) < 20f && func_210(*uParam0.f_3, *uParam0.f_11, 1) <= 28f) && func_210(*uParam0.f_4, *uParam0.f_11, 1) <= 28f))
						{
					...
					case 1:
						...
						else
						{
							...
							else if (((AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 0) && AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_3, 242628503) != 7) && func_249(uParam0, *uParam0.f_3) > 8f)
							{
...
bool func_224(auto uParam0)
{
	...
	switch (iLocal_86)
	{
		...
		case 2:
			...
			iVar12 = func_234(uParam0.f_409, get_offset_from_entity_in_world_coords(*uParam0.f_4, 0f, 2.2f, 0.275f), get_offset_from_entity_in_world_coords(*uParam0.f_4, vVar0), 1);
			if (iVar12 == 1)
			{
				vVar0.z += 1.5f;
				if (*uParam0.f_7 == 2)
			...
			if (iVar12 != -1)
			{
				...
				set_entity_heading(*uParam0.f_3, func_229(uParam0));
		...
		case 7:
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(*uParam0.f_4, 0))
			{
				if (!is_ped_in_any_vehicle(*uParam0.f_3, 0))
				{
					...
					set_vehicle_door_shut(*uParam0.f_4, func_227(*uParam0.f_7), 1);
				}
				render_script_cams(false, false, 3000, 1, 0, 0);
				destroy_cam(*uParam0, 0);
...
void func_228(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	if (!does_cam_exist(*uParam0))
	{
...
float func_229(auto uParam0)
{
	...
	fVar0 = func_230(ENTITY::GET_ENTITY_COORDS(*uParam0.f_3, 1), vVar1);
	return fVar0;
}

float func_230(struct<2> Param0, Vector3 fParam1, struct<2> Param2, auto uParam3)
{
...
int func_234(auto uParam0, Vector3 vParam1, Vector3 vParam2, int iParam3)
{
	auto uVar0;
	auto uVar3;
	int iVar6;
...
{
	if ((get_entity_speed(*uParam0.f_4) > 3f && func_397(uParam0, 5) > 15f) || is_entity_upsidedown(*uParam0.f_4))
	{
		return true;
	}
	return false;
...
bool func_242(auto uParam0, int iParam1)
{
	int[] iVar0 = new int[3];
	int iVar4;
...
int func_243(auto uParam0, auto uParam1)
{
	int iVar0;
...
bool func_245(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_3, 0))
	{
		if (!ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3) && func_150(*uParam0.f_3, 1) < fParam2)
		{
		...
		if (((func_397(uParam0, 5) > IntToFloat(iParam1) && get_entity_speed(*uParam0.f_4) < fParam4) && !ENTITY::IS_ENTITY_OCCLUDED(*uParam0.f_3)) || func_150(*uParam0.f_3, 1) <= fParam3)
		{
			return true;
		}
	}
...
bool func_246(auto uParam0, float fParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	switch (iLocal_87)
	{
		...
		case 1:
			if ((func_151(*uParam0.f_4, *uParam0.f_3, 0) <= fParam1 && !*uParam0.f_142) && absf(vVar0.z - vVar3.z) < 5f)
			{
				if (*uParam0.f_409 == 0)
				{
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_248(iParam3), 0);
}
...
float func_249(auto uParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		if (func_197(uParam0))
...
bool func_253(auto uParam0, int iParam1)
{
	...
	if (func_23(*uParam0.f_44, 8))
	{
		if (!func_23(*uParam0.f_44, 128))
		{
			if (is_ped_jacking(PLAYER::PLAYER_PED_ID()) && !func_23(*uParam0.f_44, 256))
			{
				func_62(uParam0.f_44, 256);
			}
			if (func_23(*uParam0.f_44, 256) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
	...
	if (!func_256(uParam0, iParam1))
	{
		...
		if ((PED::IS_PED_INJURED(*uParam0.f_3) || is_ped_fleeing(*uParam0.f_3)) || func_150(*uParam0.f_3, 1) > 400f)
		{
...
{
	Local_343 = 0;
	func_276(41063/*func_278*/, 41038/*func_277*/, 1);
	func_276(40799/*func_274*/, 40776/*func_273*/, 1);
	func_276(40714/*func_272*/, 40689/*func_271*/, 1);
	func_276(40617/*func_270*/, 40593/*func_269*/, 1);
	func_276(40483/*func_268*/, 40462/*func_267*/, 1);
	func_276(40409/*func_265*/, 40384/*func_264*/, 1);
	func_276(40242/*func_261*/, 40219/*func_260*/, 1);
}

bool func_260(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_264(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_271(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_273(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_277(auto uParam0, auto uParam1)
{
	uParam1 = uParam1;
...
bool func_280()
{
	...
	if (!has_scaleform_movie_loaded(iLocal_964))
	{
		return false;
	}
...
{
	return func_134(iParam0, !iParam1, iParam2);
}

bool func_285(auto uParam0, Vector3 vParam1, Vector3 vParam2, char* sParam3, int iParam4, Vector3 fParam5, float fParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_3))
	{
...
void func_286(auto uParam0, Vector3 vParam1)
{
	*uParam0.f_51[0] = _0x2CE544C68FB812A0(vParam1, 20f, 5f, 0);
}

void func_287(auto uParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
...
void func_291(auto uParam0, auto uParam1)
{
	int iVar0;
...
void func_292(auto uParam0, char* sParam1, int iParam2)
{
	*uParam0 = 0;
	*uParam0.f_1 = iParam2;
	*uParam0.f_2 = sParam1;
...
bool func_293()
{
	...
	fVar0 = to_float(GAMEPLAY::GET_GAME_TIMER());
...
bool func_295(auto uParam0, int iParam1, float fParam2)
{
	if (*uParam0.f_410 < 29)
	{
...
void func_296(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_411 == 0)
	{
		if (get_player_wanted_level(player_id()) == 0)
	...
	if (((((is_vehicle_driveable(*uParam0.f_4, 0) && !func_15(&(Local_190[0 /*10*/].f_3))) && !func_15(&(Local_190[8 /*10*/].f_3))) && !func_15(&(Local_190[5 /*10*/].f_3))) && !func_15(&(Local_190[9 /*10*/].f_3))) && !func_15(&(Local_190[7 /*10*/].f_3)))
	{
		if (!func_15(&(Local_190[14 /*10*/].f_3)))
		{
			*uParam0.f_5 = get_closest_vehicle(ENTITY::GET_ENTITY_COORDS(*uParam0.f_4, 1), 10f, false, 260);
			...
			{
				if ((get_entity_speed(*uParam0.f_4) > 15f && func_151(*uParam0.f_5, *uParam0.f_4, 1) < 3f) && (!ENTITY::IS_ENTITY_DEAD(*uParam0.f_5, 0) && !is_vehicle_seat_free(*uParam0.f_5, -1)))
				{
					func_196(&(Local_190[14 /*10*/].f_3));
				}
			}
		}
		else if ((func_97(&(Local_190[14 /*10*/].f_3)) < 1.5f && func_151(*uParam0.f_5, *uParam0.f_4, 1) > 4.5f) && !has_entity_been_damaged_by_any_vehicle(*uParam0.f_5))
		{
...
bool func_302(auto uParam0)
{
	...
	{
		if (!func_303(*uParam0.f_4) && get_entity_speed(*uParam0.f_4) > 15f)
		{
...
int func_303(int iParam0)
{
	...
	vVar9 = {func_307(vVar3.x - vVar0.x, vVar3.y - vVar0.y, 0f)};
	vVar12 = {func_306(vVar9, 0) * Vector(fVar27, fVar27, fVar27)};
	...
	vVar24 = {vVar24};
	return func_304(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar15, vVar18, vVar21);
}

bool func_304(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	...
	vParam6.z = 0f;
	vParam9.z = 0f;
	vVar0 = {func_307(vParam6 - vParam3)};
	vVar3 = {func_307(vParam9 - vParam3)};
	fVar6 = func_305(vParam0, vVar0);
	fVar7 = func_305(vParam3, vVar0);
	fVar8 = func_305(vParam6, vVar0);
	fVar9 = func_305(vParam0, vVar3);
	fVar10 = func_305(vParam3, vVar3);
	fVar11 = func_305(vParam9, vVar3);
	if (fVar7 > fVar8)
	{
		fVar12 = fVar7;
		fVar7 = fVar8;
...
void func_316(int iParam0, auto uParam1)
{
...
void func_317(auto uParam0, auto uParam1)
{
...
void func_320(auto uParam0, char* sParam1, int iParam2)
{
	struct<6> Var0;
	...
	func_417(2);
	Var0 = {func_324()};
	if ((!is_string_null_or_empty(&Var0) && func_174()) && !are_strings_equal(&Var0, "NULL"))
	{
	}
	else
	{
...
void func_322(auto uParam0, char* sParam1)
{
	if (func_323(uParam0))
	{
...
void func_326()
{
	if (func_358(&Local_410, &Local_886))
	{
		switch (Local_886.f_27)
		{
			case 0:
				...
				{
					if (!func_357(&Local_410) && get_player_wanted_level(player_id()) < 1)
					{
						if (func_356("TX_OBJ_TIE_DO") || does_blip_exist(Local_410.f_9))
						{
							Local_886.f_27++;
						}
			...
			case 2:
				if ((iLocal_879 && iLocal_847 == 0) && !func_174())
				{
	...
	func_327(&Local_410, &uLocal_916, &Local_886, 4, iLocal_885);
}

bool func_327(auto uParam0, auto uParam1, auto uParam2, int iParam3, int iParam4)
{
	struct<6> Var0;
	struct<6> Var6;
	...
	if (!*uParam0.f_109)
	{
		switch (*uParam2)
		{
			...
			case 3:
				...
				{
					func_63(uParam2.f_26, round(pow(2f, to_float(*uParam2.f_27))));
					*uParam2.f_27++;
					func_332(uParam1);
			...
			case 5:
				if ((func_397(uParam0, 18) > 1.5f && !func_174()) && !func_199(uParam0))
				{
					...
					else
					{
						if (*uParam2.f_29)
						{
							StringConCat(&Var0, "_resB", 24);
						}
						else
						{
							StringConCat(&Var0, "_resA", 24);
						}
						Var6 = {Var0};
						func_330(uParam2.f_25, iParam3, &Var0, 1, 1, 0);
						func_329(uParam0.f_244, *uParam0.f_144, &Var6, &Var0, 8, 0, 0);
						func_287(uParam0, 18, 0, 0);
						*uParam2 = 6;
					}
				}
...
int func_328(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_330(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
bool func_331(auto uParam0, char* sParam1)
{
...
struct<6> func_335(auto uParam0)
{
	int iVar0;
	struct<6> Var1;
...
void func_338(auto uParam0, auto uParam1)
{
	struct<6> Var0;
	struct<6> Var6;
	int iVar12;
	...
	else if (func_159(uParam0, 14))
	{
		...
		switch (func_355(uParam0))
		{
			case 55:
				...
				Var6 = {Var0};
				func_330(uParam0.f_93, 3, &Var6, 0, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
		...
		switch (func_355(uParam0))
		{
			...
			case 4:
				...
				if (!func_23(*uParam0.f_44, 128))
				{
					...
					{
						func_330(uParam0.f_99, 4, &Var6, 0, 1, 0);
						func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					}
					else
					{
			...
			case 72:
				...
				else if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_330(uParam0.f_95, 5, &Var6, 1, 0, 1);
					func_176(uParam0.f_244, *uParam0.f_144, &Var6, 8, 0, 0, 0);
				}
				else
				{
					...
					if (*uParam0.f_411 == 0)
					{
						func_330(uParam0.f_95, 8, &Var6, 1, 1, 0);
					}
					else
					{
						func_330(uParam0.f_95, 5, &Var6, 1, 1, 0);
					}
					func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 79:
				...
				{
					func_348(uParam0, 4096, Var0, "_sideW1", iVar24, 8);
				}
				else if (!func_23(*uParam0.f_81, 8192))
				{
					func_348(uParam0, 8192, Var0, "_sideW2", iVar24, 8);
				}
			...
			case 80:
				...
				{
					func_348(uParam0, 16384, Var0, "_opLne1", iVar24, 8);
				}
				else if (!func_23(*uParam0.f_81, 32768))
				{
					func_348(uParam0, 32768, Var0, "_opLne2", iVar24, 8);
				}
			...
			case 83:
				...
				if (*uParam0.f_411 == 1)
				{
					...
					Var6 = {Var0};
					func_330(uParam0.f_93, 6, &Var6, 0, 1, 0);
					func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_354(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
					func_287(uParam0, 16, 0, 0);
					func_252(uParam0, 0, 0);
			...
			case 92:
				...
				Var6 = {Var0};
				func_330(uParam0.f_96, 2, &Var6, 0, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_354(9, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_287(uParam0, 16, 0, 0);
				func_252(uParam0, 0, 0);
			...
			case 93:
				...
				Var6 = {Var0};
				func_330(uParam0.f_97, 2, &Var6, 0, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_354(12, uParam0.f_57, uParam0.f_55, uParam0.f_124, Var0, 0);
				func_287(uParam0, 16, 0, 0);
				func_252(uParam0, 0, 0);
					...
					if (!*uParam0.f_109 && !func_174())
					{
						switch (*uParam0.f_414)
						{
							...
							case 8:
								StringConCat(&Var0, "_good1", 24);
								Var6 = {Var0};
								func_330(uParam0.f_93, 6, &Var6, 1, 1, 0);
								func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 78:
				...
				Var6 = {Var0};
				func_330(uParam0.f_87, 6, &Var6, 1, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 48:
				...
				Var6 = {Var0};
				func_330(uParam0.f_86, 4, &Var6, 0, 1, 0);
				if (*uParam0.f_411 != 9)
				{
					func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 67:
				...
				Var6 = {Var0};
				func_330(uParam0.f_88, 4, &Var6, 0, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
			...
			case 51:
				...
				else
				{
					StringConCat(&Var0, "_copBa1", 24);
					Var6 = {Var0};
					func_330(uParam0.f_85, 6, &Var6, 1, 1, 0);
					func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
					func_287(uParam0, 16, 0, 0);
					func_252(uParam0, 0, 0);
				}
			...
			case 58:
				if (*uParam0.f_411 == 6)
				{
					...
					Var6 = {Var0};
					func_330(uParam0.f_93, 6, &Var6, 1, 1, 1);
					func_170(&Var0);
					func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				}
			...
			case 115:
				...
				Var6 = {Var0};
				func_330(uParam0.f_91, 5, &Var6, 1, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_287(uParam0, 16, 0, 0);
				func_252(uParam0, 0, 0);
				break;
			...
			case 116:
				...
				Var6 = {Var0};
				func_330(uParam0.f_92, 5, &Var6, 1, 1, 0);
				func_329(uParam0.f_244, *uParam0.f_144, &Var0, &Var6, 8, 0, 0);
				func_287(uParam0, 16, 0, 0);
				func_252(uParam0, 0, 0);
				break;
...
void func_340(auto uParam0, struct<6> Param1, int iParam2)
{
	struct<6> Var0;
	...
	func_329(uParam0.f_244, *uParam0.f_144, &Param1, &Var0, iParam7, 0, 0);
	func_287(uParam0, 16, 0, 0);
}
...
void func_343(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4)
{
...
void func_344(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	Vector3 fVar0;
	int iVar1;
	int iVar2;
...
void func_345(char[24] cParam0, auto uParam1)
{
	int iVar0;
...
void func_348(auto uParam0, int iParam1, struct<6> Param2, char* sParam3, int iParam4, int iParam5)
{
	func_62(uParam0.f_81, iParam1);
	func_287(uParam0, 16, 0, 0);
	StringConCat(&Param2, sParam8, 24);
...
int func_349(Vector3 vParam0, int iParam1)
{
	int iVar0;
...
int func_358(auto uParam0, auto uParam1)
{
	return ((*uParam1 == -1 && *uParam0.f_412 == 0) && !func_159(uParam0, 9));
}

auto func_359(auto uParam0)
{
...
void func_361(auto uParam0, auto uParam1, int iParam2)
{
	if (!func_23(*uParam0.f_55, 1))
	{
		...
		{
			case 0:
				if (!is_string_null_or_empty(uParam0.f_124) && func_174())
				{
					*uParam1++;
				}
				break;
...
bool func_362(auto uParam0, auto uParam1)
{
	...
	if ((((!is_player_control_on(player_id()) && (does_cam_exist(*uParam0) && !is_cam_active(*uParam0))) && (does_cam_exist(*uParam0.f_1) && !is_cam_active(*uParam0.f_1))) && !is_message_being_displayed()) && !func_174())
	{
...
bool func_390(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_150(iParam0, 1) < 1.5f)
		{
			return true;
		}
...
float func_397(auto uParam0, int iParam1)
{
...
void func_404(auto uParam0, int iParam1, int iParam2)
{
...
void func_408(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
...
void func_409(auto uParam0)
{
	...
	switch (*uParam0.f_411)
	{
		...
		case 9:
			func_413(uParam0, get_random_int_in_range(false, 17));
			iVar0 = func_411(*uParam0.f_418.f_2 + get_random_int_in_range(true, 17), 0, 16);
