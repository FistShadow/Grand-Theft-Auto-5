#region Local Var
	...
	auto uLocal_76 = 0;
	auto uLocal_77 = 0;
	auto uLocal_78 = 1097859072;
	auto uLocal_79 = 1500;
	auto uLocal_80 = 45;
	auto uLocal_81 = 1103626240;
	auto uLocal_82 = 5;
	auto uLocal_83 = 0;
	auto uLocal_84 = 16;
	auto uLocal_85 = 0;
...
void main()
{
	...
	while (true)
	{
		if (func_132())
		{
			...
			{
				iLocal_279 = 0;
				func_2(&iLocal_278, iVar2, &uVar0, &iLocal_279, iVar1);
			}
			wait(iLocal_279);
		}
		else
...
void func_2(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4)
{
	auto uVar0;
	Vector3 vVar3;
	auto uVar6;
	...
	*iParam3 = 500;
	if (!is_entity_dead(iParam1, 0))
	{
		...
		func_129(Global_101154.f_18663.f_3, &vVar3, &fVar7, &uVar0, &uVar6);
		if (Global_101154.f_18663.f_3 >= 5 || uLocal_263)
		{
			func_128(iParam1, vVar3, fVar7, iParam0);
		...
		switch (*iParam0)
		{
			...
			case 17:
				if (!is_thread_active(iLocal_249))
				{
					...
					else
					{
						...
						func_124(&(Global_101154.f_18663.f_1), 8192);
						func_124(&(Global_101154.f_18663.f_1), 16384);
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_274) && !is_entity_dead(iLocal_274, 0))
						{
							remove_ped_from_group(iLocal_274);
						}
						if (does_blip_exist(iLocal_273))
						{
							remove_blip(&iLocal_273);
						}
						...
						if (Global_101154.f_18663.f_3 >= 5)
						{
							if (has_model_loaded(iLocal_271))
							{
								...
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_275))
								{
									...
									iLocal_275 = create_vehicle(iLocal_271, 408.8376f, -1638.952f, 28.2928f, 230.2387f, 1, 1);
									set_model_as_no_longer_needed(iLocal_271);
								}
								if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_dead(iLocal_275, 0))
								{
									set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_275, -1);
									set_ped_coords_keep_vehicle(PLAYER::PLAYER_PED_ID(), 408.8376f, -1638.952f, 28.2928f);
...
void func_25(char* sParam0, int iParam1, int iParam2)
{
	if (Global_91278 != 10 && Global_91278 != 9)
	{
		...
		func_27(&Global_93091, sParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_85789 = 0;
	}
}
...
void func_27(auto uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_102()
{
	switch (iLocal_74)
	{
		case 1:
			if (!func_122())
			{
				if (!is_help_message_being_displayed() && !func_121(&iLocal_62))
				{
					set_frontend_radio_active(0);
					func_119(&iLocal_62);
				}
				else if (!is_help_message_being_displayed() && func_121(&iLocal_62))
				{
					if (func_116(&iLocal_62) >= 2f)
					{
						iLocal_74 = 0;
					}
				}
...
int func_104(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
float func_116(int iParam0)
{
	if (func_121(iParam0))
	{
		...
		{
			return func_117(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
{
	*iParam0.f_1 = func_117(is_bit_set(*iParam0, 4)) - fParam1;
	...
	if (is_ped_in_any_vehicle(iParam0, 0))
	{
		...
		if (!is_entity_dead(iVar0, 0))
		{
			if (get_ped_in_vehicle_seat(iVar0, -1) == iParam0)
			{
				...
				{
					iLocal_275 = iVar0;
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_275) && !is_entity_dead(iLocal_275, 0))
					{
...
void func_125(auto uParam0, auto uParam1)
{
	*uParam0 -= (*uParam0 && uParam1);
}
...
void func_126(auto uParam0, int iParam1)
{
	if (!func_130(uParam0, 0, 1))
	{
		if (func_123(iParam1))
		{
			if (is_control_just_pressed(0, 86) || is_disabled_control_pressed(0, 86))
			{
				if ((((((!func_122() && !is_help_message_being_displayed()) && !func_98(0)) && !func_56(6)) && !func_56(7)) && !get_player_wanted_level(player_id()) > 0) && func_90() == 1)
				{
					func_115(&uLocal_84, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_115(&uLocal_84, 4, 0, "TOWDISPATCH", 0, 1);
					if (func_104(&uLocal_84, "TOWAUD", "TOW_JOBS_AVL", 4, 0, 0, 0))
					{
						if (!func_121(&iLocal_71))
						{
							func_127(&iLocal_71);
						}
						else
...
void func_128(int iParam0, Vector3 vParam1, Vector3 fParam2, auto uParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
	
	fVar0 = vdist2(vParam1, get_entity_coords(iParam0, 1));
	switch (iLocal_75)
	{
		case 0:
		...
		case 2:
			if (has_model_loaded(joaat("towtruck")))
			{
				if (!is_sphere_visible(vLocal_258, fLocal_261) || func_22(Global_101154.f_18663.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_275))
					{
						iLocal_275 = create_vehicle(joaat("towtruck"), vParam1, fParam4, 1, 1);
						set_model_as_no_longer_needed(joaat("towtruck"));
						iLocal_75 = 3;
					}
				}
		...
		case 3:
			if (is_ped_in_any_vehicle(iParam0, 0))
			{
				if (get_vehicle_ped_is_in(iParam0, 0) == iLocal_275)
				{
					iLocal_75 = 0;
				}
			}
...
void func_129(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4)
{
	switch (iParam0)
	{
		case 0:
...
bool func_130(auto uParam0, int iParam1, int iParam2)
{
	if (!iParam1)
	{
		if (func_98(9))
