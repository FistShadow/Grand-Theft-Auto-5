#region Local Var
	...
	auto uLocal_271 = 0;
	auto uLocal_272 = 0;
	Vector3[] vLocal_273 = new Vector3[4];
	...
	if (iLocal_306)
	{
		...
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_309)
		{
			...
			if (fLocal_311 > fVar0)
			{
				...
				{
					set_cam_motion_blur_strength(iLocal_296, fLocal_311);
				}
			}
			if (fLocal_312 > fVar2)
			{
...
void func_4()
{
	...
	{
		case 0:
			if ((func_58(vVar0, vVar3) && get_entity_heading(PLAYER::PLAYER_PED_ID()) >= func_57() - 90f) && get_entity_heading(PLAYER::PLAYER_PED_ID()) <= func_57() + 90f)
			{
				func_56();
		...
		case 2:
			...
			iLocal_297 = create_synchronized_scene(func_41(), func_40(), 2);
			task_synchronized_scene(PLAYER::PLAYER_PED_ID(), iLocal_297, func_69(), func_39(0), 1000f, -8f, 0, 0, 1000f, 0);
			play_synchronized_entity_anim(iLocal_41, iLocal_297, func_38(0), func_69(), 1000f, -8f, 0, 1000f);
			if (!_0x7F2F4F13AC5257EF(iLocal_297))
			{
				_0x394B9CD12435C981(iLocal_297, true);
			}
			if (get_follow_ped_cam_view_mode() != 4)
			{
				iLocal_296 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
				play_synchronized_cam_anim(iLocal_296, iLocal_297, func_35(0), func_69());
		...
		case 3:
			...
			hide_hud_and_radar_this_frame();
			CONTROLS::DISABLE_CONTROL_ACTION(0, 0, 1);
			if (get_synchronized_scene_phase(iLocal_297) > 0.95f)
			{
				iLocal_293 = 4;
			}
			else if (get_synchronized_scene_phase(iLocal_297) > 0.35f)
			{
				if (!iLocal_295)
				{
					set_entity_motion_blur(PLAYER::PLAYER_PED_ID(), 1);
		...
		case 4:
			...
			if (is_screen_faded_out())
			{
				...
				if (is_synchronized_scene_running(iLocal_297))
				{
					set_synchronized_scene_phase(iLocal_297, 1f);
				}
				if (does_cam_exist(iLocal_296))
				{
				...
				set_entity_coords(PLAYER::PLAYER_PED_ID(), vLocal_302, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_305);
		...
		case 5:
			...
			if (!is_synchronized_scene_running(iLocal_297))
			{
				...
				iLocal_297 = create_synchronized_scene(vVar9.x, vVar9.y, vVar9.z, 0f, 0f, fLocal_305, 2);
				task_synchronized_scene(PLAYER::PLAYER_PED_ID(), iLocal_297, func_69(), sLocal_300, 1000f, -4f, 0, 0, 1000f, 0);
				if (_0x7F2F4F13AC5257EF(iLocal_297))
				{
					_0x394B9CD12435C981(iLocal_297, false);
				}
				if (get_follow_ped_cam_view_mode() != 4)
				{
					iLocal_296 = create_cam("DEFAULT_ANIMATED_CAMERA", true);
					play_synchronized_cam_anim(iLocal_296, iLocal_297, sLocal_301, func_69());
					render_script_cams(true, false, 3000, 1, 0, 0);
				}
				else
				{
...
void func_18(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_48(player_id())) && !func_45(player_id(), 0)) && !func_44())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_48(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_50(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
bool func_58(Vector3 vParam0, float fParam1, auto uParam2, auto uParam3)
{
	if (is_player_playing(player_id()))
	{
		if ((!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_on_fire(PLAYER::PLAYER_PED_ID())) && is_player_control_on(player_id()))
		{
			if (!is_explosion_in_sphere(-1, vParam0, 2f))
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_62(0)) && !func_61())
				{
					...
					if (func_59(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return true;
					}
				}
...
bool func_64()
{
	if (request_ambient_audio_bank(func_65(), 0))
	{
		return true;
	}
	return false;
...
bool func_67()
{
	...
	if (!iLocal_294)
	{
		...
		if (!is_object_within_brain_activation_range(iLocal_41))
		{
			return false;
		}
	}
...
bool func_68()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
	{
		vVar0 = {get_entity_coords(iLocal_41, 1)};
		if (!is_entity_dead(iLocal_41, 0) && vVar0.z > 33f)
		{
			return true;
		}
	}
...
bool func_84(int iParam0)
{
	...
	if (is_player_playing(player_id()))
	{
		...
		{
			if (func_59(get_entity_coords(iLocal_41, 0), func_63(), 5f, 0))
			{
				return true;
			}
		}
		...
		else if (get_interior_from_entity(PLAYER::PLAYER_PED_ID()) == get_interior_from_entity(iParam0))
		{
			return true;
		}
	}
...
void func_95()
{
	...
	if (does_cam_exist(iLocal_296))
	{
		set_cam_motion_blur_strength(iLocal_296, 0f);
		destroy_cam(iLocal_296, 0);
	}
	func_96();
