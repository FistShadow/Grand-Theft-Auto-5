...
void func_1()
{
	...
	{
		case 0:
			if (!is_bit_set(Global_2454809.f_1, true))
			{
				func_35(&(Global_2454809.f_167));
				set_bit(&(Global_2454809.f_1), true);
			}
			else if (func_33(&(Global_2454809.f_167), Global_2454809.f_169, 0))
			{
				clear_bit(&(Global_2454809.f_1), true);
				func_32(1);
			}
			break;
			...
			switch (func_10(Global_2454809.f_3))
			{
				...
				case 1:
					...
					if (iVar3)
					{
						...
						{
							if (is_bit_set(Global_2454809.f_1, 4))
							{
								func_32(5);
							}
							else
		...
		case 5:
			if (Global_2454809.f_3 == 1)
			{
				if (is_bit_set(Global_2454809.f_1, 4))
				{
					if (!is_bit_set(Global_2454809.f_1, 3))
					{
						func_35(&(Global_2454809.f_165));
						set_bit(&(Global_2454809.f_1), 3);
					}
					else if (func_33(&(Global_2454809.f_165), Global_262145.f_45 * 120000, 0))
					{
						clear_bit(&(Global_2454809.f_1), 3);
						func_32(6);
					}
				}
				else
		...
		case 8:
			if (is_bit_set(Global_2454809.f_1, false))
			{
				func_32(0);
				clear_bit(&(Global_2454809.f_1), false);
			}
			else
			{
				Global_2454809.f_169 = Global_262145.f_6482;
				Global_2454809.f_8[Global_2454809.f_3 /*5*/].f_4 = 1;
				if (is_bit_set(Global_2454809.f_1, 2))
				{
					clear_bit(&(Global_2454809.f_1), 2);
				}
				if (is_bit_set(Global_2454809.f_1, 4))
				{
					clear_bit(&(Global_2454809.f_1), 4);
				}
				Global_2454809.f_3 = -1;
				Global_2454809.f_3.f_1 = 0;
				set_bit(&(Global_2454809.f_1), false);
			}
			break;
	}
}
...
int func_10(struct<2> Param0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
	...
	while (iVar0 < 30)
	{
		...
		{
			if (is_bit_set(vLocal_117[iVar0 /*3*/].f_1, false))
			{
				if (!is_bit_set(vLocal_117[iVar0 /*3*/].f_1, 4))
				{
					iLocal_108++;
				}
				if (Param0.f_1 == 18)
				...
				if (iLocal_108 >= func_11(Param0))
				{
					if (Param0.f_1 == 2)
					{
						if (!is_bit_set(Global_2454809.f_1, 2))
						{
							set_bit(&(Global_2454809.f_1), 2);
						}
					}
					return 1;
				}
			}
			else if (is_bit_set(vLocal_117[iVar0 /*3*/].f_1, true))
			{
			}
			else if (!is_bit_set(vLocal_117[iVar0 /*3*/].f_1, true))
			{
	...
	switch (vLocal_117[network_player_id_to_int() /*3*/].f_2)
	{
		case 0:
			if (Global_2454809.f_2 >= 4 && Global_2454809.f_2 != 8)
			{
				if (is_bit_set(Global_2454809.f_1, 2))
				{
					set_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), false);
					clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), true);
				}
				if (!is_bit_set(vLocal_117[network_player_id_to_int() /*3*/].f_1, true))
				{
					func_110(4);
				}
				else if (!is_bit_set(vLocal_117[network_player_id_to_int() /*3*/].f_1, 3))
				{
					func_35(&uLocal_109);
					set_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 3);
				}
				else
				{
					if (is_bit_set(iLocal_87, true))
					{
						iVar0 = 500;
					}
					if (func_33(&uLocal_109, iVar0, 0))
					{
						clear_bit(&iLocal_87, true);
						func_110(4);
						clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 3);
					}
				}
			}
			else if (is_bit_set(vLocal_117[network_player_id_to_int() /*3*/].f_1, true))
			{
				clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), true);
			}
			break;
		...
		case 4:
			if (is_bit_set(vLocal_117[network_player_id_to_int() /*3*/].f_1, false))
			{
				if (Global_2454809.f_2 == 8)
				{
					func_110(8);
					clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), false);
					clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 4);
				}
			...
			else
			{
				...
				if (((((((((((((((!network_is_in_tutorial_session() && !func_109(player_id())) && !func_108()) && !func_107()) && !func_106()) && !func_105()) && !func_103(player_id())) && !network_is_activity_session()) && !func_101(player_id())) && func_99()) && !func_98(player_id(), 0)) && !func_98(player_id(), 7)) && !func_98(player_id(), 21)) && (!func_95(player_id(), 0, 0) || Global_2454809.f_3 == 11)) && func_12(player_id(), 1, 1)) && !func_94(player_id()))
				{
					...
					{
						set_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 4);
					}
					switch (Global_2454809.f_3)
					{
						case 0:
							if (((func_81(0) && func_79(func_80(player_id()), 40f, 40f, 40f)) && get_entity_speed(player_ped_id()) < 10f) && !func_78())
							{
								iVar1 = 1;
							}
							else
				...
				{
					if (!func_99() && !is_bit_set(iLocal_87, false))
					{
						set_bit(&iLocal_87, true);
					}
					func_110(0);
					set_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), true);
					clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 4);
				}
			}
			break;
		...
		case 5:
			...
			{
				clear_bit(&(Global_2460486.f_202.f_1), true);
				clear_bit(&(Global_2460486.f_202.f_1), 2);
				clear_bit(&(Global_2460486.f_202.f_1), 3);
				func_110(6);
			}
			else if (is_bit_set(Global_2454809.f_1, 3) && func_51(&(Global_2454809.f_165)))
			{
				func_44();
			}
			break;
		...
		case 6:
			...
			else if (!is_bit_set(vLocal_117[network_player_id_to_int() /*3*/].f_1, 2))
			{
				Local_88.f_16 = -1;
				if (_get_number_of_instances_of_streamed_script(get_hash_key(sVar3)) == 0)
				{
					if (!network_is_script_active(sVar3, -1, 0, 0) || _0x3658E8CD94FC121A(sVar3, -1, 0) < 32)
					{
						if (!network_is_script_active(sVar3, -1, 1, 0))
						{
							...
							{
								set_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 2);
							}
						}
					}
				}
			}
			else if (_get_number_of_instances_of_streamed_script(get_hash_key(sVar3)) != 0)
			{
				if (Global_2454809.f_2 == 7)
				{
					func_110(7);
					set_bit(&iLocal_87, false);
					clear_bit(&(vLocal_117[network_player_id_to_int() /*3*/].f_1), 2);
				}
			}
			break;
...
bool func_40(struct<17> Param0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	char[32] cVar0;
	int iVar8;
	int iVar9;
...
void func_44()
{
	...
	{
		if (!is_bit_set(Global_2460486.f_202.f_1, true))
		{
...
int func_57()
{
	...
	if (!iVar0)
	{
		...
		{
			if (get_distance_between_coords(-1367.557f, -3220.598f, 12.9448f, vVar5, 1) >= 600f)
			{
				if (get_distance_between_coords(vVar5, vLocal_112, 1) >= 75f)
				{
	...
	if (iParam4 && !iParam7)
	{
		if (func_12(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_80(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_60(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (get_distance_between_coords(func_80(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
...
bool func_61(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_12(iVar1, iParam4, iParam5))
			{
				...
				{
					if (!iParam7 || (!is_ped_injured(get_player_ped(iVar1)) && func_60(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (get_distance_between_coords(func_80(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
bool func_67()
{
	if (is_entity_in_angled_area(player_ped_id(), 1216.995f, -3001.906f, 4.865235f, 835.3747f, -3013.846f, 54.7638f, 250f, 0, true, 0))
	{
		return true;
	}
	if (is_entity_in_angled_area(player_ped_id(), 1284.885f, -3184.986f, 4.906164f, 833.8964f, -3182.306f, 54.90125f, 250f, 0, true, 0))
	{
		return true;
	}
	if (is_entity_in_angled_area(player_ped_id(), 1284.793f, -3270.265f, 4.902858f, 838.3597f, -3268.248f, 55.07449f, 250f, 0, true, 0))
	{
		return true;
	}
	if (is_entity_in_angled_area(player_ped_id(), 864.6642f, -2900.037f, 4.900886f, 864.0037f, -3345.969f, 54.90067f, 250f, 0, true, 0))
	{
		return true;
	}
	if (is_entity_in_angled_area(player_ped_id(), 447.0059f, -2983.689f, 5.00868f, 750.05f, -2981.953f, 54.88502f, 250f, 0, true, 0))
	{
		return true;
	}
	return false;
...
bool func_78()
{
	...
	else if (is_entity_in_angled_area(player_ped_id(), 1284.885f, -3184.986f, 4.906164f, 833.8964f, -3182.306f, 54.90125f, 250f, 0, true, 0))
	{
		return true;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 1284.793f, -3270.265f, 4.902858f, 838.3597f, -3268.248f, 55.07449f, 250f, 0, true, 0))
	{
		return true;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 864.6642f, -2900.037f, 4.900886f, 864.0037f, -3345.969f, 54.90067f, 250f, 0, true, 0))
	{
		return true;
	}
	else if (is_entity_in_angled_area(player_ped_id(), 447.0059f, -2983.689f, 5.00868f, 750.05f, -2981.953f, 54.88502f, 250f, 0, true, 0))
	{
		return true;
	}
	return false;
...
bool func_79(vector3 vParam0, vector3 vParam1)
{
	...
	{
		if (is_entity_at_coord(player_ped_id(), vVar0, vParam3, false, true, 0))
		{
			return true;
		}
	}
...
{
	return is_bit_set(Global_1610316[uParam0 /*174*/].f_1, 2);
}
...
void func_129(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_128();
