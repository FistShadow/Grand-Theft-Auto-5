	...
	switch (*iParam0.f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (is_ped_in_any_vehicle(player_ped_id(), 0))
				{
					if (func_179(get_vehicle_ped_is_in(player_ped_id(), 0)))
					{
...
bool func_171(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_179(player_ped_id()) && func_179(*iParam0.f_28[0])) && !func_129()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_175(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_176(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_159(2))
	{
		if (!func_129())
		{
			if (((func_179(player_ped_id()) && func_179(*iParam0.f_28[0])) && get_game_timer() - *iParam0.f_60 > iParam8) && func_175(player_ped_id(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_174(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
				func_172(&uVar0, sParam4, sParam5, 7, 0, 0);
	...
	if (func_179(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				...
				{
					if (func_190(iParam2) && !is_ped_facing_ped(iParam0, player_ped_id(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, player_ped_id(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_191(uParam1) && *uParam1.f_4 == 0) && get_distance_between_coords(get_entity_coords(player_ped_id(), 1), get_entity_coords(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_190(iParam2) || is_ped_facing_ped(iParam0, player_ped_id(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						task_play_anim(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (does_entity_exist(*uParam0.f_35[iVar0]))
			{
				...
				if (iParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_197(player_ped_id(), *uParam0.f_35[iVar0]))
							{
...
bool func_200(int iParam0, float fParam1)
{
	...
	if (func_179(player_ped_id()) && func_179(iParam0))
	{
...
{
	return func_202(iParam0, player_ped_id(), fParam1, 1, 250, 7);
}
