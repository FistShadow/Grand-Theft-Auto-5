...
void func_1()
{
	...
	if (iLocal_219)
	{
		...
		{
			if ((((!func_171() && !is_ped_fleeing(iLocal_53)) && !PED::IS_PED_RAGDOLL(iLocal_53)) && !is_ped_prone(iLocal_53)) && !PED::IS_PED_INJURED(iLocal_53))
			{
	...
	if (is_player_playing(player_id()) && func_157(0))
	{
		switch (iLocal_222)
		{
			...
			case 2:
				if ((func_37(PLAYER::PLAYER_PED_ID(), 12, iLocal_47) && is_player_control_on(player_id())) && !is_help_message_being_displayed())
				{
			...
			case 3:
				...
				else if (!func_34(14))
				{
					...
					if (func_131(iLocal_223, iLocal_225))
					{
						...
						Global_101154.f_8739.f_105 += iVar4;
						iLocal_224 = func_146();
						iLocal_225 = func_146();
						func_138(&iLocal_225, 0, 0, 1, 0, 0, 0);
...
void func_6()
{
	...
	{
		if (func_128(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_9(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_10(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (iParam7 == 1)
		{
			Global_2990 = iParam6;
...
bool func_10(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_14572)
	{
		if (Global_14413.f_1 == 6)
		{
			...
			func_11(1);
			func_14(Global_14394, "DISPLAY_VIEW", 1f, to_float(Global_14393), -1082130432, -1082130432, -1082130432);
		}
	}
	return true;
}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (Global_2443081)
							{
								if (iVar1 == 14)
								{
									func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16775), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2852[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16780), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_69489)
								{
									...
									func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14413)
									...
									func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar5), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2290[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar8), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_12(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(false), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2852[iVar0] = 1;
						}
					}
...
void func_21(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_22(Vector3 fParam0, float fParam1, float fParam2)
{
	float fVar0;
...
{
	return shift_right(iParam0, 26) & 31 * func_28(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_30()
{
	if (((!func_33() && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !is_ambient_speech_playing(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_49 == 1)
		{
...
bool func_37(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_38(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_38(iParam1)))
	{
		return true;
	}
	return false;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_38(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_38(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_55(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_55(vVar16.z)] = func_51(iParam1, vVar16.x, func_55(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_55(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_59(int iParam0)
{
	...
	func_60(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_60(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_70(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_63(func_66(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_61(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_63(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_61(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_63(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_64(iParam1)];
...
int func_67(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_68(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_71(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_60(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_38(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_60(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_133(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_139(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_148(int iParam0)
{
	...
	if (!Global_46152[iVar0 /*203*/].f_10[iVar2 /*48*/].f_1)
	{
		...
		MemCopy(&Var3, {func_153(Global_36852[uVar7 /*12*/].f_1)}, 4);
	}
	else
	{
...
void func_149(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	iVar0 = func_5();
	iVar1 = false;
	StringCopy(&cVar2, func_152(iParam1, &iVar1), 64);
	if (iVar0 == iParam0)
	{
		switch (iParam2)
		{
...
bool func_154(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar1 < Global_46152[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_155(Global_46152[iVar0 /*203*/].f_4[iVar1], Global_46152[iVar0 /*203*/].f_1, 1, iParam2, 0);
		}
		iVar1++;
	}
	return true;
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iParam2)
	{
		...
		iVar2 = uVar20;
		Var3 = {func_153(Global_36852[uVar20 /*12*/].f_1)};
	...
	else
	{
		...
		{
			Var3 = {func_153(Global_36852[uVar26 /*12*/].f_1)};
		}
	}
	if (!iParam4)
	{
...
bool func_161(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_169(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_181()
{
	...
	{
		func_185(13, floor(Global_101154.f_8884.f_3853));
	}
...
bool func_187(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
