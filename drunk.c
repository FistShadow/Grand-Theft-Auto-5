...
void main()
{
	...
	while (true)
	{
		...
		func_130();
		func_6();
		if ((network_is_game_in_progress() && !network_is_activity_session()) && !func_5())
		{
			func_1();
		}
	}
...
void func_9(char* sParam0, var uParam1, char* sParam2)
{
	...
	*uParam1.f_33 = 0;
	...
	if (!is_entity_dead(player_ped_id(), 0))
	{
		...
		func_38(player_ped_id(), *uParam1.f_18);
	...
	if (!is_string_null_or_empty(uParam1.f_11))
	{
		...
		func_36(&uVar9, iVar175, player_ped_id(), sVar176, 0, 1);
	}
			...
			if (get_follow_ped_cam_view_mode() == 4 && *uParam1.f_52 > 0f)
			{
				if (fVar0 >= *uParam1.f_52)
				{
					if (!*uParam1.f_32)
					{
						...
						func_17(uParam1.f_34, player_ped_id(), func_57(), 1E-06f, 300, 300, 0, 0, 1045220557);
...
void func_17(var uParam0, int iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	*uParam0.f_5 = iParam1;
	*uParam0.f_6 = uParam2;
...
var func_90(int iParam0, float fParam1, float fParam2)
{
	Vector3 fVar0;
	Vector3 fVar1;
	int iVar2;
