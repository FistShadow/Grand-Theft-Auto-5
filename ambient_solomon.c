...
void main()
{
	...
	while (true)
	{
		...
		vLocal_246 = {get_entity_forward_vector(PLAYER::PLAYER_PED_ID())};
		if (get_player_wanted_level(player_id()) == 0)
		{
			func_57(&uLocal_235);
			func_3(&uLocal_236);
			if (func_2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 7, 0, 0))
			{
				func_60(65, 1);
				func_1(30);
				func_70();
...
bool func_2(Vector3 vParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				fVar1 = acos(func_50(vLocal_246, 0.73f, 0.683f, -0.013f));
				if (absf(fVar1) < 25f)
				{
					if (func_51(iVar2, -1211.774f, -580.9299f, 26.33095f, -1208.127f, -585.3617f, 29.66056f, 4.5f))
					{
						fLocal_237 = 3f;
						*uParam0++;
					}
		...
		case 2:
			...
			if (func_47(-1210.152f, -578.0859f, 26.7238f))
			{
				...
				if (func_45())
				{
					iVar0 = func_34(&uLocal_70, "AMSOLAU", "AMSOL_HERE", 8, 0, 0, 0);
				}
				else
				{
					iVar0 = func_34(&uLocal_70, "AMSOLAU", "AMSOL_WORK", 8, 0, 0, 0);
				}
				if (iVar0)
				{
					*uParam0++;
		...
		case 4:
			if (!is_scripted_speech_playing(PLAYER::PLAYER_PED_ID()) && !is_scripted_conversation_ongoing())
			{
		...
		case 6:
			func_4(&iLocal_241, -1206.84f, -583.2034f, 26.1738f, 311.4116f);
			*uParam0++;
			break;
...
void func_44(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_46(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_47(Vector3 vParam0)
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (is_ped_model(uVar2[iVar1], iLocal_249))
			{
...
float func_50(struct<2> Param0, auto uParam1, struct<2> Param2, float fParam3)
{
	return Param0 * Param3 + Param0.f_1 * Param3.f_1;
}

bool func_51(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	struct<2> Var3;
	struct<2> Var6;
	
	if (is_entity_in_angled_area(iParam0, vParam1, vParam4, fParam7, 0, true, 0))
	{
		return true;
	}
	...
	get_model_dimensions(ENTITY::GET_ENTITY_MODEL(iParam0), &Var3, &Var6);
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, Var3, Var6.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, 0f, Var6.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, Var6, Var6.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, Var3, Var3.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, 0f, Var3.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
	vVar0 = {get_offset_from_entity_in_world_coords(iParam0, Var6, Var3.f_1, 0f)};
	if (is_point_in_angled_area(vVar0, vParam1, vParam4, fParam7, 0, true))
	{
		return true;
	}
...
void func_57(auto uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar2 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
				fVar1 = acos(func_50(vLocal_246, -0.37f, -0.927f, -0.053f));
				if (absf(fVar1) < 45f)
				{
					if (func_51(iVar2, -1049.318f, -473.7472f, 34.94196f, -1059.483f, -468.7608f, 39.94483f, 4.5f))
					{
						fLocal_237 = 1f;
						*uParam0++;
					}
		...
		case 6:
			func_4(&iLocal_239, -1051.956f, -472.055f, 35.5672f, 161.4418f);
			*uParam0++;
			break;
...
{
	func_68(PLAYER::PLAYER_PED_ID());
	if (_get_number_of_instances_of_streamed_script(joaat("solomon1")) > 0)
	{
		func_1(30);
		func_60(65, 1);
		func_70();
...
void func_70()
{
	func_53(&iLocal_239);
	func_53(&iLocal_241);
	func_71(&iLocal_244, 0, 0, 1);
	func_71(&iLocal_245, 0, 0, 1);
	func_60(65, 1);
