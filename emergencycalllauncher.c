...
void func_7()
{
	switch (iLocal_44)
	{
		...
		case 1:
			if (_get_number_of_instances_of_streamed_script(joaat("emergencycall")) == 0)
			{
				if (!func_27(130))
				{
					iLocal_43 = 1;
...
int func_8(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
...
void func_24(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
{
	Global_25343 = 1;
	StringCopy(&Global_25344, get_this_script_name(), 24);
}
