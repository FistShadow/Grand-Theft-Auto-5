#region Local Var
	...
	Vector3 vLocal_197 = 0;
	Vector3 vLocal_200 = 0;
	int iLocal_203 = 0;
	int iLocal_204 = 0;
	int iLocal_205 = 0;
	int iLocal_206 = 0;
	int iLocal_207 = 0;
	char*[] sLocal_208 = new char*[3];
	char* sLocal_212 = 0;
	auto uLocal_213 = 16;
	auto uLocal_214 = 0;
	auto uLocal_215 = 0;
...
void func_22()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				task_look_at_coord(PLAYER::PLAYER_PED_ID(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
		...
		case 2:
			...
			{
				func_21(&iLocal_192);
				if (func_42(&uLocal_382, &sLocal_378, &uLocal_213))
				{
					func_41(0, -1);
...
bool func_42(auto uParam0, char* sParam1, auto uParam2)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<15> Var0;
	int iVar15;
...
int func_59(auto uParam0, auto uParam1, auto uParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
...
void func_68(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_71(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_78(int iParam0, Vector3 vParam1, int iParam2, int iParam3, char* sParam4)
{
	if (!does_blip_exist(*iParam0))
	{
...
int func_79(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
auto func_80(char* sParam0, int iParam1, char* sParam2)
{
...
int func_87(int iParam0, Vector3 vParam1, float fParam2)
{
...
void func_89(int iParam0, Vector3 vParam1, Vector3 fParam2)
{
	if (func_192(iParam0))
	{
...
int func_90(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_91(int iParam0, Vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			request_additional_text(sLocal_188, false);
...
bool func_92(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_108(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
bool func_109(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_115(*iParam1, 0, &uVar0))
		{
...
bool func_111(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_112(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_114(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_115(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	if (!func_117(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
void func_120(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_121(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_136(iParam0, 0, 0)) || func_136(iParam0, 1, 0)) || func_136(iParam0, 2, 0)) || func_135(iParam0) != 145) || func_134(iParam0)) || func_133(iParam0)) || func_116(iParam0)) || func_132(iParam0)) || !func_124(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_133(iParam0))
		{
		}
...
bool func_136(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_137(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_137(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_141(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_144(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_143(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_143(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_142(*iParam0))
	{
...
bool func_145(auto uParam0, int iParam1)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_146(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_147(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_148(iParam0, iParam1))
				{
...
void func_153(auto uParam0, auto uParam1)
{
...
int func_157(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_158(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_159(Vector3 vParam0, Vector3 fParam1)
{
	return func_160(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_160(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
...
bool func_162(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_163(iParam0, uVar1[iVar6], 1) && func_92(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_158(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_164(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_121(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(*uParam1.f_77, 15) || func_167(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_166())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
...
bool func_180()
{
	...
	if (!func_181(iLocal_190, iVar0) && !iLocal_190)
	{
		return false;
	}
	return true;
...
void func_189(char* sParam0, char* sParam1, char* sParam2)
{
...
bool func_195(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_200() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_200() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_199(iParam0));
...
int func_202(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_200() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_206(auto uParam0, int iParam1)
{
	int iVar0;
...
bool func_207(auto uParam0, int iParam1)
{
	int iVar0;
...
int func_208(auto uParam0, int iParam1)
{
...
void func_211(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
auto func_212(auto uParam0)
{
	return *uParam0.f_72;
}

int func_213(auto uParam0, int iParam1)
{
...
void func_222(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_223())
	{
...
int func_226(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_229(int iParam0)
{
	...
	func_230(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_230(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_236(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_233(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_231(iParam1, *uParam0.f_2, &uVar1))
			{
...
int func_231(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_234(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_237(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_230(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_238(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_230(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_296(auto uParam0, auto uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0.f_46 = *uParam1.f_46;
	while (iVar1 < *uParam1.f_46)
	{
		...
		if (func_297(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = {-vVar9};
		}
...
int func_297(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_299(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
