...
void main()
{
	...
	while (true)
	{
		...
		if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && network_is_activity_session()) && !func_40())
		{
		...
		else
		{
			...
			switch (iLocal_150)
			{
				...
				case 1:
					Local_47.f_3.f_26 = 1;
					if (iLocal_151 == 0 && !GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_39.f_18, 30))
					{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_39.f_18, 29))
						{
							if (func_2())
							{
								func_1();
...
bool func_6()
{
	if (GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_39.f_18, 30))
	{
		return false;
	}
	if (GAMEPLAY::IS_BIT_SET(Global_1587523[player_id() /*444*/].f_39.f_18, 29))
	...
	if (((((((((((((((func_28() == 0 && !func_27()) && !func_2()) && !func_26()) && !func_25()) && !func_24()) && !func_23()) && !func_22()) && !func_21()) && func_18()) && func_12()) && Global_1587523[player_id() /*444*/].f_87 != 8) && Global_1587523[player_id() /*444*/].f_87 != 9) && !func_10(player_id())) && !func_9()) && !func_7(player_id(), 1, 0))
	{
		return true;
	}
	return false;
...
bool func_42(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	*uParam0.f_3.f_26 = 1;
	switch (*uParam0)
	{
...
bool func_45(auto uParam0, auto uParam1, int iParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	int iVar0;
	int iVar1;
	...
	switch (*uParam0.f_4)
	{
		...
		case 2:
			if ((_0xD53ACDBEF24A46E8() || _0x941E5306BCD7C2C7()) && _0xE0A6138401BCB837() > 0)
			{
				*uParam0.f_10 += _0xE0A6138401BCB837();
				*uParam0.f_7 = 0;
								...
								switch (iParam4)
								{
									...
									case 0:
										switch (iParam2)
										{
											case 0:
											case 1:
												func_96(uParam0, iParam2, 0, iParam8, iParam10, 0);
												break;
											
											case 8:
												func_96(uParam0, iParam2, 31, iParam8, iParam10, 1);
												break;
											
											case 7:
											case 2:
												func_62(uParam0, iParam8);
												break;
										}
										break;
								}
						...
						case 0:
							switch (iParam4)
							{
								...
								case 2:
									...
									{
										func_32(uParam0, 1, 1);
										Global_794608.f_3 = _get_posix_time();
										func_242();
										_0xE9B99B6853181409();
										*uParam0 = 1;
										return true;
								...
								case 4:
									if (*uParam0.f_9 > 200)
									{
										...
										if (iParam10)
										{
											Global_927910.f_2 = _get_posix_time();
										}
										else
										{
											Global_906487.f_2 = _get_posix_time();
										}
										func_242();
										_0xE9B99B6853181409();
										*uParam0 = 1;
			...
			if (_0x02ADA21EA2F6918F())
			{
				if (_0x941E5306BCD7C2C7())
				{
					...
					if (iParam4 == 1)
					{
						Global_794608.f_1 = _0x3A17A27D75C74887();
						iVar1 = *uParam0.f_9;
						if (iVar1 == 0)
						{
							iVar1 = *uParam0.f_13;
					...
					func_51(iParam5, iParam2, iParam4, *uParam0.f_13, iParam10);
					func_32(uParam0, 1, 1);
					*uParam0 = 1;
					return true;
				}
				...
				{
					func_51(iParam5, iParam2, iParam4, *uParam0.f_9, iParam10);
					func_32(uParam0, 1, 1);
					*uParam0.f_40 = _0xEDF7F927136C224B();
					*uParam0 = 0;
					return true;
...
void func_46(int iParam0)
{
	...
	if (iParam0)
	{
		...
		while (iVar0 < iVar4)
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Global_1572884[iVar1], iVar2))
			{
				iVar3 = iVar0;
				while (iVar3 <= iVar4 - 2)
				{
				...
				GAMEPLAY::CLEAR_BIT(&(Global_1572884[iVar1]), iVar2);
				return;
			}
			GAMEPLAY::CLEAR_BIT(&(Global_1572884[iVar1]), iVar2);
			iVar0++;
...
bool func_47(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
	}
	func_48(uParam0, iParam2, 0);
...
void func_48(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_1 == 0)
	{
				...
				case 0:
					switch (iParam1)
					{
						...
						case 1:
							if (iParam4)
							{
								func_239(&Global_954863, 1, 1, 0, iParam3, iParam4);
							}
							else
							{
						...
						case 8:
							if (iParam4)
							{
								func_239(&Global_960393, 1, 1, 0, iParam3, iParam4);
								iVar0 = 0;
								while (iVar0 < 62)
								{
									Global_960393.f_5462[iVar0] = 0;
...
void func_53(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_57(*uParam0.f_24, *uParam0.f_25, _get_content_user_id(*uParam0.f_7), _get_content_category(*uParam0.f_7)))
	{
		func_243();
		return;
	}
	...
	{
		if (func_55(_get_content_user_id(*uParam0.f_7)))
		{
			func_243();
			return;
		}
	...
	{
		iVar51 = _object_value_get_boolean(iVar1, "open");
		if (!iVar51)
		{
			func_243();
			return;
	...
	StringCopy(&(Global_974329.f_354[*uParam0.f_9 /*16*/]), _object_value_get_string(iVar1, "crewnm"), 64);
	StringCopy(&(Global_974329[*uParam0.f_9 /*16*/]), _0xBF09786A7FCAB582(*uParam0.f_7), 64);
	StringCopy(&(Global_974329.f_257[*uParam0.f_9 /*6*/]), _get_content_id(*uParam0.f_7), 24);
	Global_974329.f_884[*uParam0.f_9] = _object_value_get_integer(iVar1, "cash");
	Global_974329.f_901[*uParam0.f_9] = _object_value_get_integer(iVar2, "scr");
	Global_974329.f_918[*uParam0.f_9] = _object_value_get_integer(iVar2, "time");
	Global_974329.f_936 = *uParam0.f_9 + 1;
	if (!is_string_null_or_empty(&(Global_974329[*uParam0.f_9 /*16*/])) && !is_string_null_or_empty(&(Global_974329.f_257[*uParam0.f_9 /*6*/])))
	{
		*uParam0.f_9++;
	}
	func_243();
...
bool func_57(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	struct<13> Var0;
	struct<13> Var13;
...
void func_60(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar2 = _get_root_object();
	iVar3 = _object_value_get_array(iVar2, "list");
	if (iParam2)
	{
		iVar0 = _object_value_get_boolean(iVar2, "h2h");
		iVar1 = _object_value_get_boolean(iVar2, "ch");
		if (iVar0)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_1865, *uParam0.f_9);
		}
		if (iVar1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_1866, *uParam0.f_9);
		}
	}
...
void func_61(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam2)
	{
		...
		if (iVar0)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_937, *uParam0.f_9);
		}
		if (iVar1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_938, *uParam0.f_9);
		}
	}
	iVar4 = _array_value_get_size(iVar3);
	if (iVar4 != 0)
...
void func_62(auto uParam0, int iParam1)
{
	...
	if (iParam1 == 0)
	{
		...
		iVar5 = _object_value_get_integer(iVar2, "rank");
		if (iVar5 > 1000)
		{
			if (_get_root_object() != 0)
			{
		...
		if (_object_value_get_integer(iVar2, "charcon") != 0)
		{
			func_243();
			return;
		}
	...
	Var6.f_66 = -1;
	Var6.f_67 = 2;
	Global_965923.f_1[uVar3 /*88*/] = {Var6};
	Global_965923.f_1[uVar3 /*88*/].f_65 = iVar4;
	Global_965923.f_1[uVar3 /*88*/].f_56 = {func_94(iVar2, "start")};
	if (_object_value_get_type(iVar2, "cam") == 5)
	{
		Global_965923.f_1[uVar3 /*88*/].f_59 = {func_94(iVar2, "cam")};
	}
	else if (_object_value_get_type(iVar2, "cam") == 6)
	{
		iVar94 = _object_value_get_object(iVar2, "cam");
		if (_object_value_get_type(iVar94, "x") == 2)
		{
			Global_965923.f_1[uVar3 /*88*/].f_59 = to_float(_object_value_get_integer(iVar94, "x"));
		}
		else
		{
			Global_965923.f_1[uVar3 /*88*/].f_59 = _object_value_get_float(iVar94, "x");
		}
		if (_object_value_get_type(iVar94, "y") == 2)
		{
			Global_965923.f_1[uVar3 /*88*/].f_59.f_1 = to_float(_object_value_get_integer(iVar94, "y"));
		}
		else
		{
			Global_965923.f_1[uVar3 /*88*/].f_59.f_1 = _object_value_get_float(iVar94, "y");
		}
		if (_object_value_get_type(iVar94, "z") == 2)
		{
			Global_965923.f_1[uVar3 /*88*/].f_59.f_2 = to_float(_object_value_get_integer(iVar94, "z"));
		}
		else
		{
			Global_965923.f_1[uVar3 /*88*/].f_59.f_2 = _object_value_get_float(iVar94, "z");
		}
	}
	Global_965923.f_1[uVar3 /*88*/].f_62 = {func_93(iVar2)};
	Global_965923.f_1[uVar3 /*88*/].f_69 = _object_value_get_integer(iVar2, "min");
	Global_965923.f_1[uVar3 /*88*/].f_71 = _object_value_get_integer(iVar2, "num");
	if (Global_965923.f_1[uVar3 /*88*/].f_71 == -1)
	{
		Global_965923.f_1[uVar3 /*88*/].f_71 = 30;
	}
	StringCopy(&(Global_965923.f_1[uVar3 /*88*/].f_22), _0xBF09786A7FCAB582(*uParam0.f_7), 64);
	Global_965923.f_1[uVar3 /*88*/].f_81 = _get_content_category(*uParam0.f_7);
	Global_965923.f_1[uVar3 /*88*/].f_68 = _object_value_get_integer(iVar2, "subtype");
	Global_965923.f_1[uVar3 /*88*/].f_80 = _object_value_get_integer(iVar2, "adverm");
	Global_965923.f_1[uVar3 /*88*/].f_70 = _object_value_get_integer(iVar2, "rank");
	Global_965923.f_1[uVar3 /*88*/].f_73 = func_92(_0x1ACCFBA3D8DAB2EE(*uParam0.f_7, 0), _0x759299C5BB31D2A9(*uParam0.f_7, 0));
	StringCopy(&(Global_965923.f_1[uVar3 /*88*/]), _get_content_id(*uParam0.f_7), 24);
	Global_965923.f_1[uVar3 /*88*/].f_55 = _0xAEAB987727C5A8A4(*uParam0.f_7);
	if (func_91() != 2)
	{
	...
	StringCopy(&(Global_965923.f_1[uVar3 /*88*/].f_6), _0x703F12425ECA8BF5(*uParam0.f_7), 64);
	_0xCFD115B373C0DF63(*uParam0.f_7, &(Global_965923.f_1[uVar3 /*88*/].f_82));
	Global_965923.f_2730[uVar3] = 0;
	if (!func_273())
	{
		if (_0xF53E48461B71EECB(_0x32DD916F3F7C9672(*uParam0.f_7)))
		{
			Global_965923.f_1[uVar3 /*88*/].f_54 = _get_content_description_hash(*uParam0.f_7);
		}
		else
		{
			Global_965923.f_1[uVar3 /*88*/].f_54 = -1;
		}
		Global_965923.f_1[uVar3 /*88*/].f_67 = func_90(*uParam0.f_7);
		Global_965923.f_1[uVar3 /*88*/].f_66 = _get_content_file_version(*uParam0.f_7, Global_965923.f_1[uVar3 /*88*/].f_67);
		if (_0x70EA8DA57840F9BE(*uParam0.f_7))
		{
			Global_965923.f_2730[uVar3] = _0x993CBE59D350D225(*uParam0.f_7);
		}
	}
	Global_965923.f_1[uVar3 /*88*/].f_75 = _object_value_get_integer(iVar2, "charcon");
	Global_965923.f_1[uVar3 /*88*/].f_72 = _object_value_get_integer(iVar2, "tnum");
	func_89(Global_965923.f_1[uVar3 /*88*/].f_65, &(Global_965923.f_1[uVar3 /*88*/].f_71), &(Global_965923.f_1[uVar3 /*88*/].f_69));
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_965923.f_1[uVar3 /*88*/].f_76), 13);
	GAMEPLAY::CLEAR_BIT(&(Global_965923.f_1[uVar3 /*88*/].f_76), 15);
	GAMEPLAY::CLEAR_BIT(&(Global_965923.f_1[uVar3 /*88*/].f_76), 18);
	...
	{
		GAMEPLAY::CLEAR_BIT(&(Global_965923.f_1[uVar3 /*88*/].f_76), 13);
	}
	if (func_63(Global_965923.f_1[uVar3 /*88*/].f_56))
	{
		GAMEPLAY::CLEAR_BIT(&(Global_965923.f_1[uVar3 /*88*/].f_76), 13);
	}
	Global_965923++;
...
void func_89(int iParam0, auto uParam1, auto uParam2)
{
	if (iParam0 == 1)
	{
		if (*uParam2 < 2)
...
void func_96(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam1 != 0 && iParam1 != 1)
	{
		...
		if (!func_57(*uParam0.f_24, *uParam0.f_25, _get_content_user_id(*uParam0.f_7), _get_content_category(*uParam0.f_7)))
		{
			if (iParam5 && is_durango_version())
			{
				iVar1 = iVar0 % 32;
				iVar2 = floor(to_float(iVar0) / 32f);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1572884[iVar2]), iVar1);
				Var3 = {func_56(_get_content_user_id(*uParam0.f_7))};
				if (iParam4)
				{
					Global_960393.f_5462[iVar0] = _0xDEB2B99A1AF1A2A6(&Var3);
				}
				else
				{
					Global_949333.f_5462[iVar0] = _0xDEB2B99A1AF1A2A6(&Var3);
				}
			}
			else
			{
	...
	if (iParam4)
	{
		if (iParam5)
		{
			if (func_189(uParam0, &(Global_960393.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, iParam5))
			{
				Global_960393++;
				*uParam0.f_9++;
			}
		...
		else if (func_189(uParam0, &(Global_954863.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0))
		{
			...
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_954863.f_5[iVar0 /*88*/].f_76), 16);
			*uParam0.f_9++;
		}
	}
	else if (iParam3)
	...
	else if (func_189(uParam0, &(Global_949333.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0))
	{
		...
		{
			Global_949333.f_4++;
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_949333.f_5[iVar0 /*88*/].f_76), 16);
		}
		*uParam0.f_9++;
	}
	if (_get_root_object() != 0)
...
void func_98(struct<16> Param0)
{
	...
	uVar0 = func_99(4);
	Global_2411218[uVar0 /*83*/] = 4;
	Global_2411218[uVar0 /*83*/].f_1 = {Param0};
	StringCopy(&(Global_2411218[uVar0 /*83*/].f_18[0 /*16*/]), "-FromLiveArea", 64);
	StringCopy(&(Global_2411218[uVar0 /*83*/].f_18[1 /*16*/]), "-LiveAreaContentType=UGC_TYPE_GTA5_MISSION", 64);
	StringCopy(&(Global_2411218[uVar0 /*83*/].f_18[2 /*16*/]), "-LiveAreaLoadContent=", 64);
	MemCopy(&(Global_2411218[uVar0 /*83*/].f_18[3 /*16*/]), {Global_1617379.f_70652}, 16);
}
...
bool func_104(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
	{
		if (func_107(iParam1, Global_69311[1 /*14*/].f_2, &iVar0))
		{
			...
			if (iParam3)
			{
				GAMEPLAY::CLEAR_BIT(&iVar1, Global_69311[1 /*14*/].f_1);
			}
			else
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&iVar1, Global_69311[1 /*14*/].f_1);
			}
...
int func_107(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
void func_110(int iParam0)
{
	...
	func_111(&(Global_69311[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_111(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_118(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			if (func_107(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_106(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_114(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_115(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_116(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_106(uVar2, iVar0, 0);
		return GAMEPLAY::IS_BIT_SET(iVar3, iVar1);
	}
	return false;
}

int func_116(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_120(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_111(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_121(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_111(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_122(int iParam0)
{
	...
	func_111(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_156(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > -1)
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, func_160(iVar1));
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&iVar0, func_160(iVar1));
		}
...
auto func_161(int iParam0, int iParam1)
{
	auto uVar0;
...
int func_170(auto uParam0)
{
	...
	iVar0 = func_169(uParam0);
	iVar1 = uParam0;
	return GAMEPLAY::IS_BIT_SET(iVar0, func_160(iVar1));
}
...
void func_171(int iParam0, int iParam1)
{
	...
	if (iVar0 > -1)
	{
		if (iParam1)
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2467971.f_1027[func_159(iVar0)]), func_160(iVar0));
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_2467971.f_1027[func_159(iVar0)]), func_160(iVar0));
		}
	}
}
...
auto func_181(auto uParam0, int iParam1)
{
	auto uVar0;
...
bool func_189(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<88> Var0;
	int iVar88;
	int iVar89;
	...
	Var0.f_67 = 2;
	*sParam1 = {Var0};
	iVar88 = _get_root_object();
	iVar89 = _object_value_get_object(iVar88, "mission");
	iVar90 = _object_value_get_object(iVar89, "gen");
	if (Global_262145.f_5036 == 0)
	{
	...
	if (iParam3)
	{
		if (!_0x3054F114121C21EA(*uParam0.f_7))
		{
			...
			{
				iVar91 = _object_value_get_integer(iVar90, "optbs");
	...
	*sParam1.f_73 = func_92(_0x1ACCFBA3D8DAB2EE(*uParam0.f_7, 0), _0x759299C5BB31D2A9(*uParam0.f_7, 0));
	...
	*sParam1.f_55 = _0xAEAB987727C5A8A4(*uParam0.f_7);
	...
	if (iParam3 || iParam5)
	{
		if (!_0x3054F114121C21EA(*uParam0.f_7))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(sParam1.f_76, 29);
		}
	}
	...
	if (iParam2 == 0 && !iParam5)
	{
		...
		iVar93 = _0x87E5C46C187FE0AE(*uParam0.f_7, 1);
		Global_949333.f_5525 += iVar93;
	...
	*sParam1.f_72 = _object_value_get_integer(iVar90, "tnum");
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(sParam1.f_76, 13);
	...
	if (!func_273())
	{
		if (_0x70EA8DA57840F9BE(*uParam0.f_7))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(sParam1.f_76, 14);
		}
	}
	return true;
}

void func_190(auto uParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]) = {Var3};
	if (!func_273())
	{
		...
		*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_66 = _get_content_file_version(*uParam1.f_7, *(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_67);
		*(uParam0.f_18805[*uParam1.f_9 /*12*/]).f_5 = _0x32DD916F3F7C9672(*uParam1.f_7);
	}
	...
	*(uParam0.f_1204[*uParam1.f_9 /*88*/].f_62) = {func_93(iVar2)};
	...
	{
		*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_76 = _object_value_get_integer(iVar2, "optbs");
	}
	if (!func_273())
	{
		if (_0xF53E48461B71EECB(_0x32DD916F3F7C9672(*uParam1.f_7)))
		{
			*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_54 = _get_content_description_hash(*uParam1.f_7);
		}
		else
		{
	...
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_69 = _object_value_get_integer(iVar2, "min");
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_71 = _object_value_get_integer(iVar2, "num");
	if (*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_71 == -1)
	{
		*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_71 = 30;
	}
	StringCopy(uParam0.f_1204[*uParam1.f_9 /*88*/].f_22, _0xBF09786A7FCAB582(*uParam1.f_7), 64);
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_65 = _object_value_get_integer(iVar2, "type");
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_68 = _object_value_get_integer(iVar2, "subtype");
	StringCopy(uParam0.f_1204[*uParam1.f_9 /*88*/].f_6, _get_content_user_id(*uParam1.f_7), 64);
	...
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_70 = _object_value_get_integer(iVar2, "rank");
	*uParam0.f_18805[*uParam1.f_9 /*12*/] = _object_value_get_integer(iVar2, "tnum");
	if (!func_273())
	{
		*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_73 = func_92(_0x1ACCFBA3D8DAB2EE(*uParam1.f_7, 0), _0x759299C5BB31D2A9(*uParam1.f_7, 0));
	...
	*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_78 = _object_value_get_integer(iVar2, "ltm");
	func_89(*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_65, uParam0.f_1204[*uParam1.f_9 /*88*/].f_71, uParam0.f_1204[*uParam1.f_9 /*88*/].f_69);
	GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1204[*uParam1.f_9 /*88*/].f_76, 13);
	*uParam0.f_21408[*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_65]++;
	...
	if (!func_273())
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1204[*uParam1.f_9 /*88*/].f_76, 14);
	...
	if (!iParam2)
	{
		func_202(*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_65, *(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_68, GAMEPLAY::IS_BIT_SET(*(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_76, 14), *(uParam0.f_1204[*uParam1.f_9 /*88*/]).f_70, 1);
...
void func_191(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_18())
	{
		if (iParam0 == 0)
		{
			...
			{
				if (func_198(player_id()) < iParam2)
				{
					return;
				}
			}
		}
		iVar0 = func_197(iParam0, iParam1, iParam3);
		if (iVar0 == -1)
		{
			return;
		}
...
void func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_203(iParam0, iParam1, iParam4);
	if (iVar0 == -1)
	{
		return;
	}
...
void func_205(auto uParam0, int iParam1)
{
	...
	if (func_273())
	{
		if (func_231(_get_content_id(*uParam0.f_7)))
		{
			if (_get_root_object() != 0)
			{
				datafile_delete();
	...
	if ((_object_value_get_integer(iVar2, "type") == 0 && _object_value_get_integer(iVar2, "subtype") == 7) && *uParam0.f_9 < 1100)
	{
		if (_get_root_object() != 0)
		{
			datafile_delete();
	...
	if (!func_273())
	{
		Global_794608.f_98389[*uParam0.f_9 /*12*/].f_4 = _get_content_file_version(*uParam0.f_7, 0);
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_67 = func_90(*uParam0.f_7);
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_66 = _get_content_file_version(*uParam0.f_7, Global_794608.f_4[*uParam0.f_9 /*88*/].f_67);
		Global_794608.f_98389[*uParam0.f_9 /*12*/].f_5 = _0x32DD916F3F7C9672(*uParam0.f_7);
	}
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_56 = {func_94(iVar2, "start")};
	if (_object_value_get_type(iVar2, "optbs") == 2)
	{
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_76 = _object_value_get_integer(iVar2, "optbs");
	}
	GAMEPLAY::CLEAR_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 15);
	GAMEPLAY::CLEAR_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 18);
	GAMEPLAY::CLEAR_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 19);
	GAMEPLAY::CLEAR_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 28);
	GAMEPLAY::CLEAR_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 27);
	...
	if (!func_273())
	{
		if (_0xF53E48461B71EECB(_0x32DD916F3F7C9672(*uParam0.f_7)))
		{
			Global_794608.f_4[*uParam0.f_9 /*88*/].f_54 = _get_content_description_hash(*uParam0.f_7);
		}
		else
		{
	...
	{
		Global_794608.f_98389[*uParam0.f_9 /*12*/].f_7 = _object_value_get_integer(iVar2, "mgrk");
	}
	if (_object_value_get_type(iVar2, "mght") == 2)
	{
		Global_794608.f_98389[*uParam0.f_9 /*12*/].f_8 = _object_value_get_integer(iVar2, "mght");
	}
	Global_794608.f_98389[*uParam0.f_9 /*12*/].f_10 = _object_value_get_integer(iVar2, "cncmbs");
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_69 = _object_value_get_integer(iVar2, "min");
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_71 = _object_value_get_integer(iVar2, "num");
	if (Global_794608.f_4[*uParam0.f_9 /*88*/].f_71 == -1)
	{
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_71 = 30;
	}
	StringCopy(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_22), _0xBF09786A7FCAB582(*uParam0.f_7), 64);
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_65 = _object_value_get_integer(iVar2, "type");
	if (func_273())
	{
	...
	{
		StringCopy(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_6), _get_content_user_id(*uParam0.f_7), 64);
	}
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_70 = _object_value_get_integer(iVar2, "rank");
	Global_794608.f_98389[*uParam0.f_9 /*12*/] = _object_value_get_integer(iVar2, "tnum");
	if (!func_273())
	{
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_73 = func_92(_0x1ACCFBA3D8DAB2EE(*uParam0.f_7, 0), _0x759299C5BB31D2A9(*uParam0.f_7, 0));
		Global_794608.f_98389[*uParam0.f_9 /*12*/].f_3 = _0x759299C5BB31D2A9(*uParam0.f_7, 0);
	}
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_75 = _object_value_get_integer(iVar2, "charcon");
	Global_794608.f_4[*uParam0.f_9 /*88*/].f_78 = _object_value_get_integer(iVar2, "ltm");
	if (Global_794608.f_4[*uParam0.f_9 /*88*/].f_65 == 6 && !iParam1)
	{
		if (Global_968690.f_598 < 85)
		{
			...
			{
				Global_968690.f_512[Global_794608.f_4[*uParam0.f_9 /*88*/].f_68] = to_float(_object_value_get_integer(iVar2, "rad"));
			}
			else
			{
				Global_968690.f_512[Global_794608.f_4[*uParam0.f_9 /*88*/].f_68] = _object_value_get_float(iVar2, "rad");
			}
	...
	{
		Global_794608.f_4[*uParam0.f_9 /*88*/].f_68 = _object_value_get_integer(iVar2, "subtype");
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 13);
	if (Global_794608.f_4[*uParam0.f_9 /*88*/].f_65 < 13 && !iParam1)
	{
	...
	if (!func_273())
	{
		...
		if ((Global_794608.f_111850 < 5 && Global_794608.f_4[*uParam0.f_9 /*88*/].f_65 == 0) && Global_794608.f_4[*uParam0.f_9 /*88*/].f_68 == 1)
		{
			...
			StringCopy(&(Global_794608.f_111819[Global_794608.f_111850 /*6*/]), _get_root_content_id(*uParam0.f_7), 24);
		...
		if (iParam1)
		{
			if (_0x70EA8DA57840F9BE(*uParam0.f_7))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 14);
			}
		}
		else
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76), 14);
				if (GAMEPLAY::IS_BIT_SET(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76, true) || Global_794608.f_4[*uParam0.f_9 /*88*/].f_68 == 2)
				{
				...
				Global_794608.f_98389[*uParam0.f_9 /*12*/].f_6 = _0x993CBE59D350D225(*uParam0.f_7);
			}
		}
	}
	if (!iParam1)
	{
		if (func_18())
		{
			func_202(Global_794608.f_4[*uParam0.f_9 /*88*/].f_65, Global_794608.f_4[*uParam0.f_9 /*88*/].f_68, GAMEPLAY::IS_BIT_SET(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76, 14), Global_794608.f_4[*uParam0.f_9 /*88*/].f_70, 0);
			...
			func_214(Global_794608.f_4[*uParam0.f_9 /*88*/].f_65, Global_794608.f_4[*uParam0.f_9 /*88*/].f_68, Global_794608.f_4[*uParam0.f_9 /*88*/].f_75, Global_794608.f_4[*uParam0.f_9 /*88*/].f_70, GAMEPLAY::IS_BIT_SET(Global_794608.f_4[*uParam0.f_9 /*88*/].f_76, 14));
...
bool func_208(int iParam0, int iParam1, int iParam2, auto uParam3, int iParam4)
{
	int iVar0;
...
void func_228(int iParam0)
{
	...
	if (iParam0)
	{
		...
		func_194(280555198, 0);
		func_194(-1776238337, 0);
		...
		func_194(937781072, 0);
		func_194(978181703, 0);
	...
	else
	{
		...
		func_194(-1054420012, 0);
		func_194(-548839670, 0);
		...
		func_194(348170426, 0);
		func_194(-708118870, 0);
	}
}
...
bool func_232(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, auto uParam5, auto uParam6, auto uParam7, int iParam8, int iParam9)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				if (_0x9BF438815F5D96EA(uParam1, uParam6, func_234(iParam3), 0, iParam8, uParam7))
				{
					return true;
				}
			}
			else if (_0x3195F8DD0D531052(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 1:
			if (_0x9BF438815F5D96EA(uParam1, uParam6, func_234(iParam3), 1, iParam8, uParam7))
			{
				return true;
			}
			break;
		...
		case 2:
			if (_0x9BF438815F5D96EA(uParam1, uParam6, func_234(iParam3), 2, iParam8, uParam7))
			{
				return true;
			}
			break;
		...
		case 3:
			if (_0xF9E1CCAE8BA4C281(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 4:
			if (iParam4 == -1)
			{
				iParam4 = func_233(player_id());
			}
			if (_0x9F6E2821885CAEE2(iParam4, uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 5:
			...
			{
				if (_0x692D58DF40657E8C(iParam2, uParam1, uParam6, func_234(iParam3), 0, 0))
				{
					return true;
				}
			}
			else if (_0x678BB03C1A3BD51E(iParam2, uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 6:
			if (_0x5324A0E3E4CE3570(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 7:
			if (network_get_background_loading_recipients(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 8:
			if (_0xD5A4B59980401588(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
		...
		case 9:
			if (iParam3 == 4)
			{
				if (_0x6D4CB481FAC835E8(uParam1, uParam6, func_234(iParam3), uParam7))
				{
					return true;
				}
			}
			else if (_0xA7862BC5ED1DFD7E(uParam1, uParam6, func_234(iParam3), uParam5))
			{
				return true;
			}
			break;
...
void func_238(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	struct<88> Var1;
...
void func_239(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	struct<88> Var1;
...
void func_240(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	struct<88> Var1;
...
bool func_249(auto uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (_0xB746D20B17F2A229(uParam0.f_1, func_234(0)))
			{
				*uParam0++;
			}
			break;
		...
		case 2:
			if (_0x63B406D7884BFA95())
			{
				...
				{
					if (_0x597F8DBA9B206FC7() > 0 && _0x01095C95CD46B624(0))
					{
						iVar13 = _get_root_object();
						iVar14 = _object_value_get_integer(iVar13, "pt");
						func_251(2, iVar14);
						*uParam0++;
					}
					else
...
void func_253(auto uParam0, int iParam1)
{
	...
	while (iVar1 <= 30)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_949333.f_5[iVar1 /*88*/].f_76, 13))
		{
			iVar0 = uParam0;
...
bool func_254(struct<2> Param0, auto uParam1, Vector3 vParam2, float fParam3)
{
	if (!func_63(vParam3))
	{
...
int func_255(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	return func_45(uParam0, &uVar0, 0, iParam1, 0, 0, iParam2, -1, iParam3, 1, 0, 0, -1);
}
...
void func_257(auto uParam0, int iParam1)
{
	...
	while (iVar1 <= 199)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_906487.f_1204[iVar1 /*88*/].f_76, 13))
		{
			iVar0 = uParam0;
			while (iVar0 <= iParam1 - 1)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_794608.f_4[iVar0 /*88*/].f_76, 13))
				{
					...
					{
						GAMEPLAY::CLEAR_BIT(&(Global_906487.f_1204[iVar0 /*88*/].f_76), 13);
...
int func_258(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_264(auto uParam0)
{
	...
	switch (*uParam0.f_4)
	{
			...
			*uParam0.f_9 = 0;
			...
			while (iVar0 <= 63)
			{
				if (iVar0 < 35)
				{
					...
					{
						_0x5A34CD9C3C5BEC44(Global_786484.f_3503[iVar0 /*132*/].f_129);
					}
			...
			*uParam0.f_13 = 0;
			...
			while (iVar0 <= 63)
			{
				if (iVar0 < 35)
				{
					...
					if (!is_string_null_or_empty(&(Global_970889.f_1177[iVar0 /*6*/])))
					{
						*uParam0.f_13++;
					}
				}
		...
		case 1:
			if (_0xC7397A83F7A2A462(&(Global_970889.f_1177), *uParam0.f_13, 1, func_234(0)))
			{
				func_33(uParam0, 2);
			}
			break;
	...
	if (iVar1)
	{
		...
		while (iVar0 <= *uParam0.f_12 + 63)
		{
			if (iVar0 < 35)
			{
				...
				iVar5 = 0;
				iVar6 = false;
				sVar2 = func_266(Global_786484.f_1[iVar0 /*88*/].f_54, 500);
				...
				while (!iVar6)
				{
					...
					{
						StringCopy(&(Global_786484.f_3503[iVar0 /*132*/][iVar5 /*16*/]), _get_text_substring_safe(sVar2, iVar3, iVar4, 63), 64);
						iVar3 += get_length_of_literal_string(&(Global_786484.f_3503[iVar0 /*132*/][iVar5 /*16*/]));
						iVar5++;
					}
				}
			}
...
auto func_266(int iParam0, int iParam1)
{
	if (iParam0 == -1)
	{
		return func_267();
...
bool func_268(int iParam0, auto uParam1)
{
	if (*uParam1 != iParam0)
	{
		if (*uParam1 != 0)
...
void func_269(auto uParam0)
{
	...
	if (!func_273())
	{
		Global_786484.f_3082[*uParam0.f_9 /*12*/].f_4 = _get_content_file_version(*uParam0.f_7, 0);
		Global_786484.f_1[*uParam0.f_9 /*88*/].f_67 = func_90(*uParam0.f_7);
		Global_786484.f_1[*uParam0.f_9 /*88*/].f_66 = _get_content_file_version(*uParam0.f_7, Global_794608.f_4[*uParam0.f_9 /*88*/].f_67);
		Global_786484.f_3082[*uParam0.f_9 /*12*/].f_5 = _0x32DD916F3F7C9672(*uParam0.f_7);
	}
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_56 = {func_94(iVar2, "start")};
	if (_object_value_get_type(iVar2, "optbs") == 2)
	{
		Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76 = _object_value_get_integer(iVar2, "optbs");
	}
	GAMEPLAY::CLEAR_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 15);
	GAMEPLAY::CLEAR_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 18);
	GAMEPLAY::CLEAR_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 19);
	GAMEPLAY::CLEAR_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 28);
	GAMEPLAY::CLEAR_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 27);
	...
	if (!func_273())
	{
		if (_0xF53E48461B71EECB(_0x32DD916F3F7C9672(*uParam0.f_7)))
		{
			Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_54 = _get_content_description_hash(*uParam0.f_7);
		}
		else
		{
	...
	if (_object_value_get_type(iVar2, "mgrk") == 2)
	{
		Global_786484.f_3082[*uParam0.f_9 + *uParam0.f_12 /*12*/].f_7 = _object_value_get_integer(iVar2, "mgrk");
	}
	if (_object_value_get_type(iVar2, "mght") == 2)
	{
		Global_786484.f_3082[*uParam0.f_9 + *uParam0.f_12 /*12*/].f_8 = _object_value_get_integer(iVar2, "mght");
	}
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_69 = _object_value_get_integer(iVar2, "min");
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_71 = _object_value_get_integer(iVar2, "num");
	if (Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_71 == -1)
	{
		Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_71 = 30;
	}
	StringCopy(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_22), _0xBF09786A7FCAB582(*uParam0.f_7), 64);
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_65 = _object_value_get_integer(iVar2, "type");
	if (func_273())
	{
	...
	{
		StringCopy(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_6), _get_content_user_id(*uParam0.f_7), 64);
	}
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_70 = _object_value_get_integer(iVar2, "rank");
	Global_786484.f_3082[*uParam0.f_9 + *uParam0.f_12 /*12*/] = _object_value_get_integer(iVar2, "tnum");
	if (!func_273())
	{
		Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_73 = func_92(_0x1ACCFBA3D8DAB2EE(*uParam0.f_7, 0), _0x759299C5BB31D2A9(*uParam0.f_7, 0));
		Global_786484.f_3082[*uParam0.f_9 + *uParam0.f_12 /*12*/].f_3 = _0x759299C5BB31D2A9(*uParam0.f_7, 0);
	}
	Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_75 = _object_value_get_integer(iVar2, "charcon");
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 13);
	if (_get_root_object() != 0)
	{
		datafile_delete();
	}
	if (!func_273())
	{
		...
		if (_0x70EA8DA57840F9BE(*uParam0.f_7))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_786484.f_1[*uParam0.f_9 + *uParam0.f_12 /*88*/].f_76), 14);
			Global_786484.f_3082[*uParam0.f_9 + *uParam0.f_12 /*12*/].f_6 = _0x993CBE59D350D225(*uParam0.f_7);
		}
	}
	*uParam0.f_9++;
	Global_786484++;
...
struct<6> func_271(int iParam0)
{
	...
	{
		case 0:
			StringCopy(&cVar0, "hK5OgJk1BkinXGGXghhTMg", 24);
			break;
		
		case 1:
			StringCopy(&cVar0, "V7yEdnL6TEyU3i-U1Rv_pQ", 24);
			break;
		
		case 2:
			StringCopy(&cVar0, "BWsCWtmnvEWXBrprK9hDHA", 24);
			break;
		
		case 3:
			StringCopy(&cVar0, "CvGcgHoGwUuA_1hEo-f8Hg", 24);
			break;
		
		case 4:
			StringCopy(&cVar0, "6k6LOpnf2E-GG38OhjS-TA", 24);
			break;
		
		case 5:
			StringCopy(&cVar0, "nSWwSwAf3EaHZWsk449lBg", 24);
			break;
		
		case 6:
			StringCopy(&cVar0, "qRsMyKTHCEaL0qJQJR7JKQ", 24);
			break;
		
		case 7:
			StringCopy(&cVar0, "ciWN4gwmakid4lW-nSllcA", 24);
			break;
		
		case 8:
			StringCopy(&cVar0, "v-8OOQYzxE-Zvqj5xO03DQ", 24);
			break;
		
		case 9:
			StringCopy(&cVar0, "zCxFg29teE2ReKGnr0L4Bg", 24);
			break;
		
		case 10:
			StringCopy(&cVar0, "6ClY8ZA_DkuBUdZ_fPn6Rw", 24);
			break;
		
		case 11:
			StringCopy(&cVar0, "OiSO3Z0YdkCaEqVHhhkj4Q", 24);
			break;
		
		case 12:
			StringCopy(&cVar0, "Cy2OZSwCt0-mSXY00o4SNw", 24);
			break;
		
		case 13:
			StringCopy(&cVar0, "Y4zpRQDfvkawfFDR1Uxi2A", 24);
			break;
		
		case 14:
			StringCopy(&cVar0, "7-w96-PU4kSevhtG5YwUHQ", 24);
			break;
		
		case 15:
			StringCopy(&cVar0, "oSXhVwaHH0KDOzg0rfIj3Q", 24);
			break;
		
		case 16:
			StringCopy(&cVar0, "QS6WYcjJFk2YxqYDMN8mjQ", 24);
			break;
		
		case 17:
			StringCopy(&cVar0, "opjT3-kJLUOJt16LHNtbUw", 24);
			break;
		
		case 18:
			StringCopy(&cVar0, "JJ9OzPbPo02eQbaniO8E3g", 24);
			break;
		
		case 19:
			StringCopy(&cVar0, "20Lu41Px20OJMPdZ6wXG3g", 24);
			break;
		
		case 20:
			StringCopy(&cVar0, "6UzZkstFeEeCkvs2lrF_6A", 24);
			break;
		
		case 21:
			StringCopy(&cVar0, "-zZdcIxFfU6zmPJyUqu6zw", 24);
			break;
		
		case 22:
			StringCopy(&cVar0, "NuWMXoqFB0OxtRXY9AEOfQ", 24);
			break;
		
		case 23:
			StringCopy(&cVar0, "3tYmphlR1ka7IB37wNw45A", 24);
			break;
		
		case 24:
			StringCopy(&cVar0, "kNqG_EaEpUm-F411W5AyIQ", 24);
			break;
		
		case 25:
			StringCopy(&cVar0, "PPnsIR0v2U2COyRbED87gw", 24);
			break;
		
		case 26:
			StringCopy(&cVar0, "z49DSS9db0i_vh6A2e-Q-g", 24);
			break;
		
		case 27:
			StringCopy(&cVar0, "Fo168mMjCUCeN_IKmL4VnA", 24);
			break;
	}
	return cVar0;
}
...
int func_274(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
