...
bool func_8()
{
	...
	if (get_distance_between_coords(Local_100.f_4, func_11(), 1) < 1000f)
	{
		return false;
	}
	...
	switch (Local_100.f_15[2])
	{
		case 0:
			if (is_waypoint_active())
			{
				...
				if (get_distance_between_coords(Local_100.f_4, vVar0, 1) > 1000f)
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_100.f_1, 7))
					{
						func_13();
						set_minimap_block_waypoint(1);
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 7);
					}
					return vVar0;
				}
			}
...
void func_17()
{
	...
	fVar2 = 999999f;
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 2);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), true);
	GAMEPLAY::CLEAR_BIT(&(Local_100.f_1), false);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 3);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 6);
	Local_100.f_14 = 0;
	if (Local_100.f_22 == 0)
	{
		iLocal_125 = 0;
	...
	while (iVar0 < _network_get_num_participants_host())
	{
		if (network_is_participant_active(int_to_participantindex(iVar0)))
		{
			...
			if (func_7(iVar6, 1, 1))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), false);
	...
	switch (Local_127[participant_id_to_int() /*4*/].f_3)
	{
			...
			if (func_7(player_id(), 1, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(iLocal_256, 4))
				{
					if (does_blip_exist(iLocal_257))
					{
						...
						iLocal_260 = 1;
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 4);
					}
					else
					{
		...
		case 1:
			...
			if (!GAMEPLAY::IS_BIT_SET(iLocal_256, 3))
			{
				...
				func_168(0);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 3);
			}
			if (Local_100.f_22 > 1 && func_167(&vLocal_331))
			{
				...
				else if (!is_entity_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_279, 7.5f, 7.5f, 7.5f, false, true, 0))
				{
					...
					func_153(&(vLocal_331.f_2));
					func_152(&vLocal_331);
					GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 7);
...
void func_28()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_256, true))
	{
		...
		func_31(21);
		func_29();
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, true);
	}
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_256, 5))
	{
		if (is_entity_at_coord(PLAYER::PLAYER_PED_ID(), Local_100.f_7 + Vector(20f / 2f + 4f, 0f, 0f), 7f, 7f, 20f, false, true, 0))
		{
			if (func_18(PLAYER::PLAYER_PED_ID()))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 5);
			}
		}
	}
...
void func_199()
{
	...
	if (func_428(0, -1, 0))
	{
		...
		if (iVar0)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_307.f_15), false);
				iLocal_260 = 1;
				iLocal_261 = 1;
				GAMEPLAY::CLEAR_BIT(&(Local_100.f_1), 7);
				GAMEPLAY::CLEAR_BIT(&(Local_100.f_1), 8);
		...
		if ((func_397(iVar0) || !GAMEPLAY::IS_BIT_SET(Local_307.f_15, true)) || _0x6CD79468A1E595C6(2))
		{
			...
			if (((iLocal_260 == 1 || !GAMEPLAY::IS_BIT_SET(Local_307.f_15, true)) || _0x6CD79468A1E595C6(2)) || Local_307.f_20 != Local_100.f_15.f_6)
			{
				...
				if (iVar0)
				{
					...
					{
						if (get_distance_between_coords(Local_100.f_4, func_11(), 1) < 1000f && Local_100.f_15[2] != 0)
						{
							Local_100.f_15[2]++;
			...
			if (!GAMEPLAY::IS_BIT_SET(Local_307.f_15, true))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_307.f_15), true);
			}
		}
		if (func_24(&uLocal_341))
		{
...
void func_244()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Local_100.f_1, 9))
	{
		if (GAMEPLAY::IS_BIT_SET(Local_100.f_1, 8))
		{
			...
			if (((get_water_height_no_waves(vVar1, &uVar0) && !func_369(vVar1)) || func_368()) || func_245(vVar1, 100f, &(Local_100.f_7), &uVar0, Var4))
			{
				...
				iLocal_260 = 1;
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 9);
				GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 10);
				Local_100.f_15[2] = 0;
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(Local_100.f_1, 7))
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 8);
		}
	}
	if (!is_waypoint_active())
	{
	...
	else if (!GAMEPLAY::IS_BIT_SET(iLocal_256, 2))
	{
		...
		if (get_distance_between_coords(Local_100.f_4, vVar29, 1) > 1000f)
		{
			func_13();
			...
			set_minimap_block_waypoint(1);
			GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 7);
			GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 2);
			iLocal_260 = 1;
		}
	}
}
	...
	if (iParam4 && !iParam7)
	{
		if (func_7(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (get_distance_between_coords(func_130(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
					if (is_sphere_visible(vParam0, fParam3))
					{
						return true;
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_292(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							if ((iParam5 || (iParam5 == 0 && get_player_team(iVar1) != get_player_team(player_id()))) || get_player_team(iVar1) == -1)
							{
								if (get_distance_between_coords(func_130(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
									if (is_sphere_visible_to_player(iVar1, vParam0, fParam3))
									{
										return true;
				...
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_292(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (get_distance_between_coords(func_130(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
bool func_368()
{
	...
	if (_0xF7B79A50B905A30D(Local_100.f_7 - 25f, Local_100.f_7.f_1 - 25f, Local_100.f_7 + 25f, Local_100.f_7.f_1 + 25f))
	{
		...
		if (get_distance_between_coords(Local_100.f_7, vVar0, 0) <= 25f)
		{
			Local_100.f_7 = {vVar0};
			return true;
		}
...
void func_372(int iParam0)
{
	...
	if (Local_100.f_15[2] <= 0 || Local_100.f_15[2] > iLocal_98)
	{
		...
		{
			if ((func_10(func_11(), 0f, 0f, -2000f, 0) || func_10(func_11(), 0f, 0f, 0f, 0)) || get_distance_between_coords(Local_100.f_4, func_11(), 1) < 1000f)
			{
				iLocal_338 = 1;
	...
	if (iParam0)
	{
		...
		if (Local_100.f_14 >= 2)
		{
			...
			else if ((func_10(func_11(), 0f, 0f, -2000f, 0) || func_10(func_11(), 0f, 0f, 0f, 0)) || get_distance_between_coords(Local_100.f_4, func_11(), 1) < 1000f)
			{
				iVar4 = false;
			}
		}
...
int func_379()
{
	...
	return round(get_distance_between_coords(Local_100.f_4, Local_100.f_7, 1));
}
			...
			case 0:
				if (iLocal_264 == 1)
				{
					if (func_427(&uLocal_328, iLocal_330, 0))
					{
						...
						iLocal_330 = 5000;
						iLocal_260 = 1;
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_307.f_18), 2);
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_100.f_1), 11);
					}
				}
				break;
...
void func_420()
{
	...
	if (!GAMEPLAY::IS_BIT_SET(iLocal_256, 6))
	{
		...
		GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_256, 6);
	}
}
