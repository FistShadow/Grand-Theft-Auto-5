	...
	while (iLocal_287 && func_119(2, 0))
	{
		...
		switch (iLocal_96)
		{
			...
			case 2:
				if (func_115())
				{
					func_114(&uLocal_98, 0, player_ped_id(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_543 && has_entity_been_damaged_by_entity(iParam0, player_ped_id(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_92(75, get_entity_coords(iParam0, 0), 250f, -1);
	...
	else
	{
		...
		if (iLocal_541 > 0)
		{
			if (iLocal_542 == 0)
			{
				if (iLocal_541 + 15000 < get_game_timer())
				{
			...
			else if (iLocal_541 + 10000 < get_game_timer())
			{
...
bool func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	if (iVar18 || func_26(sParam3, &Var8, uParam4))
	{
		if (iVar7 == 5)
		{
			if (iVar6 == 0)
			{
				func_114(uParam2, 0, player_ped_id(), "MICHAEL", 0, 1);
			}
			else if (iVar6 == 1)
			{
				func_114(uParam2, 0, player_ped_id(), "FRANKLIN", 0, 1);
			}
			else if (iVar6 == 2)
			{
				func_114(uParam2, 0, player_ped_id(), "TREVOR", 0, 1);
			}
		}
...
bool func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		{
			func_114(uParam2, 0, player_ped_id(), sVar0, 0, 1);
...
bool func_26(char* sParam0, char* sParam1, var uParam2)
{
	char[16] cVar0;
	struct<4> Var4;
	int iVar8;
...
void func_41(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_43() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_43() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_45(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_43() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_70(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, int iParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
bool func_89(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
...
int func_94(int iParam0, int iParam1)
{
	...
	iVar10 = false;
	if (is_bit_set(Var0.f_2, func_95()))
	{
		iVar10 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (does_entity_exist(*iParam0))
	{
		...
		switch (iLocal_296[iParam1])
		{
			...
			case 1:
				...
				if (vdist2(get_entity_coords(*iParam0, 1), vLocal_303) >= fVar7)
				{
			...
			case 3:
				...
				if (vdist2(get_entity_coords(*iParam0, 1), vLocal_303 + vLocal_317[iParam1 /*3*/]) < fLocal_334[iParam1] * fLocal_334[iParam1])
				{
			...
			case 4:
				...
				else
				{
					...
					{
						if (vdist2(get_entity_coords(*iParam0, 1), vVar11) > 100f)
						{
...
bool func_117()
{
	...
	if (!func_116())
	{
		if (is_synchronized_scene_running(Global_88941))
		{
			...
			while (iVar0 < iLocal_288)
			{
				if (!is_ped_injured(iLocal_288[iVar0]))
				{
...
bool func_118()
{
	...
	if (is_synchronized_scene_running(Global_88940))
	{
		...
		{
			func_114(&uLocal_98, 1, player_ped_id(), "FRANKLIN", 0, 1);
		}
		if (!is_ped_injured(Global_91064))
		{
			func_114(&uLocal_98, 4, Global_91064, "LAMAR", 0, 1);
		}
		if (!is_ped_injured(iLocal_288[0]))
		{
			func_114(&uLocal_98, 5, iLocal_288[0], "GangMember1", 0, 1);
		}
		if (!is_ped_injured(iLocal_288[1]))
		{
...
void func_127()
{
	...
	while (!iVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_288)
		{
			...
			{
				request_model(iLocal_292[iVar0]);
				if (!has_model_loaded(iLocal_292[iVar0]))
				{
					iVar2 = false;
					request_model(iLocal_292[iVar0]);
				}
	...
	if (does_entity_exist(Global_91064))
	{
		if (func_31(19) == get_entity_model(Global_91064))
		{
...
bool func_131(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
bool func_133(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	int iVar0;
