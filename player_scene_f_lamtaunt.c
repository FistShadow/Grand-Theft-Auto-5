...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_543 && has_entity_been_damaged_by_entity(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	fVar4 = vdist2(get_entity_coords(iParam0, 1), get_entity_coords(PLAYER::PLAYER_PED_ID(), 1));
	if (fVar4 > 8f * 8f)
	{
		iLocal_541 = -1;
	}
