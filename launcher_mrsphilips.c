...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_240(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_227(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_224(&iVar64, &Var0, vVar61, 1f))
	{
		func_223();
	...
	func_212(&Var0);
	iLocal_92 = add_scenario_blocking_area(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_173(Var0);
		func_165(&iLocal_91, &(Var0.f_9), vVar61);
		if (func_150(&Var0, 0))
		{
			if (Var0 == 35)
			{
...
int func_218(int iParam0, char* sParam1)
{
...
bool func_224(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_225(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_225(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_225(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_226(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_226(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_228(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_236(auto uParam0, int iParam1)
{
