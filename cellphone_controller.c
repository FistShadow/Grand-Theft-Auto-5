...
void main()
{
	...
	while (true)
	{
		...
		if (Global_69489 == 1)
		{
			if (Global_14413.f_1 == 3)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2563397, 15))
				{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_2563397, 16))
				{
					GAMEPLAY::SET_BIT(&Global_2563397, 14);
					wait(0);
		...
		if (Global_69489 == 0)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_2563397, 11))
			{
				if ((Global_14413.f_1 != 10 && Global_14413.f_1 != 9) || func_68() == 0)
				{
					GAMEPLAY::CLEAR_BIT(&Global_2563397, 11);
			...
			else if (Global_14413.f_1 == 10 || Global_14413.f_1 == 9)
			{
				if (func_68())
				{
					GAMEPLAY::SET_BIT(&Global_2563397, 11);
					GAMEPLAY::SET_BIT(&Global_2284, 11);
				}
			}
			if (GAMEPLAY::IS_BIT_SET(Global_2563397, 12))
			{
				GAMEPLAY::CLEAR_BIT(&Global_2563397, 12);
				GAMEPLAY::SET_BIT(&Global_2284, 11);
			}
		}
		else if (GAMEPLAY::IS_BIT_SET(Global_2563397, 12))
		{
		...
		{
			GAMEPLAY::SET_BIT(&Global_2563397, 12);
			GAMEPLAY::SET_BIT(&Global_2284, 11);
		}
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_2563397, 19))
				{
					GAMEPLAY::SET_BIT(&Global_2563397, 19);
					GAMEPLAY::SET_BIT(&Global_2284, 11);
				}
			}
			else if (GAMEPLAY::IS_BIT_SET(Global_2563397, 19))
			{
				GAMEPLAY::CLEAR_BIT(&Global_2563397, 19);
				GAMEPLAY::SET_BIT(&Global_2284, 11);
			}
		}
		if (iLocal_91 == 0)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_2283, 25))
			{
		...
		else if (!GAMEPLAY::IS_BIT_SET(Global_2283, 25))
		{
			STATS::STAT_GET_INT(joaat("sp_cellphone_sleep_time"), &iLocal_90, -1);
		...
		func_51();
		func_50();
		if (GAMEPLAY::IS_BIT_SET(Global_2284, 21))
		{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2283, 7))
		{
			func_46();
			GAMEPLAY::CLEAR_BIT(&Global_2283, 7);
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2283, false))
		{
			func_45();
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2563397, false))
		{
			func_44();
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2284, 11))
		{
			Global_2987 = 0;
			if (GAMEPLAY::IS_BIT_SET(Global_2283, 25))
			{
			...
			if (Global_2987 == 0)
			{
				GAMEPLAY::CLEAR_BIT(&Global_2284, 11);
				iLocal_39 = 0;
			}
			else
			{
...
void func_1()
{
	...
	switch (iLocal_68)
	{
		...
		case 2:
			GAMEPLAY::SET_BIT(&Global_2284, 15);
			func_12();
			break;
	}
}
...
void func_7()
{
	...
	switch (iLocal_68)
	{
		...
		case 2:
			if (iLocal_69 == 3)
			{
				GAMEPLAY::SET_BIT(&Global_2284, 14);
...
void func_13()
{
	...
	{
		Global_16747 = 1;
		GAMEPLAY::CLEAR_BIT(&Global_2284, 14);
		settimerb(0);
	}
}
...
void func_15()
{
	...
	else
	{
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			else if (GAMEPLAY::IS_BIT_SET(Global_2283, 13))
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2563397, 19))
				{
					iLocal_38 = false;
		...
		else if (Global_2412879.f_871 || GAMEPLAY::IS_BIT_SET(Global_2283, 13))
		{
			iLocal_38 = true;
		}
		else
					...
					if (!func_43())
					{
						if (!func_16())
						{
							if (is_player_playing(player_id()))
							{
								...
								{
									_set_2d_layer(4);
									if (GAMEPLAY::IS_PC_VERSION() && Global_2412879.f_871)
									{
										fLocal_85 = 0.165f;
										fLocal_86 = 0.755f;
									}
...
void func_31()
{
	if (func_14() || GAMEPLAY::IS_BIT_SET(Global_2283, 8))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2283, 8);
		func_37();
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
...
bool func_36()
{
	if (is_player_playing(player_id()))
	{
		if ((((get_ped_config_flag(PLAYER::PLAYER_PED_ID(), 78, 1) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_being_stunned(PLAYER::PLAYER_PED_ID(), 0)) || is_ped_in_parachute_free_fall(PLAYER::PLAYER_PED_ID())) || get_ped_parachute_state(PLAYER::PLAYER_PED_ID()) == 1)
		{
			return true;
		}
		else
...
void func_44()
{
	...
	GAMEPLAY::CLEAR_BIT(&Global_2563397, false);
	if (Global_16773 != 0)
	{
	...
	if (((((((Global_2562132[Global_2563381 /*104*/].f_32 == 4 || Global_2562132[Global_2563381 /*104*/].f_32 == 5) || Global_2562132[Global_2563381 /*104*/].f_32 == 6) || Global_2562132[Global_2563381 /*104*/].f_32 == 7) || Global_2562132[Global_2563381 /*104*/].f_32 == 8) || Global_2562132[Global_2563381 /*104*/].f_32 == 9) || Global_2562132[Global_2563381 /*104*/].f_32 == 10) || Global_2562132[Global_2563381 /*104*/].f_32 == 11)
	{
		...
		GAMEPLAY::SET_BIT(&Global_2563397, true);
		Global_16770 = 1;
...
void func_46()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2283, true))
	{
		func_49();
		func_47();
		...
		else if (!GAMEPLAY::IS_BIT_SET(Global_2283, 10))
		{
			iLocal_46[Global_14413] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_41[Global_14413] = 1;
		}
		else
		{
			iLocal_46[0] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_46[2] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_46[1] = GAMEPLAY::GET_GAME_TIMER();
			iLocal_41[0] = 1;
			iLocal_41[2] = 1;
			iLocal_41[1] = 1;
		}
		GAMEPLAY::CLEAR_BIT(&Global_2283, true);
	}
}
...
void func_50()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2283, 19))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2283, 19);
		func_37();
...
void func_51()
{
	if (iLocal_41[Global_14413] == 1)
	{
		...
		{
			iLocal_56[Global_14413] = GAMEPLAY::GET_GAME_TIMER();
...
bool func_55(auto uParam0, char* sParam1, int iParam2, int iParam3, auto uParam4, auto uParam5, int iParam6, int iParam7, auto uParam8, auto uParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_56(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_63()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2283, 6))
	{
		if (Global_2987 > 0)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_2284, 11))
			{
				if (iLocal_39)
				{
					...
					if (GAMEPLAY::IS_BIT_SET(Global_2563397, 19))
					{
						...
						_push_scaleform_movie_function_parameter_float(222f);
						if ((GAMEPLAY::IS_BIT_SET(Global_2563397, 12) || GAMEPLAY::IS_BIT_SET(Global_2563397, 11)) || GAMEPLAY::IS_BIT_SET(Global_2283, 25))
						{
		...
		if (Global_2987 < 1)
		{
			...
			GAMEPLAY::CLEAR_BIT(&Global_2283, 6);
		}
		else
		{
			func_15();
	...
	else if (Global_2987 > 0)
	{
		...
		_set_2d_layer(4);
		GAMEPLAY::SET_BIT(&Global_2283, 6);
	}
}
...
void func_65()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2284, 7))
	{
		GAMEPLAY::SET_BIT(&Global_2284, 6);
		GAMEPLAY::CLEAR_BIT(&Global_2284, 7);
		return;
	}
	if (!GAMEPLAY::IS_BIT_SET(Global_2284, 7))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2284, 6);
		return;
	}
}
...
void func_66()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2284, 4))
	{
		GAMEPLAY::SET_BIT(&Global_2284, 3);
		GAMEPLAY::CLEAR_BIT(&Global_2284, 4);
		return;
	}
	if (!GAMEPLAY::IS_BIT_SET(Global_2284, 4))
	{
		GAMEPLAY::CLEAR_BIT(&Global_2284, 3);
		return;
	}
}
...
void func_67()
{
	if (GAMEPLAY::IS_BIT_SET(Global_2284, 2))
	{
		if (!Global_14413.f_1 == 1)
		{
			Global_14413.f_1 = 0;
		}
		GAMEPLAY::CLEAR_BIT(&Global_2284, 2);
		return;
	}
	if (!GAMEPLAY::IS_BIT_SET(Global_2284, 2))
	{
...
auto func_84(int iParam0, auto uParam1)
{
	struct<5> Var0;
