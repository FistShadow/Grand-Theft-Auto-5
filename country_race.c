...
int func_177(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_180(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_178(iVar0, 0), 1);
...
auto func_182()
{
	...
	func_190(&uVar0, TIME::GET_CLOCK_HOURS());
...
void func_209(struct<5> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15)
{
	...
	if ((CONTROLS::IS_CONTROL_PRESSED(0, 75) || is_disabled_control_pressed(0, 75)) || iLocal_122 == 1)
	{
		switch (iLocal_125)
		{
			case 0:
			...
			case 0:
				...
				else if (iParam21)
				{
					if (!func_243(*uParam0, 242628503, 1))
					{
						...
						task_pause(false, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(200, 500));
						task_vehicle_temp_action(false, *uParam0.f_5, 31, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 2000));
...
int func_293(auto uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_54[uParam0 /*3*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
		if (fVar0 > 100f)
		{
			iVar1 = 240;
		}
...
void func_314(int iParam0)
{
	...
	while (iVar0 < 23)
	{
		...
		*(iParam0[iVar0 /*50*/]).f_43 = 0;
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 4);
		if (iVar1 == 0)
		{
...
void func_315(int iParam0, int iParam1)
{
	...
	while (iVar0 < 8)
	{
		...
		*(iParam0[iVar0 /*50*/]).f_4 = iLocal_120;
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 2);
		if (iVar1 == 0)
		{
		...
		iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 6);
		if (iVar1 == 0)
		{
...
void func_328(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0)
	{
		...
		{
			ENTITY::FREEZE_ENTITY_POSITION(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), false);
		}
		else
		{
