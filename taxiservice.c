#region Local Var
	...
	auto uLocal_799 = 0;
	auto uLocal_800 = 0;
	auto uLocal_801 = 1065353216;
	int iLocal_802 = 0;
	struct<9> Local_803 = 0;
	int iLocal_812 = 0;
	int iLocal_813 = 0;
	int iLocal_814 = 0;
	int iLocal_815 = 0;
	Vector3[] vLocal_816 = new Vector3[40];
	int iLocal_937 = 0;
	int iLocal_938 = 0;
	int iLocal_939 = 0;
	int iLocal_940 = 0;
	char[32] cLocal_941 = 0;
	...
	Vector3 vLocal_973 = 0;
	Vector3 vLocal_976 = 0;
	int iLocal_979 = 0;
#endregion
...
void main()
{
	...
	iLocal_107 = -1;
	iLocal_108 = -1;
	sLocal_109 = _get_control_action_name(2, 195, true);
...
void func_1()
{
	...
	func_5();
	if (func_3(Global_100185) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Global_100185, 1))
	{
	...
	else
	{
		if (is_player_wanted_level_greater(player_id(), 0))
		{
			...
			{
				if (is_ped_in_vehicle(Global_100186, Global_100185, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						task_vehicle_mission_ped_target(Global_100186, Global_100185, PLAYER::PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
					}
				}
				else if (!is_ped_fleeing(Global_100186))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						task_smart_flee_ped(Global_100186, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
					}
				}
				set_ped_keep_task(Global_100186, true);
				set_blocking_of_non_temporary_events(Global_100186, false);
			}
		}
		else if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
		{
			if (is_ped_in_vehicle(Global_100186, Global_100185, 0))
			{
				if (!func_2(Global_100186, -258271821))
				{
					task_vehicle_drive_wander(Global_100186, Global_100185, 12f, 790699);
				}
			}
			set_ped_keep_task(Global_100186, true);
			set_blocking_of_non_temporary_events(Global_100186, false);
	...
	if (does_group_exist(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				if (!is_entity_dead(Global_100185, 0))
				{
					if (is_ped_in_vehicle(iVar2, Global_100185, 0))
					{
						task_leave_vehicle(iVar2, Global_100185, 64);
					}
				}
			}
			if (iVar0 > 1)
...
void func_7()
{
	...
	{
		if (!PED::IS_PED_INJURED(Global_100186))
		{
			if (is_ped_sitting_in_vehicle(Global_100186, Global_100185))
			{
				if (!func_53())
				{
					iVar0 = true;
					if (func_47(func_48()) >= iLocal_103)
					{
						...
						else if (get_entity_speed(Global_100185) > 5f)
						{
							if (!func_8())
							{
								iLocal_815 = 12;
...
int func_9(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_10(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}

bool func_10(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_13(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_101154.f_25089.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_15() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_101154.f_25089.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_15() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
...
int func_17(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_15() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_22(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_26(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_28(auto uParam0, int iParam1)
{
		...
		if (!func_43(iParam0, 0))
		{
			if (!*iParam1 == 0)
			{
				...
				else if (*iParam1 == 9)
				{
					if (is_player_playing(player_id()))
					{
						iVar0 = is_ambient_speech_disabled(PLAYER::PLAYER_PED_ID());
						if (iVar0)
						{
							stop_ped_speaking(PLAYER::PLAYER_PED_ID(), 0);
						}
				...
				else if (*iParam1 == 18)
				{
					...
					else if (timera() > 4000)
					{
						if (is_player_playing(player_id()))
						{
							...
							{
								case 0:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_VIBE", 7);
									break;
								
								case 1:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_LRR", 7);
									break;
								
								case 2:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_JNR", 7);
									break;
								
								case 3:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_MASSIVEB", 7);
									break;
								
								case 4:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_K109", 7);
									break;
								
								case 5:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_WKTT", 7);
									break;
								
								case 6:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_LCHC", 7);
									break;
								
								case 7:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_JOURNEY", 7);
									break;
								
								case 8:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_FUSION", 7);
									break;
								
								case 9:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_BEAT", 7);
									break;
								
								case 10:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_BROKER", 7);
									break;
								
								case 11:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_VLADIVOSTOK", 7);
									break;
								
								case 12:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_PLR", 7);
									break;
								
								case 13:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_SANJUAN", 7);
									break;
								
								case 14:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_FRANCOIS", 7);
									break;
								
								case 15:
									func_41(PLAYER::PLAYER_PED_ID(), "RADIO_REQ_CLASSICS", 7);
									break;
							}
							if (iVar0)
							{
...
void func_38()
{
	...
	{
		iVar1 = is_ambient_speech_disabled(PLAYER::PLAYER_PED_ID());
		if (iVar1)
		{
			stop_ped_speaking(PLAYER::PLAYER_PED_ID(), 0);
		}
...
Vector3 func_40(int iParam0)
{
	...
	{
		iVar6 = get_blip_info_id_pickup_index(iParam0);
		if (does_pickup_exist(iVar6))
		{
			vVar0 = {get_pickup_coords(iVar6)};
		}
	}
	else if (iVar7 == 5)
	{
...
bool func_43(int iParam0, int iParam1)
{
	...
	if (is_player_playing(player_id()))
	{
		...
		{
			func_45("\ntaxi_functions - IS_ANY_DIALOGUE_PLAYING - IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())\n");
			return true;
		}
	}
	if (func_44())
	...
	if (func_215())
	{
		...
		if (iLocal_938 != 4)
		{
			...
			if (iLocal_938 != 0)
			{
				if (func_199())
				{
					if (has_scaleform_movie_loaded(iLocal_113))
					{
						func_175();
						iLocal_60 = 1;
					}
		...
		switch (iLocal_938)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
				{
					if (is_ped_sitting_in_vehicle(Global_100186, Global_100185))
					{
						if (!is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_enter", 3) && !is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_idle", 3))
						{
				...
				if (func_165())
				{
					if (func_164() && !is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						func_175();
						iLocal_815 = 1;
						iLocal_937 = 0;
...
void func_56()
{
	...
	if (!func_208())
	{
		if (has_scaleform_movie_loaded(iLocal_114))
		{
			if (iLocal_938 != 0)
			{
	...
	{
		set_scaleform_movie_as_no_longer_needed(&iLocal_114);
		iLocal_60 = 1;
	}
}

void func_57(int iParam0, auto uParam1, auto uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < *uParam2.f_680)
			{
				if (GAMEPLAY::IS_BIT_SET(*uParam2.f_676, iVar0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(*uParam2.f_677, iVar0))
					{
						...
						func_61(_get_control_action_name(iVar1, iVar2, true));
						if (iVar3 < 344)
						{
							func_61(_get_control_action_name(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_61(_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_67(int iParam0, int iParam1, char* sParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	switch (iLocal_940)
	{
		...
		case 1:
			if (is_screen_faded_out() && is_audio_scene_active("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (is_vehicle_driveable(Global_100185, 0))
				{
					set_vehicle_radio_enabled(Global_100185, 0);
				}
				clear_prints();
				...
				if (is_cam_active(iLocal_70))
				{
					...
					Global_100202 = 0;
					set_cam_active(iLocal_70, false);
					render_script_cams(false, false, 3000, 1, 0, 0);
		...
		case 2:
			if (func_116(&vLocal_43, &Global_100192, &Global_100198))
			{
				func_147();
				iLocal_940 = 3;
			}
		...
		case 3:
			if (Global_69505 == -1)
			{
				...
				func_108();
				func_107();
				clear_area(Global_100192, 5f, 1, 0, 0, false);
				func_103(1097859072);
				if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
				{
				...
				new_load_scene_stop();
				clear_area(Global_100192, 5000f, 1, 0, 0, false);
				clear_area_of_objects(Global_100192, 5000f, 0);
				clear_area_of_projectiles(Global_100192, 30f, 0);
				remove_particle_fx_in_range(Global_100192, 5000f);
				remove_decals_in_range(Global_100192, 5000f);
				if (Global_88533 != -1)
				{
		...
		case 4:
			if (_new_load_scene_start_safe(Global_100192, 4500f, 0))
			{
				iLocal_59 = 1;
				iLocal_940 = 5;
			}
		...
		case 6:
			...
			if (iLocal_812 != -1)
			{
				...
				if (iVar1)
				{
					if (((func_48() == 0 && !GAMEPLAY::IS_BIT_SET(Global_82399[iLocal_812 /*34*/].f_15, 8)) || (func_48() == 1 && !GAMEPLAY::IS_BIT_SET(Global_82399[iLocal_812 /*34*/].f_15, 9))) || (func_48() == 2 && !GAMEPLAY::IS_BIT_SET(Global_82399[iLocal_812 /*34*/].f_15, 10)))
					{
						iVar1 = false;
					}
				}
				...
				if (iVar1)
				{
					advance_clock_time_to(Global_82399[iLocal_812 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (iVar0)
			{
				...
				{
					iLocal_69 = 0;
					get_ground_z_for_3d_coord(Global_100192 + Vector(100f, 0f, 0f), &fVar2, 0);
				...
				if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
				{
					...
					task_vehicle_temp_action(Global_100186, Global_100185, 24, 5000);
				}
				iLocal_91 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_940 = 8;
			}
		...
		case 9:
			if (is_screen_faded_in() || func_72())
			{
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Global_100185, 1))
					{
						task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), false, 0);
					}
				}
	...
	switch (iLocal_813)
	{
		case 92:
			...
			if (fVar3 < 100f)
			{
				...
				vVar0 = {Global_100192 + vVar0.x * IntToFloat(100 - round(fVar3)), Global_100192.f_1 + vVar0.y * IntToFloat(100 - round(fVar3)), Global_100192.f_2};
				get_closest_vehicle_node_with_heading(vVar0, &Global_100192, &Global_100198, 1, 1077936128, 0);
				set_entity_coords(Global_100185, Global_100192, 1, false, 0, 1);
				set_entity_heading(Global_100185, Global_100198);
			}
			break;
...
float func_79(int iParam0)
{
	if (func_84(iParam0))
	{
		...
		{
			return func_80(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
void func_82(int iParam0, float fParam1)
{
	if (!func_84(iParam0))
	{
		func_83(iParam0, fParam1);
	}
}

void func_83(int iParam0, float fParam1)
{
	*iParam0.f_1 = func_80(GAMEPLAY::IS_BIT_SET(*iParam0, 4)) - fParam1;
...
int func_85(Vector3 vParam0)
{
	...
	if (func_86(0, 4))
	{
		...
		while (iVar1 <= 72)
		{
			fVar2 = vdist2(func_75(iVar1, 0), vParam0);
			if (fVar2 <= 1225f)
			{
				iVar0++;
			}
...
void func_103(float fParam0)
{
	...
	while (!iVar1 && iVar2 < 10)
	{
		...
		{
			iVar1 = false;
			if (get_nth_closest_vehicle_node(Global_100192, iVar2, &vVar3, 1, 3f, 0f))
			{
				iVar2++;
			}
		}
	}
	if (vdist2(vVar3, Global_100192) > 2f)
	{
		get_safe_coord_for_ped(vVar3, 0, &Global_100192, 0);
	}
}
...
bool func_104(int iParam0, Vector3 vParam1, float fParam2)
{
	...
	while (iVar6 < iVar0)
	{
		*iParam0 = get_closest_vehicle(vParam1, fParam4, iVar0[iVar6], 67590);
		if (*iParam0 != 0)
		{
			return true;
		}
...
void func_108()
{
	...
	fVar0 = func_111(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Global_100192);
	if (iLocal_66)
	{
	...
	func_109(to_float(iVar1 * 60 + iVar2) / 60f);
}
...
void func_110(int iParam0, float fParam1)
{
	if (func_84(iParam0))
	{
		func_83(iParam0, func_79(iParam0) + fParam1);
	}
}

float func_111(Vector3 vParam0, Vector3 vParam1)
{
...
void func_112()
{
	...
	fVar0 = func_111(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Global_100192) / 50f * fLocal_75 * 2.4f;
...
void func_113()
{
	iLocal_105 += round(get_frame_time() * 1000f);
	if (iLocal_105 > 5000)
	{
		fLocal_84 += fLocal_75;
		iLocal_105 = 0;
	}
	if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), vLocal_961, 0) > 50f)
	{
		fLocal_84 += fLocal_75;
		iLocal_105 = 0;
		vLocal_961 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 0)};
	}
	iLocal_103 = ceil(fLocal_84);
	if (iLocal_103 != iLocal_104)
	{
		_push_scaleform_movie_function(iLocal_113, "SET_TAXI_PRICE");
		_push_scaleform_movie_function_parameter_int(iLocal_103);
		_pop_scaleform_movie_function_void();
		fLocal_85 = vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Global_100192);
...
void func_114()
{
	...
	if (!func_32(14))
	{
		fVar1 = calculate_travel_distance_between_points(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Global_100192);
...
{
	new_load_scene_stop();
	if (_0x07C313F94746702C(Global_99866.f_218))
	{
		_0x1EE7D8DF4425F053(Global_99866.f_218);
	}
}

bool func_116(int iParam0, auto uParam1, float fParam2)
{
	Vector3 vVar0;
	...
	if (does_blip_exist(*iParam0))
	{
		switch (iLocal_937)
		{
			case 0:
				...
				if (does_blip_exist(Global_100190) && *iParam0 == Global_100190)
				{
					*uParam1 = {Global_100195};
					*fParam2 = Global_100199;
			...
			case 2:
				if (ENTITY::DOES_ENTITY_EXIST(Global_100185))
				{
					if (func_117(&Global_100185, get_entity_coords(Global_100185, 0), vLocal_949, uParam1, fParam2, &iLocal_90, 1000))
					{
						iLocal_937 = 3;
						return true;
					}
...
bool func_117(auto uParam0, Vector3 vParam1, Vector3 vParam2, auto uParam3, float fParam4, int iParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	Vector3 vVar2;
	...
	{
		while (!iVar19 && *iParam9 < iVar24)
		{
			if (vParam4.z == 1f)
			{
				fVar0 = 0f;
			}
			if (get_nth_closest_vehicle_node_with_heading(vParam4, *iParam9, uParam7, fParam8, &iVar12, iVar20, fVar0, fVar1))
			{
				iVar18 = get_nth_closest_vehicle_node_id(*uParam7, 1, iVar20, 1077936128, 0);
				if (is_vehicle_node_id_valid(iVar18))
				{
					if (get_closest_road(*uParam7, 1f, 1, &uVar8, &uVar5, &iVar14, &iVar13, &fVar16, iVar21))
					{
						...
						{
							*uParam7 = {_get_object_offset_from_coords(*uParam7, *fParam8, fVar15, 0f, 0f)};
...
bool func_118(Vector3 vParam0, Vector3 vParam1)
{
	Vector3 fVar0;
	float fVar1;
...
bool func_119(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
void func_120(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, auto uParam4, auto uParam5, int iParam6)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_121(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_123(Vector3 vParam0, auto uParam1, float fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
...
float func_125(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
int func_128(Vector3 vParam0, Vector3 vParam1, float fParam2)
{
	Vector3 vVar0;
...
bool func_129(Vector3 vParam0, int iParam1, int iParam2, int iParam3)
{
...
int func_130(int iParam0, Vector3 vParam1)
{
	return vdist2(vParam1, func_132(iParam0)) < func_131(iParam0);
}
...
bool func_133(Vector3 vParam0, Vector3 vParam1, Vector3 vParam2)
{
...
bool func_134(Vector3 vParam0, auto uParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_136(int iParam0, Vector3 vParam1)
{
	switch (iParam0)
	{
		case 76:
			...
			if (is_point_in_angled_area(vParam1, -1157.595f, -2726.636f, 12.94464f, -1110.794f, -2679.33f, 22.94466f, 26f, 0, true))
			{
				return true;
			}
			break;
		...
		case 70:
			...
			if (is_point_in_angled_area(vParam1, -1908.065f, 4432.693f, 51.3842f, -1962.212f, 4473.8f, 22.93989f, 70f, 0, true))
			{
				return true;
			}
			break;
		...
		case 71:
			...
			if (is_point_in_angled_area(vParam1, -541.8311f, 2050.599f, 186.3904f, -499.787f, 1968.325f, 228.0183f, 70f, 0, true))
			{
				return true;
			}
			break;
		...
		case 73:
			...
			if (is_point_in_angled_area(vParam1, -179.8588f, 4216.167f, 30.26505f, -246.32f, 4226.653f, 53.77886f, 70f, 0, true))
			{
				return true;
			}
			break;
		...
		case 74:
			...
			if (is_point_in_angled_area(vParam1, 1634.122f, 3858.049f, 28.33912f, 1573.259f, 3800.442f, 48.35476f, 70f, 0, true))
			{
				return true;
			}
			break;
		...
		case 75:
			...
			if (is_point_in_angled_area(vParam1, 2057.873f, 2059.198f, 63.88074f, 1999.045f, 2190.544f, 122.2642f, 110f, 0, true))
			{
				return true;
			}
			break;
		...
		case 72:
			...
			if (is_point_in_angled_area(vParam1, 3028.084f, 2768.167f, 57.72984f, 2944.284f, 2772.836f, 30.23068f, 85f, 0, true))
			{
				return true;
			}
			break;
		...
		case 106:
			...
			if (is_point_in_angled_area(vParam1, 2097.951f, 4820.308f, 55.48169f, 2151.254f, 4726.398f, 31.0732f, 120f, 0, true))
			{
				return true;
			}
			break;
		...
		case 125:
			...
			if (is_point_in_angled_area(vParam1, -763.5086f, -1297.98f, 2.000373f, -864.1372f, -1278.007f, 24.15038f, 85f, 0, true))
			{
				return true;
			}
			break;
		...
		case 126:
			...
			if (is_point_in_angled_area(vParam1, 1137.022f, 89.06853f, 74.89022f, 1267.821f, 292.0106f, 102.9904f, 195f, 0, true))
			{
				return true;
			}
			break;
		...
		case 127:
			...
			if (is_point_in_angled_area(vParam1, 2512.305f, 1519.462f, 28.55504f, 2380.374f, 1521.587f, 58.80984f, 90f, 0, true))
			{
				return true;
			}
			break;
		...
		case 128:
			...
			if (is_point_in_angled_area(vParam1, -193.5583f, 6533.439f, -1.902109f, -299.2512f, 6645.049f, 20.45973f, 120f, 0, true))
			{
				return true;
			}
			break;
		...
		case 131:
			...
			if (is_point_in_angled_area(vParam1, -1171.147f, 4647.89f, 203.7937f, -1280.149f, 4457.597f, 5.653551f, 120f, 0, true))
			{
				return true;
			}
			break;
		...
		case 132:
			...
			if (is_point_in_angled_area(vParam1, -687.974f, 4499.52f, 114.781f, -826.0081f, 4496.864f, 49.88359f, 140f, 0, true))
			{
				return true;
			}
			break;
		...
		case 134:
			...
			if (is_point_in_angled_area(vParam1, -1364.701f, 4490.626f, 49.52477f, -1367.169f, 4340.34f, -1.682158f, 100f, 0, true))
			{
				return true;
			}
			break;
		...
		case 135:
			...
			if (is_point_in_angled_area(vParam1, 2566.189f, 5007.007f, 97.36896f, 2491.714f, 4923.261f, 30.43494f, 80f, 0, true))
			{
				return true;
			}
			break;
		...
		case 136:
			...
			if (is_point_in_angled_area(vParam1, 1009.917f, -163.4684f, 102.1028f, 1113.474f, -221.3295f, 49.8745f, 90f, 0, true))
			{
				return true;
			}
			break;
...
bool func_137(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
bool func_138(int iParam0, Vector3 vParam1)
{
	switch (iParam0)
	{
		...
		case 11:
			...
			if (is_point_in_angled_area(vParam1, 1882.79f, 4725.034f, 34.74373f, 1701.497f, 4677.47f, 47.89289f, 159.5f, 0, true))
			{
				return true;
			}
			break;
		...
		case 21:
			...
			if (is_point_in_angled_area(vParam1, -1903.322f, -401.2384f, 19.23456f, -1844.879f, -445.7261f, 73.56197f, 115f, 0, true))
			{
				return true;
			}
			break;
		...
		case 22:
			...
			if (is_point_in_angled_area(vParam1, 794.2453f, 1277.443f, -100f, 833.8215f, 1277.108f, 400f, 19f, 0, true))
			{
				return true;
			}
			break;
		...
		case 23:
			...
			if (is_point_in_angled_area(vParam1, -1015.526f, 6287.513f, -10.94449f, -761.3104f, 5895.014f, 45.33727f, 167.75f, 0, true))
			{
				return true;
			}
			break;
		...
		case 24:
			...
			if (is_point_in_angled_area(vParam1, -72.13491f, -1267.587f, 27.68361f, -72.18015f, -1256.712f, 31f, 30f, 0, true))
			{
				return true;
			}
			break;
		...
		case 33:
			...
			if (is_point_in_angled_area(vParam1, -21.12362f, 4518.907f, 119.7836f, 43.13283f, 4538.929f, 72.58955f, 48f, 0, true))
			{
				return true;
			}
			break;
		...
		case 39:
			...
			if (is_point_in_angled_area(vParam1, -1088.425f, 372.0723f, 62.75896f, -967.03f, 363.5976f, 101.3483f, 75f, 0, true))
			{
				return true;
			}
			break;
		...
		case 43:
			...
			if (is_point_in_angled_area(vParam1, -91.45676f, -1296.975f, 26.15437f, 40.67288f, -1297.459f, 58.29368f, 110f, 0, true))
			{
				return true;
			}
			break;
		...
		case 47:
			...
			if (is_point_in_angled_area(vParam1, -78.38029f, 285.5254f, 102.6286f, -51.1546f, 357.5217f, 122.0617f, 40f, 0, true))
			{
				return true;
			}
			break;
		...
		case 49:
			...
			if (is_point_in_angled_area(vParam1, 420.5196f, 116.2892f, 77.57532f, 212.2937f, 193.6794f, 131.8767f, 250f, 0, true))
			{
				return true;
			}
			break;
		...
		case 50:
			...
			if (is_point_in_angled_area(vParam1, 1140.158f, -540.9644f, 49.99944f, 972.3716f, -535.1002f, 85.64397f, 168.25f, 0, true))
			{
				return true;
			}
			break;
...
bool func_139(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
...
bool func_140(int iParam0, Vector3 vParam1)
{
	switch (iParam0)
	{
		case 3:
			...
			if (is_point_in_angled_area(vParam1, -1535.754f, -922.101f, 4.122119f, -1487.87f, -961.3929f, 26.71922f, 50f, 0, true))
			{
				return true;
			}
			break;
		...
		case 8:
			...
			if (is_point_in_angled_area(vParam1, 53.12898f, -463.9999f, 36.9208f, 99.3761f, -329.3476f, 118.0454f, 125f, 0, true))
			{
				return true;
			}
			break;
		...
		case 38:
			...
			if (is_point_in_angled_area(vParam1, 1420.347f, -2036.558f, 47.36072f, 1341.11f, -2103.844f, 72.32651f, 55f, 0, true))
			{
				return true;
			}
			break;
		...
		case 48:
			...
			if (is_point_in_angled_area(vParam1, -2306.98f, 435.3038f, 171.4666f, -2303.291f, 366.3199f, 179.6018f, 65.5f, 0, true))
			{
				return true;
			}
			break;
		...
		case 45:
			...
			if (is_point_in_angled_area(vParam1, 1324.172f, 1110.748f, 99.65493f, 1523.097f, 1110.473f, 132.8859f, 170f, 0, true))
			{
				return true;
			}
			break;
		...
		case 60:
			...
			if (is_point_in_angled_area(vParam1, -995.978f, -517.4324f, 11.37763f, -1060.725f, -547.5588f, 65.33043f, 35.75f, 0, true))
			{
				return true;
			}
			break;
		...
		case 86:
			...
			if (is_point_in_angled_area(vParam1, 682.6544f, -968.7439f, 19.97575f, 762.8684f, -964.4064f, 43.03712f, 53f, 0, true))
			{
				return true;
			}
			break;
		...
		case 87:
			...
			if (is_point_in_angled_area(vParam1, 148.8361f, -3029.146f, 4.277727f, 148.1396f, -3342.344f, 22.90379f, 97.75f, 0, true))
			{
				return true;
			}
			break;
		...
		case 78:
			...
			if (is_point_in_angled_area(vParam1, 446.8174f, -1691.708f, 23.28233f, 288.5565f, -1552.352f, 108.3117f, 155f, 0, true))
			{
				return true;
			}
			break;
		...
		case 79:
			...
			if (is_point_in_angled_area(vParam1, 910.9382f, -1749.91f, 14.50614f, 921.7415f, -1455.248f, 99.67125f, 210f, 0, true))
			{
				return true;
			}
			break;
		...
		case 83:
			...
			if (is_point_in_angled_area(vParam1, 2657.302f, 2974.529f, 34.53447f, 2591.657f, 2880.223f, 68.08156f, 78.75f, 0, true))
			{
				return true;
			}
			break;
		...
		case 84:
			...
			if (is_point_in_angled_area(vParam1, 83.32325f, -1312.172f, 23.33694f, 148.383f, -1273.553f, 49.46651f, 65f, 0, true))
			{
				return true;
			}
			break;
...
bool func_141(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
...
bool func_144(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	{
		*iParam1 = iVar6;
		if (GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[*iParam1 /*6*/], false) && !GAMEPLAY::IS_BIT_SET(Global_101154.f_17264[*iParam1 /*6*/], 3))
		{
...
bool func_146(auto uParam0, int iParam1, float fParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	while (iVar6 < 8)
	{
		if (Global_88544[iVar6 /*17*/])
		{
			...
			{
				if (does_blip_exist(Global_25433[Global_88544[iVar6 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = {get_blip_coords(Global_25433[Global_88544[iVar6 /*17*/].f_9 /*23*/].f_19)};
					if (*uParam0.f_2 == 1f)
					{
						vVar3.z = 1f;
					}
	...
	if (does_group_exist(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!PED::IS_PED_INJURED(iVar2))
				{
					if (!is_ped_sitting_in_vehicle(iVar2, Global_100185))
					{
						iVar3 = false;
						if (!is_vehicle_seat_free(Global_100185, iVar3))
						{
							iVar3 = func_149(&Global_100185);
							if (is_vehicle_seat_free(Global_100185, iVar3))
							{
								clear_ped_tasks(iVar2);
								set_ped_into_vehicle(iVar2, Global_100185, iVar3);
							}
						}
						else
						{
...
int func_149(auto uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			if (is_vehicle_seat_free(*uParam0, false))
			{
				return 0;
			}
			if (is_vehicle_seat_free(*uParam0, true))
			{
				return 1;
			}
			if (is_vehicle_seat_free(*uParam0, 2))
			{
				return 2;
			}
		}
...
void func_157()
{
	...
	if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
	{
		if (is_ped_sitting_in_vehicle(Global_100186, Global_100185))
		{
			if (is_vehicle_stopped(Global_100185))
			{
				if (!is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_enter", 3) && !is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_idle", 3))
				{
					if (!func_2(Global_100186, -2118855366))
			...
			{
				vVar0 = {get_entity_coords(Global_100185, 1)};
				fVar3 = get_entity_heading(Global_100185);
				task_vehicle_park(Global_100186, Global_100185, vVar0, fVar3, 3, 60f, 0);
			}
		}
	}
}
		...
		if (iLocal_63)
		{
			...
			if (is_vehicle_driveable(Global_100185, 0))
			{
				if (!PED::IS_PED_INJURED(Global_100186))
				{
					if (func_160())
					{
						if (get_entity_speed(Global_100185) < 2f)
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Global_100185, 1))
					...
					else if (is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_enter", 3) || is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_idle", 3))
					{
						if (is_ped_headtracking_ped(Global_100186, PLAYER::PLAYER_PED_ID()))
						{
							task_clear_look_at(Global_100186);
						}
						task_play_anim(Global_100186, &cLocal_941, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_exit", 3))
					{
						set_entity_anim_speed(Global_100186, &cLocal_941, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_100186, 242628503))
					{
						...
						else
						{
							...
							clear_ped_tasks(Global_100186);
							task_clear_look_at(Global_100186);
							set_driver_ability(Global_100186, 0.5f);
							open_sequence_task(&iLocal_802);
							task_vehicle_drive_to_coord_longrange(false, Global_100185, Global_100192, fVar1, iVar0, 45f);
							task_vehicle_park(false, Global_100185, Global_100192, Global_100198, iLocal_112, 60f, 1);
							close_sequence_task(iLocal_802);
							task_perform_sequence(Global_100186, iLocal_802);
							clear_sequence_task(&iLocal_802);
						}
					}
				}
			}
...
bool func_159(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iVar3))
	{
		...
		iVar4 = true;
		iVar2 = get_ped_in_vehicle_seat(Global_100185, iVar6);
		...
		if (iVar4)
		{
			task_enter_vehicle(iVar3, Global_100185, 20000, iVar6, 2f, 9437185, 0);
			iVar5 = true;
		}
	}
	if (iVar0 > 1)
...
bool func_160()
{
	if ((is_entity_at_coord(Global_100185, Global_100192, 45f, 45f, 20f, false, true, 0) || iLocal_58) || iLocal_938 == 4)
	{
		iLocal_58 = 1;
		if (get_script_task_status(Global_100186, 242628503) == 7)
		{
			return true;
		}
	}
...
bool func_161()
{
	if (iLocal_62)
	{
		...
		else if (func_116(&vLocal_43, &Global_100192, &Global_100198))
		{
			iLocal_105 = 0;
			vLocal_961 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 0)};
			fLocal_85 = vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), Global_100192);
	...
	if (does_group_exist(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				iVar4 = true;
				iVar3 = get_ped_in_vehicle_seat(*uParam0, iVar5);
	...
	if (!PED::IS_PED_INJURED(Global_100186) && is_vehicle_driveable(Global_100185, 0))
	{
		if (is_ped_sitting_in_vehicle(Global_100186, Global_100185))
		{
			...
			if (has_anim_dict_loaded(&cLocal_941))
			{
				...
				open_sequence_task(&iLocal_802);
				task_play_anim(false, &cLocal_941, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				task_play_anim(false, &cLocal_941, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				close_sequence_task(iLocal_802);
				task_perform_sequence(Global_100186, iLocal_802);
				clear_sequence_task(&iLocal_802);
				return true;
...
bool func_164()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_100185))
	{
		if (is_vehicle_driveable(Global_100185, 0))
		{
			iLocal_111 = create_object(iLocal_110, get_entity_coords(Global_100185, 1), 1, true, false);
			attach_entity_to_entity(iLocal_111, Global_100185, get_entity_bone_index_by_name(Global_100185, "Chassis"), vLocal_973, vLocal_976, 0, 0, 0, 0, 2, 1);
			set_taxi_lights(Global_100185, 0);
			if (!is_named_rendertarget_registered("taxi"))
			{
				register_named_rendertarget("taxi", 0);
				link_named_rendertarget(ENTITY::GET_ENTITY_MODEL(iLocal_111));
			}
			iLocal_95 = get_named_rendertarget_render_id("taxi");
		}
	}
	return false;
}
...
bool func_165()
{
	...
	iLocal_114 = unk_0x67D02A194A2FC2BD("instructional_buttons");
	request_anim_dict(&cLocal_941);
	if (((STREAMING::HAS_MODEL_LOADED(iLocal_110) && has_scaleform_movie_loaded(iLocal_113)) && has_scaleform_movie_loaded(iLocal_114)) && has_anim_dict_loaded(&cLocal_941))
	{
		return true;
	}
	return false;
...
void func_166()
{
	...
	if (!does_cam_exist(iLocal_70))
	{
		...
		{
			iLocal_70 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
			attach_cam_to_entity(iLocal_70, Global_100185, vLocal_967, 1);
			func_170();
			_0x661B5C8654ADD825(iLocal_70, 1);
		}
	}
	else if (!iLocal_62 || iLocal_61)
	{
		if (!func_174() && !func_173(8, -1))
		{
			if (!is_cam_active(iLocal_70))
	...
	else if (is_cam_active(iLocal_70))
	{
		set_cam_active(iLocal_70, false);
...
void func_167()
{
	...
	_push_scaleform_movie_function(iLocal_113, "HIGHLIGHT_DESTINATION");
	_push_scaleform_movie_function_parameter_int(iLocal_94);
	_pop_scaleform_movie_function_void();
}
...
void func_168()
{
	...
	if (does_blip_exist(vLocal_43.x))
	{
		...
		if (does_cam_exist(iLocal_70) && is_cam_active(iLocal_70))
		{
...
void func_170()
{
	if (does_cam_exist(iLocal_70))
	{
		func_171(Global_100185, &iLocal_70, vLocal_970);
		set_cam_fov(iLocal_70, fLocal_76);
		set_cam_near_clip(iLocal_70, 0.01f);
		_0xA2767257A320FC82(iLocal_70, 1);
...
void func_171(int iParam0, int iParam1, Vector3 vParam2)
{
	...
	if (!is_entity_dead(iParam0, 0))
	{
		if (does_cam_exist(*iParam1))
		{
			...
			fVar5 = vVar0.y;
			vVar6 = {func_74(get_offset_from_entity_in_world_coords(Global_100185, vParam2) - get_offset_from_entity_in_world_coords(Global_100185, vLocal_967))};
...
void func_172(Vector3 vParam0, auto uParam1, auto uParam2, int iParam3)
{
	Vector3 fVar0;
...
void func_175()
{
	...
	iVar0 = false;
	func_181();
	_push_scaleform_movie_function(iLocal_113, "CLEAR_TAXI_DISPLAY");
	_pop_scaleform_movie_function_void();
	iVar0 = false;
	while (iVar0 < iLocal_93)
	{
		...
		else if (func_121(get_blip_coords(vLocal_816[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			_push_scaleform_movie_function(iLocal_113, "ADD_TAXI_DESTINATION");
			_push_scaleform_movie_function_parameter_int(iVar0);
			_push_scaleform_movie_function_parameter_int(get_blip_sprite(vLocal_816[iVar0 /*3*/]));
			get_hud_colour(get_blip_hud_colour(vLocal_816[iVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			...
			{
				_begin_text_component("STRING");
				_add_text_component_item_string(func_176(iVar8));
				_end_text_component();
			}
			if (get_blip_info_id_type(vLocal_816[iVar0 /*3*/]) == 2)
			{
				if (!PED::IS_PED_INJURED(get_ped_index_from_entity_index(get_blip_info_id_entity_index(vLocal_816[iVar0 /*3*/]))))
				{
			...
			else
			{
				...
				_0x17299B63C7683A2B(vLocal_816[iVar0 /*3*/].f_1);
				_0x17299B63C7683A2B(vLocal_816[iVar0 /*3*/].f_2);
				_end_text_component();
			}
			_pop_scaleform_movie_function_void();
			if (iLocal_62)
	...
	if (iLocal_62)
	{
		_push_scaleform_movie_function(iLocal_113, "SHOW_TAXI_DESTINATION");
		_pop_scaleform_movie_function_void();
		_push_scaleform_movie_function(iLocal_113, "HIGHLIGHT_DESTINATION");
		_push_scaleform_movie_function_parameter_int(iLocal_94);
		_pop_scaleform_movie_function_void();
...
void func_181()
{
	...
	if (get_mission_flag())
	{
		if (iLocal_96 == 0)
		{
			if (does_blip_exist(Global_100189))
			{
				iVar0 = 0;
				while (iVar0 < 40)
				{
					if (does_blip_exist(vLocal_816[iVar0 /*3*/]))
					{
						if (vLocal_816[iVar0 /*3*/] == Global_100189)
						{
							iLocal_94 = iVar0;
							iVar0 = 40;
						}
	...
	if (get_mission_flag())
	{
		if (!Global_100191 == -1)
		{
			...
			while (iVar0 < 40)
			{
				if (does_blip_exist(vLocal_816[iVar0 /*3*/]))
				{
					if (func_180(vLocal_816[iVar0 /*3*/]) == Global_100191)
					{
						iLocal_94 = iVar0;
						iVar0 = 40;
					}
			...
			if (func_184(iVar4))
			{
				if (func_197(iVar4))
				{
					if (!func_195(&iVar4))
					{
						...
						if (does_blip_exist(Global_100188))
						{
...
void func_186(Vector3 vParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_187(Vector3 vParam0, int iParam1)
{
	func_188(iParam3);
	vLocal_816[iParam3 /*3*/] = {vParam0};
	if (func_180(vLocal_816[iParam3 /*3*/]) == _get_blip_info_id_iterator())
	{
		iLocal_99 = iParam3;
...
void func_189(Vector3 vParam0, int iParam1)
{
	vLocal_816[iParam3 /*3*/] = {vParam0};
	if (func_180(vLocal_816[iParam3 /*3*/]) == _get_blip_info_id_iterator())
	{
...
bool func_190(int iParam0, auto uParam1, auto uParam2, int iParam3, auto uParam4, auto uParam5)
{
...
float func_191(int iParam0)
{
	...
	if (is_player_playing(player_id()))
	{
		if (does_blip_exist(iParam0))
		{
			vVar0 = {func_40(iParam0) - get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
		}
	}
	return vmag(vVar0);
}
...
void func_192(int iParam0, auto uParam1)
{
	...
	*uParam1 = *iParam0;
	...
	{
		get_street_name_at_coord(Global_100192, uParam1.f_1, uParam1.f_2);
	}
}
...
int func_194(int iParam0)
{
	...
	while (iVar0 < 8)
	{
		if (Global_88544[iVar0 /*17*/])
		{
			if (Global_88544[iVar0 /*17*/].f_9 != 263)
			{
				if (does_blip_exist(Global_25433[Global_88544[iVar0 /*17*/].f_9 /*23*/].f_19))
				{
					if (Global_25433[Global_88544[iVar0 /*17*/].f_9 /*23*/].f_19 == *iParam0)
					{
						return Global_88544[iVar0 /*17*/].f_5;
...
bool func_195(int iParam0)
{
	...
	if (func_196(get_blip_coords(*iParam0), 0f, 0f, 0f, 0))
	{
		return true;
	}
...
int func_196(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
	...
	if (timerb() > 250)
	{
		...
		if (!iVar0)
		{
			if (iLocal_99 != -1)
			{
				...
				{
					if (func_180(vLocal_816[iLocal_99 /*3*/]) == _get_blip_info_id_iterator())
					{
				...
				{
					iVar4 = get_first_blip_info_id(_get_blip_info_id_iterator());
					if (does_blip_exist(iVar4))
					{
						vVar1 = {get_blip_coords(iVar4)};
						if (!func_121(vVar1, vLocal_964, 1056964608, 0))
						{
							iVar0 = true;
						}
...
int func_200()
{
	...
	{
		if (!is_vehicle_seat_free(Global_100185, -1))
		{
			iVar0++;
		}
		if (!is_vehicle_seat_free(Global_100185, false))
		{
			iVar0++;
		}
		if (!is_vehicle_seat_free(Global_100185, true))
		{
			iVar0++;
		}
		if (!is_vehicle_seat_free(Global_100185, 2))
		{
			iVar0++;
		}
	}
...
void func_201()
{
	if (iLocal_938 != 0)
	{
		set_text_render_id(iLocal_95);
		_set_2d_layer(4);
		_0xC6372ECD45D73BCD(1);
		if (is_vehicle_driveable(Global_100185, 0))
		{
			draw_scaleform_movie(iLocal_113, fLocal_88, fLocal_89, fLocal_86, fLocal_87, 0, 0, 0, 255, 0);
		}
	}
}
			...
			if (iLocal_938 == 2)
			{
				...
				if (!iLocal_66)
				{
					if (is_control_just_pressed(2, 179))
					{
						...
						if (!PED::IS_PED_INJURED(Global_100186))
						{
							if (!is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_enter", 3))
							{
								if (!is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_idle", 3))
								{
									if (!is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_exit", 3))
									{
										clear_ped_tasks(Global_100186);
									}
								}
...
void func_204()
{
	...
	_push_scaleform_movie_function(iLocal_113, "SET_INPUT_EVENT");
...
void func_207(auto uParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4)
{
...
void func_211()
{
	if (!Global_100190 == 0)
	{
		if (!does_blip_exist(Global_100190))
		{
			Global_100190 = 0;
		}
	}
...
bool func_215()
{
	...
	if (is_player_playing(player_id()))
	{
		if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (func_216(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
				{
					iVar0 = get_ped_in_vehicle_seat(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), -1);
...
bool func_217(int iParam0)
{
	...
	if (iLocal_938 != 4)
	{
		if (iParam0 == 1)
		{
			...
			if (((is_vehicle_stuck_timer_up(Global_100185, 2, 30000) || is_vehicle_stuck_timer_up(Global_100185, 3, 30000)) || is_vehicle_stuck_timer_up(Global_100185, 0, 7000)) || is_vehicle_stuck_timer_up(Global_100185, 1, 7000))
			{
				return true;
			}
		}
		vVar0 = {get_entity_coords(Global_100185, 0)};
...
bool func_219()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_223(&iVar0, func_225(), func_224()))
		{
			...
			hide_hud_component_this_frame(2);
			stop_ped_speaking(PLAYER::PLAYER_PED_ID(), 1);
			if (get_ped_in_vehicle_seat(iVar0, true) == PLAYER::PLAYER_PED_ID())
			{
				iLocal_979 = 1;
			}
			else
			...
			{
				vLocal_958 = {get_entity_coords(Global_100185, 1) - get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
				vLocal_958.z = 0f;
...
void func_220()
{
	...
	if (is_vehicle_driveable(Global_100185, 0))
	{
		if (!is_vehicle_seat_free(Global_100185, true))
		{
			iVar0 = get_ped_in_vehicle_seat(Global_100185, true);
			if (PLAYER::PLAYER_PED_ID() != iVar0)
			{
				if (!is_ped_group_member(iVar0, get_player_group(player_id())))
				{
					task_smart_flee_ped(iVar0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
				}
			}
		}
		if (!is_vehicle_seat_free(Global_100185, 2))
		{
			iVar0 = get_ped_in_vehicle_seat(Global_100185, 2);
			if (PLAYER::PLAYER_PED_ID() != iVar0)
			{
				if (!is_ped_group_member(iVar0, get_player_group(player_id())))
				{
		...
		if (is_vehicle_driveable(*iParam0, 0))
		{
			if (!PED::IS_PED_INJURED(*iParam1))
			{
				if (is_ped_sitting_in_vehicle(*iParam1, *iParam0))
				{
					...
					if (iParam2)
					{
						set_entity_as_mission_entity(Global_100186, true, 1);
						set_entity_as_mission_entity(Global_100185, true, 1);
						StringCopy(&Global_100216, get_this_script_name(), 24);
					}
					else
					{
						if (!is_entity_a_mission_entity(Global_100186))
						{
							set_entity_as_mission_entity(Global_100186, true, 0);
						}
						if (!is_entity_a_mission_entity(Global_100185))
						{
							set_entity_as_mission_entity(Global_100185, true, 0);
							StringCopy(&Global_100216, get_this_script_name(), 24);
						}
					}
					...
					set_vehicle_doors_locked(Global_100185, 1);
					set_vehicle_has_been_owned_by_player(Global_100185, 1);
					set_vehicle_automatically_attaches(Global_100185, false, 0);
					_0xBE5C1255A1830FF5(Global_100185, 1);
					return true;
				}
			}
		}
...
void func_222()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_100186))
	{
		if (!PED::IS_PED_INJURED(Global_100186))
		{
			...
			{
				if (is_ped_in_any_vehicle(Global_100186, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_100185))
					{
						if (is_vehicle_driveable(Global_100185, 0))
						{
							if (is_ped_sitting_in_vehicle(Global_100186, Global_100185))
							{
								if (get_script_task_status(Global_100186, -258271821) != 1 && get_script_task_status(Global_100186, -258271821) != 0)
								{
									open_sequence_task(&iVar0);
									if ((!is_vehicle_seat_free(Global_100185, true) || !is_vehicle_seat_free(Global_100185, 2)) || !is_vehicle_seat_free(Global_100185, false))
									{
									...
									task_vehicle_drive_wander(false, Global_100185, 12f, 790699);
									close_sequence_task(iVar0);
									task_perform_sequence(Global_100186, iVar0);
									clear_sequence_task(&iVar0);
								}
							}
							else
							{
								task_smart_flee_ped(Global_100186, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							}
						}
						else
						{
				...
				else if (get_script_task_status(Global_100186, -1146898486) != 1 && get_script_task_status(Global_100186, -1146898486) != 0)
				{
					task_wander_standard(Global_100186, 1193033728, 0);
				}
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_100186))
	{
		if (is_entity_a_mission_entity(Global_100186))
		{
			if (does_entity_belong_to_this_script(Global_100186, 0))
			{
				if (!PED::IS_PED_INJURED(Global_100186))
				{
					set_entity_load_collision_flag(Global_100186, false);
					set_blocking_of_non_temporary_events(Global_100186, false);
				}
				set_ped_as_no_longer_needed(&Global_100186);
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_100185))
	{
		if (is_entity_a_mission_entity(Global_100185))
		{
			if (does_entity_belong_to_this_script(Global_100185, 0))
			{
				if (is_vehicle_driveable(Global_100185, 0))
				{
					set_vehicle_has_been_owned_by_player(Global_100185, 0);
					set_vehicle_automatically_attaches(Global_100185, true, 0);
					_0xBE5C1255A1830FF5(Global_100185, 0);
				}
				set_vehicle_as_no_longer_needed(&Global_100185);
			}
		}
	}
	Global_100186 = 0;
...
void func_226(int iParam0)
{
	...
	set_scaleform_movie_as_no_longer_needed(&iLocal_113);
	set_scaleform_movie_as_no_longer_needed(&iLocal_114);
	if (func_227(Global_100186))
	{
		if (is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_enter", 3))
		{
			stop_entity_anim(Global_100186, "leanover_enter", &cLocal_941, -2f);
		}
		else if (is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_idle", 3))
		{
			stop_entity_anim(Global_100186, "leanover_idle", &cLocal_941, -2f);
		}
		else if (is_entity_playing_anim(Global_100186, &cLocal_941, "leanover_exit", 3))
		{
			stop_entity_anim(Global_100186, "leanover_exit", &cLocal_941, -2f);
		}
		if (is_ped_headtracking_ped(Global_100186, PLAYER::PLAYER_PED_ID()))
		{
			task_clear_look_at(Global_100186);
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_3(Global_100185))
		{
			if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), Global_100185, 1))
			{
				if (get_ped_in_vehicle_seat(Global_100185, -1) != PLAYER::PLAYER_PED_ID())
				{
					if (!func_2(PLAYER::PLAYER_PED_ID(), -828834893) && !func_2(PLAYER::PLAYER_PED_ID(), 451360105))
					{
						task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), false, 0);
