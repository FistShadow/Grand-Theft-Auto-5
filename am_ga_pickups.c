...
bool func_28(struct<41> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<20> Var0;
	int iVar20;
...
void func_32(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4)
{
	if (!network_is_game_in_progress())
	{
		func_27();
