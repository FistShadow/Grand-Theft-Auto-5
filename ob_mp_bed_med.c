...
void main()
{
	...
	while (true)
	{
		...
		{
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_322)
				{
					case 0:
			...
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f)
			{
				func_73();
			}
		}
...
void func_2()
{
	...
	switch (iLocal_323)
	{
		...
		case 1:
			vLocal_350 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)};
			if (func_39(1, 0, 1))
			{
				if ((((((func_45(vLocal_334, vVar0) && vLocal_350.z < vLocal_334.z + 1f) && func_49(9)) && get_interior_from_entity(PLAYER::PLAYER_PED_ID()) == get_interior_at_coords(vLocal_334)) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_338, vLocal_341, 2f, 0, true, 0)) && func_44()) && !func_41(player_id()))
				{
					if (func_37(iLocal_329, 1))
					{
						...
						if (get_follow_ped_cam_view_mode() == 4)
						{
							set_ped_desired_heading(PLAYER::PLAYER_PED_ID(), func_16(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_41, 1)));
		...
		if ((!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_on_fire(PLAYER::PLAYER_PED_ID())) && is_player_control_on(player_id()))
		{
			if (!is_explosion_in_sphere(-1, vParam0, 2f))
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_38(0)) && !func_48())
				{
					...
					if (func_46(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return true;
					}
				}
