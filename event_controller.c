...
bool func_4(struct<6> Param0, struct<16> Param1, auto uParam2, struct<13> Param3, auto uParam4, int iParam5)
{
	...
	while (iVar21 <= 11)
	{
		if (iVar20 == Global_2395202[iVar21 /*4*/].f_3 && GAMEPLAY::GET_GAME_TIMER() < Global_2395202[iVar21 /*4*/].f_2)
		{
			Global_2395202[iVar21 /*4*/].f_2 = GAMEPLAY::GET_GAME_TIMER() + 30000;
			iVar21 = 12;
			func_46(uParam22);
			return false;
		}
	...
	else
	{
		...
		if (func_18(player_id(), Param23))
		{
			...
			{
				func_46(uParam22);
				if ((is_xbox360_version() || is_ps3_version()) && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
					func_17();
				}
				else
	...
	{
		Global_2392939[iVar82 /*98*/].f_47 = GAMEPLAY::GET_GAME_TIMER() + 15000;
	}
	return true;
}
...
int func_20(auto uParam0)
{
	...
	if (func_24(uParam0))
	{
		return GAMEPLAY::IS_BIT_SET(Global_2395256.f_356[*uParam0.f_9 /*75*/].f_10.f_63, 14);
	}
	if (func_23(*uParam0.f_1))
	{
		if (func_22(uParam0))
		{
			return GAMEPLAY::IS_BIT_SET(Global_2398013.f_1.f_63, 14);
		}
		return iVar0;
	}
	...
	{
		case 63:
			return GAMEPLAY::IS_BIT_SET(Global_794608.f_4[iVar1 /*88*/].f_76, 14);
		
		case 62:
			return GAMEPLAY::IS_BIT_SET(Global_906487.f_1204[iVar1 /*88*/].f_76, 14);
...
int func_28(auto uParam0)
{
	...
	if (func_24(uParam0))
	{
		return GAMEPLAY::IS_BIT_SET(Global_2395256.f_356[*uParam0.f_9 /*75*/].f_10.f_63, 17);
	}
	if (func_23(*uParam0.f_1))
	{
		if (func_22(uParam0))
		{
			return GAMEPLAY::IS_BIT_SET(Global_2398013.f_1.f_63, 17);
		}
		return iVar0;
	}
	iVar1 = func_21(uParam0);
	...
	{
		case 63:
			return GAMEPLAY::IS_BIT_SET(Global_794608.f_4[iVar1 /*88*/].f_76, 17);
		
		case 62:
			return GAMEPLAY::IS_BIT_SET(Global_906487.f_1204[iVar1 /*88*/].f_76, 17);
...
void func_80()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2434762.f_2), 15);
}
