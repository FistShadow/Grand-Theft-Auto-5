#region Local Var
	...
	auto uLocal_284 = 0;
	auto uLocal_285 = 0;
	Vector3 vLocal_286 = 0;
	Vector3 vLocal_289 = 0;
	auto uLocal_292 = 0;
	auto uLocal_293 = 0;
	float fLocal_294 = 0;
	float fLocal_295 = 0;
	...
	char* sLocal_376 = 0;
	char* sLocal_377 = 0;
	Vector3 vLocal_378 = 0;
	float fLocal_381 = 0;
	Vector3 vLocal_382 = 0;
	Vector3 vLocal_385 = 0;
	Vector3 vLocal_388 = 0;
	Vector3 fLocal_391 = 0;
	int iLocal_392 = 0;
	int iLocal_393 = 0;
#endregion
...
void main()
{
	...
	{
		iLocal_41 = iLocal_393;
		iLocal_316 = Global_1587523[player_id() /*444*/].f_250.f_9;
		func_69(&Global_1224248, iLocal_316);
		vLocal_378 = {Global_1224248.f_146.f_82[5 /*102*/]};
		fLocal_381 = Global_1224248.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_381 < 0f)
		{
			fLocal_381 += 360f;
		}
		vLocal_388 = {Global_1224248.f_146.f_82[5 /*102*/].f_16};
		fLocal_391 = Global_1224248.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_382 = {Global_1224248.f_146.f_82[5 /*102*/].f_7};
		vLocal_385 = {Global_1224248.f_146.f_82[5 /*102*/].f_10};
	}
	reserve_network_mission_peds(2);
	while (true)
	{
		wait(0);
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !is_player_switch_in_progress())
		{
			if (get_distance_between_coords(vLocal_378, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 1) < 3f)
			{
				switch (iLocal_311)
				{
					case 0:
			...
			else if (get_distance_between_coords(vLocal_378, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 1) > 3f + 2f)
			{
				func_90();
			}
		}
...
void func_1()
{
	...
	{
		case 0:
			if (((func_52(vLocal_378, vVar0) && !func_51()) && get_entity_heading(PLAYER::PLAYER_PED_ID()) > fLocal_381 - 45f) && get_entity_heading(PLAYER::PLAYER_PED_ID()) < fLocal_381 + 45f)
			{
			...
			if (func_48(1, 0, 1))
			{
				if (((func_52(vLocal_378, vVar0) && !func_51()) && get_entity_heading(PLAYER::PLAYER_PED_ID()) > fLocal_381 - 45f) && get_entity_heading(PLAYER::PLAYER_PED_ID()) < fLocal_381 + 45f)
				{
					if ((!is_player_free_aiming(player_id()) && !is_player_targetting_anything(player_id())) && is_control_just_pressed(2, 51))
					{
						...
						func_24(1, 1, 1, 0);
						task_ped_slide_to_coord(PLAYER::PLAYER_PED_ID(), vLocal_378, fLocal_381, 0.75f);
						iLocal_312 = 2;
					}
				}
				else
		...
		case 2:
			...
			func_20();
			if (get_script_task_status(PLAYER::PLAYER_PED_ID(), 1045468327) == 7)
			{
				func_17(104, 1, -1, 1);
				iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_324, sLocal_325, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_16(iLocal_322))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_324, sLocal_326, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_322), sLocal_328, sLocal_324);
				}
				if (!func_16(iLocal_323))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_324, sLocal_327, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_323), sLocal_329, sLocal_324);
				}
				network_start_synchronised_scene(iLocal_317);
				iLocal_312 = 3;
			}
			break;
		...
		case 3:
			...
			hide_hud_and_radar_this_frame();
			func_20();
			iLocal_318 = _0x02C40BF885C567B6(iLocal_317);
			if (get_synchronized_scene_phase(iLocal_318) > 0.99f)
			{
		...
		case 4:
			...
			func_20();
			iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_372, sLocal_373, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_16(iLocal_322))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_372, sLocal_374, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_322), sLocal_376, sLocal_372);
			}
			if (!func_16(iLocal_323))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_372, sLocal_375, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_323), sLocal_377, sLocal_372);
			}
			network_start_synchronised_scene(iLocal_317);
		...
		case 5:
			...
			{
				iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_348, sLocal_349, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_16(iLocal_322))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_348, sLocal_350, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_322), sLocal_352, sLocal_348);
				}
				if (!func_16(iLocal_323))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_348, sLocal_351, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_323), sLocal_353, sLocal_348);
				}
				network_start_synchronised_scene(iLocal_317);
				if (func_50("SA_STRIP_CAM"))
				{
		...
		case 6:
			...
			{
				iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, true, 1f, 0f, 1f);
				network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_354, sLocal_355, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_16(iLocal_322))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_354, sLocal_356, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_322), sLocal_358, sLocal_354);
				}
				if (!func_16(iLocal_323))
				{
					network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_354, sLocal_357, 4f, -2f, 1, 0, 1000f, 0);
					play_facial_anim(net_to_ped(iLocal_323), sLocal_359, sLocal_354);
				}
				network_start_synchronised_scene(iLocal_317);
				iLocal_319++;
		...
		case 8:
			...
			func_20();
			iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_360, sLocal_361, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_16(iLocal_322))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_360, sLocal_362, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_322), sLocal_364, sLocal_360);
			}
			if (!func_16(iLocal_323))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_360, sLocal_363, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_323), sLocal_365, sLocal_360);
			}
			network_start_synchronised_scene(iLocal_317);
			iLocal_312 = 9;
			break;
		...
		case 10:
			...
			Global_1572921 = 3;
			iLocal_317 = network_create_synchronised_scene(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
			network_add_ped_to_synchronised_scene(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_366, sLocal_367, 4f, -2f, 1, 0, 1000f, 0);
			if (!func_16(iLocal_322))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_322), iLocal_317, sLocal_366, sLocal_368, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_322), sLocal_370, sLocal_366);
			}
			if (!func_16(iLocal_323))
			{
				network_add_ped_to_synchronised_scene(net_to_ped(iLocal_323), iLocal_317, sLocal_366, sLocal_369, 4f, -2f, 1, 0, 1000f, 0);
				play_facial_anim(net_to_ped(iLocal_323), sLocal_371, sLocal_366);
			}
			network_start_synchronised_scene(iLocal_317);
			iLocal_312 = 11;
			break;
		...
		case 11:
			...
			if (get_synchronized_scene_phase(iLocal_318) > 0.5f)
			{
				if (!func_16(iLocal_322))
				{
					if (network_has_control_of_network_id(iLocal_322))
					{
						func_11(&iLocal_322);
					}
				}
				if (!func_16(iLocal_323))
				{
					if (network_has_control_of_network_id(iLocal_323))
					{
						func_11(&iLocal_323);
					}
				}
				...
				_0xC819F3CBB62BF692(0, 1f, 3, 0);
				func_33(player_id(), 1, 0);
				iLocal_36 = 0;
				iLocal_312 = 0;
			}
			break;
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1338622.f_241.f_136[func_15(9) /*33*/][iParam0], func_14(9));
}
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_28(player_id())) && !func_26(player_id(), 0)) && !func_25())
			{
...
void func_33(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_36(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
...
void func_39()
{
	if (!network_does_network_id_exist(iLocal_322))
	{
		if (func_41(2, 0, 1))
		{
			if (can_register_mission_peds(2))
			{
				if (func_40(&iLocal_322, 5, iLocal_320, vLocal_388, fLocal_391, 1, 1, 1) && func_40(&iLocal_323, 5, iLocal_321, vLocal_388, fLocal_391, 1, 1, 1))
				{
...
bool func_40(int iParam0, int iParam1, int iParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
{
	return func_42(0, iParam0, 1, iParam1, iParam2);
}

bool func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if ((iParam2 && !iParam3) && iParam1 <= func_46(iParam0) - func_45(iParam0, 0))
	{
		return true;
	}
	else
...
bool func_52(Vector3 vParam0, float fParam1, auto uParam2, auto uParam3)
{
	if (is_player_playing(player_id()))
	{
		if ((!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_on_fire(PLAYER::PLAYER_PED_ID())) && is_player_control_on(player_id()))
		{
			if (!is_explosion_in_sphere(-1, vParam0, 2f))
			{
				if ((((is_gameplay_cam_rendering() && !is_cutscene_playing()) && !is_cinematic_cam_rendering()) && !func_56(0)) && !func_55())
				{
					...
					if (func_53(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return true;
					}
				}
...
bool func_53(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
	...
	while (iVar1 < iVar0)
	{
		if (!PED::IS_PED_INJURED(uVar2[iVar1]))
		{
			if (iLocal_35)
			{
				...
				{
					if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(uVar2[iVar1], 1), 1) < 3f)
					{
						return true;
					}
				}
...
bool func_57()
{
	...
	if (func_58() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_58()) == 0)
		{
			return true;
		}
	}
...
void func_70(int iParam0, auto uParam1, auto uParam2, int iParam3)
{
	struct<4> Var0;
...
void func_71(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	...
	*uParam2 = {func_73(iParam1, 86)};
	...
	vVar13 = {func_72(vVar13, -Var0[0 /*6*/].f_3.f_2)};
	vVar13 = {func_72(vVar13, Var0[1 /*6*/].f_3.f_2)};
...
Vector3 func_72(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
void func_80(auto uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 42:
		case 43:
			func_84(iParam1, 4, &vVar0, -1);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, -1);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 19f;
			func_84(iParam1, 276, &vVar0, -1);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, -1);
		...
		case 64:
		case 65:
			func_84(iParam1, 4, &vVar0, 61);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 61);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 21f;
			func_84(iParam1, 276, &vVar0, 61);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 61);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
			*(uParam0[1 /*8*/]).f_6 = 14.5f;
			break;
		...
		case 75:
		case 76:
			func_84(iParam1, 4, &vVar0, 73);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 73);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 9.75f;
			func_84(iParam1, 276, &vVar0, 73);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 73);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
			*(uParam0[1 /*8*/]).f_6 = 10.25f;
			func_84(iParam1, 483, &vVar0, 73);
			*(uParam0[2 /*8*/]) = {vVar0};
			func_84(iParam1, 484, &vVar0, 73);
		...
		case 81:
		case 82:
			func_84(iParam1, 4, &vVar0, 77);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 77);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 9.75f;
			func_84(iParam1, 276, &vVar0, 77);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 77);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
			*(uParam0[1 /*8*/]).f_6 = 5f;
			func_84(iParam1, 483, &vVar0, 77);
			*(uParam0[2 /*8*/]) = {vVar0};
			func_84(iParam1, 484, &vVar0, 77);
			*(uParam0[2 /*8*/].f_3) = {vVar0};
		...
		case 84:
		case 85:
			func_84(iParam1, 4, &vVar0, 83);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 83);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 26.75f;
			func_84(iParam1, 276, &vVar0, 83);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 83);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
			*(uParam0[1 /*8*/]).f_6 = 18.25f;
			break;
		
		case 86:
			func_84(iParam1, 4, &vVar0, 86);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 86);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 14.75f;
			func_84(iParam1, 276, &vVar0, 86);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 86);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
		...
		case 89:
		case 90:
			func_84(iParam1, 4, &vVar0, 88);
			*(uParam0[0 /*8*/]) = {vVar0};
			func_84(iParam1, 5, &vVar0, 88);
			*(uParam0[0 /*8*/].f_3) = {vVar0};
			*(uParam0[0 /*8*/]).f_6 = 27.25f;
			func_84(iParam1, 276, &vVar0, 88);
			*(uParam0[1 /*8*/]) = {vVar0};
			func_84(iParam1, 277, &vVar0, 88);
			*(uParam0[1 /*8*/].f_3) = {vVar0};
...
void func_84(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	struct<6>[] Var0 = new struct<6>[2];
	Vector3 vVar13;
