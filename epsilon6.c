...
void func_262()
{
	...
	switch (iLocal_190)
	{
		...
		case 3:
			...
			func_265(55);
			while (((!has_model_loaded(iLocal_761) || !has_model_loaded(Local_163.f_1)) || !has_anim_dict_loaded(Local_174.f_6)) || !func_264(55))
			{
		...
		case 4:
			...
			if (!func_261())
			{
				while (((((!has_model_loaded(Local_163.f_1) || !has_cutscene_loaded()) || !has_model_loaded(vLocal_156.y)) || !has_anim_dict_loaded(Local_174.f_6)) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff")) || !func_264(55))
				{
			...
			{
				while ((((!has_model_loaded(Local_163.f_1) || !has_model_loaded(vLocal_156.y)) || !has_anim_dict_loaded(Local_174.f_6)) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff")) || !func_264(55))
				{
					func_492("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					wait(0);
				}
...
int func_264(int iParam0)
{
	if (!func_172(iParam0))
	{
		return has_model_loaded(func_493(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_265(int iParam0)
{
	if (!func_172(iParam0))
	{
		request_model(func_493(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
int func_320(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return is_bit_set(func_91(func_321(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	return shift_right(iParam0, 26) & 31 * func_334(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_376()
{
	switch (iLocal_191)
	{
		case 0:
			...
			request_vehicle_recording(501, "Eps6_Takeoff");
			while ((((!func_264(55) || !has_anim_dict_loaded(Local_174.f_6)) || !has_model_loaded(Local_163.f_1)) || !has_model_loaded(joaat("p_amb_phone_01"))) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff"))
			{
				wait(0);
			}
			if (iLocal_209)
			...
			if (func_232())
			{
				...
				if (iLocal_230 == 0)
				{
					if (func_397(vLocal_156.x, Local_170, 1) < 350f)
					{
						...
						if (((has_model_loaded(Local_163.f_1) && func_264(55)) && has_anim_dict_loaded(Local_174.f_6)) && has_model_loaded(joaat("p_amb_phone_01")))
						{
							func_276();
							func_263();
							func_15(&uLocal_595, 3, Local_174, "JIMMYBOSTON", 0, 1);
