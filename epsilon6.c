		...
		case 1:
			...
			else
			{
				...
				if (func_232())
				{
					...
					if (((((!func_22() && !is_ped_fleeing(Local_174)) && !PED::IS_PED_RAGDOLL(Local_174)) && !is_ped_prone(Local_174)) && !PED::IS_PED_INJURED(Local_174)) && !is_ped_in_any_vehicle(Local_174, 0))
					{
...
void func_233()
{
	...
	{
		if (func_237(Local_174, 0, 1116471296, 1126825984, 1, 0, 0, 0) || is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 1))
		{
		...
		else if ((func_234(PLAYER::PLAYER_PED_ID(), Local_174, 1) || is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(Local_174, 1), 3f, 0)) || is_ped_being_jacked(Local_174))
		{
			if (iLocal_190 != 5 && iLocal_190 != 3)
			{
				iLocal_233 = true;
...
bool func_244(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_246(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_254(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_246(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_259()
{
	if (func_232())
	{
		if (_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 0), joaat("weapon_stickybomb"), 10f, 0))
		{
	...
	switch (iLocal_190)
	{
		...
		case 2:
			...
			if (func_232())
			{
				if (!func_261())
				{
					func_266(ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 200f, 12, 5000, 0, 0);
				}
				if (func_232())
				{
...
void func_273()
{
	...
	AI::TASK_PLAY_ANIM(false, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_276()
{
	switch (iLocal_190)
	{
		...
		case 4:
			...
			{
				iLocal_262 = create_object(joaat("p_amb_phone_01"), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1, true, false);
			}
...
bool func_318(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_327())
		{
			*uParam0 = func_323(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_323(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_326(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_324(iVar0, 0), 1);
			...
			if (func_232())
			{
				...
				else if (func_377(PLAYER::PLAYER_PED_ID(), Local_174, 5f, 1))
				{
					if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(Local_174))
					{
						...
						if ((vLocal_764.z - vLocal_767.z < 1.5f && !is_ped_falling(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
						{
							iLocal_191 = 2;
						}
					}
...
void func_380()
{
	...
	{
		fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1);
	}
	if (fVar0 < 50f)
	{
		fLocal_250 = 100f;
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_250)
	{
		if (!iLocal_214)
		{
		...
		else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174, 1), 1) > fLocal_251)
		{
			iLocal_264 = 2;
			iLocal_191 = 0;
			iLocal_190 = 6;
		...
		case 1:
			...
			if (func_232())
			{
				...
				else
				{
					...
					func_16(&(Local_170.f_3));
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 80f)
					{
						if (func_397(vLocal_156.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 150f)
							{
								if (func_390())
								{
									iLocal_233 = true;
						...
						else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 250f)
						{
							if (func_390())
							{
								iLocal_233 = true;
			...
			if (iLocal_195 == 0)
			{
				if (func_450(Local_182))
				{
					if (func_397(Local_182, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						...
						AI::TASK_PLAY_ANIM(false, "gestures@m@standing@casual", "gesture_bye_soft", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	if (iLocal_194 == 2)
	{
		switch (iLocal_196)
		{
			...
			case 2:
				if (func_449(Local_182) && func_449(PLAYER::PLAYER_PED_ID()))
				{
					if (func_231(Local_182, PLAYER::PLAYER_PED_ID(), 1) < 5f || AI::GET_SCRIPT_TASK_STATUS(Local_182, 242628503) == 7)
					{
						AI::CLEAR_PED_TASKS(Local_182);
						task_turn_ped_to_face_entity(Local_182, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_196 = 0;
			...
			if (func_232())
			{
				...
				else
				{
					...
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 80f)
					{
						...
						else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 120f)
						{
							if (func_390())
							{
								iLocal_233 = true;
	...
	switch (iLocal_191)
	{
		case 0:
			...
			if (func_449(Local_182))
			{
				...
				play_sound_from_entity(iLocal_236, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_entity_index(Local_182), "EPSILONISM_04_SOUNDSET", 0, 0);
				play_sound_from_entity(iLocal_237, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_entity_index(Local_182), "EPSILONISM_04_SOUNDSET", 0, 0);
			}
		...
		case 1:
			...
			else if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 50f)
			{
				if (!iLocal_214)
				{
					if (is_scripted_conversation_ongoing())
				...
				else
				{
					...
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_156.x, 1), 1) > 100f)
					{
						iLocal_264 = 1;
						iLocal_191 = 0;
						iLocal_190 = 6;
