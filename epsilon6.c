#region Local Var
	...
	auto uLocal_93 = 0;
	auto uLocal_94 = 0;
	struct<61> Local_95 = 0;
	Vector3 vLocal_156 = 0;
	auto uLocal_159 = 0;
	auto uLocal_160 = 0;
	auto uLocal_161 = 0;
	auto uLocal_162 = 0;
	struct<7> Local_163 = 0;
	struct<4> Local_170 = 0;
	struct<8> Local_174 = 0;
	struct<2> Local_182 = 0;
	auto uLocal_184 = 0;
	auto uLocal_185 = 0;
	auto uLocal_186 = 0;
	auto uLocal_187 = 0;
	...
	int iLocal_197 = 0;
	int iLocal_198 = 0;
	Vector3[] vLocal_199 = new Vector3[3];
	int iLocal_209 = 0;
	int iLocal_210 = 0;
	int iLocal_211 = 0;
	int iLocal_212 = 0;
	...
	float fLocal_251 = 0;
	int iLocal_252 = 0;
	Vector3 vLocal_253 = 0;
	Vector3 vLocal_256 = 0;
	int iLocal_259 = 0;
	int iLocal_260 = 0;
	int iLocal_261 = 0;
	int iLocal_262 = 0;
	...
	Vector3 vLocal_767 = 0;
	struct<61> Local_770 = 0;
#endregion
...
void main()
{
	...
	if (func_452(Local_95.f_35[0]))
	{
		...
		func_451(vLocal_156.x, 0);
		set_vehicle_has_strong_axles(vLocal_156.x, true);
		set_vehicle_doors_locked(vLocal_156.x, 1);
	}
	if (func_450(PLAYER::PLAYER_PED_ID()))
	{
		iLocal_760 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
	}
	if (func_449(Local_95.f_28[0]))
	{
		Local_182 = Local_95.f_28[0];
		set_blocking_of_non_temporary_events(Local_182, true);
...
{
	func_9(&(Global_95496.f_2311), vParam0, fParam3);
}

void func_9(auto uParam0, Vector3 vParam1, auto uParam2)
{
	*uParam0 = {vParam1};
	*uParam0.f_6 = uParam4;
}
...
void func_15(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	switch (iLocal_191)
	{
		...
		case 1:
			...
			else
			{
				...
				if (func_232())
				{
					if (func_231(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1) > 300f && !is_entity_on_screen(vLocal_156.x))
					{
						open_sequence_task(&iLocal_261);
						task_plane_mission(false, vLocal_156.x, false, false, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30);
						task_plane_mission(false, vLocal_156.x, false, false, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100);
						set_sequence_to_repeat(iLocal_261, 1);
						close_sequence_task(iLocal_261);
						task_perform_sequence(Local_174, iLocal_261);
						clear_sequence_task(&iLocal_261);
						iLocal_191 = 2;
					}
					if (((((!func_22() && !is_ped_fleeing(Local_174)) && !is_ped_ragdoll(Local_174)) && !is_ped_prone(Local_174)) && !PED::IS_PED_INJURED(Local_174)) && !is_ped_in_any_vehicle(Local_174, 0))
					{
						if (func_231(Local_174, PLAYER::PLAYER_PED_ID(), 1) <= 2.3f)
						{
					...
					switch (iLocal_243)
					{
						...
						case 2:
							if (is_playback_going_on_for_vehicle(vLocal_156.x))
							{
								...
								if (iLocal_245 == 0)
								{
									if (GAMEPLAY::GET_GAME_TIMER() - iLocal_244 > 23000)
									{
										...
										_set_vehicle_landing_gear(vLocal_156.x, 1);
										iLocal_245 = 1;
									}
								}
							}
							else
							{
								...
								{
									set_vehicle_engine_on(vLocal_156.x, true, 1, 0);
								}
								clear_sequence_task(&iLocal_261);
								iLocal_243++;
							}
				...
				else
				{
					...
					iLocal_191 = 0;
					iLocal_190 = 6;
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
					{
						iLocal_233 = true;
					}
					trigger_music_event("EPS_FAIL");
		...
		case 2:
			...
			if (!iLocal_210)
			{
				if (func_232())
				{
					if (_get_vehicle_landing_gear(vLocal_156.x) != 3 || _get_vehicle_landing_gear(vLocal_156.x) != 1)
					{
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_96(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_96(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_96(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_55(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_56(iParam1);
	if (Global_101154.f_1826.f_539[uVar0 /*65*/].f_63 != -99)
	{
		if (!func_169(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_96(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_96(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_96(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_87(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_96(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_96(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_96(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_66(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_88(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_92(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_91(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_89(uVar2, iVar3, iVar0, 1);
	}
}

void func_89(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_90(iParam2)];
	if (iVar0 != 0)
	{
...
int func_91(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_90(iParam1)];
...
int func_92(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_93(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_95(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_169(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_102(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_102(vVar16.z)] = func_83(iParam1, vVar16.x, func_102(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_102(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_106(int iParam0)
{
	...
	func_107(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_107(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_113(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_91(func_110(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_108(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_91(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_108(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_111(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_114(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_107(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_96(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_107(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_169(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_96(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_96(iParam1)))
	{
		return true;
	}
	return false;
...
void func_175()
{
	...
	{
		if (func_171(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_180(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_181(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_186()
{
	...
	{
		func_175();
		_0xBF59707B3E5ED531(func_187(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
bool func_205(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_210(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
int func_220(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_232()
{
	if (func_452(vLocal_156.x))
	{
		if (_get_vehicle_landing_gear(vLocal_156.x) == 4)
		{
...
void func_233()
{
	if (func_449(Local_174))
	{
		if (func_237(Local_174, 0, 1116471296, 1126825984, 1, 0, 0, 0) || is_bullet_in_area(get_entity_coords(Local_174, 1), 3f, 1))
		{
		...
		else if ((func_234(PLAYER::PLAYER_PED_ID(), Local_174, 1) || is_bullet_in_area(get_entity_coords(Local_174, 1), 3f, 0)) || is_ped_being_jacked(Local_174))
		{
			if (iLocal_190 != 5 && iLocal_190 != 3)
			{
				iLocal_233 = true;
		...
		else if (has_entity_been_damaged_by_entity(Local_174, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (has_ped_been_damaged_by_weapon(Local_174, false, 2))
			{
				if (iLocal_190 != 5 && iLocal_190 != 3)
				{
					iLocal_233 = true;
...
{
	if (func_450(iParam0) && is_ped_in_any_vehicle(iParam0, 0))
	{
		if (func_450(iParam1))
		{
...
void func_235()
{
	if (func_449(Local_174))
	{
		...
		set_ped_keep_task(Local_174, true);
		task_smart_flee_ped(Local_174, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
}

void func_236(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_237(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	...
	if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(iParam0))
	{
		...
		if (func_251(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
...
bool func_238(int iParam0, float fParam1)
{
	...
	if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(iParam0))
	{
		if (func_249(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
			if (is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
int func_240(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_241(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3 < iParam4);
}

bool func_241(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = {func_242(iParam4, iParam7)};
...
bool func_244(int iParam0, int iParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_246(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_246(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_245(vVar3, vVar0);
...
Vector3 func_246(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_250(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_251(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_255(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_252(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_252(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_254(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_246(vParam1 - get_entity_coords(iParam0, 1))};
...
bool func_255(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
bool func_259()
{
	if (func_232())
	{
		if (_0x34318593248C8FB2(get_entity_coords(vLocal_156.x, 0), joaat("weapon_stickybomb"), 10f, 0))
		{
...
void func_262()
{
	...
	switch (iLocal_190)
	{
		case 0:
			...
			while ((!STREAMING::HAS_MODEL_LOADED(iLocal_762) || !STREAMING::HAS_MODEL_LOADED(iLocal_761)) || !has_anim_dict_loaded("rcm_epsilonism4"))
			{
		...
		case 2:
			...
			if (func_232())
			{
				if (!func_261())
				{
					func_266(get_entity_coords(vLocal_156.x, 1), 200f, 12, 5000, 0, 0);
				}
				if (func_232())
				{
					freeze_entity_position(vLocal_156.x, false);
		...
		case 3:
			...
			func_265(55);
			while (((!STREAMING::HAS_MODEL_LOADED(iLocal_761) || !STREAMING::HAS_MODEL_LOADED(Local_163.f_1)) || !has_anim_dict_loaded(Local_174.f_6)) || !func_264(55))
			{
		...
		case 4:
			...
			if (!func_261())
			{
				while (((((!STREAMING::HAS_MODEL_LOADED(Local_163.f_1) || !has_cutscene_loaded()) || !STREAMING::HAS_MODEL_LOADED(vLocal_156.y)) || !has_anim_dict_loaded(Local_174.f_6)) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff")) || !func_264(55))
				{
					if (_0xB56BBBCC2955D9CB())
					{
						set_cutscene_ped_prop_variation("Jimmy_Boston", true, 0, 0, false);
					}
			...
			{
				while ((((!STREAMING::HAS_MODEL_LOADED(Local_163.f_1) || !STREAMING::HAS_MODEL_LOADED(vLocal_156.y)) || !has_anim_dict_loaded(Local_174.f_6)) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff")) || !func_264(55))
				{
					func_492("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					wait(0);
				}
...
void func_263()
{
	switch (iLocal_190)
	{
		...
		case 5:
			if (!func_452(Local_163))
			{
				Local_163 = create_vehicle(Local_163.f_1, Local_163.f_3, Local_163.f_6, 1, 1);
				set_vehicle_on_ground_properly(Local_163);
	...
	set_vehicle_model_is_suppressed(Local_163.f_1, true);
...
int func_264(int iParam0)
{
	if (!func_172(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(func_493(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_265(int iParam0)
{
	if (!func_172(iParam0))
	{
		STREAMING::REQUEST_MODEL(func_493(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_266(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	switch (iLocal_190)
	{
		case 0:
			if (func_449(Local_182))
			{
				...
				set_entity_coords(Local_182, -2881.755f, 3188.125f, 10.1136f, 1, false, 0, 1);
			...
			if (func_449(Local_182))
			{
				...
				set_ped_dies_when_injured(Local_182, true);
				set_ped_can_be_targetted(Local_182, false);
		...
		case 1:
			...
			{
				set_entity_heading(Local_182, 254.1723f);
				set_entity_coords(Local_182, -2889.89f, 3198.69f, 10.11f, 1, false, 0, 1);
				clear_ped_tasks(Local_182);
			}
			else
			{
...
void func_273()
{
	give_weapon_to_ped(Local_182, joaat("weapon_digiscanner"), false, true, true);
	set_ped_can_switch_weapon(Local_182, false);
	stop_ped_speaking(Local_182, 1);
	set_ped_dies_when_injured(Local_182, true);
	set_ped_can_be_targetted(Local_182, false);
	open_sequence_task(&iLocal_261);
	task_go_to_coord_while_aiming_at_coord(false, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, false, 0.5f, 4f, true, 0, 0, -957453492);
	task_play_anim(false, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	task_go_to_coord_while_aiming_at_coord(false, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, false, 0.5f, 4f, true, 0, 0, -957453492);
	task_play_anim(false, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	task_go_to_coord_while_aiming_at_coord(false, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, false, 0.5f, 4f, true, 0, 0, -957453492);
	task_play_anim(false, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	set_sequence_to_repeat(iLocal_261, 1);
	close_sequence_task(iLocal_261);
	task_perform_sequence(Local_182, iLocal_261);
}
...
void func_274()
{
	switch (iLocal_190)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(vLocal_156.x))
			{
				if (func_449(PLAYER::PLAYER_PED_ID()))
				{
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
					{
						func_275(PLAYER::PLAYER_PED_ID(), -2882.42f, 3197.76f, 10.74f, 0, 0, 1);
					}
				}
				delete_vehicle(&vLocal_156);
			}
			vLocal_156.x = create_vehicle(iLocal_761, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0);
			set_vehicle_on_ground_properly(vLocal_156.x);
			...
			set_vehicle_engine_can_degrade(vLocal_156.x, false);
			set_vehicle_has_strong_axles(vLocal_156.x, true);
			func_451(vLocal_156.x, 0);
		...
		case 2:
			if (func_232())
			{
				...
				set_vehicle_engine_can_degrade(vLocal_156.x, false);
				set_vehicle_has_strong_axles(vLocal_156.x, true);
				_set_vehicle_landing_gear(vLocal_156.x, 3);
				freeze_entity_position(vLocal_156.x, true);
			}
			else
			{
				vLocal_156.x = create_vehicle(iLocal_761, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0);
				set_vehicle_on_ground_properly(vLocal_156.x);
				add_vehicle_upsidedown_check(vLocal_156.x);
				set_vehicle_colours(vLocal_156.x, 157, 157);
				set_vehicle_extra_colours(vLocal_156.x, 157, 5);
				...
				if (!func_261())
				{
					set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, -1);
				}
				_set_vehicle_landing_gear(vLocal_156.x, 3);
				freeze_entity_position(vLocal_156.x, true);
		...
		case 4:
			...
			vLocal_156.x = create_vehicle(vLocal_156.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1);
			if (func_452(vLocal_156.x))
			{
				set_vehicle_on_ground_properly(vLocal_156.x);
				add_vehicle_upsidedown_check(vLocal_156.x);
		...
		case 5:
			...
			if (!iLocal_210)
			{
				...
				vLocal_156.x = create_vehicle(vLocal_156.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1);
				if (func_452(vLocal_156.x))
				{
					set_vehicle_on_ground_properly(vLocal_156.x);
					add_vehicle_upsidedown_check(vLocal_156.x);
	...
	set_vehicle_model_is_suppressed(vLocal_156.y, true);
}

int func_275(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	switch (iLocal_190)
	{
		...
		case 4:
			if (!func_449(Local_174))
			{
				...
				set_blocking_of_non_temporary_events(Local_174, true);
				set_ped_can_ragdoll_from_player_impact(Local_174, 0);
				set_ped_can_be_targetted(Local_174, false);
				PED::SET_PED_CONFIG_FLAG(Local_174, 185, true);
				set_ped_prop_index(Local_174, true, 0, 0, false);
			...
			{
				func_275(Local_174, Local_174.f_2, Local_174.f_5, 0, 1);
				if (func_449(Local_174))
				{
					task_play_anim(Local_174, Local_174.f_6, Local_174.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
					set_ped_prop_index(Local_174, true, 0, 0, false);
			...
			{
				iLocal_262 = create_object(joaat("p_amb_phone_01"), get_entity_coords(Local_174, 1), 1, true, false);
			}
			if (!is_entity_attached(iLocal_262))
			{
				attach_entity_to_entity(iLocal_262, Local_174, get_ped_bone_index(Local_174, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
			}
			func_279(55);
			break;
		...
		case 5:
			if (!iLocal_210)
			{
				if (!func_449(Local_174))
				{
					...
					{
						Local_174.f_1 = func_278(Local_174, 1, 1, 9);
					}
					if (func_449(Local_174) && func_232())
					{
						open_sequence_task(&iLocal_261);
						task_follow_nav_mesh_to_coord(false, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 40000f);
						task_enter_vehicle(false, vLocal_156.x, 20000, -1, 2f, 1, 0);
						close_sequence_task(iLocal_261);
						task_perform_sequence(Local_174, iLocal_261);
						clear_sequence_task(&iLocal_261);
					}
				...
				{
					func_275(Local_174, 1683.76f, 3270.74f, 39.78f, 168.3395f, 0, 1);
					if (!does_blip_exist(Local_174.f_1))
					{
						Local_174.f_1 = func_278(Local_174, 1, 1, 9);
					}
...
void func_279(int iParam0)
{
	if (!func_172(iParam0))
	{
		set_model_as_no_longer_needed(func_493(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
bool func_280(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_281(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_281(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_282(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_283()
{
	switch (iLocal_190)
	{
		case 0:
			...
			if (!func_261())
			{
				func_275(PLAYER::PLAYER_PED_ID(), -2914.707f, 3234.639f, 9.7863f, 215.2149f, 0, 1);
			}
			break;
		...
		case 1:
			if (func_452(vLocal_156.x))
			{
				func_275(PLAYER::PLAYER_PED_ID(), -2892.93f, 3192.37f, 11.66f, 0, 0, 1);
				set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, -1);
			}
			break;
		...
		case 2:
			if (!func_261())
			{
				if (func_449(PLAYER::PLAYER_PED_ID()) && func_452(vLocal_156.x))
				{
					if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
					{
						set_ped_into_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, -1);
					}
					set_ped_coords_keep_vehicle(PLAYER::PLAYER_PED_ID(), 376.0205f, 2886.552f, 171.3085f);
				}
			}
			break;
		...
		case 4:
			if (!func_261())
			{
				func_275(PLAYER::PLAYER_PED_ID(), 1681.54f, 3259.38f, 39.77f, 298.33f, 0, 1);
			}
			break;
		...
		case 5:
			if (!func_261())
			{
				func_275(PLAYER::PLAYER_PED_ID(), 1688.45f, 3277.15f, 40.08f, 131.1749f, 1, 1);
			}
			break;
	}
	set_gameplay_cam_relative_heading(0f);
...
void func_284(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_342(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_219(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_285(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_286(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_286(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_328();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_307())
		{
			func_303(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_288(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_289(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_291(auto uParam0, int iParam1, int iParam2)
{
...
void func_296(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_297(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_298(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_299(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_300(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_301(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_302(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_302(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
int func_304(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_90(iParam1)];
...
void func_305(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_306(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_309(int iParam0, auto uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_313(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_310(Var9.f_1)) && iVar70 < 50)
			{
...
int func_312(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_316(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_318(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_327())
		{
			*uParam0 = func_323(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_320(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_91(func_321(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_323(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_325(iVar0))
			{
				fVar1 = get_distance_between_coords(vParam0, func_324(iVar0, 0), 1);
...
{
	return shift_right(iParam0, 26) & 31 * func_334(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
void func_337(auto uParam0, int iParam1)
{
	...
	switch (iLocal_191)
	{
		case 0:
			...
			if (func_371(1, 1093140480, 0))
			{
				...
				if (func_232())
				{
					set_entity_coords(vLocal_156.x, 1674.91f, 3252.47f, 41.69f, 1, false, 0, 1);
				...
				if (func_449(Local_174))
				{
					register_entity_for_cutscene(Local_174, "Jimmy_Boston", 0, false, 0);
				}
				if (func_449(PLAYER::PLAYER_PED_ID()))
				{
					register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), "Michael", 0, false, 0);
				}
				if (func_449(vLocal_156.x))
				{
					register_entity_for_cutscene(vLocal_156.x, "ep_plane", 0, false, 0);
				}
		...
		case 2:
			...
			func_275(vLocal_156.x, 1684.78f, 3255.58f, 41.78f, 284.26f, 0, 1);
			if (_0xBC9823AB80A3DCAC())
			{
				_0x1EE7D8DF4425F053(iLocal_260);
			}
...
void func_347(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_351(player_id())) && !func_349(player_id(), 0)) && !func_348())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_351(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_353(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_355()
{
	if (can_set_exit_state_for_registered_entity("ep_plane", false))
	{
		func_492("Doing plane exit state");
		if (func_232())
		{
			set_entity_coords(vLocal_156.x, 1684.78f, 3255.58f, 41.78f, 1, false, 0, 1);
			set_entity_heading(vLocal_156.x, 284.26f);
			set_vehicle_on_ground_properly(vLocal_156.x);
		}
		else
...
void func_356()
{
	if (func_449(Local_174))
	{
		if (can_set_exit_state_for_registered_entity("Jimmy_Boston", false))
		{
			func_492("Doing Jimmy exit state");
			if (func_449(Local_174) && func_232())
			{
				func_275(Local_174, 1682.13f, 3268.65f, 39.75f, 183.3768f, 0, 1);
				open_sequence_task(&iLocal_261);
				task_follow_nav_mesh_to_coord(false, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
				task_enter_vehicle(false, vLocal_156.x, 20000, -1, 2f, 1, 0);
				close_sequence_task(iLocal_261);
				task_perform_sequence(Local_174, iLocal_261);
				clear_sequence_task(&iLocal_261);
			}
			force_ped_motion_state(Local_174, -530524, false, 1, 0);
		}
	}
}
...
bool func_357()
{
	if (func_449(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -1871534317, false, 1, 0);
			set_gameplay_cam_relative_heading(0f);
			set_gameplay_cam_relative_pitch(0f, 1f);
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_174, -1, 0, 2);
			func_492("Do Michael exit");
			func_275(Local_163, Local_163.f_3, Local_163.f_6, 1, 1);
			if (func_452(Local_163))
			{
				set_vehicle_doors_locked(Local_163, 1);
			}
...
void func_360(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_361(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_363(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_364(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_364(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_366(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_246(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_367(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_367(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_367(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_367(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_367(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_367(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_367(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_367(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_367(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_367(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_367(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_367(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_367(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_367(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_367(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_367(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_367(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_371(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_375(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_374(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_376()
{
	switch (iLocal_191)
	{
		case 0:
			...
			request_vehicle_recording(501, "Eps6_Takeoff");
			while ((((!func_264(55) || !has_anim_dict_loaded(Local_174.f_6)) || !STREAMING::HAS_MODEL_LOADED(Local_163.f_1)) || !STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01"))) || !has_vehicle_recording_been_loaded(501, "Eps6_Takeoff"))
			{
				wait(0);
			}
			if (iLocal_209)
			...
			if (func_232())
			{
				set_vehicle_engine_on(vLocal_156.x, false, 0, 0);
			}
			if (!does_blip_exist(Local_174.f_1))
			{
				Local_174.f_1 = func_278(Local_174, 1, 1, 9);
			...
			if (_0xB56BBBCC2955D9CB())
			{
				...
				if (func_449(PLAYER::PLAYER_PED_ID()))
				{
					func_383("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
				}
				set_cutscene_ped_prop_variation("Jimmy_Boston", true, 0, 0, false);
			}
			if (iLocal_263 == -1)
		...
		case 1:
			...
			if (func_449(Local_174))
			{
				if (func_231(PLAYER::PLAYER_PED_ID(), Local_174, 1) < 100f)
				{
				...
				else if (func_231(PLAYER::PLAYER_PED_ID(), Local_174, 1) > 120f)
				{
					if (has_cutscene_loaded())
					{
			...
			if (func_232())
			{
				...
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (func_377(PLAYER::PLAYER_PED_ID(), Local_174, 13f, 1))
					{
						if (!is_vehicle_stopped(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
						{
							_task_bring_vehicle_to_halt(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 2f, -1, 0);
						}
						else
						{
							task_leave_any_vehicle(PLAYER::PLAYER_PED_ID(), 0, 0);
							while (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
							{
								wait(0);
							}
							iLocal_191 = 2;
				...
				else if (func_377(PLAYER::PLAYER_PED_ID(), Local_174, 5f, 1))
				{
					if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(Local_174))
					{
						vLocal_764 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
						vLocal_767 = {get_entity_coords(Local_174, 1)};
						if ((vLocal_764.z - vLocal_767.z < 1.5f && !is_ped_falling(PLAYER::PLAYER_PED_ID())) && !is_ped_ragdoll(PLAYER::PLAYER_PED_ID()))
						{
							iLocal_191 = 2;
						}
					}
...
void func_378()
{
	if (func_231(PLAYER::PLAYER_PED_ID(), Local_174, 1) <= 15f)
	{
		if (!_0xBC9823AB80A3DCAC())
		{
			if (!_0x7D41E9D2D17C5B2D(iLocal_260))
			{
				func_492("Loading streamvol");
				iLocal_260 = _0x1F3F018BC3AFA77C(1684.85f, 3276.16f, 39.93f, func_379(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_380()
{
	...
	if (func_449(Local_174) && func_449(PLAYER::PLAYER_PED_ID()))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(Local_174, 1), 1);
	}
	if (fVar0 < 50f)
	{
		fLocal_250 = 100f;
	...
	if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(Local_174, 1), 1) > fLocal_250)
	{
		if (!iLocal_214)
		{
		...
		else if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(Local_174, 1), 1) > fLocal_251)
		{
			iLocal_264 = 2;
			iLocal_191 = 0;
			iLocal_190 = 6;
...
void func_382()
{
	if (func_449(Local_174))
	{
		if (func_231(PLAYER::PLAYER_PED_ID(), Local_174, 1) <= 15f)
		{
			if (!is_ped_headtracking_ped(Local_174, PLAYER::PLAYER_PED_ID()))
			{
				func_492("Jimmy headlooking");
				task_look_at_entity(Local_174, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
			}
		}
		else if (func_231(PLAYER::PLAYER_PED_ID(), Local_174, 1) <= 25f && func_22())
		{
			if (!is_ped_headtracking_ped(Local_174, PLAYER::PLAYER_PED_ID()))
			{
		...
		else if (is_ped_headtracking_ped(Local_174, PLAYER::PLAYER_PED_ID()) && !func_22())
		{
	...
	if (!func_22() && !is_message_being_displayed())
	{
		if (func_449(Local_174) && func_449(PLAYER::PLAYER_PED_ID()))
		{
			if (func_377(PLAYER::PLAYER_PED_ID(), Local_174, 25f, 1))
			{
...
void func_384(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<50> Var2;
...
void func_385()
{
	switch (iLocal_191)
	{
		case 0:
			...
			clear_angled_area_of_vehicles(1727.442f, 3288.315f, 39.406f, 1706.909f, 3280.669f, 45.13256f, 14.25f, 0, 0, 0, 0, 0);
			if (func_458())
			{
				if (func_261())
				{
					func_260(vLocal_156.x, -1, 1);
					if (func_452(vLocal_156.x))
					{
						start_playback_recorded_vehicle(vLocal_156.x, 500, "Eps6_LandingSkip", 1);
					}
		...
		case 1:
			...
			if (func_232())
			{
				if (iLocal_229 == 0)
				{
					if (func_397(vLocal_156.x, Local_170, 1) < 1100f)
					{
						func_284(1, "Landing stage", 0, 0, 0, 1);
						iLocal_229 = 1;
				...
				if (iLocal_230 == 0)
				{
					if (func_397(vLocal_156.x, Local_170, 1) < 350f)
					{
						STREAMING::REQUEST_MODEL(Local_163.f_1);
						func_265(55);
						request_anim_dict(Local_174.f_6);
						...
						if (((STREAMING::HAS_MODEL_LOADED(Local_163.f_1) && func_264(55)) && has_anim_dict_loaded(Local_174.f_6)) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
						{
							func_276();
							func_263();
							func_15(&uLocal_595, 3, Local_174, "JIMMYBOSTON", 0, 1);
				...
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
				{
					...
					{
						if (is_entity_in_angled_area(vLocal_156.x, vLocal_253, vLocal_256, 33.25f, 0, true, 2))
						{
				...
				else
				{
					...
					{
						vLocal_156.z = func_393(vLocal_156.x, 1, 5);
					...
					func_16(&(Local_170.f_3));
					if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 80f)
					{
						if (func_397(vLocal_156.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							if (!iLocal_214)
							{
							...
							else if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 150f)
							{
								if (func_390())
								{
									iLocal_233 = true;
						...
						else if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 250f)
						{
							if (func_390())
							{
								iLocal_233 = true;
		...
		case 2:
			if (func_452(vLocal_156.x))
			{
				...
				{
					func_16(&(vLocal_156.f_2));
					if (_get_vehicle_landing_gear(vLocal_156.x) == 0 || _get_vehicle_landing_gear(vLocal_156.x) == 2)
					{
						if (!does_blip_exist(Local_174.f_1))
						{
							Local_174.f_1 = func_278(Local_174, 1, 1, 9);
						...
						if (func_389() && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
						{
							func_492("*** Finishing Landing cleanup");
							func_388("*** Plane 'entity' health: ", get_entity_health(vLocal_156.x));
							func_387("*** Plane engine health: ", get_vehicle_engine_health(vLocal_156.x));
							func_387("*** Plane petrol tank health: ", get_vehicle_petrol_tank_health(vLocal_156.x));
					...
					if ((_get_vehicle_landing_gear(vLocal_156.x) == 1 || _get_vehicle_landing_gear(vLocal_156.x) == 3) || _get_vehicle_landing_gear(vLocal_156.x) == 4)
					{
				...
				else
				{
					...
					set_vehicle_engine_on(vLocal_156.x, true, 0, 0);
					set_vehicle_doors_locked(vLocal_156.x, 1);
					iLocal_191 = 1;
				}
			}
...
void func_394()
{
	if (func_449(Local_174))
	{
		if (func_231(Local_174, vLocal_156.x, 1) < 17f)
		{
			if (!iLocal_224)
			{
				if (!func_22())
				{
					if (func_220(&uLocal_595, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						...
						clear_ped_tasks(Local_174);
						task_look_at_entity(Local_174, PLAYER::PLAYER_PED_ID(), 10000, 48, 2);
		...
		if (func_231(Local_174, vLocal_156.x, 1) < 12f)
		{
			func_235();
			iLocal_264 = 5;
			iLocal_191 = 0;
...
float func_397(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_398()
{
	if (func_232())
	{
		if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
		{
			if ((is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -2611.599f, 2953.922f, 10.79497f, -2698.713f, 2367.25f, -0.336048f, 3f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1506.538f, 2717.231f, 15.28982f, -1377.953f, 2609.015f, 0.028772f, 3f, 0, true, 0)) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -395.9501f, 2960.714f, 23.47385f, -426.3539f, 2966.561f, 14.00403f, 3f, 0, true, 0))
			{
				if (!iLocal_763)
				{
					iLocal_763 = 1;
...
void func_399()
{
	...
	if (iLocal_190 >= 1)
	{
		...
		if (func_22())
		{
			...
			{
				if (func_397(PLAYER::PLAYER_PED_ID(), vVar0, 1) > 35f)
				{
					if (func_22())
					{
		...
		if (func_397(PLAYER::PLAYER_PED_ID(), vVar0, 1) > 450f)
		{
			func_7(&Local_182, 1, 0, 1);
		}
	}
	...
	switch (iLocal_194)
	{
		case 0:
			...
			else if (iLocal_195 == 1)
			{
				...
				{
					case 0:
						if (func_231(PLAYER::PLAYER_PED_ID(), Local_182, 1) < 50f)
						{
							if (!func_22())
							{
				...
				if (func_449(PLAYER::PLAYER_PED_ID()) && func_452(vLocal_156.x))
				{
					if (func_231(PLAYER::PLAYER_PED_ID(), Local_182, 1) < 10f || func_231(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1) < 10f)
					{
						if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
						{
							if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
							{
								func_257(2);
		...
		case 1:
			if (iLocal_195 == 0)
			{
				if (func_450(Local_182))
				{
					clear_ped_tasks(Local_182);
					task_turn_ped_to_face_entity(Local_182, PLAYER::PLAYER_PED_ID(), 0);
			...
			{
				if ((func_449(PLAYER::PLAYER_PED_ID()) && func_452(vLocal_156.x)) && func_450(Local_182))
				{
					if (!is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_231(PLAYER::PLAYER_PED_ID(), Local_182, 1) < 15f || func_231(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1) < 10f)
						{
							if (!is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
							{
								func_257(2);
		...
		case 2:
			if (iLocal_195 == 0)
			{
				if (func_449(Local_182))
				{
					...
					if (is_message_being_displayed())
					{
						...
						task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_182, -1, 0, 2);
						task_look_at_entity(Local_182, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			...
			else if (iLocal_195 == 1)
			{
				...
				if (func_238(Local_182, 1126825984))
				{
					if (func_22())
					{
						func_410();
				...
				else if (GAMEPLAY::GET_GAME_TIMER() - iLocal_248 > 1000 || iLocal_248 == 0)
				{
					...
					if (func_391("EPS6_SPOT"))
					{
						...
						{
							if (func_405(Local_182, PLAYER::PLAYER_PED_ID()) > 10f)
							{
								func_20();
								iLocal_228 = true;
							}
				...
				if (func_452(vLocal_156.x) && func_449(Local_182))
				{
					if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1))
					{
						if (func_22())
						{
							func_20();
		...
		case 3:
			if (iLocal_195 == 0)
			{
				...
				if (iLocal_234 == 0)
				{
					func_403(Local_182, "AIMED_AT_BY_PLAYER", "TOM", 4);
					if (!func_374(Local_182, -1519143300))
					{
						clear_ped_tasks(Local_182);
						task_hands_up(Local_182, -1, PLAYER::PLAYER_PED_ID(), -1, 1);
					}
					iLocal_239 = -1;
					iLocal_195 = 1;
				}
		...
		case 5:
			if (iLocal_195 == 0)
			{
				...
				task_turn_ped_to_face_entity(Local_182, PLAYER::PLAYER_PED_ID(), -1);
				iLocal_195 = 1;
			}
			else if (iLocal_195 == 1)
			{
				if (iLocal_211 == 0)
				{
					if ((!is_message_being_displayed() && !func_22()) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1))
					{
						_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			if (iLocal_195 == 0)
			{
				if (func_450(Local_182))
				{
					if (func_397(Local_182, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						clear_ped_tasks(Local_182);
						task_clear_look_at(Local_182);
						open_sequence_task(&iLocal_261);
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						task_play_anim(false, "gestures@m@standing@casual", "gesture_bye_soft", 8f, -8f, -1, 0, 0, 0, 0, 0);
						task_follow_nav_mesh_to_coord(false, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 0.25f, 0, 1193033728);
			...
			else if (iLocal_195 == 1)
			{
				if (iLocal_190 == 0)
				{
					if (iLocal_211 == 0)
					{
						if ((!func_391("EPS6_SPOT") && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1)) && !is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID()))
						{
							func_402("EPS6_GETIN", 7500, 1);
...
void func_401()
{
	...
	if (func_450(Local_182))
	{
		...
		task_smart_flee_ped(Local_182, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
		func_16(&(Local_182.f_1));
	}
}
...
{
	_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_404(iParam3), 0);
}
...
int func_406(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_407()
{
	if (func_232() && func_449(Local_182))
	{
		if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 1))
		{
			if (has_entity_been_damaged_by_entity(vLocal_156.x, PLAYER::PLAYER_PED_ID(), 1))
			{
...
int func_408(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_230(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_409()
{
	if (iLocal_194 == 2)
	{
		switch (iLocal_196)
		{
			...
			case 1:
				if (func_449(Local_182) && func_449(PLAYER::PLAYER_PED_ID()))
				{
					clear_ped_tasks(Local_182);
					vLocal_764 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
					open_sequence_task(&iLocal_261);
					task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					task_follow_nav_mesh_to_coord(false, vLocal_764, 1f, 20000, 0.25f, 0, 1193033728);
					close_sequence_task(iLocal_261);
					task_perform_sequence(Local_182, iLocal_261);
					clear_sequence_task(&iLocal_261);
					iLocal_196 = 2;
			...
			case 2:
				if (func_449(Local_182) && func_449(PLAYER::PLAYER_PED_ID()))
				{
					if (func_231(Local_182, PLAYER::PLAYER_PED_ID(), 1) < 5f || get_script_task_status(Local_182, 242628503) == 7)
					{
						clear_ped_tasks(Local_182);
						task_turn_ped_to_face_entity(Local_182, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_196 = 0;
	...
	if (func_449(Local_182))
	{
		switch (iLocal_197)
		{
			case 0:
				...
				{
					task_play_anim(Local_182, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_197 = 1;
			...
			case 1:
				if (!func_374(Local_182, 713668775))
				{
					task_follow_nav_mesh_to_coord(Local_182, vLocal_199[iLocal_198 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
			...
			case 2:
				if (func_397(Local_182, vLocal_199[iLocal_198 /*3*/], 1) <= 1.2f)
				{
					iLocal_197 = 3;
			...
			case 4:
				if (is_entity_playing_anim(Local_182, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (get_entity_anim_current_time(Local_182, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						task_play_anim(Local_182, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						_0x2208438012482A1A(Local_182, 0, 0);
						iLocal_197 = 1;
...
bool func_415()
{
	if (func_449(PLAYER::PLAYER_PED_ID()) && func_449(Local_182))
	{
		if (func_251(Local_182, 0, 0, 0, 0))
		{
			func_492("Player shot near cultist");
			return true;
		}
		if (has_entity_been_damaged_by_entity(Local_182, PLAYER::PLAYER_PED_ID(), 1))
		{
...
bool func_417()
{
	if ((func_237(Local_182, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_234(PLAYER::PLAYER_PED_ID(), Local_182, 0)) || func_407())
	{
		if (func_237(Local_182, 0, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			func_492("Player threatened cultist");
		}
		if (func_234(PLAYER::PLAYER_PED_ID(), Local_182, 0))
		{
		...
		if (func_450(Local_182))
		{
			...
			func_403(Local_182, "FIGHT_RUN", "TOM", 4);
		}
		return true;
	}
	return false;
...
void func_418()
{
	if (iLocal_232 == 0)
	{
		if (func_450(Local_182) && func_449(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_231 == 0)
			{
				if (is_entity_touching_entity(PLAYER::PLAYER_PED_ID(), Local_182) && is_ped_ragdoll(Local_182))
				{
					func_20();
		...
		case 1:
			...
			if (func_232())
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), vLocal_156.x, 0))
				{
					...
					if (get_player_wanted_level(player_id()) == 0)
					{
						if (func_397(PLAYER::PLAYER_PED_ID(), Local_170, 0) < 2300f)
						{
							iLocal_191 = 2;
						}
					}
				...
				else
				{
					...
					if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 80f)
					{
						...
						else if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 120f)
						{
							if (func_390())
							{
								iLocal_233 = true;
...
int func_423(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	Global_2621441 = 0;
	return func_221(sParam3, iParam4, iParam8);
}
...
void func_424()
{
	...
	switch (iLocal_191)
	{
		case 0:
			...
			{
				Local_182.f_1 = func_278(Local_182, 1, 1, 5);
			}
			if (func_232())
			{
				func_388("*** Plane 'entity' health: ", get_entity_health(vLocal_156.x));
		...
		case 1:
			...
			else if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 50f)
			{
				if (!iLocal_214)
				{
					if (is_scripted_conversation_ongoing())
				...
				{
					if (GAMEPLAY::GET_GAME_TIMER() - iLocal_217 > 7500 && !is_message_being_displayed())
					{
					...
					if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(vLocal_156.x, 1), 1) > 100f)
					{
						iLocal_264 = 1;
						iLocal_191 = 0;
						iLocal_190 = 6;
			...
			else if (iLocal_214)
			{
				if (iLocal_215)
				{
					StringConCat(&Var0, &Local_218, 24);
					StringConCat(&Var0, "_", 24);
					StringIntConCat(&Var0, iLocal_216, 24);
					if (func_406(&uLocal_265, "EPS6AUD", &Local_218, &Var0, 8, 0, 0))
					{
						iLocal_215 = 0;
						iLocal_214 = 0;
					}
...
void func_425(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_427(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_434(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_433(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_432(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_431(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_430(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_429(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_428(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_434(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_436(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_438(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_271(0)) || func_437(1))
			{
			}
			else
			{
...
void func_443(int iParam0, int iParam1)
{
	...
	func_360(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
void func_446()
{
	...
	func_447(60, 0, 0);
	func_447(55, 0, 0);
	request_additional_text("EPS6", false);
...
bool func_453(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_456(&iVar0) || !has_anim_dict_loaded(sVar5))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				iVar4 = get_random_vehicle_in_sphere(-2892.93f, 3192.37f, 11.66f, 11f, iVar0[0], 16390);
				if (func_449(iVar4))
				{
					*uParam0.f_35[0] = iVar4;
					set_entity_as_mission_entity(iVar4, true, 1);
				}
				else
				{
					clear_area_of_vehicles(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[0]))
			{
				...
				if (Global_69734)
				{
					if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
					{
						set_entity_coords(PLAYER::PLAYER_PED_ID(), -2907.29f, 3215.91f, 9.86f, 1, false, 0, 1);
						set_entity_heading(PLAYER::PLAYER_PED_ID(), 215.2149f);
					}
				}
			}
			else
			...
			if (func_449(*uParam0.f_28[0]) && func_450(PLAYER::PLAYER_PED_ID()))
			{
				iVar7 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
...
void func_454(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	func_4(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_455(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_5(iParam0);
...
void func_462(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_463(uParam0, iParam3);
}

void func_463(auto uParam0, int iParam1)
{
	func_464(uParam0.f_41, iParam1);
}
...
void func_470(auto uParam0, int iParam1, int iParam2)
{
	char* sVar0;
...
void func_473(int iParam0)
{
	...
	if (!func_485())
	{
		...
		{
			func_180(iVar0, 1, 0);
			func_474(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_475(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
void func_489(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
