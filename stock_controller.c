	...
	while (iVar0 < 204)
	{
		if (!Global_51491[iVar0 /*7*/])
		{
			if (Global_51491[iVar0 /*7*/].f_2)
			{
				...
				{
					stat_get_int(Global_51491[iVar0 /*7*/].f_3, &(Global_51491[iVar0 /*7*/].f_5), -1);
				}
				else
				{
					fVar1 = 0f;
...
void func_12(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_27()
{
	...
	while (iVar0 < 8)
	{
		if (!is_bit_set(Global_101154.f_25089.f_461[iVar0], true))
		{
	...
	while (iVar0 < 204)
	{
		if (!Global_51491[iVar0 /*7*/])
		{
			if (Global_51491[iVar0 /*7*/].f_2)
			{
				...
				if (!Global_51491[iVar0 /*7*/].f_4)
				{
					stat_get_int(Global_51491[iVar0 /*7*/].f_3, &iVar1, -1);
				}
				else
				{
					fVar2 = 0f;
...
bool func_60(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_68319.f_484[iVar0] == iParam0)
		{
			...
			{
				if (is_bit_set(Global_68319.f_555[0 /*21*/].f_9, 10) && Global_68319.f_555[0 /*21*/].f_4 == get_entity_model(iParam0))
				{
					*uParam1 = iVar0;
					return true;
				}
				...
				if (iVar4)
				{
					if (does_entity_exist(iVar1))
					{
						...
						else if (is_entity_a_vehicle(iVar1))
						{
							...
							func_71(get_entity_model(iVar1));
						}
			...
			case 139:
				...
				if (iVar4)
				{
					if (does_entity_exist(iVar1))
					{
						...
						{
							func_68(get_entity_model(iVar1));
							func_2(111, 1);
						}
						else if (is_entity_an_object(iVar1))
						{
...
bool func_81(int iParam0, int iParam1)
{
	...
	if (func_82(iParam0, 1, 1))
	{
		if (is_ped_in_any_vehicle(get_player_ped(iParam0), 0))
		{
			...
			{
				if (player_ped_id() == get_ped_in_vehicle_seat(iVar0, iParam1))
				{
					return true;
				}
			}
