...
int func_219(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_218(player_ped_id()) && func_218(iParam0))
	{
		...
		if (!is_ped_armed(player_ped_id(), 6))
		{
			if (is_ped_in_melee_combat(player_ped_id()))
			{
				...
				{
					return func_232(player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_218(player_ped_id()))
			{
				...
				{
					func_273(sLocal_160, player_ped_id(), 0, 2);
				}
			}
			if (func_267(1, 1093140480, 0))
			{
				...
				if (func_218(player_ped_id()))
				{
					register_entity_for_cutscene(player_ped_id(), sLocal_160, 0, false, 0);
				}
				...
				if (does_entity_exist(iLocal_148))
				{
		...
		case 1:
			...
			{
				set_entity_coords(player_ped_id(), -258.8661f, 292.7882f, 90.5764f, 1, false, 0, 1);
			...
			if (!does_entity_exist(iLocal_149[0]))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_156, false)))
				{
			...
			if (!does_entity_exist(iLocal_149[1]))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_157, false)))
				{
			...
			if (!does_entity_exist(iLocal_147))
			{
				if (does_entity_exist(get_entity_index_of_registered_entity(sLocal_159, false)))
				{
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_246(player_id())) && !func_244(player_id(), 0)) && !func_243())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_246(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
bool func_264()
{
	...
	{
		get_model_dimensions(get_entity_model(iVar10), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar7 = {func_265()};
...
bool func_267(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		{
			if (!func_272(get_vehicle_ped_is_in(player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_271(player_ped_id(), -828834893))
				{
...
void func_280()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_217(Local_85.f_28[0]) && does_entity_exist(iLocal_148))
			{
...
void func_281()
{
	if (does_entity_exist(Local_85.f_41[3]) && !iLocal_345)
	{
		...
		if (request_script_audio_bank(sLocal_343, false))
		{
...
void func_284()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			if (func_272(get_vehicle_ped_is_in(player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_289()
{
	...
	if (func_217(player_ped_id()))
	{
		iLocal_146 = get_ped_relationship_group_hash(player_ped_id());
	}
	if (func_217(Local_85.f_28[0]))
	{
		set_ped_relationship_group_hash(Local_85.f_28[0], iLocal_146);
		set_ped_config_flag(Local_85.f_28[0], 132, true);
	...
	func_297(&uLocal_163, 1, player_ped_id(), "FRANKLIN", 0, 1);
...
void func_290()
{
	...
	func_293();
	func_240(1);
	func_292(player_ped_id(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_291(1, 1, 1);
}
...
void func_293()
{
	if (func_218(Local_85.f_28[0]) && does_entity_exist(iLocal_148))
	{
		iLocal_332 = create_synchronized_scene(vLocal_333, vLocal_336, 2);
		task_synchronized_scene(Local_85.f_28[0], iLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
		if (does_entity_exist(iLocal_148))
...
void func_324(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_150(iParam0) && does_entity_exist(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_259(iParam0, 0, 0)) || func_259(iParam0, 1, 0)) || func_259(iParam0, 2, 0)) || func_348(iParam0) != 145) || func_347(iParam0)) || func_346(iParam0)) || func_330(iParam0)) || func_345(iParam0)) || !func_337(get_entity_model(iParam0)))
	{
		if (func_346(iParam0))
		{
		}
...
bool func_352(int iParam0, auto uParam1, auto uParam2)
{
	...
	if (func_355(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_354(*iParam0, *uParam1[38] - 1))
	{
...
void func_358(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_88942[iVar0]) == func_359(iParam0, iParam1))
				{
...
void func_373(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				set_bit(uParam1.f_77, func_335(iVar1 + 1));
			}
		}
