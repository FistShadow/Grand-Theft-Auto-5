#region Local Var
	...
	int iLocal_83 = 0;
	int iLocal_84 = 0;
	struct<61> Local_85 = 0;
	int iLocal_146 = 0;
	int iLocal_147 = 0;
	int iLocal_148 = 0;
	int[] iLocal_149 = new int[2];
	int iLocal_152 = 0;
	int iLocal_153 = 0;
	int iLocal_154 = 0;
	int iLocal_155 = 0;
	...
	int iLocal_331 = 0;
	int iLocal_332 = 0;
	Vector3 vLocal_333 = 0;
	Vector3 vLocal_336 = 0;
	int iLocal_339 = 0;
	Vector3 vLocal_340 = 0;
	char* sLocal_343 = 0;
	char* sLocal_344 = 0;
	int iLocal_345 = 0;
	char* sLocal_346 = 0;
	struct<61> Local_347 = 0;
#endregion
	...
	if (!func_219(Local_85.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_84)
		{
			case 0:
				...
				{
					set_blocking_of_non_temporary_events(Local_85.f_28[0], true);
				}
				iLocal_84 = 1;
				break;
			...
			case 1:
				if (!iLocal_329)
				{
					iLocal_329 = func_207(&uLocal_163, "PAP3AU", "PAP3_RCM_LO", 8, 0, 0, 0);
				}
				else if (!func_206())
				{
					if (is_synchronized_scene_running(iLocal_332))
					{
						if (get_synchronized_scene_phase(iLocal_332) >= 1f)
						{
							iLocal_84 = 2;
						}
					}
...
int func_207(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_216(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
int func_219(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	
	if (func_218(PLAYER::PLAYER_PED_ID()) && func_218(iParam0))
	{
		if (has_entity_been_damaged_by_entity(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		if (func_233(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
		if (!is_ped_armed(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_232(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (iParam4)
...
int func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
...
bool func_223(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
int func_232(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_233(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_218(PLAYER::PLAYER_PED_ID()) && func_218(iParam0))
	{
		...
		if (!iParam2)
		{
			if (func_237(iParam0, iParam1, fVar0, fVar1))
			{
				return true;
			}
			if (func_234(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_234(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_236(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_228(vParam1 - get_entity_coords(iParam0, 1))};
...
bool func_237(int iParam0, int iParam1, float fParam2, float fParam3)
{
	if (iParam1)
	{
		if (is_ped_shooting(PLAYER::PLAYER_PED_ID()))
...
void func_238()
{
	if (is_player_playing(player_id()) && func_218(Local_85.f_28[0]))
	{
		set_ik_target(Local_85.f_28[0], 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
		set_ik_target(PLAYER::PLAYER_PED_ID(), 1, Local_85.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_218(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_273(sLocal_160, PLAYER::PLAYER_PED_ID(), 0, 2);
				}
			}
			if (func_267(1, 1093140480, 0))
			{
				...
				{
					register_entity_for_cutscene(Local_85.f_28[0], sLocal_162, 0, false, 0);
				}
				if (func_218(PLAYER::PLAYER_PED_ID()))
				{
					register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), sLocal_160, 0, false, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[0]))
				{
					register_entity_for_cutscene(iLocal_149[0], sLocal_156, 0, iLocal_152, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_149[0], sLocal_156, 2, iLocal_152, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[1]))
				{
					register_entity_for_cutscene(iLocal_149[1], sLocal_157, 0, iLocal_153, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_149[1], sLocal_157, 2, iLocal_153, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_147))
				{
					register_entity_for_cutscene(iLocal_147, sLocal_159, 0, iLocal_155, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_147, sLocal_159, 2, iLocal_155, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_148))
				{
					register_entity_for_cutscene(iLocal_148, sLocal_158, 0, iLocal_154, 0);
				}
				else
				{
					register_entity_for_cutscene(iLocal_148, sLocal_158, 2, iLocal_154, 0);
				}
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity(sLocal_162, false))
			{
				iLocal_332 = create_synchronized_scene(vLocal_333, vLocal_336, 2);
				task_synchronized_scene(Local_85.f_28[0], iLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1000f, 0);
				_0x2208438012482A1A(Local_85.f_28[0], 0, 0);
			}
			if (can_set_exit_state_for_registered_entity(sLocal_160, false))
			{
				set_entity_coords(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), 153.0417f);
				_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_148))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity(sLocal_158, iLocal_154)))
				{
					iLocal_148 = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_158, iLocal_154));
				}
			}
			else if (is_synchronized_scene_running(iLocal_332) && can_set_exit_state_for_registered_entity(sLocal_158, false))
			{
				set_entity_coords(iLocal_148, vLocal_333, 0, false, 0, 1);
				set_entity_rotation(iLocal_148, vLocal_336, 2, 0);
				play_synchronized_entity_anim(iLocal_148, iLocal_332, "leadout_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1000f);
				force_entity_ai_and_animation_update(iLocal_148);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_149[0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity(sLocal_156, false)))
				{
					iLocal_149[0] = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_156, iLocal_152));
				}
			}
			else if (is_synchronized_scene_running(iLocal_332) && can_set_exit_state_for_registered_entity(sLocal_156, false))
			{
				play_synchronized_entity_anim(iLocal_149[0], iLocal_332, "leadout_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 1, 1000f);
				force_entity_ai_and_animation_update(iLocal_149[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_149[1]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity(sLocal_157, false)))
				{
					iLocal_149[1] = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_157, iLocal_153));
				}
			}
			else if (is_synchronized_scene_running(iLocal_332) && can_set_exit_state_for_registered_entity(sLocal_157, false))
			{
				play_synchronized_entity_anim(iLocal_149[1], iLocal_332, "leadout_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 1, 1000f);
				force_entity_ai_and_animation_update(iLocal_149[1]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_entity_index_of_registered_entity(sLocal_159, false)))
				{
					iLocal_147 = get_object_index_from_entity_index(get_entity_index_of_registered_entity(sLocal_159, iLocal_155));
				}
			}
			else if (is_synchronized_scene_running(iLocal_332) && can_set_exit_state_for_registered_entity(sLocal_159, false))
			{
				set_entity_coords(iLocal_147, -261.1132f, 294.1956f, 90.68612f, 0, false, 0, 1);
				set_entity_rotation(iLocal_147, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				force_entity_ai_and_animation_update(iLocal_147);
			}
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_246(player_id())) && !func_244(player_id(), 0)) && !func_243())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_246(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_248(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_252(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_254(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_256(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_257(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_257(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_261(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_259(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_260(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_260(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_261(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_228(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_262(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_262(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_262(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_262(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_262(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_262(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_262(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_262(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_262(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_262(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_262(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_262(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_262(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_262(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_262(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_262(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_262(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_267(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_272(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_271(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_272(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_274(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<50> Var2;
...
void func_275(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_277(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_278(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_280()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_217(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_148))
			{
				iLocal_330 = create_synchronized_scene(get_entity_coords(iLocal_148, 1), get_entity_rotation(iLocal_148, 2), 2);
				task_synchronized_scene(Local_85.f_28[0], iLocal_330, sLocal_161, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_148))
				{
					play_synchronized_entity_anim(iLocal_148, iLocal_330, "leadin_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1000f);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[0]))
				{
					play_synchronized_entity_anim(iLocal_149[0], iLocal_330, "leadin_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1000f);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[1]))
				{
					play_synchronized_entity_anim(iLocal_149[1], iLocal_330, "leadin_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1000f);
				}
				func_241(1, 1, 1, 1);
				iLocal_84 = 1;
			}
		...
		case 1:
			if (func_217(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_148))
			{
				if (is_synchronized_scene_running(iLocal_330))
				{
					if (get_synchronized_scene_phase(iLocal_330) > 0.99f)
					{
						if (!is_synchronized_scene_running(iLocal_331))
						{
							iLocal_331 = create_synchronized_scene(get_entity_coords(iLocal_148, 1), get_entity_rotation(iLocal_148, 2), 2);
							task_synchronized_scene(Local_85.f_28[0], iLocal_331, sLocal_161, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
							_0x2208438012482A1A(Local_85.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_148))
							{
								play_synchronized_entity_anim(iLocal_148, iLocal_331, "idle_01_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_148);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[0]))
							{
								play_synchronized_entity_anim(iLocal_149[0], iLocal_331, "idle_01_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_149[0]);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[1]))
							{
								play_synchronized_entity_anim(iLocal_149[1], iLocal_331, "idle_01_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1000f);
								force_entity_ai_and_animation_update(iLocal_149[1]);
							}
						}
					}
					if (get_synchronized_scene_phase(iLocal_330) > 0.3f)
					{
						if (!iLocal_328)
						{
							iLocal_328 = func_207(&uLocal_163, "PAP3AU", "PAP3_RCM_LI", 8, 0, 0, 0);
						}
					}
					if (get_synchronized_scene_phase(iLocal_330) > 0.3f)
					{
					...
					if (get_synchronized_scene_phase(iLocal_330) > 0.05f)
					{
						func_279();
					}
				}
...
void func_281()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_85.f_41[3]) && !iLocal_345)
	{
		...
		if (!has_sound_finished(iLocal_339))
		{
			stop_sound(iLocal_339);
		}
		if (SCRIPT::REQUEST_SCRIPT_audio_bank(sLocal_343, false))
		{
			play_sound_from_coord(iLocal_339, "CAMERA", get_ped_bone_coords(Local_85.f_28[0], 28422, vLocal_340), sLocal_344, 0, 0, 0);
			iLocal_345 = 1;
		}
	}
}
...
void func_284()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_272(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_289()
{
	...
	if (func_217(PLAYER::PLAYER_PED_ID()))
	{
		iLocal_146 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
	}
	if (func_217(Local_85.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_85.f_28[0], iLocal_146);
		PED::SET_PED_CONFIG_FLAG(Local_85.f_28[0], 132, true);
		set_ped_keep_task(Local_85.f_28[0], true);
		set_blocking_of_non_temporary_events(Local_85.f_28[0], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147))
	{
		iLocal_147 = get_closest_object_of_type(-261.19f, 292.22f, 90.79f, 10f, iLocal_155, 1, 0, 1);
		_0xA80AE305E0A3044F(iLocal_147, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_148))
	{
	...
	func_297(&uLocal_163, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_290()
{
	...
	func_293();
	func_240(1);
	func_292(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_291(1, 1, 1);
}
...
int func_292(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_293()
{
	if (func_218(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_148))
	{
		...
		set_synchronized_scene_phase(iLocal_332, 0.02f);
	}
	iLocal_329 = false;
}
...
void func_294(int iParam0, int iParam1)
{
	...
	func_252(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
void func_297(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
struct<2> func_307(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_314(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_313(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_312(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_311(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_310(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_309(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_308(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_314(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_316(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_318(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_288(0)) || func_317(1))
			{
			}
			else
			{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_259(iParam0, 0, 0)) || func_259(iParam0, 1, 0)) || func_259(iParam0, 2, 0)) || func_348(iParam0) != 145) || func_347(iParam0)) || func_346(iParam0)) || func_330(iParam0)) || func_345(iParam0)) || !func_337(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_346(iParam0))
		{
		}
...
bool func_386(auto uParam0)
{
	int[] iVar0 = new int[5];
	int[] iVar6 = new int[3];
	Vector3[] vVar10 = new Vector3[3];
	Vector3[] vVar20 = new Vector3[3];
	char* sVar30;
	int iVar31;
	int iVar32;
	...
	switch (iLocal_79)
	{
		...
		case 1:
			if (!func_391(&iVar0) || !has_anim_dict_loaded(sVar30))
			{
				return false;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			if (func_217(*uParam0.f_28[0]))
			{
				...
				{
					func_387(uParam0.f_41[3], iVar0[1], get_offset_from_entity_in_world_coords(*uParam0.f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (iVar32)
			{
				iVar6[0] = get_closest_object_of_type(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				vVar10[0 /*3*/] = {-260.614f, 292.106f, 91.127f};
				vVar20[0 /*3*/] = {7.2E-05f, -2.500116f, 89.63998f};
				iVar6[1] = get_closest_object_of_type(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				vVar10[1 /*3*/] = {-261.108f, 292.5062f, 92.03645f};
				vVar20[1 /*3*/] = {-0.656039f, -2.50018f, 89.6114f};
				iVar6[2] = get_closest_object_of_type(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				vVar10[2 /*3*/] = {-261.1135f, 291.6249f, 91.99765f};
				vVar20[2 /*3*/] = {-0.281056f, -2.500049f, 89.62769f};
				iVar31 = 0;
				while (iVar31 <= 2)
				{
					set_object_as_no_longer_needed(&(iVar6[iVar31]));
					iVar31++;
				}
		...
		case 3:
			...
			{
				iLocal_82 = create_synchronized_scene(get_entity_coords(*uParam0.f_41[0], 1), get_entity_rotation(*uParam0.f_41[0], 2), 2);
				play_synchronized_entity_anim(*uParam0.f_41[0], iLocal_82, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1000f);
				set_synchronized_scene_looped(iLocal_82, true);
				if (func_218(*uParam0.f_28[0]))
				{
					task_synchronized_scene(*uParam0.f_28[0], iLocal_82, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_218(*uParam0.f_41[1]))
				{
					play_synchronized_entity_anim(*uParam0.f_41[1], iLocal_82, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1000f);
				}
				if (func_218(*uParam0.f_41[2]))
				{
					play_synchronized_entity_anim(*uParam0.f_41[2], iLocal_82, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1000f);
				}
			}
			iVar31 = 0;
			while (iVar31 <= iVar0 - 1)
...
void func_387(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_251(iParam0);
...
bool func_388(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_389(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_389(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_393()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[0]))
	{
		freeze_entity_position(iLocal_149[0], true);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_149[1]))
	{
		freeze_entity_position(iLocal_149[1], true);
	}
...
void func_394(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_403(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_408(int iParam0)
{
	...
	if (!func_425())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_409(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_410(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_416())
	{
		...
		{
			iVar33 = func_411(get_this_script_name());
			if (iVar33 > -1)
			{
