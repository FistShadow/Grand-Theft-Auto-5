...
void func_280()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			{
				iLocal_330 = create_synchronized_scene(ENTITY::GET_ENTITY_COORDS(iLocal_148, 1), get_entity_rotation(iLocal_148, 2), 2);
			...
			if (func_217(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_148))
			{
				if (is_synchronized_scene_running(iLocal_330))
				{
					if (get_synchronized_scene_phase(iLocal_330) > 0.99f)
					{
						...
						{
							iLocal_331 = create_synchronized_scene(ENTITY::GET_ENTITY_COORDS(iLocal_148, 1), get_entity_rotation(iLocal_148, 2), 2);
...
void func_281()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_85.f_41[3]) && !iLocal_345)
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(iLocal_339, "CAMERA", get_ped_bone_coords(Local_85.f_28[0], 28422, vLocal_340), sLocal_344, 0, 0, 0);
			iLocal_345 = 1;
		}
	}
}
...
bool func_386(auto uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 3:
			...
			{
				iLocal_82 = create_synchronized_scene(ENTITY::GET_ENTITY_COORDS(*uParam0.f_41[0], 1), get_entity_rotation(*uParam0.f_41[0], 2), 2);
