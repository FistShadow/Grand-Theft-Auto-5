...
bool func_2()
{
	...
	if (!func_3(&uVar0))
	{
		...
		if (fVar4 < 4.5f * 4.5f)
		{
			task_vehicle_drive_wander(iLocal_68, iLocal_70, fLocal_175, 786599);
			return true;
		}
	}
	return false;
...
bool func_3(auto uParam0)
{
	...
	if (is_vehicle_driveable(iLocal_70, 0))
	{
	}
	else
	{
...
bool func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (is_synchronized_scene_running(Global_88941))
		{
			...
			if (!func_5(Global_91064, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					set_ped_into_vehicle(Global_91064, iLocal_70, 2);
				}
			}
			if (!iLocal_176)
			{
		...
		else
		{
			...
			stop_synchronized_entity_anim(iLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				open_sequence_task(&iVar2);
				task_vehicle_temp_action(false, iLocal_70, 24, 50);
				task_pause(false, 2000);
				task_vehicle_drive_to_coord(false, iLocal_70, vLocal_172 + vLocal_177, fLocal_175, 0, iLocal_71, 786599, 4.5f / 2f - 1f, 10f);
...
int func_10(auto uParam0, auto uParam1)
{
...
void func_21()
{
	...
	iVar0 = 0;
	while ((!does_entity_exist(Global_91064) || !does_entity_exist(iLocal_70)) || (!has_model_loaded(iLocal_69) && iVar0 < 400))
	{
...
void func_22()
{
	...
	func_39(iLocal_66, &vLocal_177, &uLocal_180, &sVar0);
	iLocal_69 = joaat("a_m_m_eastsa_02");
	func_28(1, iLocal_66, &iLocal_71, &vLocal_169, &uVar8, &vLocal_172, &fLocal_175);
	Var9.f_1 = -1;
	Var9.f_17 = 4;
	Var9.f_17.f_8 = 4;
	Var9.f_17.f_13 = 4;
	...
	func_25(Var9, &Var118);
	func_23(iLocal_66, &sLocal_181, &sLocal_197, &sLocal_197, &uVar238, &uVar239);
}

bool func_23(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5)
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
bool func_25(struct<109> Param0, auto uParam1)
{
	*uParam109.f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_26(auto uParam0, int iParam1, int iParam2, int iParam3, Vector3 vParam4, Vector3 fParam5)
{
...
int func_28(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	*uParam2.f_3 = 1000;
	*uParam2.f_1 = 0;
	*uParam2.f_84 = 255;
...
void func_29(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
bool func_30(int iParam0, auto uParam1, int iParam2)
{
...
bool func_39(int iParam0, auto uParam1, auto uParam2, char* sParam3)
{
	int iVar0;
...
int func_42(int iParam0, auto uParam1, char* sParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
	...
	switch (iParam0)
	{
		...
		case 11:
			if (func_45(iParam0, &vVar0, uParam1))
			{
...
int func_43(int iParam0, int iParam1, auto uParam2, auto uParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_45(int iParam0, auto uParam1, auto uParam2)
{
	switch (iParam0)
	{
		case 11:
