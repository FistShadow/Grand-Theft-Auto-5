		...
		if (((STREAMING::HAS_MODEL_LOADED(joaat("p_cs_mp_jet_01_s")) && STREAMING::HAS_MODEL_LOADED(joaat("mp_m_freemode_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("mp_f_freemode_01"))) && (!*iParam0.f_294 || has_ptfx_asset_loaded()))
		{
			*iParam0.f_33 = create_object(joaat("p_cs_mp_jet_01_s"), vVar1, 0, false, false);
			...
			while (iVar0 < 7)
			{
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(get_player_ped(int_to_playerindex(*iParam0.f_112[iVar0])), 0))
					{
					}
		...
		switch (Local_562.f_2)
		{
			...
			case 1:
				if (func_359(Local_562.f_3))
				{
					if (!func_357(Local_562.f_4))
					{
						...
						{
							if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_562.f_4), -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_562.f_4), -1273030092) != 0)
							{
			...
			case 4:
				if (!func_357(Local_562.f_4))
				{
					...
					{
						if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_562.f_4), -272084098) == 7)
						{
			...
			case 6:
				if (!func_357(Local_562.f_4))
				{
					if (func_359(Local_562.f_3))
					{
						if (AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_562.f_4), -258271821) != 1 && AI::GET_SCRIPT_TASK_STATUS(net_to_ped(Local_562.f_4), -258271821) != 0)
						{
		...
		if (!Global_1587523[player_id() /*444*/].f_12 && !func_593())
		{
			if (network_is_activity_session())
			{
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
						Global_2435528.f_2842.f_197 = {ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)};
					}
					func_426();
					func_621();
					func_425(6);
...
void func_529(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5)
{
	...
	if (!GAMEPLAY::ARE_STRINGS_EQUAL(&uParam0, &(Global_2398781.f_1)))
	{
		return;
	}
	Global_2398847 = 1;
...
void func_538()
{
	...
	{
		if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_2398079.f_3), &(Global_2391053.f_4.f_3)))
		{
			Global_1311838 = 0;
		}
		else
