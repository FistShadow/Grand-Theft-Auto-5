...
bool func_1()
{
	...
	if (Global_2406737.f_16)
	{
		if (((!network_is_in_mp_cutscene() && !is_cutscene_playing()) && !func_13()) && !func_8(player_id()))
		{
			...
			if (!iLocal_90)
			{
				...
				else
				{
					...
					if (!is_entity_dead(iVar0, 0))
					{
						...
						task_vehicle_drive_wander(player_ped_id(), iVar0, 20f, 786603);
						iLocal_92 = 1;
					}
				}
				iLocal_90 = 1;
		...
		if (func_6(player_id(), 0, 1))
		{
			...
			{
				Global_2406737.f_27 = NETWORK::GET_NETWORK_TIME();
...
bool func_3()
{
	if (Global_2406737.f_26)
	{
		if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2406737.f_27)) > 6000)
		{
			return true;
		}
	}
...
bool func_14()
{
	...
	{
		if (_get_number_of_instances_of_streamed_script(joaat("spawn_activities")) == 0)
		{
	...
	else if (_get_number_of_instances_of_streamed_script(joaat("spawn_activities")) == 0)
	{
		func_19();
		return true;
	}
	if (absi(get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2406737.f_3)) > 120000)
	{
		func_19();
		return true;
	}
	set_bit(&(Global_1724577[1]), 22);
	return false;
}
...
void func_27(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_28(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
int func_31(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_30(iParam1)];
		...
		switch (Global_2406737)
		{
			...
			case 5:
				if (func_6(player_id(), 0, 0))
				{
					...
					if (Global_2406737.f_1 == 1)
					{
						if (!func_72(Global_2406737) || get_time_difference(NETWORK::GET_NETWORK_TIME(), iLocal_93) > 20000)
						{
							Global_2406737.f_16 = 1;
							func_71();
						}
...
void func_35()
{
	...
	iVar0 = 13823;
	if ((((((is_bit_set(Global_1587316.f_22, 5) || is_bit_set(Global_1587316.f_22, 6)) || is_bit_set(Global_1587316.f_22, 8)) || is_bit_set(Global_1587316.f_22, 7)) || is_bit_set(Global_1587316.f_22, 9)) || is_bit_set(Global_1587316.f_22, 20)) || func_70())
	{
	...
	else if (Global_1587316.f_19 != 0 && func_68(player_id(), 1, 0))
	{
		if (!is_bit_set(Global_1048576.f_8, false))
		{
			if (_get_number_of_instances_of_streamed_script(joaat("am_mp_property_int")) <= 0 && !network_is_script_active("AM_MP_PROPERTY_INT", Global_1048576.f_583, 1, 0))
	...
	else if (((!is_bit_set(Global_1048576.f_8, false) && !is_bit_set(Global_2460486.f_357.f_5, 3)) && (!Global_2404955 || (Global_2404955 && Global_2435528.f_1.f_2824.f_13 > 0))) && !func_67())
	{
		if (_get_number_of_instances_of_streamed_script(joaat("am_mp_property_int")) <= 0 && !network_is_script_active("AM_MP_PROPERTY_INT", Global_1048576.f_583, 1, 0))
		{
			if (!func_66())
			...
			else
			{
				...
				if (Global_1048576.f_582 > 90 || is_bit_set(Global_1048576.f_8, 10))
				{
					...
					{
						if ((!func_46() && !func_45()) && !network_is_in_transition())
						{
...
struct<8> func_47(auto uParam0, int iParam1)
{
	switch (iParam1)
	{
		case 2:
...
bool func_49(auto uParam0, int iParam1, float fParam2)
{
	Vector3 vVar0;
...
Vector3 func_50(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 84:
		case 85:
			func_51(iParam0, 3, &vVar0, 83);
			vVar6 = {vVar0};
			break;
		
		case 86:
			func_51(iParam0, 3, &vVar0, 86);
			vVar6 = {vVar0};
			break;
...
void func_51(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	...
	*uParam2 = {func_53(iParam1, iParam3)};
	...
	vVar13 = {func_52(vVar13, -Var0[0 /*6*/].f_3.f_2)};
	vVar13 = {func_52(vVar13, Var0[1 /*6*/].f_3.f_2)};
...
Vector3 func_52(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
bool func_77()
{
	...
	iVar0 = func_101();
	if ((((((iVar0 > -1 && !Global_1321273[iVar0 /*138*/].f_66 == 0) && !is_bit_set(Global_1321273[iVar0 /*138*/].f_99, true)) && !is_bit_set(Global_1321273[iVar0 /*138*/].f_99, 6)) && !func_100(0)) && !func_100(31)) && func_78())
	{
		return true;
	}
	return false;
...
bool func_78()
{
	...
	iVar0 = func_99();
	if ((((((((((((((((((((((((((func_98() || func_97()) || func_96()) || (func_95() && !func_93())) || (func_42() && !func_92())) || func_91(player_id())) || func_90(player_id())) || func_89(player_id())) || func_88()) || func_84()) || func_83()) || func_82()) || func_81()) || (func_80() && !func_92())) || (func_9() && !func_6(player_id(), 1, 0))) || func_10(player_id(), 0)) || Global_1587523[player_id() /*444*/] == 10) || Global_1587523[player_id() /*444*/] == 11) || Global_1587523[player_id() /*444*/] == 12) || Global_1587523[player_id() /*444*/] == 13) || Global_1587523[player_id() /*444*/] == 14) || Global_1587523[player_id() /*444*/] == 15) || Global_1587523[player_id() /*444*/] == 1) || Global_1587523[player_id() /*444*/] == 3) || Global_1587523[player_id() /*444*/] == 8) || Global_1587523[player_id() /*444*/] == 122) || func_79())
	{
		return false;
	}
	else if (iVar0 != -1)
...
bool func_103()
{
	...
	if (func_104() != 0)
	{
		if (_get_number_of_instances_of_streamed_script(func_104()) == 0)
		{
			return true;
		}
	}
...
bool func_112(int iParam0, auto uParam1)
{
...
void func_113()
{
	...
	if (does_cam_exist(iLocal_88))
	{
		destroy_cam(iLocal_88, 0);
	}
	if (iLocal_92)
	{
		if (func_6(player_id(), 0, 1))
