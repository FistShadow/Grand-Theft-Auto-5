#region Local Var
	...
	int iLocal_405 = 0;
	int iLocal_406 = 0;
	struct<6> Local_407 = 0;
	struct<6> Local_413 = 0;
	Vector3 vLocal_419 = 0;
	Vector3 vLocal_422 = 0;
	Vector3 fLocal_425 = 0;
	Vector3 fLocal_426 = 0;
...
void main()
{
	...
	if (!is_player_dead(player_id()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				display_radar(false);
				func_231();
				while (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1))
				{
					wait(0);
				}
				task_follow_nav_mesh_to_coord(PLAYER::PLAYER_PED_ID(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 0.25f, 0, 40000f);
				iVar12 = create_camera_with_params(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				iVar13 = create_camera_with_params(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				set_cam_active_with_interp(iVar13, iVar12, 5000, 1, 1);
			...
			case 1:
				...
				if (iVar4)
				{
					if (!iVar5)
					{
						if (_0xB56BBBCC2955D9CB())
						{
							...
							{
								func_123(&Local_407, PLAYER::PLAYER_PED_ID(), 0, 2);
							}
							if (!is_entity_dead(iLocal_399, 0))
							{
								func_123(&Local_413, iLocal_399, 0, 2);
							}
							iVar5 = true;
						}
					}
				...
				{
					if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_dead(iLocal_399, 0))
					{
						register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), &Local_407, 0, false, 0);
						register_entity_for_cutscene(iLocal_399, &Local_413, 0, false, 0);
					}
					start_cutscene(0);
			...
			case 2:
				if (does_cam_exist(iVar12))
				{
					destroy_cam(iVar12, 0);
				}
				if (does_cam_exist(iVar13))
				{
					destroy_cam(iVar13, 0);
				}
				if (can_set_exit_state_for_registered_entity(&Local_407, false))
				{
					func_118(iLocal_399, 1, 0);
				}
				if (can_set_exit_state_for_registered_entity(&Local_413, false))
				{
					func_118(iLocal_399, 0, 1);
				}
				if (can_set_exit_state_for_camera(0))
				{
					func_117(iLocal_399, &iLocal_401, &iLocal_402, &iLocal_404, &uLocal_83, vLocal_422, fLocal_427, iLocal_57);
					func_115(func_239());
					func_230(&iLocal_251);
					func_114(&iLocal_275, 0, 0, 0, 1);
					func_113(&iLocal_275, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_113(&iLocal_275, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					iVar5 = false;
					set_player_control(player_id(), false, 0);
					iLocal_60 = 3;
			...
			case 3:
				...
				if (is_screen_faded_out() || iVar24)
				{
					...
					func_107(&iLocal_251);
					while (func_121(&iLocal_251) < 0.4f)
					{
						wait(0);
						func_108();
					}
				...
				if (!iVar2)
				{
					if (!iLocal_435 && !is_cutscene_active())
					{
						Local_61.f_20 = 0;
						func_95(&(Local_61.f_12), &Local_61, func_239());
						iLocal_435 = true;
					}
					if (func_85(&iLocal_251, &iLocal_275, &iVar1))
					{
						if (iVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_121(&iLocal_251) >= 14f)
					{
						Local_61.f_20 = 2;
						iVar2 = true;
						clear_help(1);
					}
					else if (!iVar3 && func_121(&iLocal_251) >= 7f)
					{
						StringCopy(&Var18, "DRF_PROMPT", 16);
						func_84(&uLocal_83, &Var14, &Var18, 9, 0, 0, 0);
						iVar3 = true;
					}
				}
				else if ((func_121(&iLocal_251) > 5f && func_120()) || (has_cutscene_loaded() && ((Local_61.f_20 != 1 || func_121(&iLocal_251) > fVar22) || func_81(iLocal_82, iLocal_399, &iLocal_404))))
				{
					func_78();
					if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
					{
			...
			case 14:
				if (does_cam_exist(iLocal_404))
				{
					render_script_cams(false, false, 3000, 1, 0, 0);
					destroy_cam(iLocal_404, 0);
				}
				if (((func_77() && is_cutscene_playing()) && !is_screen_fading_out()) && !is_screen_faded_out())
				{
					stop_cutscene(0);
				}
				if (can_set_exit_state_for_camera(0))
				{
					...
					else
					{
						...
						if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							set_entity_heading(PLAYER::PLAYER_PED_ID(), fLocal_426);
							set_gameplay_cam_relative_heading(0f);
							set_gameplay_cam_relative_pitch(0f, 1f);
							func_65(0, 1, 1, 0);
							iLocal_402 = get_players_last_vehicle();
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_402))
							{
								if (!is_entity_dead(iLocal_402, 0))
								{
									set_entity_coords(iLocal_402, func_64(iLocal_402), 1, false, 0, 1);
									set_entity_heading(iLocal_402, 231f);
								}
							}
							if (is_screen_faded_out())
							{
								if (!iLocal_436)
								{
									new_load_scene_start(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_436 = 1;
									wait(0);
								}
								if (!iLocal_437)
				...
				else
				{
					if (!iLocal_436)
					{
						if (get_cutscene_time() > 60000)
						{
							if (iLocal_82 == 4)
							{
								new_load_scene_start(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								new_load_scene_start(-1903.87f, -562.9188f, 12.8354f, func_63(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_437)
					{
						if (_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_121(&iVar9) > func_61(func_239()))
							{
								if (func_239() == 4)
								{
									...
									set_entity_load_collision_flag(iLocal_400, true);
			...
			case 15:
				...
				if (is_entity_dead(iLocal_400, 0))
				{
					func_257(80, 1);
					stat_set_bool(joaat("sp_killed_dr_friedlander"), 1, 1);
					func_84(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (does_blip_exist(iLocal_403))
					{
						set_blip_colour(iLocal_403, 1);
					}
					iLocal_60 = 17;
				}
				else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_400) || func_59(iLocal_400, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					...
					if (does_blip_exist(iLocal_403))
					{
						set_blip_colour(iLocal_403, 3);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_400))
					{
						clear_area_of_projectiles(get_entity_coords(iLocal_400, 1), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					...
					if (!iLocal_439)
					{
						...
						if (func_121(&iLocal_263) > 2f)
						{
							...
							iLocal_404 = create_camera_with_params(26379945, vVar26, vVar29, 50f, 0, 2);
							set_cam_active_with_interp(iLocal_404, iLocal_405, 2660, 1, 1);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_402) && !is_entity_dead(iLocal_402, 0))
							{
								set_vehicle_fixed(iLocal_402);
								set_entity_invincible(iLocal_402, false);
								set_vehicle_can_break(iLocal_402, true);
							}
							func_107(&iLocal_263);
							iLocal_439 = 1;
						}
					...
					else if (does_cam_exist(iLocal_405))
					{
						if (func_121(&iLocal_263) >= 2.66f)
						{
							set_gameplay_cam_relative_heading(func_46(get_follow_ped_cam_view_mode() == 2, -16f, 0f));
							render_script_cams(false, true, 340, 0, 0, 0);
							destroy_cam(iLocal_405, 0);
						}
						else
						{
							set_gameplay_cam_relative_heading(0f);
					...
					if (iLocal_438 && is_player_control_on(player_id()))
					{
						if (func_44(&iLocal_257, 0.5f))
						{
							...
							if (!does_blip_exist(iLocal_403))
							{
								if (!is_entity_dead(iLocal_400, 0))
								{
									iLocal_403 = add_blip_for_entity(iLocal_400);
									set_blip_colour(iLocal_403, 1);
									func_107(&iLocal_257);
								}
							}
							else if (get_blip_colour(iLocal_403) != 3)
							{
								set_blip_colour(iLocal_403, 3);
					...
					if (!PED::IS_PED_INJURED(iLocal_400))
					{
						...
						{
							if (is_ped_in_any_vehicle(iLocal_400, 0))
							{
								iVar0 = 1;
							}
							if (!is_ped_fleeing(iLocal_400))
							{
								if ((((((((!is_vehicle_driveable(iLocal_401, 0) || is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_401, 1)) || is_vehicle_stuck_timer_up(iLocal_401, 0, 2000)) || is_vehicle_stuck_timer_up(iLocal_401, 1, 2000)) || is_vehicle_stuck_timer_up(iLocal_401, 2, 2000)) || is_vehicle_stuck_timer_up(iLocal_401, 3, 2000)) || (iVar0 && !is_ped_in_any_vehicle(iLocal_400, 0))) || func_40(iLocal_401)) || func_36(iLocal_401))
								{
									task_smart_flee_ped(iLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
								}
							}
						}
						else if (!is_ped_fleeing(iLocal_400))
						{
							task_smart_flee_ped(iLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
						}
						if (!iVar25 && !is_entity_in_angled_area(iLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, true, 0))
						{
							set_blocking_of_non_temporary_events(iLocal_400, false);
							iVar25 = true;
						}
					}
				}
			...
			case 17:
				...
				if (func_121(&iLocal_254) > 4f || is_screen_faded_out())
				{
					remove_blip(&iLocal_403);
					if (does_cam_exist(iLocal_404))
					{
						destroy_cam(iLocal_404, 0);
					}
					...
					if (!func_1(80))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_400))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_401) && is_ped_in_vehicle(iLocal_400, iLocal_401, 0))
							{
								delete_vehicle(&iLocal_401);
							}
						}
						delete_ped(&iLocal_400);
					}
...
int func_2(auto uParam0, int iParam1, int iParam2)
{
	...
	return func_3(Global_101154.f_32575[uParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_8() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_8() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_7(iParam0));
...
int func_10(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_8() /*10375*/].f_7704.f_10, iParam0);
}
...
int func_16(auto uParam0, int iParam1)
{
...
void func_19(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
bool func_36(int iParam0)
{
	...
	if ((func_39(PLAYER::PLAYER_PED_ID()) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0)) && func_37(iParam0))
	{
...
float func_46(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
void func_47()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_400) || is_entity_dead(iLocal_400, 0)) || is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
	{
		return;
	}
	if (!func_62(&iLocal_269))
	{
		func_230(&iLocal_269);
	}
	if (!func_62(&iLocal_272))
	{
		func_230(&iLocal_272);
	}
	fVar6 = vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			if (func_121(&iLocal_269) > 0.2f)
			{
				iVar4 = get_random_int_in_range(false, 7);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_428, iVar4);
		...
		else if (func_121(&iLocal_269) > 12f)
		{
			if (fVar6 <= 144f && !is_scripted_speech_playing(PLAYER::PLAYER_PED_ID()))
			{
				iVar4 = get_random_int_in_range(false, 7 - iLocal_429);
				while (iVar5 >= 0 && iVar5 < 7)
				{
					if (!is_bit_set(iLocal_428, iVar5))
					{
						if (iVar4 == 0)
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_428, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			if (func_121(&iLocal_272) > 1f && !is_scripted_speech_playing(iLocal_400))
			{
				iVar4 = get_random_int_in_range(false, 8);
				GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_430, iVar4);
		...
		else if (func_121(&iLocal_272) > 10.3f)
		{
			if (fVar6 <= 2500f && !is_scripted_speech_playing(iLocal_400))
			{
				iVar4 = get_random_int_in_range(false, 8 - iLocal_431);
				iVar5 = false;
				while (iVar5 >= 0)
				{
					if (!is_bit_set(iLocal_430, iVar5))
					{
						if (iVar4 == 0)
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_430, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
...
int func_48(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_49(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
Vector3 func_64(int iParam0)
{
	...
	get_entity_matrix(iParam0, &uVar0, &uVar3, &uVar6, &uVar9);
	get_model_dimensions(ENTITY::GET_ENTITY_MODEL(iParam0), &uVar12, &Var15);
...
void func_76()
{
	...
	if (!is_vehicle_driveable(iLocal_401, 0))
	{
		delete_vehicle(&iLocal_401);
		iLocal_401 = create_vehicle(iLocal_57, vLocal_422, fLocal_427, 1, 1);
		set_vehicle_colour_combination(iLocal_401, 6);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_399))
	{
		delete_ped(&iLocal_399);
	}
	if ((!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !is_entity_dead(iLocal_401, 0)) && is_vehicle_driveable(iLocal_401, 0))
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -1907.827f, -560.0641f, 10.8064f, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 260.195f);
		set_entity_coords(iLocal_401, vLocal_422, 1, false, 0, 1);
		set_entity_heading(iLocal_401, fLocal_427);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_402))
		{
			if (!is_entity_dead(iLocal_402, 0))
			{
				set_vehicle_fixed(iLocal_402);
				set_entity_invincible(iLocal_402, true);
				set_vehicle_can_break(iLocal_402, false);
				set_entity_coords(iLocal_402, func_64(iLocal_402), 1, false, 0, 1);
				set_entity_heading(iLocal_402, 231f);
			}
		}
		...
		if ((!iLocal_437 || !ENTITY::DOES_ENTITY_EXIST(iLocal_400)) || is_entity_dead(iLocal_400, 0))
		{
			iLocal_400 = PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, true);
			set_ped_component_variation(iLocal_400, 3, iLocal_432, iLocal_433, 0);
			set_ped_component_variation(iLocal_400, 4, 0, iLocal_434, 0);
			set_ped_money(iLocal_400, 2000 + get_random_int_in_range(5, 301));
			set_entity_load_collision_flag(iLocal_400, true);
			set_blocking_of_non_temporary_events(iLocal_400, true);
			func_60(&uLocal_83, 1, iLocal_400, "FRIEDLANDER", 0, 1);
			iLocal_437 = 1;
		}
		else
		{
			set_entity_coords(iLocal_400, -1899.7f, -562.2f, 10.7945f, 1, false, 0, 1);
			set_entity_heading(iLocal_400, 217.9453f);
			clear_ped_tasks_immediately(iLocal_400);
			task_stand_still(iLocal_400, -1);
		}
		if (is_screen_faded_out())
		{
			if (!iLocal_436)
			{
				new_load_scene_start(-1905.5f, -557.8768f, 12.4125f, func_63(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_436 = 1;
				wait(0);
			}
			while (!is_new_load_scene_loaded() || (!PED::IS_PED_INJURED(iLocal_400) && !_0x7350823473013C02(iLocal_400)))
			{
				wait(0);
			}
			if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
		...
		fVar0 = 2f;
		if (!PED::IS_PED_INJURED(iLocal_400) && !is_entity_dead(iLocal_401, 0))
		{
			open_sequence_task(&iLocal_406);
			task_enter_vehicle(false, iLocal_401, -1, -1, fVar0, 1, 0);
			task_vehicle_drive_to_coord(false, iLocal_401, -1783.73f, -629.1945f, 9.89f, 20f, 0, ENTITY::GET_ENTITY_MODEL(iLocal_401), 786484, 10f, 12f);
			task_vehicle_drive_wander(false, iLocal_401, 19f, 786484);
			close_sequence_task(iLocal_406);
			task_perform_sequence(iLocal_400, iLocal_406);
			force_ped_motion_state(iLocal_400, -530524, true, 1, 1);
		}
		iLocal_403 = add_blip_for_entity(iLocal_400);
		set_blip_colour(iLocal_403, 1);
		func_107(&iLocal_257);
		set_gameplay_cam_relative_heading(0f);
		set_gameplay_cam_relative_pitch(0f, 1f);
		iLocal_405 = create_camera_with_params(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		render_script_cams(true, false, 3000, 1, 0, 0);
		display_radar(false);
		display_hud(false);
	}
	clear_area(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, false);
	create_vehicle(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1);
}
...
bool func_81(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_82())
	{
		...
		{
			if (!is_entity_playing_anim(PLAYER::PLAYER_PED_ID(), &cVar1, &Var13, 3))
			{
				task_play_anim(PLAYER::PLAYER_PED_ID(), &cVar1, &Var13, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				task_play_anim(iParam1, &cVar1, &cVar21, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				task_play_anim(PLAYER::PLAYER_PED_ID(), &cVar9, &cVar25, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
			...
			else if (get_entity_anim_current_time(PLAYER::PLAYER_PED_ID(), &cVar1, &Var13) >= 0.99f)
			{
				return true;
			}
		}
...
struct<8> func_83(int iParam0)
{
	...
	{
		case 0:
			StringCopy(&cVar0, "hand2chin_michael", 32);
			break;
		...
		case 4:
			StringCopy(&cVar0, "leanback_michael", 32);
			break;
		
		default:
			StringCopy(&cVar0, "uneasy_michael", 32);
			break;
	}
	return cVar0;
}

int func_84(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_85(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	
	if (func_62(iParam0) && func_121(iParam0) > 1.3f)
	{
		iVar0 = is_control_just_pressed(2, 201);
		iVar1 = is_control_just_pressed(2, 202);
		if (iVar0 || iVar1)
		{
			if (iVar0)
			{
	...
	func_86(iParam1, 1128792064, 1, 0, 1, 1065353216);
	return false;
}

void func_86(int iParam0, Vector3 fParam1, int iParam2, int iParam3, int iParam4, Vector3 fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_91(*iParam0.f_1, 256) || (func_91(*iParam0.f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			_push_scaleform_movie_function_parameter_bool(func_91(*iParam0.f_1, 4096));
			_pop_scaleform_movie_function_void();
		}
		iVar5 = false;
		iVar6 = 0;
		while (iVar6 < *iParam0.f_123)
		{
			...
			if (iVar4)
			{
				if (_push_scaleform_movie_function(*iParam0, "SET_DATA_SLOT"))
				{
					...
					{
						func_89(*iParam0.f_2[iVar6 /*15*/]);
					}
					if (is_pc_version())
					{
						if (func_91(*iParam0.f_1, 4096))
						{
							if (*(iParam0.f_2[iVar6 /*15*/]).f_1)
							{
								_push_scaleform_movie_function_parameter_bool(true);
								_push_scaleform_movie_function_parameter_int(*(iParam0.f_2[iVar6 /*15*/].f_3[0 /*2*/]).f_1);
							}
							else
							{
		...
		fVar8 = func_46(iParam4, func_46(func_91(*iParam0.f_1, 32), 1f, 0f), -1f);
...
void func_95(char* sParam0, auto uParam1, int iParam2)
{
	int iVar0;
	...
	iVar0 |= 98304;
	_request_cutscene_2(sParam0, iVar0, 8);
}
...
struct<4> func_97(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	char[16] cVar0;
	int iVar4;
...
void func_98(auto uParam0, int iParam1, int iParam2)
{
	...
	if (iParam2)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_1, iParam1);
	}
	else
	{
...
bool func_113(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_114(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (*uParam0 == 0)
	{
...
void func_117(int iParam0, auto uParam1, int iParam2, int iParam3, auto uParam4, Vector3 vParam5, Vector3 fParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	*iParam2 = get_players_last_vehicle();
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
		...
		else
		{
			...
			{
				iVar1 = get_ped_in_vehicle_seat(*iParam2, -1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = create_vehicle(iParam9, vParam5, fParam8, 1, 1);
...
void func_118(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_entity_coords(PLAYER::PLAYER_PED_ID(), -1907.39f, -577.33f, 17.64f, 1, false, 0, 1);
		set_entity_heading(PLAYER::PLAYER_PED_ID(), 318.6574f);
		task_play_anim(PLAYER::PLAYER_PED_ID(), &cVar1, &cVar13, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		task_play_anim(PLAYER::PLAYER_PED_ID(), &cVar9, &cVar21, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	}
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_130(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
bool func_133(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	auto uVar0;
...
void func_137(int iParam0)
{
	...
	func_138(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_138(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_12 = func_147(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_141(func_143(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_141(func_140(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
...
int func_139(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2469339[iParam0 /*5*/][func_142(iParam1)];
...
int func_144(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_145(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_146(uParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3))
	{
...
int func_146(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_148(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_138(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_130(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_138(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_203(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	auto uVar0;
...
void func_206(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_142(iParam1)];
...
void func_208(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_209(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_210(char* sParam0, int iParam1)
{
	...
	iVar1 = (iVar1 || shift_left(func_211(iParam1), iVar0));
	_request_cutscene_2(sParam0, iVar1, 8);
}
...
struct<4> func_212(int iParam0, int iParam1, int iParam2, auto uParam3)
{
	char[16] cVar0;
	int iVar4;
	int iVar5;
	...
	if ((((!func_217(&(Global_101154.f_18651), 8) && iParam1) && iParam0 != 4) && func_215(3) > 0) && get_random_float_in_range(0f, 1f) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	else
	{
		...
		{
			GAMEPLAY::GAMEPLAY::SET_BIT(&iVar5, 11);
			iVar6++;
		}
		if (iVar6 <= 0)
		{
...
void func_213(auto uParam0, int iParam1, int iParam2)
{
...
int func_216(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_217(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 > 11)
	{
		return false;
...
void func_220(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
	{
...
struct<2> func_223(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
auto func_225(int iParam0, int iParam1)
{
	struct<5> Var0;
...
void func_232(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	func_234(uParam0);
	request_additional_text("SHRINK", false);
...
void func_248(auto uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_250(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_250(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
