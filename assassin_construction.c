#region Local Var
	...
	auto uLocal_45 = 0;
	auto uLocal_46 = 0;
	auto uLocal_47 = 1132396544;
	auto uLocal_48 = 1132396544;
	auto uLocal_49 = 1132396544;
	auto uLocal_50 = 0;
	auto uLocal_51 = -1082130432;
	auto uLocal_52 = 0;
	auto uLocal_53 = 0;
	auto uLocal_54 = 8;
	auto uLocal_55 = 0;
	...
	struct<4> Local_122 = 0;
	auto uLocal_126 = 45;
	auto uLocal_127 = 1103626240;
	auto uLocal_128 = 5;
	int iLocal_129 = 0;
	auto uLocal_130 = 0;
	auto uLocal_131 = 0;
	...
	int iLocal_1036 = 0;
	int iLocal_1037 = 0;
	Vector3 vLocal_1038 = 0;
	Vector3 vLocal_1041 = 0;
	Vector3 fLocal_1044 = 0;
	float fLocal_1045 = 0;
	auto uLocal_1046 = 0;
	auto uLocal_1047 = 0;
	Vector3 vLocal_1048 = 0;
	Vector3 vLocal_1051 = 0;
	int iLocal_1054 = 0;
	auto uLocal_1055 = 0;
	auto uLocal_1056 = 0;
	int iLocal_1057 = 0;
	...
	int iLocal_1066 = 0;
	int iLocal_1067 = 0;
	Vector3 vLocal_1068 = 0;
	Vector3 vLocal_1071 = 0;
	int iLocal_1074 = 0;
	int iLocal_1075 = 0;
	int iLocal_1076 = 0;
	auto uLocal_1077 = 0;
	...
	auto uLocal_1200 = 0;
	int iLocal_1201 = 0;
	struct<19>[] Local_1202 = new struct<19>[5];
	struct<19>[] Local_1298 = new struct<19>[3];
	struct<19>[] Local_1356 = new struct<19>[6];
	struct<19>[] Local_1471 = new struct<19>[2];
	struct<19>[] Local_1510 = new struct<19>[4];
	struct<19>[] Local_1587 = new struct<19>[3];
	struct<19>[] Local_1645 = new struct<19>[3];
	int[] iLocal_1703 = new int[3];
	int iLocal_1707 = 0;
	int iLocal_1708 = 0;
	int iLocal_1709 = 0;
	int iLocal_1710 = 0;
	...
	int iLocal_1785 = 0;
	int iLocal_1786 = 0;
	int[] iLocal_1787 = new int[3];
	int[] iLocal_1791 = new int[3];
	int[] iLocal_1795 = new int[5];
	int iLocal_1801 = 0;
	int iLocal_1802 = 0;
	int iLocal_1803 = 0;
	int iLocal_1804 = 0;
	var[] uLocal_1805 = new var[2];
	int iLocal_1808 = 0;
	int iLocal_1809 = 0;
	int iLocal_1810 = 0;
	Vector3 vLocal_1811 = 0;
	Vector3 vLocal_1814 = 0;
	Vector3 vLocal_1817 = 0;
	Vector3 vLocal_1820 = 0;
	Vector3 vLocal_1823 = 0;
	Vector3 vLocal_1826 = 0;
	Vector3 vLocal_1829 = 0;
	Vector3[] vLocal_1832 = new Vector3[3];
	Vector3[] vLocal_1842 = new Vector3[2];
	Vector3[] vLocal_1849 = new Vector3[20];
	Vector3 vLocal_1910 = 0;
	Vector3 vLocal_1913 = 0;
	Vector3 vLocal_1916 = 0;
	Vector3[] vLocal_1919 = new Vector3[3];
	Vector3[] vLocal_1929 = new Vector3[3];
	float[] fLocal_1939 = new float[3];
	Vector3 vLocal_1943 = 0;
	Vector3 vLocal_1946 = 0;
	Vector3 vLocal_1949 = 0;
	Vector3 fLocal_1952 = 0;
	Vector3 vLocal_1953 = 0;
	Vector3 fLocal_1956 = 0;
	Vector3 vLocal_1957 = 0;
	float fLocal_1960 = 0;
	Vector3 vLocal_1961 = 0;
	Vector3 fLocal_1964 = 0;
	Vector3 vLocal_1965 = 0;
	Vector3 fLocal_1968 = 0;
	int iLocal_1969 = 0;
	int iLocal_1970 = 0;
	int iLocal_1971 = 0;
	int iLocal_1972 = 0;
...
void main()
{
	...
	iLocal_145 = 100;
	iLocal_146 = 3;
	iLocal_798 = _0x4A9923385BDB9DAD();
	iLocal_799 = _get_blip_info_id_iterator();
	iLocal_1012 = -1;
	fLocal_1014 = 1f;
	iLocal_1030 = 1;
	...
	if (func_433())
	{
		...
		if (iLocal_1775 == 0)
		{
			if (iLocal_1746)
			{
				...
				iVar0 = func_383(vLocal_1961, fLocal_1964);
		...
		else if (iLocal_1775 == 1)
		{
			if (iLocal_1746)
			{
				...
				iVar1 = func_383(vLocal_1965, fLocal_1968);
		...
		else if (iLocal_1775 == 2)
		{
			...
			{
				remove_cover_point(iLocal_1711);
			}
			iLocal_1711 = add_cover_point(-182.0891f, -1004.055f, 113.1355f, 341.2941f, 1, 2, 0, 0);
		...
		else if (iLocal_1775 == 3)
		{
			...
			{
				remove_cover_point(iLocal_1712);
			}
			iLocal_1712 = add_cover_point(-150.5964f, -945.8911f, 268.1318f, 231.5456f, 2, 0, 0, 0);
			_0x2208438012482A1A(iLocal_1801, 1, 0);
			task_put_ped_directly_into_cover(iLocal_1801, vLocal_1957, -1, false, 0f, false, 0, 0, 0);
			set_gameplay_cam_relative_heading(90f);
			set_gameplay_cam_relative_pitch(0f, 1f);
			func_382(vLocal_1957, fLocal_1960, 1, 0);
		}
	...
	while (true)
	{
		...
		else if (!is_ped_injured(iLocal_1801))
		{
			func_1();
		}
		wait(0);
...
void func_1()
{
	...
	switch (iLocal_1030)
	{
		...
		case 5:
			if (func_359())
			{
				set_ped_model_is_suppressed(iLocal_1778[0], true);
				iLocal_1030 = 6;
			}
			break;
...
void func_5(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_7(Global_101154.f_17223[iVar0], &vVar2, &fVar5))
			{
...
int func_7(int iParam0, auto uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
{
	func_21(&(Global_95496.f_2311), vParam0, fParam3);
}

void func_21(auto uParam0, Vector3 vParam1, auto uParam2)
{
	*uParam0 = {vParam1};
	*uParam0.f_6 = uParam4;
}
...
int func_23(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_24(auto uParam0)
{
	...
	else if (iLocal_1030 >= 11)
	{
		if (iLocal_1030 == 13)
		{
			vVar0 = {get_entity_coords(iLocal_1801, 1)};
			if (!iLocal_1742)
			{
				if (vVar0.z < vLocal_1826.z - 50f && ((does_entity_exist(iLocal_1802) && !is_ped_injured(iLocal_1802)) && !is_ped_in_any_vehicle(iLocal_1802, 0)))
				{
					return true;
				}
			}
	...
	else if (is_screen_faded_in())
	{
		if (iLocal_1030 < 8)
		{
			if (func_25(&uLocal_1713, vLocal_1817, "ASS_CS_RTNY", 500f))
			{
				*uParam0 = 1;
				return true;
			}
		}
		else if (func_25(&uLocal_1713, vLocal_1817, "ASS_CS_RTNR", 250f))
		{
			*uParam0 = 1;
			return true;
		}
...
bool func_25(auto uParam0, Vector3 vParam1, char* sParam2, float fParam3)
{
	float fVar0;
...
float func_26(int iParam0)
{
	if (func_29(iParam0))
	{
		...
		{
			return func_27(is_bit_set(*iParam0, 4)) - *iParam0.f_1;
		}
	}
	return *iParam0.f_1;
}
...
{
	*iParam0.f_1 = func_27(is_bit_set(*iParam0, 4)) - fParam1;
...
bool func_35()
{
	if (does_entity_exist(Local_1587[0 /*19*/]))
	{
		if (!is_ped_injured(Local_1587[0 /*19*/]))
		{
			return true;
		}
	}
...
bool func_36(int iParam0, float fParam1, float fParam2)
{
	int iVar0;
	float fVar1;
...
{
	return func_38(get_player_ped(get_player_index()), iParam0, iParam1);
}
...
void func_39()
{
	...
	{
		if (func_41(&iLocal_1802, &iLocal_1972) && is_player_ready_for_cutscene(player_id()))
		{
			if (!is_ped_injured(Local_1510[3 /*19*/]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_1510[3 /*19*/], 30, true);
				set_entity_coords(Local_1510[3 /*19*/], -119.0637f, -973.7914f, 292.04f, 1, false, 0, 1);
				task_combat_ped(Local_1510[3 /*19*/], iLocal_1801, 0, 16);
			}
			func_40();
			iLocal_1030 = 14;
		}
		...
		if (is_screen_faded_in() && !is_message_being_displayed())
		{
			...
			switch (iLocal_1763)
			{
				case 0:
					if (iLocal_1714)
					{
						if (!func_29(&iLocal_1979))
						{
							func_61(&iLocal_1979);
						}
						else if (func_26(&iLocal_1979) > 2f)
						{
				...
				case 4:
					if (iLocal_1030 >= 11)
					{
						if (func_29(&iLocal_1979))
						{
							if (func_26(&iLocal_1979) > 13f)
							{
								iLocal_1804 = func_60(50f);
								if (iLocal_1804 != 0)
								{
									if (_0x6CD5A433374D4CFB(iLocal_1804, player_ped_id()))
									{
										func_360(&uLocal_2005, 7, iLocal_1804, "OJAcsGUARD4", 0, 1);
				...
				case 7:
					if (func_26(&iLocal_1979) > 12f)
					{
						if (is_ped_in_cover(iLocal_1801, 0) || func_44(&Local_1356, 6) < 4)
						{
							iLocal_1804 = func_60(75f);
							if (iLocal_1804 != 0)
							{
								if (is_ped_in_cover(iLocal_1801, 0))
								{
									func_360(&uLocal_2005, 7, iLocal_1804, "OJAcsGUARD4", 0, 1);
				...
				case 10:
					if (does_entity_exist(Local_1510[0 /*19*/]) && does_entity_exist(iLocal_1802))
					{
						if (!is_ped_injured(Local_1510[0 /*19*/]) && !is_ped_injured(iLocal_1802))
						{
...
int func_45(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_46(char* sParam0, int iParam1, int iParam2)
{
	Global_15713 = 0;
...
void func_55(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_59(int iParam0)
{
	if (!is_ped_injured(iParam0))
	{
		...
		if (is_ped_armed(iLocal_1801, 6) && !is_ped_in_any_vehicle(iLocal_1801, 0))
		{
...
int func_60(float fParam0)
{
	...
	vVar1 = {get_entity_coords(iLocal_1801, 1)};
	if (iLocal_1030 < 10)
	{
		iVar4 = 0;
		while (iVar4 <= 4)
		{
			if (!is_ped_injured(Local_1202[iVar4 /*19*/]))
			{
				fVar6 = vdist2(vVar1, get_entity_coords(Local_1202[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else if (iLocal_1030 < 12)
	{
		...
		while (iVar4 <= 5)
		{
			if (!is_ped_injured(Local_1356[iVar4 /*19*/]))
			{
				fVar6 = vdist2(vVar1, get_entity_coords(Local_1356[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else
	{
		...
		while (iVar4 <= 3)
		{
			if (!is_ped_injured(Local_1510[iVar4 /*19*/]))
			{
				fVar6 = vdist2(vVar1, get_entity_coords(Local_1510[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
			...
			if (!is_message_being_displayed())
			{
				switch (iLocal_1759)
				{
					...
					case 1:
						if (iLocal_1762 >= 2)
						{
							if (!does_entity_exist(iLocal_1802) || (!is_entity_dead(iLocal_1802, 0) && iLocal_1030 < 13))
							{
					...
					case 2:
						if (iLocal_1762 >= 5)
						{
							if (iLocal_1030 < 13)
							{
								if (!does_entity_exist(iLocal_1802) || !is_entity_dead(iLocal_1802, 0))
								{
...
bool func_64(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8)
{
	if (iParam3 == 0)
	{
...
void func_67(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1 - 1)
	{
		...
		{
			func_64(*iParam0[iVar0 /*19*/], iParam0[iVar0 /*19*/].f_2, -1, 0, 0, 0, -1082130432, 0, -1);
	...
	if (does_entity_exist(iParam0))
	{
		if (!is_ped_injured(iParam0))
		{
			if (func_70())
			{
				...
				if ((fVar0 <= 33f && _0x6CD5A433374D4CFB(iParam0, iLocal_1801)) || (is_ped_in_any_vehicle(iLocal_1801, 0) && fVar0 <= 5f))
				{
					return true;
				}
			}
...
bool func_70()
{
	if (is_entity_in_angled_area(iLocal_1801, -140.6299f, -1029.231f, 26.29815f, -109.2613f, -943.295f, 29.2294f, 107f, 0, false, 0) || is_entity_in_angled_area(iLocal_1801, -169.2749f, -1096.598f, 18.68888f, -142.4606f, -1029.005f, 27.31028f, 99.5f, 0, false, 0))
	{
		return true;
	}
	return false;
...
bool func_71(int iParam0, int iParam1)
{
	...
	if (does_entity_exist(iParam0))
	{
		if (has_entity_been_damaged_by_entity(iParam0, player_ped_id(), 1) && !is_entity_dead(iParam0, 0))
		{
			return true;
		}
...
bool func_72(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	if (!is_entity_dead(iVar0, 0) && !is_entity_dead(iParam0, 0))
	{
		...
		iVar1 = !func_79(*uParam2, 128);
		if (iParam4)
		{
			if (func_73(iParam0, iParam1, 1, iParam6, iVar1, 1))
			{
				*uParam3 = 32;
				return true;
			}
		...
		{
			if (func_73(iParam0, iParam1, 0, iParam6, iVar1, iParam8))
			{
				*uParam3 = 16;
				return true;
			}
...
bool func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	if (iParam5)
	{
		if (is_ped_in_melee_combat(player_ped_id()))
		{
			if (is_entity_at_coord(iParam0, get_entity_coords(player_ped_id(), 1), 10f, 10f, 10f, false, true, 0))
			{
	...
	if (func_74(player_ped_id(), iParam0))
	{
		return true;
	}
	if (iParam2)
	{
		if (is_ped_ragdoll(iParam0) && func_37(iParam0, 1) < 1.5f)
		{
			return true;
		}
		else if (is_ped_in_any_vehicle(iParam0, 0))
		{
			if (is_entity_touching_entity(player_ped_id(), get_vehicle_ped_is_in(iParam0, 0)))
			{
				return true;
			}
		}
...
bool func_75(int iParam0, int iParam1, auto uParam2)
{
...
bool func_76(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	Vector3 vVar0;
	int iVar3;
	...
	if (is_ped_armed(iParam0, 2))
	{
		...
		else
		{
			...
			if (is_ped_planting_bomb(iParam0) || func_77(iVar3))
			{
				if (is_entity_at_coord(iParam1, get_entity_coords(iParam0, 1), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), IntToFloat(*uParam2.f_6 * 3), false, true, 0))
				{
					if (is_ped_facing_ped(get_ped_index_from_entity_index(iParam1), iParam0, 120f) && has_entity_clear_los_to_entity(iParam1, iParam0, 17))
...
bool func_78(int iParam0, auto uParam1)
{
	if (!is_entity_dead(iParam0, 0))
	{
...
int func_79(auto uParam0, int iParam1)
{
	...
	switch (iLocal_1075)
	{
		case 0:
			if (!iLocal_139)
			{
				...
				Global_101154.f_18653.f_9 = func_26(&iLocal_1976);
		...
		case 1:
			...
			if (func_155(&uLocal_150, 1, 0) && _0x6F259F82D873B8B8())
			{
...
void func_85(struct<25> Param0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14)
{
	Vector3 fVar0;
	...
	func_86(func_10(), 96, round(fVar0), 0, 0);
}
...
bool func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_90(int iParam0)
{
	...
	else if (is_bit_set(Global_101154.f_25089.f_471, iParam0) || is_bit_set(Global_2097152[func_92() /*10375*/].f_7704.f_10, iParam0))
	{
		iVar0 = true;
		clear_bit(&(Global_101154.f_25089.f_471), iParam0);
		clear_bit(&(Global_2097152[func_92() /*10375*/].f_7704.f_10), iParam0);
	}
	if (iVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_set_notification_text_entry("COUP_RED");
		_add_text_component_item_string(func_91(iParam0));
...
int func_94(int iParam0)
{
	...
	return is_bit_set(Global_2097152[func_92() /*10375*/].f_7704.f_10, iParam0);
}
...
bool func_99(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_103(auto uParam0, float fParam1)
{
	if (fParam1 == 0f)
	{
		*uParam0.f_72 = 0f;
...
int func_106(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_118(auto uParam0, Vector3 fParam1, int iParam2, int iParam3, int iParam4, Vector3 fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_124(*uParam0.f_1, 256) || (func_124(*uParam0.f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (is_pc_version())
		{
			...
			_push_scaleform_movie_function_parameter_bool(func_124(*uParam0.f_1, 4096));
			_pop_scaleform_movie_function_void();
		}
		iVar5 = false;
		iVar6 = 0;
...
float func_121(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
int func_124(auto uParam0, int iParam1)
{
	return (uParam0 && iParam1) != 0;
}

bool func_125(auto uParam0)
{
	if (*uParam0 != 0)
	{
...
int func_126(auto uParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	...
	*uParam0.f_574 = get_frame_count();
	...
	if (*uParam0.f_560 == 0f)
	{
		*uParam0.f_560 += func_148(30f);
		*uParam0.f_560 += IntToFloat(*uParam0.f_56) * func_148(25f);
		if (*uParam0.f_56 > 0)
		{
			*uParam0.f_560 += func_148(25f * 0.5f);
		}
		if (*uParam0.f_549)
		{
			*uParam0.f_560 += func_148(30f) - func_148(2f);
		}
	}
	iVar0 = true;
	while (iVar0)
		...
		*uParam0.f_548 = func_128(*uParam0.f_548, 0f, 1f);
		...
		if ((*uParam0.f_565 || *uParam0.f_566) && *uParam0.f_56 != 0)
		{
			if (IntToFloat(*uParam0.f_572) > IntToFloat(*uParam0.f_558 + 1165) - 15000f * fParam2)
			{
				...
				*uParam0.f_559 = func_128(*uParam0.f_559 + 1f / 0.3f * *uParam0.f_573 * timestep(), 0f, 1f);
				*uParam0.f_573 = func_128(*uParam0.f_573 + 0.07f, 0.75f, 1.15f);
			}
		}
		else
		{
			*uParam0.f_559 = func_128(*uParam0.f_559 - 1f / 0.3f * *uParam0.f_573 * 0.01f * timestep(), 0f, 1f);
			*uParam0.f_573 = func_128(*uParam0.f_573 + 0.07f, 0.75f, 1.15f);
		}
...
void func_127(auto uParam0, int iParam1)
{
	...
	func_123(_get_control_action_name(2, 215, true));
	func_122("ES_HELP");
	if (is_pc_version())
	{
		_push_scaleform_movie_function_parameter_bool(true);
	...
	if (iParam1)
	{
		...
		func_123(_get_control_action_name(2, 216, true));
		func_122("ES_XPAND");
		if (is_pc_version())
		{
			_push_scaleform_movie_function_parameter_bool(true);
...
void func_129(auto uParam0, float fParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	fVar1 -= func_148(6f);
	fVar1 += func_148(30f) - func_148(2f * 2f);
	fVar11 = fVar2 - func_148(2f * 14f);
	if (fVar11 >= 0f)
	{
		fVar12 = func_128(fVar11 / 0.6f * func_148(25f), 0f, 1f);
		func_146();
		draw_rect(0.5f, fVar1 - func_148(2f - 0.5f) - 0.001388889f, fVar6, func_141(1f), iVar13, iVar14, iVar15, round(fVar12 * IntToFloat(iVar16)), 0);
	}
	else
	{
		return;
	}
	fVar1 += func_148(2f * 0.3f);
	if (*uParam0.f_56 > 0)
	{
		fVar1 += func_148(25f * 0.2f);
	}
	iVar17 = 0;
	iVar17 = 0;
	while (iVar17 < *uParam0.f_56)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			func_138(uParam0, iVar17, fVar1 + func_148(2f), fVar9, fVar10, round(IntToFloat(iVar0) * fVar12));
		}
		else
		{
			return;
	...
	if (*uParam0.f_56 > 0)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			fVar12 = func_128(fVar11 / 0.6f * func_148(25f), 0f, 1f);
			func_146();
			draw_rect(0.5f, fVar1 + func_148(2f * 0.5f), fVar6, func_141(1f), iVar13, iVar14, iVar15, round(fVar12 * IntToFloat(iVar16)), 0);
		}
	}
	if (*uParam0.f_549)
	{
		...
		if (fVar11 >= 0f)
		{
			...
			switch (*uParam0.f_556)
			{
				case 0:
					...
					_draw_text(fVar20, fVar1 + func_148(2f * 2f), 0);
					break;
...
bool func_132(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4, int iParam5)
{
	char* sVar0;
	char* sVar1;
	int iVar2;
	...
	if (get_hash_key(sVar1) != 0)
	{
		...
		vVar7.x *= func_133(iParam0) / fVar4;
		vVar7.y *= func_133(iParam0) / fVar4;
		if (!iParam2)
		{
			vVar7.x -= 2f;
			vVar7.y -= 2f;
...
auto func_135(int iParam0, int iParam1)
{
...
void func_138(auto uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	set_text_justification(1);
	set_text_scale(1f, func_140(14f));
	set_text_centre(0);
	set_text_font(0);
	func_146();
	...
	switch (*uParam0.f_517[iParam1])
	{
		...
		case 1:
			...
			draw_sprite("CommonMenu", func_135(7, 0), fParam4 - 0.006f, fParam2 + func_148(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
		
		case 2:
			func_132(5, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_135(5, 0), fParam4 - 0.006f, fParam2 + func_148(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
		
		case 3:
			func_132(6, 0, 1, &fVar5, &fVar6, 0);
			draw_sprite("CommonMenu", func_135(6, 0), fParam4 - 0.006f, fParam2 + func_148(2f) + 0.25f * fVar6, fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 -= fVar5 * 0.38f + 0.006f;
			break;
	}
...
void func_139(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			set_text_scale(1f, func_140(18f));
			set_text_font(4);
			if (iParam0 < 0)
			{
...
bool func_153(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_156(auto uParam0)
{
	...
	func_123(_get_control_action_name(2, 188, true));
	func_122("ES_HELP_TU");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "SET_DATA_SLOT");
	_push_scaleform_movie_function_parameter_int(true);
	func_123(_get_control_action_name(2, 187, true));
	func_122("ES_HELP_TD");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "SET_DATA_SLOT");
	_push_scaleform_movie_function_parameter_int(false);
	func_123(_get_control_action_name(2, 202, true));
	func_122("ES_HELP_AB");
	_pop_scaleform_movie_function_void();
	_push_scaleform_movie_function(*uParam0.f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	_pop_scaleform_movie_function_void();
...
void func_157(auto uParam0)
{
	...
	fVar0 = 0f;
	set_text_justification(0);
	set_text_scale(1f, func_140(16f));
	if (*uParam0.f_31 == 0)
	{
		if (*uParam0.f_29)
		{
...
void func_159()
{
	...
	if (!iLocal_139)
	{
		...
		if (Global_85788)
		{
			func_164(&uLocal_150, 6, &(Local_726.f_12), "MTPHPERSKI", floor(fLocal_134), 0, 3, 0);
			func_164(&uLocal_150, 6, &(Local_726.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_164(&uLocal_150, 6, &(Local_726.f_30), "MTPHPERSKI", round(fLocal_136 + fLocal_135), 0, 3, 0);
			func_163();
		}
		else
		{
			if (iLocal_138)
			{
				func_164(&uLocal_150, 6, &(Local_726.f_12), "MTPHPERRET", floor(fLocal_134), 0, 3, 0);
			}
			else
			{
				func_164(&uLocal_150, 9, &(Local_726.f_12), "", floor(fLocal_134), 0, 0, 0);
			}
			if (!is_string_null_or_empty(&(Local_726.f_18)))
			{
				if (iLocal_137)
				{
					...
					func_164(&uLocal_150, 3, &(Local_726.f_30), "", round(fLocal_136 + fLocal_135), 0, 2, 0);
				}
				else
				{
					func_164(&uLocal_150, 6, &(Local_726.f_24), "", 0, 0, 1, 0);
					func_164(&uLocal_150, 3, &(Local_726.f_30), "", round(fLocal_135), 0, 0, 0);
				}
			}
			else
			{
...
void func_160()
{
	...
	{
		func_161(38, floor(fLocal_134), 1);
		if (iLocal_137)
		{
			func_161(39, 1, 1);
		}
		...
		if (iLocal_137)
		{
			func_161(40, round(fLocal_136 + fLocal_135), 1);
		}
		else
		{
			func_161(40, round(fLocal_135), 1);
		}
	...
	{
		func_161(52, floor(fLocal_134), 1);
		if (iLocal_137)
		{
			func_161(53, 1, 1);
		}
		...
		if (iLocal_137)
		{
			func_161(56, round(fLocal_136 + fLocal_135), 1);
		}
		else
		{
			func_161(56, round(fLocal_135), 1);
		}
	...
	{
		func_161(66, floor(fLocal_134), 1);
		if (iLocal_137)
		{
			func_161(67, 1, 1);
		}
		...
		if (iLocal_137)
		{
			func_161(68, round(fLocal_136 + fLocal_135), 1);
		}
		else
		{
			func_161(68, round(fLocal_135), 1);
		}
	...
	{
		func_161(81, floor(fLocal_134), 1);
		if (iLocal_137)
		{
			func_161(82, 1, 1);
		}
		...
		if (iLocal_137)
		{
			func_161(83, round(fLocal_136 + fLocal_135), 1);
		}
		else
		{
			func_161(83, round(fLocal_135), 1);
		}
	...
	{
		func_161(97, floor(fLocal_134), 1);
		if (iLocal_137)
		{
			func_161(98, 1, 1);
		}
		...
		if (iLocal_137)
		{
			func_161(99, round(fLocal_136 + fLocal_135), 1);
		}
		else
		{
			func_161(99, round(fLocal_135), 1);
		}
...
void func_162(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_164(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	auto uVar0;
...
void func_165(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
...
void func_167()
{
	...
	{
		if ((func_26(&iLocal_2000) > 7f && !is_message_being_displayed()) && !is_help_message_being_displayed())
		{
	...
	{
		case 0:
			if (get_ped_parachute_state(iLocal_1801) != -1)
			{
				if (!iLocal_1755 && !is_scripted_conversation_ongoing())
				{
				...
				if (get_ped_parachute_state(iLocal_1801) == 1 || get_ped_parachute_state(iLocal_1801) == 2)
				{
					clear_help(1);
				...
				else if (get_ped_parachute_state(iLocal_1801) == 0)
				{
					if (does_blip_exist(iLocal_1710))
					{
						remove_blip(&iLocal_1710);
					}
			...
			else
			{
				...
				if (!func_70() && !is_ped_ragdoll(iLocal_1801))
				{
					iLocal_1760 = 3;
				}
			}
		...
		case 1:
			if (!iLocal_1738)
			{
				if (get_ped_parachute_state(iLocal_1801) == 3)
				{
					settimera(0);
					remove_all_shocking_events(0);
					iLocal_1760++;
				}
				else if (!has_ped_got_weapon(iLocal_1801, joaat("gadget_parachute"), 0))
				{
					if (!is_ped_injured(iLocal_1801))
					{
						settimera(0);
						remove_all_shocking_events(0);
						iLocal_1760++;
			...
			else if (iLocal_1739)
			{
				if (does_entity_exist(iLocal_1971))
				{
					...
					{
						set_vehicle_on_ground_properly(iLocal_1971);
					}
				}
				iLocal_1760++;
			}
		...
		case 2:
			if (get_ped_parachute_state(iLocal_1801) == -1 && !is_entity_in_air(iLocal_1801))
			{
				if (!is_ped_injured(iLocal_1801))
				{
					if (func_70())
...
void func_169(int iParam0)
{
	...
	if (iParam0)
	{
		if (does_entity_exist(iLocal_1802))
		{
			if (!is_ped_injured(iLocal_1802))
			{
				if (is_ped_in_any_heli(iLocal_1802))
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1802, 3, false);
					set_ped_flee_attributes(iLocal_1802, 2, false);
					set_ped_keep_task(iLocal_1802, true);
				}
			}
			set_ped_as_no_longer_needed(&iLocal_1802);
		}
		if (does_blip_exist(iLocal_1707))
		{
			remove_blip(&iLocal_1707);
		}
	}
}
		...
		if (does_entity_exist(*iParam0[iVar0 /*19*/]))
		{
			if (!is_ped_injured(*iParam0[iVar0 /*19*/]))
			{
				if (is_entity_occluded(*iParam0[iVar0 /*19*/]) || !is_entity_on_screen(*iParam0[iVar0 /*19*/]))
				{
					if (!is_ped_injured(*iParam0[iVar0 /*19*/]))
					{
						set_entity_health(*iParam0[iVar0 /*19*/], false);
					}
				}
				else
				{
...
int func_174(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_175()
{
	...
	switch (iLocal_1769)
	{
		case 0:
			...
			clear_area(vLocal_1826, 10f, 1, 0, 0, false);
			clear_help(1);
			settimera(0);
			iLocal_1769++;
			break;
		...
		case 1:
			if (func_195(iLocal_1787[1], iLocal_1791[1], 152.2146f))
			{
				iLocal_1769++;
			}
			break;
		...
		case 2:
			...
			{
				func_200(&iLocal_1765);
				freeze_entity_position(iLocal_1801, false);
				display_radar(false);
				display_hud(false);
				iLocal_1769++;
			}
		...
		case 3:
			if (does_entity_exist(iLocal_1787[1]))
			{
				vVar0 = {get_entity_coords(iLocal_1787[1], 1)};
				if (vVar0.z <= 32f)
				{
				...
				{
					func_191(iLocal_1787[1], 0, 0, 0.25f, 1, 0, 1);
				}
			}
			break;
	...
	if (iLocal_1769 >= 3)
	{
		...
		else if (is_screen_faded_out())
		{
			func_177();
			func_194(1);
			set_entity_heading(iLocal_1801, 74.1208f);
...
{
	if (func_179() && get_game_timer() >= iParam0 + 1000)
	{
...
void func_182(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (network_is_game_in_progress())
		{
			if (((!is_ped_injured(player_ped_id()) && !func_187(player_id())) && !func_184(player_id(), 0)) && !func_183())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_187(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
...
void func_191(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	if (iParam4)
	{
		if (is_ped_in_any_vehicle(iLocal_1801, 0))
		{
			iVar4 = get_vehicle_ped_is_in(iLocal_1801, 0);
		}
		if (iVar4 == 0)
		{
			if (!is_entity_attached(iLocal_1801))
			{
				fVar3 = get_entity_heading(iLocal_1801);
				if (fVar3 + 90f >= 360f)
				{
					fVar3 += 90f - 360f;
				}
				...
				if (!is_ped_in_any_vehicle(iLocal_1801, 0))
				{
					attach_entity_to_entity(iLocal_1801, iParam0, 0, vLocal_1946, 0f, 0f, fVar3, 0, 0, 1, 0, 2, 1);
				}
			}
		}
...
void func_193(char* sParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)
{
	func_200(iParam1);
	if (iParam2)
	{
...
void func_194(int iParam0)
{
	...
	if (is_ped_in_any_vehicle(iLocal_1801, 0))
	{
		iVar0 = get_vehicle_ped_is_in(iLocal_1801, 0);
		detach_entity(iVar0, 1, true);
	}
	else
	{
		detach_entity(iLocal_1801, 1, true);
	}
	func_200(&iLocal_1765);
	if (does_entity_exist(iLocal_1787[1]))
	{
		set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 31.44f, 1, false, 0, 1);
	}
	else
	{
		iLocal_1787[1] = create_object(iLocal_1784, -158.84f, -942.24f, 31.44f, 1, true, false);
		set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 31.44f, 1, false, 0, 1);
		set_entity_rotation(iLocal_1787[1], vLocal_1832[1 /*3*/], 2, 1);
	}
	if (iVar0 == 0)
	{
		attach_entity_to_entity(iLocal_1801, iLocal_1787[1], 0, vLocal_1946, 0f, 0f, 74.1208f, 0, 0, 1, 0, 2, 1);
	}
	else
	{
		attach_entity_to_entity(iVar0, iLocal_1787[1], 0, 0.4f, -2.2f, -1.2f, 0f, 0f, 74.1208f, 0, 0, 0, 0, 2, 1);
	}
	if (iParam0)
	{
	}
	...
	{
		detach_entity(iLocal_1801, 0, false);
	}
	set_player_control(player_id(), true, 0);
	set_gameplay_cam_relative_heading(0f);
}

bool func_195(int iParam0, auto uParam1, float fParam2)
{
	Vector3 vVar0;
	...
	{
		case 0:
			task_go_straight_to_coord(player_ped_id(), get_offset_from_entity_in_world_coords(iParam0, vLocal_1916), 1f, -1, fParam2, 0.5f);
			iLocal_1761++;
			break;
		...
		case 1:
			...
			{
				get_current_ped_weapon(player_ped_id(), &iLocal_2174, 1);
		...
		case 2:
			...
			{
				iLocal_1777 = create_synchronized_scene(get_offset_from_entity_in_world_coords(iParam0, vLocal_1916), get_entity_rotation(iParam0, 2), 2);
				task_synchronized_scene(player_ped_id(), iLocal_1777, "oddjobs@assassinate@construction@", "ig_1_button", 4f, -4f, 1, 0, 1000f, 0);
				iLocal_1761++;
			}
			break;
		
		case 3:
			if (is_synchronized_scene_running(iLocal_1777) && get_synchronized_scene_phase(iLocal_1777) > 0.9f)
			{
				iLocal_1761++;
			}
			break;
		...
		case 4:
			vVar0 = {get_offset_from_entity_given_world_coords(iParam0, get_entity_coords(player_ped_id(), 1))};
			vVar0.z = -1.333402f;
			attach_entity_to_entity(player_ped_id(), iParam0, 0, vVar0, 0f, 0f, get_entity_heading(player_ped_id()) - get_entity_heading(iParam0), 1, 1, 0, 0, 2, 1);
...
void func_196()
{
	...
	while (iVar0 < 3)
	{
		if (does_entity_exist(Local_1645[iVar0 /*19*/]))
		{
			if (is_entity_occluded(Local_1645[iVar0 /*19*/]))
			{
				delete_ped(&(Local_1645[iVar0 /*19*/]));
			}
			else
			{
				set_ped_as_no_longer_needed(&(Local_1645[iVar0 /*19*/]));
			}
		}
		iVar0++;
	}
...
{
	if ((((((func_34(iLocal_1801, vParam0, 1) <= 1.65f && !is_entity_in_air(iLocal_1801)) && !is_ped_ragdoll(player_ped_id())) && func_60(3f) == 0) && !func_204()) && !is_ped_jumping(iLocal_1801)) && !is_ped_in_any_vehicle(iLocal_1801, 0))
	{
		return true;
	}
	return false;
...
auto func_206(char* sParam0, int iParam1, char* sParam2)
{
...
bool func_207(int iParam0, auto uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!*iParam0)
	{
...
void func_208()
{
	switch (iLocal_1760)
	{
		case 0:
			...
			{
				if (!is_entity_dead(iLocal_1972, 0) && !is_entity_dead(get_ped_in_vehicle_seat(iLocal_1972, -1), 0))
				{
					task_heli_mission(get_ped_in_vehicle_seat(iLocal_1972, -1), iLocal_1972, false, iLocal_1801, 0f, 0f, 180f, 8, 20f, 30f, -1f, 325, 40, -1f, 0);
				}
				else
				{
					set_vehicle_as_no_longer_needed(&iLocal_1972);
				}
			}
...
void func_209()
{
	if (does_blip_exist(iLocal_1708))
	{
		remove_blip(&iLocal_1708);
	}
	if (does_blip_exist(iLocal_1709))
	{
		remove_blip(&iLocal_1709);
	}
}
...
void func_210()
{
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			func_222(5);
			func_221(0);
			if ((!is_entity_dead(iLocal_1802, 0) && !is_entity_dead(iLocal_1972, 0)) && !is_ped_in_vehicle(iLocal_1802, iLocal_1972, 0))
			{
				task_enter_vehicle(iLocal_1802, iLocal_1972, 20000, false, 2f, 1, 0);
			}
			if (iLocal_1736)
			{
		...
		case 1:
			...
			{
				if (!is_entity_dead(Local_1587[1 /*19*/], 0))
				{
					task_combat_ped(Local_1587[1 /*19*/], iLocal_1801, 0, 16);
				}
				if (!is_entity_dead(Local_1587[2 /*19*/], 0))
				{
					task_combat_ped(Local_1587[2 /*19*/], iLocal_1801, 0, 16);
				}
				func_220();
				settimera(0);
				iLocal_1760++;
...
void func_211()
{
	if (!iLocal_1733)
	{
		if (!is_entity_dead(Local_1510[3 /*19*/], 0))
		{
			if (has_entity_been_damaged_by_entity(Local_1510[3 /*19*/], player_ped_id(), 1) || is_ped_injured(Local_1510[3 /*19*/]))
			{
				apply_force_to_entity(Local_1510[3 /*19*/], 1, 0f, -4f, 2f, 0f, 0.2f, 0f, 0, 1, 1, 1, 0, 1);
				set_entity_collision(Local_1510[3 /*19*/], false, 0);
				set_entity_has_gravity(Local_1510[3 /*19*/], 1);
				set_entity_health(Local_1510[3 /*19*/], false);
				iLocal_1733 = 1;
			}
		}
	}
	if (!iLocal_1734)
	{
		if (!is_entity_dead(Local_1510[3 /*19*/], 0))
		{
			if (!is_ped_injured(Local_1510[3 /*19*/]) && !is_ped_ragdoll(Local_1510[3 /*19*/]))
			{
				if (!is_entity_at_coord(Local_1510[3 /*19*/], vLocal_1811, 5f, 5f, 5f, false, true, 0))
				{
					set_entity_coords(Local_1510[3 /*19*/], vLocal_1811, 1, false, 0, 1);
					iLocal_1734 = 1;
				}
			}
		}
	...
	switch (iLocal_1767)
	{
		case 0:
			if (iLocal_1751)
			{
				if (!is_ped_injured(Local_1510[3 /*19*/]))
				{
					if (!is_entity_waiting_for_world_collision(Local_1510[3 /*19*/]))
					{
						set_ped_accuracy(Local_1510[3 /*19*/], 0);
						freeze_entity_position(Local_1510[3 /*19*/], false);
						if (get_script_task_status(Local_1510[3 /*19*/], 167901368) != 1 && get_script_task_status(Local_1510[3 /*19*/], 167901368) != 0)
						{
							task_shoot_at_entity(Local_1510[3 /*19*/], iLocal_1801, -1, -957453492);
						}
					}
				}
				iLocal_1764 = get_random_int_in_range(5000, 10000);
				iLocal_1764 = iLocal_1764;
				iLocal_1767++;
			}
			break;
		...
		case 1:
			if (!is_ped_injured(Local_1510[3 /*19*/]))
			{
				vLocal_1910 = {get_entity_coords(Local_1510[3 /*19*/], 1)};
				if (vLocal_1910.z > 294f)
				{
					if (!is_entity_at_coord(Local_1510[3 /*19*/], vLocal_1811, 2f, 2f, 2f, false, true, 0))
					{
						if (get_script_task_status(Local_1510[3 /*19*/], 2106541073) != 1 && get_script_task_status(Local_1510[3 /*19*/], 2106541073) != 0)
						{
							task_go_straight_to_coord(Local_1510[3 /*19*/], vLocal_1811, 2f, 20000, 40000f, 0.5f);
						}
					}
					else if (get_script_task_status(Local_1510[3 /*19*/], 167901368) != 1 && get_script_task_status(Local_1510[3 /*19*/], 167901368) != 0)
					{
						task_shoot_at_entity(Local_1510[3 /*19*/], iLocal_1801, -1, -957453492);
					}
				}
...
void func_212()
{
	...
	if (does_entity_exist(iLocal_1972))
	{
		if (does_entity_exist(iLocal_1802))
		{
			if (!is_vehicle_driveable(iLocal_1972, 0) || is_ped_injured(get_ped_in_vehicle_seat(iLocal_1972, -1)))
			{
				if (!iLocal_1737)
				{
					if (!is_entity_dead(iLocal_1972, 0))
					{
						if (is_playback_going_on_for_vehicle(iLocal_1972))
						{
							stop_playback_recorded_vehicle(iLocal_1972);
						}
						if (is_entity_in_air(iLocal_1972))
						{
							set_entity_load_collision_flag(iLocal_1972, true);
							set_vehicle_out_of_control(iLocal_1972, 1, 1);
							set_vehicle_engine_health(iLocal_1972, 10f);
							set_vehicle_doors_locked(iLocal_1972, 3);
						}
						else
						{
							func_215();
			...
			else if (iLocal_1731 == 0)
			{
				if (!is_ped_injured(iLocal_1802))
				{
					if (is_ped_in_vehicle(iLocal_1802, iLocal_1972, 0))
					{
						iLocal_1731 = 1;
					}
				}
...
void func_213()
{
	...
	{
		case 0:
			if (!is_entity_dead(iLocal_1802, 0) && !is_entity_dead(iLocal_1972, 0))
			{
				if (is_ped_in_vehicle(iLocal_1802, iLocal_1972, 0))
				{
					set_heli_blades_speed(iLocal_1972, 1f);
					task_heli_mission(get_ped_in_vehicle_seat(iLocal_1972, -1), iLocal_1972, false, iLocal_1801, 0f, 0f, 10f, 9, 20f, 30f, -1f, 325, 40, -1f, 0);
				}
			}
			func_30(&iLocal_1988);
			iLocal_1032 = 1;
		...
		case 1:
			if (!is_ped_injured(Local_1587[0 /*19*/]))
			{
				if (does_entity_exist(iLocal_1802))
				{
					if (!is_ped_injured(iLocal_1802))
					{
						if (is_ped_injured(Local_1587[1 /*19*/]) && is_ped_injured(Local_1587[2 /*19*/]))
						{
							if (!func_29(&iLocal_1991))
							{
								func_30(&iLocal_1991);
							}
							else if (func_26(&iLocal_1991) > 45f)
							{
								task_heli_mission(Local_1587[0 /*19*/], iLocal_1972, false, iLocal_1801, 0f, 0f, 0f, 8, 30f, 300f, -1f, 325, 40, -1f, 0);
								iLocal_1032 = 2;
							}
						}
						else if (!func_29(&iLocal_1988))
						{
							func_30(&iLocal_1988);
						}
						else if (func_26(&iLocal_1988) > 180f)
						{
							task_heli_mission(Local_1587[0 /*19*/], iLocal_1972, false, iLocal_1801, 0f, 0f, 0f, 8, 30f, 300f, -1f, 325, 40, -1f, 0);
							iLocal_1032 = 2;
						}
...
void func_214()
{
	...
	if (!is_ped_injured(iLocal_1802))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1802, 3, true);
		open_sequence_task(&iVar0);
		task_leave_any_vehicle(false, 0, 0);
		task_cower(false, -1);
		close_sequence_task(iVar0);
		task_perform_sequence(iLocal_1802, iVar0);
...
void func_215()
{
	...
	while (iVar0 < 3)
	{
		if (!is_ped_injured(Local_1587[iVar0 /*19*/]))
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_1587[iVar0 /*19*/], 3, true);
			task_combat_ped(Local_1587[iVar0 /*19*/], player_ped_id(), 0, 16);
		}
		iVar0++;
	}
}
...
void func_216()
{
	...
	if (!iLocal_1747)
	{
		if (does_entity_exist(iLocal_1972) && !is_entity_dead(iLocal_1972, 0))
		{
			if (get_ped_in_vehicle_seat(iLocal_1972, true) != 0)
			{
				iLocal_1808 = get_ped_in_vehicle_seat(iLocal_1972, true);
				iLocal_1808 = iLocal_1808;
			}
			if (get_ped_in_vehicle_seat(iLocal_1972, 2) != 0)
			{
				iLocal_1809 = get_ped_in_vehicle_seat(iLocal_1972, 2);
			}
			if (is_vehicle_seat_free(iLocal_1972, true))
			{
				clear_sequence_task(&iVar0);
				open_sequence_task(&iVar0);
				task_shuffle_to_next_vehicle_seat(false, iLocal_1972);
				task_combat_ped(false, iLocal_1801, 0, 16);
				close_sequence_task(iVar0);
				if (!is_entity_dead(iLocal_1809, 0))
				{
					task_perform_sequence(iLocal_1809, iVar0);
				}
				clear_sequence_task(&iVar0);
				iLocal_1747 = 1;
			}
...
void func_217()
{
	if (!iLocal_1749)
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			...
			{
				if (is_entity_in_angled_area(player_ped_id(), -160.1407f, -981.4936f, 273.4415f, -144.7745f, -941.6792f, 266.6331f, 42f, 0, true, 0))
				{
					func_225(3, "assassin_construction_rooftop_battle", 0, 0, 0, 1);
					iLocal_1749 = 1;
				}
...
void func_218()
{
	if (func_29(&iLocal_1997))
	{
		if (!iLocal_2004)
		{
			if (func_26(&iLocal_1997) >= 12f)
			{
				func_219(5, 15);
				func_219(6, 15);
				iLocal_2004 = 1;
...
void func_219(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 1:
			...
			while (iVar0 <= 4)
			{
				if (does_entity_exist(Local_1202[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1202[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1202[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 2:
			...
			while (iVar0 <= 2)
			{
				if (does_entity_exist(Local_1298[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1298[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1298[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 3:
			...
			while (iVar0 <= 5)
			{
				if (does_entity_exist(Local_1356[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1356[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1356[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar0 <= 1)
			{
				if (does_entity_exist(Local_1471[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1471[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1471[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 5:
			...
			while (iVar0 <= 3)
			{
				if (does_entity_exist(Local_1510[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1510[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1510[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
		...
		case 6:
			...
			while (iVar0 <= 2)
			{
				if (does_entity_exist(Local_1587[iVar0 /*19*/]))
				{
					if (!is_ped_injured(Local_1587[iVar0 /*19*/]))
					{
						set_ped_accuracy(Local_1587[iVar0 /*19*/], iParam1);
					}
				}
				iVar0++;
			}
...
void func_220()
{
	...
	while (iVar1 <= 3)
	{
		if (iVar1 == 0)
		{
			if (!is_ped_injured(Local_1510[iVar1 /*19*/]))
			{
				if (is_screen_faded_in())
				{
					set_ped_sphere_defensive_area(Local_1510[iVar1 /*19*/], Local_1510[iVar1 /*19*/].f_10, 15f, 0, 0);
					clear_sequence_task(&iVar0);
					open_sequence_task(&iVar0);
					task_aim_gun_at_entity(false, iLocal_1801, 250, 0);
					task_go_to_coord_while_aiming_at_entity(0, -141.3603f, -946.2284f, 268.135f, iLocal_1801, 2f, true, 0.5f, 4f, true, 0, 0, -957453492, 20000);
					task_combat_ped(false, iLocal_1801, 0, 16);
					close_sequence_task(iVar0);
					task_perform_sequence(Local_1510[iVar1 /*19*/], iVar0);
					clear_sequence_task(&iVar0);
					set_ped_combat_movement(Local_1510[iVar1 /*19*/], 2);
					set_ped_keep_task(Local_1510[iVar1 /*19*/], true);
				}
			}
		}
		else if (iVar1 == 1)
		{
			if (!is_ped_injured(Local_1510[iVar1 /*19*/]))
			{
				clear_sequence_task(&iVar0);
				open_sequence_task(&iVar0);
				task_go_to_coord_any_means(false, -140.121f, -959.6016f, 268.2571f, 3f, 0, 0, 786603, -1082130432);
				task_combat_ped(false, iLocal_1801, 0, 16);
				close_sequence_task(iVar0);
				task_perform_sequence(Local_1510[iVar1 /*19*/], iVar0);
				clear_sequence_task(&iVar0);
		...
		else if (iVar1 == 2)
		{
			if (!is_ped_injured(Local_1510[iVar1 /*19*/]))
			{
				task_combat_ped(Local_1510[iVar1 /*19*/], iLocal_1801, 0, 16);
				set_ped_sphere_defensive_area(Local_1510[iVar1 /*19*/], Local_1510[iVar1 /*19*/].f_10, 10f, 0, 0);
				set_ped_combat_movement(Local_1510[iVar1 /*19*/], 2);
				set_ped_keep_task(Local_1510[iVar1 /*19*/], true);
			}
		}
...
void func_221(int iParam0)
{
	...
	if (!iLocal_1736)
	{
		if (has_model_loaded(iLocal_1785))
		{
			iLocal_1736 = true;
		}
	}
	if (iLocal_1736)
	{
		if (!iLocal_1729)
		{
			if (!does_entity_exist(iLocal_1972))
			{
				iLocal_1972 = create_vehicle(iLocal_1785, vLocal_1949, fLocal_1952, 1, 1);
				set_vehicle_engine_on(iLocal_1972, true, 1, 0);
				set_vehicle_radio_enabled(iLocal_1972, 0);
				set_entity_load_collision_flag(iLocal_1972, true);
				if (iParam0)
				{
					iLocal_1802 = PED::CREATE_PED_inside_vehicle(iLocal_1972, 26, iLocal_1778[0], false, 1, true);
				}
				else
				{
					iLocal_1802 = PED::CREATE_PED(26, iLocal_1778[0], vLocal_1953, fLocal_1956, 1, true);
				}
				set_ped_default_component_variation(iLocal_1802);
				func_360(&uLocal_2005, 3, iLocal_1802, "MAFIABOSS", 0, 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1802, 3, false);
				give_weapon_to_ped(iLocal_1802, joaat("weapon_pistol"), -1, true, true);
				set_ped_combat_movement(iLocal_1802, 2);
				set_ped_accuracy(iLocal_1802, 10);
				set_entity_load_collision_flag(iLocal_1802, true);
				PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_1802, iLocal_1975);
				set_blocking_of_non_temporary_events(iLocal_1802, true);
				_0x153973AB99FE8980(iLocal_1972, "ASSASSINATION_CONSTRUCT_HELI_GROUP", 0f);
				func_222(6);
				iLocal_1729 = true;
			}
		}
...
void func_222(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		...
		while (iVar0 <= 4)
		{
			if (!does_entity_exist(Local_1202[iVar0 /*19*/]) && !func_224(Local_1202[iVar0 /*19*/].f_10))
			{
				if (iVar0 % 2 == 0)
				{
					Local_1202[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[0], Local_1202[iVar0 /*19*/].f_10, Local_1202[iVar0 /*19*/].f_13, 1, true);
					set_ped_component_variation(Local_1202[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
				}
				else
				{
					Local_1202[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], Local_1202[iVar0 /*19*/].f_10, Local_1202[iVar0 /*19*/].f_13, 1, true);
				}
				if (iVar0 == 0)
				{
					task_patrol(Local_1202[iVar0 /*19*/], "miss_Ass0", 1, 0, 1);
				}
				else if (iVar0 == 1)
				{
					task_patrol(Local_1202[iVar0 /*19*/], "miss_Ass4", 1, 0, 1);
				}
				else if (iVar0 == 2)
				{
					task_guard_current_position(Local_1202[iVar0 /*19*/], 10f, 10f, 1);
				}
				else if (iVar0 == 3)
				{
					task_patrol(Local_1202[iVar0 /*19*/], "miss_Ass6", 1, 0, 1);
				}
				else if (iVar0 == 4)
				{
					task_patrol(Local_1202[iVar0 /*19*/], "miss_Ass3", 1, 0, 1);
				}
				func_223(&Local_1202, iVar0, 0);
				set_entity_load_collision_flag(Local_1202[iVar0 /*19*/], true);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_1202[iVar0 /*19*/], 50, true);
				stop_ped_weapon_firing_when_dropped(Local_1202[iVar0 /*19*/]);
			}
			iVar0++;
		}
	}
	if (iParam0 == 2)
	{
		...
		while (iVar0 <= 2)
		{
			if (!does_entity_exist(Local_1298[iVar0 /*19*/]))
			{
				if (does_entity_exist(iLocal_1970))
				{
					if (is_vehicle_driveable(iLocal_1970, 0))
					{
						if (iVar0 == 0)
						{
							Local_1298[iVar0 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1970, 26, iLocal_1778[0], -1, 1, true);
							set_ped_component_variation(Local_1298[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
						}
						else if (iVar0 == 1)
						{
							Local_1298[iVar0 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1970, 26, iLocal_1778[0], false, 1, true);
							set_ped_component_variation(Local_1298[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
						}
						else if (iVar0 == 2)
						{
							Local_1298[iVar0 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1970, 26, iLocal_1778[1], true, 1, true);
						}
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_1298[iVar0 /*19*/], 3, false);
					}
					func_223(&Local_1298, iVar0, 1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_1298[iVar0 /*19*/], 50, true);
					stop_ped_weapon_firing_when_dropped(Local_1298[iVar0 /*19*/]);
				}
			}
			iVar0++;
		}
	...
	else if (iParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (!does_entity_exist(Local_1356[iVar0 /*19*/]))
			{
				if (iVar0 % 2 == 0)
				{
					Local_1356[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[0], Local_1356[iVar0 /*19*/].f_10, Local_1356[iVar0 /*19*/].f_13, 1, true);
					set_ped_component_variation(Local_1356[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
				}
				else
				{
					Local_1356[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], Local_1356[iVar0 /*19*/].f_10, Local_1356[iVar0 /*19*/].f_13, 1, true);
				}
				func_223(&Local_1356, iVar0, 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_1356[iVar0 /*19*/], 50, true);
				stop_ped_speaking(Local_1356[iVar0 /*19*/], 1);
				if (iVar0 == 0)
				{
					if (!is_ped_injured(Local_1356[iVar0 /*19*/]))
					{
						task_play_anim(Local_1356[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
	...
	else if (iParam0 == 4)
	{
		...
		while (iVar0 <= 1)
		{
			if (!does_entity_exist(Local_1471[iVar0 /*19*/]))
			{
				if (iVar0 % 2 == 0)
				{
					Local_1471[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[0], Local_1471[iVar0 /*19*/].f_10, Local_1471[iVar0 /*19*/].f_13, 1, true);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
					task_aim_gun_at_entity(Local_1471[iVar0 /*19*/], player_ped_id(), -1, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], false, 0, 0, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 2, 0, 0, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 3, 0, 2, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 4, 0, 2, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 11, 1, 0, 0);
				}
				else
				{
					Local_1471[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], Local_1471[iVar0 /*19*/].f_10, Local_1471[iVar0 /*19*/].f_13, 1, true);
					task_aim_gun_at_entity(Local_1471[iVar0 /*19*/], player_ped_id(), -1, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], false, 0, 2, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 3, 0, 0, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 4, 0, 1, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 8, 0, 0, 0);
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 11, 1, 1, 0);
				}
				if (does_entity_exist(iLocal_1787[1]))
				{
					if (iVar0 == 0)
					{
						attach_entity_to_entity(Local_1471[iVar0 /*19*/], iLocal_1787[1], 0, vLocal_1946, 0f, 0f, 84.24f, 0, 0, 0, 0, 2, 1);
						func_360(&uLocal_2005, 4, Local_1471[iVar0 /*19*/], "OJAcsGUARD", 0, 1);
					}
					else if (iVar0 == 1)
					{
						attach_entity_to_entity(Local_1471[iVar0 /*19*/], iLocal_1787[1], 0, -1.34f, -2.36f, -1.34f, 0f, 0f, 84.24f, 0, 0, 0, 0, 2, 1);
						func_360(&uLocal_2005, 5, Local_1471[iVar0 /*19*/], "OJAcsGUARD2", 0, 1);
					}
				}
			}
			func_223(&Local_1471, iVar0, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_1471[iVar0 /*19*/], 50, true);
			iVar0++;
		}
	}
	else if (iParam0 == 5)
		...
		if (!iLocal_1728)
		{
			...
			while (iVar0 <= 4 - iVar1)
			{
				if (!does_entity_exist(Local_1510[iVar0 /*19*/]))
				{
					if (iVar0 % 2 == 0)
					{
						Local_1510[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[0], Local_1510[iVar0 /*19*/].f_10, Local_1510[iVar0 /*19*/].f_13, 1, true);
						set_ped_component_variation(Local_1510[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
					}
					else
					{
						Local_1510[iVar0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], Local_1510[iVar0 /*19*/].f_10, Local_1510[iVar0 /*19*/].f_13, 1, true);
					}
					if (iVar0 == 3)
					{
						task_aim_gun_at_entity(Local_1510[iVar0 /*19*/], player_ped_id(), -1, 1);
						freeze_entity_position(Local_1510[iVar0 /*19*/], true);
					}
					func_223(&Local_1510, iVar0, 1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_1510[iVar0 /*19*/], 50, true);
				}
				iVar0++;
			}
			iLocal_1728 = true;
		...
		while (iVar0 <= 2)
		{
			if (!does_entity_exist(Local_1587[iVar0 /*19*/]))
			{
				if (is_vehicle_driveable(iLocal_1972, 0))
				{
					if (iVar0 == 0)
					{
						Local_1587[iVar0 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1972, 26, iLocal_1778[0], -1, 1, true);
						set_ped_component_variation(Local_1587[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
						give_weapon_to_ped(Local_1587[0 /*19*/], joaat("weapon_assaultrifle"), -1, true, true);
					}
					else if (iVar0 == 1)
					{
						Local_1587[1 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1972, 26, iLocal_1778[1], 2, 1, true);
						give_weapon_to_ped(Local_1587[1 /*19*/], joaat("weapon_carbinerifle"), -1, true, true);
					}
					else if (iVar0 == 2)
					{
						Local_1587[2 /*19*/] = PED::CREATE_PED_inside_vehicle(iLocal_1972, 26, iLocal_1778[0], true, 1, true);
						set_ped_component_variation(Local_1587[iVar0 /*19*/], 3, 0, get_random_int_in_range(1, 4), 0);
						give_weapon_to_ped(Local_1587[2 /*19*/], joaat("weapon_carbinerifle"), -1, true, true);
					}
					set_blocking_of_non_temporary_events(Local_1587[iVar0 /*19*/], true);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_1587[iVar0 /*19*/], 3, false);
					set_ped_combat_movement(Local_1587[iVar0 /*19*/], 2);
					set_ped_accuracy(Local_1587[iVar0 /*19*/], 0);
					PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_1587[iVar0 /*19*/], iLocal_1975);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_1587[iVar0 /*19*/], 50, true);
					PED::SET_PED_CONFIG_FLAG(Local_1587[iVar0 /*19*/], 115, true);
				}
			}
			iVar0++;
		}
...
void func_223(int iParam0, int iParam1, int iParam2)
{
	...
	PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(*iParam0[iParam1 /*19*/], iLocal_1975);
...
void func_225(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_293(get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_286(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_226(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_227(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_227(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_273();
	...
	if (!is_ped_injured(player_ped_id()))
	{
		...
		func_258(player_ped_id());
		func_252(player_ped_id(), 0);
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_251())
		{
			func_245(player_ped_id(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_229(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_230(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_232(auto uParam0, int iParam1, int iParam2)
{
...
void func_237(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_238(int iParam0, auto uParam1)
{
	int iVar0;
...
bool func_240(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_242(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
void func_245(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
int func_248(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2490231[iParam0 /*5*/][func_247(iParam1)];
...
void func_249(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_250(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_253(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!is_ped_injured(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_257(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_254(Var9.f_1)) && iVar70 < 50)
			{
...
int func_256(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_260(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_261(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_262(auto uParam0)
{
	if (!is_entity_dead(player_ped_id(), 0) && !is_ped_injured(player_ped_id()))
	{
		if (func_272())
		{
			*uParam0 = func_268(get_entity_coords(player_ped_id(), 0), 5, -1, 0, 1, -1);
...
int func_264(int iParam0, int iParam1, int iParam2)
{
	...
	else if (network_is_game_in_progress())
	{
		if (func_266() == 0)
		{
			return is_bit_set(func_246(func_265(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_268(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
{
	return shift_right(iParam0, 26) & 31 * func_279(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_283(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_287(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_295()
{
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			clear_help(1);
			set_player_invincible(player_id(), 1);
			clear_area(vLocal_1823, 10f, 1, 0, 0, false);
			clear_help(1);
			settimera(0);
			iLocal_1760++;
			break;
		...
		case 3:
			if (does_entity_exist(iLocal_1787[1]))
			{
				...
				else
				{
					...
					fVar3 = func_298(vVar0.z, 260f, 270.46f, 266f, 0.1f, 0.25f);
					func_191(iLocal_1787[1], 0, 0, fVar3, 1, 1, 1);
					func_297();
				}
			}
			break;
	...
	if (iLocal_1760 >= 3)
	{
		...
		else if (is_screen_faded_out())
		{
			...
			if (iLocal_1728 && iLocal_1729)
			{
				func_177();
				func_296(1, 1);
				set_entity_heading(iLocal_1801, 243.9563f);
				set_gameplay_cam_relative_heading(0f);
				set_gameplay_cam_relative_pitch(0f, 1f);
				func_180(1, 1, 1);
				func_176();
...
void func_296(int iParam0, int iParam1)
{
	...
	if (iParam0)
	{
		if (does_entity_exist(iLocal_1787[1]))
		{
			set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 270.46f, 1, false, 0, 1);
		}
		else
		{
			iLocal_1787[1] = create_object(iLocal_1784, -158.84f, -942.24f, 270.46f, 1, true, false);
			set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 270.46f, 1, false, 0, 1);
			set_entity_rotation(iLocal_1787[1], vLocal_1832[1 /*3*/], 2, 1);
		}
	}
	if (iParam1)
	{
		attach_entity_to_entity(iLocal_1801, iLocal_1787[1], 0, vLocal_1946, 0f, 0f, 269f, 0, 0, 1, 0, 2, 1);
		detach_entity(iLocal_1801, 0, false);
		set_player_control(player_id(), true, 0);
		set_gameplay_cam_relative_heading(0f);
	}
	if (!does_entity_exist(iLocal_1791[1]))
	{
		iLocal_1791[1] = create_object(iLocal_1786, vLocal_1842[1 /*3*/], 1, true, false);
		attach_entity_to_entity(iLocal_1791[1], iLocal_1787[1], 0, vLocal_1913, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_297()
{
	...
	if (!is_entity_dead(player_ped_id(), 0))
	{
		...
		{
			WEAPON::SET_CURRENT_PED_WEAPON(player_ped_id(), iLocal_2174, true);
			get_ammo_in_clip(player_ped_id(), iLocal_2174, &iVar1);
			iVar2 = get_max_ammo_in_clip(player_ped_id(), iLocal_2174, 1);
			iVar3 = get_ammo_in_ped_weapon(player_ped_id(), iLocal_2174);
...
void func_299()
{
	...
	while (iVar0 < 2)
	{
		if (is_ped_injured(Local_1471[iVar0 /*19*/]))
		{
			vVar1 = {get_entity_coords(Local_1471[iVar0 /*19*/], 0)};
			if (get_distance_between_coords(vVar1, vLocal_1823, 1) < 3.25f)
			{
				delete_ped(&(Local_1471[iVar0 /*19*/]));
			}
		}
		iVar0++;
	}
...
void func_300()
{
	...
	if (!iLocal_2003)
	{
		if (func_29(&iLocal_1994))
		{
			if (func_26(&iLocal_1994) >= 12f)
			{
				func_219(3, 20);
				func_219(4, 20);
				iLocal_2003 = 1;
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			if (!does_blip_exist(iLocal_1710))
			{
				iLocal_1710 = add_blip_for_coord(-154.799f, -941.62f, 269.1f);
				set_blip_route(iLocal_1710, false);
				set_blip_name_from_text_file(iLocal_1710, "ASS_CS_TARGET");
			}
			else
			{
				set_blip_coords(iLocal_1710, -154.799f, -941.62f, 269.1f);
			}
			if (iLocal_1763 < 4)
			{
				iLocal_1763 = 4;
		...
		else if (iVar1 == 5)
		{
			if (!iLocal_1724)
			{
				if (func_60(50f) != 0)
				{
					...
					task_combat_ped(iVar0, iLocal_1801, 0, 16);
					iLocal_1724 = 1;
				}
			}
		}
...
void func_301(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1 - 1)
	{
		if (!is_ped_injured(*iParam0[iVar0 /*19*/]))
		{
			...
			task_combat_ped(*iParam0[iVar0 /*19*/], iLocal_1801, 0, 16);
		}
		iVar0++;
	}
}
...
void func_302()
{
	...
	if (!iLocal_1718)
	{
		...
		if (vVar0.z >= 115.5f)
		{
			func_191(iLocal_1787[1], 0, 0, 0.2f, 0, 0, 0);
			if (vVar0.z >= 117.8f)
			{
			}
		}
...
void func_303()
{
	...
	while (iVar0 <= 1)
	{
		if (!is_ped_injured(Local_1471[iVar0 /*19*/]))
		{
			detach_entity(Local_1471[iVar0 /*19*/], 0, false);
			if (iVar0 == 0)
			{
				set_ped_sphere_defensive_area(Local_1471[iVar0 /*19*/], -145.5655f, -941.1028f, 113.2452f, 10f, 0, 0);
			}
			else if (iVar0 == 1)
			{
				set_ped_sphere_defensive_area(Local_1471[iVar0 /*19*/], -152.5679f, -947.0895f, 113.1339f, 10f, 0, 0);
			}
			set_ped_keep_task(Local_1471[iVar0 /*19*/], true);
			...
			task_go_to_coord_while_aiming_at_entity(0, vVar2, iLocal_1801, 2f, false, 0.5f, 0f, true, 0, 0, -957453492, 20000);
			task_combat_ped(false, iLocal_1801, 0, 16);
			close_sequence_task(iVar1);
			task_perform_sequence(Local_1471[iVar0 /*19*/], iVar1);
			clear_sequence_task(&iVar1);
		}
		iVar0++;
	}
...
void func_304(int iParam0)
{
	if (!does_entity_exist(iLocal_1787[1]))
	{
		if (iParam0)
		{
			iLocal_1787[1] = create_object(iLocal_1784, vLocal_1842[1 /*3*/], 1, true, false);
		}
		else
		{
			iLocal_1787[1] = create_object(iLocal_1784, vLocal_1842[1 /*3*/], 1, true, false);
			set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 125.8f, 1, false, 0, 1);
		}
		set_entity_rotation(iLocal_1787[1], vLocal_1832[1 /*3*/], 2, 1);
	}
	else
...
void func_305()
{
	...
	uVar0 = uVar0;
	if (does_entity_exist(iLocal_1787[0]))
	{
		vVar1 = {get_entity_coords(iLocal_1787[0], 1)};
	}
	switch (iLocal_1760)
	{
		case 0:
			...
			set_player_invincible(player_id(), 1);
			clear_area(vLocal_1820, 10f, 1, 0, 0, false);
			settimera(0);
			iLocal_1760++;
			break;
		
		case 1:
			if (func_195(iLocal_1787[0], iLocal_1791[0], 264.1952f))
			{
				iLocal_1760++;
			}
			break;
			...
			if (does_entity_exist(iLocal_1787[0]))
			{
				if (vVar1.z >= 115.4f || iLocal_1721)
				{
					...
					else
					{
						...
						{
							detach_entity(get_vehicle_ped_is_in(iLocal_1801, 0), 0, false);
						}
						settimera(0);
						func_200(&iLocal_1765);
						iLocal_1760++;
				...
				{
					fVar4 = func_298(vVar1.z, 105f, 115.4f, 111f, 0.1f, 0.25f);
					func_191(iLocal_1787[0], 0, 0, fVar4, 1, 1, 1);
					if (vVar1.z >= 113.8f)
					{
						if (!iLocal_1714)
						{
...
void func_306(int iParam0)
{
	...
	if (does_entity_exist(iLocal_1787[0]))
	{
		set_entity_coords(iLocal_1787[0], -182.17f, -1016.09f, 115.46f, 1, false, 0, 1);
	}
	else
	{
		iLocal_1787[0] = create_object(iLocal_1784, -182.17f, -1016.09f, 115.46f, 1, true, false);
		set_entity_coords(iLocal_1787[0], -182.17f, -1016.09f, 115.46f, 1, false, 0, 1);
		set_entity_rotation(iLocal_1787[0], vLocal_1832[0 /*3*/], 2, 1);
		set_entity_load_collision_flag(iLocal_1787[0], true);
	}
	if (!does_entity_exist(iLocal_1791[0]) && does_entity_exist(iLocal_1787[0]))
	{
		iLocal_1791[0] = create_object(iLocal_1786, vLocal_1842[0 /*3*/], 1, true, false);
		attach_entity_to_entity(iLocal_1791[0], iLocal_1787[0], 0, vLocal_1913, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
	if (iParam0)
	{
		attach_entity_to_entity(iLocal_1801, iLocal_1787[0], 0, vLocal_1946, 0f, 0f, 340f, 0, 0, 1, 0, 2, 1);
		detach_entity(iLocal_1801, 0, false);
		set_entity_heading(iLocal_1801, 340.3911f);
		set_player_control(player_id(), true, 0);
		set_gameplay_cam_relative_heading(0f);
	}
}
...
void func_307()
{
	...
	while (iVar0 <= 5)
	{
		if (!is_ped_injured(Local_1356[iVar0 /*19*/]))
		{
			if (get_script_task_status(Local_1356[iVar0 /*19*/], 242628503) != 1)
			{
				if (iVar0 == 0)
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], Local_1356[iVar0 /*19*/].f_10, 10f, 0, 0);
					set_entity_load_collision_flag(Local_1356[iVar0 /*19*/], true);
				}
				else if (iVar0 == 1)
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], Local_1356[iVar0 /*19*/].f_10, 10f, 0, 0);
				...
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], -151.3457f, -948.0886f, 113.1339f, 10f, 0, 0);
				}
				else if (iVar0 == 3)
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], -145.5338f, -986.0398f, 113.1282f, 10f, 0, 0);
				}
				else if (iVar0 == 4)
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], -139.7715f, -968.064f, 113.1339f, 10f, 0, 0);
				}
				else if (iVar0 == 5)
				{
					set_ped_sphere_defensive_area(Local_1356[iVar0 /*19*/], -154.0288f, -960.1566f, 113.1317f, 10f, 0, 0);
				}
				open_sequence_task(&iVar1);
				if (iVar0 == 0)
				{
					task_go_to_coord_while_aiming_at_entity(0, -162.7042f, -999.0336f, 113.1382f, player_ped_id(), 2f, false, 1.5f, 1.5f, false, 0, 0, -957453492, 20000);
				}
				task_combat_ped(false, iLocal_1801, 0, 16);
				close_sequence_task(iVar1);
				task_perform_sequence(Local_1356[iVar0 /*19*/], iVar1);
				clear_sequence_task(&iVar1);
				set_ped_combat_movement(Local_1356[iVar0 /*19*/], 2);
				PED::SET_COMBAT_FLOAT(Local_1356[iVar0 /*19*/], 13, 3f);
				set_ped_keep_task(Local_1356[iVar0 /*19*/], true);
			}
		}
		iVar0++;
	}
...
void func_308()
{
	switch (iLocal_1760)
	{
		case 0:
			...
			if (!does_blip_exist(iLocal_1710))
			{
				iLocal_1710 = add_blip_for_coord(-184.599f, -1015.819f, 254.2567f);
				set_blip_route(iLocal_1710, false);
				set_blip_name_from_text_file(iLocal_1710, "ASS_CS_TARGET");
			}
			iLocal_1760++;
		...
		case 1:
			if (func_203(vLocal_1820) && !func_314())
			{
				func_202();
				if (is_control_just_pressed(0, 51) || is_control_just_pressed(2, 51))
				{
					if (func_201("ASS_CS_ELEHELP"))
					{
						iLocal_1971 = get_players_last_vehicle();
						if (iLocal_1971 != 0)
						{
							if (is_vehicle_driveable(iLocal_1971, 0))
							{
								set_entity_as_mission_entity(iLocal_1971, true, 0);
							}
						}
...
void func_309()
{
	...
	while (iVar0 <= 4)
	{
		if (!is_ped_injured(Local_1202[iVar0 /*19*/]))
		{
			if (iVar0 == 0)
			{
				set_ped_combat_movement(Local_1202[iVar0 /*19*/], 2);
			}
			else if (iVar0 == 1)
			{
				set_ped_combat_movement(Local_1202[iVar0 /*19*/], 2);
			...
			{
				set_ped_sphere_defensive_area(Local_1202[iVar0 /*19*/], Local_1202[iVar0 /*19*/].f_10, 10f, 0, 0);
			}
			else if (iVar0 == 3)
			{
				set_ped_sphere_defensive_area(Local_1202[iVar0 /*19*/], Local_1202[iVar0 /*19*/].f_10, 10f, 0, 0);
			...
			{
				set_ped_sphere_defensive_area(Local_1202[iVar0 /*19*/], -176.2501f, -1026.913f, 26.2752f, 25f, 0, 0);
				set_ped_combat_movement(Local_1202[iVar0 /*19*/], 1);
			}
			if (get_script_task_status(Local_1202[iVar0 /*19*/], -1253019028) == 1)
			{
				_0xF1C03A5352243A30(Local_1202[iVar0 /*19*/]);
				clear_ped_tasks(Local_1202[iVar0 /*19*/]);
			}
			task_combat_ped(Local_1202[iVar0 /*19*/], iLocal_1801, 0, 16);
			set_ped_keep_task(Local_1202[iVar0 /*19*/], true);
		}
		iVar0++;
	}
}
...
void func_310()
{
	...
	if (!iLocal_1735)
	{
		if (does_entity_exist(iLocal_1970) && !is_entity_dead(iLocal_1970, 0))
		{
			vVar0 = {get_entity_coords(iLocal_1970, 1)};
	...
	if (!iLocal_1720)
	{
		if (does_entity_exist(iLocal_1970))
		{
			if (((iLocal_1714 && is_entity_in_angled_area(iLocal_1801, -125.446f, -999.097f, 27.228f, -173.264f, -1095.935f, 27.228f, 98f, 0, false, 0)) || (iLocal_1714 && func_37(iLocal_1970, 1) < 50f)) || (iLocal_1714 && func_33(vLocal_1820, 0) < 50f))
			{
				func_312();
				iLocal_1720 = 1;
			}
...
void func_311()
{
	if (!iLocal_1719)
	{
		if (is_vehicle_driveable(iLocal_1970, 0))
		{
			if (((((!is_waypoint_playback_going_on_for_vehicle(iLocal_1970) || is_ped_injured(get_ped_in_vehicle_seat(iLocal_1970, -1))) || func_34(iLocal_1970, -177.2643f, -1036.083f, 26.2322f, 0) <= 8f) || is_vehicle_stuck_timer_up(iLocal_1970, 0, 3000)) || is_vehicle_stuck_timer_up(iLocal_1970, 2, 3000)) || is_vehicle_stuck_timer_up(iLocal_1970, 3, 3000))
			{
...
void func_312()
{
	...
	if (does_entity_exist(iLocal_1970))
	{
		if (is_vehicle_driveable(iLocal_1970, 0))
		{
			if (!is_waypoint_playback_going_on_for_vehicle(iLocal_1970))
			{
				iVar0 = 0;
				while (iVar0 <= 2)
				{
					if (!is_ped_injured(Local_1298[iVar0 /*19*/]))
					{
						if (Local_1298[iVar0 /*19*/] == get_ped_in_vehicle_seat(iLocal_1970, -1))
						{
							if (!is_audio_scene_active("ASSASSINATION_CONSTRUCT_CAR_ARRIVES"))
							{
								start_audio_scene("ASSASSINATION_CONSTRUCT_CAR_ARRIVES");
							}
							task_vehicle_follow_waypoint_recording(Local_1298[iVar0 /*19*/], iLocal_1970, "OJAScs_101", 52, 0, 0, -1, -1f, 0, 2f);
							set_ped_keep_task(Local_1298[iVar0 /*19*/], true);
							iLocal_1750 = true;
						}
						else
						{
							task_combat_ped(Local_1298[iVar0 /*19*/], iLocal_1801, 0, 16);
							set_ped_keep_task(Local_1298[iVar0 /*19*/], true);
							iLocal_1750 = true;
						}
					}
...
void func_313()
{
	...
	while (iVar1 <= 2)
	{
		if (!is_ped_injured(Local_1298[iVar1 /*19*/]))
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_1298[iVar1 /*19*/], 3, true);
			if (iVar1 != 2)
			{
				set_ped_sphere_defensive_area(Local_1298[iVar1 /*19*/], Local_1202[3 /*19*/].f_10, 10f, 0, 0);
				set_ped_combat_movement(Local_1298[iVar1 /*19*/], 2);
			}
			clear_sequence_task(&iVar0);
			open_sequence_task(&iVar0);
			...
			task_combat_ped(false, iLocal_1801, 0, 16);
			close_sequence_task(iVar0);
			task_perform_sequence(Local_1298[iVar1 /*19*/], iVar0);
			clear_sequence_task(&iVar0);
		}
		iVar1++;
	}
...
void func_315()
{
	iLocal_1787[0] = create_object(iLocal_1784, vLocal_1842[0 /*3*/], 1, true, false);
	set_entity_rotation(iLocal_1787[0], vLocal_1832[0 /*3*/], 2, 1);
	iLocal_1791[0] = create_object(iLocal_1786, vLocal_1842[0 /*3*/], 1, true, false);
	attach_entity_to_entity(iLocal_1791[0], iLocal_1787[0], 0, vLocal_1913, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
...
void func_316()
{
	...
	{
		case 0:
			if ((func_320(5f, 0) && is_srl_loaded()) || ((func_320(1084227584, 1) && func_29(&iLocal_2000)) && func_26(&iLocal_2000) > 15f))
			{
				if (!iLocal_1744)
				{
					iLocal_1768 = _0x2CE544C68FB812A0(-69.7777f, -923.6335f, 28.2933f, 10f, 0f, 0);
					if (!is_entity_dead(player_ped_id(), 0))
					{
						if (is_ped_in_any_vehicle(player_ped_id(), 0))
						{
							iLocal_1973 = get_vehicle_ped_is_in(player_ped_id(), 0);
							if (does_entity_exist(iLocal_1973))
							{
								if (!is_entity_dead(iLocal_1973, 0))
								{
									set_veh_radio_station(iLocal_1973, "OFF");
								}
							}
						}
					}
					...
					if (!is_ped_injured(iLocal_1802))
					{
						...
						task_play_anim(iLocal_1802, "oddjobs@assassinate@construction@", "CS_GetInLift", 1000f, -4f, 9500, 0, 0, 0, 0, 0);
					}
					if (!is_ped_injured(iLocal_1803))
					{
						_0x2208438012482A1A(iLocal_1803, 1, 0);
						task_play_anim(iLocal_1803, "oddjobs@assassinate@construction@", "idle_a", 1000f, -4f, -1, 1, 0, 0, 0, 0);
					...
					if (does_entity_exist(iLocal_1787[1]))
					{
						if (!is_ped_injured(iLocal_1802))
						{
							attach_entity_to_entity(iLocal_1802, iLocal_1787[1], 0, -1.75f, -1.88f, -1.3f, 0f, 0f, 84.2f, 0, 0, 0, 0, 2, 1);
						}
					}
					iLocal_1756 = create_camera_with_params(26379945, -147.5668f, -958.6139f, 114.8839f, -1.648425f, -0.29868f, 24.55094f, 31.35205f, 0, 2);
					iLocal_1757 = create_camera_with_params(26379945, -147.2354f, -957.6655f, 114.8667f, -1.648426f, -0.29868f, 25.52002f, 31.35205f, 0, 2);
					shake_cam(iLocal_1756, "HAND_SHAKE", 0.2f);
					shake_cam(iLocal_1757, "HAND_SHAKE", 0.2f);
					iLocal_1744 = 1;
				}
				else
				{
					...
					set_cam_active_with_interp(iLocal_1757, iLocal_1756, 4800, 0, 1);
		...
		case 1:
			...
			if (timera() >= 4800)
			{
				set_cam_params(iLocal_1756, -152.6485f, -944.8f, 114.2028f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, false, 1, 1, 2);
				set_cam_params(iLocal_1757, -152.7505f, -944.6934f, 114.2089f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, false, 1, 1, 2);
				shake_cam(iLocal_1756, "HAND_SHAKE", 0.2f);
				shake_cam(iLocal_1757, "HAND_SHAKE", 0.2f);
				set_cam_active_with_interp(iLocal_1757, iLocal_1756, 6000, 0, 1);
				iLocal_1760++;
			}
			_0xA76359FC80B2438E(1f);
			break;
		...
		case 2:
			...
			if (timera() >= 7500)
			{
				set_cam_params(iLocal_1756, -165.2002f, -938.0276f, 113.4667f, 4.389886f, 0.213688f, -112.1127f, 32.21227f, false, 1, 1, 2);
				set_cam_params(iLocal_1757, -164.6229f, -937.1241f, 113.4675f, 77.82435f, 0.213692f, -131.0643f, 32.21227f, false, 1, 1, 2);
				shake_cam(iLocal_1756, "HAND_SHAKE", 0.2f);
				shake_cam(iLocal_1757, "HAND_SHAKE", 0.2f);
				set_cam_active_with_interp(iLocal_1757, iLocal_1756, 4250, 1, 1);
				func_200(&iLocal_1765);
				iLocal_1760++;
			}
			_0xA76359FC80B2438E(1f);
		...
		case 3:
			...
			vVar0 = {get_entity_coords(iLocal_1787[1], 1)};
			fVar3 = func_318(vVar0.z, vLocal_1842[1 /*3*/].f_2 + 7.5f, vLocal_1842[1 /*3*/].f_2 + 2.763f, 0.1f, 0.2f);
			func_191(iLocal_1787[1], 0, 0, fVar3, 0, 1, 1);
			break;
		...
		case 4:
			...
			vVar0 = {get_entity_coords(iLocal_1787[1], 1)};
			fVar3 = func_318(vVar0.z, vLocal_1842[1 /*3*/].f_2 + 7.5f, vLocal_1842[1 /*3*/].f_2 + 2.763f, 0.1f, 0.25f);
			func_191(iLocal_1787[1], 0, 0, fVar3, 0, 1, 1);
			break;
		...
		case 5:
			...
			vVar0 = {get_entity_coords(iLocal_1787[1], 1)};
			fVar3 = func_318(vVar0.z, vLocal_1842[1 /*3*/].f_2 + 7.5f, vLocal_1842[1 /*3*/].f_2 + 2.763f, 0.1f, 0.25f);
			func_191(iLocal_1787[1], 0, 0, 0.25f, 0, 1, 1);
			break;
	}
	if (iLocal_1760 >= 2)
	{
...
void func_319(int iParam0)
{
	if (!does_entity_exist(iLocal_1802))
	{
		if (iParam0)
		{
			iLocal_1802 = PED::CREATE_PED(26, iLocal_1778[0], -153.2591f, -941.5044f, 113.1339f, 263f, 1, true);
			set_ped_default_component_variation(iLocal_1802);
			func_360(&uLocal_2005, 3, iLocal_1802, "MAFIABOSS", 0, 1);
			iLocal_1803 = PED::CREATE_PED(26, iLocal_1778[1], -153.6352f, -942.8479f, 113.1339f, 66f, 1, true);
			set_ped_random_component_variation(iLocal_1803, 0);
			give_weapon_to_ped(iLocal_1803, joaat("weapon_smg"), -1, true, true);
		}
		if (!is_ped_injured(iLocal_1803))
		{
...
bool func_320(float fParam0, int iParam1)
{
	int iVar0;
	
	if (((is_ped_in_any_vehicle(player_ped_id(), 0) && func_321(get_vehicle_ped_is_in(player_ped_id(), 0), fParam0, 1, 1056964608, 0, 1, 0)) && !is_entity_in_air(player_ped_id())) || !is_ped_in_any_vehicle(player_ped_id(), 0))
	{
...
bool func_321(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_322()
{
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			if (is_entity_at_coord(player_ped_id(), vLocal_1943, 5f, 5f, 2f, true, true, 0))
			{
			}
			if (func_324(vLocal_1943, 5f) && is_player_ready_for_cutscene(player_id()))
			{
				if (does_blip_exist(iLocal_1709))
				{
					remove_blip(&iLocal_1709);
		...
		case 1:
			if ((is_ped_in_any_vehicle(player_ped_id(), 0) && func_321(get_vehicle_ped_is_in(player_ped_id(), 0), 10f, 1, 1056964608, 0, 1, 0)) || !is_ped_in_any_vehicle(player_ped_id(), 0))
			{
				if (!iLocal_1714)
				{
					func_30(&iLocal_2000);
...
bool func_324(Vector3 vParam0, float fParam1)
{
	if (func_33(vParam0, 1) <= fParam3 && !func_325())
	{
		return true;
	}
	return false;
...
void func_326()
{
	if (!does_entity_exist(Local_1645[0 /*19*/]))
	{
		Local_1645[0 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], -111.9202f, -943.5192f, 28.2288f, 344.7112f, 1, true);
		set_entity_load_collision_flag(Local_1645[0 /*19*/], true);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_1645[0 /*19*/], 50, true);
		stop_ped_weapon_firing_when_dropped(Local_1645[0 /*19*/]);
		func_327(0);
	}
	if (!does_entity_exist(Local_1645[1 /*19*/]))
	{
		Local_1645[1 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], -197.8959f, -1078.97f, 20.6882f, 166.4473f, 1, true);
		set_entity_load_collision_flag(Local_1645[1 /*19*/], true);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_1645[1 /*19*/], 50, true);
		stop_ped_weapon_firing_when_dropped(Local_1645[1 /*19*/]);
		func_327(1);
	}
	if (!does_entity_exist(Local_1645[2 /*19*/]))
	{
		Local_1645[2 /*19*/] = PED::CREATE_PED(26, iLocal_1778[1], -82.0262f, -1023.124f, 27.3748f, 269.8311f, 1, true);
		set_entity_load_collision_flag(Local_1645[2 /*19*/], true);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_1645[2 /*19*/], 50, true);
		stop_ped_weapon_firing_when_dropped(Local_1645[2 /*19*/]);
		func_327(2);
	}
}
...
{
	set_blocking_of_non_temporary_events(Local_1645[iParam0 /*19*/], true);
	give_weapon_to_ped(Local_1645[iParam0 /*19*/], joaat("weapon_microsmg"), -1, false, true);
	set_ped_combat_movement(Local_1645[iParam0 /*19*/], 2);
	set_ped_combat_range(Local_1645[iParam0 /*19*/], 2);
	task_play_anim(Local_1645[iParam0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -4f, -1, 1, 0, 0, 0, 0);
	PED::PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_1645[iParam0 /*19*/], iLocal_1975);
}
...
int func_328()
{
	...
	request_model(iLocal_1778[0]);
	request_model(iLocal_1778[1]);
	if (has_model_loaded(iLocal_1778[0]) && has_model_loaded(iLocal_1778[1]))
	{
		iVar0 = 1;
	}
	else
...
void func_329()
{
	if (!does_entity_exist(iLocal_1974))
	{
		if (!is_entity_dead(player_ped_id(), 0))
		{
			if (is_ped_in_any_vehicle(player_ped_id(), 0))
			{
				iLocal_1974 = get_vehicle_ped_is_in(player_ped_id(), 0);
				if (does_entity_exist(iLocal_1974) && !is_entity_dead(iLocal_1974, 0))
				{
...
void func_331()
{
	...
	if (!does_entity_exist(iLocal_1036))
	{
		return;
	}
	if (!is_entity_dead(player_ped_id(), 0))
	...
	if (vdist2(vVar0, vLocal_1038) > 10000f)
	{
		if (does_entity_exist(iLocal_1036))
		{
			set_model_as_no_longer_needed(-1559354806);
			delete_object(&iLocal_1036);
		}
		if (does_entity_exist(iLocal_1035))
		{
			set_entity_visible(iLocal_1035, true, 0);
			set_entity_collision(iLocal_1035, true, 0);
		}
	}
}
...
void func_332()
{
	...
	{
		case 0:
			if (iLocal_1715 || get_number_of_fires_in_range(vLocal_2175, 10f) > 0)
			{
				iLocal_1033 = 1;
			}
			break;
		...
		case 1:
			if (!func_29(&iLocal_1985))
			{
				func_30(&iLocal_1985);
				if (!is_ped_injured(iLocal_1810))
				{
					func_360(&uLocal_2005, 4, iLocal_1810, "OJAcsGUARD", 0, 1);
					func_58(&uLocal_2005, "OJASAUD", "OJAScs_ALERT", 8, 0, 0, 0);
					if (get_script_task_status(iLocal_1810, -1253019028) == 1)
					{
						_0xF1C03A5352243A30(iLocal_1810);
						clear_ped_tasks(iLocal_1810);
					}
					if (!is_ped_in_any_vehicle(iLocal_1810, 0))
					{
						if (func_38(iLocal_1810, iLocal_1801, 1) > 5f)
						{
							task_go_to_entity_while_aiming_at_entity(iLocal_1810, iLocal_1801, iLocal_1801, 2f, 0, 0.5f, 4f, 1, 0, -957453492);
						}
						else
						{
							task_aim_gun_at_entity(iLocal_1810, iLocal_1801, -1, 0);
						}
					}
				}
			}
			else if (func_26(&iLocal_1985) > 0.25f)
			{
				iLocal_1714 = true;
				iLocal_1033 = 2;
			}
...
bool func_333()
{
	...
	if (!is_entity_dead(iLocal_1801, 0))
	{
		if (((is_entity_in_angled_area(iLocal_1801, -113.319f, -941.315f, -100f, -171.373f, -1095.764f, 100f, 100f, 0, false, 0) || is_entity_in_angled_area(iLocal_1801, vLocal_1929[0 /*3*/], vLocal_1919[0 /*3*/], fLocal_1939[0], 0, true, 0)) || is_entity_in_angled_area(iLocal_1801, vLocal_1929[1 /*3*/], vLocal_1919[1 /*3*/], fLocal_1939[1], 0, true, 0)) || is_entity_in_angled_area(iLocal_1801, vLocal_1929[2 /*3*/], vLocal_1919[2 /*3*/], fLocal_1939[2], 0, true, 0))
		{
			iLocal_1740 = true;
		}
		else
	...
	switch (iLocal_1770)
	{
		case 0:
			...
			while (iVar0 < 3)
			{
				if (!is_ped_injured(Local_1645[iVar0 /*19*/]))
				{
					if (iLocal_1703[iVar0])
					{
						task_play_anim(Local_1645[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 4f, -4f, -1, 1, 0, 0, 0, 0);
						iLocal_1703[iVar0] = 0;
					}
					if (is_entity_in_angled_area(iLocal_1801, vLocal_1929[0 /*3*/], vLocal_1919[0 /*3*/], fLocal_1939[0], 0, true, 0))
					{
						iLocal_1771 = 0;
					}
					else if (is_entity_in_angled_area(iLocal_1801, vLocal_1929[1 /*3*/], vLocal_1919[1 /*3*/], fLocal_1939[1], 0, true, 0))
					{
						iLocal_1771 = 1;
					}
					else if (is_entity_in_angled_area(iLocal_1801, vLocal_1929[2 /*3*/], vLocal_1919[2 /*3*/], fLocal_1939[2], 0, true, 0))
					{
						iLocal_1771 = 2;
					}
					else
					...
					if (iLocal_1771 != -1)
					{
						...
						if (!is_ped_injured(Local_1645[iLocal_1771 /*19*/]))
						{
							task_turn_ped_to_face_entity(Local_1645[iLocal_1771 /*19*/], player_ped_id(), -1);
						}
						iLocal_1770 = 1;
						break;
					}
		...
		case 2:
			if (func_29(&iLocal_1982))
			{
				if (func_26(&iLocal_1982) > IntToFloat(iLocal_1772))
				{
					if (!func_334() && iLocal_1740)
					{
						iLocal_1770 = 3;
					}
					else if (!func_334())
		...
		case 3:
			if (!is_ped_injured(Local_1645[iLocal_1771 /*19*/]))
			{
				...
				if (func_58(&uLocal_2005, "OJASAUD", "OJAScs_WRN2", 9, 0, 0, 0))
				{
					if (!is_ped_injured(Local_1645[iLocal_1771 /*19*/]))
					{
						task_aim_gun_at_entity(Local_1645[iLocal_1771 /*19*/], player_ped_id(), -1, 1);
		...
		case 4:
			if (func_29(&iLocal_1982))
			{
				if (func_26(&iLocal_1982) > IntToFloat(iLocal_1773))
				{
					if (iLocal_1740)
					{
						func_360(&uLocal_2005, 8, Local_1645[iLocal_1771 /*19*/], "OJAScsWARN1", 0, 1);
		...
		case 5:
			...
			while (iVar0 < 3)
			{
				if (!is_ped_injured(Local_1645[iVar0 /*19*/]))
				{
					clear_ped_tasks(Local_1645[iVar0 /*19*/]);
					task_combat_ped(Local_1645[iVar0 /*19*/], player_ped_id(), 0, 16);
				}
				iVar0++;
			}
			iLocal_1714 = true;
...
bool func_335()
{
	...
	while (iVar0 < 3)
	{
		if (!is_entity_dead(Local_1645[iVar0 /*19*/], 0))
		{
...
void func_336()
{
	...
	if (iLocal_1727)
	{
		...
		{
			func_31(&iLocal_1976, Global_101154.f_18653.f_9);
		}
		if (iLocal_1775 == 0)
		{
			func_352();
...
void func_337(int iParam0)
{
	if (!does_blip_exist(iLocal_1709))
	{
		iLocal_1709 = func_339(vLocal_1943, 1);
		set_blip_name_from_text_file(iLocal_1709, "ASS_CS_STATION");
		func_338(&iLocal_1709, -79.8767f, -917.7642f, 28.1898f, 269.6892f);
		if (iParam0)
		{
...
void func_338(int iParam0, Vector3 vParam1, float fParam2)
{
	if (does_blip_exist(*iParam0))
	{
...
int func_339(Vector3 vParam0, int iParam1)
{
	int iVar0;
	
	iVar0 = add_blip_for_coord(vParam0);
	set_blip_scale(iVar0, func_121(network_is_game_in_progress(), 1f, 1f));
...
void func_347()
{
	...
	func_222(3);
	if (!is_ped_injured(Local_1356[0 /*19*/]))
	{
		set_entity_coords(Local_1356[0 /*19*/], -152.2697f, -1003.765f, 113.1382f, 1, false, 0, 1);
	}
	func_307();
	func_306(0);
	...
	_0x2208438012482A1A(iLocal_1801, 1, 0);
	task_put_ped_directly_into_cover(iLocal_1801, -182.1094f, -1004.058f, 113.1362f, -1, false, 0f, false, 0, 0, 0);
	func_342(0, -1, 1);
	set_gameplay_cam_relative_heading(90f);
	set_gameplay_cam_relative_pitch(0f, 1f);
	clear_player_wanted_level(player_id());
...
void func_348()
{
	...
	if (iLocal_2173 != 0)
	{
		give_weapon_to_ped(player_ped_id(), iLocal_2173, false, false, false);
	}
	else
	{
		iLocal_2173 = get_best_ped_weapon(player_ped_id(), 0);
		give_weapon_to_ped(player_ped_id(), iLocal_2173, false, false, false);
	}
}
...
void func_350(int iParam0, int iParam1)
{
	...
	if (!is_ped_injured(player_ped_id()))
	{
		if (has_ped_got_weapon(player_ped_id(), iParam0, 0))
		{
			...
			if (iVar0 < iParam1)
			{
				set_ped_ammo(player_ped_id(), iParam0, iParam1);
			}
		}
		else
		{
			...
			give_weapon_to_ped(player_ped_id(), iParam0, false, false, false);
		}
	}
}
...
void func_353()
{
	...
	{
		iLocal_1776 = 0;
		set_bit(&iLocal_1776, 3);
		set_bit(&iLocal_1776, 4);
		uLocal_2171 = create_pickup(joaat("pickup_parachute"), -140.6149f, -945.9811f, 268.1331f, iLocal_1776, 1, 1, false);
		if (!does_pickup_exist(uLocal_2172))
		{
			uLocal_2172 = create_pickup_rotate(joaat("pickup_parachute"), -149.709f, -966.41f, 269.23f, 87f, 22f, 90f, 0, -1, 2, 1, false);
		}
	}
}
...
void func_354()
{
	if (!does_pickup_exist(uLocal_2170))
	{
		uLocal_2170 = create_pickup_rotate(joaat("pickup_health_standard"), -170.47f, -1016.089f, 114.537f, 0f, 0f, 65f, 0, -1, 2, 1, false);
	}
}
...
{
	int iVar0;
	Vector3[] vVar1 = new Vector3[5];
	float[] fVar17 = new float[5];
	...
	while (iVar0 < 5)
	{
		if (iParam0)
		{
			if (does_entity_exist(iLocal_1795[iVar0]))
			{
				set_object_as_no_longer_needed(&(iLocal_1795[iVar0]));
			}
		}
		else if (!does_entity_exist(iLocal_1795[iVar0]))
		{
			iLocal_1795[iVar0] = create_object(-1951226014, vVar1[iVar0 /*3*/], 1, true, false);
			set_entity_heading(iLocal_1795[iVar0], fVar17[iVar0]);
			freeze_entity_position(iLocal_1795[iVar0], true);
		}
		iVar0++;
	}
}
...
void func_357()
{
	if (!does_entity_exist(iLocal_1969))
	{
		iLocal_1969 = create_vehicle(iLocal_1781, vLocal_1814, fLocal_1758, 1, 1);
	}
	if (!does_entity_exist(iLocal_1970))
	{
		iLocal_1970 = create_vehicle(iLocal_1782, -130.3431f, -1096.441f, 21.3323f, 337f, 1, 1);
		_0x153973AB99FE8980(iLocal_1970, "ASSASSINATION_CONSTRUCT_CAR_GROUP", 0f);
	}
}

void func_358()
{
	iLocal_1756 = create_camera_with_params(26379945, -150.9599f, -944.2627f, 114.3693f, 3.6074f, -0.2888f, 15.6398f, 50f, 0, 2);
	iLocal_1757 = create_camera_with_params(26379945, -150.6499f, -945.0825f, 114.3487f, 1.2634f, -0.2776f, 28.5068f, 50f, 0, 2);
}
...
int func_359()
{
	...
	iVar0 = 0;
	if (((((((((((has_model_loaded(iLocal_1781) && has_model_loaded(iLocal_1782)) && has_model_loaded(iLocal_1783)) && has_model_loaded(iLocal_1784)) && has_model_loaded(-1951226014)) && has_model_loaded(iLocal_1786)) && has_additional_text_loaded(3)) && has_anim_dict_loaded("oddjobs@assassinate@construction@")) && get_is_waypoint_recording_loaded("OJAScs_101")) && has_vehicle_recording_been_loaded(102, "OJAScs")) && SCRIPT::REQUEST_SCRIPT_audio_bank("Freight_Elevator", false)) && SCRIPT::REQUEST_SCRIPT_audio_bank("SCRIPT\ASSASSINATION_MULTI", false))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_360(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (*(uParam0[iParam1 /*10*/]).f_7 == 1)
	{
	}
...
void func_361()
{
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[0 /*3*/], -139.4077f, -993.4732f, 26.2754f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[1 /*3*/], -116.1392f, -987.4984f, 26.38541f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[2 /*3*/], -128.4685f, -979.0341f, 26.2754f, get_random_int_in_range(5000, 10000));
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[3 /*3*/], -138.0908f, -980.1388f, 26.3835f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[4 /*3*/], 0f, 0f, 0f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[5 /*3*/], -150.6753f, -982.7073f, 26.3835f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[6 /*3*/], 0f, 0f, 0f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[7 /*3*/], 0f, 0f, 0f, 0);
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[8 /*3*/], 0f, 0f, 0f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[9 /*3*/], -108.7927f, -1033.771f, 26.2731f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[10 /*3*/], -115.0062f, -1054.933f, 26.2892f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[11 /*3*/], -144.801f, -1043.662f, 26.2912f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[12 /*3*/], -130.3284f, -998.4552f, 26.2731f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[13 /*3*/], -142.5782f, -1008.276f, 26.2731f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[14 /*3*/], -194.7176f, -1062.09f, 21.8847f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[15 /*3*/], -167.7465f, -1038.089f, 26.2798f, 0);
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[16 /*3*/], -194.7176f, -1062.09f, 21.8847f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[17 /*3*/], -194.4449f, -1017.974f, 28.2895f, get_random_int_in_range(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[18 /*3*/], -182.4519f, -1021.044f, 28.2863f, get_random_int_in_range(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 0);
	close_patrol_route();
	create_patrol_route();
...
void func_362()
{
	...
	add_relationship_group("ConstructionEnemies", &iLocal_1975);
...
void func_365()
{
	...
	SCRIPT::REQUEST_SCRIPT_audio_bank("Freight_Elevator", false);
	SCRIPT::REQUEST_SCRIPT_audio_bank("SCRIPT\ASSASSINATION_MULTI", false);
...
void func_367()
{
	switch (iLocal_1034)
	{
		case 0:
			...
			if (iLocal_1062)
			{
				if (does_entity_exist(iLocal_1035))
				{
					...
					if (!func_29(&iLocal_1057))
					{
						func_61(&iLocal_1057);
					}
					if (does_entity_exist(iLocal_1035))
					{
						set_entity_visible(iLocal_1035, false, 0);
						set_entity_collision(iLocal_1035, false, 0);
						set_entity_can_be_damaged(iLocal_1035, 0);
						iLocal_1036 = create_object(-1559354806, 809.3085f, -1074.928f, 27.6018f, 1, true, false);
						set_entity_rotation(iLocal_1036, 0f, 0f, 0.091681f, 2, 1);
						set_entity_collision(iLocal_1036, false, 0);
						set_entity_can_be_damaged(iLocal_1036, 0);
						set_entity_visible(player_ped_id(), true, 0);
					}
					iLocal_1201 = _0x219C7B8D53E429FD(809.3085f, -1074.928f, 27.6018f, 350f, 12, 127);
					func_182(1, 1, 1, 0);
					if (!is_entity_dead(player_ped_id(), 0))
					{
						_0x2208438012482A1A(player_ped_id(), 0, 0);
						set_entity_coords(player_ped_id(), vLocal_1041, 1, false, 0, 1);
						set_entity_heading(player_ped_id(), fLocal_1044);
						WEAPON::SET_CURRENT_PED_WEAPON(player_ped_id(), joaat("weapon_unarmed"), true);
						remove_ped_helmet(player_ped_id(), 1);
					}
					iLocal_1074 = create_synchronized_scene(vLocal_1068, vLocal_1071, 2);
					if (does_entity_exist(iLocal_1036))
					{
						attach_synchronized_scene_to_entity(iLocal_1074, iLocal_1036, -1);
					}
					task_synchronized_scene(player_ped_id(), iLocal_1074, "oddjobs@assassinate@construction@call", "ass_construction_call_p1", 1000f, -2f, 2, 0, 1000f, 0);
					play_synchronized_entity_anim(iLocal_1036, iLocal_1074, "ass_construction_call_phone", "oddjobs@assassinate@construction@call", 1000f, -2f, 0, 1000f);
					remove_particle_fx_in_range(vLocal_1041, 5f);
					if (!does_cam_exist(iLocal_1037))
					{
						iLocal_1037 = create_camera_with_params(26379945, vLocal_1048, vLocal_1051, 34.0542f, 1, 2);
						render_script_cams(true, false, 3000, 1, 0, 0);
						shake_cam(iLocal_1037, "HAND_SHAKE", 0.2f);
					}
					func_360(&uLocal_2005, 3, 0, "LESTER", 0, 1);
					func_360(&uLocal_2005, 1, player_ped_id(), "FRANKLIN", 0, 1);
					display_radar(false);
					display_hud(false);
				...
				else
				{
					...
					if (!does_entity_exist(iLocal_1035))
					{
						iLocal_1035 = get_closest_object_of_type(vLocal_1038, 5f, 1281992692, 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			func_369();
			if (func_29(&iLocal_1054))
			{
				if (func_26(&iLocal_1054) > 1f)
				{
					if (func_179())
					{
						iLocal_1060 = true;
			...
			if (!iLocal_1061)
			{
				if (!is_entity_dead(player_ped_id(), 0))
				{
					if (is_synchronized_scene_running(iLocal_1074))
					{
						if (get_synchronized_scene_phase(iLocal_1074) > 0.05f)
						{
			...
			if (func_29(&iLocal_1054))
			{
				if ((func_26(&iLocal_1054) > fLocal_1045 || (is_synchronized_scene_running(iLocal_1074) && get_synchronized_scene_phase(iLocal_1074) >= 0.961f)) || iLocal_1060)
				{
					iLocal_1034 = 3;
				}
			}
		...
		case 2:
			...
			if (iLocal_1060)
			{
				if (is_screen_faded_out())
				{
					...
					stop_synchronized_entity_anim(iLocal_1036, -1000f, 1);
					wait(0);
		...
		case 3:
			...
			if (_0x07C313F94746702C(iLocal_1201))
			{
				_0x1EE7D8DF4425F053(iLocal_1201);
			}
			set_entity_collision(iLocal_1036, true, 0);
			display_radar(true);
			display_hud(true);
			clear_ped_tasks(player_ped_id());
			set_player_control(player_id(), true, 0);
			...
			set_object_as_no_longer_needed(&iLocal_1035);
			iLocal_1030 = 4;
			break;
	}
}
...
void func_369()
{
	...
	{
		case 0:
			if (func_370(&iLocal_1037, 4f, 799.7321f, -1083.417f, 30.3753f, -1.3455f, 0f, -42.1124f, 42.5517f, 1, 0.3f))
			{
				iLocal_1076 = 1;
			}
			break;
		...
		case 1:
			if (func_370(&iLocal_1037, 11f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.3f))
			{
				iLocal_1076 = 2;
			}
			break;
		...
		case 2:
			if (func_370(&iLocal_1037, 20f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.3f))
			{
				iLocal_1076 = 3;
			}
			break;
		...
		case 3:
			if (func_370(&iLocal_1037, 25f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.2f))
			{
				iLocal_1076 = 4;
			}
			break;
		...
		case 4:
			if (func_370(&iLocal_1037, 30f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.2f))
			{
				iLocal_1076 = 5;
			}
			break;
		...
		case 5:
			if (func_370(&iLocal_1037, 37f, 812.5805f, -1076.648f, 28.9375f, 2.1171f, 0.0247f, 79.0055f, 29.2734f, 1, 0.2f))
			{
				iLocal_1076 = 6;
			}
			break;
...
bool func_370(int iParam0, float fParam1, Vector3 vParam2, Vector3 vParam3, float fParam4, int iParam5, float fParam6)
{
	if (does_cam_exist(*iParam0))
	{
		if (func_29(&iLocal_1057))
		{
			if (func_26(&iLocal_1057) >= fParam1)
			{
				set_cam_coord(iLocal_1037, vParam2);
				set_cam_rot(iLocal_1037, vParam5, 2);
				set_cam_fov(iLocal_1037, fParam8);
				if (iParam9)
				{
					shake_cam(iLocal_1037, "HAND_SHAKE", fParam10);
				}
				return true;
			}
		}
...
void func_371(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_372(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_372(Vector3 vParam0, Vector3 vParam1, float fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (does_entity_exist(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_373(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_373(int iParam0, Vector3 vParam1, Vector3 vParam2, float fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_375(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_374(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_374(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_374(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_374(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_374(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_374(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_374(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_374(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_374(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_374(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_374(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_374(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_374(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_374(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_374(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_374(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_374(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_378()
{
	if (iLocal_2178 > 0)
	{
		if (get_number_of_fires_in_range(vLocal_2175, 5f) > 0)
		{
			if (is_vehicle_driveable(iLocal_1969, 0))
			{
				if (get_vehicle_petrol_tank_health(iLocal_1969) > 499f)
				{
					set_vehicle_petrol_tank_health(iLocal_1969, 499f);
				}
			}
		}
	}
	switch (iLocal_2178)
	{
		case 0:
			if (func_33(vLocal_2175, 0) < 100f)
			{
				if (is_vehicle_driveable(iLocal_1969, 0))
				{
					set_entity_proofs(iLocal_1969, false, false, false, false, false, false, 0, false);
					_0x192547247864DFDD(iLocal_1969, true);
					set_disable_vehicle_petrol_tank_fires(iLocal_1969, 0);
				}
				add_petrol_decal(vLocal_2175, 1.5f, 2f, 1f);
				iLocal_2178++;
			}
			break;
		
		case 1:
			add_petrol_decal(vLocal_2175 + Vector(0f, 0.35f, 0.25f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 2:
			add_petrol_decal(vLocal_2175 + Vector(0f, 0.7f, 0.5f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 3:
			add_petrol_decal(vLocal_2175 + Vector(0f, 1.05f, 0.75f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 4:
			add_petrol_decal(vLocal_2175 + Vector(0f, 1.4f, 1f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 5:
			add_petrol_decal(vLocal_2175 + Vector(0f, 1.75f, 1.25f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 6:
			add_petrol_decal(vLocal_2175 + Vector(0f, 2.15f, 1.5f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 7:
			add_petrol_decal(vLocal_2175 + Vector(0f, 2.4f, 1.8f), 1.5f, 2f, 1f);
			iLocal_2178++;
			break;
		
		case 8:
			_0x99AC7F0D8B9C893D(1f);
			_0x967278682CB6967A(vLocal_2175, 1f);
			iLocal_2178++;
			break;
		
		case 9:
			_0x967278682CB6967A(vLocal_2175 + Vector(0f, 0.7f, 0.5f), 1f);
			iLocal_2178++;
			break;
		
		case 10:
			_0x967278682CB6967A(vLocal_2175 + Vector(0f, 1.4f, 1f), 1f);
			iLocal_2178++;
			break;
		
		case 11:
			_0x967278682CB6967A(vLocal_2175 + Vector(0f, 2.15f, 1.5f), 1f);
			iLocal_2178++;
			break;
	...
	switch (iLocal_1774)
	{
		case 0:
			if (!is_ped_injured(player_ped_id()))
			{
				...
				if (((is_ped_in_any_heli(player_ped_id()) || is_ped_in_any_plane(player_ped_id())) || iVar4) || is_entity_in_angled_area(iLocal_1801, -117.225f, -977.2565f, 200.1625f, -135.9228f, -971.2293f, 268.8807f, 11f, 0, true, 0))
				{
					fVar3 = vdist2(vVar0, vLocal_1829);
		...
		case 1:
			if (iLocal_1742)
			{
				...
				if (does_entity_exist(iLocal_1970))
				{
					_0x18EB48CFC41F2EA0(iLocal_1970, 0f);
				}
				iLocal_1760 = 0;
				iLocal_1030 = 13;
				iLocal_1774 = 2;
...
void func_382(Vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_433())
	{
...
int func_383(Vector3 vParam0, Vector3 fParam1)
{
	return func_384(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_384(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_423(uParam0))
	{
		...
		if (func_422(uParam0))
		{
			...
			if (does_entity_exist(iVar0))
			{
				...
				else if ((!func_408(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
{
	if ((((((((((!does_entity_exist(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_243(iParam0, 0, 0)) || func_243(iParam0, 1, 0)) || func_243(iParam0, 2, 0)) || func_234(iParam0) != 145) || func_398(iParam0)) || func_397(iParam0)) || func_396(iParam0)) || func_395(iParam0)) || !func_387(get_entity_model(iParam0)))
	{
		if (func_397(iParam0))
		{
		}
...
void func_403(auto uParam0, auto uParam1)
{
...
int func_406(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
bool func_408(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_410(iParam0, uVar1[iVar6], 1) && func_409(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_23(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_409(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_411(int iParam0, auto uParam1)
{
	int iVar0;
...
void func_412(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (does_entity_exist(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || get_entity_model(Global_88942[iVar0]) == func_236(iParam0, iParam1))
				{
...
void func_413(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_239(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_239(iVar1 + 1)))
			{
			}
			else
			{
				set_bit(uParam1.f_77, func_239(iVar1 + 1));
			}
		}
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_420(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_419())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_239(iVar2 + 1)))
				{
...
bool func_414(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_417(get_entity_model(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_416(*iParam0, *uParam1[38] - 1))
	{
...
void func_421(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_430()
{
	...
	iVar0 = func_79(Global_101154.f_18653.f_1, 4096);
...
void func_434()
{
	...
	func_439();
	end_srl();
	_0x1033371FC8E842A7(iLocal_1768);
	func_197(&Local_1202, 5);
	func_197(&Local_1298, 3);
	func_197(&Local_1356, 6);
	func_197(&Local_1471, 2);
	...
	set_model_as_no_longer_needed(iLocal_1778[0]);
	set_model_as_no_longer_needed(iLocal_1778[1]);
	set_model_as_no_longer_needed(iLocal_1783);
	...
	if (does_entity_exist(iLocal_1787[0]))
	{
		if (is_entity_attached_to_entity(iLocal_1801, iLocal_1787[0]))
		{
			detach_entity(iLocal_1801, 1, true);
		}
	}
	...
	remove_decals_in_range(vLocal_2175, 10f);
	if (does_entity_exist(iLocal_1035))
	{
		set_entity_visible(iLocal_1035, true, 0);
		set_entity_collision(iLocal_1035, true, 0);
		set_entity_can_be_damaged(iLocal_1035, 1);
	}
...
void func_435()
{
	...
	if (does_entity_exist(iLocal_1972))
	{
		_0x18EB48CFC41F2EA0(iLocal_1972, 0f);
	}
	if (is_audio_scene_active("ASSASSINATION_CONSTRUCT_CUTSCENE"))
	{
		stop_audio_scene("ASSASSINATION_CONSTRUCT_CUTSCENE");
...
void func_436()
{
	if (does_entity_exist(iLocal_1969))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1969);
	}
	if (does_entity_exist(iLocal_1972))
	{
		set_vehicle_as_no_longer_needed(&iLocal_1972);
...
void func_437()
{
	if (does_entity_exist(iLocal_1972))
	{
		if (is_entity_occluded(iLocal_1972))
		{
			delete_vehicle(&iLocal_1972);
		}
		else
		{
			set_vehicle_as_no_longer_needed(&iLocal_1972);
	...
	if (does_entity_exist(iLocal_1802))
	{
		if (is_entity_occluded(iLocal_1802))
		{
			delete_ped(&iLocal_1802);
		}
		else
...
void func_438()
{
	if (does_entity_exist(uLocal_1805[0]))
	{
		delete_ped(&(uLocal_1805[0]));
	}
	if (does_entity_exist(uLocal_1805[1]))
	{
		delete_ped(&(uLocal_1805[1]));
	}
}
...
void func_443(auto uParam0, int iParam1)
{
	func_444(uParam0, iParam1);
}

void func_444(auto uParam0, auto uParam1)
{
