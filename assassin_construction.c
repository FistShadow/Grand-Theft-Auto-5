...
void func_365()
{
	...
	AUDIO::REQUEST_SCRIPT_AUDIO_BANK("Freight_Elevator", false);
...
void func_413(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		else if (*uParam1.f_66 == joaat("sandking") || *uParam1.f_66 == joaat("sandking2"))
		{
			...
			{
				GAMEPLAY::SET_BIT(uParam1.f_77, func_239(iVar1 + 1));
			}
		}
