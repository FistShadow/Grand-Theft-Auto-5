	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (is_ped_in_any_vehicle(iParam0, 0))
			{
				...
				if (fVar1 > fParam1)
				{
					if (!is_entity_on_screen(iVar0) || ENTITY::IS_ENTITY_OCCLUDED(iVar0))
					{
						return true;
					}
					else if (fParam2 != 0f)
			...
			{
				if (!is_entity_on_screen(iParam0) || ENTITY::IS_ENTITY_OCCLUDED(iParam0))
				{
					return true;
				}
			}
...
void func_59(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (WEAPON::IS_PED_ARMED(iLocal_1801, 6) && !is_ped_in_any_vehicle(iLocal_1801, 0))
		{
...
int func_60(float fParam0)
{
	...
	if (iLocal_1030 < 10)
	{
		...
		while (iVar4 <= 4)
		{
			...
			{
				fVar6 = vdist2(vVar1, ENTITY::GET_ENTITY_COORDS(Local_1202[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else if (iLocal_1030 < 12)
	{
		...
		while (iVar4 <= 5)
		{
			...
			{
				fVar6 = vdist2(vVar1, ENTITY::GET_ENTITY_COORDS(Local_1356[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else
	{
		...
		while (iVar4 <= 3)
		{
			...
			{
				fVar6 = vdist2(vVar1, ENTITY::GET_ENTITY_COORDS(Local_1510[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
			...
			if (!is_message_being_displayed())
			{
				switch (iLocal_1759)
				{
					...
					case 1:
						if (iLocal_1762 >= 2)
						{
							if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1802) || (!ENTITY::IS_ENTITY_DEAD(iLocal_1802, 0) && iLocal_1030 < 13))
							{
...
void func_170(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1 - 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0[iVar0 /*19*/]))
		{
			if (!PED::IS_PED_INJURED(*iParam0[iVar0 /*19*/]))
			{
				if (ENTITY::IS_ENTITY_OCCLUDED(*iParam0[iVar0 /*19*/]) || !is_entity_on_screen(*iParam0[iVar0 /*19*/]))
				{
					if (!PED::IS_PED_INJURED(*iParam0[iVar0 /*19*/]))
					{
						ENTITY::SET_ENTITY_HEALTH(*iParam0[iVar0 /*19*/], false);
					}
				}
				else
				{
...
void func_175()
{
	...
	switch (iLocal_1769)
	{
		...
		case 2:
			...
			{
				func_200(&iLocal_1765);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_1801, false);
				display_radar(false);
				display_hud(false);
				iLocal_1769++;
			}
		...
		case 3:
			...
			{
				vVar0 = {ENTITY::GET_ENTITY_COORDS(iLocal_1787[1], 1)};
				if (vVar0.z <= 32f)
				{
...
void func_194(int iParam0)
{
	...
	else
	{
		...
		set_entity_coords(iLocal_1787[1], -158.84f, -942.24f, 31.44f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_ROTATION(iLocal_1787[1], vLocal_1832[1 /*3*/], 2, 1);
	}
	if (iVar0 == 0)
	{
...
bool func_195(int iParam0, auto uParam1, float fParam2)
{
	...
	switch (iLocal_1761)
	{
		...
		case 4:
			vVar0 = {get_offset_from_entity_given_world_coords(iParam0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))};
			vVar0.z = -1.333402f;
...
{
	if ((((((func_34(iLocal_1801, vParam0, 1) <= 1.65f && !is_entity_in_air(iLocal_1801)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && func_60(3f) == 0) && !func_204()) && !is_ped_jumping(iLocal_1801)) && !is_ped_in_any_vehicle(iLocal_1801, 0))
	{
		return true;
	}
	return false;
...
void func_208()
{
	switch (iLocal_1760)
	{
		case 0:
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_1972, 0) && !ENTITY::IS_ENTITY_DEAD(get_ped_in_vehicle_seat(iLocal_1972, -1), 0))
				{
...
void func_210()
{
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			func_222(5);
			func_221(0);
			if ((!ENTITY::IS_ENTITY_DEAD(iLocal_1802, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_1972, 0)) && !is_ped_in_vehicle(iLocal_1802, iLocal_1972, 0))
			{
...
void func_211()
{
	if (!iLocal_1733)
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1510[3 /*19*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_INJURED(Local_1510[3 /*19*/]))
			{
				...
				ENTITY::SET_ENTITY_HEALTH(Local_1510[3 /*19*/], false);
				iLocal_1733 = 1;
			}
		}
	}
	if (!iLocal_1734)
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_1510[3 /*19*/], 0))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(Local_1510[3 /*19*/], vLocal_1811, 5f, 5f, 5f, false, true, 0))
				{
	...
	switch (iLocal_1767)
	{
			...
			if (iLocal_1751)
			{
				if (!PED::IS_PED_INJURED(Local_1510[3 /*19*/]))
				{
					if (!is_entity_waiting_for_world_collision(Local_1510[3 /*19*/]))
					{
						...
						ENTITY::FREEZE_ENTITY_POSITION(Local_1510[3 /*19*/], false);
						if (AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 167901368) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 167901368) != 0)
						{
							task_shoot_at_entity(Local_1510[3 /*19*/], iLocal_1801, -1, -957453492);
						}
					}
				}
				iLocal_1764 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000);
		...
		case 1:
			if (!PED::IS_PED_INJURED(Local_1510[3 /*19*/]))
			{
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_1510[3 /*19*/], vLocal_1811, 2f, 2f, 2f, false, true, 0))
					{
						if (AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 2106541073) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 2106541073) != 0)
						{
							task_go_straight_to_coord(Local_1510[3 /*19*/], vLocal_1811, 2f, 20000, 40000f, 0.5f);
						}
					}
					else if (AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 167901368) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_1510[3 /*19*/], 167901368) != 0)
					{
						task_shoot_at_entity(Local_1510[3 /*19*/], iLocal_1801, -1, -957453492);
					}
				}
		...
		while (iVar0 <= 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_1202[iVar0 /*19*/]) && !func_224(Local_1202[iVar0 /*19*/].f_10))
			{
				if (iVar0 % 2 == 0)
				{
					...
					set_ped_component_variation(Local_1202[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
				}
				else
				{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1970))
				{
					if (is_vehicle_driveable(iLocal_1970, 0))
					{
						if (iVar0 == 0)
						{
							...
							set_ped_component_variation(Local_1298[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
						}
						else if (iVar0 == 1)
						{
		...
		while (iVar0 <= 5)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_1356[iVar0 /*19*/]))
			{
				if (iVar0 % 2 == 0)
				{
					...
					set_ped_component_variation(Local_1356[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
				}
				else
				{
				...
				if (iVar0 == 0)
				{
					if (!PED::IS_PED_INJURED(Local_1356[iVar0 /*19*/]))
					{
						AI::TASK_PLAY_ANIM(Local_1356[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
		...
		while (iVar0 <= 1)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_1471[iVar0 /*19*/]))
			{
				if (iVar0 % 2 == 0)
				{
					...
					set_ped_component_variation(Local_1471[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
			...
			while (iVar0 <= 4 - iVar1)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Local_1510[iVar0 /*19*/]))
				{
					if (iVar0 % 2 == 0)
					{
						...
						set_ped_component_variation(Local_1510[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
					}
					else
					{
					...
					if (iVar0 == 3)
					{
						...
						ENTITY::FREEZE_ENTITY_POSITION(Local_1510[iVar0 /*19*/], true);
					}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(Local_1587[iVar0 /*19*/]))
			{
				if (is_vehicle_driveable(iLocal_1972, 0))
				{
					if (iVar0 == 0)
					{
						...
						set_ped_component_variation(Local_1587[iVar0 /*19*/], 3, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
...
bool func_262(auto uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_272())
		{
			*uParam0 = func_268(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
void func_305()
{
	...
	{
		vVar1 = {ENTITY::GET_ENTITY_COORDS(iLocal_1787[0], 1)};
	}
	switch (iLocal_1760)
	{
		case 0:
...
void func_306(int iParam0)
{
	...
	else
	{
		...
		set_entity_coords(iLocal_1787[0], -182.17f, -1016.09f, 115.46f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_ROTATION(iLocal_1787[0], vLocal_1832[0 /*3*/], 2, 1);
			...
			if ((func_320(5f, 0) && is_srl_loaded()) || ((func_320(1084227584, 1) && func_29(&iLocal_2000)) && func_26(&iLocal_2000) > 15f))
			{
				if (!iLocal_1744)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_1802))
					{
						...
						AI::TASK_PLAY_ANIM(iLocal_1802, "oddjobs@assassinate@construction@", "CS_GetInLift", 1000f, -4f, 9500, 0, 0, 0, 0, 0);
					}
...
void func_322()
{
	...
	switch (iLocal_1760)
	{
		case 0:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_1943, 5f, 5f, 2f, true, true, 0))
			{
			}
...
void func_327(int iParam0)
{
	...
	AI::TASK_PLAY_ANIM(Local_1645[iParam0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -4f, -1, 1, 0, 0, 0, 0);
		...
		case 0:
			...
			while (iVar0 < 3)
			{
				if (!PED::IS_PED_INJURED(Local_1645[iVar0 /*19*/]))
				{
					...
					{
						AI::TASK_PLAY_ANIM(Local_1645[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 4f, -4f, -1, 1, 0, 0, 0, 0);
						iLocal_1703[iVar0] = 0;
					}
...
void func_355(int iParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1795[iVar0]))
		{
			...
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_1795[iVar0], true);
		}
		iVar0++;
	}
}
...
void func_361()
{
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[0 /*3*/], -139.4077f, -993.4732f, 26.2754f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[1 /*3*/], -116.1392f, -987.4984f, 26.38541f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[2 /*3*/], -128.4685f, -979.0341f, 26.2754f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[3 /*3*/], -138.0908f, -980.1388f, 26.3835f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[4 /*3*/], 0f, 0f, 0f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[5 /*3*/], -150.6753f, -982.7073f, 26.3835f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[6 /*3*/], 0f, 0f, 0f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[7 /*3*/], 0f, 0f, 0f, 0);
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[8 /*3*/], 0f, 0f, 0f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[9 /*3*/], -108.7927f, -1033.771f, 26.2731f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[10 /*3*/], -115.0062f, -1054.933f, 26.2892f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[11 /*3*/], -144.801f, -1043.662f, 26.2912f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[12 /*3*/], -130.3284f, -998.4552f, 26.2731f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[13 /*3*/], -142.5782f, -1008.276f, 26.2731f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[14 /*3*/], -194.7176f, -1062.09f, 21.8847f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[15 /*3*/], -167.7465f, -1038.089f, 26.2798f, 0);
	add_patrol_route_node(2, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[16 /*3*/], -194.7176f, -1062.09f, 21.8847f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 2);
	add_patrol_route_link(2, 0);
	close_patrol_route();
	...
	add_patrol_route_node(0, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[17 /*3*/], -194.4449f, -1017.974f, 28.2895f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_node(1, "WORLD_HUMAN_GUARD_STAND", vLocal_1849[18 /*3*/], -182.4519f, -1021.044f, 28.2863f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	add_patrol_route_link(0, 1);
	add_patrol_route_link(1, 0);
	close_patrol_route();
	create_patrol_route();
	...
	switch (iLocal_2178)
	{
		case 0:
			if (func_33(vLocal_2175, 0) < 100f)
			{
				if (is_vehicle_driveable(iLocal_1969, 0))
				{
					ENTITY::SET_ENTITY_PROOFS(iLocal_1969, false, false, false, false, false, false, 0, false);
	...
	if (func_423(uParam0))
	{
		...
		if (func_422(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_408(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(get_this_script_name(), "startup_positioning"))
				{
