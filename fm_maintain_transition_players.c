#region Local Var
	...
	int iLocal_216 = 0;
	int iLocal_217 = 0;
	var[] uLocal_218 = new var[4];
	struct<122> Local_223 = 0;
	auto uLocal_345 = 0;
	auto uLocal_346 = 0;
	auto uLocal_347 = 0;
	struct<19>[] Local_348 = new struct<19>[32];
	struct<17> Local_957 = 0;
	int iLocal_974 = 0;
	int[] iLocal_975 = new int[8];
	int[] iLocal_984 = new int[8];
	int[] iLocal_993 = new int[8];
	int iLocal_1002 = 0;
	int iLocal_1003 = 0;
	int iLocal_1004 = 0;
	int iLocal_1005 = 0;
	int[] iLocal_1006 = new int[32];
	int iLocal_1039 = 0;
	int iLocal_1040 = 0;
	int iLocal_1041 = 0;
	auto uLocal_1042 = 0;
...
void main()
{
	...
	func_488();
	func_487();
	if (Local_1048.f_14 == 0 && !func_486())
	{
		if (!func_483(&Local_1048))
		{
		}
		else
		{
			func_454(Local_1048, Local_1048.f_1, Local_1048.f_11, &(Local_1048.f_8), Local_1048.f_5, Local_1048.f_4, Local_1048.f_3, &(Local_957.f_10), &(Local_957.f_8), 0, 0);
			Local_957.f_13 = 1;
		}
	}
	func_448(&Local_1048);
	...
	while (true)
	{
		...
		if (Local_957.f_8 == 1)
		{
			if (!is_player_switch_in_progress() && !func_440(player_id()))
			{
				Local_957.f_8 = 0;
				func_439(Local_957.f_10);
			}
		}
		if (Local_1048.f_3 && !func_438())
		{
		...
		if ((Local_1048.f_14 == 0 && !func_435()) && !func_486())
		{
			if (!Local_957.f_16)
			{
				if (func_433())
		...
		if (func_421() && !func_420())
		{
			if (func_419())
			{
				if (!func_438() && !Local_1048.f_3)
				{
					if (func_433())
					{
						if (!Local_957.f_13)
						{
							func_454(Local_1048, Local_1048.f_1, Local_1048.f_11, &uVar0, Local_1048.f_5, 1, Local_1048.f_3, &(Local_957.f_10), &(Local_957.f_8), 0, 0);
							Local_957.f_13 = 1;
							Local_957.f_5 = 0;
						}
		...
		if (func_332())
		{
			if (!Local_957.f_16)
			{
				if (!Local_957.f_4)
				{
					...
					func_454(Local_1048, Local_1048.f_1, Local_1048.f_11, &(Local_1048.f_8), Local_1048.f_5, Local_1048.f_4, Local_1048.f_3, &(Local_957.f_10), &(Local_957.f_8), 1, 1);
					Local_957.f_4 = 1;
					Local_957.f_5 = 0;
				}
				else if (Local_957.f_5 == 0)
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_119(&Local_1048);
			func_105(Local_1048, &Local_1048);
			...
			switch (Local_223)
			{
				...
				case 1:
					if (func_67(&Local_223))
					{
						...
						{
							if ((Global_2434762.f_546.f_9 != 0 && iLocal_217) || GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 14))
							{
								Global_1609227[player_id() /*34*/] = Global_1617379.f_25;
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_223.f_119), false);
						func_72(&Local_223, 4);
					}
					break;
		...
		{
			set_clock_time(iLocal_1045, iLocal_1046, iLocal_1047);
			if (func_11())
			{
				if (iLocal_1041 == 0)
				{
					func_9(0);
					func_6(Local_1048.f_3);
					iLocal_1041 = 1;
				}
				if (func_5())
				{
				...
				if (!func_445())
				{
					if (Local_1048.f_14)
					{
						set_clock_time(Global_1715013.f_8, false, false);
					}
				}
			}
			else
...
int func_5()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 12);
}
...
bool func_12(int iParam0, auto uParam1)
{
	if (!func_16(iParam0))
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(iParam0.f_119, false);
		return true;
	}
	if (!GAMEPLAY::IS_BIT_SET(*iParam0.f_119, false))
	{
...
bool func_13(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < Global_2435528.f_1.f_2804)
			{
				if (*iParam0.f_12[iVar0] == -1)
				{
					...
					if (iVar2 >= 0)
					{
						...
						{
							*iParam0.f_12[iVar0] = Local_957;
							*iParam0.f_12[iVar2] = Local_957;
							Local_957++;
						}
					}
				}
...
void func_19()
{
	...
	{
		iVar1 += Global_1617379.f_32[iVar0];
...
bool func_20(int iParam0, auto uParam1, int iParam2)
{
...
bool func_21(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 4:
			if (func_40(uParam0))
			{
				if (!func_35(uParam0, uParam2))
				{
					...
					if (iVar3 != -1)
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1004, iVar3);
...
int func_23(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(auto uParam0, int iParam1)
{
		...
		if (iParam1 != *(uParam0[iVar0 /*19*/]).f_1)
		{
			...
			while (iVar1 < Global_2435528.f_1.f_2804)
			{
				if (iVar0 != iVar1 && iParam1 != *(uParam0[iVar1 /*19*/]).f_1)
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1002, iVar0);
					}
					else if (iLocal_1006[iVar0] == iLocal_1006[iVar1])
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1003, iVar0);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < Global_2435528.f_1.f_2804)
	{
		if ((!GAMEPLAY::IS_BIT_SET(iLocal_1002, iVar0) && iParam1 != *(uParam0[iVar0 /*19*/]).f_1) && !GAMEPLAY::IS_BIT_SET(iLocal_1004, iVar0))
		{
			return iVar0;
		}
		iVar0++;
	...
	if (iVar2 == -1)
	{
		...
		while (iVar0 < Global_2435528.f_1.f_2804)
		{
			if (((GAMEPLAY::IS_BIT_SET(iLocal_1003, iVar0) && iParam1 != *(uParam0[iVar0 /*19*/]).f_1) && !GAMEPLAY::IS_BIT_SET(iLocal_1004, iVar0)) && GAMEPLAY::IS_BIT_SET(iLocal_1005, iVar0))
			{
				return iVar0;
			}
			iVar0++;
	...
	while (iVar0 < Global_2435528.f_1.f_2804)
	{
		if (GAMEPLAY::IS_BIT_SET(iLocal_1005, iVar0) && iParam1 != *(uParam0[iVar0 /*19*/]).f_1)
		{
			return iVar0;
		}
		iVar0++;
...
int func_25(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_26(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 0:
			return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iParam0 /*57*/].f_55, iParam1);
			break;
		
		case 1:
			return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iParam0 /*57*/].f_56, iParam1);
			break;
	}
	return false;
}
...
int func_27(auto uParam0)
{
	...
	while (iVar0 < Global_2435528.f_1.f_2804)
	{
		if (!GAMEPLAY::IS_BIT_SET(iLocal_1002, iVar0))
		{
		...
		while (iVar0 < Global_2435528.f_1.f_2804)
		{
			...
			while (iVar1 < Global_2435528.f_1.f_2804)
			{
				if (iVar0 != iVar1)
				{
					...
					{
						GAMEPLAY::GAMEPLAY::SET_BIT(&iLocal_1005, iVar0);
						iLocal_1039++;
						*uParam0 = 1;
					}
				}
...
int func_28(auto uParam0, int iParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar2 < Global_2435528.f_1.f_2804)
	{
		...
		{
			iLocal_975[*(uParam0[iVar2 /*19*/]).f_1] += Global_2435528.f_1.f_844[iVar2 /*57*/].f_45;
	...
	if (iLocal_993[*(uParam0[iParam1 /*19*/]).f_1] > iLocal_993[uParam2])
	{
		if (Global_2435528.f_1.f_844[iParam1 /*57*/].f_45 <= iLocal_993[uParam2] && iLocal_993[uParam2] != 0)
		{
			iVar1++;
		}
	}
	else if (Global_2435528.f_1.f_844[iParam1 /*57*/].f_45 >= iLocal_993[uParam2] && iLocal_993[uParam2] != 0)
	{
		iVar1++;
	}
	return iVar1;
...
bool func_35(auto uParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (uLocal_218[*uParam0.f_63[0]] != 0 && uLocal_218[*uParam0.f_63[iParam1]] != 0)
		{
			if (Global_1617379.f_79 != 0)
			{
				if (func_34(uParam0) && func_38(uParam0))
				{
					...
					if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_79, *uParam0.f_63[0]) && (uLocal_218[*uParam0.f_63[0]] == *uParam0.f_73[*uParam0.f_63[0]] || func_37(uParam0)))
					{
						return true;
					}
					else
...
void func_47(auto uParam0)
{
	...
	else if (!GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 14))
	{
...
void func_70(int iParam0)
{
	...
	{
		fVar0 = to_float(Global_1617379.f_74364) / 10f;
...
void func_73(int iParam0)
{
	...
	if (func_67(iParam0) && func_74())
	{
		if (Global_1617379.f_25 > 1)
		{
			...
			while (iVar0 <= Global_2435528.f_1.f_2804 - 1)
			{
				if (GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iVar0 /*57*/].f_50, 14))
				{
					iVar1++;
					if (GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iVar0 /*57*/].f_50, 15))
					{
						Global_2435528.f_1.f_844[iVar0 /*57*/].f_33[0] = 1;
					}
					else if (GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iVar0 /*57*/].f_50, 16))
					{
						Global_2435528.f_1.f_844[iVar0 /*57*/].f_33[0] = 2;
					}
					else if (GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iVar0 /*57*/].f_50, 17))
					{
						Global_2435528.f_1.f_844[iVar0 /*57*/].f_33[0] = 3;
					}
					else if (GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[iVar0 /*57*/].f_50, 18))
					{
...
int func_75()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 9);
}
...
void func_81()
{
	GAMEPLAY::CLEAR_BIT(&Global_2434762, 9);
}

void func_82()
{
	GAMEPLAY::CLEAR_BIT(&Global_2434762, 13);
}

void func_83()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1587523[player_id() /*444*/].f_88.f_32), false);
}
...
void func_90(int iParam0, auto uParam1)
{
	...
	{
		uVar4 = func_94();
		iVar5 = Global_2435528.f_1.f_844[uVar4 /*57*/].f_47;
		iVar0 = 0;
		while (iVar0 <= Global_2435528.f_1.f_2804 - 1)
		{
			if (func_67(iParam0))
			...
			else
			{
				...
				while (iVar0 <= Global_2435528.f_1.f_2804 - 1)
				{
					...
					while (iVar1 <= Global_2435528.f_1.f_2804 - 1)
					{
						...
						{
							GAMEPLAY::GAMEPLAY::SET_BIT(&iVar6, Global_2435528.f_1.f_844[iVar0 /*57*/].f_44);
						}
						iVar1++;
					}
					iVar0++;
				...
				while (iVar0 <= Global_2435528.f_1.f_2804 - 1)
				{
					if (!GAMEPLAY::IS_BIT_SET(iVar6, Global_2435528.f_1.f_844[iVar0 /*57*/].f_44))
					{
...
int func_94()
{
	...
	if (network_is_handle_valid(&uVar0, 13))
	{
		...
		{
			if (network_is_handle_valid(&(Global_2435528.f_1.f_844[iVar13 /*57*/]), 13))
			{
				if (network_are_handles_the_same(&(Global_2435528.f_1.f_844[iVar13 /*57*/]), &uVar0))
				{
					return iVar13;
				}
			}
...
{
	func_97(1);
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Local_957.f_3), true);
}
...
void func_98(int iParam0, auto uParam1)
{
	int iVar0;
...
int func_99(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
int func_103(auto uParam0)
{
	return GAMEPLAY::IS_BIT_SET(*uParam0.f_119, false);
}
...
bool func_109()
{
	...
	iVar0 = Global_1587523[player_id() /*444*/].f_180;
	switch (iVar0)
	{
		case 0:
			if (!func_445())
...
bool func_117(int iParam0, auto uParam1)
{
...
void func_119(int iParam0)
{
	...
	{
		func_9(0);
		if (!network_is_script_active(func_7(), -1, 1, 0))
		{
			if (func_250())
			{
	...
	else if ((network_is_activity_session() && func_120()) && func_11())
	{
		func_9(0);
		func_6(*iParam0.f_3);
		iLocal_1041 = 1;
...
int func_120()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, 7);
}
...
void func_121(int iParam0)
{
	...
	func_144();
	func_138();
	_0xFF4803BC019852D9(Global_1315918, Global_1315917);
	func_122();
...
void func_125(int iParam0, int iParam1, int iParam2)
{
	...
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332477[iVar0]), iParam2);
}
...
int func_126(auto uParam0, int iParam1)
{
	...
	iVar0 = Global_1333688[uParam0 /*6*/].f_5;
	iVar1 = Global_1333688[uParam0 /*6*/].f_4;
	switch (iVar1)
	{
		case 0:
			if (iParam1 == 0)
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar0 < iVar1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1332906[iVar0 /*6*/]), iParam2);
		switch (iParam2)
		{
			case 1:
				func_130(iVar0, to_float(iParam3));
				break;
		}
		iVar0++;
	}
...
void func_130(int iParam0, Vector3 fParam1)
{
	if (fParam1 <= 0f)
	{
		return;
...
bool func_131(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	if (Global_1333688[uParam0 /*6*/].f_1 == -1)
	{
		return false;
	}
	iVar0 = false;
	...
	if (!iVar0)
	{
		if (iParam1 >= Global_1333688[uParam0 /*6*/].f_1)
		{
			return false;
		}
	}
	*iParam2 = Global_1333688[uParam0 /*6*/].f_2;
	*iParam3 = *iParam2 + Global_1333688[uParam0 /*6*/].f_1;
	if (!iVar0)
	{
		*iParam2 += iParam1;
		*iParam3 = *iParam2 + 1;
...
void func_138()
{
	...
	if (is_player_online())
	{
		...
		{
			Global_1315947[player_id() /*35*/] = {func_142()};
			if (func_141())
			{
				if (func_139(player_id(), &Global_1317072, &Global_1317073, &Global_1317074))
				{
					Global_1317071 = 1;
				}
				else
...
bool func_139(int iParam0, auto uParam1, auto uParam2, auto uParam3)
{
	struct<35> Var0;
	struct<13> Var35;
	...
	if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
	{
		...
		else
		{
			if (iParam1 != 5)
			{
				...
				if (iParam3)
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(&iVar33, Global_69311[1 /*14*/].f_1);
				}
				else
				{
				...
				if (iParam0 == joaat("mp_m_freemode_01"))
				{
					...
					else if (iParam1 == 7)
					{
						if (iParam2 >= 41 && iParam2 <= 56)
						{
							...
							{
								case 0:
									func_145(iParam0, 7, func_152(iParam0, -1893758670, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 221276858, 7, 3), 1, 0);
									break;
								
								case 1:
									func_145(iParam0, 7, func_152(iParam0, -1596052305, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 576886046, 7, 3), 1, 0);
									break;
								
								case 2:
									func_145(iParam0, 7, func_152(iParam0, 1233059274, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -392978047, 7, 3), 1, 0);
									break;
								
								case 3:
									func_145(iParam0, 7, func_152(iParam0, 232228476, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -33764269, 7, 3), 1, 0);
									break;
								
								case 4:
									func_145(iParam0, 7, func_152(iParam0, -454445919, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1510704243, 7, 3), 1, 0);
									break;
								
								case 5:
									func_145(iParam0, 7, func_152(iParam0, 925653285, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1800939276, 7, 3), 1, 0);
									break;
								
								case 6:
									func_145(iParam0, 7, func_152(iParam0, -2104856604, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 833565623, 7, 3), 1, 0);
									break;
								
								case 7:
									func_145(iParam0, 7, func_152(iParam0, 1657483366, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1201823645, 7, 3), 1, 0);
									break;
								
								case 8:
									func_145(iParam0, 7, func_152(iParam0, 501294735, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 2132496022, 7, 3), 1, 0);
									break;
								
								case 9:
									func_145(iParam0, 7, func_152(iParam0, 1882573627, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1939019463, 7, 3), 1, 0);
									break;
								
								case 10:
									func_145(iParam0, 7, func_152(iParam0, 206035418, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1713491273, 7, 3), 1, 0);
									break;
								
								case 11:
									func_145(iParam0, 7, func_152(iParam0, -642943834, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -156668318, 7, 3), 1, 0);
									break;
								
								case 12:
									func_145(iParam0, 7, func_152(iParam0, -388295935, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 106696135, 7, 3), 1, 0);
									break;
								
								case 13:
									func_145(iParam0, 7, func_152(iParam0, 927641567, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -802905767, 7, 3), 1, 0);
									break;
								
								case 14:
									func_145(iParam0, 7, func_152(iParam0, 1147226636, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -505527092, 7, 3), 1, 0);
									break;
								
								case 15:
									func_145(iParam0, 7, func_152(iParam0, 312665744, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1144129332, 7, 3), 1, 0);
									break;
							}
						}
						else if (iParam2 >= 73 && iParam2 <= 88)
						{
							...
							{
								case 0:
									func_145(iParam0, 7, func_152(iParam0, -335266079, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -925989020, 7, 3), 1, 0);
									break;
								
								case 1:
									func_145(iParam0, 7, func_152(iParam0, -1379548555, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 244486895, 7, 3), 1, 0);
									break;
								
								case 2:
									func_145(iParam0, 7, func_152(iParam0, -1402159165, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1095104597, 7, 3), 1, 0);
									break;
								
								case 3:
									func_145(iParam0, 7, func_152(iParam0, 1357351098, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1787874026, 7, 3), 1, 0);
									break;
								
								case 4:
									func_145(iParam0, 7, func_152(iParam0, -1097178082, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 476163725, 7, 3), 1, 0);
									break;
								
								case 5:
									func_145(iParam0, 7, func_152(iParam0, -179482237, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1223952305, 7, 3), 1, 0);
									break;
								
								case 6:
									func_145(iParam0, 7, func_152(iParam0, -750514831, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 2049796643, 7, 3), 1, 0);
									break;
								
								case 7:
									func_145(iParam0, 7, func_152(iParam0, -1724573356, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1013547784, 7, 3), 1, 0);
									break;
								
								case 8:
									func_145(iParam0, 7, func_152(iParam0, 94106144, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1456972664, 7, 3), 1, 0);
									break;
								
								case 9:
									func_145(iParam0, 7, func_152(iParam0, 1070524041, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1670762848, 7, 3), 1, 0);
									break;
								
								case 10:
									func_145(iParam0, 7, func_152(iParam0, -1644577318, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, 1428867383, 7, 3), 1, 0);
									break;
								
								case 11:
									func_145(iParam0, 7, func_152(iParam0, 1865900118, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1664165762, 7, 3), 1, 0);
									break;
								
								case 12:
									func_145(iParam0, 7, func_152(iParam0, 1611776523, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1962101510, 7, 3), 1, 0);
									break;
								
								case 13:
									func_145(iParam0, 7, func_152(iParam0, 1381115532, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1270511757, 7, 3), 1, 0);
									break;
								
								case 14:
									func_145(iParam0, 7, func_152(iParam0, 1636484345, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -1571626106, 7, 3), 1, 0);
									break;
								
								case 15:
									func_145(iParam0, 7, func_152(iParam0, 1422633851, 7, 3), 1, 0);
									func_145(iParam0, 7, func_152(iParam0, -698332248, 7, 3), 1, 0);
									break;
								}
							}
					}
...
int func_147(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_149(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_149(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_155(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_154(iParam1)];
		...
		if (!_is_dlc_data_empty(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						*iParam0[vVar16.z] = func_152(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
bool func_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false) && !GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, 6))
	{
		...
		if (iParam1 != 5)
		{
			...
			if (iParam3)
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(&iVar0, Global_69311[1 /*14*/].f_1);
			}
			else
			{
		...
		if (iParam4)
		{
			if (func_161(iParam1, Global_69311[1 /*14*/].f_2, &iVar1))
			{
				...
				GAMEPLAY::GAMEPLAY::SET_BIT(&iVar2, Global_69311[1 /*14*/].f_1);
		...
		if (Global_69310 == 1 && iParam3 == 1)
		{
			if (iParam0 == joaat("mp_m_freemode_01"))
			{
				if (iParam1 == 14)
				{
					if (iParam2 >= 83 && iParam2 <= 90)
					{
						...
						func_160(iParam0, 14, iVar3, 1, iParam4);
					}
					else if (iParam2 >= 75 && iParam2 <= 82)
					{
				...
				else if (iParam1 == 8)
				{
					if (iParam2 >= 48 && iParam2 <= 63)
					{
						...
						func_160(iParam0, 8, iVar3, 1, iParam4);
					}
					else if (iParam2 >= 64 && iParam2 <= 79)
					{
					...
					else if (iParam2 >= 32 && iParam2 <= 47)
					{
						...
						func_160(iParam0, 11, iVar3, 1, iParam4);
					}
					else if (iParam2 >= 224 && iParam2 <= 239)
					{
			...
			if (iParam1 == 11)
			{
				...
				if (iVar4 != -99)
				{
					func_160(iParam0, 8, iVar4, 1, iParam4);
				}
			}
			else if (iParam1 == 8)
			{
				...
				if (iVar4 != -99)
				{
					func_160(iParam0, 11, iVar4, 1, iParam4);
				}
			}
		}
		Global_69310--;
...
int func_161(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_169(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_169(vVar16.z)] = func_152(iParam1, vVar16.x, func_169(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_169(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_170(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_171(uParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_155(iVar2, iVar0, 0);
		GAMEPLAY::CLEAR_BIT(&iVar3, iVar1);
		func_153(iVar2, iVar3, iVar0, 1);
	}
}

int func_171(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_172(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_171(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_155(iVar2, iVar0, 0);
...
void func_175(int iParam0)
{
	...
	func_176(&(Global_69311[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_176(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_180(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_155(func_162(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_161(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_155(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_177(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_178(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_171(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_155(uVar2, iVar0, 0);
...
void func_182(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_176(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_149(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_176(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_183(int iParam0)
{
	...
	func_176(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
int func_194(int iParam0, int iParam1)
{
	...
	iVar1 = iParam0;
	return GAMEPLAY::IS_BIT_SET(iVar0, func_195(iVar1));
}
...
auto func_196(auto uParam0, int iParam1)
{
	auto uVar0;
...
void func_222(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7)
{
	int iVar0;
...
void func_234()
{
	...
	while (iVar0 <= 6)
	{
		...
		{
			iVar1 = player_id();
			GAMEPLAY::CLEAR_BIT(&(Global_2418472[iVar1 /*313*/].f_226), Global_1334607[iVar0]);
...
void func_253()
{
	...
	{
		_set_radar_zoom_level_this_frame(Global_2444099);
	}
	lock_minimap_position(fLocal_211, fLocal_212);
}
...
void func_255(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2812), iVar1);
	}
	else if (iVar0 == 1)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2813), iVar1);
	}
	else if (iVar0 == 2)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2814), iVar1);
	}
	else if (iVar0 == 3)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2815), iVar1);
	}
	else if (iVar0 == 4)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2816), iVar1);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_2435528.f_1.f_2817), iVar1);
	}
}
...
void func_260()
{
	...
	while (iVar0 <= Global_1617379.f_41497 - 1)
	{
		if (!func_281(Global_1617379.f_41501[iVar0 /*38*/]))
		{
			...
			_0x551DF99658DB6EE8(Global_1617379.f_41501[iVar0 /*38*/]);
		}
		iVar0++;
	}
}

auto func_261(int iParam0, int iParam1)
{
	auto uVar0;
	auto uVar1;
	char* sVar2;
	
	func_262(iParam0, &uVar0, &uVar1, &sVar2, iParam1);
	return uVar1;
}

void func_262(auto uParam0, auto uParam1, auto uParam2, char* sParam3, int iParam4)
{
	if (Global_1617379.f_41501[uParam0 /*38*/].f_13 != 77)
	{
		*uParam1 = func_265(uParam0);
...
{
	iParam0 = _0x5EAAD83F8CFB4575(iParam0);
	switch (iParam0)
	{
...
int func_265(auto uParam0)
{
	...
	iVar0 = Global_1617379.f_41501[uParam0 /*38*/].f_13;
	...
	{
		iVar1 = _0x08F96CA6C551AD51(iVar0);
	}
	...
	if (iVar2 > -1)
	{
		...
		{
			if ((!func_269(player_id(), 0) && !Global_1573825) && !func_268())
			{
...
void func_282()
{
	...
	if (func_287())
	{
		...
		while (iVar0 <= 69)
		{
			...
			{
				_0x311438A071DD9B1A(Global_1617379.f_30355[iVar0 /*3*/]);
				iVar1 = iVar0;
			}
			iVar0++;
		}
		_0x900086F371220B6F(1, 18, 30);
		if (func_284() && func_269(player_id(), 0))
		{
			iVar0 = 0;
			while (iVar0 <= 69)
			{
				if (!func_281(Global_1617379.f_30355[iVar0 /*3*/]))
				{
					if (iVar0 != 0 && iVar0 != iVar1)
					{
						...
						_0x551DF99658DB6EE8(Global_1617379.f_30355[iVar0 /*3*/]);
					}
				}
				iVar0++;
			}
		...
		if (!func_281(Global_1617379.f_30355[0 /*3*/]))
		{
			...
			_0x551DF99658DB6EE8(Global_1617379.f_30355[0 /*3*/]);
		}
		if (!func_281(Global_1617379.f_30355[iVar1 /*3*/]))
		{
			_0x1EAE6DD17B7A5EFA(144);
			_0x551DF99658DB6EE8(Global_1617379.f_30355[iVar1 /*3*/]);
		}
	}
	else
	{
		...
		if (!func_281(Global_1617379.f_30355[0 /*3*/]))
		{
			_0x311438A071DD9B1A(Global_1617379.f_30355[0 /*3*/]);
		}
		_0x900086F371220B6F(1, 18, 30);
		iVar2 = 55;
		if (!func_281(Global_1617379.f_30355[0 /*3*/]))
		...
		if (!func_281(_get_object_offset_from_coords(Global_1617379.f_30355[0 /*3*/], func_283(Global_1617379.f_30355[0 /*3*/], Global_1617379.f_30355[1 /*3*/]), 0f, IntToFloat(iVar2), 0f)))
		{
			_0x1EAE6DD17B7A5EFA(145);
			_0x551DF99658DB6EE8(_get_object_offset_from_coords(Global_1617379.f_30355[0 /*3*/], func_283(Global_1617379.f_30355[0 /*3*/], Global_1617379.f_30355[1 /*3*/]), 0f, IntToFloat(iVar2), 0f));
		}
	}
}

float func_283(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
void func_288()
{
	...
	fLocal_211 = Var5 + Var8 / 2f;
	fLocal_212 = Var5.f_1 + Var8.f_1 / 2f;
	lock_minimap_position(fLocal_211, fLocal_212);
	lock_minimap_angle(false);
	fVar11 = Var5 - Var8;
...
bool func_291()
{
	...
	if ((Global_1617379 == 1 && Global_1617379.f_55 != 1) && !func_292(player_id()))
	{
	...
	if (Global_1617379 == 0 && !func_292(player_id()))
	{
	...
	if (Global_1617379 == 3 && !func_292(player_id()))
	{
		if (func_290(Global_1617379) > 0)
		{
			return true;
...
void func_295(int iParam0)
{
	...
	if (func_320())
	{
		if (!func_257(43))
		{
			...
			{
				if (func_433() && !is_player_switch_in_progress())
				{
					func_310(iParam0.f_11, *iParam0.f_4);
					vVar0 = {func_306(*iParam0.f_11, *iParam0.f_15)};
					vVar0 = {func_304(&vVar0, *iParam0.f_4)};
					if (!func_281(vVar0))
					{
						...
						_new_load_scene_start_safe(vVar0, 60f, 0);
						func_303();
						func_302();
						func_301(43);
						func_300();
...
void func_296()
{
	GAMEPLAY::CLEAR_BIT(&(Global_2434762.f_2), true);
}

void func_297()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2434762.f_2), false);
}

int func_298()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, false);
}

int func_299()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, true);
}

void func_300()
{
	GAMEPLAY::CLEAR_BIT(&Global_2434762, 27);
}
...
void func_301(int iParam0)
{
	...
	if (iVar0 == 0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2812), iVar1);
	}
	else if (iVar0 == 1)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2813), iVar1);
	}
	else if (iVar0 == 2)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2814), iVar1);
	}
	else if (iVar0 == 3)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2815), iVar1);
	}
	else if (iVar0 == 4)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2816), iVar1);
	}
	else
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2435528.f_1.f_2817), iVar1);
	}
}

void func_302()
{
	GAMEPLAY::CLEAR_BIT(&(Global_2434762.f_2), false);
}

void func_303()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_2434762.f_2), true);
}

Vector3 func_304(auto uParam0, auto uParam1)
{
...
Vector3 func_306(Vector3 vParam0, Vector3 vParam1)
{
	if (func_307())
	{
		return vParam3;
...
void func_310(auto uParam0, int iParam1)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (Global_1617379 == 0)
	{
		if (iParam1)
		{
			if (func_305(&Global_2431938))
			{
				...
				if (!func_316())
				{
					if (get_ground_z_for_3d_coord(*uParam0, &uVar3, 0))
					{
						*uParam0.f_2 = uVar3;
					}
				}
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_1617379.f_4, 6))
	{
		return true;
	}
	if (func_313(vParam0))
...
int func_314(Vector3 vParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 vVar4;
	...
	iVar0 = 0;
	vVar1 = {Global_1617379.f_70696[iParam3 /*26*/][0 /*3*/]};
	vVar4 = {Global_1617379.f_70696[iParam3 /*26*/][1 /*3*/]};
	...
	switch (Global_1617379.f_70696[iParam3 /*26*/].f_8)
	{
		case 0:
			...
			if (func_315(vParam0, vVar1, vVar4))
			{
				iVar0 = 1;
			}
			break;
		...
		case 1:
			...
			if (vdist2(vParam0, vVar1) < fVar7 * fVar7)
			{
				iVar0 = 1;
			}
			break;
		...
		case 2:
			if (is_point_in_angled_area(vParam0, vVar1, vVar4, fVar7, 0, iParam4))
			{
				iVar0 = 1;
			}
			break;
...
bool func_315(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5)
{
...
bool func_319(int iParam0, Vector3 vParam1, int iParam2, int iParam3)
{
	if (iParam4)
	{
		if (func_316())
...
int func_320()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 27);
}
...
int func_322(int iParam0, auto uParam1)
{
	if (iParam0 != 0)
	{
		return 0;
...
void func_323()
{
	if ((Global_2443510 == 1 || func_417()) || (network_is_activity_session() && func_324(&(Global_1721440.f_55))))
	{
		if (iLocal_215 != 1)
		{
			_0xD57AAAE0E2214D11();
...
void func_327(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
bool func_329()
{
	if (func_269(player_id(), 0))
	{
		if (Global_1587523[player_id() /*444*/].f_355 != func_331())
		{
			if (func_118(Global_1587523[player_id() /*444*/].f_355, 0, 1))
			{
...
int func_332()
{
	return GAMEPLAY::IS_BIT_SET(Global_2460486.f_1639, 6);
}
...
void func_333()
{
	...
	{
		if (!func_397(&uLocal_1042) && network_is_activity_session())
		{
...
void func_341()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2434762, 19);
}
...
void func_342(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (network_is_player_active(iParam0) && is_player_playing(iParam0))
		{
			...
			if (iParam1)
			{
				if (!func_345(iVar25) && !is_entity_attached_to_any_vehicle(iVar25))
				{
					if (!iVar21)
					{
...
int func_348()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 23);
}
...
void func_350(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 0:
			if ((func_236(player_id()) && network_is_signed_online()) && func_373())
			{
				func_363(iParam1);
			}
			if ((!func_362() && !iParam2) && !func_361())
			{
				if (func_360() == 0)
				{
					func_359(1);
...
float func_354(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2489085[iParam0 /*5*/][func_154(iParam1)];
...
void func_363(int iParam0)
{
	...
	func_364(joaat("mpply_current_crew_rank"), func_365(func_366(player_id()), 1));
}
...
auto func_370(int iParam0, int iParam1, int iParam2)
{
	if (iParam2 == 0)
	{
	}
...
void func_383()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		while (iVar0 < 32)
		{
			...
			{
				if ((Global_1587523[iVar3 /*444*/].f_355 == player_id() && func_269(iVar3, 0)) && iVar3 != player_id())
				{
					Var4 = {func_140(iVar3)};
					if (iVar2 < 32)
					{
						...
						iVar2++;
						GAMEPLAY::GAMEPLAY::SET_BIT(&iVar1, iVar0);
					}
				}
			}
			iVar0++;
		...
		{
			func_384(iVar1);
			network_add_followers(&Global_978147, iVar2);
		}
	}
}
...
bool func_395(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
...
void func_398(int iParam0)
{
	...
	{
		Var0 = {func_143()};
		if (func_400(Var0) && network_is_activity_spectator_from_handle(&Var0))
		{
			func_399();
		}
	}
...
int func_400(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12)
{
	return network_is_handle_valid(&uParam0, 13);
}

void func_401(auto uParam0, char* sParam1, int iParam2, char* sParam3)
{
	if (*uParam0 == 0)
	{
		if ((((!is_string_null_or_empty(sParam3) && func_404() != -1) && (func_444() || func_445())) && !func_403(func_404())) && func_402() - 1 > _get_posix_time())
		{
			_0xABA17D7CE615ADBF(sParam3);
			add_text_component_substring_player_name(&(Global_2435528.f_1.f_844[func_404() /*57*/].f_13));
			_0xBD12F8228410D9B4(iParam2);
		}
		else
		{
			_0xABA17D7CE615ADBF(sParam1);
			_0xBD12F8228410D9B4(iParam2);
		}
		*uParam0 = 1;
	}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_2435528.f_1.f_844[uParam0 /*57*/].f_51, 4);
}
...
void func_425(int iParam0)
{
	...
	if (func_427() == 0 || is_pause_menu_active())
	{
		func_426(1);
...
{
	if ((func_427() == 1 || is_pause_menu_active()) || iParam0)
	{
		func_426(0);
...
int func_438()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762.f_2, 21);
}

void func_439(Vector3 vParam0)
{
	if (!func_329())
	{
		return;
...
int func_441()
{
	return GAMEPLAY::IS_BIT_SET(Global_2434762, 13);
}
...
void func_447()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1587523[player_id() /*444*/].f_39.f_18), 9);
}
...
void func_448(int iParam0)
{
	...
	if (Local_223.f_4 == 0)
	{
		Local_223.f_1 = GAMEPLAY::IS_BIT_SET(Global_1617379.f_39, 16);
	}
	else
	{
		Local_223.f_1 = 0;
...
void func_452()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1587523[player_id() /*444*/].f_88.f_32), 3);
}
...
void func_454(int iParam0, int iParam1, Vector3 vParam2, auto uParam3, Vector3 vParam4, int iParam5, int iParam6, auto uParam7, auto uParam8, int iParam9, int iParam10)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 fVar6;
	...
	if (!does_cam_exist(Global_2434762.f_654))
	{
		Global_2434762.f_654 = create_cam("DEFAULT_SCRIPTED_CAMERA", false);
	}
	vVar3 = {vParam6};
	fVar6 = -1f;
	if (func_479(iParam0))
	{
		*uParam5 = {func_478(iParam0, iParam1)};
		vVar3 = {func_477(iParam0, iParam1)};
	...
	if (iParam0 == 0 && iParam10)
	{
		func_436();
		func_472(&vVar7, 144, Global_1587523[player_id() /*444*/].f_250.f_9);
		if (!func_281(vVar7))
		{
			vVar0 = {vVar7};
		}
		func_462(&vVar7, 144, Global_1587523[player_id() /*444*/].f_250.f_9);
		vVar3 = {vVar7};
	}
	set_cam_active(Global_2434762.f_654, true);
	set_cam_coord(Global_2434762.f_654, vVar0);
	set_cam_rot(Global_2434762.f_654, vVar3, 2);
	if (fVar6 > 0f)
	{
		set_cam_fov(Global_2434762.f_654, fVar6);
	}
	else
	{
		set_cam_fov(Global_2434762.f_654, 40f);
	}
	if (func_482() && !iParam14)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (!func_461(player_id()))
			{
				...
				set_entity_coords(PLAYER::PLAYER_PED_ID(), -209.434f, 305.016f, 95.9464f, 1, false, 0, 1);
				set_entity_heading(PLAYER::PLAYER_PED_ID(), 12.5f);
				task_go_straight_to_coord(PLAYER::PLAYER_PED_ID(), -209.867f, 306.969f, 95.9464f, 1f, 20000, 1193033728, 0.1f);
				force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -668482597, false, 0, 0);
				_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
		clear_area_of_vehicles(-209.434f, 305.016f, 95.9464f, 30f, 0, 0, 0, 0, false);
		func_460(1);
	}
	if (!is_player_switch_in_progress())
	{
...
void func_455(int iParam0)
{
	...
	if (!iParam0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_456())
			{
				func_342(player_id(), 0, 32772);
			}
			else
			{
				func_342(player_id(), 0, 319492);
			}
		}
		else
		{
			func_342(player_id(), 0, 57348);
		}
	}
}
...
bool func_457()
{
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_459(iVar0) && !func_458(iVar0))
		{
			return true;
		}
	}
...
void func_460(int iParam0)
{
	if (iParam0)
	{
		GAMEPLAY::GAMEPLAY::SET_BIT(&(Global_1587523[player_id() /*444*/].f_135), 27);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_1587523[player_id() /*444*/].f_135), 27);
	}
}

int func_461(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(Global_1587523[iParam0 /*444*/].f_135, 27);
}

bool func_462(auto uParam0, int iParam1, int iParam2)
{
	struct<4> Var0;
...
void func_463(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	...
	*uParam2 = {func_465(iParam1, iParam3)};
	...
	vVar13 = {func_464(vVar13, -Var0[0 /*6*/].f_3.f_2)};
	vVar13 = {func_464(vVar13, Var0[1 /*6*/].f_3.f_2)};
...
Vector3 func_464(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
bool func_472(auto uParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	...
	switch (iParam2)
	{
		...
		case 42:
		case 43:
			func_463(iParam2, iParam1, &vVar0, -1);
			*uParam0 = {vVar0};
			return true;
		...
		case 64:
		case 65:
			func_463(iParam2, iParam1, &vVar0, 61);
			*uParam0 = {vVar0};
			return true;
		...
		case 84:
		case 85:
			func_463(iParam2, iParam1, &vVar0, 83);
			*uParam0 = {vVar0};
			return true;
		...
		case 81:
		case 82:
			func_463(iParam2, iParam1, &vVar0, 77);
			*uParam0 = {vVar0};
			return true;
		...
		case 75:
		case 76:
			func_463(iParam2, iParam1, &vVar0, 73);
			*uParam0 = {vVar0};
			return true;
			return false;
	}
...
{
	if (!_get_screen_effect_is_active(func_481(0)))
	{
		_start_screen_effect(func_481(iParam0), false, 1);
	}
}
...
void func_488()
{
	GAMEPLAY::GAMEPLAY::SET_BIT(&Global_2434762, 13);
}
