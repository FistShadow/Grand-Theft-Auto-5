			...
			if (does_entity_exist(player_ped_id()))
			{
				if (!is_entity_dead(player_ped_id(), 0))
				{
					...
					if (get_game_timer() > iLocal_59)
					{
						...
						iLocal_59 = get_game_timer() + iLocal_64;
					}
				}
			}
...
void func_2()
{
	...
	{
		if (is_bit_set(Global_2460486.f_2084.f_18, true))
		{
			func_112(41, 1);
		}
	}
...
int func_22(int iParam0, int iParam1)
{
	...
	if (network_is_game_in_progress() && func_65())
	{
		StringCopy(&cVar144, func_63(iParam1, iParam0), 16);
		func_60(&sVar128, cVar144, get_entity_model(player_ped_id()), 3, 1, func_61(iParam0), -1, -1);
...
void func_60(char* sParam0, struct<4> Param1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, int iParam7)
{
...
bool func_99()
{
	...
	if (network_is_game_in_progress() || Global_69489)
	{
		return false;
	}
...
bool func_107()
{
	...
	while (iVar0 < 4)
	{
		if (is_bit_set(Global_101154.f_29501.f_1, iVar0))
		{
			return true;
		}
		iVar0++;
...
bool func_108()
{
	...
	while (iVar0 < 5)
	{
		if (is_bit_set(Global_101154.f_29504.f_2, iVar0))
		{
			return true;
		}
		iVar0++;
...
void func_134()
{
	...
	if (is_entity_dead(player_ped_id(), 0))
	{
		iVar0 = _get_ped_killer(player_ped_id());
...
void func_137(var uParam0)
{
	if (func_80(uParam0))
	{
		if (!func_79(uParam0))
		{
			*uParam0.f_2 = func_78(is_bit_set(*uParam0, 4)) - *uParam0.f_1;
			set_bit(uParam0, 2);
		}
	}
}
...
int func_141()
{
	...
	iVar0 = 0;
	iVar1 = func_143(2);
	if (func_142(iVar1, 0) || is_bit_set(Global_87462, 2))
	{
		iVar0++;
	}
	iVar1 = func_143(1);
	if (func_142(iVar1, 0) || is_bit_set(Global_87462, true))
	{
		iVar0++;
	}
	iVar1 = func_143(0);
	if (func_142(iVar1, 0) || is_bit_set(Global_87462, false))
	{
		iVar0++;
	}
	return iVar0;
