...
void main()
{
	...
	if (func_279(player_ped_id()))
	{
		iLocal_328 = get_ped_relationship_group_hash(player_ped_id());
	}
	if (func_278(Local_83.f_28[0]))
	{
		set_ped_relationship_group_hash(Local_83.f_28[0], iLocal_328);
		set_ped_config_flag(Local_83.f_28[0], 132, true);
	}
	while (true)
	{
...
void func_1()
{
	switch (iLocal_145)
	{
		...
		case 1:
			...
			if (!iLocal_160)
			{
				if (func_279(Local_83.f_28[0]) && does_entity_exist(iLocal_147))
				{
			...
			else if (is_synchronized_scene_running(iLocal_149))
			{
				if (get_synchronized_scene_phase(iLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_219(&uLocal_163, 2, player_ped_id(), "Trevor", 0, 1);
				...
				if (is_entity_in_angled_area(player_ped_id(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
				...
				if (func_208(Local_83.f_28[0], player_ped_id(), 1) > 17.5f)
				{
					if (func_278(Local_83.f_28[0]))
					{
		...
		case 2:
			...
			if (func_278(Local_83.f_28[0]))
			{
				if (iLocal_162 == 1)
				{
					...
					task_play_anim(false, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					task_play_anim(false, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!is_ped_injured(player_ped_id()) && !func_227(player_id())) && !func_225(player_id(), 0)) && !func_224())
			{
				set_entity_invincible(player_ped_id(), false);
			}
		}
		else if (!is_ped_injured(player_ped_id()) && !func_227(player_id()))
		{
			set_entity_invincible(player_ped_id(), false);
		}
		Global_69487 = 0;
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity("Josh", false))
			{
				...
				if (!iLocal_160)
				{
					...
					func_233(player_ped_id(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					set_gameplay_cam_relative_pitch(0f, 1f);
					set_gameplay_cam_relative_heading(0f);
					if (func_279(Local_83.f_28[0]) && does_entity_exist(iLocal_147))
					{
...
bool func_248(int iParam0, float fParam1, int iParam2)
{
	...
	if (is_ped_in_any_vehicle(player_ped_id(), 0))
	{
		...
		{
			if (!func_254(get_vehicle_ped_is_in(player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_253(player_ped_id(), -828834893))
				{
...
void func_255()
{
	...
	{
		case 0:
			if (!func_5(0) && is_entity_in_angled_area(player_ped_id(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0))
			{
				if (!iLocal_156)
				{
					if (is_entity_in_angled_area(player_ped_id(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_279(Local_83.f_28[0]) && does_entity_exist(iLocal_147))
						{
				...
				else if (is_synchronized_scene_running(iLocal_148))
				{
					...
					if (func_208(player_ped_id(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_257()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(player_ped_id(), 0))
		{
			if (func_254(get_vehicle_ped_is_in(player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
