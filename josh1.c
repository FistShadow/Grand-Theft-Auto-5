#region Local Var
	...
	int iLocal_148 = 0;
	int iLocal_149 = 0;
	Vector3 vLocal_150 = 0;
	Vector3 vLocal_153 = 0;
	int iLocal_156 = 0;
	int iLocal_157 = 0;
	int iLocal_158 = 0;
	int iLocal_159 = 0;
...
void main()
{
	...
	{
		iLocal_328 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
	}
...
void func_1()
{
	switch (iLocal_145)
	{
		case 0:
			...
			if (has_anim_dict_loaded("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147))
				{
					...
					iLocal_147 = get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
				}
				iLocal_145 = 1;
			}
			break;
		...
		case 1:
			...
			if (!iLocal_160)
			{
				if (func_279(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
				{
					iLocal_149 = create_synchronized_scene(vLocal_150, vLocal_153, 2);
					task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
			...
			else if (is_synchronized_scene_running(iLocal_149))
			{
				if (get_synchronized_scene_phase(iLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_219(&uLocal_163, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
				...
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						stop_synchronized_entity_anim(iLocal_147, -8f, 1);
					}
					iLocal_162 = 1;
				}
				if (func_208(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_278(Local_83.f_28[0]))
					{
				...
				if ((PED::IS_PED_INJURED(Local_83.f_28[0]) || is_entity_on_fire(Local_83.f_28[0])) || is_explosion_in_sphere(-1, ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 1), 5f))
				{
					if (func_278(Local_83.f_28[0]))
					{
						stop_synchronized_entity_anim(Local_83.f_28[0], -8f, 1);
		...
		case 2:
			...
			if (func_278(Local_83.f_28[0]))
			{
				if (iLocal_162 == 1)
				{
					...
					task_follow_nav_mesh_to_coord(false, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 0, 1193033728);
					AI::TASK_PLAY_ANIM(false, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
					close_sequence_task(iLocal_146);
				}
				else
				{
					open_sequence_task(&iLocal_146);
					task_follow_nav_mesh_to_coord(false, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 1, 1193033728);
					AI::TASK_PLAY_ANIM(false, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(false, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
					close_sequence_task(iLocal_146);
				}
				task_perform_sequence(Local_83.f_28[0], iLocal_146);
				clear_sequence_task(&iLocal_146);
				set_blocking_of_non_temporary_events(Local_83.f_28[0], false);
				if (iLocal_162 == 0)
				{
					force_ped_motion_state(Local_83.f_28[0], -668482597, false, 0, 1);
				}
			}
			if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
...
bool func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<14> Var0;
...
void func_218(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, auto uParam5)
{
...
void func_219(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_227(player_id())) && !func_225(player_id(), 0)) && !func_224())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_227(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_229(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_232()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		...
		if (func_278(Local_83.f_28[0]))
		{
			_0x2A56C06EBEF2B0D9("Josh", Local_83.f_28[0], false);
		}
	}
	switch (iLocal_145)
	{
		case 0:
			if (func_248(1, 1093140480, 0))
			{
				...
				if (func_278(Local_83.f_28[0]))
				{
					register_entity_for_cutscene(Local_83.f_28[0], "Josh", 0, false, 0);
				}
				if (func_278(PLAYER::PLAYER_PED_ID()))
				{
				...
				clear_area_of_vehicles(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, false);
				clear_area_of_vehicles(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, false);
				clear_area_of_vehicles(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, false);
				clear_area_of_vehicles(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, false);
				clear_area_of_vehicles(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, false);
				clear_angled_area_of_vehicles(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0);
				...
				func_237(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 3f, 6f, 3f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if (can_set_exit_state_for_registered_entity("Josh", false))
			{
				...
				if (!iLocal_160)
				{
					...
					func_233(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					set_gameplay_cam_relative_pitch(0f, 1f);
					set_gameplay_cam_relative_heading(0f);
					if (func_279(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						iLocal_149 = create_synchronized_scene(vLocal_150, vLocal_153, 2);
						task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
						func_231("Done Josh leadout anim on Josh exit state");
						force_entity_ai_and_animation_update(iLocal_147);
						force_ped_motion_state(Local_83.f_28[0], -1871534317, false, 1, 1);
						iLocal_160 = 1;
					}
				}
			}
			...
			if (was_cutscene_skipped())
			{
				...
				if (does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					ENTITY::ENTITY::REMOVE_MODEL_HIDE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false);
				...
				{
					ENTITY::ENTITY::REMOVE_MODEL_HIDE(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), false);
			...
			if (!is_cutscene_active())
			{
				...
				if (!iLocal_160)
				{
					...
					{
						iLocal_149 = create_synchronized_scene(vLocal_150, vLocal_153, 2);
						task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
...
int func_233(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_234(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_237(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	func_238(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

void func_238(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_242(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_240(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_241(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_241(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
bool func_242(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_244(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_243(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_243(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_243(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_243(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_243(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_243(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_243(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_243(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_243(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_243(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_243(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_243(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_243(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_243(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_243(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_243(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_243(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_244(Vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_248(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_254(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_254(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_255()
{
	...
	{
		case 0:
			if (!func_5(0) && is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
				...
				if (has_anim_dict_loaded("rcmjosh1leadinout"))
				{
					...
					iLocal_147 = get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
					func_236(1);
					_request_cutscene_2("JOSH_1_INT_CONCAT", 14, 8);
					iLocal_145 = 1;
				}
			}
			else
		...
		case 1:
			if (!func_5(0))
			{
				if (!iLocal_156)
				{
					if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_279(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
						{
							iLocal_148 = create_synchronized_scene(vLocal_150, vLocal_153, 2);
							task_synchronized_scene(Local_83.f_28[0], iLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1000f, 0);
							play_synchronized_entity_anim(iLocal_147, iLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1000f);
							task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], -1, 0, 2);
							task_look_at_entity(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
					...
					else
					{
						if (!func_5(0) && !iLocal_156)
						{
							...
							remove_cutscene();
							_request_cutscene_2("JOSH_1_INT_CONCAT", 13, 8);
						}
						func_231("Replay in progress, skipping leadin");
						iLocal_145 = 2;
					}
				}
				else if (is_synchronized_scene_running(iLocal_148))
				{
					if (get_synchronized_scene_phase(iLocal_148) > 0.15f)
					{
						if (!iLocal_157)
						{
					...
					if (get_synchronized_scene_phase(iLocal_148) > 0.9f)
					{
						func_231("Leadin anim done, launch cutscene");
						iLocal_145 = 2;
					}
					if (func_208(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_257()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_254(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
struct<2> func_264(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_271(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_270(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_269(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_268(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_267(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_266(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_265(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_271(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_273(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_275(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_261(0)) || func_274(1))
			{
			}
			else
			{
...
void func_283(int iParam0, int iParam1)
{
	...
	func_284(iParam0, iLocal_81, vVar0, fVar3);
...
void func_284(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_285(iParam0);
...
bool func_286(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_287(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_287(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
void func_292(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
void func_295(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_303(uParam0, iParam1);
	func_300(uParam0, iParam2);
	func_296(uParam0, iParam3);
}

void func_296(auto uParam0, int iParam1)
{
	func_297(uParam0.f_41, iParam1);
}
...
void func_308(int iParam0)
{
	...
	if (!func_325())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_309(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_310(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_316())
	{
		...
		{
			iVar33 = func_311(get_this_script_name());
			if (iVar33 > -1)
			{
