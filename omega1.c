#region Local Var
	...
	int iLocal_329 = 0;
	int iLocal_330 = 0;
	Vector3[] vLocal_331 = new Vector3[2];
	Vector3 fLocal_338 = 0;
	struct<61> Local_339 = 0;
#endregion
...
void main()
{
	...
	fLocal_150 = 20f;
	sLocal_316 = "Omega";
	iLocal_317 = get_weapontype_model(joaat("weapon_digiscanner"));
			...
			case 1:
				if (func_221(Local_81.f_28[0]))
				{
					if (func_221(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_147)
						{
							if (func_219(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > fLocal_150)
							{
								func_217();
								iLocal_147 = 1;
							}
							else if (GAMEPLAY::GET_GAME_TIMER() - iLocal_330 > 7500)
							{
								if (!iLocal_145)
								{
									iLocal_145 = func_205(&uLocal_151, "SCRAPAU", "SCRAP_1_AMB2", 7, 0, 0, 0);
								}
								else if (!iLocal_146)
								{
									iLocal_146 = func_205(&uLocal_151, "SCRAPAU", "SCRAP_1_HANG", 7, 0, 0, 0);
								}
							}
						}
						else if (!iLocal_148 && func_219(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > 50f)
						{
							iLocal_148 = func_205(&uLocal_151, "SCRAPAU", "SCRAP_WALK", 7, 0, 0, 0);
						}
						if (func_219(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > fLocal_149)
						{
							iLocal_143 = 2;
						}
					}
...
int func_36(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_78(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_78(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_78(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_37(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_151(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (is_bit_set(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_78(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_78(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_78(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_69(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_78(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_78(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_78(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_43(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_48(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_78(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_57(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_78(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_70(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_74(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_73(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_71(uVar2, iVar3, iVar0, 1);
	}
}

void func_71(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_72(iParam2)];
	if (iVar0 != 0)
	{
...
int func_73(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	auto uVar1;
	...
	iVar0 = Global_2469339[uParam0 /*5*/][func_72(iParam1)];
...
int func_74(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_75(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_77(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_151(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						*iParam0[func_84(vVar16.z)] = func_65(iParam1, vVar16.x, func_84(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
void func_89(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_95(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_73(func_92(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, true);
			}
			iVar0 = func_73(func_91(iParam1, *uParam0.f_2), Global_69309, 0);
			if (is_bit_set(iVar0, *uParam0.f_1))
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 2);
			}
			...
			{
				iVar0 = func_73(uVar1, Global_69309, 0);
				if (!is_bit_set(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_90(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_93(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_96(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_78(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
bool func_151(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_78(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_78(iParam1)))
	{
		return true;
	}
	return false;
...
void func_157()
{
	...
	{
		if (func_153(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_162(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_163(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_168()
{
	...
	{
		func_157();
		_0xBF59707B3E5ED531(func_169(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_184(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		...
		func_187(iParam0, iParam3, iParam4, 0);
...
bool func_190(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_203(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
int func_205(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
auto func_219(int iParam0, int iParam1)
{
	return func_220(iParam0, iParam1, 1);
}

auto func_220(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_222()
{
	if (func_221(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			task_smart_flee_ped(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			iLocal_144 = 3;
			func_244(5);
			return false;
		}
		else if (func_223(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1))
		{
			task_smart_flee_ped(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			iLocal_144 = 3;
			func_244(5);
...
{
	if (func_224(iParam0) && is_ped_in_any_vehicle(iParam0, 0))
	{
		if (func_224(iParam1))
		{
...
int func_225(int iParam0, int iParam1, Vector3 fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	Vector3 vVar0;
	...
	if (func_221(PLAYER::PLAYER_PED_ID()) && func_221(iParam0))
	{
		...
		if (func_239(iParam0, iParam1, iParam5, iParam6, iParam7))
		{
			return 1;
		}
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
...
bool func_229(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_232(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_234(get_entity_coords(iParam1, 1) - get_entity_coords(iParam0, 1))};
...
int func_238(int iParam0, int iParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_239(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_221(PLAYER::PLAYER_PED_ID()) && func_221(iParam0))
	{
		...
		if (!iParam2)
		{
			...
			if (func_240(iParam0, fVar1, iParam3, iParam4))
			{
				return true;
			}
		}
...
bool func_240(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_242(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	...
	if (func_222())
	{
		switch (iLocal_143)
		{
			case 0:
				if (func_221(Local_81.f_28[0]))
				{
					task_perform_sequence(Local_81.f_28[0], iLocal_326);
				}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_271(1, 1093140480, 0))
			{
				if (func_221(Local_81.f_28[0]))
				{
					register_entity_for_cutscene(Local_81.f_28[0], sLocal_316, 0, false, 0);
				}
				func_270();
				func_269(1, 0, 1, 0);
				start_cutscene(0);
				...
				func_315(0);
				func_268();
				func_260(vLocal_331[0 /*3*/], vLocal_331[1 /*3*/], fLocal_338, 2455.886f, 3432.445f, 49.2697f, 189.77f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if (has_cutscene_finished())
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
				{
					Local_81.f_41[0] = create_object(iLocal_317, 2468.51f, 3437.39f, 55f, 1, true, false);
				}
				iLocal_319 = create_object(iLocal_318, 2472.3f, 3437.3f, 49.3f, 1, true, false);
				if (func_221(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
				{
				...
				if (func_221(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_319))
				{
					attach_entity_to_entity(iLocal_319, Local_81.f_28[0], get_ped_bone_index(Local_81.f_28[0], 64729), vLocal_320, vLocal_323, 0, 0, 0, 0, 2, 1);
				}
				_0x81CBAE94390F9F89();
				iLocal_143 = 2;
			}
...
void func_249(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_253(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_257(player_id())) && !func_255(player_id(), 0)) && !func_254())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_257(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
void func_260(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_261(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_261(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_265(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
bool func_266(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_268()
{
	...
	get_ped_nearby_vehicles(PLAYER::PLAYER_PED_ID(), &uVar1);
	iVar0 = 0;
	while (iVar0 < 16)
	{
		if (func_221(uVar1[iVar0]) && is_entity_in_angled_area(uVar1[iVar0], vLocal_331[0 /*3*/], vLocal_331[1 /*3*/], fLocal_338, 0, true, 0))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar1[iVar0]) == joaat("taxi"))
			{
				if (ENTITY::DOES_ENTITY_EXIST(get_ped_in_vehicle_seat(uVar1[iVar0], -1)))
				{
					set_entity_heading(uVar1[iVar0], 217.679f);
					set_entity_coords(uVar1[iVar0], 2479.249f, 3401.234f, 48.9551f, 1, false, 0, 1);
					return;
				}
			}
		}
...
void func_279()
{
	...
	if (func_222())
	{
		if (GAMEPLAY::GET_GAME_TIMER() < iLocal_327 && !func_280(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 4f, 1))
		{
			...
			task_look_at_entity(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 2000, 0, 2);
		}
		else
		{
			func_246(2);
...
void func_282()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_277(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_287()
{
	...
	request_additional_text("OMEGA1", false);
	request_model(iLocal_317);
	request_model(iLocal_318);
	if (func_222())
	{
		if ((((has_anim_dict_loaded("rcmrc_omega_1leadinoutscrap_1_rcm") && has_anim_dict_loaded("rcmrc_omega_1")) && has_additional_text_loaded(false)) && has_model_loaded(iLocal_317)) && has_model_loaded(iLocal_318))
		{
			open_sequence_task(&iLocal_326);
			task_play_anim(false, "rcmrc_omega_1leadinoutscrap_1_rcm", "leadout_scrap_1_rcm_omega", 8f, -8f, -1, 262144, 0, 0, 0, 0);
			task_play_anim(false, "rcmrc_omega_1", "omega_idle_geiger_counter", 8f, -8f, -1, 262145, 0, 0, 0, 0);
			...
			if (func_224(PLAYER::PLAYER_PED_ID()) && func_224(Local_81.f_28[0]))
			{
				iLocal_329 = get_ped_relationship_group_hash(PLAYER::PLAYER_PED_ID());
				...
				func_288(&uLocal_151, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
...
void func_288(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
struct<2> func_291(int iParam0, int iParam1, int iParam2)
{
	...
	{
		case 1:
			cVar0 = {func_299(iParam0)};
			break;
		
		case 7:
			cVar0 = {func_158(iParam0)};
			break;
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				case 4:
					cVar0 = {func_293(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_292(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_298(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_300(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_302(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_286(0)) || func_301(1))
			{
			}
			else
			{
...
bool func_307(auto uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				*uParam0.f_41[0] = create_object(iVar0[1], 2468.51f, 3437.39f, 55f, 1, true, false);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_41[1]))
			{
				*uParam0.f_41[1] = create_object(iVar0[2], 2468.51f, 3437.39f, 57f, 1, true, false);
			}
			if ((func_221(*uParam0.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(*uParam0.f_41[0])) && ENTITY::DOES_ENTITY_EXIST(*uParam0.f_41[1]))
			{
...
bool func_308(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_309(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_309(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_310(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_314(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = iParam3;
...
void func_315(int iParam0)
{
	...
	if (func_221(iParam0))
	{
		if (is_entity_in_angled_area(iParam0, vLocal_331[0 /*3*/], vLocal_331[1 /*3*/], fLocal_338, 0, true, 0))
		{
			...
			if (is_model_valid(iVar14))
			{
				...
				if (iVar13)
				{
					...
					set_entity_coords(iParam0, 2531.08f, 3357.171f, 50.9746f, 1, false, 0, 1);
				}
			}
		}
	}
...
void func_318(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_363(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_362(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = {Global_95496.f_2311};
			fParam4 = Global_95496.f_2311.f_6;
		}
		clear_area(vParam1, 5f, 1, 0, 0, false);
		func_356(vParam1, 5f, 0);
		if (func_154(iParam12))
		{
			func_354(iParam12, 0);
			while (!func_319(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				wait(0);
			}
		}
...
bool func_319(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5)
{
	int iVar0;
	auto uVar1;
	struct<97> Var5;
...
void func_320(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && is_vehicle_driveable(*iParam1, 0))
	{
		...
		if ((get_vehicle_mod_kit(*iParam1) >= 0 && get_vehicle_mod_kit(*iParam1) < 255) && func_325(*iParam1, 0, &uVar0))
		{
...
bool func_321(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_322(int iParam0, char* sParam1, auto uParam2, auto uParam3, auto uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
bool func_324(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_325(int iParam0, int iParam1, auto uParam2)
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_327(iVar0, iParam1, uParam2))
	{
		return false;
	}
...
bool func_327(int iParam0, int iParam1, auto uParam2)
{
	if (!iParam1)
	{
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_331(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_263(iParam0, 0, 0)) || func_263(iParam0, 1, 0)) || func_263(iParam0, 2, 0)) || func_344(iParam0) != 145) || func_343(iParam0)) || func_342(iParam0)) || func_326(iParam0)) || func_341(iParam0)) || !func_333(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_342(iParam0))
		{
		}
...
bool func_348(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_351(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && get_vehicle_mod(*iParam0, 24) != func_350(*iParam0, *uParam1[38] - 1))
	{
		set_vehicle_mod(*iParam0, 24, func_350(*iParam0, *uParam1[38] - 1), false);
	}
	if (func_349(*iParam0))
	{
...
void func_353(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_354(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_88942[iVar0]) == func_355(iParam0, iParam1))
				{
...
void func_356(Vector3 vParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_358(auto uParam0, auto uParam1)
{
...
auto func_360(auto uParam0)
{
	return *uParam0;
}

int func_361(auto uParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_362(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
int func_363(Vector3 vParam0, Vector3 fParam1)
{
	return func_364(&(Global_95496.f_2311), vParam0, fParam3, 0);
}

int func_364(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
	int iVar4;
	...
	if (func_374(uParam0))
	{
		...
		if (func_373(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_366(iVar0, *uParam0.f_3, *uParam0.f_8) && *uParam0.f_10) && are_strings_equal(get_this_script_name(), "startup_positioning"))
				{
...
bool func_366(int iParam0, Vector3 vParam1, int iParam2)
{
	int iVar0;
	var[] uVar1 = new var[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_368(iParam0, uVar1[iVar6], 1) && func_367(get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_362(vParam1, 0f, 0f, 0f, 0)) || get_distance_between_coords(get_entity_coords(iParam0, 1), get_entity_coords(uVar1[iVar6], 1), 1) < 10f)
					{
...
bool func_367(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_369(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (is_bit_set(*uParam1.f_77, func_331(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (is_bit_set(*uParam1.f_77, func_331(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_331(iVar1 + 1));
			}
		}
		...
		if (((is_bit_set(*uParam1.f_77, 15) || func_372(iParam0)) || (((*uParam1.f_62 == 0 && *uParam1.f_63 == 0) && *uParam1.f_64 == 0) && *uParam1.f_9[20] > 0)) && func_371())
		{
			*uParam1.f_62 = 0;
			*uParam1.f_63 = 0;
			*uParam1.f_64 = 0;
		...
		if (!is_this_model_a_heli(*uParam1.f_66) && !is_this_model_a_boat(*uParam1.f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (is_bit_set(*uParam1.f_77, func_331(iVar2 + 1)))
				{
...
void func_385(auto uParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_402(int iParam0)
{
	...
	if (!func_419())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_403(get_this_script_name(), iVar0);
		}
		else
		{
			if (Global_100241[iVar0 /*10*/].f_9 == -1)
...
bool func_404(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_410())
	{
		...
		{
			iVar33 = func_405(get_this_script_name());
			if (iVar33 > -1)
			{
