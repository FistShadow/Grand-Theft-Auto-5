#region Local Var
	...
	int iLocal_110 = 0;
	auto uLocal_111 = 0;
	auto uLocal_112 = 1065353216;
	auto uLocal_113 = 1065353216;
	auto uLocal_114 = 1;
	auto uLocal_115 = 0;
	auto uLocal_116 = 0;
	auto uLocal_117 = 0;
	...
	while (true)
	{
		...
		if (func_630() && func_629())
		{
			if (!func_628())
			{
				if (func_625())
				{
					func_606(170, ENTITY::GET_ENTITY_COORDS(func_624(), 1), &uLocal_159, 1140457472, 700f, iLocal_160);
				}
				else
				{
					func_606(170, ENTITY::GET_ENTITY_COORDS(func_605(), 1), &uLocal_159, 1140457472, 700f, iLocal_160);
				}
			}
		}
		func_584();
...
void func_2(int iParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&(Local_196.f_1), iParam0);
}
...
void func_4(int iParam0)
{
	...
	GAMEPLAY::SET_BIT(&(Local_196.f_1), iParam0);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Local_196.f_1, iParam0);
}

int func_9(int iParam0, int iParam1)
{
	return GAMEPLAY::IS_BIT_SET(vLocal_310[iParam0 /*3*/].f_1, iParam1);
}
...
void func_10()
{
	switch (func_63())
	{
		...
		case 2:
			func_15();
			if (!func_60(&(Local_196.f_20)) && !ENTITY::IS_ENTITY_DEAD(func_605(), 0))
			{
...
{
	return network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_31[iParam0 /*17*/]);
}

int func_22()
{
	return network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_100);
}
					...
					if (func_21(iVar0))
					{
						if (func_22())
						{
							if (!func_18(func_20(iVar0), func_19(), 0))
							{
								if (!func_25())
								{
									if (!is_vehicle_driveable(func_19(), 0) || ENTITY::IS_ENTITY_DEAD(func_19(), 0))
									{
										if (!PED::IS_PED_INJURED(func_20(iVar0)))
										{
											Local_196.f_31[iVar0 /*17*/].f_10 = 2;
...
bool func_25()
{
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_100))
	{
		...
		if (func_34() > func_33())
		{
			...
			else if (iLocal_174)
			{
				if (is_entity_in_air(func_624()))
				{
					...
					{
						vLocal_175 = {ENTITY::GET_ENTITY_COORDS(func_624(), 0)};
					}
				}
				else if (!func_30(vLocal_175))
				{
					iVar1 = Local_196.f_13 / 5;
					vLocal_178 = {ENTITY::GET_ENTITY_COORDS(func_624(), 0)};
					fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_175, vLocal_178, 1);
...
auto func_38(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
auto func_41(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_48(auto uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return true;
...
int func_52()
{
	...
	while (iVar4 < 32)
	{
		if (network_is_participant_active(int_to_participantindex(iVar4)))
		{
			...
			if (!func_53(iVar2))
			{
				if (ENTITY::IS_ENTITY_DEAD(func_605(), 0))
				{
...
void func_59(auto uParam0, int iParam1, int iParam2)
{
	if (*uParam0.f_1 == 0)
	{
		...
		if (func_70(Local_196.f_31[iParam0 /*17*/].f_5))
		{
			if (can_register_mission_peds(1))
			{
				if (func_69(&(Local_196.f_31[iParam0 /*17*/]), 26, Local_196.f_31[iParam0 /*17*/].f_5, Local_196.f_31[iParam0 /*17*/].f_1, Local_196.f_31[iParam0 /*17*/].f_4, 1, 1, 1))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(func_20(iParam0), Global_1574233);
					if (iParam0 == 3)
					{
...
bool func_69(auto uParam0, int iParam1, int iParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
bool func_73(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
		...
		if (func_70(Local_196.f_27))
		{
			if (can_register_mission_objects(1))
			{
				if (func_76(&(Local_196.f_22), Local_196.f_27, Local_196.f_23, 1, 1, 0, 1))
				{
					...
					ENTITY::SET_ENTITY_HEALTH(func_624(), func_75());
...
bool func_76(auto uParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (!can_register_mission_objects(1))
	{
		return false;
		...
		if (func_70(Local_196.f_19))
		{
			if (can_register_mission_vehicles(1))
			{
				if (func_73(&(Local_196.f_14), Local_196.f_19, Local_196.f_15, Local_196.f_18, 1, 1, 1, 0, 1, 1))
				{
					...
					ENTITY::SET_ENTITY_HEALTH(func_31(), func_79());
...
bool func_81()
{
	if (!func_8(1))
	{
		if (func_86())
		{
			Local_196.f_11 = iLocal_155[GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3)];
			Local_196.f_12 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3);
			if (func_85() > -1)
			{
...
bool func_86()
{
	...
	if (func_680(player_id(), 1, 1))
	{
		...
		while (iVar0 < 11)
		{
			fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar6, func_87(iVar0), 0);
			if (fVar1 < fVar2[0])
			{
				fVar2[2] = fVar2[1];
...
bool func_92(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_97()
{
	...
	{
		if ((((((((!is_radar_hidden() && !GAMEPLAY::IS_BIT_SET(Global_2460486.f_743, 2)) && func_680(player_id(), 1, 1)) && !Global_68058) && !Global_52930) && !is_screen_faded_out()) && !func_102(player_id(), 22)) && func_108(player_id()) != 0) && !func_100(func_101()))
		{
...
void func_117(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar1 > 0)
	{
		...
		func_187();
		func_136(0, PLAYER::PLAYER_PED_ID(), "", -875716015, 1626430110, iVar1, 1, -1, 0, 0);
	}
	if (iVar0 > 0)
	{
...
void func_122(int iParam0, int iParam1, auto uParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_123(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_130(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, auto uParam8)
{
	int iVar0;
...
void func_134(int iParam0, auto uParam1, auto uParam2)
{
...
Vector3 func_141(int iParam0, int iParam1)
{
	...
	if (iParam0 == func_142(PLAYER::PLAYER_PED_ID()) && _0xEE778F8C7E1142E2(_0x19CAFA3C87F7C2FF()) == 4)
	{
...
float func_146(Vector3 vParam0, auto uParam1, auto uParam2)
{
	Vector3 fVar0;
	float fVar1;
	float fVar2;
...
auto func_147(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	auto uVar0;
...
bool func_162(int iParam0, auto uParam1)
{
	if (Global_1315901)
	{
		return false;
...
void func_188(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1)
	{
		if (iParam2 > -1)
		{
			if (func_176(iVar0, iParam2, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_210(1);
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!iVar1)
	{
		if (iVar0 != -1)
		{
			if ((func_217(iParam1, iParam0, iVar0, 0) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)) || ((func_176(get_player_team(iParam1), get_player_team(iParam0), 0) && GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 23)) && !GAMEPLAY::IS_BIT_SET(Global_1617379.f_15, 18)))
			{
				return func_210(1);
			}
...
void func_233(int iParam0, auto uParam1, auto uParam2)
{
	struct<4> Var0;
...
auto func_243(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
int func_251(int iParam0)
{
	...
	if (func_258(iParam0))
	{
		...
		if (iVar1 < func_252(iParam0))
		{
			...
			{
				iVar0 += func_256(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(true, 6));
				iVar2++;
			}
		}
	}
...
void func_266(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
			...
			if (func_60(&(Local_196.f_20)))
			{
				...
				if (func_436(1))
				{
					if (!func_455() && !func_454())
					{
						if (iLocal_154 >= 0)
						{
							if (func_18(PLAYER::PLAYER_PED_ID(), func_31(), 1) || (func_329() && func_18(func_219(), func_31(), 1)))
							{
						...
						else if (func_18(PLAYER::PLAYER_PED_ID(), func_31(), 1) || (func_329() && func_18(func_219(), func_31(), 1)))
						{
							if ((!func_286() && func_625()) || func_329())
							{
...
int func_287(auto uParam0, int iParam1, int iParam2)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !iParam1)
	{
		if (!iParam2)
		...
		case 2:
			if (func_630())
			{
				if (func_288())
				{
					if (func_625() || func_329())
					{
						if (func_18(PLAYER::PLAYER_PED_ID(), func_31(), 0) || (func_329() && func_18(func_219(), func_31(), 0)))
						{
...
{
	GAMEPLAY::SET_BIT(&(vLocal_310[participant_id_to_int() /*3*/].f_1), iParam0);
}
...
bool func_331()
{
	if (func_629())
	{
		if (func_41(PLAYER::PLAYER_PED_ID(), func_624(), 1) < 150f)
		{
			return true;
		}
	}
...
bool func_334(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
...
void func_348()
{
	...
	{
		if (func_351(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_362(int iParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7)
{
	struct<72> Var0;
...
void func_369(auto uParam0, auto uParam1, int iParam2, char* sParam3, char* sParam4)
{
	*uParam1.f_16 = func_3();
	*uParam1.f_17 = func_3();
	*uParam1.f_18 = func_3();
...
int func_370(int iParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	auto uVar0;
	auto uVar1;
	auto uVar2;
...
int func_371(auto uParam0, char* sParam1, char* sParam2, char* sParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, char* sParam8, int iParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13)
{
	struct<72> Var0;
...
void func_383()
{
	if (!GAMEPLAY::IS_BIT_SET(iLocal_195, 3))
	{
		if (iLocal_152 > 35000)
		{
			if (func_625())
		...
		else if ((func_625() || func_270(player_id())) || func_578(11))
		{
			switch (iLocal_194)
			{
				...
				case 1:
					if (!GAMEPLAY::IS_BIT_SET(iLocal_195, true))
					{
						if (iLocal_152 <= 30000)
						{
							if (prepare_music_event("APT_COUNTDOWN_30S"))
							{
								...
								GAMEPLAY::SET_BIT(&iLocal_195, true);
							}
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(iLocal_195, 2))
					{
						if (iLocal_152 <= 27000)
						{
...
{
	GAMEPLAY::SET_BIT(&iLocal_130, iParam0);
}

int func_386(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(iLocal_130, iParam0);
}
...
void func_391()
{
	if (func_630())
	{
		if (!func_628())
		{
			if (func_625())
			{
				if (func_680(player_id(), 1, 1) && func_18(PLAYER::PLAYER_PED_ID(), func_31(), 0))
				{
					if (get_ped_in_vehicle_seat(func_31(), -1) == PLAYER::PLAYER_PED_ID())
					{
...
{
	GAMEPLAY::CLEAR_BIT(&(vLocal_310[participant_id_to_int() /*3*/].f_1), iParam0);
}
...
void func_395()
{
	if (func_629())
	{
		...
		else if (func_41(PLAYER::PLAYER_PED_ID(), func_624(), 1) > 150f || func_8(11))
		{
			func_396(10);
		}
	}
...
{
	GAMEPLAY::CLEAR_BIT(&iLocal_127, iParam0);
}
			...
			if (func_382(participant_id_to_int()) == 1)
			{
				if (func_578(10))
				{
					if (iLocal_160 == 0 || func_410())
					{
						...
						func_401(ENTITY::GET_ENTITY_COORDS(func_624(), 1), 1, 0);
						iLocal_160 = 1;
					}
				}
				else if (iLocal_160)
...
void func_402(Vector3 vParam0, auto uParam1, float fParam2, int iParam3, float fParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	struct<25> Var0;
...
int func_411()
{
	return ENTITY::IS_ENTITY_DEAD(func_624(), 0);
}
	...
	if (!func_625() && !func_329())
	{
		if (func_327())
		{
			if (!func_578(5))
			{
				...
				if (func_41(PLAYER::PLAYER_PED_ID(), func_605(), 1) <= 100f)
				{
					func_380();
					func_557(5);
				}
			...
			if (!func_270(player_id()))
			{
				if (!func_578(11))
				{
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_14))
					{
						if (func_41(PLAYER::PLAYER_PED_ID(), func_605(), 0) < 500f)
						{
							func_557(11);
							func_116(19);
							func_376(1);
				...
				else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_14))
				{
					if (func_41(PLAYER::PLAYER_PED_ID(), func_605(), 0) > 700f)
					{
						func_396(11);
						func_379(19);
						func_376(0);
	...
	while (iVar0 < 4)
	{
		if (!does_blip_exist(uLocal_134[iVar0]))
		{
			if (func_21(iVar0))
			{
				if (!PED::IS_PED_INJURED(func_20(iVar0)) && !ENTITY::IS_ENTITY_DEAD(func_20(iVar0), 0))
				{
					if (Local_196.f_31[iVar0 /*17*/].f_9 == 1 && func_41(PLAYER::PLAYER_PED_ID(), func_20(iVar0), 0) <= 100f)
					{
		...
		{
			if (((PED::IS_PED_INJURED(func_20(iVar0)) || ENTITY::IS_ENTITY_DEAD(func_20(iVar0), 0)) || Local_196.f_31[iVar0 /*17*/].f_9 == 0) || func_41(PLAYER::PLAYER_PED_ID(), func_20(iVar0), 0) > 100f)
			{
...
int func_426(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_427(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_427(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
void func_431(auto uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
...
void func_460()
{
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_14))
	{
...
void func_468()
{
	if (network_ENTITY::DOES_ENTITY_EXIST_with_network_id(Local_196.f_22))
	{
...
void func_471()
{
	...
	while (iVar0 < 4)
	{
		if (func_21(iVar0))
		{
			if (func_625())
			{
				if (func_41(PLAYER::PLAYER_PED_ID(), func_20(iVar0), 1) < 50f && is_ped_on_foot(PLAYER::PLAYER_PED_ID()))
				{
					func_330(2);
					return;
				}
				if ((func_41(PLAYER::PLAYER_PED_ID(), func_20(iVar0), 1) < 100f && func_387()) && is_entity_in_air(func_31()))
				{
					func_330(2);
					return;
				}
			}
			if (func_41(PLAYER::PLAYER_PED_ID(), func_20(iVar0), 1) < 50f && is_ped_shooting(PLAYER::PLAYER_PED_ID()))
			{
				func_330(2);
				return;
			}
	...
	while (iVar0 < 4)
	{
		if (func_21(iVar0))
		{
			switch (Local_196.f_31[iVar0 /*17*/].f_10)
			{
				...
				case 3:
					if ((func_22() && is_vehicle_driveable(func_19(), 0)) && !ENTITY::IS_ENTITY_DEAD(func_19(), 0))
					{
						if (network_has_control_of_network_id(Local_196.f_31[iVar0 /*17*/]))
						{
							if (!func_18(func_20(iVar0), func_19(), 0))
							...
							else if ((((!PED::IS_PED_INJURED(func_20(iVar0)) && func_26(func_20(iVar0))) && func_26(func_19())) && func_630()) && func_26(func_31()))
							{
	...
	if (func_630())
	{
		if (network_has_control_of_network_id(func_32()) && !func_628())
		{
			if (((is_vehicle_stuck_timer_up(func_31(), 0, func_556()) || is_vehicle_stuck_timer_up(func_31(), 1, func_556())) || is_vehicle_stuck_timer_up(func_31(), 3, func_556())) || is_vehicle_stuck_timer_up(func_31(), 2, func_556()))
			{
				...
				Var4.f_11 = 0;
				Var4.f_4 = 0;
				if (func_484(ENTITY::GET_ENTITY_COORDS(func_31(), 1), 0f, 0f, 0f, Local_196.f_19, 1, &vVar0, &fVar3, &Var4))
				{
...
bool func_484(Vector3 vParam0, Vector3 vParam1, int iParam2, int iParam3, auto uParam4, auto uParam5, auto uParam6)
{
	int iVar0;
	int iVar1;
	struct<57> Var2;
	...
	if (!Global_2404956.f_558 == 0 && get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_563) < func_555(0))
	{
	...
	if (!get_id_of_this_thread() == Global_2404956.f_609)
	{
		if (!Global_2404956.f_610 == 0)
		{
			if (get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_613) < func_555(0))
			{
				return false;
			}
			else
	...
	else
	{
		...
		if (!Global_2404956.f_610 == 0)
		{
			if (get_time_difference(NETWORK::GET_NETWORK_TIME(), Global_2404956.f_613) > func_555(1))
			{
				Global_2404956.f_610 = 0;
			}
		}
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && player_id() != iVar1) || iParam9 == 0)
		{
			if (func_680(iVar1, iParam5, iParam6))
			{
				...
				{
					if (!iParam8 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_492(iVar1)))
					{
...
void func_488(auto uParam0, Vector3 vParam1)
{
	Vector3 fVar0;
	Vector3 fVar1;
	Vector3 vVar2;
...
void func_496(Vector3 vParam0, auto uParam1, int iParam2)
{
	struct<7> Var0;
...
auto func_497(int iParam0, int iParam1)
{
	auto uVar0;
	int iVar1;
	int iVar2;
...
void func_498(auto uParam0, auto uParam1, auto uParam2)
{
...
void func_499(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 fVar4;
...
void func_500(auto uParam0, auto uParam1, auto uParam2, Vector3 vParam3)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
void func_504(int iParam0, auto uParam1)
{
...
bool func_513(Vector3 vParam0, auto uParam1)
{
	if (*uParam3.f_18)
	{
		switch (*uParam3.f_26)
...
void func_515(auto uParam0, auto uParam1)
{
	auto uVar0;
...
int func_519(Vector3 vParam0, auto uParam1)
{
	return is_point_in_angled_area(vParam0, *uParam3, *uParam3.f_3, *uParam3.f_6, 0, true);
}

int func_520(struct<2> Param0, auto uParam1)
{
...
bool func_521(auto uParam0, int iParam1)
{
	auto uVar0;
	Vector3 vVar1;
...
bool func_522(Vector3 vParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
int func_523(Vector3 vParam0, auto uParam1, float fParam2, int iParam3, int iParam4)
{
	switch (*uParam3.f_10)
	{
		case 0:
...
void func_525(auto uParam0, Vector3 vParam1, float fParam2, float fParam3, int iParam4)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
int func_527(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_529(auto uParam0, Vector3 vParam1, Vector3 vParam2, float fParam3, float fParam4, int iParam5)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
...
void func_531(auto uParam0, struct<2> Param1, auto uParam2, struct<2> Param3, auto uParam4, float fParam5, int iParam6)
{
	Vector3 vVar0;
	float fVar3;
	float fVar4;
...
bool func_532(Vector3 vParam0, auto uParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
bool func_534(auto uParam0, int iParam1, int iParam2)
{
	auto uVar0;
	auto uVar1;
	Vector3 vVar2;
...
void func_535(auto uParam0, auto uParam1, float fParam2, int iParam3, int iParam4)
{
	if (iParam4)
	{
		switch (*uParam1.f_10)
...
bool func_536(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	Vector3 vVar1;
...
int func_537(auto uParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	Vector3 vVar1;
	Vector3 fVar4;
	...
	if (iParam4 && !iParam7)
	{
		if (func_680(player_id(), 1, 1))
		{
			if (!is_screen_faded_out())
			{
				...
				if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_179(player_id()), vParam0, 1) <= fVar2 + fParam3)
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != player_id()))
				{
					if ((func_492(iVar1) || !iParam10) && !Global_2418472[iVar1 /*313*/].f_255)
					{
						...
						if (!iParam7)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_179(iVar1), vParam0, 1) <= fVar2 + fParam3)
								{
...
bool func_543(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, auto uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && player_id() != iVar1) || iParam8 == 0)
		{
			if (func_680(iVar1, iParam4, iParam5))
			{
				if (_0x9DE986FC9A87C474(player_id(), iVar1))
				{
					if (!iParam7 || (!PED::IS_PED_INJURED(get_player_ped(iVar1)) && func_492(iVar1)))
					{
						if ((!iParam6 || (iParam6 == 1 && get_player_team(player_id()) != get_player_team(iVar1))) || get_player_team(player_id()) == -1)
						{
							...
							{
								if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(func_179(iVar1), vParam0, 1) < fParam3)
								{
									return true;
								}
							}
...
bool func_548(auto uParam0, int iParam1)
{
	int iVar0;
	Vector3 vVar1;
...
{
	GAMEPLAY::SET_BIT(&iLocal_127, iParam0);
}
...
void func_565(float fParam0)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(get_this_script_name()) == func_566())
	{
		return;
	}
...
{
	return GAMEPLAY::IS_BIT_SET(iLocal_127, iParam0);
}
...
int func_593(int iParam0)
{
	switch (iParam0)
	{
		...
		case 3:
			return GAMEPLAY::GET_RANDOM_INT_IN_RANGE(func_596(), func_595() + 1);
...
void func_606(int iParam0, Vector3 vParam1, auto uParam2, float fParam3, float fParam4, auto uParam5)
{
	float fVar0;
	float fVar1;
	
	if (((func_114(player_id()) && !func_113(player_id())) && !GAMEPLAY::IS_BIT_SET(Global_1610316[player_id() /*174*/].f_1, 8)) && (func_111(player_id()) || func_110(player_id())))
	{
		return;
	}
...
int func_628()
{
	return ENTITY::IS_ENTITY_DEAD(func_605(), 0);
}

int func_629()
{
	return network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_289());
}

int func_630()
{
	return network_ENTITY::DOES_ENTITY_EXIST_with_network_id(func_32());
}
...
bool func_638(int iParam0, auto uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
bool func_647(auto uParam0, int iParam1, int iParam2)
{
	if (iParam2)
	{
...
bool func_655(auto uParam0, int iParam1)
{
...
void func_658(auto uParam0, auto uParam1, auto uParam2, int iParam3)
{
	char* sVar0;
	struct<14> Var1;
	struct<17> Var15;
...
void func_662(int iParam0, auto uParam1)
{
...
void func_678(int iParam0, struct<17> Param1, auto uParam2, auto uParam3, auto uParam4)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_671();
