#region Local Var
	...
	auto uLocal_56 = 0;
	auto uLocal_57 = 0;
	auto uLocal_58 = 1092616192;
	auto uLocal_59 = 1101004800;
	auto uLocal_60 = 0;
	auto uLocal_61 = 0;
	auto uLocal_62 = 0;
	auto uLocal_63 = 0;
	...
	auto uLocal_240 = 0;
	int iLocal_241 = 0;
	struct<8>[] Local_242 = new struct<8>[10];
	int iLocal_323 = 0;
	int iLocal_324 = 0;
	int iLocal_325 = 0;
	int iLocal_326 = 0;
...
void main()
{
	...
	StringCopy(&Local_39, "PMPLANE", 16);
	StringCopy(&Local_43, "", 16);
	iLocal_49 = -1;
	set_mission_flag(1);
...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_241))
	{
		...
		{
			if (!is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_241, 0))
			{
				if (!does_blip_exist(iLocal_50))
				{
					func_130("BK_PLANE", 7500, 1);
					iLocal_50 = func_129(iLocal_241, 0, 0);
				}
				if (func_128(PLAYER::PLAYER_PED_ID(), iLocal_241, 1) > 300f)
				{
					func_131();
				}
			}
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_241) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)) && is_entity_in_air(iLocal_241)) && iLocal_325) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false))
	{
		if (!iLocal_326)
		{
			if (is_control_just_pressed(0, 114))
			{
				...
				{
					if (!does_particle_fx_looped_exist(iLocal_332))
					{
						iLocal_332 = start_particle_fx_looped_on_entity("scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_330 = 0f;
					}
					if (func_127("LEAFLET"))
					{
	...
	else if (does_particle_fx_looped_exist(iLocal_332))
	{
		stop_particle_fx_looped(iLocal_332, 0);
		fLocal_330 = 0f;
	}
	if (does_particle_fx_looped_exist(iLocal_332))
	{
		...
		fLocal_330 += fVar7 * timestep() * 100f;
		fLocal_330 = func_126(fLocal_330, 0f, 1f);
		set_particle_fx_looped_evolution(iLocal_332, "spawn", fLocal_330, 0);
	}
	switch (iLocal_47)
	{
		case 0:
			...
			{
				iLocal_241 = Global_99866.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
					iLocal_241 = create_vehicle(joaat("stunt"), vVar0, 121.2244f, 1, true);
					set_vehicle_on_ground_properly(iLocal_241);
				}
				else
				{
					set_entity_as_mission_entity(iLocal_241, true, 1);
				}
				...
				iLocal_50 = func_129(iLocal_241, 0, 0);
				request_ptfx_asset();
				func_123(&iLocal_51, 1, 0);
				iLocal_47++;
			}
			break;
		
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_241) && is_vehicle_driveable(iLocal_241, 0))
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_241, 0))
				{
					clear_prints();
		...
		case 3:
			if (func_23(&iLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !is_entity_in_air(iLocal_241))
			{
				func_123(&iLocal_51, 1, 0);
				iLocal_47++;
			}
	...
	switch (iLocal_48)
	{
		case 0:
			...
			else if ((func_20() && GAMEPLAY::GET_GAME_TIMER() - iLocal_49 > 5000) && iLocal_329)
			{
				...
				StringConCat(&cVar3, &Local_43, 16);
				if (func_19(49) && GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3) == 0)
				{
				...
				if (func_2(&uLocal_76, &Local_39, &cVar3, 8, 0, 0, 0))
				{
					iLocal_331++;
					if (iLocal_331 >= 6)
					{
		...
		case 1:
			...
			{
				if (func_2(&uLocal_76, &Local_39, "DONE", 8, 0, 0, 0))
				{
					StringCopy(&cVar3, "", 16);
					iLocal_48++;
				}
...
int func_23(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, char* sParam7, char* sParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	return func_24(iParam0, vParam1, func_68(), vParam4, vParam7, iParam11, 5, 0, 0, 0, iParam12, sParam13, func_67(), func_67(), func_67(), func_67(), sParam14, 0, iParam16, sParam15, 1, iParam17, iParam18, iParam19, func_67(), func_67(), func_67(), 1, fParam10);
}

bool func_24(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 vParam3, Vector3 vParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, int iParam17, int iParam18, char* sParam19, int iParam20, int iParam21, int iParam22, int iParam23, auto uParam24, auto uParam25, auto uParam26, int iParam27, Vector3 fParam28)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*iParam0.f_16 = iParam15;
	...
	func_65(iParam0);
	func_64();
	if (func_47(iParam0, *iParam0.f_17[0], *iParam0.f_17[1], *iParam0.f_17[2], sParam20, sParam21, sParam22, sParam23, *iParam0.f_8, iParam25, iParam18, 0, 0, uParam32, uParam33, uParam34, iParam14, iParam26))
	{
		func_46(sParam20);
		func_46(sParam21);
		func_46(sParam22);
		...
		if (is_screen_faded_in())
		{
			...
			if (iVar1)
			{
				...
				if (iParam26 && is_player_wanted_level_greater(player_id(), 0))
				{
					...
					if ((!func_41(iParam0, 1) && !func_40(iParam0)) && !GAMEPLAY::IS_BIT_SET(*iParam0.f_13, false))
					{
						if (iParam30)
						{
							func_39(iParam0, "LOSE_WANTED", 0);
							if (!PED::IS_PED_INJURED(*iParam0.f_17[0]))
							{
								func_37(*iParam0.f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
							}
						}
				...
				else
				{
					...
					if (GAMEPLAY::IS_BIT_SET(*iParam0.f_13, true))
					{
						if (!func_41(iParam0, 1))
						{
							if (!PED::IS_PED_INJURED(*iParam0.f_17[0]))
							{
								func_37(*iParam0.f_17[0], "LOSE_WANTED_LEVEL", 3);
							}
							GAMEPLAY::CLEAR_BIT(iParam0.f_13, true);
						}
					}
					if (!does_blip_exist(*iParam0.f_5))
					{
						...
						*iParam0.f_5 = func_36(vVar3, 0);
						...
						if (iParam35)
						{
							func_35(*iParam0.f_5, iParam0);
						}
					}
					else if (!func_34(vVar3, get_blip_coords(*iParam0.f_5), 0.1f, 0))
					{
					...
					if (iVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(*iParam0.f_17[iVar2]))
							{
								...
								else if (!is_ped_group_member(*iParam0.f_17[iVar2], func_33()) || !func_31(*iParam0.f_17[iVar2], 1))
								{
									iVar1 = false;
								}
							}
						...
						if (!func_41(iParam0, 2))
						{
							...
							else if (GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 9))
							{
								...
								if (!GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 23))
								{
									if (!PED::IS_PED_INJURED(*iParam0.f_17[0]))
									{
										func_37(*iParam0.f_17[0], "GET_IN_CAR", 3);
									}
						...
						if (!func_41(iParam0, 2))
						{
							if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
							{
								if (!GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 13))
								{
									...
									{
										func_37(*iParam0.f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
									}
									func_39(iParam0, "MORE_SEATS", 0);
...
{
	return func_26(iParam0, !iParam1, iParam2);
}
...
bool func_28(int iParam0)
{
	if (GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 12))
	{
		...
		{
			if (func_29(1, 0, 1) || GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 7))
			{
				return true;
			}
		}
	}
	else if (func_29(1, 0, 1) || GAMEPLAY::IS_BIT_SET(*iParam0.f_13, 7))
	{
		return true;
	}
	return false;
...
bool func_31(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && iParam1)
		{
			...
			{
				set_group_separation_range(func_33(), 50f);
				return true;
			}
		}
		else if (is_ped_group_member(iParam0, func_33()))
		{
			set_group_separation_range(func_33(), 50f);
			return true;
		}
...
bool func_34(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	_play_ambient_speech1(iParam0, sParam1, func_38(iParam2), 1);
}
...
bool func_45(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_47(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, char* sParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, auto uParam13, auto uParam14, auto uParam15, int iParam16, int iParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0.f_16 = uParam1;
						...
						if (func_45(*uParam0.f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
								{
									...
									if (is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
									{
										remove_ped_from_group(*uParam0.f_17[iVar0]);
									}
									if (AI::GET_SCRIPT_TASK_STATUS(*uParam0.f_17[iVar0], -1794415470) == 7 && !func_63(*uParam0.f_17[iVar0], *uParam0.f_21))
									{
		...
		if (iVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
				{
					...
					if (!is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
					{
						if (func_61(uParam0, *uParam0.f_17[iVar0], fParam8, 1))
						{
							set_ped_as_group_member(*uParam0.f_17[iVar0], func_33());
						}
					}
				}
				iVar0++;
	...
	if (!GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 26))
	{
		if ((!func_60(uParam0) && is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
			if ((!PED::IS_PED_INJURED(*uParam0.f_17[0]) || !PED::IS_PED_INJURED(*uParam0.f_17[1])) || !PED::IS_PED_INJURED(*uParam0.f_17[2]))
			{
				...
				{
					if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()) && !func_41(uParam0, 2))
					{
						iVar13 = get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0);
				...
				if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
				{
					...
					if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (is_vehicle_driveable(iVar13, 0))
						{
							if (is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
							{
								if (!func_60(uParam0) && is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
								{
					...
					if (is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar32))
						{
							...
							{
								if (func_57(iVar0, uParam0) || !GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 27))
								{
									set_ped_group_member_passenger_index(*uParam0.f_17[iVar0], iVar0);
					...
					if ((!is_ped_group_member(*uParam0.f_17[iVar0], func_33()) && !func_54(*uParam0.f_17[iVar0], iParam10)) && !func_53(*uParam0.f_17[iVar0], iParam10))
					{
						if (func_61(uParam0, *uParam0.f_17[iVar0], fParam8, iParam11))
						{
							if (!is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
							{
					...
					{
						if (((func_31(*uParam0.f_17[iVar0], 1) || func_54(*uParam0.f_17[iVar0], iParam10)) || iParam12) || (is_vehicle_driveable(iParam10, 0) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
						{
							if (does_blip_exist(*uParam0.f_1[iVar0]))
							{
					...
					else if (is_vehicle_driveable(iParam10, 0))
					{
						if (!is_ped_sitting_in_vehicle(*uParam0.f_17[iVar0], iParam10))
						{
							if ((is_entity_at_entity(*uParam0.f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !GAMEPLAY::IS_BIT_SET(*uParam0.f_13, 11)) && !((iParam17 && is_player_wanted_level_greater(player_id(), 0)) && !is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!is_ped_jumping_out_of_vehicle(*uParam0.f_17[iVar0]) && !is_ped_jumping_out_of_vehicle(PLAYER::PLAYER_PED_ID())) && !func_52(*uParam0.f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(*uParam0.f_17[iVar0])) && !is_ped_getting_up(*uParam0.f_17[iVar0])) && !is_entity_on_fire(iParam10))
										{
											set_blocking_of_non_temporary_events(*uParam0.f_17[iVar0], true);
							...
							else if (!is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
							{
								if (func_61(uParam0, *uParam0.f_17[iVar0], fParam8, iParam11))
								{
									if (!PED::IS_PED_RAGDOLL(*uParam0.f_17[iVar0]) && !is_ped_getting_up(*uParam0.f_17[iVar0]))
						...
						else if (is_ped_group_member(*uParam0.f_17[iVar0], func_33()) && !is_entity_on_fire(iParam10))
						{
							remove_ped_from_group(*uParam0.f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
						{
							if (func_58(*uParam0.f_17[iVar0]) || is_entity_at_entity(*uParam0.f_17[iVar0], PLAYER::PLAYER_PED_ID(), *uParam0.f_8, *uParam0.f_8, *uParam0.f_8, 0, 1, 0))
							{
								iVar1--;
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!is_entity_at_entity(*uParam0.f_17[iVar0], PLAYER::PLAYER_PED_ID(), *uParam0.f_8 * 0.85f, *uParam0.f_8 * 0.85f, *uParam0.f_8, 0, 1, 0) && !func_58(*uParam0.f_17[iVar0]))
						{
						}
					}
					iVar0++;
...
void func_49(auto uParam0, char* sParam1, char* sParam2, int iParam3)
{
	if (!iParam3)
	{
		if (!is_string_null(sParam1))
		{
			if (!GAMEPLAY::ARE_STRINGS_EQUAL(sParam1, ""))
			{
				func_50(sParam1, sParam2, 7500, 1);
			}
		}
	}
...
void func_50(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
int func_51(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
bool func_53(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!is_ped_group_member(iParam0, func_33()))
		{
...
int func_57(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_61(auto uParam0, int iParam1, float fParam2, int iParam3)
{
	int iVar0;
	...
	if (!*uParam0.f_6)
	{
		...
		if (!iLocal_327)
		{
			if (fVar0 < 400f)
			{
				...
				AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false);
				iLocal_327 = 1;
			}
		}
		if (!iLocal_328)
		...
		if (!*uParam0.f_6)
		{
			if (!does_blip_exist(*uParam0.f_4))
			{
				*uParam0.f_4 = func_36(*uParam0, 0);
				...
				_0x75A16C3DA34F1245(*uParam0.f_4, false);
			}
			if (!does_blip_exist(*uParam0.f_5))
			{
...
int func_70(Vector3 vParam0, Vector3 fParam1, int iParam2)
{
	int iVar0;
	
	iVar0 = add_blip_for_radius(vParam0, fParam3);
	set_blip_colour(iVar0, 5);
	set_blip_alpha(iVar0, 64);
	set_blip_as_short_range(iVar0, iParam4);
	if (!iParam4)
	{
		set_blip_display(iVar0, 4);
	}
	return iVar0;
}
...
auto func_72(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
void func_73(Vector3 vParam0, Vector3 fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	auto uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_93091.f_4))
	{
		...
		{
			if (func_122(24) != Global_93091.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_119(ENTITY::GET_ENTITY_COORDS(Global_93091.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = {vVar0};
						fParam3 = uVar3;
					}
				}
				func_74(Global_93091.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_74(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && is_vehicle_driveable(iParam0, 0))
	{
		...
		if (func_113(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_106(iParam5, &Var0, vParam1, fParam4, func_112(iParam0));
...
void func_75(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_103(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (is_vehicle_driveable(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_101154.f_18807.f_4801 = func_92();
			}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !is_vehicle_driveable(iParam0, 0)) || func_90(iParam0, 0, 0)) || func_90(iParam0, 1, 0)) || func_90(iParam0, 2, 0)) || func_112(iParam0) != 145) || func_89(iParam0)) || func_88(iParam0)) || func_87(iParam0)) || func_86(iParam0)) || !func_78(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_88(iParam0))
		{
		}
...
auto func_92()
{
	...
	func_102(&uVar0, get_clock_seconds());
	func_101(&uVar0, get_clock_minutes());
	func_100(&uVar0, TIME::GET_CLOCK_HOURS());
	func_95(&uVar0, get_clock_day_of_month());
	func_94(&uVar0, get_clock_month());
	func_93(&uVar0, get_clock_year());
	return uVar0;
}
...
auto func_97(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_98(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
	...
	*uParam0.f_18 = {0f, 0f, 0f};
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0.f_9, 10))
	{
		*uParam0.f_4 = Global_101154.f_18807.f_69[*uParam0.f_14 /*78*/].f_66;
		...
		if (!func_113(Global_101154.f_18807.f_1864[*uParam0.f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_113(Global_101154.f_1826.f_539.f_2816[1 /*10*/][*uParam0.f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_113(Global_101154.f_1826.f_539.f_2816[0 /*10*/][*uParam0.f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_105(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_106(int iParam0, auto uParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	if (func_103(&(Global_68319.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_111(iParam0);
			func_110(uParam1, &(Global_101154.f_18807.f_69[Global_68319.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_110(auto uParam0, auto uParam1)
{
...
bool func_119(Vector3 vParam0, int iParam1, auto uParam2, auto uParam3)
{
	int iVar0;
	
	iVar0 = func_120(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_120(Vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	*iParam0.f_15 = 0;
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(*iParam0.f_17[iVar0]))
		{
			...
			if (iParam1)
			{
				if (is_ped_group_member(*iParam0.f_17[iVar0], func_33()) && *iParam0.f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
void func_124(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
auto func_128(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_133()
{
	...
	request_additional_text("PPROM", false);
	func_137(2, 1);
	func_136(&uLocal_76, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	while (iVar0 <= 9)
	{
		...
		{
			fVar1 = 0f;
			get_ground_z_for_3d_coord(Local_242[iVar0 /*8*/], &fVar1, 0);
	...
	{
		case 6:
			StringCopy(&Local_43, "DT", 16);
			break;
		
		case 5:
			StringCopy(&Local_43, "VW", 16);
			break;
		
		case 7:
			StringCopy(&Local_43, "MW", 16);
			break;
	}
...
void func_136(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
