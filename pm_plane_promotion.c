		...
		if (is_screen_faded_in())
		{
			...
			if (iVar1)
			{
				...
				if (iParam26 && is_player_wanted_level_greater(player_id(), 0))
				{
					...
					if ((!func_41(iParam0, 1) && !func_40(iParam0)) && !is_bit_set(*iParam0.f_13, false))
					{
						if (iParam30)
						{
...
bool func_28(int iParam0)
{
	if (is_bit_set(*iParam0.f_13, 12))
	{
		...
		{
			if (func_29(1, 0, 1) || is_bit_set(*iParam0.f_13, 7))
			{
				return true;
			}
		}
	}
	else if (func_29(1, 0, 1) || is_bit_set(*iParam0.f_13, 7))
	{
		return true;
	}
	return false;
				...
				if (!PED::IS_PED_INJURED(*uParam0.f_17[iVar0]))
				{
					...
					if (is_ped_group_member(*uParam0.f_17[iVar0], func_33()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar32))
						{
							...
							{
								if (func_57(iVar0, uParam0) || !is_bit_set(*uParam0.f_13, 27))
								{
									set_ped_group_member_passenger_index(*uParam0.f_17[iVar0], iVar0);
...
{
	return shift_right(iParam0, 26) & 31 * func_98(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
