	...
	switch (Global_100148)
	{
		case 0:
			if (!Global_100148.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_65(func_66(iVar0)) && Global_100148.f_15[iVar1] + 120000 < get_game_timer())
					{
						if (func_63(iVar0))
						{
							func_62(iVar0, 0);
						...
						else
						{
							...
							else if (((get_game_timer() >= Global_100148.f_4[iVar1] && func_50()) && func_49(iVar0)) && func_48(iVar0) >= func_47(iVar0))
							{
...
bool func_4(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<14> Var0;
...
{
	Global_101154.f_243[func_20() /*53*/].f_2[uParam0 /*5*/].f_1 = iParam1;
}
...
void func_28(auto uParam0, int iParam1)
{
	if (iParam1 > -1)
	{
		Global_100148.f_4[uParam0] = get_game_timer() + iParam1;
	}
	else
	{
		Global_100148.f_4[uParam0] = get_game_timer() + get_random_int_in_range(1200000, 2100000);
	}
}
...
int func_32(auto uParam0, auto uParam1, char* sParam2, auto uParam3, auto uParam4, char[4] cParam5, char[4] cParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	auto uVar0;
	auto uVar11;
	
	func_45(uParam0, uParam1, sParam2, iParam9, iParam10, 0);
	func_44();
	if (iParam8 == 1)
	{
		Global_15724 = 1;
...
bool func_33(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
void func_42(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
	func_43(iParam0);
	*uParam1[0] = uParam3;
	*uParam2[0] = uParam4;
...
void func_45(auto uParam0, auto uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
struct<16> func_53()
{
	...
	StringCopy(&cVar0, "BC_PLYRQ_", 64);
	if (func_46() == 0)
	{
		StringConCat(&cVar0, "M", 64);
	}
	else if (func_46() == 2)
	{
		StringConCat(&cVar0, "T", 64);
	}
	else if (func_46() == 1)
	{
		StringConCat(&cVar0, "F", 64);
	}
	return cVar0;
}
...
void func_61(auto uParam0, auto uParam1)
{
	*uParam0 = (*uParam0 || uParam1);
}
...
void func_67()
{
	...
	switch (Global_100148)
	{
		case 0:
			...
			{
				if (get_game_timer() >= Global_100148.f_3)
				{
...
void func_68(auto uParam0)
{
	...
	Global_101154.f_243[func_20() /*53*/].f_2[uParam0 /*5*/].f_2++;
}

void func_69(auto uParam0, int iParam1)
{
	Global_101154.f_243[func_20() /*53*/].f_2[uParam0 /*5*/].f_2 = iParam1;
}

auto func_70(auto uParam0)
{
	return Global_101154.f_243[func_20() /*53*/].f_2[uParam0 /*5*/].f_2;
}
...
int func_72(auto uParam0)
{
	...
	uVar0 = func_73();
	return Global_101154.f_32575[uParam0 /*29*/].f_12[uVar0] == 1;
}
...
int func_74()
{
	...
	while (iVar0 < 10)
	{
		if (Global_101154.f_243[func_46() /*53*/].f_2[iVar0 /*5*/].f_4 && get_game_timer() >= Global_100148.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
...
{
	if ((((func_76(0) && !iParam0) || func_31()) || Global_100148.f_2 != -1) || !func_6(func_46()))
	{
		return false;
	}
	return true;
...
void func_77()
{
	...
	{
		if (Global_100148.f_3 < get_game_timer() + 120000)
		{
			func_80(1800000);
		}
