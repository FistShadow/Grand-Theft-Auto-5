...
void main()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_100241[Var0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_100241[Var0 /*10*/].f_9));
			}
		}
		func_278(&Var0, &Var116, 1);
	}
	if (!func_275(&iVar126, &Var0, vVar61, 1f))
	{
		func_274();
	...
	while (true)
	{
		...
		func_196(Var0);
		func_189(&iLocal_108, &(Var0.f_9), vVar61);
		if (Var0 == 42)
		{
			if (_0xB56BBBCC2955D9CB())
			{
				set_cutscene_ped_component_variation(func_188(), 4, 0, false, func_187());
				func_297("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_186(&uLocal_96) && Var0 == 37)
		{
			func_183(Var0.f_28[1], &uLocal_96, Var0);
		}
		if (Var0 == 37)
		{
			func_179(&Var0, vVar61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_110);
		}
		else if (Var0 == 42)
		{
			func_174(&Var0, vVar61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0 == 43)
		{
...
void func_115(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_122(player_id())) && !func_120(player_id(), 0)) && !func_119())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_122(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
void func_131()
{
	if (is_player_playing(player_id()))
	{
		if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_132(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_150(Vector3 vParam0, int iParam1)
{
	...
	set_blip_scale(iVar0, func_151(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
bool func_154(int iParam0, int iParam1)
{
	switch (*iParam0.f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					...
					{
						if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*iParam0.f_28[0], 1), 1) < 3f)
						{
							if (func_160(2))
							{
		...
		case 2:
			...
			{
				if (is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), *iParam0.f_35[0], 0))
				{
					if (func_160(3))
					{
						func_157(*iParam0.f_27, *iParam0);
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(*iParam0.f_35[0]))
			{
				...
				{
					if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*iParam0.f_35[0], 1), 1) < *iParam0.f_15)
					{
						if (func_160(2))
						{
							if (func_158(*iParam0.f_27))
		...
		case 3:
			if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), *(iParam0.f_17[0 /*3*/]), 1) < *iParam0.f_15)
			{
				if (func_160(2))
				{
					if (func_158(*iParam0.f_27))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_111(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)))
					{
						...
						{
							if (is_vehicle_attached_to_tow_truck(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), *iParam0.f_35[0]))
							{
								if (func_160(3))
								{
									return true;
						...
						{
							if (_is_cargobob_hook_active(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0)) && is_vehicle_attached_to_cargobob(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), *iParam0.f_35[0]))
							{
								if (func_160(3))
								{
									return true;
			...
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), *(iParam0.f_17[0 /*3*/]), *(iParam0.f_17[1 /*3*/]), *iParam0.f_24, 0, true, 0))
			{
				if (*iParam0 == 45)
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_168()) || Global_100201) || Global_25122) || func_167()) || func_166(8, -1)) || func_77()) || func_165()) || func_164()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 1:
						if (((((((((is_player_being_arrested(player_id(), 1) || func_168()) || Global_25122) || func_167()) || func_166(8, -1)) || func_164()) || func_77()) || func_165()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_getting_into_a_vehicle(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_168()) || Global_100201) || Global_25122) || func_167()) || func_166(8, -1)) || func_164()) || func_77()) || func_165()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5) || Global_36258 != -1)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false)) || func_168()) || Global_100201) || Global_25122) || func_167()) || func_166(8, -1)) || func_77()) || func_165()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 4:
						if (((((func_168() || get_player_wanted_level(player_id()) > 0) || func_166(8, -1)) || func_163()) || func_162()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_168()) || Global_25122) || func_167()) || func_166(8, -1)) || func_165()) || func_164()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || func_168()) || func_165()) || Global_100201) || Global_25122) || func_167()) || Global_36839) || func_166(8, -1)) || func_164()) || func_162()) || func_163()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(PLAYER::PLAYER_PED_ID(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(PLAYER::PLAYER_PED_ID())) || is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || is_ped_falling(PLAYER::PLAYER_PED_ID())) || is_ped_swimming(PLAYER::PLAYER_PED_ID())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_168()) || Global_100201) || Global_25122) || func_167()) || func_166(8, -1)) || func_164()) || func_162()) || func_77()) || func_165()) || func_163())
						{
							return false;
						}
						break;
	...
	if (func_111(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= *iParam0.f_28 - 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(*iParam0.f_28[iVar0]))
			{
				...
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*iParam0.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 1) || is_bullet_in_area(ENTITY::GET_ENTITY_COORDS(*iParam0.f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_160(2))
						{
							func_157(*iParam0.f_27, *iParam0);
...
bool func_170(int iParam0, auto uParam1)
{
	if (func_171(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (func_160(2))
		{
			if (func_158(*iParam0.f_27))
...
int func_171(auto uParam0, struct<2> Param1, Vector3 fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_172(int iParam0, auto uParam1, auto uParam2)
{
	if (func_111(*uParam1))
	{
		switch (*iParam0)
		{
			case 0:
				if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CAR_TRUNK_THUMPS", false))
				{
			...
			case 1:
				...
				{
					AUDIO::PLAY_SOUND_FROM_COORD(*iParam0.f_1, "TRUNK_THUMPS", get_offset_from_entity_in_world_coords(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					_play_ambient_speech_with_voice(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_173(0), 0);
			...
			case 2:
				if (GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_6 > *iParam0.f_7)
				{
					...
					*iParam0.f_9 = 0.5f * to_float(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(-2, 3));
...
bool func_174(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	auto uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && !func_129()) && GAMEPLAY::GET_GAME_TIMER() - *iParam0.f_60 > iParam8) && func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_177(&uVar0, iParam6, *iParam0.f_28[0], sParam7, 0, 1);
		func_175(&uVar0, sParam4, sParam5, 7, 0, 0);
...
void func_175(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_176(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
auto func_178(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_179(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, auto uParam8)
{
	auto uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_160(2))
		{
			if (!func_129())
			{
				if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(*iParam0.f_28[0])) && func_111(*iParam0.f_28[1])) && func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			else if (((func_181(sParam5) && !*uParam10 == 1) && func_111(PLAYER::PLAYER_PED_ID())) && func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_297("pause conversation");
				func_180(1);
				*uParam10 = 1;
			}
			if (func_178(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_183(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_111(iParam0))
	{
		switch (*uParam1.f_3)
		{
			...
			case 2:
				if (!func_185(uParam1) || !is_entity_playing_anim(iParam0, *uParam1, *uParam1.f_2, 3))
				{
					if (func_184(iParam2) && !is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						task_turn_ped_to_face_entity(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						*uParam1.f_3 = 5;
					}
					else if ((func_185(uParam1) && *uParam1.f_4 == 0) && INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						*uParam1.f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_184(iParam2) || is_ped_facing_ped(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(*uParam1.f_5, 0f, 0f, 0f, 0))
					{
						AI::TASK_PLAY_ANIM(iParam0, *uParam1, *uParam1.f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
bool func_201(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_203(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_205(int iParam0, float fParam1)
{
	...
	{
		if (func_216(iParam0) || is_player_targetting_entity(player_id(), iParam0))
		{
...
int func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_208(&(Local_49[iVar4 /*4*/]), vVar1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || GAMEPLAY::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3 < iParam4);
}

bool func_208(auto uParam0, Vector3 vParam1, int iParam2, auto uParam3, int iParam4, int iParam5)
{
	auto uVar0;
	Vector3 vVar1;
	auto uVar4;
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = {func_213(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
bool func_218(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_220(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_231(int iParam0, auto uParam1)
{
	switch (*iParam0)
	{
		case 37:
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[0]))
			{
				...
				if (func_111(*uParam0.f_35[0]))
				{
					set_vehicle_colours(*uParam0.f_35[0], 65, false);
...
bool func_233(auto uParam0, auto uParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
...
bool func_236(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_237(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
bool func_237(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_238(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_241(auto uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	*uParam0.f_1 = sParam2;
	*uParam0.f_2 = sParam3;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[1]))
			{
				...
				{
					set_vehicle_colours(*uParam0.f_35[1], false, false);
...
bool func_247(auto uParam0, auto uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_240(&iVar0) || !has_anim_dict_loaded(*uParam0.f_48)) || !has_anim_dict_loaded(sVar8))
			{
				return false;
			}
			iLocal_91 = 2;
...
void func_249(auto uParam0, Vector3 vParam1)
{
	if (*uParam0.f_51 == 0)
	{
	}
...
bool func_251(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_240(&iVar0) || !has_anim_dict_loaded(sVar4))
			{
				return false;
			}
			iLocal_91 = 2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_35[0]))
			{
				...
				if (func_111(*uParam0.f_35[0]))
				{
					...
					_set_vehicle_door_breakable(*uParam0.f_35[0], 2, false);
		...
		case 3:
			...
			if (func_110(*uParam0.f_28[1]))
			{
				...
				set_ped_component_variation(*uParam0.f_28[1], 8, 0, true, 0);
...
void func_253(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_199(iParam0);
...
bool func_256(auto uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			*uParam0.f_59 = -1;
			func_243(38, 1);
			iVar9 = get_interior_at_coords_with_type(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (is_valid_interior(iVar9))
			{
				refresh_interior(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= iVar0 - 1)
			{
		...
		case 1:
			if (!func_240(&iVar0) || !has_anim_dict_loaded(*uParam0.f_48))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_110(*uParam0.f_28[1]))
			{
				...
				set_ped_component_variation(*uParam0.f_28[1], 4, 0, true, 0);
				set_ped_component_variation(*uParam0.f_28[1], 7, 0, true, 0);
			...
			*uParam0.f_59 = create_synchronized_scene(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			...
			if (func_110(*uParam0.f_28[2]))
			{
				...
				set_ped_component_variation(*uParam0.f_28[2], 3, 1, true, 0);
				set_ped_component_variation(*uParam0.f_28[2], 4, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[2], 7, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[2], 8, 1, false, 0);
			}
			if (func_110(*uParam0.f_28[3]))
			{
				set_ped_component_variation(*uParam0.f_28[3], false, 1, true, 0);
				set_ped_component_variation(*uParam0.f_28[3], 2, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[3], 3, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[3], 4, 1, true, 0);
				set_ped_component_variation(*uParam0.f_28[3], 7, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[3], 8, 1, false, 0);
			}
			if (func_110(*uParam0.f_28[4]))
			{
				set_ped_component_variation(*uParam0.f_28[4], false, 0, false, 0);
				set_ped_component_variation(*uParam0.f_28[4], 2, 0, 2, 0);
				set_ped_component_variation(*uParam0.f_28[4], 3, 0, false, 0);
				set_ped_component_variation(*uParam0.f_28[4], 4, 0, true, 0);
				set_ped_component_variation(*uParam0.f_28[4], 8, 0, false, 0);
			}
			if (func_110(*uParam0.f_28[5]))
			{
				set_ped_component_variation(*uParam0.f_28[5], false, 1, false, 0);
				set_ped_component_variation(*uParam0.f_28[5], 2, 2, false, 0);
				set_ped_component_variation(*uParam0.f_28[5], 3, 0, 3, 0);
				set_ped_component_variation(*uParam0.f_28[5], 4, 1, false, 0);
...
struct<2> func_259(auto uParam0)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_111(*uParam0.f_28[0]) && func_111(*uParam0.f_28[1]))
			{
				set_blocking_of_non_temporary_events(*uParam0.f_28[0], true);
				set_blocking_of_non_temporary_events(*uParam0.f_28[1], true);
				iVar5 = create_synchronized_scene(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				task_synchronized_scene(*uParam0.f_28[0], iVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1000f, 0);
				task_synchronized_scene(*uParam0.f_28[1], iVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1000f, 0);
			}
			iVar4 = 0;
			while (iVar4 <= iVar0 - 1)
			{
...
int func_269(int iParam0, char* sParam1)
{
...
bool func_275(int iParam0, int iParam1, Vector3 vParam2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_276(*iParam0[0], vParam2, fParam5, iParam1))
		{
			return true;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_276(*iParam0[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return true;
			}
...
bool func_276(int iParam0, Vector3 vParam1, float fParam2, auto uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_277(Var1.f_6, vParam1, fParam4, 0))
	{
...
bool func_277(Vector3 vParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_283(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_290(uParam0, iParam1);
	func_287(uParam0, iParam2);
	func_284(uParam0, iParam3);
}

void func_284(auto uParam0, int iParam1)
{
	func_285(uParam0.f_41, iParam1);
}
