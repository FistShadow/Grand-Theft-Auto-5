...
bool func_150()
{
	if (func_153(2))
	{
		if (func_152(player_ped_id(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !is_ped_ragdoll(player_ped_id()))
		{
			if (!is_ped_in_any_vehicle(player_ped_id(), 0))
			{
			...
			else if ((!func_151(player_ped_id(), -828834893) && func_111(get_vehicle_ped_is_in(player_ped_id(), 0))) && func_133(get_vehicle_ped_is_in(player_ped_id(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				task_leave_any_vehicle(player_ped_id(), 0, 0);
			}
		}
		...
		if (does_entity_exist(player_ped_id()))
		{
			if (!is_ped_injured(player_ped_id()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!is_player_ready_for_cutscene(player_id()) || is_entity_in_air(player_ped_id())) || is_ped_getting_into_a_vehicle(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || is_ped_in_combat(player_ped_id(), false)) || func_161()) || Global_100201) || Global_25122) || func_160()) || func_159(8, -1)) || func_77()) || func_158()) || func_157()) || func_156()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 3:
						if ((((((((((((is_ped_ragdoll(player_ped_id()) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_ped_in_combat(player_ped_id(), false)) || func_161()) || Global_100201) || Global_25122) || func_160()) || func_159(8, -1)) || func_77()) || func_158()) || func_156()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 6:
						if (does_entity_exist(player_ped_id()))
						{
							if ((((((((((((((is_ped_in_combat(player_ped_id(), false) || get_player_wanted_level(player_id()) > 0) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_161()) || Global_25122) || func_160()) || func_159(8, -1)) || func_158()) || func_157()) || func_156()) || Global_101154.f_6378.f_919[iVar0] == 5)
							{
								return false;
							}
						}
					...
					case 7:
						if ((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_entity_in_air(player_ped_id())) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || func_161()) || func_158()) || Global_100201) || Global_25122) || func_160()) || Global_36839) || func_159(8, -1)) || func_157()) || func_155()) || func_156()) || Global_101154.f_6378.f_919[iVar0] == 5)
						{
							return false;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((is_ped_in_combat(player_ped_id(), false) || !is_player_control_on(player_id())) || !is_player_ready_for_cutscene(player_id())) || !is_screen_faded_in()) || is_player_wanted_level_greater(player_id(), 0)) || is_entity_in_air(player_ped_id())) || is_ped_in_any_vehicle(player_ped_id(), 1)) || is_ped_ragdoll(player_ped_id())) || is_ped_falling(player_ped_id())) || is_ped_swimming(player_ped_id())) || is_player_being_arrested(player_id(), 1)) || is_player_climbing(player_id())) || func_161()) || Global_100201) || Global_25122) || func_160()) || func_159(8, -1)) || func_157()) || func_155()) || func_77()) || func_158()) || func_156())
						{
							return false;
						}
						break;
...
bool func_168(int iParam0, Vector3 vParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_111(player_ped_id()) && func_111(*iParam0.f_28[0])) && !func_130()) && get_game_timer() - *iParam0.f_60 > iParam8) && func_152(player_ped_id(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_172(int iParam0, char* sParam1, Vector3 vParam2)
{
	if (is_player_playing(player_id()))
	{
		if (!is_string_null_or_empty(sParam1))
		{
			...
			{
				if (func_152(player_ped_id(), vParam2, 1) <= 100f)
				{
					func_175(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_152(player_ped_id(), vParam2, 1) > 120f)
				{
					func_177(iParam0);
				}
			}
