...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_22() == 0)
		{
			return is_bit_set(func_83(func_376(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	return shift_right(iParam0, 26) & 31 * func_389(is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
void func_452()
{
	...
	while (((((((!has_model_loaded(iLocal_2304) || !request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_CALLS", 0)) || !request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_VOCALS", 0)) || !request_mission_audio_bank("SCRIPT\HUNTING_MAIN_A", 0)) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@enter")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@idle_a")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@exit")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@base"))
	{
		wait(0);
	}
	iLocal_2204 = 1;
