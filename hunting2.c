#region Local Var
	...
	auto uLocal_93 = 0;
	int iLocal_94 = 0;
	struct<36>[] Local_95 = new struct<36>[8];
	int iLocal_384 = 0;
	struct<5>[] Local_385 = new struct<5>[58];
	struct<671> Local_676 = 0;
	auto uLocal_1347 = 0;
	auto uLocal_1348 = 0;
	auto uLocal_1349 = 3;
	auto uLocal_1350 = 0;
	...
	int iLocal_1961 = 0;
	int iLocal_1962 = 0;
	Vector3 vLocal_1963 = 0;
	int iLocal_1966 = 0;
	struct<61> Local_1967 = 0;
	int iLocal_2028 = 0;
	int iLocal_2029 = 0;
	int iLocal_2030 = 0;
	int iLocal_2031 = 0;
	...
	int iLocal_2224 = 0;
	int iLocal_2225 = 0;
	int[] iLocal_2226 = new int[13];
	int[] iLocal_2240 = new int[5];
	int[] iLocal_2246 = new int[5];
	int[] iLocal_2252 = new int[5];
	int[] iLocal_2258 = new int[5];
	int[] iLocal_2264 = new int[5];
	int[] iLocal_2270 = new int[7];
	int iLocal_2278 = 0;
	Vector3 fLocal_2279 = 0;
	Vector3 fLocal_2280 = 0;
	Vector3 fLocal_2281 = 0;
	Vector3 fLocal_2282 = 0;
	Vector3 fLocal_2283 = 0;
	Vector3 fLocal_2284 = 0;
	Vector3 fLocal_2285 = 0;
	Vector3 fLocal_2286 = 0;
	float[] fLocal_2287 = new float[5];
	int iLocal_2293 = 0;
	int iLocal_2294 = 0;
	int iLocal_2295 = 0;
	int iLocal_2296 = 0;
	...
	char* sLocal_2311 = 0;
	char* sLocal_2312 = 0;
	struct<6> Local_2313 = 0;
	struct<6> Local_2319 = 0;
	struct<6> Local_2325 = 0;
	Vector3 vLocal_2331 = 0;
	Vector3 vLocal_2334 = 0;
	Vector3 vLocal_2337 = 0;
	Vector3 vLocal_2340 = 0;
	Vector3 vLocal_2343 = 0;
	Vector3 fLocal_2346 = 0;
	Vector3 vLocal_2347 = 0;
	Vector3 fLocal_2350 = 0;
	Vector3 vLocal_2351 = 0;
	Vector3 vLocal_2354 = 0;
	Vector3 vLocal_2357 = 0;
	Vector3 vLocal_2360 = 0;
	Vector3 vLocal_2363 = 0;
	Vector3[] vLocal_2366 = new Vector3[5];
	Vector3 vLocal_2382 = 0;
	Vector3 vLocal_2385 = 0;
	Vector3 fLocal_2388 = 0;
	Vector3 vLocal_2389 = 0;
	Vector3 fLocal_2392 = 0;
	Vector3 vLocal_2393 = 0;
	float fLocal_2396 = 0;
	Vector3 vLocal_2397 = 0;
	float fLocal_2400 = 0;
	Vector3 vLocal_2401 = 0;
	Vector3 vLocal_2404 = 0;
	Vector3 vLocal_2407 = 0;
	Vector3 vLocal_2410 = 0;
	Vector3 vLocal_2413 = 0;
	Vector3 vLocal_2416 = 0;
	Vector3 vLocal_2419 = 0;
	Vector3 vLocal_2422 = 0;
	Vector3 fLocal_2425 = 0;
	int iLocal_2426 = 0;
	int iLocal_2427 = 0;
	int iLocal_2428 = 0;
	int iLocal_2429 = 0;
...
void main()
{
	...
	iLocal_1960 = get_weapontype_model(joaat("weapon_sniperrifle"));
	iLocal_1961 = get_weapon_component_type_model(joaat("component_at_scope_large"));
	iLocal_1962 = get_weapon_component_type_model(joaat("component_at_ar_supp_02"));
	...
	StringCopy(&Local_2319, "HT_CUT_1", 24);
	...
	while (true)
	{
		...
		{
			vLocal_1800 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
	...
	switch (iLocal_2029)
	{
		case 0:
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2296 && !func_9())
			{
				...
				if (is_string_null_or_empty(sLocal_2309))
				{
					func_536(1);
				}
				else
...
void func_2()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_2307))
	{
		if (func_8(iLocal_2307))
		{
			set_entity_load_collision_flag(iLocal_2307, false);
			if (does_group_exist(func_4()))
			{
				if (is_ped_group_member(iLocal_2307, func_4()))
				{
					remove_ped_from_group(iLocal_2307);
				}
			}
		}
	}
	...
	if (does_cam_exist(iLocal_2278))
	{
		render_script_cams(false, false, 3000, 1, 0, 0);
		destroy_cam(iLocal_2278, 0);
	}
	if (is_audio_scene_active("HUNTING_02_SETTINGS"))
	{
		stop_audio_scene("HUNTING_02_SETTINGS");
		stop_sound(iLocal_1819);
		release_sound_id(iLocal_1819);
	}
...
void func_21()
{
	...
	{
		func_23(13, floor(Global_101154.f_8884.f_3853));
	}
...
int func_46(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (get_number_of_ped_drawable_variations(iParam0, func_88(iParam1)) > 0 && get_number_of_ped_texture_variations(iParam0, func_88(iParam1), Global_69311[1 /*14*/].f_3) > 0)
		{
			set_ped_component_variation(iParam0, func_88(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, 0);
		}
	}
...
bool func_47(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_161(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_64, Global_101154.f_1826.f_539[uVar0 /*65*/].f_63))
		{
...
bool func_49(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_69311[1 /*14*/].f_6, false))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							set_ped_component_variation(iParam0, func_88(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_88(iVar0)));
						}
						else
						{
							set_ped_component_variation(iParam0, func_88(iVar0), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
						}
						func_79(iVar0);
						if (Global_69310 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			set_ped_component_variation(iParam0, func_88(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, get_ped_palette_variation(iParam0, func_88(iParam1)));
		}
		else
		{
			set_ped_component_variation(iParam0, func_88(iParam1), Global_69311[1 /*14*/].f_3, Global_69311[1 /*14*/].f_4, iParam4);
		}
		if (Global_69310 == 1)
		{
			iVar2 = 0;
...
bool func_53(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4, auto uParam5)
{
	auto uVar0;
	int iVar10;
...
bool func_58(int iParam0, int iParam1, int iParam2, int iParam3, auto uParam4)
{
	int iVar0;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 3), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 3), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 1, 3), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 1, 3), -1842686353, false));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (_0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 4), -1757550583, true) || _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 4), -1842686353, true));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (_0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 1, 4), -1757550583, false) || _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 1, 4), -1842686353, false));
					}
					break;
			}
			break;
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_88(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	switch (iParam0)
	{
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 3), 97230661, true);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return _0x341DE7ED1D2A1BFD(func_67(iParam0, iParam2, 14, 4), 97230661, true);
				}
			}
			break;
	}
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_88(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_80(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
	...
	if (func_84(uParam0, iParam1, &uVar2, &iVar1, iParam2, iParam3))
	{
		iVar3 = func_83(uVar2, iVar0, 0);
		GAMEPLAY::GAMEPLAY::SET_BIT(&iVar3, iVar1);
		func_81(uVar2, iVar3, iVar0, 1);
	}
}

void func_81(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	
	iVar0 = Global_2469339[uParam0 /*5*/][func_82(iParam2)];
	if (iVar0 != 0)
	{
...
int func_84(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_85(int iParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_87(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_161(iParam0, Global_101154.f_1826.f_539[uVar0 /*65*/].f_61, Global_101154.f_1826.f_539[uVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (_get_prop_from_outfit(Var1.f_1, iVar19, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					if (vVar16.z == 10)
					{
						*iParam0[func_94(vVar16.z)] = vVar16.x;
					}
					else
					{
						*iParam0[func_94(vVar16.z)] = func_75(iParam1, vVar16.x, func_94(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					*iParam0[func_94(vVar16.z)] = vVar16.y;
				}
			}
			iVar19++;
		}
...
void func_98(int iParam0)
{
	...
	func_99(&(Global_69311[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

void func_99(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	auto uVar1;
	...
	*uParam0.f_12 = func_105(iParam8);
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_102(iParam1, *uParam0.f_2), Global_69309, 0);
			...
			if (func_100(iParam1, *uParam0.f_2, &uVar1))
			{
				iVar0 = func_83(uVar1, Global_69309, 0);
				if (!GAMEPLAY::IS_BIT_SET(iVar0, *uParam0.f_1))
				{
					GAMEPLAY::GAMEPLAY::SET_BIT(uParam0.f_6, 4);
				}
...
int func_100(int iParam0, int iParam1, auto uParam2)
{
	*uParam2 = 971;
	switch (iParam1)
	{
...
int func_103(auto uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	auto uVar2;
...
void func_106(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_is_dlc_data_empty(Var20))
			{
				if (iVar39 == iParam1 - iParam2)
				{
					...
					func_99(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_88(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!_is_dlc_data_empty(Var41))
			{
				if (iVar59 == iParam1 - iParam2)
				{
					...
					func_99(&(Global_69311[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, false), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
bool func_161(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_69311[1 /*14*/].f_3 == get_ped_drawable_variation(iParam0, func_88(iParam1)) && Global_69311[1 /*14*/].f_4 == get_ped_texture_variation(iParam0, func_88(iParam1)))
	{
		return true;
	}
	return false;
...
void func_167()
{
	...
	{
		if (func_163(Global_101154.f_1826.f_539.f_3549) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_172(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_173(&sVar32, Var0.f_3, Global_91315, iParam1, iParam2);
	}
}
...
void func_174(int iParam0, auto uParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_178()
{
	...
	{
		func_167();
		_0xBF59707B3E5ED531(func_179(Global_101154.f_1826.f_539.f_3549));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_194(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != 198)
	{
		...
		func_197(iParam0, iParam3, iParam4, 0);
...
bool func_200(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_205(char* sParam0, char* sParam1, auto uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, auto uParam9)
{
	int iVar0;
...
int func_213()
{
	return func_214(get_this_script_name(), 0);
}
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				...
				if (!func_230())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_2357, fLocal_2282, 0, 1);
					func_222(vLocal_2357, 1112014848, 12, 5000, 0, 0);
				}
				func_519(1);
				func_221();
				iLocal_1798 = 0;
...
void func_222(Vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
int func_229(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
void func_237()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2302)
	{
		if (func_262(54) || iLocal_2217)
		{
			...
			{
				func_249(&uLocal_2034, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int func_239(auto uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	Global_15766 = 0;
	Global_2621441 = 0;
	return func_240(sParam3, iParam4, iParam7);
}
...
void func_248(auto uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_249(auto uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_250(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_251(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (iParam7 == 1)
		{
			Global_2990 = iParam6;
...
bool func_251(auto uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, auto uParam8, auto uParam9, int iParam10, auto uParam11, auto uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_14572)
	{
		if (Global_14413.f_1 == 6)
		{
			...
			func_252(1);
			func_255(Global_14394, "DISPLAY_VIEW", 1f, to_float(Global_14393), -1082130432, -1082130432, -1082130432);
		}
	}
	return true;
}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (Global_2443081)
							{
								if (iVar1 == 14)
								{
									func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16775), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2852[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2290[iVar1 /*15*/].f_4)
					{
						if (Global_2852[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(Global_16780), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_69489)
								{
									...
									func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14413)
									...
									func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar5), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2290[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(iVar8), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_253(Global_14394, "SET_DATA_SLOT", to_float(true), to_float(iVar0), to_float(Global_2290[iVar1 /*15*/].f_10), to_float(false), -1f, &(Global_2290[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2852[iVar0] = 1;
						}
					}
...
void func_253(int iParam0, char* sParam1, Vector3 fParam2, Vector3 fParam3, Vector3 fParam4, Vector3 fParam5, Vector3 fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_255(int iParam0, char* sParam1, Vector3 fParam2, Vector3 fParam3, Vector3 fParam4, Vector3 fParam5, Vector3 fParam6)
{
	_push_scaleform_movie_function(iParam0, sParam1);
	_push_scaleform_movie_function_parameter_int(round(fParam2));
	if (fParam3 != -1f)
...
bool func_260(struct<6> Param0, struct<6> Param1)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_263()
{
	...
	if (!func_270())
	{
		if (func_269(2, Global_14382, 0))
		{
			func_268(1);
			func_267(0);
			iLocal_2199 = add_blip_for_entity(Local_95[4 /*36*/]);
			if (does_blip_exist(iLocal_2199))
			{
				set_blip_colour(iLocal_2199, 1);
			}
			Global_16748 = 0;
			func_265("HT_PHOTO");
			iLocal_2028 = 19;
...
void func_271()
{
	...
	if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vVar0, 0) < 40f)
	{
		Local_676.f_670 = _get_gameplay_cam_zoom();
		if (func_273())
		{
			fVar3 = vdist2(vVar0, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1));
			if (_world3d_to_screen2d(vVar0, &fVar4, &fVar5))
			{
...
void func_274()
{
	...
	if (get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), vVar0, 0) < 5f)
	{
		Local_676.f_670 = _get_gameplay_cam_zoom();
		func_267(0);
		func_268(1);
...
void func_275()
{
	...
	switch (iLocal_2029)
	{
		...
		case 2:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2302)
			{
				set_entity_as_mission_entity(Local_95[4 /*36*/], true, 1);
				iLocal_2199 = add_blip_for_entity(Local_95[4 /*36*/]);
				if (does_blip_exist(iLocal_2199))
				{
					set_blip_colour(iLocal_2199, 1);
...
auto func_281(char* sParam0, int iParam1, char* sParam2)
{
...
void func_284(int iParam0)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]) && is_entity_dead(Local_95[iParam0 /*36*/], 0))
		{
			if (has_entity_been_damaged_by_entity(Local_95[iParam0 /*36*/], PLAYER::PLAYER_PED_ID(), 1))
			{
				iLocal_1823 = 1;
			}
		}
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]))
			{
				if (!PED::IS_PED_INJURED(Local_95[iParam0 /*36*/]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						fVar0 = get_distance_between_coords(vLocal_1800, vVar1, 1);
						if (fVar0 > 250f)
						{
	...
	switch (Local_95[iParam0 /*36*/].f_16)
	{
		...
		case 2:
			...
			{
				if (iLocal_1792 && !func_307(Local_95[iParam0 /*36*/]))
				{
					if (!func_306())
					{
						if (get_random_int_in_range(false, 100) < 100)
						{
		...
		case 3:
			if (!Local_95[iParam0 /*36*/].f_9)
			{
				iVar4 = get_random_int_in_range(false, 65535) % 3;
				open_sequence_task(&iVar5);
				task_play_anim(false, "creatures@deer@amb@world_deer_grazing@enter", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
				if (iVar4 == 0)
				{
					task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				else if (iVar4 == 1)
				{
					task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				else
				{
					task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_c", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				close_sequence_task(iVar5);
				task_perform_sequence(Local_95[iParam0 /*36*/], iVar5);
				clear_sequence_task(&iVar5);
				Local_95[iParam0 /*36*/].f_23 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(15000, 25000);
		...
		case 4:
			if (func_298(iParam0))
			{
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					...
					if ((GAMEPLAY::GET_GAME_TIMER() > Local_95[iParam0 /*36*/].f_23 && func_295(vVar6)) && vdist2(vVar6, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)) < 10000f)
					{
						open_sequence_task(&iVar9);
						if (get_script_task_status(Local_95[iParam0 /*36*/], 242628503) == 1)
						{
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@exit", "exit", 4f, -8f, -1, 0, 0, 0, 0, 0);
						}
						task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), 4200, 0, 2);
						close_sequence_task(iVar9);
						task_perform_sequence(Local_95[iParam0 /*36*/], iVar9);
						clear_sequence_task(&iVar9);
						Local_95[iParam0 /*36*/].f_23 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(1500, 3000);
		...
		case 6:
			if (func_298(iParam0))
			{
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					iLocal_1812 = get_random_int_in_range(false, 58);
					...
					task_follow_nav_mesh_to_coord(Local_95[iParam0 /*36*/], Local_385[Local_95[iParam0 /*36*/].f_27 /*5*/], 1f, -1, 0.25f, 0, 1193033728);
		...
		case 7:
			if (func_298(iParam0))
			{
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					if (is_entity_at_coord(Local_95[iParam0 /*36*/], Local_385[Local_95[iParam0 /*36*/].f_27 /*5*/], 3f, 3f, 3f, false, false, 0))
					{
		...
		case 14:
			...
			if (func_298(iParam0))
			{
				...
				clear_ped_tasks(Local_95[iParam0 /*36*/]);
				task_smart_flee_ped(Local_95[iParam0 /*36*/], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				set_ped_keep_task(Local_95[iParam0 /*36*/], true);
			...
			if (func_298(iParam0))
			{
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					if (get_script_task_status(Local_95[iParam0 /*36*/], 242628503) == 7 || get_script_task_status(Local_95[iParam0 /*36*/], 242628503) != 1)
					{
						...
						task_play_anim(false, "creatures@deer@amb@world_deer_grazing@enter", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "creatures@deer@amb@world_deer_grazing@base", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
						if (func_286())
						{
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@base", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						if (func_286())
						{
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						else
						{
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@idle_a", "idle_c", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						task_play_anim(false, "creatures@deer@amb@world_deer_grazing@base", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
						task_play_anim(false, "creatures@deer@amb@world_deer_grazing@exit", "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
						close_sequence_task(iVar10);
						task_perform_sequence(Local_95[iParam0 /*36*/], iVar10);
						clear_sequence_task(&iVar10);
						Local_95[iParam0 /*36*/].f_24 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(10000, 15000);
				...
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					if (get_script_task_status(Local_95[iParam0 /*36*/], 242628503) == 7 || get_script_task_status(Local_95[iParam0 /*36*/], 242628503) != 1)
					{
						if (GAMEPLAY::GET_GAME_TIMER() > Local_95[iParam0 /*36*/].f_24)
						{
							...
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@enter", "enter", 16f, -8f, -1, 0, 0, 0, 0, 0);
							task_play_anim(false, "creatures@deer@amb@world_deer_grazing@base", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
							if (func_286())
							{
								task_play_anim(false, "creatures@deer@amb@world_deer_grazing@base", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
							...
							task_perform_sequence(Local_95[iParam0 /*36*/], iVar11);
		...
		case 15:
			if (func_298(iParam0) && func_490(PLAYER::PLAYER_PED_ID()))
			{
				vVar13 = {get_entity_coords(Local_95[iParam0 /*36*/], 0)};
				fVar12 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), vVar13, 1);
...
void func_288(auto uParam0, int iParam1, int iParam2, float fParam3)
{
	if (!does_blip_exist(*uParam0))
	{
		if (func_490(iParam1))
		{
			*uParam0 = func_289(iParam1, iParam2, 145);
...
int func_289(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_290(iParam0, !iParam1, 0);
...
int func_290(int iParam0, int iParam1, int iParam2)
{
	...
	{
		set_blip_scale(iVar0, func_291(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!iParam2)
		{
	...
	{
		set_blip_scale(iVar0, func_291(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		set_blip_as_friendly(iVar0, iParam1);
	}
...
float func_291(int iParam0, float fParam1, float fParam2)
{
	if (iParam0)
	{
		return fParam1;
...
auto func_294(int iParam0, Vector3 vParam1, int iParam2)
{
	Vector3 vVar0;
...
bool func_295(Vector3 vParam0)
{
	...
	vVar0 = {get_entity_forward_vector(PLAYER::PLAYER_PED_ID())};
	vVar0.z = 0f;
	vVar3 = {vParam0 - get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
	vVar3 = {func_297(vVar3)};
	fVar6 = func_296(vVar0, vVar3);
	if (fVar6 > 0.1f)
	{
		return true;
	}
...
float func_296(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3)
{
...
{
	return (ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]) && !is_entity_dead(Local_95[iParam0 /*36*/], 0));
}
...
bool func_300(int iParam0, auto uParam1)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 fVar6;
	...
	if (func_490(Local_95[uParam1 /*36*/]))
	{
		vVar3 = {get_entity_coords(Local_95[uParam1 /*36*/], 1)};
		fVar6 = get_entity_heading(Local_95[uParam1 /*36*/]);
		switch (iParam0)
		{
			case 3:
		...
		Local_95[iParam0 /*36*/].f_25 = Local_95[uParam1 /*36*/].f_25;
		func_285(iParam0, 0);
		Local_95[iParam0 /*36*/].f_29 = 1;
		Local_95[iParam0 /*36*/].f_30 = uParam1;
		Local_95[uParam1 /*36*/].f_28 = 1;
		...
		if (func_302(&(Local_95[iParam0 /*36*/]), Local_95[iParam0 /*36*/].f_17, Local_95[iParam0 /*36*/].f_32, Local_95[iParam0 /*36*/].f_15, 0, iVar7))
		{
			...
			task_follow_to_offset_of_entity(Local_95[iParam0 /*36*/], Local_95[uParam1 /*36*/], vVar0, 1f, -1, 0.1f, 1);
			return true;
		}
		return false;
	}
...
void func_301(auto uParam0, int iParam1, int iParam2)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		...
		set_entity_load_collision_flag(*uParam0, true);
...
bool func_302(auto uParam0, Vector3 vParam1, Vector3 fParam2, int iParam3, int iParam4, int iParam5)
{
	if (func_303(uParam0, iParam5, vParam1, fParam4, iParam6, 0, iParam7))
	{
		if (func_490(*uParam0))
		{
			return true;
...
bool func_303(auto uParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4, int iParam5, auto uParam6)
{
	int iVar0;
	float fVar1;
			...
			if (!iParam7)
			{
				if (iParam1 == joaat("a_c_deer"))
				{
					...
					if (iLocal_1807 < 3 || uParam8)
					{
						...
						if (iLocal_1808 != 0)
						{
							fVar1 = to_float(iLocal_1807) / to_float(iLocal_1808);
							fVar1 *= 75f;
						}
						if (IntToFloat(get_random_int_in_range(false, 100)) > fVar1 || uParam8)
						{
							set_ped_component_variation(*uParam0, 8, 0, false, 0);
					...
					if (iVar0)
					{
						set_ped_component_variation(*uParam0, 8, 1, false, 0);
						if (decor_exist_on(*uParam0, "doe_elk"))
						{
							decor_remove(*uParam0, "doe_elk");
						}
					}
					set_ped_component_variation(*uParam0, false, 0, get_random_int_in_range(false, 3), 0);
				}
				...
				{
					set_ped_component_variation(*uParam0, false, 0, get_random_int_in_range(false, 4), 0);
				}
				set_entity_lod_dist(*uParam0, 1500);
				set_entity_load_collision_flag(*uParam0, true);
				set_ped_lod_multiplier(*uParam0, 5f);
...
bool func_305(auto uParam0, float fParam1)
{
	float fVar0;
...
bool func_308(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 && iLocal_1792)
	{
		...
		{
			if (vdist2(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), Local_385[iVar0 /*5*/]) > 22500f)
			{
				return false;
			}
			...
			vVar1 = {func_309(Local_385[iVar0 /*5*/], 5f)};
			get_ground_z_for_3d_coord(vVar1 + Vector(0f, 0.5f, 0f), &(vVar1.f_2), 0);
...
Vector3 func_309(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	
	vVar0 = {get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f), get_random_float_in_range(-1f, 1f)};
	return vParam0 + func_310(vVar0, get_random_float_in_range(0f, fParam3));
}

Vector3 func_310(Vector3 vParam0, Vector3 fParam1)
{
	float fVar0;
...
int func_311()
{
	...
	iVar0 = get_random_int_in_range(false, 58);
	...
	vVar7 = {func_313(0f, 1f, 0f, vVar4.z)};
	vVar10 = {Local_385[iVar0 /*5*/] - vVar1};
	fVar13 = func_312(vVar7, vVar10);
	if (fVar13 > 0f)
	{
		return 59;
	}
	vVar14 = {get_entity_coords(PLAYER::PLAYER_PED_ID(), 1)};
...
Vector3 func_313(Vector3 vParam0, Vector3 fParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	Vector3 fVar4;
...
void func_314(auto uParam0, int iParam1)
{
	Vector3 vVar0;
	Vector3 fVar3;
	int iVar4;
	...
	fVar3 = get_distance_between_coords(vLocal_1800, vVar0, 1);
	iVar4 = is_entity_on_screen(*uParam0);
	if (!*uParam0.f_12)
	{
		iVar5 = true;
		if (((iVar4 && *uParam0.f_2 < GAMEPLAY::GET_GAME_TIMER()) && fVar3 < fLocal_1793) && (iLocal_1817 == iParam1 || iLocal_1817 == -1))
		{
			iLocal_1817 = iParam1;
			iVar6 = func_317(uParam0, vVar0, fVar3);
			if (iVar6 == 1)
			{
				iVar5 = false;
			}
		...
		if (iVar4 && !iVar5)
		{
			_0xF9904D11F1ACBEC3(vVar0, &fVar7, &fVar8);
		...
		if (((iLocal_1799 && GAMEPLAY::GET_GAME_TIMER() > iLocal_1943) && !*uParam0.f_10) || *uParam0.f_10)
		{
			...
			if ((*uParam0.f_8 && GAMEPLAY::GET_GAME_TIMER() > iLocal_1943) || iLocal_1799)
			{
				if (!*uParam0.f_10)
				{
					if (*uParam0.f_6 == 0)
					{
						*uParam0.f_6 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(false, 11) * 100;
					}
					else if (*uParam0.f_6 < GAMEPLAY::GET_GAME_TIMER())
					{
						...
						*uParam0.f_10 = 1;
						iLocal_1814 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(30000, 60000);
					}
				}
			}
		}
	...
	else if (does_blip_exist(*uParam0.f_1))
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() > *uParam0.f_5 && fVar3 > 35f) && *uParam0.f_11)
		{
			if (iVar4)
			{
				if ((*uParam0.f_2 < GAMEPLAY::GET_GAME_TIMER() && (iLocal_1817 == iParam1 || iLocal_1817 == -1)) && fVar3 < fLocal_1793)
				{
					iLocal_1817 = iParam1;
					iVar13 = func_317(uParam0, vVar0, fVar3);
					if (iVar13 == 1)
					{
						if (*uParam0.f_12)
						{
			...
			*uParam0.f_3 = get_blip_alpha(*uParam0.f_1);
			if (*uParam0.f_3 > 0)
			{
				if (get_random_int_in_range(false, 1000) > 666)
				{
					*uParam0.f_3--;
...
void func_315(char* sParam0, int iParam1)
{
	...
	_play_ambient_speech_with_voice(PLAYER::PLAYER_PED_ID(), sParam0, "TREVOR_NORMAL", func_316(3), 0);
	Local_676.f_54 += 8000;
}
...
int func_317(auto uParam0, Vector3 vParam1, Vector3 fParam2)
{
	Vector3 vVar0;
	int iVar3;
	auto uVar4;
	...
	if (iLocal_1818 == 0)
	{
		...
		iLocal_1818 = _0x7EE9F5D83DD4F90E(vVar0, vParam1, 1, false, 7);
	}
	else
	{
		iVar11 = _get_raycast_result(iLocal_1818, &iVar3, &uVar4, &uVar7, &uVar10);
		if (iVar11 == 2)
		{
			if (iVar3 == 0)
			{
				*uParam0.f_2 = GAMEPLAY::GET_GAME_TIMER() + func_318(fParam4);
				iLocal_1817 = -1;
				iLocal_1818 = 0;
				return 1;
			}
...
void func_319(int iParam0)
{
	...
	if ((iLocal_1799 && iLocal_1944 + 4000 + 5000 < GAMEPLAY::GET_GAME_TIMER()) && Local_95[iParam0 /*36*/].f_4 < GAMEPLAY::GET_GAME_TIMER())
	{
		iLocal_1799 = 0;
...
void func_320(int iParam0)
{
	...
	iVar0 = Local_95[iParam0 /*36*/].f_9;
	if (func_298(iParam0) && !Local_95[iParam0 /*36*/].f_9)
	{
		Local_95[iParam0 /*36*/].f_17 = {get_entity_coords(Local_95[iParam0 /*36*/], 0)};
		Local_95[iParam0 /*36*/].f_33 = get_distance_between_coords(Local_95[iParam0 /*36*/].f_17, get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 0);
		Local_95[iParam0 /*36*/].f_20 = {_get_object_offset_from_coords(Local_95[iParam0 /*36*/].f_17, fLocal_1788, -vLocal_1809)};
		if (_0x6CD5A433374D4CFB(Local_95[iParam0 /*36*/], PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_1792)
			{
		...
		if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), Local_95[iParam0 /*36*/].f_17 + Vector(-45f, 0f, 0f), Local_95[iParam0 /*36*/].f_20 + Vector(45f, 0f, 0f), 10f, 0, false, 0))
		{
			if (iLocal_1792)
			{
	...
	if (Local_95[iParam0 /*36*/].f_9 && !iVar0)
	{
		Local_676.f_32 = 0;
...
void func_321(int iParam0)
{
	...
	while (iVar1 < 8)
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_95[iVar1 /*36*/]) && !is_entity_dead(Local_95[iVar1 /*36*/], 0))
			{
				func_328(iVar1);
...
bool func_322(int iParam0, float fParam1, float fParam2)
{
	if (func_8(iParam0))
	{
		if (is_bullet_in_area(get_entity_coords(iParam0, 1), fParam1, 0))
		{
			return true;
		}
...
bool func_323(int iParam0, float fParam1, int iParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
bool func_324(int iParam0, float fParam1)
{
	auto uVar0;
	Vector3 vVar1;
	...
	{
		if (func_325(iParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_325(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	float fVar6;
	
	vVar0 = {func_297(vParam1 - get_entity_coords(iParam0, 1))};
	...
	{
		vVar3 = {func_297(get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) - get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
...
auto func_327(int iParam0, int iParam1, int iParam2)
{
	Vector3 vVar0;
	Vector3 vVar3;
...
void func_328(int iParam0)
{
	if (!iLocal_1792)
	{
		...
		{
			set_entity_proofs(Local_95[iParam0 /*36*/], true, false, false, false, false, false, 0, false);
			task_smart_flee_ped(Local_95[iParam0 /*36*/], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			set_ped_keep_task(Local_95[iParam0 /*36*/], true);
		}
		func_285(iParam0, 1);
...
void func_329()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(get_vehicle_ped_is_using(iVar0)))
	{
		return;
	}
	if (func_9())
	...
	if ((((is_control_just_released(2, 234) && !is_player_free_aiming(player_id())) && !is_ped_ragdoll(iVar0)) && !is_ped_running_ragdoll_task(iVar0)) || iLocal_1945 != -1)
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_1946)
		{
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_1945)
			{
				...
				play_sound_from_entity(-1, "PLAYER_CALLS_ELK_MASTER", iVar0, 0, 0, 0);
				_0x72DD432F3CDFC0EE(get_entity_coords(iVar0, 1), 30f, 11);
		...
		if (!func_9())
		{
			if (!iLocal_2270[5])
			{
				if (func_332(4))
				{
					...
					fVar3 = fLocal_2396;
					fVar4 = 8.25f * 4f;
					if (vdist(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), vVar0) <= fVar4)
					{
						vVar0 = {vLocal_2397};
						fVar3 = fLocal_2400;
					}
					task_follow_nav_mesh_to_coord(Local_95[4 /*36*/], vVar0, 2f, -1, 0.25f, 0, fVar3);
			...
			else
			{
				...
				{
					clear_help(1);
					task_look_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_2366[4 /*3*/], -1, 0, 2);
					iLocal_2302 = GAMEPLAY::GET_GAME_TIMER() + 3000;
					iLocal_2028 = 17;
					iLocal_2029 = 1;
				}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]) && !is_entity_visible(Local_95[iParam0 /*36*/]))
	{
		set_entity_visible(Local_95[iParam0 /*36*/], true, 0);
	}
}
...
bool func_332(int iParam0)
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]))
	{
		if (iParam0 == 0)
		{
			if (func_336(iParam0, 10, vLocal_2366[iParam0 /*3*/], 0, 0))
			{
				if (func_8(Local_95[iParam0 /*36*/]))
				{
					iLocal_1799 = 0;
					set_entity_heading(Local_95[iParam0 /*36*/], fLocal_2287[iParam0]);
		...
		else if (func_336(iParam0, 10, vLocal_2366[iParam0 /*3*/], 0, 1))
		{
			if (func_8(Local_95[iParam0 /*36*/]))
			{
				iLocal_1799 = 0;
				set_entity_heading(Local_95[iParam0 /*36*/], fLocal_2287[iParam0]);
				func_334(&(Local_95[iParam0 /*36*/]), 0);
				set_entity_visible(Local_95[iParam0 /*36*/], false, 0);
				if (iParam0 == 3)
				{
...
void func_334(auto uParam0, int iParam1)
{
	*uParam0.f_8 = iParam1;
}
...
bool func_336(int iParam0, int iParam1, Vector3 vParam2, int iParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]))
	{
		if (func_308(iParam0, iParam1, iParam5, iParam6))
		{
			func_229(Local_95[iParam0 /*36*/], vParam2, 0, 0, 1);
			return true;
		}
	}
	else
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				...
				{
					clear_ped_tasks(iLocal_2307);
					func_229(iLocal_2307, vLocal_2360, fLocal_2286, 0, 1);
					func_400(0, 0);
				}
				if (!func_230())
				{
		...
		case 2:
			...
			func_219();
			func_217();
			set_ped_can_use_auto_conversation_lookat(PLAYER::PLAYER_PED_ID(), 1);
			iLocal_2302 = GAMEPLAY::GET_GAME_TIMER() + 1700;
			iLocal_2270[5] = 0;
			iLocal_2226[10] = 1;
			iLocal_2032 = 0;
...
void func_338(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_214(get_this_script_name(), 1);
			if (iVar5 != -1)
			{
...
void func_339(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	func_340(&Global_95496, get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

void func_340(auto uParam0, char* sParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0.f_1 = func_383();
	...
	while (iVar1 < 3)
	{
		*uParam0.f_17[iVar1] = Global_101154.f_1826.f_539.f_294[iVar1];
		if (iVar1 == func_361())
		{
			func_357(PLAYER::PLAYER_PED_ID(), uParam0.f_616[iVar1 /*65*/], 1);
		}
		else
		{
			iVar0 = 0;
...
void func_342(auto uParam0, auto uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
bool func_343(auto uParam0, auto uParam1, int iParam2, int iParam3)
{
...
void func_345(auto uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_88942[iVar0]))
		{
			if (Global_88942[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_349(iParam1, iParam2))
					{
						return true;
					}
				}
...
void func_350(int iParam0, auto uParam1, int iParam2)
{
	int iVar0;
...
void func_351(int iParam0, auto uParam1)
{
	int iVar0;
	...
	if (is_vehicle_driveable(iParam0, 0))
	{
		...
		*uParam1.f_70 = get_vehicle_door_lock_status(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::GAMEPLAY::SET_BIT(uParam1.f_77, func_352(iVar0 + 1));
			}
			iVar0++;
		}
...
bool func_353(int iParam0, auto uParam1, auto uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_354(int iParam0, auto uParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
bool func_355(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	while (func_356(iParam1, iVar0, &sVar1, &uVar9))
	{
...
bool func_356(int iParam0, int iParam1, char* sParam2, auto uParam3)
{
...
void func_359(int iParam0, int iParam1, auto uParam2, auto uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_360(int iParam0, int iParam1, auto uParam2, auto uParam3, auto uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_363(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 44 - 1)
		{
			...
			if (iVar3 != 0)
			{
				vVar4.x = get_ped_weapontype_in_slot(iParam0, func_367(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((get_dlc_weapon_data(iVar7, &Var9) && !func_364(Var9.f_1)) && iVar70 < 50)
			{
...
int func_366(int iParam0, auto uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_370(Vector3 vParam0, char* sParam1, Vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_371(int iParam0, auto uParam1, auto uParam2)
{
	*uParam1 = {0f, 0f, 0f};
	*uParam2 = 0f;
	switch (iParam0)
...
int func_372(Vector3 vParam0, Vector3 vParam1, int iParam2)
{
	if (iParam6)
	{
...
bool func_373(auto uParam0)
{
	if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_382())
		{
			*uParam0 = func_378(get_entity_coords(PLAYER::PLAYER_PED_ID(), 0), 5, -1, 0, 1, -1);
...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_22() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_83(func_376(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_378(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	Vector3 fVar1;
	Vector3 fVar2;
	...
	while (iVar0 <= 44)
	{
		...
		{
			if (!iParam5 || func_380(iVar0))
			{
				fVar1 = get_distance_between_coords(vParam0, func_379(iVar0, 0), 1);
...
auto func_388(int iParam0)
{
	return shift_right(iParam0, 26) & 31 * func_389(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1) + 2011;
}
...
int func_390(auto uParam0)
{
	return uParam0 & 15;
}

void func_391(auto uParam0, int iParam1)
{
...
void func_392(auto uParam0, int iParam1)
{
...
void func_393(auto uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_397(char* sParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
{
	if (!does_blip_exist(iLocal_2200))
	{
	...
	if (does_blip_exist(iLocal_2200))
	{
		if (!iParam0)
		{
			set_blip_scale(iLocal_2200, 0.75f);
		}
		set_blip_flashes(iLocal_2200, iParam1);
	}
}
			...
			if (!Local_95[2 /*36*/].f_9)
			{
				...
				else
				{
					if (!iLocal_2246[2])
					{
						...
						{
							func_265("HT_OBJ");
							set_ped_can_use_auto_conversation_lookat(PLAYER::PLAYER_PED_ID(), 0);
							task_look_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_2366[2 /*3*/], -1, 0, 2);
							iLocal_2246[2] = 1;
						}
					}
...
bool func_403(float fParam0)
{
	...
	if (func_490(PLAYER::PLAYER_PED_ID()) && func_490(iLocal_2307))
	{
		fVar0 = get_distance_between_coords(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), get_entity_coords(iLocal_2307, 1), 0);
		if (fVar0 < fParam0)
		{
			return true;
		}
		...
		if (iLocal_2226[8] && iLocal_2030 != 2)
		{
			if (!func_9())
			{
				...
				else if (func_332(2) && func_332(3))
				{
					...
					task_follow_nav_mesh_to_coord(Local_95[2 /*36*/], vLocal_2385, 2f, -1, 0.25f, 0, fLocal_2388);
					task_follow_nav_mesh_to_coord(Local_95[3 /*36*/], vLocal_2389, 2f, -1, 0.25f, 0, fLocal_2392);
					iLocal_2028 = 13;
					iLocal_2029 = 0;
				}
			}
...
void func_405()
{
	...
	if (func_490(iLocal_2307))
	{
		if (func_490(PLAYER::PLAYER_PED_ID()))
		{
			fVar0 = func_327(iLocal_2307, PLAYER::PLAYER_PED_ID(), 0);
			if (fVar0 > 100f)
			{
				if (!iLocal_2220)
				{
...
void func_406(auto uParam0, int iParam1)
{
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				...
				{
					clear_ped_tasks(iLocal_2307);
					func_229(iLocal_2307, vLocal_2354, fLocal_2285, 0, 1);
					func_400(0, 0);
				}
				if (!func_230())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_2351, fLocal_2281, 0, 1);
					func_222(vLocal_2357, 1112014848, 12, 5000, 0, 0);
				}
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (!Local_95[1 /*36*/].f_9)
			{
				...
				else if (((does_blip_exist(Local_95[1 /*36*/].f_1) && !iLocal_2246[1]) && iLocal_2226[5]) && !func_9())
				{
					func_265("HT_OBJ");
					iLocal_2246[1] = 1;
				}
...
void func_409()
{
	...
	switch (iLocal_2029)
	{
		...
		case 2:
			set_ped_can_use_auto_conversation_lookat(PLAYER::PLAYER_PED_ID(), 0);
			task_look_at_coord(PLAYER::PLAYER_PED_ID(), vLocal_2366[1 /*3*/], -1, 0, 2);
			task_follow_nav_mesh_to_coord(Local_95[1 /*36*/], vLocal_2382, 2f, -1, 0.25f, 0, 1193033728);
			iLocal_2302 = GAMEPLAY::GET_GAME_TIMER() + 3000;
			iLocal_2028 = 9;
			iLocal_2029 = 0;
			break;
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				...
				{
					clear_ped_tasks(iLocal_2307);
					func_229(iLocal_2307, vLocal_2347, fLocal_2350, 0, 1);
					func_400(0, 0);
				}
				if (!func_230())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_2343, fLocal_2346, 0, 1);
					func_222(vLocal_2337, 1112014848, 12, 5000, 0, 0);
				}
...
void func_411()
{
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (!iLocal_2246[0])
			{
				if ((iLocal_2226[1] && !func_9()) && iLocal_2426)
				{
					func_265("HT_OBJ");
					iLocal_1799 = 1;
					if (func_281("HT_OBJ", 0, 0))
			...
			{
				if (!iLocal_2270[1] && !get_ped_stealth_movement(PLAYER::PLAYER_PED_ID()))
				{
					func_279(1);
				}
			}
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				...
				if (!func_230())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_2337, fLocal_2280, 0, 1);
					func_222(vLocal_2337, 1112014848, 12, 5000, 0, 0);
				}
				if (!PED::IS_PED_INJURED(iLocal_2307))
				{
				...
				func_229(iLocal_2307, vLocal_2340, fLocal_2284, 0, 1);
				iLocal_2029 = 2;
			}
			break;
	...
	switch (iLocal_2029)
	{
		...
		case 1:
			if (is_screen_faded_out())
			{
				if (!func_230())
				{
					func_229(PLAYER::PLAYER_PED_ID(), vLocal_2331, fLocal_2279, 0, 1);
					func_222(vLocal_2331, 1112014848, 12, 5000, 0, 0);
					func_219();
				}
			...
			switch (iLocal_2294)
			{
				case 0:
					if (func_438(1, 1093140480, 0))
					{
						if (func_8(PLAYER::PLAYER_PED_ID()))
						{
							register_entity_for_cutscene(PLAYER::PLAYER_PED_ID(), sLocal_2311, 0, false, 0);
						}
						if (func_8(iLocal_2307))
						{
							register_entity_for_cutscene(iLocal_2307, "Cletus", 0, false, 0);
							_0x2A56C06EBEF2B0D9("Cletus", PLAYER::PLAYER_PED_ID(), false);
							...
							give_weapon_component_to_weapon_object(iLocal_2306, joaat("component_at_ar_supp_02"));
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_2305))
						{
							register_entity_for_cutscene(iLocal_2305, "Cletus_Gun", 0, false, 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_2306))
						{
							register_entity_for_cutscene(iLocal_2306, "Trevors_Weapon", 0, false, 0);
						}
						func_435();
						start_cutscene(0);
						_0x48621C9FCA3EBD28(4);
						wait(0);
						func_429(vLocal_2413, vLocal_2416, 5f, vLocal_2422, fLocal_2425, 1, 1, 1, 0, 0);
						func_429(vLocal_2413, vLocal_2419, 25f, vLocal_2422, fLocal_2425, 1, 1, 1, 0, 0);
						func_425(vLocal_2331, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
						iLocal_2294++;
					}
					break;
				...
				case 1:
					...
					{
						give_weapon_object_to_ped(iLocal_2306, PLAYER::PLAYER_PED_ID());
						if (has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), 0))
						{
							set_ammo_in_clip(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), 10);
						}
					}
					if (can_set_exit_state_for_registered_entity("Cletus_Gun", get_weapontype_model(joaat("weapon_sniperrifle"))))
					{
						give_weapon_object_to_ped(iLocal_2305, iLocal_2307);
						force_ped_motion_state(iLocal_2307, -668482597, false, 1, 0);
					}
					if (can_set_exit_state_for_registered_entity(sLocal_2311, false))
					{
						force_ped_motion_state(PLAYER::PLAYER_PED_ID(), -668482597, false, 1, 0);
...
void func_417(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_421(player_id())) && !func_419(player_id(), 0)) && !func_418())
			{
				set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_421(player_id()))
		{
			set_entity_invincible(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_69487 = 0;
...
int func_423(int iParam0, int iParam1, auto uParam2, int iParam3)
{
	int iVar0;
...
void func_425(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	...
	if (is_player_playing(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			clear_area_of_peds(func_427(get_player_index()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_429(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_430(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

void func_430(Vector3 vParam0, Vector3 vParam1, Vector3 fParam2, Vector3 vParam3, Vector3 fParam4, Vector3 vParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (is_vehicle_driveable(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_432(iVar0, vParam0, vParam3, fParam6))
					{
						iVar1 = true;
					}
				}
...
bool func_432(int iParam0, Vector3 vParam1, Vector3 vParam2, Vector3 fParam3)
{
	Vector3 vVar0;
	Vector3 vVar3;
	Vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = {func_297(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_433(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_433(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_433(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_433(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_433(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_433(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_433(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_433(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_433(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_433(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_433(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_433(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_433(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_433(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_433(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_433(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return true;
		}
	}
...
bool func_433(struct<2> Param0, auto uParam1, struct<2> Param2, auto uParam3, struct<2> Param4, auto uParam5, struct<2> Param6, auto uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_436(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_365(iVar2, iVar8) != 0)
	{
		if (!is_entity_dead(iParam0, 0))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_365(iVar2, iVar8)))
			{
				if (func_437(func_365(iVar2, iVar8)))
				{
					iVar9 = get_weapon_component_type_model(func_365(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_365(iVar2, iVar8) != 0)
	{
		if (!is_entity_dead(iParam0, 0))
		{
			if (has_ped_got_weapon_component(iParam0, iVar2, func_365(iVar2, iVar8)))
			{
				give_weapon_component_to_weapon_object(iVar1, func_365(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
bool func_438(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_442(get_vehicle_ped_is_in(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_441(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_442(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_444()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_2307))
	{
		set_ped_dies_in_water(iLocal_2307, 0);
		set_ped_default_component_variation(iLocal_2307);
		set_entity_only_damaged_by_player(iLocal_2307, true);
		set_ped_can_ragdoll_from_player_impact(iLocal_2307, 0);
		give_weapon_to_ped(iLocal_2307, joaat("weapon_pumpshotgun"), -1, false, true);
	}
	iLocal_1798 = 0;
	iLocal_1828 = true;
	fLocal_1788 = 0f;
	...
	if (func_517())
	{
		...
		{
			case 0:
				func_445(vLocal_2331, fLocal_2279, 1, 0);
				iLocal_2028 = 2;
				break;
			
			case 1:
				func_445(vLocal_2337, fLocal_2280, 1, 0);
				iLocal_2028 = 3;
				break;
			
			case 2:
				func_445(vLocal_2343, fLocal_2346, 1, 0);
				iLocal_2028 = 6;
				break;
			
			case 3:
				func_445(vLocal_2351, fLocal_2281, 1, 0);
				iLocal_2028 = 10;
				break;
			
			case 4:
				func_445(vLocal_2357, fLocal_2282, 1, 0);
				iLocal_2028 = 14;
				break;
...
void func_452()
{
	...
	request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_CALLS", 0);
	request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_VOCALS", 0);
	request_mission_audio_bank("SCRIPT\HUNTING_MAIN_A", 0);
	...
	while (((((((!STREAMING::HAS_MODEL_LOADED(iLocal_2304) || !request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_CALLS", 0)) || !request_mission_audio_bank("SCRIPT\HUNTING_2_ELK_VOCALS", 0)) || !request_mission_audio_bank("SCRIPT\HUNTING_MAIN_A", 0)) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@enter")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@idle_a")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@exit")) || !has_anim_dict_loaded("creatures@deer@amb@world_deer_grazing@base"))
	{
		wait(0);
	}
	iLocal_2204 = 1;
...
void func_453()
{
	request_additional_text("HUNT2", false);
	request_additional_text(sLocal_2310, 6);
...
void func_456(int iParam0, float fParam1)
{
	...
	if (iLocal_1948 == -1)
	{
		get_hud_colour(18, &iLocal_1948, &iLocal_1949, &iLocal_1950, &uVar0);
		get_hud_colour(18, &iLocal_1954, &iLocal_1955, &iLocal_1956, &uVar0);
		get_hud_colour(6, &iLocal_1951, &iLocal_1952, &iLocal_1953, &uVar0);
	}
	fVar1 = 0f;
	...
	if (!iParam0)
	{
		if (!is_entity_dead(PLAYER::PLAYER_PED_ID(), 0))
		{
			vLocal_1789 = {get_wind_direction()};
			fLocal_1788 = get_heading_from_vector_2d(vLocal_1789.x, vLocal_1789.y);
	...
	func_457("AHT_WIND_UPPR", round(fVar5), fVar1, iLocal_1948, iLocal_1949, iLocal_1950, 6);
}
...
bool func_460()
{
	...
	while (iVar0 < 8)
	{
		...
		{
			vVar1 = {func_297(Local_95[iVar0 /*36*/].f_20 + Vector(45f, 0f, 0f) - Local_95[iVar0 /*36*/].f_17 + Vector(-45f, 0f, 0f))};
			vVar4 = {Local_95[iVar0 /*36*/].f_17 + Vector(45f, 0f, 0f)};
			vVar7 = {Local_95[iVar0 /*36*/].f_20 + Vector(-45f, 0f, 0f) + vVar1 * Vector(45f, 45f, 45f)};
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vVar4, vVar7, 10f + 20f, 0, false, 0))
			{
				if (iLocal_1792)
				{
					if (!Local_676.f_662)
	...
	if (func_490(PLAYER::PLAYER_PED_ID()))
	{
		if (!iLocal_2214 && !iLocal_2203)
		{
			...
			if (is_explosion_in_sphere(-1, vVar0, 40f))
			{
				clear_prints();
				func_215();
				task_wander_standard(iLocal_2307, 1193033728, 0);
				set_ped_keep_task(iLocal_2307, true);
				iLocal_2030 = 0;
			...
			if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
			{
				if ((func_294(PLAYER::PLAYER_PED_ID(), vLocal_2366[0 /*3*/], 1) < 80f || func_294(PLAYER::PLAYER_PED_ID(), vLocal_2366[1 /*3*/], 1) < 80f) || func_294(PLAYER::PLAYER_PED_ID(), vLocal_2366[2 /*3*/], 1) < 80f)
				{
					clear_prints();
					func_215();
					task_wander_standard(iLocal_2307, 1193033728, 0);
...
void func_463()
{
	...
	{
		if (((func_468() && !iLocal_1804) && is_player_free_aiming(player_id())) && is_first_person_aim_cam_active())
		{
			if (iLocal_1819 == -1)
			{
				iLocal_1819 = get_sound_id();
			}
			if (iLocal_1820 >= 10)
			{
				if (!is_audio_scene_active("HUNTING_02_SETTINGS"))
				{
					...
					set_audio_scene_variable("HUNTING_02_SETTINGS", "Concentration", fLocal_1821);
					play_sound_from_entity(iLocal_1819, "Heart_Breathing", PLAYER::PLAYER_PED_ID(), 0, 0, 0);
				}
				else
				{
				...
				set_variable_on_sound(iLocal_1819, "Concentration", fLocal_1822);
			}
			else
			{
				iLocal_1820++;
...
void func_464()
{
	...
	{
		set_audio_scene_variable("HUNTING_02_SETTINGS", "Concentration", fLocal_1821);
		set_audio_scene_variable("HUNTING_02_SETTINGS", "Breathing", fLocal_1821);
		set_variable_on_sound(iLocal_1819, "Concentration", fLocal_1822);
	}
}
...
void func_467(float fParam0, float fParam1)
{
	if (func_490(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (is_ped_sprinting(PLAYER::PLAYER_PED_ID()))
		{
			*fParam0 = 0f;
			*fParam1 = 0f;
		}
...
bool func_468()
{
	if (func_490(PLAYER::PLAYER_PED_ID()))
	{
		if (get_weapontype_group(func_469(PLAYER::PLAYER_PED_ID())) == -1212426201)
		{
			if (!iLocal_1805)
			{
				iLocal_1805 = 1;
...
void func_470()
{
	...
	switch (iLocal_2030)
	{
		...
		case 1:
			switch (iLocal_2032)
			{
				case 0:
					if (!func_9())
					{
						task_follow_waypoint_recording(iLocal_2307, "HT2_CLE_0_1", iLocal_2438, 2, -1);
						set_ped_can_ragdoll_from_player_impact(iLocal_2307, 0);
						settimera(0);
						iLocal_2032 = 1;
					}
				...
				case 1:
					if (func_403(15f))
					{
						if (!iLocal_2226[0])
						{
							...
							{
								StringCopy(&Local_2313, "HT_CUT", 24);
								if (func_485(&uLocal_2034, sLocal_2310, &Local_2313, &Local_2319, 7, 0, 0))
								{
									if (!is_ped_headtracking_ped(iLocal_2307, PLAYER::PLAYER_PED_ID()))
									{
										task_look_at_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
									}
									if (!is_string_null_or_empty(&Local_2319))
									{
										Local_2319 = {func_484()};
									}
									iLocal_2226[0] = 1;
						...
						{
							Local_2325 = {func_483()};
							if (are_strings_equal(&Local_2325, "HT_CUT_6"))
							{
								iLocal_2202 = 1;
								func_279(0);
							}
						}
						else if (get_script_task_status(iLocal_2307, -1689270312) == 7)
						{
							set_ped_can_ragdoll_from_player_impact(iLocal_2307, 1);
							iLocal_2032 = 2;
						}
					}
					else
					{
						if (get_script_task_status(iLocal_2307, -1689270312) == 1)
						{
							iLocal_2438 = get_ped_waypoint_progress(iLocal_2307);
						}
						func_400(0, 0);
						iLocal_2032 = 0;
						iLocal_2031 = 1;
		...
		case 2:
			...
			else
			{
				if (func_281("HT_BAC", 0, 0))
				{
					...
					if (iLocal_2301 == 0)
					{
						iLocal_2301 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(5000, 10000);
						task_stand_still(iLocal_2307, -1);
						clear_ped_tasks(iLocal_2307);
						task_turn_ped_to_face_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), 0);
						if (func_9())
						{
							Local_2319 = {func_484()};
							func_231();
				...
				{
					fVar0 = func_482(iLocal_2307, PLAYER::PLAYER_PED_ID());
					if (func_281("HT_BAC", 0, 0))
					{
						iVar1 = 1;
					}
					...
					if (fVar0 < 20f)
					{
						if (is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								iLocal_2301 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(8000, 12000);
							}
						}
						else
						{
							iVar2 = get_random_int_in_range(false, 65535);
							if (iVar2 < 20000)
							{
		...
		case 3:
			if (func_403(15f))
			{
				if (!is_help_message_on_screen())
				{
					...
					{
						if (!iLocal_2429 && timera() > 333)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_2307) && !is_entity_dead(iLocal_2307, 0))
							{
								open_sequence_task(&iVar3);
								task_turn_ped_to_face_coord(false, -607.1139f, 5851.372f, 23.0589f, 0);
								task_play_anim(false, "gestures@m@standing@casual", "gesture_point", 4f, -2f, -1, 48, 0, 0, 0, 0);
								close_sequence_task(iVar3);
								task_perform_sequence(iLocal_2307, iVar3);
								clear_sequence_task(&iVar3);
							}
							task_look_at_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), -1, 1, 2);
							iLocal_2429 = 1;
						}
						Local_2325 = {func_483()};
						if (are_strings_equal(&Local_2325, "HT2_HUNT_3") || !func_9())
						{
							func_480(iLocal_2307, 1);
							task_follow_nav_mesh_to_coord(iLocal_2307, -605.36f, 5856.549f, 22.7741f, 1f, 60000, 0.25f, 0, 239.6328f);
							set_ped_can_ragdoll_from_player_impact(iLocal_2307, 0);
							iLocal_2030 = 4;
						}
					}
		...
		case 4:
			if (!iLocal_2426)
			{
				iLocal_2426 = vdist(get_entity_coords(iLocal_2307, 1), -605.36f, 5856.549f, 22.7741f) < 4f;
				task_look_at_entity(iLocal_2307, Local_95[0 /*36*/], -1, 1, 2);
			}
			if (func_490(Local_95[0 /*36*/]))
			{
				if (!Local_95[0 /*36*/].f_9)
			...
			else
			{
				...
				func_231();
				func_14(Local_95[0 /*36*/]);
				if (!iLocal_2219 && !Local_95[0 /*36*/].f_9)
				{
					if (!iLocal_2226[2])
					{
						...
						{
							func_480(iLocal_2307, 0);
							task_clear_look_at(iLocal_2307);
							task_turn_ped_to_face_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), 0);
							task_look_at_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							iLocal_2226[2] = 1;
							iLocal_2030 = 5;
						}
					}
		...
		case 7:
			switch (iLocal_2032)
			{
				case 0:
					...
					{
						func_485(&uLocal_2034, sLocal_2310, &Local_2313, &Local_2319, 7, 0, 0);
					}
					Local_2325 = {func_483()};
					if (are_strings_equal(&Local_2325, "HT2_WHISTLE2_1") || iLocal_2439 != 0)
					{
						func_480(iLocal_2307, 1);
						task_clear_look_at(iLocal_2307);
						task_follow_waypoint_recording(iLocal_2307, "HT2_CLE_1_2", iLocal_2439, 258, -1);
						set_ped_can_ragdoll_from_player_impact(iLocal_2307, 0);
						iLocal_2032 = 1;
					}
					break;
				...
				case 1:
					if (!iLocal_2226[4])
					{
						if (func_403(15f))
						{
							if (get_script_task_status(iLocal_2307, -1689270312) == 7)
							{
								if (!func_9())
								{
									if (func_481(&uLocal_2034, sLocal_2310, "HT2_WHISTLE1", 7, 0, 0, 0))
									{
										...
										task_look_at_entity(false, PLAYER::PLAYER_PED_ID(), 5000, 16, 4);
										task_pause(false, 5000);
										task_play_anim(false, "amb@world_human_guard_patrol@male@idle_a", "idle_b", 2f, -2f, -1, 1, 0, 0, 0, 0);
										close_sequence_task(iVar4);
										task_perform_sequence(iLocal_2307, iVar4);
						...
						{
							iLocal_2439 = get_ped_waypoint_progress(iLocal_2307);
							iLocal_2032 = 0;
							iLocal_2031 = 7;
							iLocal_2030 = 2;
						}
					...
					else if (iLocal_2427 && !iLocal_2428)
					{
						if (timera() > 2500)
						{
							if (func_403(15f))
		...
		case 6:
			if (does_blip_exist(Local_95[1 /*36*/].f_1))
			{
				if (!iLocal_2226[5])
				{
					...
					{
						task_clear_look_at(iLocal_2307);
						task_turn_ped_to_face_coord(iLocal_2307, vLocal_2366[1 /*3*/], 0);
						func_480(iLocal_2307, 0);
					...
					else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2299)
					{
						if (func_481(&uLocal_2034, sLocal_2310, "HT2_WLK2", 6, 0, 0, 0))
						{
							...
							iLocal_2208 = 0;
							task_look_at_entity(iLocal_2307, Local_95[1 /*36*/], -1, 0, 2);
							settimera(0);
							iLocal_2226[5] = 1;
							iLocal_2030 = 8;
							iLocal_2032 = 0;
		...
		case 8:
			if (func_490(Local_95[1 /*36*/]))
			{
				if (!iLocal_2431 && timera() > 1000)
				{
					vVar5 = {func_297(get_entity_coords(Local_95[1 /*36*/], 1) - get_entity_coords(iLocal_2307, 1))};
					vVar8 = {get_entity_forward_vector(iLocal_2307)};
					fVar11 = func_312(vVar8, vVar5);
					if (fVar11 > 0.92f)
					{
						task_play_anim(iLocal_2307, "oddjobs@hunter", "point_fwd", 4f, -2f, -1, 48, 0, 0, 0, 0);
						iLocal_2431 = 1;
						iLocal_2433 = 0;
					}
				}
			...
			else
			{
				...
				if (!iLocal_2226[6])
				{
					if (!func_9())
					{
						if (!iLocal_2219 && !Local_95[1 /*36*/].f_9)
						{
							if (!iLocal_2430)
							{
								func_480(iLocal_2307, 0);
								if (get_script_task_status(iLocal_2307, 713668775) != 1)
								{
									task_follow_nav_mesh_to_coord(iLocal_2307, get_entity_coords(PLAYER::PLAYER_PED_ID(), 1), 2f, 60000, 0.25f, 0, fLocal_2286);
								}
			...
			switch (iLocal_2032)
			{
				case 0:
					if (!func_9() && func_403(15f))
					{
						...
						func_480(iLocal_2307, 1);
						task_look_at_coord(iLocal_2307, vLocal_2366[2 /*3*/], -1, 0, 2);
						task_follow_waypoint_recording(iLocal_2307, "HT2_CLE_2_3", iLocal_2440, 2, -1);
						iLocal_2032 = 1;
					}
					break;
				...
				case 1:
					...
					{
						iLocal_2440 = get_ped_waypoint_progress(iLocal_2307);
						iLocal_2032 = 0;
						iLocal_2031 = 11;
						iLocal_2030 = 2;
					}
				...
				else if (timera() > 1700)
				{
					if (!iLocal_2226[9])
					{
						if (func_481(&uLocal_2034, sLocal_2310, "HT2_ARR3", 6, 0, 0, 0))
						{
							...
							iLocal_2226[9] = 1;
							func_480(iLocal_2307, 1);
							iVar12 = get_ped_group_index(PLAYER::PLAYER_PED_ID());
							set_ped_as_group_member(iLocal_2307, iVar12);
							iLocal_2433 = 0;
							iLocal_2032 = 0;
							iLocal_2030 = 12;
						}
			...
			else
			{
				...
				if (!iLocal_2219)
				{
					if (!iLocal_2226[10])
					{
						...
						if (func_481(&uLocal_2034, sLocal_2310, sLocal_2312, 7, 0, 0, 0))
						{
							clear_ped_tasks_immediately(iLocal_2307);
							func_480(iLocal_2307, 0);
							iLocal_2226[10] = 1;
						}
					}
					else if (func_403(15f))
					{
						if (!func_9() && !iLocal_2226[11])
						{
							if (func_481(&uLocal_2034, sLocal_2310, "HT2_WLKOFF", 7, 0, 0, 0))
							{
								...
								{
									clear_ped_tasks(iLocal_2307);
									task_turn_ped_to_face_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), -1);
									task_look_at_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									iLocal_2226[11] = 1;
									_0x293220DA1B46CEBC(2f, 5f, 4);
									iLocal_2030 = 13;
					...
					else if (get_script_task_status(iLocal_2307, 713668775) != 1)
					{
						task_follow_nav_mesh_to_coord(iLocal_2307, Local_95[2 /*36*/].f_17, 1f, 60000, 0.25f, 0, fLocal_2286);
					}
				}
			}
			break;
		...
		case 13:
			Local_2325 = {func_483()};
			if (!func_9() || are_strings_equal(&Local_2325, "HT2_WLKOFF_4"))
			{
				task_clear_look_at(iLocal_2307);
				func_11(&iLocal_2200);
				func_480(iLocal_2307, 0);
				task_follow_nav_mesh_to_coord(iLocal_2307, vLocal_2334, 1f, 60000, 0.25f, 0, fLocal_2286);
				iLocal_2030 = 14;
			}
			break;
		...
		case 14:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_2307))
			{
				if (is_entity_occluded(iLocal_2307) && !func_403(15f))
				{
					set_ped_as_no_longer_needed(&iLocal_2307);
					func_3(&iLocal_2307);
					iLocal_2030 = 0;
				}
				else if (func_403(15f))
				{
					if (iLocal_2434 == 0)
					{
						iLocal_2434 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(8000, 12000);
					}
		...
		case 15:
			if (func_403(15f))
			{
				vVar13 = {func_297(get_entity_coords(PLAYER::PLAYER_PED_ID(), 1) - get_entity_coords(iLocal_2307, 1))};
				vVar16 = {get_entity_forward_vector(iLocal_2307)};
				fVar19 = func_312(vVar16, vVar13);
				if (fVar19 > 0.92f)
				{
					if (!iLocal_2435)
					{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_2307))
	{
		if (iLocal_2028 != 25 && iLocal_2030 != 0)
		{
			if (!iLocal_2209)
			{
				if (is_ped_in_melee_combat(PLAYER::PLAYER_PED_ID()) || _0xDCCA191DF9980FD7(PLAYER::PLAYER_PED_ID()))
				{
					if (is_ped_ragdoll(iLocal_2307))
					{
						func_215();
				...
				if ((has_entity_been_damaged_by_entity(iLocal_2307, PLAYER::PLAYER_PED_ID(), 1) || has_ped_been_damaged_by_weapon(iLocal_2307, false, 2)) || is_explosion_in_sphere(-1, get_entity_coords(iLocal_2307, 0), 10f))
				{
					func_215();
					iLocal_2297 = GAMEPLAY::GET_GAME_TIMER() + 1700;
					iLocal_2209 = 1;
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2297)
			{
				...
				{
					clear_ped_tasks(iLocal_2307);
					task_smart_flee_ped(iLocal_2307, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					set_ped_keep_task(iLocal_2307, true);
				}
				if (!is_entity_dead(iLocal_2307, 0))
				{
					func_282(5);
				}
				else
...
void func_471(int iParam0)
{
	if (does_blip_exist(Local_95[iParam0 /*36*/].f_1))
	{
		...
		if (IntToFloat(Local_95[iParam0 /*36*/].f_3) < 0.1f)
		{
			if (!iLocal_2208)
			{
				iLocal_2293 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(4000, 10000);
				iLocal_2208 = 1;
			}
...
bool func_475(int iParam0)
{
	if (!func_403(6f))
	{
		iLocal_2433 = GAMEPLAY::GET_GAME_TIMER() + get_random_int_in_range(25000, 45000);
		return true;
	}
	if (iLocal_2433 == 0)
	{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2433 && !func_476(iParam0))
	{
...
bool func_476(auto uParam0)
{
	if (func_490(Local_95[uParam0 /*36*/]))
	{
		if (is_entity_on_screen(Local_95[uParam0 /*36*/]))
		{
			if (is_player_free_aiming_at_entity(player_id(), Local_95[uParam0 /*36*/]))
			{
				if (!would_entity_be_occluded(Local_95[uParam0 /*36*/].f_15, get_entity_coords(Local_95[uParam0 /*36*/], 0), 1))
				{
					return true;
				}
			}
...
bool func_478()
{
	if (func_490(PLAYER::PLAYER_PED_ID()) && get_weapontype_group(func_469(PLAYER::PLAYER_PED_ID())) == -1212426201)
	{
		return true;
	}
	return false;
...
void func_479(int iParam0)
{
	...
	{
		if (((iLocal_2246[iParam0] && !func_9()) && !func_281("HT_OBJ", 0, 0)) && is_entity_on_screen(Local_95[iParam0 /*36*/]))
		{
			if (is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_2401, vLocal_2404, 20f, 0, true, 0) || is_entity_in_angled_area(PLAYER::PLAYER_PED_ID(), vLocal_2407, vLocal_2410, 20f, 0, true, 0))
			{
...
int func_481(auto uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
auto func_482(int iParam0, int iParam1)
{
...
int func_485(auto uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_486()
{
	...
	iVar1 = 0;
	if (func_490(iLocal_2307) && func_490(PLAYER::PLAYER_PED_ID()))
	{
		if (func_489())
		{
			iVar1 = 0;
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_487(iVar1)))
				{
					iVar0 = get_ped_index_from_entity_index(func_487(iVar1));
					if (iVar0 != PLAYER::PLAYER_PED_ID() && iVar0 != iLocal_2307)
					{
						...
						{
							if (has_entity_been_damaged_by_entity(iVar0, PLAYER::PLAYER_PED_ID(), 1))
							{
...
struct<2> func_493(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					cVar0 = {func_500(iParam2)};
					break;
				
				case 8:
					cVar0 = {func_499(iParam2)};
					break;
				
				case 7:
					cVar0 = {func_498(iParam2)};
					break;
				
				case 10:
					cVar0 = {func_497(iParam2)};
					break;
				
				case 5:
					cVar0 = {func_496(iParam2)};
					break;
				
				case 4:
					cVar0 = {func_495(iParam2)};
					break;
				
				default:
					StringCopy(&cVar0, func_494(iVar2), 8);
					break;
			}
			break;
...
struct<2> func_500(auto uParam0)
{
	char[8] cVar0;
	struct<2> Var2;
...
bool func_502(int iParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6)
{
	if (((!func_504(0) || Global_69758) || Global_69747 == 1) || !is_screen_faded_in())
	{
		return false;
	}
	switch (Global_69743)
	{
		...
		case 5:
			if ((is_cutscene_playing() || func_228(0)) || func_503(1))
			{
			}
			else
			{
...
void func_507(auto uParam0, int iParam1, int iParam2)
{
	int iVar0;
...
bool func_508(auto uParam0)
{
	...
	switch (iLocal_1957)
	{
		...
		case 1:
			if (!func_516(&iVar0) || !has_anim_dict_loaded("rcmhunting2"))
			{
				return false;
			}
			iLocal_1957 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam0.f_28[0]))
			{
				...
				{
					give_weapon_to_ped(*uParam0.f_28[0], joaat("weapon_pumpshotgun"), false, true, true);
				}
				else
				{
					iVar7 = false;
			...
			{
				iLocal_1966 = create_weapon_object(joaat("weapon_sniperrifle"), false, vLocal_1963, 0, 1f, false, 0, 1);
				give_weapon_component_to_weapon_object(iLocal_1966, joaat("component_at_scope_large"));
				give_weapon_component_to_weapon_object(iLocal_1966, joaat("component_at_ar_supp_02"));
			}
			if (iVar7)
			{
				iLocal_1957 = 3;
		...
		case 3:
			...
			if (does_object_of_type_exist_at_coords(vLocal_1963, 1f, iLocal_1960, 0))
			{
				set_entity_rotation(iLocal_1966, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= iVar0 - 1)
			{
...
void func_509(int iParam0, Vector3 vParam1, Vector3 fParam2, int iParam3)
{
	func_510(iParam0, iLocal_1959, vParam1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_510(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3)
{
	func_511(iParam0);
...
bool func_513(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, char* sParam4, int iParam5)
{
	if (func_514(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!is_entity_dead(*iParam0, 0))
...
bool func_514(int iParam0, int iParam1, Vector3 vParam2, Vector3 fParam3, int iParam4)
{
	int iVar0;
...
bool func_515(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_519(int iParam0)
{
	...
	if (func_490(iVar0))
	{
		...
		{
			iLocal_1795 = 0;
			give_weapon_to_ped(iVar0, joaat("weapon_sniperrifle"), -1, iParam0, true);
		}
		else
		{
			iLocal_1795 = 1;
...
void func_520()
{
	if (func_8(PLAYER::PLAYER_PED_ID()) && has_ped_got_weapon(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), 0))
	{
		iLocal_1795 = 1;
		iLocal_2303 = get_ped_weapon_tint_index(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"));
		iLocal_1797 = get_ped_ammo_by_type(PLAYER::PLAYER_PED_ID(), 1285032059);
		if (has_ped_got_weapon_component(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_ar_supp_02")))
		{
			iLocal_1796 = 1;
		}
		if (has_ped_got_weapon_component(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_scope_large")))
		{
			iLocal_2224 = 1;
		}
		if (has_ped_got_weapon_component(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_scope_max")))
		{
			iLocal_2225 = 1;
		}
		if (has_ped_got_weapon_component(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_sniperrifle_clip_01")))
		{
			iLocal_2223 = 1;
		}
	}
...
void func_521()
{
	...
	if (func_490(PLAYER::PLAYER_PED_ID()))
	{
		func_480(PLAYER::PLAYER_PED_ID(), 0);
	}
	func_451(1);
	...
	if (iLocal_2211)
	{
		remove_relationship_group(iLocal_2308);
		remove_relationship_group(iLocal_94);
	}
	func_522(&Local_1967, 0, 0, 0);
}

void func_522(auto uParam0, int iParam1, int iParam2, int iParam3)
{
	func_530(uParam0, iParam1);
	func_527(uParam0, iParam2);
	func_523(uParam0, iParam3);
}

void func_523(auto uParam0, int iParam1)
{
	func_524(uParam0.f_41, iParam1);
}
...
void func_527(auto uParam0, int iParam1)
{
	func_528(uParam0.f_35, iParam1);
}

void func_528(auto uParam0, int iParam1)
{
	int iVar0;
...
void func_530(auto uParam0, int iParam1)
{
...
void func_534()
{
	if (func_490(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_1795)
		{
			give_weapon_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), iLocal_1797, false, false);
			set_ped_infinite_ammo(PLAYER::PLAYER_PED_ID(), 0, joaat("weapon_sniperrifle"));
			set_ped_ammo_by_type(PLAYER::PLAYER_PED_ID(), 1285032059, iLocal_1797);
			if (iLocal_1796)
			{
				give_weapon_component_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_ar_supp_02"));
			}
			if (iLocal_2303 != -1)
			{
				set_ped_weapon_tint_index(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), iLocal_2303);
			}
			if (iLocal_2223)
			{
				give_weapon_component_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_sniperrifle_clip_01"));
			}
			if (iLocal_2224)
			{
				give_weapon_component_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_scope_large"));
			}
			if (iLocal_2225)
			{
				give_weapon_component_to_ped(PLAYER::PLAYER_PED_ID(), joaat("weapon_sniperrifle"), joaat("component_at_scope_max"));
			}
		}
	}
}
...
bool func_538(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_541())
	{
		...
		{
			iVar33 = func_394(get_this_script_name());
			if (iVar33 > -1)
			{
