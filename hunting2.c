...
void func_271()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 0) < 40f)
	{
...
void func_274()
{
	...
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 0) < 5f)
	{
		Local_676.f_670 = _get_gameplay_cam_zoom();
		func_267(0);
		func_268(1);
...
void func_284(int iParam0)
{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_95[iParam0 /*36*/]))
			{
				if (!PED::IS_PED_INJURED(Local_95[iParam0 /*36*/]))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_1800, vVar1, 1);
						if (fVar0 > 250f)
						{
							if (!CAM::IS_SPHERE_VISIBLE(vVar1, 2f) || is_screen_faded_out())
							{
	...
	switch (Local_95[iParam0 /*36*/].f_16)
	{
		...
		case 2:
			if (func_308(iParam0, 8, 1, 1))
			{
				if (iLocal_1792 && !func_307(Local_95[iParam0 /*36*/]))
				{
					if (!func_306())
					{
						if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 100) < 100)
						{
		...
		case 3:
			if (!Local_95[iParam0 /*36*/].f_9)
			{
				iVar4 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) % 3;
		...
		case 6:
			if (func_298(iParam0))
			{
				if (!Local_95[iParam0 /*36*/].f_9)
				{
					iLocal_1812 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 58);
		...
		case 15:
			if (func_298(iParam0) && func_490(PLAYER::PLAYER_PED_ID()))
			{
				...
				fVar12 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vVar13, 1);
...
int func_292(int iParam0)
{
	...
	while (iVar2 < 58)
	{
		...
		{
			fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_385[Local_95[iParam0 /*36*/].f_25 /*5*/], Local_385[iVar2 /*5*/], 0);
			if (fVar0 < fVar1)
			{
				fVar1 = fVar0;
				iVar3 = iVar2;
			...
			if (!iParam7)
			{
				if (iParam1 == joaat("a_c_deer"))
				{
					...
					if (iLocal_1807 < 3 || uParam8)
					{
						...
						if (IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 100)) > fVar1 || uParam8)
						{
					...
					set_ped_component_variation(*uParam0, false, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3), 0);
				}
				...
				{
					set_ped_component_variation(*uParam0, false, 0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 4), 0);
				}
				set_entity_lod_dist(*uParam0, 1500);
				set_entity_load_collision_flag(*uParam0, true);
				set_ped_lod_multiplier(*uParam0, 5f);
...
int func_311()
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 58);
	...
	fVar17 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar14, Local_385[iVar0 /*5*/], 1);
...
void func_314(auto uParam0, int iParam1)
{
	...
	fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vLocal_1800, vVar0, 1);
		...
		if (((iLocal_1799 && GAMEPLAY::GET_GAME_TIMER() > iLocal_1943) && !*uParam0.f_10) || *uParam0.f_10)
		{
			...
			if ((*uParam0.f_8 && GAMEPLAY::GET_GAME_TIMER() > iLocal_1943) || iLocal_1799)
			{
				if (!*uParam0.f_10)
				{
					if (*uParam0.f_6 == 0)
					{
						*uParam0.f_6 = GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 11) * 100;
					}
	...
	else if (does_blip_exist(*uParam0.f_1))
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() > *uParam0.f_5 && fVar3 > 35f) && *uParam0.f_11)
		{
			...
			*uParam0.f_3 = get_blip_alpha(*uParam0.f_1);
			if (*uParam0.f_3 > 0)
			{
				if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 1000) > 666)
				{
					*uParam0.f_3--;
...
void func_320(int iParam0)
{
	...
	if (func_298(iParam0) && !Local_95[iParam0 /*36*/].f_9)
	{
		...
		Local_95[iParam0 /*36*/].f_33 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_95[iParam0 /*36*/].f_17, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 0);
...
int func_378(Vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 44)
	{
		if (iParam3 == 5 || iParam3 == func_381(iVar0))
		{
			...
			{
				fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam0, func_379(iVar0, 0), 1);
...
bool func_403(float fParam0)
{
	...
	{
		fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_2307, 1), 0);
		if (fVar0 < fParam0)
		{
			return true;
		}
			...
			else
			{
				...
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_2301)
				{
					...
					if (fVar0 < 20f)
					{
						...
						{
							iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535);
							if (iVar2 < 20000)
							{
