...
void main()
{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_3138, 0) && !ENTITY::IS_ENTITY_DEAD(Local_3138.f_1, 0))
		{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0))
		{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_2992)
			{
				case 0:
					...
					{
						if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0)) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iLocal_3109, 0))
						{
							if (!iLocal_468)
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
								{
									...
									{
										func_132(&uLocal_399, ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 0, 0, 1, 1, 1);
									}
								}
							}
							else
...
void func_35(auto uParam0, auto uParam1, auto uParam2, auto uParam3, auto uParam4, auto uParam5, auto uParam6, auto uParam7, auto uParam8, auto uParam9, auto uParam10, auto uParam11, auto uParam12, auto uParam13, auto uParam14, auto uParam15, auto uParam16, auto uParam17, auto uParam18, auto uParam19, auto uParam20, auto uParam21, auto uParam22, auto uParam23, auto uParam24, auto uParam25, auto uParam26, auto uParam27, auto uParam28, auto uParam29, auto uParam30, auto uParam31, auto uParam32, auto uParam33, auto uParam34, auto uParam35, auto uParam36, auto uParam37, auto uParam38, auto uParam39, auto uParam40, auto uParam41, auto uParam42, auto uParam43, auto uParam44, auto uParam45, auto uParam46, auto uParam47, auto uParam48, auto uParam49, auto uParam50, auto uParam51, auto uParam52, auto uParam53, auto uParam54, auto uParam55, auto uParam56, auto uParam57, auto uParam58, auto uParam59, auto uParam60, auto uParam61, auto uParam62, auto uParam63, auto uParam64, auto uParam65, auto uParam66, auto uParam67, auto uParam68, auto uParam69, auto uParam70, auto uParam71, auto uParam72, auto uParam73, auto uParam74, auto uParam75, auto uParam76, auto uParam77, auto uParam78, auto uParam79, auto uParam80, auto uParam81, auto uParam82, auto uParam83, auto uParam84, auto uParam85, auto uParam86, auto uParam87, auto uParam88, auto uParam89, auto uParam90, auto uParam91, auto uParam92, auto uParam93, auto uParam94, auto uParam95, auto uParam96, auto uParam97, auto uParam98, auto uParam99, auto uParam100, auto uParam101, auto uParam102, auto uParam103, auto uParam104, auto uParam105, auto uParam106, auto uParam107, auto uParam108, auto uParam109, auto uParam110, auto uParam111, auto uParam112, auto uParam113, auto uParam114, auto uParam115, auto uParam116, auto uParam117, auto uParam118, auto uParam119, auto uParam120, auto uParam121, auto uParam122, auto uParam123, auto uParam124, auto uParam125, auto uParam126, auto uParam127, auto uParam128, auto uParam129, auto uParam130, auto uParam131, auto uParam132, auto uParam133, auto uParam134, auto uParam135, auto uParam136, auto uParam137, auto uParam138, auto uParam139, auto uParam140, auto uParam141, auto uParam142, auto uParam143, auto uParam144, auto uParam145, auto uParam146, auto uParam147, auto uParam148, auto uParam149, auto uParam150, auto uParam151, auto uParam152, auto uParam153, auto uParam154, auto uParam155, auto uParam156, auto uParam157, auto uParam158, auto uParam159, auto uParam160, auto uParam161, auto uParam162, auto uParam163, auto uParam164, auto uParam165)
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) % 4;
	if (iVar0 == 0)
	{
...
bool func_42(auto uParam0, auto uParam1)
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(*(uParam0[0 /*20*/]).f_6) && !ENTITY::IS_ENTITY_DEAD(*(uParam0[0 /*20*/]).f_6, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_427)
		{
			if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*(uParam0[0 /*20*/]).f_6, PLAYER::PLAYER_PED_ID(), 1) || has_entity_been_damaged_by_any_object(*(uParam0[0 /*20*/]).f_6)) || has_entity_been_damaged_by_any_ped(*(uParam0[0 /*20*/]).f_6))
			{
				iLocal_2606 = 2;
				return true;
			}
...
bool func_88(char* sParam0)
{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/], 0) && is_ped_in_vehicle(Local_2996[iLocal_3037 /*20*/], iLocal_3109, 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_2996[iLocal_3037 /*20*/]) && !ENTITY::IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/], 0))
			{
				...
				iVar7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 65535) % 3;
				if (iVar7 == 0)
				{
...
void func_98()
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && is_vehicle_attached_to_tow_truck(iLocal_3109, Local_2996[0 /*20*/].f_6)) || (Global_101154.f_18663.f_3 == 0 || Global_101154.f_18663.f_3 > 2))
	{
		return;
	}
	switch (iLocal_3050)
		...
		case 0:
			if (!iLocal_2958)
			{
				if ((func_108(Local_2996[iParam1 /*20*/].f_6, iLocal_3109, &iLocal_2603, 10, 150f, 4f, 1) || iLocal_2953) || iLocal_468)
				{
					...
					if (iLocal_2936)
					{
						if (ENTITY::IS_ENTITY_AT_COORD(iLocal_3109, ENTITY::GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 25f, 25f, 25f, false, true, 0))
						{
						...
						else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_3109, ENTITY::GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 50f, 50f, 50f, false, true, 0))
						{
							if (!iLocal_2977)
							{
								if (Global_101154.f_18663.f_7 == 0 || Global_101154.f_18663.f_7 == 1)
...
bool func_108(int iParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, int iParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam1, 0))
		{
			...
			if (((*iParam2 > iParam3 || func_103(iParam0, 1) < 8f) && get_entity_speed(iParam1) < fParam5) && !ENTITY::IS_ENTITY_OCCLUDED(iParam0))
			{
				*iParam2 = 0;
				return true;
			}
...
bool func_124(auto uParam0, Vector3 fParam1, auto uParam2, auto uParam3)
{
	...
	fVar8 = 0f;
	fVar9 = 0f;
	iVar10 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, 3999) / 1000;
	if (iVar10 == 0)
	{
	...
	switch (*uParam0)
	{
		...
		case 3:
			...
			while (iVar0 < iParam5)
			{
				...
				{
					open_sequence_task(&iLocal_421);
					AI::TASK_PLAY_ANIM(false, sParam6, *sParam7[iVar0], 4f, -4f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000), 0, 0, 0, 0, 0);
		...
		while (iVar2 < iParam11)
		{
			...
			*sParam10[iVar2] = *sParam10[iVar2];
			...
			if (iLocal_420 == 3)
			{
				...
				AI::TASK_PLAY_ANIM(false, "oddjobs@towingcome_here", "come_here_idle_a", 4f, -4f, -1, 49, 0, 0, 0, 0);
...
bool func_167()
{
	...
	switch (iLocal_3120)
	{
		...
		case 1:
			open_sequence_task(&iLocal_421);
			AI::TASK_PLAY_ANIM(false, "oddjobs@towing", "Start_Engine_Loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
			close_sequence_task(iLocal_421);
			...
			{
				AI::TASK_PLAY_ANIM(false, "oddjobs@towing", "Start_Engine_Exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
				iLocal_3120 = 2;
			}
			break;
			...
			if (!func_11(Local_650[iLocal_2604 /*23*/].f_13))
			{
				...
				if (!is_entity_in_angled_area(Local_2996[0 /*20*/].f_6, Local_650[iLocal_2604 /*23*/].f_13, Local_650[iLocal_2604 /*23*/].f_16, Local_650[iLocal_2604 /*23*/].f_19, 0, true, 0))
				{
					...
					if (is_ped_in_any_vehicle(Local_2996[0 /*20*/], 0))
					{
						open_sequence_task(&iLocal_421);
						task_leave_any_vehicle(false, false, 0);
						AI::TASK_PLAY_ANIM(false, "oddjobs@towingpleadingidle_b", "idle_d", 4f, -4f, 10000, 16, 0, 0, 0, 0);
						close_sequence_task(iLocal_421);
						task_perform_sequence(Local_2996[0 /*20*/], iLocal_421);
						clear_sequence_task(&iLocal_421);
						iLocal_3120 = 4;
...
void func_170()
{
	...
	if (iLocal_2947 || ((!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && !is_ped_in_vehicle(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0)))
	{
		if (iLocal_2598 != -1)
		{
	...
	switch (iLocal_3118)
	{
		...
		case 1:
			if (iLocal_2965)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 15f, 15f, 15f, false, true, 0))
					{
						if (!iLocal_3136)
						{
			...
			if (func_7(&iLocal_3103) && func_4(&iLocal_3103) > 1f)
			{
				if (iLocal_2965 && func_7(&iLocal_3103))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
					{
						...
						AI::TASK_PLAY_ANIM(false, "oddjobs@towingpleadingidle_b", "idle_d", -8f, 0.25f, -1, 1, 0, 0, 0, 0);
						close_sequence_task(iLocal_421);
						task_perform_sequence(Local_2996[0 /*20*/], iLocal_421);
						clear_sequence_task(&iLocal_421);
						open_sequence_task(&iLocal_421);
						...
						AI::TASK_PLAY_ANIM(false, "oddjobs@towingpleadingidle_a", "idle_c", 0.25f, 0.25f, 30000, 1, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(false, Local_2996[0 /*20*/], 1000f, -1, 0, 0);
						task_wander_standard(false, 1193033728, 0);
						close_sequence_task(iLocal_421);
						if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
						{
				...
				else if (iLocal_2966)
				{
					if (Global_101154.f_18663.f_4 % 2 == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
						{
							...
							task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
							AI::TASK_PLAY_ANIM(false, "oddjobs@towingangryidle_a", "idle_b", -8f, 0.25f, 7000, 0, 0, 0, 0, 0);
							task_wander_standard(false, 1193033728, 0);
							close_sequence_task(iLocal_421);
							task_perform_sequence(Local_2996[0 /*20*/], iLocal_421);
							clear_sequence_task(&iLocal_421);
						...
						if (!func_41())
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], 242628503) == 1)
							{
								if (get_sequence_progress(Local_2996[0 /*20*/]) == 2)
								{
									...
									if (vdist2(vVar1, ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/], 1)) < 400f)
									{
										if (Global_101154.f_18663.f_4 % 2 == 0)
										{
			...
			if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
			{
				if (func_104(Local_2996[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1) < 12f)
				{
					...
					else if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
					{
						open_sequence_task(&iLocal_421);
						task_turn_ped_to_face_entity(false, PLAYER::PLAYER_PED_ID(), false);
						AI::TASK_PLAY_ANIM(false, "oddjobs@towingpleadingidle_a", "idle_c", -8f, 0.25f, 5000, 0, 0, 0, 0, 0);
						close_sequence_task(iLocal_421);
						task_perform_sequence(Local_2996[0 /*20*/], iLocal_421);
						clear_sequence_task(&iLocal_421);
					}
...
bool func_197(auto uParam0, int iParam1, auto uParam2, auto uParam3, int iParam4)
{
	...
	if (iVar0 > 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
			{
				if ((is_ped_in_any_vehicle(PLAYER::PLAYER_PED_ID(), 0) && is_ped_in_vehicle(PLAYER::PLAYER_PED_ID(), iParam1, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1, PLAYER::PLAYER_PED_ID(), 1))
				{
					*uParam3 += iVar0;
				}
	...
	if (iParam5)
	{
		if (iVar0 > 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam1) && ENTITY::DOES_ENTITY_EXIST(iParam2))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0) && !ENTITY::IS_ENTITY_DEAD(iParam2, 0))
				{
					if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam1, iParam2) || is_vehicle_attached_to_tow_truck(iParam2, iParam1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1, PLAYER::PLAYER_PED_ID(), 1))
					{
						*uParam4 += iVar0;
					}
					else if (ENTITY::DOES_ENTITY_EXIST(iParam1))
...
void func_201(int iParam0, int iParam1, auto uParam2, auto uParam3, char* sParam4, auto uParam5, auto uParam6, int iParam7, auto uParam8, int iParam9, auto uParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (!iParam9)
	{
		...
		else if (func_202(iParam0))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(*(uParam2[uParam6 /*20*/]).f_6, 0))
				{
...
auto func_223(auto uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	iVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, iParam2 - 1);
...
int func_240(float fParam0, int iParam1, int iParam2)
{
	...
	if (iVar57 > 1)
	{
		iVar1 = iVar3[GAMEPLAY::GET_RANDOM_INT_IN_RANGE(false, iVar57 - 1)];
	}
	else if (iVar57 == 1)
	{
		iVar1 = iVar3[0];
