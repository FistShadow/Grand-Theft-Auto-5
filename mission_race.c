...
void main()
{
	...
	iLocal_1158 = -1;
	iLocal_1165 = -1;
	iLocal_1232 = AUDIO::GET_SOUND_ID();
...
void func_2(int iParam0)
{
	...
	if (Local_611.f_1 == 1)
	{
		clear_area_of_vehicles(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 50f, 0, 0, 0, 0, false);
		func_110(&vLocal_18);
	...
	clear_area_of_projectiles(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 0);
	stop_fire_in_range(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f);
	...
	wait(0);
	clear_area_of_vehicles(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 500f, 0, 0, 0, 0, false);
	...
	while (iVar3 <= Local_629.f_249 - 1)
	{
		...
		{
			AI::CLEAR_PED_TASKS(Local_882[iVar3 /*18*/].f_3);
		}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_882[iParam0 /*18*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_882[iParam0 /*18*/].f_6, 0))
	{
...
void func_32(int iParam0)
{
	...
	while (iVar0 <= 14)
	{
		...
		if (iParam0 == 1)
		{
			...
			{
				PED::DELETE_PED(&(Local_882[iVar0 /*18*/].f_3));
			}
		...
		else
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_882[iVar0 /*18*/].f_3))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_882[iVar0 /*18*/].f_3, 0))
				{
					set_ped_keep_task(Local_882[iVar0 /*18*/].f_3, true);
					if (ENTITY::DOES_ENTITY_EXIST(Local_882[iVar0 /*18*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_882[iVar0 /*18*/].f_6, 0))
					{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_882[iVar0 /*18*/].f_6))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_882[iVar0 /*18*/].f_6, 0))
				{
...
bool func_35()
{
	...
	if (is_ped_sitting_in_any_vehicle(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			iVar0 = ENTITY::GET_ENTITY_MODEL(iLocal_1167);
			if ((is_this_model_a_bike(iVar0) && !VEHICLE::IS_THIS_MODEL_A_BICYCLE(iVar0)) && !func_36(iVar0))
			{
				return true;
			}
		}
...
bool func_92(int iParam0, Vector3 vParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= iVar5 - 1)
			{
				if (func_94(iParam0, uVar1[iVar6], 1) && func_93(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!iParam4 || func_88(vParam1, 0f, 0f, 0f, 0)) || INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_174()
{
	...
	if (iLocal_1810)
	{
		if (func_9(iLocal_1450))
		{
			...
			{
				vVar0 = {_get_object_offset_from_coords(ENTITY::GET_ENTITY_COORDS(iLocal_1450, 1), get_entity_heading(iLocal_1450), 0f, 5f, 0f)};
			}
			...
			AI::CLEAR_PED_TASKS(iLocal_1450);
	...
	switch (iLocal_606)
	{
		case 0:
			...
			else
			{
				...
				fVar2 = func_332(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[0 /*3*/]);
				fVar3 = fVar1 - fVar2;
		...
		case 2:
			...
			if (func_192(&uLocal_1812, 0, 1065353216, 0, 0, 0))
			{
				...
				if (func_191())
				{
					if (func_9(iLocal_1450))
					{
						AI::TASK_PLAY_ANIM(iLocal_1450, sLocal_1434, "_grid_girl_end", 1000f, -8f, 5500, 0, 0, 0, 0, 0);
					}
					iLocal_605 = 4;
					iLocal_606 = 0;
				}
...
void func_315()
{
	...
	while (iVar0 <= Local_629.f_249 - 1)
	{
		...
		{
			AI::CLEAR_PED_TASKS(Local_882[iVar0 /*18*/].f_3);
...
void func_354(int iParam0, Vector3 vParam1)
{
	...
	fVar0 = func_355(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1, 1);
...
void func_364()
{
	...
	{
		waypoint_recording_get_closest_waypoint(sLocal_1461, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar0);
...
bool func_370()
{
	...
	while (iVar0 <= Local_629.f_249 - 1)
	{
		if (func_138(Local_882[iVar0 /*18*/].f_6))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(vLocal_18.x, Local_882[iVar0 /*18*/].f_6))
			{
				return true;
			}
		}
...
void func_388()
{
	...
	if (is_player_playing(player_id()))
	{
		Local_617.f_11 = 1;
		iVar0 = Local_617.f_6;
		fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[Local_617.f_6 /*3*/], 1);
		if (fVar1 > fLocal_1164 + 100f)
		{
			...
			fVar3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[iVar2 /*3*/], 1);
			fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_629[iVar2 /*3*/], Local_629[Local_617.f_6 /*3*/], 1) + 20f;
			if (fVar3 < fVar4)
			{
				iLocal_604 = 5;
			}
		...
		else if (fVar1 > fLocal_1164 + 7.5f)
		{
			...
			while (iVar5 < Local_629.f_248)
			{
				...
				{
					fVar7 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[iVar5 /*3*/], 1);
					if (fVar7 < fVar6)
					{
						fVar6 = fVar7;
						iVar0 = iVar5;
		...
		while (iVar9 < Local_629.f_249)
		{
			if (func_10(Local_882[iVar9 /*18*/].f_3))
			{
				...
				else if (Local_882[iVar9 /*18*/].f_9 == Local_617.f_8)
				{
					...
					{
						fVar1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[iVar0 /*3*/], 1);
						fVar8 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(Local_882[iVar9 /*18*/].f_6, 1), Local_629[Local_882[iVar9 /*18*/].f_8 /*3*/], 1);
						if (fVar8 < fVar1)
						{
							Local_617.f_11++;
						}
...
void func_391(int iParam0, auto uParam1, int iParam2)
{
	...
	if (iParam0 >= 0 || iParam0 < Local_629.f_249)
	{
		if (func_407(iParam0))
		{
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1), 3f))
				{
					func_402(iParam0);
				}
				else
...
void func_392(auto uParam0, int iParam1, int iParam2, float fParam3, int iParam4)
{
	...
	{
		*uParam0 = func_393(ENTITY::GET_ENTITY_COORDS(iParam1, 1), 0);
		if (iParam2)
		{
...
bool func_396(int iParam0)
{
	...
	vVar0 = {ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1)};
	if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar0, Local_629[Local_882[iParam0 /*18*/].f_8 /*3*/], 0) <= 12f)
	{
		return true;
	}
	iVar4 = 0;
	waypoint_recording_get_closest_waypoint(sLocal_1461, ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1), &iVar3);
	iVar4 = 0;
	while (iVar4 < 5)
	{
		if (iVar3 - iVar4 > 0)
...
void func_398(int iParam0)
{
	if (func_138(vLocal_18.x) && func_9(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(vLocal_18.x, Local_882[iParam0 /*18*/].f_6))
			{
...
void func_399(int iParam0)
{
	...
	{
		case 0:
			vVar0 = {get_offset_from_entity_given_world_coords(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1))};
		...
		case 1:
			...
			{
				ENTITY::APPLY_FORCE_TO_ENTITY(Local_882[iParam0 /*18*/].f_6, 0, 0f, 25f, 0f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
			}
			break;
	}
}
...
void func_401(int iParam0)
{
	...
	{
		waypoint_recording_get_closest_waypoint(sLocal_1461, ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1), &iVar0);
	...
	switch (Local_882[iParam0 /*18*/].f_15)
	{
		case 0:
			if (((func_406(iParam0, iParam1) && is_ped_in_vehicle(Local_882[iParam0 /*18*/].f_3, Local_882[iParam0 /*18*/].f_6, 0)) && is_waypoint_playback_going_on_for_vehicle(Local_882[iParam0 /*18*/].f_6)) && get_is_waypoint_recording_loaded(sLocal_1461))
			{
				...
				if ((waypoint_recording_get_closest_waypoint(sLocal_1461, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar2) && waypoint_recording_get_coord(sLocal_1461, iVar3, &vVar5)) && waypoint_recording_get_coord(sLocal_1461, iVar2, &vVar8))
				{
					fVar4 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar8, vVar5, 1);
					if (((((fVar4 > 40f || Local_882[iParam0 /*18*/].f_9 < Local_617.f_8) && !func_405(PLAYER::PLAYER_PED_ID(), Local_882[iParam0 /*18*/].f_6, fVar0, 1)) && !func_404(PLAYER::PLAYER_PED_ID(), vVar5, fVar0)) && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1), 5f)) && !CAM::IS_SPHERE_VISIBLE(vVar5, 5f))
					{
						if (iParam1 && iParam0 == Local_629.f_249 - 1)
						{
		...
		case 1:
			...
			{
				if (((((func_405(PLAYER::PLAYER_PED_ID(), Local_882[iParam0 /*18*/].f_6, fVar0, 1) || func_404(PLAYER::PLAYER_PED_ID(), vVar12, fVar0)) || CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_882[iParam0 /*18*/].f_6, 1), 5f)) || CAM::IS_SPHERE_VISIBLE(vVar12, 5f)) || (Local_882[iParam0 /*18*/].f_9 == Local_617.f_8 && Local_882[iParam0 /*18*/].f_8 >= Local_617.f_6)) || Local_882[iParam0 /*18*/].f_9 > Local_617.f_8)
				{
				...
				else if (GAMEPLAY::GET_GAME_TIMER() > Local_882[iParam0 /*18*/].f_17)
				{
					if (!is_any_vehicle_near_point(vVar12, 5f) || func_404(Local_882[iParam0 /*18*/].f_6, vVar12, 5f))
					{
						if (waypoint_recording_get_coord(sLocal_1461, iVar11, &vVar15))
						{
							...
							if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vVar12, Local_629[Local_882[iParam0 /*18*/].f_8 /*3*/], 0) <= 12f * 2f)
							{
								func_394(iParam0);
							}
...
bool func_407(int iParam0)
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_882[iParam0 /*18*/].f_3, 0))
		{
			iLocal_604 = 2;
			iLocal_605 = 5;
			iLocal_606 = 0;
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_882[iParam0 /*18*/].f_6, 0))
		{
			iLocal_604 = 2;
			iLocal_605 = 5;
			iLocal_606 = 0;
		}
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_882[iParam0 /*18*/].f_6, PLAYER::PLAYER_PED_ID(), 0))
		{
			iLocal_604 = 1;
			iLocal_605 = 5;
			iLocal_606 = 0;
...
bool func_411(int iParam0, Vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = {func_413(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1))};
...
bool func_416(int iParam0)
{
	...
	{
		func_418(iParam0);
		if (INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[Local_617.f_6 /*3*/], 1) <= 12f)
		{
...
void func_417()
{
	if (is_player_playing(player_id()))
	{
		fLocal_1164 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_629[Local_617.f_6 /*3*/], 1);
	}
}
...
int func_424(int iParam0)
{
	...
	{
		fVar0 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Local_629[iParam0 /*3*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
		if (fVar0 > 100f)
		{
			iVar1 = 240;
		}
...
void func_426()
{
	iLocal_1158 = AUDIO::GET_SOUND_ID();
	iLocal_1157 = -1;
}
...
void func_431()
{
	...
	if ((func_9(PLAYER::PLAYER_PED_ID()) && is_ped_shooting(PLAYER::PLAYER_PED_ID())) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		iLocal_604 = 1;
		iLocal_605 = 5;
		iLocal_606 = 0;
		...
		{
			AI::TASK_SMART_FLEE_PED(iLocal_1431, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			set_ped_keep_task(iLocal_1431, true);
		}
		if (func_9(iLocal_1432))
		{
			AI::TASK_SMART_FLEE_PED(iLocal_1432, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
...
{
	return (has_scaleform_movie_loaded(*uParam0) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("HUD_321_GO", false));
}
...
void func_466(Vector3 fParam0)
{
	...
	if (Local_611.f_1 == 2)
	{
		...
		{
			open_sequence_task(&iVar0);
			AI::TASK_PLAY_ANIM(false, sLocal_1434, "grid_girl_race_start", 4f, -8f, -1, 8, fParam0, 0, 0, 0);
...
void func_467()
{
	...
	if (Local_611.f_1 == 2)
	{
		...
		vVar1 = {get_offset_from_entity_in_world_coords(iLocal_1432, 0f, 20f, 0f)};
		open_sequence_task(&iVar0);
		AI::TASK_PLAY_ANIM(false, sLocal_1434, "grid_girl_a", 8f, -8f, -1, 9, 0, 0, 0, 0);
		task_go_straight_to_coord(false, vVar1, 1f, 20000, 1193033728, 0.5f);
		task_wander_standard(false, 1193033728, 0);
		close_sequence_task(iVar0);
		task_perform_sequence(iLocal_1432, iVar0);
		...
		vVar1 = {get_offset_from_entity_in_world_coords(iLocal_1433, 0f, 15f, 0f)};
		open_sequence_task(&iVar0);
		AI::TASK_PLAY_ANIM(false, sLocal_1434, "grid_girl_b", 8f, -8f, -1, 9, 0, 0, 0, 0);
		task_go_straight_to_coord(false, vVar1, 1f, 20000, 1193033728, 0.5f);
		task_wander_standard(false, 1193033728, 0);
		close_sequence_task(iVar0);
		task_perform_sequence(iLocal_1433, iVar0);
...
void func_472(int iParam0, int iParam1)
{
	...
	{
		GAMEPLAY::SET_BIT(&(Global_25433[iVar1 /*23*/].f_11), 18);
		if (Global_25430 == 1)
		{
			Global_25431 = 1;
		}
	...
	if (iParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_25433[iVar1 /*23*/].f_11), 3);
	}
	else
	{
...
void func_494(int iParam0, int iParam1)
{
	...
	if ((iParam1 && ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (Local_611.f_1 == 1 || Local_611.f_1 == 2)
		{
			iLocal_1470 = func_496(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 60f);
...
void func_510()
{
	switch (Local_611)
	{
		case 5:
			...
			{
				func_512(82, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29501.f_1), false);
				func_511();
			}
			break;
		...
		case 6:
			...
			{
				func_512(83, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29501.f_1), true);
				func_511();
			}
			break;
		...
		case 7:
			...
			{
				func_512(84, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29501.f_1), 2);
				func_511();
			}
			break;
		...
		case 8:
			...
			{
				func_512(85, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29501.f_1), 3);
				func_511();
			}
			break;
		...
		case 0:
			...
			{
				func_512(86, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_2), false);
				func_511();
			}
			break;
		...
		case 1:
			...
			{
				func_512(87, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_2), true);
				func_511();
			}
			break;
		...
		case 2:
			...
			{
				func_512(88, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_2), 2);
				func_511();
			}
			break;
		...
		case 3:
			...
			{
				func_512(89, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_2), 3);
				func_511();
			}
			break;
		...
		case 4:
			...
			{
				func_512(90, 1);
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_2), 4);
				func_511();
			}
			break;
	}
...
void func_513()
{
	...
	switch (Local_611)
	{
		case 0:
			...
			{
				GAMEPLAY::SET_BIT(&(Global_101154.f_29504.f_1), true);
				iVar0 = true;
			}
			break;
